...
@XmlType(name = "ATMCustomer2", propOrder = {
    "prfl",
    "authntcnRslt"
})
public class ATMCustomer2 {
     ...
     *     
     */
    public ATMCustomer2 setPrfl(ATMCustomerProfile2 value) {
        this.prfl = value;
        return this;
    }
     ...
     * 
     */
    public ATMCustomer2 addAuthntcnRslt(TransactionVerificationResult5 authntcnRslt) {
