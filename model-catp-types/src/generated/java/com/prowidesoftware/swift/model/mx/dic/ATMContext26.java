...
@XmlType(name = "ATMContext26", propOrder = {
    "ssnRef",
    "svc"
})
public class ATMContext26 {

    @XmlElement(name = "SsnRef")
    protected String ssnRef;
    @XmlElement(name = "Svc", required = true)
    protected ATMService25 svc;
     ...
     *     
     */
    public ATMContext26 setSsnRef(String value) {
        this.ssnRef = value;
        return this;
    }
     ...
     *     
     */
    public ATMContext26 setSvc(ATMService25 value) {
        this.svc = value;
        return this;
    }
