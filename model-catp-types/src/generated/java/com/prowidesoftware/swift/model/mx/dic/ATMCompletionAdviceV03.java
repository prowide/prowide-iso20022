...
@XmlType(name = "ATMCompletionAdviceV03", propOrder = {
    "hdr",
    "prtctdATMCmpltnAdvc",
    "atmCmpltnAdvc",
    "sctyTrlr"
})
public class ATMCompletionAdviceV03 {
    ...
    protected ATMCompletionAdvice3 atmCmpltnAdvc;
     ...
     *     
     */
    public ATMCompletionAdviceV03 setHdr(Header32 value) {
        this.hdr = value;
        return this;
    }
     ...
     *     
     */
    public ATMCompletionAdviceV03 setPrtctdATMCmpltnAdvc(ContentInformationType10 value) {
     ...
     * @return
     *     possible object is
     *     {@link ATMCompletionAdvice3 }
     *     
     */
    public ATMCompletionAdvice3 getATMCmpltnAdvc() {
     ...
     *     
     */
    public ATMCompletionAdviceV03 setATMCmpltnAdvc(ATMCompletionAdvice3 value) {
     ...
     *     
     */
    public ATMCompletionAdviceV03 setSctyTrlr(ContentInformationType15 value) {
        this.sctyTrlr = value;
        return this;
    }
