...
@XmlType(name = "ATMService28", propOrder = {
    "svcTp",
    "svcVarnt",
    "lmts",
    "prefrdWdrwl"
})
public class ATMService28 {
     ...
     *     
     */
    public ATMService28 setSvcTp(ATMServiceType13Code value) {
        this.svcTp = value;
        return this;
    }
     ...
     *     
     */
    public ATMService28 setPrefrdWdrwl(ATMTransaction8 value) {
     ...
     * 
     */
    public ATMService28 addSvcVarnt(ATMService18 svcVarnt) {
     ...
     * 
     */
    public ATMService28 addLmts(ATMTransactionAmounts6 lmts) {
        getLmts().add(lmts);
        return this;
    }
