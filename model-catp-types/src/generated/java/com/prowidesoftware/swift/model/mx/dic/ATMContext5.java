...
@XmlType(name = "ATMContext5", propOrder = {
    "ssnRef",
    "svc"
})
public class ATMContext5 {

    @XmlElement(name = "SsnRef")
    protected String ssnRef;
    @XmlElement(name = "Svc", required = true)
    protected ATMService5 svc;
     ...
     *     
     */
    public ATMContext5 setSsnRef(String value) {
        this.ssnRef = value;
        return this;
    }
     ...
     *     
     */
    public ATMContext5 setSvc(ATMService5 value) {
        this.svc = value;
        return this;
    }
