...
public class ATMService19 {
     ...
     *     
     */
    public ATMService19 setSvcTp(ATMServiceType8Code value) {
        this.svcTp = value;
        return this;
    }
     ...
     * 
     */
    public ATMService19 addSvcVarnt(ATMService18 svcVarnt) {
     ...
     * 
     */
    public ATMService19 addLmts(ATMTransactionAmounts6 lmts) {
        getLmts().add(lmts);
        return this;
    }
