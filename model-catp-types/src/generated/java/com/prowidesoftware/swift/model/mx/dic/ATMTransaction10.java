...
@XmlType(name = "ATMTransaction10", propOrder = {
    "txId",
    "rcncltnId",
    "cmpltnReqrd",
    "txRspn",
...
public class ATMTransaction10 {
     ...
     *     
     */
    public ATMTransaction10 setTxId(TransactionIdentifier1 value) {
        this.txId = value;
        return this;
    }
     ...
     *     
     */
    public ATMTransaction10 setRcncltnId(String value) {
     ...
     *     
     */
    public ATMTransaction10 setCmpltnReqrd(Boolean value) {
     ...
     *     
     */
    public ATMTransaction10 setTxRspn(ResponseType3 value) {
        this.txRspn = value;
        return this;
    }
     ...
     *     byte[]
     */
    public ATMTransaction10 setICCRltdData(byte[] value) {
     ...
     * 
     */
    public ATMTransaction10 addActn(Action5 actn) {
        getActn().add(actn);
        return this;
    }
     ...
     * 
     */
    public ATMTransaction10 addCmd(ATMCommand1 cmd) {
        getCmd().add(cmd);
        return this;
    }
