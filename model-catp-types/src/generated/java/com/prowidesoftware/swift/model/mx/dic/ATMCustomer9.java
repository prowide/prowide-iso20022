...
@XmlType(name = "ATMCustomer9", propOrder = {
    "prfl",
    "authntcnRslt",
    "prefrdLang"
})
public class ATMCustomer9 {
     ...
     *     
     */
    public ATMCustomer9 setPrfl(ATMCustomerProfile2 value) {
        this.prfl = value;
        return this;
    }
     ...
     *     
     */
    public ATMCustomer9 setPrefrdLang(String value) {
     ...
     * 
     */
    public ATMCustomer9 addAuthntcnRslt(TransactionVerificationResult5 authntcnRslt) {
