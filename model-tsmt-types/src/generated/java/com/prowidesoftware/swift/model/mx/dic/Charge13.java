...
@XmlType(name = "Charge13", propOrder = {
    "tp",
    "chrgs"
})
public class Charge13 {
    ...
    protected List<ChargesDetails2> chrgs;
     ...
     *     
     */
    public Charge13 setTp(FreightCharges1Code value) {
        this.tp = value;
        return this;
    }
     ...
     * 
     */
    public List<ChargesDetails2> getChrgs() {
        if (chrgs == null) {
            chrgs = new ArrayList<ChargesDetails2>();
        }
        return this.chrgs;
    }
     ...
     * 
     */
    public Charge13 addChrgs(ChargesDetails2 chrgs) {
        getChrgs().add(chrgs);
        return this;
    }
