...
public class MultimodalTransport2 {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the airCrrierNm property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     * @return
     *     The value of the airCrrierNm property.
     */
    public List<String> getAirCrrierNm() {
        if (airCrrierNm == null) {
            airCrrierNm = new ArrayList<>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the vsslNm property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     * @return
     *     The value of the vsslNm property.
     */
    public List<String> getVsslNm() {
        if (vsslNm == null) {
            vsslNm = new ArrayList<>();
        }
        return this.vsslNm;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the trnstLctn property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     * @return
     *     The value of the trnstLctn property.
     */
    public List<String> getTrnstLctn() {
        if (trnstLctn == null) {
            trnstLctn = new ArrayList<>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the roadCrrierNm property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     * @return
     *     The value of the roadCrrierNm property.
     */
    public List<String> getRoadCrrierNm() {
        if (roadCrrierNm == null) {
            roadCrrierNm = new ArrayList<>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the railCrrierNm property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     * @return
     *     The value of the railCrrierNm property.
     */
    public List<String> getRailCrrierNm() {
        if (railCrrierNm == null) {
            railCrrierNm = new ArrayList<>();
        }
