...
@XmlType(name = "TransportDetails3", propOrder = {
    "trnsprtDocRef",
    "trnsprtdGoods",
    "consgnmt",
    "rtgSummry",
...
public class TransportDetails3 {
    ...
    protected TransportMeans4 rtgSummry;
     ...
     *     
     */
    public TransportDetails3 setConsgnmt(Consignment3 value) {
        this.consgnmt = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link TransportMeans4 }
     *     
     */
    public TransportMeans4 getRtgSummry() {
        return rtgSummry;
    }
     ...
     *     
     */
    public TransportDetails3 setRtgSummry(TransportMeans4 value) {
     ...
     *     
     */
    public TransportDetails3 setShipmntDt(ShipmentDate1Choice value) {
     ...
     *     
     */
    public TransportDetails3 setFrghtChrgs(Charge25 value) {
     ...
     *     
     */
    public TransportDetails3 setIncotrms(Incoterms4 value) {
        this.incotrms = value;
        return this;
    }
     ...
     * 
     */
    public TransportDetails3 addTrnsprtDocRef(DocumentIdentification7 trnsprtDocRef) {
     ...
     * 
     */
    public TransportDetails3 addTrnsprtdGoods(TransportedGoods1 trnsprtdGoods) {
