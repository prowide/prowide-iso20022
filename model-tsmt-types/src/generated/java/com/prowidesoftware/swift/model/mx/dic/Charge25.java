...
@XmlType(name = "Charge25", propOrder = {
    "tp",
    "chrgs"
})
public class Charge25 {
    ...
    protected List<ChargesDetails4> chrgs;
     ...
     *     
     */
    public Charge25 setTp(FreightCharges1Code value) {
        this.tp = value;
        return this;
    }
     ...
     * 
     */
    public List<ChargesDetails4> getChrgs() {
        if (chrgs == null) {
            chrgs = new ArrayList<ChargesDetails4>();
        }
        return this.chrgs;
    }
     ...
     * 
     */
    public Charge25 addChrgs(ChargesDetails4 chrgs) {
        getChrgs().add(chrgs);
        return this;
    }
