...
@XmlType(name = "ActivityReportV03", propOrder = {
    "rptId",
    "rltdMsgRef",
    "rpt"
})
public class ActivityReportV03 {
     ...
     *     
     */
    public ActivityReportV03 setRptId(MessageIdentification1 value) {
        this.rptId = value;
        return this;
    }
     ...
     *     
     */
    public ActivityReportV03 setRltdMsgRef(MessageIdentification1 value) {
     ...
     * {@link ActivityReportItems2 }
     * 
     * 
     */
    public List<ActivityReportItems2> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<ActivityReportItems2>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public ActivityReportV03 addRpt(ActivityReportItems2 rpt) {
        getRpt().add(rpt);
        return this;
    }
