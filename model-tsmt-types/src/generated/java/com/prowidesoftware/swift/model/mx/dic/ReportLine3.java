...
@XmlType(name = "ReportLine3", propOrder = {
    "purchsOrdrRef",
    "adjstmnt",
    "netAmt"
})
public class ReportLine3 {
     ...
     *     
     */
    public ReportLine3 setPurchsOrdrRef(DocumentIdentification7 value) {
     ...
     *     
     */
    public ReportLine3 setNetAmt(CurrencyAndAmount value) {
        this.netAmt = value;
        return this;
    }
     ...
     * 
     */
    public ReportLine3 addAdjstmnt(Adjustment4 adjstmnt) {
