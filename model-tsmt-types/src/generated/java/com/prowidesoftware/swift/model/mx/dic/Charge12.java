...
@XmlType(name = "Charge12", propOrder = {
    "tp",
    "chrgs"
})
public class Charge12 {
    ...
    protected List<ChargesDetails1> chrgs;
     ...
     *     
     */
    public Charge12 setTp(FreightCharges1Code value) {
        this.tp = value;
        return this;
    }
     ...
     * {@link ChargesDetails1 }
     * 
     * 
     */
    public List<ChargesDetails1> getChrgs() {
        if (chrgs == null) {
            chrgs = new ArrayList<ChargesDetails1>();
        }
        return this.chrgs;
    }
     ...
     * 
     */
    public Charge12 addChrgs(ChargesDetails1 chrgs) {
        getChrgs().add(chrgs);
        return this;
    }
