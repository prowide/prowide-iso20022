...
@XmlType(name = "tsmt.036.001.02", propOrder = {
    "ntfctnId",
    "txId",
    "tsuBaselnId",
    "usrTxRef",
...
public class Tsmt03600102 {
     ...
     *     
     */
    public Tsmt03600102 setNtfctnId(MessageIdentification1 value) {
        this.ntfctnId = value;
        return this;
    }
     ...
     *     
     */
    public Tsmt03600102 setTxId(SimpleIdentificationInformation value) {
        this.txId = value;
        return this;
    }
     ...
     *     
     */
    public Tsmt03600102 setTSUBaselnId(DocumentIdentification3 value) {
     ...
     *     
     */
    public Tsmt03600102 setStsToBeXtnded(TransactionStatus1 value) {
     ...
     *     
     */
    public Tsmt03600102 setReqForActn(PendingActivity1 value) {
     ...
     * 
     */
    public Tsmt03600102 addUsrTxRef(DocumentIdentification5 usrTxRef) {
