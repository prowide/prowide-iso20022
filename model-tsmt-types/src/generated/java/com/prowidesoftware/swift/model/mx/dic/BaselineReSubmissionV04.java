...
@XmlType(name = "BaselineReSubmissionV04", propOrder = {
    "submissnId",
    "txId",
    "submitrTxRef",
    "baseln",
...
public class BaselineReSubmissionV04 {
     ...
     *     
     */
    public BaselineReSubmissionV04 setSubmissnId(MessageIdentification1 value) {
     ...
     *     
     */
    public BaselineReSubmissionV04 setTxId(SimpleIdentificationInformation value) {
        this.txId = value;
        return this;
    }
     ...
     *     
     */
    public BaselineReSubmissionV04 setSubmitrTxRef(SimpleIdentificationInformation value) {
     ...
     *     
     */
    public BaselineReSubmissionV04 setBaseln(Baseline4 value) {
        this.baseln = value;
        return this;
    }
     ...
     *     
     */
    public BaselineReSubmissionV04 setBkCtctPrsn(BankContactPerson1Choice value) {
     ...
     * 
     */
    public BaselineReSubmissionV04 addBuyrCtctPrsn(ContactIdentification1 buyrCtctPrsn) {
     ...
     * 
     */
    public BaselineReSubmissionV04 addSellrCtctPrsn(ContactIdentification1 sellrCtctPrsn) {
     ...
     * 
     */
    public BaselineReSubmissionV04 addOthrBkCtctPrsn(ContactIdentification3 othrBkCtctPrsn) {
