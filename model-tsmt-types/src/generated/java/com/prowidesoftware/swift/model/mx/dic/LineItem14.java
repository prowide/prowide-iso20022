...
public class LineItem14 {
    ...
    public List<LineItemDetails12> getLineItmDtls() {
        if (lineItmDtls == null) {
            lineItmDtls = new ArrayList<LineItemDetails12>();
        }
     ...
     *     
     */
    public LineItem14 setOrdrdLineItmsTtlAmt(CurrencyAndAmount value) {
     ...
     *     
     */
    public LineItem14 setAccptdLineItmsTtlAmt(CurrencyAndAmount value) {
     ...
     *     
     */
    public LineItem14 setOutsdngLineItmsTtlAmt(CurrencyAndAmount value) {
     ...
     *     
     */
    public LineItem14 setPdgLineItmsTtlAmt(CurrencyAndAmount value) {
     ...
     *     
     */
    public LineItem14 setOrdrdTtlNetAmt(CurrencyAndAmount value) {
     ...
     *     
     */
    public LineItem14 setAccptdTtlNetAmt(CurrencyAndAmount value) {
     ...
     *     
     */
    public LineItem14 setOutsdngTtlNetAmt(CurrencyAndAmount value) {
     ...
     *     
     */
    public LineItem14 setPdgTtlNetAmt(CurrencyAndAmount value) {
     ...
     * 
     */
    public LineItem14 addLineItmDtls(LineItemDetails12 lineItmDtls) {
