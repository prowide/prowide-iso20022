...
public class MisMatchReport3 {
     ...
     *     
     */
    public MisMatchReport3 setNbOfMisMtchs(BigDecimal value) {
    ...
    public List<ValidationResult5> getMisMtchInf() {
        if (misMtchInf == null) {
            misMtchInf = new ArrayList<ValidationResult5>();
        }
     ...
     * 
     */
    public MisMatchReport3 addMisMtchInf(ValidationResult5 misMtchInf) {
