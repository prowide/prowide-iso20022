...
@XmlType(name = "TransportByRoad3", propOrder = {
    "plcOfRct",
    "plcOfDlvry",
    "roadCrrierNm"
})
public class TransportByRoad3 {
     ...
     *     
     */
    public TransportByRoad3 setRoadCrrierNm(String value) {
     ...
     * 
     */
    public TransportByRoad3 addPlcOfRct(String plcOfRct) {
     ...
     * 
     */
    public TransportByRoad3 addPlcOfDlvry(String plcOfDlvry) {
