    ...
    extends AbstractMX
{
    ...
    public static MxTsin01000101 parse(String xml) {
        return ((MxTsin01000101) MxReadImpl.parse(MxTsin01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsin01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsin01000101) MxReadImpl.parse(MxTsin01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
