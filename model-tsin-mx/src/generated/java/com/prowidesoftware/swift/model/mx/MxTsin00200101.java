    ...
    extends AbstractMX
{
    ...
    public static MxTsin00200101 parse(String xml) {
        return ((MxTsin00200101) MxReadImpl.parse(MxTsin00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsin00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsin00200101) MxReadImpl.parse(MxTsin00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsin00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsin00200101 .class);
    }
