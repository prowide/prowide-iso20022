    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsin.005.001.01";
    ...
    public static MxTsin00500101 parse(String xml) {
        return ((MxTsin00500101) MxReadImpl.parse(MxTsin00500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsin00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsin00500101) MxReadImpl.parse(MxTsin00500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsin00500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsin00500101 .class);
    }
