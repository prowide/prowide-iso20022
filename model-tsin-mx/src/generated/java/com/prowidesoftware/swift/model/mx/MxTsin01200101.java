    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsin.012.001.01";
    ...
    public static MxTsin01200101 parse(String xml) {
        return ((MxTsin01200101) MxReadImpl.parse(MxTsin01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsin01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsin01200101) MxReadImpl.parse(MxTsin01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsin01200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsin01200101 .class);
    }
