    ...
    extends AbstractMX
{
    ...
    public static MxTsin00900101 parse(String xml) {
        return ((MxTsin00900101) MxReadImpl.parse(MxTsin00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsin00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsin00900101) MxReadImpl.parse(MxTsin00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
