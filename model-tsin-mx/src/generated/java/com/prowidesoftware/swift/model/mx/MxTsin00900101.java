    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsin.009.001.01";
    ...
    public static MxTsin00900101 parse(String xml) {
        return ((MxTsin00900101) MxReadImpl.parse(MxTsin00900101 .class, xml, _classes));
    }
     ...
     */
    public final static MxTsin00900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsin00900101 .class);
    }
