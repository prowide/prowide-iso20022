    ...
    extends AbstractMX
{
    ...
    public static MxTsin00100101 parse(String xml) {
        return ((MxTsin00100101) MxReadImpl.parse(MxTsin00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsin00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsin00100101) MxReadImpl.parse(MxTsin00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsin00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsin00100101 .class);
    }
