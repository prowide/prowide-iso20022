    ...
    extends AbstractMX
{
    ...
    public static MxTsin00700101 parse(String xml) {
        return ((MxTsin00700101) MxReadImpl.parse(MxTsin00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsin00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsin00700101) MxReadImpl.parse(MxTsin00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
