    ...
    extends AbstractMX
{
    ...
    public static MxTsin00300101 parse(String xml) {
        return ((MxTsin00300101) MxReadImpl.parse(MxTsin00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsin00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsin00300101) MxReadImpl.parse(MxTsin00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsin00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsin00300101 .class);
    }
