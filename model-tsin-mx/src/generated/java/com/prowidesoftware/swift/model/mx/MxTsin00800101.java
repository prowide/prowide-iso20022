    ...
    extends AbstractMX
{
    ...
    public static MxTsin00800101 parse(String xml) {
        return ((MxTsin00800101) MxReadImpl.parse(MxTsin00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsin00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsin00800101) MxReadImpl.parse(MxTsin00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsin00800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsin00800101 .class);
    }
