    ...
    extends AbstractMX
{
    ...
    public static MxTsin01100101 parse(String xml) {
        return ((MxTsin01100101) MxReadImpl.parse(MxTsin01100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsin01100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsin01100101) MxReadImpl.parse(MxTsin01100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsin01100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsin01100101 .class);
    }
