    ...
    extends AbstractMX
{
    ...
    public static MxTsin01300101 parse(String xml) {
        return ((MxTsin01300101) MxReadImpl.parse(MxTsin01300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsin01300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsin01300101) MxReadImpl.parse(MxTsin01300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsin01300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsin01300101 .class);
    }
