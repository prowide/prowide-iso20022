...
public class MessageDetails1 {
     ...
     * This is why there is not a {@code set} method for the sntNtry property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the sntNtry property.
     */
    public List<CBRFReportEntry1> getSntNtry() {
        if (sntNtry == null) {
            sntNtry = new ArrayList<>();
        }
        return this.sntNtry;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the rcvdNtry property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     * @return
     *     The value of the rcvdNtry property.
     */
    public List<CBRFReportEntry1> getRcvdNtry() {
        if (rcvdNtry == null) {
            rcvdNtry = new ArrayList<>();
        }
