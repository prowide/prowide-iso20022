    ...
    extends AbstractMX
{
    ...
    public static MxAuth02400101 parse(String xml) {
        return ((MxAuth02400101) MxReadImpl.parse(MxAuth02400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02400101) MxReadImpl.parse(MxAuth02400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth02400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02400101 .class);
    }
