    ...
    extends AbstractMX
{
    ...
    public static MxAuth08500102 parse(String xml) {
        return ((MxAuth08500102) MxReadImpl.parse(MxAuth08500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth08500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth08500102) MxReadImpl.parse(MxAuth08500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth08500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth08500102 .class);
    }
