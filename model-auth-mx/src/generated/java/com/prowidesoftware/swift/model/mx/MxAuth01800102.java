    ...
    extends AbstractMX
{
    ...
    public static MxAuth01800102 parse(String xml) {
        return ((MxAuth01800102) MxReadImpl.parse(MxAuth01800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01800102) MxReadImpl.parse(MxAuth01800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth01800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth01800102 .class);
    }
