    ...
    extends AbstractMX
{
    ...
    public static MxAuth06500101 parse(String xml) {
        return ((MxAuth06500101) MxReadImpl.parse(MxAuth06500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth06500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth06500101) MxReadImpl.parse(MxAuth06500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth06500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth06500101 .class);
    }
