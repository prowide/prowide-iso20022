    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.024.001.03";
    ...
    public static MxAuth02400103 parse(String xml) {
        return ((MxAuth02400103) MxReadImpl.parse(MxAuth02400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02400103) MxReadImpl.parse(MxAuth02400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth02400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02400103 .class);
    }
