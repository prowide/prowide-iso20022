    ...
    extends AbstractMX
{
    ...
    public static MxAuth05300101 parse(String xml) {
        return ((MxAuth05300101) MxReadImpl.parse(MxAuth05300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth05300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth05300101) MxReadImpl.parse(MxAuth05300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth05300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth05300101 .class);
    }
