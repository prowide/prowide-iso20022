    ...
    extends AbstractMX
{
    ...
    public static MxAuth02700104 parse(String xml) {
        return ((MxAuth02700104) MxReadImpl.parse(MxAuth02700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02700104) MxReadImpl.parse(MxAuth02700104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth02700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02700104 .class);
    }
