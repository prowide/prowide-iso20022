    ...
    extends AbstractMX
{
    ...
    public static MxAuth06700101 parse(String xml) {
        return ((MxAuth06700101) MxReadImpl.parse(MxAuth06700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth06700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth06700101) MxReadImpl.parse(MxAuth06700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth06700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth06700101 .class);
    }
