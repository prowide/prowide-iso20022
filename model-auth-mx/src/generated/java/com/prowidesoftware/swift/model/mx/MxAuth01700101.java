    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.017.001.01";
    ...
    public static MxAuth01700101 parse(String xml) {
        return ((MxAuth01700101) MxReadImpl.parse(MxAuth01700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01700101) MxReadImpl.parse(MxAuth01700101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth01700101 fromJson(String json) {
