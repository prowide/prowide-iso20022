    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.029.001.01";
    ...
    public static MxAuth02900101 parse(String xml) {
        return ((MxAuth02900101) MxReadImpl.parse(MxAuth02900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02900101) MxReadImpl.parse(MxAuth02900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth02900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02900101 .class);
    }
