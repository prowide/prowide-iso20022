    ...
    extends AbstractMX
{
    ...
    public static MxAuth07200101 parse(String xml) {
        return ((MxAuth07200101) MxReadImpl.parse(MxAuth07200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth07200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth07200101) MxReadImpl.parse(MxAuth07200101 .class, xml, _classes, new MxReadParams(conf)));
    }
