    ...
    extends AbstractMX
{
    ...
    public static MxAuth03000101 parse(String xml) {
        return ((MxAuth03000101) MxReadImpl.parse(MxAuth03000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth03000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth03000101) MxReadImpl.parse(MxAuth03000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth03000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth03000101 .class);
    }
