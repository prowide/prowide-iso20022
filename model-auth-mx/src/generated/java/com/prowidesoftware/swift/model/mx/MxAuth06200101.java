    ...
    extends AbstractMX
{
    ...
    public static MxAuth06200101 parse(String xml) {
        return ((MxAuth06200101) MxReadImpl.parse(MxAuth06200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth06200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth06200101) MxReadImpl.parse(MxAuth06200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth06200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth06200101 .class);
    }
