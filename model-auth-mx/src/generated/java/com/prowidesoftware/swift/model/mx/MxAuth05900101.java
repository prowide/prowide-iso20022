    ...
    extends AbstractMX
{
    ...
    public static MxAuth05900101 parse(String xml) {
        return ((MxAuth05900101) MxReadImpl.parse(MxAuth05900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth05900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth05900101) MxReadImpl.parse(MxAuth05900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth05900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth05900101 .class);
    }
