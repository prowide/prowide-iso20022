    ...
    extends AbstractMX
{
    ...
    public static MxAuth08600102 parse(String xml) {
        return ((MxAuth08600102) MxReadImpl.parse(MxAuth08600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth08600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth08600102) MxReadImpl.parse(MxAuth08600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth08600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth08600102 .class);
    }
