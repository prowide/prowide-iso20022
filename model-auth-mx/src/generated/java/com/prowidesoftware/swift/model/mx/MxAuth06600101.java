    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {ActiveCurrencyAndAmount.class, CCPBackTestingResultReportV01 .class, GenericIdentification165 .class, MonthlyResult1 .class, MxAuth06600101 .class, SchemeIdentificationType1Code.class, SupplementaryData1 .class, SupplementaryDataEnvelope1 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.066.001.01";
    ...
    public static MxAuth06600101 parse(String xml) {
        return ((MxAuth06600101) MxReadImpl.parse(MxAuth06600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth06600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth06600101) MxReadImpl.parse(MxAuth06600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth06600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth06600101 .class);
    }
