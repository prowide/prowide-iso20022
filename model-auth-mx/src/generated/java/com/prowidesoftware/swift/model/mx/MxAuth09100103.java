    ...
    extends AbstractMX
{
    ...
    public static MxAuth09100103 parse(String xml) {
        return ((MxAuth09100103) MxReadImpl.parse(MxAuth09100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth09100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth09100103) MxReadImpl.parse(MxAuth09100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth09100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth09100103 .class);
    }
