    ...
    extends AbstractMX
{
    ...
    public static MxAuth05400101 parse(String xml) {
        return ((MxAuth05400101) MxReadImpl.parse(MxAuth05400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth05400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth05400101) MxReadImpl.parse(MxAuth05400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth05400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth05400101 .class);
    }
