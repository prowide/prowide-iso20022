    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.058.001.01";
    ...
    public static MxAuth05800101 parse(String xml) {
        return ((MxAuth05800101) MxReadImpl.parse(MxAuth05800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth05800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth05800101) MxReadImpl.parse(MxAuth05800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth05800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth05800101 .class);
    }
