    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.070.001.02";
    ...
    public static MxAuth07000102 parse(String xml) {
        return ((MxAuth07000102) MxReadImpl.parse(MxAuth07000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth07000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth07000102) MxReadImpl.parse(MxAuth07000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth07000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth07000102 .class);
    }
