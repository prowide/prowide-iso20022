    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.022.001.01";
    ...
    public static MxAuth02200101 parse(String xml) {
        return ((MxAuth02200101) MxReadImpl.parse(MxAuth02200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02200101) MxReadImpl.parse(MxAuth02200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth02200101 fromJson(String json) {
