    ...
    extends AbstractMX
{
    ...
    public static MxAuth00100101 parse(String xml) {
        return ((MxAuth00100101) MxReadImpl.parse(MxAuth00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth00100101) MxReadImpl.parse(MxAuth00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
