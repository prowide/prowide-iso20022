    ...
    extends AbstractMX
{
    ...
    public static MxAuth01300101 parse(String xml) {
        return ((MxAuth01300101) MxReadImpl.parse(MxAuth01300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01300101) MxReadImpl.parse(MxAuth01300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth01300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth01300101 .class);
    }
