    ...
    extends AbstractMX
{
    ...
    public static MxAuth01900104 parse(String xml) {
        return ((MxAuth01900104) MxReadImpl.parse(MxAuth01900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01900104) MxReadImpl.parse(MxAuth01900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth01900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth01900104 .class);
    }
