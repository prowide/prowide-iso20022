    ...
    extends AbstractMX
{
    ...
    public static MxAuth02500101 parse(String xml) {
        return ((MxAuth02500101) MxReadImpl.parse(MxAuth02500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02500101) MxReadImpl.parse(MxAuth02500101 .class, xml, _classes, new MxReadParams(conf)));
    }
