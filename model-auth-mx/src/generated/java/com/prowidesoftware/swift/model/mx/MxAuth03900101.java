    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.039.001.01";
    ...
    public static MxAuth03900101 parse(String xml) {
        return ((MxAuth03900101) MxReadImpl.parse(MxAuth03900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth03900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth03900101) MxReadImpl.parse(MxAuth03900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth03900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth03900101 .class);
    }
