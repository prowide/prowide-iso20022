    ...
    extends AbstractMX
{
    ...
    public static MxAuth02900104 parse(String xml) {
        return ((MxAuth02900104) MxReadImpl.parse(MxAuth02900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02900104) MxReadImpl.parse(MxAuth02900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth02900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02900104 .class);
    }
