    ...
    extends AbstractMX
{
    ...
    public static MxAuth04500102 parse(String xml) {
        return ((MxAuth04500102) MxReadImpl.parse(MxAuth04500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth04500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth04500102) MxReadImpl.parse(MxAuth04500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth04500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth04500102 .class);
    }
