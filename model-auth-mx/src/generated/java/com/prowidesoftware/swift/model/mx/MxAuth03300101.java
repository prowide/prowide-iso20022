    ...
    extends AbstractMX
{
    ...
    public static MxAuth03300101 parse(String xml) {
        return ((MxAuth03300101) MxReadImpl.parse(MxAuth03300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth03300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth03300101) MxReadImpl.parse(MxAuth03300101 .class, xml, _classes, new MxReadParams(conf)));
    }
