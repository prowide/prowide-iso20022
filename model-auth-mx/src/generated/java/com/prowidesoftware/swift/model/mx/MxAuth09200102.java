    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.092.001.02";
    ...
    public static MxAuth09200102 parse(String xml) {
        return ((MxAuth09200102) MxReadImpl.parse(MxAuth09200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth09200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth09200102) MxReadImpl.parse(MxAuth09200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth09200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth09200102 .class);
    }
