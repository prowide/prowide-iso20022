    ...
    extends AbstractMX
{
    ...
    public static MxAuth01400101 parse(String xml) {
        return ((MxAuth01400101) MxReadImpl.parse(MxAuth01400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01400101) MxReadImpl.parse(MxAuth01400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth01400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth01400101 .class);
    }
