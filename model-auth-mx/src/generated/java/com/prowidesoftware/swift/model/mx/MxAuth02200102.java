    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.022.001.02";
    ...
    public static MxAuth02200102 parse(String xml) {
        return ((MxAuth02200102) MxReadImpl.parse(MxAuth02200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02200102) MxReadImpl.parse(MxAuth02200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth02200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02200102 .class);
    }
