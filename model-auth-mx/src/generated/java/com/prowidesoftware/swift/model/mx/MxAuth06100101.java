    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.061.001.01";
    ...
    public static MxAuth06100101 parse(String xml) {
        return ((MxAuth06100101) MxReadImpl.parse(MxAuth06100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth06100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth06100101) MxReadImpl.parse(MxAuth06100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth06100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth06100101 .class);
    }
