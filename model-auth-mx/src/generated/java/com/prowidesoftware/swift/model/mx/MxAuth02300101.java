    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.023.001.01";
    ...
    public static MxAuth02300101 parse(String xml) {
        return ((MxAuth02300101) MxReadImpl.parse(MxAuth02300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02300101) MxReadImpl.parse(MxAuth02300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth02300101 fromJson(String json) {
