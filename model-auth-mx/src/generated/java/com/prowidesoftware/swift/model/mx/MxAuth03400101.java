    ...
    extends AbstractMX
{
    ...
    public static MxAuth03400101 parse(String xml) {
        return ((MxAuth03400101) MxReadImpl.parse(MxAuth03400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth03400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth03400101) MxReadImpl.parse(MxAuth03400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth03400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth03400101 .class);
    }
