    ...
    extends AbstractMX
{
    ...
    public static MxAuth08600101 parse(String xml) {
        return ((MxAuth08600101) MxReadImpl.parse(MxAuth08600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth08600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth08600101) MxReadImpl.parse(MxAuth08600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth08600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth08600101 .class);
    }
