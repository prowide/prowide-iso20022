    ...
    extends AbstractMX
{
    ...
    public static MxAuth02700101 parse(String xml) {
        return ((MxAuth02700101) MxReadImpl.parse(MxAuth02700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02700101) MxReadImpl.parse(MxAuth02700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth02700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02700101 .class);
    }
