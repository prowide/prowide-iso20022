    ...
    extends AbstractMX
{
    ...
    public static MxAuth07700101 parse(String xml) {
        return ((MxAuth07700101) MxReadImpl.parse(MxAuth07700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth07700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth07700101) MxReadImpl.parse(MxAuth07700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth07700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth07700101 .class);
    }
