    ...
    extends AbstractMX
{
    ...
    public static MxAuth02300102 parse(String xml) {
        return ((MxAuth02300102) MxReadImpl.parse(MxAuth02300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02300102) MxReadImpl.parse(MxAuth02300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth02300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02300102 .class);
    }
