    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.078.001.02";
    ...
    public static MxAuth07800102 parse(String xml) {
        return ((MxAuth07800102) MxReadImpl.parse(MxAuth07800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth07800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth07800102) MxReadImpl.parse(MxAuth07800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth07800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth07800102 .class);
    }
