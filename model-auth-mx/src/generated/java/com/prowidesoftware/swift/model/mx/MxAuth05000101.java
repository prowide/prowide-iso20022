    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.050.001.01";
    ...
    public static MxAuth05000101 parse(String xml) {
        return ((MxAuth05000101) MxReadImpl.parse(MxAuth05000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth05000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth05000101) MxReadImpl.parse(MxAuth05000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth05000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth05000101 .class);
    }
