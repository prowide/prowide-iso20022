    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.078.001.01";
    ...
    public static MxAuth07800101 parse(String xml) {
        return ((MxAuth07800101) MxReadImpl.parse(MxAuth07800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth07800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth07800101) MxReadImpl.parse(MxAuth07800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth07800101 fromJson(String json) {
