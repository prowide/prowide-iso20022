    ...
    extends AbstractMX
{
    ...
    public static MxAuth04200102 parse(String xml) {
        return ((MxAuth04200102) MxReadImpl.parse(MxAuth04200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth04200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth04200102) MxReadImpl.parse(MxAuth04200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth04200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth04200102 .class);
    }
