    ...
    extends AbstractMX
{
    ...
    public static MxAuth04400102 parse(String xml) {
        return ((MxAuth04400102) MxReadImpl.parse(MxAuth04400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth04400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth04400102) MxReadImpl.parse(MxAuth04400102 .class, xml, _classes, new MxReadParams(conf)));
    }
