    ...
    extends AbstractMX
{
    ...
    public static MxAuth08000102 parse(String xml) {
        return ((MxAuth08000102) MxReadImpl.parse(MxAuth08000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth08000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth08000102) MxReadImpl.parse(MxAuth08000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth08000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth08000102 .class);
    }
