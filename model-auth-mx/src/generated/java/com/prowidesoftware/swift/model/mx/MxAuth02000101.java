    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.020.001.01";
    ...
    public static MxAuth02000101 parse(String xml) {
        return ((MxAuth02000101) MxReadImpl.parse(MxAuth02000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02000101) MxReadImpl.parse(MxAuth02000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth02000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02000101 .class);
    }
