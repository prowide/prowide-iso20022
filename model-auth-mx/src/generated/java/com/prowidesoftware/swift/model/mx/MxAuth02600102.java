    ...
    extends AbstractMX
{
    ...
    public static MxAuth02600102 parse(String xml) {
        return ((MxAuth02600102) MxReadImpl.parse(MxAuth02600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02600102) MxReadImpl.parse(MxAuth02600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth02600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02600102 .class);
    }
