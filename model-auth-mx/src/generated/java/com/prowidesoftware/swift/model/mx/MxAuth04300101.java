    ...
    extends AbstractMX
{
    ...
    public static MxAuth04300101 parse(String xml) {
        return ((MxAuth04300101) MxReadImpl.parse(MxAuth04300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth04300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth04300101) MxReadImpl.parse(MxAuth04300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth04300101 fromJson(String json) {
