    ...
    extends AbstractMX
{
    ...
    public static MxAuth05200101 parse(String xml) {
        return ((MxAuth05200101) MxReadImpl.parse(MxAuth05200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth05200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth05200101) MxReadImpl.parse(MxAuth05200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth05200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth05200101 .class);
    }
