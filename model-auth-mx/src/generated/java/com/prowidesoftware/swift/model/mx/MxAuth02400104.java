    ...
    extends AbstractMX
{
    ...
    public static MxAuth02400104 parse(String xml) {
        return ((MxAuth02400104) MxReadImpl.parse(MxAuth02400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02400104) MxReadImpl.parse(MxAuth02400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth02400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02400104 .class);
    }
