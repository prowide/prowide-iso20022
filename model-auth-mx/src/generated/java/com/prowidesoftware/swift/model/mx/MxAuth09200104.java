    ...
    extends AbstractMX
{
    ...
    public static MxAuth09200104 parse(String xml) {
        return ((MxAuth09200104) MxReadImpl.parse(MxAuth09200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth09200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth09200104) MxReadImpl.parse(MxAuth09200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth09200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth09200104 .class);
    }
