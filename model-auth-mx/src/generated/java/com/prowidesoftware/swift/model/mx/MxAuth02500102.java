    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.025.001.02";
    ...
    public static MxAuth02500102 parse(String xml) {
        return ((MxAuth02500102) MxReadImpl.parse(MxAuth02500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02500102) MxReadImpl.parse(MxAuth02500102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth02500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02500102 .class);
    }
