    ...
    extends AbstractMX
{
    ...
    public static MxAuth02100102 parse(String xml) {
        return ((MxAuth02100102) MxReadImpl.parse(MxAuth02100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02100102) MxReadImpl.parse(MxAuth02100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth02100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02100102 .class);
    }
