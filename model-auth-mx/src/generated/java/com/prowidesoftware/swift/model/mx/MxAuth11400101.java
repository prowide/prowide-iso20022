    ...
    extends AbstractMX
{
    ...
    public static MxAuth11400101 parse(String xml) {
        return ((MxAuth11400101) MxReadImpl.parse(MxAuth11400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth11400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth11400101) MxReadImpl.parse(MxAuth11400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth11400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth11400101 .class);
    }
