    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.083.001.02";
    ...
    public static MxAuth08300102 parse(String xml) {
        return ((MxAuth08300102) MxReadImpl.parse(MxAuth08300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth08300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth08300102) MxReadImpl.parse(MxAuth08300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth08300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth08300102 .class);
    }
