    ...
    extends AbstractMX
{
    ...
    public static MxAuth02300104 parse(String xml) {
        return ((MxAuth02300104) MxReadImpl.parse(MxAuth02300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02300104) MxReadImpl.parse(MxAuth02300104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth02300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02300104 .class);
    }
