    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.048.001.01";
    ...
    public static MxAuth04800101 parse(String xml) {
        return ((MxAuth04800101) MxReadImpl.parse(MxAuth04800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth04800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth04800101) MxReadImpl.parse(MxAuth04800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth04800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth04800101 .class);
    }
