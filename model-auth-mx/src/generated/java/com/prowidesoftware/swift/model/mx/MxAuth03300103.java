    ...
    extends AbstractMX
{
    ...
    public static MxAuth03300103 parse(String xml) {
        return ((MxAuth03300103) MxReadImpl.parse(MxAuth03300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth03300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth03300103) MxReadImpl.parse(MxAuth03300103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth03300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth03300103 .class);
    }
