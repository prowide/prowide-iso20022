    ...
    extends AbstractMX
{
    ...
    public static MxAuth00100102 parse(String xml) {
        return ((MxAuth00100102) MxReadImpl.parse(MxAuth00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth00100102) MxReadImpl.parse(MxAuth00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth00100102 .class);
    }
