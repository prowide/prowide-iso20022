    ...
    extends AbstractMX
{
    ...
    public static MxAuth06900101 parse(String xml) {
        return ((MxAuth06900101) MxReadImpl.parse(MxAuth06900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth06900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth06900101) MxReadImpl.parse(MxAuth06900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth06900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth06900101 .class);
    }
