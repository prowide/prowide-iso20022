    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.018.001.01";
    ...
    public static MxAuth01800101 parse(String xml) {
        return ((MxAuth01800101) MxReadImpl.parse(MxAuth01800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01800101) MxReadImpl.parse(MxAuth01800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth01800101 fromJson(String json) {
