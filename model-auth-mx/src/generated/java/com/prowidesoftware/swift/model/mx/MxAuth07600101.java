    ...
    extends AbstractMX
{
    ...
    public static MxAuth07600101 parse(String xml) {
        return ((MxAuth07600101) MxReadImpl.parse(MxAuth07600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth07600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth07600101) MxReadImpl.parse(MxAuth07600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth07600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth07600101 .class);
    }
