    ...
    extends AbstractMX
{
    ...
    public static MxAuth03300102 parse(String xml) {
        return ((MxAuth03300102) MxReadImpl.parse(MxAuth03300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth03300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth03300102) MxReadImpl.parse(MxAuth03300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth03300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth03300102 .class);
    }
