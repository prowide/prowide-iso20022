    ...
    extends AbstractMX
{
    ...
    public static MxAuth10700101 parse(String xml) {
        return ((MxAuth10700101) MxReadImpl.parse(MxAuth10700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth10700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth10700101) MxReadImpl.parse(MxAuth10700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth10700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth10700101 .class);
    }
