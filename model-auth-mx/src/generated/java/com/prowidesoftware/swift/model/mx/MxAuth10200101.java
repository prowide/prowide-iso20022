    ...
    extends AbstractMX
{
    ...
    public static MxAuth10200101 parse(String xml) {
        return ((MxAuth10200101) MxReadImpl.parse(MxAuth10200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth10200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth10200101) MxReadImpl.parse(MxAuth10200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth10200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth10200101 .class);
    }
