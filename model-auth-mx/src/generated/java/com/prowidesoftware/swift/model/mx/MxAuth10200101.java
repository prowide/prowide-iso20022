...
/**
 * Class for auth.102.001.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxAuth10200101(final String xml) {
        this();
        MxAuth10200101 tmp = parse(xml);
        finInstrmRptgCxlRpt = tmp.getFinInstrmRptgCxlRpt();
    }
     ...
     * 
     */
    public MxAuth10200101(final MxSwiftMessage mxSwiftMessage) {
        this(mxSwiftMessage.message());
    }

    /**
     * Gets the value of the finInstrmRptgCxlRpt property.
     * 
     * @return
     *     possible object is
     *     {@link FinancialInstrumentReportingCancellationReportV01 }
     *     
     */
    public FinancialInstrumentReportingCancellationReportV01 getFinInstrmRptgCxlRpt() {
        return finInstrmRptgCxlRpt;
    }

    /**
     * Sets the value of the finInstrmRptgCxlRpt property.
     * 
     * @param value
     *     allowed object is
     *     {@link FinancialInstrumentReportingCancellationReportV01 }
     *     
     */
    public MxAuth10200101 setFinInstrmRptgCxlRpt(FinancialInstrumentReportingCancellationReportV01 value) {
        this.finInstrmRptgCxlRpt = value;
        return this;
    }
     ...
     * 
     */
    public static MxAuth10200101 parse(String xml) {
        return ((MxAuth10200101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxAuth10200101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxAuth10200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth10200101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxAuth10200101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxAuth10200101 parse(String xml, MxRead parserImpl) {
        return ((MxAuth10200101) parserImpl.read(MxAuth10200101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxAuth10200101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxAuth10200101 message
     * @return
     *     a new instance of MxAuth10200101
     */
    public final static MxAuth10200101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxAuth10200101 .class);
    }
