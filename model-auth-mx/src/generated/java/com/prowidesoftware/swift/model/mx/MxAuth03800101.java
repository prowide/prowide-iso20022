    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.038.001.01";
    ...
    public static MxAuth03800101 parse(String xml) {
        return ((MxAuth03800101) MxReadImpl.parse(MxAuth03800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth03800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth03800101) MxReadImpl.parse(MxAuth03800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth03800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth03800101 .class);
    }
