    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.008.001.02";
    ...
    public static MxAuth00800102 parse(String xml) {
        return ((MxAuth00800102) MxReadImpl.parse(MxAuth00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth00800102) MxReadImpl.parse(MxAuth00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth00800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth00800102 .class);
    }
