    ...
    extends AbstractMX
{
    ...
    public static MxAuth07100102 parse(String xml) {
        return ((MxAuth07100102) MxReadImpl.parse(MxAuth07100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth07100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth07100102) MxReadImpl.parse(MxAuth07100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth07100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth07100102 .class);
    }
