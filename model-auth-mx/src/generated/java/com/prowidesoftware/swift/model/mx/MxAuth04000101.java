    ...
    extends AbstractMX
{
    ...
    public static MxAuth04000101 parse(String xml) {
        return ((MxAuth04000101) MxReadImpl.parse(MxAuth04000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth04000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth04000101) MxReadImpl.parse(MxAuth04000101 .class, xml, _classes, new MxReadParams(conf)));
    }
