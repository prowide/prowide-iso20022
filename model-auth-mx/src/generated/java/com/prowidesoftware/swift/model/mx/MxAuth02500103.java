    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.025.001.03";
    ...
    public static MxAuth02500103 parse(String xml) {
        return ((MxAuth02500103) MxReadImpl.parse(MxAuth02500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02500103) MxReadImpl.parse(MxAuth02500103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth02500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02500103 .class);
    }
