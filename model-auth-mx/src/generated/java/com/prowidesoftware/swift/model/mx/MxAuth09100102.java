    ...
    extends AbstractMX
{
    ...
    public static MxAuth09100102 parse(String xml) {
        return ((MxAuth09100102) MxReadImpl.parse(MxAuth09100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth09100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth09100102) MxReadImpl.parse(MxAuth09100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth09100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth09100102 .class);
    }
