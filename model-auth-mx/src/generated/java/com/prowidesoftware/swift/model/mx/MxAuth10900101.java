    ...
    extends AbstractMX
{
    ...
    public static MxAuth10900101 parse(String xml) {
        return ((MxAuth10900101) MxReadImpl.parse(MxAuth10900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth10900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth10900101) MxReadImpl.parse(MxAuth10900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth10900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth10900101 .class);
    }
