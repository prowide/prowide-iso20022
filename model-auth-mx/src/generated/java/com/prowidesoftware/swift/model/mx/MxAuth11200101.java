    ...
    extends AbstractMX
{
    ...
    public static final transient int FUNCTIONALITY = 112;
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.112.001.01";
    ...
    public static MxAuth11200101 parse(String xml) {
        return ((MxAuth11200101) MxReadImpl.parse(MxAuth11200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth11200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth11200101) MxReadImpl.parse(MxAuth11200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth11200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth11200101 .class);
    }
