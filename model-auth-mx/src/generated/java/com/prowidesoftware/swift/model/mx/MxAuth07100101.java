    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.071.001.01";
    ...
    public static MxAuth07100101 parse(String xml) {
        return ((MxAuth07100101) MxReadImpl.parse(MxAuth07100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth07100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth07100101) MxReadImpl.parse(MxAuth07100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth07100101 fromJson(String json) {
