    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.080.001.01";
    ...
    public static MxAuth08000101 parse(String xml) {
        return ((MxAuth08000101) MxReadImpl.parse(MxAuth08000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth08000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth08000101) MxReadImpl.parse(MxAuth08000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth08000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth08000101 .class);
    }
