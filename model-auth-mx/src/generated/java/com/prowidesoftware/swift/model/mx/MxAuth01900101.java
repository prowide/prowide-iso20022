    ...
    extends AbstractMX
{
    ...
    public static MxAuth01900101 parse(String xml) {
        return ((MxAuth01900101) MxReadImpl.parse(MxAuth01900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01900101) MxReadImpl.parse(MxAuth01900101 .class, xml, _classes, new MxReadParams(conf)));
    }
