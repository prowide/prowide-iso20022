    ...
    extends AbstractMX
{
    ...
    public static MxAuth01500101 parse(String xml) {
        return ((MxAuth01500101) MxReadImpl.parse(MxAuth01500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01500101) MxReadImpl.parse(MxAuth01500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth01500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth01500101 .class);
    }
