    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.036.001.03";
    ...
    public static MxAuth03600103 parse(String xml) {
        return ((MxAuth03600103) MxReadImpl.parse(MxAuth03600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth03600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth03600103) MxReadImpl.parse(MxAuth03600103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth03600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth03600103 .class);
    }
