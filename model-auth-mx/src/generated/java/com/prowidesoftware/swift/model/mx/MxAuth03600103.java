...
/**
 * Class for auth.036.001.03 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:auth.036.001.03")
public class MxAuth03600103
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxAuth03600103(final String xml) {
        this();
        MxAuth03600103 tmp = parse(xml);
     ...
     * 
     */
    public MxAuth03600103(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxAuth03600103 setFinInstrmRptgRefDataDltaRpt(FinancialInstrumentReportingReferenceDataDeltaReportV03 value) {
     ...
     * 
     */
    public static MxAuth03600103 parse(String xml) {
        return ((MxAuth03600103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxAuth03600103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxAuth03600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth03600103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxAuth03600103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxAuth03600103 parse(String xml, MxRead parserImpl) {
        return ((MxAuth03600103) parserImpl.read(MxAuth03600103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxAuth03600103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxAuth03600103 message
     * @return
     *     a new instance of MxAuth03600103
     */
    public final static MxAuth03600103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxAuth03600103 .class);
    }
