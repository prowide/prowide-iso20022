    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.026.001.04";
    ...
    public static MxAuth02600104 parse(String xml) {
        return ((MxAuth02600104) MxReadImpl.parse(MxAuth02600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02600104) MxReadImpl.parse(MxAuth02600104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth02600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02600104 .class);
    }
