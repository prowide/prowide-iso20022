    ...
    extends AbstractMX
{
    ...
    public static MxAuth03000103 parse(String xml) {
        return ((MxAuth03000103) MxReadImpl.parse(MxAuth03000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth03000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth03000103) MxReadImpl.parse(MxAuth03000103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth03000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth03000103 .class);
    }
