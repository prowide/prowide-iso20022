    ...
    extends AbstractMX
{
    ...
    public static MxAuth01500102 parse(String xml) {
        return ((MxAuth01500102) MxReadImpl.parse(MxAuth01500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01500102) MxReadImpl.parse(MxAuth01500102 .class, xml, _classes, new MxReadParams(conf)));
    }
