    ...
    extends AbstractMX
{
    ...
    public static MxAuth02900102 parse(String xml) {
        return ((MxAuth02900102) MxReadImpl.parse(MxAuth02900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02900102) MxReadImpl.parse(MxAuth02900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth02900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02900102 .class);
    }
