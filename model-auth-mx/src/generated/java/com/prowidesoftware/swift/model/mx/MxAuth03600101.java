    ...
    extends AbstractMX
{
    ...
    public static MxAuth03600101 parse(String xml) {
        return ((MxAuth03600101) MxReadImpl.parse(MxAuth03600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth03600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth03600101) MxReadImpl.parse(MxAuth03600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth03600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth03600101 .class);
    }
