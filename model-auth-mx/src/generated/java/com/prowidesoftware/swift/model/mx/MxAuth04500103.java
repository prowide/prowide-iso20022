    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.045.001.03";
    ...
    public static MxAuth04500103 parse(String xml) {
        return ((MxAuth04500103) MxReadImpl.parse(MxAuth04500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth04500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth04500103) MxReadImpl.parse(MxAuth04500103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth04500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth04500103 .class);
    }
