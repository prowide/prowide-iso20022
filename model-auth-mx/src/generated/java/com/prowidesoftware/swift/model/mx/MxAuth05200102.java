    ...
    extends AbstractMX
{
    ...
    public static MxAuth05200102 parse(String xml) {
        return ((MxAuth05200102) MxReadImpl.parse(MxAuth05200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth05200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth05200102) MxReadImpl.parse(MxAuth05200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth05200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth05200102 .class);
    }
