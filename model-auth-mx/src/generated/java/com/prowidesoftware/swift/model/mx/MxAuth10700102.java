    ...
    extends AbstractMX
{
    ...
    public static MxAuth10700102 parse(String xml) {
        return ((MxAuth10700102) MxReadImpl.parse(MxAuth10700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth10700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth10700102) MxReadImpl.parse(MxAuth10700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth10700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth10700102 .class);
    }
