    ...
    extends AbstractMX
{
    ...
    public static MxAuth02600101 parse(String xml) {
        return ((MxAuth02600101) MxReadImpl.parse(MxAuth02600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02600101) MxReadImpl.parse(MxAuth02600101 .class, xml, _classes, new MxReadParams(conf)));
    }
