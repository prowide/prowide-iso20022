    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.059.001.02";
    ...
    public static MxAuth05900102 parse(String xml) {
        return ((MxAuth05900102) MxReadImpl.parse(MxAuth05900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth05900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth05900102) MxReadImpl.parse(MxAuth05900102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth05900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth05900102 .class);
    }
