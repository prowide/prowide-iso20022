    ...
    extends AbstractMX
{
    ...
    public static MxAuth02100103 parse(String xml) {
        return ((MxAuth02100103) MxReadImpl.parse(MxAuth02100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02100103) MxReadImpl.parse(MxAuth02100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth02100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02100103 .class);
    }
