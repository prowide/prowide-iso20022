    ...
    extends AbstractMX
{
    ...
    public static MxAuth00300101 parse(String xml) {
        return ((MxAuth00300101) MxReadImpl.parse(MxAuth00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth00300101) MxReadImpl.parse(MxAuth00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth00300101 .class);
    }
