    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.021.001.01";
    ...
    public static MxAuth02100101 parse(String xml) {
        return ((MxAuth02100101) MxReadImpl.parse(MxAuth02100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02100101) MxReadImpl.parse(MxAuth02100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth02100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02100101 .class);
    }
