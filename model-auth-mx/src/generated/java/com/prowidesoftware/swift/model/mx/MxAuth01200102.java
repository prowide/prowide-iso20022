    ...
    extends AbstractMX
{
    ...
    public static MxAuth01200102 parse(String xml) {
        return ((MxAuth01200102) MxReadImpl.parse(MxAuth01200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01200102) MxReadImpl.parse(MxAuth01200102 .class, xml, _classes, new MxReadParams(conf)));
    }
