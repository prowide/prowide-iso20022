    ...
    extends AbstractMX
{
    ...
    public static MxAuth10500101 parse(String xml) {
        return ((MxAuth10500101) MxReadImpl.parse(MxAuth10500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth10500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth10500101) MxReadImpl.parse(MxAuth10500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth10500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth10500101 .class);
    }
