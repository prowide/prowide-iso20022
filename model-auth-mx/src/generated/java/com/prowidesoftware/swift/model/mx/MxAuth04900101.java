    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.049.001.01";
    ...
    public static MxAuth04900101 parse(String xml) {
        return ((MxAuth04900101) MxReadImpl.parse(MxAuth04900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth04900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth04900101) MxReadImpl.parse(MxAuth04900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth04900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth04900101 .class);
    }
