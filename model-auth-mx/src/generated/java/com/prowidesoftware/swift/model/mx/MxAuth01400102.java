    ...
    extends AbstractMX
{
    ...
    public static MxAuth01400102 parse(String xml) {
        return ((MxAuth01400102) MxReadImpl.parse(MxAuth01400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01400102) MxReadImpl.parse(MxAuth01400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth01400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth01400102 .class);
    }
