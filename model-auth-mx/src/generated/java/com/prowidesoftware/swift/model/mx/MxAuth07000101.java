    ...
    extends AbstractMX
{
    ...
    public static MxAuth07000101 parse(String xml) {
        return ((MxAuth07000101) MxReadImpl.parse(MxAuth07000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth07000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth07000101) MxReadImpl.parse(MxAuth07000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth07000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth07000101 .class);
    }
