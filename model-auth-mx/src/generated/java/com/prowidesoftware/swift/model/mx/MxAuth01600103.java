...
/**
 * Class for auth.016.001.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxAuth01600103(final String xml) {
        this();
        MxAuth01600103 tmp = parse(xml);
     ...
     * 
     */
    public MxAuth01600103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link FinancialInstrumentReportingTransactionReportV03 }
     *     
     */
    public FinancialInstrumentReportingTransactionReportV03 getFinInstrmRptgTxRpt() {
     ...
     *     
     */
    public MxAuth01600103 setFinInstrmRptgTxRpt(FinancialInstrumentReportingTransactionReportV03 value) {
     ...
     */
    public static MxAuth01600103 parse(String xml, MxRead parserImpl) {
        return ((MxAuth01600103) parserImpl.read(MxAuth01600103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxAuth01600103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxAuth01600103 message
     * @return
