    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.032.001.01";
    ...
    public static MxAuth03200101 parse(String xml) {
        return ((MxAuth03200101) MxReadImpl.parse(MxAuth03200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth03200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth03200101) MxReadImpl.parse(MxAuth03200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth03200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth03200101 .class);
    }
