    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.060.001.02";
    ...
    public static MxAuth06000102 parse(String xml) {
        return ((MxAuth06000102) MxReadImpl.parse(MxAuth06000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth06000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth06000102) MxReadImpl.parse(MxAuth06000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth06000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth06000102 .class);
    }
