    ...
    extends AbstractMX
{
    ...
    public static MxAuth08500101 parse(String xml) {
        return ((MxAuth08500101) MxReadImpl.parse(MxAuth08500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth08500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth08500101) MxReadImpl.parse(MxAuth08500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth08500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth08500101 .class);
    }
