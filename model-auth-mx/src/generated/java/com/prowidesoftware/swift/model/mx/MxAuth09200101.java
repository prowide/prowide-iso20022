    ...
    extends AbstractMX
{
    ...
    public static MxAuth09200101 parse(String xml) {
        return ((MxAuth09200101) MxReadImpl.parse(MxAuth09200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth09200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth09200101) MxReadImpl.parse(MxAuth09200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth09200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth09200101 .class);
    }
