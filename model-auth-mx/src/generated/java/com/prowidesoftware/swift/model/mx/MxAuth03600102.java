    ...
    extends AbstractMX
{
    ...
    public static MxAuth03600102 parse(String xml) {
        return ((MxAuth03600102) MxReadImpl.parse(MxAuth03600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth03600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth03600102) MxReadImpl.parse(MxAuth03600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth03600102 fromJson(String json) {
