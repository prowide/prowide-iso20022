    ...
    extends AbstractMX
{
    ...
    public static MxAuth09400101 parse(String xml) {
        return ((MxAuth09400101) MxReadImpl.parse(MxAuth09400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth09400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth09400101) MxReadImpl.parse(MxAuth09400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth09400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth09400101 .class);
    }
