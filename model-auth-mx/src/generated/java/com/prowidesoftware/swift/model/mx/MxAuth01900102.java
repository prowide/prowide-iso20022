    ...
    extends AbstractMX
{
    ...
    public static MxAuth01900102 parse(String xml) {
        return ((MxAuth01900102) MxReadImpl.parse(MxAuth01900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01900102) MxReadImpl.parse(MxAuth01900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth01900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth01900102 .class);
    }
