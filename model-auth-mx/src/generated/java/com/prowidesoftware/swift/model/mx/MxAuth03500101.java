    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.035.001.01";
    ...
    public static MxAuth03500101 parse(String xml) {
        return ((MxAuth03500101) MxReadImpl.parse(MxAuth03500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth03500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth03500101) MxReadImpl.parse(MxAuth03500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth03500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth03500101 .class);
    }
