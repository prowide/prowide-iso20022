    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.016.001.02";
    ...
    public static MxAuth01600102 parse(String xml) {
        return ((MxAuth01600102) MxReadImpl.parse(MxAuth01600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01600102) MxReadImpl.parse(MxAuth01600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth01600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth01600102 .class);
    }
