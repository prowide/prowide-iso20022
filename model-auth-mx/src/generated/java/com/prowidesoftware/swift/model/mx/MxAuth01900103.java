    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.019.001.03";
    ...
    public static MxAuth01900103 parse(String xml) {
        return ((MxAuth01900103) MxReadImpl.parse(MxAuth01900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01900103) MxReadImpl.parse(MxAuth01900103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth01900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth01900103 .class);
    }
