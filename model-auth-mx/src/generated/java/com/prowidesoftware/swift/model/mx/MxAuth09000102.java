    ...
    extends AbstractMX
{
    ...
    public static MxAuth09000102 parse(String xml) {
        return ((MxAuth09000102) MxReadImpl.parse(MxAuth09000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth09000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth09000102) MxReadImpl.parse(MxAuth09000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth09000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth09000102 .class);
    }
