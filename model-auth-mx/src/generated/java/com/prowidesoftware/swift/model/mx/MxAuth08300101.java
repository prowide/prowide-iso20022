    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.083.001.01";
    ...
    public static MxAuth08300101 parse(String xml) {
        return ((MxAuth08300101) MxReadImpl.parse(MxAuth08300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth08300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth08300101) MxReadImpl.parse(MxAuth08300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth08300101 fromJson(String json) {
