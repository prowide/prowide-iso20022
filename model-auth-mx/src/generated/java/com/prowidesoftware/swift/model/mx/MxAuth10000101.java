    ...
    extends AbstractMX
{
    ...
    public static final transient int FUNCTIONALITY = 100;
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.100.001.01";
    ...
    public static MxAuth10000101 parse(String xml) {
        return ((MxAuth10000101) MxReadImpl.parse(MxAuth10000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth10000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth10000101) MxReadImpl.parse(MxAuth10000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth10000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth10000101 .class);
    }
