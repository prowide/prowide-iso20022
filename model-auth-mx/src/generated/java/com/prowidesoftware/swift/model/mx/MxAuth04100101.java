    ...
    extends AbstractMX
{
    ...
    public static MxAuth04100101 parse(String xml) {
        return ((MxAuth04100101) MxReadImpl.parse(MxAuth04100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth04100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth04100101) MxReadImpl.parse(MxAuth04100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth04100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth04100101 .class);
    }
