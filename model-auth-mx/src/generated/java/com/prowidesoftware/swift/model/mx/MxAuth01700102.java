...
/**
 * Class for auth.017.001.02 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxAuth01700102(final String xml) {
        this();
        MxAuth01700102 tmp = parse(xml);
     ...
     * 
     */
    public MxAuth01700102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link FinancialInstrumentReportingReferenceDataReportV02 }
     *     
     */
    public FinancialInstrumentReportingReferenceDataReportV02 getFinInstrmRptgRefDataRpt() {
     ...
     *     
     */
    public MxAuth01700102 setFinInstrmRptgRefDataRpt(FinancialInstrumentReportingReferenceDataReportV02 value) {
    ...
    public static MxAuth01700102 parse(String xml) {
        return ((MxAuth01700102) MxReadImpl.parse(MxAuth01700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01700102) MxReadImpl.parse(MxAuth01700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxAuth01700102 parse(String xml, MxRead parserImpl) {
        return ((MxAuth01700102) parserImpl.read(MxAuth01700102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxAuth01700102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxAuth01700102 message
     * @return
     *     a new instance of MxAuth01700102
     */
    public static final MxAuth01700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth01700102 .class);
    }
