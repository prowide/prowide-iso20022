    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.055.001.01";
    ...
    public static MxAuth05500101 parse(String xml) {
        return ((MxAuth05500101) MxReadImpl.parse(MxAuth05500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth05500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth05500101) MxReadImpl.parse(MxAuth05500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth05500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth05500101 .class);
    }
