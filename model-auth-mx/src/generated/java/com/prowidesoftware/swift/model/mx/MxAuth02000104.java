    ...
    extends AbstractMX
{
    ...
    public static MxAuth02000104 parse(String xml) {
        return ((MxAuth02000104) MxReadImpl.parse(MxAuth02000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02000104) MxReadImpl.parse(MxAuth02000104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth02000104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02000104 .class);
    }
