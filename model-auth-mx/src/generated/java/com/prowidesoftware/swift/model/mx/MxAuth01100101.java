    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.011.001.01";
    ...
    public static MxAuth01100101 parse(String xml) {
        return ((MxAuth01100101) MxReadImpl.parse(MxAuth01100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01100101) MxReadImpl.parse(MxAuth01100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth01100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth01100101 .class);
    }
