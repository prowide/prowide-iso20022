    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.094.001.02";
    ...
    public static MxAuth09400102 parse(String xml) {
        return ((MxAuth09400102) MxReadImpl.parse(MxAuth09400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth09400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth09400102) MxReadImpl.parse(MxAuth09400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth09400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth09400102 .class);
    }
