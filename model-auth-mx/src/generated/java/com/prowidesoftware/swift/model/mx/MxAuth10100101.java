    ...
    extends AbstractMX
{
    ...
    public static MxAuth10100101 parse(String xml) {
        return ((MxAuth10100101) MxReadImpl.parse(MxAuth10100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth10100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth10100101) MxReadImpl.parse(MxAuth10100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth10100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth10100101 .class);
    }
