    ...
    extends AbstractMX
{
    ...
    public static MxAuth10900102 parse(String xml) {
        return ((MxAuth10900102) MxReadImpl.parse(MxAuth10900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth10900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth10900102) MxReadImpl.parse(MxAuth10900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth10900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth10900102 .class);
    }
