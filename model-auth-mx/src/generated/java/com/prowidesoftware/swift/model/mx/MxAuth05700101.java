    ...
    extends AbstractMX
{
    ...
    public static MxAuth05700101 parse(String xml) {
        return ((MxAuth05700101) MxReadImpl.parse(MxAuth05700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth05700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth05700101) MxReadImpl.parse(MxAuth05700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth05700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth05700101 .class);
    }
