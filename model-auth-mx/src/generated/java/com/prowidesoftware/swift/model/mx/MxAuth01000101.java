    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.010.001.01";
    ...
    public static MxAuth01000101 parse(String xml) {
        return ((MxAuth01000101) MxReadImpl.parse(MxAuth01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01000101) MxReadImpl.parse(MxAuth01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth01000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth01000101 .class);
    }
