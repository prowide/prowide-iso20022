    ...
    extends AbstractMX
{
    ...
    public static MxAuth01300102 parse(String xml) {
        return ((MxAuth01300102) MxReadImpl.parse(MxAuth01300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01300102) MxReadImpl.parse(MxAuth01300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth01300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth01300102 .class);
    }
