    ...
    extends AbstractMX
{
    ...
    public static MxAuth01600101 parse(String xml) {
        return ((MxAuth01600101) MxReadImpl.parse(MxAuth01600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth01600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth01600101) MxReadImpl.parse(MxAuth01600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth01600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth01600101 .class);
    }
