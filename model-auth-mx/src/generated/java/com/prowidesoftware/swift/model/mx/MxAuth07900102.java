    ...
    extends AbstractMX
{
    ...
    public static MxAuth07900102 parse(String xml) {
        return ((MxAuth07900102) MxReadImpl.parse(MxAuth07900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth07900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth07900102) MxReadImpl.parse(MxAuth07900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth07900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth07900102 .class);
    }
