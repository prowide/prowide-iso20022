    ...
    extends AbstractMX
{
    ...
    public static MxAuth10800101 parse(String xml) {
        return ((MxAuth10800101) MxReadImpl.parse(MxAuth10800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth10800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth10800101) MxReadImpl.parse(MxAuth10800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth10800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth10800101 .class);
    }
