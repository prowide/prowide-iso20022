    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:auth.063.001.01";
    ...
    public static MxAuth06300101 parse(String xml) {
        return ((MxAuth06300101) MxReadImpl.parse(MxAuth06300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth06300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth06300101) MxReadImpl.parse(MxAuth06300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAuth06300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth06300101 .class);
    }
