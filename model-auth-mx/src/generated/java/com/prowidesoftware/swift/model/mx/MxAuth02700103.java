    ...
    extends AbstractMX
{
    ...
    public static MxAuth02700103 parse(String xml) {
        return ((MxAuth02700103) MxReadImpl.parse(MxAuth02700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02700103) MxReadImpl.parse(MxAuth02700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth02700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02700103 .class);
    }
