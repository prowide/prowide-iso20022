    ...
    extends AbstractMX
{
    ...
    public static MxAuth02900105 parse(String xml) {
        return ((MxAuth02900105) MxReadImpl.parse(MxAuth02900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAuth02900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxAuth02900105) MxReadImpl.parse(MxAuth02900105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAuth02900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAuth02900105 .class);
    }
