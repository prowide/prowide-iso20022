...
/**
 * <p>Java class for DTCCSubEventType11Code.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="DTCCSubEventType11Code"&gt;
 ...
 * 
 */
@XmlType(name = "DTCCSubEventType11Code")
@XmlEnum
public enum DTCCSubEventType11Code {
    ...
    DTCCSubEventType11Code(String v) {
        value = v;
    }
    ...
    public static DTCCSubEventType11Code fromValue(String v) {
        for (DTCCSubEventType11Code c: DTCCSubEventType11Code.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
