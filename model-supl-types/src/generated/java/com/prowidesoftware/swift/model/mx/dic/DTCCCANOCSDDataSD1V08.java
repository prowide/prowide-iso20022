...
@XmlType(name = "DTCCCANOCSDDataSD1V08", propOrder = {
    "ntfctnGnlInf",
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
...
public class DTCCCANOCSDDataSD1V08 {

    @XmlElement(name = "NtfctnGnlInf")
    protected CorporateActionNotificationSD3 ntfctnGnlInf;
    @XmlElement(name = "CorpActnGnlInf")
    protected CorporateActionGeneralInformationSD22 corpActnGnlInf;
    @XmlElement(name = "UndrlygScty")
    protected FinancialInstrumentAttributesSD12 undrlygScty;
    ...
    protected List<CashOptionSD9> cshMvmntDtls;
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V08 setNtfctnGnlInf(CorporateActionNotificationSD3 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformationSD22 }
     *     
     */
    public CorporateActionGeneralInformationSD22 getCorpActnGnlInf() {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V08 setCorpActnGnlInf(CorporateActionGeneralInformationSD22 value) {
     ...
     * @return
     *     possible object is
     *     {@link FinancialInstrumentAttributesSD12 }
     *     
     */
    public FinancialInstrumentAttributesSD12 getUndrlygScty() {
        return undrlygScty;
    }
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V08 setUndrlygScty(FinancialInstrumentAttributesSD12 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V08 setCorpActnDtls(CorporateActionSD14 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V08 setCorpActnDtDtls(CorporateActionDateSD5 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V08 setCorpActnPricDtls(CorporateActionPriceSD3 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V08 setCorpActnPrdDtls(CorporateActionPeriodSD2 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V08 setCorpActnRateAndAmtDtls(CorporateActionRateSD5 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V08 setCorpActnSctiesQty(CorporateActionQuantitySD1 value) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V08 addOptnDtls(CorporateActionOptionSD10 optnDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V08 addSctiesMvmntDtls(SecuritiesOptionSD8 sctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V08 addSctiesMvmntSctyDtls(FinancialInstrumentAttributesSD1 sctiesMvmntSctyDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V08 addSctiesMvmntRateDtls(CorporateActionRateSD8 sctiesMvmntRateDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V08 addSctiesMvmntCshInLieuDtls(CorporateActionPriceSD1 sctiesMvmntCshInLieuDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V08 addSctiesMvmntFrctnDspstn(FractionDispositionTypeSD2 sctiesMvmntFrctnDspstn) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V08 addCshMvmntDtls(CashOptionSD9 cshMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V08 addNewAgt(PartyIdentificationSD1 newAgt) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V08 addAgt(PartyIdentificationSD2 agt) {
        getAgt().add(agt);
        return this;
    }
