...
@XmlType(name = "DTCCCANOCSDDataSD1V16", propOrder = {
    "ntfctnGnlInf",
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
...
public class DTCCCANOCSDDataSD1V16 {
    ...
    protected List<CorporateActionOptionSD15> optnDtls;
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V16 setNtfctnGnlInf(CorporateActionNotificationSD9 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformationSD47 }
     *     
     */
    public CorporateActionGeneralInformationSD47 getCorpActnGnlInf() {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V16 setCorpActnGnlInf(CorporateActionGeneralInformationSD47 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V16 setUndrlygScty(FinancialInstrumentAttributesSD19 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionSD24 }
     *     
     */
    public CorporateActionSD24 getCorpActnDtls() {
        return corpActnDtls;
    }
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V16 setCorpActnDtls(CorporateActionSD24 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V16 setCorpActnDtDtls(CorporateActionDateSD10 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V16 setCorpActnPricDtls(CorporateActionPriceSD4 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V16 setCorpActnPrdDtls(CorporateActionPeriodSD3 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V16 setCorpActnRateAndAmtDtls(CorporateActionRateSD9 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V16 setCorpActnSctiesQty(CorporateActionQuantitySD3 value) {
     ...
     * {@link CorporateActionOptionSD15 }
     * 
     * 
     */
    public List<CorporateActionOptionSD15> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<CorporateActionOptionSD15>();
        }
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V16 addOptnDtls(CorporateActionOptionSD15 optnDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V16 addOptnDtDtls(CorporateActionDateSD11 optnDtDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V16 addSctiesMvmntDtls(SecuritiesOptionSD9 sctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V16 addSctiesMvmntSctyDtls(FinancialInstrumentAttributesSD16 sctiesMvmntSctyDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V16 addSctiesMvmntRateDtls(CorporateActionRateSD10 sctiesMvmntRateDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V16 addSctiesMvmntCshInLieuDtls(CorporateActionPriceSD5 sctiesMvmntCshInLieuDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V16 addSctiesMvmntFrctnDspstn(FractionDispositionTypeSD3 sctiesMvmntFrctnDspstn) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V16 addCshMvmntDtls(CashOptionSD14 cshMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V16 addNewAgt(PartyIdentificationSD5 newAgt) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V16 addAgt(PartyIdentificationSD6 agt) {
        getAgt().add(agt);
        return this;
    }
