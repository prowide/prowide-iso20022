...
@XmlType(name = "DTCCCANOEligibleBalanceSD1V11", propOrder = {
    "corpActnGnlInf",
    "undrlygScty",
    "dstrbtnAcctBal",
    "redAcctBal",
...
public class DTCCCANOEligibleBalanceSD1V11 {

    @XmlElement(name = "CorpActnGnlInf")
    protected CorporateActionGeneralInformationSD49 corpActnGnlInf;
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformationSD49 }
     *     
     */
    public CorporateActionGeneralInformationSD49 getCorpActnGnlInf() {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V11 setCorpActnGnlInf(CorporateActionGeneralInformationSD49 value) {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V11 setUndrlygScty(FinancialInstrumentAttributesSD21 value) {
    ...
    public List<AccountBalanceSD10> getDstrbtnAcctBal() {
        if (dstrbtnAcctBal == null) {
            dstrbtnAcctBal = new ArrayList<AccountBalanceSD10>();
        }
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V11 setRedAcctBal(AccountBalanceSD11 value) {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V11 setReorgAcctBal(AccountBalanceSD12 value) {
     ...
     * 
     */
    public DTCCCANOEligibleBalanceSD1V11 addDstrbtnAcctBal(AccountBalanceSD10 dstrbtnAcctBal) {
