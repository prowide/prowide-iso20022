...
@XmlType(name = "CashOptionSD4", propOrder = {
    "plcAndNm",
...
public class CashOptionSD4 {
     ...
     *     
     */
    public CashOptionSD4 setPlcAndNm(String value) {
        this.plcAndNm = value;
        return this;
    }
     ...
     *     
     */
    public CashOptionSD4 setRinvstmtIncmClssfctn(ReinvestmentIncomeClassification1Code value) {
     ...
     *     
     */
    public CashOptionSD4 setDTCPayMtd(String value) {
     ...
     *     
     */
    public CashOptionSD4 setDTCPayOrdr(String value) {
     ...
     *     
     */
    public CashOptionSD4 setEntitlmntClctnMtd(DTCEntitlementCalculationMethod1Code value) {
     ...
     *     
     */
    public CashOptionSD4 setEstmtdRateFlg(Boolean value) {
     ...
     *     
     */
    public CashOptionSD4 setNRATaxRptblFlg(Boolean value) {
     ...
     *     
     */
    public CashOptionSD4 setPrtctChrgFlg(Boolean value) {
     ...
     *     
     */
    public CashOptionSD4 setDclrdCshRate(RateAndAmountFormat17Choice value) {
     ...
     *     
     */
    public CashOptionSD4 setDclrdGrssRate(RateAndAmountFormat17Choice value) {
     ...
     *     
     */
    public CashOptionSD4 setDclrdNetRate(RateAndAmountFormat17Choice value) {
     ...
     *     
     */
    public CashOptionSD4 setDclrdFeeRate(RateAndAmountFormat17Choice value) {
     ...
     *     
     */
    public CashOptionSD4 setDTCUSTaxInstrPrd(Period3 value) {
