...
@XmlType(name = "DTCCCANOCSDDataSD1V14", propOrder = {
    "ntfctnGnlInf",
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
...
public class DTCCCANOCSDDataSD1V14 {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V14 setNtfctnGnlInf(CorporateActionNotificationSD9 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V14 setCorpActnGnlInf(CorporateActionGeneralInformationSD47 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V14 setUndrlygScty(FinancialInstrumentAttributesSD19 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V14 setCorpActnDtls(CorporateActionSD22 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V14 setCorpActnDtDtls(CorporateActionDateSD10 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V14 setCorpActnPricDtls(CorporateActionPriceSD4 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V14 setCorpActnPrdDtls(CorporateActionPeriodSD3 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V14 setCorpActnRateAndAmtDtls(CorporateActionRateSD9 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V14 setCorpActnSctiesQty(CorporateActionQuantitySD3 value) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V14 addOptnDtls(CorporateActionOptionSD14 optnDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V14 addOptnDtDtls(CorporateActionDateSD11 optnDtDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V14 addSctiesMvmntDtls(SecuritiesOptionSD9 sctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V14 addSctiesMvmntSctyDtls(FinancialInstrumentAttributesSD16 sctiesMvmntSctyDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V14 addSctiesMvmntRateDtls(CorporateActionRateSD10 sctiesMvmntRateDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V14 addSctiesMvmntCshInLieuDtls(CorporateActionPriceSD5 sctiesMvmntCshInLieuDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V14 addSctiesMvmntFrctnDspstn(FractionDispositionTypeSD3 sctiesMvmntFrctnDspstn) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V14 addCshMvmntDtls(CashOptionSD13 cshMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V14 addNewAgt(PartyIdentificationSD5 newAgt) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V14 addAgt(PartyIdentificationSD6 agt) {
        getAgt().add(agt);
        return this;
    }
