...
@XmlType(name = "DTCCCANOEligibleBalanceSD1V09", propOrder = {
    "corpActnGnlInf",
    "undrlygScty",
    "dstrbtnAcctBal",
    "redAcctBal",
...
public class DTCCCANOEligibleBalanceSD1V09 {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V09 setCorpActnGnlInf(CorporateActionGeneralInformationSD42 value) {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V09 setUndrlygScty(FinancialInstrumentAttributesSD17 value) {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V09 setRedAcctBal(AccountBalanceSD11 value) {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V09 setReorgAcctBal(AccountBalanceSD12 value) {
     ...
     * 
     */
    public DTCCCANOEligibleBalanceSD1V09 addDstrbtnAcctBal(AccountBalanceSD10 dstrbtnAcctBal) {
