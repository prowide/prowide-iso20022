...
/**
 * <p>Java class for DTCCSubEventType7Code.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="DTCCSubEventType7Code"&gt;
 ...
 * 
 */
@XmlType(name = "DTCCSubEventType7Code")
@XmlEnum
public enum DTCCSubEventType7Code {
    ...
    DTCCSubEventType7Code(String v) {
        value = v;
    }
    ...
    public static DTCCSubEventType7Code fromValue(String v) {
        for (DTCCSubEventType7Code c: DTCCSubEventType7Code.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
