...
@XmlType(name = "DTCCCACOSD1V11", propOrder = {
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
    "acctBal",
...
public class DTCCCACOSD1V11 {

    @XmlElement(name = "CorpActnGnlInf")
    protected CorporateActionGeneralInformationSD60 corpActnGnlInf;
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformationSD60 }
     *     
     */
    public CorporateActionGeneralInformationSD60 getCorpActnGnlInf() {
     ...
     *     
     */
    public DTCCCACOSD1V11 setCorpActnGnlInf(CorporateActionGeneralInformationSD60 value) {
     ...
     *     
     */
    public DTCCCACOSD1V11 setUndrlygScty(FinancialInstrumentAttributesSD21 value) {
     ...
     *     
     */
    public DTCCCACOSD1V11 setCorpActnDtls(CorporateActionSD20 value) {
     ...
     *     
     */
    public DTCCCACOSD1V11 setCorpActnConfDtls(CorporateActionConfirmationDetailsSD2 value) {
     ...
     * 
     */
    public DTCCCACOSD1V11 addAcctBal(AccountBalanceSD14 acctBal) {
     ...
     * 
     */
    public DTCCCACOSD1V11 addCorpActnConfSctiesMvmntDtls(CorporateActionConfirmationSecuritiesMovementDetailsSD6 corpActnConfSctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCACOSD1V11 addCorpActnConfCshMvmntDtls(CorporateActionConfirmationCashMovementDetailsSD5 corpActnConfCshMvmntDtls) {
     ...
     * 
     */
    public DTCCCACOSD1V11 addOptnTxDtls(OptionTransactionSD6 optnTxDtls) {
