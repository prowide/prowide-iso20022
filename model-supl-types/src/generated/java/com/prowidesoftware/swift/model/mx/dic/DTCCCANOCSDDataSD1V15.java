...
@XmlType(name = "DTCCCANOCSDDataSD1V15", propOrder = {
    "ntfctnGnlInf",
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
...
public class DTCCCANOCSDDataSD1V15 {
    ...
    protected CorporateActionSD23 corpActnDtls;
    ...
    protected List<CashOptionSD13> cshMvmntDtls;
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V15 setNtfctnGnlInf(CorporateActionNotificationSD9 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V15 setCorpActnGnlInf(CorporateActionGeneralInformationSD47 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V15 setUndrlygScty(FinancialInstrumentAttributesSD19 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionSD23 }
     *     
     */
    public CorporateActionSD23 getCorpActnDtls() {
        return corpActnDtls;
    }
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V15 setCorpActnDtls(CorporateActionSD23 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V15 setCorpActnDtDtls(CorporateActionDateSD10 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V15 setCorpActnPricDtls(CorporateActionPriceSD4 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V15 setCorpActnPrdDtls(CorporateActionPeriodSD3 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V15 setCorpActnRateAndAmtDtls(CorporateActionRateSD9 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V15 setCorpActnSctiesQty(CorporateActionQuantitySD3 value) {
     ...
     * {@link CorporateActionOptionSD14 }
     * 
     * 
     */
    public List<CorporateActionOptionSD14> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<CorporateActionOptionSD14>();
        }
     ...
     * 
     */
    public List<CashOptionSD13> getCshMvmntDtls() {
        if (cshMvmntDtls == null) {
            cshMvmntDtls = new ArrayList<CashOptionSD13>();
        }
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V15 addOptnDtls(CorporateActionOptionSD14 optnDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V15 addOptnDtDtls(CorporateActionDateSD11 optnDtDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V15 addSctiesMvmntDtls(SecuritiesOptionSD9 sctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V15 addSctiesMvmntSctyDtls(FinancialInstrumentAttributesSD16 sctiesMvmntSctyDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V15 addSctiesMvmntRateDtls(CorporateActionRateSD10 sctiesMvmntRateDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V15 addSctiesMvmntCshInLieuDtls(CorporateActionPriceSD5 sctiesMvmntCshInLieuDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V15 addSctiesMvmntFrctnDspstn(FractionDispositionTypeSD3 sctiesMvmntFrctnDspstn) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V15 addCshMvmntDtls(CashOptionSD13 cshMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V15 addNewAgt(PartyIdentificationSD5 newAgt) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V15 addAgt(PartyIdentificationSD6 agt) {
        getAgt().add(agt);
        return this;
    }
