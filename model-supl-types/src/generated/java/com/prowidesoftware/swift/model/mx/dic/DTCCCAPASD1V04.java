...
@XmlType(name = "DTCCCAPASD1V04", propOrder = {
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnBalDtls",
    "corpActnDtls",
...
public class DTCCCAPASD1V04 {
     ...
     *     
     */
    public DTCCCAPASD1V04 setCorpActnGnlInf(CorporateActionGeneralInformationSD21 value) {
     ...
     *     
     */
    public DTCCCAPASD1V04 setUndrlygScty(FinancialInstrumentAttributesSD9 value) {
     ...
     *     
     */
    public DTCCCAPASD1V04 setCorpActnBalDtls(CorporateActionBalanceSD1 value) {
     ...
     *     
     */
    public DTCCCAPASD1V04 setCorpActnDtls(CorporateActionSD8 value) {
    ...
    public List<CorporateActionMovementCashMovementDetailsSD3> getCorpActnMvmntCshMvmntDtls() {
        if (corpActnMvmntCshMvmntDtls == null) {
            corpActnMvmntCshMvmntDtls = new ArrayList<CorporateActionMovementCashMovementDetailsSD3>();
        }
     ...
     * 
     */
    public DTCCCAPASD1V04 addCorpActnMvmntSctiesMvmntDtls(CorporateActionMovementSecuritiesMovementDetailsSD4 corpActnMvmntSctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCAPASD1V04 addCorpActnMvmntCshMvmntDtls(CorporateActionMovementCashMovementDetailsSD3 corpActnMvmntCshMvmntDtls) {
