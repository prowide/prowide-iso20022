...
public class DTCCCANOMarketDataSD1V06 {
     ...
     * {@link CorporateActionOptionSD9 }
     * 
     * 
     */
    public List<CorporateActionOptionSD9> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<CorporateActionOptionSD9>();
        }
    ...
    public List<CashOptionSD7> getCshMvmntDtls() {
        if (cshMvmntDtls == null) {
            cshMvmntDtls = new ArrayList<CashOptionSD7>();
        }
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V06 addOptnDtls(CorporateActionOptionSD9 optnDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V06 addSctiesMvmntDtls(SecuritiesOptionSD6 sctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V06 addSctiesMvmntSctyDtls(FinancialInstrumentAttributesSD3 sctiesMvmntSctyDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V06 addSctiesMvmntRateDtls(CorporateActionRateSD7 sctiesMvmntRateDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V06 addSctiesMvmntCshInLieuDtls(CorporateActionPriceSD2 sctiesMvmntCshInLieuDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V06 addSctiesMvmntFrctnDspstn(FractionDispositionTypeSD2 sctiesMvmntFrctnDspstn) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V06 addCshMvmntDtls(CashOptionSD7 cshMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V06 addAgt(PartyIdentificationSD2 agt) {
        getAgt().add(agt);
        return this;
    }
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V06 addNewAgt(PartyIdentificationSD1 newAgt) {
