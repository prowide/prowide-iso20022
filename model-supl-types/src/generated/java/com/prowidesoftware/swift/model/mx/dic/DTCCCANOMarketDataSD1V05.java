...
@XmlType(name = "DTCCCANOMarketDataSD1V05", propOrder = {
    "ntfctnGnlInf",
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
...
public class DTCCCANOMarketDataSD1V05 {
    ...
    protected List<CorporateActionOptionSD7> optnDtls;
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V05 setNtfctnGnlInf(CorporateActionNotificationSD3 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformationSD11 }
     *     
     */
    public CorporateActionGeneralInformationSD11 getCorpActnGnlInf() {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V05 setCorpActnGnlInf(CorporateActionGeneralInformationSD11 value) {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V05 setUndrlygScty(FinancialInstrumentAttributesSD6 value) {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V05 setCorpActnDtls(CorporateActionSD7 value) {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V05 setCorpActnDtDtls(CorporateActionDateSD5 value) {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V05 setCorpActnPricDtls(CorporateActionPriceSD3 value) {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V05 setCorpActnPrdDtls(CorporateActionPeriodSD2 value) {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V05 setCorpActnSctiesQty(CorporateActionQuantitySD1 value) {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V05 setCorpActnRateAndAmtDtls(CorporateActionRateSD5 value) {
     ...
     * {@link CorporateActionOptionSD7 }
     * 
     * 
     */
    public List<CorporateActionOptionSD7> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<CorporateActionOptionSD7>();
        }
    ...
    public List<SecuritiesOptionSD5> getSctiesMvmntDtls() {
        if (sctiesMvmntDtls == null) {
            sctiesMvmntDtls = new ArrayList<SecuritiesOptionSD5>();
        }
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V05 addOptnDtls(CorporateActionOptionSD7 optnDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V05 addSctiesMvmntDtls(SecuritiesOptionSD5 sctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V05 addSctiesMvmntSctyDtls(FinancialInstrumentAttributesSD3 sctiesMvmntSctyDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V05 addSctiesMvmntRateDtls(CorporateActionRateSD7 sctiesMvmntRateDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V05 addSctiesMvmntCshInLieuDtls(CorporateActionPriceSD2 sctiesMvmntCshInLieuDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V05 addSctiesMvmntFrctnDspstn(FractionDispositionTypeSD2 sctiesMvmntFrctnDspstn) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V05 addCshMvmntDtls(CashOptionSD2 cshMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V05 addAgt(PartyIdentificationSD2 agt) {
        getAgt().add(agt);
        return this;
    }
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V05 addNewAgt(PartyIdentificationSD1 newAgt) {
