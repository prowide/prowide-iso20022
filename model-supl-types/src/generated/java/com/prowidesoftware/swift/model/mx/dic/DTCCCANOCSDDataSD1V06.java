...
public class DTCCCANOCSDDataSD1V06 {
    ...
    public List<SecuritiesOptionSD7> getSctiesMvmntDtls() {
        if (sctiesMvmntDtls == null) {
            sctiesMvmntDtls = new ArrayList<SecuritiesOptionSD7>();
        }
    ...
    public List<CashOptionSD8> getCshMvmntDtls() {
        if (cshMvmntDtls == null) {
            cshMvmntDtls = new ArrayList<CashOptionSD8>();
        }
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V06 addOptnDtls(CorporateActionOptionSD10 optnDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V06 addSctiesMvmntDtls(SecuritiesOptionSD7 sctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V06 addSctiesMvmntSctyDtls(FinancialInstrumentAttributesSD1 sctiesMvmntSctyDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V06 addSctiesMvmntRateDtls(CorporateActionRateSD8 sctiesMvmntRateDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V06 addSctiesMvmntCshInLieuDtls(CorporateActionPriceSD1 sctiesMvmntCshInLieuDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V06 addSctiesMvmntFrctnDspstn(FractionDispositionTypeSD2 sctiesMvmntFrctnDspstn) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V06 addCshMvmntDtls(CashOptionSD8 cshMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V06 addNewAgt(PartyIdentificationSD1 newAgt) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V06 addAgt(PartyIdentificationSD2 agt) {
        getAgt().add(agt);
        return this;
    }
