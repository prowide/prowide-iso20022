...
@XmlType(name = "DTCCCAPASD1V06", propOrder = {
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnBalDtls",
    "corpActnDtls",
...
public class DTCCCAPASD1V06 {

    @XmlElement(name = "CorpActnGnlInf")
    protected CorporateActionGeneralInformationSD30 corpActnGnlInf;
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformationSD30 }
     *     
     */
    public CorporateActionGeneralInformationSD30 getCorpActnGnlInf() {
     ...
     *     
     */
    public DTCCCAPASD1V06 setCorpActnGnlInf(CorporateActionGeneralInformationSD30 value) {
     ...
     *     
     */
    public DTCCCAPASD1V06 setUndrlygScty(FinancialInstrumentAttributesSD17 value) {
     ...
     *     
     */
    public DTCCCAPASD1V06 setCorpActnBalDtls(CorporateActionBalanceSD4 value) {
     ...
     *     
     */
    public DTCCCAPASD1V06 setCorpActnDtls(CorporateActionSD18 value) {
     ...
     * 
     */
    public DTCCCAPASD1V06 addCorpActnMvmntSctiesMvmntDtls(CorporateActionMovementSecuritiesMovementDetailsSD5 corpActnMvmntSctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCAPASD1V06 addCorpActnMvmntCshMvmntDtls(CorporateActionMovementCashMovementDetailsSD5 corpActnMvmntCshMvmntDtls) {
     ...
     * 
     */
    public DTCCCAPASD1V06 addOptnTxDtls(OptionTransactionDetailsSD3 optnTxDtls) {
