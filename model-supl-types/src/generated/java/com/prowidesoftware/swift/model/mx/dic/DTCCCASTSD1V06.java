...
public class DTCCCASTSD1V06 {
    ...
    protected List<CorporateActionInstructedBalanceOptionInstructionSD5> ttlInstdBalOptnInstrDtls;
     ...
     *     
     */
    public DTCCCASTSD1V06 setEvtBalDtls(CorporateActionBalanceSD5 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CorporateActionInstructedBalanceOptionInstructionSD5 }
     * 
     * 
     */
    public List<CorporateActionInstructedBalanceOptionInstructionSD5> getTtlInstdBalOptnInstrDtls() {
        if (ttlInstdBalOptnInstrDtls == null) {
            ttlInstdBalOptnInstrDtls = new ArrayList<CorporateActionInstructedBalanceOptionInstructionSD5>();
        }
     ...
     * 
     */
    public DTCCCASTSD1V06 addTtlInstdBalOptnBalDtls(CorporateActionInstructedBalanceOptionBalanceSD3 ttlInstdBalOptnBalDtls) {
     ...
     * 
     */
    public DTCCCASTSD1V06 addTtlInstdBalOptnInstrDtls(CorporateActionInstructedBalanceOptionInstructionSD5 ttlInstdBalOptnInstrDtls) {
     ...
     * 
     */
    public DTCCCASTSD1V06 addTtlInstdBalOptnPrtctInstrDtls(CorporateActionInstructedBalanceOptionProtectInstructionSD4 ttlInstdBalOptnPrtctInstrDtls) {
