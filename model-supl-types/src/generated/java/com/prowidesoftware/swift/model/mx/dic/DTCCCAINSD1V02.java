...
@XmlType(name = "DTCCCAINSD1V02", propOrder = {
    "optnlDvdd",
    "taxXmpt",
    "wireInstr"
})
public class DTCCCAINSD1V02 {
     ...
     * 
     */
    public DTCCCAINSD1V02 addOptnlDvdd(OptionalDividendAccountQuantitySD2 optnlDvdd) {
     ...
     * 
     */
    public DTCCCAINSD1V02 addTaxXmpt(TaxExemptQuantitySD1 taxXmpt) {
     ...
     * 
     */
    public DTCCCAINSD1V02 addWireInstr(WireInstructionSD2 wireInstr) {
