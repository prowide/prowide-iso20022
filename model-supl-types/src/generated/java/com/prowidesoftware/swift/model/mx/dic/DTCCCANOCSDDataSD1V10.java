...
@XmlType(name = "DTCCCANOCSDDataSD1V10", propOrder = {
    "ntfctnGnlInf",
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
...
public class DTCCCANOCSDDataSD1V10 {
    ...
    protected CorporateActionDateSD8 corpActnDtDtls;
    ...
    protected List<CorporateActionOptionSD11> optnDtls;
    @XmlElement(name = "OptnDtDtls")
    protected List<CorporateActionDateSD9> optnDtDtls;
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V10 setNtfctnGnlInf(CorporateActionNotificationSD9 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformationSD28 }
     *     
     */
    public CorporateActionGeneralInformationSD28 getCorpActnGnlInf() {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V10 setCorpActnGnlInf(CorporateActionGeneralInformationSD28 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V10 setUndrlygScty(FinancialInstrumentAttributesSD15 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V10 setCorpActnDtls(CorporateActionSD17 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionDateSD8 }
     *     
     */
    public CorporateActionDateSD8 getCorpActnDtDtls() {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V10 setCorpActnDtDtls(CorporateActionDateSD8 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V10 setCorpActnPricDtls(CorporateActionPriceSD4 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V10 setCorpActnPrdDtls(CorporateActionPeriodSD3 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V10 setCorpActnRateAndAmtDtls(CorporateActionRateSD9 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V10 setCorpActnSctiesQty(CorporateActionQuantitySD3 value) {
     ...
     * {@link CorporateActionOptionSD11 }
     * 
     * 
     */
    public List<CorporateActionOptionSD11> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<CorporateActionOptionSD11>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CorporateActionDateSD9 }
     * 
     * 
     */
    public List<CorporateActionDateSD9> getOptnDtDtls() {
        if (optnDtDtls == null) {
            optnDtDtls = new ArrayList<CorporateActionDateSD9>();
        }
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V10 addOptnDtls(CorporateActionOptionSD11 optnDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V10 addOptnDtDtls(CorporateActionDateSD9 optnDtDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V10 addSctiesMvmntDtls(SecuritiesOptionSD9 sctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V10 addSctiesMvmntSctyDtls(FinancialInstrumentAttributesSD16 sctiesMvmntSctyDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V10 addSctiesMvmntRateDtls(CorporateActionRateSD10 sctiesMvmntRateDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V10 addSctiesMvmntCshInLieuDtls(CorporateActionPriceSD5 sctiesMvmntCshInLieuDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V10 addSctiesMvmntFrctnDspstn(FractionDispositionTypeSD3 sctiesMvmntFrctnDspstn) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V10 addCshMvmntDtls(CashOptionSD11 cshMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V10 addNewAgt(PartyIdentificationSD5 newAgt) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V10 addAgt(PartyIdentificationSD6 agt) {
        getAgt().add(agt);
        return this;
    }
