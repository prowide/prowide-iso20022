...
@XmlType(name = "DTCCCANOCSDDataSD1V05", propOrder = {
    "ntfctnGnlInf",
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
...
public class DTCCCANOCSDDataSD1V05 {
    ...
    protected List<CorporateActionOptionSD8> optnDtls;
    ...
    protected List<CashOptionSD6> cshMvmntDtls;
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V05 setNtfctnGnlInf(CorporateActionNotificationSD3 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V05 setCorpActnGnlInf(CorporateActionGeneralInformationSD12 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V05 setUndrlygScty(FinancialInstrumentAttributesSD8 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V05 setCorpActnDtls(CorporateActionSD11 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V05 setCorpActnDtDtls(CorporateActionDateSD5 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V05 setCorpActnPricDtls(CorporateActionPriceSD3 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V05 setCorpActnPrdDtls(CorporateActionPeriodSD2 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V05 setCorpActnRateAndAmtDtls(CorporateActionRateSD5 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V05 setCorpActnSctiesQty(CorporateActionQuantitySD1 value) {
     ...
     * {@link CorporateActionOptionSD8 }
     * 
     * 
     */
    public List<CorporateActionOptionSD8> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<CorporateActionOptionSD8>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SecuritiesOptionSD6 }
     * 
     * 
     */
    public List<SecuritiesOptionSD6> getSctiesMvmntDtls() {
        if (sctiesMvmntDtls == null) {
            sctiesMvmntDtls = new ArrayList<SecuritiesOptionSD6>();
        }
     ...
     * 
     */
    public List<CashOptionSD6> getCshMvmntDtls() {
        if (cshMvmntDtls == null) {
            cshMvmntDtls = new ArrayList<CashOptionSD6>();
        }
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V05 addOptnDtls(CorporateActionOptionSD8 optnDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V05 addSctiesMvmntDtls(SecuritiesOptionSD6 sctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V05 addSctiesMvmntSctyDtls(FinancialInstrumentAttributesSD1 sctiesMvmntSctyDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V05 addSctiesMvmntRateDtls(CorporateActionRateSD6 sctiesMvmntRateDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V05 addSctiesMvmntCshInLieuDtls(CorporateActionPriceSD1 sctiesMvmntCshInLieuDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V05 addSctiesMvmntFrctnDspstn(FractionDispositionTypeSD2 sctiesMvmntFrctnDspstn) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V05 addCshMvmntDtls(CashOptionSD6 cshMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V05 addNewAgt(PartyIdentificationSD1 newAgt) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V05 addAgt(PartyIdentificationSD2 agt) {
        getAgt().add(agt);
        return this;
    }
