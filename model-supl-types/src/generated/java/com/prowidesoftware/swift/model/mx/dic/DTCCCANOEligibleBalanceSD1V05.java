...
@XmlType(name = "DTCCCANOEligibleBalanceSD1V05", propOrder = {
    "corpActnGnlInf",
    "undrlygScty",
    "dstrbtnAcctBal",
    "redAcctBal"
...
public class DTCCCANOEligibleBalanceSD1V05 {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V05 setCorpActnGnlInf(CorporateActionGeneralInformationSD21 value) {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V05 setUndrlygScty(FinancialInstrumentAttributesSD9 value) {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V05 setRedAcctBal(AccountBalanceSD6 value) {
     ...
     * 
     */
    public DTCCCANOEligibleBalanceSD1V05 addDstrbtnAcctBal(AccountBalanceSD7 dstrbtnAcctBal) {
