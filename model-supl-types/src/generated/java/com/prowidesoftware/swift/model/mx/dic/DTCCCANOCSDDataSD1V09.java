...
@XmlType(name = "DTCCCANOCSDDataSD1V09", propOrder = {
    "ntfctnGnlInf",
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
...
public class DTCCCANOCSDDataSD1V09 {

    @XmlElement(name = "NtfctnGnlInf")
    protected CorporateActionNotificationSD3 ntfctnGnlInf;
    @XmlElement(name = "CorpActnGnlInf")
    protected CorporateActionGeneralInformationSD23 corpActnGnlInf;
    @XmlElement(name = "UndrlygScty")
    protected FinancialInstrumentAttributesSD14 undrlygScty;
    @XmlElement(name = "CorpActnDtls")
    protected CorporateActionSD14 corpActnDtls;
    ...
    protected List<CorporateActionDateSD7> optnDtDtls;
    @XmlElement(name = "SctiesMvmntDtls")
    protected List<SecuritiesOptionSD8> sctiesMvmntDtls;
    @XmlElement(name = "SctiesMvmntSctyDtls")
    protected List<FinancialInstrumentAttributesSD13> sctiesMvmntSctyDtls;
    ...
    protected List<CashOptionSD10> cshMvmntDtls;
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V09 setNtfctnGnlInf(CorporateActionNotificationSD3 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformationSD23 }
     *     
     */
    public CorporateActionGeneralInformationSD23 getCorpActnGnlInf() {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V09 setCorpActnGnlInf(CorporateActionGeneralInformationSD23 value) {
     ...
     * @return
     *     possible object is
     *     {@link FinancialInstrumentAttributesSD14 }
     *     
     */
    public FinancialInstrumentAttributesSD14 getUndrlygScty() {
        return undrlygScty;
    }
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V09 setUndrlygScty(FinancialInstrumentAttributesSD14 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionSD14 }
     *     
     */
    public CorporateActionSD14 getCorpActnDtls() {
        return corpActnDtls;
    }
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V09 setCorpActnDtls(CorporateActionSD14 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V09 setCorpActnDtDtls(CorporateActionDateSD5 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V09 setCorpActnPricDtls(CorporateActionPriceSD3 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V09 setCorpActnPrdDtls(CorporateActionPeriodSD2 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V09 setCorpActnRateAndAmtDtls(CorporateActionRateSD5 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V09 setCorpActnSctiesQty(CorporateActionQuantitySD1 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CorporateActionDateSD7 }
     * 
     * 
     */
    public List<CorporateActionDateSD7> getOptnDtDtls() {
        if (optnDtDtls == null) {
            optnDtDtls = new ArrayList<CorporateActionDateSD7>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FinancialInstrumentAttributesSD13 }
     * 
     * 
     */
    public List<FinancialInstrumentAttributesSD13> getSctiesMvmntSctyDtls() {
        if (sctiesMvmntSctyDtls == null) {
            sctiesMvmntSctyDtls = new ArrayList<FinancialInstrumentAttributesSD13>();
        }
     ...
     * 
     */
    public List<CashOptionSD10> getCshMvmntDtls() {
        if (cshMvmntDtls == null) {
            cshMvmntDtls = new ArrayList<CashOptionSD10>();
        }
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V09 addOptnDtls(CorporateActionOptionSD10 optnDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V09 addOptnDtDtls(CorporateActionDateSD7 optnDtDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V09 addSctiesMvmntDtls(SecuritiesOptionSD8 sctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V09 addSctiesMvmntSctyDtls(FinancialInstrumentAttributesSD13 sctiesMvmntSctyDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V09 addSctiesMvmntRateDtls(CorporateActionRateSD8 sctiesMvmntRateDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V09 addSctiesMvmntCshInLieuDtls(CorporateActionPriceSD1 sctiesMvmntCshInLieuDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V09 addSctiesMvmntFrctnDspstn(FractionDispositionTypeSD2 sctiesMvmntFrctnDspstn) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V09 addCshMvmntDtls(CashOptionSD10 cshMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V09 addNewAgt(PartyIdentificationSD1 newAgt) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V09 addAgt(PartyIdentificationSD2 agt) {
        getAgt().add(agt);
        return this;
    }
