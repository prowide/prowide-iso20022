...
@XmlType(name = "DTCCCANOMarketDataSD1V04", propOrder = {
    "ntfctnGnlInf",
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
...
public class DTCCCANOMarketDataSD1V04 {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V04 setNtfctnGnlInf(CorporateActionNotificationSD3 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionNotificationSD7 }
     *     
     */
    public CorporateActionNotificationSD7 getCorpActnGnlInf() {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V04 setCorpActnGnlInf(CorporateActionNotificationSD7 value) {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V04 setUndrlygScty(FinancialInstrumentAttributesSD6 value) {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V04 setCorpActnDtls(CorporateActionSD1 value) {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V04 setCorpActnDtDtls(CorporateActionDateSD5 value) {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V04 setCorpActnPricDtls(CorporateActionPriceSD3 value) {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V04 setCorpActnPrdDtls(CorporateActionPeriodSD2 value) {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V04 setCorpActnSctiesQty(CorporateActionQuantitySD1 value) {
     ...
     *     
     */
    public DTCCCANOMarketDataSD1V04 setCorpActnRateAndAmtDtls(CorporateActionRateSD5 value) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V04 addOptnDtls(CorporateActionOptionSD1 optnDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V04 addSctiesMvmntDtls(SecuritiesOptionSD2 sctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V04 addSctiesMvmntSctyDtls(FinancialInstrumentAttributesSD3 sctiesMvmntSctyDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V04 addSctiesMvmntRateDtls(CorporateActionRateSD7 sctiesMvmntRateDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V04 addSctiesMvmntCshInLieuDtls(CorporateActionPriceSD2 sctiesMvmntCshInLieuDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V04 addSctiesMvmntFrctnDspstn(FractionDispositionTypeSD2 sctiesMvmntFrctnDspstn) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V04 addCshMvmntDtls(CashOptionSD2 cshMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V04 addAgt(PartyIdentificationSD2 agt) {
        getAgt().add(agt);
        return this;
    }
     ...
     * 
     */
    public DTCCCANOMarketDataSD1V04 addNewAgt(PartyIdentificationSD1 newAgt) {
