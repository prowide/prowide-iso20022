...
@XmlType(name = "CashOptionSD2", propOrder = {
    "plcAndNm",
...
public class CashOptionSD2 {
     ...
     *     
     */
    public CashOptionSD2 setPlcAndNm(String value) {
        this.plcAndNm = value;
        return this;
    }
     ...
     *     
     */
    public CashOptionSD2 setRinvstmtIncmClssfctn(ReinvestmentIncomeClassification1Code value) {
     ...
     *     
     */
    public CashOptionSD2 setDTCPayMtd(String value) {
     ...
     *     
     */
    public CashOptionSD2 setDTCPayOrdr(String value) {
     ...
     *     
     */
    public CashOptionSD2 setEntitlmntClctnMtd(DTCEntitlementCalculationMethod1Code value) {
     ...
     *     
     */
    public CashOptionSD2 setEstmtdRateFlg(Boolean value) {
     ...
     *     
     */
    public CashOptionSD2 setNRATaxRptblFlg(Boolean value) {
     ...
     *     
     */
    public CashOptionSD2 setPrtctChrgFlg(Boolean value) {
     ...
     *     
     */
    public CashOptionSD2 setCSDCshRate(PriceFormatSD1Choice value) {
     ...
     *     
     */
    public CashOptionSD2 setDTCFeeRate(PriceFormatSD1Choice value) {
     ...
     *     
     */
    public CashOptionSD2 setDTCUSTaxInstrPrd(Period3 value) {
