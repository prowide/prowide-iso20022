...
@XmlType(name = "CorporateActionSD1", propOrder = {
    "plcAndNm",
    "ntceTp",
    "evtCshVal",
    "nbOfShrsToBeIssd",
...
public class CorporateActionSD1 {
     ...
     *     
     */
    public CorporateActionSD1 setPlcAndNm(String value) {
        this.plcAndNm = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionSD1 setNtceTp(NoticeType1Code value) {
        this.ntceTp = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionSD1 setEvtCshVal(RestrictedFINActiveCurrencyAnd13DecimalAmount value) {
     ...
     *     
     */
    public CorporateActionSD1 setNbOfShrsToBeIssd(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionSD1 setTtlNbOfShrsOfferd(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionSD1 setCutOffDays(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionSD1 setDTCAutomtdOfferPrgm(DTCAutoOfferProgram1Code value) {
     ...
     *     
     */
    public CorporateActionSD1 setDTCRcyclCutOffInd(CutOff1Code value) {
     ...
     *     
     */
    public CorporateActionSD1 setLngShrtPmtInd(AccrualPeriodType1Code value) {
     ...
     *     
     */
    public CorporateActionSD1 setOvrsbcptTp(OversubscriptionType1Code value) {
     ...
     *     
     */
    public CorporateActionSD1 setCondlPmtAplblFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD1 setSlctnDealrFeeFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD1 setDTCCtdyElgblFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD1 setDTCReorgCtdyElgblFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD1 setDTCReorgDpstElgblFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD1 setSrrndrShrsToAgtFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD1 setStepUpPrvlgFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD1 setRghtsOvrsbcptFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD1 setRghtsRndUpPrvlgFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD1 setRghtsTrfblFlg(Boolean value) {
     ...
     * 
     */
    public CorporateActionSD1 addCertDtls(CorporateActionSD5 certDtls) {
