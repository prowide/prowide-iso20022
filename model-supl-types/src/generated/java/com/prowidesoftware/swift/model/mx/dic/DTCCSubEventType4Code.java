...
/**
 * <p>Java class for DTCCSubEventType4Code.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="DTCCSubEventType4Code"&gt;
 ...
 * 
 */
@XmlType(name = "DTCCSubEventType4Code")
@XmlEnum
public enum DTCCSubEventType4Code {
    ...
    DTCCSubEventType4Code(String v) {
        value = v;
    }
    ...
    public static DTCCSubEventType4Code fromValue(String v) {
        for (DTCCSubEventType4Code c: DTCCSubEventType4Code.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
