...
@XmlType(name = "CorporateActionSD22", propOrder = {
    "plcAndNm",
    "ntceTp",
    "evtCshVal",
    "nbOfShrsToBeIssd",
...
public class CorporateActionSD22 {
     ...
     *     
     */
    public CorporateActionSD22 setPlcAndNm(String value) {
        this.plcAndNm = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionSD22 setNtceTp(NoticeType1Code value) {
        this.ntceTp = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionSD22 setEvtCshVal(RestrictedFINActiveCurrencyAnd13DecimalAmount value) {
     ...
     *     
     */
    public CorporateActionSD22 setNbOfShrsToBeIssd(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionSD22 setTtlNbOfShrsOfferd(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionSD22 setCutOffDays(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionSD22 setDTCAutomtdOfferPrgm(DTCAutoOfferProgram1Code value) {
     ...
     *     
     */
    public CorporateActionSD22 setDTCRcyclCutOffInd(CutOff1Code value) {
     ...
     *     
     */
    public CorporateActionSD22 setLngShrtPmtInd(AccrualPeriodType1Code value) {
     ...
     *     
     */
    public CorporateActionSD22 setOvrsbcptTp(OversubscriptionType1Code value) {
     ...
     *     
     */
    public CorporateActionSD22 setCondlPmtAplblFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD22 setSlctnDealrFeeFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD22 setDTCCtdyElgblFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD22 setDTCReorgCtdyElgblFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD22 setDTCReorgDpstElgblFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD22 setSrrndrShrsToAgtFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD22 setStepUpPrvlgFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD22 setRghtsOvrsbcptFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD22 setRghtsRndUpPrvlgFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD22 setRghtsTrfblFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD22 setDsstrRghtsAplblFlg(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD22 setNonXmptAllwdInd(Boolean value) {
     ...
     *     
     */
    public CorporateActionSD22 setDTCInstrLckoutInd(InstructionLockoutType1Code value) {
     ...
     *     
     */
    public CorporateActionSD22 setEDSMsggCtryCd(String value) {
     ...
     *     
     */
    public CorporateActionSD22 setRDPRefNb(String value) {
        this.rdpRefNb = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionSD22 addCertDtls(CorporateActionSD15 certDtls) {
