...
@XmlType(name = "DTCCCAPASD1V07", propOrder = {
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnBalDtls",
    "corpActnDtls",
...
public class DTCCCAPASD1V07 {

    @XmlElement(name = "CorpActnGnlInf")
    protected CorporateActionGeneralInformationSD39 corpActnGnlInf;
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformationSD39 }
     *     
     */
    public CorporateActionGeneralInformationSD39 getCorpActnGnlInf() {
     ...
     *     
     */
    public DTCCCAPASD1V07 setCorpActnGnlInf(CorporateActionGeneralInformationSD39 value) {
     ...
     *     
     */
    public DTCCCAPASD1V07 setUndrlygScty(FinancialInstrumentAttributesSD17 value) {
     ...
     *     
     */
    public DTCCCAPASD1V07 setCorpActnBalDtls(CorporateActionBalanceSD4 value) {
     ...
     *     
     */
    public DTCCCAPASD1V07 setCorpActnDtls(CorporateActionSD18 value) {
     ...
     * 
     */
    public DTCCCAPASD1V07 addCorpActnMvmntSctiesMvmntDtls(CorporateActionMovementSecuritiesMovementDetailsSD5 corpActnMvmntSctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCAPASD1V07 addCorpActnMvmntCshMvmntDtls(CorporateActionMovementCashMovementDetailsSD5 corpActnMvmntCshMvmntDtls) {
     ...
     * 
     */
    public DTCCCAPASD1V07 addOptnTxDtls(OptionTransactionDetailsSD3 optnTxDtls) {
