...
@XmlType(name = "DTCCCACOSD1V08", propOrder = {
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
    "acctBal",
...
public class DTCCCACOSD1V08 {
     ...
     *     
     */
    public DTCCCACOSD1V08 setCorpActnGnlInf(CorporateActionGeneralInformationSD44 value) {
     ...
     *     
     */
    public DTCCCACOSD1V08 setUndrlygScty(FinancialInstrumentAttributesSD17 value) {
     ...
     *     
     */
    public DTCCCACOSD1V08 setCorpActnDtls(CorporateActionSD20 value) {
     ...
     *     
     */
    public DTCCCACOSD1V08 setCorpActnConfDtls(CorporateActionConfirmationDetailsSD2 value) {
     ...
     * 
     */
    public DTCCCACOSD1V08 addAcctBal(AccountBalanceSD14 acctBal) {
     ...
     * 
     */
    public DTCCCACOSD1V08 addCorpActnConfSctiesMvmntDtls(CorporateActionConfirmationSecuritiesMovementDetailsSD6 corpActnConfSctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCACOSD1V08 addCorpActnConfCshMvmntDtls(CorporateActionConfirmationCashMovementDetailsSD5 corpActnConfCshMvmntDtls) {
     ...
     * 
     */
    public DTCCCACOSD1V08 addOptnTxDtls(OptionTransactionSD6 optnTxDtls) {
