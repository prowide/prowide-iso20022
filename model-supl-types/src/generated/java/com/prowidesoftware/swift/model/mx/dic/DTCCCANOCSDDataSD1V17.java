...
@XmlType(name = "DTCCCANOCSDDataSD1V17", propOrder = {
    "ntfctnGnlInf",
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
...
public class DTCCCANOCSDDataSD1V17 {
    ...
    protected CorporateActionSD25 corpActnDtls;
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V17 setNtfctnGnlInf(CorporateActionNotificationSD9 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V17 setCorpActnGnlInf(CorporateActionGeneralInformationSD55 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V17 setUndrlygScty(FinancialInstrumentAttributesSD19 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionSD25 }
     *     
     */
    public CorporateActionSD25 getCorpActnDtls() {
        return corpActnDtls;
    }
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V17 setCorpActnDtls(CorporateActionSD25 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V17 setCorpActnDtDtls(CorporateActionDateSD10 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V17 setCorpActnPricDtls(CorporateActionPriceSD4 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V17 setCorpActnPrdDtls(CorporateActionPeriodSD3 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V17 setCorpActnRateAndAmtDtls(CorporateActionRateSD9 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V17 setCorpActnSctiesQty(CorporateActionQuantitySD3 value) {
    ...
    public List<CorporateActionOptionSD16> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<CorporateActionOptionSD16>();
        }
    ...
    public List<CashOptionSD14> getCshMvmntDtls() {
        if (cshMvmntDtls == null) {
            cshMvmntDtls = new ArrayList<CashOptionSD14>();
        }
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V17 addOptnDtls(CorporateActionOptionSD16 optnDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V17 addOptnDtDtls(CorporateActionDateSD11 optnDtDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V17 addSctiesMvmntDtls(SecuritiesOptionSD9 sctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V17 addSctiesMvmntSctyDtls(FinancialInstrumentAttributesSD16 sctiesMvmntSctyDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V17 addSctiesMvmntRateDtls(CorporateActionRateSD10 sctiesMvmntRateDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V17 addSctiesMvmntCshInLieuDtls(CorporateActionPriceSD5 sctiesMvmntCshInLieuDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V17 addSctiesMvmntFrctnDspstn(FractionDispositionTypeSD3 sctiesMvmntFrctnDspstn) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V17 addCshMvmntDtls(CashOptionSD14 cshMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V17 addNewAgt(PartyIdentificationSD5 newAgt) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V17 addAgt(PartyIdentificationSD6 agt) {
        getAgt().add(agt);
        return this;
    }
