...
/**
 * <p>Java class for DTCCSubEventType6Code.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="DTCCSubEventType6Code"&gt;
...
public enum DTCCSubEventType6Code {
    ...
    DTCCSubEventType6Code(String v) {
        value = v;
    }
    ...
    public static DTCCSubEventType6Code fromValue(String v) {
        for (DTCCSubEventType6Code c: DTCCSubEventType6Code.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
