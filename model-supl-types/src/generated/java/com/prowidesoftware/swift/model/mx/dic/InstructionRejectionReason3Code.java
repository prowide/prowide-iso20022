...
/**
 * <p>Java class for InstructionRejectionReason3Code.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="InstructionRejectionReason3Code"&gt;
...
public enum InstructionRejectionReason3Code {
    ...
    InstructionRejectionReason3Code(String v) {
        value = v;
    }
    ...
    public static InstructionRejectionReason3Code fromValue(String v) {
        for (InstructionRejectionReason3Code c: InstructionRejectionReason3Code.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
