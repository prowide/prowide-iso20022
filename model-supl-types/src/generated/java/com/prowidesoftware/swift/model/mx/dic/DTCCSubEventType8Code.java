...
/**
 * <p>Java class for DTCCSubEventType8Code.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="DTCCSubEventType8Code"&gt;
 ...
 * 
 */
@XmlType(name = "DTCCSubEventType8Code")
@XmlEnum
public enum DTCCSubEventType8Code {
    ...
    DTCCSubEventType8Code(String v) {
        value = v;
    }
    ...
    public static DTCCSubEventType8Code fromValue(String v) {
        for (DTCCSubEventType8Code c: DTCCSubEventType8Code.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
