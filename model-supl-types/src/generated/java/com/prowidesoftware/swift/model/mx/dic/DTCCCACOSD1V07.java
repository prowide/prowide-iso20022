...
@XmlType(name = "DTCCCACOSD1V07", propOrder = {
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
    "acctBal",
...
public class DTCCCACOSD1V07 {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformationSD37 }
     *     
     */
     ...
     *     
     */
    public DTCCCACOSD1V07 setCorpActnGnlInf(CorporateActionGeneralInformationSD37 value) {
     ...
     *     
     */
    public DTCCCACOSD1V07 setUndrlygScty(FinancialInstrumentAttributesSD17 value) {
     ...
     *     
     */
    public DTCCCACOSD1V07 setCorpActnDtls(CorporateActionSD20 value) {
     ...
     *     
     */
    public DTCCCACOSD1V07 setCorpActnConfDtls(CorporateActionConfirmationDetailsSD2 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link OptionTransactionSD5 }
     * 
     * 
     */
    public List<OptionTransactionSD5> getOptnTxDtls() {
        if (optnTxDtls == null) {
            optnTxDtls = new ArrayList<OptionTransactionSD5>();
        }
     ...
     * 
     */
    public DTCCCACOSD1V07 addAcctBal(AccountBalanceSD14 acctBal) {
     ...
     * 
     */
    public DTCCCACOSD1V07 addCorpActnConfSctiesMvmntDtls(CorporateActionConfirmationSecuritiesMovementDetailsSD6 corpActnConfSctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCACOSD1V07 addCorpActnConfCshMvmntDtls(CorporateActionConfirmationCashMovementDetailsSD5 corpActnConfCshMvmntDtls) {
     ...
     * 
     */
    public DTCCCACOSD1V07 addOptnTxDtls(OptionTransactionSD5 optnTxDtls) {
