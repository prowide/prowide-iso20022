...
@XmlType(name = "DTCCCANOCSDDataSD1V13", propOrder = {
    "ntfctnGnlInf",
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
...
public class DTCCCANOCSDDataSD1V13 {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V13 setNtfctnGnlInf(CorporateActionNotificationSD9 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V13 setCorpActnGnlInf(CorporateActionGeneralInformationSD41 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V13 setUndrlygScty(FinancialInstrumentAttributesSD19 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V13 setCorpActnDtls(CorporateActionSD22 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V13 setCorpActnDtDtls(CorporateActionDateSD10 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V13 setCorpActnPricDtls(CorporateActionPriceSD4 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V13 setCorpActnPrdDtls(CorporateActionPeriodSD3 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V13 setCorpActnRateAndAmtDtls(CorporateActionRateSD9 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V13 setCorpActnSctiesQty(CorporateActionQuantitySD3 value) {
    ...
    public List<CashOptionSD12> getCshMvmntDtls() {
        if (cshMvmntDtls == null) {
            cshMvmntDtls = new ArrayList<CashOptionSD12>();
        }
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V13 addOptnDtls(CorporateActionOptionSD14 optnDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V13 addOptnDtDtls(CorporateActionDateSD11 optnDtDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V13 addSctiesMvmntDtls(SecuritiesOptionSD9 sctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V13 addSctiesMvmntSctyDtls(FinancialInstrumentAttributesSD16 sctiesMvmntSctyDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V13 addSctiesMvmntRateDtls(CorporateActionRateSD10 sctiesMvmntRateDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V13 addSctiesMvmntCshInLieuDtls(CorporateActionPriceSD5 sctiesMvmntCshInLieuDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V13 addSctiesMvmntFrctnDspstn(FractionDispositionTypeSD3 sctiesMvmntFrctnDspstn) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V13 addCshMvmntDtls(CashOptionSD12 cshMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V13 addNewAgt(PartyIdentificationSD5 newAgt) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V13 addAgt(PartyIdentificationSD6 agt) {
        getAgt().add(agt);
        return this;
    }
