...
@XmlType(name = "DTCCCAPASD1V09", propOrder = {
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnBalDtls",
    "corpActnDtls",
...
public class DTCCCAPASD1V09 {
     ...
     *     
     */
    public DTCCCAPASD1V09 setCorpActnGnlInf(CorporateActionGeneralInformationSD43 value) {
     ...
     *     
     */
    public DTCCCAPASD1V09 setUndrlygScty(FinancialInstrumentAttributesSD21 value) {
     ...
     *     
     */
    public DTCCCAPASD1V09 setCorpActnBalDtls(CorporateActionBalanceSD4 value) {
     ...
     *     
     */
    public DTCCCAPASD1V09 setCorpActnDtls(CorporateActionSD18 value) {
     ...
     * 
     */
    public DTCCCAPASD1V09 addCorpActnMvmntSctiesMvmntDtls(CorporateActionMovementSecuritiesMovementDetailsSD5 corpActnMvmntSctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCAPASD1V09 addCorpActnMvmntCshMvmntDtls(CorporateActionMovementCashMovementDetailsSD5 corpActnMvmntCshMvmntDtls) {
     ...
     * 
     */
    public DTCCCAPASD1V09 addOptnTxDtls(OptionTransactionDetailsSD3 optnTxDtls) {
