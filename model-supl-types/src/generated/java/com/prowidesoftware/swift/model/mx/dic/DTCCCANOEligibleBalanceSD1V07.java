...
@XmlType(name = "DTCCCANOEligibleBalanceSD1V07", propOrder = {
    "corpActnGnlInf",
    "undrlygScty",
    "dstrbtnAcctBal",
    "redAcctBal",
...
public class DTCCCANOEligibleBalanceSD1V07 {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V07 setCorpActnGnlInf(CorporateActionGeneralInformationSD30 value) {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V07 setUndrlygScty(FinancialInstrumentAttributesSD17 value) {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V07 setRedAcctBal(AccountBalanceSD11 value) {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V07 setReorgAcctBal(AccountBalanceSD12 value) {
     ...
     * 
     */
    public DTCCCANOEligibleBalanceSD1V07 addDstrbtnAcctBal(AccountBalanceSD10 dstrbtnAcctBal) {
