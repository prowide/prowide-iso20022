...
@XmlType(name = "DTCCCANOEligibleBalanceSD1V08", propOrder = {
    "corpActnGnlInf",
    "undrlygScty",
    "dstrbtnAcctBal",
    "redAcctBal",
...
public class DTCCCANOEligibleBalanceSD1V08 {

    @XmlElement(name = "CorpActnGnlInf")
    protected CorporateActionGeneralInformationSD38 corpActnGnlInf;
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformationSD38 }
     *     
     */
    public CorporateActionGeneralInformationSD38 getCorpActnGnlInf() {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V08 setCorpActnGnlInf(CorporateActionGeneralInformationSD38 value) {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V08 setUndrlygScty(FinancialInstrumentAttributesSD17 value) {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V08 setRedAcctBal(AccountBalanceSD11 value) {
     ...
     *     
     */
    public DTCCCANOEligibleBalanceSD1V08 setReorgAcctBal(AccountBalanceSD12 value) {
     ...
     * 
     */
    public DTCCCANOEligibleBalanceSD1V08 addDstrbtnAcctBal(AccountBalanceSD10 dstrbtnAcctBal) {
