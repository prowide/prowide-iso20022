...
@XmlType(name = "DTCCCANOCSDDataSD1V18", propOrder = {
    "ntfctnGnlInf",
    "corpActnGnlInf",
    "undrlygScty",
    "corpActnDtls",
...
public class DTCCCANOCSDDataSD1V18 {
    ...
    protected List<CorporateActionOptionSD16> optnDtls;
    ...
    protected List<CorporateActionRateSD12> sctiesMvmntRateDtls;
    ...
    protected List<CashOptionSD14> cshMvmntDtls;
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V18 setNtfctnGnlInf(CorporateActionNotificationSD9 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformationSD55 }
     *     
     */
    public CorporateActionGeneralInformationSD55 getCorpActnGnlInf() {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V18 setCorpActnGnlInf(CorporateActionGeneralInformationSD55 value) {
     ...
     * @return
     *     possible object is
     *     {@link FinancialInstrumentAttributesSD19 }
     *     
     */
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V18 setUndrlygScty(FinancialInstrumentAttributesSD19 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionSD27 }
     *     
     */
    public CorporateActionSD27 getCorpActnDtls() {
        return corpActnDtls;
    }
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V18 setCorpActnDtls(CorporateActionSD27 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V18 setCorpActnDtDtls(CorporateActionDateSD10 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V18 setCorpActnPricDtls(CorporateActionPriceSD4 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V18 setCorpActnPrdDtls(CorporateActionPeriodSD3 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V18 setCorpActnRateAndAmtDtls(CorporateActionRateSD9 value) {
     ...
     *     
     */
    public DTCCCANOCSDDataSD1V18 setCorpActnSctiesQty(CorporateActionQuantitySD3 value) {
     ...
     * {@link CorporateActionOptionSD16 }
     * 
     * 
     * @return
     *     The value of the optnDtls property.
     */
    public List<CorporateActionOptionSD16> getOptnDtls() {
        if (optnDtls == null) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CorporateActionRateSD12 }
     * 
     * 
     * @return
     *     The value of the sctiesMvmntRateDtls property.
     */
    public List<CorporateActionRateSD12> getSctiesMvmntRateDtls() {
     ...
     */
    public List<CashOptionSD14> getCshMvmntDtls() {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V18 addOptnDtls(CorporateActionOptionSD16 optnDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V18 addOptnDtDtls(CorporateActionDateSD11 optnDtDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V18 addSctiesMvmntDtls(SecuritiesOptionSD9 sctiesMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V18 addSctiesMvmntSctyDtls(FinancialInstrumentAttributesSD16 sctiesMvmntSctyDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V18 addSctiesMvmntRateDtls(CorporateActionRateSD12 sctiesMvmntRateDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V18 addSctiesMvmntCshInLieuDtls(CorporateActionPriceSD5 sctiesMvmntCshInLieuDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V18 addSctiesMvmntFrctnDspstn(FractionDispositionTypeSD3 sctiesMvmntFrctnDspstn) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V18 addCshMvmntDtls(CashOptionSD14 cshMvmntDtls) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V18 addNewAgt(PartyIdentificationSD5 newAgt) {
     ...
     * 
     */
    public DTCCCANOCSDDataSD1V18 addAgt(PartyIdentificationSD6 agt) {
        getAgt().add(agt);
        return this;
    }
