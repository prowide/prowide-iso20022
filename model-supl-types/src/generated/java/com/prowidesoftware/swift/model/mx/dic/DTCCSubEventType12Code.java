...
/**
 * <p>Java class for DTCCSubEventType12Code.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <pre>{@code
 * <simpleType name="DTCCSubEventType12Code">
 ...
 * 
 */
@XmlType(name = "DTCCSubEventType12Code")
@XmlEnum
public enum DTCCSubEventType12Code {
    ...
    DTCCSubEventType12Code(String v) {
        value = v;
    }
    ...
    public static DTCCSubEventType12Code fromValue(String v) {
        for (DTCCSubEventType12Code c: DTCCSubEventType12Code.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
