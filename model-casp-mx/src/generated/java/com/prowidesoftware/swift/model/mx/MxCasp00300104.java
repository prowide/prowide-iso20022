    ...
    extends AbstractMX
{
    ...
    public static MxCasp00300104 parse(String xml) {
        return ((MxCasp00300104) MxReadImpl.parse(MxCasp00300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00300104) MxReadImpl.parse(MxCasp00300104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00300104 .class);
    }
