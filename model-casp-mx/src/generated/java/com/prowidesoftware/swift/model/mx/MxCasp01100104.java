    ...
    extends AbstractMX
{
    ...
    public static MxCasp01100104 parse(String xml) {
        return ((MxCasp01100104) MxReadImpl.parse(MxCasp01100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01100104) MxReadImpl.parse(MxCasp01100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01100104 .class);
    }
