...
/**
 * Class for casp.011.001.04 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCasp01100104(final String xml) {
        this();
        MxCasp01100104 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01100104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIAbortV04 }
     *     
     */
    public SaleToPOIAbortV04 getSaleToPOIAbrt() {
     ...
     *     
     */
    public MxCasp01100104 setSaleToPOIAbrt(SaleToPOIAbortV04 value) {
     ...
     * 
     */
    public static MxCasp01100104 parse(String xml) {
        return ((MxCasp01100104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01100104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01100104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01100104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01100104 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01100104) parserImpl.read(MxCasp01100104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01100104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01100104 message
     * @return
     *     a new instance of MxCasp01100104
     */
    public final static MxCasp01100104 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01100104 .class);
    }
