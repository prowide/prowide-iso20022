    ...
    extends AbstractMX
{
    ...
    public static MxCasp00200106 parse(String xml) {
        return ((MxCasp00200106) MxReadImpl.parse(MxCasp00200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00200106) MxReadImpl.parse(MxCasp00200106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00200106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00200106 .class);
    }
