    ...
    extends AbstractMX
{
    ...
    public static MxCasp00400106 parse(String xml) {
        return ((MxCasp00400106) MxReadImpl.parse(MxCasp00400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00400106) MxReadImpl.parse(MxCasp00400106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00400106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00400106 .class);
    }
