    ...
    extends AbstractMX
{
    ...
    public static MxCasp00900102 parse(String xml) {
        return ((MxCasp00900102) MxReadImpl.parse(MxCasp00900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00900102) MxReadImpl.parse(MxCasp00900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00900102 .class);
    }
