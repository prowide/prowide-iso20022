    ...
    extends AbstractMX
{
    ...
    public static MxCasp00300107 parse(String xml) {
        return ((MxCasp00300107) MxReadImpl.parse(MxCasp00300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00300107) MxReadImpl.parse(MxCasp00300107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00300107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00300107 .class);
    }
