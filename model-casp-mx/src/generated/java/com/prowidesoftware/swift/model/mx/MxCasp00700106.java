    ...
    extends AbstractMX
{
    ...
    public static MxCasp00700106 parse(String xml) {
        return ((MxCasp00700106) MxReadImpl.parse(MxCasp00700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00700106) MxReadImpl.parse(MxCasp00700106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00700106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00700106 .class);
    }
