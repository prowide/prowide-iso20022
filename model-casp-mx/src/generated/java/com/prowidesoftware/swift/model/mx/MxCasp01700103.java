    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casp.017.001.03";
    ...
    public static MxCasp01700103 parse(String xml) {
        return ((MxCasp01700103) MxReadImpl.parse(MxCasp01700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01700103) MxReadImpl.parse(MxCasp01700103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasp01700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01700103 .class);
    }
