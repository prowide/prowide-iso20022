    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casp.004.001.03";
    ...
    public static MxCasp00400103 parse(String xml) {
        return ((MxCasp00400103) MxReadImpl.parse(MxCasp00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00400103) MxReadImpl.parse(MxCasp00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasp00400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00400103 .class);
    }
