...
/**
 * Class for casp.003.001.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCasp00300101(final String xml) {
        this();
        MxCasp00300101 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp00300101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIReconciliationRequestV01 }
     *     
     */
    public SaleToPOIReconciliationRequestV01 getSaleToPOIRcncltnReq() {
     ...
     *     
     */
    public MxCasp00300101 setSaleToPOIRcncltnReq(SaleToPOIReconciliationRequestV01 value) {
     ...
     * 
     */
    public static MxCasp00300101 parse(String xml) {
        return ((MxCasp00300101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp00300101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00300101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp00300101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp00300101 parse(String xml, MxRead parserImpl) {
        return ((MxCasp00300101) parserImpl.read(MxCasp00300101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp00300101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp00300101 message
     * @return
     *     a new instance of MxCasp00300101
     */
    public final static MxCasp00300101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp00300101 .class);
    }
