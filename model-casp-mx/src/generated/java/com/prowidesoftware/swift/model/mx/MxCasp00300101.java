    ...
    extends AbstractMX
{
    ...
    public static MxCasp00300101 parse(String xml) {
        return ((MxCasp00300101) MxReadImpl.parse(MxCasp00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00300101) MxReadImpl.parse(MxCasp00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00300101 .class);
    }
