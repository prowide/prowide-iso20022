...
/**
 * Class for casp.015.001.06 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.015.001.06")
public class MxCasp01500106
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIMsgStsRspn", required = true)
    protected SaleToPOIMessageStatusResponseV06 saleToPOIMsgStsRspn;
     ...
     * 
     */
    public MxCasp01500106(final String xml) {
        this();
        MxCasp01500106 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01500106(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIMessageStatusResponseV06 }
     *     
     */
    public SaleToPOIMessageStatusResponseV06 getSaleToPOIMsgStsRspn() {
     ...
     *     
     */
    public MxCasp01500106 setSaleToPOIMsgStsRspn(SaleToPOIMessageStatusResponseV06 value) {
     ...
     * 
     */
    public static MxCasp01500106 parse(String xml) {
        return ((MxCasp01500106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01500106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01500106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01500106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01500106 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01500106) parserImpl.read(MxCasp01500106 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01500106 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01500106 message
     * @return
     *     a new instance of MxCasp01500106
     */
    public static final MxCasp01500106 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01500106 .class);
    }
