    ...
    extends AbstractMX
{
    ...
    public static MxCasp01500106 parse(String xml) {
        return ((MxCasp01500106) MxReadImpl.parse(MxCasp01500106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01500106) MxReadImpl.parse(MxCasp01500106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01500106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01500106 .class);
    }
