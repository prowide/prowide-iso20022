    ...
    extends AbstractMX
{
    ...
    public static MxCasp00600101 parse(String xml) {
        return ((MxCasp00600101) MxReadImpl.parse(MxCasp00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00600101) MxReadImpl.parse(MxCasp00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00600101 .class);
    }
