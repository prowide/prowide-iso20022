    ...
    extends AbstractMX
{
    ...
    public static MxCasp00800104 parse(String xml) {
        return ((MxCasp00800104) MxReadImpl.parse(MxCasp00800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00800104) MxReadImpl.parse(MxCasp00800104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00800104 .class);
    }
