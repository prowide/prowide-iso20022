    ...
    extends AbstractMX
{
    ...
    public static MxCasp00800102 parse(String xml) {
        return ((MxCasp00800102) MxReadImpl.parse(MxCasp00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00800102) MxReadImpl.parse(MxCasp00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00800102 .class);
    }
