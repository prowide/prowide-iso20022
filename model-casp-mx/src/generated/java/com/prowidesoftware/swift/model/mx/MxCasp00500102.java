    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casp.005.001.02";
    ...
    public static MxCasp00500102 parse(String xml) {
        return ((MxCasp00500102) MxReadImpl.parse(MxCasp00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00500102) MxReadImpl.parse(MxCasp00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasp00500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00500102 .class);
    }
