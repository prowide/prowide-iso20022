    ...
    extends AbstractMX
{
    ...
    public static MxCasp01600102 parse(String xml) {
        return ((MxCasp01600102) MxReadImpl.parse(MxCasp01600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01600102) MxReadImpl.parse(MxCasp01600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01600102 .class);
    }
