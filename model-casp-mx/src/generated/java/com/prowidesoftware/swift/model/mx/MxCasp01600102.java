...
/**
 * Class for casp.016.001.02 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.016.001.02")
public class MxCasp01600102
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIDvcReq", required = true)
    protected SaleToPOIDeviceRequestV02 saleToPOIDvcReq;
     ...
     * 
     */
    public MxCasp01600102(final String xml) {
        this();
        MxCasp01600102 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01600102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIDeviceRequestV02 }
     *     
     */
    public SaleToPOIDeviceRequestV02 getSaleToPOIDvcReq() {
     ...
     *     
     */
    public MxCasp01600102 setSaleToPOIDvcReq(SaleToPOIDeviceRequestV02 value) {
     ...
     * 
     */
    public static MxCasp01600102 parse(String xml) {
        return ((MxCasp01600102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01600102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01600102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01600102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01600102 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01600102) parserImpl.read(MxCasp01600102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01600102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01600102 message
     * @return
     *     a new instance of MxCasp01600102
     */
    public final static MxCasp01600102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01600102 .class);
    }
