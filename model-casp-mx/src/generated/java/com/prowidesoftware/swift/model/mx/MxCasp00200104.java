    ...
    extends AbstractMX
{
    ...
    public static MxCasp00200104 parse(String xml) {
        return ((MxCasp00200104) MxReadImpl.parse(MxCasp00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00200104) MxReadImpl.parse(MxCasp00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00200104 .class);
    }
