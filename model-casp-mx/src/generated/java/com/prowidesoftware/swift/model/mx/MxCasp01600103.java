    ...
    extends AbstractMX
{
    ...
    public static MxCasp01600103 parse(String xml) {
        return ((MxCasp01600103) MxReadImpl.parse(MxCasp01600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01600103) MxReadImpl.parse(MxCasp01600103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01600103 .class);
    }
