    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casp.015.001.07";
    ...
    public static MxCasp01500107 parse(String xml) {
        return ((MxCasp01500107) MxReadImpl.parse(MxCasp01500107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01500107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01500107) MxReadImpl.parse(MxCasp01500107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasp01500107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01500107 .class);
    }
