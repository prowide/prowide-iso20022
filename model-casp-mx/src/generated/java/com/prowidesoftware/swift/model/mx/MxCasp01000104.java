    ...
    extends AbstractMX
{
    ...
    public static MxCasp01000104 parse(String xml) {
        return ((MxCasp01000104) MxReadImpl.parse(MxCasp01000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01000104) MxReadImpl.parse(MxCasp01000104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01000104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01000104 .class);
    }
