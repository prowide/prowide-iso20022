    ...
    extends AbstractMX
{
    ...
    public static MxCasp00300106 parse(String xml) {
        return ((MxCasp00300106) MxReadImpl.parse(MxCasp00300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00300106) MxReadImpl.parse(MxCasp00300106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00300106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00300106 .class);
    }
