    ...
    extends AbstractMX
{
    ...
    public static MxCasp01700105 parse(String xml) {
        return ((MxCasp01700105) MxReadImpl.parse(MxCasp01700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01700105) MxReadImpl.parse(MxCasp01700105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01700105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01700105 .class);
    }
