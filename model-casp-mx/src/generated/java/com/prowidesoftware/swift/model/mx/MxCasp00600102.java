    ...
    extends AbstractMX
{
    ...
    public static MxCasp00600102 parse(String xml) {
        return ((MxCasp00600102) MxReadImpl.parse(MxCasp00600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00600102) MxReadImpl.parse(MxCasp00600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00600102 .class);
    }
