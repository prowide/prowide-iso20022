...
/**
 * Class for casp.014.001.02 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.014.001.02")
public class MxCasp01400102
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIMsgStsReq", required = true)
    protected SaleToPOIMessageStatusRequestV02 saleToPOIMsgStsReq;
     ...
     * 
     */
    public MxCasp01400102(final String xml) {
        this();
        MxCasp01400102 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01400102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIMessageStatusRequestV02 }
     *     
     */
    public SaleToPOIMessageStatusRequestV02 getSaleToPOIMsgStsReq() {
     ...
     *     
     */
    public MxCasp01400102 setSaleToPOIMsgStsReq(SaleToPOIMessageStatusRequestV02 value) {
     ...
     * 
     */
    public static MxCasp01400102 parse(String xml) {
        return ((MxCasp01400102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01400102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01400102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01400102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01400102 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01400102) parserImpl.read(MxCasp01400102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01400102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01400102 message
     * @return
     *     a new instance of MxCasp01400102
     */
    public static final MxCasp01400102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01400102 .class);
    }
