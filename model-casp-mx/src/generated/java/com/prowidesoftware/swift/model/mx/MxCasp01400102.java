    ...
    extends AbstractMX
{
    ...
    public static MxCasp01400102 parse(String xml) {
        return ((MxCasp01400102) MxReadImpl.parse(MxCasp01400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01400102) MxReadImpl.parse(MxCasp01400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01400102 .class);
    }
