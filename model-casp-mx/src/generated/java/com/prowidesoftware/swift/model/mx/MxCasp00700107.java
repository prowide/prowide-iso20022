    ...
    extends AbstractMX
{
    ...
    public static MxCasp00700107 parse(String xml) {
        return ((MxCasp00700107) MxReadImpl.parse(MxCasp00700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00700107) MxReadImpl.parse(MxCasp00700107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00700107 .class);
    }
