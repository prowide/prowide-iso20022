    ...
    extends AbstractMX
{
    ...
    public static MxCasp00500107 parse(String xml) {
        return ((MxCasp00500107) MxReadImpl.parse(MxCasp00500107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00500107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00500107) MxReadImpl.parse(MxCasp00500107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00500107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00500107 .class);
    }
