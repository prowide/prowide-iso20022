...
/**
 * Class for casp.015.001.02 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.015.001.02")
public class MxCasp01500102
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIMsgStsRspn", required = true)
    protected SaleToPOIMessageStatusResponseV02 saleToPOIMsgStsRspn;
     ...
     * 
     */
    public MxCasp01500102(final String xml) {
        this();
        MxCasp01500102 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01500102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIMessageStatusResponseV02 }
     *     
     */
    public SaleToPOIMessageStatusResponseV02 getSaleToPOIMsgStsRspn() {
     ...
     *     
     */
    public MxCasp01500102 setSaleToPOIMsgStsRspn(SaleToPOIMessageStatusResponseV02 value) {
     ...
     * 
     */
    public static MxCasp01500102 parse(String xml) {
        return ((MxCasp01500102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01500102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01500102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01500102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01500102 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01500102) parserImpl.read(MxCasp01500102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01500102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01500102 message
     * @return
     *     a new instance of MxCasp01500102
     */
    public static final MxCasp01500102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01500102 .class);
    }
