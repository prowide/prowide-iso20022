    ...
    extends AbstractMX
{
    ...
    public static MxCasp01500102 parse(String xml) {
        return ((MxCasp01500102) MxReadImpl.parse(MxCasp01500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01500102) MxReadImpl.parse(MxCasp01500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01500102 .class);
    }
