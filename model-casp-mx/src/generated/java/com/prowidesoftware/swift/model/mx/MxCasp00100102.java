    ...
    extends AbstractMX
{
    ...
    public static MxCasp00100102 parse(String xml) {
        return ((MxCasp00100102) MxReadImpl.parse(MxCasp00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00100102) MxReadImpl.parse(MxCasp00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00100102 .class);
    }
