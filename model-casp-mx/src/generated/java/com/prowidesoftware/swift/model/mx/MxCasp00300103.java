...
/**
 * Class for casp.003.001.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCasp00300103(final String xml) {
        this();
        MxCasp00300103 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp00300103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIReconciliationRequestV03 }
     *     
     */
    public SaleToPOIReconciliationRequestV03 getSaleToPOIRcncltnReq() {
     ...
     *     
     */
    public MxCasp00300103 setSaleToPOIRcncltnReq(SaleToPOIReconciliationRequestV03 value) {
     ...
     * 
     */
    public static MxCasp00300103 parse(String xml) {
        return ((MxCasp00300103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp00300103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00300103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp00300103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp00300103 parse(String xml, MxRead parserImpl) {
        return ((MxCasp00300103) parserImpl.read(MxCasp00300103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp00300103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp00300103 message
     * @return
     *     a new instance of MxCasp00300103
     */
    public final static MxCasp00300103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp00300103 .class);
    }
