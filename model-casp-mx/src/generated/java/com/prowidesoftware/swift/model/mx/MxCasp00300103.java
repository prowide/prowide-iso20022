    ...
    extends AbstractMX
{
    ...
    public static MxCasp00300103 parse(String xml) {
        return ((MxCasp00300103) MxReadImpl.parse(MxCasp00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00300103) MxReadImpl.parse(MxCasp00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00300103 .class);
    }
