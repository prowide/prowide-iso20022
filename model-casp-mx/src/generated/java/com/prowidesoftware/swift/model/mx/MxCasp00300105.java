    ...
    extends AbstractMX
{
    ...
    public static MxCasp00300105 parse(String xml) {
        return ((MxCasp00300105) MxReadImpl.parse(MxCasp00300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00300105) MxReadImpl.parse(MxCasp00300105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00300105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00300105 .class);
    }
