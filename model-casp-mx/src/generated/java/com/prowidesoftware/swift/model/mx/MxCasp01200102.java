...
/**
 * Class for casp.012.001.02 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.012.001.02")
public class MxCasp01200102
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIEvtNtfctn", required = true)
    protected SaleToPOIEventNotificationV02 saleToPOIEvtNtfctn;
     ...
     * 
     */
    public MxCasp01200102(final String xml) {
        this();
        MxCasp01200102 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01200102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIEventNotificationV02 }
     *     
     */
    public SaleToPOIEventNotificationV02 getSaleToPOIEvtNtfctn() {
     ...
     *     
     */
    public MxCasp01200102 setSaleToPOIEvtNtfctn(SaleToPOIEventNotificationV02 value) {
     ...
     * 
     */
    public static MxCasp01200102 parse(String xml) {
        return ((MxCasp01200102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01200102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01200102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01200102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01200102 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01200102) parserImpl.read(MxCasp01200102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01200102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01200102 message
     * @return
     *     a new instance of MxCasp01200102
     */
    public final static MxCasp01200102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01200102 .class);
    }
