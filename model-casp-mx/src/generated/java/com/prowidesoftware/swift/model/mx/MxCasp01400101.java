    ...
    extends AbstractMX
{
    ...
    public static MxCasp01400101 parse(String xml) {
        return ((MxCasp01400101) MxReadImpl.parse(MxCasp01400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01400101) MxReadImpl.parse(MxCasp01400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01400101 .class);
    }
