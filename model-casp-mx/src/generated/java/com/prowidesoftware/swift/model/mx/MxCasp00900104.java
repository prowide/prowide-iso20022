    ...
    extends AbstractMX
{
    ...
    public static MxCasp00900104 parse(String xml) {
        return ((MxCasp00900104) MxReadImpl.parse(MxCasp00900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00900104) MxReadImpl.parse(MxCasp00900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00900104 .class);
    }
