    ...
    extends AbstractMX
{
    ...
    public static MxCasp00400104 parse(String xml) {
        return ((MxCasp00400104) MxReadImpl.parse(MxCasp00400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00400104) MxReadImpl.parse(MxCasp00400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00400104 .class);
    }
