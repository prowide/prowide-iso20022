    ...
    extends AbstractMX
{
    ...
    public static MxCasp00500103 parse(String xml) {
        return ((MxCasp00500103) MxReadImpl.parse(MxCasp00500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00500103) MxReadImpl.parse(MxCasp00500103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00500103 .class);
    }
