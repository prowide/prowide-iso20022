    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casp.003.001.02";
    ...
    public static MxCasp00300102 parse(String xml) {
        return ((MxCasp00300102) MxReadImpl.parse(MxCasp00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00300102) MxReadImpl.parse(MxCasp00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasp00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00300102 .class);
    }
