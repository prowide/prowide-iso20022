    ...
    extends AbstractMX
{
    ...
    public static MxCasp00900105 parse(String xml) {
        return ((MxCasp00900105) MxReadImpl.parse(MxCasp00900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00900105) MxReadImpl.parse(MxCasp00900105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00900105 .class);
    }
