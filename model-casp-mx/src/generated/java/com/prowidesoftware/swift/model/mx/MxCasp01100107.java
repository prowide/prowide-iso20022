    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casp.011.001.07";
    ...
    public static MxCasp01100107 parse(String xml) {
        return ((MxCasp01100107) MxReadImpl.parse(MxCasp01100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01100107) MxReadImpl.parse(MxCasp01100107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasp01100107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01100107 .class);
    }
