    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casp.013.001.02";
    ...
    public static MxCasp01300102 parse(String xml) {
        return ((MxCasp01300102) MxReadImpl.parse(MxCasp01300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01300102) MxReadImpl.parse(MxCasp01300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasp01300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01300102 .class);
    }
