    ...
    extends AbstractMX
{
    ...
    public static MxCasp01300101 parse(String xml) {
        return ((MxCasp01300101) MxReadImpl.parse(MxCasp01300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01300101) MxReadImpl.parse(MxCasp01300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01300101 .class);
    }
