    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casp.002.001.07";
    ...
    public static MxCasp00200107 parse(String xml) {
        return ((MxCasp00200107) MxReadImpl.parse(MxCasp00200107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00200107) MxReadImpl.parse(MxCasp00200107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasp00200107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00200107 .class);
    }
