...
/**
 * Class for casp.014.001.07 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCasp01400107(final String xml) {
        this();
        MxCasp01400107 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01400107(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIMessageStatusRequestV07 }
     *     
     */
    public SaleToPOIMessageStatusRequestV07 getSaleToPOIMsgStsReq() {
     ...
     *     
     */
    public MxCasp01400107 setSaleToPOIMsgStsReq(SaleToPOIMessageStatusRequestV07 value) {
     ...
     * 
     */
    public static MxCasp01400107 parse(String xml) {
        return ((MxCasp01400107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01400107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01400107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01400107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01400107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01400107 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01400107) parserImpl.read(MxCasp01400107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01400107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01400107 message
     * @return
     *     a new instance of MxCasp01400107
     */
    public final static MxCasp01400107 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01400107 .class);
    }
