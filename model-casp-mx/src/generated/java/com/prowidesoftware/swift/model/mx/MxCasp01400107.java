    ...
    extends AbstractMX
{
    ...
    public static MxCasp01400107 parse(String xml) {
        return ((MxCasp01400107) MxReadImpl.parse(MxCasp01400107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01400107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01400107) MxReadImpl.parse(MxCasp01400107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01400107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01400107 .class);
    }
