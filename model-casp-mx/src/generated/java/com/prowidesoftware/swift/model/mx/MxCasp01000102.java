...
/**
 * Class for casp.010.001.02 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCasp01000102(final String xml) {
        this();
        MxCasp01000102 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01000102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIReportResponseV02 }
     *     
     */
    public SaleToPOIReportResponseV02 getSaleToPOIRptRspn() {
     ...
     *     
     */
    public MxCasp01000102 setSaleToPOIRptRspn(SaleToPOIReportResponseV02 value) {
     ...
     * 
     */
    public static MxCasp01000102 parse(String xml) {
        return ((MxCasp01000102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01000102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01000102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01000102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01000102 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01000102) parserImpl.read(MxCasp01000102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01000102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01000102 message
     * @return
     *     a new instance of MxCasp01000102
     */
    public final static MxCasp01000102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01000102 .class);
    }
