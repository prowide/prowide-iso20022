    ...
    extends AbstractMX
{
    ...
    public static MxCasp01000102 parse(String xml) {
        return ((MxCasp01000102) MxReadImpl.parse(MxCasp01000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01000102) MxReadImpl.parse(MxCasp01000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01000102 .class);
    }
