    ...
    extends AbstractMX
{
    ...
    public static MxCasp00500104 parse(String xml) {
        return ((MxCasp00500104) MxReadImpl.parse(MxCasp00500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00500104) MxReadImpl.parse(MxCasp00500104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00500104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00500104 .class);
    }
