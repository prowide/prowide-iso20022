    ...
    extends AbstractMX
{
    ...
    public static MxCasp01600101 parse(String xml) {
        return ((MxCasp01600101) MxReadImpl.parse(MxCasp01600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01600101) MxReadImpl.parse(MxCasp01600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01600101 .class);
    }
