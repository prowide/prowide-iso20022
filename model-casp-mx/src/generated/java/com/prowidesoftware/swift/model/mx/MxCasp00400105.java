    ...
    extends AbstractMX
{
    ...
    public static MxCasp00400105 parse(String xml) {
        return ((MxCasp00400105) MxReadImpl.parse(MxCasp00400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00400105) MxReadImpl.parse(MxCasp00400105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00400105 .class);
    }
