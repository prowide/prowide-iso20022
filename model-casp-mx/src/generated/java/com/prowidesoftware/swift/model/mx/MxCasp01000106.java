    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casp.010.001.06";
    ...
    public static MxCasp01000106 parse(String xml) {
        return ((MxCasp01000106) MxReadImpl.parse(MxCasp01000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01000106) MxReadImpl.parse(MxCasp01000106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasp01000106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01000106 .class);
    }
