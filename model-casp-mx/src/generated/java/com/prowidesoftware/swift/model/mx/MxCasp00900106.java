    ...
    extends AbstractMX
{
    ...
    public static MxCasp00900106 parse(String xml) {
        return ((MxCasp00900106) MxReadImpl.parse(MxCasp00900106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00900106) MxReadImpl.parse(MxCasp00900106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00900106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00900106 .class);
    }
