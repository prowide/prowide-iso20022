...
/**
 * Class for casp.009.001.06 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.009.001.06")
public class MxCasp00900106
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIRptReq", required = true)
    protected SaleToPOIReportRequestV06 saleToPOIRptReq;
     ...
     * 
     */
    public MxCasp00900106(final String xml) {
        this();
        MxCasp00900106 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp00900106(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIReportRequestV06 }
     *     
     */
    public SaleToPOIReportRequestV06 getSaleToPOIRptReq() {
     ...
     *     
     */
    public MxCasp00900106 setSaleToPOIRptReq(SaleToPOIReportRequestV06 value) {
     ...
     * 
     */
    public static MxCasp00900106 parse(String xml) {
        return ((MxCasp00900106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp00900106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp00900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00900106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp00900106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp00900106 parse(String xml, MxRead parserImpl) {
        return ((MxCasp00900106) parserImpl.read(MxCasp00900106 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp00900106 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp00900106 message
     * @return
     *     a new instance of MxCasp00900106
     */
    public static final MxCasp00900106 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp00900106 .class);
    }
