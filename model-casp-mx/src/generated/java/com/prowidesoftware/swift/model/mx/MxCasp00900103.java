    ...
    extends AbstractMX
{
    ...
    public static MxCasp00900103 parse(String xml) {
        return ((MxCasp00900103) MxReadImpl.parse(MxCasp00900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00900103) MxReadImpl.parse(MxCasp00900103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00900103 .class);
    }
