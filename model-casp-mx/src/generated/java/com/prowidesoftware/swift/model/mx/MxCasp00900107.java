    ...
    extends AbstractMX
{
    ...
    public static MxCasp00900107 parse(String xml) {
        return ((MxCasp00900107) MxReadImpl.parse(MxCasp00900107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00900107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00900107) MxReadImpl.parse(MxCasp00900107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00900107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00900107 .class);
    }
