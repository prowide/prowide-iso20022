    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casp.002.001.03";
    ...
    public static MxCasp00200103 parse(String xml) {
        return ((MxCasp00200103) MxReadImpl.parse(MxCasp00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00200103) MxReadImpl.parse(MxCasp00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasp00200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00200103 .class);
    }
