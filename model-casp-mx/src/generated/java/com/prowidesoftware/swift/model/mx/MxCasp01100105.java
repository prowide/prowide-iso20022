...
/**
 * Class for casp.011.001.05 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.011.001.05")
public class MxCasp01100105
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCasp01100105(final String xml) {
        this();
        MxCasp01100105 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01100105(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCasp01100105 setSaleToPOIAbrt(SaleToPOIAbortV05 value) {
     ...
     * 
     */
    public static MxCasp01100105 parse(String xml) {
        return ((MxCasp01100105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01100105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01100105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01100105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01100105 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01100105) parserImpl.read(MxCasp01100105 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01100105 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01100105 message
     * @return
     *     a new instance of MxCasp01100105
     */
    public final static MxCasp01100105 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01100105 .class);
    }
