    ...
    extends AbstractMX
{
    ...
    public static MxCasp01100105 parse(String xml) {
        return ((MxCasp01100105) MxReadImpl.parse(MxCasp01100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01100105) MxReadImpl.parse(MxCasp01100105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01100105 .class);
    }
