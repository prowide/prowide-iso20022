    ...
    extends AbstractMX
{
    ...
    public static MxCasp00400107 parse(String xml) {
        return ((MxCasp00400107) MxReadImpl.parse(MxCasp00400107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00400107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00400107) MxReadImpl.parse(MxCasp00400107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00400107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00400107 .class);
    }
