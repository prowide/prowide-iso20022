    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casp.012.001.01";
    ...
    public static MxCasp01200101 parse(String xml) {
        return ((MxCasp01200101) MxReadImpl.parse(MxCasp01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01200101) MxReadImpl.parse(MxCasp01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasp01200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01200101 .class);
    }
