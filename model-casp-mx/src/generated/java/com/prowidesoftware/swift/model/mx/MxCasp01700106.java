    ...
    extends AbstractMX
{
    ...
    public static MxCasp01700106 parse(String xml) {
        return ((MxCasp01700106) MxReadImpl.parse(MxCasp01700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01700106) MxReadImpl.parse(MxCasp01700106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01700106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01700106 .class);
    }
