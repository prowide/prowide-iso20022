...
/**
 * Class for casp.017.001.06 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.017.001.06")
public class MxCasp01700106
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCasp01700106(final String xml) {
        this();
        MxCasp01700106 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01700106(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCasp01700106 setSaleToPOIDvcRspn(SaleToPOIDeviceResponseV06 value) {
     ...
     * 
     */
    public static MxCasp01700106 parse(String xml) {
        return ((MxCasp01700106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01700106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01700106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01700106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01700106 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01700106) parserImpl.read(MxCasp01700106 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01700106 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01700106 message
     * @return
     *     a new instance of MxCasp01700106
     */
    public final static MxCasp01700106 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01700106 .class);
    }
