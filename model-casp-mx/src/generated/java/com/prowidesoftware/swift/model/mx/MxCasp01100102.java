...
/**
 * Class for casp.011.001.02 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.011.001.02")
public class MxCasp01100102
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIAbrt", required = true)
    protected SaleToPOIAbortV02 saleToPOIAbrt;
     ...
     * 
     */
    public MxCasp01100102(final String xml) {
        this();
        MxCasp01100102 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01100102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIAbortV02 }
     *     
     */
    public SaleToPOIAbortV02 getSaleToPOIAbrt() {
     ...
     *     
     */
    public MxCasp01100102 setSaleToPOIAbrt(SaleToPOIAbortV02 value) {
     ...
     * 
     */
    public static MxCasp01100102 parse(String xml) {
        return ((MxCasp01100102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01100102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01100102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01100102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01100102 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01100102) parserImpl.read(MxCasp01100102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01100102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01100102 message
     * @return
     *     a new instance of MxCasp01100102
     */
    public static final MxCasp01100102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01100102 .class);
    }
