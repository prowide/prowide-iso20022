    ...
    extends AbstractMX
{
    ...
    public static MxCasp01100102 parse(String xml) {
        return ((MxCasp01100102) MxReadImpl.parse(MxCasp01100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01100102) MxReadImpl.parse(MxCasp01100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01100102 .class);
    }
