    ...
    extends AbstractMX
{
    ...
    public static MxCasp01600106 parse(String xml) {
        return ((MxCasp01600106) MxReadImpl.parse(MxCasp01600106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01600106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01600106) MxReadImpl.parse(MxCasp01600106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01600106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01600106 .class);
    }
