...
/**
 * Class for casp.016.001.06 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.016.001.06")
public class MxCasp01600106
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIDvcReq", required = true)
    protected SaleToPOIDeviceRequestV06 saleToPOIDvcReq;
     ...
     * 
     */
    public MxCasp01600106(final String xml) {
        this();
        MxCasp01600106 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01600106(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIDeviceRequestV06 }
     *     
     */
    public SaleToPOIDeviceRequestV06 getSaleToPOIDvcReq() {
     ...
     *     
     */
    public MxCasp01600106 setSaleToPOIDvcReq(SaleToPOIDeviceRequestV06 value) {
     ...
     * 
     */
    public static MxCasp01600106 parse(String xml) {
        return ((MxCasp01600106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01600106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01600106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01600106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01600106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01600106 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01600106) parserImpl.read(MxCasp01600106 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01600106 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01600106 message
     * @return
     *     a new instance of MxCasp01600106
     */
    public final static MxCasp01600106 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01600106 .class);
    }
