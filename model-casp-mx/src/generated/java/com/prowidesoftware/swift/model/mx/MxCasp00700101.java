    ...
    extends AbstractMX
{
    ...
    public static MxCasp00700101 parse(String xml) {
        return ((MxCasp00700101) MxReadImpl.parse(MxCasp00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00700101) MxReadImpl.parse(MxCasp00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00700101 .class);
    }
