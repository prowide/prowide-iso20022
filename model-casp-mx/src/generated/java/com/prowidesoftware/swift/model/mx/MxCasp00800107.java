    ...
    extends AbstractMX
{
    ...
    public static MxCasp00800107 parse(String xml) {
        return ((MxCasp00800107) MxReadImpl.parse(MxCasp00800107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00800107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00800107) MxReadImpl.parse(MxCasp00800107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00800107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00800107 .class);
    }
