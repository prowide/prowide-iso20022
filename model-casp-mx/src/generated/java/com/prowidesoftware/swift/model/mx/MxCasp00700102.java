    ...
    extends AbstractMX
{
    ...
    public static MxCasp00700102 parse(String xml) {
        return ((MxCasp00700102) MxReadImpl.parse(MxCasp00700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00700102) MxReadImpl.parse(MxCasp00700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00700102 .class);
    }
