    ...
    extends AbstractMX
{
    ...
    public static MxCasp00400101 parse(String xml) {
        return ((MxCasp00400101) MxReadImpl.parse(MxCasp00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00400101) MxReadImpl.parse(MxCasp00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00400101 .class);
    }
