...
/**
 * Class for casp.011.001.03 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.011.001.03")
public class MxCasp01100103
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIAbrt", required = true)
    protected SaleToPOIAbortV03 saleToPOIAbrt;
     ...
     * 
     */
    public MxCasp01100103(final String xml) {
        this();
        MxCasp01100103 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01100103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIAbortV03 }
     *     
     */
    public SaleToPOIAbortV03 getSaleToPOIAbrt() {
     ...
     *     
     */
    public MxCasp01100103 setSaleToPOIAbrt(SaleToPOIAbortV03 value) {
     ...
     * 
     */
    public static MxCasp01100103 parse(String xml) {
        return ((MxCasp01100103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01100103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01100103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01100103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01100103 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01100103) parserImpl.read(MxCasp01100103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01100103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01100103 message
     * @return
     *     a new instance of MxCasp01100103
     */
    public static final MxCasp01100103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01100103 .class);
    }
