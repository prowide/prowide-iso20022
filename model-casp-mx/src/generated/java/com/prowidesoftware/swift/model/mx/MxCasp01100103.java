    ...
    extends AbstractMX
{
    ...
    public static MxCasp01100103 parse(String xml) {
        return ((MxCasp01100103) MxReadImpl.parse(MxCasp01100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01100103) MxReadImpl.parse(MxCasp01100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01100103 .class);
    }
