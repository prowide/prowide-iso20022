    ...
    extends AbstractMX
{
    ...
    public static MxCasp00100105 parse(String xml) {
        return ((MxCasp00100105) MxReadImpl.parse(MxCasp00100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00100105) MxReadImpl.parse(MxCasp00100105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00100105 .class);
    }
