    ...
    extends AbstractMX
{
    ...
    public static MxCasp01200107 parse(String xml) {
        return ((MxCasp01200107) MxReadImpl.parse(MxCasp01200107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01200107) MxReadImpl.parse(MxCasp01200107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01200107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01200107 .class);
    }
