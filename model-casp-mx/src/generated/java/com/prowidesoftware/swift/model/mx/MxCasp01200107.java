...
/**
 * Class for casp.012.001.07 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.012.001.07")
public class MxCasp01200107
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIEvtNtfctn", required = true)
    protected SaleToPOIEventNotificationV07 saleToPOIEvtNtfctn;
     ...
     * 
     */
    public MxCasp01200107(final String xml) {
        this();
        MxCasp01200107 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01200107(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIEventNotificationV07 }
     *     
     */
    public SaleToPOIEventNotificationV07 getSaleToPOIEvtNtfctn() {
     ...
     *     
     */
    public MxCasp01200107 setSaleToPOIEvtNtfctn(SaleToPOIEventNotificationV07 value) {
     ...
     * 
     */
    public static MxCasp01200107 parse(String xml) {
        return ((MxCasp01200107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01200107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01200107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01200107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01200107 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01200107) parserImpl.read(MxCasp01200107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01200107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01200107 message
     * @return
     *     a new instance of MxCasp01200107
     */
    public static final MxCasp01200107 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01200107 .class);
    }
