...
/**
 * Class for casp.016.001.07 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.016.001.07")
public class MxCasp01600107
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIDvcReq", required = true)
    protected SaleToPOIDeviceRequestV07 saleToPOIDvcReq;
     ...
     * 
     */
    public MxCasp01600107(final String xml) {
        this();
        MxCasp01600107 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01600107(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIDeviceRequestV07 }
     *     
     */
    public SaleToPOIDeviceRequestV07 getSaleToPOIDvcReq() {
     ...
     *     
     */
    public MxCasp01600107 setSaleToPOIDvcReq(SaleToPOIDeviceRequestV07 value) {
     ...
     * 
     */
    public static MxCasp01600107 parse(String xml) {
        return ((MxCasp01600107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01600107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01600107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01600107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01600107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01600107 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01600107) parserImpl.read(MxCasp01600107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01600107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01600107 message
     * @return
     *     a new instance of MxCasp01600107
     */
    public final static MxCasp01600107 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01600107 .class);
    }
