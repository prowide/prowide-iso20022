    ...
    extends AbstractMX
{
    ...
    public static MxCasp01600107 parse(String xml) {
        return ((MxCasp01600107) MxReadImpl.parse(MxCasp01600107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01600107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01600107) MxReadImpl.parse(MxCasp01600107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01600107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01600107 .class);
    }
