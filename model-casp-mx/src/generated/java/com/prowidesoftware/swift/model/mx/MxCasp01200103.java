...
/**
 * Class for casp.012.001.03 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.012.001.03")
public class MxCasp01200103
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIEvtNtfctn", required = true)
    protected SaleToPOIEventNotificationV03 saleToPOIEvtNtfctn;
     ...
     * 
     */
    public MxCasp01200103(final String xml) {
        this();
        MxCasp01200103 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01200103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIEventNotificationV03 }
     *     
     */
    public SaleToPOIEventNotificationV03 getSaleToPOIEvtNtfctn() {
     ...
     *     
     */
    public MxCasp01200103 setSaleToPOIEvtNtfctn(SaleToPOIEventNotificationV03 value) {
     ...
     * 
     */
    public static MxCasp01200103 parse(String xml) {
        return ((MxCasp01200103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01200103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01200103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01200103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01200103 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01200103) parserImpl.read(MxCasp01200103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01200103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01200103 message
     * @return
     *     a new instance of MxCasp01200103
     */
    public final static MxCasp01200103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01200103 .class);
    }
