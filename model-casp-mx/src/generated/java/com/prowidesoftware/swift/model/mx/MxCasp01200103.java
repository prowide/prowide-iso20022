    ...
    extends AbstractMX
{
    ...
    public static MxCasp01200103 parse(String xml) {
        return ((MxCasp01200103) MxReadImpl.parse(MxCasp01200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01200103) MxReadImpl.parse(MxCasp01200103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01200103 .class);
    }
