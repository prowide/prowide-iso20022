...
/**
 * Class for casp.017.001.07 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.017.001.07")
public class MxCasp01700107
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIDvcRspn", required = true)
    protected SaleToPOIDeviceResponseV07 saleToPOIDvcRspn;
     ...
     * 
     */
    public MxCasp01700107(final String xml) {
        this();
        MxCasp01700107 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01700107(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIDeviceResponseV07 }
     *     
     */
    public SaleToPOIDeviceResponseV07 getSaleToPOIDvcRspn() {
     ...
     *     
     */
    public MxCasp01700107 setSaleToPOIDvcRspn(SaleToPOIDeviceResponseV07 value) {
     ...
     * 
     */
    public static MxCasp01700107 parse(String xml) {
        return ((MxCasp01700107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01700107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01700107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01700107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01700107 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01700107) parserImpl.read(MxCasp01700107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01700107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01700107 message
     * @return
     *     a new instance of MxCasp01700107
     */
    public final static MxCasp01700107 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01700107 .class);
    }
