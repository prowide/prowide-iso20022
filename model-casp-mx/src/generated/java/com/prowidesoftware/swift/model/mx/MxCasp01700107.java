    ...
    extends AbstractMX
{
    ...
    public static MxCasp01700107 parse(String xml) {
        return ((MxCasp01700107) MxReadImpl.parse(MxCasp01700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01700107) MxReadImpl.parse(MxCasp01700107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01700107 .class);
    }
