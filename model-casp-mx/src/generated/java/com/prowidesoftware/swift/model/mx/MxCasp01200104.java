...
/**
 * Class for casp.012.001.04 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.012.001.04")
public class MxCasp01200104
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIEvtNtfctn", required = true)
    protected SaleToPOIEventNotificationV04 saleToPOIEvtNtfctn;
     ...
     * 
     */
    public MxCasp01200104(final String xml) {
        this();
        MxCasp01200104 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01200104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIEventNotificationV04 }
     *     
     */
    public SaleToPOIEventNotificationV04 getSaleToPOIEvtNtfctn() {
     ...
     *     
     */
    public MxCasp01200104 setSaleToPOIEvtNtfctn(SaleToPOIEventNotificationV04 value) {
     ...
     * 
     */
    public static MxCasp01200104 parse(String xml) {
        return ((MxCasp01200104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01200104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01200104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01200104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01200104 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01200104) parserImpl.read(MxCasp01200104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01200104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01200104 message
     * @return
     *     a new instance of MxCasp01200104
     */
    public final static MxCasp01200104 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01200104 .class);
    }
