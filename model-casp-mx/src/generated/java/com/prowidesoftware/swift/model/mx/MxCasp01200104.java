    ...
    extends AbstractMX
{
    ...
    public static MxCasp01200104 parse(String xml) {
        return ((MxCasp01200104) MxReadImpl.parse(MxCasp01200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01200104) MxReadImpl.parse(MxCasp01200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01200104 .class);
    }
