    ...
    extends AbstractMX
{
    ...
    public static MxCasp01400106 parse(String xml) {
        return ((MxCasp01400106) MxReadImpl.parse(MxCasp01400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01400106) MxReadImpl.parse(MxCasp01400106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01400106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01400106 .class);
    }
