    ...
    extends AbstractMX
{
    ...
    public static MxCasp01500105 parse(String xml) {
        return ((MxCasp01500105) MxReadImpl.parse(MxCasp01500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01500105) MxReadImpl.parse(MxCasp01500105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01500105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01500105 .class);
    }
