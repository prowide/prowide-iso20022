    ...
    extends AbstractMX
{
    ...
    public static MxCasp00400102 parse(String xml) {
        return ((MxCasp00400102) MxReadImpl.parse(MxCasp00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00400102) MxReadImpl.parse(MxCasp00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00400102 .class);
    }
