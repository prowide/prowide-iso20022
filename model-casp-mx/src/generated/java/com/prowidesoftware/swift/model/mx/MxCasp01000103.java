    ...
    extends AbstractMX
{
    ...
    public static MxCasp01000103 parse(String xml) {
        return ((MxCasp01000103) MxReadImpl.parse(MxCasp01000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01000103) MxReadImpl.parse(MxCasp01000103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01000103 .class);
    }
