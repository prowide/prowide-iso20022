...
/**
 * Class for casp.010.001.03 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.010.001.03")
public class MxCasp01000103
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIRptRspn", required = true)
    protected SaleToPOIReportResponseV03 saleToPOIRptRspn;
     ...
     * 
     */
    public MxCasp01000103(final String xml) {
        this();
        MxCasp01000103 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01000103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIReportResponseV03 }
     *     
     */
    public SaleToPOIReportResponseV03 getSaleToPOIRptRspn() {
     ...
     *     
     */
    public MxCasp01000103 setSaleToPOIRptRspn(SaleToPOIReportResponseV03 value) {
     ...
     * 
     */
    public static MxCasp01000103 parse(String xml) {
        return ((MxCasp01000103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01000103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01000103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01000103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01000103 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01000103) parserImpl.read(MxCasp01000103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01000103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01000103 message
     * @return
     *     a new instance of MxCasp01000103
     */
    public static final MxCasp01000103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01000103 .class);
    }
