    ...
    extends AbstractMX
{
    ...
    public static MxCasp01000107 parse(String xml) {
        return ((MxCasp01000107) MxReadImpl.parse(MxCasp01000107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01000107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01000107) MxReadImpl.parse(MxCasp01000107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01000107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01000107 .class);
    }
