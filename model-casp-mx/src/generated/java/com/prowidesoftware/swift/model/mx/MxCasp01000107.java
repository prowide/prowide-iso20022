...
/**
 * Class for casp.010.001.07 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.010.001.07")
public class MxCasp01000107
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIRptRspn", required = true)
    protected SaleToPOIReportResponseV07 saleToPOIRptRspn;
     ...
     * 
     */
    public MxCasp01000107(final String xml) {
        this();
        MxCasp01000107 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01000107(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIReportResponseV07 }
     *     
     */
    public SaleToPOIReportResponseV07 getSaleToPOIRptRspn() {
     ...
     *     
     */
    public MxCasp01000107 setSaleToPOIRptRspn(SaleToPOIReportResponseV07 value) {
     ...
     * 
     */
    public static MxCasp01000107 parse(String xml) {
        return ((MxCasp01000107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01000107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01000107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01000107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01000107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01000107 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01000107) parserImpl.read(MxCasp01000107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01000107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01000107 message
     * @return
     *     a new instance of MxCasp01000107
     */
    public static final MxCasp01000107 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01000107 .class);
    }
