    ...
    extends AbstractMX
{
    ...
    public static MxCasp01000101 parse(String xml) {
        return ((MxCasp01000101) MxReadImpl.parse(MxCasp01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01000101) MxReadImpl.parse(MxCasp01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01000101 .class);
    }
