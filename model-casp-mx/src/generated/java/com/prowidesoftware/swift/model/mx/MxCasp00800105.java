    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casp.008.001.05";
    ...
    public static MxCasp00800105 parse(String xml) {
        return ((MxCasp00800105) MxReadImpl.parse(MxCasp00800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00800105) MxReadImpl.parse(MxCasp00800105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasp00800105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00800105 .class);
    }
