    ...
    extends AbstractMX
{
    ...
    public static MxCasp01100101 parse(String xml) {
        return ((MxCasp01100101) MxReadImpl.parse(MxCasp01100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01100101) MxReadImpl.parse(MxCasp01100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01100101 .class);
    }
