...
/**
 * Class for casp.011.001.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCasp01100101(final String xml) {
        this();
        MxCasp01100101 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01100101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIAbortV01 }
     *     
     */
    public SaleToPOIAbortV01 getSaleToPOIAbrt() {
     ...
     *     
     */
    public MxCasp01100101 setSaleToPOIAbrt(SaleToPOIAbortV01 value) {
     ...
     * 
     */
    public static MxCasp01100101 parse(String xml) {
        return ((MxCasp01100101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01100101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01100101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01100101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01100101 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01100101) parserImpl.read(MxCasp01100101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01100101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01100101 message
     * @return
     *     a new instance of MxCasp01100101
     */
    public final static MxCasp01100101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01100101 .class);
    }
