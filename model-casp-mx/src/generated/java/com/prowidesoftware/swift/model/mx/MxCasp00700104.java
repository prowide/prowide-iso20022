    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casp.007.001.04";
    ...
    public static MxCasp00700104 parse(String xml) {
        return ((MxCasp00700104) MxReadImpl.parse(MxCasp00700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00700104) MxReadImpl.parse(MxCasp00700104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasp00700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00700104 .class);
    }
