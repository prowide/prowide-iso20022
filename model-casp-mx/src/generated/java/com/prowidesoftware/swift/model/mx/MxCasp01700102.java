...
/**
 * Class for casp.017.001.02 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.017.001.02")
public class MxCasp01700102
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIDvcRspn", required = true)
    protected SaleToPOIDeviceResponseV02 saleToPOIDvcRspn;
     ...
     * 
     */
    public MxCasp01700102(final String xml) {
        this();
        MxCasp01700102 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01700102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIDeviceResponseV02 }
     *     
     */
    public SaleToPOIDeviceResponseV02 getSaleToPOIDvcRspn() {
     ...
     *     
     */
    public MxCasp01700102 setSaleToPOIDvcRspn(SaleToPOIDeviceResponseV02 value) {
     ...
     * 
     */
    public static MxCasp01700102 parse(String xml) {
        return ((MxCasp01700102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01700102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01700102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01700102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01700102 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01700102) parserImpl.read(MxCasp01700102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01700102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01700102 message
     * @return
     *     a new instance of MxCasp01700102
     */
    public final static MxCasp01700102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01700102 .class);
    }
