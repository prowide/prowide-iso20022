    ...
    extends AbstractMX
{
    ...
    public static MxCasp01700102 parse(String xml) {
        return ((MxCasp01700102) MxReadImpl.parse(MxCasp01700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01700102) MxReadImpl.parse(MxCasp01700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01700102 .class);
    }
