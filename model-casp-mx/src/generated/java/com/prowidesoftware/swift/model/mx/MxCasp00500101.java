    ...
    extends AbstractMX
{
    ...
    public static MxCasp00500101 parse(String xml) {
        return ((MxCasp00500101) MxReadImpl.parse(MxCasp00500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00500101) MxReadImpl.parse(MxCasp00500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00500101 .class);
    }
