...
/**
 * Class for casp.014.001.05 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.014.001.05")
public class MxCasp01400105
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIMsgStsReq", required = true)
    protected SaleToPOIMessageStatusRequestV05 saleToPOIMsgStsReq;
     ...
     * 
     */
    public MxCasp01400105(final String xml) {
        this();
        MxCasp01400105 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01400105(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIMessageStatusRequestV05 }
     *     
     */
    public SaleToPOIMessageStatusRequestV05 getSaleToPOIMsgStsReq() {
     ...
     *     
     */
    public MxCasp01400105 setSaleToPOIMsgStsReq(SaleToPOIMessageStatusRequestV05 value) {
     ...
     * 
     */
    public static MxCasp01400105 parse(String xml) {
        return ((MxCasp01400105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01400105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01400105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01400105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01400105 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01400105) parserImpl.read(MxCasp01400105 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01400105 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01400105 message
     * @return
     *     a new instance of MxCasp01400105
     */
    public static final MxCasp01400105 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01400105 .class);
    }
