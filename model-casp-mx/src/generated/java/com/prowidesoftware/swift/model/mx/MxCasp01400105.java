    ...
    extends AbstractMX
{
    ...
    public static MxCasp01400105 parse(String xml) {
        return ((MxCasp01400105) MxReadImpl.parse(MxCasp01400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01400105) MxReadImpl.parse(MxCasp01400105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01400105 .class);
    }
