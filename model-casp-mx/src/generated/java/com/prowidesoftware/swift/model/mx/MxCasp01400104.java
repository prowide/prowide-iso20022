    ...
    extends AbstractMX
{
    ...
    public static MxCasp01400104 parse(String xml) {
        return ((MxCasp01400104) MxReadImpl.parse(MxCasp01400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01400104) MxReadImpl.parse(MxCasp01400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01400104 .class);
    }
