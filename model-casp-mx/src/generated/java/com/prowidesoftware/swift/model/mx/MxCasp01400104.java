...
/**
 * Class for casp.014.001.04 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCasp01400104(final String xml) {
        this();
        MxCasp01400104 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01400104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIMessageStatusRequestV04 }
     *     
     */
    public SaleToPOIMessageStatusRequestV04 getSaleToPOIMsgStsReq() {
     ...
     *     
     */
    public MxCasp01400104 setSaleToPOIMsgStsReq(SaleToPOIMessageStatusRequestV04 value) {
     ...
     * 
     */
    public static MxCasp01400104 parse(String xml) {
        return ((MxCasp01400104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01400104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01400104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01400104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01400104 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01400104) parserImpl.read(MxCasp01400104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01400104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01400104 message
     * @return
     *     a new instance of MxCasp01400104
     */
    public final static MxCasp01400104 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01400104 .class);
    }
