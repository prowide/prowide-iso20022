    ...
    extends AbstractMX
{
    ...
    public static MxCasp00700103 parse(String xml) {
        return ((MxCasp00700103) MxReadImpl.parse(MxCasp00700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00700103) MxReadImpl.parse(MxCasp00700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00700103 .class);
    }
