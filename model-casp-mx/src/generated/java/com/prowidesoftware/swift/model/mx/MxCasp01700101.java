...
/**
 * Class for casp.017.001.01 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.017.001.01")
public class MxCasp01700101
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIDvcRspn", required = true)
    protected SaleToPOIDeviceResponseV01 saleToPOIDvcRspn;
     ...
     * 
     */
    public MxCasp01700101(final String xml) {
        this();
        MxCasp01700101 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01700101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIDeviceResponseV01 }
     *     
     */
    public SaleToPOIDeviceResponseV01 getSaleToPOIDvcRspn() {
     ...
     *     
     */
    public MxCasp01700101 setSaleToPOIDvcRspn(SaleToPOIDeviceResponseV01 value) {
     ...
     * 
     */
    public static MxCasp01700101 parse(String xml) {
        return ((MxCasp01700101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01700101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01700101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01700101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01700101 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01700101) parserImpl.read(MxCasp01700101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01700101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01700101 message
     * @return
     *     a new instance of MxCasp01700101
     */
    public final static MxCasp01700101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01700101 .class);
    }
