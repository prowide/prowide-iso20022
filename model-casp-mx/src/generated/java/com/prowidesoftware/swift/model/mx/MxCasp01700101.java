    ...
    extends AbstractMX
{
    ...
    public static MxCasp01700101 parse(String xml) {
        return ((MxCasp01700101) MxReadImpl.parse(MxCasp01700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01700101) MxReadImpl.parse(MxCasp01700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01700101 .class);
    }
