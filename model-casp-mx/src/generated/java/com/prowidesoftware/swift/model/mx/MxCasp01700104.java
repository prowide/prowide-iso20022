    ...
    extends AbstractMX
{
    ...
    public static MxCasp01700104 parse(String xml) {
        return ((MxCasp01700104) MxReadImpl.parse(MxCasp01700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01700104) MxReadImpl.parse(MxCasp01700104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01700104 .class);
    }
