...
/**
 * Class for casp.017.001.04 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:casp.017.001.04")
public class MxCasp01700104
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "SaleToPOIDvcRspn", required = true)
    protected SaleToPOIDeviceResponseV04 saleToPOIDvcRspn;
     ...
     * 
     */
    public MxCasp01700104(final String xml) {
        this();
        MxCasp01700104 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01700104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIDeviceResponseV04 }
     *     
     */
    public SaleToPOIDeviceResponseV04 getSaleToPOIDvcRspn() {
     ...
     *     
     */
    public MxCasp01700104 setSaleToPOIDvcRspn(SaleToPOIDeviceResponseV04 value) {
     ...
     * 
     */
    public static MxCasp01700104 parse(String xml) {
        return ((MxCasp01700104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01700104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01700104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01700104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01700104 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01700104) parserImpl.read(MxCasp01700104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01700104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01700104 message
     * @return
     *     a new instance of MxCasp01700104
     */
    public static final MxCasp01700104 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01700104 .class);
    }
