    ...
    extends AbstractMX
{
    ...
    public static MxCasp00700105 parse(String xml) {
        return ((MxCasp00700105) MxReadImpl.parse(MxCasp00700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00700105) MxReadImpl.parse(MxCasp00700105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00700105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00700105 .class);
    }
