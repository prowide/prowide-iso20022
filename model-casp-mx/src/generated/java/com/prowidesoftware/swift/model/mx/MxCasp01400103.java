...
/**
 * Class for casp.014.001.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCasp01400103(final String xml) {
        this();
        MxCasp01400103 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp01400103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIMessageStatusRequestV03 }
     *     
     */
    public SaleToPOIMessageStatusRequestV03 getSaleToPOIMsgStsReq() {
     ...
     *     
     */
    public MxCasp01400103 setSaleToPOIMsgStsReq(SaleToPOIMessageStatusRequestV03 value) {
     ...
     * 
     */
    public static MxCasp01400103 parse(String xml) {
        return ((MxCasp01400103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01400103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp01400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01400103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp01400103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp01400103 parse(String xml, MxRead parserImpl) {
        return ((MxCasp01400103) parserImpl.read(MxCasp01400103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp01400103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp01400103 message
     * @return
     *     a new instance of MxCasp01400103
     */
    public final static MxCasp01400103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp01400103 .class);
    }
