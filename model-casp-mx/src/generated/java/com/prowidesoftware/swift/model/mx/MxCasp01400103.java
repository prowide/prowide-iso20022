    ...
    extends AbstractMX
{
    ...
    public static MxCasp01400103 parse(String xml) {
        return ((MxCasp01400103) MxReadImpl.parse(MxCasp01400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp01400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp01400103) MxReadImpl.parse(MxCasp01400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp01400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp01400103 .class);
    }
