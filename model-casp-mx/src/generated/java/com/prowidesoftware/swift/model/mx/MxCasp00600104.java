    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casp.006.001.04";
    ...
    public static MxCasp00600104 parse(String xml) {
        return ((MxCasp00600104) MxReadImpl.parse(MxCasp00600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00600104) MxReadImpl.parse(MxCasp00600104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasp00600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00600104 .class);
    }
