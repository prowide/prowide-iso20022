...
/**
 * Class for casp.009.001.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCasp00900101(final String xml) {
        this();
        MxCasp00900101 tmp = parse(xml);
     ...
     * 
     */
    public MxCasp00900101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SaleToPOIReportRequestV01 }
     *     
     */
    public SaleToPOIReportRequestV01 getSaleToPOIRptReq() {
     ...
     *     
     */
    public MxCasp00900101 setSaleToPOIRptReq(SaleToPOIReportRequestV01 value) {
     ...
     * 
     */
    public static MxCasp00900101 parse(String xml) {
        return ((MxCasp00900101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp00900101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCasp00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00900101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCasp00900101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCasp00900101 parse(String xml, MxRead parserImpl) {
        return ((MxCasp00900101) parserImpl.read(MxCasp00900101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCasp00900101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCasp00900101 message
     * @return
     *     a new instance of MxCasp00900101
     */
    public final static MxCasp00900101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCasp00900101 .class);
    }
