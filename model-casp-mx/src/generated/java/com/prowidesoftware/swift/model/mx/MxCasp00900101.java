    ...
    extends AbstractMX
{
    ...
    public static MxCasp00900101 parse(String xml) {
        return ((MxCasp00900101) MxReadImpl.parse(MxCasp00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasp00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasp00900101) MxReadImpl.parse(MxCasp00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasp00900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasp00900101 .class);
    }
