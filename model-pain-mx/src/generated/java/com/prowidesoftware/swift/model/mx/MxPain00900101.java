    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.009.001.01";
    ...
    public static MxPain00900101 parse(String xml) {
        return ((MxPain00900101) MxReadImpl.parse(MxPain00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00900101) MxReadImpl.parse(MxPain00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain00900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00900101 .class);
    }
