    ...
    extends AbstractMX
{
    ...
    public static MxPain00700101 parse(String xml) {
        return ((MxPain00700101) MxReadImpl.parse(MxPain00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00700101) MxReadImpl.parse(MxPain00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
