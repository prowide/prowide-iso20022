    ...
    extends AbstractMX
{
    ...
    public static MxPain00800110 parse(String xml) {
        return ((MxPain00800110) MxReadImpl.parse(MxPain00800110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00800110 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00800110) MxReadImpl.parse(MxPain00800110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00800110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00800110 .class);
    }
