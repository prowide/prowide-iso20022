    ...
    extends AbstractMX
{
    ...
    public static MxPain01400101 parse(String xml) {
        return ((MxPain01400101) MxReadImpl.parse(MxPain01400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01400101) MxReadImpl.parse(MxPain01400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01400101 .class);
    }
