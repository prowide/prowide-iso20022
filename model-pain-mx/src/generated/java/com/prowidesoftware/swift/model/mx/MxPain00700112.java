    ...
    extends AbstractMX
{
    ...
    public static MxPain00700112 parse(String xml) {
        return ((MxPain00700112) MxReadImpl.parse(MxPain00700112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00700112 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00700112) MxReadImpl.parse(MxPain00700112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00700112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00700112 .class);
    }
