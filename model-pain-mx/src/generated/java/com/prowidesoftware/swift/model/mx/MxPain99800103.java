    ...
    extends AbstractMX
{
    ...
    public static MxPain99800103 parse(String xml) {
        return ((MxPain99800103) MxReadImpl.parse(MxPain99800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain99800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain99800103) MxReadImpl.parse(MxPain99800103 .class, xml, _classes, new MxReadParams(conf)));
    }
