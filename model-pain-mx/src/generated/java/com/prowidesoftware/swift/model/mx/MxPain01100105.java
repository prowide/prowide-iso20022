    ...
    extends AbstractMX
{
    ...
    public static MxPain01100105 parse(String xml) {
        return ((MxPain01100105) MxReadImpl.parse(MxPain01100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01100105) MxReadImpl.parse(MxPain01100105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01100105 .class);
    }
