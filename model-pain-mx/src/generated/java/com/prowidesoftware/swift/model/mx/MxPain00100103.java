    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03";
    ...
    public static MxPain00100103 parse(String xml) {
        return ((MxPain00100103) MxReadImpl.parse(MxPain00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00100103) MxReadImpl.parse(MxPain00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain00100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00100103 .class);
    }
