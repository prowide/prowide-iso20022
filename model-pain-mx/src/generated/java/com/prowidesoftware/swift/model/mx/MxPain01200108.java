    ...
    extends AbstractMX
{
    ...
    public static MxPain01200108 parse(String xml) {
        return ((MxPain01200108) MxReadImpl.parse(MxPain01200108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01200108 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01200108) MxReadImpl.parse(MxPain01200108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01200108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01200108 .class);
    }
