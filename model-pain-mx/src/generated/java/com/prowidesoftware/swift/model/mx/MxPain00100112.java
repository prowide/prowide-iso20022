    ...
    extends AbstractMX
{
    ...
    public static MxPain00100112 parse(String xml) {
        return ((MxPain00100112) MxReadImpl.parse(MxPain00100112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00100112 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00100112) MxReadImpl.parse(MxPain00100112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00100112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00100112 .class);
    }
