    ...
    extends AbstractMX
{
    ...
    public static MxPain01200105 parse(String xml) {
        return ((MxPain01200105) MxReadImpl.parse(MxPain01200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01200105) MxReadImpl.parse(MxPain01200105 .class, xml, _classes, new MxReadParams(conf)));
    }
