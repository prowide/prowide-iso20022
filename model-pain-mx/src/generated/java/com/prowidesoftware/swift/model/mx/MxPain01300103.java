    ...
    extends AbstractMX
{
    ...
    public static MxPain01300103 parse(String xml) {
        return ((MxPain01300103) MxReadImpl.parse(MxPain01300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01300103) MxReadImpl.parse(MxPain01300103 .class, xml, _classes, new MxReadParams(conf)));
    }
