    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.010.001.08";
    ...
    public static MxPain01000108 parse(String xml) {
        return ((MxPain01000108) MxReadImpl.parse(MxPain01000108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01000108 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01000108) MxReadImpl.parse(MxPain01000108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain01000108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01000108 .class);
    }
