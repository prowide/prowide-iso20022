    ...
    extends AbstractMX
{
    ...
    public static MxPain00800101 parse(String xml) {
        return ((MxPain00800101) MxReadImpl.parse(MxPain00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00800101) MxReadImpl.parse(MxPain00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
