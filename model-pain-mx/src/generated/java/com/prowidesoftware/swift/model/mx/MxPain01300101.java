    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.01";
    ...
    public static MxPain01300101 parse(String xml) {
        return ((MxPain01300101) MxReadImpl.parse(MxPain01300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01300101) MxReadImpl.parse(MxPain01300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain01300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01300101 .class);
    }
