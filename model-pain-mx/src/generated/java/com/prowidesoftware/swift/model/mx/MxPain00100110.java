    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.10";
    ...
    public static MxPain00100110 parse(String xml) {
        return ((MxPain00100110) MxReadImpl.parse(MxPain00100110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00100110 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00100110) MxReadImpl.parse(MxPain00100110 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain00100110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00100110 .class);
    }
