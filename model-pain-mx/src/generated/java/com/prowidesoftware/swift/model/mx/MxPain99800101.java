    ...
    extends AbstractMX
{
    ...
    public static MxPain99800101 parse(String xml) {
        return ((MxPain99800101) MxReadImpl.parse(MxPain99800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain99800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain99800101) MxReadImpl.parse(MxPain99800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain99800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain99800101 .class);
    }
