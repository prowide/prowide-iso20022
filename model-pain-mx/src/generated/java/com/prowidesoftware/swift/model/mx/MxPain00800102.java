    ...
    extends AbstractMX
{
    ...
    public static MxPain00800102 parse(String xml) {
        return ((MxPain00800102) MxReadImpl.parse(MxPain00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00800102) MxReadImpl.parse(MxPain00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00800102 .class);
    }
