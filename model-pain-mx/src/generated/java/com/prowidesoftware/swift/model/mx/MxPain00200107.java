    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.07";
    ...
    public static MxPain00200107 parse(String xml) {
        return ((MxPain00200107) MxReadImpl.parse(MxPain00200107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00200107) MxReadImpl.parse(MxPain00200107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain00200107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00200107 .class);
    }
