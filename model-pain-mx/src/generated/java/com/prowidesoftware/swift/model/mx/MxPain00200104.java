...
/**
 * Class for pain.002.001.04 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxPain00200104(final String xml) {
        this();
        MxPain00200104 tmp = parse(xml);
     ...
     * 
     */
    public MxPain00200104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CustomerPaymentStatusReportV04 }
     *     
     */
    public CustomerPaymentStatusReportV04 getCstmrPmtStsRpt() {
     ...
     *     
     */
    public MxPain00200104 setCstmrPmtStsRpt(CustomerPaymentStatusReportV04 value) {
     ...
     * 
     */
    public static MxPain00200104 parse(String xml) {
        return ((MxPain00200104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxPain00200104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxPain00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00200104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxPain00200104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxPain00200104 parse(String xml, MxRead parserImpl) {
        return ((MxPain00200104) parserImpl.read(MxPain00200104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxPain00200104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxPain00200104 message
     * @return
     *     a new instance of MxPain00200104
     */
    public final static MxPain00200104 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxPain00200104 .class);
    }
