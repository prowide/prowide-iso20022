    ...
    extends AbstractMX
{
    ...
    public static MxPain00200104 parse(String xml) {
        return ((MxPain00200104) MxReadImpl.parse(MxPain00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00200104) MxReadImpl.parse(MxPain00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00200104 .class);
    }
