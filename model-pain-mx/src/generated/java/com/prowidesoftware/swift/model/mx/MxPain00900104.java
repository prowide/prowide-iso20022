    ...
    extends AbstractMX
{
    ...
    public static MxPain00900104 parse(String xml) {
        return ((MxPain00900104) MxReadImpl.parse(MxPain00900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00900104) MxReadImpl.parse(MxPain00900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00900104 .class);
    }
