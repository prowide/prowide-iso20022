    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.11";
    ...
    public static MxPain01300111 parse(String xml) {
        return ((MxPain01300111) MxReadImpl.parse(MxPain01300111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01300111 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01300111) MxReadImpl.parse(MxPain01300111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain01300111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01300111 .class);
    }
