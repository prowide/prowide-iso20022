    ...
    extends AbstractMX
{
    ...
    public static MxPain01300109 parse(String xml) {
        return ((MxPain01300109) MxReadImpl.parse(MxPain01300109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01300109 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01300109) MxReadImpl.parse(MxPain01300109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01300109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01300109 .class);
    }
