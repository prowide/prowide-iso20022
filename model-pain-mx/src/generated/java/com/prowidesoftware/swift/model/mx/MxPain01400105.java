    ...
    extends AbstractMX
{
    ...
    public static MxPain01400105 parse(String xml) {
        return ((MxPain01400105) MxReadImpl.parse(MxPain01400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01400105) MxReadImpl.parse(MxPain01400105 .class, xml, _classes, new MxReadParams(conf)));
    }
