    ...
    extends AbstractMX
{
    ...
    public static MxPain01400109 parse(String xml) {
        return ((MxPain01400109) MxReadImpl.parse(MxPain01400109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01400109 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01400109) MxReadImpl.parse(MxPain01400109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01400109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01400109 .class);
    }
