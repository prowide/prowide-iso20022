    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.018.001.02";
    ...
    public static MxPain01800102 parse(String xml) {
        return ((MxPain01800102) MxReadImpl.parse(MxPain01800102 .class, xml, _classes));
    }
     ...
     */
    public final static MxPain01800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01800102 .class);
    }
