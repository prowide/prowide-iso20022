    ...
    extends AbstractMX
{
    ...
    public static MxPain01800102 parse(String xml) {
        return ((MxPain01800102) MxReadImpl.parse(MxPain01800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01800102) MxReadImpl.parse(MxPain01800102 .class, xml, _classes, new MxReadParams(conf)));
    }
