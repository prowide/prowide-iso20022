    ...
    extends AbstractMX
{
    ...
    public static MxPain01300110 parse(String xml) {
        return ((MxPain01300110) MxReadImpl.parse(MxPain01300110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01300110 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01300110) MxReadImpl.parse(MxPain01300110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01300110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01300110 .class);
    }
