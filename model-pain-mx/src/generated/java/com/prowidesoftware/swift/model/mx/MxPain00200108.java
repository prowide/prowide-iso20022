    ...
    extends AbstractMX
{
    ...
    public static MxPain00200108 parse(String xml) {
        return ((MxPain00200108) MxReadImpl.parse(MxPain00200108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00200108 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00200108) MxReadImpl.parse(MxPain00200108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00200108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00200108 .class);
    }
