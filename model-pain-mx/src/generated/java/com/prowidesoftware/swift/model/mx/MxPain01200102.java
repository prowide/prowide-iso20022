    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.012.001.02";
    ...
    public static MxPain01200102 parse(String xml) {
        return ((MxPain01200102) MxReadImpl.parse(MxPain01200102 .class, xml, _classes));
    }
     ...
     */
    public final static MxPain01200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01200102 .class);
    }
