    ...
    extends AbstractMX
{
    ...
    public static MxPain01200102 parse(String xml) {
        return ((MxPain01200102) MxReadImpl.parse(MxPain01200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01200102) MxReadImpl.parse(MxPain01200102 .class, xml, _classes, new MxReadParams(conf)));
    }
