    ...
    extends AbstractMX
{
    ...
    public static MxPain01100101 parse(String xml) {
        return ((MxPain01100101) MxReadImpl.parse(MxPain01100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01100101) MxReadImpl.parse(MxPain01100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01100101 .class);
    }
