    ...
    extends AbstractMX
{
    ...
    public static MxPain01700103 parse(String xml) {
        return ((MxPain01700103) MxReadImpl.parse(MxPain01700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01700103) MxReadImpl.parse(MxPain01700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01700103 .class);
    }
