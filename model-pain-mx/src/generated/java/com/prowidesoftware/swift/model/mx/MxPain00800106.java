    ...
    extends AbstractMX
{
    ...
    public static MxPain00800106 parse(String xml) {
        return ((MxPain00800106) MxReadImpl.parse(MxPain00800106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00800106 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00800106) MxReadImpl.parse(MxPain00800106 .class, xml, _classes, new MxReadParams(conf)));
    }
