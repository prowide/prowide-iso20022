    ...
    extends AbstractMX
{
    ...
    public static MxPain01400111 parse(String xml) {
        return ((MxPain01400111) MxReadImpl.parse(MxPain01400111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01400111 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01400111) MxReadImpl.parse(MxPain01400111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01400111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01400111 .class);
    }
