    ...
    extends AbstractMX
{
    ...
    public static MxPain01000105 parse(String xml) {
        return ((MxPain01000105) MxReadImpl.parse(MxPain01000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01000105) MxReadImpl.parse(MxPain01000105 .class, xml, _classes, new MxReadParams(conf)));
    }
