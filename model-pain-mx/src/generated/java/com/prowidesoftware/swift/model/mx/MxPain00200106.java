    ...
    extends AbstractMX
{
    ...
    public static MxPain00200106 parse(String xml) {
        return ((MxPain00200106) MxReadImpl.parse(MxPain00200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00200106) MxReadImpl.parse(MxPain00200106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00200106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00200106 .class);
    }
