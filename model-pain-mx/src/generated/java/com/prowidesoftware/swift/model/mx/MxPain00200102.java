    ...
    extends AbstractMX
{
    ...
    public static MxPain00200102 parse(String xml) {
        return ((MxPain00200102) MxReadImpl.parse(MxPain00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00200102) MxReadImpl.parse(MxPain00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00200102 .class);
    }
