...
/**
 * Class for pain.002.001.02 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxPain00200102(final String xml) {
        this();
        MxPain00200102 tmp = parse(xml);
        pain00200102 = tmp.getPain00200102();
    }
     ...
     * 
     */
    public MxPain00200102(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxPain00200102 setPain00200102(Pain00200102 value) {
     ...
     * 
     */
    public static MxPain00200102 parse(String xml) {
        return ((MxPain00200102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxPain00200102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxPain00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00200102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxPain00200102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxPain00200102 parse(String xml, MxRead parserImpl) {
        return ((MxPain00200102) parserImpl.read(MxPain00200102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxPain00200102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxPain00200102 message
     * @return
     *     a new instance of MxPain00200102
     */
    public final static MxPain00200102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxPain00200102 .class);
    }
