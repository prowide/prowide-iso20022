    ...
    extends AbstractMX
{
    ...
    public static MxPain00100106 parse(String xml) {
        return ((MxPain00100106) MxReadImpl.parse(MxPain00100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00100106) MxReadImpl.parse(MxPain00100106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00100106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00100106 .class);
    }
