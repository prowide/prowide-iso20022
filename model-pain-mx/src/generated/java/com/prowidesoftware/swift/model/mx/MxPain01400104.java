    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.014.001.04";
    ...
    public static MxPain01400104 parse(String xml) {
        return ((MxPain01400104) MxReadImpl.parse(MxPain01400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01400104) MxReadImpl.parse(MxPain01400104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain01400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01400104 .class);
    }
