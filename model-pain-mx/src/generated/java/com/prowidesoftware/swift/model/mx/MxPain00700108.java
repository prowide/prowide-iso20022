    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.007.001.08";
    ...
    public static MxPain00700108 parse(String xml) {
        return ((MxPain00700108) MxReadImpl.parse(MxPain00700108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00700108 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00700108) MxReadImpl.parse(MxPain00700108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain00700108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00700108 .class);
    }
