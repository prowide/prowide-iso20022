    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.012.001.04";
    ...
    public static MxPain01200104 parse(String xml) {
        return ((MxPain01200104) MxReadImpl.parse(MxPain01200104 .class, xml, _classes));
    }
     ...
     */
    public final static MxPain01200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01200104 .class);
    }
