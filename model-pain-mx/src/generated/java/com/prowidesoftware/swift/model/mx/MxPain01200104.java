    ...
    extends AbstractMX
{
    ...
    public static MxPain01200104 parse(String xml) {
        return ((MxPain01200104) MxReadImpl.parse(MxPain01200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01200104) MxReadImpl.parse(MxPain01200104 .class, xml, _classes, new MxReadParams(conf)));
    }
