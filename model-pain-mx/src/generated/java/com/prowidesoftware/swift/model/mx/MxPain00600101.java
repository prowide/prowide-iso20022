    ...
    extends AbstractMX
{
    ...
    public static MxPain00600101 parse(String xml) {
        return ((MxPain00600101) MxReadImpl.parse(MxPain00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00600101) MxReadImpl.parse(MxPain00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
