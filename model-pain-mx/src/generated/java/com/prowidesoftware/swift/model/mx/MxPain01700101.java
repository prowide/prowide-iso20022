    ...
    extends AbstractMX
{
    ...
    public static MxPain01700101 parse(String xml) {
        return ((MxPain01700101) MxReadImpl.parse(MxPain01700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01700101) MxReadImpl.parse(MxPain01700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01700101 .class);
    }
