    ...
    extends AbstractMX
{
    ...
    public static MxPain01100102 parse(String xml) {
        return ((MxPain01100102) MxReadImpl.parse(MxPain01100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01100102) MxReadImpl.parse(MxPain01100102 .class, xml, _classes, new MxReadParams(conf)));
    }
