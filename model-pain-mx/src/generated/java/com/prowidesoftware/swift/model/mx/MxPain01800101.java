    ...
    extends AbstractMX
{
    ...
    public static MxPain01800101 parse(String xml) {
        return ((MxPain01800101) MxReadImpl.parse(MxPain01800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01800101) MxReadImpl.parse(MxPain01800101 .class, xml, _classes, new MxReadParams(conf)));
    }
