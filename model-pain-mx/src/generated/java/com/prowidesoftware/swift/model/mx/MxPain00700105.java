...
/**
 * Class for pain.007.001.05 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.007.001.05";
     ...
     * 
     */
    public MxPain00700105(final String xml) {
        this();
        MxPain00700105 tmp = parse(xml);
     ...
     * 
     */
    public MxPain00700105(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CustomerPaymentReversalV05 }
     *     
     */
     ...
     *     
     */
    public MxPain00700105 setCstmrPmtRvsl(CustomerPaymentReversalV05 value) {
     ...
     * 
     */
    public static MxPain00700105 parse(String xml) {
        return ((MxPain00700105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxPain00700105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxPain00700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00700105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxPain00700105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxPain00700105 parse(String xml, MxRead parserImpl) {
        return ((MxPain00700105) parserImpl.read(MxPain00700105 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxPain00700105 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxPain00700105 message
     * @return
     *     a new instance of MxPain00700105
     */
    public final static MxPain00700105 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxPain00700105 .class);
    }
