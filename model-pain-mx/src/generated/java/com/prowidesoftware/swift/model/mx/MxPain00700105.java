    ...
    extends AbstractMX
{
    ...
    public static MxPain00700105 parse(String xml) {
        return ((MxPain00700105) MxReadImpl.parse(MxPain00700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00700105) MxReadImpl.parse(MxPain00700105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00700105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00700105 .class);
    }
