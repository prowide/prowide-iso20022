    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.04";
    ...
    public static MxPain01300104 parse(String xml) {
        return ((MxPain01300104) MxReadImpl.parse(MxPain01300104 .class, xml, _classes));
    }
     ...
     */
    public final static MxPain01300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01300104 .class);
    }
