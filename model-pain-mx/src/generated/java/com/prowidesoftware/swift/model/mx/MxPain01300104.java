    ...
    extends AbstractMX
{
    ...
    public static MxPain01300104 parse(String xml) {
        return ((MxPain01300104) MxReadImpl.parse(MxPain01300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01300104) MxReadImpl.parse(MxPain01300104 .class, xml, _classes, new MxReadParams(conf)));
    }
