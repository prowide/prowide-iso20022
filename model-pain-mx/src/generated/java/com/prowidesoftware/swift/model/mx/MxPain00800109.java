    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.09";
    ...
    public static MxPain00800109 parse(String xml) {
        return ((MxPain00800109) MxReadImpl.parse(MxPain00800109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00800109 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00800109) MxReadImpl.parse(MxPain00800109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain00800109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00800109 .class);
    }
