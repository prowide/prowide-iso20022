    ...
    extends AbstractMX
{
    ...
    public static MxPain01200101 parse(String xml) {
        return ((MxPain01200101) MxReadImpl.parse(MxPain01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01200101) MxReadImpl.parse(MxPain01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
