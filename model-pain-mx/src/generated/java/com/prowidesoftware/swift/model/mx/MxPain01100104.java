    ...
    extends AbstractMX
{
    ...
    public static MxPain01100104 parse(String xml) {
        return ((MxPain01100104) MxReadImpl.parse(MxPain01100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01100104) MxReadImpl.parse(MxPain01100104 .class, xml, _classes, new MxReadParams(conf)));
    }
