    ...
    extends AbstractMX
{
    ...
    public static MxPain01300108 parse(String xml) {
        return ((MxPain01300108) MxReadImpl.parse(MxPain01300108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01300108 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01300108) MxReadImpl.parse(MxPain01300108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01300108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01300108 .class);
    }
