...
/**
 * Class for pain.013.001.08 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.08")
public class MxPain01300108
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxPain01300108(final String xml) {
        this();
        MxPain01300108 tmp = parse(xml);
     ...
     * 
     */
    public MxPain01300108(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxPain01300108 setCdtrPmtActvtnReq(CreditorPaymentActivationRequestV08 value) {
     ...
     * 
     */
    public static MxPain01300108 parse(String xml) {
        return ((MxPain01300108) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxPain01300108 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxPain01300108 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01300108) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxPain01300108 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxPain01300108 parse(String xml, MxRead parserImpl) {
        return ((MxPain01300108) parserImpl.read(MxPain01300108 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxPain01300108 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxPain01300108 message
     * @return
     *     a new instance of MxPain01300108
     */
    public static final MxPain01300108 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxPain01300108 .class);
    }
