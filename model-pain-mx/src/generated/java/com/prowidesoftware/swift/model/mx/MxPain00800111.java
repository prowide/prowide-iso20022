    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.11";
    ...
    public static MxPain00800111 parse(String xml) {
        return ((MxPain00800111) MxReadImpl.parse(MxPain00800111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00800111 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00800111) MxReadImpl.parse(MxPain00800111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain00800111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00800111 .class);
    }
