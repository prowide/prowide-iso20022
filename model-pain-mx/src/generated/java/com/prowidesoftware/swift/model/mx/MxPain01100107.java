    ...
    extends AbstractMX
{
    ...
    public static MxPain01100107 parse(String xml) {
        return ((MxPain01100107) MxReadImpl.parse(MxPain01100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01100107) MxReadImpl.parse(MxPain01100107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01100107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01100107 .class);
    }
