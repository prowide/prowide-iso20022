    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.02";
    ...
    public static MxPain00100102 parse(String xml) {
        return ((MxPain00100102) MxReadImpl.parse(MxPain00100102 .class, xml, _classes));
    }
     ...
     */
    public final static MxPain00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00100102 .class);
    }
