    ...
    extends AbstractMX
{
    ...
    public static MxPain00100102 parse(String xml) {
        return ((MxPain00100102) MxReadImpl.parse(MxPain00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00100102) MxReadImpl.parse(MxPain00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
