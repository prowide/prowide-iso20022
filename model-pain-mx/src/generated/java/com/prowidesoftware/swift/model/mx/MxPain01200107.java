    ...
    extends AbstractMX
{
    ...
    public static MxPain01200107 parse(String xml) {
        return ((MxPain01200107) MxReadImpl.parse(MxPain01200107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01200107) MxReadImpl.parse(MxPain01200107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01200107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01200107 .class);
    }
