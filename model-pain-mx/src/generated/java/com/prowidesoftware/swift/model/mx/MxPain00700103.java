    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.007.001.03";
    ...
    public static MxPain00700103 parse(String xml) {
        return ((MxPain00700103) MxReadImpl.parse(MxPain00700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00700103) MxReadImpl.parse(MxPain00700103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain00700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00700103 .class);
    }
