    ...
    extends AbstractMX
{
    ...
    public static MxPain00900107 parse(String xml) {
        return ((MxPain00900107) MxReadImpl.parse(MxPain00900107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00900107 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00900107) MxReadImpl.parse(MxPain00900107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00900107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00900107 .class);
    }
