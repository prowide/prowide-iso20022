...
/**
 * Class for pain.008.001.08 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.08")
public class MxPain00800108
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxPain00800108(final String xml) {
        this();
        MxPain00800108 tmp = parse(xml);
     ...
     * 
     */
    public MxPain00800108(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxPain00800108 setCstmrDrctDbtInitn(CustomerDirectDebitInitiationV08 value) {
     ...
     * 
     */
    public static MxPain00800108 parse(String xml) {
        return ((MxPain00800108) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxPain00800108 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxPain00800108 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00800108) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxPain00800108 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxPain00800108 parse(String xml, MxRead parserImpl) {
        return ((MxPain00800108) parserImpl.read(MxPain00800108 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxPain00800108 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxPain00800108 message
     * @return
     *     a new instance of MxPain00800108
     */
    public static final MxPain00800108 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxPain00800108 .class);
    }
