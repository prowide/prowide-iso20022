    ...
    extends AbstractMX
{
    ...
    public static MxPain00800108 parse(String xml) {
        return ((MxPain00800108) MxReadImpl.parse(MxPain00800108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00800108 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00800108) MxReadImpl.parse(MxPain00800108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00800108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00800108 .class);
    }
