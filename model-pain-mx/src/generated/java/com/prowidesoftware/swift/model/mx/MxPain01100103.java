    ...
    extends AbstractMX
{
    ...
    public static MxPain01100103 parse(String xml) {
        return ((MxPain01100103) MxReadImpl.parse(MxPain01100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01100103) MxReadImpl.parse(MxPain01100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01100103 .class);
    }
