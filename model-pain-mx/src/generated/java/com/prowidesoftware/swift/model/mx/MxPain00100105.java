    ...
    extends AbstractMX
{
    ...
    public static MxPain00100105 parse(String xml) {
        return ((MxPain00100105) MxReadImpl.parse(MxPain00100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00100105) MxReadImpl.parse(MxPain00100105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00100105 .class);
    }
