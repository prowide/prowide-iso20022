    ...
    extends AbstractMX
{
    ...
    public static MxPain00700107 parse(String xml) {
        return ((MxPain00700107) MxReadImpl.parse(MxPain00700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00700107) MxReadImpl.parse(MxPain00700107 .class, xml, _classes, new MxReadParams(conf)));
    }
