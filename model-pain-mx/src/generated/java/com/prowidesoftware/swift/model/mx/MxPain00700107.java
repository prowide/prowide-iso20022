    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.007.001.07";
    ...
    public static MxPain00700107 parse(String xml) {
        return ((MxPain00700107) MxReadImpl.parse(MxPain00700107 .class, xml, _classes));
    }
     ...
     */
    public final static MxPain00700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00700107 .class);
    }
