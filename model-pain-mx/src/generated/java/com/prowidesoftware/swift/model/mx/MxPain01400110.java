...
/**
 * Class for pain.014.001.10 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.014.001.10")
public class MxPain01400110
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.014.001.10";
     ...
     * 
     */
    public MxPain01400110(final String xml) {
        this();
        MxPain01400110 tmp = parse(xml);
     ...
     * 
     */
    public MxPain01400110(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxPain01400110 setCdtrPmtActvtnReqStsRpt(CreditorPaymentActivationRequestStatusReportV10 value) {
     ...
     * 
     */
    public static MxPain01400110 parse(String xml) {
        return ((MxPain01400110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxPain01400110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxPain01400110 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01400110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxPain01400110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxPain01400110 parse(String xml, MxRead parserImpl) {
        return ((MxPain01400110) parserImpl.read(MxPain01400110 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxPain01400110 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxPain01400110 message
     * @return
     *     a new instance of MxPain01400110
     */
    public final static MxPain01400110 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxPain01400110 .class);
    }
