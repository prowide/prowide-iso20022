    ...
    extends AbstractMX
{
    ...
    public static MxPain01400110 parse(String xml) {
        return ((MxPain01400110) MxReadImpl.parse(MxPain01400110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01400110 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01400110) MxReadImpl.parse(MxPain01400110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01400110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01400110 .class);
    }
