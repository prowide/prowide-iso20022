    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.007.001.04";
    ...
    public static MxPain00700104 parse(String xml) {
        return ((MxPain00700104) MxReadImpl.parse(MxPain00700104 .class, xml, _classes));
    }
     ...
     */
    public final static MxPain00700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00700104 .class);
    }
