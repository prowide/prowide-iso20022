    ...
    extends AbstractMX
{
    ...
    public static MxPain00700104 parse(String xml) {
        return ((MxPain00700104) MxReadImpl.parse(MxPain00700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00700104) MxReadImpl.parse(MxPain00700104 .class, xml, _classes, new MxReadParams(conf)));
    }
