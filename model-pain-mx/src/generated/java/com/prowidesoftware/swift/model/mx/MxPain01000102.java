    ...
    extends AbstractMX
{
    ...
    public static MxPain01000102 parse(String xml) {
        return ((MxPain01000102) MxReadImpl.parse(MxPain01000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01000102) MxReadImpl.parse(MxPain01000102 .class, xml, _classes, new MxReadParams(conf)));
    }
