    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.05";
    ...
    public static MxPain00200105 parse(String xml) {
        return ((MxPain00200105) MxReadImpl.parse(MxPain00200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00200105) MxReadImpl.parse(MxPain00200105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain00200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00200105 .class);
    }
