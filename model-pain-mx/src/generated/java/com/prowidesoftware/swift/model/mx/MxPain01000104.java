    ...
    extends AbstractMX
{
    ...
    public static MxPain01000104 parse(String xml) {
        return ((MxPain01000104) MxReadImpl.parse(MxPain01000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01000104) MxReadImpl.parse(MxPain01000104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01000104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01000104 .class);
    }
