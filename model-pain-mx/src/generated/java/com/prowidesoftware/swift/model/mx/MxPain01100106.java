    ...
    extends AbstractMX
{
    ...
    public static MxPain01100106 parse(String xml) {
        return ((MxPain01100106) MxReadImpl.parse(MxPain01100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01100106) MxReadImpl.parse(MxPain01100106 .class, xml, _classes, new MxReadParams(conf)));
    }
