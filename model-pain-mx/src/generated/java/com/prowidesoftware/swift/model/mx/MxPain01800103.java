    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.018.001.03";
    ...
    public static MxPain01800103 parse(String xml) {
        return ((MxPain01800103) MxReadImpl.parse(MxPain01800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01800103) MxReadImpl.parse(MxPain01800103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain01800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01800103 .class);
    }
