    ...
    extends AbstractMX
{
    ...
    public static MxPain01400102 parse(String xml) {
        return ((MxPain01400102) MxReadImpl.parse(MxPain01400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01400102) MxReadImpl.parse(MxPain01400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01400102 .class);
    }
