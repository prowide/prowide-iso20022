    ...
    extends AbstractMX
{
    ...
    public static MxPain01400106 parse(String xml) {
        return ((MxPain01400106) MxReadImpl.parse(MxPain01400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01400106) MxReadImpl.parse(MxPain01400106 .class, xml, _classes, new MxReadParams(conf)));
    }
