    ...
    extends AbstractMX
{
    ...
    public static MxPain01700104 parse(String xml) {
        return ((MxPain01700104) MxReadImpl.parse(MxPain01700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01700104) MxReadImpl.parse(MxPain01700104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01700104 .class);
    }
