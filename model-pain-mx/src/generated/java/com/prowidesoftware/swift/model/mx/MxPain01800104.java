    ...
    extends AbstractMX
{
    ...
    public static MxPain01800104 parse(String xml) {
        return ((MxPain01800104) MxReadImpl.parse(MxPain01800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01800104) MxReadImpl.parse(MxPain01800104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01800104 .class);
    }
