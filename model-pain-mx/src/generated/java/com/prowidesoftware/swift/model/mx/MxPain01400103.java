    ...
    extends AbstractMX
{
    ...
    public static MxPain01400103 parse(String xml) {
        return ((MxPain01400103) MxReadImpl.parse(MxPain01400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01400103) MxReadImpl.parse(MxPain01400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01400103 .class);
    }
