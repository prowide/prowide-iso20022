    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.07";
    ...
    public static MxPain01300107 parse(String xml) {
        return ((MxPain01300107) MxReadImpl.parse(MxPain01300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01300107) MxReadImpl.parse(MxPain01300107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPain01300107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01300107 .class);
    }
