    ...
    extends AbstractMX
{
    ...
    public static MxPain01000106 parse(String xml) {
        return ((MxPain01000106) MxReadImpl.parse(MxPain01000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain01000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain01000106) MxReadImpl.parse(MxPain01000106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain01000106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain01000106 .class);
    }
