    ...
    extends AbstractMX
{
    ...
    public static MxPain00200114 parse(String xml) {
        return ((MxPain00200114) MxReadImpl.parse(MxPain00200114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPain00200114 parse(String xml, MxReadConfiguration conf) {
        return ((MxPain00200114) MxReadImpl.parse(MxPain00200114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPain00200114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPain00200114 .class);
    }
