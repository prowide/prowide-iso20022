...
@XmlType(name = "RemittanceAdviceV07", propOrder = {
    "grpHdr",
    "rmtInf",
    "splmtryData"
})
public class RemittanceAdviceV07 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader122 grpHdr;
    @XmlElement(name = "RmtInf", required = true)
    protected List<RemittanceInformation27> rmtInf;
     ...
     *     
     */
    public RemittanceAdviceV07 setGrpHdr(GroupHeader122 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link RemittanceInformation27 }
     * 
     * 
     * @return
     *     The value of the rmtInf property.
     */
    public List<RemittanceInformation27> getRmtInf() {
        if (rmtInf == null) {
     ...
     * 
     */
    public RemittanceAdviceV07 addRmtInf(RemittanceInformation27 rmtInf) {
     ...
     * 
     */
    public RemittanceAdviceV07 addSplmtryData(SupplementaryData1 splmtryData) {
