...
@XmlType(name = "RemittanceInformation27", propOrder = {
    "rmtId",
    "ustrd",
    "strd",
    "orgnlPmtInf"
})
public class RemittanceInformation27 {
    ...
    protected List<StructuredRemittanceInformation22> strd;
     ...
     *     
     */
    public RemittanceInformation27 setRmtId(String value) {
        this.rmtId = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StructuredRemittanceInformation22 }
     * 
     * 
     * @return
     *     The value of the strd property.
     */
    public List<StructuredRemittanceInformation22> getStrd() {
        if (strd == null) {
            strd = new ArrayList<>();
        }
        return this.strd;
     ...
     *     
     */
    public RemittanceInformation27 setOrgnlPmtInf(OriginalPaymentInformation10 value) {
     ...
     * 
     */
    public RemittanceInformation27 addUstrd(String ustrd) {
        getUstrd().add(ustrd);
        return this;
    }
     ...
     * 
     */
    public RemittanceInformation27 addStrd(StructuredRemittanceInformation22 strd) {
        getStrd().add(strd);
        return this;
    }
