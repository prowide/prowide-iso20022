    ...
    extends AbstractMX
{
    ...
    public static MxSupl03000105 parse(String xml) {
        return ((MxSupl03000105) MxReadImpl.parse(MxSupl03000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03000105) MxReadImpl.parse(MxSupl03000105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl03000105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03000105 .class);
    }
