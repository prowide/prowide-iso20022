    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {DTCCCAISSD1V01 .class, FinancialInstrumentQuantity15Choice.class, MxSupl03000101 .class, OriginalAndCurrentQuantities4 .class, Quantity1Code.class, Quantity40Choice.class, SecuritiesQuantityDetailsSD1 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:supl.030.001.01";
    ...
    public static MxSupl03000101 parse(String xml) {
        return ((MxSupl03000101) MxReadImpl.parse(MxSupl03000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03000101) MxReadImpl.parse(MxSupl03000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl03000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03000101 .class);
    }
