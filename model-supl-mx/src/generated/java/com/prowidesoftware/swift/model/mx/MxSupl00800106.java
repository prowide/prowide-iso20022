    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.008.001.06";
    ...
    public static MxSupl00800106 parse(String xml) {
        return ((MxSupl00800106) MxReadImpl.parse(MxSupl00800106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00800106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00800106) MxReadImpl.parse(MxSupl00800106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00800106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00800106 .class);
    }
