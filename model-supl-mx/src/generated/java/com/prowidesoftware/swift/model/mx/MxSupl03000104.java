    ...
    extends AbstractMX
{
    ...
    public static MxSupl03000104 parse(String xml) {
        return ((MxSupl03000104) MxReadImpl.parse(MxSupl03000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03000104) MxReadImpl.parse(MxSupl03000104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl03000104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03000104 .class);
    }
