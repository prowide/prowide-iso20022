    ...
    extends AbstractMX
{
    ...
    public static MxSupl03500101 parse(String xml) {
        return ((MxSupl03500101) MxReadImpl.parse(MxSupl03500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03500101) MxReadImpl.parse(MxSupl03500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl03500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03500101 .class);
    }
