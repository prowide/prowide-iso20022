    ...
    extends AbstractMX
{
    ...
    public static MxSupl01000101 parse(String xml) {
        return ((MxSupl01000101) MxReadImpl.parse(MxSupl01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl01000101) MxReadImpl.parse(MxSupl01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl01000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl01000101 .class);
    }
