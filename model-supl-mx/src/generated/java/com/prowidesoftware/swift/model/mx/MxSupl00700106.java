    ...
    extends AbstractMX
{
    ...
    public static MxSupl00700106 parse(String xml) {
        return ((MxSupl00700106) MxReadImpl.parse(MxSupl00700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00700106) MxReadImpl.parse(MxSupl00700106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00700106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00700106 .class);
    }
