    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.007.001.09";
    ...
    public static MxSupl00700109 parse(String xml) {
        return ((MxSupl00700109) MxReadImpl.parse(MxSupl00700109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00700109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00700109) MxReadImpl.parse(MxSupl00700109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00700109 fromJson(String json) {
