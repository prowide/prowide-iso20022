    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.008.001.04";
    ...
    public static MxSupl00800104 parse(String xml) {
        return ((MxSupl00800104) MxReadImpl.parse(MxSupl00800104 .class, xml, _classes, new MxReadParams()));
    }
     ...
     * 
     */
    public static MxSupl00800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00800104) MxReadImpl.parse(MxSupl00800104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00800104 .class);
    }
