    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.001.001.14";
    ...
    public static MxSupl00100114 parse(String xml) {
        return ((MxSupl00100114) MxReadImpl.parse(MxSupl00100114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00100114 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00100114) MxReadImpl.parse(MxSupl00100114 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00100114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00100114 .class);
    }
