    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:supl.001.001.06";
    ...
    public static MxSupl00100106 parse(String xml) {
        return ((MxSupl00100106) MxReadImpl.parse(MxSupl00100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00100106) MxReadImpl.parse(MxSupl00100106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00100106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00100106 .class);
    }
