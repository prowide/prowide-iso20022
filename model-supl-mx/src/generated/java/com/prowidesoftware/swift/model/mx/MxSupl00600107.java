    ...
    extends AbstractMX
{
    ...
    public static MxSupl00600107 parse(String xml) {
        return ((MxSupl00600107) MxReadImpl.parse(MxSupl00600107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00600107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00600107) MxReadImpl.parse(MxSupl00600107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00600107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00600107 .class);
    }
