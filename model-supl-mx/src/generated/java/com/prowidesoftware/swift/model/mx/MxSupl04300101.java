    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {ActiveOrHistoricCurrencyAndAmount.class, AmountType4Choice.class, EquivalentAmount2 .class, ExchangeRateInformation3 .class, ExchangeRateType4Code.class, FXSupplementaryData1 .class, MultipleForeignExchangeSD1V01 .class, MxSupl04300101 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.043.001.01";
    ...
    public static MxSupl04300101 parse(String xml) {
        return ((MxSupl04300101) MxReadImpl.parse(MxSupl04300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl04300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl04300101) MxReadImpl.parse(MxSupl04300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl04300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl04300101 .class);
    }
