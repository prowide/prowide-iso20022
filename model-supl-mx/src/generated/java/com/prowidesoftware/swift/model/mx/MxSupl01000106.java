    ...
    extends AbstractMX
{
    ...
    public static MxSupl01000106 parse(String xml) {
        return ((MxSupl01000106) MxReadImpl.parse(MxSupl01000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl01000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl01000106) MxReadImpl.parse(MxSupl01000106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl01000106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl01000106 .class);
    }
