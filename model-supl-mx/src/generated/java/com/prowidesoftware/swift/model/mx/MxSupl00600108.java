    ...
    extends AbstractMX
{
    ...
    public static MxSupl00600108 parse(String xml) {
        return ((MxSupl00600108) MxReadImpl.parse(MxSupl00600108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00600108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00600108) MxReadImpl.parse(MxSupl00600108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00600108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00600108 .class);
    }
