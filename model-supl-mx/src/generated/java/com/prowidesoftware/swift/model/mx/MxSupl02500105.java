    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {CorporateActionGeneralInformationSD61 .class, DTCCCARESD1V05 .class, DTCCSubEventType12Code.class, EventGroup3Code.class, FinancialInstrumentAttributesSD20 .class, MxSupl02500105 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.025.001.05";
    ...
    public static MxSupl02500105 parse(String xml) {
        return ((MxSupl02500105) MxReadImpl.parse(MxSupl02500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl02500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl02500105) MxReadImpl.parse(MxSupl02500105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl02500105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl02500105 .class);
    }
