    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:supl.011.001.02";
    ...
    public static MxSupl01100102 parse(String xml) {
        return ((MxSupl01100102) MxReadImpl.parse(MxSupl01100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl01100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl01100102) MxReadImpl.parse(MxSupl01100102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl01100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl01100102 .class);
    }
