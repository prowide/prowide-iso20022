    ...
    extends AbstractMX
{
    ...
    public static MxSupl00800105 parse(String xml) {
        return ((MxSupl00800105) MxReadImpl.parse(MxSupl00800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00800105) MxReadImpl.parse(MxSupl00800105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00800105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00800105 .class);
    }
