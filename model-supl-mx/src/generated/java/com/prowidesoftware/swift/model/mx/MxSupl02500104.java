    ...
    extends AbstractMX
{
    ...
    public static MxSupl02500104 parse(String xml) {
        return ((MxSupl02500104) MxReadImpl.parse(MxSupl02500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl02500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl02500104) MxReadImpl.parse(MxSupl02500104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl02500104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl02500104 .class);
    }
