...
/**
 * Class for supl.006.001.04 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxSupl00600104(final String xml) {
        this();
        MxSupl00600104 tmp = parse(xml);
     ...
     * 
     */
    public MxSupl00600104(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public DTCCCACNSD1V04 getDTCCCACNSD1() {
        return dtcccacnsd1;
    }
     ...
     *     
     */
    public MxSupl00600104 setDTCCCACNSD1(DTCCCACNSD1V04 value) {
    ...
    public static MxSupl00600104 parse(String xml) {
        return ((MxSupl00600104) MxReadImpl.parse(MxSupl00600104 .class, xml, _classes));
    }
     ...
     */
    public static MxSupl00600104 parse(String xml, MxRead parserImpl) {
        return ((MxSupl00600104) parserImpl.read(MxSupl00600104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSupl00600104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSupl00600104 message
     * @return
