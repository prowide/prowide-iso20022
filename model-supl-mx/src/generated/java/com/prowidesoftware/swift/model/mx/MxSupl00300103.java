    ...
    extends AbstractMX
{
    ...
    public static MxSupl00300103 parse(String xml) {
        return ((MxSupl00300103) MxReadImpl.parse(MxSupl00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00300103) MxReadImpl.parse(MxSupl00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
