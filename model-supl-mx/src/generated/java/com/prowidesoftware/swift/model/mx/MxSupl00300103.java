    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:supl.003.001.03";
    ...
    public static MxSupl00300103 parse(String xml) {
        return ((MxSupl00300103) MxReadImpl.parse(MxSupl00300103 .class, xml, _classes));
    }
     ...
     */
    public final static MxSupl00300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00300103 .class);
    }
