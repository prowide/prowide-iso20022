    ...
    extends AbstractMX
{
    ...
    public static MxSupl01100101 parse(String xml) {
        return ((MxSupl01100101) MxReadImpl.parse(MxSupl01100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl01100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl01100101) MxReadImpl.parse(MxSupl01100101 .class, xml, _classes, new MxReadParams(conf)));
    }
