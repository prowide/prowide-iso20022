    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:supl.001.001.04";
    ...
    public static MxSupl00100104 parse(String xml) {
        return ((MxSupl00100104) MxReadImpl.parse(MxSupl00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00100104) MxReadImpl.parse(MxSupl00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00100104 .class);
    }
