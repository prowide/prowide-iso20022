    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {CorporateActionGeneralInformationSD45 .class, DTCCCAPCSD1V03 .class, DTCCSubEventType8Code.class, EventGroup2Code.class, ExtendedEventType6Code.class, FinancialInstrumentAttributesSD20 .class, MxSupl03400103 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.034.001.03";
    ...
    public static MxSupl03400103 parse(String xml) {
        return ((MxSupl03400103) MxReadImpl.parse(MxSupl03400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03400103) MxReadImpl.parse(MxSupl03400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl03400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03400103 .class);
    }
