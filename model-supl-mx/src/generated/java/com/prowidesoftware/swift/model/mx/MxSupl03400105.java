    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {CorporateActionGeneralInformationSD62 .class, DTCCCAPCSD1V05 .class, DTCCSubEventType11Code.class, EventGroup2Code.class, ExtendedEventType6Code.class, FinancialInstrumentAttributesSD20 .class, MxSupl03400105 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.034.001.05";
    ...
    public static MxSupl03400105 parse(String xml) {
        return ((MxSupl03400105) MxReadImpl.parse(MxSupl03400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03400105) MxReadImpl.parse(MxSupl03400105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl03400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03400105 .class);
    }
