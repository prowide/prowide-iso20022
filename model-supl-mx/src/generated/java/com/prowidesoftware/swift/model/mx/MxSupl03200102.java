    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {ContactIdentification5 .class, DTCCCAICSD1V02 .class, MxSupl03200102 .class, ReorganisationInstructionSD7 .class, ReorganisationWithdrawalTransactionType2Code.class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.032.001.02";
    ...
    public static MxSupl03200102 parse(String xml) {
        return ((MxSupl03200102) MxReadImpl.parse(MxSupl03200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03200102) MxReadImpl.parse(MxSupl03200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl03200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03200102 .class);
    }
