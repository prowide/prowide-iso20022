    ...
    extends AbstractMX
{
    ...
    public static MxSupl02500102 parse(String xml) {
        return ((MxSupl02500102) MxReadImpl.parse(MxSupl02500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl02500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl02500102) MxReadImpl.parse(MxSupl02500102 .class, xml, _classes, new MxReadParams(conf)));
    }
