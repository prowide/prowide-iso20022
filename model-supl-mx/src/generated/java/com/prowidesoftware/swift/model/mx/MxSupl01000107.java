    ...
    extends AbstractMX
{
    ...
    public static MxSupl01000107 parse(String xml) {
        return ((MxSupl01000107) MxReadImpl.parse(MxSupl01000107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl01000107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl01000107) MxReadImpl.parse(MxSupl01000107 .class, xml, _classes, new MxReadParams(conf)));
    }
