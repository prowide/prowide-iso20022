    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.007.001.07";
    ...
    public static MxSupl00700107 parse(String xml) {
        return ((MxSupl00700107) MxReadImpl.parse(MxSupl00700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00700107) MxReadImpl.parse(MxSupl00700107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00700107 .class);
    }
