    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.044.001.01";
    ...
    public static MxSupl04400101 parse(String xml) {
        return ((MxSupl04400101) MxReadImpl.parse(MxSupl04400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl04400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl04400101) MxReadImpl.parse(MxSupl04400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl04400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl04400101 .class);
    }
