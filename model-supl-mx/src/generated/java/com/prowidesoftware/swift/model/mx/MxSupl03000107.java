    ...
    extends AbstractMX
{
    ...
    public static MxSupl03000107 parse(String xml) {
        return ((MxSupl03000107) MxReadImpl.parse(MxSupl03000107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03000107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03000107) MxReadImpl.parse(MxSupl03000107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl03000107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03000107 .class);
    }
