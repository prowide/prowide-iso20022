    ...
    extends AbstractMX
{
    ...
    public static MxSupl03200101 parse(String xml) {
        return ((MxSupl03200101) MxReadImpl.parse(MxSupl03200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03200101) MxReadImpl.parse(MxSupl03200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl03200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03200101 .class);
    }
