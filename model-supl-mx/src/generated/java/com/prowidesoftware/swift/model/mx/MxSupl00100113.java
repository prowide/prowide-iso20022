    ...
    extends AbstractMX
{
    ...
    public static MxSupl00100113 parse(String xml) {
        return ((MxSupl00100113) MxReadImpl.parse(MxSupl00100113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00100113 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00100113) MxReadImpl.parse(MxSupl00100113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00100113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00100113 .class);
    }
