    ...
    extends AbstractMX
{
    ...
    public static MxSupl03000102 parse(String xml) {
        return ((MxSupl03000102) MxReadImpl.parse(MxSupl03000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03000102) MxReadImpl.parse(MxSupl03000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl03000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03000102 .class);
    }
