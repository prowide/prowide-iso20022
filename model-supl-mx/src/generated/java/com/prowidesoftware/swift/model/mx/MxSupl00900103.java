    ...
    extends AbstractMX
{
    ...
    public static MxSupl00900103 parse(String xml) {
        return ((MxSupl00900103) MxReadImpl.parse(MxSupl00900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00900103) MxReadImpl.parse(MxSupl00900103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00900103 .class);
    }
