    ...
    extends AbstractMX
{
    ...
    public static MxSupl01100103 parse(String xml) {
        return ((MxSupl01100103) MxReadImpl.parse(MxSupl01100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl01100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl01100103) MxReadImpl.parse(MxSupl01100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl01100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl01100103 .class);
    }
