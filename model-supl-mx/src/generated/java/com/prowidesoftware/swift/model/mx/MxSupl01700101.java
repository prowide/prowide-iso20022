    ...
    extends AbstractMX
{
    ...
    public static MxSupl01700101 parse(String xml) {
        return ((MxSupl01700101) MxReadImpl.parse(MxSupl01700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl01700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl01700101) MxReadImpl.parse(MxSupl01700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl01700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl01700101 .class);
    }
