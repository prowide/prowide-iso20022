    ...
    extends AbstractMX
{
    ...
    public static MxSupl01000109 parse(String xml) {
        return ((MxSupl01000109) MxReadImpl.parse(MxSupl01000109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl01000109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl01000109) MxReadImpl.parse(MxSupl01000109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl01000109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl01000109 .class);
    }
