    ...
    extends AbstractMX
{
    ...
    public static MxSupl03300101 parse(String xml) {
        return ((MxSupl03300101) MxReadImpl.parse(MxSupl03300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03300101) MxReadImpl.parse(MxSupl03300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl03300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03300101 .class);
    }
