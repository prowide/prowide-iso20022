    ...
    extends AbstractMX
{
    ...
    public static MxSupl00100116 parse(String xml) {
        return ((MxSupl00100116) MxReadImpl.parse(MxSupl00100116 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00100116 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00100116) MxReadImpl.parse(MxSupl00100116 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00100116 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00100116 .class);
    }
