    ...
    extends AbstractMX
{
    ...
    public static MxSupl03000108 parse(String xml) {
        return ((MxSupl03000108) MxReadImpl.parse(MxSupl03000108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03000108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03000108) MxReadImpl.parse(MxSupl03000108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl03000108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03000108 .class);
    }
