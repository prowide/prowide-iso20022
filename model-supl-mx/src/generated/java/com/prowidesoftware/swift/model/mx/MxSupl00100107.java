    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:supl.001.001.07";
    ...
    public static MxSupl00100107 parse(String xml) {
        return ((MxSupl00100107) MxReadImpl.parse(MxSupl00100107 .class, xml, _classes));
    }
     ...
     */
    public final static MxSupl00100107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00100107 .class);
    }
