    ...
    extends AbstractMX
{
    ...
    public static MxSupl00100107 parse(String xml) {
        return ((MxSupl00100107) MxReadImpl.parse(MxSupl00100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00100107) MxReadImpl.parse(MxSupl00100107 .class, xml, _classes, new MxReadParams(conf)));
    }
