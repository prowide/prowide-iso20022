    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:supl.008.001.01";
    ...
    public static MxSupl00800101 parse(String xml) {
        return ((MxSupl00800101) MxReadImpl.parse(MxSupl00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00800101) MxReadImpl.parse(MxSupl00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00800101 .class);
    }
