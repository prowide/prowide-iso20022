    ...
    extends AbstractMX
{
    ...
    public static MxSupl00200104 parse(String xml) {
        return ((MxSupl00200104) MxReadImpl.parse(MxSupl00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00200104) MxReadImpl.parse(MxSupl00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00200104 .class);
    }
