...
/**
 * Class for supl.002.001.04 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:swift:xsd:supl.002.001.04")
public class MxSupl00200104
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:supl.002.001.04";
     ...
     * 
     */
    public MxSupl00200104(final String xml) {
        this();
        MxSupl00200104 tmp = parse(xml);
     ...
     * 
     */
    public MxSupl00200104(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxSupl00200104 setDTCCCANOMktDataSD1(DTCCCANOMarketDataSD1V04 value) {
     ...
     * 
     */
    public static MxSupl00200104 parse(String xml) {
        return ((MxSupl00200104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSupl00200104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSupl00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00200104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSupl00200104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSupl00200104 parse(String xml, MxRead parserImpl) {
        return ((MxSupl00200104) parserImpl.read(MxSupl00200104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSupl00200104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSupl00200104 message
     * @return
     *     a new instance of MxSupl00200104
     */
    public final static MxSupl00200104 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSupl00200104 .class);
    }
