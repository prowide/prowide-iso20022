    ...
    extends AbstractMX
{
    ...
    public static MxSupl03300103 parse(String xml) {
        return ((MxSupl03300103) MxReadImpl.parse(MxSupl03300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03300103) MxReadImpl.parse(MxSupl03300103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl03300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03300103 .class);
    }
