    ...
    extends AbstractMX
{
    ...
    public static MxSupl02700101 parse(String xml) {
        return ((MxSupl02700101) MxReadImpl.parse(MxSupl02700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl02700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl02700101) MxReadImpl.parse(MxSupl02700101 .class, xml, _classes, new MxReadParams(conf)));
    }
