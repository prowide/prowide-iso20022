    ...
    extends AbstractMX
{
    ...
    public static MxSupl03300102 parse(String xml) {
        return ((MxSupl03300102) MxReadImpl.parse(MxSupl03300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03300102) MxReadImpl.parse(MxSupl03300102 .class, xml, _classes, new MxReadParams(conf)));
    }
