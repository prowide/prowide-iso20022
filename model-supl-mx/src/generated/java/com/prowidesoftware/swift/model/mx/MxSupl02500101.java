    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {CorporateActionEventStage4Code.class, CorporateActionSD12 .class, DTCCCARESD1V01 .class, MxSupl02500101 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:supl.025.001.01";
    ...
    public static MxSupl02500101 parse(String xml) {
        return ((MxSupl02500101) MxReadImpl.parse(MxSupl02500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl02500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl02500101) MxReadImpl.parse(MxSupl02500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl02500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl02500101 .class);
    }
