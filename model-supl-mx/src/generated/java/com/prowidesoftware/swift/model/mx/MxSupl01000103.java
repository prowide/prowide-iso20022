    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:supl.010.001.03";
    ...
    public static MxSupl01000103 parse(String xml) {
        return ((MxSupl01000103) MxReadImpl.parse(MxSupl01000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl01000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl01000103) MxReadImpl.parse(MxSupl01000103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl01000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl01000103 .class);
    }
