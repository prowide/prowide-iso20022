    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:supl.001.001.02";
    ...
    public static MxSupl00100102 parse(String xml) {
        return ((MxSupl00100102) MxReadImpl.parse(MxSupl00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00100102) MxReadImpl.parse(MxSupl00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00100102 .class);
    }
