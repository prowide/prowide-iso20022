    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {DTCCCAINSD1V02 .class, FinancialInstrumentQuantity15Choice.class, MxSupl00800102 .class, OptionalDividendAccountQuantitySD2 .class, TaxExemptQuantitySD1 .class, WireInstructionSD2 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:supl.008.001.02";
    ...
    public static MxSupl00800102 parse(String xml) {
        return ((MxSupl00800102) MxReadImpl.parse(MxSupl00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00800102) MxReadImpl.parse(MxSupl00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00800102 .class);
    }
