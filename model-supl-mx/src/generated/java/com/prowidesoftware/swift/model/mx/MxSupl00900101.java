    ...
    extends AbstractMX
{
    ...
    public static MxSupl00900101 parse(String xml) {
        return ((MxSupl00900101) MxReadImpl.parse(MxSupl00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00900101) MxReadImpl.parse(MxSupl00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
