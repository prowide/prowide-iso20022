    ...
    extends AbstractMX
{
    ...
    public static MxSupl00900105 parse(String xml) {
        return ((MxSupl00900105) MxReadImpl.parse(MxSupl00900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00900105) MxReadImpl.parse(MxSupl00900105 .class, xml, _classes, new MxReadParams(conf)));
    }
