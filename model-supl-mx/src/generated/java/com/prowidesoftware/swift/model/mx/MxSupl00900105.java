    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:supl.009.001.05";
    ...
    public static MxSupl00900105 parse(String xml) {
        return ((MxSupl00900105) MxReadImpl.parse(MxSupl00900105 .class, xml, _classes));
    }
     ...
     */
    public final static MxSupl00900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00900105 .class);
    }
