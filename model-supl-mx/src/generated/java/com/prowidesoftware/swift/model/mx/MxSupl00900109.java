    ...
    extends AbstractMX
{
    ...
    public static MxSupl00900109 parse(String xml) {
        return ((MxSupl00900109) MxReadImpl.parse(MxSupl00900109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00900109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00900109) MxReadImpl.parse(MxSupl00900109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00900109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00900109 .class);
    }
