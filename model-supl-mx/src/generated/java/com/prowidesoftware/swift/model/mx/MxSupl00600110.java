    ...
    extends AbstractMX
{
    ...
    public static MxSupl00600110 parse(String xml) {
        return ((MxSupl00600110) MxReadImpl.parse(MxSupl00600110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00600110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00600110) MxReadImpl.parse(MxSupl00600110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00600110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00600110 .class);
    }
