    ...
    extends AbstractMX
{
    ...
    public static MxSupl00900107 parse(String xml) {
        return ((MxSupl00900107) MxReadImpl.parse(MxSupl00900107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00900107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00900107) MxReadImpl.parse(MxSupl00900107 .class, xml, _classes, new MxReadParams(conf)));
    }
