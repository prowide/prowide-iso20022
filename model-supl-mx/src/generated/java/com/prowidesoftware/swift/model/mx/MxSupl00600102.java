    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:supl.006.001.02";
    ...
    public static MxSupl00600102 parse(String xml) {
        return ((MxSupl00600102) MxReadImpl.parse(MxSupl00600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00600102) MxReadImpl.parse(MxSupl00600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00600102 fromJson(String json) {
