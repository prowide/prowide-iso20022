    ...
    extends AbstractMX
{
    ...
    public static MxSupl03100106 parse(String xml) {
        return ((MxSupl03100106) MxReadImpl.parse(MxSupl03100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03100106) MxReadImpl.parse(MxSupl03100106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl03100106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03100106 .class);
    }
