    ...
    extends AbstractMX
{
    ...
    public static MxSupl00200102 parse(String xml) {
        return ((MxSupl00200102) MxReadImpl.parse(MxSupl00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00200102) MxReadImpl.parse(MxSupl00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00200102 .class);
    }
