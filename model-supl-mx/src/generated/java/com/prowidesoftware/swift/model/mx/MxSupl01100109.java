    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.011.001.09";
    ...
    public static MxSupl01100109 parse(String xml) {
        return ((MxSupl01100109) MxReadImpl.parse(MxSupl01100109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl01100109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl01100109) MxReadImpl.parse(MxSupl01100109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl01100109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl01100109 .class);
    }
