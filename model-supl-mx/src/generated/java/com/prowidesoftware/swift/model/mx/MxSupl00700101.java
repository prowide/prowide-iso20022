    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {AccountBalanceExtensionSD1 .class, AdjustedBalanceTypeSD1Choice.class, DTCCCANOEligibleBalanceSD1V01 .class, FinancialInstrumentQuantity15Choice.class, MxSupl00700101 .class, ShortLong1Code.class, SignedQuantityFormat4 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:supl.007.001.01";
    ...
    public static MxSupl00700101 parse(String xml) {
        return ((MxSupl00700101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSupl00700101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSupl00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00700101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSupl00700101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00700101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSupl00700101 .class);
    }
