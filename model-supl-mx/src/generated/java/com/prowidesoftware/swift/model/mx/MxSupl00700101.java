    ...
    extends AbstractMX
{
    ...
    public static MxSupl00700101 parse(String xml) {
        return ((MxSupl00700101) MxReadImpl.parse(MxSupl00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00700101) MxReadImpl.parse(MxSupl00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
