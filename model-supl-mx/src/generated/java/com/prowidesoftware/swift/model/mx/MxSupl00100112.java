    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.001.001.12";
    ...
    public static MxSupl00100112 parse(String xml) {
        return ((MxSupl00100112) MxReadImpl.parse(MxSupl00100112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00100112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00100112) MxReadImpl.parse(MxSupl00100112 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00100112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00100112 .class);
    }
