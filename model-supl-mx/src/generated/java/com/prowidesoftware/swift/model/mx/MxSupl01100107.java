    ...
    extends AbstractMX
{
    ...
    public static MxSupl01100107 parse(String xml) {
        return ((MxSupl01100107) MxReadImpl.parse(MxSupl01100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl01100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl01100107) MxReadImpl.parse(MxSupl01100107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl01100107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl01100107 .class);
    }
