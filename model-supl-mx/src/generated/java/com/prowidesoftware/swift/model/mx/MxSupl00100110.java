    ...
    extends AbstractMX
{
    ...
    public static MxSupl00100110 parse(String xml) {
        return ((MxSupl00100110) MxReadImpl.parse(MxSupl00100110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00100110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00100110) MxReadImpl.parse(MxSupl00100110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00100110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00100110 .class);
    }
