    ...
    extends AbstractMX
{
    ...
    public static MxSupl01100104 parse(String xml) {
        return ((MxSupl01100104) MxReadImpl.parse(MxSupl01100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl01100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl01100104) MxReadImpl.parse(MxSupl01100104 .class, xml, _classes, new MxReadParams(conf)));
    }
