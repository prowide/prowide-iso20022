    ...
    extends AbstractMX
{
    ...
    public static MxSupl00700112 parse(String xml) {
        return ((MxSupl00700112) MxReadImpl.parse(MxSupl00700112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00700112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00700112) MxReadImpl.parse(MxSupl00700112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00700112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00700112 .class);
    }
