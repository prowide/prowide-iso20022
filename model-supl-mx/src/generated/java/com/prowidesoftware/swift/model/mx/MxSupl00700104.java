    ...
    extends AbstractMX
{
    ...
    public static MxSupl00700104 parse(String xml) {
        return ((MxSupl00700104) MxReadImpl.parse(MxSupl00700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00700104) MxReadImpl.parse(MxSupl00700104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00700104 .class);
    }
