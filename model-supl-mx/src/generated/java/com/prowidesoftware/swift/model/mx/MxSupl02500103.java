    ...
    extends AbstractMX
{
    ...
    public static MxSupl02500103 parse(String xml) {
        return ((MxSupl02500103) MxReadImpl.parse(MxSupl02500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl02500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl02500103) MxReadImpl.parse(MxSupl02500103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl02500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl02500103 .class);
    }
