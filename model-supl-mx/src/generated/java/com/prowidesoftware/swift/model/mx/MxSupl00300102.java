    ...
    extends AbstractMX
{
    ...
    public static MxSupl00300102 parse(String xml) {
        return ((MxSupl00300102) MxReadImpl.parse(MxSupl00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00300102) MxReadImpl.parse(MxSupl00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00300102 .class);
    }
