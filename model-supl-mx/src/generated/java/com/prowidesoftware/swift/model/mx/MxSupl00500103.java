    ...
    extends AbstractMX
{
    ...
    public static MxSupl00500103 parse(String xml) {
        return ((MxSupl00500103) MxReadImpl.parse(MxSupl00500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00500103) MxReadImpl.parse(MxSupl00500103 .class, xml, _classes, new MxReadParams(conf)));
    }
