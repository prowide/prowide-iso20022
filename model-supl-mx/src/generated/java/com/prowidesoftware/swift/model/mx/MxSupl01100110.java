    ...
    extends AbstractMX
{
    ...
    public static MxSupl01100110 parse(String xml) {
        return ((MxSupl01100110) MxReadImpl.parse(MxSupl01100110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl01100110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl01100110) MxReadImpl.parse(MxSupl01100110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl01100110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl01100110 .class);
    }
