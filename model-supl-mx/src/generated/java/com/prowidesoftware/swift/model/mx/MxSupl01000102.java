    ...
    extends AbstractMX
{
    ...
    public static MxSupl01000102 parse(String xml) {
        return ((MxSupl01000102) MxReadImpl.parse(MxSupl01000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl01000102) MxReadImpl.parse(MxSupl01000102 .class, xml, _classes, new MxReadParams(conf)));
    }
