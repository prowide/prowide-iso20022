    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:supl.009.001.02";
    ...
    public static MxSupl00900102 parse(String xml) {
        return ((MxSupl00900102) MxReadImpl.parse(MxSupl00900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00900102) MxReadImpl.parse(MxSupl00900102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00900102 .class);
    }
