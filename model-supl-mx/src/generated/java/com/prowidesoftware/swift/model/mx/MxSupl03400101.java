    ...
    extends AbstractMX
{
    ...
    public final static transient Class[] _classes = new Class[] {CorporateActionGeneralInformationSD36 .class, DTCCCAPCSD1V01 .class, DTCCSubEventType6Code.class, EventGroup2Code.class, ExtendedEventType6Code.class, MxSupl03400101 .class };
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.034.001.01";
    ...
    public static MxSupl03400101 parse(String xml) {
        return ((MxSupl03400101) MxReadImpl.parse(MxSupl03400101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSupl03400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03400101 .class);
    }
