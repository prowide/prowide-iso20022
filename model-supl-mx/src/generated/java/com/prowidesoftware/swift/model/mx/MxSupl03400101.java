    ...
    extends AbstractMX
{
    ...
    public static MxSupl03400101 parse(String xml) {
        return ((MxSupl03400101) MxReadImpl.parse(MxSupl03400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03400101) MxReadImpl.parse(MxSupl03400101 .class, xml, _classes, new MxReadParams(conf)));
    }
