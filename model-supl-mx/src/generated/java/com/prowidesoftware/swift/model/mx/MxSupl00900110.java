    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.009.001.10";
    ...
    public static MxSupl00900110 parse(String xml) {
        return ((MxSupl00900110) MxReadImpl.parse(MxSupl00900110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00900110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00900110) MxReadImpl.parse(MxSupl00900110 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl00900110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00900110 .class);
    }
