    ...
    extends AbstractMX
{
    ...
    public static MxSupl00200105 parse(String xml) {
        return ((MxSupl00200105) MxReadImpl.parse(MxSupl00200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00200105) MxReadImpl.parse(MxSupl00200105 .class, xml, _classes, new MxReadParams(conf)));
    }
