    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.030.001.03";
    ...
    public static MxSupl03000103 parse(String xml) {
        return ((MxSupl03000103) MxReadImpl.parse(MxSupl03000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03000103) MxReadImpl.parse(MxSupl03000103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl03000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03000103 .class);
    }
