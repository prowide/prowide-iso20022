    ...
    extends AbstractMX
{
    ...
    public static MxSupl00600105 parse(String xml) {
        return ((MxSupl00600105) MxReadImpl.parse(MxSupl00600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00600105) MxReadImpl.parse(MxSupl00600105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00600105 .class);
    }
