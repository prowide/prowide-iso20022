    ...
    extends AbstractMX
{
    ...
    public static MxSupl00800103 parse(String xml) {
        return ((MxSupl00800103) MxReadImpl.parse(MxSupl00800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00800103) MxReadImpl.parse(MxSupl00800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00800103 .class);
    }
