    ...
    extends AbstractMX
{
    ...
    public static MxSupl00700103 parse(String xml) {
        return ((MxSupl00700103) MxReadImpl.parse(MxSupl00700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00700103) MxReadImpl.parse(MxSupl00700103 .class, xml, _classes, new MxReadParams(conf)));
    }
