    ...
    extends AbstractMX
{
    ...
    public static MxSupl03400102 parse(String xml) {
        return ((MxSupl03400102) MxReadImpl.parse(MxSupl03400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03400102) MxReadImpl.parse(MxSupl03400102 .class, xml, _classes, new MxReadParams(conf)));
    }
