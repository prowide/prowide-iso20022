    ...
    extends AbstractMX
{
    ...
    public final static transient Class[] _classes = new Class[] {CorporateActionGeneralInformationSD45 .class, DTCCCAPCSD1V02 .class, DTCCSubEventType8Code.class, EventGroup2Code.class, ExtendedEventType6Code.class, MxSupl03400102 .class };
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.034.001.02";
    ...
    public static MxSupl03400102 parse(String xml) {
        return ((MxSupl03400102) MxReadImpl.parse(MxSupl03400102 .class, xml, _classes));
    }
     ...
     */
    public final static MxSupl03400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03400102 .class);
    }
