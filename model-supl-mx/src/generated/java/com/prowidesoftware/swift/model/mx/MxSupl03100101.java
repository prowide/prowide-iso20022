    ...
    extends AbstractMX
{
    ...
    public static MxSupl03100101 parse(String xml) {
        return ((MxSupl03100101) MxReadImpl.parse(MxSupl03100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03100101) MxReadImpl.parse(MxSupl03100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl03100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03100101 .class);
    }
