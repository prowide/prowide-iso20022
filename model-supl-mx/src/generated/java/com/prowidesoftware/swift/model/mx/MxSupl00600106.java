    ...
    extends AbstractMX
{
    ...
    public static MxSupl00600106 parse(String xml) {
        return ((MxSupl00600106) MxReadImpl.parse(MxSupl00600106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00600106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00600106) MxReadImpl.parse(MxSupl00600106 .class, xml, _classes, new MxReadParams(conf)));
    }
