    ...
    extends AbstractMX
{
    ...
    public static MxSupl00700110 parse(String xml) {
        return ((MxSupl00700110) MxReadImpl.parse(MxSupl00700110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00700110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00700110) MxReadImpl.parse(MxSupl00700110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00700110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00700110 .class);
    }
