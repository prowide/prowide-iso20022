    ...
    extends AbstractMX
{
    ...
    public static MxSupl00900104 parse(String xml) {
        return ((MxSupl00900104) MxReadImpl.parse(MxSupl00900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00900104) MxReadImpl.parse(MxSupl00900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00900104 .class);
    }
