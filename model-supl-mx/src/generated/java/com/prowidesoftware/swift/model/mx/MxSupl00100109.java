    ...
    extends AbstractMX
{
    ...
    public static MxSupl00100109 parse(String xml) {
        return ((MxSupl00100109) MxReadImpl.parse(MxSupl00100109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00100109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00100109) MxReadImpl.parse(MxSupl00100109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSupl00100109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl00100109 .class);
    }
