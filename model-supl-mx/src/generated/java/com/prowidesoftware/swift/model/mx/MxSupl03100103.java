    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:supl.031.001.03";
    ...
    public static MxSupl03100103 parse(String xml) {
        return ((MxSupl03100103) MxReadImpl.parse(MxSupl03100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl03100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl03100103) MxReadImpl.parse(MxSupl03100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSupl03100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSupl03100103 .class);
    }
