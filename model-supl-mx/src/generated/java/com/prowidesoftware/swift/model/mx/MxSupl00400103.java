    ...
    extends AbstractMX
{
    ...
    public static MxSupl00400103 parse(String xml) {
        return ((MxSupl00400103) MxReadImpl.parse(MxSupl00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSupl00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSupl00400103) MxReadImpl.parse(MxSupl00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
