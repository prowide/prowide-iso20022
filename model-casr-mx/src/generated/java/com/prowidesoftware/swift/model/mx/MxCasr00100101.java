    ...
    extends AbstractMX
{
    ...
    public static MxCasr00100101 parse(String xml) {
        return ((MxCasr00100101) MxReadImpl.parse(MxCasr00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasr00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasr00100101) MxReadImpl.parse(MxCasr00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasr00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasr00100101 .class);
    }
