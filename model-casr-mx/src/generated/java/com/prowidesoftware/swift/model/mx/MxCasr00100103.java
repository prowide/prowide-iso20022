    ...
    extends AbstractMX
{
    ...
    public static MxCasr00100103 parse(String xml) {
        return ((MxCasr00100103) MxReadImpl.parse(MxCasr00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasr00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasr00100103) MxReadImpl.parse(MxCasr00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasr00100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasr00100103 .class);
    }
