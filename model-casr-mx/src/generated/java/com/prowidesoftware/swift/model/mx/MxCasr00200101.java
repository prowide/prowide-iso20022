    ...
    extends AbstractMX
{
    ...
    public static MxCasr00200101 parse(String xml) {
        return ((MxCasr00200101) MxReadImpl.parse(MxCasr00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasr00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasr00200101) MxReadImpl.parse(MxCasr00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasr00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasr00200101 .class);
    }
