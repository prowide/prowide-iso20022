    ...
    extends AbstractMX
{
    ...
    public static MxCasr00200102 parse(String xml) {
        return ((MxCasr00200102) MxReadImpl.parse(MxCasr00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasr00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasr00200102) MxReadImpl.parse(MxCasr00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasr00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasr00200102 .class);
    }
