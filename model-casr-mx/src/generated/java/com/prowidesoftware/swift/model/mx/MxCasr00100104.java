    ...
    extends AbstractMX
{
    ...
    public static MxCasr00100104 parse(String xml) {
        return ((MxCasr00100104) MxReadImpl.parse(MxCasr00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasr00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasr00100104) MxReadImpl.parse(MxCasr00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCasr00100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasr00100104 .class);
    }
