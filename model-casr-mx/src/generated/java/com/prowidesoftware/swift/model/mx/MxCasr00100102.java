    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casr.001.001.02";
    ...
    public static MxCasr00100102 parse(String xml) {
        return ((MxCasr00100102) MxReadImpl.parse(MxCasr00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasr00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasr00100102) MxReadImpl.parse(MxCasr00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasr00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasr00100102 .class);
    }
