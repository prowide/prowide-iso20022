    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:casr.002.001.03";
    ...
    public static MxCasr00200103 parse(String xml) {
        return ((MxCasr00200103) MxReadImpl.parse(MxCasr00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCasr00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCasr00200103) MxReadImpl.parse(MxCasr00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCasr00200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCasr00200103 .class);
    }
