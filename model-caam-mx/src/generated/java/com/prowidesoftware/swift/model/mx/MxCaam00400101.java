    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caam.004.001.01";
    ...
    public static MxCaam00400101 parse(String xml) {
        return ((MxCaam00400101) MxReadImpl.parse(MxCaam00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00400101) MxReadImpl.parse(MxCaam00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaam00400101 fromJson(String json) {
