    ...
    extends AbstractMX
{
    ...
    public static MxCaam00800101 parse(String xml) {
        return ((MxCaam00800101) MxReadImpl.parse(MxCaam00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00800101) MxReadImpl.parse(MxCaam00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaam00800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00800101 .class);
    }
