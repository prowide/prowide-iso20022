    ...
    extends AbstractMX
{
    ...
    public static MxCaam00300101 parse(String xml) {
        return ((MxCaam00300101) MxReadImpl.parse(MxCaam00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00300101) MxReadImpl.parse(MxCaam00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaam00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00300101 .class);
    }
