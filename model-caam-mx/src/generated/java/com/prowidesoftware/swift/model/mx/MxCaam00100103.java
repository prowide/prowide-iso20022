    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caam.001.001.03";
    ...
    public static MxCaam00100103 parse(String xml) {
        return ((MxCaam00100103) MxReadImpl.parse(MxCaam00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00100103) MxReadImpl.parse(MxCaam00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaam00100103 fromJson(String json) {
