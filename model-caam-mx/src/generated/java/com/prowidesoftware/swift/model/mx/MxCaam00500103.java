    ...
    extends AbstractMX
{
    ...
    public static MxCaam00500103 parse(String xml) {
        return ((MxCaam00500103) MxReadImpl.parse(MxCaam00500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00500103) MxReadImpl.parse(MxCaam00500103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaam00500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00500103 .class);
    }
