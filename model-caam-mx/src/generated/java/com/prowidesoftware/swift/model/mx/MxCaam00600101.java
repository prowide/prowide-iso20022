    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caam.006.001.01";
    ...
    public static MxCaam00600101 parse(String xml) {
        return ((MxCaam00600101) MxReadImpl.parse(MxCaam00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00600101) MxReadImpl.parse(MxCaam00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaam00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00600101 .class);
    }
