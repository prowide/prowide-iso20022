    ...
    extends AbstractMX
{
    ...
    public static MxCaam00100104 parse(String xml) {
        return ((MxCaam00100104) MxReadImpl.parse(MxCaam00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00100104) MxReadImpl.parse(MxCaam00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaam00100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00100104 .class);
    }
