    ...
    extends AbstractMX
{
    ...
    public static MxCaam00100102 parse(String xml) {
        return ((MxCaam00100102) MxReadImpl.parse(MxCaam00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00100102) MxReadImpl.parse(MxCaam00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaam00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00100102 .class);
    }
