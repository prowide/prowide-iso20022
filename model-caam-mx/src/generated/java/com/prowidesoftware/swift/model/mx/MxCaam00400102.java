    ...
    extends AbstractMX
{
    ...
    public static MxCaam00400102 parse(String xml) {
        return ((MxCaam00400102) MxReadImpl.parse(MxCaam00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00400102) MxReadImpl.parse(MxCaam00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaam00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00400102 .class);
    }
