    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caam.005.001.02";
    ...
    public static MxCaam00500102 parse(String xml) {
        return ((MxCaam00500102) MxReadImpl.parse(MxCaam00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00500102) MxReadImpl.parse(MxCaam00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaam00500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00500102 .class);
    }
