    ...
    extends AbstractMX
{
    ...
    public static MxCaam00400103 parse(String xml) {
        return ((MxCaam00400103) MxReadImpl.parse(MxCaam00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00400103) MxReadImpl.parse(MxCaam00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaam00400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00400103 .class);
    }
