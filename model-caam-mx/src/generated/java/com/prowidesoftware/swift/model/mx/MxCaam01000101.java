    ...
    extends AbstractMX
{
    ...
    public static MxCaam01000101 parse(String xml) {
        return ((MxCaam01000101) MxReadImpl.parse(MxCaam01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam01000101) MxReadImpl.parse(MxCaam01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaam01000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam01000101 .class);
    }
