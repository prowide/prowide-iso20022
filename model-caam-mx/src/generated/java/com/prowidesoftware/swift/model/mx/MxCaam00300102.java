    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caam.003.001.02";
    ...
    public static MxCaam00300102 parse(String xml) {
        return ((MxCaam00300102) MxReadImpl.parse(MxCaam00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00300102) MxReadImpl.parse(MxCaam00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaam00300102 fromJson(String json) {
