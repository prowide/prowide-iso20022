    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caam.005.001.01";
    ...
    public static MxCaam00500101 parse(String xml) {
        return ((MxCaam00500101) MxReadImpl.parse(MxCaam00500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00500101) MxReadImpl.parse(MxCaam00500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaam00500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00500101 .class);
    }
