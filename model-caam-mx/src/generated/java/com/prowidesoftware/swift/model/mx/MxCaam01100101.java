    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caam.011.001.01";
    ...
    public static MxCaam01100101 parse(String xml) {
        return ((MxCaam01100101) MxReadImpl.parse(MxCaam01100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam01100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam01100101) MxReadImpl.parse(MxCaam01100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaam01100101 fromJson(String json) {
