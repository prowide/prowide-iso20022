    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caam.009.001.02";
    ...
    public static MxCaam00900102 parse(String xml) {
        return ((MxCaam00900102) MxReadImpl.parse(MxCaam00900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00900102) MxReadImpl.parse(MxCaam00900102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaam00900102 fromJson(String json) {
