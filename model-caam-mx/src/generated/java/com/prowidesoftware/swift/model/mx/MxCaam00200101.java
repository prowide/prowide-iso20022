    ...
    extends AbstractMX
{
    ...
    public static MxCaam00200101 parse(String xml) {
        return ((MxCaam00200101) MxReadImpl.parse(MxCaam00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00200101) MxReadImpl.parse(MxCaam00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
