    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caam.012.001.01";
    ...
    public static MxCaam01200101 parse(String xml) {
        return ((MxCaam01200101) MxReadImpl.parse(MxCaam01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam01200101) MxReadImpl.parse(MxCaam01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaam01200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam01200101 .class);
    }
