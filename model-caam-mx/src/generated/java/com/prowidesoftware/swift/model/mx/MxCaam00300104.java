    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caam.003.001.04";
    ...
    public static MxCaam00300104 parse(String xml) {
        return ((MxCaam00300104) MxReadImpl.parse(MxCaam00300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00300104) MxReadImpl.parse(MxCaam00300104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaam00300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00300104 .class);
    }
