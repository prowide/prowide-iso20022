...
/**
 * Class for caam.001.001.01 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCaam00100101(final String xml) {
        this();
        MxCaam00100101 tmp = parse(xml);
     ...
     * 
     */
    public MxCaam00100101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link ATMDeviceReportV01 }
     *     
     */
    public ATMDeviceReportV01 getATMDvcRpt() {
        return atmDvcRpt;
    }
     ...
     *     
     */
    public MxCaam00100101 setATMDvcRpt(ATMDeviceReportV01 value) {
    ...
    public static MxCaam00100101 parse(String xml) {
        return ((MxCaam00100101) MxReadImpl.parse(MxCaam00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00100101) MxReadImpl.parse(MxCaam00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCaam00100101 parse(String xml, MxRead parserImpl) {
        return ((MxCaam00100101) parserImpl.read(MxCaam00100101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaam00100101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaam00100101 message
     * @return
     *     a new instance of MxCaam00100101
     */
    public static final MxCaam00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00100101 .class);
    }
