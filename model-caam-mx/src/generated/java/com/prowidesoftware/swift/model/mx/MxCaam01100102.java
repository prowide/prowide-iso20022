    ...
    extends AbstractMX
{
    ...
    public static MxCaam01100102 parse(String xml) {
        return ((MxCaam01100102) MxReadImpl.parse(MxCaam01100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam01100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam01100102) MxReadImpl.parse(MxCaam01100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaam01100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam01100102 .class);
    }
