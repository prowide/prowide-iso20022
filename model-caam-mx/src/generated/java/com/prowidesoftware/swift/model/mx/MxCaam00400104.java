    ...
    extends AbstractMX
{
    ...
    public static MxCaam00400104 parse(String xml) {
        return ((MxCaam00400104) MxReadImpl.parse(MxCaam00400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00400104) MxReadImpl.parse(MxCaam00400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaam00400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00400104 .class);
    }
