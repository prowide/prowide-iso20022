    ...
    extends AbstractMX
{
    ...
    public static MxCaam00200102 parse(String xml) {
        return ((MxCaam00200102) MxReadImpl.parse(MxCaam00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00200102) MxReadImpl.parse(MxCaam00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaam00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00200102 .class);
    }
