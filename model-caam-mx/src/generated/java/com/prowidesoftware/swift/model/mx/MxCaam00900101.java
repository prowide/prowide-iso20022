    ...
    extends AbstractMX
{
    ...
    public static MxCaam00900101 parse(String xml) {
        return ((MxCaam00900101) MxReadImpl.parse(MxCaam00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaam00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaam00900101) MxReadImpl.parse(MxCaam00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaam00900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaam00900101 .class);
    }
