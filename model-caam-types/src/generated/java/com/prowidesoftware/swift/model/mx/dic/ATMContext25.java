...
@XmlType(name = "ATMContext25", propOrder = {
    "ssnRef",
    "svc"
})
public class ATMContext25 {

    @XmlElement(name = "SsnRef")
    protected String ssnRef;
    @XmlElement(name = "Svc", required = true)
    protected ATMService27 svc;
     ...
     *     
     */
    public ATMContext25 setSsnRef(String value) {
        this.ssnRef = value;
        return this;
    }
     ...
     *     
     */
    public ATMContext25 setSvc(ATMService27 value) {
        this.svc = value;
        return this;
    }
