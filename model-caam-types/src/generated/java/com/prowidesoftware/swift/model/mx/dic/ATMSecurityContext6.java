...
@XmlType(name = "ATMSecurityContext6", propOrder = {
    "curSctySchme",
    "sctySchmeCpblties",
    "sctyDvc",
    "key",
...
public class ATMSecurityContext6 {
    ...
    @XmlElement(name = "Key")
    protected List<CryptographicKey20> key;
     ...
     *     
     */
    public ATMSecurityContext6 setCurSctySchme(ATMSecurityScheme3Code value) {
     ...
     *     
     */
    public ATMSecurityContext6 setSctyDvc(ATMSecurityDevice2 value) {
        this.sctyDvc = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CryptographicKey20 }
     * 
     * 
     * @return
     *     The value of the key property.
     */
    public List<CryptographicKey20> getKey() {
        if (key == null) {
            key = new ArrayList<>();
        }
        return this.key;
     ...
     *     byte[]
     */
    public ATMSecurityContext6 setHstChllng(byte[] value) {
     ...
     * 
     */
    public ATMSecurityContext6 addSctySchmeCpblties(ATMSecurityScheme4Code sctySchmeCpblties) {
     ...
     * 
     */
    public ATMSecurityContext6 addKey(CryptographicKey20 key) {
        getKey().add(key);
        return this;
    }
