...
public class ATMTransaction27 {
     ...
     *     
     */
    public ATMTransaction27 setTxId(TransactionIdentifier1 value) {
        this.txId = value;
        return this;
    }
     ...
     *     
     */
    public ATMTransaction27 setRcncltnId(String value) {
     ...
     *     
     */
    public ATMTransaction27 setElctrncPrsBal(CurrencyAndAmount value) {
     ...
     * 
     */
    public ATMTransaction27 addXcptn(FailureReason8Code xcptn) {
        getXcptn().add(xcptn);
        return this;
    }
     ...
     * 
     */
    public ATMTransaction27 addXcptnDtl(String xcptnDtl) {
