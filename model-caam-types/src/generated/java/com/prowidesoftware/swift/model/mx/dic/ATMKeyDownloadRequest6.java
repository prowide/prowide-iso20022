...
@XmlType(name = "ATMKeyDownloadRequest6", propOrder = {
    "envt",
    "cmdRslt",
    "cmdCntxt",
    "atmSctyCntxt",
...
public class ATMKeyDownloadRequest6 {
    ...
    protected SecurityParameters18 atmSctyParams;
     ...
     *     
     */
    public ATMKeyDownloadRequest6 setEnvt(ATMEnvironment15 value) {
        this.envt = value;
        return this;
    }
     ...
     *     
     */
    public ATMKeyDownloadRequest6 setCmdCntxt(ATMCommand16 value) {
        this.cmdCntxt = value;
        return this;
    }
     ...
     *     
     */
    public ATMKeyDownloadRequest6 setATMSctyCntxt(ATMSecurityContext3 value) {
     ...
     * @return
     *     possible object is
     *     {@link SecurityParameters18 }
     *     
     */
    public SecurityParameters18 getATMSctyParams() {
     ...
     *     
     */
    public ATMKeyDownloadRequest6 setATMSctyParams(SecurityParameters18 value) {
     ...
     *     byte[]
     */
    public ATMKeyDownloadRequest6 setHstChllng(byte[] value) {
     ...
     * 
     */
    public ATMKeyDownloadRequest6 addCmdRslt(ATMCommand15 cmdRslt) {
