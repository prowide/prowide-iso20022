...
@XmlType(name = "ATMKeyDownloadResponse6", propOrder = {
    "envt",
    "atmSctyCntxt",
    "atmChllng",
    "hstSctyParams",
...
public class ATMKeyDownloadResponse6 {
    ...
    protected SecurityParameters19 hstSctyParams;
    @XmlElement(name = "Cmd")
    protected List<ATMCommand17> cmd;
     ...
     *     
     */
    public ATMKeyDownloadResponse6 setEnvt(ATMEnvironment7 value) {
        this.envt = value;
        return this;
    }
     ...
     *     
     */
    public ATMKeyDownloadResponse6 setATMSctyCntxt(ATMSecurityContext3 value) {
     ...
     *     byte[]
     */
    public ATMKeyDownloadResponse6 setATMChllng(byte[] value) {
     ...
     * @return
     *     possible object is
     *     {@link SecurityParameters19 }
     *     
     */
    public SecurityParameters19 getHstSctyParams() {
     ...
     *     
     */
    public ATMKeyDownloadResponse6 setHstSctyParams(SecurityParameters19 value) {
     ...
     */
    public List<ATMCommand17> getCmd() {
        if (cmd == null) {
            cmd = new ArrayList<>();
        }
        return this.cmd;
     ...
     * 
     */
    public ATMKeyDownloadResponse6 addCmd(ATMCommand17 cmd) {
        getCmd().add(cmd);
        return this;
    }
