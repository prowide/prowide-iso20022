...
@XmlType(name = "ATMDeviceControl1", propOrder = {
    "envt",
    "cmd"
})
public class ATMDeviceControl1 {
    ...
    @XmlElement(name = "Cmd")
    protected List<ATMCommand4> cmd;
     ...
     *     
     */
    public ATMDeviceControl1 setEnvt(ATMEnvironment7 value) {
        this.envt = value;
        return this;
    }
     ...
     * 
     */
    public List<ATMCommand4> getCmd() {
        if (cmd == null) {
            cmd = new ArrayList<ATMCommand4>();
        }
        return this.cmd;
    }
     ...
     * 
     */
    public ATMDeviceControl1 addCmd(ATMCommand4 cmd) {
        getCmd().add(cmd);
        return this;
    }
