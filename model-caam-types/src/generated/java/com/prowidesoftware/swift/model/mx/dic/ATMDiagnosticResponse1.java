...
@XmlType(name = "ATMDiagnosticResponse1", propOrder = {
    "envt",
    "cmd"
})
public class ATMDiagnosticResponse1 {
     ...
     *     
     */
    public ATMDiagnosticResponse1 setEnvt(ATMEnvironment6 value) {
        this.envt = value;
        return this;
    }
     ...
     * 
     */
    public ATMDiagnosticResponse1 addCmd(ATMCommand1 cmd) {
        getCmd().add(cmd);
        return this;
    }
