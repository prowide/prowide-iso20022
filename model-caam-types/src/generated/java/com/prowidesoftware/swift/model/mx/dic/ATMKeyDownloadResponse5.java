...
@XmlType(name = "ATMKeyDownloadResponse5", propOrder = {
    "envt",
    "atmSctyCntxt",
    "atmChllng",
    "hstSctyParams",
...
public class ATMKeyDownloadResponse5 {
     ...
     *     
     */
    public ATMKeyDownloadResponse5 setEnvt(ATMEnvironment7 value) {
        this.envt = value;
        return this;
    }
     ...
     *     
     */
    public ATMKeyDownloadResponse5 setATMSctyCntxt(ATMSecurityContext3 value) {
     ...
     *     byte[]
     */
    public ATMKeyDownloadResponse5 setATMChllng(byte[] value) {
     ...
     *     
     */
    public ATMKeyDownloadResponse5 setHstSctyParams(SecurityParameters10 value) {
    ...
    public List<ATMCommand17> getCmd() {
        if (cmd == null) {
            cmd = new ArrayList<ATMCommand17>();
        }
        return this.cmd;
    }
     ...
     * 
     */
    public ATMKeyDownloadResponse5 addCmd(ATMCommand17 cmd) {
        getCmd().add(cmd);
        return this;
    }
