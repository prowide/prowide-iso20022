...
@XmlType(name = "ATMKeyDownloadRequestV05", propOrder = {
    "hdr",
    "prtctdATMKeyDwnldReq",
    "atmKeyDwnldReq",
    "sctyTrlr"
})
public class ATMKeyDownloadRequestV05 {
    ...
    protected ATMKeyDownloadRequest6 atmKeyDwnldReq;
     ...
     *     
     */
    public ATMKeyDownloadRequestV05 setHdr(Header31 value) {
        this.hdr = value;
        return this;
    }
     ...
     *     
     */
    public ATMKeyDownloadRequestV05 setPrtctdATMKeyDwnldReq(ContentInformationType10 value) {
     ...
     * @return
     *     possible object is
     *     {@link ATMKeyDownloadRequest6 }
     *     
     */
    public ATMKeyDownloadRequest6 getATMKeyDwnldReq() {
     ...
     *     
     */
    public ATMKeyDownloadRequestV05 setATMKeyDwnldReq(ATMKeyDownloadRequest6 value) {
     ...
     *     
     */
    public ATMKeyDownloadRequestV05 setSctyTrlr(ContentInformationType13 value) {
        this.sctyTrlr = value;
        return this;
    }
