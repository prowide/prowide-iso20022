    ...
    extends AbstractMX
{
    ...
    public static MxColr01300105 parse(String xml) {
        return ((MxColr01300105) MxReadImpl.parse(MxColr01300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01300105) MxReadImpl.parse(MxColr01300105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01300105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01300105 .class);
    }
