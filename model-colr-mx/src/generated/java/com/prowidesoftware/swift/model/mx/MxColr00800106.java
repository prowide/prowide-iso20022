    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.008.001.06";
    ...
    public static MxColr00800106 parse(String xml) {
        return ((MxColr00800106) MxReadImpl.parse(MxColr00800106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00800106 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00800106) MxReadImpl.parse(MxColr00800106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr00800106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00800106 .class);
    }
