    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.003.001.01";
    ...
    public static MxColr00300101 parse(String xml) {
        return ((MxColr00300101) MxReadImpl.parse(MxColr00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00300101) MxReadImpl.parse(MxColr00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00300101 .class);
    }
