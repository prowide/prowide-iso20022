    ...
    extends AbstractMX
{
    ...
    public static MxColr01100104 parse(String xml) {
        return ((MxColr01100104) MxReadImpl.parse(MxColr01100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01100104) MxReadImpl.parse(MxColr01100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr01100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01100104 .class);
    }
