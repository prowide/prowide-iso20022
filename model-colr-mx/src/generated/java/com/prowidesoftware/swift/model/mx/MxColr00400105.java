    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.004.001.05";
    ...
    public static MxColr00400105 parse(String xml) {
        return ((MxColr00400105) MxReadImpl.parse(MxColr00400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00400105) MxReadImpl.parse(MxColr00400105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr00400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00400105 .class);
    }
