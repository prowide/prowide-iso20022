    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.014.001.03";
    ...
    public static MxColr01400103 parse(String xml) {
        return ((MxColr01400103) MxReadImpl.parse(MxColr01400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01400103) MxReadImpl.parse(MxColr01400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01400103 .class);
    }
