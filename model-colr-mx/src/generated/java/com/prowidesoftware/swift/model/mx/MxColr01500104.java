    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.015.001.04";
    ...
    public static MxColr01500104 parse(String xml) {
        return ((MxColr01500104) MxReadImpl.parse(MxColr01500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01500104) MxReadImpl.parse(MxColr01500104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01500104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01500104 .class);
    }
