...
/**
 * Class for colr.014.001.01 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:swift:xsd:colr.014.001.01")
public class MxColr01400101
    extends AbstractMX
{
     ...
     * 
     */
    public MxColr01400101(final String xml) {
        this();
        MxColr01400101 tmp = parse(xml);
     ...
     * 
     */
    public MxColr01400101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link InterestPaymentResponseV01 }
     *     
     */
     ...
     *     
     */
    public MxColr01400101 setIntrstPmtRspn(InterestPaymentResponseV01 value) {
    ...
    public static MxColr01400101 parse(String xml) {
        return ((MxColr01400101) MxReadImpl.parse(MxColr01400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01400101) MxReadImpl.parse(MxColr01400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxColr01400101 parse(String xml, MxRead parserImpl) {
        return ((MxColr01400101) parserImpl.read(MxColr01400101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxColr01400101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxColr01400101 message
     * @return
     *     a new instance of MxColr01400101
     */
    public static final MxColr01400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01400101 .class);
    }
