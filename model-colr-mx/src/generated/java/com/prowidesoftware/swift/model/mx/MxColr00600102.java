    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.006.001.02";
    ...
    public static MxColr00600102 parse(String xml) {
        return ((MxColr00600102) MxReadImpl.parse(MxColr00600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00600102) MxReadImpl.parse(MxColr00600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr00600102 fromJson(String json) {
