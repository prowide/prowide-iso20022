    ...
    extends AbstractMX
{
    ...
    public static MxColr00200102 parse(String xml) {
        return ((MxColr00200102) MxReadImpl.parse(MxColr00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00200102) MxReadImpl.parse(MxColr00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00200102 .class);
    }
