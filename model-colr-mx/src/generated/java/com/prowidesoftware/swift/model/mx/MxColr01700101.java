    ...
    extends AbstractMX
{
    ...
    public static MxColr01700101 parse(String xml) {
        return ((MxColr01700101) MxReadImpl.parse(MxColr01700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01700101) MxReadImpl.parse(MxColr01700101 .class, xml, _classes, new MxReadParams(conf)));
    }
