    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.015.001.05";
    ...
    public static MxColr01500105 parse(String xml) {
        return ((MxColr01500105) MxReadImpl.parse(MxColr01500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01500105) MxReadImpl.parse(MxColr01500105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01500105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01500105 .class);
    }
