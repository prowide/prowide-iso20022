    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.013.001.03";
    ...
    public static MxColr01300103 parse(String xml) {
        return ((MxColr01300103) MxReadImpl.parse(MxColr01300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01300103) MxReadImpl.parse(MxColr01300103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01300103 fromJson(String json) {
