    ...
    extends AbstractMX
{
    ...
    public static MxColr01200104 parse(String xml) {
        return ((MxColr01200104) MxReadImpl.parse(MxColr01200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01200104) MxReadImpl.parse(MxColr01200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr01200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01200104 .class);
    }
