    ...
    extends AbstractMX
{
    ...
    public static MxColr00800103 parse(String xml) {
        return ((MxColr00800103) MxReadImpl.parse(MxColr00800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00800103) MxReadImpl.parse(MxColr00800103 .class, xml, _classes, new MxReadParams(conf)));
    }
