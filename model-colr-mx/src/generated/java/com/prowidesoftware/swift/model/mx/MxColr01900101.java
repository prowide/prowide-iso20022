    ...
    extends AbstractMX
{
    ...
    public static MxColr01900101 parse(String xml) {
        return ((MxColr01900101) MxReadImpl.parse(MxColr01900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01900101) MxReadImpl.parse(MxColr01900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01900101 .class);
    }
