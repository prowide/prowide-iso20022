    ...
    extends AbstractMX
{
    ...
    public static MxColr01800101 parse(String xml) {
        return ((MxColr01800101) MxReadImpl.parse(MxColr01800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01800101) MxReadImpl.parse(MxColr01800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr01800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01800101 .class);
    }
