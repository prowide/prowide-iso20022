    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.016.001.03";
    ...
    public static MxColr01600103 parse(String xml) {
        return ((MxColr01600103) MxReadImpl.parse(MxColr01600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01600103) MxReadImpl.parse(MxColr01600103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01600103 .class);
    }
