    ...
    extends AbstractMX
{
    ...
    public static MxColr00400102 parse(String xml) {
        return ((MxColr00400102) MxReadImpl.parse(MxColr00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00400102) MxReadImpl.parse(MxColr00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00400102 .class);
    }
