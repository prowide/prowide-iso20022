    ...
    extends AbstractMX
{
    ...
    public static MxColr00800102 parse(String xml) {
        return ((MxColr00800102) MxReadImpl.parse(MxColr00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00800102) MxReadImpl.parse(MxColr00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr00800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00800102 .class);
    }
