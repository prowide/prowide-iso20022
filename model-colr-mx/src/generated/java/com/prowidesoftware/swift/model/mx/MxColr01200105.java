    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.012.001.05";
    ...
    public static MxColr01200105 parse(String xml) {
        return ((MxColr01200105) MxReadImpl.parse(MxColr01200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01200105) MxReadImpl.parse(MxColr01200105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01200105 .class);
    }
