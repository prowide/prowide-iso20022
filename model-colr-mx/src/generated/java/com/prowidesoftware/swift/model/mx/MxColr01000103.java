    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.010.001.03";
    ...
    public static MxColr01000103 parse(String xml) {
        return ((MxColr01000103) MxReadImpl.parse(MxColr01000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01000103) MxReadImpl.parse(MxColr01000103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01000103 fromJson(String json) {
