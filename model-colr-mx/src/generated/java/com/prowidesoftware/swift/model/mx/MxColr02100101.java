    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.021.001.01";
    ...
    public static MxColr02100101 parse(String xml) {
        return ((MxColr02100101) MxReadImpl.parse(MxColr02100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr02100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr02100101) MxReadImpl.parse(MxColr02100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr02100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr02100101 .class);
    }
