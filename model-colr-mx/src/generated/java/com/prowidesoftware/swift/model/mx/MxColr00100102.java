    ...
    extends AbstractMX
{
    ...
    public static MxColr00100102 parse(String xml) {
        return ((MxColr00100102) MxReadImpl.parse(MxColr00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00100102) MxReadImpl.parse(MxColr00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00100102 .class);
    }
