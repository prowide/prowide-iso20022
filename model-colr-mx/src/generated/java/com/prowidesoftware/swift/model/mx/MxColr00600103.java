    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.006.001.03";
    ...
    public static MxColr00600103 parse(String xml) {
        return ((MxColr00600103) MxReadImpl.parse(MxColr00600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00600103) MxReadImpl.parse(MxColr00600103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr00600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00600103 .class);
    }
