    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.007.001.05";
    ...
    public static MxColr00700105 parse(String xml) {
        return ((MxColr00700105) MxReadImpl.parse(MxColr00700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00700105) MxReadImpl.parse(MxColr00700105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr00700105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00700105 .class);
    }
