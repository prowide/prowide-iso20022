    ...
    extends AbstractMX
{
    ...
    public static MxColr00300104 parse(String xml) {
        return ((MxColr00300104) MxReadImpl.parse(MxColr00300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00300104) MxReadImpl.parse(MxColr00300104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr00300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00300104 .class);
    }
