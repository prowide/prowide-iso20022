    ...
    extends AbstractMX
{
    ...
    public static MxColr00700106 parse(String xml) {
        return ((MxColr00700106) MxReadImpl.parse(MxColr00700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00700106) MxReadImpl.parse(MxColr00700106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr00700106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00700106 .class);
    }
