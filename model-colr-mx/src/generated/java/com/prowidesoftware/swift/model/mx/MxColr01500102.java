    ...
    extends AbstractMX
{
    ...
    public static MxColr01500102 parse(String xml) {
        return ((MxColr01500102) MxReadImpl.parse(MxColr01500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01500102) MxReadImpl.parse(MxColr01500102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01500102 .class);
    }
