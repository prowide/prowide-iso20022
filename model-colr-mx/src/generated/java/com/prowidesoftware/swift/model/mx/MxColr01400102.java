    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.014.001.02";
    ...
    public static MxColr01400102 parse(String xml) {
        return ((MxColr01400102) MxReadImpl.parse(MxColr01400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01400102) MxReadImpl.parse(MxColr01400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01400102 .class);
    }
