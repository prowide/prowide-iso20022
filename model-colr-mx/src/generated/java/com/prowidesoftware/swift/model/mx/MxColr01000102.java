    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.010.001.02";
    ...
    public static MxColr01000102 parse(String xml) {
        return ((MxColr01000102) MxReadImpl.parse(MxColr01000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01000102) MxReadImpl.parse(MxColr01000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01000102 .class);
    }
