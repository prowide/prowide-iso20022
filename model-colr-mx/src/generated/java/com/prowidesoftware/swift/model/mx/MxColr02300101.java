    ...
    extends AbstractMX
{
    ...
    public static MxColr02300101 parse(String xml) {
        return ((MxColr02300101) MxReadImpl.parse(MxColr02300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr02300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr02300101) MxReadImpl.parse(MxColr02300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr02300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr02300101 .class);
    }
