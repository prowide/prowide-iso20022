    ...
    extends AbstractMX
{
    ...
    public static MxColr00900105 parse(String xml) {
        return ((MxColr00900105) MxReadImpl.parse(MxColr00900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00900105) MxReadImpl.parse(MxColr00900105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr00900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00900105 .class);
    }
