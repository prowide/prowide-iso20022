    ...
    extends AbstractMX
{
    ...
    public static MxColr01200102 parse(String xml) {
        return ((MxColr01200102) MxReadImpl.parse(MxColr01200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01200102) MxReadImpl.parse(MxColr01200102 .class, xml, _classes, new MxReadParams(conf)));
    }
