    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.016.001.02";
    ...
    public static MxColr01600102 parse(String xml) {
        return ((MxColr01600102) MxReadImpl.parse(MxColr01600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01600102) MxReadImpl.parse(MxColr01600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01600102 fromJson(String json) {
