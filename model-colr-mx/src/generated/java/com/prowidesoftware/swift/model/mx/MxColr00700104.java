    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.007.001.04";
    ...
    public static MxColr00700104 parse(String xml) {
        return ((MxColr00700104) MxReadImpl.parse(MxColr00700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00700104) MxReadImpl.parse(MxColr00700104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr00700104 fromJson(String json) {
