    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.005.001.04";
    ...
    public static MxColr00500104 parse(String xml) {
        return ((MxColr00500104) MxReadImpl.parse(MxColr00500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00500104) MxReadImpl.parse(MxColr00500104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr00500104 fromJson(String json) {
