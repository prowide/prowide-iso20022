    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.010.001.01";
    ...
    public static MxColr01000101 parse(String xml) {
        return ((MxColr01000101) MxReadImpl.parse(MxColr01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01000101) MxReadImpl.parse(MxColr01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01000101 .class);
    }
