    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.006.001.04";
    ...
    public static MxColr00600104 parse(String xml) {
        return ((MxColr00600104) MxReadImpl.parse(MxColr00600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00600104) MxReadImpl.parse(MxColr00600104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr00600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00600104 .class);
    }
