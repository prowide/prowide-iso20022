    ...
    extends AbstractMX
{
    ...
    public static MxColr01500101 parse(String xml) {
        return ((MxColr01500101) MxReadImpl.parse(MxColr01500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01500101) MxReadImpl.parse(MxColr01500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr01500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01500101 .class);
    }
