    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.009.001.03";
    ...
    public static MxColr00900103 parse(String xml) {
        return ((MxColr00900103) MxReadImpl.parse(MxColr00900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00900103) MxReadImpl.parse(MxColr00900103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr00900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00900103 .class);
    }
