    ...
    extends AbstractMX
{
    ...
    public static MxColr01200101 parse(String xml) {
        return ((MxColr01200101) MxReadImpl.parse(MxColr01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01200101) MxReadImpl.parse(MxColr01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
