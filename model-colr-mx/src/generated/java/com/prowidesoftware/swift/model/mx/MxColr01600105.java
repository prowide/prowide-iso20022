    ...
    extends AbstractMX
{
    ...
    public static MxColr01600105 parse(String xml) {
        return ((MxColr01600105) MxReadImpl.parse(MxColr01600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01600105) MxReadImpl.parse(MxColr01600105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01600105 .class);
    }
