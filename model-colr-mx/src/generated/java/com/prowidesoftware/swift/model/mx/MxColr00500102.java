    ...
    extends AbstractMX
{
    ...
    public static MxColr00500102 parse(String xml) {
        return ((MxColr00500102) MxReadImpl.parse(MxColr00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00500102) MxReadImpl.parse(MxColr00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
