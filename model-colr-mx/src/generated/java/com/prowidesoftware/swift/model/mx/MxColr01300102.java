    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.013.001.02";
    ...
    public static MxColr01300102 parse(String xml) {
        return ((MxColr01300102) MxReadImpl.parse(MxColr01300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01300102) MxReadImpl.parse(MxColr01300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr01300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01300102 .class);
    }
