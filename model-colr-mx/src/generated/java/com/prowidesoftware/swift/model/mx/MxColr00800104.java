    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.008.001.04";
    ...
    public static MxColr00800104 parse(String xml) {
        return ((MxColr00800104) MxReadImpl.parse(MxColr00800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00800104) MxReadImpl.parse(MxColr00800104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr00800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00800104 .class);
    }
