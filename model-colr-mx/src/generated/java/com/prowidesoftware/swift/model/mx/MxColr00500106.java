    ...
    extends AbstractMX
{
    ...
    public static MxColr00500106 parse(String xml) {
        return ((MxColr00500106) MxReadImpl.parse(MxColr00500106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00500106) MxReadImpl.parse(MxColr00500106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr00500106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00500106 .class);
    }
