    ...
    extends AbstractMX
{
    ...
    public static MxColr00700103 parse(String xml) {
        return ((MxColr00700103) MxReadImpl.parse(MxColr00700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00700103) MxReadImpl.parse(MxColr00700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr00700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00700103 .class);
    }
