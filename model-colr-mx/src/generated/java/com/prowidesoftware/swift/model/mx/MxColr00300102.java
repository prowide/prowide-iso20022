    ...
    extends AbstractMX
{
    ...
    public static MxColr00300102 parse(String xml) {
        return ((MxColr00300102) MxReadImpl.parse(MxColr00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00300102) MxReadImpl.parse(MxColr00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00300102 .class);
    }
