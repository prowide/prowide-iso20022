    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.006.001.01";
    ...
    public static MxColr00600101 parse(String xml) {
        return ((MxColr00600101) MxReadImpl.parse(MxColr00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00600101) MxReadImpl.parse(MxColr00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr00600101 fromJson(String json) {
