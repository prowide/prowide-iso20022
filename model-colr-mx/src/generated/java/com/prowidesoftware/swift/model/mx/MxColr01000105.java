    ...
    extends AbstractMX
{
    ...
    public static MxColr01000105 parse(String xml) {
        return ((MxColr01000105) MxReadImpl.parse(MxColr01000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01000105) MxReadImpl.parse(MxColr01000105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr01000105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01000105 .class);
    }
