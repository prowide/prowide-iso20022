    ...
    extends AbstractMX
{
    ...
    public static MxColr01400104 parse(String xml) {
        return ((MxColr01400104) MxReadImpl.parse(MxColr01400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01400104) MxReadImpl.parse(MxColr01400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr01400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01400104 .class);
    }
