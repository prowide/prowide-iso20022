    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.024.001.01";
    ...
    public static MxColr02400101 parse(String xml) {
        return ((MxColr02400101) MxReadImpl.parse(MxColr02400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr02400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr02400101) MxReadImpl.parse(MxColr02400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr02400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr02400101 .class);
    }
