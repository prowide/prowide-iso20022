    ...
    extends AbstractMX
{
    ...
    public static MxColr01600104 parse(String xml) {
        return ((MxColr01600104) MxReadImpl.parse(MxColr01600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr01600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr01600104) MxReadImpl.parse(MxColr01600104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxColr01600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr01600104 .class);
    }
