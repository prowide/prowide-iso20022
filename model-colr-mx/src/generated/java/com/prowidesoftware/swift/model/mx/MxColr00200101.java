    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:colr.002.001.01";
    ...
    public static MxColr00200101 parse(String xml) {
        return ((MxColr00200101) MxReadImpl.parse(MxColr00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxColr00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxColr00200101) MxReadImpl.parse(MxColr00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxColr00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxColr00200101 .class);
    }
