    ...
    extends AbstractMX
{
    ...
    public static MxXsys00700101 parse(String xml) {
        return ((MxXsys00700101) MxReadImpl.parse(MxXsys00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys00700101) MxReadImpl.parse(MxXsys00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxXsys00700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxXsys00700101 .class);
    }
