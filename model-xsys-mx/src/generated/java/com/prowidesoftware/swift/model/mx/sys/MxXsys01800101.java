    ...
    extends AbstractMX
{
    ...
    public static MxXsys01800101 parse(String xml) {
        return ((MxXsys01800101) MxReadImpl.parse(MxXsys01800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys01800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys01800101) MxReadImpl.parse(MxXsys01800101 .class, xml, _classes, new MxReadParams(conf)));
    }
