    ...
    extends AbstractMX
{
    ...
    public static MxXsys01900101 parse(String xml) {
        return ((MxXsys01900101) MxReadImpl.parse(MxXsys01900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys01900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys01900101) MxReadImpl.parse(MxXsys01900101 .class, xml, _classes, new MxReadParams(conf)));
    }
