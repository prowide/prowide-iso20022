    ...
    extends AbstractMX
{
    ...
    public static MxXsys01300101 parse(String xml) {
        return ((MxXsys01300101) MxReadImpl.parse(MxXsys01300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys01300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys01300101) MxReadImpl.parse(MxXsys01300101 .class, xml, _classes, new MxReadParams(conf)));
    }
