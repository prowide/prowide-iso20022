    ...
    extends AbstractMX
{
    ...
    public static MxXsys00900103 parse(String xml) {
        return ((MxXsys00900103) MxReadImpl.parse(MxXsys00900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys00900103) MxReadImpl.parse(MxXsys00900103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxXsys00900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxXsys00900103 .class);
    }
