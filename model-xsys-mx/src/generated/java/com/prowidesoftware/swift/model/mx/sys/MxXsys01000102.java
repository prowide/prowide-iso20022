    ...
    extends AbstractMX
{
    ...
    public static MxXsys01000102 parse(String xml) {
        return ((MxXsys01000102) MxReadImpl.parse(MxXsys01000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys01000102) MxReadImpl.parse(MxXsys01000102 .class, xml, _classes, new MxReadParams(conf)));
    }
