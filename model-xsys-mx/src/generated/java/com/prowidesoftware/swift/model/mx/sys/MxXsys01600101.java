    ...
    extends AbstractMX
{
    ...
    public static MxXsys01600101 parse(String xml) {
        return ((MxXsys01600101) MxReadImpl.parse(MxXsys01600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys01600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys01600101) MxReadImpl.parse(MxXsys01600101 .class, xml, _classes, new MxReadParams(conf)));
    }
