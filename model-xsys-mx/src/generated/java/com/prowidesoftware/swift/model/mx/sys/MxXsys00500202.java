    ...
    extends AbstractMX
{
    ...
    public static MxXsys00500202 parse(String xml) {
        return ((MxXsys00500202) MxReadImpl.parse(MxXsys00500202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys00500202 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys00500202) MxReadImpl.parse(MxXsys00500202 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxXsys00500202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxXsys00500202 .class);
    }
