    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {AbstractReportDescription.class, GetUndeliveredMessagesRequest.class, MsgServiceCode.class, MxXsys00400101 .class, ReportDescription.class };
    public static final transient String NAMESPACE = "urn:swift:xsd:xsys.004.001.01";
    ...
    public static MxXsys00400101 parse(String xml) {
        return ((MxXsys00400101) MxReadImpl.parse(MxXsys00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys00400101) MxReadImpl.parse(MxXsys00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxXsys00400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxXsys00400101 .class);
    }
