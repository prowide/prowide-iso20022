    ...
    extends AbstractMX
{
    ...
    public static MxXsys00100101 parse(String xml) {
        return ((MxXsys00100101) MxReadImpl.parse(MxXsys00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys00100101) MxReadImpl.parse(MxXsys00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
