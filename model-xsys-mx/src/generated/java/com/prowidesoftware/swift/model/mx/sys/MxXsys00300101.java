    ...
    extends AbstractMX
{
    ...
    public static MxXsys00300101 parse(String xml) {
        return ((MxXsys00300101) MxReadImpl.parse(MxXsys00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys00300101) MxReadImpl.parse(MxXsys00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
