    ...
    extends AbstractMX
{
    ...
    public static MxXsys01200102 parse(String xml) {
        return ((MxXsys01200102) MxReadImpl.parse(MxXsys01200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys01200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys01200102) MxReadImpl.parse(MxXsys01200102 .class, xml, _classes, new MxReadParams(conf)));
    }
