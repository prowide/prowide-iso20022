    ...
    extends AbstractMX
{
    ...
    public final static transient Class[] _classes = new Class[] {GetInputChannelsListRequest.class, InputChannels.class, MxXsys00600101 .class };
    public final static transient String NAMESPACE = "urn:swift:xsd:xsys.006.001.01";
    ...
    public static MxXsys00600101 parse(String xml) {
        return ((MxXsys00600101) MxReadImpl.parse(MxXsys00600101 .class, xml, _classes));
    }
     ...
     */
    public final static MxXsys00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxXsys00600101 .class);
    }
