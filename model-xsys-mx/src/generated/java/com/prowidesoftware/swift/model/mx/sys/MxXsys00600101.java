    ...
    extends AbstractMX
{
    ...
    public static MxXsys00600101 parse(String xml) {
        return ((MxXsys00600101) MxReadImpl.parse(MxXsys00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys00600101) MxReadImpl.parse(MxXsys00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
