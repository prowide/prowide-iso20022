    ...
    extends AbstractMX
{
    ...
    public static MxXsys00900101 parse(String xml) {
        return ((MxXsys00900101) MxReadImpl.parse(MxXsys00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys00900101) MxReadImpl.parse(MxXsys00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxXsys00900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxXsys00900101 .class);
    }
