    ...
    extends AbstractMX
{
    ...
    public static MxXsys00900102 parse(String xml) {
        return ((MxXsys00900102) MxReadImpl.parse(MxXsys00900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys00900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys00900102) MxReadImpl.parse(MxXsys00900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxXsys00900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxXsys00900102 .class);
    }
