    ...
    extends AbstractMX
{
    ...
    public static MxXsys01200101 parse(String xml) {
        return ((MxXsys01200101) MxReadImpl.parse(MxXsys01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys01200101) MxReadImpl.parse(MxXsys01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
