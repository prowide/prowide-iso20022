    ...
    extends AbstractMX
{
    ...
    public static MxXsys02700101 parse(String xml) {
        return ((MxXsys02700101) MxReadImpl.parse(MxXsys02700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys02700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys02700101) MxReadImpl.parse(MxXsys02700101 .class, xml, _classes, new MxReadParams(conf)));
    }
