    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {MxXsys02800101 .class, QueueSharingModeRequest.class, SharingMode.class };
    public static final transient String NAMESPACE = "urn:swift:xsd:xsys.028.001.01";
    ...
    public static MxXsys02800101 parse(String xml) {
        return ((MxXsys02800101) MxReadImpl.parse(MxXsys02800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys02800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys02800101) MxReadImpl.parse(MxXsys02800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxXsys02800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxXsys02800101 .class);
    }
