    ...
    extends AbstractMX
{
    ...
    public static MxXsys02600101 parse(String xml) {
        return ((MxXsys02600101) MxReadImpl.parse(MxXsys02600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys02600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys02600101) MxReadImpl.parse(MxXsys02600101 .class, xml, _classes, new MxReadParams(conf)));
    }
