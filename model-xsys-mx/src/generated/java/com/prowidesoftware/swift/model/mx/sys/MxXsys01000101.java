    ...
    extends AbstractMX
{
    ...
    public static MxXsys01000101 parse(String xml) {
        return ((MxXsys01000101) MxReadImpl.parse(MxXsys01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxXsys01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxXsys01000101) MxReadImpl.parse(MxXsys01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
