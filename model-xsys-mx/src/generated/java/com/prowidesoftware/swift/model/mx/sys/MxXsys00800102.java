    ...
    extends AbstractMX
{
    ...
    public final static transient Class[] _classes = new Class[] {MxXsys00800102 .class, QueueStatusReportRequest.class, ReportCriteriav2 .class, ReportOptionCode.class, SwBooleanIndicator.class };
    public final static transient String NAMESPACE = "urn:swift:xsd:xsys.008.001.02";
    ...
    public static MxXsys00800102 parse(String xml) {
        return ((MxXsys00800102) MxReadImpl.parse(MxXsys00800102 .class, xml, _classes));
    }
     ...
     */
    public final static MxXsys00800102 fromJson(String json) {
