 ...
 * Usage
 * The notification is sent by a central settlement system to the two trading parties after it has received Create, Amend or Cancel notifications from both. It may also contain information on the settlement of the trade and/or premium.
 * 
 * 
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ForeignExchangeOptionNotificationV05", propOrder = {
    "tradgSdId",
    "ctrPtySdId",
    "optnData",
    "tradSts",
...
public class ForeignExchangeOptionNotificationV05 {
     ...
     *     
     */
    public ForeignExchangeOptionNotificationV05 setTradgSdId(TradePartyIdentification4 value) {
     ...
     *     
     */
    public ForeignExchangeOptionNotificationV05 setCtrPtySdId(TradePartyIdentification4 value) {
     ...
     *     
     */
    public ForeignExchangeOptionNotificationV05 setOptnData(OptionData4 value) {
        this.optnData = value;
        return this;
    }
     ...
     *     
     */
    public ForeignExchangeOptionNotificationV05 setTradSts(TradeStatus1 value) {
        this.tradSts = value;
        return this;
    }
     ...
     *     
     */
    public ForeignExchangeOptionNotificationV05 setSttlmData(SettlementData2 value) {
