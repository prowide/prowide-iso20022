...
@XmlType(name = "ForeignExchangeTradeConfirmationRequestCancellationRequestV02", propOrder = {
    "hdr",
    "cxlReqId",
    "tradgSdId",
    "ctrPtyRoleId",
...
public class ForeignExchangeTradeConfirmationRequestCancellationRequestV02 {
    ...
    protected TradePartyIdentification9 ctrPtyRoleId;
     ...
     *     
     */
    public ForeignExchangeTradeConfirmationRequestCancellationRequestV02 setHdr(Header23 value) {
        this.hdr = value;
        return this;
    }
     ...
     *     
     */
    public ForeignExchangeTradeConfirmationRequestCancellationRequestV02 setCxlReqId(MessageIdentification1 value) {
        this.cxlReqId = value;
        return this;
    }
     ...
     *     
     */
    public ForeignExchangeTradeConfirmationRequestCancellationRequestV02 setTradgSdId(TradePartyIdentification9 value) {
     ...
     *     
     */
    public TradePartyIdentification9 getCtrPtyRoleId() {
        return ctrPtyRoleId;
    }
     ...
     *     
     */
    public ForeignExchangeTradeConfirmationRequestCancellationRequestV02 setCtrPtyRoleId(TradePartyIdentification9 value) {
     ...
     *     
     */
    public ForeignExchangeTradeConfirmationRequestCancellationRequestV02 setTradId(String value) {
        this.tradId = value;
        return this;
    }
     ...
     *     
     */
    public ForeignExchangeTradeConfirmationRequestCancellationRequestV02 setUndrlygPdctTp(UnderlyingProductIdentifier1Code value) {
     ...
     * 
     */
    public ForeignExchangeTradeConfirmationRequestCancellationRequestV02 addSplmtryData(SupplementaryData1 splmtryData) {
