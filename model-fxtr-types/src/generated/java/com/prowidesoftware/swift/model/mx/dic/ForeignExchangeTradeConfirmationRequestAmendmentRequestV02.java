...
@XmlType(name = "ForeignExchangeTradeConfirmationRequestAmendmentRequestV02", propOrder = {
    "hdr",
    "amdmntReqId",
    "tradgSdId",
    "ctrPtySdId",
...
public class ForeignExchangeTradeConfirmationRequestAmendmentRequestV02 {
    ...
    protected Trade9 tradDtl;
    @XmlElement(name = "QryPrd", required = true)
    protected Period12 qryPrd;
     ...
     *     
     */
    public ForeignExchangeTradeConfirmationRequestAmendmentRequestV02 setHdr(Header23 value) {
        this.hdr = value;
        return this;
    }
     ...
     *     
     */
    public ForeignExchangeTradeConfirmationRequestAmendmentRequestV02 setAmdmntReqId(MessageIdentification1 value) {
     ...
     *     
     */
    public ForeignExchangeTradeConfirmationRequestAmendmentRequestV02 setTradgSdId(TradePartyIdentification9 value) {
     ...
     *     
     */
    public ForeignExchangeTradeConfirmationRequestAmendmentRequestV02 setCtrPtySdId(TradePartyIdentification9 value) {
     ...
     *     
     */
    public ForeignExchangeTradeConfirmationRequestAmendmentRequestV02 setTradDtl(Trade9 value) {
        this.tradDtl = value;
        return this;
    }
     ...
     *     
     */
    public ForeignExchangeTradeConfirmationRequestAmendmentRequestV02 setQryPrd(Period12 value) {
        this.qryPrd = value;
        return this;
    }
     ...
     *     
     */
    public ForeignExchangeTradeConfirmationRequestAmendmentRequestV02 setQryStartNb(String value) {
     ...
     *     
     */
    public ForeignExchangeTradeConfirmationRequestAmendmentRequestV02 setQryTradSts(QueryTradeStatus1Code value) {
     ...
     * 
     */
    public ForeignExchangeTradeConfirmationRequestAmendmentRequestV02 addSplmtryData(SupplementaryData1 splmtryData) {
