...
@XmlType(name = "ForeignExchangeTradeInstructionAmendmentV03", propOrder = {
    "tradInf",
    "tradgSdId",
    "ctrPtySdId",
    "tradAmts",
...
public class ForeignExchangeTradeInstructionAmendmentV03 {
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV03 setTradInf(TradeAgreement11 value) {
        this.tradInf = value;
        return this;
    }
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV03 setTradgSdId(TradePartyIdentification6 value) {
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV03 setCtrPtySdId(TradePartyIdentification6 value) {
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV03 setTradAmts(AmountsAndValueDate1 value) {
        this.tradAmts = value;
        return this;
    }
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV03 setAgrdRate(AgreedRate1 value) {
        this.agrdRate = value;
        return this;
    }
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV03 setTradgSdSttlmInstrs(SettlementParties29 value) {
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV03 setCtrPtySdSttlmInstrs(SettlementParties29 value) {
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV03 setOptnlGnlInf(GeneralInformation4 value) {
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV03 setRgltryRptg(RegulatoryReporting4 value) {
     ...
     * 
     */
    public ForeignExchangeTradeInstructionAmendmentV03 addSplmtryData(SupplementaryData1 splmtryData) {
