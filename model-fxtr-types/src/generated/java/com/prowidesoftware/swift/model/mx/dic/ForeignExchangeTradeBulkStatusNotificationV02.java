...
@XmlType(name = "ForeignExchangeTradeBulkStatusNotificationV02", propOrder = {
    "stsDtls",
    "tradData",
    "msgPgntn",
    "splmtryData"
...
public class ForeignExchangeTradeBulkStatusNotificationV02 {
    ...
    protected List<TradeData8> tradData;
     ...
     *     
     */
    public ForeignExchangeTradeBulkStatusNotificationV02 setStsDtls(TradeData10 value) {
        this.stsDtls = value;
        return this;
    }
     ...
     * 
     */
    public List<TradeData8> getTradData() {
        if (tradData == null) {
            tradData = new ArrayList<TradeData8>();
        }
     ...
     *     
     */
    public ForeignExchangeTradeBulkStatusNotificationV02 setMsgPgntn(Pagination value) {
        this.msgPgntn = value;
        return this;
    }
     ...
     * 
     */
    public ForeignExchangeTradeBulkStatusNotificationV02 addTradData(TradeData8 tradData) {
     ...
     * 
     */
    public ForeignExchangeTradeBulkStatusNotificationV02 addSplmtryData(SupplementaryData1 splmtryData) {
