 ...
 * Usage
 * The message is sent from a participant to a central settlement system to advise of the update of a previously sent notification. The "Related Reference" must be used to link it to the previous notification.
 * 
 * 
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ForeignExchangeTradeInstructionAmendmentV01", propOrder = {
    "tradInf",
    "tradgSdId",
    "ctrPtySdId",
    "tradAmts",
...
public class ForeignExchangeTradeInstructionAmendmentV01 {
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV01 setTradInf(TradeAgreement4 value) {
        this.tradInf = value;
        return this;
    }
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV01 setTradgSdId(TradePartyIdentification3 value) {
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV01 setCtrPtySdId(TradePartyIdentification3 value) {
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV01 setTradAmts(AmountsAndValueDate1 value) {
        this.tradAmts = value;
        return this;
    }
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV01 setAgrdRate(AgreedRate1 value) {
        this.agrdRate = value;
        return this;
    }
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV01 setTradgSdSttlmInstrs(SettlementParties1 value) {
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV01 setCtrPtySdSttlmInstrs(SettlementParties1 value) {
     ...
     *     
     */
    public ForeignExchangeTradeInstructionAmendmentV01 setOptnlGnlInf(GeneralInformation1 value) {
