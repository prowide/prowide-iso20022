    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catm.005.001.11";
    ...
    public static MxCatm00500111 parse(String xml) {
        return ((MxCatm00500111) MxReadImpl.parse(MxCatm00500111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00500111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00500111) MxReadImpl.parse(MxCatm00500111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatm00500111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00500111 .class);
    }
