    ...
    extends AbstractMX
{
    ...
    public static MxCatm00700107 parse(String xml) {
        return ((MxCatm00700107) MxReadImpl.parse(MxCatm00700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00700107) MxReadImpl.parse(MxCatm00700107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00700107 .class);
    }
