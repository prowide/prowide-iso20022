    ...
    extends AbstractMX
{
    ...
    public static MxCatm00400102 parse(String xml) {
        return ((MxCatm00400102) MxReadImpl.parse(MxCatm00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00400102) MxReadImpl.parse(MxCatm00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
