    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catm.005.001.04";
    ...
    public static MxCatm00500104 parse(String xml) {
        return ((MxCatm00500104) MxReadImpl.parse(MxCatm00500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00500104) MxReadImpl.parse(MxCatm00500104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatm00500104 fromJson(String json) {
