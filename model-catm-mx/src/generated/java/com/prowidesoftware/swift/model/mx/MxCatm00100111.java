    ...
    extends AbstractMX
{
    ...
    public static MxCatm00100111 parse(String xml) {
        return ((MxCatm00100111) MxReadImpl.parse(MxCatm00100111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00100111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00100111) MxReadImpl.parse(MxCatm00100111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatm00100111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00100111 .class);
    }
