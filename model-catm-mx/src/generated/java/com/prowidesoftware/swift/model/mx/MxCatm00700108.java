    ...
    extends AbstractMX
{
    ...
    public static MxCatm00700108 parse(String xml) {
        return ((MxCatm00700108) MxReadImpl.parse(MxCatm00700108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00700108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00700108) MxReadImpl.parse(MxCatm00700108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00700108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00700108 .class);
    }
