    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catm.001.001.09";
    ...
    public static MxCatm00100109 parse(String xml) {
        return ((MxCatm00100109) MxReadImpl.parse(MxCatm00100109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00100109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00100109) MxReadImpl.parse(MxCatm00100109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatm00100109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00100109 .class);
    }
