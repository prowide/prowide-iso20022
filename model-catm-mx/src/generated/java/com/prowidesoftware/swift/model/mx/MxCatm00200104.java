    ...
    extends AbstractMX
{
    ...
    public static MxCatm00200104 parse(String xml) {
        return ((MxCatm00200104) MxReadImpl.parse(MxCatm00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00200104) MxReadImpl.parse(MxCatm00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00200104 .class);
    }
