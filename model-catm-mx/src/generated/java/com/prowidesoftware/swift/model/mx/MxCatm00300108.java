    ...
    extends AbstractMX
{
    ...
    public static MxCatm00300108 parse(String xml) {
        return ((MxCatm00300108) MxReadImpl.parse(MxCatm00300108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00300108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00300108) MxReadImpl.parse(MxCatm00300108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00300108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00300108 .class);
    }
