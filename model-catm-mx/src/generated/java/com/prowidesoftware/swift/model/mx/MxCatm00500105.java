    ...
    extends AbstractMX
{
    ...
    public static MxCatm00500105 parse(String xml) {
        return ((MxCatm00500105) MxReadImpl.parse(MxCatm00500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00500105) MxReadImpl.parse(MxCatm00500105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00500105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00500105 .class);
    }
