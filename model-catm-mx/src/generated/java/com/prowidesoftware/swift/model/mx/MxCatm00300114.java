    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catm.003.001.14";
    ...
    public static MxCatm00300114 parse(String xml) {
        return ((MxCatm00300114) MxReadImpl.parse(MxCatm00300114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00300114 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00300114) MxReadImpl.parse(MxCatm00300114 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatm00300114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00300114 .class);
    }
