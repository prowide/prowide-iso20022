    ...
    extends AbstractMX
{
    ...
    public static MxCatm00500110 parse(String xml) {
        return ((MxCatm00500110) MxReadImpl.parse(MxCatm00500110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00500110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00500110) MxReadImpl.parse(MxCatm00500110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00500110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00500110 .class);
    }
