    ...
    extends AbstractMX
{
    ...
    public static MxCatm00300101 parse(String xml) {
        return ((MxCatm00300101) MxReadImpl.parse(MxCatm00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00300101) MxReadImpl.parse(MxCatm00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00300101 .class);
    }
