    ...
    extends AbstractMX
{
    ...
    public static MxCatm00300112 parse(String xml) {
        return ((MxCatm00300112) MxReadImpl.parse(MxCatm00300112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00300112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00300112) MxReadImpl.parse(MxCatm00300112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00300112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00300112 .class);
    }
