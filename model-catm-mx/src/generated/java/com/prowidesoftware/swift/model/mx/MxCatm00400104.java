    ...
    extends AbstractMX
{
    ...
    public static MxCatm00400104 parse(String xml) {
        return ((MxCatm00400104) MxReadImpl.parse(MxCatm00400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00400104) MxReadImpl.parse(MxCatm00400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00400104 .class);
    }
