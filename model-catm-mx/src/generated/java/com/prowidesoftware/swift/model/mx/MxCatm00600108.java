    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catm.006.001.08";
    ...
    public static MxCatm00600108 parse(String xml) {
        return ((MxCatm00600108) MxReadImpl.parse(MxCatm00600108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00600108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00600108) MxReadImpl.parse(MxCatm00600108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatm00600108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00600108 .class);
    }
