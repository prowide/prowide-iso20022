    ...
    extends AbstractMX
{
    ...
    public static MxCatm00200113 parse(String xml) {
        return ((MxCatm00200113) MxReadImpl.parse(MxCatm00200113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00200113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00200113) MxReadImpl.parse(MxCatm00200113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00200113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00200113 .class);
    }
