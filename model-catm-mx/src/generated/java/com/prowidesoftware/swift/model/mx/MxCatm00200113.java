...
/**
 * Class for catm.002.001.13 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:catm.002.001.13")
public class MxCatm00200113
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "MgmtPlanRplcmnt", required = true)
    protected ManagementPlanReplacementV13 mgmtPlanRplcmnt;
     ...
     * 
     */
    public MxCatm00200113(final String xml) {
        this();
        MxCatm00200113 tmp = parse(xml);
     ...
     * 
     */
    public MxCatm00200113(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link ManagementPlanReplacementV13 }
     *     
     */
    public ManagementPlanReplacementV13 getMgmtPlanRplcmnt() {
     ...
     *     
     */
    public MxCatm00200113 setMgmtPlanRplcmnt(ManagementPlanReplacementV13 value) {
     ...
     * 
     */
    public static MxCatm00200113 parse(String xml) {
        return ((MxCatm00200113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCatm00200113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCatm00200113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00200113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCatm00200113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCatm00200113 parse(String xml, MxRead parserImpl) {
        return ((MxCatm00200113) parserImpl.read(MxCatm00200113 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCatm00200113 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCatm00200113 message
     * @return
     *     a new instance of MxCatm00200113
     */
    public final static MxCatm00200113 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCatm00200113 .class);
    }
