    ...
    extends AbstractMX
{
    ...
    public static MxCatm00800105 parse(String xml) {
        return ((MxCatm00800105) MxReadImpl.parse(MxCatm00800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00800105) MxReadImpl.parse(MxCatm00800105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00800105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00800105 .class);
    }
