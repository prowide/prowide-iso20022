    ...
    extends AbstractMX
{
    ...
    public static MxCatm00300110 parse(String xml) {
        return ((MxCatm00300110) MxReadImpl.parse(MxCatm00300110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00300110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00300110) MxReadImpl.parse(MxCatm00300110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00300110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00300110 .class);
    }
