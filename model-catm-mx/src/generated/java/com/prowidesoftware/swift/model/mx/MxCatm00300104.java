    ...
    extends AbstractMX
{
    ...
    public static MxCatm00300104 parse(String xml) {
        return ((MxCatm00300104) MxReadImpl.parse(MxCatm00300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00300104) MxReadImpl.parse(MxCatm00300104 .class, xml, _classes, new MxReadParams(conf)));
    }
