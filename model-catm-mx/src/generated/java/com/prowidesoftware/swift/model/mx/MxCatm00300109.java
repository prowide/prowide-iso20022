    ...
    extends AbstractMX
{
    ...
    public static MxCatm00300109 parse(String xml) {
        return ((MxCatm00300109) MxReadImpl.parse(MxCatm00300109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00300109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00300109) MxReadImpl.parse(MxCatm00300109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00300109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00300109 .class);
    }
