    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catm.002.001.06";
    ...
    public static MxCatm00200106 parse(String xml) {
        return ((MxCatm00200106) MxReadImpl.parse(MxCatm00200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00200106) MxReadImpl.parse(MxCatm00200106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatm00200106 fromJson(String json) {
