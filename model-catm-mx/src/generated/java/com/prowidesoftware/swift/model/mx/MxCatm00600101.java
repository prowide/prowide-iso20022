    ...
    extends AbstractMX
{
    ...
    public static MxCatm00600101 parse(String xml) {
        return ((MxCatm00600101) MxReadImpl.parse(MxCatm00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00600101) MxReadImpl.parse(MxCatm00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00600101 .class);
    }
