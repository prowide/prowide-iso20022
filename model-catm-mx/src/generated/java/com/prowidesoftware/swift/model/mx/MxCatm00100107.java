    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catm.001.001.07";
    ...
    public static MxCatm00100107 parse(String xml) {
        return ((MxCatm00100107) MxReadImpl.parse(MxCatm00100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00100107) MxReadImpl.parse(MxCatm00100107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatm00100107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00100107 .class);
    }
