    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catm.007.001.05";
    ...
    public static MxCatm00700105 parse(String xml) {
        return ((MxCatm00700105) MxReadImpl.parse(MxCatm00700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00700105) MxReadImpl.parse(MxCatm00700105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatm00700105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00700105 .class);
    }
