    ...
    extends AbstractMX
{
    ...
    public static MxCatm00100101 parse(String xml) {
        return ((MxCatm00100101) MxReadImpl.parse(MxCatm00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00100101) MxReadImpl.parse(MxCatm00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00100101 .class);
    }
