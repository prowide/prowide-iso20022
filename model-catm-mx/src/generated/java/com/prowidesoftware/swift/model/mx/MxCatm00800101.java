    ...
    extends AbstractMX
{
    ...
    public static MxCatm00800101 parse(String xml) {
        return ((MxCatm00800101) MxReadImpl.parse(MxCatm00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00800101) MxReadImpl.parse(MxCatm00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00800101 .class);
    }
