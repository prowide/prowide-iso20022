    ...
    extends AbstractMX
{
    ...
    public static MxCatm00100110 parse(String xml) {
        return ((MxCatm00100110) MxReadImpl.parse(MxCatm00100110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00100110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00100110) MxReadImpl.parse(MxCatm00100110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00100110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00100110 .class);
    }
