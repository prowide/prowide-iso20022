    ...
    extends AbstractMX
{
    ...
    public static MxCatm00500102 parse(String xml) {
        return ((MxCatm00500102) MxReadImpl.parse(MxCatm00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00500102) MxReadImpl.parse(MxCatm00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00500102 .class);
    }
