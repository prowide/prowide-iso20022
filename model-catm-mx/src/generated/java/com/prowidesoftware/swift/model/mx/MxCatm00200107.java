    ...
    extends AbstractMX
{
    ...
    public static MxCatm00200107 parse(String xml) {
        return ((MxCatm00200107) MxReadImpl.parse(MxCatm00200107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00200107) MxReadImpl.parse(MxCatm00200107 .class, xml, _classes, new MxReadParams(conf)));
    }
