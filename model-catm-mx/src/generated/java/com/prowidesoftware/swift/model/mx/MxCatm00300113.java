    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catm.003.001.13";
    ...
    public static MxCatm00300113 parse(String xml) {
        return ((MxCatm00300113) MxReadImpl.parse(MxCatm00300113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00300113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00300113) MxReadImpl.parse(MxCatm00300113 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatm00300113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00300113 .class);
    }
