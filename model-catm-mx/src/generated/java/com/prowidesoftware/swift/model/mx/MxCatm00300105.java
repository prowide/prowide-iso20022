    ...
    extends AbstractMX
{
    ...
    public static MxCatm00300105 parse(String xml) {
        return ((MxCatm00300105) MxReadImpl.parse(MxCatm00300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00300105) MxReadImpl.parse(MxCatm00300105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00300105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00300105 .class);
    }
