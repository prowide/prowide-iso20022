    ...
    extends AbstractMX
{
    ...
    public static MxCatm00200101 parse(String xml) {
        return ((MxCatm00200101) MxReadImpl.parse(MxCatm00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00200101) MxReadImpl.parse(MxCatm00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
