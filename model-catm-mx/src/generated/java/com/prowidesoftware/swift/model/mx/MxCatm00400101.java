    ...
    extends AbstractMX
{
    ...
    public static MxCatm00400101 parse(String xml) {
        return ((MxCatm00400101) MxReadImpl.parse(MxCatm00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00400101) MxReadImpl.parse(MxCatm00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
