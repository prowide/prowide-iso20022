    ...
    extends AbstractMX
{
    ...
    public static MxCatm00300115 parse(String xml) {
        return ((MxCatm00300115) MxReadImpl.parse(MxCatm00300115 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00300115 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00300115) MxReadImpl.parse(MxCatm00300115 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00300115 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00300115 .class);
    }
