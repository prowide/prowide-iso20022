    ...
    extends AbstractMX
{
    ...
    public static MxCatm00400103 parse(String xml) {
        return ((MxCatm00400103) MxReadImpl.parse(MxCatm00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00400103) MxReadImpl.parse(MxCatm00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00400103 .class);
    }
