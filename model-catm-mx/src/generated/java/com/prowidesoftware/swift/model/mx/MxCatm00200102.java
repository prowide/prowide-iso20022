    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catm.002.001.02";
    ...
    public static MxCatm00200102 parse(String xml) {
        return ((MxCatm00200102) MxReadImpl.parse(MxCatm00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00200102) MxReadImpl.parse(MxCatm00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatm00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00200102 .class);
    }
