    ...
    extends AbstractMX
{
    ...
    public static MxCatm00400105 parse(String xml) {
        return ((MxCatm00400105) MxReadImpl.parse(MxCatm00400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00400105) MxReadImpl.parse(MxCatm00400105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00400105 .class);
    }
