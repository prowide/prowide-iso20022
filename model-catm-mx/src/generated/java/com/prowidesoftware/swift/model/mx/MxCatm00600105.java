    ...
    extends AbstractMX
{
    ...
    public static MxCatm00600105 parse(String xml) {
        return ((MxCatm00600105) MxReadImpl.parse(MxCatm00600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00600105) MxReadImpl.parse(MxCatm00600105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00600105 .class);
    }
