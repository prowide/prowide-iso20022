    ...
    extends AbstractMX
{
    ...
    public static MxCatm00100108 parse(String xml) {
        return ((MxCatm00100108) MxReadImpl.parse(MxCatm00100108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00100108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00100108) MxReadImpl.parse(MxCatm00100108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00100108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00100108 .class);
    }
