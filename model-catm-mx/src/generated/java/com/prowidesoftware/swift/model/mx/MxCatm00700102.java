    ...
    extends AbstractMX
{
    ...
    public static MxCatm00700102 parse(String xml) {
        return ((MxCatm00700102) MxReadImpl.parse(MxCatm00700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00700102) MxReadImpl.parse(MxCatm00700102 .class, xml, _classes, new MxReadParams(conf)));
    }
