    ...
    extends AbstractMX
{
    ...
    public static MxCatm00200110 parse(String xml) {
        return ((MxCatm00200110) MxReadImpl.parse(MxCatm00200110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatm00200110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatm00200110) MxReadImpl.parse(MxCatm00200110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatm00200110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatm00200110 .class);
    }
