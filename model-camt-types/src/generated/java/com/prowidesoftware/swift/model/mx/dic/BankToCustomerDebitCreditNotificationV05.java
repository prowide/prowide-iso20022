...
@XmlType(name = "BankToCustomerDebitCreditNotificationV05", propOrder = {
    "grpHdr",
    "ntfctn",
    "splmtryData"
})
public class BankToCustomerDebitCreditNotificationV05 {
    ...
    protected List<AccountNotification11> ntfctn;
     ...
     *     
     */
    public BankToCustomerDebitCreditNotificationV05 setGrpHdr(GroupHeader58 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountNotification11 }
     * 
     * 
     */
    public List<AccountNotification11> getNtfctn() {
        if (ntfctn == null) {
            ntfctn = new ArrayList<AccountNotification11>();
        }
        return this.ntfctn;
    }
     ...
     * 
     */
    public BankToCustomerDebitCreditNotificationV05 addNtfctn(AccountNotification11 ntfctn) {
     ...
     * 
     */
    public BankToCustomerDebitCreditNotificationV05 addSplmtryData(SupplementaryData1 splmtryData) {
