...
@XmlType(name = "DeleteReservationV04", propOrder = {
    "msgHdr",
    "curRsvatn",
    "splmtryData"
})
public class DeleteReservationV04 {
     ...
     *     
     */
    public DeleteReservationV04 setMsgHdr(MessageHeader1 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     *     
     */
    public DeleteReservationV04 setCurRsvatn(ReservationIdentification1 value) {
     ...
     * 
     */
    public DeleteReservationV04 addSplmtryData(SupplementaryData1 splmtryData) {
