...
@XmlType(name = "PaymentStatusDetails3", propOrder = {
    "pmtInstrSts",
    "pmtInstrStsDtTm",
    "pmtInstrStsRsn"
})
public class PaymentStatusDetails3 {
     ...
     *     
     */
    public PaymentStatusDetails3 setPmtInstrSts(PaymentStatusCode3Choice value) {
     ...
     *     
     */
    public PaymentStatusDetails3 setPmtInstrStsDtTm(DateAndDateTimeChoice value) {
    ...
    public List<PaymentStatusReasonCode3Choice> getPmtInstrStsRsn() {
        if (pmtInstrStsRsn == null) {
            pmtInstrStsRsn = new ArrayList<PaymentStatusReasonCode3Choice>();
        }
     ...
     * 
     */
    public PaymentStatusDetails3 addPmtInstrStsRsn(PaymentStatusReasonCode3Choice pmtInstrStsRsn) {
