...
@XmlType(name = "ChargesPerTransaction3", propOrder = {
    "chrgsId",
    "ttlChrgsPerTx",
    "chrgsAcctAgt",
    "chrgsAcctAgtAcct",
...
public class ChargesPerTransaction3 {
    ...
    protected List<ChargesPerTransactionRecord3> rcrd;
     ...
     *     
     */
    public ChargesPerTransaction3 setChrgsId(String value) {
        this.chrgsId = value;
        return this;
    }
     ...
     *     
     */
    public ChargesPerTransaction3 setTtlChrgsPerTx(TotalCharges7 value) {
     ...
     *     
     */
    public ChargesPerTransaction3 setChrgsAcctAgt(BranchAndFinancialInstitutionIdentification8 value) {
     ...
     *     
     */
    public ChargesPerTransaction3 setChrgsAcctAgtAcct(CashAccount40 value) {
     ...
     * {@link ChargesPerTransactionRecord3 }
     * 
     * 
     */
    public List<ChargesPerTransactionRecord3> getRcrd() {
        if (rcrd == null) {
            rcrd = new ArrayList<ChargesPerTransactionRecord3>();
        }
        return this.rcrd;
    }
     ...
     *     
     */
    public ChargesPerTransaction3 setAddtlInf(String value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public ChargesPerTransaction3 addRcrd(ChargesPerTransactionRecord3 rcrd) {
        getRcrd().add(rcrd);
        return this;
    }
