...
@XmlType(name = "BankToCustomerDebitCreditNotificationV11", propOrder = {
    "grpHdr",
    "ntfctn",
    "splmtryData"
})
public class BankToCustomerDebitCreditNotificationV11 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader81 grpHdr;
    @XmlElement(name = "Ntfctn", required = true)
    protected List<AccountNotification21> ntfctn;
     ...
     *     
     */
    public BankToCustomerDebitCreditNotificationV11 setGrpHdr(GroupHeader81 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountNotification21 }
     * 
     * 
     */
    public List<AccountNotification21> getNtfctn() {
        if (ntfctn == null) {
            ntfctn = new ArrayList<AccountNotification21>();
        }
        return this.ntfctn;
    }
     ...
     * 
     */
    public BankToCustomerDebitCreditNotificationV11 addNtfctn(AccountNotification21 ntfctn) {
     ...
     * 
     */
    public BankToCustomerDebitCreditNotificationV11 addSplmtryData(SupplementaryData1 splmtryData) {
