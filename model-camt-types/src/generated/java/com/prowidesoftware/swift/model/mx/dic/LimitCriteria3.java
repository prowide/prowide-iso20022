...
@XmlType(name = "LimitCriteria3", propOrder = {
    "newQryNm",
    "schCrit",
    "rtrCrit"
})
public class LimitCriteria3 {
    ...
    protected List<LimitSearchCriteria3> schCrit;
     ...
     *     
     */
    public LimitCriteria3 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
     ...
     * {@link LimitSearchCriteria3 }
     * 
     * 
     */
    public List<LimitSearchCriteria3> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<LimitSearchCriteria3>();
        }
        return this.schCrit;
    }
     ...
     *     
     */
    public LimitCriteria3 setRtrCrit(LimitReturnCriteria2 value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public LimitCriteria3 addSchCrit(LimitSearchCriteria3 schCrit) {
