...
@XmlType(name = "BusinessDayReportOrError1Choice", propOrder = {
    "bizRpt",
    "oprlErr"
})
public class BusinessDayReportOrError1Choice {
    ...
    protected List<BusinessDay1> bizRpt;
     ...
     * 
     */
    public List<BusinessDay1> getBizRpt() {
        if (bizRpt == null) {
            bizRpt = new ArrayList<BusinessDay1>();
        }
        return this.bizRpt;
    }
     ...
     * 
     */
    public BusinessDayReportOrError1Choice addBizRpt(BusinessDay1 bizRpt) {
     ...
     * 
     */
    public BusinessDayReportOrError1Choice addOprlErr(ErrorHandling3 oprlErr) {
