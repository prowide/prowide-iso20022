...
@XmlType(name = "TransactionOrError6Choice", propOrder = {
    "tx",
    "bizErr"
})
public class TransactionOrError6Choice {

    @XmlElement(name = "Tx")
    protected Transaction159 tx;
     ...
     *     
     */
    public TransactionOrError6Choice setTx(Transaction159 value) {
        this.tx = value;
        return this;
    }
     ...
     * 
     */
    public TransactionOrError6Choice addBizErr(ErrorHandling5 bizErr) {
