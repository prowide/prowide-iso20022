...
@XmlType(name = "StandingOrderCriteria1", propOrder = {
    "newQryNm",
    "schCrit",
    "rtrCrit"
})
public class StandingOrderCriteria1 {
    ...
    protected List<StandingOrderSearchCriteria1> schCrit;
     ...
     *     
     */
    public StandingOrderCriteria1 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
     ...
     * {@link StandingOrderSearchCriteria1 }
     * 
     * 
     */
    public List<StandingOrderSearchCriteria1> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<StandingOrderSearchCriteria1>();
        }
        return this.schCrit;
    }
     ...
     *     
     */
    public StandingOrderCriteria1 setRtrCrit(StandingOrderReturnCriteria1 value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public StandingOrderCriteria1 addSchCrit(StandingOrderSearchCriteria1 schCrit) {
