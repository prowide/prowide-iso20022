...
@XmlType(name = "ReturnLimitV05", propOrder = {
    "msgHdr",
    "rptOrErr"
})
public class ReturnLimitV05 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader3 msgHdr;
    @XmlElement(name = "RptOrErr", required = true)
    protected LimitReportOrError1Choice rptOrErr;
     ...
     *     
     */
    public ReturnLimitV05 setMsgHdr(MessageHeader3 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link LimitReportOrError1Choice }
     *     
     */
    public LimitReportOrError1Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public ReturnLimitV05 setRptOrErr(LimitReportOrError1Choice value) {
        this.rptOrErr = value;
        return this;
    }
