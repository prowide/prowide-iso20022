...
@XmlType(name = "ChequeCancellationOrStopRequestV02", propOrder = {
    "grpHdr",
    "chq",
    "splmtryData"
})
public class ChequeCancellationOrStopRequestV02 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader103 grpHdr;
    @XmlElement(name = "Chq", required = true)
    protected List<Cheque20> chq;
     ...
     *     
     */
    public ChequeCancellationOrStopRequestV02 setGrpHdr(GroupHeader103 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public ChequeCancellationOrStopRequestV02 addChq(Cheque20 chq) {
        getChq().add(chq);
        return this;
    }
     ...
     * 
     */
    public ChequeCancellationOrStopRequestV02 addSplmtryData(SupplementaryData1 splmtryData) {
