...
@XmlType(name = "PaymentInstructionInformation", propOrder = {
    "reqdExctnDtTm",
    "pmtTp"
})
public class PaymentInstructionInformation {
     ...
     *     
     */
    public PaymentInstructionInformation setReqdExctnDtTm(OffsetDateTime value) {
     ...
     *     
     */
    public PaymentInstructionInformation setPmtTp(PaymentType2Choice value) {
        this.pmtTp = value;
        return this;
    }
