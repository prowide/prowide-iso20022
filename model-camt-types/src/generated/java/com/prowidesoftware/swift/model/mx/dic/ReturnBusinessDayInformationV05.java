...
@XmlType(name = "ReturnBusinessDayInformationV05", propOrder = {
    "msgHdr",
    "rptOrErr"
})
public class ReturnBusinessDayInformationV05 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader3 msgHdr;
    @XmlElement(name = "RptOrErr", required = true)
    protected BusinessDayReportOrError5Choice rptOrErr;
     ...
     *     
     */
    public ReturnBusinessDayInformationV05 setMsgHdr(MessageHeader3 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link BusinessDayReportOrError5Choice }
     *     
     */
    public BusinessDayReportOrError5Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public ReturnBusinessDayInformationV05 setRptOrErr(BusinessDayReportOrError5Choice value) {
        this.rptOrErr = value;
        return this;
    }
