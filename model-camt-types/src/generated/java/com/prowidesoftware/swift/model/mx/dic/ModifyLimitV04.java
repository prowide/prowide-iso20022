...
@XmlType(name = "ModifyLimitV04", propOrder = {
    "msgId",
    "lmtDtls"
})
public class ModifyLimitV04 {

    @XmlElement(name = "MsgId", required = true)
    protected MessageIdentification msgId;
    @XmlElement(name = "LmtDtls", required = true)
    protected List<LimitDetailsStructure2> lmtDtls;
     ...
     *     
     */
    public ModifyLimitV04 setMsgId(MessageIdentification value) {
        this.msgId = value;
        return this;
    }
     ...
     * {@link LimitDetailsStructure2 }
     * 
     * 
     */
    public List<LimitDetailsStructure2> getLmtDtls() {
        if (lmtDtls == null) {
            lmtDtls = new ArrayList<LimitDetailsStructure2>();
        }
        return this.lmtDtls;
    }
     ...
     * 
     */
    public ModifyLimitV04 addLmtDtls(LimitDetailsStructure2 lmtDtls) {
