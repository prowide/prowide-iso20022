...
@XmlType(name = "UnderlyingTransaction35", propOrder = {
    "orgnlGrpInfAndSts",
    "orgnlPmtInfAndSts",
    "txInfAndSts"
})
public class UnderlyingTransaction35 {

    @XmlElement(name = "OrgnlGrpInfAndSts")
    protected OriginalGroupHeader23 orgnlGrpInfAndSts;
    @XmlElement(name = "OrgnlPmtInfAndSts")
    protected List<OriginalPaymentInstruction54> orgnlPmtInfAndSts;
    @XmlElement(name = "TxInfAndSts")
    protected List<PaymentTransaction170> txInfAndSts;
     ...
     *     
     */
    public UnderlyingTransaction35 setOrgnlGrpInfAndSts(OriginalGroupHeader23 value) {
     ...
     * {@link OriginalPaymentInstruction54 }
     * 
     * 
     * @return
     *     The value of the orgnlPmtInfAndSts property.
     */
    public List<OriginalPaymentInstruction54> getOrgnlPmtInfAndSts() {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction170 }
     * 
     * 
     * @return
     *     The value of the txInfAndSts property.
     */
    public List<PaymentTransaction170> getTxInfAndSts() {
        if (txInfAndSts == null) {
     ...
     * 
     */
    public UnderlyingTransaction35 addOrgnlPmtInfAndSts(OriginalPaymentInstruction54 orgnlPmtInfAndSts) {
     ...
     * 
     */
    public UnderlyingTransaction35 addTxInfAndSts(PaymentTransaction170 txInfAndSts) {
