...
public class StandingOrderCriteria4 {
     ...
     *     
     */
    public StandingOrderCriteria4 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
    ...
    public List<StandingOrderSearchCriteria4> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<StandingOrderSearchCriteria4>();
        }
        return this.schCrit;
    }
     ...
     *     
     */
    public StandingOrderCriteria4 setRtrCrit(StandingOrderReturnCriteria1 value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public StandingOrderCriteria4 addSchCrit(StandingOrderSearchCriteria4 schCrit) {
