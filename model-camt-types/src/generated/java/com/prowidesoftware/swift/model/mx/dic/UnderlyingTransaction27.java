...
@XmlType(name = "UnderlyingTransaction27", propOrder = {
    "orgnlGrpInfAndCxl",
    "orgnlPmtInfAndCxl"
})
public class UnderlyingTransaction27 {

    @XmlElement(name = "OrgnlGrpInfAndCxl")
    protected OriginalGroupHeader15 orgnlGrpInfAndCxl;
    @XmlElement(name = "OrgnlPmtInfAndCxl")
    protected List<OriginalPaymentInstruction36> orgnlPmtInfAndCxl;
     ...
     *     
     */
    public UnderlyingTransaction27 setOrgnlGrpInfAndCxl(OriginalGroupHeader15 value) {
     ...
     * {@link OriginalPaymentInstruction36 }
     * 
     * 
     */
    public List<OriginalPaymentInstruction36> getOrgnlPmtInfAndCxl() {
        if (orgnlPmtInfAndCxl == null) {
            orgnlPmtInfAndCxl = new ArrayList<OriginalPaymentInstruction36>();
        }
     ...
     * 
     */
    public UnderlyingTransaction27 addOrgnlPmtInfAndCxl(OriginalPaymentInstruction36 orgnlPmtInfAndCxl) {
