...
@XmlType(name = "LiquidityCreditTransferV05", propOrder = {
    "msgHdr",
    "lqdtyCdtTrf",
    "splmtryData"
})
public class LiquidityCreditTransferV05 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader1 msgHdr;
    @XmlElement(name = "LqdtyCdtTrf", required = true)
    protected LiquidityCreditTransfer2 lqdtyCdtTrf;
     ...
     *     
     */
    public LiquidityCreditTransferV05 setMsgHdr(MessageHeader1 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link LiquidityCreditTransfer2 }
     *     
     */
    public LiquidityCreditTransfer2 getLqdtyCdtTrf() {
        return lqdtyCdtTrf;
    }
     ...
     *     
     */
    public LiquidityCreditTransferV05 setLqdtyCdtTrf(LiquidityCreditTransfer2 value) {
     ...
     * 
     */
    public LiquidityCreditTransferV05 addSplmtryData(SupplementaryData1 splmtryData) {
