...
@XmlType(name = "ReceiptV07", propOrder = {
    "msgHdr",
    "rctDtls",
    "splmtryData"
})
public class ReceiptV07 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader9 msgHdr;
    @XmlElement(name = "RctDtls", required = true)
    protected List<Receipt5> rctDtls;
     ...
     *     
     */
    public ReceiptV07 setMsgHdr(MessageHeader9 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * 
     */
    public List<Receipt5> getRctDtls() {
        if (rctDtls == null) {
            rctDtls = new ArrayList<Receipt5>();
        }
        return this.rctDtls;
    }
     ...
     * 
     */
    public ReceiptV07 addRctDtls(Receipt5 rctDtls) {
     ...
     * 
     */
    public ReceiptV07 addSplmtryData(SupplementaryData1 splmtryData) {
