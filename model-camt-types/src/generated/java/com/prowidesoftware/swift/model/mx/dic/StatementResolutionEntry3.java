...
@XmlType(name = "StatementResolutionEntry3", propOrder = {
    "orgnlGrpInf",
    "orgnlStmtId",
    "acctSvcrRef",
    "crrctdAmt",
...
public class StatementResolutionEntry3 {
     ...
     *     
     */
    public StatementResolutionEntry3 setOrgnlGrpInf(OriginalGroupInformation29 value) {
     ...
     *     
     */
    public StatementResolutionEntry3 setOrgnlStmtId(String value) {
     ...
     *     
     */
    public StatementResolutionEntry3 setAcctSvcrRef(String value) {
     ...
     *     
     */
    public StatementResolutionEntry3 setCrrctdAmt(ActiveOrHistoricCurrencyAndAmount value) {
     ...
     *     
     */
    public StatementResolutionEntry3 setPurp(Purpose2Choice value) {
        this.purp = value;
        return this;
    }
     ...
     * 
     */
    public StatementResolutionEntry3 addChrgs(Charges3 chrgs) {
        getChrgs().add(chrgs);
        return this;
    }
