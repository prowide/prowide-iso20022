...
@XmlType(name = "BankToCustomerAccountReportV13", propOrder = {
    "grpHdr",
    "rpt",
    "splmtryData"
})
public class BankToCustomerAccountReportV13 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader116 grpHdr;
    @XmlElement(name = "Rpt", required = true)
    protected List<AccountReport37> rpt;
     ...
     *     
     */
    public BankToCustomerAccountReportV13 setGrpHdr(GroupHeader116 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountReport37 }
     * 
     * 
     */
    public List<AccountReport37> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<AccountReport37>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV13 addRpt(AccountReport37 rpt) {
        getRpt().add(rpt);
        return this;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV13 addSplmtryData(SupplementaryData1 splmtryData) {
