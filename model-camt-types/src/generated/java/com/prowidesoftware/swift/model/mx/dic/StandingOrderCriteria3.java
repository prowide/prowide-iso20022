...
@XmlType(name = "StandingOrderCriteria3", propOrder = {
    "newQryNm",
    "schCrit",
    "rtrCrit"
})
public class StandingOrderCriteria3 {

    @XmlElement(name = "NewQryNm")
    protected String newQryNm;
    @XmlElement(name = "SchCrit")
    protected List<StandingOrderSearchCriteria3> schCrit;
     ...
     *     
     */
    public StandingOrderCriteria3 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
     ...
     *     
     */
    public StandingOrderCriteria3 setRtrCrit(StandingOrderReturnCriteria1 value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public StandingOrderCriteria3 addSchCrit(StandingOrderSearchCriteria3 schCrit) {
