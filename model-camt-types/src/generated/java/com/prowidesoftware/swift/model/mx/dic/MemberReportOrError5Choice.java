...
@XmlType(name = "MemberReportOrError5Choice", propOrder = {
    "rpt",
    "oprlErr"
})
public class MemberReportOrError5Choice {

    @XmlElement(name = "Rpt")
    protected List<MemberReport5> rpt;
     ...
     * 
     */
    public MemberReportOrError5Choice addRpt(MemberReport5 rpt) {
        getRpt().add(rpt);
        return this;
    }
     ...
     * 
     */
    public MemberReportOrError5Choice addOprlErr(ErrorHandling3 oprlErr) {
