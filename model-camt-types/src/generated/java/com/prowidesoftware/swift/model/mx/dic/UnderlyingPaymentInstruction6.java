...
@XmlType(name = "UnderlyingPaymentInstruction6", propOrder = {
    "orgnlGrpInf",
    "orgnlPmtInfId",
    "orgnlInstrId",
    "orgnlEndToEndId",
...
public class UnderlyingPaymentInstruction6 {
     ...
     *     
     */
    public UnderlyingPaymentInstruction6 setOrgnlGrpInf(UnderlyingGroupInformation1 value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction6 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction6 setOrgnlInstrId(String value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction6 setOrgnlEndToEndId(String value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction6 setOrgnlUETR(String value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction6 setOrgnlInstdAmt(ActiveOrHistoricCurrencyAndAmount value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction6 setReqdExctnDt(DateAndDateTime2Choice value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction6 setReqdColltnDt(LocalDate value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction6 setOrgnlTxRef(OriginalTransactionReference31 value) {
