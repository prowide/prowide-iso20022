...
@XmlType(name = "CurrentAndDefaultReservation3", propOrder = {
    "curRsvatn",
    "dfltRsvatn"
})
public class CurrentAndDefaultReservation3 {
    ...
    protected List<ReservationReport5> curRsvatn;
    @XmlElement(name = "DfltRsvatn")
    protected List<ReservationReport5> dfltRsvatn;
     ...
     * {@link ReservationReport5 }
     * 
     * 
     */
    public List<ReservationReport5> getCurRsvatn() {
        if (curRsvatn == null) {
            curRsvatn = new ArrayList<ReservationReport5>();
        }
     ...
     * 
     */
    public List<ReservationReport5> getDfltRsvatn() {
        if (dfltRsvatn == null) {
            dfltRsvatn = new ArrayList<ReservationReport5>();
        }
     ...
     * 
     */
    public CurrentAndDefaultReservation3 addCurRsvatn(ReservationReport5 curRsvatn) {
     ...
     * 
     */
    public CurrentAndDefaultReservation3 addDfltRsvatn(ReservationReport5 dfltRsvatn) {
