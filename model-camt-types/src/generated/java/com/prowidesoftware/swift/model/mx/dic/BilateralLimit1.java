...
@XmlType(name = "BilateralLimit1", propOrder = {
    "ctrPtyId",
    "lmtAmt",
    "cdtDbtInd",
    "bilBal"
...
public class BilateralLimit1 {
     ...
     *     
     */
    public BilateralLimit1 setCtrPtyId(BranchAndFinancialInstitutionIdentification5 value) {
        this.ctrPtyId = value;
        return this;
    }
     ...
     *     
     */
    public BilateralLimit1 setLmtAmt(Amount2Choice value) {
        this.lmtAmt = value;
        return this;
    }
     ...
     *     
     */
    public BilateralLimit1 setCdtDbtInd(CreditDebitCode value) {
    ...
    public List<CashBalance6> getBilBal() {
        if (bilBal == null) {
            bilBal = new ArrayList<CashBalance6>();
        }
        return this.bilBal;
    }
     ...
     * 
     */
    public BilateralLimit1 addBilBal(CashBalance6 bilBal) {
