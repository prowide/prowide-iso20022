...
@XmlType(name = "EntryDetails13", propOrder = {
    "btch",
    "txDtls"
})
public class EntryDetails13 {

    @XmlElement(name = "Btch")
    protected BatchInformation2 btch;
    @XmlElement(name = "TxDtls")
    protected List<EntryTransaction14> txDtls;
     ...
     *     
     */
    public EntryDetails13 setBtch(BatchInformation2 value) {
        this.btch = value;
        return this;
    }
     ...
     * {@link EntryTransaction14 }
     * 
     * 
     */
    public List<EntryTransaction14> getTxDtls() {
        if (txDtls == null) {
            txDtls = new ArrayList<EntryTransaction14>();
        }
        return this.txDtls;
    }
     ...
     * 
     */
    public EntryDetails13 addTxDtls(EntryTransaction14 txDtls) {
