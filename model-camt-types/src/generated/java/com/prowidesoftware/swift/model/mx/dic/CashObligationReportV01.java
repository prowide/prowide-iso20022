...
/**
 * The CashObligationReport message is sent by the settlement system to a settlement member to report on the projected or actual cash settlement obligations that will be submitted for settlement.
 * 
...
public class CashObligationReportV01 {
     ...
     * This is why there is not a {@code set} method for the sttlmAcctNetPos property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the sttlmAcctNetPos property.
     */
    public List<CashNetPosition2> getSttlmAcctNetPos() {
        if (sttlmAcctNetPos == null) {
            sttlmAcctNetPos = new ArrayList<>();
        }
