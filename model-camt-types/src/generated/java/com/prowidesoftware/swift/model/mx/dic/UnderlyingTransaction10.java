...
@XmlType(name = "UnderlyingTransaction10", propOrder = {
    "orgnlGrpInfAndCxl",
    "txInf"
})
public class UnderlyingTransaction10 {
     ...
     *     
     */
    public UnderlyingTransaction10 setOrgnlGrpInfAndCxl(OriginalGroupHeader4 value) {
     ...
     * 
     */
    public UnderlyingTransaction10 addTxInf(PaymentTransaction55 txInf) {
        getTxInf().add(txInf);
        return this;
    }
