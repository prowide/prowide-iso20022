...
@XmlType(name = "BankServicesBillingStatementV03", propOrder = {
    "rptHdr",
    "bllgStmtGrp"
})
public class BankServicesBillingStatementV03 {

    @XmlElement(name = "RptHdr", required = true)
    protected ReportHeader6 rptHdr;
    @XmlElement(name = "BllgStmtGrp", required = true)
    protected List<StatementGroup3> bllgStmtGrp;
     ...
     *     
     */
    public BankServicesBillingStatementV03 setRptHdr(ReportHeader6 value) {
        this.rptHdr = value;
        return this;
    }
     ...
     * {@link StatementGroup3 }
     * 
     * 
     */
    public List<StatementGroup3> getBllgStmtGrp() {
        if (bllgStmtGrp == null) {
            bllgStmtGrp = new ArrayList<StatementGroup3>();
        }
     ...
     * 
     */
    public BankServicesBillingStatementV03 addBllgStmtGrp(StatementGroup3 bllgStmtGrp) {
