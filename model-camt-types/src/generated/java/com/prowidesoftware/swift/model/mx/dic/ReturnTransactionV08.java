...
@XmlType(name = "ReturnTransactionV08", propOrder = {
    "msgHdr",
    "rptOrErr",
    "splmtryData"
})
public class ReturnTransactionV08 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader8 msgHdr;
    @XmlElement(name = "RptOrErr", required = true)
    protected TransactionReportOrError4Choice rptOrErr;
     ...
     *     
     */
    public ReturnTransactionV08 setMsgHdr(MessageHeader8 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link TransactionReportOrError4Choice }
     *     
     */
    public TransactionReportOrError4Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public ReturnTransactionV08 setRptOrErr(TransactionReportOrError4Choice value) {
        this.rptOrErr = value;
        return this;
    }
     ...
     * 
     */
    public ReturnTransactionV08 addSplmtryData(SupplementaryData1 splmtryData) {
