...
@XmlType(name = "EntryDetails12", propOrder = {
    "btch",
    "txDtls"
})
public class EntryDetails12 {

    @XmlElement(name = "Btch")
    protected BatchInformation2 btch;
    @XmlElement(name = "TxDtls")
    protected List<EntryTransaction13> txDtls;
     ...
     *     
     */
    public EntryDetails12 setBtch(BatchInformation2 value) {
        this.btch = value;
        return this;
    }
     ...
     * {@link EntryTransaction13 }
     * 
     * 
     */
    public List<EntryTransaction13> getTxDtls() {
        if (txDtls == null) {
            txDtls = new ArrayList<EntryTransaction13>();
        }
        return this.txDtls;
    }
     ...
     * 
     */
    public EntryDetails12 addTxDtls(EntryTransaction13 txDtls) {
