...
@XmlType(name = "AccountCriteria2", propOrder = {
    "newQryNm",
    "schCrit",
    "rtrCrit"
})
public class AccountCriteria2 {
    ...
    protected List<CashAccountSearchCriteria2> schCrit;
     ...
     *     
     */
    public AccountCriteria2 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
     ...
     * {@link CashAccountSearchCriteria2 }
     * 
     * 
     */
    public List<CashAccountSearchCriteria2> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<CashAccountSearchCriteria2>();
        }
        return this.schCrit;
    }
     ...
     *     
     */
    public AccountCriteria2 setRtrCrit(CashAccountReturnCriteria2 value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public AccountCriteria2 addSchCrit(CashAccountSearchCriteria2 schCrit) {
