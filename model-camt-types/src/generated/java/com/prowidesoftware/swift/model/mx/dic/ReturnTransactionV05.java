...
@XmlType(name = "ReturnTransactionV05", propOrder = {
    "msgHdr",
    "rptOrErr"
})
public class ReturnTransactionV05 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader5 msgHdr;
    @XmlElement(name = "RptOrErr", required = true)
    protected TransactionReportOrError1Choice rptOrErr;
     ...
     *     
     */
    public ReturnTransactionV05 setMsgHdr(MessageHeader5 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link TransactionReportOrError1Choice }
     *     
     */
    public TransactionReportOrError1Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public ReturnTransactionV05 setRptOrErr(TransactionReportOrError1Choice value) {
        this.rptOrErr = value;
        return this;
    }
