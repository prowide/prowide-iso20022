...
@XmlType(name = "ReturnReservationV03", propOrder = {
    "msgHdr",
    "rptOrErr"
})
public class ReturnReservationV03 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader3 msgHdr;
    @XmlElement(name = "RptOrErr", required = true)
    protected ReservationOrError2Choice rptOrErr;
     ...
     *     
     */
    public ReturnReservationV03 setMsgHdr(MessageHeader3 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link ReservationOrError2Choice }
     *     
     */
    public ReservationOrError2Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public ReturnReservationV03 setRptOrErr(ReservationOrError2Choice value) {
        this.rptOrErr = value;
        return this;
    }
