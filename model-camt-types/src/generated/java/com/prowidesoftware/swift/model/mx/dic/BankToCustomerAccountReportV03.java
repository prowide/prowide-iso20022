...
@XmlType(name = "BankToCustomerAccountReportV03", propOrder = {
    "grpHdr",
    "rpt",
    "splmtryData"
})
public class BankToCustomerAccountReportV03 {
    ...
    protected List<AccountReport12> rpt;
     ...
     *     
     */
    public BankToCustomerAccountReportV03 setGrpHdr(GroupHeader58 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountReport12 }
     * 
     * 
     */
    public List<AccountReport12> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<AccountReport12>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV03 addRpt(AccountReport12 rpt) {
        getRpt().add(rpt);
        return this;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV03 addSplmtryData(SupplementaryData1 splmtryData) {
