...
@XmlType(name = "ReservationOrError10Choice", propOrder = {
    "bizRpt",
    "oprlErr"
})
public class ReservationOrError10Choice {

    @XmlElement(name = "BizRpt")
    protected CurrentAndDefaultReservation5 bizRpt;
     ...
     * @return
     *     possible object is
     *     {@link CurrentAndDefaultReservation5 }
     *     
     */
    public CurrentAndDefaultReservation5 getBizRpt() {
        return bizRpt;
    }
     ...
     *     
     */
    public ReservationOrError10Choice setBizRpt(CurrentAndDefaultReservation5 value) {
        this.bizRpt = value;
        return this;
    }
     ...
     * 
     */
    public ReservationOrError10Choice addOprlErr(ErrorHandling5 oprlErr) {
