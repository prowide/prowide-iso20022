...
@XmlType(name = "ReceiptV08", propOrder = {
    "msgHdr",
    "rctDtls",
    "splmtryData"
})
public class ReceiptV08 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader9 msgHdr;
    @XmlElement(name = "RctDtls", required = true)
    protected List<Receipt6> rctDtls;
     ...
     *     
     */
    public ReceiptV08 setMsgHdr(MessageHeader9 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * 
     */
    public List<Receipt6> getRctDtls() {
        if (rctDtls == null) {
            rctDtls = new ArrayList<Receipt6>();
        }
        return this.rctDtls;
    }
     ...
     * 
     */
    public ReceiptV08 addRctDtls(Receipt6 rctDtls) {
     ...
     * 
     */
    public ReceiptV08 addSplmtryData(SupplementaryData1 splmtryData) {
