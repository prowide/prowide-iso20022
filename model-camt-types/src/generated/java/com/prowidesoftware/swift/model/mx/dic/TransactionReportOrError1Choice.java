...
@XmlType(name = "TransactionReportOrError1Choice", propOrder = {
    "bizRpt",
    "oprlErr"
})
public class TransactionReportOrError1Choice {
    ...
    protected Transactions5 bizRpt;
     ...
     *     
     */
    public Transactions5 getBizRpt() {
        return bizRpt;
    }
     ...
     *     
     */
    public TransactionReportOrError1Choice setBizRpt(Transactions5 value) {
        this.bizRpt = value;
        return this;
    }
     ...
     * 
     */
    public TransactionReportOrError1Choice addOprlErr(ErrorHandling3 oprlErr) {
