...
@XmlType(name = "TotalTransactions1", propOrder = {
    "ttlNtries",
    "ttlCdtNtries",
    "ttlDbtNtries",
    "ttlNtriesPerBkTxCd"
...
public class TotalTransactions1 {
     ...
     *     
     */
    public TotalTransactions1 setTtlNtries(NumberAndSumOfTransactions2 value) {
     ...
     *     
     */
    public TotalTransactions1 setTtlCdtNtries(NumberAndSumOfTransactions1 value) {
     ...
     *     
     */
    public TotalTransactions1 setTtlDbtNtries(NumberAndSumOfTransactions1 value) {
     ...
     * {@link NumberAndSumOfTransactionsPerBankTransactionCode1 }
     * 
     * 
     */
    public List<NumberAndSumOfTransactionsPerBankTransactionCode1> getTtlNtriesPerBkTxCd() {
        if (ttlNtriesPerBkTxCd == null) {
            ttlNtriesPerBkTxCd = new ArrayList<NumberAndSumOfTransactionsPerBankTransactionCode1>();
        }
     ...
     * 
     */
    public TotalTransactions1 addTtlNtriesPerBkTxCd(NumberAndSumOfTransactionsPerBankTransactionCode1 ttlNtriesPerBkTxCd) {
