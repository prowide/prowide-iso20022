...
@XmlType(name = "AccountOrOperationalError3Choice", propOrder = {
    "acctRpt",
    "oprlErr"
})
public class AccountOrOperationalError3Choice {
    ...
    protected List<AccountReport21> acctRpt;
     ...
     * {@link AccountReport21 }
     * 
     * 
     */
    public List<AccountReport21> getAcctRpt() {
        if (acctRpt == null) {
            acctRpt = new ArrayList<AccountReport21>();
        }
        return this.acctRpt;
    }
     ...
     * 
     */
    public AccountOrOperationalError3Choice addAcctRpt(AccountReport21 acctRpt) {
     ...
     * 
     */
    public AccountOrOperationalError3Choice addOprlErr(ErrorHandling4 oprlErr) {
