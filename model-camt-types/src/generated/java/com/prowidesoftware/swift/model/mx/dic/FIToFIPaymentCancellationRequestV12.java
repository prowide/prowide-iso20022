 ...
 * The processing of a FIToFIPaymentCancellationRequest message case may lead to an InvestigationRequest message sent to the creditor by its account servicing institution.
...
@XmlType(name = "FIToFIPaymentCancellationRequestV12", propOrder = {
    "assgnmt",
    "_case",
    "ctrlData",
    "undrlyg",
...
public class FIToFIPaymentCancellationRequestV12 {
    ...
    protected List<UnderlyingTransaction36> undrlyg;
     ...
     *     
     */
    public FIToFIPaymentCancellationRequestV12 setAssgnmt(CaseAssignment6 value) {
        this.assgnmt = value;
        return this;
    }
     ...
     *     
     */
    public FIToFIPaymentCancellationRequestV12 setCase(Case6 value) {
        this._case = value;
        return this;
    }
     ...
     *     
     */
    public FIToFIPaymentCancellationRequestV12 setCtrlData(ControlData1 value) {
        this.ctrlData = value;
        return this;
    }
     ...
     * {@link UnderlyingTransaction36 }
     * 
     * 
     * @return
     *     The value of the undrlyg property.
     */
    public List<UnderlyingTransaction36> getUndrlyg() {
        if (undrlyg == null) {
     ...
     * 
     */
    public FIToFIPaymentCancellationRequestV12 addUndrlyg(UnderlyingTransaction36 undrlyg) {
     ...
     * 
     */
    public FIToFIPaymentCancellationRequestV12 addSplmtryData(SupplementaryData1 splmtryData) {
