...
@XmlType(name = "MemberInformation2", propOrder = {
    "mmbRpt"
})
public class MemberInformation2 {

    @XmlElement(name = "MmbRpt", required = true)
    protected List<MemberReport2> mmbRpt;
     ...
     * 
     */
    public List<MemberReport2> getMmbRpt() {
        if (mmbRpt == null) {
            mmbRpt = new ArrayList<MemberReport2>();
        }
        return this.mmbRpt;
    }
     ...
     * 
     */
    public MemberInformation2 addMmbRpt(MemberReport2 mmbRpt) {
