...
@XmlType(name = "OriginalPaymentInstruction30", propOrder = {
    "orgnlPmtInfCxlId",
    "rslvdCase",
    "orgnlPmtInfId",
    "orgnlGrpInf",
...
public class OriginalPaymentInstruction30 {
    ...
    protected List<PaymentTransaction103> txInfAndSts;
     ...
     *     
     */
    public OriginalPaymentInstruction30 setOrgnlPmtInfCxlId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction30 setRslvdCase(Case5 value) {
     ...
     *     
     */
    public OriginalPaymentInstruction30 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction30 setOrgnlGrpInf(OriginalGroupInformation29 value) {
     ...
     *     
     */
    public OriginalPaymentInstruction30 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction30 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction30 setPmtInfCxlSts(GroupCancellationStatus1Code value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction103 }
     * 
     * 
     */
    public List<PaymentTransaction103> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new ArrayList<PaymentTransaction103>();
        }
     ...
     * 
     */
    public OriginalPaymentInstruction30 addCxlStsRsnInf(CancellationStatusReason4 cxlStsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction30 addNbOfTxsPerCxlSts(NumberOfCancellationsPerStatus1 nbOfTxsPerCxlSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction30 addTxInfAndSts(PaymentTransaction103 txInfAndSts) {
