...
@XmlType(name = "Transactions9", propOrder = {
    "pmtCmonInf",
    "txsSummry",
    "txRpt"
})
public class Transactions9 {
    ...
    protected List<TransactionReport6> txRpt;
     ...
     *     
     */
    public Transactions9 setPmtCmonInf(PaymentCommon5 value) {
     ...
     *     
     */
    public Transactions9 setTxsSummry(NumberAndSumOfTransactions2 value) {
     ...
     * {@link TransactionReport6 }
     * 
     * 
     */
    public List<TransactionReport6> getTxRpt() {
        if (txRpt == null) {
            txRpt = new ArrayList<TransactionReport6>();
        }
        return this.txRpt;
    }
     ...
     * 
     */
    public Transactions9 addTxRpt(TransactionReport6 txRpt) {
        getTxRpt().add(txRpt);
        return this;
    }
