...
@XmlType(name = "ReturnMemberV04", propOrder = {
    "msgHdr",
    "rptOrErr",
    "splmtryData"
})
public class ReturnMemberV04 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader7 msgHdr;
    @XmlElement(name = "RptOrErr", required = true)
    protected MemberReportOrError5Choice rptOrErr;
     ...
     *     
     */
    public ReturnMemberV04 setMsgHdr(MessageHeader7 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link MemberReportOrError5Choice }
     *     
     */
    public MemberReportOrError5Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public ReturnMemberV04 setRptOrErr(MemberReportOrError5Choice value) {
        this.rptOrErr = value;
        return this;
    }
     ...
     * 
     */
    public ReturnMemberV04 addSplmtryData(SupplementaryData1 splmtryData) {
