...
@XmlType(name = "BusinessDay1", propOrder = {
    "sysId",
    "bizDayOrErr"
})
public class BusinessDay1 {
    ...
    protected BusinessDayReportOrError2Choice bizDayOrErr;
     ...
     * @return
     *     possible object is
     *     {@link BusinessDayReportOrError2Choice }
     *     
     */
    public BusinessDayReportOrError2Choice getBizDayOrErr() {
        return bizDayOrErr;
    }
     ...
     *     
     */
    public BusinessDay1 setBizDayOrErr(BusinessDayReportOrError2Choice value) {
     ...
     * 
     */
    public BusinessDay1 addSysId(SystemIdentification2Choice sysId) {
        getSysId().add(sysId);
        return this;
    }
