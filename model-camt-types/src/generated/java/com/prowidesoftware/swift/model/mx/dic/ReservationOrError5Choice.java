...
@XmlType(name = "ReservationOrError5Choice", propOrder = {
    "rsvatn",
    "bizErr"
})
public class ReservationOrError5Choice {
     ...
     *     
     */
    public ReservationOrError5Choice setRsvatn(Reservation1 value) {
        this.rsvatn = value;
        return this;
    }
     ...
     * 
     */
    public ReservationOrError5Choice addBizErr(ErrorHandling4 bizErr) {
