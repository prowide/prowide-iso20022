...
@XmlType(name = "StandingOrderOrError5Choice", propOrder = {
    "rpt",
    "oprlErr"
})
public class StandingOrderOrError5Choice {

    @XmlElement(name = "Rpt")
    protected List<StandingOrderReport1> rpt;
     ...
     * {@link StandingOrderReport1 }
     * 
     * 
     */
    public List<StandingOrderReport1> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<StandingOrderReport1>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public StandingOrderOrError5Choice addRpt(StandingOrderReport1 rpt) {
        getRpt().add(rpt);
        return this;
    }
     ...
     * 
     */
    public StandingOrderOrError5Choice addOprlErr(ErrorHandling5 oprlErr) {
