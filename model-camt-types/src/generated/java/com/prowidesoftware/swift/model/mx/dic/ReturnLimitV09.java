...
@XmlType(name = "ReturnLimitV09", propOrder = {
    "msgHdr",
    "rptOrErr",
    "splmtryData"
})
public class ReturnLimitV09 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader7 msgHdr;
    @XmlElement(name = "RptOrErr", required = true)
    protected LimitReportOrError5Choice rptOrErr;
     ...
     *     
     */
    public ReturnLimitV09 setMsgHdr(MessageHeader7 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link LimitReportOrError5Choice }
     *     
     */
    public LimitReportOrError5Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public ReturnLimitV09 setRptOrErr(LimitReportOrError5Choice value) {
        this.rptOrErr = value;
        return this;
    }
     ...
     * 
     */
    public ReturnLimitV09 addSplmtryData(SupplementaryData1 splmtryData) {
