...
public class LimitCriteria2 {
    ...
    protected List<LimitSearchCriteria2> schCrit;
     ...
     *     
     */
    public LimitCriteria2 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
    ...
    public List<LimitSearchCriteria2> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<LimitSearchCriteria2>();
        }
        return this.schCrit;
    }
     ...
     *     
     */
    public LimitCriteria2 setRtrCrit(LimitReturnCriteria value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public LimitCriteria2 addSchCrit(LimitSearchCriteria2 schCrit) {
