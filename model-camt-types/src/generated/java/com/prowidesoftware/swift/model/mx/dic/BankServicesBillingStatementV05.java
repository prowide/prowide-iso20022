...
@XmlType(name = "BankServicesBillingStatementV05", propOrder = {
    "rptHdr",
    "bllgStmtGrp"
})
public class BankServicesBillingStatementV05 {

    @XmlElement(name = "RptHdr", required = true)
    protected ReportHeader6 rptHdr;
    @XmlElement(name = "BllgStmtGrp", required = true)
    protected List<StatementGroup5> bllgStmtGrp;
     ...
     *     
     */
    public BankServicesBillingStatementV05 setRptHdr(ReportHeader6 value) {
        this.rptHdr = value;
        return this;
    }
     ...
     * 
     */
    public BankServicesBillingStatementV05 addBllgStmtGrp(StatementGroup5 bllgStmtGrp) {
