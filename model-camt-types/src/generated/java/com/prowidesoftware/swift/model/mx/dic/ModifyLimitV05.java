...
@XmlType(name = "ModifyLimitV05", propOrder = {
    "msgHdr",
    "lmtDtls"
})
public class ModifyLimitV05 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader1 msgHdr;
    @XmlElement(name = "LmtDtls")
    protected List<LimitStructure1> lmtDtls;
     ...
     *     
     */
    public ModifyLimitV05 setMsgHdr(MessageHeader1 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * 
     */
    public ModifyLimitV05 addLmtDtls(LimitStructure1 lmtDtls) {
