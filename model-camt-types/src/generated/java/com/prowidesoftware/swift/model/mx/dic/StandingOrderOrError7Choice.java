...
@XmlType(name = "StandingOrderOrError7Choice", propOrder = {
    "rpt",
    "oprlErr"
})
public class StandingOrderOrError7Choice {

    @XmlElement(name = "Rpt")
    protected List<StandingOrderReport2> rpt;
     ...
     * {@link StandingOrderReport2 }
     * 
     * 
     */
    public List<StandingOrderReport2> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<StandingOrderReport2>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public StandingOrderOrError7Choice addRpt(StandingOrderReport2 rpt) {
        getRpt().add(rpt);
        return this;
    }
     ...
     * 
     */
    public StandingOrderOrError7Choice addOprlErr(ErrorHandling5 oprlErr) {
