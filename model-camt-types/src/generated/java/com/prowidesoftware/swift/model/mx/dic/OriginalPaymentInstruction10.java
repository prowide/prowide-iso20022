...
@XmlType(name = "OriginalPaymentInstruction10", propOrder = {
    "orgnlPmtInfCxlId",
    "rslvdCase",
    "orgnlPmtInfId",
    "orgnlGrpInf",
...
public class OriginalPaymentInstruction10 {
    ...
    protected List<PaymentTransaction54> txInfAndSts;
     ...
     *     
     */
    public OriginalPaymentInstruction10 setOrgnlPmtInfCxlId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction10 setRslvdCase(Case3 value) {
     ...
     *     
     */
    public OriginalPaymentInstruction10 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction10 setOrgnlGrpInf(OriginalGroupInformation3 value) {
     ...
     *     
     */
    public OriginalPaymentInstruction10 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction10 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction10 setPmtInfCxlSts(GroupCancellationStatus1Code value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction54 }
     * 
     * 
     */
    public List<PaymentTransaction54> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new ArrayList<PaymentTransaction54>();
        }
     ...
     * 
     */
    public OriginalPaymentInstruction10 addCxlStsRsnInf(CancellationStatusReason2 cxlStsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction10 addNbOfTxsPerCxlSts(NumberOfCancellationsPerStatus1 nbOfTxsPerCxlSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction10 addTxInfAndSts(PaymentTransaction54 txInfAndSts) {
