...
public class BankToCustomerStatementV05 {
    ...
    protected List<AccountStatement5> stmt;
     ...
     *     
     */
    public BankToCustomerStatementV05 setGrpHdr(GroupHeader58 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountStatement5 }
     * 
     * 
     */
    public List<AccountStatement5> getStmt() {
        if (stmt == null) {
            stmt = new ArrayList<AccountStatement5>();
        }
        return this.stmt;
    }
     ...
     * 
     */
    public BankToCustomerStatementV05 addStmt(AccountStatement5 stmt) {
        getStmt().add(stmt);
        return this;
    }
     ...
     * 
     */
    public BankToCustomerStatementV05 addSplmtryData(SupplementaryData1 splmtryData) {
