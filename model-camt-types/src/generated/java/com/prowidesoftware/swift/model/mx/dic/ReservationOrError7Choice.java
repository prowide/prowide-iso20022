...
@XmlType(name = "ReservationOrError7Choice", propOrder = {
    "rsvatn",
    "bizErr"
})
public class ReservationOrError7Choice {
     ...
     *     
     */
    public ReservationOrError7Choice setRsvatn(Reservation3 value) {
        this.rsvatn = value;
        return this;
    }
     ...
     * 
     */
    public ReservationOrError7Choice addBizErr(ErrorHandling4 bizErr) {
