...
public class PaymentTransaction154 {
     ...
     *     
     */
    public PaymentTransaction154 setCxlId(String value) {
        this.cxlId = value;
        return this;
    }
     ...
     *     
     */
    public PaymentTransaction154 setCase(Case6 value) {
        this._case = value;
        return this;
    }
     ...
     *     
     */
    public PaymentTransaction154 setOrgnlInstrId(String value) {
     ...
     *     
     */
    public PaymentTransaction154 setOrgnlEndToEndId(String value) {
     ...
     *     
     */
    public PaymentTransaction154 setOrgnlUETR(String value) {
     ...
     *     
     */
    public PaymentTransaction154 setOrgnlInstdAmt(ActiveOrHistoricCurrencyAndAmount value) {
     ...
     *     
     */
    public PaymentTransaction154 setOrgnlReqdExctnDt(DateAndDateTime2Choice value) {
     ...
     *     
     */
    public PaymentTransaction154 setOrgnlReqdColltnDt(XMLGregorianCalendar value) {
     ...
     *     
     */
    public PaymentTransaction154 setOrgnlTxRef(OriginalTransactionReference42 value) {
     ...
     * 
     */
    public PaymentTransaction154 addCxlRsnInf(PaymentCancellationReason6 cxlRsnInf) {
     ...
     * 
     */
    public PaymentTransaction154 addSplmtryData(SupplementaryData1 splmtryData) {
