...
@XmlType(name = "GetAccountV07", propOrder = {
    "msgHdr",
    "acctQryDef",
    "splmtryData"
})
public class GetAccountV07 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader9 msgHdr;
    @XmlElement(name = "AcctQryDef")
    protected AccountQuery3 acctQryDef;
     ...
     *     
     */
    public GetAccountV07 setMsgHdr(MessageHeader9 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     *     
     */
    public AccountQuery3 getAcctQryDef() {
        return acctQryDef;
    }
     ...
     *     
     */
    public GetAccountV07 setAcctQryDef(AccountQuery3 value) {
     ...
     * 
     */
    public GetAccountV07 addSplmtryData(SupplementaryData1 splmtryData) {
