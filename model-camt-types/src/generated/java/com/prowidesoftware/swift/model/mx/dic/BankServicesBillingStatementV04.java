...
public class BankServicesBillingStatementV04 {
     ...
     *     
     */
    public BankServicesBillingStatementV04 setRptHdr(ReportHeader6 value) {
        this.rptHdr = value;
        return this;
    }
    ...
    public List<StatementGroup4> getBllgStmtGrp() {
        if (bllgStmtGrp == null) {
            bllgStmtGrp = new ArrayList<StatementGroup4>();
        }
     ...
     * 
     */
    public BankServicesBillingStatementV04 addBllgStmtGrp(StatementGroup4 bllgStmtGrp) {
