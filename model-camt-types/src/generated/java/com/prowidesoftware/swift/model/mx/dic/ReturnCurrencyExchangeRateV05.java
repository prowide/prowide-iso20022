...
@XmlType(name = "ReturnCurrencyExchangeRateV05", propOrder = {
    "msgHdr",
    "rptOrErr",
    "splmtryData"
})
public class ReturnCurrencyExchangeRateV05 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader7 msgHdr;
    @XmlElement(name = "RptOrErr", required = true)
    protected ExchangeRateReportOrError3Choice rptOrErr;
     ...
     *     
     */
    public ReturnCurrencyExchangeRateV05 setMsgHdr(MessageHeader7 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link ExchangeRateReportOrError3Choice }
     *     
     */
    public ExchangeRateReportOrError3Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public ReturnCurrencyExchangeRateV05 setRptOrErr(ExchangeRateReportOrError3Choice value) {
        this.rptOrErr = value;
        return this;
    }
     ...
     * 
     */
    public ReturnCurrencyExchangeRateV05 addSplmtryData(SupplementaryData1 splmtryData) {
