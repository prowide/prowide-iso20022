...
@XmlType(name = "ReturnGeneralBusinessInformationV03", propOrder = {
    "msgHdr",
    "rptOrErr"
})
public class ReturnGeneralBusinessInformationV03 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader3 msgHdr;
    @XmlElement(name = "RptOrErr", required = true)
    protected GeneralBusinessOrError1Choice rptOrErr;
     ...
     *     
     */
    public ReturnGeneralBusinessInformationV03 setMsgHdr(MessageHeader3 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link GeneralBusinessOrError1Choice }
     *     
     */
    public GeneralBusinessOrError1Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public ReturnGeneralBusinessInformationV03 setRptOrErr(GeneralBusinessOrError1Choice value) {
        this.rptOrErr = value;
        return this;
    }
