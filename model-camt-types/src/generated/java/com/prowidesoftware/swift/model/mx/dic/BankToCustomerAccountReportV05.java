...
@XmlType(name = "BankToCustomerAccountReportV05", propOrder = {
    "grpHdr",
    "rpt",
    "splmtryData"
})
public class BankToCustomerAccountReportV05 {
     ...
     *     
     */
    public BankToCustomerAccountReportV05 setGrpHdr(GroupHeader58 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountReport18 }
     * 
     * 
     */
    public List<AccountReport18> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<AccountReport18>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV05 addRpt(AccountReport18 rpt) {
        getRpt().add(rpt);
        return this;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV05 addSplmtryData(SupplementaryData1 splmtryData) {
