...
/**
 * The CashSettlementInitiationStatusAdvice messages is sent by the cash settlement participant to the settlement system to advice on the status of the initiation request.
 * 
