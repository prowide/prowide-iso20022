...
@XmlType(name = "BankToCustomerDebitCreditNotificationV12", propOrder = {
    "grpHdr",
    "ntfctn",
    "splmtryData"
})
public class BankToCustomerDebitCreditNotificationV12 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader116 grpHdr;
    @XmlElement(name = "Ntfctn", required = true)
    protected List<AccountNotification22> ntfctn;
     ...
     *     
     */
    public BankToCustomerDebitCreditNotificationV12 setGrpHdr(GroupHeader116 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountNotification22 }
     * 
     * 
     */
    public List<AccountNotification22> getNtfctn() {
        if (ntfctn == null) {
            ntfctn = new ArrayList<AccountNotification22>();
        }
        return this.ntfctn;
    }
     ...
     * 
     */
    public BankToCustomerDebitCreditNotificationV12 addNtfctn(AccountNotification22 ntfctn) {
     ...
     * 
     */
    public BankToCustomerDebitCreditNotificationV12 addSplmtryData(SupplementaryData1 splmtryData) {
