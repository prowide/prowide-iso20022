...
@XmlType(name = "UnderlyingTransaction36", propOrder = {
    "orgnlGrpInfAndCxl",
    "txInf"
})
public class UnderlyingTransaction36 {

    @XmlElement(name = "OrgnlGrpInfAndCxl")
    protected OriginalGroupHeader21 orgnlGrpInfAndCxl;
    @XmlElement(name = "TxInf")
    protected List<PaymentTransaction172> txInf;
     ...
     *     
     */
    public UnderlyingTransaction36 setOrgnlGrpInfAndCxl(OriginalGroupHeader21 value) {
     ...
     * {@link PaymentTransaction172 }
     * 
     * 
     * @return
     *     The value of the txInf property.
     */
    public List<PaymentTransaction172> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<>();
        }
        return this.txInf;
     ...
     * 
     */
    public UnderlyingTransaction36 addTxInf(PaymentTransaction172 txInf) {
        getTxInf().add(txInf);
        return this;
    }
