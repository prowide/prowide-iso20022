...
@XmlType(name = "StandingOrderCriteria2", propOrder = {
    "newQryNm",
    "schCrit",
    "rtrCrit"
})
public class StandingOrderCriteria2 {

    @XmlElement(name = "NewQryNm")
    protected String newQryNm;
    @XmlElement(name = "SchCrit")
    protected List<StandingOrderSearchCriteria2> schCrit;
     ...
     *     
     */
    public StandingOrderCriteria2 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
     ...
     * {@link StandingOrderSearchCriteria2 }
     * 
     * 
     */
    public List<StandingOrderSearchCriteria2> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<StandingOrderSearchCriteria2>();
        }
        return this.schCrit;
    }
     ...
     *     
     */
    public StandingOrderCriteria2 setRtrCrit(StandingOrderReturnCriteria1 value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public StandingOrderCriteria2 addSchCrit(StandingOrderSearchCriteria2 schCrit) {
