...
public class Transactions10 {
     ...
     *     
     */
    public Transactions10 setPmtCmonInf(PaymentCommon5 value) {
     ...
     *     
     */
    public Transactions10 setTxsSummry(NumberAndSumOfTransactions2 value) {
    ...
    public List<TransactionReport7> getTxRpt() {
        if (txRpt == null) {
            txRpt = new ArrayList<TransactionReport7>();
        }
        return this.txRpt;
    }
     ...
     * 
     */
    public Transactions10 addTxRpt(TransactionReport7 txRpt) {
        getTxRpt().add(txRpt);
        return this;
    }
