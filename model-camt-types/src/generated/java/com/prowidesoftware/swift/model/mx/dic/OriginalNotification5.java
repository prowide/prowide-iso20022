...
@XmlType(name = "OriginalNotification5", propOrder = {
    "orgnlMsgId",
    "orgnlCreDtTm",
    "orgnlNtfctnId",
    "ntfctnSts",
...
public class OriginalNotification5 {
    ...
    protected List<OriginalNotificationReference3> orgnlNtfctnRef;
     ...
     *     
     */
    public OriginalNotification5 setOrgnlMsgId(String value) {
     ...
     *     
     */
    public OriginalNotification5 setOrgnlCreDtTm(OffsetDateTime value) {
     ...
     *     
     */
    public OriginalNotification5 setOrgnlNtfctnId(String value) {
     ...
     *     
     */
    public OriginalNotification5 setNtfctnSts(NotificationStatus3Code value) {
     ...
     *     
     */
    public OriginalNotification5 setAddtlStsInf(String value) {
     ...
     * {@link OriginalNotificationReference3 }
     * 
     * 
     * @return
     *     The value of the orgnlNtfctnRef property.
     */
    public List<OriginalNotificationReference3> getOrgnlNtfctnRef() {
     ...
     * 
     */
    public OriginalNotification5 addOrgnlNtfctnRef(OriginalNotificationReference3 orgnlNtfctnRef) {
