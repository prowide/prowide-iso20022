...
@XmlType(name = "BankToCustomerAccountReportV07", propOrder = {
    "grpHdr",
    "rpt",
    "splmtryData"
})
public class BankToCustomerAccountReportV07 {
    ...
    protected List<AccountReport22> rpt;
     ...
     *     
     */
    public BankToCustomerAccountReportV07 setGrpHdr(GroupHeader73 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountReport22 }
     * 
     * 
     */
    public List<AccountReport22> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<AccountReport22>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV07 addRpt(AccountReport22 rpt) {
        getRpt().add(rpt);
        return this;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV07 addSplmtryData(SupplementaryData1 splmtryData) {
