...
@XmlType(name = "BankToCustomerStatementV06", propOrder = {
    "grpHdr",
    "stmt",
    "splmtryData"
})
public class BankToCustomerStatementV06 {
    ...
    protected List<AccountStatement6> stmt;
     ...
     *     
     */
    public BankToCustomerStatementV06 setGrpHdr(GroupHeader58 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public BankToCustomerStatementV06 addStmt(AccountStatement6 stmt) {
        getStmt().add(stmt);
        return this;
    }
     ...
     * 
     */
    public BankToCustomerStatementV06 addSplmtryData(SupplementaryData1 splmtryData) {
