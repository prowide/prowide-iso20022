...
@XmlType(name = "BankToCustomerAccountReportV10", propOrder = {
    "grpHdr",
    "rpt",
    "splmtryData"
})
public class BankToCustomerAccountReportV10 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader81 grpHdr;
    @XmlElement(name = "Rpt", required = true)
    protected List<AccountReport31> rpt;
     ...
     *     
     */
    public BankToCustomerAccountReportV10 setGrpHdr(GroupHeader81 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountReport31 }
     * 
     * 
     */
    public List<AccountReport31> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<AccountReport31>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV10 addRpt(AccountReport31 rpt) {
        getRpt().add(rpt);
        return this;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV10 addSplmtryData(SupplementaryData1 splmtryData) {
