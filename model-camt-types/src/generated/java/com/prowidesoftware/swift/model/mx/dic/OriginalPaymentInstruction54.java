...
@XmlType(name = "OriginalPaymentInstruction54", propOrder = {
    "orgnlPmtInfCxlId",
    "rslvdCase",
    "orgnlPmtInfId",
    "orgnlGrpInf",
...
public class OriginalPaymentInstruction54 {
    ...
    protected List<PaymentTransaction175> txInfAndSts;
     ...
     *     
     */
    public OriginalPaymentInstruction54 setOrgnlPmtInfCxlId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction54 setRslvdCase(Case6 value) {
     ...
     *     
     */
    public OriginalPaymentInstruction54 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction54 setOrgnlGrpInf(OriginalGroupInformation33 value) {
     ...
     *     
     */
    public OriginalPaymentInstruction54 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction54 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction54 setPmtInfCxlSts(GroupCancellationStatus1Code value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction175 }
     * 
     * 
     * @return
     *     The value of the txInfAndSts property.
     */
    public List<PaymentTransaction175> getTxInfAndSts() {
        if (txInfAndSts == null) {
     ...
     * 
     */
    public OriginalPaymentInstruction54 addCxlStsRsnInf(CancellationStatusReason5 cxlStsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction54 addNbOfTxsPerCxlSts(NumberOfCancellationsPerStatus1 nbOfTxsPerCxlSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction54 addTxInfAndSts(PaymentTransaction175 txInfAndSts) {
