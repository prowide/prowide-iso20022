...
@XmlType(name = "ModifyTransactionV10", propOrder = {
    "msgHdr",
    "mod",
    "splmtryData"
})
public class ModifyTransactionV10 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader1 msgHdr;
    @XmlElement(name = "Mod", required = true)
    protected List<TransactionModification7> mod;
     ...
     *     
     */
    public ModifyTransactionV10 setMsgHdr(MessageHeader1 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * {@link TransactionModification7 }
     * 
     * 
     */
    public List<TransactionModification7> getMod() {
        if (mod == null) {
            mod = new ArrayList<TransactionModification7>();
        }
        return this.mod;
    }
     ...
     * 
     */
    public ModifyTransactionV10 addMod(TransactionModification7 mod) {
        getMod().add(mod);
        return this;
    }
     ...
     * 
     */
    public ModifyTransactionV10 addSplmtryData(SupplementaryData1 splmtryData) {
