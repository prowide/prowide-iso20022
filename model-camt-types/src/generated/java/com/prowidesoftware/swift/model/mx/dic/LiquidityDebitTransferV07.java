...
@XmlType(name = "LiquidityDebitTransferV07", propOrder = {
    "msgHdr",
    "lqdtyDbtTrf",
    "splmtryData"
})
public class LiquidityDebitTransferV07 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader1 msgHdr;
    @XmlElement(name = "LqdtyDbtTrf", required = true)
    protected LiquidityDebitTransfer4 lqdtyDbtTrf;
     ...
     *     
     */
    public LiquidityDebitTransferV07 setMsgHdr(MessageHeader1 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link LiquidityDebitTransfer4 }
     *     
     */
    public LiquidityDebitTransfer4 getLqdtyDbtTrf() {
        return lqdtyDbtTrf;
    }
     ...
     *     
     */
    public LiquidityDebitTransferV07 setLqdtyDbtTrf(LiquidityDebitTransfer4 value) {
     ...
     * 
     */
    public LiquidityDebitTransferV07 addSplmtryData(SupplementaryData1 splmtryData) {
