...
@XmlType(name = "BusinessDay5", propOrder = {
    "sysId",
    "bizDayOrErr"
})
public class BusinessDay5 {
    ...
    protected BusinessDayReportOrError6Choice bizDayOrErr;
     ...
     * @return
     *     possible object is
     *     {@link BusinessDayReportOrError6Choice }
     *     
     */
    public BusinessDayReportOrError6Choice getBizDayOrErr() {
        return bizDayOrErr;
    }
     ...
     *     
     */
    public BusinessDay5 setBizDayOrErr(BusinessDayReportOrError6Choice value) {
     ...
     * 
     */
    public BusinessDay5 addSysId(SystemIdentification2Choice sysId) {
        getSysId().add(sysId);
        return this;
    }
