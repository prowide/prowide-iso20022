...
@XmlType(name = "BankToCustomerAccountReportV12", propOrder = {
    "grpHdr",
    "rpt",
    "splmtryData"
})
public class BankToCustomerAccountReportV12 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader116 grpHdr;
    @XmlElement(name = "Rpt", required = true)
    protected List<AccountReport33> rpt;
     ...
     *     
     */
    public BankToCustomerAccountReportV12 setGrpHdr(GroupHeader116 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountReport33 }
     * 
     * 
     */
    public List<AccountReport33> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<AccountReport33>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV12 addRpt(AccountReport33 rpt) {
        getRpt().add(rpt);
        return this;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV12 addSplmtryData(SupplementaryData1 splmtryData) {
