 ...
 * The processing of a CustomerPaymentCancellationRequest message case may lead to an InvestigationRequest message sent to the creditor by its account servicing institution.
...
@XmlType(name = "CustomerPaymentCancellationRequestV13", propOrder = {
    "assgnmt",
    "_case",
    "ctrlData",
    "undrlyg",
...
public class CustomerPaymentCancellationRequestV13 {
    ...
    protected List<UnderlyingTransaction37> undrlyg;
     ...
     *     
     */
    public CustomerPaymentCancellationRequestV13 setAssgnmt(CaseAssignment6 value) {
        this.assgnmt = value;
        return this;
    }
     ...
     *     
     */
    public CustomerPaymentCancellationRequestV13 setCase(Case6 value) {
        this._case = value;
        return this;
    }
     ...
     *     
     */
    public CustomerPaymentCancellationRequestV13 setCtrlData(ControlData1 value) {
        this.ctrlData = value;
        return this;
    }
     ...
     * {@link UnderlyingTransaction37 }
     * 
     * 
     * @return
     *     The value of the undrlyg property.
     */
    public List<UnderlyingTransaction37> getUndrlyg() {
        if (undrlyg == null) {
     ...
     * 
     */
    public CustomerPaymentCancellationRequestV13 addUndrlyg(UnderlyingTransaction37 undrlyg) {
     ...
     * 
     */
    public CustomerPaymentCancellationRequestV13 addSplmtryData(SupplementaryData1 splmtryData) {
