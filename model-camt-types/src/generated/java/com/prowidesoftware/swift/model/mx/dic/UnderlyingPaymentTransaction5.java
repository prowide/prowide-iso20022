...
@XmlType(name = "UnderlyingPaymentTransaction5", propOrder = {
    "orgnlGrpInf",
    "orgnlInstrId",
    "orgnlEndToEndId",
    "orgnlTxId",
...
public class UnderlyingPaymentTransaction5 {
     ...
     *     
     */
    public UnderlyingPaymentTransaction5 setOrgnlGrpInf(UnderlyingGroupInformation1 value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction5 setOrgnlInstrId(String value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction5 setOrgnlEndToEndId(String value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction5 setOrgnlTxId(String value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction5 setOrgnlUETR(String value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction5 setOrgnlIntrBkSttlmAmt(ActiveOrHistoricCurrencyAndAmount value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction5 setOrgnlIntrBkSttlmDt(LocalDate value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction5 setOrgnlTxRef(OriginalTransactionReference31 value) {
