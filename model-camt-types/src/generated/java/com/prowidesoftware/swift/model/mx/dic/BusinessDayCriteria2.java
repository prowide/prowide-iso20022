...
@XmlType(name = "BusinessDayCriteria2", propOrder = {
    "newQryNm",
    "schCrit",
    "rtrCrit"
})
public class BusinessDayCriteria2 {
    ...
    protected List<BusinessDaySearchCriteria2> schCrit;
     ...
     *     
     */
    public BusinessDayCriteria2 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
     ...
     * {@link BusinessDaySearchCriteria2 }
     * 
     * 
     */
    public List<BusinessDaySearchCriteria2> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<BusinessDaySearchCriteria2>();
        }
        return this.schCrit;
    }
     ...
     *     
     */
    public BusinessDayCriteria2 setRtrCrit(BusinessDayReturnCriteria2 value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public BusinessDayCriteria2 addSchCrit(BusinessDaySearchCriteria2 schCrit) {
