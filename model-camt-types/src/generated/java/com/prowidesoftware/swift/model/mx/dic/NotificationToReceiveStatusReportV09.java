...
@XmlType(name = "NotificationToReceiveStatusReportV09", propOrder = {
    "grpHdr",
    "orgnlNtfctnAndSts",
    "splmtryData"
})
public class NotificationToReceiveStatusReportV09 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader121 grpHdr;
    @XmlElement(name = "OrgnlNtfctnAndSts", required = true)
    protected OriginalNotification17 orgnlNtfctnAndSts;
     ...
     *     
     */
    public NotificationToReceiveStatusReportV09 setGrpHdr(GroupHeader121 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link OriginalNotification17 }
     *     
     */
    public OriginalNotification17 getOrgnlNtfctnAndSts() {
     ...
     *     
     */
    public NotificationToReceiveStatusReportV09 setOrgnlNtfctnAndSts(OriginalNotification17 value) {
     ...
     * 
     */
    public NotificationToReceiveStatusReportV09 addSplmtryData(SupplementaryData1 splmtryData) {
