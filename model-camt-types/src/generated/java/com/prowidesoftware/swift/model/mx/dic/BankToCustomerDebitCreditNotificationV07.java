...
@XmlType(name = "BankToCustomerDebitCreditNotificationV07", propOrder = {
    "grpHdr",
    "ntfctn",
    "splmtryData"
})
public class BankToCustomerDebitCreditNotificationV07 {
    ...
    protected List<AccountNotification15> ntfctn;
     ...
     *     
     */
    public BankToCustomerDebitCreditNotificationV07 setGrpHdr(GroupHeader73 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountNotification15 }
     * 
     * 
     */
    public List<AccountNotification15> getNtfctn() {
        if (ntfctn == null) {
            ntfctn = new ArrayList<AccountNotification15>();
        }
        return this.ntfctn;
    }
     ...
     * 
     */
    public BankToCustomerDebitCreditNotificationV07 addNtfctn(AccountNotification15 ntfctn) {
     ...
     * 
     */
    public BankToCustomerDebitCreditNotificationV07 addSplmtryData(SupplementaryData1 splmtryData) {
