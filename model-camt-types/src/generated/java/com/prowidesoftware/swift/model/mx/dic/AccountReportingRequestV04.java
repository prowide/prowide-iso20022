...
@XmlType(name = "AccountReportingRequestV04", propOrder = {
    "grpHdr",
    "rptgReq",
    "splmtryData"
})
public class AccountReportingRequestV04 {
    ...
    protected GroupHeader76 grpHdr;
    @XmlElement(name = "RptgReq", required = true)
    protected List<ReportingRequest4> rptgReq;
     ...
     *     
     */
    public GroupHeader76 getGrpHdr() {
        return grpHdr;
    }
     ...
     *     
     */
    public AccountReportingRequestV04 setGrpHdr(GroupHeader76 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link ReportingRequest4 }
     * 
     * 
     */
    public List<ReportingRequest4> getRptgReq() {
        if (rptgReq == null) {
            rptgReq = new ArrayList<ReportingRequest4>();
        }
        return this.rptgReq;
    }
     ...
     * 
     */
    public AccountReportingRequestV04 addRptgReq(ReportingRequest4 rptgReq) {
     ...
     * 
     */
    public AccountReportingRequestV04 addSplmtryData(SupplementaryData1 splmtryData) {
