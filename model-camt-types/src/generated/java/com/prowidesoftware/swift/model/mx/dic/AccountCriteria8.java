...
@XmlType(name = "AccountCriteria8", propOrder = {
    "newQryNm",
    "schCrit",
    "rtrCrit"
})
public class AccountCriteria8 {

    @XmlElement(name = "NewQryNm")
    protected String newQryNm;
    @XmlElement(name = "SchCrit")
    protected List<CashAccountSearchCriteria8> schCrit;
     ...
     *     
     */
    public AccountCriteria8 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
     ...
     * {@link CashAccountSearchCriteria8 }
     * 
     * 
     */
    public List<CashAccountSearchCriteria8> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<CashAccountSearchCriteria8>();
        }
        return this.schCrit;
    }
     ...
     *     
     */
    public AccountCriteria8 setRtrCrit(CashAccountReturnCriteria5 value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public AccountCriteria8 addSchCrit(CashAccountSearchCriteria8 schCrit) {
