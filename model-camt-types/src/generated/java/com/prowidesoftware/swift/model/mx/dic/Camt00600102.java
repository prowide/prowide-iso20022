...
@XmlType(name = "camt.006.001.02", propOrder = {
    "msgId",
    "bizQryRef",
    "bizRpt",
    "oprlErr"
})
public class Camt00600102 {
    ...
    protected Transactions2 bizRpt;
     ...
     *     
     */
    public Camt00600102 setMsgId(MessageIdentification value) {
        this.msgId = value;
        return this;
    }
     ...
     *     
     */
    public Camt00600102 setBizQryRef(QueryReference value) {
     ...
     *     
     */
    public Transactions2 getBizRpt() {
        return bizRpt;
    }
     ...
     *     
     */
    public Camt00600102 setBizRpt(Transactions2 value) {
        this.bizRpt = value;
        return this;
    }
     ...
     *     
     */
    public Camt00600102 setOprlErr(ErrorHandling2 value) {
        this.oprlErr = value;
        return this;
    }
