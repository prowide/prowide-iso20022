...
public class OriginalPaymentInstruction17 {
     ...
     *     
     */
    public OriginalPaymentInstruction17 setOrgnlPmtInfCxlId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction17 setRslvdCase(Case3 value) {
     ...
     *     
     */
    public OriginalPaymentInstruction17 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction17 setOrgnlGrpInf(OriginalGroupInformation3 value) {
     ...
     *     
     */
    public OriginalPaymentInstruction17 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction17 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction17 setPmtInfCxlSts(GroupCancellationStatus1Code value) {
     ...
     * 
     */
    public OriginalPaymentInstruction17 addCxlStsRsnInf(CancellationStatusReason2 cxlStsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction17 addNbOfTxsPerCxlSts(NumberOfCancellationsPerStatus1 nbOfTxsPerCxlSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction17 addTxInfAndSts(PaymentTransaction66 txInfAndSts) {
