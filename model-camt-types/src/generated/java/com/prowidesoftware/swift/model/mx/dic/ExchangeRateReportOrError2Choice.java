...
@XmlType(name = "ExchangeRateReportOrError2Choice", propOrder = {
    "bizErr",
    "ccyXchg"
})
public class ExchangeRateReportOrError2Choice {
    ...
    protected CurrencyExchange7 ccyXchg;
     ...
     * @return
     *     possible object is
     *     {@link CurrencyExchange7 }
     *     
     */
    public CurrencyExchange7 getCcyXchg() {
        return ccyXchg;
    }
     ...
     *     
     */
    public ExchangeRateReportOrError2Choice setCcyXchg(CurrencyExchange7 value) {
        this.ccyXchg = value;
        return this;
    }
     ...
     * 
     */
    public ExchangeRateReportOrError2Choice addBizErr(ErrorHandling3 bizErr) {
