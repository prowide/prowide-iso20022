...
@XmlType(name = "ReturnMemberV05", propOrder = {
    "msgHdr",
    "rptOrErr",
    "splmtryData"
})
public class ReturnMemberV05 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader7 msgHdr;
    @XmlElement(name = "RptOrErr", required = true)
    protected MemberReportOrError7Choice rptOrErr;
     ...
     *     
     */
    public ReturnMemberV05 setMsgHdr(MessageHeader7 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link MemberReportOrError7Choice }
     *     
     */
    public MemberReportOrError7Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public ReturnMemberV05 setRptOrErr(MemberReportOrError7Choice value) {
        this.rptOrErr = value;
        return this;
    }
     ...
     * 
     */
    public ReturnMemberV05 addSplmtryData(SupplementaryData1 splmtryData) {
