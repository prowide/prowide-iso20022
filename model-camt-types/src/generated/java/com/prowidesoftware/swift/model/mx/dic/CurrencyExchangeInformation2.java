...
@XmlType(name = "CurrencyExchangeInformation2", propOrder = {
    "ccyXchgRpt"
})
public class CurrencyExchangeInformation2 {

    @XmlElement(name = "CcyXchgRpt", required = true)
    protected List<CurrencyExchangeReport2> ccyXchgRpt;
     ...
     * {@link CurrencyExchangeReport2 }
     * 
     * 
     */
    public List<CurrencyExchangeReport2> getCcyXchgRpt() {
        if (ccyXchgRpt == null) {
            ccyXchgRpt = new ArrayList<CurrencyExchangeReport2>();
        }
     ...
     * 
     */
    public CurrencyExchangeInformation2 addCcyXchgRpt(CurrencyExchangeReport2 ccyXchgRpt) {
