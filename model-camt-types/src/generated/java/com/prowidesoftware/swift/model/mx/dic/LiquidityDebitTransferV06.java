...
@XmlType(name = "LiquidityDebitTransferV06", propOrder = {
    "msgHdr",
    "lqdtyDbtTrf",
    "splmtryData"
})
public class LiquidityDebitTransferV06 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader1 msgHdr;
    @XmlElement(name = "LqdtyDbtTrf", required = true)
    protected LiquidityDebitTransfer3 lqdtyDbtTrf;
     ...
     *     
     */
    public LiquidityDebitTransferV06 setMsgHdr(MessageHeader1 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link LiquidityDebitTransfer3 }
     *     
     */
    public LiquidityDebitTransfer3 getLqdtyDbtTrf() {
        return lqdtyDbtTrf;
    }
     ...
     *     
     */
    public LiquidityDebitTransferV06 setLqdtyDbtTrf(LiquidityDebitTransfer3 value) {
     ...
     * 
     */
    public LiquidityDebitTransferV06 addSplmtryData(SupplementaryData1 splmtryData) {
