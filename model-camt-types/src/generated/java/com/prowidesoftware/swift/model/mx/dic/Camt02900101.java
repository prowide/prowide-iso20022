...
@XmlType(name = "camt.029.001.01", propOrder = {
    "assgnmt",
    "rslvdCase",
    "sts",
    "crrctnTx"
...
public class Camt02900101 {
    ...
    @XmlElement(name = "Sts")
    protected InvestigationStatusChoice sts;
    @XmlElement(name = "CrrctnTx")
    protected PaymentInstructionExtract crrctnTx;
     ...
     *     
     */
    public Camt02900101 setAssgnmt(CaseAssignment value) {
        this.assgnmt = value;
        return this;
    }
     ...
     *     
     */
    public Camt02900101 setRslvdCase(Case value) {
     ...
     * @return
     *     possible object is
     *     {@link InvestigationStatusChoice }
     *     
     */
    public InvestigationStatusChoice getSts() {
        return sts;
    }
     ...
     *     
     */
    public Camt02900101 setSts(InvestigationStatusChoice value) {
        this.sts = value;
        return this;
    }
     ...
     *     
     */
    public PaymentInstructionExtract getCrrctnTx() {
        return crrctnTx;
    }
     ...
     *     
     */
    public Camt02900101 setCrrctnTx(PaymentInstructionExtract value) {
        this.crrctnTx = value;
        return this;
    }
