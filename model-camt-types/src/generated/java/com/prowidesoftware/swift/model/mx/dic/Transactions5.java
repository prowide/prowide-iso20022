...
@XmlType(name = "Transactions5", propOrder = {
    "pmtCmonInf",
    "txsSummry",
    "txRpt"
})
public class Transactions5 {
     ...
     *     
     */
    public PaymentCommon1 getPmtCmonInf() {
        return pmtCmonInf;
    }
     ...
     *     
     */
    public Transactions5 setPmtCmonInf(PaymentCommon1 value) {
     ...
     *     
     */
    public Transactions5 setTxsSummry(NumberAndSumOfTransactions2 value) {
     ...
     * {@link TransactionReport1 }
     * 
     * 
     */
    public List<TransactionReport1> getTxRpt() {
        if (txRpt == null) {
            txRpt = new ArrayList<TransactionReport1>();
        }
        return this.txRpt;
    }
     ...
     * 
     */
    public Transactions5 addTxRpt(TransactionReport1 txRpt) {
        getTxRpt().add(txRpt);
        return this;
    }
