...
@XmlType(name = "EntryDetails16", propOrder = {
    "btch",
    "txDtls"
})
public class EntryDetails16 {

    @XmlElement(name = "Btch")
    protected BatchInformation2 btch;
    @XmlElement(name = "TxDtls")
    protected List<EntryTransaction16> txDtls;
     ...
     *     
     */
    public EntryDetails16 setBtch(BatchInformation2 value) {
        this.btch = value;
        return this;
    }
     ...
     * {@link EntryTransaction16 }
     * 
     * 
     * @return
     *     The value of the txDtls property.
     */
    public List<EntryTransaction16> getTxDtls() {
        if (txDtls == null) {
     ...
     * 
     */
    public EntryDetails16 addTxDtls(EntryTransaction16 txDtls) {
