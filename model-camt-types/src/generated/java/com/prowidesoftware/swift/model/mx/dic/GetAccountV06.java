...
@XmlType(name = "GetAccountV06", propOrder = {
    "msgHdr",
    "acctQryDef",
    "splmtryData"
})
public class GetAccountV06 {
    ...
    protected AccountQuery2 acctQryDef;
     ...
     *     
     */
    public GetAccountV06 setMsgHdr(MessageHeader9 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     *     
     */
    public AccountQuery2 getAcctQryDef() {
        return acctQryDef;
    }
     ...
     *     
     */
    public GetAccountV06 setAcctQryDef(AccountQuery2 value) {
     ...
     * 
     */
    public GetAccountV06 addSplmtryData(SupplementaryData1 splmtryData) {
