...
@XmlType(name = "UnderlyingTransaction37", propOrder = {
    "orgnlGrpInfAndCxl",
    "orgnlPmtInfAndCxl"
})
public class UnderlyingTransaction37 {

    @XmlElement(name = "OrgnlGrpInfAndCxl")
    protected OriginalGroupHeader21 orgnlGrpInfAndCxl;
    @XmlElement(name = "OrgnlPmtInfAndCxl")
    protected List<OriginalPaymentInstruction55> orgnlPmtInfAndCxl;
     ...
     *     
     */
    public UnderlyingTransaction37 setOrgnlGrpInfAndCxl(OriginalGroupHeader21 value) {
     ...
     * {@link OriginalPaymentInstruction55 }
     * 
     * 
     * @return
     *     The value of the orgnlPmtInfAndCxl property.
     */
    public List<OriginalPaymentInstruction55> getOrgnlPmtInfAndCxl() {
     ...
     * 
     */
    public UnderlyingTransaction37 addOrgnlPmtInfAndCxl(OriginalPaymentInstruction55 orgnlPmtInfAndCxl) {
