...
@XmlType(name = "ExchangeRateReportOrError1Choice", propOrder = {
    "ccyXchgRpt",
    "oprlErr"
})
public class ExchangeRateReportOrError1Choice {
    ...
    protected List<CurrencyExchangeReport3> ccyXchgRpt;
     ...
     * {@link CurrencyExchangeReport3 }
     * 
     * 
     */
    public List<CurrencyExchangeReport3> getCcyXchgRpt() {
        if (ccyXchgRpt == null) {
            ccyXchgRpt = new ArrayList<CurrencyExchangeReport3>();
        }
     ...
     * 
     */
    public ExchangeRateReportOrError1Choice addCcyXchgRpt(CurrencyExchangeReport3 ccyXchgRpt) {
     ...
     * 
     */
    public ExchangeRateReportOrError1Choice addOprlErr(ErrorHandling3 oprlErr) {
