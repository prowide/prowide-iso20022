...
@XmlType(name = "CashAccountReturnCriteria4", propOrder = {
    "nmInd",
    "ccyInd",
    "tpInd",
    "mulLmtInd",
...
public class CashAccountReturnCriteria4 {
    ...
    protected CashBalanceReturnCriteria1 mulBalRtrCrit;
    @XmlElement(name = "BilLmtInd")
    protected Boolean bilLmtInd;
    @XmlElement(name = "BilBalRtrCrit")
    protected CashBalanceReturnCriteria1 bilBalRtrCrit;
     ...
     *     
     */
    public CashAccountReturnCriteria4 setNmInd(Boolean value) {
        this.nmInd = value;
        return this;
    }
     ...
     *     
     */
    public CashAccountReturnCriteria4 setCcyInd(Boolean value) {
        this.ccyInd = value;
        return this;
    }
     ...
     *     
     */
    public CashAccountReturnCriteria4 setTpInd(Boolean value) {
        this.tpInd = value;
        return this;
    }
     ...
     *     
     */
    public CashAccountReturnCriteria4 setMulLmtInd(Boolean value) {
     ...
     * @return
     *     possible object is
     *     {@link CashBalanceReturnCriteria1 }
     *     
     */
    public CashBalanceReturnCriteria1 getMulBalRtrCrit() {
     ...
     *     
     */
    public CashAccountReturnCriteria4 setMulBalRtrCrit(CashBalanceReturnCriteria1 value) {
     ...
     *     
     */
    public CashAccountReturnCriteria4 setBilLmtInd(Boolean value) {
     ...
     *     
     */
    public CashBalanceReturnCriteria1 getBilBalRtrCrit() {
     ...
     *     
     */
    public CashAccountReturnCriteria4 setBilBalRtrCrit(CashBalanceReturnCriteria1 value) {
     ...
     *     
     */
    public CashAccountReturnCriteria4 setStgOrdrInd(Boolean value) {
     ...
     *     
     */
    public CashAccountReturnCriteria4 setAcctOwnrInd(Boolean value) {
     ...
     *     
     */
    public CashAccountReturnCriteria4 setAcctSvcrInd(Boolean value) {
