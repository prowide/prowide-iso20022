...
@XmlType(name = "BankToCustomerStatementV14", propOrder = {
    "grpHdr",
    "stmt",
    "splmtryData"
})
public class BankToCustomerStatementV14 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader116 grpHdr;
    @XmlElement(name = "Stmt", required = true)
    protected List<AccountStatement15> stmt;
     ...
     *     
     */
    public BankToCustomerStatementV14 setGrpHdr(GroupHeader116 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountStatement15 }
     * 
     * 
     * @return
     *     The value of the stmt property.
     */
    public List<AccountStatement15> getStmt() {
        if (stmt == null) {
            stmt = new ArrayList<>();
        }
        return this.stmt;
     ...
     * 
     */
    public BankToCustomerStatementV14 addStmt(AccountStatement15 stmt) {
        getStmt().add(stmt);
        return this;
    }
     ...
     * 
     */
    public BankToCustomerStatementV14 addSplmtryData(SupplementaryData1 splmtryData) {
