...
@XmlType(name = "TransactionReportOrError7Choice", propOrder = {
    "bizRpt",
    "oprlErr"
})
public class TransactionReportOrError7Choice {

    @XmlElement(name = "BizRpt")
    protected Transactions11 bizRpt;
     ...
     *     
     */
    public Transactions11 getBizRpt() {
        return bizRpt;
    }
     ...
     *     
     */
    public TransactionReportOrError7Choice setBizRpt(Transactions11 value) {
        this.bizRpt = value;
        return this;
    }
     ...
     * 
     */
    public TransactionReportOrError7Choice addOprlErr(ErrorHandling5 oprlErr) {
