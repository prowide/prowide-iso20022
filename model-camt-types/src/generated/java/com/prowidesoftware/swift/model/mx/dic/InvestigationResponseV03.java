...
@XmlType(name = "InvestigationResponseV03", propOrder = {
    "invstgtnRspn",
    "orgnlInvstgtnReq",
    "splmtryData"
})
public class InvestigationResponseV03 {

    @XmlElement(name = "InvstgtnRspn", required = true)
    protected InvestigationResponse23 invstgtnRspn;
    @XmlElement(name = "OrgnlInvstgtnReq", required = true)
    protected InvestigationRequest50 orgnlInvstgtnReq;
     ...
     * @return
     *     possible object is
     *     {@link InvestigationResponse23 }
     *     
     */
    public InvestigationResponse23 getInvstgtnRspn() {
        return invstgtnRspn;
    }
     ...
     *     
     */
    public InvestigationResponseV03 setInvstgtnRspn(InvestigationResponse23 value) {
     ...
     * @return
     *     possible object is
     *     {@link InvestigationRequest50 }
     *     
     */
    public InvestigationRequest50 getOrgnlInvstgtnReq() {
     ...
     *     
     */
    public InvestigationResponseV03 setOrgnlInvstgtnReq(InvestigationRequest50 value) {
     ...
     * 
     */
    public InvestigationResponseV03 addSplmtryData(SupplementaryData1 splmtryData) {
