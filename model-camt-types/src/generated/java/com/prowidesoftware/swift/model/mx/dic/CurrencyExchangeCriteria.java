...
@XmlType(name = "CurrencyExchangeCriteria", propOrder = {
    "newQryNm",
    "schCrit"
})
public class CurrencyExchangeCriteria {
    ...
    protected List<CurrencyExchangeSearchCriteria> schCrit;
     ...
     *     
     */
    public CurrencyExchangeCriteria setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
     ...
     * {@link CurrencyExchangeSearchCriteria }
     * 
     * 
     */
    public List<CurrencyExchangeSearchCriteria> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<CurrencyExchangeSearchCriteria>();
        }
        return this.schCrit;
    }
     ...
     * 
     */
    public CurrencyExchangeCriteria addSchCrit(CurrencyExchangeSearchCriteria schCrit) {
