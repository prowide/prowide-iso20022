...
@XmlType(name = "BankToCustomerAccountReportV04", propOrder = {
    "grpHdr",
    "rpt",
    "splmtryData"
})
public class BankToCustomerAccountReportV04 {
    ...
    protected List<AccountReport16> rpt;
     ...
     *     
     */
    public BankToCustomerAccountReportV04 setGrpHdr(GroupHeader58 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountReport16 }
     * 
     * 
     */
    public List<AccountReport16> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<AccountReport16>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV04 addRpt(AccountReport16 rpt) {
        getRpt().add(rpt);
        return this;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV04 addSplmtryData(SupplementaryData1 splmtryData) {
