...
@XmlType(name = "TransactionOrError1Choice", propOrder = {
    "tx",
    "bizErr"
})
public class TransactionOrError1Choice {
     ...
     *     
     */
    public TransactionOrError1Choice setTx(Transaction24 value) {
        this.tx = value;
        return this;
    }
     ...
     * 
     */
    public TransactionOrError1Choice addBizErr(ErrorHandling3 bizErr) {
