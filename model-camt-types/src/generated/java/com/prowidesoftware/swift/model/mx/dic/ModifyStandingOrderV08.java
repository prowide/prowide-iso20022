...
@XmlType(name = "ModifyStandingOrderV08", propOrder = {
    "msgHdr",
    "stgOrdrId",
    "newStgOrdrValSet",
    "splmtryData"
})
public class ModifyStandingOrderV08 {
    ...
    protected StandingOrder10 newStgOrdrValSet;
     ...
     *     
     */
    public ModifyStandingOrderV08 setMsgHdr(MessageHeader1 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     *     
     */
    public ModifyStandingOrderV08 setStgOrdrId(StandingOrderIdentification8 value) {
     ...
     *     
     */
    public StandingOrder10 getNewStgOrdrValSet() {
     ...
     *     
     */
    public ModifyStandingOrderV08 setNewStgOrdrValSet(StandingOrder10 value) {
     ...
     * 
     */
    public ModifyStandingOrderV08 addSplmtryData(SupplementaryData1 splmtryData) {
