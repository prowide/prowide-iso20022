...
@XmlType(name = "EntryDetails6", propOrder = {
    "btch",
    "txDtls"
})
public class EntryDetails6 {
    ...
    protected List<EntryTransaction7> txDtls;
     ...
     *     
     */
    public EntryDetails6 setBtch(BatchInformation2 value) {
        this.btch = value;
        return this;
    }
     ...
     * {@link EntryTransaction7 }
     * 
     * 
     */
    public List<EntryTransaction7> getTxDtls() {
        if (txDtls == null) {
            txDtls = new ArrayList<EntryTransaction7>();
        }
        return this.txDtls;
    }
     ...
     * 
     */
    public EntryDetails6 addTxDtls(EntryTransaction7 txDtls) {
