...
@XmlType(name = "ReturnTransactionV10", propOrder = {
    "msgHdr",
    "rptOrErr",
    "splmtryData"
})
public class ReturnTransactionV10 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader8 msgHdr;
    @XmlElement(name = "RptOrErr", required = true)
    protected TransactionReportOrError6Choice rptOrErr;
     ...
     *     
     */
    public ReturnTransactionV10 setMsgHdr(MessageHeader8 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link TransactionReportOrError6Choice }
     *     
     */
    public TransactionReportOrError6Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public ReturnTransactionV10 setRptOrErr(TransactionReportOrError6Choice value) {
        this.rptOrErr = value;
        return this;
    }
     ...
     * 
     */
    public ReturnTransactionV10 addSplmtryData(SupplementaryData1 splmtryData) {
