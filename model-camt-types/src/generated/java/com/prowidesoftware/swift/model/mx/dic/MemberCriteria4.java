...
public class MemberCriteria4 {
     ...
     *     
     */
    public MemberCriteria4 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
    ...
    public List<MemberSearchCriteria4> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<MemberSearchCriteria4>();
        }
        return this.schCrit;
    }
     ...
     *     
     */
    public MemberCriteria4 setRtrCrit(MemberReturnCriteria1 value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public MemberCriteria4 addSchCrit(MemberSearchCriteria4 schCrit) {
