...
@XmlType(name = "AccountOrOperationalError4Choice", propOrder = {
    "acctRpt",
    "oprlErr"
})
public class AccountOrOperationalError4Choice {

    @XmlElement(name = "AcctRpt")
    protected List<AccountReport24> acctRpt;
     ...
     * 
     */
    public AccountOrOperationalError4Choice addAcctRpt(AccountReport24 acctRpt) {
     ...
     * 
     */
    public AccountOrOperationalError4Choice addOprlErr(ErrorHandling5 oprlErr) {
