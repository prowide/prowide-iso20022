...
@XmlType(name = "Receipt7", propOrder = {
    "orgnlMsgId",
    "orgnlPmtId",
    "reqHdlg"
})
public class Receipt7 {
    ...
    protected List<RequestHandling4> reqHdlg;
     ...
     *     
     */
    public Receipt7 setOrgnlMsgId(OriginalMessageAndIssuer1 value) {
     ...
     *     
     */
    public Receipt7 setOrgnlPmtId(PaymentIdentification8Choice value) {
     ...
     * {@link RequestHandling4 }
     * 
     * 
     */
    public List<RequestHandling4> getReqHdlg() {
        if (reqHdlg == null) {
            reqHdlg = new ArrayList<RequestHandling4>();
        }
        return this.reqHdlg;
    }
     ...
     * 
     */
    public Receipt7 addReqHdlg(RequestHandling4 reqHdlg) {
