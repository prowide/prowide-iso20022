...
@XmlType(name = "OriginalNotification18", propOrder = {
    "orgnlMsgId",
    "orgnlCreDtTm",
    "orgnlNtfctnId",
    "ntfctnCxl",
...
public class OriginalNotification18 {
    ...
    protected List<OriginalNotificationReference16> orgnlNtfctnRef;
     ...
     *     
     */
    public OriginalNotification18 setOrgnlMsgId(String value) {
     ...
     *     
     */
    public OriginalNotification18 setOrgnlCreDtTm(OffsetDateTime value) {
     ...
     *     
     */
    public OriginalNotification18 setOrgnlNtfctnId(String value) {
     ...
     *     
     */
    public OriginalNotification18 setNtfctnCxl(Boolean value) {
     ...
     * {@link OriginalNotificationReference16 }
     * 
     * 
     * @return
     *     The value of the orgnlNtfctnRef property.
     */
    public List<OriginalNotificationReference16> getOrgnlNtfctnRef() {
     ...
     * 
     */
    public OriginalNotification18 addOrgnlNtfctnRef(OriginalNotificationReference16 orgnlNtfctnRef) {
