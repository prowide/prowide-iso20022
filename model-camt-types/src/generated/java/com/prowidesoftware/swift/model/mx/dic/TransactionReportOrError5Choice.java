...
@XmlType(name = "TransactionReportOrError5Choice", propOrder = {
    "bizRpt",
    "oprlErr"
})
public class TransactionReportOrError5Choice {

    @XmlElement(name = "BizRpt")
    protected Transactions9 bizRpt;
     ...
     *     
     */
    public Transactions9 getBizRpt() {
        return bizRpt;
    }
     ...
     *     
     */
    public TransactionReportOrError5Choice setBizRpt(Transactions9 value) {
        this.bizRpt = value;
        return this;
    }
     ...
     * 
     */
    public TransactionReportOrError5Choice addOprlErr(ErrorHandling5 oprlErr) {
