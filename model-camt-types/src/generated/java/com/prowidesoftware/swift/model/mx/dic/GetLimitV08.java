...
@XmlType(name = "GetLimitV08", propOrder = {
    "msgHdr",
    "lmtQryDef",
    "splmtryData"
})
public class GetLimitV08 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader9 msgHdr;
    @XmlElement(name = "LmtQryDef")
    protected LimitQuery5 lmtQryDef;
     ...
     *     
     */
    public GetLimitV08 setMsgHdr(MessageHeader9 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     *     
     */
    public LimitQuery5 getLmtQryDef() {
        return lmtQryDef;
    }
     ...
     *     
     */
    public GetLimitV08 setLmtQryDef(LimitQuery5 value) {
     ...
     * 
     */
    public GetLimitV08 addSplmtryData(SupplementaryData1 splmtryData) {
