...
@XmlType(name = "CurrencyExchangeReport4", propOrder = {
    "ccyRef",
    "ccyXchgOrErr"
})
public class CurrencyExchangeReport4 {

    @XmlElement(name = "CcyRef", required = true)
    protected CurrencySourceTarget1 ccyRef;
    @XmlElement(name = "CcyXchgOrErr", required = true)
    protected ExchangeRateReportOrError4Choice ccyXchgOrErr;
     ...
     *     
     */
    public CurrencyExchangeReport4 setCcyRef(CurrencySourceTarget1 value) {
        this.ccyRef = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link ExchangeRateReportOrError4Choice }
     *     
     */
    public ExchangeRateReportOrError4Choice getCcyXchgOrErr() {
        return ccyXchgOrErr;
    }
     ...
     *     
     */
    public CurrencyExchangeReport4 setCcyXchgOrErr(ExchangeRateReportOrError4Choice value) {
