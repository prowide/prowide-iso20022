...
public class UnderlyingTransaction25 {
    ...
    protected List<OriginalPaymentInstruction35> orgnlPmtInfAndSts;
    @XmlElement(name = "TxInfAndSts")
    protected List<PaymentTransaction127> txInfAndSts;
     ...
     *     
     */
    public UnderlyingTransaction25 setOrgnlGrpInfAndSts(OriginalGroupHeader14 value) {
     ...
     * {@link OriginalPaymentInstruction35 }
     * 
     * 
     */
    public List<OriginalPaymentInstruction35> getOrgnlPmtInfAndSts() {
        if (orgnlPmtInfAndSts == null) {
            orgnlPmtInfAndSts = new ArrayList<OriginalPaymentInstruction35>();
        }
     ...
     * 
     */
    public List<PaymentTransaction127> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new ArrayList<PaymentTransaction127>();
        }
     ...
     * 
     */
    public UnderlyingTransaction25 addOrgnlPmtInfAndSts(OriginalPaymentInstruction35 orgnlPmtInfAndSts) {
     ...
     * 
     */
    public UnderlyingTransaction25 addTxInfAndSts(PaymentTransaction127 txInfAndSts) {
