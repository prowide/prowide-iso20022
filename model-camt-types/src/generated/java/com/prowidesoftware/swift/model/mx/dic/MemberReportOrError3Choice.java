...
@XmlType(name = "MemberReportOrError3Choice", propOrder = {
    "rpt",
    "oprlErr"
})
public class MemberReportOrError3Choice {
    ...
    @XmlElement(name = "Rpt")
    protected List<MemberReport4> rpt;
     ...
     * 
     */
    public List<MemberReport4> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<MemberReport4>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public MemberReportOrError3Choice addRpt(MemberReport4 rpt) {
        getRpt().add(rpt);
        return this;
    }
     ...
     * 
     */
    public MemberReportOrError3Choice addOprlErr(ErrorHandling3 oprlErr) {
