...
@XmlType(name = "OriginalNotification8", propOrder = {
    "orgnlMsgId",
    "orgnlCreDtTm",
    "orgnlNtfctnId",
    "ntfctnCxl",
...
public class OriginalNotification8 {
    ...
    protected List<OriginalNotificationReference6> orgnlNtfctnRef;
     ...
     *     
     */
    public OriginalNotification8 setOrgnlMsgId(String value) {
     ...
     *     
     */
    public OriginalNotification8 setOrgnlCreDtTm(OffsetDateTime value) {
     ...
     *     
     */
    public OriginalNotification8 setOrgnlNtfctnId(String value) {
     ...
     *     
     */
    public OriginalNotification8 setNtfctnCxl(Boolean value) {
     ...
     * {@link OriginalNotificationReference6 }
     * 
     * 
     * @return
     *     The value of the orgnlNtfctnRef property.
     */
    public List<OriginalNotificationReference6> getOrgnlNtfctnRef() {
     ...
     * 
     */
    public OriginalNotification8 addOrgnlNtfctnRef(OriginalNotificationReference6 orgnlNtfctnRef) {
