...
public class NetReportV02 {
     ...
     *     
     */
    public NetReportV02 setNetRptData(NetReportData2 value) {
     ...
     *     
     */
    public NetReportV02 setNetSvcPtcptId(PartyIdentification242Choice value) {
     ...
     *     
     */
    public NetReportV02 setNetSvcCtrPtyId(PartyIdentification242Choice value) {
    ...
    public List<NetObligation2> getNetOblgtn() {
        if (netOblgtn == null) {
            netOblgtn = new ArrayList<NetObligation2>();
        }
     ...
     * 
     */
    public NetReportV02 addNetOblgtn(NetObligation2 netOblgtn) {
     ...
     * 
     */
    public NetReportV02 addSplmtryData(SupplementaryData1 splmtryData) {
