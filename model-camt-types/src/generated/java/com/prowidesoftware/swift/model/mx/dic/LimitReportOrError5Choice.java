...
@XmlType(name = "LimitReportOrError5Choice", propOrder = {
    "bizRpt",
    "oprlErr"
})
public class LimitReportOrError5Choice {

    @XmlElement(name = "BizRpt")
    protected Limits8 bizRpt;
     ...
     *     
     */
    public LimitReportOrError5Choice setBizRpt(Limits8 value) {
        this.bizRpt = value;
        return this;
    }
     ...
     * 
     */
    public LimitReportOrError5Choice addOprlErr(ErrorHandling5 oprlErr) {
