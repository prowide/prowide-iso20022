...
/**
 * Scope
 * The Request For Duplicate Instruction message is sent by the case assignee to the case creator or case assigner.
 * This message is used to request a copy of the original payment instruction considered in the case.
 * Usage
 * The Request For Duplicate Instruction message:
 * - must be answered with a Duplicate instruction message
...
@XmlType(name = "camt.033.001.02", propOrder = {
    "assgnmt",
    "_case"
})
public class Camt03300102 {
     ...
     *     
     */
    public Camt03300102 setAssgnmt(CaseAssignment value) {
        this.assgnmt = value;
        return this;
    }
     ...
     *     
     */
    public Camt03300102 setCase(Case value) {
        this._case = value;
        return this;
    }
