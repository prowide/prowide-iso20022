...
@XmlType(name = "CashAccountEntrySearch5", propOrder = {
    "acctId",
    "ntryAmt",
    "ntryAmtCcy",
    "cdtDbtInd",
...
public class CashAccountEntrySearch5 {
     ...
     *     
     */
    public CashAccountEntrySearch5 setCdtDbtInd(CreditDebitCode value) {
     ...
     *     
     */
    public CashAccountEntrySearch5 setAcctOwnr(PartyIdentification125 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public CashAccountEntrySearch5 setAcctSvcr(BranchAndFinancialInstitutionIdentification5 value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     * 
     */
    public CashAccountEntrySearch5 addAcctId(AccountIdentificationSearchCriteria2Choice acctId) {
     ...
     * 
     */
    public CashAccountEntrySearch5 addNtryAmt(ActiveOrHistoricAmountRange2Choice ntryAmt) {
     ...
     * 
     */
    public CashAccountEntrySearch5 addNtryAmtCcy(String ntryAmtCcy) {
     ...
     * 
     */
    public CashAccountEntrySearch5 addNtrySts(EntryStatus1Code ntrySts) {
     ...
     * 
     */
    public CashAccountEntrySearch5 addNtryDt(DateAndDateTimeSearch3Choice ntryDt) {
