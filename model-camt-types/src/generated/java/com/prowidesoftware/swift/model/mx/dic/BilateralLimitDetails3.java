...
@XmlType(name = "BilateralLimitDetails3", propOrder = {
    "ctrPtyId",
    "lmtAmt",
    "cdtDbtInd",
    "bilBal"
...
public class BilateralLimitDetails3 {
    ...
    protected List<CashBalanceDetails7> bilBal;
     ...
     *     
     */
    public BilateralLimitDetails3 setCtrPtyId(MemberIdentificationChoice value) {
        this.ctrPtyId = value;
        return this;
    }
     ...
     *     
     */
    public BilateralLimitDetails3 setLmtAmt(AmountChoice value) {
        this.lmtAmt = value;
        return this;
    }
     ...
     *     
     */
    public BilateralLimitDetails3 setCdtDbtInd(CreditDebitCode value) {
     ...
     * {@link CashBalanceDetails7 }
     * 
     * 
     */
    public List<CashBalanceDetails7> getBilBal() {
        if (bilBal == null) {
            bilBal = new ArrayList<CashBalanceDetails7>();
        }
        return this.bilBal;
    }
     ...
     * 
     */
    public BilateralLimitDetails3 addBilBal(CashBalanceDetails7 bilBal) {
