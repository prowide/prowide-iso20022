...
@XmlType(name = "GeneralBusinessReport5", propOrder = {
    "bizInfRef",
    "gnlBizOrErr"
})
public class GeneralBusinessReport5 {
    ...
    protected GeneralBusinessOrError6Choice gnlBizOrErr;
     ...
     *     
     */
    public GeneralBusinessReport5 setBizInfRef(String value) {
     ...
     * @return
     *     possible object is
     *     {@link GeneralBusinessOrError6Choice }
     *     
     */
    public GeneralBusinessOrError6Choice getGnlBizOrErr() {
        return gnlBizOrErr;
    }
     ...
     *     
     */
    public GeneralBusinessReport5 setGnlBizOrErr(GeneralBusinessOrError6Choice value) {
