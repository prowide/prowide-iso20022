...
public class OriginalGroupHeader14 {
     ...
     *     
     */
    public OriginalGroupHeader14 setOrgnlGrpCxlId(String value) {
     ...
     *     
     */
    public OriginalGroupHeader14 setRslvdCase(Case5 value) {
     ...
     *     
     */
    public OriginalGroupHeader14 setOrgnlMsgId(String value) {
     ...
     *     
     */
    public OriginalGroupHeader14 setOrgnlMsgNmId(String value) {
     ...
     *     
     */
    public OriginalGroupHeader14 setOrgnlCreDtTm(OffsetDateTime value) {
     ...
     *     
     */
    public OriginalGroupHeader14 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalGroupHeader14 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalGroupHeader14 setGrpCxlSts(GroupCancellationStatus1Code value) {
     ...
     * 
     */
    public OriginalGroupHeader14 addCxlStsRsnInf(CancellationStatusReason4 cxlStsRsnInf) {
     ...
     * 
     */
    public OriginalGroupHeader14 addNbOfTxsPerCxlSts(NumberOfTransactionsPerStatus1 nbOfTxsPerCxlSts) {
