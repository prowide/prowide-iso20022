...
public class OriginalPaymentInstruction22 {
     ...
     *     
     */
    public OriginalPaymentInstruction22 setOrgnlPmtInfCxlId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction22 setRslvdCase(Case3 value) {
     ...
     *     
     */
    public OriginalPaymentInstruction22 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction22 setOrgnlGrpInf(OriginalGroupInformation3 value) {
     ...
     *     
     */
    public OriginalPaymentInstruction22 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction22 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction22 setPmtInfCxlSts(GroupCancellationStatus1Code value) {
     ...
     * 
     */
    public OriginalPaymentInstruction22 addCxlStsRsnInf(CancellationStatusReason2 cxlStsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction22 addNbOfTxsPerCxlSts(NumberOfCancellationsPerStatus1 nbOfTxsPerCxlSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction22 addTxInfAndSts(PaymentTransaction78 txInfAndSts) {
