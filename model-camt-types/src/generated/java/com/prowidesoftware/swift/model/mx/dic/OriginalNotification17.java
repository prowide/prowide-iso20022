...
@XmlType(name = "OriginalNotification17", propOrder = {
    "orgnlMsgId",
    "orgnlCreDtTm",
    "orgnlNtfctnId",
    "ntfctnSts",
...
public class OriginalNotification17 {
    ...
    protected List<OriginalNotificationReference15> orgnlNtfctnRef;
     ...
     *     
     */
    public OriginalNotification17 setOrgnlMsgId(String value) {
     ...
     *     
     */
    public OriginalNotification17 setOrgnlCreDtTm(OffsetDateTime value) {
     ...
     *     
     */
    public OriginalNotification17 setOrgnlNtfctnId(String value) {
     ...
     *     
     */
    public OriginalNotification17 setNtfctnSts(NotificationStatus3Code value) {
     ...
     *     
     */
    public OriginalNotification17 setAddtlStsInf(String value) {
     ...
     * {@link OriginalNotificationReference15 }
     * 
     * 
     * @return
     *     The value of the orgnlNtfctnRef property.
     */
    public List<OriginalNotificationReference15> getOrgnlNtfctnRef() {
     ...
     * 
     */
    public OriginalNotification17 addOrgnlNtfctnRef(OriginalNotificationReference15 orgnlNtfctnRef) {
