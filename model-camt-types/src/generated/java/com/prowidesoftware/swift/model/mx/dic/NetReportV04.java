...
/**
 * The Net Report message is sent to a participant by a central system to provide details of the bi-lateral payment obligations, calculated by the central system per currency.
 * 
 * 
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "NetReportV04", propOrder = {
    "netRptData",
    "netSvcPtcptId",
    "netSvcCtrPtyId",
    "netOblgtn",
...
public class NetReportV04 {
    ...
    protected List<NetObligation4> netOblgtn;
     ...
     *     
     */
    public NetReportV04 setNetRptData(NetReportData2 value) {
     ...
     *     
     */
    public NetReportV04 setNetSvcPtcptId(PartyIdentification242Choice value) {
     ...
     *     
     */
    public NetReportV04 setNetSvcCtrPtyId(PartyIdentification242Choice value) {
     ...
     */
    public List<NetObligation4> getNetOblgtn() {
        if (netOblgtn == null) {
     ...
     * 
     */
    public NetReportV04 addNetOblgtn(NetObligation4 netOblgtn) {
     ...
     * 
     */
    public NetReportV04 addSplmtryData(SupplementaryData1 splmtryData) {
