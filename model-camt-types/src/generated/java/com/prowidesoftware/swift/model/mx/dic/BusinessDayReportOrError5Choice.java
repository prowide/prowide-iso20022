...
@XmlType(name = "BusinessDayReportOrError5Choice", propOrder = {
    "bizRpt",
    "oprlErr"
})
public class BusinessDayReportOrError5Choice {
    ...
    protected List<BusinessDay5> bizRpt;
     ...
     * 
     */
    public List<BusinessDay5> getBizRpt() {
        if (bizRpt == null) {
            bizRpt = new ArrayList<BusinessDay5>();
        }
        return this.bizRpt;
    }
     ...
     * 
     */
    public BusinessDayReportOrError5Choice addBizRpt(BusinessDay5 bizRpt) {
     ...
     * 
     */
    public BusinessDayReportOrError5Choice addOprlErr(ErrorHandling4 oprlErr) {
