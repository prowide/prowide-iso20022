...
@XmlType(name = "TransactionCriteria9", propOrder = {
    "newQryNm",
    "schCrit",
    "stmtRpt",
    "rtrCrit"
})
public class TransactionCriteria9 {

    @XmlElement(name = "NewQryNm")
    protected String newQryNm;
    @XmlElement(name = "SchCrit")
    protected List<TransactionSearchCriteria9> schCrit;
     ...
     *     
     */
    public TransactionCriteria9 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
     ...
     * {@link TransactionSearchCriteria9 }
     * 
     * 
     */
    public List<TransactionSearchCriteria9> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<TransactionSearchCriteria9>();
        }
        return this.schCrit;
    }
     ...
     *     
     */
    public TransactionCriteria9 setStmtRpt(ReportIndicator1Code value) {
        this.stmtRpt = value;
        return this;
    }
     ...
     *     
     */
    public TransactionCriteria9 setRtrCrit(TransactionReturnCriteria5 value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public TransactionCriteria9 addSchCrit(TransactionSearchCriteria9 schCrit) {
