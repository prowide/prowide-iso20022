...
@XmlType(name = "ReturnTransactionV07", propOrder = {
    "msgHdr",
    "rptOrErr",
    "splmtryData"
})
public class ReturnTransactionV07 {
    ...
    protected TransactionReportOrError3Choice rptOrErr;
     ...
     *     
     */
    public ReturnTransactionV07 setMsgHdr(MessageHeader8 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link TransactionReportOrError3Choice }
     *     
     */
    public TransactionReportOrError3Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public ReturnTransactionV07 setRptOrErr(TransactionReportOrError3Choice value) {
        this.rptOrErr = value;
        return this;
    }
     ...
     * 
     */
    public ReturnTransactionV07 addSplmtryData(SupplementaryData1 splmtryData) {
