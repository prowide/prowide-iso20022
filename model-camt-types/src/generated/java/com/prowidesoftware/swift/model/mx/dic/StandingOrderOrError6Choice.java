...
@XmlType(name = "StandingOrderOrError6Choice", propOrder = {
    "stgOrdr",
    "bizErr"
})
public class StandingOrderOrError6Choice {

    @XmlElement(name = "StgOrdr")
    protected StandingOrder6 stgOrdr;
     ...
     *     
     */
    public StandingOrder6 getStgOrdr() {
        return stgOrdr;
    }
     ...
     *     
     */
    public StandingOrderOrError6Choice setStgOrdr(StandingOrder6 value) {
        this.stgOrdr = value;
        return this;
    }
     ...
     * 
     */
    public StandingOrderOrError6Choice addBizErr(ErrorHandling5 bizErr) {
