...
@XmlType(name = "CashAccountEntrySearch8", propOrder = {
    "acctId",
    "ntryAmt",
    "ntryAmtCcy",
    "cdtDbtInd",
...
public class CashAccountEntrySearch8 {
     ...
     *     
     */
    public CashAccountEntrySearch8 setCdtDbtInd(CreditDebitCode value) {
     ...
     *     
     */
    public CashAccountEntrySearch8 setAcctOwnr(PartyIdentification272 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public CashAccountEntrySearch8 setAcctSvcr(BranchAndFinancialInstitutionIdentification8 value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     * 
     */
    public CashAccountEntrySearch8 addAcctId(AccountIdentificationSearchCriteria2Choice acctId) {
     ...
     * 
     */
    public CashAccountEntrySearch8 addNtryAmt(ActiveOrHistoricAmountRange2Choice ntryAmt) {
     ...
     * 
     */
    public CashAccountEntrySearch8 addNtryAmtCcy(String ntryAmtCcy) {
     ...
     * 
     */
    public CashAccountEntrySearch8 addNtrySts(EntryStatus1Code ntrySts) {
     ...
     * 
     */
    public CashAccountEntrySearch8 addNtryDt(DateAndDateTimeSearch3Choice ntryDt) {
