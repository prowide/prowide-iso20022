...
@XmlType(name = "GeneralBusinessOrError4Choice", propOrder = {
    "bizErr",
    "gnlBiz"
})
public class GeneralBusinessOrError4Choice {
     ...
     *     
     */
    public GeneralBusinessOrError4Choice setGnlBiz(GeneralBusinessInformation value) {
        this.gnlBiz = value;
        return this;
    }
     ...
     * 
     */
    public GeneralBusinessOrError4Choice addBizErr(ErrorHandling4 bizErr) {
