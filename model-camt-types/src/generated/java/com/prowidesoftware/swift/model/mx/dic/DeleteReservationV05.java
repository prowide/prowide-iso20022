...
@XmlType(name = "DeleteReservationV05", propOrder = {
    "msgHdr",
    "curRsvatn",
    "splmtryData"
})
public class DeleteReservationV05 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader1 msgHdr;
    @XmlElement(name = "CurRsvatn")
    protected ReservationIdentification2 curRsvatn;
     ...
     *     
     */
    public DeleteReservationV05 setMsgHdr(MessageHeader1 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     *     
     */
    public ReservationIdentification2 getCurRsvatn() {
        return curRsvatn;
    }
     ...
     *     
     */
    public DeleteReservationV05 setCurRsvatn(ReservationIdentification2 value) {
     ...
     * 
     */
    public DeleteReservationV05 addSplmtryData(SupplementaryData1 splmtryData) {
