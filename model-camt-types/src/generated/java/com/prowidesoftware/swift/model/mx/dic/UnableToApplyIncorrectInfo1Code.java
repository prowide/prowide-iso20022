...
/**
 * <p>Java class for UnableToApplyIncorrectInfo1Code.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <pre>{@code
 * <simpleType name="UnableToApplyIncorrectInfo1Code">
 ...
 * 
 */
@XmlType(name = "UnableToApplyIncorrectInfo1Code")
@XmlEnum
public enum UnableToApplyIncorrectInfo1Code {
    ...
    UnableToApplyIncorrectInfo1Code(String v) {
        value = v;
    }
    ...
    public static UnableToApplyIncorrectInfo1Code fromValue(String v) {
        for (UnableToApplyIncorrectInfo1Code c: UnableToApplyIncorrectInfo1Code.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
