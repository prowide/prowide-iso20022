...
@XmlType(name = "ReturnCurrencyExchangeRateV04", propOrder = {
    "msgHdr",
    "rptOrErr",
    "splmtryData"
})
public class ReturnCurrencyExchangeRateV04 {
     ...
     *     
     */
    public ReturnCurrencyExchangeRateV04 setMsgHdr(MessageHeader7 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     *     
     */
    public ReturnCurrencyExchangeRateV04 setRptOrErr(ExchangeRateReportOrError1Choice value) {
        this.rptOrErr = value;
        return this;
    }
     ...
     * 
     */
    public ReturnCurrencyExchangeRateV04 addSplmtryData(SupplementaryData1 splmtryData) {
