...
@XmlType(name = "OriginalNotification15", propOrder = {
    "orgnlMsgId",
    "orgnlCreDtTm",
    "orgnlNtfctnId",
    "ntfctnSts",
...
public class OriginalNotification15 {
     ...
     *     
     */
    public OriginalNotification15 setOrgnlMsgId(String value) {
     ...
     *     
     */
    public OriginalNotification15 setOrgnlCreDtTm(XMLGregorianCalendar value) {
     ...
     *     
     */
    public OriginalNotification15 setOrgnlNtfctnId(String value) {
     ...
     *     
     */
    public OriginalNotification15 setNtfctnSts(NotificationStatus3Code value) {
     ...
     *     
     */
    public OriginalNotification15 setAddtlStsInf(String value) {
     ...
     * 
     */
    public OriginalNotification15 addOrgnlNtfctnRef(OriginalNotificationReference13 orgnlNtfctnRef) {
