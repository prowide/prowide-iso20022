...
@XmlType(name = "ReturnReservationV07", propOrder = {
    "msgHdr",
    "rptOrErr",
    "splmtryData"
})
public class ReturnReservationV07 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader7 msgHdr;
    @XmlElement(name = "RptOrErr", required = true)
    protected ReservationOrError10Choice rptOrErr;
     ...
     *     
     */
    public ReturnReservationV07 setMsgHdr(MessageHeader7 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link ReservationOrError10Choice }
     *     
     */
    public ReservationOrError10Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public ReturnReservationV07 setRptOrErr(ReservationOrError10Choice value) {
        this.rptOrErr = value;
        return this;
    }
     ...
     * 
     */
    public ReturnReservationV07 addSplmtryData(SupplementaryData1 splmtryData) {
