...
public class OriginalNotification7 {
    ...
    protected List<OriginalNotificationReference5> orgnlNtfctnRef;
     ...
     *     
     */
    public OriginalNotification7 setOrgnlCreDtTm(Calendar value) {
     ...
     */
    public List<OriginalNotificationReference5> getOrgnlNtfctnRef() {
