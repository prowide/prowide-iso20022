...
@XmlType(name = "ModifyLimitV06", propOrder = {
    "msgHdr",
    "lmtDtls",
    "splmtryData"
})
public class ModifyLimitV06 {
    ...
    protected List<LimitStructure2> lmtDtls;
     ...
     *     
     */
    public ModifyLimitV06 setMsgHdr(MessageHeader1 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * {@link LimitStructure2 }
     * 
     * 
     */
    public List<LimitStructure2> getLmtDtls() {
        if (lmtDtls == null) {
            lmtDtls = new ArrayList<LimitStructure2>();
        }
        return this.lmtDtls;
    }
     ...
     * 
     */
    public ModifyLimitV06 addLmtDtls(LimitStructure2 lmtDtls) {
     ...
     * 
     */
    public ModifyLimitV06 addSplmtryData(SupplementaryData1 splmtryData) {
