...
@XmlType(name = "BankToCustomerAccountReportV14", propOrder = {
    "grpHdr",
    "rpt",
    "splmtryData"
})
public class BankToCustomerAccountReportV14 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader116 grpHdr;
    @XmlElement(name = "Rpt", required = true)
    protected List<AccountReport38> rpt;
     ...
     *     
     */
    public BankToCustomerAccountReportV14 setGrpHdr(GroupHeader116 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountReport38 }
     * 
     * 
     * @return
     *     The value of the rpt property.
     */
    public List<AccountReport38> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<>();
        }
        return this.rpt;
     ...
     * 
     */
    public BankToCustomerAccountReportV14 addRpt(AccountReport38 rpt) {
        getRpt().add(rpt);
        return this;
    }
     ...
     * 
     */
    public BankToCustomerAccountReportV14 addSplmtryData(SupplementaryData1 splmtryData) {
