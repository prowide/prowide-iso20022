...
@XmlType(name = "BankServicesBillingStatementV01", propOrder = {
    "rptHdr",
    "bllgStmtGrp"
})
public class BankServicesBillingStatementV01 {
    ...
    protected List<StatementGroup1> bllgStmtGrp;
     ...
     *     
     */
    public BankServicesBillingStatementV01 setRptHdr(ReportHeader3 value) {
        this.rptHdr = value;
        return this;
    }
     ...
     * {@link StatementGroup1 }
     * 
     * 
     */
    public List<StatementGroup1> getBllgStmtGrp() {
        if (bllgStmtGrp == null) {
            bllgStmtGrp = new ArrayList<StatementGroup1>();
        }
     ...
     * 
     */
    public BankServicesBillingStatementV01 addBllgStmtGrp(StatementGroup1 bllgStmtGrp) {
