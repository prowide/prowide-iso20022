...
@XmlType(name = "ReceiptV06", propOrder = {
    "msgHdr",
    "rctDtls",
    "splmtryData"
})
public class ReceiptV06 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader9 msgHdr;
    @XmlElement(name = "RctDtls", required = true)
    protected List<Receipt4> rctDtls;
     ...
     *     
     */
    public ReceiptV06 setMsgHdr(MessageHeader9 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * 
     */
    public List<Receipt4> getRctDtls() {
        if (rctDtls == null) {
            rctDtls = new ArrayList<Receipt4>();
        }
        return this.rctDtls;
    }
     ...
     * 
     */
    public ReceiptV06 addRctDtls(Receipt4 rctDtls) {
     ...
     * 
     */
    public ReceiptV06 addSplmtryData(SupplementaryData1 splmtryData) {
