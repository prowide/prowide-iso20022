...
@XmlType(name = "BankToCustomerDebitCreditNotificationV13", propOrder = {
    "grpHdr",
    "ntfctn",
    "splmtryData"
})
public class BankToCustomerDebitCreditNotificationV13 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader116 grpHdr;
    @XmlElement(name = "Ntfctn", required = true)
    protected List<AccountNotification24> ntfctn;
     ...
     *     
     */
    public BankToCustomerDebitCreditNotificationV13 setGrpHdr(GroupHeader116 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountNotification24 }
     * 
     * 
     */
    public List<AccountNotification24> getNtfctn() {
        if (ntfctn == null) {
            ntfctn = new ArrayList<AccountNotification24>();
        }
        return this.ntfctn;
    }
     ...
     * 
     */
    public BankToCustomerDebitCreditNotificationV13 addNtfctn(AccountNotification24 ntfctn) {
     ...
     * 
     */
    public BankToCustomerDebitCreditNotificationV13 addSplmtryData(SupplementaryData1 splmtryData) {
