...
@XmlType(name = "TransactionCriteria4", propOrder = {
    "newQryNm",
    "schCrit",
    "stmtRpt",
    "rtrCrit"
...
public class TransactionCriteria4 {
    ...
    protected List<TransactionSearchCriteria4> schCrit;
     ...
     *     
     */
    public TransactionCriteria4 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
     ...
     * {@link TransactionSearchCriteria4 }
     * 
     * 
     */
    public List<TransactionSearchCriteria4> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<TransactionSearchCriteria4>();
        }
        return this.schCrit;
    }
     ...
     *     
     */
    public TransactionCriteria4 setStmtRpt(ReportIndicator1Code value) {
        this.stmtRpt = value;
        return this;
    }
     ...
     *     
     */
    public TransactionCriteria4 setRtrCrit(TransactionReturnCriteria3 value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public TransactionCriteria4 addSchCrit(TransactionSearchCriteria4 schCrit) {
