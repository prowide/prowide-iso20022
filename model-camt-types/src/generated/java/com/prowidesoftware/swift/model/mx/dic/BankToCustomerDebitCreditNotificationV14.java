...
@XmlType(name = "BankToCustomerDebitCreditNotificationV14", propOrder = {
    "grpHdr",
    "ntfctn",
    "splmtryData"
})
public class BankToCustomerDebitCreditNotificationV14 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader116 grpHdr;
    @XmlElement(name = "Ntfctn", required = true)
    protected List<AccountNotification25> ntfctn;
     ...
     *     
     */
    public BankToCustomerDebitCreditNotificationV14 setGrpHdr(GroupHeader116 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountNotification25 }
     * 
     * 
     * @return
     *     The value of the ntfctn property.
     */
    public List<AccountNotification25> getNtfctn() {
        if (ntfctn == null) {
     ...
     * 
     */
    public BankToCustomerDebitCreditNotificationV14 addNtfctn(AccountNotification25 ntfctn) {
     ...
     * 
     */
    public BankToCustomerDebitCreditNotificationV14 addSplmtryData(SupplementaryData1 splmtryData) {
