...
@XmlType(name = "UnderlyingTransaction19", propOrder = {
    "orgnlGrpInfAndSts",
    "orgnlPmtInfAndSts",
    "txInfAndSts"
})
public class UnderlyingTransaction19 {
    ...
    protected OriginalGroupHeader9 orgnlGrpInfAndSts;
    @XmlElement(name = "OrgnlPmtInfAndSts")
    protected List<OriginalPaymentInstruction26> orgnlPmtInfAndSts;
    @XmlElement(name = "TxInfAndSts")
    protected List<PaymentTransaction85> txInfAndSts;
     ...
     * @return
     *     possible object is
     *     {@link OriginalGroupHeader9 }
     *     
     */
    public OriginalGroupHeader9 getOrgnlGrpInfAndSts() {
     ...
     *     
     */
    public UnderlyingTransaction19 setOrgnlGrpInfAndSts(OriginalGroupHeader9 value) {
     ...
     * 
     */
    public UnderlyingTransaction19 addOrgnlPmtInfAndSts(OriginalPaymentInstruction26 orgnlPmtInfAndSts) {
     ...
     * 
     */
    public UnderlyingTransaction19 addTxInfAndSts(PaymentTransaction85 txInfAndSts) {
