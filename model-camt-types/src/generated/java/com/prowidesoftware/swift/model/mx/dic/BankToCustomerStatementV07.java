...
@XmlType(name = "BankToCustomerStatementV07", propOrder = {
    "grpHdr",
    "stmt",
    "splmtryData"
})
public class BankToCustomerStatementV07 {
     ...
     *     
     */
    public BankToCustomerStatementV07 setGrpHdr(GroupHeader73 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public BankToCustomerStatementV07 addStmt(AccountStatement8 stmt) {
        getStmt().add(stmt);
        return this;
    }
     ...
     * 
     */
    public BankToCustomerStatementV07 addSplmtryData(SupplementaryData1 splmtryData) {
