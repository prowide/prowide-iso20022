...
@XmlType(name = "ModifyStandingOrderV05", propOrder = {
    "msgHdr",
    "stgOrdrId",
    "newStgOrdrValSet",
    "splmtryData"
...
public class ModifyStandingOrderV05 {
    ...
    protected StandingOrder5 newStgOrdrValSet;
     ...
     *     
     */
    public ModifyStandingOrderV05 setMsgHdr(MessageHeader1 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     *     
     */
    public ModifyStandingOrderV05 setStgOrdrId(StandingOrderIdentification2 value) {
     ...
     *     
     */
    public StandingOrder5 getNewStgOrdrValSet() {
     ...
     *     
     */
    public ModifyStandingOrderV05 setNewStgOrdrValSet(StandingOrder5 value) {
     ...
     * 
     */
    public ModifyStandingOrderV05 addSplmtryData(SupplementaryData1 splmtryData) {
