...
@XmlType(name = "ReservationCriteria1", propOrder = {
    "newQryNm",
    "schCrit",
    "rtrCrit"
})
public class ReservationCriteria1 {
    ...
    protected List<ReservationSearchCriteria1> schCrit;
    @XmlElement(name = "RtrCrit")
    protected ReservationReturnCriteria rtrCrit;
     ...
     *     
     */
    public ReservationCriteria1 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
     ...
     * {@link ReservationSearchCriteria1 }
     * 
     * 
     */
    public List<ReservationSearchCriteria1> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<ReservationSearchCriteria1>();
        }
        return this.schCrit;
    }
     ...
     * @return
     *     possible object is
     *     {@link ReservationReturnCriteria }
     *     
     */
    public ReservationReturnCriteria getRtrCrit() {
        return rtrCrit;
    }
     ...
     *     
     */
    public ReservationCriteria1 setRtrCrit(ReservationReturnCriteria value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public ReservationCriteria1 addSchCrit(ReservationSearchCriteria1 schCrit) {
