...
@XmlType(name = "AccountOrBusinessError1Choice", propOrder = {
    "acct",
    "bizErr"
})
public class AccountOrBusinessError1Choice {
     ...
     *     
     */
    public AccountOrBusinessError1Choice setAcct(CashAccount23 value) {
        this.acct = value;
        return this;
    }
     ...
     * 
     */
    public AccountOrBusinessError1Choice addBizErr(ErrorHandling3 bizErr) {
