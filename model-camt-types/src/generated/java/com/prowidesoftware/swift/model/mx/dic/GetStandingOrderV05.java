...
@XmlType(name = "GetStandingOrderV05", propOrder = {
    "msgHdr",
    "stgOrdrQryDef",
    "splmtryData"
})
public class GetStandingOrderV05 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader4 msgHdr;
    @XmlElement(name = "StgOrdrQryDef")
    protected StandingOrderQuery5 stgOrdrQryDef;
     ...
     *     
     */
    public GetStandingOrderV05 setMsgHdr(MessageHeader4 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link StandingOrderQuery5 }
     *     
     */
    public StandingOrderQuery5 getStgOrdrQryDef() {
     ...
     *     
     */
    public GetStandingOrderV05 setStgOrdrQryDef(StandingOrderQuery5 value) {
     ...
     * 
     */
    public GetStandingOrderV05 addSplmtryData(SupplementaryData1 splmtryData) {
