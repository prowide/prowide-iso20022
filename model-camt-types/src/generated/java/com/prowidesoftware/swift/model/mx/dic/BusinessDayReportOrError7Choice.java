...
@XmlType(name = "BusinessDayReportOrError7Choice", propOrder = {
    "bizRpt",
    "oprlErr"
})
public class BusinessDayReportOrError7Choice {
    ...
    protected List<BusinessDay6> bizRpt;
     ...
     * 
     */
    public List<BusinessDay6> getBizRpt() {
        if (bizRpt == null) {
            bizRpt = new ArrayList<BusinessDay6>();
        }
        return this.bizRpt;
    }
     ...
     * 
     */
    public BusinessDayReportOrError7Choice addBizRpt(BusinessDay6 bizRpt) {
     ...
     * 
     */
    public BusinessDayReportOrError7Choice addOprlErr(ErrorHandling4 oprlErr) {
