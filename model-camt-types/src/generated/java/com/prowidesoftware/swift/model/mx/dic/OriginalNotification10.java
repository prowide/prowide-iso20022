...
@XmlType(name = "OriginalNotification10", propOrder = {
    "orgnlMsgId",
    "orgnlCreDtTm",
    "orgnlNtfctnId",
    "ntfctnCxl",
...
public class OriginalNotification10 {
    ...
    protected List<OriginalNotificationReference8> orgnlNtfctnRef;
     ...
     *     
     */
    public OriginalNotification10 setOrgnlMsgId(String value) {
     ...
     *     
     */
    public OriginalNotification10 setOrgnlCreDtTm(OffsetDateTime value) {
     ...
     *     
     */
    public OriginalNotification10 setOrgnlNtfctnId(String value) {
     ...
     *     
     */
    public OriginalNotification10 setNtfctnCxl(Boolean value) {
     ...
     * {@link OriginalNotificationReference8 }
     * 
     * 
     * @return
     *     The value of the orgnlNtfctnRef property.
     */
    public List<OriginalNotificationReference8> getOrgnlNtfctnRef() {
     ...
     * 
     */
    public OriginalNotification10 addOrgnlNtfctnRef(OriginalNotificationReference8 orgnlNtfctnRef) {
