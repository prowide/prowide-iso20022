...
@XmlType(name = "AccountCriteria3", propOrder = {
    "newQryNm",
    "schCrit",
    "rtrCrit"
})
public class AccountCriteria3 {
    ...
    protected List<CashAccountSearchCriteria3> schCrit;
     ...
     *     
     */
    public AccountCriteria3 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
     ...
     * {@link CashAccountSearchCriteria3 }
     * 
     * 
     */
    public List<CashAccountSearchCriteria3> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<CashAccountSearchCriteria3>();
        }
        return this.schCrit;
    }
     ...
     *     
     */
    public AccountCriteria3 setRtrCrit(CashAccountReturnCriteria2 value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public AccountCriteria3 addSchCrit(CashAccountSearchCriteria3 schCrit) {
