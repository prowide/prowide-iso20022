...
@XmlType(name = "ModifyTransactionV09", propOrder = {
    "msgHdr",
    "mod",
    "splmtryData"
})
public class ModifyTransactionV09 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader1 msgHdr;
    @XmlElement(name = "Mod", required = true)
    protected List<TransactionModification6> mod;
     ...
     *     
     */
    public ModifyTransactionV09 setMsgHdr(MessageHeader1 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * {@link TransactionModification6 }
     * 
     * 
     */
    public List<TransactionModification6> getMod() {
        if (mod == null) {
            mod = new ArrayList<TransactionModification6>();
        }
        return this.mod;
    }
     ...
     * 
     */
    public ModifyTransactionV09 addMod(TransactionModification6 mod) {
        getMod().add(mod);
        return this;
    }
     ...
     * 
     */
    public ModifyTransactionV09 addSplmtryData(SupplementaryData1 splmtryData) {
