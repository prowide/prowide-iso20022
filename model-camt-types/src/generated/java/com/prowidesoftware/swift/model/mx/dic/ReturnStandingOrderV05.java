...
@XmlType(name = "ReturnStandingOrderV05", propOrder = {
    "msgHdr",
    "rptOrErr",
    "splmtryData"
})
public class ReturnStandingOrderV05 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader6 msgHdr;
    @XmlElement(name = "RptOrErr", required = true)
    protected StandingOrderOrError7Choice rptOrErr;
     ...
     *     
     */
    public ReturnStandingOrderV05 setMsgHdr(MessageHeader6 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link StandingOrderOrError7Choice }
     *     
     */
    public StandingOrderOrError7Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public ReturnStandingOrderV05 setRptOrErr(StandingOrderOrError7Choice value) {
        this.rptOrErr = value;
        return this;
    }
     ...
     * 
     */
    public ReturnStandingOrderV05 addSplmtryData(SupplementaryData1 splmtryData) {
