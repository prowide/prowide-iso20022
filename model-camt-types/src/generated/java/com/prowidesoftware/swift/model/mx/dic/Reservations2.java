...
@XmlType(name = "Reservations2", propOrder = {
    "curRsvatn",
    "dfltRsvatn"
})
public class Reservations2 {
    ...
    protected List<ReservationReport2> curRsvatn;
    @XmlElement(name = "DfltRsvatn")
    protected List<ReservationReport2> dfltRsvatn;
     ...
     * {@link ReservationReport2 }
     * 
     * 
     */
    public List<ReservationReport2> getCurRsvatn() {
        if (curRsvatn == null) {
            curRsvatn = new ArrayList<ReservationReport2>();
        }
     ...
     * 
     */
    public List<ReservationReport2> getDfltRsvatn() {
        if (dfltRsvatn == null) {
            dfltRsvatn = new ArrayList<ReservationReport2>();
        }
     ...
     * 
     */
    public Reservations2 addCurRsvatn(ReservationReport2 curRsvatn) {
     ...
     * 
     */
    public Reservations2 addDfltRsvatn(ReservationReport2 dfltRsvatn) {
