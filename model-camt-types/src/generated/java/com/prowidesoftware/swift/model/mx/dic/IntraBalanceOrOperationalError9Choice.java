...
@XmlType(name = "IntraBalanceOrOperationalError9Choice", propOrder = {
    "cxls",
    "oprlErr"
})
public class IntraBalanceOrOperationalError9Choice {

    @XmlElement(name = "Cxls")
    protected List<IntraBalanceCancellation5> cxls;
     ...
     * {@link IntraBalanceCancellation5 }
     * 
     * 
     */
    public List<IntraBalanceCancellation5> getCxls() {
        if (cxls == null) {
            cxls = new ArrayList<IntraBalanceCancellation5>();
        }
        return this.cxls;
    }
     ...
     * 
     */
    public IntraBalanceOrOperationalError9Choice addCxls(IntraBalanceCancellation5 cxls) {
        getCxls().add(cxls);
        return this;
    }
     ...
     * 
     */
    public IntraBalanceOrOperationalError9Choice addOprlErr(ErrorHandling5 oprlErr) {
