...
@XmlType(name = "BankToCustomerDebitCreditNotificationV03", propOrder = {
    "grpHdr",
    "ntfctn",
    "splmtryData"
})
public class BankToCustomerDebitCreditNotificationV03 {
     ...
     *     
     */
    public BankToCustomerDebitCreditNotificationV03 setGrpHdr(GroupHeader58 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link AccountNotification5 }
     * 
     * 
     */
    public List<AccountNotification5> getNtfctn() {
        if (ntfctn == null) {
            ntfctn = new ArrayList<AccountNotification5>();
        }
        return this.ntfctn;
    }
     ...
     * 
     */
    public BankToCustomerDebitCreditNotificationV03 addNtfctn(AccountNotification5 ntfctn) {
     ...
     * 
     */
    public BankToCustomerDebitCreditNotificationV03 addSplmtryData(SupplementaryData1 splmtryData) {
