...
@XmlType(name = "ReceiptV04", propOrder = {
    "msgHdr",
    "rctDtls",
    "splmtryData"
})
public class ReceiptV04 {
    ...
    protected List<Receipt2> rctDtls;
     ...
     *     
     */
    public ReceiptV04 setMsgHdr(MessageHeader9 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * 
     */
    public List<Receipt2> getRctDtls() {
        if (rctDtls == null) {
            rctDtls = new ArrayList<Receipt2>();
        }
        return this.rctDtls;
    }
     ...
     * 
     */
    public ReceiptV04 addRctDtls(Receipt2 rctDtls) {
     ...
     * 
     */
    public ReceiptV04 addSplmtryData(SupplementaryData1 splmtryData) {
