...
public class CurrentAndDefaultReservation5 {
    ...
    public List<ReservationReport7> getCurRsvatn() {
        if (curRsvatn == null) {
            curRsvatn = new ArrayList<ReservationReport7>();
        }
    ...
    public List<ReservationReport7> getDfltRsvatn() {
        if (dfltRsvatn == null) {
            dfltRsvatn = new ArrayList<ReservationReport7>();
        }
     ...
     * 
     */
    public CurrentAndDefaultReservation5 addCurRsvatn(ReservationReport7 curRsvatn) {
     ...
     * 
     */
    public CurrentAndDefaultReservation5 addDfltRsvatn(ReservationReport7 dfltRsvatn) {
