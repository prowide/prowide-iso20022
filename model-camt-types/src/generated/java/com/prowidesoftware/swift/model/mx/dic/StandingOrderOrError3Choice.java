...
@XmlType(name = "StandingOrderOrError3Choice", propOrder = {
    "rpt",
    "oprlErr"
})
public class StandingOrderOrError3Choice {
    ...
    @XmlElement(name = "Rpt")
    protected List<StandingOrder4> rpt;
     ...
     * 
     */
    public List<StandingOrder4> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<StandingOrder4>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public StandingOrderOrError3Choice addRpt(StandingOrder4 rpt) {
        getRpt().add(rpt);
        return this;
    }
     ...
     * 
     */
    public StandingOrderOrError3Choice addOprlErr(ErrorHandling4 oprlErr) {
