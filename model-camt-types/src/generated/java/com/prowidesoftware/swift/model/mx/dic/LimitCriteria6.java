...
@XmlType(name = "LimitCriteria6", propOrder = {
    "newQryNm",
    "schCrit",
    "rtrCrit"
})
public class LimitCriteria6 {

    @XmlElement(name = "NewQryNm")
    protected String newQryNm;
    @XmlElement(name = "SchCrit")
    protected List<LimitSearchCriteria6> schCrit;
     ...
     *     
     */
    public LimitCriteria6 setNewQryNm(String value) {
        this.newQryNm = value;
        return this;
    }
     ...
     * {@link LimitSearchCriteria6 }
     * 
     * 
     */
    public List<LimitSearchCriteria6> getSchCrit() {
        if (schCrit == null) {
            schCrit = new ArrayList<LimitSearchCriteria6>();
        }
        return this.schCrit;
    }
     ...
     *     
     */
    public LimitCriteria6 setRtrCrit(LimitReturnCriteria2 value) {
        this.rtrCrit = value;
        return this;
    }
     ...
     * 
     */
    public LimitCriteria6 addSchCrit(LimitSearchCriteria6 schCrit) {
