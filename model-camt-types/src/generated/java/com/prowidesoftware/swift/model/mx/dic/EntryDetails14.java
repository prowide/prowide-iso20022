...
@XmlType(name = "EntryDetails14", propOrder = {
    "btch",
    "txDtls"
})
public class EntryDetails14 {

    @XmlElement(name = "Btch")
    protected BatchInformation2 btch;
    @XmlElement(name = "TxDtls")
    protected List<EntryTransaction15> txDtls;
     ...
     *     
     */
    public EntryDetails14 setBtch(BatchInformation2 value) {
        this.btch = value;
        return this;
    }
     ...
     * {@link EntryTransaction15 }
     * 
     * 
     */
    public List<EntryTransaction15> getTxDtls() {
        if (txDtls == null) {
            txDtls = new ArrayList<EntryTransaction15>();
        }
        return this.txDtls;
    }
     ...
     * 
     */
    public EntryDetails14 addTxDtls(EntryTransaction15 txDtls) {
