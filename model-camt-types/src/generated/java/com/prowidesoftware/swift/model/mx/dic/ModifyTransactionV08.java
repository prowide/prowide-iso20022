...
@XmlType(name = "ModifyTransactionV08", propOrder = {
    "msgHdr",
    "mod",
    "splmtryData"
})
public class ModifyTransactionV08 {

    @XmlElement(name = "MsgHdr", required = true)
    protected MessageHeader1 msgHdr;
    @XmlElement(name = "Mod", required = true)
    protected List<TransactionModification5> mod;
     ...
     *     
     */
    public ModifyTransactionV08 setMsgHdr(MessageHeader1 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * {@link TransactionModification5 }
     * 
     * 
     */
    public List<TransactionModification5> getMod() {
        if (mod == null) {
            mod = new ArrayList<TransactionModification5>();
        }
        return this.mod;
    }
     ...
     * 
     */
    public ModifyTransactionV08 addMod(TransactionModification5 mod) {
        getMod().add(mod);
        return this;
    }
     ...
     * 
     */
    public ModifyTransactionV08 addSplmtryData(SupplementaryData1 splmtryData) {
