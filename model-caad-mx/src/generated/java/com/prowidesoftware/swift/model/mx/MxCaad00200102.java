    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caad.002.001.02";
    ...
    public static MxCaad00200102 parse(String xml) {
        return ((MxCaad00200102) MxReadImpl.parse(MxCaad00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00200102) MxReadImpl.parse(MxCaad00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaad00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00200102 .class);
    }
