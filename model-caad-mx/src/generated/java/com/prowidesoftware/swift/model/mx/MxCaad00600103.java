    ...
    extends AbstractMX
{
    ...
    public static MxCaad00600103 parse(String xml) {
        return ((MxCaad00600103) MxReadImpl.parse(MxCaad00600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00600103) MxReadImpl.parse(MxCaad00600103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00600103 .class);
    }
