    ...
    extends AbstractMX
{
    ...
    public static MxCaad00200101 parse(String xml) {
        return ((MxCaad00200101) MxReadImpl.parse(MxCaad00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00200101) MxReadImpl.parse(MxCaad00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00200101 .class);
    }
