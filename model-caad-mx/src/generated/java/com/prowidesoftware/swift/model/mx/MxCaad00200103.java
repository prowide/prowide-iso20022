    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caad.002.001.03";
    ...
    public static MxCaad00200103 parse(String xml) {
        return ((MxCaad00200103) MxReadImpl.parse(MxCaad00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00200103) MxReadImpl.parse(MxCaad00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaad00200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00200103 .class);
    }
