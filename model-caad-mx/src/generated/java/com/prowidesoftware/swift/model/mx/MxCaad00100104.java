    ...
    extends AbstractMX
{
    ...
    public static MxCaad00100104 parse(String xml) {
        return ((MxCaad00100104) MxReadImpl.parse(MxCaad00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00100104) MxReadImpl.parse(MxCaad00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00100104 .class);
    }
