    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caad.006.001.04";
    ...
    public static MxCaad00600104 parse(String xml) {
        return ((MxCaad00600104) MxReadImpl.parse(MxCaad00600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00600104) MxReadImpl.parse(MxCaad00600104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaad00600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00600104 .class);
    }
