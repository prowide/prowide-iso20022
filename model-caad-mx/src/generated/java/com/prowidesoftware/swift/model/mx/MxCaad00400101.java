    ...
    extends AbstractMX
{
    ...
    public static MxCaad00400101 parse(String xml) {
        return ((MxCaad00400101) MxReadImpl.parse(MxCaad00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00400101) MxReadImpl.parse(MxCaad00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00400101 .class);
    }
