    ...
    extends AbstractMX
{
    ...
    public static MxCaad00300104 parse(String xml) {
        return ((MxCaad00300104) MxReadImpl.parse(MxCaad00300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00300104) MxReadImpl.parse(MxCaad00300104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00300104 .class);
    }
