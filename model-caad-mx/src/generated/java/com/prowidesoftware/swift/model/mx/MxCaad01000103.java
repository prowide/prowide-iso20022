    ...
    extends AbstractMX
{
    ...
    public static MxCaad01000103 parse(String xml) {
        return ((MxCaad01000103) MxReadImpl.parse(MxCaad01000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad01000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad01000103) MxReadImpl.parse(MxCaad01000103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad01000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad01000103 .class);
    }
