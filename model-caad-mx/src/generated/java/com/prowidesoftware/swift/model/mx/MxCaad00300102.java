    ...
    extends AbstractMX
{
    ...
    public static MxCaad00300102 parse(String xml) {
        return ((MxCaad00300102) MxReadImpl.parse(MxCaad00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00300102) MxReadImpl.parse(MxCaad00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00300102 .class);
    }
