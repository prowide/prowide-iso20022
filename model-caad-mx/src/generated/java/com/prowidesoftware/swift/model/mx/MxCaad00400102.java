    ...
    extends AbstractMX
{
    ...
    public static MxCaad00400102 parse(String xml) {
        return ((MxCaad00400102) MxReadImpl.parse(MxCaad00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00400102) MxReadImpl.parse(MxCaad00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00400102 .class);
    }
