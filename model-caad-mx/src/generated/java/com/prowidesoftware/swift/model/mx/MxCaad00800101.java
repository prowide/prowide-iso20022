    ...
    extends AbstractMX
{
    ...
    public static MxCaad00800101 parse(String xml) {
        return ((MxCaad00800101) MxReadImpl.parse(MxCaad00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00800101) MxReadImpl.parse(MxCaad00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00800101 .class);
    }
