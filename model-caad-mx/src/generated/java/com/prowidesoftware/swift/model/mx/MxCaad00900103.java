...
/**
 * Class for caad.009.001.03 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:caad.009.001.03")
public class MxCaad00900103
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "AdmstvRspn", required = true)
    protected AdministrativeResponseV03 admstvRspn;
     ...
     * 
     */
    public MxCaad00900103(final String xml) {
        this();
        MxCaad00900103 tmp = parse(xml);
     ...
     * 
     */
    public MxCaad00900103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AdministrativeResponseV03 }
     *     
     */
    public AdministrativeResponseV03 getAdmstvRspn() {
        return admstvRspn;
    }
     ...
     *     
     */
    public MxCaad00900103 setAdmstvRspn(AdministrativeResponseV03 value) {
     ...
     * 
     */
    public static MxCaad00900103 parse(String xml) {
        return ((MxCaad00900103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaad00900103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaad00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00900103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaad00900103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaad00900103 parse(String xml, MxRead parserImpl) {
        return ((MxCaad00900103) parserImpl.read(MxCaad00900103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaad00900103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaad00900103 message
     * @return
     *     a new instance of MxCaad00900103
     */
    public static final MxCaad00900103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaad00900103 .class);
    }
