    ...
    extends AbstractMX
{
    ...
    public static MxCaad00900103 parse(String xml) {
        return ((MxCaad00900103) MxReadImpl.parse(MxCaad00900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00900103) MxReadImpl.parse(MxCaad00900103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00900103 .class);
    }
