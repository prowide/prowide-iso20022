    ...
    extends AbstractMX
{
    ...
    public static MxCaad01000102 parse(String xml) {
        return ((MxCaad01000102) MxReadImpl.parse(MxCaad01000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad01000102) MxReadImpl.parse(MxCaad01000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad01000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad01000102 .class);
    }
