    ...
    extends AbstractMX
{
    ...
    public static MxCaad00700105 parse(String xml) {
        return ((MxCaad00700105) MxReadImpl.parse(MxCaad00700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00700105) MxReadImpl.parse(MxCaad00700105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00700105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00700105 .class);
    }
