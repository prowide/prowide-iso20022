    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caad.001.001.02";
    ...
    public static MxCaad00100102 parse(String xml) {
        return ((MxCaad00100102) MxReadImpl.parse(MxCaad00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00100102) MxReadImpl.parse(MxCaad00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaad00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00100102 .class);
    }
