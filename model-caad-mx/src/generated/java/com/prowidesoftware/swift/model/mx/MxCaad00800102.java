    ...
    extends AbstractMX
{
    ...
    public static MxCaad00800102 parse(String xml) {
        return ((MxCaad00800102) MxReadImpl.parse(MxCaad00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00800102) MxReadImpl.parse(MxCaad00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00800102 .class);
    }
