    ...
    extends AbstractMX
{
    ...
    public static MxCaad00800103 parse(String xml) {
        return ((MxCaad00800103) MxReadImpl.parse(MxCaad00800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00800103) MxReadImpl.parse(MxCaad00800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00800103 .class);
    }
