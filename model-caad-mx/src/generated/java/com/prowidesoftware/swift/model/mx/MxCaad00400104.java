    ...
    extends AbstractMX
{
    ...
    public static MxCaad00400104 parse(String xml) {
        return ((MxCaad00400104) MxReadImpl.parse(MxCaad00400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00400104) MxReadImpl.parse(MxCaad00400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00400104 .class);
    }
