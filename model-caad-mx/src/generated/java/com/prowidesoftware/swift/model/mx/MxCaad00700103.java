    ...
    extends AbstractMX
{
    ...
    public static MxCaad00700103 parse(String xml) {
        return ((MxCaad00700103) MxReadImpl.parse(MxCaad00700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00700103) MxReadImpl.parse(MxCaad00700103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaad00700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00700103 .class);
    }
