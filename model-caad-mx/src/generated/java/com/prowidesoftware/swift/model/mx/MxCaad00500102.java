    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caad.005.001.02";
    ...
    public static MxCaad00500102 parse(String xml) {
        return ((MxCaad00500102) MxReadImpl.parse(MxCaad00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00500102) MxReadImpl.parse(MxCaad00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaad00500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00500102 .class);
    }
