    ...
    extends AbstractMX
{
    ...
    public static MxCaad01000101 parse(String xml) {
        return ((MxCaad01000101) MxReadImpl.parse(MxCaad01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad01000101) MxReadImpl.parse(MxCaad01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad01000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad01000101 .class);
    }
