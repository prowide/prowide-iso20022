    ...
    extends AbstractMX
{
    ...
    public static MxCaad00700102 parse(String xml) {
        return ((MxCaad00700102) MxReadImpl.parse(MxCaad00700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00700102) MxReadImpl.parse(MxCaad00700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00700102 .class);
    }
