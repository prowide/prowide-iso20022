    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caad.003.001.03";
    ...
    public static MxCaad00300103 parse(String xml) {
        return ((MxCaad00300103) MxReadImpl.parse(MxCaad00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00300103) MxReadImpl.parse(MxCaad00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaad00300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00300103 .class);
    }
