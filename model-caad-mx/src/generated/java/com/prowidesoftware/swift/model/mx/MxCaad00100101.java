    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caad.001.001.01";
    ...
    public static MxCaad00100101 parse(String xml) {
        return ((MxCaad00100101) MxReadImpl.parse(MxCaad00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00100101) MxReadImpl.parse(MxCaad00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaad00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00100101 .class);
    }
