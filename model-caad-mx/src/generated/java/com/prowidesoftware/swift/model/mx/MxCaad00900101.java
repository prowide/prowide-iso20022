    ...
    extends AbstractMX
{
    ...
    public static MxCaad00900101 parse(String xml) {
        return ((MxCaad00900101) MxReadImpl.parse(MxCaad00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaad00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00900101) MxReadImpl.parse(MxCaad00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaad00900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaad00900101 .class);
    }
