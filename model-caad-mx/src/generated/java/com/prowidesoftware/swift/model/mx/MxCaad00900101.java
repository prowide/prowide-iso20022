...
/**
 * Class for caad.009.001.01 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:caad.009.001.01")
public class MxCaad00900101
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "AdmstvRspn", required = true)
    protected AdministrativeResponseV01 admstvRspn;
     ...
     * 
     */
    public MxCaad00900101(final String xml) {
        this();
        MxCaad00900101 tmp = parse(xml);
     ...
     * 
     */
    public MxCaad00900101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AdministrativeResponseV01 }
     *     
     */
    public AdministrativeResponseV01 getAdmstvRspn() {
        return admstvRspn;
    }
     ...
     *     
     */
    public MxCaad00900101 setAdmstvRspn(AdministrativeResponseV01 value) {
     ...
     * 
     */
    public static MxCaad00900101 parse(String xml) {
        return ((MxCaad00900101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaad00900101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaad00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaad00900101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaad00900101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaad00900101 parse(String xml, MxRead parserImpl) {
        return ((MxCaad00900101) parserImpl.read(MxCaad00900101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaad00900101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaad00900101 message
     * @return
     *     a new instance of MxCaad00900101
     */
    public static final MxCaad00900101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaad00900101 .class);
    }
