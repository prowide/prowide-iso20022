    ...
    extends AbstractMX
{
    ...
    public static MxCafc00100104 parse(String xml) {
        return ((MxCafc00100104) MxReadImpl.parse(MxCafc00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafc00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafc00100104) MxReadImpl.parse(MxCafc00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCafc00100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafc00100104 .class);
    }
