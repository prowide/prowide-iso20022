    ...
    extends AbstractMX
{
    ...
    public static MxCafc00200101 parse(String xml) {
        return ((MxCafc00200101) MxReadImpl.parse(MxCafc00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafc00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafc00200101) MxReadImpl.parse(MxCafc00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCafc00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafc00200101 .class);
    }
