    ...
    extends AbstractMX
{
    ...
    public static MxCafc00200102 parse(String xml) {
        return ((MxCafc00200102) MxReadImpl.parse(MxCafc00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafc00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafc00200102) MxReadImpl.parse(MxCafc00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCafc00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafc00200102 .class);
    }
