    ...
    extends AbstractMX
{
    ...
    public static MxCafc00200104 parse(String xml) {
        return ((MxCafc00200104) MxReadImpl.parse(MxCafc00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafc00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafc00200104) MxReadImpl.parse(MxCafc00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCafc00200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafc00200104 .class);
    }
