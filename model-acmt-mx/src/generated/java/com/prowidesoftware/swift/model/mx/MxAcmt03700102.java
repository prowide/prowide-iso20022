    ...
    extends AbstractMX
{
    ...
    public static MxAcmt03700102 parse(String xml) {
        return ((MxAcmt03700102) MxReadImpl.parse(MxAcmt03700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03700102) MxReadImpl.parse(MxAcmt03700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt03700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03700102 .class);
    }
