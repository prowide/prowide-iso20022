    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00400102 parse(String xml) {
        return ((MxAcmt00400102) MxReadImpl.parse(MxAcmt00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00400102) MxReadImpl.parse(MxAcmt00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00400102 .class);
    }
