    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.012.001.01";
    ...
    public static MxAcmt01200101 parse(String xml) {
        return ((MxAcmt01200101) MxReadImpl.parse(MxAcmt01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01200101) MxReadImpl.parse(MxAcmt01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt01200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01200101 .class);
    }
