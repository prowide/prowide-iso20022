    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:acmt.001.001.06";
    ...
    public static MxAcmt00100106 parse(String xml) {
        return ((MxAcmt00100106) MxReadImpl.parse(MxAcmt00100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00100106) MxReadImpl.parse(MxAcmt00100106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00100106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00100106 .class);
    }
