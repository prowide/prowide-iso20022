    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.022.001.03";
    ...
    public static MxAcmt02200103 parse(String xml) {
        return ((MxAcmt02200103) MxReadImpl.parse(MxAcmt02200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02200103) MxReadImpl.parse(MxAcmt02200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt02200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02200103 .class);
    }
