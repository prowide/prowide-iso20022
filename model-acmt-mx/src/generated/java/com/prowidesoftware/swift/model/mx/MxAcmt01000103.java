    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01000103 parse(String xml) {
        return ((MxAcmt01000103) MxReadImpl.parse(MxAcmt01000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01000103) MxReadImpl.parse(MxAcmt01000103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt01000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01000103 .class);
    }
