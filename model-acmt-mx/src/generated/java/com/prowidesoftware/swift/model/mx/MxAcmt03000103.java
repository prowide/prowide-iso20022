    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.030.001.03";
    ...
    public static MxAcmt03000103 parse(String xml) {
        return ((MxAcmt03000103) MxReadImpl.parse(MxAcmt03000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03000103) MxReadImpl.parse(MxAcmt03000103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt03000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03000103 .class);
    }
