    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.036.001.01";
    ...
    public static MxAcmt03600101 parse(String xml) {
        return ((MxAcmt03600101) MxReadImpl.parse(MxAcmt03600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03600101) MxReadImpl.parse(MxAcmt03600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt03600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03600101 .class);
    }
