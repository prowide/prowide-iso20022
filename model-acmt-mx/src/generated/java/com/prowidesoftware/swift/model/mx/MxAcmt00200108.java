    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00200108 parse(String xml) {
        return ((MxAcmt00200108) MxReadImpl.parse(MxAcmt00200108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00200108 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00200108) MxReadImpl.parse(MxAcmt00200108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00200108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00200108 .class);
    }
