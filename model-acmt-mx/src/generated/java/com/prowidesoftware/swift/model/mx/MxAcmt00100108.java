    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08";
    ...
    public static MxAcmt00100108 parse(String xml) {
        return ((MxAcmt00100108) MxReadImpl.parse(MxAcmt00100108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00100108 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00100108) MxReadImpl.parse(MxAcmt00100108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00100108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00100108 .class);
    }
