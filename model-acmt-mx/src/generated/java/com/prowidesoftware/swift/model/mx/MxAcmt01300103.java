    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.013.001.03";
    ...
    public static MxAcmt01300103 parse(String xml) {
        return ((MxAcmt01300103) MxReadImpl.parse(MxAcmt01300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01300103) MxReadImpl.parse(MxAcmt01300103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt01300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01300103 .class);
    }
