    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04";
    ...
    public static MxAcmt03100104 parse(String xml) {
        return ((MxAcmt03100104) MxReadImpl.parse(MxAcmt03100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03100104) MxReadImpl.parse(MxAcmt03100104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt03100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03100104 .class);
    }
