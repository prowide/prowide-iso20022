    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01700102 parse(String xml) {
        return ((MxAcmt01700102) MxReadImpl.parse(MxAcmt01700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01700102) MxReadImpl.parse(MxAcmt01700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt01700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01700102 .class);
    }
