    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00200106 parse(String xml) {
        return ((MxAcmt00200106) MxReadImpl.parse(MxAcmt00200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00200106) MxReadImpl.parse(MxAcmt00200106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00200106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00200106 .class);
    }
