    ...
    extends AbstractMX
{
    ...
    public static MxAcmt02400102 parse(String xml) {
        return ((MxAcmt02400102) MxReadImpl.parse(MxAcmt02400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02400102) MxReadImpl.parse(MxAcmt02400102 .class, xml, _classes, new MxReadParams(conf)));
    }
