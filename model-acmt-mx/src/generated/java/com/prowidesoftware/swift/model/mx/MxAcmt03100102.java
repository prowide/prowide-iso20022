...
/**
 * Class for acmt.031.001.02 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:acmt.031.001.02")
public class MxAcmt03100102
    extends AbstractMX
{
     ...
     * 
     */
    public MxAcmt03100102(final String xml) {
        this();
        MxAcmt03100102 tmp = parse(xml);
     ...
     * 
     */
    public MxAcmt03100102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AccountSwitchRequestBalanceTransferV02 }
     *     
     */
     ...
     *     
     */
    public MxAcmt03100102 setAcctSwtchReqBalTrf(AccountSwitchRequestBalanceTransferV02 value) {
    ...
    public static MxAcmt03100102 parse(String xml) {
        return ((MxAcmt03100102) MxReadImpl.parse(MxAcmt03100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03100102) MxReadImpl.parse(MxAcmt03100102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxAcmt03100102 parse(String xml, MxRead parserImpl) {
        return ((MxAcmt03100102) parserImpl.read(MxAcmt03100102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxAcmt03100102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxAcmt03100102 message
     * @return
     *     a new instance of MxAcmt03100102
     */
    public static final MxAcmt03100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03100102 .class);
    }
