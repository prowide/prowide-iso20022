...
/**
 * Class for acmt.031.001.03 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxAcmt03100103(final String xml) {
        this();
        MxAcmt03100103 tmp = parse(xml);
     ...
     * 
     */
    public MxAcmt03100103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AccountSwitchRequestBalanceTransferV03 }
     *     
     */
    public AccountSwitchRequestBalanceTransferV03 getAcctSwtchReqBalTrf() {
     ...
     *     
     */
    public MxAcmt03100103 setAcctSwtchReqBalTrf(AccountSwitchRequestBalanceTransferV03 value) {
    ...
    public static MxAcmt03100103 parse(String xml) {
        return ((MxAcmt03100103) MxReadImpl.parse(MxAcmt03100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03100103) MxReadImpl.parse(MxAcmt03100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxAcmt03100103 parse(String xml, MxRead parserImpl) {
        return ((MxAcmt03100103) parserImpl.read(MxAcmt03100103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxAcmt03100103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxAcmt03100103 message
     * @return
     *     a new instance of MxAcmt03100103
     */
    public static final MxAcmt03100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03100103 .class);
    }
