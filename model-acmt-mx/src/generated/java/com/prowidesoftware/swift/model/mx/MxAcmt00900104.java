    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00900104 parse(String xml) {
        return ((MxAcmt00900104) MxReadImpl.parse(MxAcmt00900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00900104) MxReadImpl.parse(MxAcmt00900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00900104 .class);
    }
