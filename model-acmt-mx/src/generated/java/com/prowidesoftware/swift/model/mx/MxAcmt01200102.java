    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01200102 parse(String xml) {
        return ((MxAcmt01200102) MxReadImpl.parse(MxAcmt01200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01200102) MxReadImpl.parse(MxAcmt01200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt01200102 fromJson(String json) {
