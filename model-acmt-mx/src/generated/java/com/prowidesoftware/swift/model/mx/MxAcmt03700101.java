    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.037.001.01";
    ...
    public static MxAcmt03700101 parse(String xml) {
        return ((MxAcmt03700101) MxReadImpl.parse(MxAcmt03700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03700101) MxReadImpl.parse(MxAcmt03700101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt03700101 fromJson(String json) {
