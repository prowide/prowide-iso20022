...
/**
 * Class for acmt.001.001.03 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxAcmt00100103(final String xml) {
        this();
        MxAcmt00100103 tmp = parse(xml);
     ...
     * 
     */
    public MxAcmt00100103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AccountOpeningInstructionV03 }
     *     
     */
    public AccountOpeningInstructionV03 getAcctOpngInstr() {
     ...
     *     
     */
    public MxAcmt00100103 setAcctOpngInstr(AccountOpeningInstructionV03 value) {
    ...
    public static MxAcmt00100103 parse(String xml) {
        return ((MxAcmt00100103) MxReadImpl.parse(MxAcmt00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00100103) MxReadImpl.parse(MxAcmt00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxAcmt00100103 parse(String xml, MxRead parserImpl) {
        return ((MxAcmt00100103) parserImpl.read(MxAcmt00100103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxAcmt00100103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxAcmt00100103 message
     * @return
     *     a new instance of MxAcmt00100103
     */
    public static final MxAcmt00100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00100103 .class);
    }
