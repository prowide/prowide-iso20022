    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.030.001.02";
    ...
    public static MxAcmt03000102 parse(String xml) {
        return ((MxAcmt03000102) MxReadImpl.parse(MxAcmt03000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03000102) MxReadImpl.parse(MxAcmt03000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt03000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03000102 .class);
    }
