    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:acmt.006.001.03";
    ...
    public static MxAcmt00600103 parse(String xml) {
        return ((MxAcmt00600103) MxReadImpl.parse(MxAcmt00600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00600103) MxReadImpl.parse(MxAcmt00600103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00600103 fromJson(String json) {
