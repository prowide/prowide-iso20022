    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:acmt.002.001.03";
    ...
    public static MxAcmt00200103 parse(String xml) {
        return ((MxAcmt00200103) MxReadImpl.parse(MxAcmt00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00200103) MxReadImpl.parse(MxAcmt00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00200103 .class);
    }
