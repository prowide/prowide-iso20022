    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.024.001.04";
    ...
    public static MxAcmt02400104 parse(String xml) {
        return ((MxAcmt02400104) MxReadImpl.parse(MxAcmt02400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02400104) MxReadImpl.parse(MxAcmt02400104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt02400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02400104 .class);
    }
