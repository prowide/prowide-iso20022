    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:acmt.002.001.05";
    ...
    public static MxAcmt00200105 parse(String xml) {
        return ((MxAcmt00200105) MxReadImpl.parse(MxAcmt00200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00200105) MxReadImpl.parse(MxAcmt00200105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00200105 fromJson(String json) {
