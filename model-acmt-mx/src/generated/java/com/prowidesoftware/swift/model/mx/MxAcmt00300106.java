    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:acmt.003.001.06";
    ...
    public static MxAcmt00300106 parse(String xml) {
        return ((MxAcmt00300106) MxReadImpl.parse(MxAcmt00300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00300106) MxReadImpl.parse(MxAcmt00300106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00300106 fromJson(String json) {
