    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.007.001.02";
    ...
    public static MxAcmt00700102 parse(String xml) {
        return ((MxAcmt00700102) MxReadImpl.parse(MxAcmt00700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00700102) MxReadImpl.parse(MxAcmt00700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00700102 .class);
    }
