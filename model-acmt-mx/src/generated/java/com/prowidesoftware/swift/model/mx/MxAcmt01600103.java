    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01600103 parse(String xml) {
        return ((MxAcmt01600103) MxReadImpl.parse(MxAcmt01600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01600103) MxReadImpl.parse(MxAcmt01600103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt01600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01600103 .class);
    }
