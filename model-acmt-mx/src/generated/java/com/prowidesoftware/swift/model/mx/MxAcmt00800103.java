    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.008.001.03";
    ...
    public static MxAcmt00800103 parse(String xml) {
        return ((MxAcmt00800103) MxReadImpl.parse(MxAcmt00800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00800103) MxReadImpl.parse(MxAcmt00800103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00800103 .class);
    }
