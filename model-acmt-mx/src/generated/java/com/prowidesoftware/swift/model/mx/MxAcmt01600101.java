    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.016.001.01";
    ...
    public static MxAcmt01600101 parse(String xml) {
        return ((MxAcmt01600101) MxReadImpl.parse(MxAcmt01600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01600101) MxReadImpl.parse(MxAcmt01600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt01600101 fromJson(String json) {
