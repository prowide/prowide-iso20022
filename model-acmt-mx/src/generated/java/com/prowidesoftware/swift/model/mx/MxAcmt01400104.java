    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01400104 parse(String xml) {
        return ((MxAcmt01400104) MxReadImpl.parse(MxAcmt01400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01400104) MxReadImpl.parse(MxAcmt01400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt01400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01400104 .class);
    }
