    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:acmt.005.001.02";
    ...
    public static MxAcmt00500102 parse(String xml) {
        return ((MxAcmt00500102) MxReadImpl.parse(MxAcmt00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00500102) MxReadImpl.parse(MxAcmt00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00500102 .class);
    }
