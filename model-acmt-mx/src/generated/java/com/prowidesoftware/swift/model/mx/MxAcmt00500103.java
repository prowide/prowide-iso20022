    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00500103 parse(String xml) {
        return ((MxAcmt00500103) MxReadImpl.parse(MxAcmt00500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00500103) MxReadImpl.parse(MxAcmt00500103 .class, xml, _classes, new MxReadParams(conf)));
    }
