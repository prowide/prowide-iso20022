    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00400105 parse(String xml) {
        return ((MxAcmt00400105) MxReadImpl.parse(MxAcmt00400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00400105) MxReadImpl.parse(MxAcmt00400105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00400105 .class);
    }
