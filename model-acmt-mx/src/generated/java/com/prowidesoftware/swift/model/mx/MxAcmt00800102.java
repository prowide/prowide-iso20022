    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00800102 parse(String xml) {
        return ((MxAcmt00800102) MxReadImpl.parse(MxAcmt00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00800102) MxReadImpl.parse(MxAcmt00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00800102 .class);
    }
