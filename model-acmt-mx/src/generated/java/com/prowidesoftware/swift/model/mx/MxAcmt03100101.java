    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.031.001.01";
    ...
    public static MxAcmt03100101 parse(String xml) {
        return ((MxAcmt03100101) MxReadImpl.parse(MxAcmt03100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03100101) MxReadImpl.parse(MxAcmt03100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt03100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03100101 .class);
    }
