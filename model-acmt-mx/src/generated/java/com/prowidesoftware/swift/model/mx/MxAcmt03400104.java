...
/**
 * Class for acmt.034.001.04 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxAcmt03400104(final String xml) {
        this();
        MxAcmt03400104 tmp = parse(xml);
     ...
     * 
     */
    public MxAcmt03400104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AccountSwitchRequestPaymentV04 }
     *     
     */
    public AccountSwitchRequestPaymentV04 getAcctSwtchReqPmt() {
     ...
     *     
     */
    public MxAcmt03400104 setAcctSwtchReqPmt(AccountSwitchRequestPaymentV04 value) {
    ...
    public static MxAcmt03400104 parse(String xml) {
        return ((MxAcmt03400104) MxReadImpl.parse(MxAcmt03400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03400104) MxReadImpl.parse(MxAcmt03400104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxAcmt03400104 parse(String xml, MxRead parserImpl) {
        return ((MxAcmt03400104) parserImpl.read(MxAcmt03400104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxAcmt03400104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxAcmt03400104 message
     * @return
     *     a new instance of MxAcmt03400104
     */
    public static final MxAcmt03400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03400104 .class);
    }
