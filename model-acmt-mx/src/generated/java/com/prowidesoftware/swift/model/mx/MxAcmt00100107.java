    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.001.001.07";
    ...
    public static MxAcmt00100107 parse(String xml) {
        return ((MxAcmt00100107) MxReadImpl.parse(MxAcmt00100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00100107) MxReadImpl.parse(MxAcmt00100107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00100107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00100107 .class);
    }
