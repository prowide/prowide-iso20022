    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.009.001.03";
    ...
    public static MxAcmt00900103 parse(String xml) {
        return ((MxAcmt00900103) MxReadImpl.parse(MxAcmt00900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00900103) MxReadImpl.parse(MxAcmt00900103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00900103 fromJson(String json) {
