    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:acmt.005.001.01";
    ...
    public static MxAcmt00500101 parse(String xml) {
        return ((MxAcmt00500101) MxReadImpl.parse(MxAcmt00500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00500101) MxReadImpl.parse(MxAcmt00500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00500101 .class);
    }
