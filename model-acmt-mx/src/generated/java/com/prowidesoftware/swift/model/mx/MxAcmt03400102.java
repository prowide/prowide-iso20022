    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.034.001.02";
    ...
    public static MxAcmt03400102 parse(String xml) {
        return ((MxAcmt03400102) MxReadImpl.parse(MxAcmt03400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03400102) MxReadImpl.parse(MxAcmt03400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt03400102 fromJson(String json) {
