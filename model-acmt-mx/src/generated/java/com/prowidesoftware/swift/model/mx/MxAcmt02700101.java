    ...
    extends AbstractMX
{
    ...
    public static MxAcmt02700101 parse(String xml) {
        return ((MxAcmt02700101) MxReadImpl.parse(MxAcmt02700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02700101) MxReadImpl.parse(MxAcmt02700101 .class, xml, _classes, new MxReadParams(conf)));
    }
