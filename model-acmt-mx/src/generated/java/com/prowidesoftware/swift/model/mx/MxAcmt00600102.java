    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00600102 parse(String xml) {
        return ((MxAcmt00600102) MxReadImpl.parse(MxAcmt00600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00600102) MxReadImpl.parse(MxAcmt00600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00600102 fromJson(String json) {
