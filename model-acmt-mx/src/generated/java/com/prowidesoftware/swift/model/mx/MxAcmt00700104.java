    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00700104 parse(String xml) {
        return ((MxAcmt00700104) MxReadImpl.parse(MxAcmt00700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00700104) MxReadImpl.parse(MxAcmt00700104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00700104 .class);
    }
