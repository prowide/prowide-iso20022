    ...
    extends AbstractMX
{
    ...
    public static MxAcmt02200104 parse(String xml) {
        return ((MxAcmt02200104) MxReadImpl.parse(MxAcmt02200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02200104) MxReadImpl.parse(MxAcmt02200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt02200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02200104 .class);
    }
