    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01400102 parse(String xml) {
        return ((MxAcmt01400102) MxReadImpl.parse(MxAcmt01400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01400102) MxReadImpl.parse(MxAcmt01400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt01400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01400102 .class);
    }
