    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01400105 parse(String xml) {
        return ((MxAcmt01400105) MxReadImpl.parse(MxAcmt01400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01400105) MxReadImpl.parse(MxAcmt01400105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt01400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01400105 .class);
    }
