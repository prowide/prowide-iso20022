    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00600105 parse(String xml) {
        return ((MxAcmt00600105) MxReadImpl.parse(MxAcmt00600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00600105) MxReadImpl.parse(MxAcmt00600105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00600105 .class);
    }
