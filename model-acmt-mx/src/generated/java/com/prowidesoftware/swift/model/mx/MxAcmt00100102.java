    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:acmt.001.001.02";
    ...
    public static MxAcmt00100102 parse(String xml) {
        return ((MxAcmt00100102) MxReadImpl.parse(MxAcmt00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00100102) MxReadImpl.parse(MxAcmt00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00100102 .class);
    }
