    ...
    extends AbstractMX
{
    ...
    public static MxAcmt03200105 parse(String xml) {
        return ((MxAcmt03200105) MxReadImpl.parse(MxAcmt03200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03200105) MxReadImpl.parse(MxAcmt03200105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt03200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03200105 .class);
    }
