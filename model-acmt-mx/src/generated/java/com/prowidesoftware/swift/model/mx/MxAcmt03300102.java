    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.033.001.02";
    ...
    public static MxAcmt03300102 parse(String xml) {
        return ((MxAcmt03300102) MxReadImpl.parse(MxAcmt03300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03300102) MxReadImpl.parse(MxAcmt03300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt03300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03300102 .class);
    }
