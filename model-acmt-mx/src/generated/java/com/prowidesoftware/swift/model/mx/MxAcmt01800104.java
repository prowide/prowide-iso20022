    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.018.001.04";
    ...
    public static MxAcmt01800104 parse(String xml) {
        return ((MxAcmt01800104) MxReadImpl.parse(MxAcmt01800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01800104) MxReadImpl.parse(MxAcmt01800104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt01800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01800104 .class);
    }
