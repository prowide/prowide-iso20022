    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:acmt.006.001.01";
    ...
    public static MxAcmt00600101 parse(String xml) {
        return ((MxAcmt00600101) MxReadImpl.parse(MxAcmt00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00600101) MxReadImpl.parse(MxAcmt00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00600101 .class);
    }
