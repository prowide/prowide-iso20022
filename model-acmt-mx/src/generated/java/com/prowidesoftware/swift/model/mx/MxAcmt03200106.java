    ...
    extends AbstractMX
{
    ...
    public static MxAcmt03200106 parse(String xml) {
        return ((MxAcmt03200106) MxReadImpl.parse(MxAcmt03200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03200106) MxReadImpl.parse(MxAcmt03200106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt03200106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03200106 .class);
    }
