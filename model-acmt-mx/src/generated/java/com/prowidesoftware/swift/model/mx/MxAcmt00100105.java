    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00100105 parse(String xml) {
        return ((MxAcmt00100105) MxReadImpl.parse(MxAcmt00100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00100105) MxReadImpl.parse(MxAcmt00100105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00100105 .class);
    }
