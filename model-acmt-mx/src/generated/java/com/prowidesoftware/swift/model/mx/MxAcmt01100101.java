    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01100101 parse(String xml) {
        return ((MxAcmt01100101) MxReadImpl.parse(MxAcmt01100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01100101) MxReadImpl.parse(MxAcmt01100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt01100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01100101 .class);
    }
