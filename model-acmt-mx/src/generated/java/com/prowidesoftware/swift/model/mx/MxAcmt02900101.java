    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.029.001.01";
    ...
    public static MxAcmt02900101 parse(String xml) {
        return ((MxAcmt02900101) MxReadImpl.parse(MxAcmt02900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02900101) MxReadImpl.parse(MxAcmt02900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt02900101 fromJson(String json) {
