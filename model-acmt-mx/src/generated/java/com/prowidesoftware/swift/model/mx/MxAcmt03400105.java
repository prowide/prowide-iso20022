    ...
    extends AbstractMX
{
    ...
    public static MxAcmt03400105 parse(String xml) {
        return ((MxAcmt03400105) MxReadImpl.parse(MxAcmt03400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03400105) MxReadImpl.parse(MxAcmt03400105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt03400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03400105 .class);
    }
