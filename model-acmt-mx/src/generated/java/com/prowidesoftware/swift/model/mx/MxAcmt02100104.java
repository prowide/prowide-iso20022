    ...
    extends AbstractMX
{
    ...
    public static MxAcmt02100104 parse(String xml) {
        return ((MxAcmt02100104) MxReadImpl.parse(MxAcmt02100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02100104) MxReadImpl.parse(MxAcmt02100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt02100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02100104 .class);
    }
