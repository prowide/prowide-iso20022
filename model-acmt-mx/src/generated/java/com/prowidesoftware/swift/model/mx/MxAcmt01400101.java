...
/**
 * Class for acmt.014.001.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxAcmt01400101(final String xml) {
        this();
        MxAcmt01400101 tmp = parse(xml);
     ...
     * 
     */
    public MxAcmt01400101(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxAcmt01400101 setAcctRpt(AccountReportV01 value) {
        this.acctRpt = value;
        return this;
    }
     ...
     */
    public static MxAcmt01400101 parse(String xml, MxRead parserImpl) {
        return ((MxAcmt01400101) parserImpl.read(MxAcmt01400101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxAcmt01400101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxAcmt01400101 message
     * @return
