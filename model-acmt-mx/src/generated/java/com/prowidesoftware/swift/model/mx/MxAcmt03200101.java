    ...
    extends AbstractMX
{
    ...
    public static MxAcmt03200101 parse(String xml) {
        return ((MxAcmt03200101) MxReadImpl.parse(MxAcmt03200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03200101) MxReadImpl.parse(MxAcmt03200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt03200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03200101 .class);
    }
