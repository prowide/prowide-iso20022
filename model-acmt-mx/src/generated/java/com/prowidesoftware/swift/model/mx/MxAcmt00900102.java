    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00900102 parse(String xml) {
        return ((MxAcmt00900102) MxReadImpl.parse(MxAcmt00900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00900102) MxReadImpl.parse(MxAcmt00900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00900102 .class);
    }
