    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.007.001.01";
    ...
    public static MxAcmt00700101 parse(String xml) {
        return ((MxAcmt00700101) MxReadImpl.parse(MxAcmt00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00700101) MxReadImpl.parse(MxAcmt00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00700101 .class);
    }
