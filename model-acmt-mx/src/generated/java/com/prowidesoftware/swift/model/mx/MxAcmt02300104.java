    ...
    extends AbstractMX
{
    ...
    public static MxAcmt02300104 parse(String xml) {
        return ((MxAcmt02300104) MxReadImpl.parse(MxAcmt02300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02300104) MxReadImpl.parse(MxAcmt02300104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt02300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02300104 .class);
    }
