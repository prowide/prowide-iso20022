    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:acmt.004.001.03";
    ...
    public static MxAcmt00400103 parse(String xml) {
        return ((MxAcmt00400103) MxReadImpl.parse(MxAcmt00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00400103) MxReadImpl.parse(MxAcmt00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00400103 .class);
    }
