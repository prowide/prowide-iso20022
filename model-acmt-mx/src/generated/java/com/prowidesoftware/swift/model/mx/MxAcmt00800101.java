    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00800101 parse(String xml) {
        return ((MxAcmt00800101) MxReadImpl.parse(MxAcmt00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00800101) MxReadImpl.parse(MxAcmt00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00800101 .class);
    }
