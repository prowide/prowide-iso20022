    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00100101 parse(String xml) {
        return ((MxAcmt00100101) MxReadImpl.parse(MxAcmt00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00100101) MxReadImpl.parse(MxAcmt00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00100101 .class);
    }
