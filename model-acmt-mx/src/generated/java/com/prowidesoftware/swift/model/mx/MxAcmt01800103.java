    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01800103 parse(String xml) {
        return ((MxAcmt01800103) MxReadImpl.parse(MxAcmt01800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01800103) MxReadImpl.parse(MxAcmt01800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt01800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01800103 .class);
    }
