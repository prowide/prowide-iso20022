    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00400101 parse(String xml) {
        return ((MxAcmt00400101) MxReadImpl.parse(MxAcmt00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00400101) MxReadImpl.parse(MxAcmt00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
