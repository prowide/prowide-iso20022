    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.021.001.03";
    ...
    public static MxAcmt02100103 parse(String xml) {
        return ((MxAcmt02100103) MxReadImpl.parse(MxAcmt02100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02100103) MxReadImpl.parse(MxAcmt02100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt02100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02100103 .class);
    }
