    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00300107 parse(String xml) {
        return ((MxAcmt00300107) MxReadImpl.parse(MxAcmt00300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00300107) MxReadImpl.parse(MxAcmt00300107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00300107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00300107 .class);
    }
