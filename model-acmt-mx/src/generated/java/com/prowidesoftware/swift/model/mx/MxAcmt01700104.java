    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01700104 parse(String xml) {
        return ((MxAcmt01700104) MxReadImpl.parse(MxAcmt01700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01700104) MxReadImpl.parse(MxAcmt01700104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt01700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01700104 .class);
    }
