    ...
    extends AbstractMX
{
    ...
    public static MxAcmt03400103 parse(String xml) {
        return ((MxAcmt03400103) MxReadImpl.parse(MxAcmt03400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03400103) MxReadImpl.parse(MxAcmt03400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt03400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03400103 .class);
    }
