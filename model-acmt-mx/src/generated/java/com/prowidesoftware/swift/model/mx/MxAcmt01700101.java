    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01700101 parse(String xml) {
        return ((MxAcmt01700101) MxReadImpl.parse(MxAcmt01700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01700101) MxReadImpl.parse(MxAcmt01700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt01700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01700101 .class);
    }
