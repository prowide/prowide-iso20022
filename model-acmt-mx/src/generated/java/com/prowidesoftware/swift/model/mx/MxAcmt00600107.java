    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00600107 parse(String xml) {
        return ((MxAcmt00600107) MxReadImpl.parse(MxAcmt00600107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00600107 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00600107) MxReadImpl.parse(MxAcmt00600107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00600107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00600107 .class);
    }
