...
/**
 * Class for acmt.032.001.02 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxAcmt03200102(final String xml) {
        this();
        MxAcmt03200102 tmp = parse(xml);
     ...
     * 
     */
    public MxAcmt03200102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AccountSwitchBalanceTransferAcknowledgementV02 }
     *     
     */
    public AccountSwitchBalanceTransferAcknowledgementV02 getAcctSwtchBalTrfAck() {
     ...
     *     
     */
    public MxAcmt03200102 setAcctSwtchBalTrfAck(AccountSwitchBalanceTransferAcknowledgementV02 value) {
    ...
    public static MxAcmt03200102 parse(String xml) {
        return ((MxAcmt03200102) MxReadImpl.parse(MxAcmt03200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03200102) MxReadImpl.parse(MxAcmt03200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxAcmt03200102 parse(String xml, MxRead parserImpl) {
        return ((MxAcmt03200102) parserImpl.read(MxAcmt03200102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxAcmt03200102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxAcmt03200102 message
     * @return
     *     a new instance of MxAcmt03200102
     */
    public static final MxAcmt03200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03200102 .class);
    }
