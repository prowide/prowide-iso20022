    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00500105 parse(String xml) {
        return ((MxAcmt00500105) MxReadImpl.parse(MxAcmt00500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00500105) MxReadImpl.parse(MxAcmt00500105 .class, xml, _classes, new MxReadParams(conf)));
    }
