    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00400106 parse(String xml) {
        return ((MxAcmt00400106) MxReadImpl.parse(MxAcmt00400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00400106) MxReadImpl.parse(MxAcmt00400106 .class, xml, _classes, new MxReadParams(conf)));
    }
