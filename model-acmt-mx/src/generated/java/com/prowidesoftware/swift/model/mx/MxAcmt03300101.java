    ...
    extends AbstractMX
{
    ...
    public static MxAcmt03300101 parse(String xml) {
        return ((MxAcmt03300101) MxReadImpl.parse(MxAcmt03300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03300101) MxReadImpl.parse(MxAcmt03300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt03300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03300101 .class);
    }
