...
/**
 * Class for acmt.002.001.04 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:swift:xsd:acmt.002.001.04")
public class MxAcmt00200104
    extends AbstractMX
{
     ...
     * 
     */
    public MxAcmt00200104(final String xml) {
        this();
        MxAcmt00200104 tmp = parse(xml);
     ...
     * 
     */
    public MxAcmt00200104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AccountDetailsConfirmationV04 }
     *     
     */
     ...
     *     
     */
    public MxAcmt00200104 setAcctDtlsConf(AccountDetailsConfirmationV04 value) {
    ...
    public static MxAcmt00200104 parse(String xml) {
        return ((MxAcmt00200104) MxReadImpl.parse(MxAcmt00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00200104) MxReadImpl.parse(MxAcmt00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxAcmt00200104 parse(String xml, MxRead parserImpl) {
        return ((MxAcmt00200104) parserImpl.read(MxAcmt00200104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxAcmt00200104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxAcmt00200104 message
     * @return
     *     a new instance of MxAcmt00200104
     */
    public static final MxAcmt00200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00200104 .class);
    }
