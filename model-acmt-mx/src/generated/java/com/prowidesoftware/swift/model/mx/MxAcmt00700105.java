    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.007.001.05";
    ...
    public static MxAcmt00700105 parse(String xml) {
        return ((MxAcmt00700105) MxReadImpl.parse(MxAcmt00700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00700105) MxReadImpl.parse(MxAcmt00700105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00700105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00700105 .class);
    }
