    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.031.001.05";
    ...
    public static MxAcmt03100105 parse(String xml) {
        return ((MxAcmt03100105) MxReadImpl.parse(MxAcmt03100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03100105) MxReadImpl.parse(MxAcmt03100105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt03100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03100105 .class);
    }
