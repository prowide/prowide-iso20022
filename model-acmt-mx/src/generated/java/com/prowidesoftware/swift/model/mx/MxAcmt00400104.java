    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:acmt.004.001.04";
    ...
    public static MxAcmt00400104 parse(String xml) {
        return ((MxAcmt00400104) MxReadImpl.parse(MxAcmt00400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00400104) MxReadImpl.parse(MxAcmt00400104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00400104 .class);
    }
