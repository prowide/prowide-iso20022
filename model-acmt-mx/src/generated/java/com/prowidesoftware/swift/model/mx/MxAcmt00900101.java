    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00900101 parse(String xml) {
        return ((MxAcmt00900101) MxReadImpl.parse(MxAcmt00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00900101) MxReadImpl.parse(MxAcmt00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00900101 .class);
    }
