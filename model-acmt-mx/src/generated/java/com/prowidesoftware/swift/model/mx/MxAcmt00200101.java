    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:acmt.002.001.01";
    ...
    public static MxAcmt00200101 parse(String xml) {
        return ((MxAcmt00200101) MxReadImpl.parse(MxAcmt00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00200101) MxReadImpl.parse(MxAcmt00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00200101 .class);
    }
