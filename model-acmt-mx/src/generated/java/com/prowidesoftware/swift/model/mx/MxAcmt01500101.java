    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.015.001.01";
    ...
    public static MxAcmt01500101 parse(String xml) {
        return ((MxAcmt01500101) MxReadImpl.parse(MxAcmt01500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01500101) MxReadImpl.parse(MxAcmt01500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt01500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01500101 .class);
    }
