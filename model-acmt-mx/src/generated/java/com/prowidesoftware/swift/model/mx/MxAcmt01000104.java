    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01000104 parse(String xml) {
        return ((MxAcmt01000104) MxReadImpl.parse(MxAcmt01000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01000104) MxReadImpl.parse(MxAcmt01000104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt01000104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01000104 .class);
    }
