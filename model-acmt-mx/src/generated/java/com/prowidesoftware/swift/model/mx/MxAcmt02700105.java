    ...
    extends AbstractMX
{
    ...
    public static MxAcmt02700105 parse(String xml) {
        return ((MxAcmt02700105) MxReadImpl.parse(MxAcmt02700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02700105) MxReadImpl.parse(MxAcmt02700105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt02700105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02700105 .class);
    }
