    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01600104 parse(String xml) {
        return ((MxAcmt01600104) MxReadImpl.parse(MxAcmt01600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01600104) MxReadImpl.parse(MxAcmt01600104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt01600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01600104 .class);
    }
