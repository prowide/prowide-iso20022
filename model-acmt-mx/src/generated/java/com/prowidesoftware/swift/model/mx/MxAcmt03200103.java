    ...
    extends AbstractMX
{
    ...
    public static MxAcmt03200103 parse(String xml) {
        return ((MxAcmt03200103) MxReadImpl.parse(MxAcmt03200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03200103) MxReadImpl.parse(MxAcmt03200103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt03200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03200103 .class);
    }
