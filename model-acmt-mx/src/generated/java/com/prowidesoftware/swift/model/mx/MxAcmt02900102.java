...
/**
 * Class for acmt.029.001.02 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxAcmt02900102(final String xml) {
        this();
        MxAcmt02900102 tmp = parse(xml);
     ...
     * 
     */
    public MxAcmt02900102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AccountSwitchCancelExistingPaymentV02 }
     *     
     */
    public AccountSwitchCancelExistingPaymentV02 getAcctSwtchCclExstgPmt() {
     ...
     *     
     */
    public MxAcmt02900102 setAcctSwtchCclExstgPmt(AccountSwitchCancelExistingPaymentV02 value) {
    ...
    public static MxAcmt02900102 parse(String xml) {
        return ((MxAcmt02900102) MxReadImpl.parse(MxAcmt02900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02900102) MxReadImpl.parse(MxAcmt02900102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxAcmt02900102 parse(String xml, MxRead parserImpl) {
        return ((MxAcmt02900102) parserImpl.read(MxAcmt02900102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxAcmt02900102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxAcmt02900102 message
     * @return
     *     a new instance of MxAcmt02900102
     */
    public static final MxAcmt02900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02900102 .class);
    }
