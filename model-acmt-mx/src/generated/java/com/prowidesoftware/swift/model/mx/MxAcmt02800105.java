    ...
    extends AbstractMX
{
    ...
    public static MxAcmt02800105 parse(String xml) {
        return ((MxAcmt02800105) MxReadImpl.parse(MxAcmt02800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02800105) MxReadImpl.parse(MxAcmt02800105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt02800105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02800105 .class);
    }
