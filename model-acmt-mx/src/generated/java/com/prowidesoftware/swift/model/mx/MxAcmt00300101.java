    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:acmt.003.001.01";
    ...
    public static MxAcmt00300101 parse(String xml) {
        return ((MxAcmt00300101) MxReadImpl.parse(MxAcmt00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00300101) MxReadImpl.parse(MxAcmt00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00300101 .class);
    }
