    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01500102 parse(String xml) {
        return ((MxAcmt01500102) MxReadImpl.parse(MxAcmt01500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01500102) MxReadImpl.parse(MxAcmt01500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt01500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01500102 .class);
    }
