    ...
    extends AbstractMX
{
    ...
    public static MxAcmt03400101 parse(String xml) {
        return ((MxAcmt03400101) MxReadImpl.parse(MxAcmt03400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03400101) MxReadImpl.parse(MxAcmt03400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt03400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03400101 .class);
    }
