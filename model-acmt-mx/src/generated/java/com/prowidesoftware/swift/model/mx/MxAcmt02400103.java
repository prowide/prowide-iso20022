    ...
    extends AbstractMX
{
    ...
    public static MxAcmt02400103 parse(String xml) {
        return ((MxAcmt02400103) MxReadImpl.parse(MxAcmt02400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02400103) MxReadImpl.parse(MxAcmt02400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt02400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02400103 .class);
    }
