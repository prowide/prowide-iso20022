    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.032.001.04";
    ...
    public static MxAcmt03200104 parse(String xml) {
        return ((MxAcmt03200104) MxReadImpl.parse(MxAcmt03200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03200104) MxReadImpl.parse(MxAcmt03200104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt03200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03200104 .class);
    }
