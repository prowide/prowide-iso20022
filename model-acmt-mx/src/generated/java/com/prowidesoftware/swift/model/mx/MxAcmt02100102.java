    ...
    extends AbstractMX
{
    ...
    public static MxAcmt02100102 parse(String xml) {
        return ((MxAcmt02100102) MxReadImpl.parse(MxAcmt02100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02100102) MxReadImpl.parse(MxAcmt02100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt02100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02100102 .class);
    }
