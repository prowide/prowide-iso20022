    ...
    extends AbstractMX
{
    ...
    public static MxAcmt01900101 parse(String xml) {
        return ((MxAcmt01900101) MxReadImpl.parse(MxAcmt01900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01900101) MxReadImpl.parse(MxAcmt01900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt01900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01900101 .class);
    }
