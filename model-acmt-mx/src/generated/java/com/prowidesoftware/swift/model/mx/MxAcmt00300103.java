    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00300103 parse(String xml) {
        return ((MxAcmt00300103) MxReadImpl.parse(MxAcmt00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00300103) MxReadImpl.parse(MxAcmt00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00300103 .class);
    }
