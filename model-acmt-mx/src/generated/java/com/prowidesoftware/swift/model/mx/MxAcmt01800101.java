    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.018.001.01";
    ...
    public static MxAcmt01800101 parse(String xml) {
        return ((MxAcmt01800101) MxReadImpl.parse(MxAcmt01800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01800101) MxReadImpl.parse(MxAcmt01800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt01800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01800101 .class);
    }
