    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.016.001.02";
    ...
    public static MxAcmt01600102 parse(String xml) {
        return ((MxAcmt01600102) MxReadImpl.parse(MxAcmt01600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01600102) MxReadImpl.parse(MxAcmt01600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt01600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01600102 .class);
    }
