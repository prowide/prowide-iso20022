    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.029.001.05";
    ...
    public static MxAcmt02900105 parse(String xml) {
        return ((MxAcmt02900105) MxReadImpl.parse(MxAcmt02900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02900105) MxReadImpl.parse(MxAcmt02900105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt02900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02900105 .class);
    }
