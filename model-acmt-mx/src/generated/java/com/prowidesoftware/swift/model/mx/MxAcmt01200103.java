    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.012.001.03";
    ...
    public static MxAcmt01200103 parse(String xml) {
        return ((MxAcmt01200103) MxReadImpl.parse(MxAcmt01200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01200103) MxReadImpl.parse(MxAcmt01200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt01200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01200103 .class);
    }
