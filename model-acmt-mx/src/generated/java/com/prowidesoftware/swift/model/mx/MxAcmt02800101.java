    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.028.001.01";
    ...
    public static MxAcmt02800101 parse(String xml) {
        return ((MxAcmt02800101) MxReadImpl.parse(MxAcmt02800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02800101) MxReadImpl.parse(MxAcmt02800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt02800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02800101 .class);
    }
