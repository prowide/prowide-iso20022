...
/**
 * Class for acmt.027.001.03 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxAcmt02700103(final String xml) {
        this();
        MxAcmt02700103 tmp = parse(xml);
     ...
     * 
     */
    public MxAcmt02700103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AccountSwitchInformationRequestV03 }
     *     
     */
    public AccountSwitchInformationRequestV03 getAcctSwtchInfReq() {
     ...
     *     
     */
    public MxAcmt02700103 setAcctSwtchInfReq(AccountSwitchInformationRequestV03 value) {
    ...
    public static MxAcmt02700103 parse(String xml) {
        return ((MxAcmt02700103) MxReadImpl.parse(MxAcmt02700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02700103) MxReadImpl.parse(MxAcmt02700103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxAcmt02700103 parse(String xml, MxRead parserImpl) {
        return ((MxAcmt02700103) parserImpl.read(MxAcmt02700103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxAcmt02700103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxAcmt02700103 message
     * @return
     *     a new instance of MxAcmt02700103
     */
    public static final MxAcmt02700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02700103 .class);
    }
