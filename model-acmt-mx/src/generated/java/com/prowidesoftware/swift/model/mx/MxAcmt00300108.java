    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00300108 parse(String xml) {
        return ((MxAcmt00300108) MxReadImpl.parse(MxAcmt00300108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00300108 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00300108) MxReadImpl.parse(MxAcmt00300108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt00300108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00300108 .class);
    }
