    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:acmt.003.001.02";
    ...
    public static MxAcmt00300102 parse(String xml) {
        return ((MxAcmt00300102) MxReadImpl.parse(MxAcmt00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00300102) MxReadImpl.parse(MxAcmt00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00300102 .class);
    }
