...
/**
 * Class for acmt.028.001.02 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxAcmt02800102(final String xml) {
        this();
        MxAcmt02800102 tmp = parse(xml);
     ...
     * 
     */
    public MxAcmt02800102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AccountSwitchInformationResponseV02 }
     *     
     */
    public AccountSwitchInformationResponseV02 getAcctSwtchInfRspn() {
     ...
     *     
     */
    public MxAcmt02800102 setAcctSwtchInfRspn(AccountSwitchInformationResponseV02 value) {
    ...
    public static MxAcmt02800102 parse(String xml) {
        return ((MxAcmt02800102) MxReadImpl.parse(MxAcmt02800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02800102) MxReadImpl.parse(MxAcmt02800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxAcmt02800102 parse(String xml, MxRead parserImpl) {
        return ((MxAcmt02800102) parserImpl.read(MxAcmt02800102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxAcmt02800102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxAcmt02800102 message
     * @return
     *     a new instance of MxAcmt02800102
     */
    public static final MxAcmt02800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02800102 .class);
    }
