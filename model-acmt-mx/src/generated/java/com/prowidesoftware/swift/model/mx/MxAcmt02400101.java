    ...
    extends AbstractMX
{
    ...
    public static MxAcmt02400101 parse(String xml) {
        return ((MxAcmt02400101) MxReadImpl.parse(MxAcmt02400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02400101) MxReadImpl.parse(MxAcmt02400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt02400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02400101 .class);
    }
