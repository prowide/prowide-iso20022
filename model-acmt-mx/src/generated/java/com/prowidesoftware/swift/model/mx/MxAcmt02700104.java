    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.027.001.04";
    ...
    public static MxAcmt02700104 parse(String xml) {
        return ((MxAcmt02700104) MxReadImpl.parse(MxAcmt02700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02700104) MxReadImpl.parse(MxAcmt02700104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt02700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02700104 .class);
    }
