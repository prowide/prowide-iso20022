    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.035.001.01";
    ...
    public static MxAcmt03500101 parse(String xml) {
        return ((MxAcmt03500101) MxReadImpl.parse(MxAcmt03500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt03500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt03500101) MxReadImpl.parse(MxAcmt03500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt03500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt03500101 .class);
    }
