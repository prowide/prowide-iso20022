    ...
    extends AbstractMX
{
    ...
    public static MxAcmt02900104 parse(String xml) {
        return ((MxAcmt02900104) MxReadImpl.parse(MxAcmt02900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02900104) MxReadImpl.parse(MxAcmt02900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt02900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02900104 .class);
    }
