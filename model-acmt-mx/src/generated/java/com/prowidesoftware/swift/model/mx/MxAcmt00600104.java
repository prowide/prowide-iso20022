    ...
    extends AbstractMX
{
    ...
    public static MxAcmt00600104 parse(String xml) {
        return ((MxAcmt00600104) MxReadImpl.parse(MxAcmt00600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00600104) MxReadImpl.parse(MxAcmt00600104 .class, xml, _classes, new MxReadParams(conf)));
    }
