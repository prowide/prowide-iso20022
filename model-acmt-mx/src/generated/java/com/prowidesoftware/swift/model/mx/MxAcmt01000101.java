    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.010.001.01";
    ...
    public static MxAcmt01000101 parse(String xml) {
        return ((MxAcmt01000101) MxReadImpl.parse(MxAcmt01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt01000101) MxReadImpl.parse(MxAcmt01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt01000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt01000101 .class);
    }
