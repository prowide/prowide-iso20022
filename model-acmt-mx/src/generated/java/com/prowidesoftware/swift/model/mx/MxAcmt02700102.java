    ...
    extends AbstractMX
{
    ...
    public static MxAcmt02700102 parse(String xml) {
        return ((MxAcmt02700102) MxReadImpl.parse(MxAcmt02700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt02700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt02700102) MxReadImpl.parse(MxAcmt02700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAcmt02700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt02700102 .class);
    }
