    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:acmt.008.001.04";
    ...
    public static MxAcmt00800104 parse(String xml) {
        return ((MxAcmt00800104) MxReadImpl.parse(MxAcmt00800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAcmt00800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxAcmt00800104) MxReadImpl.parse(MxAcmt00800104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAcmt00800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAcmt00800104 .class);
    }
