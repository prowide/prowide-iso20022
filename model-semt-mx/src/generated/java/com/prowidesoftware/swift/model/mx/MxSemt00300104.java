    ...
    extends AbstractMX
{
    ...
    public static MxSemt00300104 parse(String xml) {
        return ((MxSemt00300104) MxReadImpl.parse(MxSemt00300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300104) MxReadImpl.parse(MxSemt00300104 .class, xml, _classes, new MxReadParams(conf)));
    }
