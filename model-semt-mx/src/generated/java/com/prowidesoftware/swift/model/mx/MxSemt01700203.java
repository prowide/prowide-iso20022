    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.017.002.03";
    ...
    public static MxSemt01700203 parse(String xml) {
        return ((MxSemt01700203) MxReadImpl.parse(MxSemt01700203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01700203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700203) MxReadImpl.parse(MxSemt01700203 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01700203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01700203 .class);
    }
