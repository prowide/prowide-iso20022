    ...
    extends AbstractMX
{
    ...
    public static MxSemt00100103 parse(String xml) {
        return ((MxSemt00100103) MxReadImpl.parse(MxSemt00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00100103) MxReadImpl.parse(MxSemt00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
