    ...
    extends AbstractMX
{
    ...
    public static MxSemt02200205 parse(String xml) {
        return ((MxSemt02200205) MxReadImpl.parse(MxSemt02200205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02200205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02200205) MxReadImpl.parse(MxSemt02200205 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt02200205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02200205 .class);
    }
