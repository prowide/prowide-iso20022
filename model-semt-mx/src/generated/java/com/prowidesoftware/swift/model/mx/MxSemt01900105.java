    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.019.001.05";
    ...
    public static MxSemt01900105 parse(String xml) {
        return ((MxSemt01900105) MxReadImpl.parse(MxSemt01900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900105) MxReadImpl.parse(MxSemt01900105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900105 .class);
    }
