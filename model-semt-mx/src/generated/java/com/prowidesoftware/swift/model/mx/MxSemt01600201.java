    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.016.002.01";
    ...
    public static MxSemt01600201 parse(String xml) {
        return ((MxSemt01600201) MxReadImpl.parse(MxSemt01600201 .class, xml, _classes, new MxReadParams()));
    }
     ...
     * 
     */
    public static MxSemt01600201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01600201) MxReadImpl.parse(MxSemt01600201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01600201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01600201 .class);
    }
