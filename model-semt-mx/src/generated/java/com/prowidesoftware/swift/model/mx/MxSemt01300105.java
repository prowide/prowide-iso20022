    ...
    extends AbstractMX
{
    ...
    public static MxSemt01300105 parse(String xml) {
        return ((MxSemt01300105) MxReadImpl.parse(MxSemt01300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01300105) MxReadImpl.parse(MxSemt01300105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01300105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01300105 .class);
    }
