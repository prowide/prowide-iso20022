    ...
    extends AbstractMX
{
    ...
    public static MxSemt99800102 parse(String xml) {
        return ((MxSemt99800102) MxReadImpl.parse(MxSemt99800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt99800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt99800102) MxReadImpl.parse(MxSemt99800102 .class, xml, _classes, new MxReadParams(conf)));
    }
