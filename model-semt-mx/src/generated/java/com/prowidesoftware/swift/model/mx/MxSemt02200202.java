    ...
    extends AbstractMX
{
    ...
    public static MxSemt02200202 parse(String xml) {
        return ((MxSemt02200202) MxReadImpl.parse(MxSemt02200202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02200202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02200202) MxReadImpl.parse(MxSemt02200202 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt02200202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02200202 .class);
    }
