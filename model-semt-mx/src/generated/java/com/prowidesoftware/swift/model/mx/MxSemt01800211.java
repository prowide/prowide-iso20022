    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.018.002.11";
    ...
    public static MxSemt01800211 parse(String xml) {
        return ((MxSemt01800211) MxReadImpl.parse(MxSemt01800211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800211) MxReadImpl.parse(MxSemt01800211 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01800211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800211 .class);
    }
