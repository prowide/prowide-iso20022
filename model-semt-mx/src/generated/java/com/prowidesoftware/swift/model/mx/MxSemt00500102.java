    ...
    extends AbstractMX
{
    ...
    public static MxSemt00500102 parse(String xml) {
        return ((MxSemt00500102) MxReadImpl.parse(MxSemt00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00500102) MxReadImpl.parse(MxSemt00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt00500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00500102 .class);
    }
