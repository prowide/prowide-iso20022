    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.020.002.03";
    ...
    public static MxSemt02000203 parse(String xml) {
        return ((MxSemt02000203) MxReadImpl.parse(MxSemt02000203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02000203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02000203) MxReadImpl.parse(MxSemt02000203 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt02000203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02000203 .class);
    }
