    ...
    extends AbstractMX
{
    ...
    public static MxSemt02200201 parse(String xml) {
        return ((MxSemt02200201) MxReadImpl.parse(MxSemt02200201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02200201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02200201) MxReadImpl.parse(MxSemt02200201 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02200201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02200201 .class);
    }
