    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.014.001.08";
    ...
    public static MxSemt01400108 parse(String xml) {
        return ((MxSemt01400108) MxReadImpl.parse(MxSemt01400108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01400108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01400108) MxReadImpl.parse(MxSemt01400108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01400108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01400108 .class);
    }
