    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.017.002.06";
    ...
    public static MxSemt01700206 parse(String xml) {
        return ((MxSemt01700206) MxReadImpl.parse(MxSemt01700206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01700206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700206) MxReadImpl.parse(MxSemt01700206 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01700206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01700206 .class);
    }
