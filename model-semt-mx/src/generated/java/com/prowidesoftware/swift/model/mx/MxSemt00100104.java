    ...
    extends AbstractMX
{
    ...
    public static MxSemt00100104 parse(String xml) {
        return ((MxSemt00100104) MxReadImpl.parse(MxSemt00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00100104) MxReadImpl.parse(MxSemt00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt00100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00100104 .class);
    }
