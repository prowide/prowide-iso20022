    ...
    extends AbstractMX
{
    ...
    public static MxSemt01500104 parse(String xml) {
        return ((MxSemt01500104) MxReadImpl.parse(MxSemt01500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01500104) MxReadImpl.parse(MxSemt01500104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01500104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01500104 .class);
    }
