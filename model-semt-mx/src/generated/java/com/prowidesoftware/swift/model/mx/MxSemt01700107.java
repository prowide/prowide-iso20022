    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.017.001.07";
    ...
    public static MxSemt01700107 parse(String xml) {
        return ((MxSemt01700107) MxReadImpl.parse(MxSemt01700107 .class, xml, _classes, new MxReadParams()));
    }
     ...
     * 
     */
    public static MxSemt01700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700107) MxReadImpl.parse(MxSemt01700107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01700107 .class);
    }
