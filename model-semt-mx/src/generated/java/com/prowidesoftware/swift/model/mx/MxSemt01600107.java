    ...
    extends AbstractMX
{
    ...
    public static MxSemt01600107 parse(String xml) {
        return ((MxSemt01600107) MxReadImpl.parse(MxSemt01600107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01600107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01600107) MxReadImpl.parse(MxSemt01600107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01600107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01600107 .class);
    }
