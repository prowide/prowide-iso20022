    ...
    extends AbstractMX
{
    ...
    public static MxSemt03100101 parse(String xml) {
        return ((MxSemt03100101) MxReadImpl.parse(MxSemt03100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt03100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt03100101) MxReadImpl.parse(MxSemt03100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt03100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt03100101 .class);
    }
