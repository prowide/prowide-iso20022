    ...
    extends AbstractMX
{
    ...
    public static MxSemt00600103 parse(String xml) {
        return ((MxSemt00600103) MxReadImpl.parse(MxSemt00600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00600103) MxReadImpl.parse(MxSemt00600103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt00600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00600103 .class);
    }
