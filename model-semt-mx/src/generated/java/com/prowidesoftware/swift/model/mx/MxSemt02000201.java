    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.020.002.01";
    ...
    public static MxSemt02000201 parse(String xml) {
        return ((MxSemt02000201) MxReadImpl.parse(MxSemt02000201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02000201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02000201) MxReadImpl.parse(MxSemt02000201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt02000201 fromJson(String json) {
