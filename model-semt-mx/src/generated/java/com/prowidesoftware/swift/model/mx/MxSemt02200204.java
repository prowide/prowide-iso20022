    ...
    extends AbstractMX
{
    ...
    public static MxSemt02200204 parse(String xml) {
        return ((MxSemt02200204) MxReadImpl.parse(MxSemt02200204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02200204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02200204) MxReadImpl.parse(MxSemt02200204 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02200204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02200204 .class);
    }
