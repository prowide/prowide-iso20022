    ...
    extends AbstractMX
{
    ...
    public static MxSemt01500202 parse(String xml) {
        return ((MxSemt01500202) MxReadImpl.parse(MxSemt01500202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01500202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01500202) MxReadImpl.parse(MxSemt01500202 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01500202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01500202 .class);
    }
