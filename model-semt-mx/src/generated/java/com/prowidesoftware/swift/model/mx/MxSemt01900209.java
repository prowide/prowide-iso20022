    ...
    extends AbstractMX
{
    ...
    public static MxSemt01900209 parse(String xml) {
        return ((MxSemt01900209) MxReadImpl.parse(MxSemt01900209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900209) MxReadImpl.parse(MxSemt01900209 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01900209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900209 .class);
    }
