    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.002.001.09";
    ...
    public static MxSemt00200109 parse(String xml) {
        return ((MxSemt00200109) MxReadImpl.parse(MxSemt00200109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00200109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00200109) MxReadImpl.parse(MxSemt00200109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt00200109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00200109 .class);
    }
