    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.015.001.10";
    ...
    public static MxSemt01500110 parse(String xml) {
        return ((MxSemt01500110) MxReadImpl.parse(MxSemt01500110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01500110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01500110) MxReadImpl.parse(MxSemt01500110 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01500110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01500110 .class);
    }
