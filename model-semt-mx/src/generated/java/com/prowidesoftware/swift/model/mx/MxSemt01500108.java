    ...
    extends AbstractMX
{
    ...
    public static MxSemt01500108 parse(String xml) {
        return ((MxSemt01500108) MxReadImpl.parse(MxSemt01500108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01500108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01500108) MxReadImpl.parse(MxSemt01500108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01500108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01500108 .class);
    }
