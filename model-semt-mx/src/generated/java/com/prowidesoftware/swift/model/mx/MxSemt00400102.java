    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.004.001.02";
    ...
    public static MxSemt00400102 parse(String xml) {
        return ((MxSemt00400102) MxReadImpl.parse(MxSemt00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00400102) MxReadImpl.parse(MxSemt00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00400102 .class);
    }
