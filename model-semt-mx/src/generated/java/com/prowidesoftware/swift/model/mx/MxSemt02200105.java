    ...
    extends AbstractMX
{
    ...
    public static MxSemt02200105 parse(String xml) {
        return ((MxSemt02200105) MxReadImpl.parse(MxSemt02200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02200105) MxReadImpl.parse(MxSemt02200105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02200105 .class);
    }
