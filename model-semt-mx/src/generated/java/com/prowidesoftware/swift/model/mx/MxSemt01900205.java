    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.019.002.05";
    ...
    public static MxSemt01900205 parse(String xml) {
        return ((MxSemt01900205) MxReadImpl.parse(MxSemt01900205 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01900205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900205 .class);
    }
