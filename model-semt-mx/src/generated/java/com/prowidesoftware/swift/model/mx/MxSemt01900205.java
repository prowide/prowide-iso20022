    ...
    extends AbstractMX
{
    ...
    public static MxSemt01900205 parse(String xml) {
        return ((MxSemt01900205) MxReadImpl.parse(MxSemt01900205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900205) MxReadImpl.parse(MxSemt01900205 .class, xml, _classes, new MxReadParams(conf)));
    }
