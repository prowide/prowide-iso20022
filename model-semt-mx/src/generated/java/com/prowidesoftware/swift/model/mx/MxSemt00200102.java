    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.002.001.02";
    ...
    public static MxSemt00200102 parse(String xml) {
        return ((MxSemt00200102) MxReadImpl.parse(MxSemt00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00200102) MxReadImpl.parse(MxSemt00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00200102 .class);
    }
