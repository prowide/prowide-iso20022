...
/**
 * Class for semt.019.002.08 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSemt01900208(final String xml) {
        this();
        MxSemt01900208 tmp = parse(xml);
     ...
     * 
     */
    public MxSemt01900208(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionAllegementReport002V08 }
     *     
     */
    public SecuritiesSettlementTransactionAllegementReport002V08 getSctiesSttlmTxAllgmtRpt() {
     ...
     *     
     */
    public MxSemt01900208 setSctiesSttlmTxAllgmtRpt(SecuritiesSettlementTransactionAllegementReport002V08 value) {
     ...
     * 
     */
    public static MxSemt01900208 parse(String xml) {
        return ((MxSemt01900208) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01900208 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSemt01900208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900208) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01900208 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSemt01900208 parse(String xml, MxRead parserImpl) {
        return ((MxSemt01900208) parserImpl.read(MxSemt01900208 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSemt01900208 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSemt01900208 message
     * @return
     *     a new instance of MxSemt01900208
     */
    public final static MxSemt01900208 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSemt01900208 .class);
    }
