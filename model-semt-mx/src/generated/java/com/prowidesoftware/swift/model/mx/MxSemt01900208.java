    ...
    extends AbstractMX
{
    ...
    public static MxSemt01900208 parse(String xml) {
        return ((MxSemt01900208) MxReadImpl.parse(MxSemt01900208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900208) MxReadImpl.parse(MxSemt01900208 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01900208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900208 .class);
    }
