    ...
    extends AbstractMX
{
    ...
    public static MxSemt01400204 parse(String xml) {
        return ((MxSemt01400204) MxReadImpl.parse(MxSemt01400204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01400204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01400204) MxReadImpl.parse(MxSemt01400204 .class, xml, _classes, new MxReadParams(conf)));
    }
