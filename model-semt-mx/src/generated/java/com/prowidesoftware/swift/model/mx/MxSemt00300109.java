    ...
    extends AbstractMX
{
    ...
    public static MxSemt00300109 parse(String xml) {
        return ((MxSemt00300109) MxReadImpl.parse(MxSemt00300109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00300109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300109) MxReadImpl.parse(MxSemt00300109 .class, xml, _classes, new MxReadParams(conf)));
    }
