...
/**
 * Class for semt.018.002.08 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.018.002.08";
     ...
     * 
     */
    public MxSemt01800208(final String xml) {
        this();
        MxSemt01800208 tmp = parse(xml);
     ...
     * 
     */
    public MxSemt01800208(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesTransactionPendingReport002V08 }
     *     
     */
     ...
     *     
     */
    public MxSemt01800208 setSctiesTxPdgRpt(SecuritiesTransactionPendingReport002V08 value) {
     ...
     * 
     */
    public static MxSemt01800208 parse(String xml) {
        return ((MxSemt01800208) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01800208 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSemt01800208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800208) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01800208 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSemt01800208 parse(String xml, MxRead parserImpl) {
        return ((MxSemt01800208) parserImpl.read(MxSemt01800208 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSemt01800208 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSemt01800208 message
     * @return
     *     a new instance of MxSemt01800208
     */
    public final static MxSemt01800208 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSemt01800208 .class);
    }
