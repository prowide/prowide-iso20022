    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800208 parse(String xml) {
        return ((MxSemt01800208) MxReadImpl.parse(MxSemt01800208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800208) MxReadImpl.parse(MxSemt01800208 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01800208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800208 .class);
    }
