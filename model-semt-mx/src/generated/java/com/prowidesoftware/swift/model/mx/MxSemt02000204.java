    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:semt.020.002.04";
    ...
    public static MxSemt02000204 parse(String xml) {
        return ((MxSemt02000204) MxReadImpl.parse(MxSemt02000204 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt02000204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02000204 .class);
    }
