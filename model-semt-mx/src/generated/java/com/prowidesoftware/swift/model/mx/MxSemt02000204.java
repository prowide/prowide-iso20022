    ...
    extends AbstractMX
{
    ...
    public static MxSemt02000204 parse(String xml) {
        return ((MxSemt02000204) MxReadImpl.parse(MxSemt02000204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02000204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02000204) MxReadImpl.parse(MxSemt02000204 .class, xml, _classes, new MxReadParams(conf)));
    }
