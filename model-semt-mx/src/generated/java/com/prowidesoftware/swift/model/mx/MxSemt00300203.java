    ...
    extends AbstractMX
{
    ...
    public static MxSemt00300203 parse(String xml) {
        return ((MxSemt00300203) MxReadImpl.parse(MxSemt00300203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00300203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300203) MxReadImpl.parse(MxSemt00300203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt00300203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00300203 .class);
    }
