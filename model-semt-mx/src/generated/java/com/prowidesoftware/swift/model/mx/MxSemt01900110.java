    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.019.001.10";
    ...
    public static MxSemt01900110 parse(String xml) {
        return ((MxSemt01900110) MxReadImpl.parse(MxSemt01900110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900110) MxReadImpl.parse(MxSemt01900110 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01900110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900110 .class);
    }
