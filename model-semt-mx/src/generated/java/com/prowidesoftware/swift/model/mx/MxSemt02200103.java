    ...
    extends AbstractMX
{
    ...
    public static MxSemt02200103 parse(String xml) {
        return ((MxSemt02200103) MxReadImpl.parse(MxSemt02200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02200103) MxReadImpl.parse(MxSemt02200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt02200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02200103 .class);
    }
