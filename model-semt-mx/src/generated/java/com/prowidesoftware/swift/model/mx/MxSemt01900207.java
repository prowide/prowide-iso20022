    ...
    extends AbstractMX
{
    ...
    public static MxSemt01900207 parse(String xml) {
        return ((MxSemt01900207) MxReadImpl.parse(MxSemt01900207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900207) MxReadImpl.parse(MxSemt01900207 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01900207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900207 .class);
    }
