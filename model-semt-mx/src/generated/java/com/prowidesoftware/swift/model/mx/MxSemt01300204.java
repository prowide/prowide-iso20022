    ...
    extends AbstractMX
{
    ...
    public static MxSemt01300204 parse(String xml) {
        return ((MxSemt01300204) MxReadImpl.parse(MxSemt01300204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01300204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01300204) MxReadImpl.parse(MxSemt01300204 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01300204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01300204 .class);
    }
