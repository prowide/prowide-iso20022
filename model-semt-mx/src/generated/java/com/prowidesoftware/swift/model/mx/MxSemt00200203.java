    ...
    extends AbstractMX
{
    ...
    public static MxSemt00200203 parse(String xml) {
        return ((MxSemt00200203) MxReadImpl.parse(MxSemt00200203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00200203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00200203) MxReadImpl.parse(MxSemt00200203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt00200203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00200203 .class);
    }
