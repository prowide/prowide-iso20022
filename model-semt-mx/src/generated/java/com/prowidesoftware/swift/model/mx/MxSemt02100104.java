    ...
    extends AbstractMX
{
    ...
    public static MxSemt02100104 parse(String xml) {
        return ((MxSemt02100104) MxReadImpl.parse(MxSemt02100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02100104) MxReadImpl.parse(MxSemt02100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02100104 .class);
    }
