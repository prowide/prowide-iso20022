    ...
    extends AbstractMX
{
    ...
    public static MxSemt00700101 parse(String xml) {
        return ((MxSemt00700101) MxReadImpl.parse(MxSemt00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00700101) MxReadImpl.parse(MxSemt00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt00700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00700101 .class);
    }
