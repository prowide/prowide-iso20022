    ...
    extends AbstractMX
{
    ...
    public static MxSemt02200102 parse(String xml) {
        return ((MxSemt02200102) MxReadImpl.parse(MxSemt02200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02200102) MxReadImpl.parse(MxSemt02200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02200102 .class);
    }
