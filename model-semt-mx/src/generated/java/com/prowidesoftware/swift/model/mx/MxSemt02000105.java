    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.020.001.05";
    ...
    public static MxSemt02000105 parse(String xml) {
        return ((MxSemt02000105) MxReadImpl.parse(MxSemt02000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02000105) MxReadImpl.parse(MxSemt02000105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt02000105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02000105 .class);
    }
