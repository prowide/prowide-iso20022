    ...
    extends AbstractMX
{
    ...
    public static MxSemt01500101 parse(String xml) {
        return ((MxSemt01500101) MxReadImpl.parse(MxSemt01500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01500101) MxReadImpl.parse(MxSemt01500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01500101 .class);
    }
