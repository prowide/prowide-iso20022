    ...
    extends AbstractMX
{
    ...
    public static MxSemt01500105 parse(String xml) {
        return ((MxSemt01500105) MxReadImpl.parse(MxSemt01500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01500105) MxReadImpl.parse(MxSemt01500105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01500105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01500105 .class);
    }
