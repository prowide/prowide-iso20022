    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.007.001.03";
    ...
    public static MxSemt00700103 parse(String xml) {
        return ((MxSemt00700103) MxReadImpl.parse(MxSemt00700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00700103) MxReadImpl.parse(MxSemt00700103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt00700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00700103 .class);
    }
