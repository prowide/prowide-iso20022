    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.016.002.07";
    ...
    public static MxSemt01600207 parse(String xml) {
        return ((MxSemt01600207) MxReadImpl.parse(MxSemt01600207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01600207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01600207) MxReadImpl.parse(MxSemt01600207 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01600207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01600207 .class);
    }
