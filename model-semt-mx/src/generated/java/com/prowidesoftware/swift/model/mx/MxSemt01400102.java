    ...
    extends AbstractMX
{
    ...
    public static MxSemt01400102 parse(String xml) {
        return ((MxSemt01400102) MxReadImpl.parse(MxSemt01400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01400102) MxReadImpl.parse(MxSemt01400102 .class, xml, _classes, new MxReadParams(conf)));
    }
