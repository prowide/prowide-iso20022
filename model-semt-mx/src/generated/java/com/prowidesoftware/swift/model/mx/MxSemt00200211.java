    ...
    extends AbstractMX
{
    ...
    public static MxSemt00200211 parse(String xml) {
        return ((MxSemt00200211) MxReadImpl.parse(MxSemt00200211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00200211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00200211) MxReadImpl.parse(MxSemt00200211 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt00200211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00200211 .class);
    }
