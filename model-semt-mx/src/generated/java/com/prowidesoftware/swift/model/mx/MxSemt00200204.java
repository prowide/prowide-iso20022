    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.002.002.04";
    ...
    public static MxSemt00200204 parse(String xml) {
        return ((MxSemt00200204) MxReadImpl.parse(MxSemt00200204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00200204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00200204) MxReadImpl.parse(MxSemt00200204 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt00200204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00200204 .class);
    }
