    ...
    extends AbstractMX
{
    ...
    public static MxSemt01400205 parse(String xml) {
        return ((MxSemt01400205) MxReadImpl.parse(MxSemt01400205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01400205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01400205) MxReadImpl.parse(MxSemt01400205 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01400205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01400205 .class);
    }
