    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.002.001.11";
    ...
    public static MxSemt00200111 parse(String xml) {
        return ((MxSemt00200111) MxReadImpl.parse(MxSemt00200111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00200111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00200111) MxReadImpl.parse(MxSemt00200111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt00200111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00200111 .class);
    }
