    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800108 parse(String xml) {
        return ((MxSemt01800108) MxReadImpl.parse(MxSemt01800108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800108) MxReadImpl.parse(MxSemt01800108 .class, xml, _classes, new MxReadParams(conf)));
    }
