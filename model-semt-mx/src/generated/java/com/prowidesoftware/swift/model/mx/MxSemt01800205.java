    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.018.002.05";
    ...
    public static MxSemt01800205 parse(String xml) {
        return ((MxSemt01800205) MxReadImpl.parse(MxSemt01800205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800205) MxReadImpl.parse(MxSemt01800205 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01800205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800205 .class);
    }
