    ...
    extends AbstractMX
{
    ...
    public static MxSemt00300208 parse(String xml) {
        return ((MxSemt00300208) MxReadImpl.parse(MxSemt00300208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00300208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300208) MxReadImpl.parse(MxSemt00300208 .class, xml, _classes, new MxReadParams(conf)));
    }
