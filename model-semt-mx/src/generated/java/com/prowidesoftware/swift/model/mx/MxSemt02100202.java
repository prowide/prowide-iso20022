    ...
    extends AbstractMX
{
    ...
    public static MxSemt02100202 parse(String xml) {
        return ((MxSemt02100202) MxReadImpl.parse(MxSemt02100202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02100202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02100202) MxReadImpl.parse(MxSemt02100202 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02100202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02100202 .class);
    }
