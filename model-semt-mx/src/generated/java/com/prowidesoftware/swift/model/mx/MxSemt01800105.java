    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800105 parse(String xml) {
        return ((MxSemt01800105) MxReadImpl.parse(MxSemt01800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800105) MxReadImpl.parse(MxSemt01800105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01800105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800105 .class);
    }
