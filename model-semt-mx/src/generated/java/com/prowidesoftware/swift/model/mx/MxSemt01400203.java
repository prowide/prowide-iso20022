    ...
    extends AbstractMX
{
    ...
    public static MxSemt01400203 parse(String xml) {
        return ((MxSemt01400203) MxReadImpl.parse(MxSemt01400203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01400203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01400203) MxReadImpl.parse(MxSemt01400203 .class, xml, _classes, new MxReadParams(conf)));
    }
