    ...
    extends AbstractMX
{
    ...
    public static MxSemt01700212 parse(String xml) {
        return ((MxSemt01700212) MxReadImpl.parse(MxSemt01700212 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01700212 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700212) MxReadImpl.parse(MxSemt01700212 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01700212 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01700212 .class);
    }
