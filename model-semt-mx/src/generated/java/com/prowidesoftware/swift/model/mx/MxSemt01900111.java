...
/**
 * Class for semt.019.001.11 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSemt01900111(final String xml) {
        this();
        MxSemt01900111 tmp = parse(xml);
     ...
     * 
     */
    public MxSemt01900111(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionAllegementReportV11 }
     *     
     */
    public SecuritiesSettlementTransactionAllegementReportV11 getSctiesSttlmTxAllgmtRpt() {
     ...
     *     
     */
    public MxSemt01900111 setSctiesSttlmTxAllgmtRpt(SecuritiesSettlementTransactionAllegementReportV11 value) {
     ...
     * 
     */
    public static MxSemt01900111 parse(String xml) {
        return ((MxSemt01900111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01900111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSemt01900111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01900111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSemt01900111 parse(String xml, MxRead parserImpl) {
        return ((MxSemt01900111) parserImpl.read(MxSemt01900111 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSemt01900111 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSemt01900111 message
     * @return
     *     a new instance of MxSemt01900111
     */
    public final static MxSemt01900111 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSemt01900111 .class);
    }
