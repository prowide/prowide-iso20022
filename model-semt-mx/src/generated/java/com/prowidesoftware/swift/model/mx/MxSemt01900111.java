    ...
    extends AbstractMX
{
    ...
    public static MxSemt01900111 parse(String xml) {
        return ((MxSemt01900111) MxReadImpl.parse(MxSemt01900111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900111) MxReadImpl.parse(MxSemt01900111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01900111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900111 .class);
    }
