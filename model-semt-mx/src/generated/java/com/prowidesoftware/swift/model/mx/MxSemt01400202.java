    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.014.002.02";
    ...
    public static MxSemt01400202 parse(String xml) {
        return ((MxSemt01400202) MxReadImpl.parse(MxSemt01400202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01400202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01400202) MxReadImpl.parse(MxSemt01400202 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01400202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01400202 .class);
    }
