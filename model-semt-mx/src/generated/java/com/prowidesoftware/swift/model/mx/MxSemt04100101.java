    ...
    extends AbstractMX
{
    ...
    public static MxSemt04100101 parse(String xml) {
        return ((MxSemt04100101) MxReadImpl.parse(MxSemt04100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt04100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt04100101) MxReadImpl.parse(MxSemt04100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt04100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt04100101 .class);
    }
