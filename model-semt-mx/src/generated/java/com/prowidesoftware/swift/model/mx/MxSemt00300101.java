    ...
    extends AbstractMX
{
    ...
    public static MxSemt00300101 parse(String xml) {
        return ((MxSemt00300101) MxReadImpl.parse(MxSemt00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300101) MxReadImpl.parse(MxSemt00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00300101 .class);
    }
