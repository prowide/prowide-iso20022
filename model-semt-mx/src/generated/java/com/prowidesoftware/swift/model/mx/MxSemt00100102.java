    ...
    extends AbstractMX
{
    ...
    public static MxSemt00100102 parse(String xml) {
        return ((MxSemt00100102) MxReadImpl.parse(MxSemt00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00100102) MxReadImpl.parse(MxSemt00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00100102 .class);
    }
