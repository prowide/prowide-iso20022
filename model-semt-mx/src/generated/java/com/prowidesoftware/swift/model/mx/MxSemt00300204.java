    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:semt.003.002.04";
    ...
    public static MxSemt00300204 parse(String xml) {
        return ((MxSemt00300204) MxReadImpl.parse(MxSemt00300204 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt00300204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00300204 .class);
    }
