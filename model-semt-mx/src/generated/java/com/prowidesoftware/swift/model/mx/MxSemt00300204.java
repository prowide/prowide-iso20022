    ...
    extends AbstractMX
{
    ...
    public static MxSemt00300204 parse(String xml) {
        return ((MxSemt00300204) MxReadImpl.parse(MxSemt00300204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00300204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300204) MxReadImpl.parse(MxSemt00300204 .class, xml, _classes, new MxReadParams(conf)));
    }
