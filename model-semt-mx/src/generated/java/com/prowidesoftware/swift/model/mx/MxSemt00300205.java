    ...
    extends AbstractMX
{
    ...
    public static MxSemt00300205 parse(String xml) {
        return ((MxSemt00300205) MxReadImpl.parse(MxSemt00300205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00300205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300205) MxReadImpl.parse(MxSemt00300205 .class, xml, _classes, new MxReadParams(conf)));
    }
