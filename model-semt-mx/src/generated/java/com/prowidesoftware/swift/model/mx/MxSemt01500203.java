    ...
    extends AbstractMX
{
    ...
    public static MxSemt01500203 parse(String xml) {
        return ((MxSemt01500203) MxReadImpl.parse(MxSemt01500203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01500203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01500203) MxReadImpl.parse(MxSemt01500203 .class, xml, _classes, new MxReadParams(conf)));
    }
