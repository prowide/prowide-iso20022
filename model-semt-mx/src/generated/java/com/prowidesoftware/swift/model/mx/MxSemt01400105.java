    ...
    extends AbstractMX
{
    ...
    public static MxSemt01400105 parse(String xml) {
        return ((MxSemt01400105) MxReadImpl.parse(MxSemt01400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01400105) MxReadImpl.parse(MxSemt01400105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01400105 .class);
    }
