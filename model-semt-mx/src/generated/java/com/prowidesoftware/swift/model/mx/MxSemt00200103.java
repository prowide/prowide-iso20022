    ...
    extends AbstractMX
{
    ...
    public static MxSemt00200103 parse(String xml) {
        return ((MxSemt00200103) MxReadImpl.parse(MxSemt00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00200103) MxReadImpl.parse(MxSemt00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
