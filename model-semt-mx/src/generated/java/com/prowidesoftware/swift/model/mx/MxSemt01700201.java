    ...
    extends AbstractMX
{
    ...
    public static MxSemt01700201 parse(String xml) {
        return ((MxSemt01700201) MxReadImpl.parse(MxSemt01700201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01700201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700201) MxReadImpl.parse(MxSemt01700201 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01700201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01700201 .class);
    }
