    ...
    extends AbstractMX
{
    ...
    public static MxSemt01400103 parse(String xml) {
        return ((MxSemt01400103) MxReadImpl.parse(MxSemt01400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01400103) MxReadImpl.parse(MxSemt01400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01400103 .class);
    }
