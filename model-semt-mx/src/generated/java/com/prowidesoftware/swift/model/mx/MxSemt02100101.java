    ...
    extends AbstractMX
{
    ...
    public static MxSemt02100101 parse(String xml) {
        return ((MxSemt02100101) MxReadImpl.parse(MxSemt02100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02100101) MxReadImpl.parse(MxSemt02100101 .class, xml, _classes, new MxReadParams(conf)));
    }
