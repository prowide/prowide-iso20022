    ...
    extends AbstractMX
{
    ...
    public static MxSemt01400104 parse(String xml) {
        return ((MxSemt01400104) MxReadImpl.parse(MxSemt01400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01400104) MxReadImpl.parse(MxSemt01400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01400104 .class);
    }
