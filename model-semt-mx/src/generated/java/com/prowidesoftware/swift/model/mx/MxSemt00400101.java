    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:semt.004.001.01";
    ...
    public static MxSemt00400101 parse(String xml) {
        return ((MxSemt00400101) MxReadImpl.parse(MxSemt00400101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt00400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00400101 .class);
    }
