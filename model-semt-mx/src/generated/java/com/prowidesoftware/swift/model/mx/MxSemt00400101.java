    ...
    extends AbstractMX
{
    ...
    public static MxSemt00400101 parse(String xml) {
        return ((MxSemt00400101) MxReadImpl.parse(MxSemt00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00400101) MxReadImpl.parse(MxSemt00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
