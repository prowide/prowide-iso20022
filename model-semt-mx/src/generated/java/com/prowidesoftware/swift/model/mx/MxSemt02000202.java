    ...
    extends AbstractMX
{
    ...
    public static MxSemt02000202 parse(String xml) {
        return ((MxSemt02000202) MxReadImpl.parse(MxSemt02000202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02000202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02000202) MxReadImpl.parse(MxSemt02000202 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02000202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02000202 .class);
    }
