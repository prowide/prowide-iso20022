    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800113 parse(String xml) {
        return ((MxSemt01800113) MxReadImpl.parse(MxSemt01800113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800113 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800113) MxReadImpl.parse(MxSemt01800113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01800113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800113 .class);
    }
