    ...
    extends AbstractMX
{
    ...
    public static MxSemt01700112 parse(String xml) {
        return ((MxSemt01700112) MxReadImpl.parse(MxSemt01700112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01700112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700112) MxReadImpl.parse(MxSemt01700112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01700112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01700112 .class);
    }
