    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.018.002.09";
    ...
    public static MxSemt01800209 parse(String xml) {
        return ((MxSemt01800209) MxReadImpl.parse(MxSemt01800209 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01800209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800209 .class);
    }
