    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800209 parse(String xml) {
        return ((MxSemt01800209) MxReadImpl.parse(MxSemt01800209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800209) MxReadImpl.parse(MxSemt01800209 .class, xml, _classes, new MxReadParams(conf)));
    }
