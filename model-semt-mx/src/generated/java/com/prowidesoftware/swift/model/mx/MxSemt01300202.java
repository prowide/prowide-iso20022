    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.013.002.02";
    ...
    public static MxSemt01300202 parse(String xml) {
        return ((MxSemt01300202) MxReadImpl.parse(MxSemt01300202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01300202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01300202) MxReadImpl.parse(MxSemt01300202 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01300202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01300202 .class);
    }
