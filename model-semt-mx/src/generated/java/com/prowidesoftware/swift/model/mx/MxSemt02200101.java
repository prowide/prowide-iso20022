    ...
    extends AbstractMX
{
    ...
    public static MxSemt02200101 parse(String xml) {
        return ((MxSemt02200101) MxReadImpl.parse(MxSemt02200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02200101) MxReadImpl.parse(MxSemt02200101 .class, xml, _classes, new MxReadParams(conf)));
    }
