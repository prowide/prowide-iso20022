    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.018.002.01";
    ...
    public static MxSemt01800201 parse(String xml) {
        return ((MxSemt01800201) MxReadImpl.parse(MxSemt01800201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800201) MxReadImpl.parse(MxSemt01800201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01800201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800201 .class);
    }
