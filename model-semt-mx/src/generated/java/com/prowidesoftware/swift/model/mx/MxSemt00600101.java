    ...
    extends AbstractMX
{
    ...
    public static MxSemt00600101 parse(String xml) {
        return ((MxSemt00600101) MxReadImpl.parse(MxSemt00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00600101) MxReadImpl.parse(MxSemt00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
