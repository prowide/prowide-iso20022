    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:semt.006.001.01";
    ...
    public static MxSemt00600101 parse(String xml) {
        return ((MxSemt00600101) MxReadImpl.parse(MxSemt00600101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00600101 .class);
    }
