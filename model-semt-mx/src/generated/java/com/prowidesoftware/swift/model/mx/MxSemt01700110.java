    ...
    extends AbstractMX
{
    ...
    public static MxSemt01700110 parse(String xml) {
        return ((MxSemt01700110) MxReadImpl.parse(MxSemt01700110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01700110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700110) MxReadImpl.parse(MxSemt01700110 .class, xml, _classes, new MxReadParams(conf)));
    }
