    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.017.001.10";
    ...
    public static MxSemt01700110 parse(String xml) {
        return ((MxSemt01700110) MxReadImpl.parse(MxSemt01700110 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01700110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01700110 .class);
    }
