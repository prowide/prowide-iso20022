    ...
    extends AbstractMX
{
    ...
    public static MxSemt03400101 parse(String xml) {
        return ((MxSemt03400101) MxReadImpl.parse(MxSemt03400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt03400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt03400101) MxReadImpl.parse(MxSemt03400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt03400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt03400101 .class);
    }
