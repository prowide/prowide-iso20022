    ...
    extends AbstractMX
{
    ...
    public static MxSemt02200106 parse(String xml) {
        return ((MxSemt02200106) MxReadImpl.parse(MxSemt02200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02200106) MxReadImpl.parse(MxSemt02200106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02200106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02200106 .class);
    }
