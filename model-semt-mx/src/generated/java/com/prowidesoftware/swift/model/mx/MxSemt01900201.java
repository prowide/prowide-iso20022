    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:semt.019.002.01";
    ...
    public static MxSemt01900201 parse(String xml) {
        return ((MxSemt01900201) MxReadImpl.parse(MxSemt01900201 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01900201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900201 .class);
    }
