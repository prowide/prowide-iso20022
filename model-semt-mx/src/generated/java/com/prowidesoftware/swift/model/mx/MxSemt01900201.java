    ...
    extends AbstractMX
{
    ...
    public static MxSemt01900201 parse(String xml) {
        return ((MxSemt01900201) MxReadImpl.parse(MxSemt01900201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900201) MxReadImpl.parse(MxSemt01900201 .class, xml, _classes, new MxReadParams(conf)));
    }
