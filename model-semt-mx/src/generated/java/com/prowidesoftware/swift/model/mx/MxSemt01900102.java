    ...
    extends AbstractMX
{
    ...
    public static MxSemt01900102 parse(String xml) {
        return ((MxSemt01900102) MxReadImpl.parse(MxSemt01900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900102) MxReadImpl.parse(MxSemt01900102 .class, xml, _classes, new MxReadParams(conf)));
    }
