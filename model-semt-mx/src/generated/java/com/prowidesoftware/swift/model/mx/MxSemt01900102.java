    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.019.001.02";
    ...
    public static MxSemt01900102 parse(String xml) {
        return ((MxSemt01900102) MxReadImpl.parse(MxSemt01900102 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900102 .class);
    }
