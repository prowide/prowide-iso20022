    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.019.001.08";
    ...
    public static MxSemt01900108 parse(String xml) {
        return ((MxSemt01900108) MxReadImpl.parse(MxSemt01900108 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01900108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900108 .class);
    }
