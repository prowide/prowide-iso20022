    ...
    extends AbstractMX
{
    ...
    public static MxSemt01900108 parse(String xml) {
        return ((MxSemt01900108) MxReadImpl.parse(MxSemt01900108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900108) MxReadImpl.parse(MxSemt01900108 .class, xml, _classes, new MxReadParams(conf)));
    }
