    ...
    extends AbstractMX
{
    ...
    public static MxSemt01700207 parse(String xml) {
        return ((MxSemt01700207) MxReadImpl.parse(MxSemt01700207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01700207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700207) MxReadImpl.parse(MxSemt01700207 .class, xml, _classes, new MxReadParams(conf)));
    }
