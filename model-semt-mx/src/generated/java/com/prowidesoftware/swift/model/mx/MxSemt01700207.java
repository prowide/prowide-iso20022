    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.017.002.07";
    ...
    public static MxSemt01700207 parse(String xml) {
        return ((MxSemt01700207) MxReadImpl.parse(MxSemt01700207 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01700207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01700207 .class);
    }
