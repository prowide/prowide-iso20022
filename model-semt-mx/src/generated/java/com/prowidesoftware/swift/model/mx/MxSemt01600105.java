    ...
    extends AbstractMX
{
    ...
    public static MxSemt01600105 parse(String xml) {
        return ((MxSemt01600105) MxReadImpl.parse(MxSemt01600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01600105) MxReadImpl.parse(MxSemt01600105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01600105 .class);
    }
