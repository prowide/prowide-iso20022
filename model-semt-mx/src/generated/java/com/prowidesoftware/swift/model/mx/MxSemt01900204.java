    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.019.002.04";
    ...
    public static MxSemt01900204 parse(String xml) {
        return ((MxSemt01900204) MxReadImpl.parse(MxSemt01900204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900204) MxReadImpl.parse(MxSemt01900204 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01900204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900204 .class);
    }
