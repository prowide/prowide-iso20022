    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:semt.019.002.02";
    ...
    public static MxSemt01900202 parse(String xml) {
        return ((MxSemt01900202) MxReadImpl.parse(MxSemt01900202 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01900202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900202 .class);
    }
