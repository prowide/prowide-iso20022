    ...
    extends AbstractMX
{
    ...
    public static MxSemt01900202 parse(String xml) {
        return ((MxSemt01900202) MxReadImpl.parse(MxSemt01900202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900202) MxReadImpl.parse(MxSemt01900202 .class, xml, _classes, new MxReadParams(conf)));
    }
