    ...
    extends AbstractMX
{
    ...
    public static MxSemt04000101 parse(String xml) {
        return ((MxSemt04000101) MxReadImpl.parse(MxSemt04000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt04000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt04000101) MxReadImpl.parse(MxSemt04000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt04000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt04000101 .class);
    }
