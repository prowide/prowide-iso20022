    ...
    extends AbstractMX
{
    ...
    public static MxSemt01700104 parse(String xml) {
        return ((MxSemt01700104) MxReadImpl.parse(MxSemt01700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700104) MxReadImpl.parse(MxSemt01700104 .class, xml, _classes, new MxReadParams(conf)));
    }
