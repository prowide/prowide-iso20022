    ...
    extends AbstractMX
{
    ...
    public static MxSemt99800103 parse(String xml) {
        return ((MxSemt99800103) MxReadImpl.parse(MxSemt99800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt99800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt99800103) MxReadImpl.parse(MxSemt99800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt99800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt99800103 .class);
    }
