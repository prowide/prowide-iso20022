...
/**
 * Class for semt.019.001.09 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSemt01900109(final String xml) {
        this();
        MxSemt01900109 tmp = parse(xml);
     ...
     * 
     */
    public MxSemt01900109(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionAllegementReportV09 }
     *     
     */
    public SecuritiesSettlementTransactionAllegementReportV09 getSctiesSttlmTxAllgmtRpt() {
     ...
     *     
     */
    public MxSemt01900109 setSctiesSttlmTxAllgmtRpt(SecuritiesSettlementTransactionAllegementReportV09 value) {
     ...
     * 
     */
    public static MxSemt01900109 parse(String xml) {
        return ((MxSemt01900109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01900109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSemt01900109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01900109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSemt01900109 parse(String xml, MxRead parserImpl) {
        return ((MxSemt01900109) parserImpl.read(MxSemt01900109 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSemt01900109 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSemt01900109 message
     * @return
     *     a new instance of MxSemt01900109
     */
    public final static MxSemt01900109 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSemt01900109 .class);
    }
