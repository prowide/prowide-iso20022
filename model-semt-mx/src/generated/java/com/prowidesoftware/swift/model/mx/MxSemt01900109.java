    ...
    extends AbstractMX
{
    ...
    public static MxSemt01900109 parse(String xml) {
        return ((MxSemt01900109) MxReadImpl.parse(MxSemt01900109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900109) MxReadImpl.parse(MxSemt01900109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01900109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900109 .class);
    }
