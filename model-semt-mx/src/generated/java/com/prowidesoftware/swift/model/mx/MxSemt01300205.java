    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.013.002.05";
    ...
    public static MxSemt01300205 parse(String xml) {
        return ((MxSemt01300205) MxReadImpl.parse(MxSemt01300205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01300205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01300205) MxReadImpl.parse(MxSemt01300205 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01300205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01300205 .class);
    }
