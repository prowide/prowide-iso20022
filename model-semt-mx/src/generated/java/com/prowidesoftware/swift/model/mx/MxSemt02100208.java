    ...
    extends AbstractMX
{
    ...
    public static MxSemt02100208 parse(String xml) {
        return ((MxSemt02100208) MxReadImpl.parse(MxSemt02100208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02100208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02100208) MxReadImpl.parse(MxSemt02100208 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02100208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02100208 .class);
    }
