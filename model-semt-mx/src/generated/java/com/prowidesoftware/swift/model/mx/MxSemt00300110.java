    ...
    extends AbstractMX
{
    ...
    public static MxSemt00300110 parse(String xml) {
        return ((MxSemt00300110) MxReadImpl.parse(MxSemt00300110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00300110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300110) MxReadImpl.parse(MxSemt00300110 .class, xml, _classes, new MxReadParams(conf)));
    }
