    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:semt.015.002.04";
    ...
    public static MxSemt01500204 parse(String xml) {
        return ((MxSemt01500204) MxReadImpl.parse(MxSemt01500204 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01500204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01500204 .class);
    }
