    ...
    extends AbstractMX
{
    ...
    public static MxSemt01500204 parse(String xml) {
        return ((MxSemt01500204) MxReadImpl.parse(MxSemt01500204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01500204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01500204) MxReadImpl.parse(MxSemt01500204 .class, xml, _classes, new MxReadParams(conf)));
    }
