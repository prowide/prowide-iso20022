    ...
    extends AbstractMX
{
    ...
    public static MxSemt00200205 parse(String xml) {
        return ((MxSemt00200205) MxReadImpl.parse(MxSemt00200205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00200205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00200205) MxReadImpl.parse(MxSemt00200205 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt00200205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00200205 .class);
    }
