    ...
    extends AbstractMX
{
    ...
    public static MxSemt00700102 parse(String xml) {
        return ((MxSemt00700102) MxReadImpl.parse(MxSemt00700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00700102) MxReadImpl.parse(MxSemt00700102 .class, xml, _classes, new MxReadParams(conf)));
    }
