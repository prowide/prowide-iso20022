    ...
    extends AbstractMX
{
    ...
    public static MxSemt01400107 parse(String xml) {
        return ((MxSemt01400107) MxReadImpl.parse(MxSemt01400107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01400107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01400107) MxReadImpl.parse(MxSemt01400107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01400107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01400107 .class);
    }
