    ...
    extends AbstractMX
{
    ...
    public static MxSemt02200104 parse(String xml) {
        return ((MxSemt02200104) MxReadImpl.parse(MxSemt02200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02200104) MxReadImpl.parse(MxSemt02200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02200104 .class);
    }
