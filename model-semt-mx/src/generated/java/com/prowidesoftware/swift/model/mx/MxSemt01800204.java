    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:semt.018.002.04";
    ...
    public static MxSemt01800204 parse(String xml) {
        return ((MxSemt01800204) MxReadImpl.parse(MxSemt01800204 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01800204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800204 .class);
    }
