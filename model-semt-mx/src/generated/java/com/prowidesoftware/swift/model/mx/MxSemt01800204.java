    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800204 parse(String xml) {
        return ((MxSemt01800204) MxReadImpl.parse(MxSemt01800204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800204) MxReadImpl.parse(MxSemt01800204 .class, xml, _classes, new MxReadParams(conf)));
    }
