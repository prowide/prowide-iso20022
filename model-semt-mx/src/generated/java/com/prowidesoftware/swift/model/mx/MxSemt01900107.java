    ...
    extends AbstractMX
{
    ...
    public static MxSemt01900107 parse(String xml) {
        return ((MxSemt01900107) MxReadImpl.parse(MxSemt01900107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900107) MxReadImpl.parse(MxSemt01900107 .class, xml, _classes, new MxReadParams(conf)));
    }
