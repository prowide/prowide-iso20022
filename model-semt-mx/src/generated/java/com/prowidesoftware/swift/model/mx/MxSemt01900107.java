    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.019.001.07";
    ...
    public static MxSemt01900107 parse(String xml) {
        return ((MxSemt01900107) MxReadImpl.parse(MxSemt01900107 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01900107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900107 .class);
    }
