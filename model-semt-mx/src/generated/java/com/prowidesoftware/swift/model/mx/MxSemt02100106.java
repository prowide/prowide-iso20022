    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.021.001.06";
    ...
    public static MxSemt02100106 parse(String xml) {
        return ((MxSemt02100106) MxReadImpl.parse(MxSemt02100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02100106) MxReadImpl.parse(MxSemt02100106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt02100106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02100106 .class);
    }
