    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.020.001.01";
    ...
    public static MxSemt02000101 parse(String xml) {
        return ((MxSemt02000101) MxReadImpl.parse(MxSemt02000101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt02000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02000101 .class);
    }
