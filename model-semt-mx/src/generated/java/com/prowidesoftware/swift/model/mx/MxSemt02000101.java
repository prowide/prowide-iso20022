    ...
    extends AbstractMX
{
    ...
    public static MxSemt02000101 parse(String xml) {
        return ((MxSemt02000101) MxReadImpl.parse(MxSemt02000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02000101) MxReadImpl.parse(MxSemt02000101 .class, xml, _classes, new MxReadParams(conf)));
    }
