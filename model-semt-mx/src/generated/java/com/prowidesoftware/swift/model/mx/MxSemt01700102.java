    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.017.001.02";
    ...
    public static MxSemt01700102 parse(String xml) {
        return ((MxSemt01700102) MxReadImpl.parse(MxSemt01700102 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01700102 .class);
    }
