    ...
    extends AbstractMX
{
    ...
    public static MxSemt01700102 parse(String xml) {
        return ((MxSemt01700102) MxReadImpl.parse(MxSemt01700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700102) MxReadImpl.parse(MxSemt01700102 .class, xml, _classes, new MxReadParams(conf)));
    }
