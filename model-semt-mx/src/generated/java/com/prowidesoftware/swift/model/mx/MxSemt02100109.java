    ...
    extends AbstractMX
{
    ...
    public static MxSemt02100109 parse(String xml) {
        return ((MxSemt02100109) MxReadImpl.parse(MxSemt02100109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02100109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02100109) MxReadImpl.parse(MxSemt02100109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02100109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02100109 .class);
    }
