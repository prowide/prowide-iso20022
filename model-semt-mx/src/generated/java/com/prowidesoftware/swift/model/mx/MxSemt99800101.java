    ...
    extends AbstractMX
{
    ...
    public static MxSemt99800101 parse(String xml) {
        return ((MxSemt99800101) MxReadImpl.parse(MxSemt99800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt99800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt99800101) MxReadImpl.parse(MxSemt99800101 .class, xml, _classes, new MxReadParams(conf)));
    }
