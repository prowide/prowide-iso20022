    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800109 parse(String xml) {
        return ((MxSemt01800109) MxReadImpl.parse(MxSemt01800109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800109) MxReadImpl.parse(MxSemt01800109 .class, xml, _classes, new MxReadParams(conf)));
    }
