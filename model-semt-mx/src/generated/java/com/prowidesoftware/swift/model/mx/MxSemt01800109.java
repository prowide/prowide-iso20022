    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.018.001.09";
    ...
    public static MxSemt01800109 parse(String xml) {
        return ((MxSemt01800109) MxReadImpl.parse(MxSemt01800109 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01800109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800109 .class);
    }
