    ...
    extends AbstractMX
{
    ...
    public static MxSemt01200101 parse(String xml) {
        return ((MxSemt01200101) MxReadImpl.parse(MxSemt01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01200101) MxReadImpl.parse(MxSemt01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01200101 .class);
    }
