    ...
    extends AbstractMX
{
    ...
    public static MxSemt00100101 parse(String xml) {
        return ((MxSemt00100101) MxReadImpl.parse(MxSemt00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00100101) MxReadImpl.parse(MxSemt00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00100101 .class);
    }
