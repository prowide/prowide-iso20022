...
/**
 * Class for semt.019.002.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSemt01900203(final String xml) {
        this();
        MxSemt01900203 tmp = parse(xml);
     ...
     * 
     */
    public MxSemt01900203(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionAllegementReport002V03 }
     *     
     */
    public SecuritiesSettlementTransactionAllegementReport002V03 getSctiesSttlmTxAllgmtRpt() {
     ...
     *     
     */
    public MxSemt01900203 setSctiesSttlmTxAllgmtRpt(SecuritiesSettlementTransactionAllegementReport002V03 value) {
     ...
     * 
     */
    public static MxSemt01900203 parse(String xml) {
        return ((MxSemt01900203) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01900203 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSemt01900203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900203) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01900203 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSemt01900203 parse(String xml, MxRead parserImpl) {
        return ((MxSemt01900203) parserImpl.read(MxSemt01900203 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSemt01900203 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSemt01900203 message
     * @return
     *     a new instance of MxSemt01900203
     */
    public final static MxSemt01900203 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSemt01900203 .class);
    }
