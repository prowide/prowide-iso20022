    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.013.001.03";
    ...
    public static MxSemt01300103 parse(String xml) {
        return ((MxSemt01300103) MxReadImpl.parse(MxSemt01300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01300103) MxReadImpl.parse(MxSemt01300103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01300103 .class);
    }
