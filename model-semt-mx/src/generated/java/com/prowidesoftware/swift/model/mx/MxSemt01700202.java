    ...
    extends AbstractMX
{
    ...
    public static MxSemt01700202 parse(String xml) {
        return ((MxSemt01700202) MxReadImpl.parse(MxSemt01700202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01700202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700202) MxReadImpl.parse(MxSemt01700202 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01700202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01700202 .class);
    }
