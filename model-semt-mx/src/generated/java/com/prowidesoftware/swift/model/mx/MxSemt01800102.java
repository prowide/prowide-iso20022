    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800102 parse(String xml) {
        return ((MxSemt01800102) MxReadImpl.parse(MxSemt01800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800102) MxReadImpl.parse(MxSemt01800102 .class, xml, _classes, new MxReadParams(conf)));
    }
