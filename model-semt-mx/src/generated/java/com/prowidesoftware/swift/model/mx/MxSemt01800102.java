    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.018.001.02";
    ...
    public static MxSemt01800102 parse(String xml) {
        return ((MxSemt01800102) MxReadImpl.parse(MxSemt01800102 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800102 .class);
    }
