    ...
    extends AbstractMX
{
    ...
    public static MxSemt00300108 parse(String xml) {
        return ((MxSemt00300108) MxReadImpl.parse(MxSemt00300108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00300108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300108) MxReadImpl.parse(MxSemt00300108 .class, xml, _classes, new MxReadParams(conf)));
    }
