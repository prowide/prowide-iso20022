    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.003.001.08";
    ...
    public static MxSemt00300108 parse(String xml) {
        return ((MxSemt00300108) MxReadImpl.parse(MxSemt00300108 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt00300108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00300108 .class);
    }
