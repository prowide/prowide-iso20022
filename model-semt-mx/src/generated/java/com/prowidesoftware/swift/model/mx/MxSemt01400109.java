    ...
    extends AbstractMX
{
    ...
    public static MxSemt01400109 parse(String xml) {
        return ((MxSemt01400109) MxReadImpl.parse(MxSemt01400109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01400109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01400109) MxReadImpl.parse(MxSemt01400109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01400109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01400109 .class);
    }
