    ...
    extends AbstractMX
{
    ...
    public static MxSemt01600104 parse(String xml) {
        return ((MxSemt01600104) MxReadImpl.parse(MxSemt01600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01600104) MxReadImpl.parse(MxSemt01600104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01600104 .class);
    }
