...
/**
 * Class for semt.018.001.01 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:semt.018.001.01")
public class MxSemt01800101
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.018.001.01";
     ...
     * 
     */
    public MxSemt01800101(final String xml) {
        this();
        MxSemt01800101 tmp = parse(xml);
     ...
     * 
     */
    public MxSemt01800101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesTransactionPendingReportV01 }
     *     
     */
     ...
     *     
     */
    public MxSemt01800101 setSctiesTxPdgRpt(SecuritiesTransactionPendingReportV01 value) {
     ...
     * 
     */
    public static MxSemt01800101 parse(String xml) {
        return ((MxSemt01800101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01800101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSemt01800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01800101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSemt01800101 parse(String xml, MxRead parserImpl) {
        return ((MxSemt01800101) parserImpl.read(MxSemt01800101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSemt01800101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSemt01800101 message
     * @return
     *     a new instance of MxSemt01800101
     */
    public final static MxSemt01800101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSemt01800101 .class);
    }
