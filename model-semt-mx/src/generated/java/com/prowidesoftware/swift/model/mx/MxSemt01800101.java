    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800101 parse(String xml) {
        return ((MxSemt01800101) MxReadImpl.parse(MxSemt01800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800101) MxReadImpl.parse(MxSemt01800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800101 .class);
    }
