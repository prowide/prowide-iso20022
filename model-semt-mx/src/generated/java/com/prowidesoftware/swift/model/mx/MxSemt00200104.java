    ...
    extends AbstractMX
{
    ...
    public static MxSemt00200104 parse(String xml) {
        return ((MxSemt00200104) MxReadImpl.parse(MxSemt00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00200104) MxReadImpl.parse(MxSemt00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
