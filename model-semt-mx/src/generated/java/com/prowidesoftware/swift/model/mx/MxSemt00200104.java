    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.002.001.04";
    ...
    public static MxSemt00200104 parse(String xml) {
        return ((MxSemt00200104) MxReadImpl.parse(MxSemt00200104 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt00200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00200104 .class);
    }
