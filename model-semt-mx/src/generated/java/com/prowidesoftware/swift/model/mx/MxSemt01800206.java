    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800206 parse(String xml) {
        return ((MxSemt01800206) MxReadImpl.parse(MxSemt01800206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800206) MxReadImpl.parse(MxSemt01800206 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01800206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800206 .class);
    }
