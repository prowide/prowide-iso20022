    ...
    extends AbstractMX
{
    ...
    public static MxSemt02000102 parse(String xml) {
        return ((MxSemt02000102) MxReadImpl.parse(MxSemt02000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02000102) MxReadImpl.parse(MxSemt02000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02000102 .class);
    }
