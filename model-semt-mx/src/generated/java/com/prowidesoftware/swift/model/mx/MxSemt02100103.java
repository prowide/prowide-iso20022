    ...
    extends AbstractMX
{
    ...
    public static MxSemt02100103 parse(String xml) {
        return ((MxSemt02100103) MxReadImpl.parse(MxSemt02100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02100103) MxReadImpl.parse(MxSemt02100103 .class, xml, _classes, new MxReadParams(conf)));
    }
