    ...
    extends AbstractMX
{
    ...
    public static MxSemt00300209 parse(String xml) {
        return ((MxSemt00300209) MxReadImpl.parse(MxSemt00300209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00300209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300209) MxReadImpl.parse(MxSemt00300209 .class, xml, _classes, new MxReadParams(conf)));
    }
