    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.003.002.09";
    ...
    public static MxSemt00300209 parse(String xml) {
        return ((MxSemt00300209) MxReadImpl.parse(MxSemt00300209 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt00300209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00300209 .class);
    }
