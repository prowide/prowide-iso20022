    ...
    extends AbstractMX
{
    ...
    public static MxSemt01400207 parse(String xml) {
        return ((MxSemt01400207) MxReadImpl.parse(MxSemt01400207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01400207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01400207) MxReadImpl.parse(MxSemt01400207 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01400207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01400207 .class);
    }
