    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:semt.017.002.05";
    ...
    public static MxSemt01700205 parse(String xml) {
        return ((MxSemt01700205) MxReadImpl.parse(MxSemt01700205 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01700205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01700205 .class);
    }
