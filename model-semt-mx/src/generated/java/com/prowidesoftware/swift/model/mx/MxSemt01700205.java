    ...
    extends AbstractMX
{
    ...
    public static MxSemt01700205 parse(String xml) {
        return ((MxSemt01700205) MxReadImpl.parse(MxSemt01700205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01700205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700205) MxReadImpl.parse(MxSemt01700205 .class, xml, _classes, new MxReadParams(conf)));
    }
