    ...
    extends AbstractMX
{
    ...
    public static MxSemt00600102 parse(String xml) {
        return ((MxSemt00600102) MxReadImpl.parse(MxSemt00600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00600102) MxReadImpl.parse(MxSemt00600102 .class, xml, _classes, new MxReadParams(conf)));
    }
