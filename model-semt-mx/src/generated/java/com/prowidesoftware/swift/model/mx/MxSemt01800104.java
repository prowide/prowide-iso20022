    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800104 parse(String xml) {
        return ((MxSemt01800104) MxReadImpl.parse(MxSemt01800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800104) MxReadImpl.parse(MxSemt01800104 .class, xml, _classes, new MxReadParams(conf)));
    }
