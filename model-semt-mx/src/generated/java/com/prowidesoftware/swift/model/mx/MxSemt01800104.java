    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.018.001.04";
    ...
    public static MxSemt01800104 parse(String xml) {
        return ((MxSemt01800104) MxReadImpl.parse(MxSemt01800104 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800104 .class);
    }
