    ...
    extends AbstractMX
{
    ...
    public static MxSemt01600202 parse(String xml) {
        return ((MxSemt01600202) MxReadImpl.parse(MxSemt01600202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01600202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01600202) MxReadImpl.parse(MxSemt01600202 .class, xml, _classes, new MxReadParams(conf)));
    }
