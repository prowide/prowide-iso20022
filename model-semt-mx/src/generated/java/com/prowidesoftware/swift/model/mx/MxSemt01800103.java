    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800103 parse(String xml) {
        return ((MxSemt01800103) MxReadImpl.parse(MxSemt01800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800103) MxReadImpl.parse(MxSemt01800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800103 .class);
    }
