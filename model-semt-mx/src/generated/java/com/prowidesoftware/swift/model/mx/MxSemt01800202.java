    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800202 parse(String xml) {
        return ((MxSemt01800202) MxReadImpl.parse(MxSemt01800202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800202) MxReadImpl.parse(MxSemt01800202 .class, xml, _classes, new MxReadParams(conf)));
    }
