    ...
    extends AbstractMX
{
    ...
    public static MxSemt01700105 parse(String xml) {
        return ((MxSemt01700105) MxReadImpl.parse(MxSemt01700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700105) MxReadImpl.parse(MxSemt01700105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01700105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01700105 .class);
    }
