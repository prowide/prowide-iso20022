    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800106 parse(String xml) {
        return ((MxSemt01800106) MxReadImpl.parse(MxSemt01800106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800106) MxReadImpl.parse(MxSemt01800106 .class, xml, _classes, new MxReadParams(conf)));
    }
