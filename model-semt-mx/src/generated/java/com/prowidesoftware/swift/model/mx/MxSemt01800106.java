    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.018.001.06";
    ...
    public static MxSemt01800106 parse(String xml) {
        return ((MxSemt01800106) MxReadImpl.parse(MxSemt01800106 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01800106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800106 .class);
    }
