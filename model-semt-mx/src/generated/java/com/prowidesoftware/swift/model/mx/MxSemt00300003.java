...
/**
 * Class for semt.003.000.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSemt00300003(final String xml) {
        this();
        MxSemt00300003 tmp = parse(xml);
     ...
     * 
     */
    public MxSemt00300003(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesBalanceAccountingReportV1 }
     *     
     */
    public SecuritiesBalanceAccountingReportV1 getSctiesBalAcctgRpt() {
     ...
     *     
     */
    public MxSemt00300003 setSctiesBalAcctgRpt(SecuritiesBalanceAccountingReportV1 value) {
     ...
     * 
     */
    public static MxSemt00300003 parse(String xml) {
        return ((MxSemt00300003) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt00300003 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSemt00300003 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300003) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt00300003 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSemt00300003 parse(String xml, MxRead parserImpl) {
        return ((MxSemt00300003) parserImpl.read(MxSemt00300003 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSemt00300003 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSemt00300003 message
     * @return
     *     a new instance of MxSemt00300003
     */
    public final static MxSemt00300003 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSemt00300003 .class);
    }
