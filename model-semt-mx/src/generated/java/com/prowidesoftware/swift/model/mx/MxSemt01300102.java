    ...
    extends AbstractMX
{
    ...
    public static MxSemt01300102 parse(String xml) {
        return ((MxSemt01300102) MxReadImpl.parse(MxSemt01300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01300102) MxReadImpl.parse(MxSemt01300102 .class, xml, _classes, new MxReadParams(conf)));
    }
