    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.013.001.02";
    ...
    public static MxSemt01300102 parse(String xml) {
        return ((MxSemt01300102) MxReadImpl.parse(MxSemt01300102 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01300102 .class);
    }
