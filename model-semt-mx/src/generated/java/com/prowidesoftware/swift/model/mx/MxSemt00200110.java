    ...
    extends AbstractMX
{
    ...
    public static MxSemt00200110 parse(String xml) {
        return ((MxSemt00200110) MxReadImpl.parse(MxSemt00200110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00200110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00200110) MxReadImpl.parse(MxSemt00200110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt00200110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00200110 .class);
    }
