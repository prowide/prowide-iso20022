    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.021.002.04";
    ...
    public static MxSemt02100204 parse(String xml) {
        return ((MxSemt02100204) MxReadImpl.parse(MxSemt02100204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02100204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02100204) MxReadImpl.parse(MxSemt02100204 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt02100204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02100204 .class);
    }
