    ...
    extends AbstractMX
{
    ...
    public static MxSemt00200105 parse(String xml) {
        return ((MxSemt00200105) MxReadImpl.parse(MxSemt00200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00200105) MxReadImpl.parse(MxSemt00200105 .class, xml, _classes, new MxReadParams(conf)));
    }
