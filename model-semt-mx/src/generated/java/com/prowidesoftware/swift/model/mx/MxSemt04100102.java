    ...
    extends AbstractMX
{
    ...
    public static MxSemt04100102 parse(String xml) {
        return ((MxSemt04100102) MxReadImpl.parse(MxSemt04100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt04100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt04100102) MxReadImpl.parse(MxSemt04100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt04100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt04100102 .class);
    }
