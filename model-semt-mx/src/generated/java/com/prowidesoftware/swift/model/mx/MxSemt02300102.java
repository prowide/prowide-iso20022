    ...
    extends AbstractMX
{
    ...
    public static MxSemt02300102 parse(String xml) {
        return ((MxSemt02300102) MxReadImpl.parse(MxSemt02300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02300102) MxReadImpl.parse(MxSemt02300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02300102 .class);
    }
