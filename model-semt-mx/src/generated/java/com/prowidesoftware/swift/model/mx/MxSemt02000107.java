    ...
    extends AbstractMX
{
    ...
    public static MxSemt02000107 parse(String xml) {
        return ((MxSemt02000107) MxReadImpl.parse(MxSemt02000107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02000107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02000107) MxReadImpl.parse(MxSemt02000107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02000107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02000107 .class);
    }
