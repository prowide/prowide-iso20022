    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.018.002.10";
    ...
    public static MxSemt01800210 parse(String xml) {
        return ((MxSemt01800210) MxReadImpl.parse(MxSemt01800210 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01800210 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800210 .class);
    }
