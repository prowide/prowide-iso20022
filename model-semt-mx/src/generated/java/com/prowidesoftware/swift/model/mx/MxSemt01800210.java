    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800210 parse(String xml) {
        return ((MxSemt01800210) MxReadImpl.parse(MxSemt01800210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800210) MxReadImpl.parse(MxSemt01800210 .class, xml, _classes, new MxReadParams(conf)));
    }
