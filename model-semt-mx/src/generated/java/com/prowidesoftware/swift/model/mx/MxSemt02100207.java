    ...
    extends AbstractMX
{
    ...
    public static MxSemt02100207 parse(String xml) {
        return ((MxSemt02100207) MxReadImpl.parse(MxSemt02100207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02100207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02100207) MxReadImpl.parse(MxSemt02100207 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02100207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02100207 .class);
    }
