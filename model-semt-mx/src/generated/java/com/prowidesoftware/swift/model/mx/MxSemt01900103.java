    ...
    extends AbstractMX
{
    ...
    public static MxSemt01900103 parse(String xml) {
        return ((MxSemt01900103) MxReadImpl.parse(MxSemt01900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900103) MxReadImpl.parse(MxSemt01900103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900103 .class);
    }
