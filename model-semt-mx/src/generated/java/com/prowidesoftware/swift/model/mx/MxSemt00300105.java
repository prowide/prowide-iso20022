    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.003.001.05";
    ...
    public static MxSemt00300105 parse(String xml) {
        return ((MxSemt00300105) MxReadImpl.parse(MxSemt00300105 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt00300105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00300105 .class);
    }
