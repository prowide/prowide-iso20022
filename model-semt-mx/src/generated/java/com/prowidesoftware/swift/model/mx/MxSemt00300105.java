    ...
    extends AbstractMX
{
    ...
    public static MxSemt00300105 parse(String xml) {
        return ((MxSemt00300105) MxReadImpl.parse(MxSemt00300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300105) MxReadImpl.parse(MxSemt00300105 .class, xml, _classes, new MxReadParams(conf)));
    }
