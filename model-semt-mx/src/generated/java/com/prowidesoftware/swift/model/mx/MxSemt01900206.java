...
/**
 * Class for semt.019.002.06 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.019.002.06";
     ...
     * 
     */
    public MxSemt01900206(final String xml) {
        this();
        MxSemt01900206 tmp = parse(xml);
     ...
     * 
     */
    public MxSemt01900206(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionAllegementReport002V06 }
     *     
     */
     ...
     *     
     */
    public MxSemt01900206 setSctiesSttlmTxAllgmtRpt(SecuritiesSettlementTransactionAllegementReport002V06 value) {
     ...
     * 
     */
    public static MxSemt01900206 parse(String xml) {
        return ((MxSemt01900206) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01900206 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSemt01900206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900206) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01900206 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSemt01900206 parse(String xml, MxRead parserImpl) {
        return ((MxSemt01900206) parserImpl.read(MxSemt01900206 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSemt01900206 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSemt01900206 message
     * @return
     *     a new instance of MxSemt01900206
     */
    public final static MxSemt01900206 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSemt01900206 .class);
    }
