    ...
    extends AbstractMX
{
    ...
    public static MxSemt01900206 parse(String xml) {
        return ((MxSemt01900206) MxReadImpl.parse(MxSemt01900206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900206) MxReadImpl.parse(MxSemt01900206 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01900206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900206 .class);
    }
