    ...
    extends AbstractMX
{
    ...
    public static MxSemt02200203 parse(String xml) {
        return ((MxSemt02200203) MxReadImpl.parse(MxSemt02200203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02200203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02200203) MxReadImpl.parse(MxSemt02200203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02200203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02200203 .class);
    }
