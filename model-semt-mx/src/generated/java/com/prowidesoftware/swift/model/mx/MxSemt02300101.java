    ...
    extends AbstractMX
{
    ...
    public static MxSemt02300101 parse(String xml) {
        return ((MxSemt02300101) MxReadImpl.parse(MxSemt02300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02300101) MxReadImpl.parse(MxSemt02300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02300101 .class);
    }
