    ...
    extends AbstractMX
{
    ...
    public static MxSemt01300203 parse(String xml) {
        return ((MxSemt01300203) MxReadImpl.parse(MxSemt01300203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01300203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01300203) MxReadImpl.parse(MxSemt01300203 .class, xml, _classes, new MxReadParams(conf)));
    }
