    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:semt.013.002.03";
    ...
    public static MxSemt01300203 parse(String xml) {
        return ((MxSemt01300203) MxReadImpl.parse(MxSemt01300203 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01300203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01300203 .class);
    }
