    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.017.002.08";
    ...
    public static MxSemt01700208 parse(String xml) {
        return ((MxSemt01700208) MxReadImpl.parse(MxSemt01700208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01700208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700208) MxReadImpl.parse(MxSemt01700208 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01700208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01700208 .class);
    }
