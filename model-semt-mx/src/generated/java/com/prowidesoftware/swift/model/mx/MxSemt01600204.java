    ...
    extends AbstractMX
{
    ...
    public static MxSemt01600204 parse(String xml) {
        return ((MxSemt01600204) MxReadImpl.parse(MxSemt01600204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01600204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01600204) MxReadImpl.parse(MxSemt01600204 .class, xml, _classes, new MxReadParams(conf)));
    }
