    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:semt.016.002.04";
    ...
    public static MxSemt01600204 parse(String xml) {
        return ((MxSemt01600204) MxReadImpl.parse(MxSemt01600204 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01600204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01600204 .class);
    }
