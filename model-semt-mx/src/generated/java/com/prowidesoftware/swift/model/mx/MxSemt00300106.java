    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.003.001.06";
    ...
    public static MxSemt00300106 parse(String xml) {
        return ((MxSemt00300106) MxReadImpl.parse(MxSemt00300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300106) MxReadImpl.parse(MxSemt00300106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt00300106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00300106 .class);
    }
