    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.015.002.01";
    ...
    public static MxSemt01500201 parse(String xml) {
        return ((MxSemt01500201) MxReadImpl.parse(MxSemt01500201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01500201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01500201) MxReadImpl.parse(MxSemt01500201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt01500201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01500201 .class);
    }
