    ...
    extends AbstractMX
{
    ...
    public static MxSemt02100205 parse(String xml) {
        return ((MxSemt02100205) MxReadImpl.parse(MxSemt02100205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02100205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02100205) MxReadImpl.parse(MxSemt02100205 .class, xml, _classes, new MxReadParams(conf)));
    }
