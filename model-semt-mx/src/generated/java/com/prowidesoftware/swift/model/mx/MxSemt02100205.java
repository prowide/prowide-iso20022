    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:semt.021.002.05";
    ...
    public static MxSemt02100205 parse(String xml) {
        return ((MxSemt02100205) MxReadImpl.parse(MxSemt02100205 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt02100205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02100205 .class);
    }
