    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.016.001.08";
    ...
    public static MxSemt01600108 parse(String xml) {
        return ((MxSemt01600108) MxReadImpl.parse(MxSemt01600108 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01600108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01600108 .class);
    }
