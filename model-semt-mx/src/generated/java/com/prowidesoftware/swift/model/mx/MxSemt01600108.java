    ...
    extends AbstractMX
{
    ...
    public static MxSemt01600108 parse(String xml) {
        return ((MxSemt01600108) MxReadImpl.parse(MxSemt01600108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01600108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01600108) MxReadImpl.parse(MxSemt01600108 .class, xml, _classes, new MxReadParams(conf)));
    }
