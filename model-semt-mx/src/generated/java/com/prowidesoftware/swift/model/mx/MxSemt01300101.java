    ...
    extends AbstractMX
{
    ...
    public static MxSemt01300101 parse(String xml) {
        return ((MxSemt01300101) MxReadImpl.parse(MxSemt01300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01300101) MxReadImpl.parse(MxSemt01300101 .class, xml, _classes, new MxReadParams(conf)));
    }
