    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.013.001.01";
    ...
    public static MxSemt01300101 parse(String xml) {
        return ((MxSemt01300101) MxReadImpl.parse(MxSemt01300101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01300101 .class);
    }
