    ...
    extends AbstractMX
{
    ...
    public static MxSemt00900101 parse(String xml) {
        return ((MxSemt00900101) MxReadImpl.parse(MxSemt00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00900101) MxReadImpl.parse(MxSemt00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
