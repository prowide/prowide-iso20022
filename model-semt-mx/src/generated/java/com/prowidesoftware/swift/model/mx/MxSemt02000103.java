    ...
    extends AbstractMX
{
    ...
    public static MxSemt02000103 parse(String xml) {
        return ((MxSemt02000103) MxReadImpl.parse(MxSemt02000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02000103) MxReadImpl.parse(MxSemt02000103 .class, xml, _classes, new MxReadParams(conf)));
    }
