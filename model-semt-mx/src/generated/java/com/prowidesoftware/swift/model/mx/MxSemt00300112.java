    ...
    extends AbstractMX
{
    ...
    public static MxSemt00300112 parse(String xml) {
        return ((MxSemt00300112) MxReadImpl.parse(MxSemt00300112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00300112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300112) MxReadImpl.parse(MxSemt00300112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt00300112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00300112 .class);
    }
