    ...
    extends AbstractMX
{
    ...
    public static MxSemt00200210 parse(String xml) {
        return ((MxSemt00200210) MxReadImpl.parse(MxSemt00200210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00200210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00200210) MxReadImpl.parse(MxSemt00200210 .class, xml, _classes, new MxReadParams(conf)));
    }
