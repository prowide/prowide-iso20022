...
/**
 * Class for semt.021.001.07 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:semt.021.001.07")
public class MxSemt02100107
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.021.001.07";
     ...
     * 
     */
    public MxSemt02100107(final String xml) {
        this();
        MxSemt02100107 tmp = parse(xml);
     ...
     * 
     */
    public MxSemt02100107(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesStatementQueryV07 }
     *     
     */
     ...
     *     
     */
    public MxSemt02100107 setSctiesStmtQry(SecuritiesStatementQueryV07 value) {
     ...
     * 
     */
    public static MxSemt02100107 parse(String xml) {
        return ((MxSemt02100107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt02100107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSemt02100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02100107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt02100107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSemt02100107 parse(String xml, MxRead parserImpl) {
        return ((MxSemt02100107) parserImpl.read(MxSemt02100107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSemt02100107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSemt02100107 message
     * @return
     *     a new instance of MxSemt02100107
     */
    public final static MxSemt02100107 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSemt02100107 .class);
    }
