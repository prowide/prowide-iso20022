    ...
    extends AbstractMX
{
    ...
    public static MxSemt02100107 parse(String xml) {
        return ((MxSemt02100107) MxReadImpl.parse(MxSemt02100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt02100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt02100107) MxReadImpl.parse(MxSemt02100107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt02100107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt02100107 .class);
    }
