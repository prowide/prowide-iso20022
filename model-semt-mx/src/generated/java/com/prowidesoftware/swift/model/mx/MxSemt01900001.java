...
/**
 * Class for semt.019.000.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSemt01900001(final String xml) {
        this();
        MxSemt01900001 tmp = parse(xml);
     ...
     * 
     */
    public MxSemt01900001(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionAllegementReportV1 }
     *     
     */
    public SecuritiesSettlementTransactionAllegementReportV1 getSctiesSttlmTxAllgmtRpt() {
     ...
     *     
     */
    public MxSemt01900001 setSctiesSttlmTxAllgmtRpt(SecuritiesSettlementTransactionAllegementReportV1 value) {
     ...
     * 
     */
    public static MxSemt01900001 parse(String xml) {
        return ((MxSemt01900001) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01900001 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSemt01900001 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900001) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01900001 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSemt01900001 parse(String xml, MxRead parserImpl) {
        return ((MxSemt01900001) parserImpl.read(MxSemt01900001 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSemt01900001 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSemt01900001 message
     * @return
     *     a new instance of MxSemt01900001
     */
    public static final MxSemt01900001 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSemt01900001 .class);
    }
