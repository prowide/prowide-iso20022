    ...
    extends AbstractMX
{
    ...
    public static MxSemt01900101 parse(String xml) {
        return ((MxSemt01900101) MxReadImpl.parse(MxSemt01900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01900101) MxReadImpl.parse(MxSemt01900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01900101 .class);
    }
