    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:semt.003.001.02";
    ...
    public static MxSemt00300102 parse(String xml) {
        return ((MxSemt00300102) MxReadImpl.parse(MxSemt00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt00300102) MxReadImpl.parse(MxSemt00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSemt00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt00300102 .class);
    }
