    ...
    extends AbstractMX
{
    ...
    public static MxSemt01700103 parse(String xml) {
        return ((MxSemt01700103) MxReadImpl.parse(MxSemt01700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700103) MxReadImpl.parse(MxSemt01700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01700103 .class);
    }
