...
/**
 * Class for semt.017.001.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.017.001.03";
     ...
     * 
     */
    public MxSemt01700103(final String xml) {
        this();
        MxSemt01700103 tmp = parse(xml);
     ...
     * 
     */
    public MxSemt01700103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesTransactionPostingReportV03 }
     *     
     */
     ...
     *     
     */
    public MxSemt01700103 setSctiesTxPstngRpt(SecuritiesTransactionPostingReportV03 value) {
     ...
     * 
     */
    public static MxSemt01700103 parse(String xml) {
        return ((MxSemt01700103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01700103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSemt01700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01700103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01700103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSemt01700103 parse(String xml, MxRead parserImpl) {
        return ((MxSemt01700103) parserImpl.read(MxSemt01700103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSemt01700103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSemt01700103 message
     * @return
     *     a new instance of MxSemt01700103
     */
    public final static MxSemt01700103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSemt01700103 .class);
    }
