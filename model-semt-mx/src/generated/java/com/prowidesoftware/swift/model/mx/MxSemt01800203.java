    ...
    extends AbstractMX
{
    ...
    public static MxSemt01800203 parse(String xml) {
        return ((MxSemt01800203) MxReadImpl.parse(MxSemt01800203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01800203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800203) MxReadImpl.parse(MxSemt01800203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01800203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01800203 .class);
    }
