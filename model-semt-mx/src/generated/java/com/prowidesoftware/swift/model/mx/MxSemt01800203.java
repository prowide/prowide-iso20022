...
/**
 * Class for semt.018.002.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSemt01800203(final String xml) {
        this();
        MxSemt01800203 tmp = parse(xml);
     ...
     * 
     */
    public MxSemt01800203(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesTransactionPendingReport002V03 }
     *     
     */
    public SecuritiesTransactionPendingReport002V03 getSctiesTxPdgRpt() {
     ...
     *     
     */
    public MxSemt01800203 setSctiesTxPdgRpt(SecuritiesTransactionPendingReport002V03 value) {
     ...
     * 
     */
    public static MxSemt01800203 parse(String xml) {
        return ((MxSemt01800203) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01800203 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSemt01800203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01800203) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSemt01800203 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSemt01800203 parse(String xml, MxRead parserImpl) {
        return ((MxSemt01800203) parserImpl.read(MxSemt01800203 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSemt01800203 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSemt01800203 message
     * @return
     *     a new instance of MxSemt01800203
     */
    public final static MxSemt01800203 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSemt01800203 .class);
    }
