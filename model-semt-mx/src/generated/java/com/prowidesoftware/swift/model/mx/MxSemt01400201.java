    ...
    extends AbstractMX
{
    ...
    public static MxSemt01400201 parse(String xml) {
        return ((MxSemt01400201) MxReadImpl.parse(MxSemt01400201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01400201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01400201) MxReadImpl.parse(MxSemt01400201 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01400201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01400201 .class);
    }
