    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:semt.015.001.07";
    ...
    public static MxSemt01500107 parse(String xml) {
        return ((MxSemt01500107) MxReadImpl.parse(MxSemt01500107 .class, xml, _classes));
    }
     ...
     */
    public final static MxSemt01500107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01500107 .class);
    }
