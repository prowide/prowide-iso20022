    ...
    extends AbstractMX
{
    ...
    public static MxSemt01500107 parse(String xml) {
        return ((MxSemt01500107) MxReadImpl.parse(MxSemt01500107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01500107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01500107) MxReadImpl.parse(MxSemt01500107 .class, xml, _classes, new MxReadParams(conf)));
    }
