    ...
    extends AbstractMX
{
    ...
    public static MxSemt01300107 parse(String xml) {
        return ((MxSemt01300107) MxReadImpl.parse(MxSemt01300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSemt01300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSemt01300107) MxReadImpl.parse(MxSemt01300107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSemt01300107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSemt01300107 .class);
    }
