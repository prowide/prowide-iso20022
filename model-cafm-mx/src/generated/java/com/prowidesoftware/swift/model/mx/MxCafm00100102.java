    ...
    extends AbstractMX
{
    ...
    public static MxCafm00100102 parse(String xml) {
        return ((MxCafm00100102) MxReadImpl.parse(MxCafm00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafm00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafm00100102) MxReadImpl.parse(MxCafm00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCafm00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafm00100102 .class);
    }
