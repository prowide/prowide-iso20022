    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cafm.001.001.03";
    ...
    public static MxCafm00100103 parse(String xml) {
        return ((MxCafm00100103) MxReadImpl.parse(MxCafm00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafm00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafm00100103) MxReadImpl.parse(MxCafm00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCafm00100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafm00100103 .class);
    }
