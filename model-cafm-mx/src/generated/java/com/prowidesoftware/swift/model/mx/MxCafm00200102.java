    ...
    extends AbstractMX
{
    ...
    public static MxCafm00200102 parse(String xml) {
        return ((MxCafm00200102) MxReadImpl.parse(MxCafm00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafm00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafm00200102) MxReadImpl.parse(MxCafm00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCafm00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafm00200102 .class);
    }
