...
/**
 * Class for cafm.002.001.02 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:cafm.002.001.02")
public class MxCafm00200102
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCafm00200102(final String xml) {
        this();
        MxCafm00200102 tmp = parse(xml);
     ...
     * 
     */
    public MxCafm00200102(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCafm00200102 setFileActnRspn(FileActionResponseV02 value) {
     ...
     * 
     */
    public static MxCafm00200102 parse(String xml) {
        return ((MxCafm00200102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCafm00200102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCafm00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafm00200102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCafm00200102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCafm00200102 parse(String xml, MxRead parserImpl) {
        return ((MxCafm00200102) parserImpl.read(MxCafm00200102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCafm00200102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCafm00200102 message
     * @return
     *     a new instance of MxCafm00200102
     */
    public static final MxCafm00200102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCafm00200102 .class);
    }
