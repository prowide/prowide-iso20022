    ...
    extends AbstractMX
{
    ...
    public static MxCafm00200104 parse(String xml) {
        return ((MxCafm00200104) MxReadImpl.parse(MxCafm00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafm00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafm00200104) MxReadImpl.parse(MxCafm00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCafm00200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafm00200104 .class);
    }
