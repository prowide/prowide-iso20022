    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cafm.001.001.01";
    ...
    public static MxCafm00100101 parse(String xml) {
        return ((MxCafm00100101) MxReadImpl.parse(MxCafm00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafm00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafm00100101) MxReadImpl.parse(MxCafm00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCafm00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafm00100101 .class);
    }
