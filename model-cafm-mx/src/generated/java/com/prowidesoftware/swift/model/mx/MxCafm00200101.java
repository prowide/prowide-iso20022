    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cafm.002.001.01";
    ...
    public static MxCafm00200101 parse(String xml) {
        return ((MxCafm00200101) MxReadImpl.parse(MxCafm00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafm00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafm00200101) MxReadImpl.parse(MxCafm00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCafm00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafm00200101 .class);
    }
