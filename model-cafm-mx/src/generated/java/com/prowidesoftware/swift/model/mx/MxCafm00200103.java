    ...
    extends AbstractMX
{
    ...
    public static MxCafm00200103 parse(String xml) {
        return ((MxCafm00200103) MxReadImpl.parse(MxCafm00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafm00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafm00200103) MxReadImpl.parse(MxCafm00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCafm00200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafm00200103 .class);
    }
