    ...
    extends AbstractMX
{
    ...
    public static MxCamt09200101 parse(String xml) {
        return ((MxCamt09200101) MxReadImpl.parse(MxCamt09200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt09200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt09200101) MxReadImpl.parse(MxCamt09200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt09200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt09200101 .class);
    }
