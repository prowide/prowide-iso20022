    ...
    extends AbstractMX
{
    ...
    public static MxCamt03500102 parse(String xml) {
        return ((MxCamt03500102) MxReadImpl.parse(MxCamt03500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03500102) MxReadImpl.parse(MxCamt03500102 .class, xml, _classes, new MxReadParams(conf)));
    }
