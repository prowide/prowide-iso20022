    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.057.001.07";
    ...
    public static MxCamt05700107 parse(String xml) {
        return ((MxCamt05700107) MxReadImpl.parse(MxCamt05700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05700107) MxReadImpl.parse(MxCamt05700107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05700107 .class);
    }
