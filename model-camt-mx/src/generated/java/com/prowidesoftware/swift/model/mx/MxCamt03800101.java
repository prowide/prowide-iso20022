    ...
    extends AbstractMX
{
    ...
    public static MxCamt03800101 parse(String xml) {
        return ((MxCamt03800101) MxReadImpl.parse(MxCamt03800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03800101) MxReadImpl.parse(MxCamt03800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03800101 .class);
    }
