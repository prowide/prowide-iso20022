    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.048.001.05";
    ...
    public static MxCamt04800105 parse(String xml) {
        return ((MxCamt04800105) MxReadImpl.parse(MxCamt04800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04800105) MxReadImpl.parse(MxCamt04800105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt04800105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04800105 .class);
    }
