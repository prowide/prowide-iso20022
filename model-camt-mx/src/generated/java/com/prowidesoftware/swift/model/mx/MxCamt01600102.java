    ...
    extends AbstractMX
{
    ...
    public static MxCamt01600102 parse(String xml) {
        return ((MxCamt01600102) MxReadImpl.parse(MxCamt01600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01600102) MxReadImpl.parse(MxCamt01600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01600102 .class);
    }
