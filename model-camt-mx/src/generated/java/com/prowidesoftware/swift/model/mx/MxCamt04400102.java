    ...
    extends AbstractMX
{
    ...
    public static MxCamt04400102 parse(String xml) {
        return ((MxCamt04400102) MxReadImpl.parse(MxCamt04400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04400102) MxReadImpl.parse(MxCamt04400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04400102 .class);
    }
