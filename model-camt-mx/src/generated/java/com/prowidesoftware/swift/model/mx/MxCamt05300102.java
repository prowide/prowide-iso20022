    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02";
    ...
    public static MxCamt05300102 parse(String xml) {
        return ((MxCamt05300102) MxReadImpl.parse(MxCamt05300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05300102) MxReadImpl.parse(MxCamt05300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05300102 .class);
    }
