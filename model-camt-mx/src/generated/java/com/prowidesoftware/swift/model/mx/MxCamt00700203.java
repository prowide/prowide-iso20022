    ...
    extends AbstractMX
{
    ...
    public static MxCamt00700203 parse(String xml) {
        return ((MxCamt00700203) MxReadImpl.parse(MxCamt00700203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00700203 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00700203) MxReadImpl.parse(MxCamt00700203 .class, xml, _classes, new MxReadParams(conf)));
    }
