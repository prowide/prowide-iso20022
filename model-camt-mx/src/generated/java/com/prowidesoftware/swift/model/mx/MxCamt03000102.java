    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Camt03000102 .class, Case.class, CaseAssignment.class, CaseForwardingNotification2 .class, CaseForwardingNotification2Code.class, MxCamt03000102 .class, ReportHeader.class };
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.030.001.02";
    ...
    public static MxCamt03000102 parse(String xml) {
        return ((MxCamt03000102) MxReadImpl.parse(MxCamt03000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03000102) MxReadImpl.parse(MxCamt03000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03000102 .class);
    }
