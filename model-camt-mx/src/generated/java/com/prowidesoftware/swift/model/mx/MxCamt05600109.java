...
/**
 * Class for camt.056.001.09 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.056.001.09")
public class MxCamt05600109
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt05600109(final String xml) {
        this();
        MxCamt05600109 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05600109(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCamt05600109 setFIToFIPmtCxlReq(FIToFIPaymentCancellationRequestV09 value) {
    ...
    public static MxCamt05600109 parse(String xml) {
        return ((MxCamt05600109) MxReadImpl.parse(MxCamt05600109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05600109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05600109) MxReadImpl.parse(MxCamt05600109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05600109 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05600109) parserImpl.read(MxCamt05600109 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05600109 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05600109 message
     * @return
     *     a new instance of MxCamt05600109
     */
    public static final MxCamt05600109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05600109 .class);
    }
