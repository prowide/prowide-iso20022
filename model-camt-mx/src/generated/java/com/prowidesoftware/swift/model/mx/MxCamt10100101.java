    ...
    extends AbstractMX
{
    ...
    public static MxCamt10100101 parse(String xml) {
        return ((MxCamt10100101) MxReadImpl.parse(MxCamt10100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10100101) MxReadImpl.parse(MxCamt10100101 .class, xml, _classes, new MxReadParams(conf)));
    }
