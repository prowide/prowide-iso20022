    ...
    extends AbstractMX
{
    ...
    public static MxCamt01900105 parse(String xml) {
        return ((MxCamt01900105) MxReadImpl.parse(MxCamt01900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01900105) MxReadImpl.parse(MxCamt01900105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01900105 .class);
    }
