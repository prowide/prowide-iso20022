    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Camt03300101 .class, Case.class, CaseAssignment.class, MxCamt03300101 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.033.001.01";
    ...
    public static MxCamt03300101 parse(String xml) {
        return ((MxCamt03300101) MxReadImpl.parse(MxCamt03300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03300101) MxReadImpl.parse(MxCamt03300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03300101 .class);
    }
