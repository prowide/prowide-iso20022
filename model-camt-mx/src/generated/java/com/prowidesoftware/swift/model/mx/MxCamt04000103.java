    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.040.001.03";
    ...
    public static MxCamt04000103 parse(String xml) {
        return ((MxCamt04000103) MxReadImpl.parse(MxCamt04000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04000103) MxReadImpl.parse(MxCamt04000103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt04000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04000103 .class);
    }
