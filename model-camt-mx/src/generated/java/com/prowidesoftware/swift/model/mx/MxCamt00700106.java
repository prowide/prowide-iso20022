    ...
    extends AbstractMX
{
    ...
    public static MxCamt00700106 parse(String xml) {
        return ((MxCamt00700106) MxReadImpl.parse(MxCamt00700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00700106) MxReadImpl.parse(MxCamt00700106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00700106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00700106 .class);
    }
