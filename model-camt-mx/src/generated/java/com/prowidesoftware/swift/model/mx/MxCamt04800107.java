    ...
    extends AbstractMX
{
    ...
    public static MxCamt04800107 parse(String xml) {
        return ((MxCamt04800107) MxReadImpl.parse(MxCamt04800107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04800107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04800107) MxReadImpl.parse(MxCamt04800107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04800107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04800107 .class);
    }
