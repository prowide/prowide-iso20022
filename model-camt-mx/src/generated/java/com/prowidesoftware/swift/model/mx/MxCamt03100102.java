    ...
    extends AbstractMX
{
    ...
    public static MxCamt03100102 parse(String xml) {
        return ((MxCamt03100102) MxReadImpl.parse(MxCamt03100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03100102) MxReadImpl.parse(MxCamt03100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03100102 .class);
    }
