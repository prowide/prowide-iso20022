    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Camt02700102 .class, Case.class, CaseAssignment.class, CurrencyAndAmount.class, MissingCover.class, MxCamt02700102 .class, PaymentInstructionExtract2 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.027.001.02";
    ...
    public static MxCamt02700102 parse(String xml) {
        return ((MxCamt02700102) MxReadImpl.parse(MxCamt02700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02700102) MxReadImpl.parse(MxCamt02700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02700102 fromJson(String json) {
