    ...
    extends AbstractMX
{
    ...
    public static MxCamt01900102 parse(String xml) {
        return ((MxCamt01900102) MxReadImpl.parse(MxCamt01900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01900102) MxReadImpl.parse(MxCamt01900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01900102 .class);
    }
