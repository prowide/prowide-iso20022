    ...
    extends AbstractMX
{
    ...
    public static MxCamt05900106 parse(String xml) {
        return ((MxCamt05900106) MxReadImpl.parse(MxCamt05900106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05900106) MxReadImpl.parse(MxCamt05900106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05900106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05900106 .class);
    }
