    ...
    extends AbstractMX
{
    ...
    public static MxCamt05200113 parse(String xml) {
        return ((MxCamt05200113) MxReadImpl.parse(MxCamt05200113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05200113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05200113) MxReadImpl.parse(MxCamt05200113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05200113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05200113 .class);
    }
