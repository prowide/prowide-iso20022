    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.087.001.09";
    ...
    public static MxCamt08700109 parse(String xml) {
        return ((MxCamt08700109) MxReadImpl.parse(MxCamt08700109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08700109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08700109) MxReadImpl.parse(MxCamt08700109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt08700109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08700109 .class);
    }
