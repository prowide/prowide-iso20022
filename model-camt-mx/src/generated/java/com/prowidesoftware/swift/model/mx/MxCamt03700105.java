    ...
    extends AbstractMX
{
    ...
    public static MxCamt03700105 parse(String xml) {
        return ((MxCamt03700105) MxReadImpl.parse(MxCamt03700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03700105) MxReadImpl.parse(MxCamt03700105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03700105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03700105 .class);
    }
