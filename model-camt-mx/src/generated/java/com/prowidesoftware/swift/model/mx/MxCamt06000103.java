    ...
    extends AbstractMX
{
    ...
    public static MxCamt06000103 parse(String xml) {
        return ((MxCamt06000103) MxReadImpl.parse(MxCamt06000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06000103) MxReadImpl.parse(MxCamt06000103 .class, xml, _classes, new MxReadParams(conf)));
    }
