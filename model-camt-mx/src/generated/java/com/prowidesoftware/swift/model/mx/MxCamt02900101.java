    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.029.001.01";
    ...
    public static MxCamt02900101 parse(String xml) {
        return ((MxCamt02900101) MxReadImpl.parse(MxCamt02900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02900101) MxReadImpl.parse(MxCamt02900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02900101 fromJson(String json) {
