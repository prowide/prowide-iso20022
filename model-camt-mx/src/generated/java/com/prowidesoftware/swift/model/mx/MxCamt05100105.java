    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.051.001.05";
    ...
    public static MxCamt05100105 parse(String xml) {
        return ((MxCamt05100105) MxReadImpl.parse(MxCamt05100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05100105) MxReadImpl.parse(MxCamt05100105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05100105 fromJson(String json) {
