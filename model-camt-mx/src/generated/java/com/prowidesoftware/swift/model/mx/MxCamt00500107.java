    ...
    extends AbstractMX
{
    ...
    public static MxCamt00500107 parse(String xml) {
        return ((MxCamt00500107) MxReadImpl.parse(MxCamt00500107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00500107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00500107) MxReadImpl.parse(MxCamt00500107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00500107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00500107 .class);
    }
