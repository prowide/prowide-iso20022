    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.088.001.02";
    ...
    public static MxCamt08800102 parse(String xml) {
        return ((MxCamt08800102) MxReadImpl.parse(MxCamt08800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08800102) MxReadImpl.parse(MxCamt08800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt08800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08800102 .class);
    }
