    ...
    extends AbstractMX
{
    ...
    public static MxCamt05200114 parse(String xml) {
        return ((MxCamt05200114) MxReadImpl.parse(MxCamt05200114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05200114 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05200114) MxReadImpl.parse(MxCamt05200114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05200114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05200114 .class);
    }
