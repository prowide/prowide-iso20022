    ...
    extends AbstractMX
{
    ...
    public static MxCamt07800102 parse(String xml) {
        return ((MxCamt07800102) MxReadImpl.parse(MxCamt07800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07800102) MxReadImpl.parse(MxCamt07800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt07800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07800102 .class);
    }
