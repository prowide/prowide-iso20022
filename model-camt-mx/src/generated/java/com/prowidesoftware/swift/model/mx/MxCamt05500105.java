...
/**
 * Class for camt.055.001.05 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt05500105(final String xml) {
        this();
        MxCamt05500105 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05500105(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CustomerPaymentCancellationRequestV05 }
     *     
     */
    public CustomerPaymentCancellationRequestV05 getCstmrPmtCxlReq() {
     ...
     *     
     */
    public MxCamt05500105 setCstmrPmtCxlReq(CustomerPaymentCancellationRequestV05 value) {
    ...
    public static MxCamt05500105 parse(String xml) {
        return ((MxCamt05500105) MxReadImpl.parse(MxCamt05500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05500105) MxReadImpl.parse(MxCamt05500105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05500105 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05500105) parserImpl.read(MxCamt05500105 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05500105 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05500105 message
     * @return
     *     a new instance of MxCamt05500105
     */
    public static final MxCamt05500105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05500105 .class);
    }
