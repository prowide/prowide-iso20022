    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.066.001.01";
    ...
    public static MxCamt06600101 parse(String xml) {
        return ((MxCamt06600101) MxReadImpl.parse(MxCamt06600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06600101) MxReadImpl.parse(MxCamt06600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt06600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06600101 .class);
    }
