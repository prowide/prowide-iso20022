    ...
    extends AbstractMX
{
    ...
    public static MxCamt10300102 parse(String xml) {
        return ((MxCamt10300102) MxReadImpl.parse(MxCamt10300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10300102) MxReadImpl.parse(MxCamt10300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt10300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt10300102 .class);
    }
