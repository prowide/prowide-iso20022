    ...
    extends AbstractMX
{
    ...
    public static MxCamt01200105 parse(String xml) {
        return ((MxCamt01200105) MxReadImpl.parse(MxCamt01200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01200105) MxReadImpl.parse(MxCamt01200105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01200105 .class);
    }
