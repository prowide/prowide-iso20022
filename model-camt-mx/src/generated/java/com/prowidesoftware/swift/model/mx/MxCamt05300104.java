...
/**
 * Class for camt.053.001.04 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt05300104(final String xml) {
        this();
        MxCamt05300104 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05300104(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCamt05300104 setBkToCstmrStmt(BankToCustomerStatementV04 value) {
    ...
    public static MxCamt05300104 parse(String xml) {
        return ((MxCamt05300104) MxReadImpl.parse(MxCamt05300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05300104) MxReadImpl.parse(MxCamt05300104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05300104 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05300104) parserImpl.read(MxCamt05300104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05300104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05300104 message
     * @return
     *     a new instance of MxCamt05300104
     */
    public static final MxCamt05300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05300104 .class);
    }
