    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.026.001.02";
    ...
    public static MxCamt02600102 parse(String xml) {
        return ((MxCamt02600102) MxReadImpl.parse(MxCamt02600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02600102) MxReadImpl.parse(MxCamt02600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02600102 .class);
    }
