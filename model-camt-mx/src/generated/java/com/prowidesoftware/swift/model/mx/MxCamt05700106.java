    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.057.001.06";
    ...
    public static MxCamt05700106 parse(String xml) {
        return ((MxCamt05700106) MxReadImpl.parse(MxCamt05700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05700106) MxReadImpl.parse(MxCamt05700106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05700106 fromJson(String json) {
