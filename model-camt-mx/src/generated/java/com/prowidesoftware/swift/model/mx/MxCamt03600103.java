    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.036.001.03";
    ...
    public static MxCamt03600103 parse(String xml) {
        return ((MxCamt03600103) MxReadImpl.parse(MxCamt03600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03600103) MxReadImpl.parse(MxCamt03600103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03600103 .class);
    }
