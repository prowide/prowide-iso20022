    ...
    extends AbstractMX
{
    ...
    public static MxCamt05800106 parse(String xml) {
        return ((MxCamt05800106) MxReadImpl.parse(MxCamt05800106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05800106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05800106) MxReadImpl.parse(MxCamt05800106 .class, xml, _classes, new MxReadParams(conf)));
    }
