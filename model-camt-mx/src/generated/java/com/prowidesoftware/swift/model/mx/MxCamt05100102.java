    ...
    extends AbstractMX
{
    ...
    public static MxCamt05100102 parse(String xml) {
        return ((MxCamt05100102) MxReadImpl.parse(MxCamt05100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05100102) MxReadImpl.parse(MxCamt05100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05100102 .class);
    }
