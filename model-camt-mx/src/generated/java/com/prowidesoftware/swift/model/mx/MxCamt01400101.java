    ...
    extends AbstractMX
{
    ...
    public static MxCamt01400101 parse(String xml) {
        return ((MxCamt01400101) MxReadImpl.parse(MxCamt01400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01400101) MxReadImpl.parse(MxCamt01400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01400101 .class);
    }
