    ...
    extends AbstractMX
{
    ...
    public static MxCamt10200102 parse(String xml) {
        return ((MxCamt10200102) MxReadImpl.parse(MxCamt10200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10200102) MxReadImpl.parse(MxCamt10200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt10200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt10200102 .class);
    }
