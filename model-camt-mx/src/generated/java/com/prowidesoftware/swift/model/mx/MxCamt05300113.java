    ...
    extends AbstractMX
{
    ...
    public static MxCamt05300113 parse(String xml) {
        return ((MxCamt05300113) MxReadImpl.parse(MxCamt05300113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05300113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05300113) MxReadImpl.parse(MxCamt05300113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05300113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05300113 .class);
    }
