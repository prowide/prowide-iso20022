    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.005.001.09";
    ...
    public static MxCamt00500109 parse(String xml) {
        return ((MxCamt00500109) MxReadImpl.parse(MxCamt00500109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00500109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00500109) MxReadImpl.parse(MxCamt00500109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00500109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00500109 .class);
    }
