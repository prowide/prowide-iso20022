    ...
    extends AbstractMX
{
    ...
    public static MxCamt04900106 parse(String xml) {
        return ((MxCamt04900106) MxReadImpl.parse(MxCamt04900106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04900106) MxReadImpl.parse(MxCamt04900106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04900106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04900106 .class);
    }
