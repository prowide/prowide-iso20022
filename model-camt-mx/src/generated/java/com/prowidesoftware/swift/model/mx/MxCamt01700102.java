    ...
    extends AbstractMX
{
    ...
    public static MxCamt01700102 parse(String xml) {
        return ((MxCamt01700102) MxReadImpl.parse(MxCamt01700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01700102) MxReadImpl.parse(MxCamt01700102 .class, xml, _classes, new MxReadParams(conf)));
    }
