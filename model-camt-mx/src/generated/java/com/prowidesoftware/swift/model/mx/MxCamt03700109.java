    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.037.001.09";
    ...
    public static MxCamt03700109 parse(String xml) {
        return ((MxCamt03700109) MxReadImpl.parse(MxCamt03700109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03700109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03700109) MxReadImpl.parse(MxCamt03700109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03700109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03700109 .class);
    }
