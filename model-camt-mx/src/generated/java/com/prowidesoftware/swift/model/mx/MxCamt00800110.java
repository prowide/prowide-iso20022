    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.008.001.10";
    ...
    public static MxCamt00800110 parse(String xml) {
        return ((MxCamt00800110) MxReadImpl.parse(MxCamt00800110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00800110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00800110) MxReadImpl.parse(MxCamt00800110 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00800110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00800110 .class);
    }
