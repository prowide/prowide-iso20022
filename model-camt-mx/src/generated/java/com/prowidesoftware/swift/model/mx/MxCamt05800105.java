    ...
    extends AbstractMX
{
    ...
    public static MxCamt05800105 parse(String xml) {
        return ((MxCamt05800105) MxReadImpl.parse(MxCamt05800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05800105) MxReadImpl.parse(MxCamt05800105 .class, xml, _classes, new MxReadParams(conf)));
    }
