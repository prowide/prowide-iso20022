    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.009.001.03";
    ...
    public static MxCamt00900103 parse(String xml) {
        return ((MxCamt00900103) MxReadImpl.parse(MxCamt00900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00900103) MxReadImpl.parse(MxCamt00900103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00900103 .class);
    }
