    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.023.001.06";
    ...
    public static MxCamt02300106 parse(String xml) {
        return ((MxCamt02300106) MxReadImpl.parse(MxCamt02300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02300106) MxReadImpl.parse(MxCamt02300106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02300106 fromJson(String json) {
