    ...
    extends AbstractMX
{
    ...
    public static MxCamt00800102 parse(String xml) {
        return ((MxCamt00800102) MxReadImpl.parse(MxCamt00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00800102) MxReadImpl.parse(MxCamt00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00800102 .class);
    }
