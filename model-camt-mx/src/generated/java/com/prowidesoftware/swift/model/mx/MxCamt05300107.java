...
/**
 * Class for camt.053.001.07 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt05300107(final String xml) {
        this();
        MxCamt05300107 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05300107(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCamt05300107 setBkToCstmrStmt(BankToCustomerStatementV07 value) {
    ...
    public static MxCamt05300107 parse(String xml) {
        return ((MxCamt05300107) MxReadImpl.parse(MxCamt05300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05300107) MxReadImpl.parse(MxCamt05300107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05300107 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05300107) parserImpl.read(MxCamt05300107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05300107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05300107 message
     * @return
     *     a new instance of MxCamt05300107
     */
    public static final MxCamt05300107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05300107 .class);
    }
