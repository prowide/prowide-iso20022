    ...
    extends AbstractMX
{
    ...
    public static MxCamt00600106 parse(String xml) {
        return ((MxCamt00600106) MxReadImpl.parse(MxCamt00600106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00600106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00600106) MxReadImpl.parse(MxCamt00600106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00600106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00600106 .class);
    }
