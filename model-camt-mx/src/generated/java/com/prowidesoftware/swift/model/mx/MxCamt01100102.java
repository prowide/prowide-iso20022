    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.011.001.02";
    ...
    public static MxCamt01100102 parse(String xml) {
        return ((MxCamt01100102) MxReadImpl.parse(MxCamt01100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01100102) MxReadImpl.parse(MxCamt01100102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01100102 .class);
    }
