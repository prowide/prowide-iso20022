    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.056.001.02";
    ...
    public static MxCamt05600102 parse(String xml) {
        return ((MxCamt05600102) MxReadImpl.parse(MxCamt05600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05600102) MxReadImpl.parse(MxCamt05600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05600102 .class);
    }
