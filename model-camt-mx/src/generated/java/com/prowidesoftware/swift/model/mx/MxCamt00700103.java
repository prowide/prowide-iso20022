    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.007.001.03";
    ...
    public static MxCamt00700103 parse(String xml) {
        return ((MxCamt00700103) MxReadImpl.parse(MxCamt00700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00700103) MxReadImpl.parse(MxCamt00700103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00700103 fromJson(String json) {
