    ...
    extends AbstractMX
{
    ...
    public static MxCamt03400101 parse(String xml) {
        return ((MxCamt03400101) MxReadImpl.parse(MxCamt03400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03400101) MxReadImpl.parse(MxCamt03400101 .class, xml, _classes, new MxReadParams(conf)));
    }
