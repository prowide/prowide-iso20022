    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.010.001.09";
    ...
    public static MxCamt01000109 parse(String xml) {
        return ((MxCamt01000109) MxReadImpl.parse(MxCamt01000109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01000109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01000109) MxReadImpl.parse(MxCamt01000109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01000109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01000109 .class);
    }
