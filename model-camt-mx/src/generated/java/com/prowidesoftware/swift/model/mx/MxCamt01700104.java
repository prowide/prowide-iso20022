    ...
    extends AbstractMX
{
    ...
    public static MxCamt01700104 parse(String xml) {
        return ((MxCamt01700104) MxReadImpl.parse(MxCamt01700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01700104) MxReadImpl.parse(MxCamt01700104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01700104 .class);
    }
