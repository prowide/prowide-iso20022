    ...
    extends AbstractMX
{
    ...
    public static MxCamt04800101 parse(String xml) {
        return ((MxCamt04800101) MxReadImpl.parse(MxCamt04800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04800101) MxReadImpl.parse(MxCamt04800101 .class, xml, _classes, new MxReadParams(conf)));
    }
