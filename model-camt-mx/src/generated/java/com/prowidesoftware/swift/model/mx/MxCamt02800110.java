    ...
    extends AbstractMX
{
    ...
    public static MxCamt02800110 parse(String xml) {
        return ((MxCamt02800110) MxReadImpl.parse(MxCamt02800110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02800110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02800110) MxReadImpl.parse(MxCamt02800110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt02800110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02800110 .class);
    }
