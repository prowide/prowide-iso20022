    ...
    extends AbstractMX
{
    ...
    public static MxCamt00300104 parse(String xml) {
        return ((MxCamt00300104) MxReadImpl.parse(MxCamt00300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00300104) MxReadImpl.parse(MxCamt00300104 .class, xml, _classes, new MxReadParams(conf)));
    }
