    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.050.001.02";
    ...
    public static MxCamt05000102 parse(String xml) {
        return ((MxCamt05000102) MxReadImpl.parse(MxCamt05000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05000102) MxReadImpl.parse(MxCamt05000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05000102 .class);
    }
