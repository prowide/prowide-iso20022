    ...
    extends AbstractMX
{
    ...
    public static MxCamt04600103 parse(String xml) {
        return ((MxCamt04600103) MxReadImpl.parse(MxCamt04600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04600103) MxReadImpl.parse(MxCamt04600103 .class, xml, _classes, new MxReadParams(conf)));
    }
