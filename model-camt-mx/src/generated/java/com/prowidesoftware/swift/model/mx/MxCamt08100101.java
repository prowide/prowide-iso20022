    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.081.001.01";
    ...
    public static MxCamt08100101 parse(String xml) {
        return ((MxCamt08100101) MxReadImpl.parse(MxCamt08100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08100101) MxReadImpl.parse(MxCamt08100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt08100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08100101 .class);
    }
