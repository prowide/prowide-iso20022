    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Camt03600101 .class, Case.class, CaseAssignment.class, CurrencyAndAmount.class, DebitAuthorisationConfirmation.class, MxCamt03600101 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.036.001.01";
    ...
    public static MxCamt03600101 parse(String xml) {
        return ((MxCamt03600101) MxReadImpl.parse(MxCamt03600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03600101) MxReadImpl.parse(MxCamt03600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03600101 .class);
    }
