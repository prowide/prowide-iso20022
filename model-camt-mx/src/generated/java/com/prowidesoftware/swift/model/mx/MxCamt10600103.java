    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.106.001.03";
    ...
    public static MxCamt10600103 parse(String xml) {
        return ((MxCamt10600103) MxReadImpl.parse(MxCamt10600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10600103) MxReadImpl.parse(MxCamt10600103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt10600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt10600103 .class);
    }
