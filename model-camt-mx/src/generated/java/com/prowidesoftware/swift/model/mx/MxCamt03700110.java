    ...
    extends AbstractMX
{
    ...
    public static MxCamt03700110 parse(String xml) {
        return ((MxCamt03700110) MxReadImpl.parse(MxCamt03700110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03700110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03700110) MxReadImpl.parse(MxCamt03700110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03700110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03700110 .class);
    }
