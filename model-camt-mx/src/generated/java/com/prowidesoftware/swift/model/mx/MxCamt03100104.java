    ...
    extends AbstractMX
{
    ...
    public static MxCamt03100104 parse(String xml) {
        return ((MxCamt03100104) MxReadImpl.parse(MxCamt03100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03100104) MxReadImpl.parse(MxCamt03100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03100104 .class);
    }
