    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.030.001.03";
    ...
    public static MxCamt03000103 parse(String xml) {
        return ((MxCamt03000103) MxReadImpl.parse(MxCamt03000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03000103) MxReadImpl.parse(MxCamt03000103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03000103 fromJson(String json) {
