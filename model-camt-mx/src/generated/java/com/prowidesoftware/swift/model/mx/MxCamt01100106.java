    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.011.001.06";
    ...
    public static MxCamt01100106 parse(String xml) {
        return ((MxCamt01100106) MxReadImpl.parse(MxCamt01100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01100106) MxReadImpl.parse(MxCamt01100106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01100106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01100106 .class);
    }
