    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Camt02700101 .class, Case.class, CaseAssignment.class, CurrencyAndAmount.class, MissingCover.class, MxCamt02700101 .class, PaymentInstructionExtract.class };
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.027.001.01";
    ...
    public static MxCamt02700101 parse(String xml) {
        return ((MxCamt02700101) MxReadImpl.parse(MxCamt02700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02700101) MxReadImpl.parse(MxCamt02700101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02700101 .class);
    }
