    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04";
    ...
    public static MxCamt05400104 parse(String xml) {
        return ((MxCamt05400104) MxReadImpl.parse(MxCamt05400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05400104) MxReadImpl.parse(MxCamt05400104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05400104 .class);
    }
