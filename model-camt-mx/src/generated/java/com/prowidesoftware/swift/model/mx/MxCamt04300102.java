    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.043.001.02";
    ...
    public static MxCamt04300102 parse(String xml) {
        return ((MxCamt04300102) MxReadImpl.parse(MxCamt04300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04300102) MxReadImpl.parse(MxCamt04300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt04300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04300102 .class);
    }
