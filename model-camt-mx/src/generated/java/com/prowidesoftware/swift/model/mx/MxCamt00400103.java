    ...
    extends AbstractMX
{
    ...
    public static MxCamt00400103 parse(String xml) {
        return ((MxCamt00400103) MxReadImpl.parse(MxCamt00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00400103) MxReadImpl.parse(MxCamt00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
