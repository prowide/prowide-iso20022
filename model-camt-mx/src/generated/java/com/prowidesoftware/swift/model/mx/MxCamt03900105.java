    ...
    extends AbstractMX
{
    ...
    public static MxCamt03900105 parse(String xml) {
        return ((MxCamt03900105) MxReadImpl.parse(MxCamt03900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03900105) MxReadImpl.parse(MxCamt03900105 .class, xml, _classes, new MxReadParams(conf)));
    }
