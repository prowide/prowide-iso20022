    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.047.001.06";
    ...
    public static MxCamt04700106 parse(String xml) {
        return ((MxCamt04700106) MxReadImpl.parse(MxCamt04700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04700106) MxReadImpl.parse(MxCamt04700106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt04700106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04700106 .class);
    }
