    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.107.001.02";
    ...
    public static MxCamt10700102 parse(String xml) {
        return ((MxCamt10700102) MxReadImpl.parse(MxCamt10700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10700102) MxReadImpl.parse(MxCamt10700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt10700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt10700102 .class);
    }
