    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.086.001.02";
    ...
    public static MxCamt08600102 parse(String xml) {
        return ((MxCamt08600102) MxReadImpl.parse(MxCamt08600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08600102) MxReadImpl.parse(MxCamt08600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt08600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08600102 .class);
    }
