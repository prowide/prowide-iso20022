    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.009.001.07";
    ...
    public static MxCamt00900107 parse(String xml) {
        return ((MxCamt00900107) MxReadImpl.parse(MxCamt00900107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00900107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00900107) MxReadImpl.parse(MxCamt00900107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00900107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00900107 .class);
    }
