    ...
    extends AbstractMX
{
    ...
    public static MxCamt01000102 parse(String xml) {
        return ((MxCamt01000102) MxReadImpl.parse(MxCamt01000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01000102) MxReadImpl.parse(MxCamt01000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01000102 .class);
    }
