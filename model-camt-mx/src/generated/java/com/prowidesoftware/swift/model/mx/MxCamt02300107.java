    ...
    extends AbstractMX
{
    ...
    public static MxCamt02300107 parse(String xml) {
        return ((MxCamt02300107) MxReadImpl.parse(MxCamt02300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02300107) MxReadImpl.parse(MxCamt02300107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt02300107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02300107 .class);
    }
