    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.068.001.02";
    ...
    public static MxCamt06800102 parse(String xml) {
        return ((MxCamt06800102) MxReadImpl.parse(MxCamt06800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06800102) MxReadImpl.parse(MxCamt06800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt06800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06800102 .class);
    }
