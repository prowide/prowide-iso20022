    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.050.001.04";
    ...
    public static MxCamt05000104 parse(String xml) {
        return ((MxCamt05000104) MxReadImpl.parse(MxCamt05000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05000104) MxReadImpl.parse(MxCamt05000104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05000104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05000104 .class);
    }
