    ...
    extends AbstractMX
{
    ...
    public static MxCamt02800111 parse(String xml) {
        return ((MxCamt02800111) MxReadImpl.parse(MxCamt02800111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02800111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02800111) MxReadImpl.parse(MxCamt02800111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt02800111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02800111 .class);
    }
