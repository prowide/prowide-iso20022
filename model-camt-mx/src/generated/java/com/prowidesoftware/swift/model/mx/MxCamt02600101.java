    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.026.001.01";
    ...
    public static MxCamt02600101 parse(String xml) {
        return ((MxCamt02600101) MxReadImpl.parse(MxCamt02600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02600101) MxReadImpl.parse(MxCamt02600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02600101 .class);
    }
