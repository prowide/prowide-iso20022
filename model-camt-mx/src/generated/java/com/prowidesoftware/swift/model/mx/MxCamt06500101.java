    ...
    extends AbstractMX
{
    ...
    public static MxCamt06500101 parse(String xml) {
        return ((MxCamt06500101) MxReadImpl.parse(MxCamt06500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06500101) MxReadImpl.parse(MxCamt06500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt06500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06500101 .class);
    }
