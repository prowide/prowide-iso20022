    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.06";
    ...
    public static MxCamt05400106 parse(String xml) {
        return ((MxCamt05400106) MxReadImpl.parse(MxCamt05400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05400106) MxReadImpl.parse(MxCamt05400106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05400106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05400106 .class);
    }
