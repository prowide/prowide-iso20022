    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.008.001.06";
    ...
    public static MxCamt00800106 parse(String xml) {
        return ((MxCamt00800106) MxReadImpl.parse(MxCamt00800106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00800106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00800106) MxReadImpl.parse(MxCamt00800106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00800106 fromJson(String json) {
