    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.12";
    ...
    public static MxCamt02900112 parse(String xml) {
        return ((MxCamt02900112) MxReadImpl.parse(MxCamt02900112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02900112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02900112) MxReadImpl.parse(MxCamt02900112 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02900112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02900112 .class);
    }
