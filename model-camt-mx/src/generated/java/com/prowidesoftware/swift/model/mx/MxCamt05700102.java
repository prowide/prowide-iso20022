    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.057.001.02";
    ...
    public static MxCamt05700102 parse(String xml) {
        return ((MxCamt05700102) MxReadImpl.parse(MxCamt05700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05700102) MxReadImpl.parse(MxCamt05700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05700102 .class);
    }
