    ...
    extends AbstractMX
{
    ...
    public static MxCamt03400104 parse(String xml) {
        return ((MxCamt03400104) MxReadImpl.parse(MxCamt03400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03400104) MxReadImpl.parse(MxCamt03400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03400104 .class);
    }
