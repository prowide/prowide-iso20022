    ...
    extends AbstractMX
{
    ...
    public static MxCamt03100107 parse(String xml) {
        return ((MxCamt03100107) MxReadImpl.parse(MxCamt03100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03100107) MxReadImpl.parse(MxCamt03100107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03100107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03100107 .class);
    }
