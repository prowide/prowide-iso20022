    ...
    extends AbstractMX
{
    ...
    public static MxCamt05700103 parse(String xml) {
        return ((MxCamt05700103) MxReadImpl.parse(MxCamt05700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05700103) MxReadImpl.parse(MxCamt05700103 .class, xml, _classes, new MxReadParams(conf)));
    }
