    ...
    extends AbstractMX
{
    ...
    public static MxCamt03900102 parse(String xml) {
        return ((MxCamt03900102) MxReadImpl.parse(MxCamt03900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03900102) MxReadImpl.parse(MxCamt03900102 .class, xml, _classes, new MxReadParams(conf)));
    }
