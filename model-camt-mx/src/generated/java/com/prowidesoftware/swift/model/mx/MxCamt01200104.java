    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.012.001.04";
    ...
    public static MxCamt01200104 parse(String xml) {
        return ((MxCamt01200104) MxReadImpl.parse(MxCamt01200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01200104) MxReadImpl.parse(MxCamt01200104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01200104 .class);
    }
