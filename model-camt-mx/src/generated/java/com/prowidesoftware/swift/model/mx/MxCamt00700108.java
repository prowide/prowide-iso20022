    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.007.001.08";
    ...
    public static MxCamt00700108 parse(String xml) {
        return ((MxCamt00700108) MxReadImpl.parse(MxCamt00700108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00700108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00700108) MxReadImpl.parse(MxCamt00700108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00700108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00700108 .class);
    }
