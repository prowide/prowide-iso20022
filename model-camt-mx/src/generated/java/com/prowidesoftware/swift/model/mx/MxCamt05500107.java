    ...
    extends AbstractMX
{
    ...
    public static MxCamt05500107 parse(String xml) {
        return ((MxCamt05500107) MxReadImpl.parse(MxCamt05500107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05500107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05500107) MxReadImpl.parse(MxCamt05500107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05500107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05500107 .class);
    }
