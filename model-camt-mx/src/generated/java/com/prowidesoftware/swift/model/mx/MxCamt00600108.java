    ...
    extends AbstractMX
{
    ...
    public static MxCamt00600108 parse(String xml) {
        return ((MxCamt00600108) MxReadImpl.parse(MxCamt00600108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00600108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00600108) MxReadImpl.parse(MxCamt00600108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00600108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00600108 .class);
    }
