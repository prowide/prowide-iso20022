    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.06";
    ...
    public static MxCamt02900106 parse(String xml) {
        return ((MxCamt02900106) MxReadImpl.parse(MxCamt02900106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02900106) MxReadImpl.parse(MxCamt02900106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02900106 fromJson(String json) {
