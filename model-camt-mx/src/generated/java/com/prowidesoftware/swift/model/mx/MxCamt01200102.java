    ...
    extends AbstractMX
{
    ...
    public static MxCamt01200102 parse(String xml) {
        return ((MxCamt01200102) MxReadImpl.parse(MxCamt01200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01200102) MxReadImpl.parse(MxCamt01200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01200102 .class);
    }
