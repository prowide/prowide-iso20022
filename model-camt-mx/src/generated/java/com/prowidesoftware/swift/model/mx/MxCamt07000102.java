    ...
    extends AbstractMX
{
    ...
    public static MxCamt07000102 parse(String xml) {
        return ((MxCamt07000102) MxReadImpl.parse(MxCamt07000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07000102) MxReadImpl.parse(MxCamt07000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt07000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07000102 .class);
    }
