    ...
    extends AbstractMX
{
    ...
    public static MxCamt05300101 parse(String xml) {
        return ((MxCamt05300101) MxReadImpl.parse(MxCamt05300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05300101) MxReadImpl.parse(MxCamt05300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05300101 fromJson(String json) {
