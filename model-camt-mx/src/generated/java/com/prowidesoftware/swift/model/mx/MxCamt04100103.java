    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.041.001.03";
    ...
    public static MxCamt04100103 parse(String xml) {
        return ((MxCamt04100103) MxReadImpl.parse(MxCamt04100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04100103) MxReadImpl.parse(MxCamt04100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt04100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04100103 .class);
    }
