    ...
    extends AbstractMX
{
    ...
    public static MxCamt06200101 parse(String xml) {
        return ((MxCamt06200101) MxReadImpl.parse(MxCamt06200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06200101) MxReadImpl.parse(MxCamt06200101 .class, xml, _classes, new MxReadParams(conf)));
    }
