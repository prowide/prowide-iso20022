    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.086.001.01";
    ...
    public static MxCamt08600101 parse(String xml) {
        return ((MxCamt08600101) MxReadImpl.parse(MxCamt08600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08600101) MxReadImpl.parse(MxCamt08600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt08600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08600101 .class);
    }
