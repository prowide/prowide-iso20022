    ...
    extends AbstractMX
{
    ...
    public static MxCamt07000101 parse(String xml) {
        return ((MxCamt07000101) MxReadImpl.parse(MxCamt07000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07000101) MxReadImpl.parse(MxCamt07000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt07000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07000101 .class);
    }
