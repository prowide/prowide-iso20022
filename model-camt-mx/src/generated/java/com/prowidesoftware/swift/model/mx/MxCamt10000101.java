    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:DRAFT1camt.100.001.01";
    ...
    public static MxCamt10000101 parse(String xml) {
        return ((MxCamt10000101) MxReadImpl.parse(MxCamt10000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10000101) MxReadImpl.parse(MxCamt10000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt10000101 fromJson(String json) {
