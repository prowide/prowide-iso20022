    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.035.001.06";
    ...
    public static MxCamt03500106 parse(String xml) {
        return ((MxCamt03500106) MxReadImpl.parse(MxCamt03500106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03500106) MxReadImpl.parse(MxCamt03500106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03500106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03500106 .class);
    }
