    ...
    extends AbstractMX
{
    ...
    public static MxCamt07000105 parse(String xml) {
        return ((MxCamt07000105) MxReadImpl.parse(MxCamt07000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07000105) MxReadImpl.parse(MxCamt07000105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt07000105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07000105 .class);
    }
