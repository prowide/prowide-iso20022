...
/**
 * Class for camt.052.001.07 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt05200107(final String xml) {
        this();
        MxCamt05200107 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05200107(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCamt05200107 setBkToCstmrAcctRpt(BankToCustomerAccountReportV07 value) {
    ...
    public static MxCamt05200107 parse(String xml) {
        return ((MxCamt05200107) MxReadImpl.parse(MxCamt05200107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05200107) MxReadImpl.parse(MxCamt05200107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05200107 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05200107) parserImpl.read(MxCamt05200107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05200107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05200107 message
     * @return
     *     a new instance of MxCamt05200107
     */
    public static final MxCamt05200107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05200107 .class);
    }
