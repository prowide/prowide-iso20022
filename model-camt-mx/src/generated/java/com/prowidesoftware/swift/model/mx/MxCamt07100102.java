    ...
    extends AbstractMX
{
    ...
    public static MxCamt07100102 parse(String xml) {
        return ((MxCamt07100102) MxReadImpl.parse(MxCamt07100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07100102) MxReadImpl.parse(MxCamt07100102 .class, xml, _classes, new MxReadParams(conf)));
    }
