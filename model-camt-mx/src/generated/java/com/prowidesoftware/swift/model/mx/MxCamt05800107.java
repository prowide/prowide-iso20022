    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.058.001.07";
    ...
    public static MxCamt05800107 parse(String xml) {
        return ((MxCamt05800107) MxReadImpl.parse(MxCamt05800107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05800107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05800107) MxReadImpl.parse(MxCamt05800107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05800107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05800107 .class);
    }
