    ...
    extends AbstractMX
{
    ...
    public static MxCamt04900103 parse(String xml) {
        return ((MxCamt04900103) MxReadImpl.parse(MxCamt04900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04900103) MxReadImpl.parse(MxCamt04900103 .class, xml, _classes, new MxReadParams(conf)));
    }
