    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.031.001.05";
    ...
    public static MxCamt03100105 parse(String xml) {
        return ((MxCamt03100105) MxReadImpl.parse(MxCamt03100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03100105) MxReadImpl.parse(MxCamt03100105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03100105 .class);
    }
