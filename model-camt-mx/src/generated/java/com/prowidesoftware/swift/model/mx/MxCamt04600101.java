    ...
    extends AbstractMX
{
    ...
    public static MxCamt04600101 parse(String xml) {
        return ((MxCamt04600101) MxReadImpl.parse(MxCamt04600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04600101) MxReadImpl.parse(MxCamt04600101 .class, xml, _classes, new MxReadParams(conf)));
    }
