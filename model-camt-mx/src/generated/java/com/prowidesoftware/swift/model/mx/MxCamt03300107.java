    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.033.001.07";
    ...
    public static MxCamt03300107 parse(String xml) {
        return ((MxCamt03300107) MxReadImpl.parse(MxCamt03300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03300107) MxReadImpl.parse(MxCamt03300107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03300107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03300107 .class);
    }
