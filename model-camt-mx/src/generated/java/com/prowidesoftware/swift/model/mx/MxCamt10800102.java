    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.108.001.02";
    ...
    public static MxCamt10800102 parse(String xml) {
        return ((MxCamt10800102) MxReadImpl.parse(MxCamt10800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10800102) MxReadImpl.parse(MxCamt10800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt10800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt10800102 .class);
    }
