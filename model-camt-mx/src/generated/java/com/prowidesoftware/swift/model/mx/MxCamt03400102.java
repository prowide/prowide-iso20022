    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Camt03400102 .class, Case.class, CaseAssignment.class, MxCamt03400102 .class, ProprietaryData.class };
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.034.001.02";
    ...
    public static MxCamt03400102 parse(String xml) {
        return ((MxCamt03400102) MxReadImpl.parse(MxCamt03400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03400102) MxReadImpl.parse(MxCamt03400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03400102 .class);
    }
