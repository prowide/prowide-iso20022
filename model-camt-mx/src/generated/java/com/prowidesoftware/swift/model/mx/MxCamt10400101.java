    ...
    extends AbstractMX
{
    ...
    public static final transient int FUNCTIONALITY = 104;
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.104.001.01";
    ...
    public static MxCamt10400101 parse(String xml) {
        return ((MxCamt10400101) MxReadImpl.parse(MxCamt10400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10400101) MxReadImpl.parse(MxCamt10400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt10400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt10400101 .class);
    }
