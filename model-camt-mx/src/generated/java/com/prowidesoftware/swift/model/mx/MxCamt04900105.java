    ...
    extends AbstractMX
{
    ...
    public static MxCamt04900105 parse(String xml) {
        return ((MxCamt04900105) MxReadImpl.parse(MxCamt04900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04900105) MxReadImpl.parse(MxCamt04900105 .class, xml, _classes, new MxReadParams(conf)));
    }
