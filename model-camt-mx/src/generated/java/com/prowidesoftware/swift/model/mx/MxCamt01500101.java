    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.015.001.01";
    ...
    public static MxCamt01500101 parse(String xml) {
        return ((MxCamt01500101) MxReadImpl.parse(MxCamt01500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01500101) MxReadImpl.parse(MxCamt01500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01500101 .class);
    }
