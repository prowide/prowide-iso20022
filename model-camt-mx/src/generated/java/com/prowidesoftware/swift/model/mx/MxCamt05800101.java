    ...
    extends AbstractMX
{
    ...
    public static MxCamt05800101 parse(String xml) {
        return ((MxCamt05800101) MxReadImpl.parse(MxCamt05800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05800101) MxReadImpl.parse(MxCamt05800101 .class, xml, _classes, new MxReadParams(conf)));
    }
