    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.047.001.02";
    ...
    public static MxCamt04700102 parse(String xml) {
        return ((MxCamt04700102) MxReadImpl.parse(MxCamt04700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04700102) MxReadImpl.parse(MxCamt04700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt04700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04700102 .class);
    }
