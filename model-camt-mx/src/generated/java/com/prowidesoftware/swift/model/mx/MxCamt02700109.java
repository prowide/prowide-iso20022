...
/**
 * Class for camt.027.001.09 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt02700109(final String xml) {
        this();
        MxCamt02700109 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt02700109(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link ClaimNonReceiptV09 }
     *     
     */
    public ClaimNonReceiptV09 getClmNonRct() {
        return clmNonRct;
    }
     ...
     *     
     */
    public MxCamt02700109 setClmNonRct(ClaimNonReceiptV09 value) {
    ...
    public static MxCamt02700109 parse(String xml) {
        return ((MxCamt02700109) MxReadImpl.parse(MxCamt02700109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02700109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02700109) MxReadImpl.parse(MxCamt02700109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt02700109 parse(String xml, MxRead parserImpl) {
        return ((MxCamt02700109) parserImpl.read(MxCamt02700109 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt02700109 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt02700109 message
     * @return
     *     a new instance of MxCamt02700109
     */
    public static final MxCamt02700109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02700109 .class);
    }
