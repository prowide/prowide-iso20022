    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.05";
    ...
    public static MxCamt05200105 parse(String xml) {
        return ((MxCamt05200105) MxReadImpl.parse(MxCamt05200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05200105) MxReadImpl.parse(MxCamt05200105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05200105 fromJson(String json) {
