    ...
    extends AbstractMX
{
    ...
    public static MxCamt08700105 parse(String xml) {
        return ((MxCamt08700105) MxReadImpl.parse(MxCamt08700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08700105) MxReadImpl.parse(MxCamt08700105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt08700105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08700105 .class);
    }
