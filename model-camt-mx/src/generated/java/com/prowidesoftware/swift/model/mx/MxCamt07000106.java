    ...
    extends AbstractMX
{
    ...
    public static MxCamt07000106 parse(String xml) {
        return ((MxCamt07000106) MxReadImpl.parse(MxCamt07000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07000106) MxReadImpl.parse(MxCamt07000106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt07000106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07000106 .class);
    }
