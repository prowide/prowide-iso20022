    ...
    extends AbstractMX
{
    ...
    public static MxCamt03600104 parse(String xml) {
        return ((MxCamt03600104) MxReadImpl.parse(MxCamt03600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03600104) MxReadImpl.parse(MxCamt03600104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03600104 .class);
    }
