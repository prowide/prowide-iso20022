    ...
    extends AbstractMX
{
    ...
    public static MxCamt08300102 parse(String xml) {
        return ((MxCamt08300102) MxReadImpl.parse(MxCamt08300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08300102) MxReadImpl.parse(MxCamt08300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt08300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08300102 .class);
    }
