    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.012.001.08";
    ...
    public static MxCamt01200108 parse(String xml) {
        return ((MxCamt01200108) MxReadImpl.parse(MxCamt01200108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01200108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01200108) MxReadImpl.parse(MxCamt01200108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01200108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01200108 .class);
    }
