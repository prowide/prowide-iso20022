    ...
    extends AbstractMX
{
    ...
    public static MxCamt07800101 parse(String xml) {
        return ((MxCamt07800101) MxReadImpl.parse(MxCamt07800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07800101) MxReadImpl.parse(MxCamt07800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt07800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07800101 .class);
    }
