...
/**
 * Class for camt.087.001.07 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt08700107(final String xml) {
        this();
        MxCamt08700107 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt08700107(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link RequestToModifyPaymentV07 }
     *     
     */
    public RequestToModifyPaymentV07 getReqToModfyPmt() {
     ...
     *     
     */
    public MxCamt08700107 setReqToModfyPmt(RequestToModifyPaymentV07 value) {
    ...
    public static MxCamt08700107 parse(String xml) {
        return ((MxCamt08700107) MxReadImpl.parse(MxCamt08700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08700107) MxReadImpl.parse(MxCamt08700107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt08700107 parse(String xml, MxRead parserImpl) {
        return ((MxCamt08700107) parserImpl.read(MxCamt08700107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt08700107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt08700107 message
     * @return
     *     a new instance of MxCamt08700107
     */
    public static final MxCamt08700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08700107 .class);
    }
