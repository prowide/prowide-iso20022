    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.051.001.03";
    ...
    public static MxCamt05100103 parse(String xml) {
        return ((MxCamt05100103) MxReadImpl.parse(MxCamt05100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05100103) MxReadImpl.parse(MxCamt05100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05100103 .class);
    }
