    ...
    extends AbstractMX
{
    ...
    public static MxCamt03600102 parse(String xml) {
        return ((MxCamt03600102) MxReadImpl.parse(MxCamt03600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03600102) MxReadImpl.parse(MxCamt03600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03600102 .class);
    }
