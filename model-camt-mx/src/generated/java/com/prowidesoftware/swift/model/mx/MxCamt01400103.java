    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.014.001.03";
    ...
    public static MxCamt01400103 parse(String xml) {
        return ((MxCamt01400103) MxReadImpl.parse(MxCamt01400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01400103) MxReadImpl.parse(MxCamt01400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01400103 .class);
    }
