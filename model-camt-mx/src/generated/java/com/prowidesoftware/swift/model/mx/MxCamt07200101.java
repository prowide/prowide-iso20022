    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.072.001.01";
    ...
    public static MxCamt07200101 parse(String xml) {
        return ((MxCamt07200101) MxReadImpl.parse(MxCamt07200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07200101) MxReadImpl.parse(MxCamt07200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt07200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07200101 .class);
    }
