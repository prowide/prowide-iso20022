    ...
    extends AbstractMX
{
    ...
    public static MxCamt02400102 parse(String xml) {
        return ((MxCamt02400102) MxReadImpl.parse(MxCamt02400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02400102) MxReadImpl.parse(MxCamt02400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt02400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02400102 .class);
    }
