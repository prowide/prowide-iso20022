    ...
    extends AbstractMX
{
    ...
    public static MxCamt01400102 parse(String xml) {
        return ((MxCamt01400102) MxReadImpl.parse(MxCamt01400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01400102) MxReadImpl.parse(MxCamt01400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01400102 .class);
    }
