    ...
    extends AbstractMX
{
    ...
    public static MxCamt05000106 parse(String xml) {
        return ((MxCamt05000106) MxReadImpl.parse(MxCamt05000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05000106) MxReadImpl.parse(MxCamt05000106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05000106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05000106 .class);
    }
