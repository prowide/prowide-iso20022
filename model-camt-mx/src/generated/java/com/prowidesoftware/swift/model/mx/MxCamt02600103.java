    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.026.001.03";
    ...
    public static MxCamt02600103 parse(String xml) {
        return ((MxCamt02600103) MxReadImpl.parse(MxCamt02600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02600103) MxReadImpl.parse(MxCamt02600103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02600103 fromJson(String json) {
