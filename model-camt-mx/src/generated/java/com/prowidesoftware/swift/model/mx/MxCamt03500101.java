    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Camt03500101 .class, Case.class, CaseAssignment.class, MxCamt03500101 .class, ProprietaryData.class };
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.035.001.01";
    ...
    public static MxCamt03500101 parse(String xml) {
        return ((MxCamt03500101) MxReadImpl.parse(MxCamt03500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03500101) MxReadImpl.parse(MxCamt03500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03500101 fromJson(String json) {
