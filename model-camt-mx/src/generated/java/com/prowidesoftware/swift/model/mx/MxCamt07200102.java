    ...
    extends AbstractMX
{
    ...
    public static MxCamt07200102 parse(String xml) {
        return ((MxCamt07200102) MxReadImpl.parse(MxCamt07200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07200102) MxReadImpl.parse(MxCamt07200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt07200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07200102 .class);
    }
