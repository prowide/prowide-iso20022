    ...
    extends AbstractMX
{
    ...
    public static MxCamt01300102 parse(String xml) {
        return ((MxCamt01300102) MxReadImpl.parse(MxCamt01300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01300102) MxReadImpl.parse(MxCamt01300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01300102 .class);
    }
