...
/**
 * Class for camt.037.001.08 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt03700108(final String xml) {
        this();
        MxCamt03700108 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt03700108(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link DebitAuthorisationRequestV08 }
     *     
     */
    public DebitAuthorisationRequestV08 getDbtAuthstnReq() {
     ...
     *     
     */
    public MxCamt03700108 setDbtAuthstnReq(DebitAuthorisationRequestV08 value) {
    ...
    public static MxCamt03700108 parse(String xml) {
        return ((MxCamt03700108) MxReadImpl.parse(MxCamt03700108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03700108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03700108) MxReadImpl.parse(MxCamt03700108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt03700108 parse(String xml, MxRead parserImpl) {
        return ((MxCamt03700108) parserImpl.read(MxCamt03700108 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt03700108 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt03700108 message
     * @return
     *     a new instance of MxCamt03700108
     */
    public static final MxCamt03700108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03700108 .class);
    }
