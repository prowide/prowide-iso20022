    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.09";
    ...
    public static MxCamt05500109 parse(String xml) {
        return ((MxCamt05500109) MxReadImpl.parse(MxCamt05500109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05500109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05500109) MxReadImpl.parse(MxCamt05500109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05500109 fromJson(String json) {
