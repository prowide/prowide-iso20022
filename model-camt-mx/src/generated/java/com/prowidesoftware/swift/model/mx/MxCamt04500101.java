    ...
    extends AbstractMX
{
    ...
    public static MxCamt04500101 parse(String xml) {
        return ((MxCamt04500101) MxReadImpl.parse(MxCamt04500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04500101) MxReadImpl.parse(MxCamt04500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04500101 .class);
    }
