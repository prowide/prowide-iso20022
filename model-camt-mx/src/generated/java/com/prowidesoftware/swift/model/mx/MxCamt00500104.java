    ...
    extends AbstractMX
{
    ...
    public static MxCamt00500104 parse(String xml) {
        return ((MxCamt00500104) MxReadImpl.parse(MxCamt00500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00500104) MxReadImpl.parse(MxCamt00500104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00500104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00500104 .class);
    }
