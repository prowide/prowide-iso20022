    ...
    extends AbstractMX
{
    ...
    public static MxCamt08600103 parse(String xml) {
        return ((MxCamt08600103) MxReadImpl.parse(MxCamt08600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08600103) MxReadImpl.parse(MxCamt08600103 .class, xml, _classes, new MxReadParams(conf)));
    }
