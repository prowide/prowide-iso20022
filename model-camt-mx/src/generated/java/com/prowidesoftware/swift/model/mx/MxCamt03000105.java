    ...
    extends AbstractMX
{
    ...
    public static MxCamt03000105 parse(String xml) {
        return ((MxCamt03000105) MxReadImpl.parse(MxCamt03000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03000105) MxReadImpl.parse(MxCamt03000105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03000105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03000105 .class);
    }
