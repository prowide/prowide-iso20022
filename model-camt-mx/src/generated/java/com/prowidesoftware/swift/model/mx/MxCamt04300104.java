    ...
    extends AbstractMX
{
    ...
    public static MxCamt04300104 parse(String xml) {
        return ((MxCamt04300104) MxReadImpl.parse(MxCamt04300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04300104) MxReadImpl.parse(MxCamt04300104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04300104 .class);
    }
