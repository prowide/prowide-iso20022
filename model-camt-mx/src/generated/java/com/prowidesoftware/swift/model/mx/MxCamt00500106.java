    ...
    extends AbstractMX
{
    ...
    public static MxCamt00500106 parse(String xml) {
        return ((MxCamt00500106) MxReadImpl.parse(MxCamt00500106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00500106) MxReadImpl.parse(MxCamt00500106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00500106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00500106 .class);
    }
