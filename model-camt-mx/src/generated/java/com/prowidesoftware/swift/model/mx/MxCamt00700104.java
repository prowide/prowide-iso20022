    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.007.001.04";
    ...
    public static MxCamt00700104 parse(String xml) {
        return ((MxCamt00700104) MxReadImpl.parse(MxCamt00700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00700104) MxReadImpl.parse(MxCamt00700104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00700104 fromJson(String json) {
