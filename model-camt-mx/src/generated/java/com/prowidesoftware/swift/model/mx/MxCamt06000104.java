    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.060.001.04";
    ...
    public static MxCamt06000104 parse(String xml) {
        return ((MxCamt06000104) MxReadImpl.parse(MxCamt06000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06000104) MxReadImpl.parse(MxCamt06000104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt06000104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06000104 .class);
    }
