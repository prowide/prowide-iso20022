    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.069.001.04";
    ...
    public static MxCamt06900104 parse(String xml) {
        return ((MxCamt06900104) MxReadImpl.parse(MxCamt06900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06900104) MxReadImpl.parse(MxCamt06900104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt06900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06900104 .class);
    }
