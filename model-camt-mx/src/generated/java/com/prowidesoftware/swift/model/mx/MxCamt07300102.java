    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.073.001.02";
    ...
    public static MxCamt07300102 parse(String xml) {
        return ((MxCamt07300102) MxReadImpl.parse(MxCamt07300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07300102) MxReadImpl.parse(MxCamt07300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt07300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07300102 .class);
    }
