    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.047.001.04";
    ...
    public static MxCamt04700104 parse(String xml) {
        return ((MxCamt04700104) MxReadImpl.parse(MxCamt04700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04700104) MxReadImpl.parse(MxCamt04700104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt04700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04700104 .class);
    }
