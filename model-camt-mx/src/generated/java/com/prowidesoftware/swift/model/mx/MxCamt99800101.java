    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Camt99800101 .class, MessageReference.class, MxCamt99800101 .class, ProprietaryData.class };
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.998.001.01";
    ...
    public static MxCamt99800101 parse(String xml) {
        return ((MxCamt99800101) MxReadImpl.parse(MxCamt99800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt99800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt99800101) MxReadImpl.parse(MxCamt99800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt99800101 fromJson(String json) {
