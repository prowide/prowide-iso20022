    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.025.001.05";
    ...
    public static MxCamt02500105 parse(String xml) {
        return ((MxCamt02500105) MxReadImpl.parse(MxCamt02500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02500105) MxReadImpl.parse(MxCamt02500105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02500105 fromJson(String json) {
