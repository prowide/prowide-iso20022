    ...
    extends AbstractMX
{
    ...
    public static MxCamt00900105 parse(String xml) {
        return ((MxCamt00900105) MxReadImpl.parse(MxCamt00900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00900105) MxReadImpl.parse(MxCamt00900105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00900105 .class);
    }
