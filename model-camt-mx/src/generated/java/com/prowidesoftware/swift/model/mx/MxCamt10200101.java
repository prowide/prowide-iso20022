    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.102.001.01";
    ...
    public static MxCamt10200101 parse(String xml) {
        return ((MxCamt10200101) MxReadImpl.parse(MxCamt10200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10200101) MxReadImpl.parse(MxCamt10200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt10200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt10200101 .class);
    }
