    ...
    extends AbstractMX
{
    ...
    public static MxCamt05900104 parse(String xml) {
        return ((MxCamt05900104) MxReadImpl.parse(MxCamt05900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05900104) MxReadImpl.parse(MxCamt05900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05900104 .class);
    }
