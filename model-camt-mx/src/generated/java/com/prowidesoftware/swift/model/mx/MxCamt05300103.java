    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.03";
    ...
    public static MxCamt05300103 parse(String xml) {
        return ((MxCamt05300103) MxReadImpl.parse(MxCamt05300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05300103) MxReadImpl.parse(MxCamt05300103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05300103 .class);
    }
