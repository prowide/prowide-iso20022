    ...
    extends AbstractMX
{
    ...
    public static MxCamt06300101 parse(String xml) {
        return ((MxCamt06300101) MxReadImpl.parse(MxCamt06300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06300101) MxReadImpl.parse(MxCamt06300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt06300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06300101 .class);
    }
