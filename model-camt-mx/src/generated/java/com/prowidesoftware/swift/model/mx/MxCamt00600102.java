    ...
    extends AbstractMX
{
    ...
    public static MxCamt00600102 parse(String xml) {
        return ((MxCamt00600102) MxReadImpl.parse(MxCamt00600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00600102) MxReadImpl.parse(MxCamt00600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00600102 fromJson(String json) {
