    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.023.001.03";
    ...
    public static MxCamt02300103 parse(String xml) {
        return ((MxCamt02300103) MxReadImpl.parse(MxCamt02300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02300103) MxReadImpl.parse(MxCamt02300103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02300103 fromJson(String json) {
