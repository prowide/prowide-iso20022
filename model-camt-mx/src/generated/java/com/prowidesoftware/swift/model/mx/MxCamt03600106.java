    ...
    extends AbstractMX
{
    ...
    public static MxCamt03600106 parse(String xml) {
        return ((MxCamt03600106) MxReadImpl.parse(MxCamt03600106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03600106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03600106) MxReadImpl.parse(MxCamt03600106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03600106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03600106 .class);
    }
