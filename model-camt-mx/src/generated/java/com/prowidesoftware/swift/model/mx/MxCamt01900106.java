    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.019.001.06";
    ...
    public static MxCamt01900106 parse(String xml) {
        return ((MxCamt01900106) MxReadImpl.parse(MxCamt01900106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01900106) MxReadImpl.parse(MxCamt01900106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01900106 fromJson(String json) {
