    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.056.001.04";
    ...
    public static MxCamt05600104 parse(String xml) {
        return ((MxCamt05600104) MxReadImpl.parse(MxCamt05600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05600104) MxReadImpl.parse(MxCamt05600104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05600104 fromJson(String json) {
