    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.018.001.01";
    ...
    public static MxCamt01800101 parse(String xml) {
        return ((MxCamt01800101) MxReadImpl.parse(MxCamt01800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01800101) MxReadImpl.parse(MxCamt01800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01800101 .class);
    }
