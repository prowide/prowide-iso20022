    ...
    extends AbstractMX
{
    ...
    public static MxCamt05200102 parse(String xml) {
        return ((MxCamt05200102) MxReadImpl.parse(MxCamt05200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05200102) MxReadImpl.parse(MxCamt05200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05200102 .class);
    }
