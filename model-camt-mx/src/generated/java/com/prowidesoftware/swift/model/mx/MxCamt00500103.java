    ...
    extends AbstractMX
{
    ...
    public static MxCamt00500103 parse(String xml) {
        return ((MxCamt00500103) MxReadImpl.parse(MxCamt00500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00500103) MxReadImpl.parse(MxCamt00500103 .class, xml, _classes, new MxReadParams(conf)));
    }
