    ...
    extends AbstractMX
{
    ...
    public static MxCamt04600102 parse(String xml) {
        return ((MxCamt04600102) MxReadImpl.parse(MxCamt04600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04600102) MxReadImpl.parse(MxCamt04600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04600102 .class);
    }
