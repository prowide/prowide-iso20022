    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.06";
    ...
    public static MxCamt05500106 parse(String xml) {
        return ((MxCamt05500106) MxReadImpl.parse(MxCamt05500106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05500106) MxReadImpl.parse(MxCamt05500106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05500106 fromJson(String json) {
