    ...
    extends AbstractMX
{
    ...
    public static MxCamt05200104 parse(String xml) {
        return ((MxCamt05200104) MxReadImpl.parse(MxCamt05200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05200104) MxReadImpl.parse(MxCamt05200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05200104 .class);
    }
