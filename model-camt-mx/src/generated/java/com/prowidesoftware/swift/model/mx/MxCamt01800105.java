    ...
    extends AbstractMX
{
    ...
    public static MxCamt01800105 parse(String xml) {
        return ((MxCamt01800105) MxReadImpl.parse(MxCamt01800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01800105) MxReadImpl.parse(MxCamt01800105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01800105 fromJson(String json) {
