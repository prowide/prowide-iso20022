    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.027.001.07";
    ...
    public static MxCamt02700107 parse(String xml) {
        return ((MxCamt02700107) MxReadImpl.parse(MxCamt02700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02700107) MxReadImpl.parse(MxCamt02700107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02700107 .class);
    }
