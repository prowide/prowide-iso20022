    ...
    extends AbstractMX
{
    ...
    public static MxCamt00800105 parse(String xml) {
        return ((MxCamt00800105) MxReadImpl.parse(MxCamt00800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00800105) MxReadImpl.parse(MxCamt00800105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00800105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00800105 .class);
    }
