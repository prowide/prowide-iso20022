    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.011.001.08";
    ...
    public static MxCamt01100108 parse(String xml) {
        return ((MxCamt01100108) MxReadImpl.parse(MxCamt01100108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01100108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01100108) MxReadImpl.parse(MxCamt01100108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01100108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01100108 .class);
    }
