    ...
    extends AbstractMX
{
    ...
    public static MxCamt06200102 parse(String xml) {
        return ((MxCamt06200102) MxReadImpl.parse(MxCamt06200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06200102) MxReadImpl.parse(MxCamt06200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt06200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06200102 .class);
    }
