    ...
    extends AbstractMX
{
    ...
    public static MxCamt05200111 parse(String xml) {
        return ((MxCamt05200111) MxReadImpl.parse(MxCamt05200111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05200111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05200111) MxReadImpl.parse(MxCamt05200111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05200111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05200111 .class);
    }
