...
/**
 * Class for camt.052.001.11 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCamt05200111(final String xml) {
        this();
        MxCamt05200111 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05200111(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link BankToCustomerAccountReportV11 }
     *     
     */
    public BankToCustomerAccountReportV11 getBkToCstmrAcctRpt() {
     ...
     *     
     */
    public MxCamt05200111 setBkToCstmrAcctRpt(BankToCustomerAccountReportV11 value) {
     ...
     * 
     */
    public static MxCamt05200111 parse(String xml) {
        return ((MxCamt05200111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt05200111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCamt05200111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05200111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt05200111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05200111 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05200111) parserImpl.read(MxCamt05200111 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05200111 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05200111 message
     * @return
     *     a new instance of MxCamt05200111
     */
    public static final MxCamt05200111 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCamt05200111 .class);
    }
