    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.038.001.02";
    ...
    public static MxCamt03800102 parse(String xml) {
        return ((MxCamt03800102) MxReadImpl.parse(MxCamt03800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03800102) MxReadImpl.parse(MxCamt03800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03800102 .class);
    }
