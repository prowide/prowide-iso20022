    ...
    extends AbstractMX
{
    ...
    public static MxCamt00700102 parse(String xml) {
        return ((MxCamt00700102) MxReadImpl.parse(MxCamt00700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00700102) MxReadImpl.parse(MxCamt00700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00700102 .class);
    }
