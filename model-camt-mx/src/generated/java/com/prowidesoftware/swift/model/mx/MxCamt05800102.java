    ...
    extends AbstractMX
{
    ...
    public static MxCamt05800102 parse(String xml) {
        return ((MxCamt05800102) MxReadImpl.parse(MxCamt05800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05800102) MxReadImpl.parse(MxCamt05800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05800102 .class);
    }
