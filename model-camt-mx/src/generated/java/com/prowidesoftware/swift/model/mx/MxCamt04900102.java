    ...
    extends AbstractMX
{
    ...
    public static MxCamt04900102 parse(String xml) {
        return ((MxCamt04900102) MxReadImpl.parse(MxCamt04900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04900102) MxReadImpl.parse(MxCamt04900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04900102 .class);
    }
