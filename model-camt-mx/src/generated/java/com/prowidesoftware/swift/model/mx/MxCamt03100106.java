    ...
    extends AbstractMX
{
    ...
    public static MxCamt03100106 parse(String xml) {
        return ((MxCamt03100106) MxReadImpl.parse(MxCamt03100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03100106) MxReadImpl.parse(MxCamt03100106 .class, xml, _classes, new MxReadParams(conf)));
    }
