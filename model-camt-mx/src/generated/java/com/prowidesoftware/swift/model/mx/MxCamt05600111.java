    ...
    extends AbstractMX
{
    ...
    public static MxCamt05600111 parse(String xml) {
        return ((MxCamt05600111) MxReadImpl.parse(MxCamt05600111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05600111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05600111) MxReadImpl.parse(MxCamt05600111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05600111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05600111 .class);
    }
