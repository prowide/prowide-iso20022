    ...
    extends AbstractMX
{
    ...
    public static MxCamt05400113 parse(String xml) {
        return ((MxCamt05400113) MxReadImpl.parse(MxCamt05400113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05400113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05400113) MxReadImpl.parse(MxCamt05400113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05400113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05400113 .class);
    }
