...
/**
 * Class for camt.054.001.13 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCamt05400113(final String xml) {
        this();
        MxCamt05400113 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05400113(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link BankToCustomerDebitCreditNotificationV13 }
     *     
     */
    public BankToCustomerDebitCreditNotificationV13 getBkToCstmrDbtCdtNtfctn() {
     ...
     *     
     */
    public MxCamt05400113 setBkToCstmrDbtCdtNtfctn(BankToCustomerDebitCreditNotificationV13 value) {
     ...
     * 
     */
    public static MxCamt05400113 parse(String xml) {
        return ((MxCamt05400113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt05400113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCamt05400113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05400113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt05400113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05400113 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05400113) parserImpl.read(MxCamt05400113 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05400113 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05400113 message
     * @return
     *     a new instance of MxCamt05400113
     */
    public final static MxCamt05400113 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCamt05400113 .class);
    }
