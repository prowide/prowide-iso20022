    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.032.001.02";
    ...
    public static MxCamt03200102 parse(String xml) {
        return ((MxCamt03200102) MxReadImpl.parse(MxCamt03200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03200102) MxReadImpl.parse(MxCamt03200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03200102 .class);
    }
