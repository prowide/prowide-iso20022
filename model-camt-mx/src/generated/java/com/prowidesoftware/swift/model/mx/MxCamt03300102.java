    ...
    extends AbstractMX
{
    ...
    public static MxCamt03300102 parse(String xml) {
        return ((MxCamt03300102) MxReadImpl.parse(MxCamt03300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03300102) MxReadImpl.parse(MxCamt03300102 .class, xml, _classes, new MxReadParams(conf)));
    }
