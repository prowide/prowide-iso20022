    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.103.001.01";
    ...
    public static MxCamt10300101 parse(String xml) {
        return ((MxCamt10300101) MxReadImpl.parse(MxCamt10300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10300101) MxReadImpl.parse(MxCamt10300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt10300101 fromJson(String json) {
