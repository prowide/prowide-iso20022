...
/**
 * Class for camt.079.001.01 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.079.001.01")
public class MxCamt07900101
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt07900101(final String xml) {
        this();
        MxCamt07900101 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt07900101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link IntraBalanceMovementQueryResponseV01 }
     *     
     */
     ...
     *     
     */
    public MxCamt07900101 setIntraBalMvmntQryRspn(IntraBalanceMovementQueryResponseV01 value) {
    ...
    public static MxCamt07900101 parse(String xml) {
        return ((MxCamt07900101) MxReadImpl.parse(MxCamt07900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07900101) MxReadImpl.parse(MxCamt07900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt07900101 parse(String xml, MxRead parserImpl) {
        return ((MxCamt07900101) parserImpl.read(MxCamt07900101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt07900101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt07900101 message
     * @return
     *     a new instance of MxCamt07900101
     */
    public static final MxCamt07900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07900101 .class);
    }
