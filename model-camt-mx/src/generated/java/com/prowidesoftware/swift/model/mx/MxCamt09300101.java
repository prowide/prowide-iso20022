    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:DRAFT1camt.093.001.01";
    ...
    public static MxCamt09300101 parse(String xml) {
        return ((MxCamt09300101) MxReadImpl.parse(MxCamt09300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt09300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt09300101) MxReadImpl.parse(MxCamt09300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt09300101 fromJson(String json) {
