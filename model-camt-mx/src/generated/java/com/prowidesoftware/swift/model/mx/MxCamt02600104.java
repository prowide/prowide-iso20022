    ...
    extends AbstractMX
{
    ...
    public static MxCamt02600104 parse(String xml) {
        return ((MxCamt02600104) MxReadImpl.parse(MxCamt02600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02600104) MxReadImpl.parse(MxCamt02600104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt02600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02600104 .class);
    }
