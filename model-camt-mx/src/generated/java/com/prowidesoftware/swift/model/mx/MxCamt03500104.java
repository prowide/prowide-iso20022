    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.035.001.04";
    ...
    public static MxCamt03500104 parse(String xml) {
        return ((MxCamt03500104) MxReadImpl.parse(MxCamt03500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03500104) MxReadImpl.parse(MxCamt03500104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03500104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03500104 .class);
    }
