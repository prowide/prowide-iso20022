    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.08";
    ...
    public static MxCamt05200108 parse(String xml) {
        return ((MxCamt05200108) MxReadImpl.parse(MxCamt05200108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05200108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05200108) MxReadImpl.parse(MxCamt05200108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05200108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05200108 .class);
    }
