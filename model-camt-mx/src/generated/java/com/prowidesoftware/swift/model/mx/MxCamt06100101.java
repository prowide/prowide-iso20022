    ...
    extends AbstractMX
{
    ...
    public static MxCamt06100101 parse(String xml) {
        return ((MxCamt06100101) MxReadImpl.parse(MxCamt06100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06100101) MxReadImpl.parse(MxCamt06100101 .class, xml, _classes, new MxReadParams(conf)));
    }
