    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.024.001.05";
    ...
    public static MxCamt02400105 parse(String xml) {
        return ((MxCamt02400105) MxReadImpl.parse(MxCamt02400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02400105) MxReadImpl.parse(MxCamt02400105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02400105 .class);
    }
