    ...
    extends AbstractMX
{
    ...
    public static MxCamt06800101 parse(String xml) {
        return ((MxCamt06800101) MxReadImpl.parse(MxCamt06800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06800101) MxReadImpl.parse(MxCamt06800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt06800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06800101 .class);
    }
