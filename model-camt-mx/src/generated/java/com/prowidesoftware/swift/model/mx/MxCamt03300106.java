    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.033.001.06";
    ...
    public static MxCamt03300106 parse(String xml) {
        return ((MxCamt03300106) MxReadImpl.parse(MxCamt03300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03300106) MxReadImpl.parse(MxCamt03300106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03300106 fromJson(String json) {
