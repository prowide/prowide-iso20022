    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.051.001.07";
    ...
    public static MxCamt05100107 parse(String xml) {
        return ((MxCamt05100107) MxReadImpl.parse(MxCamt05100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05100107) MxReadImpl.parse(MxCamt05100107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05100107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05100107 .class);
    }
