    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.042.001.04";
    ...
    public static MxCamt04200104 parse(String xml) {
        return ((MxCamt04200104) MxReadImpl.parse(MxCamt04200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04200104) MxReadImpl.parse(MxCamt04200104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt04200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04200104 .class);
    }
