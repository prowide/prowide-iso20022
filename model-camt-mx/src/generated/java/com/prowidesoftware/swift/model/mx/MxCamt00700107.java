    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.007.001.07";
    ...
    public static MxCamt00700107 parse(String xml) {
        return ((MxCamt00700107) MxReadImpl.parse(MxCamt00700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00700107) MxReadImpl.parse(MxCamt00700107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00700107 .class);
    }
