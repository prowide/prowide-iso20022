    ...
    extends AbstractMX
{
    ...
    public static MxCamt02100105 parse(String xml) {
        return ((MxCamt02100105) MxReadImpl.parse(MxCamt02100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02100105) MxReadImpl.parse(MxCamt02100105 .class, xml, _classes, new MxReadParams(conf)));
    }
