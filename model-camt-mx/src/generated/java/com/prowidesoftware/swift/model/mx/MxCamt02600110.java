    ...
    extends AbstractMX
{
    ...
    public static MxCamt02600110 parse(String xml) {
        return ((MxCamt02600110) MxReadImpl.parse(MxCamt02600110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02600110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02600110) MxReadImpl.parse(MxCamt02600110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt02600110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02600110 .class);
    }
