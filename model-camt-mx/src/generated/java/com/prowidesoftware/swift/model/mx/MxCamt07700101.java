    ...
    extends AbstractMX
{
    ...
    public static MxCamt07700101 parse(String xml) {
        return ((MxCamt07700101) MxReadImpl.parse(MxCamt07700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07700101) MxReadImpl.parse(MxCamt07700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt07700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07700101 .class);
    }
