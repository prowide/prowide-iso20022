    ...
    extends AbstractMX
{
    ...
    public static MxCamt06200103 parse(String xml) {
        return ((MxCamt06200103) MxReadImpl.parse(MxCamt06200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06200103) MxReadImpl.parse(MxCamt06200103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt06200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06200103 .class);
    }
