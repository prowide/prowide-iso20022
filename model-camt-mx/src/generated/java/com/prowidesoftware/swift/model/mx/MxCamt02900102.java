    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.029.001.02";
    ...
    public static MxCamt02900102 parse(String xml) {
        return ((MxCamt02900102) MxReadImpl.parse(MxCamt02900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02900102) MxReadImpl.parse(MxCamt02900102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02900102 .class);
    }
