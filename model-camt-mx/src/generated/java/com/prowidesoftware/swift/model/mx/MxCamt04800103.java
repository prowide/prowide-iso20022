    ...
    extends AbstractMX
{
    ...
    public static MxCamt04800103 parse(String xml) {
        return ((MxCamt04800103) MxReadImpl.parse(MxCamt04800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04800103) MxReadImpl.parse(MxCamt04800103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt04800103 fromJson(String json) {
