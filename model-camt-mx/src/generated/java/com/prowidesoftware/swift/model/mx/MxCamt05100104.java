    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.051.001.04";
    ...
    public static MxCamt05100104 parse(String xml) {
        return ((MxCamt05100104) MxReadImpl.parse(MxCamt05100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05100104) MxReadImpl.parse(MxCamt05100104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05100104 .class);
    }
