    ...
    extends AbstractMX
{
    ...
    public static MxCamt08000102 parse(String xml) {
        return ((MxCamt08000102) MxReadImpl.parse(MxCamt08000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08000102) MxReadImpl.parse(MxCamt08000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt08000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08000102 .class);
    }
