    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.060.001.05";
    ...
    public static MxCamt06000105 parse(String xml) {
        return ((MxCamt06000105) MxReadImpl.parse(MxCamt06000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06000105) MxReadImpl.parse(MxCamt06000105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt06000105 fromJson(String json) {
