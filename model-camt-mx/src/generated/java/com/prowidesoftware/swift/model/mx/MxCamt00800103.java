    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.008.001.03";
    ...
    public static MxCamt00800103 parse(String xml) {
        return ((MxCamt00800103) MxReadImpl.parse(MxCamt00800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00800103) MxReadImpl.parse(MxCamt00800103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00800103 .class);
    }
