    ...
    extends AbstractMX
{
    ...
    public static MxCamt05600103 parse(String xml) {
        return ((MxCamt05600103) MxReadImpl.parse(MxCamt05600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05600103) MxReadImpl.parse(MxCamt05600103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05600103 .class);
    }
