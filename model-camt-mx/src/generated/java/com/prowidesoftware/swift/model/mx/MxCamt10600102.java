    ...
    extends AbstractMX
{
    ...
    public static MxCamt10600102 parse(String xml) {
        return ((MxCamt10600102) MxReadImpl.parse(MxCamt10600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10600102) MxReadImpl.parse(MxCamt10600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt10600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt10600102 .class);
    }
