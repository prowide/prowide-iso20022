    ...
    extends AbstractMX
{
    ...
    public static MxCamt02900110 parse(String xml) {
        return ((MxCamt02900110) MxReadImpl.parse(MxCamt02900110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02900110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02900110) MxReadImpl.parse(MxCamt02900110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt02900110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02900110 .class);
    }
