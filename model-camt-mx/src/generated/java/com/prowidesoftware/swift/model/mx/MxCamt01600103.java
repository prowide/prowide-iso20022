    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.016.001.03";
    ...
    public static MxCamt01600103 parse(String xml) {
        return ((MxCamt01600103) MxReadImpl.parse(MxCamt01600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01600103) MxReadImpl.parse(MxCamt01600103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01600103 .class);
    }
