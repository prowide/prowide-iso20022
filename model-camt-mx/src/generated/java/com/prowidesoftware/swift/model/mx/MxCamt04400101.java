    ...
    extends AbstractMX
{
    ...
    public static MxCamt04400101 parse(String xml) {
        return ((MxCamt04400101) MxReadImpl.parse(MxCamt04400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04400101) MxReadImpl.parse(MxCamt04400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04400101 .class);
    }
