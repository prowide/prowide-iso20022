    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.011.001.07";
    ...
    public static MxCamt01100107 parse(String xml) {
        return ((MxCamt01100107) MxReadImpl.parse(MxCamt01100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01100107) MxReadImpl.parse(MxCamt01100107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01100107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01100107 .class);
    }
