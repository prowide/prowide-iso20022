    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.014.001.04";
    ...
    public static MxCamt01400104 parse(String xml) {
        return ((MxCamt01400104) MxReadImpl.parse(MxCamt01400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01400104) MxReadImpl.parse(MxCamt01400104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01400104 .class);
    }
