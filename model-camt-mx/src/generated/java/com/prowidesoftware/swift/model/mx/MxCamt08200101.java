    ...
    extends AbstractMX
{
    ...
    public static MxCamt08200101 parse(String xml) {
        return ((MxCamt08200101) MxReadImpl.parse(MxCamt08200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08200101) MxReadImpl.parse(MxCamt08200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt08200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08200101 .class);
    }
