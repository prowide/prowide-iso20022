    ...
    extends AbstractMX
{
    ...
    public static MxCamt11100102 parse(String xml) {
        return ((MxCamt11100102) MxReadImpl.parse(MxCamt11100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt11100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt11100102) MxReadImpl.parse(MxCamt11100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt11100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt11100102 .class);
    }
