...
/**
 * Class for camt.111.001.02 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCamt11100102(final String xml) {
        this();
        MxCamt11100102 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt11100102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link InvestigationResponseV02 }
     *     
     */
    public InvestigationResponseV02 getInvstgtnRspn() {
        return invstgtnRspn;
    }
     ...
     *     
     */
    public MxCamt11100102 setInvstgtnRspn(InvestigationResponseV02 value) {
     ...
     * 
     */
    public static MxCamt11100102 parse(String xml) {
        return ((MxCamt11100102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt11100102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCamt11100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt11100102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt11100102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt11100102 parse(String xml, MxRead parserImpl) {
        return ((MxCamt11100102) parserImpl.read(MxCamt11100102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt11100102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt11100102 message
     * @return
     *     a new instance of MxCamt11100102
     */
    public final static MxCamt11100102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCamt11100102 .class);
    }
