    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.079.001.02";
    ...
    public static MxCamt07900102 parse(String xml) {
        return ((MxCamt07900102) MxReadImpl.parse(MxCamt07900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07900102) MxReadImpl.parse(MxCamt07900102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt07900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07900102 .class);
    }
