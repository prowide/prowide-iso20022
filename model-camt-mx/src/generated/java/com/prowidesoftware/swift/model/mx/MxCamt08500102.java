    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.085.001.02";
    ...
    public static MxCamt08500102 parse(String xml) {
        return ((MxCamt08500102) MxReadImpl.parse(MxCamt08500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08500102) MxReadImpl.parse(MxCamt08500102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt08500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08500102 .class);
    }
