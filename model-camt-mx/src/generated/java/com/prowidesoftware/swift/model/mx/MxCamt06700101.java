    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.067.001.01";
    ...
    public static MxCamt06700101 parse(String xml) {
        return ((MxCamt06700101) MxReadImpl.parse(MxCamt06700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06700101) MxReadImpl.parse(MxCamt06700101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt06700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06700101 .class);
    }
