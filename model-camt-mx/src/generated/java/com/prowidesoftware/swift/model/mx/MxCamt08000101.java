    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.080.001.01";
    ...
    public static MxCamt08000101 parse(String xml) {
        return ((MxCamt08000101) MxReadImpl.parse(MxCamt08000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08000101) MxReadImpl.parse(MxCamt08000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt08000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08000101 .class);
    }
