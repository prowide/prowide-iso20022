    ...
    extends AbstractMX
{
    ...
    public static MxCamt05400109 parse(String xml) {
        return ((MxCamt05400109) MxReadImpl.parse(MxCamt05400109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05400109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05400109) MxReadImpl.parse(MxCamt05400109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05400109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05400109 .class);
    }
