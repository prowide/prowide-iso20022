    ...
    extends AbstractMX
{
    ...
    public static MxCamt00900108 parse(String xml) {
        return ((MxCamt00900108) MxReadImpl.parse(MxCamt00900108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00900108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00900108) MxReadImpl.parse(MxCamt00900108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00900108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00900108 .class);
    }
