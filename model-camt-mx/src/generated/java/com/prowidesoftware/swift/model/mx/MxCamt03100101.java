    ...
    extends AbstractMX
{
    ...
    public final static transient Class[] _classes = new Class[] {Camt03100101 .class, Case.class, CaseAssignment.class, CaseAssignmentRejection1Code.class, CaseAssignmentRejectionJustification.class, MxCamt03100101 .class };
    public final static transient String NAMESPACE = "urn:swift:xsd:camt.031.001.01";
     ...
     */
    public final static MxCamt03100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03100101 .class);
    }
