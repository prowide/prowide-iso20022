    ...
    extends AbstractMX
{
    ...
    public static MxCamt03100101 parse(String xml) {
        return ((MxCamt03100101) MxReadImpl.parse(MxCamt03100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03100101) MxReadImpl.parse(MxCamt03100101 .class, xml, _classes, new MxReadParams(conf)));
    }
