    ...
    extends AbstractMX
{
    ...
    public static MxCamt05500102 parse(String xml) {
        return ((MxCamt05500102) MxReadImpl.parse(MxCamt05500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05500102) MxReadImpl.parse(MxCamt05500102 .class, xml, _classes, new MxReadParams(conf)));
    }
