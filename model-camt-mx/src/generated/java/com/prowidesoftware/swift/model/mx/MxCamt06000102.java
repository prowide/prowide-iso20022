    ...
    extends AbstractMX
{
    ...
    public static MxCamt06000102 parse(String xml) {
        return ((MxCamt06000102) MxReadImpl.parse(MxCamt06000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06000102) MxReadImpl.parse(MxCamt06000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt06000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06000102 .class);
    }
