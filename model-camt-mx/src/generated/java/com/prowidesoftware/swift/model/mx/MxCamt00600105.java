    ...
    extends AbstractMX
{
    ...
    public static MxCamt00600105 parse(String xml) {
        return ((MxCamt00600105) MxReadImpl.parse(MxCamt00600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00600105) MxReadImpl.parse(MxCamt00600105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00600105 .class);
    }
