    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.028.001.06";
    ...
    public static MxCamt02800106 parse(String xml) {
        return ((MxCamt02800106) MxReadImpl.parse(MxCamt02800106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02800106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02800106) MxReadImpl.parse(MxCamt02800106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02800106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02800106 .class);
    }
