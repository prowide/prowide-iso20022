    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {AcknowledgementDetails1Choice.class, MxCamt06300102 .class, PayInEventAcknowledgementV02 .class, SupplementaryData1 .class, SupplementaryDataEnvelope1 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.063.001.02";
    ...
    public static MxCamt06300102 parse(String xml) {
        return ((MxCamt06300102) MxReadImpl.parse(MxCamt06300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06300102) MxReadImpl.parse(MxCamt06300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt06300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06300102 .class);
    }
