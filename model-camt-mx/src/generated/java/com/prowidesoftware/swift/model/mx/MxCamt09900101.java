    ...
    extends AbstractMX
{
    ...
    public static final transient int FUNCTIONALITY = 99;
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:DRAFT1camt.099.001.01";
    ...
    public static MxCamt09900101 parse(String xml) {
        return ((MxCamt09900101) MxReadImpl.parse(MxCamt09900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt09900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt09900101) MxReadImpl.parse(MxCamt09900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt09900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt09900101 .class);
    }
