    ...
    extends AbstractMX
{
    ...
    public static MxCamt00600109 parse(String xml) {
        return ((MxCamt00600109) MxReadImpl.parse(MxCamt00600109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00600109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00600109) MxReadImpl.parse(MxCamt00600109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00600109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00600109 .class);
    }
