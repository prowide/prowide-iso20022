    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.082.001.02";
    ...
    public static MxCamt08200102 parse(String xml) {
        return ((MxCamt08200102) MxReadImpl.parse(MxCamt08200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08200102) MxReadImpl.parse(MxCamt08200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt08200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08200102 .class);
    }
