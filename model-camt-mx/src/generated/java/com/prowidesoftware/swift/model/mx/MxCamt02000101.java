    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.020.001.01";
    ...
    public static MxCamt02000101 parse(String xml) {
        return ((MxCamt02000101) MxReadImpl.parse(MxCamt02000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02000101) MxReadImpl.parse(MxCamt02000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02000101 .class);
    }
