    ...
    extends AbstractMX
{
    ...
    public static MxCamt03900106 parse(String xml) {
        return ((MxCamt03900106) MxReadImpl.parse(MxCamt03900106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03900106) MxReadImpl.parse(MxCamt03900106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03900106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03900106 .class);
    }
