    ...
    extends AbstractMX
{
    ...
    public static MxCamt99800102 parse(String xml) {
        return ((MxCamt99800102) MxReadImpl.parse(MxCamt99800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt99800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt99800102) MxReadImpl.parse(MxCamt99800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt99800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt99800102 .class);
    }
