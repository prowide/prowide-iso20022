    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.010.001.05";
    ...
    public static MxCamt01000105 parse(String xml) {
        return ((MxCamt01000105) MxReadImpl.parse(MxCamt01000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01000105) MxReadImpl.parse(MxCamt01000105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01000105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01000105 .class);
    }
