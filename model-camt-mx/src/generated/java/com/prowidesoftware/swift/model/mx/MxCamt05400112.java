    ...
    extends AbstractMX
{
    ...
    public static MxCamt05400112 parse(String xml) {
        return ((MxCamt05400112) MxReadImpl.parse(MxCamt05400112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05400112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05400112) MxReadImpl.parse(MxCamt05400112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05400112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05400112 .class);
    }
