...
/**
 * Class for camt.054.001.12 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.12")
public class MxCamt05400112
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCamt05400112(final String xml) {
        this();
        MxCamt05400112 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05400112(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCamt05400112 setBkToCstmrDbtCdtNtfctn(BankToCustomerDebitCreditNotificationV12 value) {
     ...
     * 
     */
    public static MxCamt05400112 parse(String xml) {
        return ((MxCamt05400112) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt05400112 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCamt05400112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05400112) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt05400112 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05400112 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05400112) parserImpl.read(MxCamt05400112 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05400112 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05400112 message
     * @return
     *     a new instance of MxCamt05400112
     */
    public static final MxCamt05400112 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCamt05400112 .class);
    }
