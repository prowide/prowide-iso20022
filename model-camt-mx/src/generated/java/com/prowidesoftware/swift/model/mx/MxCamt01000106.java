    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.010.001.06";
    ...
    public static MxCamt01000106 parse(String xml) {
        return ((MxCamt01000106) MxReadImpl.parse(MxCamt01000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01000106) MxReadImpl.parse(MxCamt01000106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01000106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01000106 .class);
    }
