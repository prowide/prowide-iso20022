    ...
    extends AbstractMX
{
    ...
    public static MxCamt05400101 parse(String xml) {
        return ((MxCamt05400101) MxReadImpl.parse(MxCamt05400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05400101) MxReadImpl.parse(MxCamt05400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05400101 .class);
    }
