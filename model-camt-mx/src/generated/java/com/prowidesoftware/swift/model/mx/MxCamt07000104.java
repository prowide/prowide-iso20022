    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.070.001.04";
    ...
    public static MxCamt07000104 parse(String xml) {
        return ((MxCamt07000104) MxReadImpl.parse(MxCamt07000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07000104) MxReadImpl.parse(MxCamt07000104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt07000104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07000104 .class);
    }
