    ...
    extends AbstractMX
{
    ...
    public static MxCamt01500104 parse(String xml) {
        return ((MxCamt01500104) MxReadImpl.parse(MxCamt01500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01500104) MxReadImpl.parse(MxCamt01500104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01500104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01500104 .class);
    }
