    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.041.001.04";
    ...
    public static MxCamt04100104 parse(String xml) {
        return ((MxCamt04100104) MxReadImpl.parse(MxCamt04100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04100104) MxReadImpl.parse(MxCamt04100104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt04100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04100104 .class);
    }
