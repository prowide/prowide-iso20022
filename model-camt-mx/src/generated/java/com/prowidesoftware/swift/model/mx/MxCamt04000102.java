    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.040.001.02";
    ...
    public static MxCamt04000102 parse(String xml) {
        return ((MxCamt04000102) MxReadImpl.parse(MxCamt04000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04000102) MxReadImpl.parse(MxCamt04000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt04000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04000102 .class);
    }
