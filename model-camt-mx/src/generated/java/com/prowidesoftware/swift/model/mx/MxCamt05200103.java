...
/**
 * Class for camt.052.001.03 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt05200103(final String xml) {
        this();
        MxCamt05200103 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05200103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link BankToCustomerAccountReportV03 }
     *     
     */
    public BankToCustomerAccountReportV03 getBkToCstmrAcctRpt() {
     ...
     *     
     */
    public MxCamt05200103 setBkToCstmrAcctRpt(BankToCustomerAccountReportV03 value) {
    ...
    public static MxCamt05200103 parse(String xml) {
        return ((MxCamt05200103) MxReadImpl.parse(MxCamt05200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05200103) MxReadImpl.parse(MxCamt05200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05200103 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05200103) parserImpl.read(MxCamt05200103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05200103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05200103 message
     * @return
     *     a new instance of MxCamt05200103
     */
    public static final MxCamt05200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05200103 .class);
    }
