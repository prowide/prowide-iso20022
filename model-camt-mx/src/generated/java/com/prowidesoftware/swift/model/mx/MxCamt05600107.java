    ...
    extends AbstractMX
{
    ...
    public static MxCamt05600107 parse(String xml) {
        return ((MxCamt05600107) MxReadImpl.parse(MxCamt05600107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05600107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05600107) MxReadImpl.parse(MxCamt05600107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05600107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05600107 .class);
    }
