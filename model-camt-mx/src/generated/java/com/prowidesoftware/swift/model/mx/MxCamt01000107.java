    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.010.001.07";
    ...
    public static MxCamt01000107 parse(String xml) {
        return ((MxCamt01000107) MxReadImpl.parse(MxCamt01000107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01000107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01000107) MxReadImpl.parse(MxCamt01000107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01000107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01000107 .class);
    }
