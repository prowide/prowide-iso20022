    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.003.001.03";
    ...
    public static MxCamt00300103 parse(String xml) {
        return ((MxCamt00300103) MxReadImpl.parse(MxCamt00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00300103) MxReadImpl.parse(MxCamt00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00300103 .class);
    }
