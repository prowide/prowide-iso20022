...
/**
 * Class for camt.054.001.05 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt05400105(final String xml) {
        this();
        MxCamt05400105 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05400105(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link BankToCustomerDebitCreditNotificationV05 }
     *     
     */
    public BankToCustomerDebitCreditNotificationV05 getBkToCstmrDbtCdtNtfctn() {
     ...
     *     
     */
    public MxCamt05400105 setBkToCstmrDbtCdtNtfctn(BankToCustomerDebitCreditNotificationV05 value) {
    ...
    public static MxCamt05400105 parse(String xml) {
        return ((MxCamt05400105) MxReadImpl.parse(MxCamt05400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05400105) MxReadImpl.parse(MxCamt05400105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05400105 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05400105) parserImpl.read(MxCamt05400105 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05400105 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05400105 message
     * @return
     *     a new instance of MxCamt05400105
     */
    public static final MxCamt05400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05400105 .class);
    }
