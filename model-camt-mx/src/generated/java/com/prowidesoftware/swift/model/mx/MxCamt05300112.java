...
/**
 * Class for camt.053.001.12 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCamt05300112(final String xml) {
        this();
        MxCamt05300112 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05300112(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link BankToCustomerStatementV12 }
     *     
     */
    public BankToCustomerStatementV12 getBkToCstmrStmt() {
     ...
     *     
     */
    public MxCamt05300112 setBkToCstmrStmt(BankToCustomerStatementV12 value) {
     ...
     * 
     */
    public static MxCamt05300112 parse(String xml) {
        return ((MxCamt05300112) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt05300112 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCamt05300112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05300112) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt05300112 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05300112 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05300112) parserImpl.read(MxCamt05300112 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05300112 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05300112 message
     * @return
     *     a new instance of MxCamt05300112
     */
    public final static MxCamt05300112 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCamt05300112 .class);
    }
