    ...
    extends AbstractMX
{
    ...
    public static MxCamt05300112 parse(String xml) {
        return ((MxCamt05300112) MxReadImpl.parse(MxCamt05300112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05300112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05300112) MxReadImpl.parse(MxCamt05300112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05300112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05300112 .class);
    }
