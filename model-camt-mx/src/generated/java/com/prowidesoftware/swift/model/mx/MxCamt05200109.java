...
/**
 * Class for camt.052.001.09 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt05200109(final String xml) {
        this();
        MxCamt05200109 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05200109(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link BankToCustomerAccountReportV09 }
     *     
     */
    public BankToCustomerAccountReportV09 getBkToCstmrAcctRpt() {
     ...
     *     
     */
    public MxCamt05200109 setBkToCstmrAcctRpt(BankToCustomerAccountReportV09 value) {
    ...
    public static MxCamt05200109 parse(String xml) {
        return ((MxCamt05200109) MxReadImpl.parse(MxCamt05200109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05200109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05200109) MxReadImpl.parse(MxCamt05200109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05200109 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05200109) parserImpl.read(MxCamt05200109 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05200109 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05200109 message
     * @return
     *     a new instance of MxCamt05200109
     */
    public static final MxCamt05200109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05200109 .class);
    }
