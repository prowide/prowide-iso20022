    ...
    extends AbstractMX
{
    ...
    public static MxCamt05300108 parse(String xml) {
        return ((MxCamt05300108) MxReadImpl.parse(MxCamt05300108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05300108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05300108) MxReadImpl.parse(MxCamt05300108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05300108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05300108 .class);
    }
