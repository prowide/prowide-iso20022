    ...
    extends AbstractMX
{
    ...
    public static MxCamt00900104 parse(String xml) {
        return ((MxCamt00900104) MxReadImpl.parse(MxCamt00900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00900104) MxReadImpl.parse(MxCamt00900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00900104 .class);
    }
