    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.035.001.03";
    ...
    public static MxCamt03500103 parse(String xml) {
        return ((MxCamt03500103) MxReadImpl.parse(MxCamt03500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03500103) MxReadImpl.parse(MxCamt03500103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03500103 .class);
    }
