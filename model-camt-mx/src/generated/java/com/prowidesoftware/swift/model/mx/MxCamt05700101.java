    ...
    extends AbstractMX
{
    ...
    public static MxCamt05700101 parse(String xml) {
        return ((MxCamt05700101) MxReadImpl.parse(MxCamt05700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05700101) MxReadImpl.parse(MxCamt05700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05700101 .class);
    }
