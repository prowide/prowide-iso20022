    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.023.001.04";
    ...
    public static MxCamt02300104 parse(String xml) {
        return ((MxCamt02300104) MxReadImpl.parse(MxCamt02300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02300104) MxReadImpl.parse(MxCamt02300104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02300104 .class);
    }
