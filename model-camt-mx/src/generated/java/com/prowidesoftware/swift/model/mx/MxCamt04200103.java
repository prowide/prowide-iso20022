    ...
    extends AbstractMX
{
    ...
    public static MxCamt04200103 parse(String xml) {
        return ((MxCamt04200103) MxReadImpl.parse(MxCamt04200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04200103) MxReadImpl.parse(MxCamt04200103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04200103 .class);
    }
