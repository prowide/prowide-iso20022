...
/**
 * Class for camt.037.001.07 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.037.001.07")
public class MxCamt03700107
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt03700107(final String xml) {
        this();
        MxCamt03700107 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt03700107(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCamt03700107 setDbtAuthstnReq(DebitAuthorisationRequestV07 value) {
    ...
    public static MxCamt03700107 parse(String xml) {
        return ((MxCamt03700107) MxReadImpl.parse(MxCamt03700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03700107) MxReadImpl.parse(MxCamt03700107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt03700107 parse(String xml, MxRead parserImpl) {
        return ((MxCamt03700107) parserImpl.read(MxCamt03700107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt03700107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt03700107 message
     * @return
     *     a new instance of MxCamt03700107
     */
    public static final MxCamt03700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03700107 .class);
    }
