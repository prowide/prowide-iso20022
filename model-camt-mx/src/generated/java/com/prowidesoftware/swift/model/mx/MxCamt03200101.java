    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Camt03200101 .class, Case.class, CaseAssignment.class, MxCamt03200101 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.032.001.01";
    ...
    public static MxCamt03200101 parse(String xml) {
        return ((MxCamt03200101) MxReadImpl.parse(MxCamt03200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03200101) MxReadImpl.parse(MxCamt03200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03200101 fromJson(String json) {
