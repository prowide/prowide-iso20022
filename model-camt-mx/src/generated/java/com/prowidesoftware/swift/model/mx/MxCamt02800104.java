    ...
    extends AbstractMX
{
    ...
    public static MxCamt02800104 parse(String xml) {
        return ((MxCamt02800104) MxReadImpl.parse(MxCamt02800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02800104) MxReadImpl.parse(MxCamt02800104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt02800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02800104 .class);
    }
