    ...
    extends AbstractMX
{
    ...
    public static MxCamt06600102 parse(String xml) {
        return ((MxCamt06600102) MxReadImpl.parse(MxCamt06600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06600102) MxReadImpl.parse(MxCamt06600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt06600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06600102 .class);
    }
