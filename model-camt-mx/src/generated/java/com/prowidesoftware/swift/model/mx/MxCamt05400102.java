    ...
    extends AbstractMX
{
    ...
    public static MxCamt05400102 parse(String xml) {
        return ((MxCamt05400102) MxReadImpl.parse(MxCamt05400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05400102) MxReadImpl.parse(MxCamt05400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05400102 .class);
    }
