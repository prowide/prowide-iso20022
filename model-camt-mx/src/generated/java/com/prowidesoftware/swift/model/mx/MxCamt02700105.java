    ...
    extends AbstractMX
{
    ...
    public static MxCamt02700105 parse(String xml) {
        return ((MxCamt02700105) MxReadImpl.parse(MxCamt02700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02700105) MxReadImpl.parse(MxCamt02700105 .class, xml, _classes, new MxReadParams(conf)));
    }
