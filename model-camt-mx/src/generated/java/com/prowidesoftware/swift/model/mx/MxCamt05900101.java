...
/**
 * Class for camt.059.001.01 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.059.001.01")
public class MxCamt05900101
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt05900101(final String xml) {
        this();
        MxCamt05900101 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05900101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link NotificationToReceiveStatusReportV01 }
     *     
     */
     ...
     *     
     */
    public MxCamt05900101 setNtfctnToRcvStsRpt(NotificationToReceiveStatusReportV01 value) {
    ...
    public static MxCamt05900101 parse(String xml) {
        return ((MxCamt05900101) MxReadImpl.parse(MxCamt05900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05900101) MxReadImpl.parse(MxCamt05900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05900101 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05900101) parserImpl.read(MxCamt05900101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05900101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05900101 message
     * @return
     *     a new instance of MxCamt05900101
     */
    public static final MxCamt05900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05900101 .class);
    }
