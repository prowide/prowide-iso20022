    ...
    extends AbstractMX
{
    ...
    public static MxCamt05000103 parse(String xml) {
        return ((MxCamt05000103) MxReadImpl.parse(MxCamt05000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05000103) MxReadImpl.parse(MxCamt05000103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05000103 .class);
    }
