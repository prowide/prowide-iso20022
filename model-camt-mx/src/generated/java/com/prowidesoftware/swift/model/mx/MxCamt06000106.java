    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.060.001.06";
    ...
    public static MxCamt06000106 parse(String xml) {
        return ((MxCamt06000106) MxReadImpl.parse(MxCamt06000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06000106) MxReadImpl.parse(MxCamt06000106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt06000106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06000106 .class);
    }
