...
/**
 * Class for camt.083.001.01 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.083.001.01")
public class MxCamt08300101
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt08300101(final String xml) {
        this();
        MxCamt08300101 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt08300101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link IntraBalanceMovementCancellationReportV01 }
     *     
     */
     ...
     *     
     */
    public MxCamt08300101 setIntraBalMvmntCxlRpt(IntraBalanceMovementCancellationReportV01 value) {
    ...
    public static MxCamt08300101 parse(String xml) {
        return ((MxCamt08300101) MxReadImpl.parse(MxCamt08300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08300101) MxReadImpl.parse(MxCamt08300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt08300101 parse(String xml, MxRead parserImpl) {
        return ((MxCamt08300101) parserImpl.read(MxCamt08300101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt08300101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt08300101 message
     * @return
     *     a new instance of MxCamt08300101
     */
    public static final MxCamt08300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08300101 .class);
    }
