    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.020.001.02";
    ...
    public static MxCamt02000102 parse(String xml) {
        return ((MxCamt02000102) MxReadImpl.parse(MxCamt02000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02000102) MxReadImpl.parse(MxCamt02000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02000102 .class);
    }
