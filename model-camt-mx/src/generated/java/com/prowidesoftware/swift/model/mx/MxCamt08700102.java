    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.087.001.02";
    ...
    public static MxCamt08700102 parse(String xml) {
        return ((MxCamt08700102) MxReadImpl.parse(MxCamt08700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08700102) MxReadImpl.parse(MxCamt08700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt08700102 fromJson(String json) {
