    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.036.001.05";
    ...
    public static MxCamt03600105 parse(String xml) {
        return ((MxCamt03600105) MxReadImpl.parse(MxCamt03600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03600105) MxReadImpl.parse(MxCamt03600105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03600105 fromJson(String json) {
