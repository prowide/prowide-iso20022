    ...
    extends AbstractMX
{
    ...
    public static MxCamt02400106 parse(String xml) {
        return ((MxCamt02400106) MxReadImpl.parse(MxCamt02400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02400106) MxReadImpl.parse(MxCamt02400106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt02400106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02400106 .class);
    }
