    ...
    extends AbstractMX
{
    ...
    public static MxCamt00700202 parse(String xml) {
        return ((MxCamt00700202) MxReadImpl.parse(MxCamt00700202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00700202 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00700202) MxReadImpl.parse(MxCamt00700202 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00700202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00700202 .class);
    }
