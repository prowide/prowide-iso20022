    ...
    extends AbstractMX
{
    ...
    public static MxCamt04600105 parse(String xml) {
        return ((MxCamt04600105) MxReadImpl.parse(MxCamt04600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04600105) MxReadImpl.parse(MxCamt04600105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04600105 .class);
    }
