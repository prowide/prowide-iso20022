    ...
    extends AbstractMX
{
    ...
    public static MxCamt05800104 parse(String xml) {
        return ((MxCamt05800104) MxReadImpl.parse(MxCamt05800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05800104) MxReadImpl.parse(MxCamt05800104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05800104 .class);
    }
