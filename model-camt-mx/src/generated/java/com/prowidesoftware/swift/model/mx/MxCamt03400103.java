    ...
    extends AbstractMX
{
    ...
    public static MxCamt03400103 parse(String xml) {
        return ((MxCamt03400103) MxReadImpl.parse(MxCamt03400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03400103) MxReadImpl.parse(MxCamt03400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03400103 .class);
    }
