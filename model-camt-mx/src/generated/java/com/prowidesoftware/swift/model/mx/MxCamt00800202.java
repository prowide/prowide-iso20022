    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Camt00800202 .class, CancellationReason3Code.class, Case.class, CaseAssignment.class, CurrencyAndAmount.class, DebitAuthorisationDetails2 .class, MxCamt00800202 .class, PaymentInstructionExtract2 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.008.002.02";
    ...
    public static MxCamt00800202 parse(String xml) {
        return ((MxCamt00800202) MxReadImpl.parse(MxCamt00800202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00800202 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00800202) MxReadImpl.parse(MxCamt00800202 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00800202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00800202 .class);
    }
