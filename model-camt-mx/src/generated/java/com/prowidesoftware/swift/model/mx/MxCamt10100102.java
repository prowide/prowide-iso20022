    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.101.001.02";
    ...
    public static MxCamt10100102 parse(String xml) {
        return ((MxCamt10100102) MxReadImpl.parse(MxCamt10100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10100102) MxReadImpl.parse(MxCamt10100102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt10100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt10100102 .class);
    }
