    ...
    extends AbstractMX
{
    ...
    public static MxCamt05900103 parse(String xml) {
        return ((MxCamt05900103) MxReadImpl.parse(MxCamt05900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05900103) MxReadImpl.parse(MxCamt05900103 .class, xml, _classes, new MxReadParams(conf)));
    }
