    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.075.001.01";
    ...
    public static MxCamt07500101 parse(String xml) {
        return ((MxCamt07500101) MxReadImpl.parse(MxCamt07500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07500101) MxReadImpl.parse(MxCamt07500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt07500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07500101 .class);
    }
