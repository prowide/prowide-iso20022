    ...
    extends AbstractMX
{
    ...
    public static MxCamt00300106 parse(String xml) {
        return ((MxCamt00300106) MxReadImpl.parse(MxCamt00300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00300106) MxReadImpl.parse(MxCamt00300106 .class, xml, _classes, new MxReadParams(conf)));
    }
