    ...
    extends AbstractMX
{
    ...
    public static MxCamt04700101 parse(String xml) {
        return ((MxCamt04700101) MxReadImpl.parse(MxCamt04700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04700101) MxReadImpl.parse(MxCamt04700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04700101 .class);
    }
