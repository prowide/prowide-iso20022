    ...
    extends AbstractMX
{
    ...
    public static MxCamt08100102 parse(String xml) {
        return ((MxCamt08100102) MxReadImpl.parse(MxCamt08100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08100102) MxReadImpl.parse(MxCamt08100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt08100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08100102 .class);
    }
