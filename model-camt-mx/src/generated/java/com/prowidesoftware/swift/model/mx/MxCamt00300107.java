    ...
    extends AbstractMX
{
    ...
    public static MxCamt00300107 parse(String xml) {
        return ((MxCamt00300107) MxReadImpl.parse(MxCamt00300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00300107) MxReadImpl.parse(MxCamt00300107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00300107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00300107 .class);
    }
