    ...
    extends AbstractMX
{
    ...
    public static MxCamt01000104 parse(String xml) {
        return ((MxCamt01000104) MxReadImpl.parse(MxCamt01000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01000104) MxReadImpl.parse(MxCamt01000104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01000104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01000104 .class);
    }
