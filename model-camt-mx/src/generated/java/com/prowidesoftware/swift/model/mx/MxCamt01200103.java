    ...
    extends AbstractMX
{
    ...
    public static MxCamt01200103 parse(String xml) {
        return ((MxCamt01200103) MxReadImpl.parse(MxCamt01200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01200103) MxReadImpl.parse(MxCamt01200103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01200103 .class);
    }
