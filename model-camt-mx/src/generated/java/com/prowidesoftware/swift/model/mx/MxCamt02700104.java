    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.027.001.04";
    ...
    public static MxCamt02700104 parse(String xml) {
        return ((MxCamt02700104) MxReadImpl.parse(MxCamt02700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02700104) MxReadImpl.parse(MxCamt02700104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02700104 fromJson(String json) {
