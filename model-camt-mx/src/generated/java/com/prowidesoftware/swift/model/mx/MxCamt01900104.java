    ...
    extends AbstractMX
{
    ...
    public static MxCamt01900104 parse(String xml) {
        return ((MxCamt01900104) MxReadImpl.parse(MxCamt01900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01900104) MxReadImpl.parse(MxCamt01900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01900104 .class);
    }
