    ...
    extends AbstractMX
{
    ...
    public static MxCamt05300105 parse(String xml) {
        return ((MxCamt05300105) MxReadImpl.parse(MxCamt05300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05300105) MxReadImpl.parse(MxCamt05300105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05300105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05300105 .class);
    }
