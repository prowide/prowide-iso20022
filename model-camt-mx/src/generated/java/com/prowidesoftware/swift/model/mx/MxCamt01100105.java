    ...
    extends AbstractMX
{
    ...
    public static MxCamt01100105 parse(String xml) {
        return ((MxCamt01100105) MxReadImpl.parse(MxCamt01100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01100105) MxReadImpl.parse(MxCamt01100105 .class, xml, _classes, new MxReadParams(conf)));
    }
