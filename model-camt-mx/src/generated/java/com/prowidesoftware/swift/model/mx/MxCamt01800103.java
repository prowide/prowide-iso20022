    ...
    extends AbstractMX
{
    ...
    public static MxCamt01800103 parse(String xml) {
        return ((MxCamt01800103) MxReadImpl.parse(MxCamt01800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01800103) MxReadImpl.parse(MxCamt01800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01800103 .class);
    }
