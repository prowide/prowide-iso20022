    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.105.001.03";
    ...
    public static MxCamt10500103 parse(String xml) {
        return ((MxCamt10500103) MxReadImpl.parse(MxCamt10500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10500103) MxReadImpl.parse(MxCamt10500103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt10500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt10500103 .class);
    }
