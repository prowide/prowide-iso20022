    ...
    extends AbstractMX
{
    ...
    public static MxCamt08600105 parse(String xml) {
        return ((MxCamt08600105) MxReadImpl.parse(MxCamt08600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08600105) MxReadImpl.parse(MxCamt08600105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt08600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08600105 .class);
    }
