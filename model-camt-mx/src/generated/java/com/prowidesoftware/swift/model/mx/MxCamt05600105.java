    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.056.001.05";
    ...
    public static MxCamt05600105 parse(String xml) {
        return ((MxCamt05600105) MxReadImpl.parse(MxCamt05600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05600105) MxReadImpl.parse(MxCamt05600105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05600105 fromJson(String json) {
