...
/**
 * Class for camt.054.001.08 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt05400108(final String xml) {
        this();
        MxCamt05400108 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05400108(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCamt05400108 setBkToCstmrDbtCdtNtfctn(BankToCustomerDebitCreditNotificationV08 value) {
    ...
    public static MxCamt05400108 parse(String xml) {
        return ((MxCamt05400108) MxReadImpl.parse(MxCamt05400108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05400108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05400108) MxReadImpl.parse(MxCamt05400108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05400108 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05400108) parserImpl.read(MxCamt05400108 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05400108 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05400108 message
     * @return
     *     a new instance of MxCamt05400108
     */
    public static final MxCamt05400108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05400108 .class);
    }
