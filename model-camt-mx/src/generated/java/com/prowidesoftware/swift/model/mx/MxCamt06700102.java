    ...
    extends AbstractMX
{
    ...
    public static MxCamt06700102 parse(String xml) {
        return ((MxCamt06700102) MxReadImpl.parse(MxCamt06700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06700102) MxReadImpl.parse(MxCamt06700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt06700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06700102 .class);
    }
