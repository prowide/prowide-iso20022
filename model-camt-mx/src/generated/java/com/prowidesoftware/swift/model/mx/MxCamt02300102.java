    ...
    extends AbstractMX
{
    ...
    public static MxCamt02300102 parse(String xml) {
        return ((MxCamt02300102) MxReadImpl.parse(MxCamt02300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02300102) MxReadImpl.parse(MxCamt02300102 .class, xml, _classes, new MxReadParams(conf)));
    }
