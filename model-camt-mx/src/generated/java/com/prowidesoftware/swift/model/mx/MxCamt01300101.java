    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.013.001.01";
    ...
    public static MxCamt01300101 parse(String xml) {
        return ((MxCamt01300101) MxReadImpl.parse(MxCamt01300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01300101) MxReadImpl.parse(MxCamt01300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01300101 .class);
    }
