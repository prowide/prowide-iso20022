    ...
    extends AbstractMX
{
    ...
    public static MxCamt06900103 parse(String xml) {
        return ((MxCamt06900103) MxReadImpl.parse(MxCamt06900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06900103) MxReadImpl.parse(MxCamt06900103 .class, xml, _classes, new MxReadParams(conf)));
    }
