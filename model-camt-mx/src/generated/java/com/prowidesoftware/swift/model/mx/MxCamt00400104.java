    ...
    extends AbstractMX
{
    ...
    public static MxCamt00400104 parse(String xml) {
        return ((MxCamt00400104) MxReadImpl.parse(MxCamt00400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00400104) MxReadImpl.parse(MxCamt00400104 .class, xml, _classes, new MxReadParams(conf)));
    }
