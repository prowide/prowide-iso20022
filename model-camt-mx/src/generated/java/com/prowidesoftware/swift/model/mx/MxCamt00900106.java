    ...
    extends AbstractMX
{
    ...
    public static MxCamt00900106 parse(String xml) {
        return ((MxCamt00900106) MxReadImpl.parse(MxCamt00900106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00900106) MxReadImpl.parse(MxCamt00900106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00900106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00900106 .class);
    }
