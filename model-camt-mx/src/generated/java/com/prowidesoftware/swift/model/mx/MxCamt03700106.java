    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.037.001.06";
    ...
    public static MxCamt03700106 parse(String xml) {
        return ((MxCamt03700106) MxReadImpl.parse(MxCamt03700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03700106) MxReadImpl.parse(MxCamt03700106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03700106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03700106 .class);
    }
