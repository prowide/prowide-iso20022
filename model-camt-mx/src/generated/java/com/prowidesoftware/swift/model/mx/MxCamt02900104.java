    ...
    extends AbstractMX
{
    ...
    public static MxCamt02900104 parse(String xml) {
        return ((MxCamt02900104) MxReadImpl.parse(MxCamt02900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02900104) MxReadImpl.parse(MxCamt02900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt02900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02900104 .class);
    }
