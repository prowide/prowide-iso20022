    ...
    extends AbstractMX
{
    ...
    public static MxCamt02800101 parse(String xml) {
        return ((MxCamt02800101) MxReadImpl.parse(MxCamt02800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02800101) MxReadImpl.parse(MxCamt02800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt02800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02800101 .class);
    }
