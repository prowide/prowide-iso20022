    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Camt03700102 .class, CancellationReason1Code.class, Case.class, CaseAssignment.class, CurrencyAndAmount.class, DebitAuthorisationDetails.class, MxCamt03700102 .class, PaymentInstructionExtract2 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.037.001.02";
    ...
    public static MxCamt03700102 parse(String xml) {
        return ((MxCamt03700102) MxReadImpl.parse(MxCamt03700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03700102) MxReadImpl.parse(MxCamt03700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03700102 fromJson(String json) {
