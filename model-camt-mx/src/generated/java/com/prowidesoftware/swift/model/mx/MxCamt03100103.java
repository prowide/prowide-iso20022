    ...
    extends AbstractMX
{
    ...
    public static MxCamt03100103 parse(String xml) {
        return ((MxCamt03100103) MxReadImpl.parse(MxCamt03100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03100103) MxReadImpl.parse(MxCamt03100103 .class, xml, _classes, new MxReadParams(conf)));
    }
