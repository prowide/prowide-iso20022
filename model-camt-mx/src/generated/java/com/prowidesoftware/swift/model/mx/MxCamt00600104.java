    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.006.001.04";
    ...
    public static MxCamt00600104 parse(String xml) {
        return ((MxCamt00600104) MxReadImpl.parse(MxCamt00600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00600104) MxReadImpl.parse(MxCamt00600104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00600104 .class);
    }
