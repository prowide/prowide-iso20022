    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.059.001.08";
    ...
    public static MxCamt05900108 parse(String xml) {
        return ((MxCamt05900108) MxReadImpl.parse(MxCamt05900108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05900108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05900108) MxReadImpl.parse(MxCamt05900108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05900108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05900108 .class);
    }
