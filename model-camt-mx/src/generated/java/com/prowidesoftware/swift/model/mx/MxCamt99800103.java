    ...
    extends AbstractMX
{
    ...
    public static MxCamt99800103 parse(String xml) {
        return ((MxCamt99800103) MxReadImpl.parse(MxCamt99800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt99800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt99800103) MxReadImpl.parse(MxCamt99800103 .class, xml, _classes, new MxReadParams(conf)));
    }
