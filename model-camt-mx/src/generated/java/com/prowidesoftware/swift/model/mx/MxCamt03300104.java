    ...
    extends AbstractMX
{
    ...
    public static MxCamt03300104 parse(String xml) {
        return ((MxCamt03300104) MxReadImpl.parse(MxCamt03300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03300104) MxReadImpl.parse(MxCamt03300104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03300104 .class);
    }
