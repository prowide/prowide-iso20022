    ...
    extends AbstractMX
{
    ...
    public static MxCamt02800102 parse(String xml) {
        return ((MxCamt02800102) MxReadImpl.parse(MxCamt02800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02800102) MxReadImpl.parse(MxCamt02800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02800102 fromJson(String json) {
