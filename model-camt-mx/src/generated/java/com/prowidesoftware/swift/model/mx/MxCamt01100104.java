    ...
    extends AbstractMX
{
    ...
    public static MxCamt01100104 parse(String xml) {
        return ((MxCamt01100104) MxReadImpl.parse(MxCamt01100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01100104) MxReadImpl.parse(MxCamt01100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01100104 .class);
    }
