    ...
    extends AbstractMX
{
    ...
    public static MxCamt11000102 parse(String xml) {
        return ((MxCamt11000102) MxReadImpl.parse(MxCamt11000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt11000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt11000102) MxReadImpl.parse(MxCamt11000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt11000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt11000102 .class);
    }
