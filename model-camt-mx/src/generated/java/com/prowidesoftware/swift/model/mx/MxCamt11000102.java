...
/**
 * Class for camt.110.001.02 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCamt11000102(final String xml) {
        this();
        MxCamt11000102 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt11000102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link InvestigationRequestV02 }
     *     
     */
    public InvestigationRequestV02 getInvstgtnReq() {
        return invstgtnReq;
    }
     ...
     *     
     */
    public MxCamt11000102 setInvstgtnReq(InvestigationRequestV02 value) {
     ...
     * 
     */
    public static MxCamt11000102 parse(String xml) {
        return ((MxCamt11000102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt11000102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCamt11000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt11000102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt11000102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt11000102 parse(String xml, MxRead parserImpl) {
        return ((MxCamt11000102) parserImpl.read(MxCamt11000102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt11000102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt11000102 message
     * @return
     *     a new instance of MxCamt11000102
     */
    public static final MxCamt11000102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCamt11000102 .class);
    }
