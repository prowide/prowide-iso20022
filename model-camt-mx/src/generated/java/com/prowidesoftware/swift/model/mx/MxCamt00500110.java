    ...
    extends AbstractMX
{
    ...
    public static MxCamt00500110 parse(String xml) {
        return ((MxCamt00500110) MxReadImpl.parse(MxCamt00500110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00500110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00500110) MxReadImpl.parse(MxCamt00500110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00500110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00500110 .class);
    }
