...
/**
 * Class for camt.033.001.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCamt03300103(final String xml) {
        this();
        MxCamt03300103 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt03300103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link RequestForDuplicateV03 }
     *     
     */
    public RequestForDuplicateV03 getReqForDplct() {
        return reqForDplct;
    }
     ...
     *     
     */
    public MxCamt03300103 setReqForDplct(RequestForDuplicateV03 value) {
     ...
     */
    public static MxCamt03300103 parse(String xml, MxRead parserImpl) {
        return ((MxCamt03300103) parserImpl.read(MxCamt03300103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt03300103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt03300103 message
     * @return
