    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.074.001.02";
    ...
    public static MxCamt07400102 parse(String xml) {
        return ((MxCamt07400102) MxReadImpl.parse(MxCamt07400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07400102) MxReadImpl.parse(MxCamt07400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt07400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07400102 .class);
    }
