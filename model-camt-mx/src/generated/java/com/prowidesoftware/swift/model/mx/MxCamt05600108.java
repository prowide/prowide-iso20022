    ...
    extends AbstractMX
{
    ...
    public static MxCamt05600108 parse(String xml) {
        return ((MxCamt05600108) MxReadImpl.parse(MxCamt05600108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05600108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05600108) MxReadImpl.parse(MxCamt05600108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05600108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05600108 .class);
    }
