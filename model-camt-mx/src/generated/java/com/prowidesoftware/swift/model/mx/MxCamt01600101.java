    ...
    extends AbstractMX
{
    ...
    public static MxCamt01600101 parse(String xml) {
        return ((MxCamt01600101) MxReadImpl.parse(MxCamt01600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01600101) MxReadImpl.parse(MxCamt01600101 .class, xml, _classes, new MxReadParams(conf)));
    }
