    ...
    extends AbstractMX
{
    ...
    public static MxCamt08800101 parse(String xml) {
        return ((MxCamt08800101) MxReadImpl.parse(MxCamt08800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08800101) MxReadImpl.parse(MxCamt08800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt08800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08800101 .class);
    }
