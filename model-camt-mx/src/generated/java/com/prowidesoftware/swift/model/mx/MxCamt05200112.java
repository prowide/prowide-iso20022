    ...
    extends AbstractMX
{
    ...
    public static MxCamt05200112 parse(String xml) {
        return ((MxCamt05200112) MxReadImpl.parse(MxCamt05200112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05200112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05200112) MxReadImpl.parse(MxCamt05200112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05200112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05200112 .class);
    }
