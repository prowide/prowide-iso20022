    ...
    extends AbstractMX
{
    ...
    public static MxCamt05000105 parse(String xml) {
        return ((MxCamt05000105) MxReadImpl.parse(MxCamt05000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05000105) MxReadImpl.parse(MxCamt05000105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05000105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05000105 .class);
    }
