    ...
    extends AbstractMX
{
    ...
    public static MxCamt05200110 parse(String xml) {
        return ((MxCamt05200110) MxReadImpl.parse(MxCamt05200110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05200110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05200110) MxReadImpl.parse(MxCamt05200110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05200110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05200110 .class);
    }
