    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.010.001.03";
    ...
    public static MxCamt01000103 parse(String xml) {
        return ((MxCamt01000103) MxReadImpl.parse(MxCamt01000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01000103) MxReadImpl.parse(MxCamt01000103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt01000103 fromJson(String json) {
