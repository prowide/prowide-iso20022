    ...
    extends AbstractMX
{
    ...
    public static MxCamt04500102 parse(String xml) {
        return ((MxCamt04500102) MxReadImpl.parse(MxCamt04500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04500102) MxReadImpl.parse(MxCamt04500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04500102 .class);
    }
