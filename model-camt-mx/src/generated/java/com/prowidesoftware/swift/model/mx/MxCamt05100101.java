    ...
    extends AbstractMX
{
    ...
    public static MxCamt05100101 parse(String xml) {
        return ((MxCamt05100101) MxReadImpl.parse(MxCamt05100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05100101) MxReadImpl.parse(MxCamt05100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05100101 .class);
    }
