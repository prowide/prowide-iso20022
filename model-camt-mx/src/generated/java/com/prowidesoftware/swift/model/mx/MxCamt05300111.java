...
/**
 * Class for camt.053.001.11 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCamt05300111(final String xml) {
        this();
        MxCamt05300111 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05300111(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link BankToCustomerStatementV11 }
     *     
     */
    public BankToCustomerStatementV11 getBkToCstmrStmt() {
     ...
     *     
     */
    public MxCamt05300111 setBkToCstmrStmt(BankToCustomerStatementV11 value) {
     ...
     * 
     */
    public static MxCamt05300111 parse(String xml) {
        return ((MxCamt05300111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt05300111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCamt05300111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05300111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt05300111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05300111 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05300111) parserImpl.read(MxCamt05300111 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05300111 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05300111 message
     * @return
     *     a new instance of MxCamt05300111
     */
    public static final MxCamt05300111 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCamt05300111 .class);
    }
