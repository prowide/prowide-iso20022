    ...
    extends AbstractMX
{
    ...
    public static MxCamt05300111 parse(String xml) {
        return ((MxCamt05300111) MxReadImpl.parse(MxCamt05300111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05300111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05300111) MxReadImpl.parse(MxCamt05300111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05300111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05300111 .class);
    }
