    ...
    extends AbstractMX
{
    ...
    public static MxCamt03400105 parse(String xml) {
        return ((MxCamt03400105) MxReadImpl.parse(MxCamt03400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03400105) MxReadImpl.parse(MxCamt03400105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03400105 .class);
    }
