    ...
    extends AbstractMX
{
    ...
    public static MxCamt09000101 parse(String xml) {
        return ((MxCamt09000101) MxReadImpl.parse(MxCamt09000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt09000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt09000101) MxReadImpl.parse(MxCamt09000101 .class, xml, _classes, new MxReadParams(conf)));
    }
