    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.12";
    ...
    public static MxCamt05500112 parse(String xml) {
        return ((MxCamt05500112) MxReadImpl.parse(MxCamt05500112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05500112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05500112) MxReadImpl.parse(MxCamt05500112 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05500112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05500112 .class);
    }
