    ...
    extends AbstractMX
{
    ...
    public static MxCamt04800106 parse(String xml) {
        return ((MxCamt04800106) MxReadImpl.parse(MxCamt04800106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04800106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04800106) MxReadImpl.parse(MxCamt04800106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04800106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04800106 .class);
    }
