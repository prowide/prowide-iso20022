    ...
    extends AbstractMX
{
    ...
    public static MxCamt01200106 parse(String xml) {
        return ((MxCamt01200106) MxReadImpl.parse(MxCamt01200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01200106) MxReadImpl.parse(MxCamt01200106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt01200106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt01200106 .class);
    }
