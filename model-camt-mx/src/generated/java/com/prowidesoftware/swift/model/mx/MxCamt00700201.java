    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.007.002.01";
    ...
    public static MxCamt00700201 parse(String xml) {
        return ((MxCamt00700201) MxReadImpl.parse(MxCamt00700201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00700201 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00700201) MxReadImpl.parse(MxCamt00700201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00700201 fromJson(String json) {
