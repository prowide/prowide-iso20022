    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.06";
    ...
    public static MxCamt05200106 parse(String xml) {
        return ((MxCamt05200106) MxReadImpl.parse(MxCamt05200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05200106) MxReadImpl.parse(MxCamt05200106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05200106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05200106 .class);
    }
