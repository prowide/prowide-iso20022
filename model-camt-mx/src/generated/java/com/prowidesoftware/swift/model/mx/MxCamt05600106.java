    ...
    extends AbstractMX
{
    ...
    public static MxCamt05600106 parse(String xml) {
        return ((MxCamt05600106) MxReadImpl.parse(MxCamt05600106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05600106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05600106) MxReadImpl.parse(MxCamt05600106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05600106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05600106 .class);
    }
