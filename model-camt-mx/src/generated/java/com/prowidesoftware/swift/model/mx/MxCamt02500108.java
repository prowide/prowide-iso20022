    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.025.001.08";
    ...
    public static MxCamt02500108 parse(String xml) {
        return ((MxCamt02500108) MxReadImpl.parse(MxCamt02500108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02500108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02500108) MxReadImpl.parse(MxCamt02500108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02500108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02500108 .class);
    }
