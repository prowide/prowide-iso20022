    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.087.001.04";
    ...
    public static MxCamt08700104 parse(String xml) {
        return ((MxCamt08700104) MxReadImpl.parse(MxCamt08700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08700104) MxReadImpl.parse(MxCamt08700104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt08700104 fromJson(String json) {
