    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.026.001.05";
    ...
    public static MxCamt02600105 parse(String xml) {
        return ((MxCamt02600105) MxReadImpl.parse(MxCamt02600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02600105) MxReadImpl.parse(MxCamt02600105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02600105 .class);
    }
