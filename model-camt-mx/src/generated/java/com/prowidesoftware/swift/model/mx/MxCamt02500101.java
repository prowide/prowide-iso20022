    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {AdditionalReferences.class, Camt02500101 .class, MessageIdentification.class, MxCamt02500101 .class, PartyIdentification.class, RequestHandling.class };
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.025.001.01";
    ...
    public static MxCamt02500101 parse(String xml) {
        return ((MxCamt02500101) MxReadImpl.parse(MxCamt02500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02500101) MxReadImpl.parse(MxCamt02500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02500101 .class);
    }
