    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.056.001.10";
    ...
    public static MxCamt05600110 parse(String xml) {
        return ((MxCamt05600110) MxReadImpl.parse(MxCamt05600110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05600110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05600110) MxReadImpl.parse(MxCamt05600110 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt05600110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05600110 .class);
    }
