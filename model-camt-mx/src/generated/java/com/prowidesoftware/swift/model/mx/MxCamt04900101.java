    ...
    extends AbstractMX
{
    ...
    public static MxCamt04900101 parse(String xml) {
        return ((MxCamt04900101) MxReadImpl.parse(MxCamt04900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04900101) MxReadImpl.parse(MxCamt04900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04900101 .class);
    }
