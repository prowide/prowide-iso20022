    ...
    extends AbstractMX
{
    ...
    public static MxCamt10500101 parse(String xml) {
        return ((MxCamt10500101) MxReadImpl.parse(MxCamt10500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10500101) MxReadImpl.parse(MxCamt10500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt10500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt10500101 .class);
    }
