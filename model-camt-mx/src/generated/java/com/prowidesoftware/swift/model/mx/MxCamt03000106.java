    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.030.001.06";
    ...
    public static MxCamt03000106 parse(String xml) {
        return ((MxCamt03000106) MxReadImpl.parse(MxCamt03000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03000106) MxReadImpl.parse(MxCamt03000106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03000106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03000106 .class);
    }
