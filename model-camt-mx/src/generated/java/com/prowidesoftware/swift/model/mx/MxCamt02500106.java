    ...
    extends AbstractMX
{
    ...
    public static MxCamt02500106 parse(String xml) {
        return ((MxCamt02500106) MxReadImpl.parse(MxCamt02500106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02500106) MxReadImpl.parse(MxCamt02500106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt02500106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02500106 .class);
    }
