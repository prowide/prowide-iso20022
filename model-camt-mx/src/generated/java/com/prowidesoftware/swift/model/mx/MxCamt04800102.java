    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.048.001.02";
    ...
    public static MxCamt04800102 parse(String xml) {
        return ((MxCamt04800102) MxReadImpl.parse(MxCamt04800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04800102) MxReadImpl.parse(MxCamt04800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt04800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04800102 .class);
    }
