...
/**
 * Class for camt.054.001.10 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.10")
public class MxCamt05400110
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCamt05400110(final String xml) {
        this();
        MxCamt05400110 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05400110(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCamt05400110 setBkToCstmrDbtCdtNtfctn(BankToCustomerDebitCreditNotificationV10 value) {
     ...
     * 
     */
    public static MxCamt05400110 parse(String xml) {
        return ((MxCamt05400110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt05400110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCamt05400110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05400110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCamt05400110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05400110 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05400110) parserImpl.read(MxCamt05400110 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05400110 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05400110 message
     * @return
     *     a new instance of MxCamt05400110
     */
    public static final MxCamt05400110 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCamt05400110 .class);
    }
