    ...
    extends AbstractMX
{
    ...
    public static MxCamt05400110 parse(String xml) {
        return ((MxCamt05400110) MxReadImpl.parse(MxCamt05400110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05400110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05400110) MxReadImpl.parse(MxCamt05400110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05400110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05400110 .class);
    }
