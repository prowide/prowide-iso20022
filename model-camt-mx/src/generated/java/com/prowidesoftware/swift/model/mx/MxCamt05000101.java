    ...
    extends AbstractMX
{
    ...
    public static MxCamt05000101 parse(String xml) {
        return ((MxCamt05000101) MxReadImpl.parse(MxCamt05000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05000101) MxReadImpl.parse(MxCamt05000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05000101 .class);
    }
