    ...
    extends AbstractMX
{
    ...
    public static MxCamt00400102 parse(String xml) {
        return ((MxCamt00400102) MxReadImpl.parse(MxCamt00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00400102) MxReadImpl.parse(MxCamt00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00400102 .class);
    }
