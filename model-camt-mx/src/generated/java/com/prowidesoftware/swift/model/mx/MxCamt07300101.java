    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.073.001.01";
    ...
    public static MxCamt07300101 parse(String xml) {
        return ((MxCamt07300101) MxReadImpl.parse(MxCamt07300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07300101) MxReadImpl.parse(MxCamt07300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt07300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07300101 .class);
    }
