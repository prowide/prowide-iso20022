...
/**
 * Class for camt.054.001.03 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt05400103(final String xml) {
        this();
        MxCamt05400103 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05400103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link BankToCustomerDebitCreditNotificationV03 }
     *     
     */
    public BankToCustomerDebitCreditNotificationV03 getBkToCstmrDbtCdtNtfctn() {
     ...
     *     
     */
    public MxCamt05400103 setBkToCstmrDbtCdtNtfctn(BankToCustomerDebitCreditNotificationV03 value) {
    ...
    public static MxCamt05400103 parse(String xml) {
        return ((MxCamt05400103) MxReadImpl.parse(MxCamt05400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05400103) MxReadImpl.parse(MxCamt05400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05400103 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05400103) parserImpl.read(MxCamt05400103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05400103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05400103 message
     * @return
     *     a new instance of MxCamt05400103
     */
    public static final MxCamt05400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05400103 .class);
    }
