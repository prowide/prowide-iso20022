    ...
    extends AbstractMX
{
    ...
    public static MxCamt04700107 parse(String xml) {
        return ((MxCamt04700107) MxReadImpl.parse(MxCamt04700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04700107) MxReadImpl.parse(MxCamt04700107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04700107 .class);
    }
