    ...
    extends AbstractMX
{
    ...
    public static MxCamt01600104 parse(String xml) {
        return ((MxCamt01600104) MxReadImpl.parse(MxCamt01600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt01600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt01600104) MxReadImpl.parse(MxCamt01600104 .class, xml, _classes, new MxReadParams(conf)));
    }
