    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.004.001.07";
    ...
    public static MxCamt00400107 parse(String xml) {
        return ((MxCamt00400107) MxReadImpl.parse(MxCamt00400107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00400107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00400107) MxReadImpl.parse(MxCamt00400107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt00400107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00400107 .class);
    }
