    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.038.001.03";
    ...
    public static MxCamt03800103 parse(String xml) {
        return ((MxCamt03800103) MxReadImpl.parse(MxCamt03800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03800103) MxReadImpl.parse(MxCamt03800103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03800103 .class);
    }
