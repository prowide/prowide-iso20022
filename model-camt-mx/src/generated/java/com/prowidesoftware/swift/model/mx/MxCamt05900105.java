    ...
    extends AbstractMX
{
    ...
    public static MxCamt05900105 parse(String xml) {
        return ((MxCamt05900105) MxReadImpl.parse(MxCamt05900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05900105) MxReadImpl.parse(MxCamt05900105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt05900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05900105 .class);
    }
