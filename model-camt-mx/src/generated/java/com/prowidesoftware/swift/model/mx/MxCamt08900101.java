    ...
    extends AbstractMX
{
    ...
    public static final transient int FUNCTIONALITY = 89;
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:DRAFT1camt.089.001.01";
    ...
    public static MxCamt08900101 parse(String xml) {
        return ((MxCamt08900101) MxReadImpl.parse(MxCamt08900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08900101) MxReadImpl.parse(MxCamt08900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt08900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt08900101 .class);
    }
