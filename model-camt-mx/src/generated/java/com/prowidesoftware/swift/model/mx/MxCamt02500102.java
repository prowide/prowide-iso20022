    ...
    extends AbstractMX
{
    ...
    public static MxCamt02500102 parse(String xml) {
        return ((MxCamt02500102) MxReadImpl.parse(MxCamt02500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02500102) MxReadImpl.parse(MxCamt02500102 .class, xml, _classes, new MxReadParams(conf)));
    }
