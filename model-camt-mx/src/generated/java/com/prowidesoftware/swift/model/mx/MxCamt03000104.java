    ...
    extends AbstractMX
{
    ...
    public static MxCamt03000104 parse(String xml) {
        return ((MxCamt03000104) MxReadImpl.parse(MxCamt03000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03000104) MxReadImpl.parse(MxCamt03000104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03000104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03000104 .class);
    }
