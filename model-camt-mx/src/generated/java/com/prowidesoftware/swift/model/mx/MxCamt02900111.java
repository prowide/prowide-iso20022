...
/**
 * Class for camt.029.001.11 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt02900111(final String xml) {
        this();
        MxCamt02900111 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt02900111(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link ResolutionOfInvestigationV11 }
     *     
     */
    public ResolutionOfInvestigationV11 getRsltnOfInvstgtn() {
     ...
     *     
     */
    public MxCamt02900111 setRsltnOfInvstgtn(ResolutionOfInvestigationV11 value) {
    ...
    public static MxCamt02900111 parse(String xml) {
        return ((MxCamt02900111) MxReadImpl.parse(MxCamt02900111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02900111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02900111) MxReadImpl.parse(MxCamt02900111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt02900111 parse(String xml, MxRead parserImpl) {
        return ((MxCamt02900111) parserImpl.read(MxCamt02900111 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt02900111 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt02900111 message
     * @return
     *     a new instance of MxCamt02900111
     */
    public static final MxCamt02900111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02900111 .class);
    }
