    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.071.001.04";
    ...
    public static MxCamt07100104 parse(String xml) {
        return ((MxCamt07100104) MxReadImpl.parse(MxCamt07100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07100104) MxReadImpl.parse(MxCamt07100104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt07100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07100104 .class);
    }
