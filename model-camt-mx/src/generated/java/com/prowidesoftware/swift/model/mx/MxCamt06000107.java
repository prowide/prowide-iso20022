    ...
    extends AbstractMX
{
    ...
    public static MxCamt06000107 parse(String xml) {
        return ((MxCamt06000107) MxReadImpl.parse(MxCamt06000107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06000107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06000107) MxReadImpl.parse(MxCamt06000107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt06000107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06000107 .class);
    }
