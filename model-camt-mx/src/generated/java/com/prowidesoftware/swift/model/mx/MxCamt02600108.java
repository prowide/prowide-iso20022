...
/**
 * Class for camt.026.001.08 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt02600108(final String xml) {
        this();
        MxCamt02600108 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt02600108(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link UnableToApplyV08 }
     *     
     */
    public UnableToApplyV08 getUblToApply() {
        return ublToApply;
    }
     ...
     *     
     */
    public MxCamt02600108 setUblToApply(UnableToApplyV08 value) {
    ...
    public static MxCamt02600108 parse(String xml) {
        return ((MxCamt02600108) MxReadImpl.parse(MxCamt02600108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02600108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02600108) MxReadImpl.parse(MxCamt02600108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt02600108 parse(String xml, MxRead parserImpl) {
        return ((MxCamt02600108) parserImpl.read(MxCamt02600108 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt02600108 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt02600108 message
     * @return
     *     a new instance of MxCamt02600108
     */
    public static final MxCamt02600108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02600108 .class);
    }
