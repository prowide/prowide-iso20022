    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.034.001.06";
    ...
    public static MxCamt03400106 parse(String xml) {
        return ((MxCamt03400106) MxReadImpl.parse(MxCamt03400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03400106) MxReadImpl.parse(MxCamt03400106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt03400106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03400106 .class);
    }
