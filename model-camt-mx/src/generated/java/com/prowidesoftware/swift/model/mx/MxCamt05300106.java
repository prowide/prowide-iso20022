...
/**
 * Class for camt.053.001.06 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt05300106(final String xml) {
        this();
        MxCamt05300106 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05300106(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCamt05300106 setBkToCstmrStmt(BankToCustomerStatementV06 value) {
    ...
    public static MxCamt05300106 parse(String xml) {
        return ((MxCamt05300106) MxReadImpl.parse(MxCamt05300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05300106) MxReadImpl.parse(MxCamt05300106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05300106 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05300106) parserImpl.read(MxCamt05300106 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05300106 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05300106 message
     * @return
     *     a new instance of MxCamt05300106
     */
    public static final MxCamt05300106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05300106 .class);
    }
