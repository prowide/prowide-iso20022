    ...
    extends AbstractMX
{
    ...
    public static MxCamt02000104 parse(String xml) {
        return ((MxCamt02000104) MxReadImpl.parse(MxCamt02000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02000104) MxReadImpl.parse(MxCamt02000104 .class, xml, _classes, new MxReadParams(conf)));
    }
