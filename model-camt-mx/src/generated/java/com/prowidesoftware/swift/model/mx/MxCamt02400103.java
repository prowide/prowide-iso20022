    ...
    extends AbstractMX
{
    ...
    public static MxCamt02400103 parse(String xml) {
        return ((MxCamt02400103) MxReadImpl.parse(MxCamt02400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02400103) MxReadImpl.parse(MxCamt02400103 .class, xml, _classes, new MxReadParams(conf)));
    }
