    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.049.001.07";
    ...
    public static MxCamt04900107 parse(String xml) {
        return ((MxCamt04900107) MxReadImpl.parse(MxCamt04900107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04900107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04900107) MxReadImpl.parse(MxCamt04900107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt04900107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04900107 .class);
    }
