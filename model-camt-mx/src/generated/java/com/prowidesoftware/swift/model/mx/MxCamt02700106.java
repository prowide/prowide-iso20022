    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.027.001.06";
    ...
    public static MxCamt02700106 parse(String xml) {
        return ((MxCamt02700106) MxReadImpl.parse(MxCamt02700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02700106) MxReadImpl.parse(MxCamt02700106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt02700106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02700106 .class);
    }
