    ...
    extends AbstractMX
{
    ...
    public static MxCamt06100102 parse(String xml) {
        return ((MxCamt06100102) MxReadImpl.parse(MxCamt06100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt06100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt06100102) MxReadImpl.parse(MxCamt06100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt06100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt06100102 .class);
    }
