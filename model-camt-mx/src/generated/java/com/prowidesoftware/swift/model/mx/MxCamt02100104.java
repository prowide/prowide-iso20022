...
/**
 * Class for camt.021.001.04 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:swift:xsd:camt.021.001.04")
public class MxCamt02100104
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt02100104(final String xml) {
        this();
        MxCamt02100104 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt02100104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link ReturnGeneralBusinessInformationV04 }
     *     
     */
    public ReturnGeneralBusinessInformationV04 getRtrGnlBizInf() {
        return rtrGnlBizInf;
    }
    ...
    public static MxCamt02100104 parse(String xml) {
        return ((MxCamt02100104) MxReadImpl.parse(MxCamt02100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02100104) MxReadImpl.parse(MxCamt02100104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt02100104 parse(String xml, MxRead parserImpl) {
        return ((MxCamt02100104) parserImpl.read(MxCamt02100104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt02100104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt02100104 message
     * @return
     *     a new instance of MxCamt02100104
     */
    public static final MxCamt02100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02100104 .class);
    }
