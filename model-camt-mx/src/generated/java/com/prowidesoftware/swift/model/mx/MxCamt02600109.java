...
/**
 * Class for camt.026.001.09 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt02600109(final String xml) {
        this();
        MxCamt02600109 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt02600109(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link UnableToApplyV09 }
     *     
     */
    public UnableToApplyV09 getUblToApply() {
        return ublToApply;
    }
     ...
     *     
     */
    public MxCamt02600109 setUblToApply(UnableToApplyV09 value) {
    ...
    public static MxCamt02600109 parse(String xml) {
        return ((MxCamt02600109) MxReadImpl.parse(MxCamt02600109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02600109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02600109) MxReadImpl.parse(MxCamt02600109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt02600109 parse(String xml, MxRead parserImpl) {
        return ((MxCamt02600109) parserImpl.read(MxCamt02600109 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt02600109 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt02600109 message
     * @return
     *     a new instance of MxCamt02600109
     */
    public static final MxCamt02600109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02600109 .class);
    }
