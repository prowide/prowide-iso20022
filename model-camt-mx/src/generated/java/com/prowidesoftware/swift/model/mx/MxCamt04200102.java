    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:camt.042.001.02";
    ...
    public static MxCamt04200102 parse(String xml) {
        return ((MxCamt04200102) MxReadImpl.parse(MxCamt04200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04200102) MxReadImpl.parse(MxCamt04200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt04200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04200102 .class);
    }
