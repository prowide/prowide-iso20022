    ...
    extends AbstractMX
{
    ...
    public static MxCamt04700105 parse(String xml) {
        return ((MxCamt04700105) MxReadImpl.parse(MxCamt04700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04700105) MxReadImpl.parse(MxCamt04700105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04700105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04700105 .class);
    }
