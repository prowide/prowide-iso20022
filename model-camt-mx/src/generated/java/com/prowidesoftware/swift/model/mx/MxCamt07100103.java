    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:camt.071.001.03";
    ...
    public static MxCamt07100103 parse(String xml) {
        return ((MxCamt07100103) MxReadImpl.parse(MxCamt07100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt07100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt07100103) MxReadImpl.parse(MxCamt07100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCamt07100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt07100103 .class);
    }
