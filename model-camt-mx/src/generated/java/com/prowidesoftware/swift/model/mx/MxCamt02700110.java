    ...
    extends AbstractMX
{
    ...
    public static MxCamt02700110 parse(String xml) {
        return ((MxCamt02700110) MxReadImpl.parse(MxCamt02700110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02700110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02700110) MxReadImpl.parse(MxCamt02700110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt02700110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02700110 .class);
    }
