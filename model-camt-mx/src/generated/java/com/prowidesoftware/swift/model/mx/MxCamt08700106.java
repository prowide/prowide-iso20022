    ...
    extends AbstractMX
{
    ...
    public static MxCamt08700106 parse(String xml) {
        return ((MxCamt08700106) MxReadImpl.parse(MxCamt08700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt08700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt08700106) MxReadImpl.parse(MxCamt08700106 .class, xml, _classes, new MxReadParams(conf)));
    }
