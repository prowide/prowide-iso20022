    ...
    extends AbstractMX
{
    ...
    public static MxCamt03700104 parse(String xml) {
        return ((MxCamt03700104) MxReadImpl.parse(MxCamt03700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt03700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt03700104) MxReadImpl.parse(MxCamt03700104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt03700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt03700104 .class);
    }
