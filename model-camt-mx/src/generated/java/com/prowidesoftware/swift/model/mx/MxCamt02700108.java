    ...
    extends AbstractMX
{
    ...
    public static MxCamt02700108 parse(String xml) {
        return ((MxCamt02700108) MxReadImpl.parse(MxCamt02700108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt02700108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt02700108) MxReadImpl.parse(MxCamt02700108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt02700108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt02700108 .class);
    }
