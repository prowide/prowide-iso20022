    ...
    extends AbstractMX
{
    ...
    public static MxCamt00500108 parse(String xml) {
        return ((MxCamt00500108) MxReadImpl.parse(MxCamt00500108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt00500108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt00500108) MxReadImpl.parse(MxCamt00500108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt00500108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt00500108 .class);
    }
