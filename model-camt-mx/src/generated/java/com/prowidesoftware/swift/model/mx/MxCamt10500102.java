    ...
    extends AbstractMX
{
    ...
    public static MxCamt10500102 parse(String xml) {
        return ((MxCamt10500102) MxReadImpl.parse(MxCamt10500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt10500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt10500102) MxReadImpl.parse(MxCamt10500102 .class, xml, _classes, new MxReadParams(conf)));
    }
