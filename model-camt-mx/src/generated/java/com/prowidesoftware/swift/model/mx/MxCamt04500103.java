    ...
    extends AbstractMX
{
    ...
    public static MxCamt04500103 parse(String xml) {
        return ((MxCamt04500103) MxReadImpl.parse(MxCamt04500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt04500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt04500103) MxReadImpl.parse(MxCamt04500103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCamt04500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt04500103 .class);
    }
