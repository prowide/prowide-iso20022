...
/**
 * Class for camt.053.001.09 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCamt05300109(final String xml) {
        this();
        MxCamt05300109 tmp = parse(xml);
     ...
     * 
     */
    public MxCamt05300109(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link BankToCustomerStatementV09 }
     *     
     */
    public BankToCustomerStatementV09 getBkToCstmrStmt() {
     ...
     *     
     */
    public MxCamt05300109 setBkToCstmrStmt(BankToCustomerStatementV09 value) {
    ...
    public static MxCamt05300109 parse(String xml) {
        return ((MxCamt05300109) MxReadImpl.parse(MxCamt05300109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCamt05300109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCamt05300109) MxReadImpl.parse(MxCamt05300109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCamt05300109 parse(String xml, MxRead parserImpl) {
        return ((MxCamt05300109) parserImpl.read(MxCamt05300109 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCamt05300109 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCamt05300109 message
     * @return
     *     a new instance of MxCamt05300109
     */
    public static final MxCamt05300109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCamt05300109 .class);
    }
