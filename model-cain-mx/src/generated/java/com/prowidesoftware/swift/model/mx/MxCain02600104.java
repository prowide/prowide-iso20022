    ...
    extends AbstractMX
{
    ...
    public static MxCain02600104 parse(String xml) {
        return ((MxCain02600104) MxReadImpl.parse(MxCain02600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02600104) MxReadImpl.parse(MxCain02600104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain02600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02600104 .class);
    }
