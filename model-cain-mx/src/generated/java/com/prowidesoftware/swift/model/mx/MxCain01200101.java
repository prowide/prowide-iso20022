    ...
    extends AbstractMX
{
    ...
    public static MxCain01200101 parse(String xml) {
        return ((MxCain01200101) MxReadImpl.parse(MxCain01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01200101) MxReadImpl.parse(MxCain01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain01200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01200101 .class);
    }
