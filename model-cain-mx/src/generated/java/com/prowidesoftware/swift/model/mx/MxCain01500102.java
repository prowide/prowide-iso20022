    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.015.001.02";
    ...
    public static MxCain01500102 parse(String xml) {
        return ((MxCain01500102) MxReadImpl.parse(MxCain01500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01500102) MxReadImpl.parse(MxCain01500102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain01500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01500102 .class);
    }
