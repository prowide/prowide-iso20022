    ...
    extends AbstractMX
{
    ...
    public static MxCain01800101 parse(String xml) {
        return ((MxCain01800101) MxReadImpl.parse(MxCain01800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01800101) MxReadImpl.parse(MxCain01800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain01800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01800101 .class);
    }
