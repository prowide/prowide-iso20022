...
/**
 * Class for cain.001.001.02 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCain00100102(final String xml) {
        this();
        MxCain00100102 tmp = parse(xml);
     ...
     * 
     */
    public MxCain00100102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AuthorisationInitiationV02 }
     *     
     */
    public AuthorisationInitiationV02 getAuthstnInitn() {
        return authstnInitn;
    }
     ...
     *     
     */
    public MxCain00100102 setAuthstnInitn(AuthorisationInitiationV02 value) {
     ...
     * 
     */
    public static MxCain00100102 parse(String xml) {
        return ((MxCain00100102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCain00100102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCain00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00100102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCain00100102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCain00100102 parse(String xml, MxRead parserImpl) {
        return ((MxCain00100102) parserImpl.read(MxCain00100102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCain00100102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCain00100102 message
     * @return
     *     a new instance of MxCain00100102
     */
    public final static MxCain00100102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCain00100102 .class);
    }
