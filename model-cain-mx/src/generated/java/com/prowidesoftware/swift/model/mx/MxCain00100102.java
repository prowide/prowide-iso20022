    ...
    extends AbstractMX
{
    ...
    public static MxCain00100102 parse(String xml) {
        return ((MxCain00100102) MxReadImpl.parse(MxCain00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00100102) MxReadImpl.parse(MxCain00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00100102 .class);
    }
