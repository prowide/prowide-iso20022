    ...
    extends AbstractMX
{
    ...
    public static MxCain00100101 parse(String xml) {
        return ((MxCain00100101) MxReadImpl.parse(MxCain00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00100101) MxReadImpl.parse(MxCain00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00100101 .class);
    }
