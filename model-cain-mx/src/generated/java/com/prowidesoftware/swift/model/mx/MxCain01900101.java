    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.019.001.01";
    ...
    public static MxCain01900101 parse(String xml) {
        return ((MxCain01900101) MxReadImpl.parse(MxCain01900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01900101) MxReadImpl.parse(MxCain01900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain01900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01900101 .class);
    }
