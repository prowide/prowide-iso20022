    ...
    extends AbstractMX
{
    ...
    public static MxCain00100105 parse(String xml) {
        return ((MxCain00100105) MxReadImpl.parse(MxCain00100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00100105) MxReadImpl.parse(MxCain00100105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain00100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00100105 .class);
    }
