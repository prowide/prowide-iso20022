    ...
    extends AbstractMX
{
    ...
    public static MxCain00200105 parse(String xml) {
        return ((MxCain00200105) MxReadImpl.parse(MxCain00200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00200105) MxReadImpl.parse(MxCain00200105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain00200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00200105 .class);
    }
