...
/**
 * Class for cain.014.001.04 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:cain.014.001.04")
public class MxCain01400104
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "RtrvlFlfmtInitn", required = true)
    protected RetrievalFulfilmentInitiationV04 rtrvlFlfmtInitn;
     ...
     * 
     */
    public MxCain01400104(final String xml) {
        this();
        MxCain01400104 tmp = parse(xml);
     ...
     * 
     */
    public MxCain01400104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link RetrievalFulfilmentInitiationV04 }
     *     
     */
    public RetrievalFulfilmentInitiationV04 getRtrvlFlfmtInitn() {
     ...
     *     
     */
    public MxCain01400104 setRtrvlFlfmtInitn(RetrievalFulfilmentInitiationV04 value) {
     ...
     * 
     */
    public static MxCain01400104 parse(String xml) {
        return ((MxCain01400104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCain01400104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCain01400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01400104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCain01400104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCain01400104 parse(String xml, MxRead parserImpl) {
        return ((MxCain01400104) parserImpl.read(MxCain01400104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCain01400104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCain01400104 message
     * @return
     *     a new instance of MxCain01400104
     */
    public static final MxCain01400104 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCain01400104 .class);
    }
