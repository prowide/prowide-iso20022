    ...
    extends AbstractMX
{
    ...
    public static MxCain01400104 parse(String xml) {
        return ((MxCain01400104) MxReadImpl.parse(MxCain01400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01400104) MxReadImpl.parse(MxCain01400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain01400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01400104 .class);
    }
