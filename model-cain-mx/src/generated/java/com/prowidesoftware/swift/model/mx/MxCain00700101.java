    ...
    extends AbstractMX
{
    ...
    public static MxCain00700101 parse(String xml) {
        return ((MxCain00700101) MxReadImpl.parse(MxCain00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00700101) MxReadImpl.parse(MxCain00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain00700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00700101 .class);
    }
