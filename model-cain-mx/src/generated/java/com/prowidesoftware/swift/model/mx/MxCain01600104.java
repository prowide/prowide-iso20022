    ...
    extends AbstractMX
{
    ...
    public static MxCain01600104 parse(String xml) {
        return ((MxCain01600104) MxReadImpl.parse(MxCain01600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01600104) MxReadImpl.parse(MxCain01600104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain01600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01600104 .class);
    }
