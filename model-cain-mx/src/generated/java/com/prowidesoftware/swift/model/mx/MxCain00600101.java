    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.006.001.01";
    ...
    public static MxCain00600101 parse(String xml) {
        return ((MxCain00600101) MxReadImpl.parse(MxCain00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00600101) MxReadImpl.parse(MxCain00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00600101 .class);
    }
