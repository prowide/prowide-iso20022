    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.002.001.04";
    ...
    public static MxCain00200104 parse(String xml) {
        return ((MxCain00200104) MxReadImpl.parse(MxCain00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00200104) MxReadImpl.parse(MxCain00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain00200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00200104 .class);
    }
