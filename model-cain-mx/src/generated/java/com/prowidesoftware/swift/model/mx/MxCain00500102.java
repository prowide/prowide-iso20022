    ...
    extends AbstractMX
{
    ...
    public static MxCain00500102 parse(String xml) {
        return ((MxCain00500102) MxReadImpl.parse(MxCain00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00500102) MxReadImpl.parse(MxCain00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain00500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00500102 .class);
    }
