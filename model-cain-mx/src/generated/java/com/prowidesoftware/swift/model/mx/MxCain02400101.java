    ...
    extends AbstractMX
{
    ...
    public static MxCain02400101 parse(String xml) {
        return ((MxCain02400101) MxReadImpl.parse(MxCain02400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02400101) MxReadImpl.parse(MxCain02400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain02400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02400101 .class);
    }
