    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.001.001.04";
    ...
    public static MxCain00100104 parse(String xml) {
        return ((MxCain00100104) MxReadImpl.parse(MxCain00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00100104) MxReadImpl.parse(MxCain00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain00100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00100104 .class);
    }
