    ...
    extends AbstractMX
{
    ...
    public static MxCain00400104 parse(String xml) {
        return ((MxCain00400104) MxReadImpl.parse(MxCain00400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00400104) MxReadImpl.parse(MxCain00400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain00400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00400104 .class);
    }
