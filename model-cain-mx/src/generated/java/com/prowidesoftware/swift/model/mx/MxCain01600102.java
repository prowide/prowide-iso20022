    ...
    extends AbstractMX
{
    ...
    public static MxCain01600102 parse(String xml) {
        return ((MxCain01600102) MxReadImpl.parse(MxCain01600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01600102) MxReadImpl.parse(MxCain01600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain01600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01600102 .class);
    }
