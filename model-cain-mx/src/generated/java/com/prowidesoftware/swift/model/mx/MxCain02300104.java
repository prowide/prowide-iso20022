    ...
    extends AbstractMX
{
    ...
    public static MxCain02300104 parse(String xml) {
        return ((MxCain02300104) MxReadImpl.parse(MxCain02300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02300104) MxReadImpl.parse(MxCain02300104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain02300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02300104 .class);
    }
