    ...
    extends AbstractMX
{
    ...
    public static MxCain02200104 parse(String xml) {
        return ((MxCain02200104) MxReadImpl.parse(MxCain02200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02200104) MxReadImpl.parse(MxCain02200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain02200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02200104 .class);
    }
