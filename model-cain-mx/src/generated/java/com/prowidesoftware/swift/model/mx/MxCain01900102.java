    ...
    extends AbstractMX
{
    ...
    public static MxCain01900102 parse(String xml) {
        return ((MxCain01900102) MxReadImpl.parse(MxCain01900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01900102) MxReadImpl.parse(MxCain01900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain01900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01900102 .class);
    }
