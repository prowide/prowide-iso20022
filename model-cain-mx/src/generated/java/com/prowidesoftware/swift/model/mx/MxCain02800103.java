    ...
    extends AbstractMX
{
    ...
    public static MxCain02800103 parse(String xml) {
        return ((MxCain02800103) MxReadImpl.parse(MxCain02800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02800103) MxReadImpl.parse(MxCain02800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain02800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02800103 .class);
    }
