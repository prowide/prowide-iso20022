    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.014.001.01";
    ...
    public static MxCain01400101 parse(String xml) {
        return ((MxCain01400101) MxReadImpl.parse(MxCain01400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01400101) MxReadImpl.parse(MxCain01400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain01400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01400101 .class);
    }
