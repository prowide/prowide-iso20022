    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.006.001.03";
    ...
    public static MxCain00600103 parse(String xml) {
        return ((MxCain00600103) MxReadImpl.parse(MxCain00600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00600103) MxReadImpl.parse(MxCain00600103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain00600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00600103 .class);
    }
