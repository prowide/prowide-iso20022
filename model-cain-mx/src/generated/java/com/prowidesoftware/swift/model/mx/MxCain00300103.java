    ...
    extends AbstractMX
{
    ...
    public static MxCain00300103 parse(String xml) {
        return ((MxCain00300103) MxReadImpl.parse(MxCain00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00300103) MxReadImpl.parse(MxCain00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain00300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00300103 .class);
    }
