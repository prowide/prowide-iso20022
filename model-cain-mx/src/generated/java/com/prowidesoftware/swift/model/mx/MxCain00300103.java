...
/**
 * Class for cain.003.001.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCain00300103(final String xml) {
        this();
        MxCain00300103 tmp = parse(xml);
     ...
     * 
     */
    public MxCain00300103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link FinancialInitiationV03 }
     *     
     */
    public FinancialInitiationV03 getFinInitn() {
        return finInitn;
    }
     ...
     *     
     */
    public MxCain00300103 setFinInitn(FinancialInitiationV03 value) {
        this.finInitn = value;
        return this;
    }
     ...
     * 
     */
    public static MxCain00300103 parse(String xml) {
        return ((MxCain00300103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCain00300103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCain00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00300103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCain00300103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCain00300103 parse(String xml, MxRead parserImpl) {
        return ((MxCain00300103) parserImpl.read(MxCain00300103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCain00300103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCain00300103 message
     * @return
     *     a new instance of MxCain00300103
     */
    public final static MxCain00300103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCain00300103 .class);
    }
