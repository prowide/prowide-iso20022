    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.022.001.01";
    ...
    public static MxCain02200101 parse(String xml) {
        return ((MxCain02200101) MxReadImpl.parse(MxCain02200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02200101) MxReadImpl.parse(MxCain02200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain02200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02200101 .class);
    }
