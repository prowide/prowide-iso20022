    ...
    extends AbstractMX
{
    ...
    public static MxCain00400101 parse(String xml) {
        return ((MxCain00400101) MxReadImpl.parse(MxCain00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00400101) MxReadImpl.parse(MxCain00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain00400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00400101 .class);
    }
