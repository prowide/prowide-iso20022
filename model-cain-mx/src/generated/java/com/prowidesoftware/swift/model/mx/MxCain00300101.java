    ...
    extends AbstractMX
{
    ...
    public static MxCain00300101 parse(String xml) {
        return ((MxCain00300101) MxReadImpl.parse(MxCain00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00300101) MxReadImpl.parse(MxCain00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00300101 .class);
    }
