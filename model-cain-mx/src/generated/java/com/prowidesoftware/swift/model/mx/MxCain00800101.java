    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.008.001.01";
    ...
    public static MxCain00800101 parse(String xml) {
        return ((MxCain00800101) MxReadImpl.parse(MxCain00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00800101) MxReadImpl.parse(MxCain00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain00800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00800101 .class);
    }
