    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.017.001.02";
    ...
    public static MxCain01700102 parse(String xml) {
        return ((MxCain01700102) MxReadImpl.parse(MxCain01700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01700102) MxReadImpl.parse(MxCain01700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain01700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01700102 .class);
    }
