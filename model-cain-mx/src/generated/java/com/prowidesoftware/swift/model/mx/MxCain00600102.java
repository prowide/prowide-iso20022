    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.006.001.02";
    ...
    public static MxCain00600102 parse(String xml) {
        return ((MxCain00600102) MxReadImpl.parse(MxCain00600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00600102) MxReadImpl.parse(MxCain00600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain00600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00600102 .class);
    }
