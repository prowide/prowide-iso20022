    ...
    extends AbstractMX
{
    ...
    public static MxCain00200103 parse(String xml) {
        return ((MxCain00200103) MxReadImpl.parse(MxCain00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00200103) MxReadImpl.parse(MxCain00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain00200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00200103 .class);
    }
