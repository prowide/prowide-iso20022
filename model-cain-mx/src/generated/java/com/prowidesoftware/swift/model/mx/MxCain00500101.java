    ...
    extends AbstractMX
{
    ...
    public static MxCain00500101 parse(String xml) {
        return ((MxCain00500101) MxReadImpl.parse(MxCain00500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00500101) MxReadImpl.parse(MxCain00500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain00500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00500101 .class);
    }
