    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.002.001.02";
    ...
    public static MxCain00200102 parse(String xml) {
        return ((MxCain00200102) MxReadImpl.parse(MxCain00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00200102) MxReadImpl.parse(MxCain00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00200102 .class);
    }
