    ...
    extends AbstractMX
{
    ...
    public static MxCain00400105 parse(String xml) {
        return ((MxCain00400105) MxReadImpl.parse(MxCain00400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00400105) MxReadImpl.parse(MxCain00400105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain00400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00400105 .class);
    }
