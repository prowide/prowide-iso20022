    ...
    extends AbstractMX
{
    ...
    public static MxCain00500105 parse(String xml) {
        return ((MxCain00500105) MxReadImpl.parse(MxCain00500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00500105) MxReadImpl.parse(MxCain00500105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain00500105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00500105 .class);
    }
