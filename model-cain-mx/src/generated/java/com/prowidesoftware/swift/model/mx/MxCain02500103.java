    ...
    extends AbstractMX
{
    ...
    public static MxCain02500103 parse(String xml) {
        return ((MxCain02500103) MxReadImpl.parse(MxCain02500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02500103) MxReadImpl.parse(MxCain02500103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain02500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02500103 .class);
    }
