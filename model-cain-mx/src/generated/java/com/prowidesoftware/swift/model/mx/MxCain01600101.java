    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.016.001.01";
    ...
    public static MxCain01600101 parse(String xml) {
        return ((MxCain01600101) MxReadImpl.parse(MxCain01600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01600101) MxReadImpl.parse(MxCain01600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain01600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01600101 .class);
    }
