...
/**
 * Class for cain.021.001.01 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:cain.021.001.01")
public class MxCain02100101
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "RtrvlInitn", required = true)
    protected RetrievalInitiationV01 rtrvlInitn;
     ...
     * 
     */
    public MxCain02100101(final String xml) {
        this();
        MxCain02100101 tmp = parse(xml);
     ...
     * 
     */
    public MxCain02100101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link RetrievalInitiationV01 }
     *     
     */
    public RetrievalInitiationV01 getRtrvlInitn() {
        return rtrvlInitn;
    }
     ...
     *     
     */
    public MxCain02100101 setRtrvlInitn(RetrievalInitiationV01 value) {
     ...
     * 
     */
    public static MxCain02100101 parse(String xml) {
        return ((MxCain02100101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCain02100101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCain02100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02100101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCain02100101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCain02100101 parse(String xml, MxRead parserImpl) {
        return ((MxCain02100101) parserImpl.read(MxCain02100101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCain02100101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCain02100101 message
     * @return
     *     a new instance of MxCain02100101
     */
    public static final MxCain02100101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCain02100101 .class);
    }
