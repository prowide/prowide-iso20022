    ...
    extends AbstractMX
{
    ...
    public static MxCain02100101 parse(String xml) {
        return ((MxCain02100101) MxReadImpl.parse(MxCain02100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02100101) MxReadImpl.parse(MxCain02100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain02100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02100101 .class);
    }
