    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.026.001.02";
    ...
    public static MxCain02600102 parse(String xml) {
        return ((MxCain02600102) MxReadImpl.parse(MxCain02600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02600102) MxReadImpl.parse(MxCain02600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain02600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02600102 .class);
    }
