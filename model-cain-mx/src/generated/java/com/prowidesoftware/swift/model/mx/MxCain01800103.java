...
/**
 * Class for cain.018.001.03 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:cain.018.001.03")
public class MxCain01800103
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "VrfctnInitn", required = true)
    protected VerificationInitiationV03 vrfctnInitn;
     ...
     * 
     */
    public MxCain01800103(final String xml) {
        this();
        MxCain01800103 tmp = parse(xml);
     ...
     * 
     */
    public MxCain01800103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link VerificationInitiationV03 }
     *     
     */
    public VerificationInitiationV03 getVrfctnInitn() {
        return vrfctnInitn;
    }
     ...
     *     
     */
    public MxCain01800103 setVrfctnInitn(VerificationInitiationV03 value) {
     ...
     * 
     */
    public static MxCain01800103 parse(String xml) {
        return ((MxCain01800103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCain01800103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCain01800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01800103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCain01800103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCain01800103 parse(String xml, MxRead parserImpl) {
        return ((MxCain01800103) parserImpl.read(MxCain01800103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCain01800103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCain01800103 message
     * @return
     *     a new instance of MxCain01800103
     */
    public final static MxCain01800103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCain01800103 .class);
    }
