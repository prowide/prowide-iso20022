    ...
    extends AbstractMX
{
    ...
    public static MxCain01800103 parse(String xml) {
        return ((MxCain01800103) MxReadImpl.parse(MxCain01800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01800103) MxReadImpl.parse(MxCain01800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain01800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01800103 .class);
    }
