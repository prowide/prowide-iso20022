    ...
    extends AbstractMX
{
    ...
    public static MxCain01500101 parse(String xml) {
        return ((MxCain01500101) MxReadImpl.parse(MxCain01500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01500101) MxReadImpl.parse(MxCain01500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain01500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01500101 .class);
    }
