    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.004.001.03";
    ...
    public static MxCain00400103 parse(String xml) {
        return ((MxCain00400103) MxReadImpl.parse(MxCain00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00400103) MxReadImpl.parse(MxCain00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain00400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00400103 .class);
    }
