...
/**
 * Class for cain.021.001.02 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:cain.021.001.02")
public class MxCain02100102
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "RtrvlInitn", required = true)
    protected RetrievalInitiationV02 rtrvlInitn;
     ...
     * 
     */
    public MxCain02100102(final String xml) {
        this();
        MxCain02100102 tmp = parse(xml);
     ...
     * 
     */
    public MxCain02100102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link RetrievalInitiationV02 }
     *     
     */
    public RetrievalInitiationV02 getRtrvlInitn() {
        return rtrvlInitn;
    }
     ...
     *     
     */
    public MxCain02100102 setRtrvlInitn(RetrievalInitiationV02 value) {
     ...
     * 
     */
    public static MxCain02100102 parse(String xml) {
        return ((MxCain02100102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCain02100102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCain02100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02100102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCain02100102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCain02100102 parse(String xml, MxRead parserImpl) {
        return ((MxCain02100102) parserImpl.read(MxCain02100102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCain02100102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCain02100102 message
     * @return
     *     a new instance of MxCain02100102
     */
    public static final MxCain02100102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCain02100102 .class);
    }
