    ...
    extends AbstractMX
{
    ...
    public static MxCain02100102 parse(String xml) {
        return ((MxCain02100102) MxReadImpl.parse(MxCain02100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02100102) MxReadImpl.parse(MxCain02100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain02100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02100102 .class);
    }
