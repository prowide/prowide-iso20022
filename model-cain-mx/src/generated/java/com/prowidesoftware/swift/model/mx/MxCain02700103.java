    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.027.001.03";
    ...
    public static MxCain02700103 parse(String xml) {
        return ((MxCain02700103) MxReadImpl.parse(MxCain02700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02700103) MxReadImpl.parse(MxCain02700103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain02700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02700103 .class);
    }
