    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.003.001.04";
    ...
    public static MxCain00300104 parse(String xml) {
        return ((MxCain00300104) MxReadImpl.parse(MxCain00300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00300104) MxReadImpl.parse(MxCain00300104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain00300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00300104 .class);
    }
