    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.026.001.01";
    ...
    public static MxCain02600101 parse(String xml) {
        return ((MxCain02600101) MxReadImpl.parse(MxCain02600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02600101) MxReadImpl.parse(MxCain02600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain02600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02600101 .class);
    }
