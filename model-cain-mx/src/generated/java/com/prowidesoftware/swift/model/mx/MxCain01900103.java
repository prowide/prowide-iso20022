    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.019.001.03";
    ...
    public static MxCain01900103 parse(String xml) {
        return ((MxCain01900103) MxReadImpl.parse(MxCain01900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01900103) MxReadImpl.parse(MxCain01900103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain01900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01900103 .class);
    }
