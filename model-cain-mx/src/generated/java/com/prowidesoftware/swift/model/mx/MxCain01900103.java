...
/**
 * Class for cain.019.001.03 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:cain.019.001.03")
public class MxCain01900103
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "VrfctnRspn", required = true)
    protected VerificationResponseV03 vrfctnRspn;
     ...
     * 
     */
    public MxCain01900103(final String xml) {
        this();
        MxCain01900103 tmp = parse(xml);
     ...
     * 
     */
    public MxCain01900103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link VerificationResponseV03 }
     *     
     */
    public VerificationResponseV03 getVrfctnRspn() {
        return vrfctnRspn;
    }
     ...
     *     
     */
    public MxCain01900103 setVrfctnRspn(VerificationResponseV03 value) {
     ...
     * 
     */
    public static MxCain01900103 parse(String xml) {
        return ((MxCain01900103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCain01900103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCain01900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01900103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCain01900103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCain01900103 parse(String xml, MxRead parserImpl) {
        return ((MxCain01900103) parserImpl.read(MxCain01900103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCain01900103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCain01900103 message
     * @return
     *     a new instance of MxCain01900103
     */
    public final static MxCain01900103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCain01900103 .class);
    }
