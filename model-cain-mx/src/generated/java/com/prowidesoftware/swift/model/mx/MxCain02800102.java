    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.028.001.02";
    ...
    public static MxCain02800102 parse(String xml) {
        return ((MxCain02800102) MxReadImpl.parse(MxCain02800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02800102) MxReadImpl.parse(MxCain02800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain02800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02800102 .class);
    }
