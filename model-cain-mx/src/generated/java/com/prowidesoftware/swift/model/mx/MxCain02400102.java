    ...
    extends AbstractMX
{
    ...
    public static MxCain02400102 parse(String xml) {
        return ((MxCain02400102) MxReadImpl.parse(MxCain02400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02400102) MxReadImpl.parse(MxCain02400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain02400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02400102 .class);
    }
