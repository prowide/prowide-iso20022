    ...
    extends AbstractMX
{
    ...
    public static MxCain00400102 parse(String xml) {
        return ((MxCain00400102) MxReadImpl.parse(MxCain00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00400102) MxReadImpl.parse(MxCain00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00400102 .class);
    }
