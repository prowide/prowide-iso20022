    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.003.001.02";
    ...
    public static MxCain00300102 parse(String xml) {
        return ((MxCain00300102) MxReadImpl.parse(MxCain00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain00300102) MxReadImpl.parse(MxCain00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain00300102 .class);
    }
