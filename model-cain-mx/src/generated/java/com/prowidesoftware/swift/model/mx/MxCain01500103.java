    ...
    extends AbstractMX
{
    ...
    public static MxCain01500103 parse(String xml) {
        return ((MxCain01500103) MxReadImpl.parse(MxCain01500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01500103) MxReadImpl.parse(MxCain01500103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain01500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01500103 .class);
    }
