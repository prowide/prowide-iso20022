    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.017.001.03";
    ...
    public static MxCain01700103 parse(String xml) {
        return ((MxCain01700103) MxReadImpl.parse(MxCain01700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01700103) MxReadImpl.parse(MxCain01700103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain01700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01700103 .class);
    }
