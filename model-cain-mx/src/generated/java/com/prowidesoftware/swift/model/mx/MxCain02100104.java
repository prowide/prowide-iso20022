    ...
    extends AbstractMX
{
    ...
    public static MxCain02100104 parse(String xml) {
        return ((MxCain02100104) MxReadImpl.parse(MxCain02100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain02100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain02100104) MxReadImpl.parse(MxCain02100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCain02100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain02100104 .class);
    }
