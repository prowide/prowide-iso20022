    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cain.016.001.03";
    ...
    public static MxCain01600103 parse(String xml) {
        return ((MxCain01600103) MxReadImpl.parse(MxCain01600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCain01600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCain01600103) MxReadImpl.parse(MxCain01600103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCain01600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCain01600103 .class);
    }
