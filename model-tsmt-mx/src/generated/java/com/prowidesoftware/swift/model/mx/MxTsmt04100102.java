    ...
    extends AbstractMX
{
    ...
    public static MxTsmt04100102 parse(String xml) {
        return ((MxTsmt04100102) MxReadImpl.parse(MxTsmt04100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt04100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt04100102) MxReadImpl.parse(MxTsmt04100102 .class, xml, _classes, new MxReadParams(conf)));
    }
