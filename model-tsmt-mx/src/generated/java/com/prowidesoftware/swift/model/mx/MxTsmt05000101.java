    ...
    extends AbstractMX
{
    ...
    public static MxTsmt05000101 parse(String xml) {
        return ((MxTsmt05000101) MxReadImpl.parse(MxTsmt05000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt05000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt05000101) MxReadImpl.parse(MxTsmt05000101 .class, xml, _classes, new MxReadParams(conf)));
    }
