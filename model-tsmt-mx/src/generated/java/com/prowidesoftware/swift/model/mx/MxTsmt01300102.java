    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:tsmt.013.001.02";
    ...
    public static MxTsmt01300102 parse(String xml) {
        return ((MxTsmt01300102) MxReadImpl.parse(MxTsmt01300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01300102) MxReadImpl.parse(MxTsmt01300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt01300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt01300102 .class);
    }
