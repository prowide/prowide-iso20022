    ...
    extends AbstractMX
{
    ...
    public static MxTsmt03600102 parse(String xml) {
        return ((MxTsmt03600102) MxReadImpl.parse(MxTsmt03600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03600102) MxReadImpl.parse(MxTsmt03600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt03600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt03600102 .class);
    }
