    ...
    extends AbstractMX
{
    ...
    public static MxTsmt01200102 parse(String xml) {
        return ((MxTsmt01200102) MxReadImpl.parse(MxTsmt01200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01200102) MxReadImpl.parse(MxTsmt01200102 .class, xml, _classes, new MxReadParams(conf)));
    }
