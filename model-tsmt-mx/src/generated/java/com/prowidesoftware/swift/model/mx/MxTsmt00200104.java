    ...
    extends AbstractMX
{
    ...
    public static MxTsmt00200104 parse(String xml) {
        return ((MxTsmt00200104) MxReadImpl.parse(MxTsmt00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00200104) MxReadImpl.parse(MxTsmt00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
