    ...
    extends AbstractMX
{
    ...
    public static MxTsmt00900105 parse(String xml) {
        return ((MxTsmt00900105) MxReadImpl.parse(MxTsmt00900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00900105) MxReadImpl.parse(MxTsmt00900105 .class, xml, _classes, new MxReadParams(conf)));
    }
