    ...
    extends AbstractMX
{
    ...
    public static MxTsmt01700105 parse(String xml) {
        return ((MxTsmt01700105) MxReadImpl.parse(MxTsmt01700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01700105) MxReadImpl.parse(MxTsmt01700105 .class, xml, _classes, new MxReadParams(conf)));
    }
