    ...
    extends AbstractMX
{
    ...
    public static MxTsmt04700101 parse(String xml) {
        return ((MxTsmt04700101) MxReadImpl.parse(MxTsmt04700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt04700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt04700101) MxReadImpl.parse(MxTsmt04700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt04700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt04700101 .class);
    }
