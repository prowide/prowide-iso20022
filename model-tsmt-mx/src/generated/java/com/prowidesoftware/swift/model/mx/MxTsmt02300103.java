    ...
    extends AbstractMX
{
    ...
    public static MxTsmt02300103 parse(String xml) {
        return ((MxTsmt02300103) MxReadImpl.parse(MxTsmt02300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02300103) MxReadImpl.parse(MxTsmt02300103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt02300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt02300103 .class);
    }
