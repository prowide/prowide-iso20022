    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {BICIdentification1 .class, DateTimePeriodDetails1 .class, MessageIdentification1 .class, MxTsmt00300102 .class, Tsmt00300102 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:tsmt.003.001.02";
    ...
    public static MxTsmt00300102 parse(String xml) {
        return ((MxTsmt00300102) MxReadImpl.parse(MxTsmt00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00300102) MxReadImpl.parse(MxTsmt00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt00300102 .class);
    }
