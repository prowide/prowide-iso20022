    ...
    extends AbstractMX
{
    ...
    public static MxTsmt04800101 parse(String xml) {
        return ((MxTsmt04800101) MxReadImpl.parse(MxTsmt04800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt04800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt04800101) MxReadImpl.parse(MxTsmt04800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt04800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt04800101 .class);
    }
