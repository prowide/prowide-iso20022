    ...
    extends AbstractMX
{
    ...
    public static MxTsmt04000103 parse(String xml) {
        return ((MxTsmt04000103) MxReadImpl.parse(MxTsmt04000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt04000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt04000103) MxReadImpl.parse(MxTsmt04000103 .class, xml, _classes, new MxReadParams(conf)));
    }
