    ...
    extends AbstractMX
{
    ...
    public static MxTsmt03200103 parse(String xml) {
        return ((MxTsmt03200103) MxReadImpl.parse(MxTsmt03200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03200103) MxReadImpl.parse(MxTsmt03200103 .class, xml, _classes, new MxReadParams(conf)));
    }
