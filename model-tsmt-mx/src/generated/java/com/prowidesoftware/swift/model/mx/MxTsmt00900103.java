    ...
    extends AbstractMX
{
    ...
    public static MxTsmt00900103 parse(String xml) {
        return ((MxTsmt00900103) MxReadImpl.parse(MxTsmt00900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00900103) MxReadImpl.parse(MxTsmt00900103 .class, xml, _classes, new MxReadParams(conf)));
    }
