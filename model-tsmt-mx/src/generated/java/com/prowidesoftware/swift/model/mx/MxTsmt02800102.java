    ...
    extends AbstractMX
{
    ...
    public static MxTsmt02800102 parse(String xml) {
        return ((MxTsmt02800102) MxReadImpl.parse(MxTsmt02800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02800102) MxReadImpl.parse(MxTsmt02800102 .class, xml, _classes, new MxReadParams(conf)));
    }
