    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsmt.012.001.05";
    ...
    public static MxTsmt01200105 parse(String xml) {
        return ((MxTsmt01200105) MxReadImpl.parse(MxTsmt01200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01200105) MxReadImpl.parse(MxTsmt01200105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt01200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt01200105 .class);
    }
