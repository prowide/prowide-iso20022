    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsmt.008.001.03";
    ...
    public static MxTsmt00800103 parse(String xml) {
        return ((MxTsmt00800103) MxReadImpl.parse(MxTsmt00800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00800103) MxReadImpl.parse(MxTsmt00800103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt00800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt00800103 .class);
    }
