    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsmt.010.001.03";
    ...
    public static MxTsmt01000103 parse(String xml) {
        return ((MxTsmt01000103) MxReadImpl.parse(MxTsmt01000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01000103) MxReadImpl.parse(MxTsmt01000103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt01000103 fromJson(String json) {
