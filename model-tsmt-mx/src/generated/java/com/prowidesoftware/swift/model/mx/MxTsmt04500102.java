    ...
    extends AbstractMX
{
    ...
    public static MxTsmt04500102 parse(String xml) {
        return ((MxTsmt04500102) MxReadImpl.parse(MxTsmt04500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt04500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt04500102) MxReadImpl.parse(MxTsmt04500102 .class, xml, _classes, new MxReadParams(conf)));
    }
