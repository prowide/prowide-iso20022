    ...
    extends AbstractMX
{
    ...
    public static MxTsmt00600103 parse(String xml) {
        return ((MxTsmt00600103) MxReadImpl.parse(MxTsmt00600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00600103) MxReadImpl.parse(MxTsmt00600103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt00600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt00600103 .class);
    }
