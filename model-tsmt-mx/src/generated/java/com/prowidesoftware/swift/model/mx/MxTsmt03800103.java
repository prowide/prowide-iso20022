    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {BICIdentification1 .class, MessageIdentification1 .class, MxTsmt03800103 .class, StatusReportRequestV03 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsmt.038.001.03";
    ...
    public static MxTsmt03800103 parse(String xml) {
        return ((MxTsmt03800103) MxReadImpl.parse(MxTsmt03800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03800103) MxReadImpl.parse(MxTsmt03800103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt03800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt03800103 .class);
    }
