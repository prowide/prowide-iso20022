    ...
    extends AbstractMX
{
    ...
    public static MxTsmt01800105 parse(String xml) {
        return ((MxTsmt01800105) MxReadImpl.parse(MxTsmt01800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01800105) MxReadImpl.parse(MxTsmt01800105 .class, xml, _classes, new MxReadParams(conf)));
    }
