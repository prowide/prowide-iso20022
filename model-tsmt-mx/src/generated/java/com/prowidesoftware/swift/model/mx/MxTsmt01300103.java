    ...
    extends AbstractMX
{
    ...
    public static MxTsmt01300103 parse(String xml) {
        return ((MxTsmt01300103) MxReadImpl.parse(MxTsmt01300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01300103) MxReadImpl.parse(MxTsmt01300103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt01300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt01300103 .class);
    }
