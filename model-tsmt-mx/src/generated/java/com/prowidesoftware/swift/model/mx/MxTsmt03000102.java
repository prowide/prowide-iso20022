    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:tsmt.030.001.02";
    ...
    public static MxTsmt03000102 parse(String xml) {
        return ((MxTsmt03000102) MxReadImpl.parse(MxTsmt03000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03000102) MxReadImpl.parse(MxTsmt03000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt03000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt03000102 .class);
    }
