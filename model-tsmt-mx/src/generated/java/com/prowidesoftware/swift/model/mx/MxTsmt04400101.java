    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.01";
    ...
    public static MxTsmt04400101 parse(String xml) {
        return ((MxTsmt04400101) MxReadImpl.parse(MxTsmt04400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt04400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt04400101) MxReadImpl.parse(MxTsmt04400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt04400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt04400101 .class);
    }
