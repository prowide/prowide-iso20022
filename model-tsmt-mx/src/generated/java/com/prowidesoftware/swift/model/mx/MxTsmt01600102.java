    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:tsmt.016.001.02";
    ...
    public static MxTsmt01600102 parse(String xml) {
        return ((MxTsmt01600102) MxReadImpl.parse(MxTsmt01600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01600102) MxReadImpl.parse(MxTsmt01600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt01600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt01600102 .class);
    }
