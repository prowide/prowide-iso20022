    ...
    extends AbstractMX
{
    ...
    public static MxTsmt00700102 parse(String xml) {
        return ((MxTsmt00700102) MxReadImpl.parse(MxTsmt00700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00700102) MxReadImpl.parse(MxTsmt00700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt00700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt00700102 .class);
    }
