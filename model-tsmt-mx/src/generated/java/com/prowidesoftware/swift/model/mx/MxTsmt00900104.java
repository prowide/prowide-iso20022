    ...
    extends AbstractMX
{
    ...
    public static MxTsmt00900104 parse(String xml) {
        return ((MxTsmt00900104) MxReadImpl.parse(MxTsmt00900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00900104) MxReadImpl.parse(MxTsmt00900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt00900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt00900104 .class);
    }
