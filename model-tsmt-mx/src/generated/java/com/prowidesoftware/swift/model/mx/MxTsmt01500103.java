    ...
    extends AbstractMX
{
    ...
    public static MxTsmt01500103 parse(String xml) {
        return ((MxTsmt01500103) MxReadImpl.parse(MxTsmt01500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01500103) MxReadImpl.parse(MxTsmt01500103 .class, xml, _classes, new MxReadParams(conf)));
    }
