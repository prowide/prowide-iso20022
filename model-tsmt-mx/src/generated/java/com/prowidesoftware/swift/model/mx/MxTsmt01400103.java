    ...
    extends AbstractMX
{
    ...
    public static MxTsmt01400103 parse(String xml) {
        return ((MxTsmt01400103) MxReadImpl.parse(MxTsmt01400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01400103) MxReadImpl.parse(MxTsmt01400103 .class, xml, _classes, new MxReadParams(conf)));
    }
