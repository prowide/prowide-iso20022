    ...
    extends AbstractMX
{
    ...
    public static MxTsmt04200102 parse(String xml) {
        return ((MxTsmt04200102) MxReadImpl.parse(MxTsmt04200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt04200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt04200102) MxReadImpl.parse(MxTsmt04200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt04200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt04200102 .class);
    }
