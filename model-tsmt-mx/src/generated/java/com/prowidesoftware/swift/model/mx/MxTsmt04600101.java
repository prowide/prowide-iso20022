    ...
    extends AbstractMX
{
    ...
    public static MxTsmt04600101 parse(String xml) {
        return ((MxTsmt04600101) MxReadImpl.parse(MxTsmt04600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt04600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt04600101) MxReadImpl.parse(MxTsmt04600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt04600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt04600101 .class);
    }
