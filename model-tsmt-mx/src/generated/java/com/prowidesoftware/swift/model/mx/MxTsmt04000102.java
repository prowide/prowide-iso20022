    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:tsmt.040.001.02";
    ...
    public static MxTsmt04000102 parse(String xml) {
        return ((MxTsmt04000102) MxReadImpl.parse(MxTsmt04000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt04000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt04000102) MxReadImpl.parse(MxTsmt04000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt04000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt04000102 .class);
    }
