    ...
    extends AbstractMX
{
    ...
    public static MxTsmt03600103 parse(String xml) {
        return ((MxTsmt03600103) MxReadImpl.parse(MxTsmt03600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03600103) MxReadImpl.parse(MxTsmt03600103 .class, xml, _classes, new MxReadParams(conf)));
    }
