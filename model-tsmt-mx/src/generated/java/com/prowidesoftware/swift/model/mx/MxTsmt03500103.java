    ...
    extends AbstractMX
{
    ...
    public static MxTsmt03500103 parse(String xml) {
        return ((MxTsmt03500103) MxReadImpl.parse(MxTsmt03500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03500103) MxReadImpl.parse(MxTsmt03500103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt03500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt03500103 .class);
    }
