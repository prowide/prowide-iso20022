    ...
    extends AbstractMX
{
    ...
    public static MxTsmt04200103 parse(String xml) {
        return ((MxTsmt04200103) MxReadImpl.parse(MxTsmt04200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt04200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt04200103) MxReadImpl.parse(MxTsmt04200103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt04200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt04200103 .class);
    }
