    ...
    extends AbstractMX
{
    ...
    public static MxTsmt00100102 parse(String xml) {
        return ((MxTsmt00100102) MxReadImpl.parse(MxTsmt00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00100102) MxReadImpl.parse(MxTsmt00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
