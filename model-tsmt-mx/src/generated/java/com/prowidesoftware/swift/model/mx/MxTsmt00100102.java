    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:tsmt.001.001.02";
    ...
    public static MxTsmt00100102 parse(String xml) {
        return ((MxTsmt00100102) MxReadImpl.parse(MxTsmt00100102 .class, xml, _classes));
    }
     ...
     */
    public final static MxTsmt00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt00100102 .class);
    }
