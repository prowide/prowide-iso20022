    ...
    extends AbstractMX
{
    ...
    public static MxTsmt02000101 parse(String xml) {
        return ((MxTsmt02000101) MxReadImpl.parse(MxTsmt02000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02000101) MxReadImpl.parse(MxTsmt02000101 .class, xml, _classes, new MxReadParams(conf)));
    }
