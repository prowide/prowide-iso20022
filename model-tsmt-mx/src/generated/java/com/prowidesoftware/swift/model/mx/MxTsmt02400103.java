    ...
    extends AbstractMX
{
    ...
    public static MxTsmt02400103 parse(String xml) {
        return ((MxTsmt02400103) MxReadImpl.parse(MxTsmt02400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02400103) MxReadImpl.parse(MxTsmt02400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt02400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt02400103 .class);
    }
