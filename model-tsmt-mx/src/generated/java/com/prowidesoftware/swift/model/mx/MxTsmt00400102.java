    ...
    extends AbstractMX
{
    ...
    public static MxTsmt00400102 parse(String xml) {
        return ((MxTsmt00400102) MxReadImpl.parse(MxTsmt00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00400102) MxReadImpl.parse(MxTsmt00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt00400102 .class);
    }
