    ...
    extends AbstractMX
{
    ...
    public static MxTsmt00400101 parse(String xml) {
        return ((MxTsmt00400101) MxReadImpl.parse(MxTsmt00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00400101) MxReadImpl.parse(MxTsmt00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
