    ...
    extends AbstractMX
{
    ...
    public static MxTsmt00300103 parse(String xml) {
        return ((MxTsmt00300103) MxReadImpl.parse(MxTsmt00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00300103) MxReadImpl.parse(MxTsmt00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt00300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt00300103 .class);
    }
