    ...
    extends AbstractMX
{
    ...
    public static MxTsmt03500102 parse(String xml) {
        return ((MxTsmt03500102) MxReadImpl.parse(MxTsmt03500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03500102) MxReadImpl.parse(MxTsmt03500102 .class, xml, _classes, new MxReadParams(conf)));
    }
