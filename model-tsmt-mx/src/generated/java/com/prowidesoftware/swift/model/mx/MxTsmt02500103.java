    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsmt.025.001.03";
    ...
    public static MxTsmt02500103 parse(String xml) {
        return ((MxTsmt02500103) MxReadImpl.parse(MxTsmt02500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02500103) MxReadImpl.parse(MxTsmt02500103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt02500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt02500103 .class);
    }
