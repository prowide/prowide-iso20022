    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsmt.041.001.03";
    ...
    public static MxTsmt04100103 parse(String xml) {
        return ((MxTsmt04100103) MxReadImpl.parse(MxTsmt04100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt04100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt04100103) MxReadImpl.parse(MxTsmt04100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt04100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt04100103 .class);
    }
