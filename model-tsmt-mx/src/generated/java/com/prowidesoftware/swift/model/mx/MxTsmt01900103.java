    ...
    extends AbstractMX
{
    ...
    public static MxTsmt01900103 parse(String xml) {
        return ((MxTsmt01900103) MxReadImpl.parse(MxTsmt01900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01900103) MxReadImpl.parse(MxTsmt01900103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt01900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt01900103 .class);
    }
