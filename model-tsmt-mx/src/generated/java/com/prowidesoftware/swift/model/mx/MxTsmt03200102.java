    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:tsmt.032.001.02";
    ...
    public static MxTsmt03200102 parse(String xml) {
        return ((MxTsmt03200102) MxReadImpl.parse(MxTsmt03200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03200102) MxReadImpl.parse(MxTsmt03200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt03200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt03200102 .class);
    }
