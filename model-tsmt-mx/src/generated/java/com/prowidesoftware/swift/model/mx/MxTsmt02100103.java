    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsmt.021.001.03";
    ...
    public static MxTsmt02100103 parse(String xml) {
        return ((MxTsmt02100103) MxReadImpl.parse(MxTsmt02100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02100103) MxReadImpl.parse(MxTsmt02100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt02100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt02100103 .class);
    }
