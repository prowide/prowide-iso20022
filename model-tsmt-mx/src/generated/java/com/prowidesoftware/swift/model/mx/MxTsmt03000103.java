    ...
    extends AbstractMX
{
    ...
    public static MxTsmt03000103 parse(String xml) {
        return ((MxTsmt03000103) MxReadImpl.parse(MxTsmt03000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03000103) MxReadImpl.parse(MxTsmt03000103 .class, xml, _classes, new MxReadParams(conf)));
    }
