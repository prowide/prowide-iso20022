    ...
    extends AbstractMX
{
    ...
    public static MxTsmt01400104 parse(String xml) {
        return ((MxTsmt01400104) MxReadImpl.parse(MxTsmt01400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01400104) MxReadImpl.parse(MxTsmt01400104 .class, xml, _classes, new MxReadParams(conf)));
    }
