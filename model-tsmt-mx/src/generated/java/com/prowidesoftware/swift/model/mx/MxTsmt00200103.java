    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Action2Code.class, Activity1 .class, ActivityDetails1 .class, ActivityReportItems2 .class, ActivityReportV03 .class, BICIdentification1 .class, DocumentIdentification5 .class, MessageIdentification1 .class, MxTsmt00200103 .class, PendingActivity2 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsmt.002.001.03";
    ...
    public static MxTsmt00200103 parse(String xml) {
        return ((MxTsmt00200103) MxReadImpl.parse(MxTsmt00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00200103) MxReadImpl.parse(MxTsmt00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt00200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt00200103 .class);
    }
