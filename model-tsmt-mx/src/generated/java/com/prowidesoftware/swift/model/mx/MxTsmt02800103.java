    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsmt.028.001.03";
    ...
    public static MxTsmt02800103 parse(String xml) {
        return ((MxTsmt02800103) MxReadImpl.parse(MxTsmt02800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02800103) MxReadImpl.parse(MxTsmt02800103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt02800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt02800103 .class);
    }
