    ...
    extends AbstractMX
{
    ...
    public static MxTsmt00800102 parse(String xml) {
        return ((MxTsmt00800102) MxReadImpl.parse(MxTsmt00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00800102) MxReadImpl.parse(MxTsmt00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
