...
/**
 * Class for tsmt.039.001.02 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:swift:xsd:tsmt.039.001.02")
public class MxTsmt03900102
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxTsmt03900102(final String xml) {
        this();
        MxTsmt03900102 tmp = parse(xml);
        tsmt03900102 = tmp.getTsmt03900102();
    }
    ...
    /**
     * Gets the value of the tsmt03900102 property.
     * 
     * @return
     *     possible object is
     *     {@link Tsmt03900102 }
     *     
     */
    public Tsmt03900102 getTsmt03900102() {
        return tsmt03900102;
    }

    /**
     * Sets the value of the tsmt03900102 property.
     * 
     * @param value
     *     allowed object is
     *     {@link Tsmt03900102 }
     ...
     * 
     */
    public static MxTsmt03900102 parse(String xml) {
        return ((MxTsmt03900102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTsmt03900102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxTsmt03900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03900102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTsmt03900102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxTsmt03900102 parse(String xml, MxRead parserImpl) {
        return ((MxTsmt03900102) parserImpl.read(MxTsmt03900102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxTsmt03900102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxTsmt03900102 message
     * @return
