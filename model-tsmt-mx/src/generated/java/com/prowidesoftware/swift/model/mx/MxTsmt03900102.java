    ...
    extends AbstractMX
{
    ...
    public static MxTsmt03900102 parse(String xml) {
        return ((MxTsmt03900102) MxReadImpl.parse(MxTsmt03900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03900102) MxReadImpl.parse(MxTsmt03900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt03900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt03900102 .class);
    }
