    ...
    extends AbstractMX
{
    ...
    public static MxTsmt05100101 parse(String xml) {
        return ((MxTsmt05100101) MxReadImpl.parse(MxTsmt05100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt05100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt05100101) MxReadImpl.parse(MxTsmt05100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt05100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt05100101 .class);
    }
