    ...
    extends AbstractMX
{
    ...
    public static MxTsmt02900102 parse(String xml) {
        return ((MxTsmt02900102) MxReadImpl.parse(MxTsmt02900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02900102) MxReadImpl.parse(MxTsmt02900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt02900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt02900102 .class);
    }
