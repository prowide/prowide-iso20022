    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:tsmt.025.001.02";
    ...
    public static MxTsmt02500102 parse(String xml) {
        return ((MxTsmt02500102) MxReadImpl.parse(MxTsmt02500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02500102) MxReadImpl.parse(MxTsmt02500102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt02500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt02500102 .class);
    }
