    ...
    extends AbstractMX
{
    ...
    public static MxTsmt02600102 parse(String xml) {
        return ((MxTsmt02600102) MxReadImpl.parse(MxTsmt02600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02600102) MxReadImpl.parse(MxTsmt02600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt02600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt02600102 .class);
    }
