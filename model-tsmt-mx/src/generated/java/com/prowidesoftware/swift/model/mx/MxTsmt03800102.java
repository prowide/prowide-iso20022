    ...
    extends AbstractMX
{
    ...
    public static MxTsmt03800102 parse(String xml) {
        return ((MxTsmt03800102) MxReadImpl.parse(MxTsmt03800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03800102) MxReadImpl.parse(MxTsmt03800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt03800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt03800102 .class);
    }
