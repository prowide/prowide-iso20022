    ...
    extends AbstractMX
{
    ...
    public static MxTsmt01800103 parse(String xml) {
        return ((MxTsmt01800103) MxReadImpl.parse(MxTsmt01800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01800103) MxReadImpl.parse(MxTsmt01800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt01800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt01800103 .class);
    }
