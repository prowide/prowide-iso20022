    ...
    extends AbstractMX
{
    ...
    public static MxTsmt01500102 parse(String xml) {
        return ((MxTsmt01500102) MxReadImpl.parse(MxTsmt01500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01500102) MxReadImpl.parse(MxTsmt01500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt01500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt01500102 .class);
    }
