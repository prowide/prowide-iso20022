    ...
    extends AbstractMX
{
    ...
    public static MxTsmt02200101 parse(String xml) {
        return ((MxTsmt02200101) MxReadImpl.parse(MxTsmt02200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02200101) MxReadImpl.parse(MxTsmt02200101 .class, xml, _classes, new MxReadParams(conf)));
    }
