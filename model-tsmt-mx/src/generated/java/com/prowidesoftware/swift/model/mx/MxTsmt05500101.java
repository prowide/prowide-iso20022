    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsmt.055.001.01";
    ...
    public static MxTsmt05500101 parse(String xml) {
        return ((MxTsmt05500101) MxReadImpl.parse(MxTsmt05500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt05500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt05500101) MxReadImpl.parse(MxTsmt05500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt05500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt05500101 .class);
    }
