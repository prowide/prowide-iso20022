    ...
    extends AbstractMX
{
    ...
    public static MxTsmt05400101 parse(String xml) {
        return ((MxTsmt05400101) MxReadImpl.parse(MxTsmt05400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt05400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt05400101) MxReadImpl.parse(MxTsmt05400101 .class, xml, _classes, new MxReadParams(conf)));
    }
