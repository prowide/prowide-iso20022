    ...
    extends AbstractMX
{
    ...
    public static MxTsmt03400102 parse(String xml) {
        return ((MxTsmt03400102) MxReadImpl.parse(MxTsmt03400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03400102) MxReadImpl.parse(MxTsmt03400102 .class, xml, _classes, new MxReadParams(conf)));
    }
