    ...
    extends AbstractMX
{
    ...
    public static MxTsmt05200101 parse(String xml) {
        return ((MxTsmt05200101) MxReadImpl.parse(MxTsmt05200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt05200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt05200101) MxReadImpl.parse(MxTsmt05200101 .class, xml, _classes, new MxReadParams(conf)));
    }
