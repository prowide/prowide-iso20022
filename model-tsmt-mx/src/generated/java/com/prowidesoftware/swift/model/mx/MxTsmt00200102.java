    ...
    extends AbstractMX
{
    ...
    public static MxTsmt00200102 parse(String xml) {
        return ((MxTsmt00200102) MxReadImpl.parse(MxTsmt00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00200102) MxReadImpl.parse(MxTsmt00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
