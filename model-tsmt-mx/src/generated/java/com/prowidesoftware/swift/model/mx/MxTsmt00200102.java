    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Action1Code.class, Activity1 .class, ActivityDetails1 .class, ActivityReportItems1 .class, BICIdentification1 .class, DocumentIdentification5 .class, MessageIdentification1 .class, MxTsmt00200102 .class, PendingActivity1 .class, Tsmt00200102 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:tsmt.002.001.02";
    ...
    public static MxTsmt00200102 parse(String xml) {
        return ((MxTsmt00200102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTsmt00200102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxTsmt00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00200102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTsmt00200102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt00200102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxTsmt00200102 .class);
    }
