    ...
    extends AbstractMX
{
    ...
    public static MxTsmt00700101 parse(String xml) {
        return ((MxTsmt00700101) MxReadImpl.parse(MxTsmt00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00700101) MxReadImpl.parse(MxTsmt00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt00700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt00700101 .class);
    }
