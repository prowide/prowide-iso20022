    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01";
    ...
    public static MxTsmt05300101 parse(String xml) {
        return ((MxTsmt05300101) MxReadImpl.parse(MxTsmt05300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt05300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt05300101) MxReadImpl.parse(MxTsmt05300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt05300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt05300101 .class);
    }
