    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {BICIdentification1 .class, BaselineStatus2Code.class, DocumentIdentification5 .class, MessageIdentification1 .class, MxTsmt02700101 .class, SimpleIdentificationInformation.class, TransactionStatus3 .class, Tsmt02700101 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:tsmt.027.001.01";
    ...
    public static MxTsmt02700101 parse(String xml) {
        return ((MxTsmt02700101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTsmt02700101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxTsmt02700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02700101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTsmt02700101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt02700101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxTsmt02700101 .class);
    }
