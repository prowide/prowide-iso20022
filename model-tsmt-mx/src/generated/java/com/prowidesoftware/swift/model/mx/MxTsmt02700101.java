    ...
    extends AbstractMX
{
    ...
    public static MxTsmt02700101 parse(String xml) {
        return ((MxTsmt02700101) MxReadImpl.parse(MxTsmt02700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02700101) MxReadImpl.parse(MxTsmt02700101 .class, xml, _classes, new MxReadParams(conf)));
    }
