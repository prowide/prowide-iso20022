    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {BICIdentification1 .class, BaselineStatus1Code.class, MessageIdentification1 .class, MxTsmt03700102 .class, StatusReportItems1 .class, Tsmt03700102 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:tsmt.037.001.02";
    ...
    public static MxTsmt03700102 parse(String xml) {
        return ((MxTsmt03700102) MxReadImpl.parse(MxTsmt03700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03700102) MxReadImpl.parse(MxTsmt03700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt03700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt03700102 .class);
    }
