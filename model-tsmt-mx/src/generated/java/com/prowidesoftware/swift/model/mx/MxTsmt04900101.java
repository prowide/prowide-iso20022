    ...
    extends AbstractMX
{
    ...
    public static MxTsmt04900101 parse(String xml) {
        return ((MxTsmt04900101) MxReadImpl.parse(MxTsmt04900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt04900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt04900101) MxReadImpl.parse(MxTsmt04900101 .class, xml, _classes, new MxReadParams(conf)));
    }
