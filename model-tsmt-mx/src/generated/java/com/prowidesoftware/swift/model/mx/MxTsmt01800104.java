    ...
    extends AbstractMX
{
    ...
    public static MxTsmt01800104 parse(String xml) {
        return ((MxTsmt01800104) MxReadImpl.parse(MxTsmt01800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01800104) MxReadImpl.parse(MxTsmt01800104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt01800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt01800104 .class);
    }
