    ...
    extends AbstractMX
{
    ...
    public static MxTsmt02900101 parse(String xml) {
        return ((MxTsmt02900101) MxReadImpl.parse(MxTsmt02900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02900101) MxReadImpl.parse(MxTsmt02900101 .class, xml, _classes, new MxReadParams(conf)));
    }
