    ...
    extends AbstractMX
{
    ...
    public final static transient Class[] _classes = new Class[] {BICIdentification1 .class, BaselineStatus2Code.class, DocumentIdentification5 .class, MessageIdentification1 .class, MxTsmt02900101 .class, Reason2 .class, SimpleIdentificationInformation.class, TransactionStatus3 .class, Tsmt02900101 .class };
    public final static transient String NAMESPACE = "urn:swift:xsd:tsmt.029.001.01";
    ...
    public static MxTsmt02900101 parse(String xml) {
        return ((MxTsmt02900101) MxReadImpl.parse(MxTsmt02900101 .class, xml, _classes));
    }
     ...
     */
    public final static MxTsmt02900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt02900101 .class);
    }
