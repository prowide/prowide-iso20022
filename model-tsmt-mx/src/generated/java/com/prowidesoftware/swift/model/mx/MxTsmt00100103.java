    ...
    extends AbstractMX
{
    ...
    public static MxTsmt00100103 parse(String xml) {
        return ((MxTsmt00100103) MxReadImpl.parse(MxTsmt00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt00100103) MxReadImpl.parse(MxTsmt00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt00100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt00100103 .class);
    }
