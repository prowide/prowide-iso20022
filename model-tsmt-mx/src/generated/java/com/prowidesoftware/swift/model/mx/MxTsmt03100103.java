    ...
    extends AbstractMX
{
    ...
    public static MxTsmt03100103 parse(String xml) {
        return ((MxTsmt03100103) MxReadImpl.parse(MxTsmt03100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03100103) MxReadImpl.parse(MxTsmt03100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt03100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt03100103 .class);
    }
