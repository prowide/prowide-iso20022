    ...
    extends AbstractMX
{
    ...
    public static MxTsmt03700103 parse(String xml) {
        return ((MxTsmt03700103) MxReadImpl.parse(MxTsmt03700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt03700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt03700103) MxReadImpl.parse(MxTsmt03700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt03700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt03700103 .class);
    }
