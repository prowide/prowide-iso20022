    ...
    extends AbstractMX
{
    ...
    public static MxTsmt04500101 parse(String xml) {
        return ((MxTsmt04500101) MxReadImpl.parse(MxTsmt04500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt04500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt04500101) MxReadImpl.parse(MxTsmt04500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt04500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt04500101 .class);
    }
