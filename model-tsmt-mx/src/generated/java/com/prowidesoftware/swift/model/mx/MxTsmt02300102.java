    ...
    extends AbstractMX
{
    ...
    public static MxTsmt02300102 parse(String xml) {
        return ((MxTsmt02300102) MxReadImpl.parse(MxTsmt02300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02300102) MxReadImpl.parse(MxTsmt02300102 .class, xml, _classes, new MxReadParams(conf)));
    }
