    ...
    extends AbstractMX
{
    ...
    public static MxTsmt01100102 parse(String xml) {
        return ((MxTsmt01100102) MxReadImpl.parse(MxTsmt01100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt01100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt01100102) MxReadImpl.parse(MxTsmt01100102 .class, xml, _classes, new MxReadParams(conf)));
    }
