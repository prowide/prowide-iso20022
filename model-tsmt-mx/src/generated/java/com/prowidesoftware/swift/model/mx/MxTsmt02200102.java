    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {MessageIdentification1 .class, MisMatchRejectionV02 .class, MxTsmt02200102 .class, Reason2 .class, RejectedElement1 .class, RejectionReason1Choice.class, SimpleIdentificationInformation.class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsmt.022.001.02";
    ...
    public static MxTsmt02200102 parse(String xml) {
        return ((MxTsmt02200102) MxReadImpl.parse(MxTsmt02200102 .class, xml, _classes, new MxReadParams()));
    }
     ...
     * 
     */
    public static MxTsmt02200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02200102) MxReadImpl.parse(MxTsmt02200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsmt02200102 fromJson(String json) {
