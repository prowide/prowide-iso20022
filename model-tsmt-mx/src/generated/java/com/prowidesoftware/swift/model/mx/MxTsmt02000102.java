    ...
    extends AbstractMX
{
    ...
    public static MxTsmt02000102 parse(String xml) {
        return ((MxTsmt02000102) MxReadImpl.parse(MxTsmt02000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsmt02000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsmt02000102) MxReadImpl.parse(MxTsmt02000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsmt02000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsmt02000102 .class);
    }
