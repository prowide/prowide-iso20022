...
class SupplementaryDataUtilsTest {
    ...
    final String customerXml =
            "<Document xmlns=\"urn:iso:std:iso:20022:tech:xsd:seev.031.002.11\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">"
                    + "  <CorpActnNtfctn>"
                    + "    <NtfctnGnlInf>"
    ...
    void testExtractSingleSplmtryData() {
        ...
        assertEquals(
                "<?xml version=\"1.0\" encoding=\"UTF-8\"?><SplmtryData><Data1>Value1</Data1></SplmtryData>",
                extractedData.get(0));
    }
    ...
    void testExtractMultipleSplmtryData() {
        String xmlData =
                "<root><SplmtryData><Data1>Value1</Data1></SplmtryData><SplmtryData><Data2>Value2</Data2></SplmtryData></root>";
        List<String> extractedData = SupplementaryDataUtils.extract(xmlData);
    ...
    void testExtractNestedSplmtryData() {
        String xmlData =
                "<root><SplmtryData><Data1>Value1</Data1><SplmtryData><Data2>Value2</Data2></SplmtryData></SplmtryData></root>";
        List<String> extractedData = SupplementaryDataUtils.extract(xmlData);
        assertEquals(2, extractedData.size());
        assertTrue(extractedData.get(0).contains("<SplmtryData><Data1>Value1</Data1></SplmtryData>"));
        assertTrue(extractedData.get(1).contains("<SplmtryData><Data2>Value2</Data2></SplmtryData>"));
