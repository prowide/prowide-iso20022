...
public class BusinessAppHdrV01Test {
    ...
    public void testParseNoPrefix() {
        final String xml = "<AppHdr xmlns=\"urn:iso:std:iso:20022:tech:xsd:head.001.001.01\">" + "   <Fr>"
                + "      <FIId>"
                + "         <FinInstnId>"
                + "            <Nm>Not available</Nm>"
                + "         </FinInstnId>"
    ...
    public void testParseWithWrapper() {
        final String xml = "<foo><bar>" + "<AppHdr xmlns=\"urn:iso:std:iso:20022:tech:xsd:head.001.001.01\">"
                + "   <Fr>"
                + "      <FIId>"
                + "         <FinInstnId>"
                + "            <Nm>Not available</Nm>"
