...
public class Jira1392 {
    ...
    public void testQuoteCharacter() {
        ...
        mx.getFIToFICstmrCdtTrf().getGrpHdr().getSttlmInf().setInstdRmbrsmntAgt(new BranchAndFinancialInstitutionIdentification6());
        mx.getFIToFICstmrCdtTrf().getGrpHdr().getSttlmInf().getInstdRmbrsmntAgt().setFinInstnId(new FinancialInstitutionIdentification18());
        mx.getFIToFICstmrCdtTrf().getGrpHdr().getSttlmInf().getInstdRmbrsmntAgt().getFinInstnId().setNm("FOO\"BAR");
