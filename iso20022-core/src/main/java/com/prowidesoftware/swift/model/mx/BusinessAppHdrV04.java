...
/**
 * ISO 20022 business application header version 4 usually known by its namespace head.001.001.04
 *
 * @since 9.5.3
 */
...
public class BusinessAppHdrV04 extends BusinessApplicationHeaderV04Impl implements AppHdr {
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:head.001.001.04";
    static final transient Class[] _classes;
    private static final transient Logger log = Logger.getLogger(BusinessAppHdrV04.class.getName());

    static {
        _classes = Arrays.copyOf(
                BusinessApplicationHeaderV04Impl._classes, BusinessApplicationHeaderV04Impl._classes.length + 1);
        _classes[_classes.length - 1] = BusinessAppHdrV04.class;
    }
     ...
     */
    public static BusinessAppHdrV04 parse(final String xml) {
     ...
     * @throws ProwideException if severe errors occur during parse
     */
    public static BusinessAppHdrV04 parse(final String xml, final MxReadParams params) {
        Objects.requireNonNull(params, "The unmarshalling params cannot be null");
        return (BusinessAppHdrV04) MxParseUtils.parse(BusinessAppHdrV04.class, xml, _classes, HEADER_LOCALNAME, params);
    }
     ...
     * <ol>
     * 	<li>BusinessApplicationHeaderV04/Fr/FIId/FinInstnId/BICFI</li>
     *  <li>BusinessApplicationHeaderV04/Fr/OrgId/Id/OrgId/Id/AnyBIC</li>
     * </ol>
     *
     ...
     * <ol>
     * 	<li>BusinessApplicationHeaderV04/To/FIId/FinInstnId/BICFI</li>
     *  <li>BusinessApplicationHeaderV04/To/OrgId/Id/OrgId/Id/AnyBIC</li>
     * </ol>
     *
     * @return found BIC or null if not present or cannot be parsed
     */
    ...
    private String getBIC(final Party51Choice p) {
        try {
