...
public class DemandRefusalNotificationV01 {
     ...
     * This is why there is not a {@code set} method for the dmndRfslNtfctnDtls property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the dmndRfslNtfctnDtls property.
     */
    public List<DemandRefusal1> getDmndRfslNtfctnDtls() {
        if (dmndRfslNtfctnDtls == null) {
            dmndRfslNtfctnDtls = new ArrayList<>();
        }
