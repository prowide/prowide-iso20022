...
@XmlType(name = "Instruction9", propOrder = {
    "snglInstrId",
    "reqdExctnDt",
    "voteExctnConf",
    "acctDtls",
...
public class Instruction9 {
    ...
    protected SafekeepingAccount20 acctDtls;
    @XmlElement(name = "Prxy")
    protected Proxy12 prxy;
    @XmlElement(name = "VoteDtls")
    protected VoteDetails7 voteDtls;
    ...
    @XmlElement(name = "AddtlDsclsrInf")
    protected List<PartyIdentification338> addtlDsclsrInf;
     ...
     *     
     */
    public Instruction9 setSnglInstrId(String value) {
     ...
     *     
     */
    public Instruction9 setReqdExctnDt(OffsetDateTime value) {
     ...
     * 
     */
    public Instruction9 setVoteExctnConf(boolean value) {
     ...
     * @return
     *     possible object is
     *     {@link SafekeepingAccount20 }
     *     
     */
    public SafekeepingAccount20 getAcctDtls() {
        return acctDtls;
    }
     ...
     *     
     */
    public Instruction9 setAcctDtls(SafekeepingAccount20 value) {
        this.acctDtls = value;
        return this;
    }
     ...
     *     
     */
    public Instruction9 setPrxy(Proxy12 value) {
        this.prxy = value;
        return this;
    }
     ...
     *     
     */
    public VoteDetails7 getVoteDtls() {
        return voteDtls;
    }
     ...
     *     
     */
    public Instruction9 setVoteDtls(VoteDetails7 value) {
        this.voteDtls = value;
        return this;
    }
     ...
     *     
     */
    public Instruction9 setSpcfcInstrReq(SpecificInstructionRequest4 value) {
        this.spcfcInstrReq = value;
        return this;
    }

    /**
     * Gets the value of the addtlDsclsrInf property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the addtlDsclsrInf property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAddtlDsclsrInf().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartyIdentification338 }
     * 
     * 
     * @return
     *     The value of the addtlDsclsrInf property.
     */
    public List<PartyIdentification338> getAddtlDsclsrInf() {
        if (addtlDsclsrInf == null) {
            addtlDsclsrInf = new ArrayList<>();
        }
        return this.addtlDsclsrInf;
    }
     ...
     * 
     */
    public Instruction9 addMtgAttndee(IndividualPerson41 mtgAttndee) {
        getMtgAttndee().add(mtgAttndee);
        return this;
    }

    /**
     * Adds a new item to the addtlDsclsrInf list.
     * @see #getAddtlDsclsrInf()
     * 
     */
    public Instruction9 addAddtlDsclsrInf(PartyIdentification338 addtlDsclsrInf) {
        getAddtlDsclsrInf().add(addtlDsclsrInf);
        return this;
    }
