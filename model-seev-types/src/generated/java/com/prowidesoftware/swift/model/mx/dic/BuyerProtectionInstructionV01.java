...
/**
 * Scope
 * The BuyeProtectionInstruction message is sent by an account owner to an account servicer to instruct a buyer protection on a pending settlement instruction.
 * 
 * Usage
...
@XmlType(name = "BuyerProtectionInstructionV01", propOrder = {
    "corpActnGnlInf",
    "rltdSttlmInstr",
    "acctId",
    "corpActnElctn",
...
public class BuyerProtectionInstructionV01 {
     ...
     *     
     */
    public BuyerProtectionInstructionV01 setCorpActnGnlInf(CorporateActionGeneralInformation195 value) {
     ...
     *     
     */
    public BuyerProtectionInstructionV01 setRltdSttlmInstr(RelatedSettlementInstruction3 value) {
     ...
     *     
     */
    public BuyerProtectionInstructionV01 setAcctId(SecuritiesAccountIdentification1Choice value) {
        this.acctId = value;
        return this;
    }
     ...
     *     
     */
    public BuyerProtectionInstructionV01 setCorpActnElctn(CorporateActionElection4 value) {
     ...
     * 
     */
    public BuyerProtectionInstructionV01 addSplmtryData(SupplementaryData1 splmtryData) {
