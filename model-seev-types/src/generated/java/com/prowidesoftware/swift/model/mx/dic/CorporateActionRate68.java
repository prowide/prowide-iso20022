...
@XmlType(name = "CorporateActionRate68", propOrder = {
    "addtlTax",
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
...
public class CorporateActionRate68 {
     ...
     *     
     */
    public CorporateActionRate68 setAddtlTax(RateAndAmountFormat37Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate68 setIndxFctr(RateAndAmountFormat37Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate68 setMaxAllwdOvrsbcptRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate68 setPrratnRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate68 setIssrDclrdXchgRate(ForeignExchangeTerms19 value) {
     ...
     *     
     */
    public CorporateActionRate68 setTaxOnIncm(RateAndAmountFormat37Choice value) {
     ...
     * 
     */
    public CorporateActionRate68 addGrssDvddRate(GrossDividendRateFormat19Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate68 addNetDvddRate(NetDividendRateFormat21Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate68 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat8Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate68 addWhldgTaxRate(RateAndAmountFormat41Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate68 addScndLvlTax(RateAndAmountFormat41Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate68 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus26 taxblIncmPerDvddShr) {
