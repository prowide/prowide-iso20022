...
@XmlType(name = "RejectedStatus55Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus55Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason54> rsn;
     ...
     *     
     */
    public RejectedStatus55Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason54 }
     * 
     * 
     */
    public List<RejectedStatusReason54> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason54>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus55Choice addRsn(RejectedStatusReason54 rsn) {
        getRsn().add(rsn);
        return this;
    }
