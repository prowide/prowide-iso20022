...
@XmlType(name = "CorporateActionRate139", propOrder = {
    "addtlTax",
    "grssDstrbtnRate",
    "netDstrbtnRate",
...
public class CorporateActionRate139 {
    ...
    protected RateFormat32Choice prratnRate;
     ...
     *     
     */
    public CorporateActionRate139 setAddtlTax(RateAndAmountFormat57Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate139 setMaxAllwdOvrsbcptRate(RateFormat24Choice value) {
     ...
     * @return
     *     possible object is
     *     {@link RateFormat32Choice }
     *     
     */
    public RateFormat32Choice getPrratnRate() {
        return prratnRate;
    }
     ...
     *     
     */
    public CorporateActionRate139 setPrratnRate(RateFormat32Choice value) {
     ...
     *     
     */
    public CorporateActionRate139 setIssrDclrdXchgRate(ForeignExchangeTerms38 value) {
     ...
     *     
     */
    public CorporateActionRate139 setTaxOnIncm(RateAndAmountFormat57Choice value) {
     ...
     *     
     */
    public CorporateActionRate139 setBidIntrvl(RateAndAmountFormat58Choice value) {
     ...
     * 
     */
    public CorporateActionRate139 addGrssDstrbtnRate(GrossDividendRateFormat36Choice grssDstrbtnRate) {
     ...
     * 
     */
    public CorporateActionRate139 addNetDstrbtnRate(NetDividendRateFormat38Choice netDstrbtnRate) {
     ...
     * 
     */
    public CorporateActionRate139 addGrssIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat11Choice grssIntrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate139 addWhldgTaxRate(RateAndAmountFormat56Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate139 addScndLvlTax(RateAndAmountFormat60Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate139 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus26 taxblIncmPerDvddShr) {
