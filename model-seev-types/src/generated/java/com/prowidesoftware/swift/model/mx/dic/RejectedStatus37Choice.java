...
@XmlType(name = "RejectedStatus37Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus37Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason35> rsn;
     ...
     *     
     */
    public RejectedStatus37Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason35 }
     * 
     * 
     */
    public List<RejectedStatusReason35> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason35>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus37Choice addRsn(RejectedStatusReason35 rsn) {
        getRsn().add(rsn);
        return this;
    }
