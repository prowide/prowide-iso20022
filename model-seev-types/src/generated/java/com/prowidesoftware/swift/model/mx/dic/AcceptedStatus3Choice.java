...
@XmlType(name = "AcceptedStatus3Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class AcceptedStatus3Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<AcceptedStatusReason3> rsn;
     ...
     *     
     */
    public AcceptedStatus3Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link AcceptedStatusReason3 }
     * 
     * 
     */
    public List<AcceptedStatusReason3> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<AcceptedStatusReason3>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AcceptedStatus3Choice addRsn(AcceptedStatusReason3 rsn) {
        getRsn().add(rsn);
        return this;
    }
