...
@XmlType(name = "PendingStatus84Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus84Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason34> rsn;
     ...
     *     
     */
    public PendingStatus84Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason34 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingStatusReason34> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingStatus84Choice addRsn(PendingStatusReason34 rsn) {
        getRsn().add(rsn);
        return this;
    }
