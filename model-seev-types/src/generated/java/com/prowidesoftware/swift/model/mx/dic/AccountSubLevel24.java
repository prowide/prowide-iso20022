...
@XmlType(name = "AccountSubLevel24", propOrder = {
    "nonDscldShrhldgQty",
    "blwThrshldShrhldgQty",
    "dsclsr"
})
public class AccountSubLevel24 {
    ...
    protected List<AccountSubLevel25> dsclsr;
     ...
     *     
     */
    public AccountSubLevel24 setNonDscldShrhldgQty(FinancialInstrumentQuantity18Choice value) {
     ...
     *     
     */
    public AccountSubLevel24 setBlwThrshldShrhldgQty(FinancialInstrumentQuantity18Choice value) {
     ...
     * {@link AccountSubLevel25 }
     * 
     * 
     */
    public List<AccountSubLevel25> getDsclsr() {
        if (dsclsr == null) {
            dsclsr = new ArrayList<AccountSubLevel25>();
        }
        return this.dsclsr;
    }
     ...
     * 
     */
    public AccountSubLevel24 addDsclsr(AccountSubLevel25 dsclsr) {
