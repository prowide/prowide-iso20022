...
@XmlType(name = "CorporateActionInstructionStatusAdvice002V11", propOrder = {
    "instrId",
    "othrDocId",
    "corpActnGnlInf",
    "instrPrcgSts",
...
public class CorporateActionInstructionStatusAdvice002V11 {
    ...
    protected List<InstructionProcessingStatus39Choice> instrPrcgSts;
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V11 setInstrId(DocumentIdentification17 value) {
        this.instrId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V11 setCorpActnGnlInf(CorporateActionGeneralInformation144 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionProcessingStatus39Choice }
     * 
     * 
     */
    public List<InstructionProcessingStatus39Choice> getInstrPrcgSts() {
        if (instrPrcgSts == null) {
            instrPrcgSts = new ArrayList<InstructionProcessingStatus39Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V11 setCorpActnInstr(CorporateActionOption169 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V11 setPrtctInstr(ProtectInstruction6 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V11 setAddtlInf(CorporateActionNarrative19 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V11 addOthrDocId(DocumentIdentification34 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V11 addInstrPrcgSts(InstructionProcessingStatus39Choice instrPrcgSts) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V11 addSplmtryData(SupplementaryData1 splmtryData) {
