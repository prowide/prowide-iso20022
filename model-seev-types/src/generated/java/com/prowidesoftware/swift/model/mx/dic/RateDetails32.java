...
@XmlType(name = "RateDetails32", propOrder = {
    "addtlTax",
    "chrgsFees",
    "fsclStmp",
    "grssDvddRate",
...
public class RateDetails32 {
    ...
    protected List<GrossDividendRateFormat29Choice> grssDvddRate;
    ...
    protected List<NetDividendRateFormat32Choice> netDvddRate;
     ...
     *     
     */
    public RateDetails32 setAddtlTax(RateAndAmountFormat39Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public RateDetails32 setChrgsFees(RateAndAmountFormat39Choice value) {
     ...
     *     
     */
    public RateDetails32 setFsclStmp(BigDecimal value) {
        this.fsclStmp = value;
        return this;
    }
     ...
     * {@link GrossDividendRateFormat29Choice }
     * 
     * 
     */
    public List<GrossDividendRateFormat29Choice> getGrssDvddRate() {
        if (grssDvddRate == null) {
            grssDvddRate = new ArrayList<GrossDividendRateFormat29Choice>();
        }
     ...
     *     
     */
    public RateDetails32 setEarlySlctnFeeRate(SolicitationFeeRateFormat8Choice value) {
     ...
     *     
     */
    public RateDetails32 setThrdPtyIncntivRate(RateAndAmountFormat39Choice value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NetDividendRateFormat32Choice }
     * 
     * 
     */
    public List<NetDividendRateFormat32Choice> getNetDvddRate() {
        if (netDvddRate == null) {
            netDvddRate = new ArrayList<NetDividendRateFormat32Choice>();
        }
     ...
     *     
     */
    public RateDetails32 setAplblRate(BigDecimal value) {
     ...
     *     
     */
    public RateDetails32 setSlctnFeeRate(SolicitationFeeRateFormat8Choice value) {
     ...
     *     
     */
    public RateDetails32 setTaxCdtRate(RateFormat22Choice value) {
     ...
     *     
     */
    public RateDetails32 setTaxOnIncm(RateAndAmountFormat39Choice value) {
     ...
     *     
     */
    public RateDetails32 setTaxOnPrfts(BigDecimal value) {
     ...
     *     
     */
    public RateDetails32 setTaxRclmRate(BigDecimal value) {
     ...
     *     
     */
    public RateDetails32 setEqulstnRate(ActiveCurrencyAnd13DecimalAmount value) {
    ...
    public List<RateAndAmountFormat52Choice> getDmdRate() {
        if (dmdRate == null) {
            dmdRate = new ArrayList<RateAndAmountFormat52Choice>();
        }
        return this.dmdRate;
    }
     ...
     * 
     */
    public RateDetails32 addGrssDvddRate(GrossDividendRateFormat29Choice grssDvddRate) {
     ...
     * 
     */
    public RateDetails32 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat7Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public RateDetails32 addNetDvddRate(NetDividendRateFormat32Choice netDvddRate) {
     ...
     * 
     */
    public RateDetails32 addWhldgTaxRate(RateAndAmountFormat40Choice whldgTaxRate) {
     ...
     * 
     */
    public RateDetails32 addScndLvlTax(RateAndAmountFormat40Choice scndLvlTax) {
     ...
     * 
     */
    public RateDetails32 addDmdRate(RateAndAmountFormat52Choice dmdRate) {
