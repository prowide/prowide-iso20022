...
@XmlType(name = "RejectedStatus25Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus25Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason23> rsn;
     ...
     *     
     */
    public RejectedStatus25Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason23 }
     * 
     * 
     */
    public List<RejectedStatusReason23> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason23>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus25Choice addRsn(RejectedStatusReason23 rsn) {
        getRsn().add(rsn);
        return this;
    }
