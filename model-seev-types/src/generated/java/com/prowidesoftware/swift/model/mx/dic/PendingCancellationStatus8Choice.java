...
public class PendingCancellationStatus8Choice {
     ...
     *     
     */
    public PendingCancellationStatus8Choice setNotSpcfdRsn(NoReasonCode value) {
    ...
    public List<PendingCancellationStatusReason8> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingCancellationStatusReason8>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingCancellationStatus8Choice addRsn(PendingCancellationStatusReason8 rsn) {
        getRsn().add(rsn);
        return this;
    }
