...
public class CorporateActionRate111 {
     ...
     *     
     */
    public CorporateActionRate111 setAddtlTax(RateAndAmountFormat46Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate111 setMaxAllwdOvrsbcptRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate111 setPrratnRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate111 setIssrDclrdXchgRate(ForeignExchangeTerms19 value) {
     ...
     *     
     */
    public CorporateActionRate111 setTaxOnIncm(RateAndAmountFormat46Choice value) {
     ...
     *     
     */
    public CorporateActionRate111 setBidIntrvl(RateAndAmountFormat38Choice value) {
     ...
     * 
     */
    public CorporateActionRate111 addGrssDvddRate(GrossDividendRateFormat41Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate111 addNetDvddRate(NetDividendRateFormat43Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate111 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat10Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate111 addWhldgTaxRate(RateAndAmountFormat47Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate111 addScndLvlTax(RateAndAmountFormat47Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate111 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus33 taxblIncmPerDvddShr) {
