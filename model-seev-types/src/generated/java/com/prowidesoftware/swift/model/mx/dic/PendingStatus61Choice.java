...
@XmlType(name = "PendingStatus61Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus61Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason21> rsn;
     ...
     *     
     */
    public PendingStatus61Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason21 }
     * 
     * 
     */
    public List<PendingStatusReason21> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason21>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus61Choice addRsn(PendingStatusReason21 rsn) {
        getRsn().add(rsn);
        return this;
    }
