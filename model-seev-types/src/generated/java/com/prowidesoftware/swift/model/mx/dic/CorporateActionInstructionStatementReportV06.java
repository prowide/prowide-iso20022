...
@XmlType(name = "CorporateActionInstructionStatementReportV06", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctAndStmtDtls",
    "splmtryData"
...
public class CorporateActionInstructionStatementReportV06 {
    ...
    protected Statement47 stmtGnlDtls;
    @XmlElement(name = "AcctAndStmtDtls", required = true)
    protected List<AccountIdentification40> acctAndStmtDtls;
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV06 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public Statement47 getStmtGnlDtls() {
        return stmtGnlDtls;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV06 setStmtGnlDtls(Statement47 value) {
     ...
     * {@link AccountIdentification40 }
     * 
     * 
     */
    public List<AccountIdentification40> getAcctAndStmtDtls() {
        if (acctAndStmtDtls == null) {
            acctAndStmtDtls = new ArrayList<AccountIdentification40>();
        }
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV06 addAcctAndStmtDtls(AccountIdentification40 acctAndStmtDtls) {
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV06 addSplmtryData(SupplementaryData1 splmtryData) {
