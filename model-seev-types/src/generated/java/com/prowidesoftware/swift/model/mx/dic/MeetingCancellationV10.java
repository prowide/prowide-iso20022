...
@XmlType(name = "MeetingCancellationV10", propOrder = {
    "mtgRef",
    "scty",
    "rsn",
    "splmtryData"
})
public class MeetingCancellationV10 {

    @XmlElement(name = "MtgRef", required = true)
    protected MeetingReference10 mtgRef;
    @XmlElement(name = "Scty", required = true)
    protected List<SecurityPosition23> scty;
     ...
     *     
     */
    public MeetingCancellationV10 setMtgRef(MeetingReference10 value) {
        this.mtgRef = value;
        return this;
    }
     ...
     * {@link SecurityPosition23 }
     * 
     * 
     */
    public List<SecurityPosition23> getScty() {
        if (scty == null) {
            scty = new ArrayList<SecurityPosition23>();
        }
        return this.scty;
    }
     ...
     *     
     */
    public MeetingCancellationV10 setRsn(MeetingCancellationReason2 value) {
        this.rsn = value;
        return this;
    }
     ...
     * 
     */
    public MeetingCancellationV10 addScty(SecurityPosition23 scty) {
        getScty().add(scty);
        return this;
    }
     ...
     * 
     */
    public MeetingCancellationV10 addSplmtryData(SupplementaryData1 splmtryData) {
