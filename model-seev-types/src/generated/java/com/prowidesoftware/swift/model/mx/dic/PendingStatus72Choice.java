...
@XmlType(name = "PendingStatus72Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus72Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason28> rsn;
     ...
     *     
     */
    public PendingStatus72Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason28 }
     * 
     * 
     */
    public List<PendingStatusReason28> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason28>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus72Choice addRsn(PendingStatusReason28 rsn) {
        getRsn().add(rsn);
        return this;
    }
