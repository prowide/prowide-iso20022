...
@XmlType(name = "CorporateActionRate87", propOrder = {
    "addtlTax",
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
...
public class CorporateActionRate87 {
    ...
    protected List<GrossDividendRateFormat27Choice> grssDvddRate;
    @XmlElement(name = "NetDvddRate")
    protected List<NetDividendRateFormat29Choice> netDvddRate;
     ...
     *     
     */
    public CorporateActionRate87 setAddtlTax(RateAndAmountFormat37Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     * {@link GrossDividendRateFormat27Choice }
     * 
     * 
     */
    public List<GrossDividendRateFormat27Choice> getGrssDvddRate() {
        if (grssDvddRate == null) {
            grssDvddRate = new ArrayList<GrossDividendRateFormat27Choice>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NetDividendRateFormat29Choice }
     * 
     * 
     */
    public List<NetDividendRateFormat29Choice> getNetDvddRate() {
        if (netDvddRate == null) {
            netDvddRate = new ArrayList<NetDividendRateFormat29Choice>();
        }
     ...
     *     
     */
    public CorporateActionRate87 setIndxFctr(RateAndAmountFormat37Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate87 setMaxAllwdOvrsbcptRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate87 setPrratnRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate87 setIssrDclrdXchgRate(ForeignExchangeTerms19 value) {
     ...
     *     
     */
    public CorporateActionRate87 setTaxOnIncm(RateAndAmountFormat37Choice value) {
     ...
     * 
     */
    public CorporateActionRate87 addGrssDvddRate(GrossDividendRateFormat27Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate87 addNetDvddRate(NetDividendRateFormat29Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate87 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat8Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate87 addWhldgTaxRate(RateAndAmountFormat41Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate87 addScndLvlTax(RateAndAmountFormat41Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate87 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus26 taxblIncmPerDvddShr) {
