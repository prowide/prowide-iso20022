...
@XmlType(name = "PartyIdentification56", propOrder = {
    "ownrId",
    "altrnId",
    "dmclCtry",
    "nonDmclCtry",
...
public class PartyIdentification56 {
    ...
    protected List<BeneficiaryCertificationType6Choice> certfctnTp;
     ...
     *     
     */
    public PartyIdentification56 setOwnrId(PartyIdentification48Choice value) {
        this.ownrId = value;
        return this;
    }
     ...
     *     
     */
    public PartyIdentification56 setDmclCtry(String value) {
        this.dmclCtry = value;
        return this;
    }
     ...
     *     
     */
    public PartyIdentification56 setOwndSctiesQty(FinancialInstrumentQuantity1Choice value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BeneficiaryCertificationType6Choice }
     * 
     * 
     */
    public List<BeneficiaryCertificationType6Choice> getCertfctnTp() {
        if (certfctnTp == null) {
            certfctnTp = new ArrayList<BeneficiaryCertificationType6Choice>();
        }
     ...
     *     
     */
    public PartyIdentification56 setDclrtnDtls(String value) {
     ...
     * 
     */
    public PartyIdentification56 addAltrnId(AlternatePartyIdentification2 altrnId) {
     ...
     * 
     */
    public PartyIdentification56 addNonDmclCtry(String nonDmclCtry) {
     ...
     * 
     */
    public PartyIdentification56 addCertfctnTp(BeneficiaryCertificationType6Choice certfctnTp) {
