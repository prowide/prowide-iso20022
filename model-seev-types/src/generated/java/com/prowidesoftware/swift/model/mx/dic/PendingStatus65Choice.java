...
@XmlType(name = "PendingStatus65Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus65Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason23> rsn;
     ...
     *     
     */
    public PendingStatus65Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason23 }
     * 
     * 
     */
    public List<PendingStatusReason23> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason23>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus65Choice addRsn(PendingStatusReason23 rsn) {
        getRsn().add(rsn);
        return this;
    }
