...
@XmlType(name = "AccountIdentification17Choice", propOrder = {
    "forAllAccts",
    "acctsList"
})
public class AccountIdentification17Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsList")
    protected List<AccountIdentification21> acctsList;
     ...
     *     
     */
    public AccountIdentification17Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * 
     */
    public List<AccountIdentification21> getAcctsList() {
        if (acctsList == null) {
            acctsList = new ArrayList<AccountIdentification21>();
        }
     ...
     * 
     */
    public AccountIdentification17Choice addAcctsList(AccountIdentification21 acctsList) {
