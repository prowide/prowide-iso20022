...
@XmlType(name = "RejectedStatus35Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus35Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason33> rsn;
     ...
     *     
     */
    public RejectedStatus35Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason33 }
     * 
     * 
     */
    public List<RejectedStatusReason33> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason33>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus35Choice addRsn(RejectedStatusReason33 rsn) {
        getRsn().add(rsn);
        return this;
    }
