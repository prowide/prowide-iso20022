...
public class Rate43 {
     ...
     *     
     */
    public Rate43 setAddtlTax(RateAndAmountFormat57Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public Rate43 setChrgsFees(RateAndAmountFormat57Choice value) {
     ...
     *     
     */
    public Rate43 setEarlySlctnFeeRate(SolicitationFeeRateFormat11Choice value) {
     ...
     *     
     */
    public Rate43 setFsclStmp(RateFormat24Choice value) {
        this.fsclStmp = value;
        return this;
    }
     ...
     *     
     */
    public Rate43 setThrdPtyIncntivRate(RateFormat26Choice value) {
     ...
     *     
     */
    public Rate43 setAplblRate(RateFormat24Choice value) {
     ...
     *     
     */
    public Rate43 setSlctnFeeRate(SolicitationFeeRateFormat11Choice value) {
     ...
     *     
     */
    public Rate43 setTaxCdtRate(RateFormat26Choice value) {
     ...
     *     
     */
    public Rate43 setTaxOnIncm(RateAndAmountFormat57Choice value) {
     ...
     *     
     */
    public Rate43 setTaxOnPrfts(RateFormat24Choice value) {
     ...
     *     
     */
    public Rate43 setTaxRclmRate(RateFormat24Choice value) {
     ...
     *     
     */
    public Rate43 setEqulstnRate(RateAndAmountFormat42Choice value) {
     ...
     * 
     */
    public Rate43 addGrssDstrbtnRate(GrossDividendRateFormat38Choice grssDstrbtnRate) {
     ...
     * 
     */
    public Rate43 addGrssIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat11Choice grssIntrstRateUsdForPmt) {
     ...
     * 
     */
    public Rate43 addWhldgTaxRate(RateAndAmountFormat60Choice whldgTaxRate) {
     ...
     * 
     */
    public Rate43 addScndLvlTax(RateAndAmountFormat60Choice scndLvlTax) {
     ...
     * 
     */
    public Rate43 addNetDstrbtnRate(NetDividendRateFormat39Choice netDstrbtnRate) {
     ...
     * 
     */
    public Rate43 addDmdRate(RateAndAmountFormat61Choice dmdRate) {
