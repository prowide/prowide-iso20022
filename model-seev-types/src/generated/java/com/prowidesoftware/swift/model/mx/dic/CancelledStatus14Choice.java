...
@XmlType(name = "CancelledStatus14Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class CancelledStatus14Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<CancelledStatusReason13> rsn;
     ...
     *     
     */
    public CancelledStatus14Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link CancelledStatusReason13 }
     * 
     * 
     */
    public List<CancelledStatusReason13> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<CancelledStatusReason13>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public CancelledStatus14Choice addRsn(CancelledStatusReason13 rsn) {
        getRsn().add(rsn);
        return this;
    }
