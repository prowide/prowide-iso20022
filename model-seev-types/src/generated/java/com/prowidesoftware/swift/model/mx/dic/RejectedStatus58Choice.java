...
@XmlType(name = "RejectedStatus58Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus58Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason57> rsn;
     ...
     *     
     */
    public RejectedStatus58Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason57 }
     * 
     * 
     */
    public List<RejectedStatusReason57> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason57>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus58Choice addRsn(RejectedStatusReason57 rsn) {
        getRsn().add(rsn);
        return this;
    }
