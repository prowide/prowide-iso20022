...
@XmlType(name = "AccountIdentification32Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification32Choice {
    ...
    protected List<AccountAndBalance33> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification32Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance33 }
     * 
     * 
     */
    public List<AccountAndBalance33> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance33>();
        }
     ...
     * 
     */
    public AccountIdentification32Choice addAcctsListAndBalDtls(AccountAndBalance33 acctsListAndBalDtls) {
