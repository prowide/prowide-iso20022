...
@XmlType(name = "RejectedStatus65Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus65Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason64> rsn;
     ...
     *     
     */
    public RejectedStatus65Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason64 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<RejectedStatusReason64> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public RejectedStatus65Choice addRsn(RejectedStatusReason64 rsn) {
        getRsn().add(rsn);
        return this;
    }
