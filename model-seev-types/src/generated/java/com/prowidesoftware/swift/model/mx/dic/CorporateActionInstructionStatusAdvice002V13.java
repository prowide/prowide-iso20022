...
public class CorporateActionInstructionStatusAdvice002V13 {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V13 setInstrId(DocumentIdentification17 value) {
        this.instrId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V13 setCorpActnGnlInf(CorporateActionGeneralInformation158 value) {
    ...
    public List<InstructionProcessingStatus49Choice> getInstrPrcgSts() {
        if (instrPrcgSts == null) {
            instrPrcgSts = new ArrayList<InstructionProcessingStatus49Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V13 setCorpActnInstr(CorporateActionOption203 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V13 setPrtctInstr(ProtectInstruction6 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V13 setAddtlInf(CorporateActionNarrative19 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V13 addOthrDocId(DocumentIdentification34 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V13 addInstrPrcgSts(InstructionProcessingStatus49Choice instrPrcgSts) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V13 addSplmtryData(SupplementaryData1 splmtryData) {
