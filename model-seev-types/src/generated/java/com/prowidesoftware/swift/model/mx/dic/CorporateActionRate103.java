...
@XmlType(name = "CorporateActionRate103", propOrder = {
    "addtlTax",
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
...
public class CorporateActionRate103 {
     ...
     *     
     */
    public CorporateActionRate103 setAddtlTax(RateAndAmountFormat46Choice value) {
        this.addtlTax = value;
        return this;
    }
    ...
    public List<GrossDividendRateFormat41Choice> getGrssDvddRate() {
        if (grssDvddRate == null) {
            grssDvddRate = new ArrayList<GrossDividendRateFormat41Choice>();
        }
    ...
    public List<NetDividendRateFormat43Choice> getNetDvddRate() {
        if (netDvddRate == null) {
            netDvddRate = new ArrayList<NetDividendRateFormat43Choice>();
        }
     ...
     *     
     */
    public CorporateActionRate103 setIndxFctr(RateAndAmountFormat46Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate103 setMaxAllwdOvrsbcptRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate103 setPrratnRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate103 setIssrDclrdXchgRate(ForeignExchangeTerms19 value) {
     ...
     *     
     */
    public CorporateActionRate103 setTaxOnIncm(RateAndAmountFormat46Choice value) {
     ...
     * 
     */
    public CorporateActionRate103 addGrssDvddRate(GrossDividendRateFormat41Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate103 addNetDvddRate(NetDividendRateFormat43Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate103 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat10Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate103 addWhldgTaxRate(RateAndAmountFormat47Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate103 addScndLvlTax(RateAndAmountFormat47Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate103 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus33 taxblIncmPerDvddShr) {
