...
@XmlType(name = "PendingStatus42Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus42Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason10> rsn;
     ...
     *     
     */
    public PendingStatus42Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason10 }
     * 
     * 
     */
    public List<PendingStatusReason10> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason10>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus42Choice addRsn(PendingStatusReason10 rsn) {
        getRsn().add(rsn);
        return this;
    }
