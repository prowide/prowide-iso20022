...
/**
 * Scope
 * The BuyerProtectionInstructionCancellationRequest message is sent by an account owner to an account servicer to request cancellation of a previously sent Buyer Protection Instruction.
 * 
 * Usage
...
@XmlType(name = "BuyerProtectionInstructionCancellationRequestV01", propOrder = {
    "buyrPrtcnInstrId",
    "corpActnGnlInf",
    "rltdSttlmInstr",
    "acctId",
...
public class BuyerProtectionInstructionCancellationRequestV01 {
     ...
     *     
     */
    public BuyerProtectionInstructionCancellationRequestV01 setBuyrPrtcnInstrId(DocumentIdentification57 value) {
     ...
     *     
     */
    public BuyerProtectionInstructionCancellationRequestV01 setCorpActnGnlInf(CorporateActionGeneralInformation195 value) {
     ...
     *     
     */
    public BuyerProtectionInstructionCancellationRequestV01 setRltdSttlmInstr(RelatedSettlementInstruction4 value) {
     ...
     *     
     */
    public BuyerProtectionInstructionCancellationRequestV01 setAcctId(SecuritiesAccountIdentification1Choice value) {
        this.acctId = value;
        return this;
    }
     ...
     *     
     */
    public BuyerProtectionInstructionCancellationRequestV01 setCorpActnElctn(CorporateActionElection4 value) {
     ...
     * 
     */
    public BuyerProtectionInstructionCancellationRequestV01 addSplmtryData(SupplementaryData1 splmtryData) {
