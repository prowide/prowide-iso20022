...
@XmlType(name = "AcceptedStatus1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class AcceptedStatus1Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<AcceptedStatusReason1> rsn;
     ...
     *     
     */
    public AcceptedStatus1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link AcceptedStatusReason1 }
     * 
     * 
     */
    public List<AcceptedStatusReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<AcceptedStatusReason1>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AcceptedStatus1Choice addRsn(AcceptedStatusReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
