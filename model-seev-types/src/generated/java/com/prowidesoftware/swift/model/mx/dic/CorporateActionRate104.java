...
public class CorporateActionRate104 {
     ...
     *     
     */
    public CorporateActionRate104 setAddtlTax(RateAndAmountFormat37Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate104 setMaxAllwdOvrsbcptRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate104 setPrratnRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate104 setIssrDclrdXchgRate(ForeignExchangeTerms19 value) {
     ...
     *     
     */
    public CorporateActionRate104 setTaxOnIncm(RateAndAmountFormat37Choice value) {
     ...
     *     
     */
    public CorporateActionRate104 setBidIntrvl(RateAndAmountFormat38Choice value) {
     ...
     * 
     */
    public CorporateActionRate104 addGrssDvddRate(GrossDividendRateFormat36Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate104 addNetDvddRate(NetDividendRateFormat38Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate104 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat8Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate104 addWhldgTaxRate(RateAndAmountFormat41Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate104 addScndLvlTax(RateAndAmountFormat41Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate104 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus26 taxblIncmPerDvddShr) {
