...
@XmlType(name = "RejectedStatus9Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus9Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason10> rsn;
     ...
     *     
     */
    public RejectedStatus9Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason10 }
     * 
     * 
     */
    public List<RejectedStatusReason10> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason10>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus9Choice addRsn(RejectedStatusReason10 rsn) {
        getRsn().add(rsn);
        return this;
    }
