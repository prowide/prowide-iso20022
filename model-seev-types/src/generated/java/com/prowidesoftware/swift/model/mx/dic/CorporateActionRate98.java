...
@XmlType(name = "CorporateActionRate98", propOrder = {
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
    "intrstRateUsdForPmt",
...
public class CorporateActionRate98 {
     ...
     *     
     */
    public CorporateActionRate98 setIndxFctr(RateAndAmountFormat39Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate98 setMaxAllwdOvrsbcptRate(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionRate98 setPrratnRate(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionRate98 setAddtlTax(RateAndAmountFormat39Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionRate98 addGrssDvddRate(GrossDividendRateFormat35Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate98 addNetDvddRate(NetDividendRateFormat37Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate98 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat7Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate98 addWhldgTaxRate(RateAndAmountFormat40Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate98 addScndLvlTax(RateAndAmountFormat40Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate98 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus26 taxblIncmPerDvddShr) {
