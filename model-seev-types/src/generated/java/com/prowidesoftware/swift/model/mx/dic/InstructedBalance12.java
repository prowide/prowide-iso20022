...
@XmlType(name = "InstructedBalance12", propOrder = {
    "ttlInstdBal",
    "ttlAccptdInstrBal",
    "ttlCancInstrBal",
    "ttlPdgInstrBal",
...
public class InstructedBalance12 {
     ...
     *     
     */
    public InstructedBalance12 setTtlInstdBal(BalanceFormat7Choice value) {
     ...
     *     
     */
    public InstructedBalance12 setTtlAccptdInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedBalance12 setTtlCancInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedBalance12 setTtlPdgInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedBalance12 setTtlRjctdInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedBalance12 setTtlPrtctInstrBal(SignedQuantityFormat9 value) {
     ...
     * {@link InstructedCorporateActionOption13 }
     * 
     * 
     */
    public List<InstructedCorporateActionOption13> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<InstructedCorporateActionOption13>();
        }
     ...
     * 
     */
    public InstructedBalance12 addOptnDtls(InstructedCorporateActionOption13 optnDtls) {
