...
@XmlType(name = "PendingStatus43Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus43Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason11> rsn;
     ...
     *     
     */
    public PendingStatus43Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason11 }
     * 
     * 
     */
    public List<PendingStatusReason11> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason11>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus43Choice addRsn(PendingStatusReason11 rsn) {
        getRsn().add(rsn);
        return this;
    }
