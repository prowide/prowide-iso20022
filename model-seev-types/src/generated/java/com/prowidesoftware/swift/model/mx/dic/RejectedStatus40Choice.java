...
@XmlType(name = "RejectedStatus40Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus40Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason38> rsn;
     ...
     *     
     */
    public RejectedStatus40Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason38 }
     * 
     * 
     */
    public List<RejectedStatusReason38> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason38>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus40Choice addRsn(RejectedStatusReason38 rsn) {
        getRsn().add(rsn);
        return this;
    }
