...
@XmlType(name = "CorporateActionInstructionStatementReportV08", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctAndStmtDtls",
    "splmtryData"
})
public class CorporateActionInstructionStatementReportV08 {
    ...
    protected List<AccountIdentification45> acctAndStmtDtls;
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV08 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV08 setStmtGnlDtls(Statement72 value) {
     ...
     * {@link AccountIdentification45 }
     * 
     * 
     */
    public List<AccountIdentification45> getAcctAndStmtDtls() {
        if (acctAndStmtDtls == null) {
            acctAndStmtDtls = new ArrayList<AccountIdentification45>();
        }
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV08 addAcctAndStmtDtls(AccountIdentification45 acctAndStmtDtls) {
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV08 addSplmtryData(SupplementaryData1 splmtryData) {
