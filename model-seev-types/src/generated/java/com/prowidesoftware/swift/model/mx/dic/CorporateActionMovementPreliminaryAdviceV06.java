...
@XmlType(name = "CorporateActionMovementPreliminaryAdviceV06", propOrder = {
    "pgntn",
...
public class CorporateActionMovementPreliminaryAdviceV06 {
    ...
    protected CorporateActionGeneralInformation69 corpActnGnlInf;
    @XmlElement(name = "AcctDtls", required = true)
    protected AccountIdentification23Choice acctDtls;
    @XmlElement(name = "CorpActnDtls")
    protected CorporateAction24 corpActnDtls;
    @XmlElement(name = "CorpActnMvmntDtls")
    protected List<CorporateActionOption100> corpActnMvmntDtls;
    ...
    protected PartyIdentification40Choice regar;
    @XmlElement(name = "RsellngAgt")
    protected List<PartyIdentification40Choice> rsellngAgt;
    @XmlElement(name = "PhysSctiesAgt")
    protected PartyIdentification40Choice physSctiesAgt;
    @XmlElement(name = "DrpAgt")
    protected PartyIdentification40Choice drpAgt;
    @XmlElement(name = "SlctnAgt")
    protected List<PartyIdentification40Choice> slctnAgt;
    @XmlElement(name = "InfAgt")
    protected PartyIdentification40Choice infAgt;
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setMvmntPrlimryAdvcGnlInf(CorporateActionPreliminaryAdviceType2 value) {
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setPrvsMvmntPrlimryAdvcId(DocumentIdentification15 value) {
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setNtfctnId(DocumentIdentification15 value) {
        this.ntfctnId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setMvmntConfId(DocumentIdentification15 value) {
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setInstrId(DocumentIdentification9 value) {
        this.instrId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setRvslRsn(CorporateActionReversalReason1 value) {
        this.rvslRsn = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformation69 }
     *     
     */
    public CorporateActionGeneralInformation69 getCorpActnGnlInf() {
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setCorpActnGnlInf(CorporateActionGeneralInformation69 value) {
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setAcctDtls(AccountIdentification23Choice value) {
        this.acctDtls = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link CorporateAction24 }
     *     
     */
    public CorporateAction24 getCorpActnDtls() {
        return corpActnDtls;
    }
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setCorpActnDtls(CorporateAction24 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CorporateActionOption100 }
     * 
     * 
     */
    public List<CorporateActionOption100> getCorpActnMvmntDtls() {
        if (corpActnMvmntDtls == null) {
            corpActnMvmntDtls = new ArrayList<CorporateActionOption100>();
        }
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setAddtlInf(CorporateActionNarrative6 value) {
        this.addtlInf = value;
        return this;
    }
    ...
    public List<PartyIdentification40Choice> getIssrAgt() {
        if (issrAgt == null) {
            issrAgt = new ArrayList<PartyIdentification40Choice>();
        }
        return this.issrAgt;
    }
    ...
    public List<PartyIdentification40Choice> getPngAgt() {
        if (pngAgt == null) {
            pngAgt = new ArrayList<PartyIdentification40Choice>();
        }
        return this.pngAgt;
    }
    ...
    public List<PartyIdentification40Choice> getSubPngAgt() {
        if (subPngAgt == null) {
            subPngAgt = new ArrayList<PartyIdentification40Choice>();
        }
     ...
     *     
     */
    public PartyIdentification40Choice getRegar() {
        return regar;
    }
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setRegar(PartyIdentification40Choice value) {
        this.regar = value;
        return this;
    }
     ...
     * 
     */
    public List<PartyIdentification40Choice> getRsellngAgt() {
        if (rsellngAgt == null) {
            rsellngAgt = new ArrayList<PartyIdentification40Choice>();
        }
     ...
     *     
     */
    public PartyIdentification40Choice getPhysSctiesAgt() {
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setPhysSctiesAgt(PartyIdentification40Choice value) {
     ...
     *     
     */
    public PartyIdentification40Choice getDrpAgt() {
        return drpAgt;
    }
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setDrpAgt(PartyIdentification40Choice value) {
        this.drpAgt = value;
        return this;
    }
     ...
     * 
     */
    public List<PartyIdentification40Choice> getSlctnAgt() {
        if (slctnAgt == null) {
            slctnAgt = new ArrayList<PartyIdentification40Choice>();
        }
     ...
     *     
     */
    public PartyIdentification40Choice getInfAgt() {
        return infAgt;
    }
     ...
     *     
     */
    public CorporateActionMovementPreliminaryAdviceV06 setInfAgt(PartyIdentification40Choice value) {
        this.infAgt = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionMovementPreliminaryAdviceV06 addOthrDocId(DocumentIdentification13 othrDocId) {
     ...
     * 
     */
    public CorporateActionMovementPreliminaryAdviceV06 addEvtsLkg(CorporateActionEventReference1 evtsLkg) {
     ...
     * 
     */
    public CorporateActionMovementPreliminaryAdviceV06 addCorpActnMvmntDtls(CorporateActionOption100 corpActnMvmntDtls) {
     ...
     * 
     */
    public CorporateActionMovementPreliminaryAdviceV06 addIssrAgt(PartyIdentification40Choice issrAgt) {
     ...
     * 
     */
    public CorporateActionMovementPreliminaryAdviceV06 addPngAgt(PartyIdentification40Choice pngAgt) {
     ...
     * 
     */
    public CorporateActionMovementPreliminaryAdviceV06 addSubPngAgt(PartyIdentification40Choice subPngAgt) {
     ...
     * 
     */
    public CorporateActionMovementPreliminaryAdviceV06 addRsellngAgt(PartyIdentification40Choice rsellngAgt) {
     ...
     * 
     */
    public CorporateActionMovementPreliminaryAdviceV06 addSlctnAgt(PartyIdentification40Choice slctnAgt) {
     ...
     * 
     */
    public CorporateActionMovementPreliminaryAdviceV06 addSplmtryData(SupplementaryData1 splmtryData) {
