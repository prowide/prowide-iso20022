...
@XmlType(name = "AcceptedStatus8Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class AcceptedStatus8Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<AcceptedStatusReason9> rsn;
     ...
     *     
     */
    public AcceptedStatus8Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link AcceptedStatusReason9 }
     * 
     * 
     */
    public List<AcceptedStatusReason9> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<AcceptedStatusReason9>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AcceptedStatus8Choice addRsn(AcceptedStatusReason9 rsn) {
        getRsn().add(rsn);
        return this;
    }
