...
@XmlType(name = "AccountIdentification21Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification21Choice {
    ...
    protected List<AccountAndBalance21> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification21Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance21 }
     * 
     * 
     */
    public List<AccountAndBalance21> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance21>();
        }
     ...
     * 
     */
    public AccountIdentification21Choice addAcctsListAndBalDtls(AccountAndBalance21 acctsListAndBalDtls) {
