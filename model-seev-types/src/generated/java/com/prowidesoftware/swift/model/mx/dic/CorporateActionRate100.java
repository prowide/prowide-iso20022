...
@XmlType(name = "CorporateActionRate100", propOrder = {
    "addtlTax",
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
...
public class CorporateActionRate100 {
     ...
     *     
     */
    public CorporateActionRate100 setAddtlTax(RateAndAmountFormat37Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate100 setIndxFctr(RateAndAmountFormat37Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate100 setMaxAllwdOvrsbcptRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate100 setPrratnRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate100 setTaxOnIncm(RateAndAmountFormat37Choice value) {
     ...
     * 
     */
    public CorporateActionRate100 addGrssDvddRate(GrossDividendRateFormat36Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate100 addNetDvddRate(NetDividendRateFormat38Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate100 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat8Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate100 addWhldgTaxRate(RateAndAmountFormat41Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate100 addScndLvlTax(RateAndAmountFormat41Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate100 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus26 taxblIncmPerDvddShr) {
