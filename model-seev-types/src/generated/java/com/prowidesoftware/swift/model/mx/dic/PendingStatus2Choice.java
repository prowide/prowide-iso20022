...
@XmlType(name = "PendingStatus2Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus2Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason2> rsn;
     ...
     *     
     */
    public PendingStatus2Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason2 }
     * 
     * 
     */
    public List<PendingStatusReason2> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason2>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus2Choice addRsn(PendingStatusReason2 rsn) {
        getRsn().add(rsn);
        return this;
    }
