...
@XmlType(name = "AccountIdentification6Choice", propOrder = {
    "forAllAccts",
    "acctsList"
})
public class AccountIdentification6Choice {
    ...
    protected List<AccountIdentification9> acctsList;
     ...
     *     
     */
    public AccountIdentification6Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification9 }
     * 
     * 
     */
    public List<AccountIdentification9> getAcctsList() {
        if (acctsList == null) {
            acctsList = new ArrayList<AccountIdentification9>();
        }
     ...
     * 
     */
    public AccountIdentification6Choice addAcctsList(AccountIdentification9 acctsList) {
