...
@XmlType(name = "InstructedCorporateActionOption11", propOrder = {
    "optnNb",
    "optnTp",
    "instdBal",
    "dfltActn",
...
public class InstructedCorporateActionOption11 {
    ...
    protected List<OptionInstructionDetails2> optnInstrDtls;
     ...
     *     
     */
    public InstructedCorporateActionOption11 setOptnNb(String value) {
        this.optnNb = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption11 setOptnTp(CorporateActionOption23Choice value) {
        this.optnTp = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption11 setInstdBal(BalanceFormat7Choice value) {
        this.instdBal = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption11 setDfltActn(DefaultProcessingOrStandingInstruction1Choice value) {
        this.dfltActn = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption11 setOptnAccptdInstdBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption11 setOptnCancInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption11 setOptnPdgInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption11 setOptnRjctdInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption11 setOptnPrtctInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption11 setEvtDdlns(CorporateActionEventDeadlines4 value) {
        this.evtDdlns = value;
        return this;
    }
     ...
     * {@link OptionInstructionDetails2 }
     * 
     * 
     */
    public List<OptionInstructionDetails2> getOptnInstrDtls() {
        if (optnInstrDtls == null) {
            optnInstrDtls = new ArrayList<OptionInstructionDetails2>();
        }
     ...
     * 
     */
    public InstructedCorporateActionOption11 addOptnInstrDtls(OptionInstructionDetails2 optnInstrDtls) {
