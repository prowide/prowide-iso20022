...
@XmlType(name = "AccountIdentification36Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification36Choice {
    ...
    protected List<AccountAndBalance39> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification36Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance39 }
     * 
     * 
     */
    public List<AccountAndBalance39> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance39>();
        }
     ...
     * 
     */
    public AccountIdentification36Choice addAcctsListAndBalDtls(AccountAndBalance39 acctsListAndBalDtls) {
