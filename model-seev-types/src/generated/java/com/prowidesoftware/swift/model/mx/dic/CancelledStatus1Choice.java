...
@XmlType(name = "CancelledStatus1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class CancelledStatus1Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<CancelledStatusReason4> rsn;
     ...
     *     
     */
    public CancelledStatus1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link CancelledStatusReason4 }
     * 
     * 
     */
    public List<CancelledStatusReason4> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<CancelledStatusReason4>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public CancelledStatus1Choice addRsn(CancelledStatusReason4 rsn) {
        getRsn().add(rsn);
        return this;
    }
