...
@XmlType(name = "RejectedStatus14Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus14Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason14> rsn;
     ...
     *     
     */
    public RejectedStatus14Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason14 }
     * 
     * 
     */
    public List<RejectedStatusReason14> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason14>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus14Choice addRsn(RejectedStatusReason14 rsn) {
        getRsn().add(rsn);
        return this;
    }
