...
@XmlType(name = "AccountIdentification29Choice", propOrder = {
    "forAllAccts",
    "acctsList"
})
public class AccountIdentification29Choice {
    ...
    protected List<AccountIdentification31> acctsList;
     ...
     *     
     */
    public AccountIdentification29Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * 
     */
    public List<AccountIdentification31> getAcctsList() {
        if (acctsList == null) {
            acctsList = new ArrayList<AccountIdentification31>();
        }
     ...
     * 
     */
    public AccountIdentification29Choice addAcctsList(AccountIdentification31 acctsList) {
