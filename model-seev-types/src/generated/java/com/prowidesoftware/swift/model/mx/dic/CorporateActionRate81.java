...
@XmlType(name = "CorporateActionRate81", propOrder = {
    "addtlTax",
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
...
public class CorporateActionRate81 {
     ...
     *     
     */
    public CorporateActionRate81 setAddtlTax(RateAndAmountFormat37Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate81 setIndxFctr(RateAndAmountFormat37Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate81 setMaxAllwdOvrsbcptRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate81 setPrratnRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate81 setTaxOnIncm(RateAndAmountFormat37Choice value) {
     ...
     * 
     */
    public CorporateActionRate81 addGrssDvddRate(GrossDividendRateFormat19Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate81 addNetDvddRate(NetDividendRateFormat21Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate81 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat8Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate81 addWhldgTaxRate(RateAndAmountFormat41Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate81 addScndLvlTax(RateAndAmountFormat41Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate81 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus26 taxblIncmPerDvddShr) {
