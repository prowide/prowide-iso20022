...
@XmlType(name = "InstructedBalanceDetails10", propOrder = {
    "ttlInstdBal",
    "ttlAccptdInstrBal",
    "ttlCancInstrBal",
    "ttlPdgInstrBal",
...
public class InstructedBalanceDetails10 {
    ...
    protected List<InstructedCorporateActionOption11> optnDtls;
     ...
     *     
     */
    public InstructedBalanceDetails10 setTtlInstdBal(BalanceFormat7Choice value) {
     ...
     *     
     */
    public InstructedBalanceDetails10 setTtlAccptdInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedBalanceDetails10 setTtlCancInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedBalanceDetails10 setTtlPdgInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedBalanceDetails10 setTtlRjctdInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedBalanceDetails10 setTtlPrtctInstrBal(SignedQuantityFormat9 value) {
     ...
     * {@link InstructedCorporateActionOption11 }
     * 
     * 
     */
    public List<InstructedCorporateActionOption11> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<InstructedCorporateActionOption11>();
        }
     ...
     * 
     */
    public InstructedBalanceDetails10 addOptnDtls(InstructedCorporateActionOption11 optnDtls) {
