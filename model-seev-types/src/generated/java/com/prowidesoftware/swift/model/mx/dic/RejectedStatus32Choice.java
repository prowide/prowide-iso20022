...
@XmlType(name = "RejectedStatus32Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus32Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason30> rsn;
     ...
     *     
     */
    public RejectedStatus32Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason30 }
     * 
     * 
     */
    public List<RejectedStatusReason30> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason30>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus32Choice addRsn(RejectedStatusReason30 rsn) {
        getRsn().add(rsn);
        return this;
    }
