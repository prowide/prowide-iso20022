...
@XmlType(name = "PendingStatus34Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus34Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason7> rsn;
     ...
     *     
     */
    public PendingStatus34Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason7 }
     * 
     * 
     */
    public List<PendingStatusReason7> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason7>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus34Choice addRsn(PendingStatusReason7 rsn) {
        getRsn().add(rsn);
        return this;
    }
