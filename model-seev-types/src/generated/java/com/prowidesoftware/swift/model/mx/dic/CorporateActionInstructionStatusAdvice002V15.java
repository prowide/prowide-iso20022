...
@XmlType(name = "CorporateActionInstructionStatusAdvice002V15", propOrder = {
    "instrId",
    "othrDocId",
    "corpActnGnlInf",
    "instrPrcgSts",
...
public class CorporateActionInstructionStatusAdvice002V15 {
    ...
    protected CorporateActionGeneralInformation188 corpActnGnlInf;
    @XmlElement(name = "InstrPrcgSts", required = true)
    protected List<InstructionProcessingStatus58Choice> instrPrcgSts;
    @XmlElement(name = "CorpActnInstr")
    protected CorporateActionOption242 corpActnInstr;
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V15 setInstrId(DocumentIdentification17 value) {
        this.instrId = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformation188 }
     *     
     */
    public CorporateActionGeneralInformation188 getCorpActnGnlInf() {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V15 setCorpActnGnlInf(CorporateActionGeneralInformation188 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionProcessingStatus58Choice }
     * 
     * 
     */
    public List<InstructionProcessingStatus58Choice> getInstrPrcgSts() {
        if (instrPrcgSts == null) {
            instrPrcgSts = new ArrayList<InstructionProcessingStatus58Choice>();
        }
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionOption242 }
     *     
     */
    public CorporateActionOption242 getCorpActnInstr() {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V15 setCorpActnInstr(CorporateActionOption242 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V15 setPrtctInstr(ProtectInstruction6 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V15 setAddtlInf(CorporateActionNarrative19 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V15 addOthrDocId(DocumentIdentification34 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V15 addInstrPrcgSts(InstructionProcessingStatus58Choice instrPrcgSts) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V15 addSplmtryData(SupplementaryData1 splmtryData) {
