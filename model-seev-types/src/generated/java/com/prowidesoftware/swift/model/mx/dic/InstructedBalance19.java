...
@XmlType(name = "InstructedBalance19", propOrder = {
    "ttlInstdBal",
    "ttlAccptdInstrBal",
    "ttlCancInstrBal",
    "ttlPdgInstrBal",
...
public class InstructedBalance19 {
    ...
    protected List<InstructedCorporateActionOption20> optnDtls;
     ...
     *     
     */
    public InstructedBalance19 setTtlInstdBal(BalanceFormat14Choice value) {
     ...
     *     
     */
    public InstructedBalance19 setTtlAccptdInstrBal(SignedQuantityFormat13 value) {
     ...
     *     
     */
    public InstructedBalance19 setTtlCancInstrBal(SignedQuantityFormat13 value) {
     ...
     *     
     */
    public InstructedBalance19 setTtlPdgInstrBal(SignedQuantityFormat13 value) {
     ...
     *     
     */
    public InstructedBalance19 setTtlRjctdInstrBal(SignedQuantityFormat13 value) {
     ...
     *     
     */
    public InstructedBalance19 setTtlPrtctInstrBal(SignedQuantityFormat13 value) {
     ...
     * {@link InstructedCorporateActionOption20 }
     * 
     * 
     */
    public List<InstructedCorporateActionOption20> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<InstructedCorporateActionOption20>();
        }
     ...
     * 
     */
    public InstructedBalance19 addOptnDtls(InstructedCorporateActionOption20 optnDtls) {
