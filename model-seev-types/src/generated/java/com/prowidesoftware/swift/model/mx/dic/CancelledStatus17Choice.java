...
@XmlType(name = "CancelledStatus17Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class CancelledStatus17Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<CancelledStatusReason17> rsn;
     ...
     *     
     */
    public CancelledStatus17Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link CancelledStatusReason17 }
     * 
     * 
     */
    public List<CancelledStatusReason17> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<CancelledStatusReason17>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public CancelledStatus17Choice addRsn(CancelledStatusReason17 rsn) {
        getRsn().add(rsn);
        return this;
    }
