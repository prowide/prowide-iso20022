...
@XmlType(name = "CorporateActionRate102", propOrder = {
    "addtlTax",
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
...
public class CorporateActionRate102 {
     ...
     *     
     */
    public CorporateActionRate102 setAddtlTax(RateAndAmountFormat46Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate102 setIndxFctr(RateAndAmountFormat46Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate102 setMaxAllwdOvrsbcptRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate102 setPrratnRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate102 setTaxOnIncm(RateAndAmountFormat46Choice value) {
     ...
     * 
     */
    public CorporateActionRate102 addGrssDvddRate(GrossDividendRateFormat41Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate102 addNetDvddRate(NetDividendRateFormat43Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate102 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat10Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate102 addWhldgTaxRate(RateAndAmountFormat47Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate102 addScndLvlTax(RateAndAmountFormat47Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate102 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus33 taxblIncmPerDvddShr) {
