...
@XmlType(name = "MeetingInstructionCancellationRequestV07", propOrder = {
    "mtgInstrId",
    "mtgRef",
    "finInstrmId",
    "toBeCancInstr",
...
public class MeetingInstructionCancellationRequestV07 {
    ...
    protected List<CancelInstruction2> toBeCancInstr;
     ...
     *     
     */
    public MeetingInstructionCancellationRequestV07 setMtgInstrId(String value) {
     ...
     *     
     */
    public MeetingInstructionCancellationRequestV07 setMtgRef(MeetingReference10 value) {
        this.mtgRef = value;
        return this;
    }
     ...
     *     
     */
    public MeetingInstructionCancellationRequestV07 setFinInstrmId(SecurityIdentification19 value) {
     ...
     * {@link CancelInstruction2 }
     * 
     * 
     */
    public List<CancelInstruction2> getToBeCancInstr() {
        if (toBeCancInstr == null) {
            toBeCancInstr = new ArrayList<CancelInstruction2>();
        }
     ...
     * 
     */
    public MeetingInstructionCancellationRequestV07 addToBeCancInstr(CancelInstruction2 toBeCancInstr) {
     ...
     * 
     */
    public MeetingInstructionCancellationRequestV07 addSplmtryData(SupplementaryData1 splmtryData) {
