...
public class PendingCancellationStatus11Choice {
     ...
     *     
     */
    public PendingCancellationStatus11Choice setNotSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public PendingCancellationStatus11Choice addRsn(PendingCancellationStatusReason11 rsn) {
        getRsn().add(rsn);
        return this;
    }
