...
@XmlType(name = "MeetingInstructionV07", propOrder = {
    "mtgRef",
    "finInstrmId",
    "othrDocId",
    "instr",
...
public class MeetingInstructionV07 {
    ...
    protected List<Instruction5> instr;
     ...
     *     
     */
    public MeetingInstructionV07 setMtgRef(MeetingReference10 value) {
        this.mtgRef = value;
        return this;
    }
     ...
     *     
     */
    public MeetingInstructionV07 setFinInstrmId(SecurityIdentification19 value) {
     ...
     * 
     */
    public List<Instruction5> getInstr() {
        if (instr == null) {
            instr = new ArrayList<Instruction5>();
        }
        return this.instr;
    }
     ...
     * 
     */
    public MeetingInstructionV07 addOthrDocId(DocumentIdentification32 othrDocId) {
     ...
     * 
     */
    public MeetingInstructionV07 addInstr(Instruction5 instr) {
        getInstr().add(instr);
        return this;
    }
     ...
     * 
     */
    public MeetingInstructionV07 addSplmtryData(SupplementaryData1 splmtryData) {
