...
@XmlType(name = "CancelledStatus8Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class CancelledStatus8Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<CancelledStatusReason9> rsn;
     ...
     *     
     */
    public CancelledStatus8Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link CancelledStatusReason9 }
     * 
     * 
     */
    public List<CancelledStatusReason9> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<CancelledStatusReason9>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public CancelledStatus8Choice addRsn(CancelledStatusReason9 rsn) {
        getRsn().add(rsn);
        return this;
    }
