...
@XmlType(name = "CorporateActionRate99", propOrder = {
    "addtlTax",
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
...
public class CorporateActionRate99 {
     ...
     *     
     */
    public CorporateActionRate99 setAddtlTax(RateAndAmountFormat37Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate99 setIndxFctr(RateAndAmountFormat37Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate99 setMaxAllwdOvrsbcptRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate99 setPrratnRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate99 setIssrDclrdXchgRate(ForeignExchangeTerms19 value) {
     ...
     *     
     */
    public CorporateActionRate99 setTaxOnIncm(RateAndAmountFormat37Choice value) {
     ...
     * 
     */
    public CorporateActionRate99 addGrssDvddRate(GrossDividendRateFormat36Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate99 addNetDvddRate(NetDividendRateFormat38Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate99 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat8Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate99 addWhldgTaxRate(RateAndAmountFormat41Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate99 addScndLvlTax(RateAndAmountFormat41Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate99 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus26 taxblIncmPerDvddShr) {
