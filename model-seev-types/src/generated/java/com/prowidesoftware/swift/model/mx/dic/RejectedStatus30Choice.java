...
@XmlType(name = "RejectedStatus30Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus30Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason27> rsn;
     ...
     *     
     */
    public RejectedStatus30Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason27 }
     * 
     * 
     */
    public List<RejectedStatusReason27> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason27>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus30Choice addRsn(RejectedStatusReason27 rsn) {
        getRsn().add(rsn);
        return this;
    }
