...
@XmlType(name = "PendingStatus85Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus85Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason35> rsn;
     ...
     *     
     */
    public PendingStatus85Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason35 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingStatusReason35> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingStatus85Choice addRsn(PendingStatusReason35 rsn) {
        getRsn().add(rsn);
        return this;
    }
