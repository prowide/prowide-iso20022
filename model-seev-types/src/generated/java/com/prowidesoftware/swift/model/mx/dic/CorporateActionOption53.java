...
@XmlType(name = "CorporateActionOption53", propOrder = {
    "optnNb",
    "optnTp",
    "optnFeatrs",
    "frctnDspstn",
...
public class CorporateActionOption53 {
    ...
    protected CorporateActionRate38 rateAndAmtDtls;
    @XmlElement(name = "PricDtls")
    protected CorporateActionPrice30 pricDtls;
    @XmlElement(name = "PlcOfTrad")
    protected MarketIdentification4 plcOfTrad;
    @XmlElement(name = "SctiesMvmntDtls")
    protected List<SecuritiesOption35> sctiesMvmntDtls;
    @XmlElement(name = "CshMvmntDtls")
    protected List<CashOption26> cshMvmntDtls;
     ...
     *     
     */
    public CorporateActionOption53 setOptnNb(OptionNumber1Choice value) {
        this.optnNb = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption53 setOptnTp(CorporateActionOption11Choice value) {
        this.optnTp = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption53 setFrctnDspstn(FractionDispositionType23Choice value) {
     ...
     *     
     */
    public CorporateActionOption53 setCcyOptn(String value) {
        this.ccyOptn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption53 setDtDtls(CorporateActionDate18 value) {
        this.dtDtls = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption53 setPrdDtls(CorporateActionPeriod9 value) {
        this.prdDtls = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionRate38 }
     *     
     */
    public CorporateActionRate38 getRateAndAmtDtls() {
     ...
     *     
     */
    public CorporateActionOption53 setRateAndAmtDtls(CorporateActionRate38 value) {
     ...
     *     
     */
    public CorporateActionOption53 setPricDtls(CorporateActionPrice30 value) {
        this.pricDtls = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption53 setPlcOfTrad(MarketIdentification4 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SecuritiesOption35 }
     * 
     * 
     */
    public List<SecuritiesOption35> getSctiesMvmntDtls() {
        if (sctiesMvmntDtls == null) {
            sctiesMvmntDtls = new ArrayList<SecuritiesOption35>();
        }
     ...
     * 
     */
    public List<CashOption26> getCshMvmntDtls() {
        if (cshMvmntDtls == null) {
            cshMvmntDtls = new ArrayList<CashOption26>();
        }
     ...
     * 
     */
    public CorporateActionOption53 addOptnFeatrs(OptionFeaturesFormat1Choice optnFeatrs) {
     ...
     * 
     */
    public CorporateActionOption53 addSctiesMvmntDtls(SecuritiesOption35 sctiesMvmntDtls) {
     ...
     * 
     */
    public CorporateActionOption53 addCshMvmntDtls(CashOption26 cshMvmntDtls) {
