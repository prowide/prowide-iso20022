...
@XmlType(name = "PendingStatus53Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus53Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason15> rsn;
     ...
     *     
     */
    public PendingStatus53Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason15 }
     * 
     * 
     */
    public List<PendingStatusReason15> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason15>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus53Choice addRsn(PendingStatusReason15 rsn) {
        getRsn().add(rsn);
        return this;
    }
