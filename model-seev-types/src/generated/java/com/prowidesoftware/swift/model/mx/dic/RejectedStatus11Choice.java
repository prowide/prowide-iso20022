...
@XmlType(name = "RejectedStatus11Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus11Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason11> rsn;
     ...
     *     
     */
    public RejectedStatus11Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason11 }
     * 
     * 
     */
    public List<RejectedStatusReason11> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason11>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus11Choice addRsn(RejectedStatusReason11 rsn) {
        getRsn().add(rsn);
        return this;
    }
