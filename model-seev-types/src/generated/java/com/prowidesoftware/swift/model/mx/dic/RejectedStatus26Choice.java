...
@XmlType(name = "RejectedStatus26Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus26Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason24> rsn;
     ...
     *     
     */
    public RejectedStatus26Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason24 }
     * 
     * 
     */
    public List<RejectedStatusReason24> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason24>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus26Choice addRsn(RejectedStatusReason24 rsn) {
        getRsn().add(rsn);
        return this;
    }
