...
@XmlType(name = "CorporateActionInstructionCancellationRequestStatusAdvice002V13", propOrder = {
    "instrCxlReqId",
    "othrDocId",
    "corpActnGnlInf",
    "instrCxlReqSts",
...
public class CorporateActionInstructionCancellationRequestStatusAdvice002V13 {
    ...
    protected List<InstructionCancellationRequestStatus16Choice> instrCxlReqSts;
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V13 setInstrCxlReqId(DocumentIdentification17 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V13 setCorpActnGnlInf(CorporateActionGeneralInformation158 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionCancellationRequestStatus16Choice }
     * 
     * 
     */
    public List<InstructionCancellationRequestStatus16Choice> getInstrCxlReqSts() {
        if (instrCxlReqSts == null) {
            instrCxlReqSts = new ArrayList<InstructionCancellationRequestStatus16Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V13 setCorpActnInstr(CorporateActionOption201 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V13 setPrtctInstr(ProtectInstruction8 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V13 setAddtlInf(CorporateActionNarrative19 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V13 addOthrDocId(DocumentIdentification34 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V13 addInstrCxlReqSts(InstructionCancellationRequestStatus16Choice instrCxlReqSts) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V13 addSplmtryData(SupplementaryData1 splmtryData) {
