...
@XmlType(name = "SafekeepingPlaceTypeAndText2", propOrder = {
    "sfkpgPlcTp",
    "id"
})
public class SafekeepingPlaceTypeAndText2 {
     ...
     *     
     */
    public SafekeepingPlaceTypeAndText2 setSfkpgPlcTp(SafekeepingPlace2Code value) {
     ...
     *     
     */
    public SafekeepingPlaceTypeAndText2 setId(String value) {
        this.id = value;
        return this;
    }
