...
@XmlType(name = "SafekeepingPlaceTypeAndText25", propOrder = {
    "sfkpgPlcTp",
    "id"
})
public class SafekeepingPlaceTypeAndText25 {
     ...
     *     
     */
    public SafekeepingPlaceTypeAndText25 setSfkpgPlcTp(SafekeepingPlace2Code value) {
     ...
     *     
     */
    public SafekeepingPlaceTypeAndText25 setId(String value) {
        this.id = value;
        return this;
    }
