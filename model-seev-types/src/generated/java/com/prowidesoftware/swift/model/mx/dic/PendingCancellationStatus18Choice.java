...
@XmlType(name = "PendingCancellationStatus18Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingCancellationStatus18Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingCancellationStatusReason13> rsn;
     ...
     *     
     */
    public PendingCancellationStatus18Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingCancellationStatusReason13 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingCancellationStatusReason13> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingCancellationStatus18Choice addRsn(PendingCancellationStatusReason13 rsn) {
        getRsn().add(rsn);
        return this;
    }
