...
@XmlType(name = "RejectedStatus31Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus31Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason28> rsn;
     ...
     *     
     */
    public RejectedStatus31Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason28 }
     * 
     * 
     */
    public List<RejectedStatusReason28> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason28>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus31Choice addRsn(RejectedStatusReason28 rsn) {
        getRsn().add(rsn);
        return this;
    }
