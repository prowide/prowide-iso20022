...
@XmlType(name = "CorporateActionInstructionStatementReportV13", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctAndStmtDtls",
    "splmtryData"
})
public class CorporateActionInstructionStatementReportV13 {
    ...
    protected List<AccountIdentification68> acctAndStmtDtls;
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV13 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV13 setStmtGnlDtls(Statement72 value) {
     ...
     * {@link AccountIdentification68 }
     * 
     * 
     */
    public List<AccountIdentification68> getAcctAndStmtDtls() {
        if (acctAndStmtDtls == null) {
            acctAndStmtDtls = new ArrayList<AccountIdentification68>();
        }
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV13 addAcctAndStmtDtls(AccountIdentification68 acctAndStmtDtls) {
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV13 addSplmtryData(SupplementaryData1 splmtryData) {
