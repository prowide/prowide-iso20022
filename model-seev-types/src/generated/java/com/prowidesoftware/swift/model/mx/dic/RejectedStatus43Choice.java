...
@XmlType(name = "RejectedStatus43Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus43Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason41> rsn;
     ...
     *     
     */
    public RejectedStatus43Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason41 }
     * 
     * 
     */
    public List<RejectedStatusReason41> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason41>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus43Choice addRsn(RejectedStatusReason41 rsn) {
        getRsn().add(rsn);
        return this;
    }
