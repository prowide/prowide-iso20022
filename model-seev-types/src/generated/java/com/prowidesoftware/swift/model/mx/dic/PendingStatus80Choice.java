...
@XmlType(name = "PendingStatus80Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus80Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason33> rsn;
     ...
     *     
     */
    public PendingStatus80Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason33 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingStatusReason33> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingStatus80Choice addRsn(PendingStatusReason33 rsn) {
        getRsn().add(rsn);
        return this;
    }
