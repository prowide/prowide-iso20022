...
@XmlType(name = "AccountIdentification70Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification70Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountAndBalance59> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification70Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance59 }
     * 
     * 
     */
    public List<AccountAndBalance59> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance59>();
        }
     ...
     * 
     */
    public AccountIdentification70Choice addAcctsListAndBalDtls(AccountAndBalance59 acctsListAndBalDtls) {
