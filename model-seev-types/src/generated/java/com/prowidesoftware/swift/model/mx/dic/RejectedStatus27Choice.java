...
@XmlType(name = "RejectedStatus27Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus27Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason25> rsn;
     ...
     *     
     */
    public RejectedStatus27Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason25 }
     * 
     * 
     */
    public List<RejectedStatusReason25> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason25>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus27Choice addRsn(RejectedStatusReason25 rsn) {
        getRsn().add(rsn);
        return this;
    }
