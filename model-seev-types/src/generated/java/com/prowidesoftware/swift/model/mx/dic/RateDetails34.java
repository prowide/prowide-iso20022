...
@XmlType(name = "RateDetails34", propOrder = {
    "addtlTax",
    "grssDvddRate",
    "intrstRateUsdForPmt",
    "whldgTaxRate",
...
public class RateDetails34 {
     ...
     *     
     */
    public RateDetails34 setAddtlTax(RateAndAmountFormat46Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     * {@link GrossDividendRateFormat34Choice }
     * 
     * 
     */
    public List<GrossDividendRateFormat34Choice> getGrssDvddRate() {
        if (grssDvddRate == null) {
            grssDvddRate = new ArrayList<GrossDividendRateFormat34Choice>();
        }
     ...
     *     
     */
    public RateDetails34 setChrgsFees(RateAndAmountFormat46Choice value) {
     ...
     *     
     */
    public RateDetails34 setEarlySlctnFeeRate(SolicitationFeeRateFormat10Choice value) {
     ...
     *     
     */
    public RateDetails34 setFsclStmp(RateFormat3Choice value) {
        this.fsclStmp = value;
        return this;
    }
     ...
     *     
     */
    public RateDetails34 setThrdPtyIncntivRate(RateFormat21Choice value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NetDividendRateFormat36Choice }
     * 
     * 
     */
    public List<NetDividendRateFormat36Choice> getNetDvddRate() {
        if (netDvddRate == null) {
            netDvddRate = new ArrayList<NetDividendRateFormat36Choice>();
        }
     ...
     *     
     */
    public RateDetails34 setAplblRate(RateFormat3Choice value) {
     ...
     *     
     */
    public RateDetails34 setSlctnFeeRate(SolicitationFeeRateFormat10Choice value) {
     ...
     *     
     */
    public RateDetails34 setTaxCdtRate(RateFormat21Choice value) {
     ...
     *     
     */
    public RateDetails34 setTaxOnIncm(RateAndAmountFormat46Choice value) {
     ...
     *     
     */
    public RateDetails34 setTaxOnPrfts(RateFormat3Choice value) {
     ...
     *     
     */
    public RateDetails34 setTaxRclmRate(RateFormat3Choice value) {
     ...
     *     
     */
    public RateDetails34 setEqulstnRate(RateAndAmountFormat48Choice value) {
    ...
    public List<RateAndAmountFormat53Choice> getDmdRate() {
        if (dmdRate == null) {
            dmdRate = new ArrayList<RateAndAmountFormat53Choice>();
        }
        return this.dmdRate;
    }
     ...
     * 
     */
    public RateDetails34 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat10Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public RateDetails34 addWhldgTaxRate(RateAndAmountFormat47Choice whldgTaxRate) {
     ...
     * 
     */
    public RateDetails34 addScndLvlTax(RateAndAmountFormat47Choice scndLvlTax) {
     ...
     * 
     */
    public RateDetails34 addNetDvddRate(NetDividendRateFormat36Choice netDvddRate) {
     ...
     * 
     */
    public RateDetails34 addDmdRate(RateAndAmountFormat53Choice dmdRate) {
