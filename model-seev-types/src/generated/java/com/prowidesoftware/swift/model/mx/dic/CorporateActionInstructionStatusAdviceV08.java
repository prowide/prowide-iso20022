...
@XmlType(name = "CorporateActionInstructionStatusAdviceV08", propOrder = {
    "instrId",
    "othrDocId",
    "corpActnGnlInf",
    "instrPrcgSts",
...
public class CorporateActionInstructionStatusAdviceV08 {
    ...
    protected List<InstructionProcessingStatus29Choice> instrPrcgSts;
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV08 setInstrId(DocumentIdentification9 value) {
        this.instrId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV08 setCorpActnGnlInf(CorporateActionGeneralInformation109 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionProcessingStatus29Choice }
     * 
     * 
     */
    public List<InstructionProcessingStatus29Choice> getInstrPrcgSts() {
        if (instrPrcgSts == null) {
            instrPrcgSts = new ArrayList<InstructionProcessingStatus29Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV08 setCorpActnInstr(CorporateActionOption116 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV08 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV08 addOthrDocId(DocumentIdentification33 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV08 addInstrPrcgSts(InstructionProcessingStatus29Choice instrPrcgSts) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV08 addSplmtryData(SupplementaryData1 splmtryData) {
