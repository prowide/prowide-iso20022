...
@XmlType(name = "RejectedStatus15Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus15Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason15> rsn;
     ...
     *     
     */
    public RejectedStatus15Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason15 }
     * 
     * 
     */
    public List<RejectedStatusReason15> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason15>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus15Choice addRsn(RejectedStatusReason15 rsn) {
        getRsn().add(rsn);
        return this;
    }
