...
@XmlType(name = "PendingCancellationStatus12Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingCancellationStatus12Choice {
     ...
     *     
     */
    public PendingCancellationStatus12Choice setNoSpcfdRsn(NoReasonCode value) {
    ...
    public List<PendingCancellationStatusReason10> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingCancellationStatusReason10>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingCancellationStatus12Choice addRsn(PendingCancellationStatusReason10 rsn) {
        getRsn().add(rsn);
        return this;
    }
