...
@XmlType(name = "CorporateActionInstructionStatusAdviceV04", propOrder = {
    "instrId",
    "othrDocId",
    "corpActnGnlInf",
    "instrPrcgSts",
...
public class CorporateActionInstructionStatusAdviceV04 {
    ...
    protected List<InstructionProcessingStatus12Choice> instrPrcgSts;
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV04 setInstrId(DocumentIdentification9 value) {
        this.instrId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV04 setCorpActnGnlInf(CorporateActionGeneralInformation52 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionProcessingStatus12Choice }
     * 
     * 
     */
    public List<InstructionProcessingStatus12Choice> getInstrPrcgSts() {
        if (instrPrcgSts == null) {
            instrPrcgSts = new ArrayList<InstructionProcessingStatus12Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV04 setCorpActnInstr(CorporateActionOption41 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV04 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV04 addOthrDocId(DocumentIdentification14 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV04 addInstrPrcgSts(InstructionProcessingStatus12Choice instrPrcgSts) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV04 addSplmtryData(SupplementaryData1 splmtryData) {
