...
@XmlType(name = "RejectedStatus1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus1Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason8> rsn;
     ...
     *     
     */
    public RejectedStatus1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason8 }
     * 
     * 
     */
    public List<RejectedStatusReason8> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason8>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus1Choice addRsn(RejectedStatusReason8 rsn) {
        getRsn().add(rsn);
        return this;
    }
