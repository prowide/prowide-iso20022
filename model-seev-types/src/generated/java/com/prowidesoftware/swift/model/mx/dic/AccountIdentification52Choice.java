...
@XmlType(name = "AccountIdentification52Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification52Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountAndBalance53> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification52Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance53 }
     * 
     * 
     */
    public List<AccountAndBalance53> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance53>();
        }
     ...
     * 
     */
    public AccountIdentification52Choice addAcctsListAndBalDtls(AccountAndBalance53 acctsListAndBalDtls) {
