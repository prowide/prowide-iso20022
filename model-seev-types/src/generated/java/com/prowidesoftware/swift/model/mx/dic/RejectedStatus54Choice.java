...
@XmlType(name = "RejectedStatus54Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus54Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason53> rsn;
     ...
     *     
     */
    public RejectedStatus54Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason53 }
     * 
     * 
     */
    public List<RejectedStatusReason53> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason53>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus54Choice addRsn(RejectedStatusReason53 rsn) {
        getRsn().add(rsn);
        return this;
    }
