...
@XmlType(name = "AccountIdentification43Choice", propOrder = {
    "forAllAccts",
    "acctsList"
})
public class AccountIdentification43Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsList")
    protected List<AccountIdentification48> acctsList;
     ...
     *     
     */
    public AccountIdentification43Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification48 }
     * 
     * 
     */
    public List<AccountIdentification48> getAcctsList() {
        if (acctsList == null) {
            acctsList = new ArrayList<AccountIdentification48>();
        }
     ...
     * 
     */
    public AccountIdentification43Choice addAcctsList(AccountIdentification48 acctsList) {
