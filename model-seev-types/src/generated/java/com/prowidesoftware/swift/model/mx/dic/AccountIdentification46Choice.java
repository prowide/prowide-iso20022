...
@XmlType(name = "AccountIdentification46Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification46Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountIdentification52> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification46Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification52 }
     * 
     * 
     */
    public List<AccountIdentification52> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountIdentification52>();
        }
     ...
     * 
     */
    public AccountIdentification46Choice addAcctsListAndBalDtls(AccountIdentification52 acctsListAndBalDtls) {
