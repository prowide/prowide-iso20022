...
@XmlType(name = "NetDividendRateFormat5Choice", propOrder = {
    "amt",
...
public class NetDividendRateFormat5Choice {
     ...
     *     
     */
    public NetDividendRateFormat5Choice setAmt(ActiveCurrencyAnd13DecimalAmount value) {
        this.amt = value;
        return this;
    }
     ...
     *     
     */
    public NetDividendRateFormat5Choice setRateTpAndAmtAndRateSts(RateTypeAndAmountAndStatus4 value) {
     ...
     *     
     */
    public NetDividendRateFormat5Choice setNotSpcfdRate(RateValueType7Code value) {
