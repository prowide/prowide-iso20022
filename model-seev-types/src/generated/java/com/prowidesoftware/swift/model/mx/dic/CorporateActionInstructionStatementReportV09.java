...
@XmlType(name = "CorporateActionInstructionStatementReportV09", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctAndStmtDtls",
    "splmtryData"
})
public class CorporateActionInstructionStatementReportV09 {
    ...
    protected List<AccountIdentification53> acctAndStmtDtls;
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV09 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV09 setStmtGnlDtls(Statement72 value) {
     ...
     * {@link AccountIdentification53 }
     * 
     * 
     */
    public List<AccountIdentification53> getAcctAndStmtDtls() {
        if (acctAndStmtDtls == null) {
            acctAndStmtDtls = new ArrayList<AccountIdentification53>();
        }
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV09 addAcctAndStmtDtls(AccountIdentification53 acctAndStmtDtls) {
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV09 addSplmtryData(SupplementaryData1 splmtryData) {
