...
@XmlType(name = "CorporateActionInstructionCancellationRequestStatusAdviceV06", propOrder = {
    "instrCxlReqId",
    "othrDocId",
    "corpActnGnlInf",
    "instrCxlReqSts",
...
public class CorporateActionInstructionCancellationRequestStatusAdviceV06 {
    ...
    protected List<InstructionCancellationRequestStatus9Choice> instrCxlReqSts;
    @XmlElement(name = "CorpActnInstr")
    protected CorporateActionOption116 corpActnInstr;
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV06 setInstrCxlReqId(DocumentIdentification9 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV06 setCorpActnGnlInf(CorporateActionGeneralInformation91 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionCancellationRequestStatus9Choice }
     * 
     * 
     */
    public List<InstructionCancellationRequestStatus9Choice> getInstrCxlReqSts() {
        if (instrCxlReqSts == null) {
            instrCxlReqSts = new ArrayList<InstructionCancellationRequestStatus9Choice>();
        }
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionOption116 }
     *     
     */
    public CorporateActionOption116 getCorpActnInstr() {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV06 setCorpActnInstr(CorporateActionOption116 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV06 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV06 addOthrDocId(DocumentIdentification33 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV06 addInstrCxlReqSts(InstructionCancellationRequestStatus9Choice instrCxlReqSts) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV06 addSplmtryData(SupplementaryData1 splmtryData) {
