...
@XmlType(name = "CorporateActionInstructionStatementReportV02", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctAndStmtDtls",
    "splmtryData"
...
public class CorporateActionInstructionStatementReportV02 {
    ...
    protected List<AccountIdentification16> acctAndStmtDtls;
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV02 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV02 setStmtGnlDtls(Statement12 value) {
     ...
     * {@link AccountIdentification16 }
     * 
     * 
     */
    public List<AccountIdentification16> getAcctAndStmtDtls() {
        if (acctAndStmtDtls == null) {
            acctAndStmtDtls = new ArrayList<AccountIdentification16>();
        }
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV02 addAcctAndStmtDtls(AccountIdentification16 acctAndStmtDtls) {
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV02 addSplmtryData(SupplementaryData1 splmtryData) {
