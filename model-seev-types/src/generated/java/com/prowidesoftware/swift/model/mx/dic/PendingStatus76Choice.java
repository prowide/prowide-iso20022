...
@XmlType(name = "PendingStatus76Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus76Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason31> rsn;
     ...
     *     
     */
    public PendingStatus76Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason31 }
     * 
     * 
     */
    public List<PendingStatusReason31> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason31>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus76Choice addRsn(PendingStatusReason31 rsn) {
        getRsn().add(rsn);
        return this;
    }
