...
@XmlType(name = "AcceptedStatus5Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class AcceptedStatus5Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<AcceptedStatusReason5> rsn;
     ...
     *     
     */
    public AcceptedStatus5Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link AcceptedStatusReason5 }
     * 
     * 
     */
    public List<AcceptedStatusReason5> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<AcceptedStatusReason5>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AcceptedStatus5Choice addRsn(AcceptedStatusReason5 rsn) {
        getRsn().add(rsn);
        return this;
    }
