...
@XmlType(name = "RejectedStatus56Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus56Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason56> rsn;
     ...
     *     
     */
    public RejectedStatus56Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason56 }
     * 
     * 
     */
    public List<RejectedStatusReason56> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason56>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus56Choice addRsn(RejectedStatusReason56 rsn) {
        getRsn().add(rsn);
        return this;
    }
