...
@XmlType(name = "CorporateActionInstructionStatusAdviceV06", propOrder = {
    "instrId",
    "othrDocId",
    "corpActnGnlInf",
    "instrPrcgSts",
...
public class CorporateActionInstructionStatusAdviceV06 {
    ...
    protected List<InstructionProcessingStatus20Choice> instrPrcgSts;
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV06 setInstrId(DocumentIdentification9 value) {
        this.instrId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV06 setCorpActnGnlInf(CorporateActionGeneralInformation52 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionProcessingStatus20Choice }
     * 
     * 
     */
    public List<InstructionProcessingStatus20Choice> getInstrPrcgSts() {
        if (instrPrcgSts == null) {
            instrPrcgSts = new ArrayList<InstructionProcessingStatus20Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV06 setCorpActnInstr(CorporateActionOption41 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV06 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV06 addOthrDocId(DocumentIdentification14 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV06 addInstrPrcgSts(InstructionProcessingStatus20Choice instrPrcgSts) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV06 addSplmtryData(SupplementaryData1 splmtryData) {
