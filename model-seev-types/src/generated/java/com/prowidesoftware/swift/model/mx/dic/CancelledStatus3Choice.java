...
@XmlType(name = "CancelledStatus3Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class CancelledStatus3Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<CancelledStatusReason6> rsn;
     ...
     *     
     */
    public CancelledStatus3Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link CancelledStatusReason6 }
     * 
     * 
     */
    public List<CancelledStatusReason6> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<CancelledStatusReason6>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public CancelledStatus3Choice addRsn(CancelledStatusReason6 rsn) {
        getRsn().add(rsn);
        return this;
    }
