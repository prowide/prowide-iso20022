...
@XmlType(name = "AccountIdentification73Choice", propOrder = {
    "forAllAccts",
    "acctsList"
})
public class AccountIdentification73Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsList")
    protected List<AccountIdentification69> acctsList;
     ...
     *     
     */
    public AccountIdentification73Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * 
     */
    public List<AccountIdentification69> getAcctsList() {
        if (acctsList == null) {
            acctsList = new ArrayList<AccountIdentification69>();
        }
     ...
     * 
     */
    public AccountIdentification73Choice addAcctsList(AccountIdentification69 acctsList) {
