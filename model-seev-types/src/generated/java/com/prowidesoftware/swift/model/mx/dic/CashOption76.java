...
public class CashOption76 {
     ...
     *     
     */
    public CashOption76 setCdtDbtInd(CreditDebitCode value) {
     ...
     *     
     */
    public CashOption76 setCshAcctId(CashAccountIdentification5Choice value) {
     ...
     *     
     */
    public CashOption76 setGrssCshAmt(ActiveCurrencyAndAmount value) {
     ...
     *     
     */
    public CashOption76 setNetCshAmt(ActiveCurrencyAndAmount value) {
     ...
     *     
     */
    public CashOption76 setEntitldAmt(ActiveCurrencyAndAmount value) {
     ...
     *     
     */
    public CashOption76 setWhldgTaxAmt(ActiveCurrencyAndAmount value) {
     ...
     *     
     */
    public CashOption76 setEarlstPmtDt(DateAndDateTime2Choice value) {
     ...
     *     
     */
    public CashOption76 setPmtDt(DateFormat43Choice value) {
        this.pmtDt = value;
        return this;
    }
     ...
     * 
     */
    public CashOption76 addWhldgTaxRate(RateAndAmountFormat40Choice whldgTaxRate) {
