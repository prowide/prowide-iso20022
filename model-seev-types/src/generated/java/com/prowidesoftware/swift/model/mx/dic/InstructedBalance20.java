...
@XmlType(name = "InstructedBalance20", propOrder = {
    "ttlInstdBal",
    "ttlAccptdInstrBal",
    "ttlCancInstrBal",
    "ttlPdgInstrBal",
...
public class InstructedBalance20 {
    ...
    protected List<InstructedCorporateActionOption21> optnDtls;
     ...
     *     
     */
    public InstructedBalance20 setTtlInstdBal(BalanceFormat11Choice value) {
     ...
     *     
     */
    public InstructedBalance20 setTtlAccptdInstrBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public InstructedBalance20 setTtlCancInstrBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public InstructedBalance20 setTtlPdgInstrBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public InstructedBalance20 setTtlRjctdInstrBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public InstructedBalance20 setTtlPrtctInstrBal(SignedQuantityFormat10 value) {
     ...
     * {@link InstructedCorporateActionOption21 }
     * 
     * 
     */
    public List<InstructedCorporateActionOption21> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<InstructedCorporateActionOption21>();
        }
     ...
     * 
     */
    public InstructedBalance20 addOptnDtls(InstructedCorporateActionOption21 optnDtls) {
