...
@XmlType(name = "RejectedStatus38Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus38Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason36> rsn;
     ...
     *     
     */
    public RejectedStatus38Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason36 }
     * 
     * 
     */
    public List<RejectedStatusReason36> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason36>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus38Choice addRsn(RejectedStatusReason36 rsn) {
        getRsn().add(rsn);
        return this;
    }
