...
@XmlType(name = "AccountIdentification23Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification23Choice {
    ...
    protected List<AccountAndBalance25> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification23Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance25 }
     * 
     * 
     */
    public List<AccountAndBalance25> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance25>();
        }
     ...
     * 
     */
    public AccountIdentification23Choice addAcctsListAndBalDtls(AccountAndBalance25 acctsListAndBalDtls) {
