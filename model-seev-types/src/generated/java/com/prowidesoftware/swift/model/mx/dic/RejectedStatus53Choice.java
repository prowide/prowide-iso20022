...
@XmlType(name = "RejectedStatus53Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus53Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason52> rsn;
     ...
     *     
     */
    public RejectedStatus53Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason52 }
     * 
     * 
     */
    public List<RejectedStatusReason52> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason52>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus53Choice addRsn(RejectedStatusReason52 rsn) {
        getRsn().add(rsn);
        return this;
    }
