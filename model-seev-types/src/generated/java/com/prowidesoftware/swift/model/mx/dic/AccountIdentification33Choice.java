...
@XmlType(name = "AccountIdentification33Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification33Choice {
    ...
    protected List<AccountIdentification32> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification33Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification32 }
     * 
     * 
     */
    public List<AccountIdentification32> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountIdentification32>();
        }
     ...
     * 
     */
    public AccountIdentification33Choice addAcctsListAndBalDtls(AccountIdentification32 acctsListAndBalDtls) {
