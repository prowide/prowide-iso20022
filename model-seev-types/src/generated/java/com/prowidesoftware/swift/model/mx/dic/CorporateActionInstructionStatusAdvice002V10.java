...
@XmlType(name = "CorporateActionInstructionStatusAdvice002V10", propOrder = {
    "instrId",
    "othrDocId",
    "corpActnGnlInf",
    "instrPrcgSts",
...
public class CorporateActionInstructionStatusAdvice002V10 {
    ...
    protected List<InstructionProcessingStatus34Choice> instrPrcgSts;
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V10 setInstrId(DocumentIdentification17 value) {
        this.instrId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V10 setCorpActnGnlInf(CorporateActionGeneralInformation114 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionProcessingStatus34Choice }
     * 
     * 
     */
    public List<InstructionProcessingStatus34Choice> getInstrPrcgSts() {
        if (instrPrcgSts == null) {
            instrPrcgSts = new ArrayList<InstructionProcessingStatus34Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V10 setCorpActnInstr(CorporateActionOption156 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V10 setPrtctInstr(ProtectInstruction6 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V10 setAddtlInf(CorporateActionNarrative19 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V10 addOthrDocId(DocumentIdentification34 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V10 addInstrPrcgSts(InstructionProcessingStatus34Choice instrPrcgSts) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V10 addSplmtryData(SupplementaryData1 splmtryData) {
