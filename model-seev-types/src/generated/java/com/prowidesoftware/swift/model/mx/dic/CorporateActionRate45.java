...
@XmlType(name = "CorporateActionRate45", propOrder = {
    "addtlTax",
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
...
public class CorporateActionRate45 {
     ...
     *     
     */
    public CorporateActionRate45 setAddtlTax(RateAndAmountFormat14Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate45 setIndxFctr(RateAndAmountFormat14Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate45 setMaxAllwdOvrsbcptRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate45 setPrratnRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate45 setTaxOnIncm(RateAndAmountFormat14Choice value) {
     ...
     * 
     */
    public CorporateActionRate45 addGrssDvddRate(GrossDividendRateFormat9Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate45 addNetDvddRate(NetDividendRateFormat11Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate45 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat5Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate45 addWhldgTaxRate(RateFormat10Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate45 addWhldgOfFrgnTax(RateAndAmountFormat20Choice whldgOfFrgnTax) {
     ...
     * 
     */
    public CorporateActionRate45 addTaxRltdRate(RateTypeAndAmountAndStatus6 taxRltdRate) {
     ...
     * 
     */
    public CorporateActionRate45 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus11 taxblIncmPerDvddShr) {
