...
@XmlType(name = "AccountIdentification9Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification9Choice {
    ...
    protected List<AccountIdentification7> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification9Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification7 }
     * 
     * 
     */
    public List<AccountIdentification7> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountIdentification7>();
        }
     ...
     * 
     */
    public AccountIdentification9Choice addAcctsListAndBalDtls(AccountIdentification7 acctsListAndBalDtls) {
