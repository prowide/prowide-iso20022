...
@XmlType(name = "PartyIdentification34", propOrder = {
    "ownrId",
    "altrnId",
    "dmclCtry",
    "nonDmclCtry",
...
public class PartyIdentification34 {
    ...
    protected PartyIdentification16Choice ownrId;
     ...
     *     
     */
    public PartyIdentification16Choice getOwnrId() {
        return ownrId;
    }
     ...
     *     
     */
    public PartyIdentification34 setOwnrId(PartyIdentification16Choice value) {
        this.ownrId = value;
        return this;
    }
     ...
     *     
     */
    public PartyIdentification34 setDmclCtry(String value) {
        this.dmclCtry = value;
        return this;
    }
     ...
     *     
     */
    public PartyIdentification34 setOwndSctiesQty(FinancialInstrumentQuantity15Choice value) {
    ...
    public List<BeneficiaryCertificationType4Choice> getCertfctnTp() {
        if (certfctnTp == null) {
            certfctnTp = new ArrayList<BeneficiaryCertificationType4Choice>();
        }
     ...
     *     
     */
    public PartyIdentification34 setDclrtnDtls(String value) {
     ...
     * 
     */
    public PartyIdentification34 addAltrnId(AlternatePartyIdentification3 altrnId) {
     ...
     * 
     */
    public PartyIdentification34 addNonDmclCtry(String nonDmclCtry) {
     ...
     * 
     */
    public PartyIdentification34 addCertfctnTp(BeneficiaryCertificationType4Choice certfctnTp) {
