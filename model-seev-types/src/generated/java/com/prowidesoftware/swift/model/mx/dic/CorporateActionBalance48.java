...
@XmlType(name = "CorporateActionBalance48", propOrder = {
    "ttlElgblBal",
    "uinstdBal",
    "ttlInstdBalDtls",
    "blckdBal",
...
public class CorporateActionBalance48 {
    ...
    protected InstructedBalance18 ttlInstdBalDtls;
     ...
     *     
     */
    public CorporateActionBalance48 setTtlElgblBal(Quantity49Choice value) {
     ...
     *     
     */
    public CorporateActionBalance48 setUinstdBal(BalanceFormat11Choice value) {
     ...
     * @return
     *     possible object is
     *     {@link InstructedBalance18 }
     *     
     */
    public InstructedBalance18 getTtlInstdBalDtls() {
     ...
     *     
     */
    public CorporateActionBalance48 setTtlInstdBalDtls(InstructedBalance18 value) {
     ...
     *     
     */
    public CorporateActionBalance48 setBlckdBal(SignedQuantityFormat10 value) {
        this.blckdBal = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionBalance48 setBrrwdBal(SignedQuantityFormat10 value) {
        this.brrwdBal = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionBalance48 setCollInBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public CorporateActionBalance48 setCollOutBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public CorporateActionBalance48 setOnLnBal(SignedQuantityFormat10 value) {
        this.onLnBal = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionBalance48 setOutForRegnBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public CorporateActionBalance48 setSttlmPosBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public CorporateActionBalance48 setStrtPosBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public CorporateActionBalance48 setTradDtPosBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public CorporateActionBalance48 setInTrnsShipmntBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public CorporateActionBalance48 setRegdBal(SignedQuantityFormat10 value) {
        this.regdBal = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionBalance48 setOblgtdBal(SignedQuantityFormat10 value) {
    ...
    public List<PendingBalance7> getPdgDlvryBal() {
        if (pdgDlvryBal == null) {
            pdgDlvryBal = new ArrayList<PendingBalance7>();
        }
    ...
    public List<PendingBalance7> getPdgRctBal() {
        if (pdgRctBal == null) {
            pdgRctBal = new ArrayList<PendingBalance7>();
        }
     ...
     * 
     */
    public CorporateActionBalance48 addPdgDlvryBal(PendingBalance7 pdgDlvryBal) {
     ...
     * 
     */
    public CorporateActionBalance48 addPdgRctBal(PendingBalance7 pdgRctBal) {
