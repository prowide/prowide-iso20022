...
@XmlType(name = "RejectedStatus29Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus29Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason29> rsn;
     ...
     *     
     */
    public RejectedStatus29Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason29 }
     * 
     * 
     */
    public List<RejectedStatusReason29> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason29>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus29Choice addRsn(RejectedStatusReason29 rsn) {
        getRsn().add(rsn);
        return this;
    }
