...
@XmlType(name = "PendingStatus57Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus57Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason17> rsn;
     ...
     *     
     */
    public PendingStatus57Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason17 }
     * 
     * 
     */
    public List<PendingStatusReason17> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason17>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus57Choice addRsn(PendingStatusReason17 rsn) {
        getRsn().add(rsn);
        return this;
    }
