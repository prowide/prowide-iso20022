...
@XmlType(name = "PercentagePrice3", propOrder = {
    "pctgPricTp",
    "pricVal"
})
public class PercentagePrice3 {
     ...
     *     
     */
    public PercentagePrice3 setPctgPricTp(PriceRateType3Code value) {
     ...
     *     
     */
    public PercentagePrice3 setPricVal(BigDecimal value) {
        this.pricVal = value;
        return this;
    }
