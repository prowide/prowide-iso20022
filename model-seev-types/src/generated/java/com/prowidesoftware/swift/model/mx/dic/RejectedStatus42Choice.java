...
@XmlType(name = "RejectedStatus42Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus42Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason40> rsn;
     ...
     *     
     */
    public RejectedStatus42Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason40 }
     * 
     * 
     */
    public List<RejectedStatusReason40> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason40>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus42Choice addRsn(RejectedStatusReason40 rsn) {
        getRsn().add(rsn);
        return this;
    }
