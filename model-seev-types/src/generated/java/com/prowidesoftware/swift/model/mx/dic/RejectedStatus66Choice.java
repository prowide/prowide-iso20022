...
@XmlType(name = "RejectedStatus66Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus66Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason65> rsn;
     ...
     *     
     */
    public RejectedStatus66Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason65 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<RejectedStatusReason65> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public RejectedStatus66Choice addRsn(RejectedStatusReason65 rsn) {
        getRsn().add(rsn);
        return this;
    }
