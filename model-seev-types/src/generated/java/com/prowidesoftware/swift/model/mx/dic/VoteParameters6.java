...
@XmlType(name = "VoteParameters6", propOrder = {
...
public class VoteParameters6 {
     ...
     *     
     */
    public VoteParameters6 setSctiesQtyReqrdToVote(FinancialInstrumentQuantity18Choice value) {
     ...
     * 
     */
    public VoteParameters6 setPrtlVoteAllwd(boolean value) {
     ...
     * 
     */
    public VoteParameters6 setSpltVoteAllwd(boolean value) {
     ...
     *     
     */
    public VoteParameters6 setVoteDdln(DateFormat58Choice value) {
        this.voteDdln = value;
        return this;
    }
     ...
     *     
     */
    public VoteParameters6 setVoteMktDdln(DateFormat58Choice value) {
     ...
     *     
     */
    public VoteParameters6 setVoteMthds(VoteMethods3 value) {
     ...
     *     
     */
    public VoteParameters6 setVtngBlltElctrncAdr(CommunicationAddress11 value) {
     ...
     *     
     */
    public VoteParameters6 setVtngBlltReqAdr(PostalAddress1 value) {
     ...
     *     
     */
    public VoteParameters6 setRvcbltyDdln(DateFormat58Choice value) {
     ...
     *     
     */
    public VoteParameters6 setRvcbltyMktDdln(DateFormat58Choice value) {
     ...
     *     
     */
    public VoteParameters6 setBnfclOwnrDsclsr(Boolean value) {
     ...
     *     
     */
    public VoteParameters6 setEarlyIncntivPrm(IncentivePremium5 value) {
     ...
     *     
     */
    public VoteParameters6 setIncntivPrm(IncentivePremium5 value) {
     ...
     *     
     */
    public VoteParameters6 setEarlyVoteWthPrmDdln(DateFormat58Choice value) {
     ...
     *     
     */
    public VoteParameters6 setVoteWthPrmDdln(DateFormat58Choice value) {
     ...
     *     
     */
    public VoteParameters6 setVoteWthPrmMktDdln(DateFormat58Choice value) {
     ...
     *     
     */
    public VoteParameters6 setAddtlVtngRqrmnts(String value) {
     ...
     *     
     */
    public VoteParameters6 setPrvsInstrInvldtyInd(Boolean value) {
