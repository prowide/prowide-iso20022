...
@XmlType(name = "PendingStatus41Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus41Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason9> rsn;
     ...
     *     
     */
    public PendingStatus41Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason9 }
     * 
     * 
     */
    public List<PendingStatusReason9> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason9>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus41Choice addRsn(PendingStatusReason9 rsn) {
        getRsn().add(rsn);
        return this;
    }
