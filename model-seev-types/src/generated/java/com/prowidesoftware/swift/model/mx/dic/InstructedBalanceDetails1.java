...
@XmlType(name = "InstructedBalanceDetails1", propOrder = {
    "ttlInstdBal",
    "optnDtls"
})
public class InstructedBalanceDetails1 {
    ...
    protected List<InstructedCorporateActionOption1> optnDtls;
     ...
     *     
     */
    public InstructedBalanceDetails1 setTtlInstdBal(BalanceFormat1Choice value) {
     ...
     * {@link InstructedCorporateActionOption1 }
     * 
     * 
     */
    public List<InstructedCorporateActionOption1> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<InstructedCorporateActionOption1>();
        }
     ...
     * 
     */
    public InstructedBalanceDetails1 addOptnDtls(InstructedCorporateActionOption1 optnDtls) {
