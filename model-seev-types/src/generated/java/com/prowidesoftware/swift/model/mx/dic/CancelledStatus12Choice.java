...
@XmlType(name = "CancelledStatus12Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class CancelledStatus12Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<CancelledStatusReason11> rsn;
     ...
     *     
     */
    public CancelledStatus12Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link CancelledStatusReason11 }
     * 
     * 
     */
    public List<CancelledStatusReason11> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<CancelledStatusReason11>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public CancelledStatus12Choice addRsn(CancelledStatusReason11 rsn) {
        getRsn().add(rsn);
        return this;
    }
