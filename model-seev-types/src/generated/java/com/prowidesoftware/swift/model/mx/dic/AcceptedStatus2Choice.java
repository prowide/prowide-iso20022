...
@XmlType(name = "AcceptedStatus2Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class AcceptedStatus2Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<AcceptedStatusReason2> rsn;
     ...
     *     
     */
    public AcceptedStatus2Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link AcceptedStatusReason2 }
     * 
     * 
     */
    public List<AcceptedStatusReason2> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<AcceptedStatusReason2>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AcceptedStatus2Choice addRsn(AcceptedStatusReason2 rsn) {
        getRsn().add(rsn);
        return this;
    }
