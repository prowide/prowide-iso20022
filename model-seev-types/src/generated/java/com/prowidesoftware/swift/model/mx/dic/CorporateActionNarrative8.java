...
@XmlType(name = "CorporateActionNarrative8", propOrder = {
    "infToCmplyWth",
    "dlvryDtls",
    "fxInstrsAddtlInf",
    "dsclmr",
...
public class CorporateActionNarrative8 {
     ...
     * 
     */
    public CorporateActionNarrative8 addInfToCmplyWth(String infToCmplyWth) {
     ...
     * 
     */
    public CorporateActionNarrative8 addDlvryDtls(String dlvryDtls) {
     ...
     * 
     */
    public CorporateActionNarrative8 addFXInstrsAddtlInf(String fXInstrsAddtlInf) {
     ...
     * 
     */
    public CorporateActionNarrative8 addDsclmr(String dsclmr) {
     ...
     * 
     */
    public CorporateActionNarrative8 addInstrAddtlInf(String instrAddtlInf) {
