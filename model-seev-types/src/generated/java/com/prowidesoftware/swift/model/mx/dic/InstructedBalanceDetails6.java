...
@XmlType(name = "InstructedBalanceDetails6", propOrder = {
    "ttlInstdBal",
    "optnDtls"
})
public class InstructedBalanceDetails6 {
    ...
    protected List<InstructedCorporateActionOption7> optnDtls;
     ...
     *     
     */
    public InstructedBalanceDetails6 setTtlInstdBal(BalanceFormat7Choice value) {
     ...
     * {@link InstructedCorporateActionOption7 }
     * 
     * 
     */
    public List<InstructedCorporateActionOption7> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<InstructedCorporateActionOption7>();
        }
     ...
     * 
     */
    public InstructedBalanceDetails6 addOptnDtls(InstructedCorporateActionOption7 optnDtls) {
