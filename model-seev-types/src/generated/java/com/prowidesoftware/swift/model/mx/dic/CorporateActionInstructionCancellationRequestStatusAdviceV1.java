...
@XmlType(name = "CorporateActionInstructionCancellationRequestStatusAdviceV1", propOrder = {
    "id",
    "instrCxlReqId",
    "othrDocId",
    "corpActnGnlInf",
...
public class CorporateActionInstructionCancellationRequestStatusAdviceV1 {
    ...
    protected List<InstructionCancellationRequestStatus1Choice> instrCxlReqSts;
    @XmlElement(name = "CorpActnInstr")
    protected CorporateActionOption9 corpActnInstr;
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV1 setId(DocumentIdentification11 value) {
        this.id = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV1 setInstrCxlReqId(DocumentIdentification9 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV1 setCorpActnGnlInf(CorporateActionGeneralInformation9 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionCancellationRequestStatus1Choice }
     * 
     * 
     */
    public List<InstructionCancellationRequestStatus1Choice> getInstrCxlReqSts() {
        if (instrCxlReqSts == null) {
            instrCxlReqSts = new ArrayList<InstructionCancellationRequestStatus1Choice>();
        }
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionOption9 }
     *     
     */
    public CorporateActionOption9 getCorpActnInstr() {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV1 setCorpActnInstr(CorporateActionOption9 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV1 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV1 setMsgOrgtr(PartyIdentification10Choice value) {
        this.msgOrgtr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV1 setMsgRcpt(PartyIdentification10Choice value) {
        this.msgRcpt = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV1 addOthrDocId(DocumentIdentification14 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV1 addInstrCxlReqSts(InstructionCancellationRequestStatus1Choice instrCxlReqSts) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV1 addXtnsn(Extension2 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
