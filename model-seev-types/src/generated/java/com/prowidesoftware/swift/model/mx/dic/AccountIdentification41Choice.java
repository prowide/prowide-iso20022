...
@XmlType(name = "AccountIdentification41Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification41Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountAndBalance42> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification41Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance42 }
     * 
     * 
     */
    public List<AccountAndBalance42> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance42>();
        }
     ...
     * 
     */
    public AccountIdentification41Choice addAcctsListAndBalDtls(AccountAndBalance42 acctsListAndBalDtls) {
