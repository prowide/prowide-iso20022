...
@XmlType(name = "PendingStatus78Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus78Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason32> rsn;
     ...
     *     
     */
    public PendingStatus78Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason32 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingStatusReason32> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingStatus78Choice addRsn(PendingStatusReason32 rsn) {
        getRsn().add(rsn);
        return this;
    }
