...
@XmlType(name = "RejectedStatus39Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus39Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason37> rsn;
     ...
     *     
     */
    public RejectedStatus39Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason37 }
     * 
     * 
     */
    public List<RejectedStatusReason37> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason37>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus39Choice addRsn(RejectedStatusReason37 rsn) {
        getRsn().add(rsn);
        return this;
    }
