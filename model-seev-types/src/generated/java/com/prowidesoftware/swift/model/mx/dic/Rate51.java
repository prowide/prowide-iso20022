...
public class Rate51 {
     ...
     *     
     */
    public Rate51 setAddtlTax(RateAndAmountFormat59Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public Rate51 setChrgsFees(RateAndAmountFormat59Choice value) {
     ...
     *     
     */
    public Rate51 setFsclStmp(BigDecimal value) {
        this.fsclStmp = value;
        return this;
    }
     ...
     *     
     */
    public Rate51 setEarlySlctnFeeRate(SolicitationFeeRateFormat12Choice value) {
     ...
     *     
     */
    public Rate51 setThrdPtyIncntivRate(RateAndAmountFormat59Choice value) {
     ...
     *     
     */
    public Rate51 setAplblRate(RateFormat31Choice value) {
     ...
     *     
     */
    public Rate51 setSlctnFeeRate(SolicitationFeeRateFormat12Choice value) {
     ...
     *     
     */
    public Rate51 setTaxCdtRate(RateFormat27Choice value) {
     ...
     *     
     */
    public Rate51 setTaxOnIncm(RateAndAmountFormat59Choice value) {
     ...
     *     
     */
    public Rate51 setTaxOnPrfts(BigDecimal value) {
     ...
     *     
     */
    public Rate51 setTaxRclmRate(BigDecimal value) {
     ...
     *     
     */
    public Rate51 setEqulstnRate(ActiveCurrencyAnd13DecimalAmount value) {
     ...
     * 
     */
    public Rate51 addGrssDstrbtnRate(GrossDividendRateFormat37Choice grssDstrbtnRate) {
     ...
     * 
     */
    public Rate51 addGrssIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat12Choice grssIntrstRateUsdForPmt) {
     ...
     * 
     */
    public Rate51 addNetDstrbtnRate(NetDividendRateFormat40Choice netDstrbtnRate) {
     ...
     * 
     */
    public Rate51 addWhldgTaxRate(RateAndAmountFormat55Choice whldgTaxRate) {
     ...
     * 
     */
    public Rate51 addScndLvlTax(RateAndAmountFormat55Choice scndLvlTax) {
     ...
     * 
     */
    public Rate51 addDmdRate(RateAndAmountFormat62Choice dmdRate) {
