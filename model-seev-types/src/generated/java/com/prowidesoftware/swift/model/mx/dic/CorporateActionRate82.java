...
@XmlType(name = "CorporateActionRate82", propOrder = {
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
    "intrstRateUsdForPmt",
...
public class CorporateActionRate82 {
     ...
     *     
     */
    public CorporateActionRate82 setIndxFctr(RateAndAmountFormat39Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate82 setMaxAllwdOvrsbcptRate(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionRate82 setPrratnRate(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionRate82 setAddtlTax(RateAndAmountFormat39Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionRate82 addGrssDvddRate(GrossDividendRateFormat21Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate82 addNetDvddRate(NetDividendRateFormat23Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate82 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat7Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate82 addWhldgTaxRate(RateAndAmountFormat40Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate82 addScndLvlTax(RateAndAmountFormat40Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate82 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus26 taxblIncmPerDvddShr) {
