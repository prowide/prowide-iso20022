...
@XmlType(name = "AccountIdentification34Choice", propOrder = {
    "forAllAccts",
    "acctsList"
})
public class AccountIdentification34Choice {
    ...
    protected List<AccountIdentification34> acctsList;
     ...
     *     
     */
    public AccountIdentification34Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification34 }
     * 
     * 
     */
    public List<AccountIdentification34> getAcctsList() {
        if (acctsList == null) {
            acctsList = new ArrayList<AccountIdentification34>();
        }
     ...
     * 
     */
    public AccountIdentification34Choice addAcctsList(AccountIdentification34 acctsList) {
