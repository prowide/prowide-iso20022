...
public class CorporateActionNarrative51 {
    ...
    public List<UpdatedAdditionalInformation13> getPrcgTxtForNxtIntrmy() {
        if (prcgTxtForNxtIntrmy == null) {
            prcgTxtForNxtIntrmy = new ArrayList<UpdatedAdditionalInformation13>();
        }
     ...
     * 
     */
    public CorporateActionNarrative51 addAddtlTxt(UpdatedAdditionalInformation13 addtlTxt) {
     ...
     * 
     */
    public CorporateActionNarrative51 addNrrtvVrsn(UpdatedAdditionalInformation13 nrrtvVrsn) {
     ...
     * 
     */
    public CorporateActionNarrative51 addInfConds(UpdatedAdditionalInformation13 infConds) {
     ...
     * 
     */
    public CorporateActionNarrative51 addInfToCmplyWth(UpdatedAdditionalInformation13 infToCmplyWth) {
     ...
     * 
     */
    public CorporateActionNarrative51 addTaxtnConds(UpdatedAdditionalInformation13 taxtnConds) {
     ...
     * 
     */
    public CorporateActionNarrative51 addDsclmr(UpdatedAdditionalInformation13 dsclmr) {
     ...
     * 
     */
    public CorporateActionNarrative51 addPtyCtctNrrtv(UpdatedAdditionalInformation13 ptyCtctNrrtv) {
     ...
     * 
     */
    public CorporateActionNarrative51 addRegnDtls(UpdatedAdditionalInformation13 regnDtls) {
     ...
     * 
     */
    public CorporateActionNarrative51 addBsktOrIndxInf(UpdatedAdditionalInformation13 bsktOrIndxInf) {
     ...
     * 
     */
    public CorporateActionNarrative51 addCertfctnBrkdwn(UpdatedAdditionalInformation13 certfctnBrkdwn) {
     ...
     * 
     */
    public CorporateActionNarrative51 addURLAdr(UpdatedURLlnformation4 uRLAdr) {
     ...
     * 
     */
    public CorporateActionNarrative51 addPrcgTxtForNxtIntrmy(UpdatedAdditionalInformation13 prcgTxtForNxtIntrmy) {
