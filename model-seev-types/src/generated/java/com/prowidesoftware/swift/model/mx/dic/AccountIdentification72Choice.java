...
@XmlType(name = "AccountIdentification72Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification72Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountIdentification71> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification72Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification71 }
     * 
     * 
     */
    public List<AccountIdentification71> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountIdentification71>();
        }
     ...
     * 
     */
    public AccountIdentification72Choice addAcctsListAndBalDtls(AccountIdentification71 acctsListAndBalDtls) {
