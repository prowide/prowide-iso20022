...
@XmlType(name = "PendingCancellationStatus19Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingCancellationStatus19Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingCancellationStatusReason14> rsn;
     ...
     *     
     */
    public PendingCancellationStatus19Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingCancellationStatusReason14 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingCancellationStatusReason14> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingCancellationStatus19Choice addRsn(PendingCancellationStatusReason14 rsn) {
        getRsn().add(rsn);
        return this;
    }
