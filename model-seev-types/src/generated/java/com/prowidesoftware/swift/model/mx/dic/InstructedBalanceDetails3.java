...
@XmlType(name = "InstructedBalanceDetails3", propOrder = {
    "ttlInstdBal",
    "optnDtls"
})
public class InstructedBalanceDetails3 {
    ...
    protected BalanceFormat1Choice ttlInstdBal;
    @XmlElement(name = "OptnDtls")
    protected List<InstructedCorporateActionOption4> optnDtls;
     ...
     *     
     */
    public BalanceFormat1Choice getTtlInstdBal() {
        return ttlInstdBal;
    }
     ...
     *     
     */
    public InstructedBalanceDetails3 setTtlInstdBal(BalanceFormat1Choice value) {
     ...
     * {@link InstructedCorporateActionOption4 }
     * 
     * 
     */
    public List<InstructedCorporateActionOption4> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<InstructedCorporateActionOption4>();
        }
     ...
     * 
     */
    public InstructedBalanceDetails3 addOptnDtls(InstructedCorporateActionOption4 optnDtls) {
