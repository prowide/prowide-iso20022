...
@XmlType(name = "CorporateActionInstructionCancellationRequestStatusAdviceV12", propOrder = {
    "instrCxlReqId",
    "othrDocId",
    "corpActnGnlInf",
    "instrCxlReqSts",
...
public class CorporateActionInstructionCancellationRequestStatusAdviceV12 {
    ...
    protected List<InstructionCancellationRequestStatus13Choice> instrCxlReqSts;
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV12 setInstrCxlReqId(DocumentIdentification9 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV12 setCorpActnGnlInf(CorporateActionGeneralInformation154 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionCancellationRequestStatus13Choice }
     * 
     * 
     */
    public List<InstructionCancellationRequestStatus13Choice> getInstrCxlReqSts() {
        if (instrCxlReqSts == null) {
            instrCxlReqSts = new ArrayList<InstructionCancellationRequestStatus13Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV12 setCorpActnInstr(CorporateActionOption197 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV12 setPrtctInstr(ProtectInstruction4 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV12 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV12 addOthrDocId(DocumentIdentification33 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV12 addInstrCxlReqSts(InstructionCancellationRequestStatus13Choice instrCxlReqSts) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV12 addSplmtryData(SupplementaryData1 splmtryData) {
