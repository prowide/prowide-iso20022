...
@XmlType(name = "AccountIdentification18Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification18Choice {
    ...
    protected List<AccountAndBalance15> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification18Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance15 }
     * 
     * 
     */
    public List<AccountAndBalance15> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance15>();
        }
     ...
     * 
     */
    public AccountIdentification18Choice addAcctsListAndBalDtls(AccountAndBalance15 acctsListAndBalDtls) {
