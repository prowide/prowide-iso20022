...
@XmlType(name = "CorporateActionBalance44", propOrder = {
    "ttlElgblBal",
    "uinstdBal",
    "ttlInstdBalDtls",
    "blckdBal",
...
public class CorporateActionBalance44 {
    ...
    protected InstructedBalance14 ttlInstdBalDtls;
     ...
     *     
     */
    public CorporateActionBalance44 setTtlElgblBal(Quantity17Choice value) {
     ...
     *     
     */
    public CorporateActionBalance44 setUinstdBal(BalanceFormat5Choice value) {
     ...
     * @return
     *     possible object is
     *     {@link InstructedBalance14 }
     *     
     */
    public InstructedBalance14 getTtlInstdBalDtls() {
     ...
     *     
     */
    public CorporateActionBalance44 setTtlInstdBalDtls(InstructedBalance14 value) {
     ...
     *     
     */
    public CorporateActionBalance44 setBlckdBal(SignedQuantityFormat6 value) {
        this.blckdBal = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionBalance44 setBrrwdBal(SignedQuantityFormat6 value) {
        this.brrwdBal = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionBalance44 setCollInBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public CorporateActionBalance44 setCollOutBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public CorporateActionBalance44 setOnLnBal(SignedQuantityFormat6 value) {
        this.onLnBal = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionBalance44 setOutForRegnBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public CorporateActionBalance44 setSttlmPosBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public CorporateActionBalance44 setStrtPosBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public CorporateActionBalance44 setTradDtPosBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public CorporateActionBalance44 setInTrnsShipmntBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public CorporateActionBalance44 setRegdBal(SignedQuantityFormat6 value) {
        this.regdBal = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionBalance44 setOblgtdBal(SignedQuantityFormat6 value) {
     ...
     * 
     */
    public CorporateActionBalance44 addPdgDlvryBal(PendingBalance5 pdgDlvryBal) {
     ...
     * 
     */
    public CorporateActionBalance44 addPdgRctBal(PendingBalance5 pdgRctBal) {
