...
@XmlType(name = "PendingStatus58Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus58Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason18> rsn;
     ...
     *     
     */
    public PendingStatus58Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason18 }
     * 
     * 
     */
    public List<PendingStatusReason18> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason18>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus58Choice addRsn(PendingStatusReason18 rsn) {
        getRsn().add(rsn);
        return this;
    }
