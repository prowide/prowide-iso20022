...
@XmlType(name = "PendingStatus44Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus44Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason12> rsn;
     ...
     *     
     */
    public PendingStatus44Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason12 }
     * 
     * 
     */
    public List<PendingStatusReason12> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason12>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus44Choice addRsn(PendingStatusReason12 rsn) {
        getRsn().add(rsn);
        return this;
    }
