...
@XmlType(name = "AcceptedStatus13Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class AcceptedStatus13Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<AcceptedStatusReason14> rsn;
     ...
     *     
     */
    public AcceptedStatus13Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link AcceptedStatusReason14 }
     * 
     * 
     */
    public List<AcceptedStatusReason14> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<AcceptedStatusReason14>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AcceptedStatus13Choice addRsn(AcceptedStatusReason14 rsn) {
        getRsn().add(rsn);
        return this;
    }
