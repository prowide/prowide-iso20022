...
@XmlType(name = "PendingStatus74Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus74Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason29> rsn;
     ...
     *     
     */
    public PendingStatus74Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason29 }
     * 
     * 
     */
    public List<PendingStatusReason29> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason29>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus74Choice addRsn(PendingStatusReason29 rsn) {
        getRsn().add(rsn);
        return this;
    }
