...
@XmlType(name = "CorporateActionRate138", propOrder = {
    "addtlTax",
    "grssDstrbtnRate",
    "netDstrbtnRate",
...
public class CorporateActionRate138 {
     ...
     *     
     */
    public CorporateActionRate138 setAddtlTax(RateAndAmountFormat57Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate138 setMaxAllwdOvrsbcptRate(RateFormat24Choice value) {
     ...
     *     
     */
    public CorporateActionRate138 setPrratnRate(RateFormat32Choice value) {
     ...
     *     
     */
    public CorporateActionRate138 setIssrDclrdXchgRate(ForeignExchangeTerms38 value) {
     ...
     *     
     */
    public CorporateActionRate138 setTaxOnIncm(RateAndAmountFormat57Choice value) {
     ...
     *     
     */
    public CorporateActionRate138 setBidIntrvl(RateAndAmountFormat58Choice value) {
     ...
     * 
     */
    public CorporateActionRate138 addGrssDstrbtnRate(GrossDividendRateFormat43Choice grssDstrbtnRate) {
     ...
     * 
     */
    public CorporateActionRate138 addNetDstrbtnRate(NetDividendRateFormat38Choice netDstrbtnRate) {
     ...
     * 
     */
    public CorporateActionRate138 addGrssIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat11Choice grssIntrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate138 addWhldgTaxRate(RateAndAmountFormat56Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate138 addScndLvlTax(RateAndAmountFormat56Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate138 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus26 taxblIncmPerDvddShr) {
