...
@XmlType(name = "CancelledStatus7Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class CancelledStatus7Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<CancelledStatusReason8> rsn;
     ...
     *     
     */
    public CancelledStatus7Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link CancelledStatusReason8 }
     * 
     * 
     */
    public List<CancelledStatusReason8> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<CancelledStatusReason8>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public CancelledStatus7Choice addRsn(CancelledStatusReason8 rsn) {
        getRsn().add(rsn);
        return this;
    }
