...
@XmlType(name = "RateDetails7", propOrder = {
    "addtlTax",
    "chrgsFees",
    "fnlDvddRate",
    "fsclStmp",
...
public class RateDetails7 {
     ...
     *     
     */
    public RateDetails7 setAddtlTax(RateAndAmountFormat5Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public RateDetails7 setChrgsFees(RateAndAmountFormat5Choice value) {
     ...
     *     
     */
    public RateDetails7 setFnlDvddRate(ActiveCurrencyAnd13DecimalAmount value) {
     ...
     *     
     */
    public RateDetails7 setFsclStmp(BigDecimal value) {
        this.fsclStmp = value;
        return this;
    }
     ...
     *     
     */
    public RateDetails7 setFullyFrnkdRate(RateAndAmountFormat5Choice value) {
     ...
     *     
     */
    public RateDetails7 setEarlySlctnFeeRate(BigDecimal value) {
     ...
     *     
     */
    public RateDetails7 setCshIncntivRate(BigDecimal value) {
     ...
     *     
     */
    public RateDetails7 setNonResdtRate(RateAndAmountFormat5Choice value) {
     ...
     *     
     */
    public RateDetails7 setPrvsnlDvddRate(ActiveCurrencyAnd13DecimalAmount value) {
     ...
     *     
     */
    public RateDetails7 setAplblRate(BigDecimal value) {
     ...
     *     
     */
    public RateDetails7 setSlctnFeeRate(BigDecimal value) {
     ...
     *     
     */
    public RateDetails7 setWhldgTaxRate(BigDecimal value) {
     ...
     *     
     */
    public RateDetails7 setTaxOnIncm(BigDecimal value) {
     ...
     *     
     */
    public RateDetails7 setTaxOnPrfts(BigDecimal value) {
     ...
     *     
     */
    public RateDetails7 setTaxRclmRate(BigDecimal value) {
     ...
     *     
     */
    public RateDetails7 setWhldgOfFrgnTax(RateAndAmountFormat5Choice value) {
     ...
     *     
     */
    public RateDetails7 setWhldgOfLclTax(RateAndAmountFormat5Choice value) {
     ...
     * 
     */
    public RateDetails7 addGrssDvddRate(GrossDividendRateFormat2Choice grssDvddRate) {
     ...
     * 
     */
    public RateDetails7 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat2Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public RateDetails7 addNetDvddRate(NetDividendRateFormat2Choice netDvddRate) {
     ...
     * 
     */
    public RateDetails7 addTaxCdtRate(TaxCreditRateFormat2Choice taxCdtRate) {
     ...
     * 
     */
    public RateDetails7 addTaxRltdRate(RateTypeAndAmountAndStatus6 taxRltdRate) {
