...
@XmlType(name = "AccountIdentification78Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification78Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountAndBalance65> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification78Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance65 }
     * 
     * 
     */
    public List<AccountAndBalance65> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance65>();
        }
     ...
     * 
     */
    public AccountIdentification78Choice addAcctsListAndBalDtls(AccountAndBalance65 acctsListAndBalDtls) {
