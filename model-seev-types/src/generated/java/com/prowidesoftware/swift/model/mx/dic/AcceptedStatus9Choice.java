...
@XmlType(name = "AcceptedStatus9Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class AcceptedStatus9Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<AcceptedStatusReason10> rsn;
     ...
     *     
     */
    public AcceptedStatus9Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link AcceptedStatusReason10 }
     * 
     * 
     */
    public List<AcceptedStatusReason10> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<AcceptedStatusReason10>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AcceptedStatus9Choice addRsn(AcceptedStatusReason10 rsn) {
        getRsn().add(rsn);
        return this;
    }
