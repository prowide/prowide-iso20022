...
@XmlType(name = "PendingStatus71Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus71Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason27> rsn;
     ...
     *     
     */
    public PendingStatus71Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason27 }
     * 
     * 
     */
    public List<PendingStatusReason27> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason27>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus71Choice addRsn(PendingStatusReason27 rsn) {
        getRsn().add(rsn);
        return this;
    }
