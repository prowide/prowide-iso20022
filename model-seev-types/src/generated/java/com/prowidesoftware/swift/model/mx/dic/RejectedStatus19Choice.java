...
@XmlType(name = "RejectedStatus19Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus19Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason17> rsn;
     ...
     *     
     */
    public RejectedStatus19Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason17 }
     * 
     * 
     */
    public List<RejectedStatusReason17> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason17>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus19Choice addRsn(RejectedStatusReason17 rsn) {
        getRsn().add(rsn);
        return this;
    }
