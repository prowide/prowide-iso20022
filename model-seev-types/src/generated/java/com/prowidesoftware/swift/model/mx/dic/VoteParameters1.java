...
@XmlType(name = "VoteParameters1", propOrder = {
...
public class VoteParameters1 {
    ...
    protected IncentivePremium2 incntivPrm;
     ...
     *     
     */
    public VoteParameters1 setSctiesQtyReqrdToVote(BigDecimal value) {
     ...
     * 
     */
    public VoteParameters1 setPrtlVoteAllwd(boolean value) {
     ...
     * 
     */
    public VoteParameters1 setSpltVoteAllwd(boolean value) {
     ...
     *     
     */
    public VoteParameters1 setVoteDdln(DateFormat2Choice value) {
        this.voteDdln = value;
        return this;
    }
     ...
     *     
     */
    public VoteParameters1 setVoteSTPDdln(DateFormat2Choice value) {
     ...
     *     
     */
    public VoteParameters1 setVoteMktDdln(DateFormat2Choice value) {
     ...
     *     
     */
    public VoteParameters1 setVoteMthds(VoteMethods value) {
     ...
     *     
     */
    public VoteParameters1 setVtngBlltElctrncAdr(CommunicationAddress4 value) {
     ...
     *     
     */
    public VoteParameters1 setVtngBlltReqAdr(PostalAddress1 value) {
     ...
     *     
     */
    public VoteParameters1 setRvcbltyDdln(DateFormat2Choice value) {
     ...
     *     
     */
    public VoteParameters1 setRvcbltySTPDdln(DateFormat2Choice value) {
     ...
     *     
     */
    public VoteParameters1 setRvcbltyMktDdln(DateFormat2Choice value) {
     ...
     * 
     */
    public VoteParameters1 setBnfclOwnrDsclsr(boolean value) {
     ...
     * @return
     *     possible object is
     *     {@link IncentivePremium2 }
     *     
     */
    public IncentivePremium2 getIncntivPrm() {
        return incntivPrm;
    }
     ...
     *     
     */
    public VoteParameters1 setIncntivPrm(IncentivePremium2 value) {
     ...
     *     
     */
    public VoteParameters1 setVoteWthPrmDdln(DateFormat2Choice value) {
     ...
     *     
     */
    public VoteParameters1 setVoteWthPrmSTPDdln(DateFormat2Choice value) {
     ...
     *     
     */
    public VoteParameters1 setVoteWthPrmMktDdln(DateFormat2Choice value) {
     ...
     *     
     */
    public VoteParameters1 setAddtlVtngRqrmnts(String value) {
     ...
     * 
     */
    public VoteParameters1 addVoteInstrTp(VoteInstruction2Code voteInstrTp) {
