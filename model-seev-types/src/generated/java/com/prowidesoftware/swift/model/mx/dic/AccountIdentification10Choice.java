...
@XmlType(name = "AccountIdentification10Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification10Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountIdentification13> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification10Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification13 }
     * 
     * 
     */
    public List<AccountIdentification13> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountIdentification13>();
        }
     ...
     * 
     */
    public AccountIdentification10Choice addAcctsListAndBalDtls(AccountIdentification13 acctsListAndBalDtls) {
