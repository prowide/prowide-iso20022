...
@XmlType(name = "AccountIdentification76Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification76Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountAndBalance64> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification76Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance64 }
     * 
     * 
     */
    public List<AccountAndBalance64> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance64>();
        }
     ...
     * 
     */
    public AccountIdentification76Choice addAcctsListAndBalDtls(AccountAndBalance64 acctsListAndBalDtls) {
