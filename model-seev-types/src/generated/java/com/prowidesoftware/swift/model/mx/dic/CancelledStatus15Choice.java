...
@XmlType(name = "CancelledStatus15Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class CancelledStatus15Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<CancelledStatusReason14> rsn;
     ...
     *     
     */
    public CancelledStatus15Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link CancelledStatusReason14 }
     * 
     * 
     */
    public List<CancelledStatusReason14> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<CancelledStatusReason14>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public CancelledStatus15Choice addRsn(CancelledStatusReason14 rsn) {
        getRsn().add(rsn);
        return this;
    }
