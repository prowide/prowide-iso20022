...
@XmlType(name = "PendingStatus32Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus32Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason5> rsn;
     ...
     *     
     */
    public PendingStatus32Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason5 }
     * 
     * 
     */
    public List<PendingStatusReason5> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason5>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus32Choice addRsn(PendingStatusReason5 rsn) {
        getRsn().add(rsn);
        return this;
    }
