...
@XmlType(name = "RejectedStatus24Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus24Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason22> rsn;
     ...
     *     
     */
    public RejectedStatus24Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason22 }
     * 
     * 
     */
    public List<RejectedStatusReason22> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason22>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus24Choice addRsn(RejectedStatusReason22 rsn) {
        getRsn().add(rsn);
        return this;
    }
