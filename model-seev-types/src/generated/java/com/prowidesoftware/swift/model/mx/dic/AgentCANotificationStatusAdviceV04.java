...
@XmlType(name = "AgentCANotificationStatusAdviceV04", propOrder = {
    "agtDocIdAndSts",
    "corpActnGnlInf"
})
public class AgentCANotificationStatusAdviceV04 {

    @XmlElement(name = "AgtDocIdAndSts", required = true)
    protected AgentDocumentIdentificationAndStatus2Choice agtDocIdAndSts;
     ...
     * @return
     *     possible object is
     *     {@link AgentDocumentIdentificationAndStatus2Choice }
     *     
     */
    public AgentDocumentIdentificationAndStatus2Choice getAgtDocIdAndSts() {
     ...
     *     
     */
    public AgentCANotificationStatusAdviceV04 setAgtDocIdAndSts(AgentDocumentIdentificationAndStatus2Choice value) {
     ...
     *     
     */
    public AgentCANotificationStatusAdviceV04 setCorpActnGnlInf(CorporateActionGeneralInformation175 value) {
