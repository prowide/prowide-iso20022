...
@XmlType(name = "RejectedStatus16Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus16Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason16> rsn;
     ...
     *     
     */
    public RejectedStatus16Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason16 }
     * 
     * 
     */
    public List<RejectedStatusReason16> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason16>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus16Choice addRsn(RejectedStatusReason16 rsn) {
        getRsn().add(rsn);
        return this;
    }
