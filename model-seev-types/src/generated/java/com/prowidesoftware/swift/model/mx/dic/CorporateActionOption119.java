...
@XmlType(name = "CorporateActionOption119", propOrder = {
    "optnNb",
    "optnTp",
    "sctiesMvmntDtls",
    "cshMvmntDtls"
...
public class CorporateActionOption119 {
    ...
    protected List<SecuritiesOption53> sctiesMvmntDtls;
    @XmlElement(name = "CshMvmntDtls")
    protected List<CashOption45> cshMvmntDtls;
     ...
     *     
     */
    public CorporateActionOption119 setOptnNb(OptionNumber1Choice value) {
        this.optnNb = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption119 setOptnTp(CorporateActionOption19Choice value) {
        this.optnTp = value;
        return this;
    }
     ...
     * {@link SecuritiesOption53 }
     * 
     * 
     */
    public List<SecuritiesOption53> getSctiesMvmntDtls() {
        if (sctiesMvmntDtls == null) {
            sctiesMvmntDtls = new ArrayList<SecuritiesOption53>();
        }
     ...
     * 
     */
    public List<CashOption45> getCshMvmntDtls() {
        if (cshMvmntDtls == null) {
            cshMvmntDtls = new ArrayList<CashOption45>();
        }
     ...
     * 
     */
    public CorporateActionOption119 addSctiesMvmntDtls(SecuritiesOption53 sctiesMvmntDtls) {
     ...
     * 
     */
    public CorporateActionOption119 addCshMvmntDtls(CashOption45 cshMvmntDtls) {
