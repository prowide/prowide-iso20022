...
@XmlType(name = "CorporateActionRate30", propOrder = {
    "addtlTax",
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
...
public class CorporateActionRate30 {
     ...
     *     
     */
    public CorporateActionRate30 setAddtlTax(RateAndAmountFormat16Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate30 setIndxFctr(RateAndAmountFormat16Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate30 setMaxAllwdOvrsbcptRate(RateFormat6Choice value) {
     ...
     *     
     */
    public CorporateActionRate30 setPrratnRate(RateFormat6Choice value) {
     ...
     *     
     */
    public CorporateActionRate30 setWhldgTaxRate(RateFormat6Choice value) {
     ...
     *     
     */
    public CorporateActionRate30 setWhldgOfFrgnTax(RateAndAmountFormat16Choice value) {
     ...
     * 
     */
    public CorporateActionRate30 addGrssDvddRate(GrossDividendRateFormat6Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate30 addNetDvddRate(NetDividendRateFormat6Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate30 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat6Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate30 addTaxRltdRate(RateTypeAndAmountAndStatus10 taxRltdRate) {
     ...
     * 
     */
    public CorporateActionRate30 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus12 taxblIncmPerDvddShr) {
