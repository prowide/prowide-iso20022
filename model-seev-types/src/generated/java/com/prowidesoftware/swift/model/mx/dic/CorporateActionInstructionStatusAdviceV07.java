...
@XmlType(name = "CorporateActionInstructionStatusAdviceV07", propOrder = {
    "instrId",
    "othrDocId",
    "corpActnGnlInf",
    "instrPrcgSts",
...
public class CorporateActionInstructionStatusAdviceV07 {
    ...
    protected List<InstructionProcessingStatus24Choice> instrPrcgSts;
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV07 setInstrId(DocumentIdentification9 value) {
        this.instrId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV07 setCorpActnGnlInf(CorporateActionGeneralInformation91 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionProcessingStatus24Choice }
     * 
     * 
     */
    public List<InstructionProcessingStatus24Choice> getInstrPrcgSts() {
        if (instrPrcgSts == null) {
            instrPrcgSts = new ArrayList<InstructionProcessingStatus24Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV07 setCorpActnInstr(CorporateActionOption116 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV07 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV07 addOthrDocId(DocumentIdentification33 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV07 addInstrPrcgSts(InstructionProcessingStatus24Choice instrPrcgSts) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV07 addSplmtryData(SupplementaryData1 splmtryData) {
