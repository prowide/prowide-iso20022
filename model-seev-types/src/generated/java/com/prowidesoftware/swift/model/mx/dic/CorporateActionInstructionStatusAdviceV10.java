...
@XmlType(name = "CorporateActionInstructionStatusAdviceV10", propOrder = {
    "instrId",
    "othrDocId",
    "corpActnGnlInf",
    "instrPrcgSts",
...
public class CorporateActionInstructionStatusAdviceV10 {
    ...
    protected List<InstructionProcessingStatus31Choice> instrPrcgSts;
    @XmlElement(name = "CorpActnInstr")
    protected CorporateActionOption151 corpActnInstr;
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV10 setInstrId(DocumentIdentification9 value) {
        this.instrId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV10 setCorpActnGnlInf(CorporateActionGeneralInformation109 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionProcessingStatus31Choice }
     * 
     * 
     */
    public List<InstructionProcessingStatus31Choice> getInstrPrcgSts() {
        if (instrPrcgSts == null) {
            instrPrcgSts = new ArrayList<InstructionProcessingStatus31Choice>();
        }
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionOption151 }
     *     
     */
    public CorporateActionOption151 getCorpActnInstr() {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV10 setCorpActnInstr(CorporateActionOption151 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV10 setPrtctInstr(ProtectInstruction2 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV10 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV10 addOthrDocId(DocumentIdentification33 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV10 addInstrPrcgSts(InstructionProcessingStatus31Choice instrPrcgSts) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV10 addSplmtryData(SupplementaryData1 splmtryData) {
