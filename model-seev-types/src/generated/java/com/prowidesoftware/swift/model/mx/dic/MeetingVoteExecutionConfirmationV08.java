...
@XmlType(name = "MeetingVoteExecutionConfirmationV08", propOrder = {
    "mtgInstrId",
    "mtgRef",
    "finInstrmId",
    "voteInstrs",
...
public class MeetingVoteExecutionConfirmationV08 {
    ...
    protected List<DetailedInstructionStatus17> voteInstrs;
     ...
     *     
     */
    public MeetingVoteExecutionConfirmationV08 setMtgInstrId(String value) {
     ...
     *     
     */
    public MeetingVoteExecutionConfirmationV08 setMtgRef(MeetingReference10 value) {
        this.mtgRef = value;
        return this;
    }
     ...
     *     
     */
    public MeetingVoteExecutionConfirmationV08 setFinInstrmId(SecurityIdentification19 value) {
     ...
     * {@link DetailedInstructionStatus17 }
     * 
     * 
     */
    public List<DetailedInstructionStatus17> getVoteInstrs() {
        if (voteInstrs == null) {
            voteInstrs = new ArrayList<DetailedInstructionStatus17>();
        }
     ...
     *     
     */
    public MeetingVoteExecutionConfirmationV08 setVoteInstrsConfURLAdr(String value) {
     ...
     * 
     */
    public MeetingVoteExecutionConfirmationV08 addVoteInstrs(DetailedInstructionStatus17 voteInstrs) {
     ...
     * 
     */
    public MeetingVoteExecutionConfirmationV08 addSplmtryData(SupplementaryData1 splmtryData) {
