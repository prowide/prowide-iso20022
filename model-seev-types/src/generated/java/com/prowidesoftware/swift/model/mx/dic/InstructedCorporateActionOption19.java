...
@XmlType(name = "InstructedCorporateActionOption19", propOrder = {
    "optnNb",
    "optnTp",
    "instdBal",
    "dfltActn",
...
public class InstructedCorporateActionOption19 {
    ...
    protected List<OptionInstructionDetails9> optnInstrDtls;
     ...
     *     
     */
    public InstructedCorporateActionOption19 setOptnNb(String value) {
        this.optnNb = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption19 setOptnTp(CorporateActionOption30Choice value) {
        this.optnTp = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption19 setInstdBal(BalanceFormat11Choice value) {
        this.instdBal = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption19 setDfltActn(DefaultProcessingOrStandingInstruction1Choice value) {
        this.dfltActn = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption19 setOptnAccptdInstdBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption19 setOptnCancInstrBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption19 setOptnPdgInstrBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption19 setOptnRjctdInstrBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption19 setOptnPrtctInstrBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption19 setEvtDdlns(CorporateActionEventDeadlines3 value) {
        this.evtDdlns = value;
        return this;
    }
     ...
     * {@link OptionInstructionDetails9 }
     * 
     * 
     */
    public List<OptionInstructionDetails9> getOptnInstrDtls() {
        if (optnInstrDtls == null) {
            optnInstrDtls = new ArrayList<OptionInstructionDetails9>();
        }
     ...
     * 
     */
    public InstructedCorporateActionOption19 addOptnInstrDtls(OptionInstructionDetails9 optnInstrDtls) {
