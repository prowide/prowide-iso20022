...
@XmlType(name = "CorporateActionRate79", propOrder = {
    "addtlTax",
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
...
public class CorporateActionRate79 {
     ...
     *     
     */
    public CorporateActionRate79 setAddtlTax(RateAndAmountFormat46Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate79 setIndxFctr(RateAndAmountFormat46Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate79 setMaxAllwdOvrsbcptRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate79 setPrratnRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate79 setIssrDclrdXchgRate(ForeignExchangeTerms19 value) {
     ...
     *     
     */
    public CorporateActionRate79 setTaxOnIncm(RateAndAmountFormat46Choice value) {
     ...
     * 
     */
    public CorporateActionRate79 addGrssDvddRate(GrossDividendRateFormat25Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate79 addNetDvddRate(NetDividendRateFormat27Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate79 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat10Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate79 addWhldgTaxRate(RateAndAmountFormat47Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate79 addScndLvlTax(RateAndAmountFormat47Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate79 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus33 taxblIncmPerDvddShr) {
