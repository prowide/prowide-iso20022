...
@XmlType(name = "RejectedStatus41Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus41Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason39> rsn;
     ...
     *     
     */
    public RejectedStatus41Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason39 }
     * 
     * 
     */
    public List<RejectedStatusReason39> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason39>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus41Choice addRsn(RejectedStatusReason39 rsn) {
        getRsn().add(rsn);
        return this;
    }
