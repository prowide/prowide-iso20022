...
@XmlType(name = "PendingStatus33Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus33Choice {
     ...
     *     
     */
    public PendingStatus33Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason6 }
     * 
     * 
     */
    public List<PendingStatusReason6> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason6>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus33Choice addRsn(PendingStatusReason6 rsn) {
        getRsn().add(rsn);
        return this;
    }
