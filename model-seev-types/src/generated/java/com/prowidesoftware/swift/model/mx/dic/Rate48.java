...
public class Rate48 {
    ...
    protected List<RateAndAmountFormat60Choice> whldgTaxRate;
     ...
     *     
     */
    public Rate48 setAddtlTax(RateAndAmountFormat57Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public Rate48 setChrgsFees(RateAndAmountFormat57Choice value) {
     ...
     *     
     */
    public Rate48 setEarlySlctnFeeRate(SolicitationFeeRateFormat11Choice value) {
     ...
     *     
     */
    public Rate48 setFsclStmp(RateFormat24Choice value) {
        this.fsclStmp = value;
        return this;
    }
     ...
     *     
     */
    public Rate48 setThrdPtyIncntivRate(RateFormat26Choice value) {
     ...
     *     
     */
    public Rate48 setAplblRate(RateFormat31Choice value) {
     ...
     *     
     */
    public Rate48 setSlctnFeeRate(SolicitationFeeRateFormat11Choice value) {
     ...
     *     
     */
    public Rate48 setTaxCdtRate(RateFormat26Choice value) {
     ...
     *     
     */
    public Rate48 setTaxOnIncm(RateAndAmountFormat57Choice value) {
     ...
     *     
     */
    public Rate48 setTaxOnPrfts(RateFormat24Choice value) {
     ...
     *     
     */
    public Rate48 setTaxRclmRate(RateFormat24Choice value) {
     ...
     *     
     */
    public Rate48 setEqulstnRate(RateAndAmountFormat42Choice value) {
     ...
     * 
     */
    public Rate48 addGrssDstrbtnRate(GrossDividendRateFormat38Choice grssDstrbtnRate) {
     ...
     * 
     */
    public Rate48 addGrssIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat11Choice grssIntrstRateUsdForPmt) {
     ...
     * 
     */
    public Rate48 addWhldgTaxRate(RateAndAmountFormat60Choice whldgTaxRate) {
     ...
     * 
     */
    public Rate48 addScndLvlTax(RateAndAmountFormat60Choice scndLvlTax) {
     ...
     * 
     */
    public Rate48 addNetDstrbtnRate(NetDividendRateFormat39Choice netDstrbtnRate) {
     ...
     * 
     */
    public Rate48 addDmdRate(RateAndAmountFormat61Choice dmdRate) {
