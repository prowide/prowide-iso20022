...
@XmlType(name = "AccountIdentification6", propOrder = {
    "sfkpgAcct",
    "acctOwnr",
    "sfkpgPlc",
    "corpActnEvtAndBal"
...
public class AccountIdentification6 {
    ...
    protected List<CorporateActionEventAndBalance1> corpActnEvtAndBal;
     ...
     *     
     */
    public AccountIdentification6 setSfkpgAcct(String value) {
     ...
     *     
     */
    public AccountIdentification6 setAcctOwnr(PartyIdentification13Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public AccountIdentification6 setSfkpgPlc(SafekeepingPlaceFormat2Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     * {@link CorporateActionEventAndBalance1 }
     * 
     * 
     */
    public List<CorporateActionEventAndBalance1> getCorpActnEvtAndBal() {
        if (corpActnEvtAndBal == null) {
            corpActnEvtAndBal = new ArrayList<CorporateActionEventAndBalance1>();
        }
     ...
     * 
     */
    public AccountIdentification6 addCorpActnEvtAndBal(CorporateActionEventAndBalance1 corpActnEvtAndBal) {
