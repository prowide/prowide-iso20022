...
@XmlType(name = "AccountIdentification56Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification56Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountAndBalance55> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification56Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance55 }
     * 
     * 
     */
    public List<AccountAndBalance55> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance55>();
        }
     ...
     * 
     */
    public AccountIdentification56Choice addAcctsListAndBalDtls(AccountAndBalance55 acctsListAndBalDtls) {
