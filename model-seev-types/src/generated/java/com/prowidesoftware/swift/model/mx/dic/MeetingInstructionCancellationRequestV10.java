...
@XmlType(name = "MeetingInstructionCancellationRequestV10", propOrder = {
    "mtgInstrId",
    "mtgRef",
    "finInstrmId",
    "toBeCancInstr",
...
public class MeetingInstructionCancellationRequestV10 {
    ...
    protected List<CancelInstruction5> toBeCancInstr;
     ...
     *     
     */
    public MeetingInstructionCancellationRequestV10 setMtgInstrId(String value) {
     ...
     *     
     */
    public MeetingInstructionCancellationRequestV10 setMtgRef(MeetingReference10 value) {
        this.mtgRef = value;
        return this;
    }
     ...
     *     
     */
    public MeetingInstructionCancellationRequestV10 setFinInstrmId(SecurityIdentification19 value) {
     ...
     * {@link CancelInstruction5 }
     * 
     * 
     */
    public List<CancelInstruction5> getToBeCancInstr() {
        if (toBeCancInstr == null) {
            toBeCancInstr = new ArrayList<CancelInstruction5>();
        }
     ...
     * 
     */
    public MeetingInstructionCancellationRequestV10 addToBeCancInstr(CancelInstruction5 toBeCancInstr) {
     ...
     * 
     */
    public MeetingInstructionCancellationRequestV10 addSplmtryData(SupplementaryData1 splmtryData) {
