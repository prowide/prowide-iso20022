...
@XmlType(name = "MeetingInstructionCancellationRequestV04", propOrder = {
    "id",
    "prvsRef",
    "mtgRef",
    "rqstngPty",
...
public class MeetingInstructionCancellationRequestV04 {
     ...
     *     
     */
    public MeetingInstructionCancellationRequestV04 setId(MessageIdentification1 value) {
        this.id = value;
        return this;
    }
     ...
     *     
     */
    public MeetingInstructionCancellationRequestV04 setPrvsRef(MessageIdentification value) {
        this.prvsRef = value;
        return this;
    }
     ...
     *     
     */
    public MeetingInstructionCancellationRequestV04 setMtgRef(MeetingReference4 value) {
        this.mtgRef = value;
        return this;
    }
     ...
     *     
     */
    public MeetingInstructionCancellationRequestV04 setRqstngPty(PartyIdentification9Choice value) {
     ...
     *     
     */
    public MeetingInstructionCancellationRequestV04 setSctyId(SecurityIdentification11 value) {
        this.sctyId = value;
        return this;
    }
    ...
    public List<SafekeepingAccount4> getInstdPos() {
        if (instdPos == null) {
            instdPos = new ArrayList<SafekeepingAccount4>();
        }
     ...
     * 
     */
    public MeetingInstructionCancellationRequestV04 addInstdPos(SafekeepingAccount4 instdPos) {
     ...
     * 
     */
    public MeetingInstructionCancellationRequestV04 addXtnsn(Extension2 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
