...
@XmlType(name = "CorporateActionInstructionStatementReport002V04", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctAndStmtDtls",
    "splmtryData"
})
public class CorporateActionInstructionStatementReport002V04 {
    ...
    protected List<AccountIdentification29> acctAndStmtDtls;
     ...
     *     
     */
    public CorporateActionInstructionStatementReport002V04 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatementReport002V04 setStmtGnlDtls(Statement30 value) {
     ...
     * {@link AccountIdentification29 }
     * 
     * 
     */
    public List<AccountIdentification29> getAcctAndStmtDtls() {
        if (acctAndStmtDtls == null) {
            acctAndStmtDtls = new ArrayList<AccountIdentification29>();
        }
     ...
     * 
     */
    public CorporateActionInstructionStatementReport002V04 addAcctAndStmtDtls(AccountIdentification29 acctAndStmtDtls) {
     ...
     * 
     */
    public CorporateActionInstructionStatementReport002V04 addSplmtryData(SupplementaryData1 splmtryData) {
