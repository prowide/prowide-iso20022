...
@XmlType(name = "InstructedCorporateActionOption12", propOrder = {
    "optnNb",
    "optnTp",
    "instdBal",
    "dfltActn",
...
public class InstructedCorporateActionOption12 {
    ...
    protected List<OptionInstructionDetails3> optnInstrDtls;
     ...
     *     
     */
    public InstructedCorporateActionOption12 setOptnNb(String value) {
        this.optnNb = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption12 setOptnTp(CorporateActionOption30Choice value) {
        this.optnTp = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption12 setInstdBal(BalanceFormat5Choice value) {
        this.instdBal = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption12 setDfltActn(DefaultProcessingOrStandingInstruction1Choice value) {
        this.dfltActn = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption12 setOptnAccptdInstdBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption12 setOptnCancInstrBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption12 setOptnPdgInstrBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption12 setOptnRjctdInstrBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption12 setOptnPrtctInstrBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption12 setEvtDdlns(CorporateActionEventDeadlines3 value) {
        this.evtDdlns = value;
        return this;
    }
     ...
     * {@link OptionInstructionDetails3 }
     * 
     * 
     */
    public List<OptionInstructionDetails3> getOptnInstrDtls() {
        if (optnInstrDtls == null) {
            optnInstrDtls = new ArrayList<OptionInstructionDetails3>();
        }
     ...
     * 
     */
    public InstructedCorporateActionOption12 addOptnInstrDtls(OptionInstructionDetails3 optnInstrDtls) {
