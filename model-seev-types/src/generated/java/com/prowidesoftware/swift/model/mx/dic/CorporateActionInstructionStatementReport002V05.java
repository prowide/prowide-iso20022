...
@XmlType(name = "CorporateActionInstructionStatementReport002V05", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctAndStmtDtls",
    "splmtryData"
...
public class CorporateActionInstructionStatementReport002V05 {
    ...
    protected Statement48 stmtGnlDtls;
    @XmlElement(name = "AcctAndStmtDtls", required = true)
    protected List<AccountIdentification35> acctAndStmtDtls;
     ...
     *     
     */
    public CorporateActionInstructionStatementReport002V05 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public Statement48 getStmtGnlDtls() {
        return stmtGnlDtls;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatementReport002V05 setStmtGnlDtls(Statement48 value) {
     ...
     * {@link AccountIdentification35 }
     * 
     * 
     */
    public List<AccountIdentification35> getAcctAndStmtDtls() {
        if (acctAndStmtDtls == null) {
            acctAndStmtDtls = new ArrayList<AccountIdentification35>();
        }
     ...
     * 
     */
    public CorporateActionInstructionStatementReport002V05 addAcctAndStmtDtls(AccountIdentification35 acctAndStmtDtls) {
     ...
     * 
     */
    public CorporateActionInstructionStatementReport002V05 addSplmtryData(SupplementaryData1 splmtryData) {
