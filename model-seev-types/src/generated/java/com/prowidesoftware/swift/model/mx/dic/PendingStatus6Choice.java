...
@XmlType(name = "PendingStatus6Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus6Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason4> rsn;
     ...
     *     
     */
    public PendingStatus6Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason4 }
     * 
     * 
     */
    public List<PendingStatusReason4> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason4>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus6Choice addRsn(PendingStatusReason4 rsn) {
        getRsn().add(rsn);
        return this;
    }
