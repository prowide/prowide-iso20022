...
@XmlType(name = "CorporateActionCancellationAdvice002V06", propOrder = {
    "cxlAdvcGnlInf",
    "corpActnGnlInf",
    "acctsDtls",
    "corpActnDtls",
...
public class CorporateActionCancellationAdvice002V06 {
    ...
    protected CorporateActionGeneralInformation93 corpActnGnlInf;
     ...
     *     
     */
    public CorporateActionCancellationAdvice002V06 setCxlAdvcGnlInf(CorporateActionCancellation4 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformation93 }
     *     
     */
    public CorporateActionGeneralInformation93 getCorpActnGnlInf() {
     ...
     *     
     */
    public CorporateActionCancellationAdvice002V06 setCorpActnGnlInf(CorporateActionGeneralInformation93 value) {
     ...
     *     
     */
    public CorporateActionCancellationAdvice002V06 setAcctsDtls(AccountIdentification34Choice value) {
     ...
     *     
     */
    public CorporateActionCancellationAdvice002V06 setCorpActnDtls(CorporateAction35 value) {
     ...
     *     
     */
    public CorporateActionCancellationAdvice002V06 setRegar(PartyIdentification104Choice value) {
        this.regar = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionCancellationAdvice002V06 setPhysSctiesAgt(PartyIdentification104Choice value) {
     ...
     *     
     */
    public CorporateActionCancellationAdvice002V06 setDrpAgt(PartyIdentification104Choice value) {
        this.drpAgt = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionCancellationAdvice002V06 setInfAgt(PartyIdentification104Choice value) {
        this.infAgt = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionCancellationAdvice002V06 addIssrAgt(PartyIdentification104Choice issrAgt) {
     ...
     * 
     */
    public CorporateActionCancellationAdvice002V06 addPngAgt(PartyIdentification104Choice pngAgt) {
     ...
     * 
     */
    public CorporateActionCancellationAdvice002V06 addSubPngAgt(PartyIdentification104Choice subPngAgt) {
     ...
     * 
     */
    public CorporateActionCancellationAdvice002V06 addRsellngAgt(PartyIdentification104Choice rsellngAgt) {
     ...
     * 
     */
    public CorporateActionCancellationAdvice002V06 addSlctnAgt(PartyIdentification104Choice slctnAgt) {
     ...
     * 
     */
    public CorporateActionCancellationAdvice002V06 addSplmtryData(SupplementaryData1 splmtryData) {
