...
@XmlType(name = "PendingStatus59Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus59Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason19> rsn;
     ...
     *     
     */
    public PendingStatus59Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason19 }
     * 
     * 
     */
    public List<PendingStatusReason19> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason19>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus59Choice addRsn(PendingStatusReason19 rsn) {
        getRsn().add(rsn);
        return this;
    }
