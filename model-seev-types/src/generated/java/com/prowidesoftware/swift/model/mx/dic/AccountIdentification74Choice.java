...
@XmlType(name = "AccountIdentification74Choice", propOrder = {
    "forAllAccts",
    "acctsList"
})
public class AccountIdentification74Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsList")
    protected List<AccountIdentification72> acctsList;
     ...
     *     
     */
    public AccountIdentification74Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification72 }
     * 
     * 
     */
    public List<AccountIdentification72> getAcctsList() {
        if (acctsList == null) {
            acctsList = new ArrayList<AccountIdentification72>();
        }
     ...
     * 
     */
    public AccountIdentification74Choice addAcctsList(AccountIdentification72 acctsList) {
