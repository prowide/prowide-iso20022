...
@XmlType(name = "AccountIdentification15Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification15Choice {
    ...
    protected List<AccountAndBalance14> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification15Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance14 }
     * 
     * 
     */
    public List<AccountAndBalance14> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance14>();
        }
     ...
     * 
     */
    public AccountIdentification15Choice addAcctsListAndBalDtls(AccountAndBalance14 acctsListAndBalDtls) {
