...
@XmlType(name = "AccountIdentification42Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification42Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountIdentification47> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification42Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification47 }
     * 
     * 
     */
    public List<AccountIdentification47> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountIdentification47>();
        }
     ...
     * 
     */
    public AccountIdentification42Choice addAcctsListAndBalDtls(AccountIdentification47 acctsListAndBalDtls) {
