...
@XmlType(name = "AgentCANotificationAdviceV03", propOrder = {
    "pgntn",
    "ntfctnGnlInf",
    "prvsNtfctnId",
    "agtInf",
...
public class AgentCANotificationAdviceV03 {
    ...
    protected CorporateActionGeneralInformation196 corpActnGnlInf;
    @XmlElement(name = "CorpActnDtls", required = true)
    protected CorporateAction88 corpActnDtls;
    @XmlElement(name = "CorpActnOptnDtls")
    protected List<CorporateActionOption250> corpActnOptnDtls;
     ...
     *     
     */
    public AgentCANotificationAdviceV03 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public AgentCANotificationAdviceV03 setNtfctnGnlInf(CorporateActionNotification12 value) {
     ...
     *     
     */
    public AgentCANotificationAdviceV03 setPrvsNtfctnId(DocumentIdentification31 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformation196 }
     *     
     */
    public CorporateActionGeneralInformation196 getCorpActnGnlInf() {
     ...
     *     
     */
    public AgentCANotificationAdviceV03 setCorpActnGnlInf(CorporateActionGeneralInformation196 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateAction88 }
     *     
     */
    public CorporateAction88 getCorpActnDtls() {
        return corpActnDtls;
    }
     ...
     *     
     */
    public AgentCANotificationAdviceV03 setCorpActnDtls(CorporateAction88 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CorporateActionOption250 }
     * 
     * 
     * @return
     *     The value of the corpActnOptnDtls property.
     */
    public List<CorporateActionOption250> getCorpActnOptnDtls() {
     ...
     *     
     */
    public AgentCANotificationAdviceV03 setAddtlInf(CorporateActionNarrative2 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public AgentCANotificationAdviceV03 addAgtInf(CorporateActionAgent2 agtInf) {
     ...
     * 
     */
    public AgentCANotificationAdviceV03 addCorpActnOptnDtls(CorporateActionOption250 corpActnOptnDtls) {
