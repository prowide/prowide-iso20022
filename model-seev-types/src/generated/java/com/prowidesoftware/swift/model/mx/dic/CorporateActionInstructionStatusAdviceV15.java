...
@XmlType(name = "CorporateActionInstructionStatusAdviceV15", propOrder = {
    "instrId",
    "othrDocId",
    "corpActnGnlInf",
    "instrPrcgSts",
...
public class CorporateActionInstructionStatusAdviceV15 {
    ...
    protected List<InstructionProcessingStatus55Choice> instrPrcgSts;
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV15 setInstrId(DocumentIdentification9 value) {
        this.instrId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV15 setCorpActnGnlInf(CorporateActionGeneralInformation182 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionProcessingStatus55Choice }
     * 
     * 
     */
    public List<InstructionProcessingStatus55Choice> getInstrPrcgSts() {
        if (instrPrcgSts == null) {
            instrPrcgSts = new ArrayList<InstructionProcessingStatus55Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV15 setCorpActnInstr(CorporateActionOption238 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV15 setPrtctInstr(ProtectInstruction2 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV15 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV15 addOthrDocId(DocumentIdentification33 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV15 addInstrPrcgSts(InstructionProcessingStatus55Choice instrPrcgSts) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV15 addSplmtryData(SupplementaryData1 splmtryData) {
