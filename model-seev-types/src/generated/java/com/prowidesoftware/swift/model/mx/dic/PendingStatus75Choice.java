...
@XmlType(name = "PendingStatus75Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus75Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason30> rsn;
     ...
     *     
     */
    public PendingStatus75Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason30 }
     * 
     * 
     */
    public List<PendingStatusReason30> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason30>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus75Choice addRsn(PendingStatusReason30 rsn) {
        getRsn().add(rsn);
        return this;
    }
