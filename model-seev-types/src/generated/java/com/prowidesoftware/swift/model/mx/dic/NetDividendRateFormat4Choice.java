...
@XmlType(name = "NetDividendRateFormat4Choice", propOrder = {
    "amt",
...
public class NetDividendRateFormat4Choice {
     ...
     *     
     */
    public NetDividendRateFormat4Choice setAmt(RestrictedFINActiveCurrencyAnd13DecimalAmount value) {
        this.amt = value;
        return this;
    }
     ...
     *     
     */
    public NetDividendRateFormat4Choice setRateTpAndAmtAndRateSts(RateTypeAndAmountAndStatus8 value) {
     ...
     *     
     */
    public NetDividendRateFormat4Choice setNotSpcfdRate(RateValueType6Code value) {
