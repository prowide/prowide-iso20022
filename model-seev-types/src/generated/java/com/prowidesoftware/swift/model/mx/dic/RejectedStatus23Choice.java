...
@XmlType(name = "RejectedStatus23Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus23Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason21> rsn;
     ...
     *     
     */
    public RejectedStatus23Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason21 }
     * 
     * 
     */
    public List<RejectedStatusReason21> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason21>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus23Choice addRsn(RejectedStatusReason21 rsn) {
        getRsn().add(rsn);
        return this;
    }
