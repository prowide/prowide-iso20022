...
@XmlType(name = "PartyIdentification243", propOrder = {
    "lglPrsn",
    "ntrlPrsn"
})
public class PartyIdentification243 {

    @XmlElement(name = "LglPrsn")
    protected List<PartyIdentification237> lglPrsn;
     ...
     * 
     */
    public PartyIdentification243 addLglPrsn(PartyIdentification237 lglPrsn) {
     ...
     * 
     */
    public PartyIdentification243 addNtrlPrsn(PartyIdentification217 ntrlPrsn) {
