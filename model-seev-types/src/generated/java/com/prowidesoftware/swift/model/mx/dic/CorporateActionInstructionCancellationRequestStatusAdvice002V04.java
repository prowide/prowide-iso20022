...
@XmlType(name = "CorporateActionInstructionCancellationRequestStatusAdvice002V04", propOrder = {
    "instrCxlReqId",
    "othrDocId",
    "corpActnGnlInf",
    "instrCxlReqSts",
...
public class CorporateActionInstructionCancellationRequestStatusAdvice002V04 {
    ...
    protected List<InstructionCancellationRequestStatus6Choice> instrCxlReqSts;
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V04 setInstrCxlReqId(DocumentIdentification17 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V04 setCorpActnGnlInf(CorporateActionGeneralInformation58 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionCancellationRequestStatus6Choice }
     * 
     * 
     */
    public List<InstructionCancellationRequestStatus6Choice> getInstrCxlReqSts() {
        if (instrCxlReqSts == null) {
            instrCxlReqSts = new ArrayList<InstructionCancellationRequestStatus6Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V04 setCorpActnInstr(CorporateActionOption50 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V04 setAddtlInf(CorporateActionNarrative19 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V04 addOthrDocId(DocumentIdentification21 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V04 addInstrCxlReqSts(InstructionCancellationRequestStatus6Choice instrCxlReqSts) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V04 addSplmtryData(SupplementaryData1 splmtryData) {
