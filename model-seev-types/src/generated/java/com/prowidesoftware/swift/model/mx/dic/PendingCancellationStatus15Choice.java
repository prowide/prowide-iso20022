...
@XmlType(name = "PendingCancellationStatus15Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingCancellationStatus15Choice {
     ...
     *     
     */
    public PendingCancellationStatus15Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public PendingCancellationStatus15Choice addRsn(PendingCancellationStatusReason8 rsn) {
        getRsn().add(rsn);
        return this;
    }
