...
@XmlType(name = "RejectedStatus62Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus62Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason61> rsn;
     ...
     *     
     */
    public RejectedStatus62Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason61 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<RejectedStatusReason61> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public RejectedStatus62Choice addRsn(RejectedStatusReason61 rsn) {
        getRsn().add(rsn);
        return this;
    }
