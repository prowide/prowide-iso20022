...
@XmlType(name = "CorporateActionMovementReversalAdvice002V06", propOrder = {
    "mvmntConfId",
    "othrDocId",
    "evtsLkg",
    "rvslRsn",
...
public class CorporateActionMovementReversalAdvice002V06 {
    ...
    protected CorporateActionGeneralInformation83 corpActnGnlInf;
    @XmlElement(name = "AcctDtls", required = true)
    protected AccountAndBalance8 acctDtls;
    @XmlElement(name = "CorpActnDtls")
    protected CorporateAction30 corpActnDtls;
    ...
    protected List<PartyIdentification89Choice> issrAgt;
    @XmlElement(name = "PngAgt")
    protected List<PartyIdentification89Choice> pngAgt;
    @XmlElement(name = "SubPngAgt")
    protected List<PartyIdentification89Choice> subPngAgt;
     ...
     *     
     */
    public CorporateActionMovementReversalAdvice002V06 setMvmntConfId(DocumentIdentification19 value) {
     ...
     *     
     */
    public CorporateActionMovementReversalAdvice002V06 setRvslRsn(CorporateActionReversalReason2 value) {
        this.rvslRsn = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformation83 }
     *     
     */
    public CorporateActionGeneralInformation83 getCorpActnGnlInf() {
     ...
     *     
     */
    public CorporateActionMovementReversalAdvice002V06 setCorpActnGnlInf(CorporateActionGeneralInformation83 value) {
     ...
     *     
     */
    public CorporateActionMovementReversalAdvice002V06 setAcctDtls(AccountAndBalance8 value) {
        this.acctDtls = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link CorporateAction30 }
     *     
     */
    public CorporateAction30 getCorpActnDtls() {
        return corpActnDtls;
    }
     ...
     *     
     */
    public CorporateActionMovementReversalAdvice002V06 setCorpActnDtls(CorporateAction30 value) {
     ...
     *     
     */
    public CorporateActionMovementReversalAdvice002V06 setCorpActnConfDtls(CorporateActionOption48 value) {
     ...
     *     
     */
    public CorporateActionMovementReversalAdvice002V06 setAddtlInf(CorporateActionNarrative14 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartyIdentification89Choice }
     * 
     * 
     */
    public List<PartyIdentification89Choice> getIssrAgt() {
        if (issrAgt == null) {
            issrAgt = new ArrayList<PartyIdentification89Choice>();
        }
        return this.issrAgt;
    }
     ...
     * 
     */
    public List<PartyIdentification89Choice> getPngAgt() {
        if (pngAgt == null) {
            pngAgt = new ArrayList<PartyIdentification89Choice>();
        }
        return this.pngAgt;
    }
     ...
     * 
     */
    public List<PartyIdentification89Choice> getSubPngAgt() {
        if (subPngAgt == null) {
            subPngAgt = new ArrayList<PartyIdentification89Choice>();
        }
     ...
     * 
     */
    public CorporateActionMovementReversalAdvice002V06 addOthrDocId(DocumentIdentification20 othrDocId) {
     ...
     * 
     */
    public CorporateActionMovementReversalAdvice002V06 addEvtsLkg(CorporateActionEventReference2 evtsLkg) {
     ...
     * 
     */
    public CorporateActionMovementReversalAdvice002V06 addIssrAgt(PartyIdentification89Choice issrAgt) {
     ...
     * 
     */
    public CorporateActionMovementReversalAdvice002V06 addPngAgt(PartyIdentification89Choice pngAgt) {
     ...
     * 
     */
    public CorporateActionMovementReversalAdvice002V06 addSubPngAgt(PartyIdentification89Choice subPngAgt) {
     ...
     * 
     */
    public CorporateActionMovementReversalAdvice002V06 addSplmtryData(SupplementaryData1 splmtryData) {
