...
@XmlType(name = "PendingCancellationStatus2Choice", propOrder = {
    "notSpcfdRsn",
    "rsn"
})
public class PendingCancellationStatus2Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<PendingCancellationStatusReason2> rsn;
     ...
     *     
     */
    public PendingCancellationStatus2Choice setNotSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingCancellationStatusReason2 }
     * 
     * 
     */
    public List<PendingCancellationStatusReason2> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingCancellationStatusReason2>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingCancellationStatus2Choice addRsn(PendingCancellationStatusReason2 rsn) {
        getRsn().add(rsn);
        return this;
    }
