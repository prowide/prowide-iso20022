...
@XmlType(name = "CorporateActionInstructionStatusAdvice002V14", propOrder = {
    "instrId",
    "othrDocId",
    "corpActnGnlInf",
    "instrPrcgSts",
...
public class CorporateActionInstructionStatusAdvice002V14 {
    ...
    protected List<InstructionProcessingStatus54Choice> instrPrcgSts;
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V14 setInstrId(DocumentIdentification17 value) {
        this.instrId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V14 setCorpActnGnlInf(CorporateActionGeneralInformation158 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionProcessingStatus54Choice }
     * 
     * 
     */
    public List<InstructionProcessingStatus54Choice> getInstrPrcgSts() {
        if (instrPrcgSts == null) {
            instrPrcgSts = new ArrayList<InstructionProcessingStatus54Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V14 setCorpActnInstr(CorporateActionOption203 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V14 setPrtctInstr(ProtectInstruction6 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V14 setAddtlInf(CorporateActionNarrative19 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V14 addOthrDocId(DocumentIdentification34 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V14 addInstrPrcgSts(InstructionProcessingStatus54Choice instrPrcgSts) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V14 addSplmtryData(SupplementaryData1 splmtryData) {
