...
@XmlType(name = "RejectedStatus18Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus18Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason18> rsn;
     ...
     *     
     */
    public RejectedStatus18Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason18 }
     * 
     * 
     */
    public List<RejectedStatusReason18> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason18>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus18Choice addRsn(RejectedStatusReason18 rsn) {
        getRsn().add(rsn);
        return this;
    }
