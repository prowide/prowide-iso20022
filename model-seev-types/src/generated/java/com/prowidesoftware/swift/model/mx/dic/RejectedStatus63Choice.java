...
@XmlType(name = "RejectedStatus63Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus63Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason62> rsn;
     ...
     *     
     */
    public RejectedStatus63Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason62 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<RejectedStatusReason62> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public RejectedStatus63Choice addRsn(RejectedStatusReason62 rsn) {
        getRsn().add(rsn);
        return this;
    }
