...
@XmlType(name = "AccountIdentification48Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification48Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountIdentification59> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification48Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification59 }
     * 
     * 
     */
    public List<AccountIdentification59> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountIdentification59>();
        }
     ...
     * 
     */
    public AccountIdentification48Choice addAcctsListAndBalDtls(AccountIdentification59 acctsListAndBalDtls) {
