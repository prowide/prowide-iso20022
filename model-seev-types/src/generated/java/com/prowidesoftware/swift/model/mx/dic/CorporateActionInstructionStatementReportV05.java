...
@XmlType(name = "CorporateActionInstructionStatementReportV05", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctAndStmtDtls",
    "splmtryData"
...
public class CorporateActionInstructionStatementReportV05 {
    ...
    protected List<AccountIdentification33> acctAndStmtDtls;
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV05 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV05 setStmtGnlDtls(Statement47 value) {
     ...
     * {@link AccountIdentification33 }
     * 
     * 
     */
    public List<AccountIdentification33> getAcctAndStmtDtls() {
        if (acctAndStmtDtls == null) {
            acctAndStmtDtls = new ArrayList<AccountIdentification33>();
        }
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV05 addAcctAndStmtDtls(AccountIdentification33 acctAndStmtDtls) {
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV05 addSplmtryData(SupplementaryData1 splmtryData) {
