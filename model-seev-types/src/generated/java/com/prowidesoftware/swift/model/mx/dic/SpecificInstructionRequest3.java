...
@XmlType(name = "SpecificInstructionRequest3", propOrder = {
    "prtcptnMtd",
    "sctiesRegn"
})
public class SpecificInstructionRequest3 {
     ...
     *     
     */
    public SpecificInstructionRequest3 setPrtcptnMtd(ParticipationMethod1Choice value) {
     ...
     *     
     */
    public SpecificInstructionRequest3 setSctiesRegn(Boolean value) {
