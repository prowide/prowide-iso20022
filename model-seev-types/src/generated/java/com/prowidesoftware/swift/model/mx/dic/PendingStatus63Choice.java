...
@XmlType(name = "PendingStatus63Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus63Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason22> rsn;
     ...
     *     
     */
    public PendingStatus63Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason22 }
     * 
     * 
     */
    public List<PendingStatusReason22> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason22>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus63Choice addRsn(PendingStatusReason22 rsn) {
        getRsn().add(rsn);
        return this;
    }
