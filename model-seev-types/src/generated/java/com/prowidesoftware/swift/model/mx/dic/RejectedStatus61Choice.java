...
@XmlType(name = "RejectedStatus61Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus61Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason60> rsn;
     ...
     *     
     */
    public RejectedStatus61Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason60 }
     * 
     * 
     */
    public List<RejectedStatusReason60> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason60>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus61Choice addRsn(RejectedStatusReason60 rsn) {
        getRsn().add(rsn);
        return this;
    }
