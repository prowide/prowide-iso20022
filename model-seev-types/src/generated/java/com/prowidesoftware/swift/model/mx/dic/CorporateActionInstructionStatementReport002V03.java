...
@XmlType(name = "CorporateActionInstructionStatementReport002V03", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctAndStmtDtls",
    "splmtryData"
})
public class CorporateActionInstructionStatementReport002V03 {
    ...
    protected List<AccountIdentification24> acctAndStmtDtls;
     ...
     *     
     */
    public CorporateActionInstructionStatementReport002V03 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatementReport002V03 setStmtGnlDtls(Statement30 value) {
     ...
     * {@link AccountIdentification24 }
     * 
     * 
     */
    public List<AccountIdentification24> getAcctAndStmtDtls() {
        if (acctAndStmtDtls == null) {
            acctAndStmtDtls = new ArrayList<AccountIdentification24>();
        }
     ...
     * 
     */
    public CorporateActionInstructionStatementReport002V03 addAcctAndStmtDtls(AccountIdentification24 acctAndStmtDtls) {
     ...
     * 
     */
    public CorporateActionInstructionStatementReport002V03 addSplmtryData(SupplementaryData1 splmtryData) {
