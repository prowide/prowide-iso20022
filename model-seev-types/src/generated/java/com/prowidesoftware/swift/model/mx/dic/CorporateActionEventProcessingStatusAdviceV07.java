...
@XmlType(name = "CorporateActionEventProcessingStatusAdviceV07", propOrder = {
    "ntfctnId",
    "othrDocId",
    "corpActnGnlInf",
    "evtPrcgSts",
...
public class CorporateActionEventProcessingStatusAdviceV07 {
     ...
     *     
     */
    public CorporateActionEventProcessingStatusAdviceV07 setNtfctnId(DocumentIdentification9 value) {
        this.ntfctnId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionEventProcessingStatusAdviceV07 setCorpActnGnlInf(CorporateActionGeneralInformation137 value) {
    ...
    public List<EventProcessingStatus5Choice> getEvtPrcgSts() {
        if (evtPrcgSts == null) {
            evtPrcgSts = new ArrayList<EventProcessingStatus5Choice>();
        }
     ...
     *     
     */
    public CorporateActionEventProcessingStatusAdviceV07 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionEventProcessingStatusAdviceV07 addOthrDocId(DocumentIdentification33 othrDocId) {
     ...
     * 
     */
    public CorporateActionEventProcessingStatusAdviceV07 addEvtPrcgSts(EventProcessingStatus5Choice evtPrcgSts) {
     ...
     * 
     */
    public CorporateActionEventProcessingStatusAdviceV07 addSplmtryData(SupplementaryData1 splmtryData) {
