...
@XmlType(name = "AccountIdentification22", propOrder = {
    "sfkpgAcct",
    "acctOwnr",
    "sfkpgPlc",
    "corpActnEvtAndBal"
...
public class AccountIdentification22 {
    ...
    protected List<CorporateActionEventAndBalance4> corpActnEvtAndBal;
     ...
     *     
     */
    public AccountIdentification22 setSfkpgAcct(String value) {
     ...
     *     
     */
    public AccountIdentification22 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public AccountIdentification22 setSfkpgPlc(SafekeepingPlaceFormat5Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     * {@link CorporateActionEventAndBalance4 }
     * 
     * 
     */
    public List<CorporateActionEventAndBalance4> getCorpActnEvtAndBal() {
        if (corpActnEvtAndBal == null) {
            corpActnEvtAndBal = new ArrayList<CorporateActionEventAndBalance4>();
        }
     ...
     * 
     */
    public AccountIdentification22 addCorpActnEvtAndBal(CorporateActionEventAndBalance4 corpActnEvtAndBal) {
