...
@XmlType(name = "Vote18Choice", propOrder = {
    "voteInstr",
    "gblVoteInstr"
})
public class Vote18Choice {

    @XmlElement(name = "VoteInstr")
    protected List<Vote21> voteInstr;
     ...
     */
    public List<Vote21> getVoteInstr() {
        if (voteInstr == null) {
     ...
     * 
     */
    public Vote18Choice addVoteInstr(Vote21 voteInstr) {
     ...
     * 
     */
    public Vote18Choice addGblVoteInstr(Vote15 gblVoteInstr) {
