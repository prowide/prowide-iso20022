...
@XmlType(name = "InstructedBalance22", propOrder = {
    "ttlInstdBal",
    "ttlAccptdInstrBal",
    "ttlCancInstrBal",
    "ttlPdgInstrBal",
...
public class InstructedBalance22 {
    ...
    protected List<InstructedCorporateActionOption23> optnDtls;
     ...
     *     
     */
    public InstructedBalance22 setTtlInstdBal(BalanceFormat11Choice value) {
     ...
     *     
     */
    public InstructedBalance22 setTtlAccptdInstrBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public InstructedBalance22 setTtlCancInstrBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public InstructedBalance22 setTtlPdgInstrBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public InstructedBalance22 setTtlRjctdInstrBal(SignedQuantityFormat10 value) {
     ...
     *     
     */
    public InstructedBalance22 setTtlPrtctInstrBal(SignedQuantityFormat10 value) {
     ...
     * {@link InstructedCorporateActionOption23 }
     * 
     * 
     * @return
     *     The value of the optnDtls property.
     */
    public List<InstructedCorporateActionOption23> getOptnDtls() {
        if (optnDtls == null) {
     ...
     * 
     */
    public InstructedBalance22 addOptnDtls(InstructedCorporateActionOption23 optnDtls) {
