...
@XmlType(name = "RejectedStatus64Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus64Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason63> rsn;
     ...
     *     
     */
    public RejectedStatus64Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason63 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<RejectedStatusReason63> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public RejectedStatus64Choice addRsn(RejectedStatusReason63 rsn) {
        getRsn().add(rsn);
        return this;
    }
