...
@XmlType(name = "MeetingVoteExecutionConfirmationV11", propOrder = {
    "pgntn",
    "voteExctnConfId",
    "mtgInstrId",
    "mtgRef",
...
public class MeetingVoteExecutionConfirmationV11 {
    ...
    protected List<DetailedInstructionStatus19> voteInstrs;
     ...
     *     
     */
    public MeetingVoteExecutionConfirmationV11 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public MeetingVoteExecutionConfirmationV11 setVoteExctnConfId(String value) {
     ...
     *     
     */
    public MeetingVoteExecutionConfirmationV11 setMtgInstrId(String value) {
     ...
     *     
     */
    public MeetingVoteExecutionConfirmationV11 setMtgRef(MeetingReference10 value) {
        this.mtgRef = value;
        return this;
    }
     ...
     *     
     */
    public MeetingVoteExecutionConfirmationV11 setFinInstrmId(SecurityIdentification19 value) {
     ...
     * {@link DetailedInstructionStatus19 }
     * 
     * 
     */
    public List<DetailedInstructionStatus19> getVoteInstrs() {
        if (voteInstrs == null) {
            voteInstrs = new ArrayList<DetailedInstructionStatus19>();
        }
     ...
     *     
     */
    public MeetingVoteExecutionConfirmationV11 setVoteInstrsConfURLAdr(String value) {
     ...
     * 
     */
    public MeetingVoteExecutionConfirmationV11 addVoteInstrs(DetailedInstructionStatus19 voteInstrs) {
     ...
     * 
     */
    public MeetingVoteExecutionConfirmationV11 addSplmtryData(SupplementaryData1 splmtryData) {
