...
@XmlType(name = "AccountIdentification22Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification22Choice {
    ...
    protected List<AccountAndBalance24> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification22Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance24 }
     * 
     * 
     */
    public List<AccountAndBalance24> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance24>();
        }
     ...
     * 
     */
    public AccountIdentification22Choice addAcctsListAndBalDtls(AccountAndBalance24 acctsListAndBalDtls) {
