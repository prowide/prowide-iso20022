...
@XmlType(name = "RatioFormat5Choice", propOrder = {
    "qtyToQty",
    "notSpcfdRate",
    "amtToAmt"
})
public class RatioFormat5Choice {
     ...
     *     
     */
    public RatioFormat5Choice setQtyToQty(QuantityToQuantityRatio1 value) {
        this.qtyToQty = value;
        return this;
    }
     ...
     *     
     */
    public RatioFormat5Choice setNotSpcfdRate(RateValueType6Code value) {
     ...
     *     
     */
    public RatioFormat5Choice setAmtToAmt(AmountToAmountRatio2 value) {
        this.amtToAmt = value;
        return this;
    }
