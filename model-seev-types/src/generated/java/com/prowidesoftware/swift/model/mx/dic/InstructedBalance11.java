...
@XmlType(name = "InstructedBalance11", propOrder = {
    "ttlInstdBal",
    "ttlAccptdInstrBal",
    "ttlCancInstrBal",
    "ttlPdgInstrBal",
...
public class InstructedBalance11 {
    ...
    protected List<InstructedCorporateActionOption12> optnDtls;
     ...
     *     
     */
    public InstructedBalance11 setTtlInstdBal(BalanceFormat5Choice value) {
     ...
     *     
     */
    public InstructedBalance11 setTtlAccptdInstrBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public InstructedBalance11 setTtlCancInstrBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public InstructedBalance11 setTtlPdgInstrBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public InstructedBalance11 setTtlRjctdInstrBal(SignedQuantityFormat6 value) {
     ...
     *     
     */
    public InstructedBalance11 setTtlPrtctInstrBal(SignedQuantityFormat6 value) {
     ...
     * {@link InstructedCorporateActionOption12 }
     * 
     * 
     */
    public List<InstructedCorporateActionOption12> getOptnDtls() {
        if (optnDtls == null) {
            optnDtls = new ArrayList<InstructedCorporateActionOption12>();
        }
     ...
     * 
     */
    public InstructedBalance11 addOptnDtls(InstructedCorporateActionOption12 optnDtls) {
