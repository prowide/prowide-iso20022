...
@XmlType(name = "CancelledStatus9Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class CancelledStatus9Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<CancelledStatusReason10> rsn;
     ...
     *     
     */
    public CancelledStatus9Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link CancelledStatusReason10 }
     * 
     * 
     */
    public List<CancelledStatusReason10> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<CancelledStatusReason10>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public CancelledStatus9Choice addRsn(CancelledStatusReason10 rsn) {
        getRsn().add(rsn);
        return this;
    }
