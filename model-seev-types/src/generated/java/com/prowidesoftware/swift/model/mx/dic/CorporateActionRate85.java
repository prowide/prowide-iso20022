...
@XmlType(name = "CorporateActionRate85", propOrder = {
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
    "intrstRateUsdForPmt",
...
public class CorporateActionRate85 {
     ...
     *     
     */
    public CorporateActionRate85 setIndxFctr(RateAndAmountFormat43Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate85 setMaxAllwdOvrsbcptRate(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionRate85 setPrratnRate(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionRate85 setAddtlTax(RateAndAmountFormat43Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionRate85 addGrssDvddRate(GrossDividendRateFormat23Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate85 addNetDvddRate(NetDividendRateFormat25Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate85 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat9Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate85 addWhldgTaxRate(RateAndAmountFormat45Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate85 addScndLvlTax(RateAndAmountFormat45Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate85 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus33 taxblIncmPerDvddShr) {
