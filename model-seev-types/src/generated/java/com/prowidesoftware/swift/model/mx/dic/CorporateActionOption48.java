...
@XmlType(name = "CorporateActionOption48", propOrder = {
    "optnNb",
    "optnTp",
    "sctiesMvmntDtls",
    "cshMvmntDtls"
...
public class CorporateActionOption48 {
    ...
    protected List<SecuritiesOption32> sctiesMvmntDtls;
    @XmlElement(name = "CshMvmntDtls")
    protected List<CashOption23> cshMvmntDtls;
     ...
     *     
     */
    public CorporateActionOption48 setOptnNb(OptionNumber1Choice value) {
        this.optnNb = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption48 setOptnTp(CorporateActionOption14Choice value) {
        this.optnTp = value;
        return this;
    }
     ...
     * {@link SecuritiesOption32 }
     * 
     * 
     */
    public List<SecuritiesOption32> getSctiesMvmntDtls() {
        if (sctiesMvmntDtls == null) {
            sctiesMvmntDtls = new ArrayList<SecuritiesOption32>();
        }
     ...
     * 
     */
    public List<CashOption23> getCshMvmntDtls() {
        if (cshMvmntDtls == null) {
            cshMvmntDtls = new ArrayList<CashOption23>();
        }
     ...
     * 
     */
    public CorporateActionOption48 addSctiesMvmntDtls(SecuritiesOption32 sctiesMvmntDtls) {
     ...
     * 
     */
    public CorporateActionOption48 addCshMvmntDtls(CashOption23 cshMvmntDtls) {
