...
@XmlType(name = "CorporateActionQuantity2", propOrder = {
    "minExrcblQty",
    "minExrcblMltplQty",
    "maxQty",
    "minQtySght",
...
public class CorporateActionQuantity2 {
    ...
    protected FinancialInstrumentQuantity14Choice maxQty;
    @XmlElement(name = "MinQtySght")
    protected FinancialInstrumentQuantity14Choice minQtySght;
     ...
     *     
     */
    public CorporateActionQuantity2 setMinExrcblQty(FinancialInstrumentQuantity15Choice value) {
     ...
     *     
     */
    public CorporateActionQuantity2 setMinExrcblMltplQty(FinancialInstrumentQuantity15Choice value) {
     ...
     *     
     */
    public FinancialInstrumentQuantity14Choice getMaxQty() {
        return maxQty;
    }
     ...
     *     
     */
    public CorporateActionQuantity2 setMaxQty(FinancialInstrumentQuantity14Choice value) {
        this.maxQty = value;
        return this;
    }
     ...
     *     
     */
    public FinancialInstrumentQuantity14Choice getMinQtySght() {
        return minQtySght;
    }
     ...
     *     
     */
    public CorporateActionQuantity2 setMinQtySght(FinancialInstrumentQuantity14Choice value) {
     ...
     *     
     */
    public CorporateActionQuantity2 setNewBrdLotQty(FinancialInstrumentQuantity15Choice value) {
     ...
     *     
     */
    public CorporateActionQuantity2 setNewDnmtnQty(FinancialInstrumentQuantity15Choice value) {
     ...
     *     
     */
    public CorporateActionQuantity2 setBaseDnmtn(FinancialInstrumentQuantity15Choice value) {
     ...
     *     
     */
    public CorporateActionQuantity2 setIncrmtlDnmtn(FinancialInstrumentQuantity15Choice value) {
