...
@XmlType(name = "CorporateActionInstructionStatementReportV04", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctAndStmtDtls",
    "splmtryData"
...
public class CorporateActionInstructionStatementReportV04 {
    ...
    protected List<AccountIdentification25> acctAndStmtDtls;
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV04 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV04 setStmtGnlDtls(Statement12 value) {
     ...
     * {@link AccountIdentification25 }
     * 
     * 
     */
    public List<AccountIdentification25> getAcctAndStmtDtls() {
        if (acctAndStmtDtls == null) {
            acctAndStmtDtls = new ArrayList<AccountIdentification25>();
        }
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV04 addAcctAndStmtDtls(AccountIdentification25 acctAndStmtDtls) {
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV04 addSplmtryData(SupplementaryData1 splmtryData) {
