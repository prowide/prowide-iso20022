...
@XmlType(name = "CorporateActionRate84", propOrder = {
    "addtlTax",
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
...
public class CorporateActionRate84 {
     ...
     *     
     */
    public CorporateActionRate84 setAddtlTax(RateAndAmountFormat46Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate84 setIndxFctr(RateAndAmountFormat46Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate84 setMaxAllwdOvrsbcptRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate84 setPrratnRate(RateFormat3Choice value) {
     ...
     *     
     */
    public CorporateActionRate84 setTaxOnIncm(RateAndAmountFormat46Choice value) {
     ...
     * 
     */
    public CorporateActionRate84 addGrssDvddRate(GrossDividendRateFormat25Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate84 addNetDvddRate(NetDividendRateFormat27Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate84 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat10Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate84 addWhldgTaxRate(RateAndAmountFormat47Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate84 addScndLvlTax(RateAndAmountFormat47Choice scndLvlTax) {
     ...
     * 
     */
    public CorporateActionRate84 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus33 taxblIncmPerDvddShr) {
