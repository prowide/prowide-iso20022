...
@XmlType(name = "CorporateActionRate22", propOrder = {
    "grssDvddRate",
    "indxFctr",
    "intrstRateUsdForPmt",
...
public class CorporateActionRate22 {
     ...
     *     
     */
    public CorporateActionRate22 setIndxFctr(RateAndAmountFormat6Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate22 setMaxAllwdOvrsbcptRate(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionRate22 setPrratnRate(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionRate22 setWhldgTaxRate(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionRate22 setAddtlTax(RateAndAmountFormat6Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionRate22 addGrssDvddRate(GrossDividendRateFormat3Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate22 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat3Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate22 addTaxRltdRate(RateTypeAndAmountAndStatus10 taxRltdRate) {
     ...
     * 
     */
    public CorporateActionRate22 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus12 taxblIncmPerDvddShr) {
