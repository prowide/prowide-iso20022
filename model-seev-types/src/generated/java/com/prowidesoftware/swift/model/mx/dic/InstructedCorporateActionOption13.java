...
@XmlType(name = "InstructedCorporateActionOption13", propOrder = {
    "optnNb",
    "optnTp",
    "instdBal",
    "dfltActn",
...
public class InstructedCorporateActionOption13 {
    ...
    protected List<OptionInstructionDetails4> optnInstrDtls;
     ...
     *     
     */
    public InstructedCorporateActionOption13 setOptnNb(String value) {
        this.optnNb = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption13 setOptnTp(CorporateActionOption36Choice value) {
        this.optnTp = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption13 setInstdBal(BalanceFormat7Choice value) {
        this.instdBal = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption13 setDfltActn(DefaultProcessingOrStandingInstruction1Choice value) {
        this.dfltActn = value;
        return this;
    }
     ...
     *     
     */
    public InstructedCorporateActionOption13 setOptnAccptdInstdBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption13 setOptnCancInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption13 setOptnPdgInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption13 setOptnRjctdInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption13 setOptnPrtctInstrBal(SignedQuantityFormat9 value) {
     ...
     *     
     */
    public InstructedCorporateActionOption13 setEvtDdlns(CorporateActionEventDeadlines4 value) {
        this.evtDdlns = value;
        return this;
    }
     ...
     * {@link OptionInstructionDetails4 }
     * 
     * 
     */
    public List<OptionInstructionDetails4> getOptnInstrDtls() {
        if (optnInstrDtls == null) {
            optnInstrDtls = new ArrayList<OptionInstructionDetails4>();
        }
     ...
     * 
     */
    public InstructedCorporateActionOption13 addOptnInstrDtls(OptionInstructionDetails4 optnInstrDtls) {
