...
@XmlType(name = "PartyIdentification231Choice", propOrder = {
    "lglPrsn",
    "ntrlPrsn"
})
public class PartyIdentification231Choice {

    @XmlElement(name = "LglPrsn")
    protected PartyIdentification221 lglPrsn;
    @XmlElement(name = "NtrlPrsn")
    protected List<PartyIdentification238> ntrlPrsn;
     ...
     *     
     */
    public PartyIdentification231Choice setLglPrsn(PartyIdentification221 value) {
        this.lglPrsn = value;
        return this;
    }
     ...
     * 
     */
    public List<PartyIdentification238> getNtrlPrsn() {
        if (ntrlPrsn == null) {
            ntrlPrsn = new ArrayList<PartyIdentification238>();
        }
     ...
     * 
     */
    public PartyIdentification231Choice addNtrlPrsn(PartyIdentification238 ntrlPrsn) {
