...
@XmlType(name = "CorporateActionInstructionStatusAdviceV03", propOrder = {
    "instrId",
    "othrDocId",
    "corpActnGnlInf",
    "instrPrcgSts",
...
public class CorporateActionInstructionStatusAdviceV03 {
    ...
    protected List<InstructionProcessingStatus7Choice> instrPrcgSts;
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV03 setInstrId(DocumentIdentification9 value) {
        this.instrId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV03 setCorpActnGnlInf(CorporateActionGeneralInformation34 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionProcessingStatus7Choice }
     * 
     * 
     */
    public List<InstructionProcessingStatus7Choice> getInstrPrcgSts() {
        if (instrPrcgSts == null) {
            instrPrcgSts = new ArrayList<InstructionProcessingStatus7Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV03 setCorpActnInstr(CorporateActionOption41 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV03 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV03 addOthrDocId(DocumentIdentification14 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV03 addInstrPrcgSts(InstructionProcessingStatus7Choice instrPrcgSts) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV03 addSplmtryData(SupplementaryData1 splmtryData) {
