...
@XmlType(name = "AccountIdentification37Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification37Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountIdentification37> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification37Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification37 }
     * 
     * 
     */
    public List<AccountIdentification37> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountIdentification37>();
        }
     ...
     * 
     */
    public AccountIdentification37Choice addAcctsListAndBalDtls(AccountIdentification37 acctsListAndBalDtls) {
