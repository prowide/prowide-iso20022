...
@XmlType(name = "RejectedStatus46Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus46Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason44> rsn;
     ...
     *     
     */
    public RejectedStatus46Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason44 }
     * 
     * 
     */
    public List<RejectedStatusReason44> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason44>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus46Choice addRsn(RejectedStatusReason44 rsn) {
        getRsn().add(rsn);
        return this;
    }
