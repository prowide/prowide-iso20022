...
@XmlType(name = "SignedQuantityFormat16", propOrder = {
    "shrtLngPos",
    "qty"
})
public class SignedQuantityFormat16 {
     ...
     *     
     */
    public SignedQuantityFormat16 setShrtLngPos(ShortLong1Code value) {
     ...
     *     
     */
    public SignedQuantityFormat16 setQty(FinancialInstrumentQuantity36Choice value) {
        this.qty = value;
        return this;
    }
