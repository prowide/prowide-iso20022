...
public class AccountIdentification57Choice {
     ...
     *     
     */
    public AccountIdentification57Choice setForAllAccts(AccountIdentification10 value) {
    ...
    public List<AccountAndBalance56> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance56>();
        }
     ...
     * 
     */
    public AccountIdentification57Choice addAcctsListAndBalDtls(AccountAndBalance56 acctsListAndBalDtls) {
