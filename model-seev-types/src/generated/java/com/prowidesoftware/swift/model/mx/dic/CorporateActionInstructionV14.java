...
@XmlType(name = "CorporateActionInstructionV14", propOrder = {
    "chngInstrInd",
    "cancInstrId",
    "instrCxlReqId",
    "othrDocId",
...
public class CorporateActionInstructionV14 {
    ...
    protected List<PartyIdentification340> bnfclOwnrDtls;
     ...
     *     
     */
    public CorporateActionInstructionV14 setChngInstrInd(Boolean value) {
     ...
     *     
     */
    public CorporateActionInstructionV14 setCancInstrId(DocumentIdentification31 value) {
     ...
     *     
     */
    public CorporateActionInstructionV14 setInstrCxlReqId(DocumentIdentification31 value) {
     ...
     *     
     */
    public CorporateActionInstructionV14 setCorpActnGnlInf(CorporateActionGeneralInformation180 value) {
     ...
     *     
     */
    public CorporateActionInstructionV14 setAcctDtls(AccountAndBalance61 value) {
        this.acctDtls = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartyIdentification340 }
     * 
     * 
     * @return
     *     The value of the bnfclOwnrDtls property.
     */
    public List<PartyIdentification340> getBnfclOwnrDtls() {
     ...
     *     
     */
    public CorporateActionInstructionV14 setCorpActnInstr(CorporateActionOption237 value) {
     ...
     *     
     */
    public CorporateActionInstructionV14 setPrtctInstr(ProtectInstruction1 value) {
     ...
     *     
     */
    public CorporateActionInstructionV14 setAddtlInf(CorporateActionNarrative30 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionV14 addOthrDocId(DocumentIdentification32 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionV14 addEvtsLkg(CorporateActionEventReference3 evtsLkg) {
     ...
     * 
     */
    public CorporateActionInstructionV14 addBnfclOwnrDtls(PartyIdentification340 bnfclOwnrDtls) {
     ...
     * 
     */
    public CorporateActionInstructionV14 addSplmtryData(SupplementaryData1 splmtryData) {
