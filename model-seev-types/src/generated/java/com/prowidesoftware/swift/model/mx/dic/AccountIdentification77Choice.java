...
@XmlType(name = "AccountIdentification77Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification77Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountIdentification76> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification77Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification76 }
     * 
     * 
     */
    public List<AccountIdentification76> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountIdentification76>();
        }
     ...
     * 
     */
    public AccountIdentification77Choice addAcctsListAndBalDtls(AccountIdentification76 acctsListAndBalDtls) {
