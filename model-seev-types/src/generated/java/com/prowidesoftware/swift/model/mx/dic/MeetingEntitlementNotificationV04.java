...
@XmlType(name = "MeetingEntitlementNotificationV04", propOrder = {
    "id",
    "rltdRef",
    "mtgRef",
    "ntifngPty",
...
public class MeetingEntitlementNotificationV04 {
    ...
    protected List<SecurityPosition7> scty;
     ...
     *     
     */
    public MeetingEntitlementNotificationV04 setId(MessageIdentification1 value) {
        this.id = value;
        return this;
    }
     ...
     *     
     */
    public MeetingEntitlementNotificationV04 setRltdRef(MessageIdentification value) {
        this.rltdRef = value;
        return this;
    }
     ...
     *     
     */
    public MeetingEntitlementNotificationV04 setMtgRef(MeetingReference4 value) {
        this.mtgRef = value;
        return this;
    }
     ...
     *     
     */
    public MeetingEntitlementNotificationV04 setNtifngPty(PartyIdentification9Choice value) {
     ...
     * {@link SecurityPosition7 }
     * 
     * 
     */
    public List<SecurityPosition7> getScty() {
        if (scty == null) {
            scty = new ArrayList<SecurityPosition7>();
        }
        return this.scty;
    }
     ...
     *     
     */
    public MeetingEntitlementNotificationV04 setElgblty(EligibilityDates1 value) {
        this.elgblty = value;
        return this;
    }
     ...
     * 
     */
    public MeetingEntitlementNotificationV04 addScty(SecurityPosition7 scty) {
        getScty().add(scty);
        return this;
    }
     ...
     * 
     */
    public MeetingEntitlementNotificationV04 addXtnsn(Extension2 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
