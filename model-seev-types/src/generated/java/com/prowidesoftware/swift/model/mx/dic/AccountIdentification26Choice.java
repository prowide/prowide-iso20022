...
@XmlType(name = "AccountIdentification26Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification26Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountAndBalance29> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification26Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance29 }
     * 
     * 
     */
    public List<AccountAndBalance29> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance29>();
        }
     ...
     * 
     */
    public AccountIdentification26Choice addAcctsListAndBalDtls(AccountAndBalance29 acctsListAndBalDtls) {
