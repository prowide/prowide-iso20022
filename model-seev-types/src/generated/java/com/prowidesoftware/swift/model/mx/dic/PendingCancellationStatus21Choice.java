...
@XmlType(name = "PendingCancellationStatus21Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingCancellationStatus21Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingCancellationStatusReason16> rsn;
     ...
     *     
     */
    public PendingCancellationStatus21Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingCancellationStatusReason16 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingCancellationStatusReason16> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingCancellationStatus21Choice addRsn(PendingCancellationStatusReason16 rsn) {
        getRsn().add(rsn);
        return this;
    }
