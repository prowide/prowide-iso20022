...
@XmlType(name = "CorporateActionRate46", propOrder = {
    "grssDvddRate",
    "netDvddRate",
    "indxFctr",
    "intrstRateUsdForPmt",
...
public class CorporateActionRate46 {
     ...
     * {@link GrossDividendRateFormat10Choice }
     * 
     * 
     */
    public List<GrossDividendRateFormat10Choice> getGrssDvddRate() {
        if (grssDvddRate == null) {
            grssDvddRate = new ArrayList<GrossDividendRateFormat10Choice>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NetDividendRateFormat12Choice }
     * 
     * 
     */
    public List<NetDividendRateFormat12Choice> getNetDvddRate() {
        if (netDvddRate == null) {
            netDvddRate = new ArrayList<NetDividendRateFormat12Choice>();
        }
     ...
     *     
     */
    public CorporateActionRate46 setIndxFctr(RateAndAmountFormat5Choice value) {
        this.indxFctr = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionRate46 setMaxAllwdOvrsbcptRate(BigDecimal value) {
     ...
     *     
     */
    public CorporateActionRate46 setPrratnRate(BigDecimal value) {
    ...
    public List<RateFormat11Choice> getWhldgTaxRate() {
        if (whldgTaxRate == null) {
            whldgTaxRate = new ArrayList<RateFormat11Choice>();
        }
     ...
     *     
     */
    public CorporateActionRate46 setAddtlTax(RateAndAmountFormat5Choice value) {
        this.addtlTax = value;
        return this;
    }
    ...
    public List<RateAndAmountFormat21Choice> getWhldgOfFrgnTax() {
        if (whldgOfFrgnTax == null) {
            whldgOfFrgnTax = new ArrayList<RateAndAmountFormat21Choice>();
        }
     ...
     * 
     */
    public CorporateActionRate46 addGrssDvddRate(GrossDividendRateFormat10Choice grssDvddRate) {
     ...
     * 
     */
    public CorporateActionRate46 addNetDvddRate(NetDividendRateFormat12Choice netDvddRate) {
     ...
     * 
     */
    public CorporateActionRate46 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat2Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public CorporateActionRate46 addTaxRltdRate(RateTypeAndAmountAndStatus6 taxRltdRate) {
     ...
     * 
     */
    public CorporateActionRate46 addWhldgTaxRate(RateFormat11Choice whldgTaxRate) {
     ...
     * 
     */
    public CorporateActionRate46 addWhldgOfFrgnTax(RateAndAmountFormat21Choice whldgOfFrgnTax) {
     ...
     * 
     */
    public CorporateActionRate46 addTaxblIncmPerDvddShr(RateTypeAndAmountAndStatus11 taxblIncmPerDvddShr) {
