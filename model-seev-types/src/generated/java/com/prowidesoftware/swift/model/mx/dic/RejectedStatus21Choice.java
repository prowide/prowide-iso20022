...
@XmlType(name = "RejectedStatus21Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus21Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason20> rsn;
     ...
     *     
     */
    public RejectedStatus21Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason20 }
     * 
     * 
     */
    public List<RejectedStatusReason20> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason20>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus21Choice addRsn(RejectedStatusReason20 rsn) {
        getRsn().add(rsn);
        return this;
    }
