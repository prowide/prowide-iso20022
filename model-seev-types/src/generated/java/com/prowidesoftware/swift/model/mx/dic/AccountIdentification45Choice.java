...
@XmlType(name = "AccountIdentification45Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification45Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountAndBalance46> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification45Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance46 }
     * 
     * 
     */
    public List<AccountAndBalance46> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance46>();
        }
     ...
     * 
     */
    public AccountIdentification45Choice addAcctsListAndBalDtls(AccountAndBalance46 acctsListAndBalDtls) {
