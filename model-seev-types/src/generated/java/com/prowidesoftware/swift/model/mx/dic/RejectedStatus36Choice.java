...
@XmlType(name = "RejectedStatus36Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus36Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason34> rsn;
     ...
     *     
     */
    public RejectedStatus36Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason34 }
     * 
     * 
     */
    public List<RejectedStatusReason34> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason34>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus36Choice addRsn(RejectedStatusReason34 rsn) {
        getRsn().add(rsn);
        return this;
    }
