...
@XmlType(name = "PendingStatus1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus1Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason1> rsn;
     ...
     *     
     */
    public PendingStatus1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason1 }
     * 
     * 
     */
    public List<PendingStatusReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason1>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus1Choice addRsn(PendingStatusReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
