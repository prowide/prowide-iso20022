...
public class Rate50 {
     ...
     *     
     */
    public Rate50 setAddtlTax(RateAndAmountFormat57Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public Rate50 setChrgsFees(RateAndAmountFormat57Choice value) {
     ...
     *     
     */
    public Rate50 setEarlySlctnFeeRate(SolicitationFeeRateFormat11Choice value) {
     ...
     *     
     */
    public Rate50 setFsclStmp(RateFormat24Choice value) {
        this.fsclStmp = value;
        return this;
    }
     ...
     *     
     */
    public Rate50 setThrdPtyIncntivRate(RateFormat26Choice value) {
     ...
     *     
     */
    public Rate50 setAplblRate(RateFormat31Choice value) {
     ...
     *     
     */
    public Rate50 setSlctnFeeRate(SolicitationFeeRateFormat11Choice value) {
     ...
     *     
     */
    public Rate50 setTaxCdtRate(RateFormat26Choice value) {
     ...
     *     
     */
    public Rate50 setTaxOnIncm(RateAndAmountFormat57Choice value) {
     ...
     *     
     */
    public Rate50 setTaxOnPrfts(RateFormat24Choice value) {
     ...
     *     
     */
    public Rate50 setTaxRclmRate(RateFormat24Choice value) {
     ...
     *     
     */
    public Rate50 setEqulstnRate(RateAndAmountFormat42Choice value) {
     ...
     * 
     */
    public Rate50 addGrssDstrbtnRate(GrossDividendRateFormat38Choice grssDstrbtnRate) {
     ...
     * 
     */
    public Rate50 addGrssIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat11Choice grssIntrstRateUsdForPmt) {
     ...
     * 
     */
    public Rate50 addWhldgTaxRate(RateAndAmountFormat56Choice whldgTaxRate) {
     ...
     * 
     */
    public Rate50 addScndLvlTax(RateAndAmountFormat56Choice scndLvlTax) {
     ...
     * 
     */
    public Rate50 addNetDstrbtnRate(NetDividendRateFormat39Choice netDstrbtnRate) {
     ...
     * 
     */
    public Rate50 addDmdRate(RateAndAmountFormat61Choice dmdRate) {
