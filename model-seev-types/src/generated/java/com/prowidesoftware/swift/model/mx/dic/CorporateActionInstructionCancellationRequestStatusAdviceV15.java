...
@XmlType(name = "CorporateActionInstructionCancellationRequestStatusAdviceV15", propOrder = {
    "instrCxlReqId",
    "othrDocId",
    "corpActnGnlInf",
    "instrCxlReqSts",
...
public class CorporateActionInstructionCancellationRequestStatusAdviceV15 {
    ...
    protected List<InstructionCancellationRequestStatus21Choice> instrCxlReqSts;
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV15 setInstrCxlReqId(DocumentIdentification9 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV15 setCorpActnGnlInf(CorporateActionGeneralInformation182 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionCancellationRequestStatus21Choice }
     * 
     * 
     * @return
     *     The value of the instrCxlReqSts property.
     */
    public List<InstructionCancellationRequestStatus21Choice> getInstrCxlReqSts() {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV15 setCorpActnInstr(CorporateActionOption239 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV15 setPrtctInstr(ProtectInstruction4 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV15 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV15 addOthrDocId(DocumentIdentification33 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV15 addInstrCxlReqSts(InstructionCancellationRequestStatus21Choice instrCxlReqSts) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV15 addSplmtryData(SupplementaryData1 splmtryData) {
