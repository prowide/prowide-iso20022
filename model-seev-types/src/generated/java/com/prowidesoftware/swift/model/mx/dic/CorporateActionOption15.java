...
@XmlType(name = "CorporateActionOption15", propOrder = {
    "optnNb",
    "optnTp",
    "frctnDspstn",
    "offerTp",
...
public class CorporateActionOption15 {
    ...
    protected List<SecuritiesOption10> sctiesMvmntDtls;
    @XmlElement(name = "CshMvmntDtls")
    protected List<CashOption6> cshMvmntDtls;
     ...
     *     
     */
    public CorporateActionOption15 setOptnNb(String value) {
        this.optnNb = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption15 setOptnTp(CorporateActionOption9Choice value) {
        this.optnTp = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption15 setFrctnDspstn(FractionDispositionType6Choice value) {
    ...
    public List<OptionFeaturesFormat4Choice> getOptnFeatrs() {
        if (optnFeatrs == null) {
            optnFeatrs = new ArrayList<OptionFeaturesFormat4Choice>();
        }
     ...
     *     
     */
    public CorporateActionOption15 setIntrmdtSctiesDstrbtnTp(IntermediateSecuritiesDistributionTypeFormat4Choice value) {
     ...
     *     
     */
    public CorporateActionOption15 setOptnAvlbtySts(OptionAvailabilityStatus2Choice value) {
     ...
     *     
     */
    public CorporateActionOption15 setCcyOptn(String value) {
        this.ccyOptn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption15 setDfltPrcgOrStgInstr(DefaultProcessingOrStandingInstruction1Choice value) {
     ...
     *     
     */
    public CorporateActionOption15 setChrgsApldInd(Boolean value) {
     ...
     *     
     */
    public CorporateActionOption15 setCertfctnInd(Boolean value) {
     ...
     *     
     */
    public CorporateActionOption15 setWdrwlAllwdInd(Boolean value) {
     ...
     *     
     */
    public CorporateActionOption15 setChngAllwdInd(Boolean value) {
     ...
     *     
     */
    public CorporateActionOption15 setSctyId(SecurityIdentification12 value) {
        this.sctyId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption15 setDtDtls(CorporateActionDate11 value) {
        this.dtDtls = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption15 setPrdDtls(CorporateActionPeriod5 value) {
        this.prdDtls = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption15 setRateAndAmtDtls(CorporateActionRate12 value) {
     ...
     *     
     */
    public CorporateActionOption15 setPricDtls(CorporateActionPrice14 value) {
        this.pricDtls = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption15 setSctiesQty(SecuritiesOption9 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SecuritiesOption10 }
     * 
     * 
     */
    public List<SecuritiesOption10> getSctiesMvmntDtls() {
        if (sctiesMvmntDtls == null) {
            sctiesMvmntDtls = new ArrayList<SecuritiesOption10>();
        }
     ...
     * 
     */
    public List<CashOption6> getCshMvmntDtls() {
        if (cshMvmntDtls == null) {
            cshMvmntDtls = new ArrayList<CashOption6>();
        }
     ...
     *     
     */
    public CorporateActionOption15 setAddtlInf(CorporateActionNarrative15 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionOption15 addOfferTp(OfferTypeFormat2Choice offerTp) {
     ...
     * 
     */
    public CorporateActionOption15 addOptnFeatrs(OptionFeaturesFormat4Choice optnFeatrs) {
     ...
     * 
     */
    public CorporateActionOption15 addCertfctnTp(BeneficiaryCertificationType3Choice certfctnTp) {
     ...
     * 
     */
    public CorporateActionOption15 addNonDmclCtry(String nonDmclCtry) {
     ...
     * 
     */
    public CorporateActionOption15 addVldDmclCtry(String vldDmclCtry) {
     ...
     * 
     */
    public CorporateActionOption15 addSctiesMvmntDtls(SecuritiesOption10 sctiesMvmntDtls) {
     ...
     * 
     */
    public CorporateActionOption15 addCshMvmntDtls(CashOption6 cshMvmntDtls) {
