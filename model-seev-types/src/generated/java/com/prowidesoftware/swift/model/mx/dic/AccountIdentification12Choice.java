...
@XmlType(name = "AccountIdentification12Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification12Choice {
    ...
    protected List<AccountAndBalance9> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification12Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance9 }
     * 
     * 
     */
    public List<AccountAndBalance9> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance9>();
        }
     ...
     * 
     */
    public AccountIdentification12Choice addAcctsListAndBalDtls(AccountAndBalance9 acctsListAndBalDtls) {
