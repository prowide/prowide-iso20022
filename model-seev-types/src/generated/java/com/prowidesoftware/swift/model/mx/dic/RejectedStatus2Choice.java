...
@XmlType(name = "RejectedStatus2Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus2Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason9> rsn;
     ...
     *     
     */
    public RejectedStatus2Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason9 }
     * 
     * 
     */
    public List<RejectedStatusReason9> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason9>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus2Choice addRsn(RejectedStatusReason9 rsn) {
        getRsn().add(rsn);
        return this;
    }
