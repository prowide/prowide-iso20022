...
@XmlType(name = "AccountIdentification16Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification16Choice {
    ...
    protected List<AccountIdentification20> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification16Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification20 }
     * 
     * 
     */
    public List<AccountIdentification20> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountIdentification20>();
        }
     ...
     * 
     */
    public AccountIdentification16Choice addAcctsListAndBalDtls(AccountIdentification20 acctsListAndBalDtls) {
