...
@XmlType(name = "CorporateActionInstructionCancellationRequestStatusAdvice002V06", propOrder = {
    "instrCxlReqId",
    "othrDocId",
    "corpActnGnlInf",
    "instrCxlReqSts",
...
public class CorporateActionInstructionCancellationRequestStatusAdvice002V06 {
    ...
    protected List<InstructionCancellationRequestStatus10Choice> instrCxlReqSts;
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V06 setInstrCxlReqId(DocumentIdentification17 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V06 setCorpActnGnlInf(CorporateActionGeneralInformation94 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionCancellationRequestStatus10Choice }
     * 
     * 
     */
    public List<InstructionCancellationRequestStatus10Choice> getInstrCxlReqSts() {
        if (instrCxlReqSts == null) {
            instrCxlReqSts = new ArrayList<InstructionCancellationRequestStatus10Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V06 setCorpActnInstr(CorporateActionOption121 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V06 setAddtlInf(CorporateActionNarrative19 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V06 addOthrDocId(DocumentIdentification34 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V06 addInstrCxlReqSts(InstructionCancellationRequestStatus10Choice instrCxlReqSts) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V06 addSplmtryData(SupplementaryData1 splmtryData) {
