...
@XmlType(name = "PendingStatus52Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus52Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason13> rsn;
     ...
     *     
     */
    public PendingStatus52Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason13 }
     * 
     * 
     */
    public List<PendingStatusReason13> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason13>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus52Choice addRsn(PendingStatusReason13 rsn) {
        getRsn().add(rsn);
        return this;
    }
