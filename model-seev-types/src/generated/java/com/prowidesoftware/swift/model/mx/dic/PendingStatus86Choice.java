...
@XmlType(name = "PendingStatus86Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus86Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason36> rsn;
     ...
     *     
     */
    public PendingStatus86Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason36 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingStatusReason36> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingStatus86Choice addRsn(PendingStatusReason36 rsn) {
        getRsn().add(rsn);
        return this;
    }
