...
public class CorporateActionInstructionCancellationRequestStatusAdviceV13 {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV13 setInstrCxlReqId(DocumentIdentification9 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV13 setCorpActnGnlInf(CorporateActionGeneralInformation154 value) {
    ...
    public List<InstructionCancellationRequestStatus15Choice> getInstrCxlReqSts() {
        if (instrCxlReqSts == null) {
            instrCxlReqSts = new ArrayList<InstructionCancellationRequestStatus15Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV13 setCorpActnInstr(CorporateActionOption197 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV13 setPrtctInstr(ProtectInstruction4 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV13 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV13 addOthrDocId(DocumentIdentification33 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV13 addInstrCxlReqSts(InstructionCancellationRequestStatus15Choice instrCxlReqSts) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV13 addSplmtryData(SupplementaryData1 splmtryData) {
