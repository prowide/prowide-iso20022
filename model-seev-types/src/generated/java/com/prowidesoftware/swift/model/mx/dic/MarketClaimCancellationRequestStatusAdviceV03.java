...
@XmlType(name = "MarketClaimCancellationRequestStatusAdviceV03", propOrder = {
    "mktClmCxlReqId",
    "txRef",
    "corpActnGnlInf",
    "mktClmCxlReqSts",
...
public class MarketClaimCancellationRequestStatusAdviceV03 {
    ...
    protected MarketClaimCancellationRequestStatus2Choice mktClmCxlReqSts;
     ...
     *     
     */
    public MarketClaimCancellationRequestStatusAdviceV03 setMktClmCxlReqId(DocumentIdentification9 value) {
     ...
     *     
     */
    public MarketClaimCancellationRequestStatusAdviceV03 setTxRef(References26 value) {
        this.txRef = value;
        return this;
    }
     ...
     *     
     */
    public MarketClaimCancellationRequestStatusAdviceV03 setCorpActnGnlInf(CorporateActionGeneralInformation181 value) {
     ...
     * @return
     *     possible object is
     *     {@link MarketClaimCancellationRequestStatus2Choice }
     *     
     */
    public MarketClaimCancellationRequestStatus2Choice getMktClmCxlReqSts() {
     ...
     *     
     */
    public MarketClaimCancellationRequestStatusAdviceV03 setMktClmCxlReqSts(MarketClaimCancellationRequestStatus2Choice value) {
     ...
     *     
     */
    public MarketClaimCancellationRequestStatusAdviceV03 setMktClmDtls(CorporateActionOption234 value) {
     ...
     * 
     */
    public MarketClaimCancellationRequestStatusAdviceV03 addSplmtryData(SupplementaryData1 splmtryData) {
