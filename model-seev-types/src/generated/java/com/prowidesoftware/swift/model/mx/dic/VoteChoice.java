...
@XmlType(name = "VoteChoice", propOrder = {
    "voteInstr",
    "gblVoteInstr"
})
public class VoteChoice {
    ...
    protected List<Vote1> voteInstr;
     ...
     * 
     */
    public List<Vote1> getVoteInstr() {
        if (voteInstr == null) {
            voteInstr = new ArrayList<Vote1>();
        }
     ...
     * 
     */
    public VoteChoice addVoteInstr(Vote1 voteInstr) {
     ...
     * 
     */
    public VoteChoice addGblVoteInstr(Vote3 gblVoteInstr) {
