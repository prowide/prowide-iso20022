...
@XmlType(name = "RejectedStatus33Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus33Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason31> rsn;
     ...
     *     
     */
    public RejectedStatus33Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason31 }
     * 
     * 
     */
    public List<RejectedStatusReason31> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason31>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus33Choice addRsn(RejectedStatusReason31 rsn) {
        getRsn().add(rsn);
        return this;
    }
