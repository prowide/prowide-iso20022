...
@XmlType(name = "CancelledStatus2Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class CancelledStatus2Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<CancelledStatusReason5> rsn;
     ...
     *     
     */
    public CancelledStatus2Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link CancelledStatusReason5 }
     * 
     * 
     */
    public List<CancelledStatusReason5> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<CancelledStatusReason5>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public CancelledStatus2Choice addRsn(CancelledStatusReason5 rsn) {
        getRsn().add(rsn);
        return this;
    }
