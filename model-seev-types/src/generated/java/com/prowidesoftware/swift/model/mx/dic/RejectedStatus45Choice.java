...
@XmlType(name = "RejectedStatus45Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus45Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason43> rsn;
     ...
     *     
     */
    public RejectedStatus45Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason43 }
     * 
     * 
     */
    public List<RejectedStatusReason43> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason43>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus45Choice addRsn(RejectedStatusReason43 rsn) {
        getRsn().add(rsn);
        return this;
    }
