...
@XmlType(name = "PendingStatus5Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus5Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason3> rsn;
     ...
     *     
     */
    public PendingStatus5Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason3 }
     * 
     * 
     */
    public List<PendingStatusReason3> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason3>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus5Choice addRsn(PendingStatusReason3 rsn) {
        getRsn().add(rsn);
        return this;
    }
