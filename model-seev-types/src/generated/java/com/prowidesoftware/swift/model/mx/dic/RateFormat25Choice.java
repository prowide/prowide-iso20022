...
@XmlType(name = "RateFormat25Choice", propOrder = {
    "rate",
    "notSpcfdRate"
})
public class RateFormat25Choice {
     ...
     *     
     */
    public RateFormat25Choice setRate(BigDecimal value) {
        this.rate = value;
        return this;
    }
     ...
     *     
     */
    public RateFormat25Choice setNotSpcfdRate(RateType10Code value) {
