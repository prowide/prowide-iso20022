...
@XmlType(name = "PendingCancellationStatus22Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingCancellationStatus22Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingCancellationStatusReason17> rsn;
     ...
     *     
     */
    public PendingCancellationStatus22Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingCancellationStatusReason17 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingCancellationStatusReason17> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingCancellationStatus22Choice addRsn(PendingCancellationStatusReason17 rsn) {
        getRsn().add(rsn);
        return this;
    }
