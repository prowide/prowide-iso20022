...
public class Rate37 {
     ...
     *     
     */
    public Rate37 setAddtlTax(RateAndAmountFormat43Choice value) {
        this.addtlTax = value;
        return this;
    }
     ...
     *     
     */
    public Rate37 setChrgsFees(RateAndAmountFormat43Choice value) {
     ...
     *     
     */
    public Rate37 setFsclStmp(BigDecimal value) {
        this.fsclStmp = value;
        return this;
    }
     ...
     *     
     */
    public Rate37 setEarlySlctnFeeRate(SolicitationFeeRateFormat9Choice value) {
     ...
     *     
     */
    public Rate37 setThrdPtyIncntivRate(RateAndAmountFormat43Choice value) {
     ...
     *     
     */
    public Rate37 setAplblRate(BigDecimal value) {
     ...
     *     
     */
    public Rate37 setSlctnFeeRate(SolicitationFeeRateFormat9Choice value) {
     ...
     *     
     */
    public Rate37 setTaxCdtRate(RateFormat23Choice value) {
     ...
     *     
     */
    public Rate37 setTaxOnIncm(RateAndAmountFormat43Choice value) {
     ...
     *     
     */
    public Rate37 setTaxOnPrfts(BigDecimal value) {
     ...
     *     
     */
    public Rate37 setTaxRclmRate(BigDecimal value) {
     ...
     *     
     */
    public Rate37 setEqulstnRate(RestrictedFINActiveCurrencyAnd13DecimalAmount value) {
     ...
     * 
     */
    public Rate37 addGrssDvddRate(GrossDividendRateFormat40Choice grssDvddRate) {
     ...
     * 
     */
    public Rate37 addIntrstRateUsdForPmt(InterestRateUsedForPaymentFormat9Choice intrstRateUsdForPmt) {
     ...
     * 
     */
    public Rate37 addNetDvddRate(NetDividendRateFormat42Choice netDvddRate) {
     ...
     * 
     */
    public Rate37 addWhldgTaxRate(RateAndAmountFormat45Choice whldgTaxRate) {
     ...
     * 
     */
    public Rate37 addScndLvlTax(RateAndAmountFormat45Choice scndLvlTax) {
     ...
     * 
     */
    public Rate37 addDmdRate(RateAndAmountFormat54Choice dmdRate) {
