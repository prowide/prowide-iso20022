...
@XmlType(name = "CorporateActionInstructionStatementReportV03", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctAndStmtDtls",
    "splmtryData"
...
public class CorporateActionInstructionStatementReportV03 {
    ...
    protected List<AccountIdentification23> acctAndStmtDtls;
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV03 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV03 setStmtGnlDtls(Statement12 value) {
     ...
     * {@link AccountIdentification23 }
     * 
     * 
     */
    public List<AccountIdentification23> getAcctAndStmtDtls() {
        if (acctAndStmtDtls == null) {
            acctAndStmtDtls = new ArrayList<AccountIdentification23>();
        }
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV03 addAcctAndStmtDtls(AccountIdentification23 acctAndStmtDtls) {
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV03 addSplmtryData(SupplementaryData1 splmtryData) {
