...
@XmlType(name = "CorporateActionInstructionStatusAdvice002V04", propOrder = {
    "instrId",
    "othrDocId",
    "corpActnGnlInf",
    "instrPrcgSts",
...
public class CorporateActionInstructionStatusAdvice002V04 {
    ...
    protected List<InstructionProcessingStatus13Choice> instrPrcgSts;
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V04 setInstrId(DocumentIdentification17 value) {
        this.instrId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V04 setCorpActnGnlInf(CorporateActionGeneralInformation58 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionProcessingStatus13Choice }
     * 
     * 
     */
    public List<InstructionProcessingStatus13Choice> getInstrPrcgSts() {
        if (instrPrcgSts == null) {
            instrPrcgSts = new ArrayList<InstructionProcessingStatus13Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V04 setCorpActnInstr(CorporateActionOption50 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdvice002V04 setAddtlInf(CorporateActionNarrative19 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V04 addOthrDocId(DocumentIdentification21 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V04 addInstrPrcgSts(InstructionProcessingStatus13Choice instrPrcgSts) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdvice002V04 addSplmtryData(SupplementaryData1 splmtryData) {
