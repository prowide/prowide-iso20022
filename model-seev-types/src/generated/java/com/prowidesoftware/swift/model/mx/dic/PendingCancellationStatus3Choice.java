...
@XmlType(name = "PendingCancellationStatus3Choice", propOrder = {
    "notSpcfdRsn",
    "rsn"
})
public class PendingCancellationStatus3Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<PendingCancellationStatusReason3> rsn;
     ...
     *     
     */
    public PendingCancellationStatus3Choice setNotSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingCancellationStatusReason3 }
     * 
     * 
     */
    public List<PendingCancellationStatusReason3> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingCancellationStatusReason3>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingCancellationStatus3Choice addRsn(PendingCancellationStatusReason3 rsn) {
        getRsn().add(rsn);
        return this;
    }
