...
@XmlType(name = "RejectedStatus20Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus20Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason19> rsn;
     ...
     *     
     */
    public RejectedStatus20Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason19 }
     * 
     * 
     */
    public List<RejectedStatusReason19> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason19>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus20Choice addRsn(RejectedStatusReason19 rsn) {
        getRsn().add(rsn);
        return this;
    }
