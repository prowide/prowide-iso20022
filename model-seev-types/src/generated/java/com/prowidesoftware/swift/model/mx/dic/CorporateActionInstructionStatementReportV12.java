...
@XmlType(name = "CorporateActionInstructionStatementReportV12", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctAndStmtDtls",
    "splmtryData"
})
public class CorporateActionInstructionStatementReportV12 {
    ...
    protected List<AccountIdentification66> acctAndStmtDtls;
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV12 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV12 setStmtGnlDtls(Statement72 value) {
     ...
     * {@link AccountIdentification66 }
     * 
     * 
     */
    public List<AccountIdentification66> getAcctAndStmtDtls() {
        if (acctAndStmtDtls == null) {
            acctAndStmtDtls = new ArrayList<AccountIdentification66>();
        }
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV12 addAcctAndStmtDtls(AccountIdentification66 acctAndStmtDtls) {
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV12 addSplmtryData(SupplementaryData1 splmtryData) {
