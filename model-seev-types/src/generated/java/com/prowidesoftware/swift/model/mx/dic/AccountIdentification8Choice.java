...
@XmlType(name = "AccountIdentification8Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification8Choice {
    ...
    protected List<AccountAndBalance7> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification8Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance7 }
     * 
     * 
     */
    public List<AccountAndBalance7> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance7>();
        }
     ...
     * 
     */
    public AccountIdentification8Choice addAcctsListAndBalDtls(AccountAndBalance7 acctsListAndBalDtls) {
