...
@XmlType(name = "AccountIdentification16", propOrder = {
    "sfkpgAcct",
    "acctOwnr",
    "sfkpgPlc",
    "corpActnEvtAndBal"
...
public class AccountIdentification16 {
    ...
    protected List<CorporateActionEventAndBalance3> corpActnEvtAndBal;
     ...
     *     
     */
    public AccountIdentification16 setSfkpgAcct(String value) {
     ...
     *     
     */
    public AccountIdentification16 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public AccountIdentification16 setSfkpgPlc(SafekeepingPlaceFormat2Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     * {@link CorporateActionEventAndBalance3 }
     * 
     * 
     */
    public List<CorporateActionEventAndBalance3> getCorpActnEvtAndBal() {
        if (corpActnEvtAndBal == null) {
            corpActnEvtAndBal = new ArrayList<CorporateActionEventAndBalance3>();
        }
     ...
     * 
     */
    public AccountIdentification16 addCorpActnEvtAndBal(CorporateActionEventAndBalance3 corpActnEvtAndBal) {
