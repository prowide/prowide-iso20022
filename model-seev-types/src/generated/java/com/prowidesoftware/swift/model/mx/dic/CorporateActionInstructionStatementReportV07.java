...
@XmlType(name = "CorporateActionInstructionStatementReportV07", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctAndStmtDtls",
    "splmtryData"
...
public class CorporateActionInstructionStatementReportV07 {
    ...
    protected Statement65 stmtGnlDtls;
    @XmlElement(name = "AcctAndStmtDtls", required = true)
    protected List<AccountIdentification43> acctAndStmtDtls;
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV07 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public Statement65 getStmtGnlDtls() {
        return stmtGnlDtls;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV07 setStmtGnlDtls(Statement65 value) {
     ...
     * {@link AccountIdentification43 }
     * 
     * 
     */
    public List<AccountIdentification43> getAcctAndStmtDtls() {
        if (acctAndStmtDtls == null) {
            acctAndStmtDtls = new ArrayList<AccountIdentification43>();
        }
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV07 addAcctAndStmtDtls(AccountIdentification43 acctAndStmtDtls) {
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV07 addSplmtryData(SupplementaryData1 splmtryData) {
