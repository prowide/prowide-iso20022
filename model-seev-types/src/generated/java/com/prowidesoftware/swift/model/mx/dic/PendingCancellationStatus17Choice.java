...
@XmlType(name = "PendingCancellationStatus17Choice", propOrder = {
    "notSpcfdRsn",
    "rsn"
})
public class PendingCancellationStatus17Choice {

    @XmlElement(name = "NotSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode notSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingCancellationStatusReason12> rsn;
     ...
     *     
     */
    public PendingCancellationStatus17Choice setNotSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingCancellationStatusReason12 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingCancellationStatusReason12> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingCancellationStatus17Choice addRsn(PendingCancellationStatusReason12 rsn) {
        getRsn().add(rsn);
        return this;
    }
