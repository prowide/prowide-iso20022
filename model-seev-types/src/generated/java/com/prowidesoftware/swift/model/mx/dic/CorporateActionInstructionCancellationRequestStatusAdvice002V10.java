...
@XmlType(name = "CorporateActionInstructionCancellationRequestStatusAdvice002V10", propOrder = {
    "instrCxlReqId",
    "othrDocId",
    "corpActnGnlInf",
    "instrCxlReqSts",
...
public class CorporateActionInstructionCancellationRequestStatusAdvice002V10 {
    ...
    protected CorporateActionGeneralInformation144 corpActnGnlInf;
    @XmlElement(name = "InstrCxlReqSts", required = true)
    protected List<InstructionCancellationRequestStatus12Choice> instrCxlReqSts;
    @XmlElement(name = "CorpActnInstr")
    protected CorporateActionOption169 corpActnInstr;
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V10 setInstrCxlReqId(DocumentIdentification17 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformation144 }
     *     
     */
    public CorporateActionGeneralInformation144 getCorpActnGnlInf() {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V10 setCorpActnGnlInf(CorporateActionGeneralInformation144 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionCancellationRequestStatus12Choice }
     * 
     * 
     */
    public List<InstructionCancellationRequestStatus12Choice> getInstrCxlReqSts() {
        if (instrCxlReqSts == null) {
            instrCxlReqSts = new ArrayList<InstructionCancellationRequestStatus12Choice>();
        }
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionOption169 }
     *     
     */
    public CorporateActionOption169 getCorpActnInstr() {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V10 setCorpActnInstr(CorporateActionOption169 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V10 setPrtctInstr(ProtectInstruction8 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V10 setAddtlInf(CorporateActionNarrative19 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V10 addOthrDocId(DocumentIdentification34 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V10 addInstrCxlReqSts(InstructionCancellationRequestStatus12Choice instrCxlReqSts) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V10 addSplmtryData(SupplementaryData1 splmtryData) {
