...
@XmlType(name = "VoteParameters7", propOrder = {
...
public class VoteParameters7 {
    ...
    protected VoteMethods4 voteMthds;
     ...
     *     
     */
    public VoteParameters7 setSctiesQtyReqrdToVote(FinancialInstrumentQuantity18Choice value) {
     ...
     * 
     */
    public VoteParameters7 setPrtlVoteAllwd(boolean value) {
     ...
     * 
     */
    public VoteParameters7 setSpltVoteAllwd(boolean value) {
     ...
     *     
     */
    public VoteParameters7 setVoteDdln(DateFormat58Choice value) {
        this.voteDdln = value;
        return this;
    }
     ...
     *     
     */
    public VoteParameters7 setVoteMktDdln(DateFormat58Choice value) {
     ...
     *     
     */
    public VoteMethods4 getVoteMthds() {
        return voteMthds;
    }
     ...
     *     
     */
    public VoteParameters7 setVoteMthds(VoteMethods4 value) {
     ...
     *     
     */
    public VoteParameters7 setVtngBlltElctrncAdr(CommunicationAddress11 value) {
     ...
     *     
     */
    public VoteParameters7 setVtngBlltReqAdr(PostalAddress1 value) {
     ...
     *     
     */
    public VoteParameters7 setRvcbltyDdln(DateFormat58Choice value) {
     ...
     *     
     */
    public VoteParameters7 setRvcbltyMktDdln(DateFormat58Choice value) {
     ...
     *     
     */
    public VoteParameters7 setBnfclOwnrDsclsr(Boolean value) {
     ...
     *     
     */
    public VoteParameters7 setEarlyIncntivPrm(IncentivePremium5 value) {
     ...
     *     
     */
    public VoteParameters7 setIncntivPrm(IncentivePremium5 value) {
     ...
     *     
     */
    public VoteParameters7 setEarlyVoteWthPrmDdln(DateFormat58Choice value) {
     ...
     *     
     */
    public VoteParameters7 setVoteWthPrmDdln(DateFormat58Choice value) {
     ...
     *     
     */
    public VoteParameters7 setVoteWthPrmMktDdln(DateFormat58Choice value) {
     ...
     *     
     */
    public VoteParameters7 setAddtlVtngRqrmnts(String value) {
     ...
     *     
     */
    public VoteParameters7 setPrvsInstrInvldtyInd(Boolean value) {
