...
@XmlType(name = "RejectedStatus34Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus34Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason32> rsn;
     ...
     *     
     */
    public RejectedStatus34Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason32 }
     * 
     * 
     */
    public List<RejectedStatusReason32> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason32>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus34Choice addRsn(RejectedStatusReason32 rsn) {
        getRsn().add(rsn);
        return this;
    }
