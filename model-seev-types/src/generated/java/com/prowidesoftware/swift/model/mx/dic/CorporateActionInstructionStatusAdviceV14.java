...
@XmlType(name = "CorporateActionInstructionStatusAdviceV14", propOrder = {
    "instrId",
    "othrDocId",
    "corpActnGnlInf",
    "instrPrcgSts",
...
public class CorporateActionInstructionStatusAdviceV14 {
    ...
    protected List<InstructionProcessingStatus51Choice> instrPrcgSts;
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV14 setInstrId(DocumentIdentification9 value) {
        this.instrId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV14 setCorpActnGnlInf(CorporateActionGeneralInformation154 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionProcessingStatus51Choice }
     * 
     * 
     */
    public List<InstructionProcessingStatus51Choice> getInstrPrcgSts() {
        if (instrPrcgSts == null) {
            instrPrcgSts = new ArrayList<InstructionProcessingStatus51Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV14 setCorpActnInstr(CorporateActionOption196 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV14 setPrtctInstr(ProtectInstruction2 value) {
     ...
     *     
     */
    public CorporateActionInstructionStatusAdviceV14 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV14 addOthrDocId(DocumentIdentification33 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV14 addInstrPrcgSts(InstructionProcessingStatus51Choice instrPrcgSts) {
     ...
     * 
     */
    public CorporateActionInstructionStatusAdviceV14 addSplmtryData(SupplementaryData1 splmtryData) {
