...
@XmlType(name = "PendingStatus35Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus35Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason8> rsn;
     ...
     *     
     */
    public PendingStatus35Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason8 }
     * 
     * 
     */
    public List<PendingStatusReason8> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason8>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus35Choice addRsn(PendingStatusReason8 rsn) {
        getRsn().add(rsn);
        return this;
    }
