...
@XmlType(name = "CorporateActionBalanceDetails29", propOrder = {
    "ttlElgblBal",
    "blckdBal",
    "brrwdBal",
    "collInBal",
...
public class CorporateActionBalanceDetails29 {
    ...
    protected BalanceFormat5Choice oblgtdBal;
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setTtlElgblBal(TotalEligibleBalanceFormat8 value) {
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setBlckdBal(BalanceFormat5Choice value) {
        this.blckdBal = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setBrrwdBal(BalanceFormat5Choice value) {
        this.brrwdBal = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setCollInBal(BalanceFormat5Choice value) {
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setCollOutBal(BalanceFormat5Choice value) {
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setOnLnBal(BalanceFormat5Choice value) {
        this.onLnBal = value;
        return this;
    }
    ...
    public List<BalanceFormat6Choice> getPdgDlvryBal() {
        if (pdgDlvryBal == null) {
            pdgDlvryBal = new ArrayList<BalanceFormat6Choice>();
        }
    ...
    public List<BalanceFormat6Choice> getPdgRctBal() {
        if (pdgRctBal == null) {
            pdgRctBal = new ArrayList<BalanceFormat6Choice>();
        }
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setOutForRegnBal(BalanceFormat5Choice value) {
    ...
    public List<BalanceFormat6Choice> getSttlmPosBal() {
        if (sttlmPosBal == null) {
            sttlmPosBal = new ArrayList<BalanceFormat6Choice>();
        }
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setStrtPosBal(BalanceFormat5Choice value) {
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setTradDtPosBal(BalanceFormat5Choice value) {
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setInTrnsShipmntBal(BalanceFormat5Choice value) {
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setRegdBal(BalanceFormat5Choice value) {
        this.regdBal = value;
        return this;
    }
     ...
     *     
     */
    public BalanceFormat5Choice getOblgtdBal() {
        return oblgtdBal;
    }
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setOblgtdBal(BalanceFormat5Choice value) {
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setUinstdBal(BalanceFormat5Choice value) {
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setInstdBal(BalanceFormat5Choice value) {
        this.instdBal = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setAfctdBal(BalanceFormat5Choice value) {
        this.afctdBal = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionBalanceDetails29 setUafctdBal(BalanceFormat5Choice value) {
     ...
     * 
     */
    public CorporateActionBalanceDetails29 addPdgDlvryBal(BalanceFormat6Choice pdgDlvryBal) {
     ...
     * 
     */
    public CorporateActionBalanceDetails29 addPdgRctBal(BalanceFormat6Choice pdgRctBal) {
     ...
     * 
     */
    public CorporateActionBalanceDetails29 addSttlmPosBal(BalanceFormat6Choice sttlmPosBal) {
