...
@XmlType(name = "CorporateActionOption56", propOrder = {
    "optnNb",
    "optnTp",
    "frctnDspstn",
    "offerTp",
...
public class CorporateActionOption56 {
    ...
    protected CorporateActionRate42 rateAndAmtDtls;
    @XmlElement(name = "PricDtls")
    protected CorporateActionPrice34 pricDtls;
    @XmlElement(name = "SctiesQty")
    protected SecuritiesOption28 sctiesQty;
    @XmlElement(name = "SctiesMvmntDtls")
    protected List<SecuritiesOption37> sctiesMvmntDtls;
    @XmlElement(name = "CshMvmntDtls")
    protected List<CashOption29> cshMvmntDtls;
     ...
     *     
     */
    public CorporateActionOption56 setOptnNb(String value) {
        this.optnNb = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption56 setOptnTp(CorporateActionOption17Choice value) {
        this.optnTp = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption56 setFrctnDspstn(FractionDispositionType20Choice value) {
    ...
    public List<OfferTypeFormat4Choice> getOfferTp() {
        if (offerTp == null) {
            offerTp = new ArrayList<OfferTypeFormat4Choice>();
        }
        return this.offerTp;
    }
     ...
     *     
     */
    public CorporateActionOption56 setOptnAvlbtySts(OptionAvailabilityStatus2Choice value) {
     ...
     *     
     */
    public CorporateActionOption56 setCcyOptn(String value) {
        this.ccyOptn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption56 setDfltPrcgOrStgInstr(DefaultProcessingOrStandingInstruction1Choice value) {
     ...
     *     
     */
    public CorporateActionOption56 setChrgsApldInd(Boolean value) {
     ...
     *     
     */
    public CorporateActionOption56 setCertfctnBrkdwnInd(Boolean value) {
     ...
     *     
     */
    public CorporateActionOption56 setWdrwlAllwdInd(Boolean value) {
     ...
     *     
     */
    public CorporateActionOption56 setChngAllwdInd(Boolean value) {
     ...
     *     
     */
    public CorporateActionOption56 setFinInstrmId(SecurityIdentification15 value) {
     ...
     *     
     */
    public CorporateActionOption56 setDtDtls(CorporateActionDate16 value) {
        this.dtDtls = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption56 setPrdDtls(CorporateActionPeriod7 value) {
        this.prdDtls = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionRate42 }
     *     
     */
    public CorporateActionRate42 getRateAndAmtDtls() {
     ...
     *     
     */
    public CorporateActionOption56 setRateAndAmtDtls(CorporateActionRate42 value) {
     ...
     *     
     */
    public CorporateActionOption56 setPricDtls(CorporateActionPrice34 value) {
        this.pricDtls = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption56 setSctiesQty(SecuritiesOption28 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SecuritiesOption37 }
     * 
     * 
     */
    public List<SecuritiesOption37> getSctiesMvmntDtls() {
        if (sctiesMvmntDtls == null) {
            sctiesMvmntDtls = new ArrayList<SecuritiesOption37>();
        }
     ...
     * 
     */
    public List<CashOption29> getCshMvmntDtls() {
        if (cshMvmntDtls == null) {
            cshMvmntDtls = new ArrayList<CashOption29>();
        }
     ...
     *     
     */
    public CorporateActionOption56 setAddtlInf(CorporateActionNarrative22 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionOption56 addOfferTp(OfferTypeFormat4Choice offerTp) {
     ...
     * 
     */
    public CorporateActionOption56 addOptnFeatrs(OptionFeaturesFormat11Choice optnFeatrs) {
     ...
     * 
     */
    public CorporateActionOption56 addCertfctnBrkdwnTp(BeneficiaryCertificationType7Choice certfctnBrkdwnTp) {
     ...
     * 
     */
    public CorporateActionOption56 addNonDmclCtry(String nonDmclCtry) {
     ...
     * 
     */
    public CorporateActionOption56 addVldDmclCtry(String vldDmclCtry) {
     ...
     * 
     */
    public CorporateActionOption56 addSctiesMvmntDtls(SecuritiesOption37 sctiesMvmntDtls) {
     ...
     * 
     */
    public CorporateActionOption56 addCshMvmntDtls(CashOption29 cshMvmntDtls) {
