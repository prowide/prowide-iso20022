...
@XmlType(name = "PendingStatus68Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus68Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason25> rsn;
     ...
     *     
     */
    public PendingStatus68Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason25 }
     * 
     * 
     */
    public List<PendingStatusReason25> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason25>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus68Choice addRsn(PendingStatusReason25 rsn) {
        getRsn().add(rsn);
        return this;
    }
