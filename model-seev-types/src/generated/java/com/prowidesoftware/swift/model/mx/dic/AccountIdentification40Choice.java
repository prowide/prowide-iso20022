...
@XmlType(name = "AccountIdentification40Choice", propOrder = {
    "forAllAccts",
    "acctsList"
})
public class AccountIdentification40Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsList")
    protected List<AccountIdentification46> acctsList;
     ...
     *     
     */
    public AccountIdentification40Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * 
     */
    public List<AccountIdentification46> getAcctsList() {
        if (acctsList == null) {
            acctsList = new ArrayList<AccountIdentification46>();
        }
     ...
     * 
     */
    public AccountIdentification40Choice addAcctsList(AccountIdentification46 acctsList) {
