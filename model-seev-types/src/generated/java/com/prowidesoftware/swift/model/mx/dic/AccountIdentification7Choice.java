...
@XmlType(name = "AccountIdentification7Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification7Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountAndBalance1> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification7Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance1 }
     * 
     * 
     */
    public List<AccountAndBalance1> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance1>();
        }
     ...
     * 
     */
    public AccountIdentification7Choice addAcctsListAndBalDtls(AccountAndBalance1 acctsListAndBalDtls) {
