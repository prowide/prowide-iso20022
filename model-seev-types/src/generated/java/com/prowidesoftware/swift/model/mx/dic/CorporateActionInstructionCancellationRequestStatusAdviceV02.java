...
@XmlType(name = "CorporateActionInstructionCancellationRequestStatusAdviceV02", propOrder = {
    "instrCxlReqId",
    "othrDocId",
    "corpActnGnlInf",
    "instrCxlReqSts",
...
public class CorporateActionInstructionCancellationRequestStatusAdviceV02 {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV02 setInstrCxlReqId(DocumentIdentification9 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV02 setCorpActnGnlInf(CorporateActionGeneralInformation9 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionCancellationRequestStatus3Choice }
     * 
     * 
     */
    public List<InstructionCancellationRequestStatus3Choice> getInstrCxlReqSts() {
        if (instrCxlReqSts == null) {
            instrCxlReqSts = new ArrayList<InstructionCancellationRequestStatus3Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV02 setCorpActnInstr(CorporateActionOption22 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV02 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV02 addOthrDocId(DocumentIdentification14 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV02 addInstrCxlReqSts(InstructionCancellationRequestStatus3Choice instrCxlReqSts) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV02 addSplmtryData(SupplementaryData1 splmtryData) {
