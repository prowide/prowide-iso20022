...
@XmlType(name = "AccountIdentification75Choice", propOrder = {
    "forAllAccts",
    "acctsList"
})
public class AccountIdentification75Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsList")
    protected List<AccountIdentification75> acctsList;
     ...
     *     
     */
    public AccountIdentification75Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountIdentification75 }
     * 
     * 
     */
    public List<AccountIdentification75> getAcctsList() {
        if (acctsList == null) {
            acctsList = new ArrayList<AccountIdentification75>();
        }
     ...
     * 
     */
    public AccountIdentification75Choice addAcctsList(AccountIdentification75 acctsList) {
