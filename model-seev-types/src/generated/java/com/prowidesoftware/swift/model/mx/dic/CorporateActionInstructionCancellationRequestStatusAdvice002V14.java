...
@XmlType(name = "CorporateActionInstructionCancellationRequestStatusAdvice002V14", propOrder = {
    "instrCxlReqId",
    "othrDocId",
    "corpActnGnlInf",
    "instrCxlReqSts",
...
public class CorporateActionInstructionCancellationRequestStatusAdvice002V14 {
    ...
    protected CorporateActionGeneralInformation186 corpActnGnlInf;
    @XmlElement(name = "InstrCxlReqSts", required = true)
    protected List<InstructionCancellationRequestStatus18Choice> instrCxlReqSts;
    @XmlElement(name = "CorpActnInstr")
    protected CorporateActionOption241 corpActnInstr;
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V14 setInstrCxlReqId(DocumentIdentification17 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformation186 }
     *     
     */
    public CorporateActionGeneralInformation186 getCorpActnGnlInf() {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V14 setCorpActnGnlInf(CorporateActionGeneralInformation186 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionCancellationRequestStatus18Choice }
     * 
     * 
     */
    public List<InstructionCancellationRequestStatus18Choice> getInstrCxlReqSts() {
        if (instrCxlReqSts == null) {
            instrCxlReqSts = new ArrayList<InstructionCancellationRequestStatus18Choice>();
        }
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionOption241 }
     *     
     */
    public CorporateActionOption241 getCorpActnInstr() {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V14 setCorpActnInstr(CorporateActionOption241 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V14 setPrtctInstr(ProtectInstruction8 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V14 setAddtlInf(CorporateActionNarrative19 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V14 addOthrDocId(DocumentIdentification34 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V14 addInstrCxlReqSts(InstructionCancellationRequestStatus18Choice instrCxlReqSts) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V14 addSplmtryData(SupplementaryData1 splmtryData) {
