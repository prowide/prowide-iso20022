...
@XmlType(name = "CorporateActionEventProcessingStatusAdvice002V07", propOrder = {
    "ntfctnId",
    "othrDocId",
    "corpActnGnlInf",
    "evtPrcgSts",
...
public class CorporateActionEventProcessingStatusAdvice002V07 {
     ...
     *     
     */
    public CorporateActionEventProcessingStatusAdvice002V07 setNtfctnId(DocumentIdentification17 value) {
        this.ntfctnId = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionEventProcessingStatusAdvice002V07 setCorpActnGnlInf(CorporateActionGeneralInformation144 value) {
    ...
    public List<EventProcessingStatus6Choice> getEvtPrcgSts() {
        if (evtPrcgSts == null) {
            evtPrcgSts = new ArrayList<EventProcessingStatus6Choice>();
        }
     ...
     *     
     */
    public CorporateActionEventProcessingStatusAdvice002V07 setAddtlInf(CorporateActionNarrative19 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionEventProcessingStatusAdvice002V07 addOthrDocId(DocumentIdentification34 othrDocId) {
     ...
     * 
     */
    public CorporateActionEventProcessingStatusAdvice002V07 addEvtPrcgSts(EventProcessingStatus6Choice evtPrcgSts) {
     ...
     * 
     */
    public CorporateActionEventProcessingStatusAdvice002V07 addSplmtryData(SupplementaryData1 splmtryData) {
