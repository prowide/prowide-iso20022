...
@XmlType(name = "MarketClaimCancellationRequestStatusAdviceV04", propOrder = {
    "mktClmCxlReqId",
    "txRef",
    "corpActnGnlInf",
    "mktClmCxlReqSts",
...
public class MarketClaimCancellationRequestStatusAdviceV04 {
    ...
    protected MarketClaimCancellationRequestStatus3Choice mktClmCxlReqSts;
     ...
     *     
     */
    public MarketClaimCancellationRequestStatusAdviceV04 setMktClmCxlReqId(DocumentIdentification9 value) {
     ...
     *     
     */
    public MarketClaimCancellationRequestStatusAdviceV04 setTxRef(References26 value) {
        this.txRef = value;
        return this;
    }
     ...
     *     
     */
    public MarketClaimCancellationRequestStatusAdviceV04 setCorpActnGnlInf(CorporateActionGeneralInformation181 value) {
     ...
     * @return
     *     possible object is
     *     {@link MarketClaimCancellationRequestStatus3Choice }
     *     
     */
    public MarketClaimCancellationRequestStatus3Choice getMktClmCxlReqSts() {
     ...
     *     
     */
    public MarketClaimCancellationRequestStatusAdviceV04 setMktClmCxlReqSts(MarketClaimCancellationRequestStatus3Choice value) {
     ...
     *     
     */
    public MarketClaimCancellationRequestStatusAdviceV04 setMktClmDtls(CorporateActionOption234 value) {
     ...
     * 
     */
    public MarketClaimCancellationRequestStatusAdviceV04 addSplmtryData(SupplementaryData1 splmtryData) {
