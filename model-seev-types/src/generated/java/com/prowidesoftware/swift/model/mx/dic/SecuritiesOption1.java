...
@XmlType(name = "SecuritiesOption1", propOrder = {
    "maxExrcblQty",
    "minExrcblQty",
    "minExrcblMltplQty",
    "newBrdLotQty",
...
public class SecuritiesOption1 {
    ...
    protected FinancialInstrumentQuantity2Choice frntEndOddLotQty;
    @XmlElement(name = "BckEndOddLotQty")
    protected FinancialInstrumentQuantity2Choice bckEndOddLotQty;
     ...
     *     
     */
    public SecuritiesOption1 setMaxExrcblQty(FinancialInstrumentQuantity1Choice value) {
     ...
     *     
     */
    public SecuritiesOption1 setMinExrcblQty(FinancialInstrumentQuantity1Choice value) {
     ...
     *     
     */
    public SecuritiesOption1 setMinExrcblMltplQty(FinancialInstrumentQuantity1Choice value) {
     ...
     *     
     */
    public SecuritiesOption1 setNewBrdLotQty(FinancialInstrumentQuantity1Choice value) {
     ...
     *     
     */
    public SecuritiesOption1 setNewDnmtnQty(FinancialInstrumentQuantity1Choice value) {
     ...
     *     
     */
    public FinancialInstrumentQuantity2Choice getFrntEndOddLotQty() {
     ...
     *     
     */
    public SecuritiesOption1 setFrntEndOddLotQty(FinancialInstrumentQuantity2Choice value) {
     ...
     *     
     */
    public FinancialInstrumentQuantity2Choice getBckEndOddLotQty() {
     ...
     *     
     */
    public SecuritiesOption1 setBckEndOddLotQty(FinancialInstrumentQuantity2Choice value) {
