...
@XmlType(name = "CancelledStatus4Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class CancelledStatus4Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<CancelledStatusReason7> rsn;
     ...
     *     
     */
    public CancelledStatus4Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link CancelledStatusReason7 }
     * 
     * 
     */
    public List<CancelledStatusReason7> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<CancelledStatusReason7>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public CancelledStatus4Choice addRsn(CancelledStatusReason7 rsn) {
        getRsn().add(rsn);
        return this;
    }
