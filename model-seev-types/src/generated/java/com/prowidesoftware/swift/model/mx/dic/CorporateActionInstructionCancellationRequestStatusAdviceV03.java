...
@XmlType(name = "CorporateActionInstructionCancellationRequestStatusAdviceV03", propOrder = {
    "instrCxlReqId",
    "othrDocId",
    "corpActnGnlInf",
    "instrCxlReqSts",
...
public class CorporateActionInstructionCancellationRequestStatusAdviceV03 {
    ...
    protected CorporateActionGeneralInformation34 corpActnGnlInf;
    @XmlElement(name = "InstrCxlReqSts", required = true)
    protected List<InstructionCancellationRequestStatus5Choice> instrCxlReqSts;
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV03 setInstrCxlReqId(DocumentIdentification9 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionGeneralInformation34 }
     *     
     */
    public CorporateActionGeneralInformation34 getCorpActnGnlInf() {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV03 setCorpActnGnlInf(CorporateActionGeneralInformation34 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InstructionCancellationRequestStatus5Choice }
     * 
     * 
     */
    public List<InstructionCancellationRequestStatus5Choice> getInstrCxlReqSts() {
        if (instrCxlReqSts == null) {
            instrCxlReqSts = new ArrayList<InstructionCancellationRequestStatus5Choice>();
        }
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV03 setCorpActnInstr(CorporateActionOption41 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV03 setAddtlInf(CorporateActionNarrative10 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV03 addOthrDocId(DocumentIdentification14 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV03 addInstrCxlReqSts(InstructionCancellationRequestStatus5Choice instrCxlReqSts) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV03 addSplmtryData(SupplementaryData1 splmtryData) {
