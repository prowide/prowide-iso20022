...
@XmlType(name = "PendingStatus60Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus60Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason20> rsn;
     ...
     *     
     */
    public PendingStatus60Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason20 }
     * 
     * 
     */
    public List<PendingStatusReason20> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason20>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus60Choice addRsn(PendingStatusReason20 rsn) {
        getRsn().add(rsn);
        return this;
    }
