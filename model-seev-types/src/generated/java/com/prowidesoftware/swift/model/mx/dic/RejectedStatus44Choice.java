...
@XmlType(name = "RejectedStatus44Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus44Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason42> rsn;
     ...
     *     
     */
    public RejectedStatus44Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason42 }
     * 
     * 
     */
    public List<RejectedStatusReason42> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason42>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus44Choice addRsn(RejectedStatusReason42 rsn) {
        getRsn().add(rsn);
        return this;
    }
