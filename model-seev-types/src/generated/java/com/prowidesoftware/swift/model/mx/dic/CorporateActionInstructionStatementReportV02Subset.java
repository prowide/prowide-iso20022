...
@XmlType(name = "CorporateActionInstructionStatementReportV02Subset", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctAndStmtDtls",
    "splmtryData"
})
public class CorporateActionInstructionStatementReportV02Subset {
    ...
    protected List<AccountIdentification22> acctAndStmtDtls;
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV02Subset setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionInstructionStatementReportV02Subset setStmtGnlDtls(Statement30 value) {
     ...
     * {@link AccountIdentification22 }
     * 
     * 
     */
    public List<AccountIdentification22> getAcctAndStmtDtls() {
        if (acctAndStmtDtls == null) {
            acctAndStmtDtls = new ArrayList<AccountIdentification22>();
        }
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV02Subset addAcctAndStmtDtls(AccountIdentification22 acctAndStmtDtls) {
     ...
     * 
     */
    public CorporateActionInstructionStatementReportV02Subset addSplmtryData(SupplementaryData1 splmtryData) {
