...
@XmlType(name = "RejectedStatus13Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus13Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason13> rsn;
     ...
     *     
     */
    public RejectedStatus13Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason13 }
     * 
     * 
     */
    public List<RejectedStatusReason13> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason13>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus13Choice addRsn(RejectedStatusReason13 rsn) {
        getRsn().add(rsn);
        return this;
    }
