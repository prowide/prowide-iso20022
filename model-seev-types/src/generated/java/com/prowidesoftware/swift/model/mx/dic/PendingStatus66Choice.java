...
@XmlType(name = "PendingStatus66Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus66Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason24> rsn;
     ...
     *     
     */
    public PendingStatus66Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason24 }
     * 
     * 
     */
    public List<PendingStatusReason24> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason24>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus66Choice addRsn(PendingStatusReason24 rsn) {
        getRsn().add(rsn);
        return this;
    }
