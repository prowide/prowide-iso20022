...
@XmlType(name = "InstructionTypeStatus4Choice", propOrder = {
    "instrSts",
    "cxlSts"
})
public class InstructionTypeStatus4Choice {

    @XmlElement(name = "InstrSts")
    protected List<DetailedInstructionStatus14> instrSts;
     ...
     * {@link DetailedInstructionStatus14 }
     * 
     * 
     */
    public List<DetailedInstructionStatus14> getInstrSts() {
        if (instrSts == null) {
            instrSts = new ArrayList<DetailedInstructionStatus14>();
        }
     ...
     *     
     */
    public InstructionTypeStatus4Choice setCxlSts(CancellationStatus27Choice value) {
        this.cxlSts = value;
        return this;
    }
     ...
     * 
     */
    public InstructionTypeStatus4Choice addInstrSts(DetailedInstructionStatus14 instrSts) {
