...
@XmlType(name = "AccountIdentification71Choice", propOrder = {
    "forAllAccts",
    "acctsListAndBalDtls"
})
public class AccountIdentification71Choice {

    @XmlElement(name = "ForAllAccts")
    protected AccountIdentification10 forAllAccts;
    @XmlElement(name = "AcctsListAndBalDtls")
    protected List<AccountAndBalance60> acctsListAndBalDtls;
     ...
     *     
     */
    public AccountIdentification71Choice setForAllAccts(AccountIdentification10 value) {
     ...
     * {@link AccountAndBalance60 }
     * 
     * 
     */
    public List<AccountAndBalance60> getAcctsListAndBalDtls() {
        if (acctsListAndBalDtls == null) {
            acctsListAndBalDtls = new ArrayList<AccountAndBalance60>();
        }
     ...
     * 
     */
    public AccountIdentification71Choice addAcctsListAndBalDtls(AccountAndBalance60 acctsListAndBalDtls) {
