...
@XmlType(name = "CorporateActionInstructionCancellationRequestStatusAdvice002V11", propOrder = {
    "instrCxlReqId",
    "othrDocId",
    "corpActnGnlInf",
    "instrCxlReqSts",
...
public class CorporateActionInstructionCancellationRequestStatusAdvice002V11 {
    ...
    protected CorporateActionOption186 corpActnInstr;
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V11 setInstrCxlReqId(DocumentIdentification17 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V11 setCorpActnGnlInf(CorporateActionGeneralInformation158 value) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionOption186 }
     *     
     */
    public CorporateActionOption186 getCorpActnInstr() {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V11 setCorpActnInstr(CorporateActionOption186 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V11 setPrtctInstr(ProtectInstruction8 value) {
     ...
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V11 setAddtlInf(CorporateActionNarrative19 value) {
        this.addtlInf = value;
        return this;
    }
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V11 addOthrDocId(DocumentIdentification34 othrDocId) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V11 addInstrCxlReqSts(InstructionCancellationRequestStatus12Choice instrCxlReqSts) {
     ...
     * 
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V11 addSplmtryData(SupplementaryData1 splmtryData) {
