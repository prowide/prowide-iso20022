...
@XmlType(name = "CorporateActionOption54", propOrder = {
    "optnNb",
    "optnTp",
    "optnFeatrs",
    "frctnDspstn",
...
public class CorporateActionOption54 {
    ...
    protected CorporateActionRate39 rateAndAmtDtls;
    @XmlElement(name = "PricDtls")
    protected CorporateActionPrice36 pricDtls;
    @XmlElement(name = "PlcOfTrad")
    protected MarketIdentification8 plcOfTrad;
    @XmlElement(name = "SctiesMvmntDtls")
    protected List<SecuritiesOption36> sctiesMvmntDtls;
    @XmlElement(name = "CshMvmntDtls")
    protected List<CashOption27> cshMvmntDtls;
     ...
     *     
     */
    public CorporateActionOption54 setOptnNb(OptionNumber1Choice value) {
        this.optnNb = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption54 setOptnTp(CorporateActionOption14Choice value) {
        this.optnTp = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption54 setFrctnDspstn(FractionDispositionType24Choice value) {
     ...
     *     
     */
    public CorporateActionOption54 setCcyOptn(String value) {
        this.ccyOptn = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption54 setDtDtls(CorporateActionDate19 value) {
        this.dtDtls = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption54 setPrdDtls(CorporateActionPeriod9 value) {
        this.prdDtls = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionRate39 }
     *     
     */
    public CorporateActionRate39 getRateAndAmtDtls() {
     ...
     *     
     */
    public CorporateActionOption54 setRateAndAmtDtls(CorporateActionRate39 value) {
     ...
     *     
     */
    public CorporateActionOption54 setPricDtls(CorporateActionPrice36 value) {
        this.pricDtls = value;
        return this;
    }
     ...
     *     
     */
    public CorporateActionOption54 setPlcOfTrad(MarketIdentification8 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SecuritiesOption36 }
     * 
     * 
     */
    public List<SecuritiesOption36> getSctiesMvmntDtls() {
        if (sctiesMvmntDtls == null) {
            sctiesMvmntDtls = new ArrayList<SecuritiesOption36>();
        }
     ...
     * 
     */
    public List<CashOption27> getCshMvmntDtls() {
        if (cshMvmntDtls == null) {
            cshMvmntDtls = new ArrayList<CashOption27>();
        }
     ...
     * 
     */
    public CorporateActionOption54 addOptnFeatrs(OptionFeaturesFormat3Choice optnFeatrs) {
     ...
     * 
     */
    public CorporateActionOption54 addSctiesMvmntDtls(SecuritiesOption36 sctiesMvmntDtls) {
     ...
     * 
     */
    public CorporateActionOption54 addCshMvmntDtls(CashOption27 cshMvmntDtls) {
