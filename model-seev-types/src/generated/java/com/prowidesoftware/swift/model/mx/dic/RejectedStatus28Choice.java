...
@XmlType(name = "RejectedStatus28Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus28Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason26> rsn;
     ...
     *     
     */
    public RejectedStatus28Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason26 }
     * 
     * 
     */
    public List<RejectedStatusReason26> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason26>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus28Choice addRsn(RejectedStatusReason26 rsn) {
        getRsn().add(rsn);
        return this;
    }
