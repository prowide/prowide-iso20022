...
@XmlType(name = "RejectedStatus60Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus60Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedStatusReason59> rsn;
     ...
     *     
     */
    public RejectedStatus60Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedStatusReason59 }
     * 
     * 
     */
    public List<RejectedStatusReason59> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedStatusReason59>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus60Choice addRsn(RejectedStatusReason59 rsn) {
        getRsn().add(rsn);
        return this;
    }
