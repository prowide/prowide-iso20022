...
@XmlType(name = "CreditorPaymentActivationRequestStatusReportV12", propOrder = {
    "grpHdr",
    "orgnlGrpInfAndSts",
    "orgnlPmtInfAndSts",
    "splmtryData"
})
public class CreditorPaymentActivationRequestStatusReportV12 {
    ...
    protected List<OriginalPaymentInstruction52> orgnlPmtInfAndSts;
     ...
     *     
     */
    public CreditorPaymentActivationRequestStatusReportV12 setGrpHdr(GroupHeader111 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public CreditorPaymentActivationRequestStatusReportV12 setOrgnlGrpInfAndSts(OriginalGroupInformation32 value) {
     ...
     * {@link OriginalPaymentInstruction52 }
     * 
     * 
     * @return
     *     The value of the orgnlPmtInfAndSts property.
     */
    public List<OriginalPaymentInstruction52> getOrgnlPmtInfAndSts() {
     ...
     * 
     */
    public CreditorPaymentActivationRequestStatusReportV12 addOrgnlPmtInfAndSts(OriginalPaymentInstruction52 orgnlPmtInfAndSts) {
     ...
     * 
     */
    public CreditorPaymentActivationRequestStatusReportV12 addSplmtryData(SupplementaryData1 splmtryData) {
