...
@XmlType(name = "OriginalPaymentInstruction5", propOrder = {
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
    "pmtInfSts",
...
public class OriginalPaymentInstruction5 {
    ...
    protected List<PaymentTransaction41> txInfAndSts;
     ...
     *     
     */
    public OriginalPaymentInstruction5 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction5 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction5 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction5 setPmtInfSts(TransactionGroupStatus3Code value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction41 }
     * 
     * 
     */
    public List<PaymentTransaction41> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new ArrayList<PaymentTransaction41>();
        }
     ...
     * 
     */
    public OriginalPaymentInstruction5 addStsRsnInf(StatusReasonInformation9 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction5 addNbOfTxsPerSts(NumberOfTransactionsPerStatus3 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction5 addTxInfAndSts(PaymentTransaction41 txInfAndSts) {
