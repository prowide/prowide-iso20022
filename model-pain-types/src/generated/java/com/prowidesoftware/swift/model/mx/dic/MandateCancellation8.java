...
@XmlType(name = "MandateCancellation8", propOrder = {
    "orgnlMsgInf",
    "cxlRsn",
    "orgnlMndt",
    "splmtryData"
})
public class MandateCancellation8 {

    @XmlElement(name = "OrgnlMsgInf")
    protected OriginalMessageInformation1 orgnlMsgInf;
    @XmlElement(name = "CxlRsn", required = true)
    protected MandateCancellationReason2 cxlRsn;
     ...
     *     
     */
    public MandateCancellation8 setOrgnlMsgInf(OriginalMessageInformation1 value) {
     ...
     * @return
     *     possible object is
     *     {@link MandateCancellationReason2 }
     *     
     */
    public MandateCancellationReason2 getCxlRsn() {
        return cxlRsn;
    }
     ...
     *     
     */
    public MandateCancellation8 setCxlRsn(MandateCancellationReason2 value) {
        this.cxlRsn = value;
        return this;
    }
     ...
     *     
     */
    public MandateCancellation8 setOrgnlMndt(OriginalMandate10Choice value) {
     ...
     * 
     */
    public MandateCancellation8 addSplmtryData(SupplementaryData1 splmtryData) {
