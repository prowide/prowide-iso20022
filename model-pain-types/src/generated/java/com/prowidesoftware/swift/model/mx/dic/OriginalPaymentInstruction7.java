...
@XmlType(name = "OriginalPaymentInstruction7", propOrder = {
    "rvslPmtInfId",
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
...
public class OriginalPaymentInstruction7 {
    ...
    protected List<PaymentTransaction42> txInf;
     ...
     *     
     */
    public OriginalPaymentInstruction7 setRvslPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction7 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction7 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction7 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction7 setBtchBookg(Boolean value) {
     ...
     *     
     */
    public OriginalPaymentInstruction7 setPmtInfRvsl(Boolean value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction42 }
     * 
     * 
     */
    public List<PaymentTransaction42> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction42>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public OriginalPaymentInstruction7 addRvslRsnInf(PaymentReversalReason7 rvslRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction7 addTxInf(PaymentTransaction42 txInf) {
        getTxInf().add(txInf);
        return this;
    }
