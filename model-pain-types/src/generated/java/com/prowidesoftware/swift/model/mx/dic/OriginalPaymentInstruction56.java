...
@XmlType(name = "OriginalPaymentInstruction56", propOrder = {
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
    "pmtInfSts",
...
public class OriginalPaymentInstruction56 {
    ...
    protected List<PaymentTransaction178> txInfAndSts;
     ...
     *     
     */
    public OriginalPaymentInstruction56 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction56 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction56 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction56 setPmtInfSts(String value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction178 }
     * 
     * 
     * @return
     *     The value of the txInfAndSts property.
     */
    public List<PaymentTransaction178> getTxInfAndSts() {
        if (txInfAndSts == null) {
     ...
     * 
     */
    public OriginalPaymentInstruction56 addStsRsnInf(StatusReasonInformation14 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction56 addNbOfTxsPerSts(NumberOfTransactionsPerStatus5 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction56 addTxInfAndSts(PaymentTransaction178 txInfAndSts) {
