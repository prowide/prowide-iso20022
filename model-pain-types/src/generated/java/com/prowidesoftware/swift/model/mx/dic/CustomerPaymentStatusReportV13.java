...
@XmlType(name = "CustomerPaymentStatusReportV13", propOrder = {
    "grpHdr",
    "orgnlGrpInfAndSts",
    "orgnlPmtInfAndSts",
    "splmtryData"
})
public class CustomerPaymentStatusReportV13 {
    ...
    protected List<OriginalPaymentInstruction45> orgnlPmtInfAndSts;
     ...
     *     
     */
    public CustomerPaymentStatusReportV13 setGrpHdr(GroupHeader86 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public CustomerPaymentStatusReportV13 setOrgnlGrpInfAndSts(OriginalGroupHeader17 value) {
     ...
     * {@link OriginalPaymentInstruction45 }
     * 
     * 
     */
    public List<OriginalPaymentInstruction45> getOrgnlPmtInfAndSts() {
        if (orgnlPmtInfAndSts == null) {
            orgnlPmtInfAndSts = new ArrayList<OriginalPaymentInstruction45>();
        }
     ...
     * 
     */
    public CustomerPaymentStatusReportV13 addOrgnlPmtInfAndSts(OriginalPaymentInstruction45 orgnlPmtInfAndSts) {
     ...
     * 
     */
    public CustomerPaymentStatusReportV13 addSplmtryData(SupplementaryData1 splmtryData) {
