...
public class OriginalPaymentInstruction38 {
    ...
    protected List<PaymentTransaction126> txInfAndSts;
     ...
     *     
     */
    public OriginalPaymentInstruction38 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction38 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction38 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction38 setPmtInfSts(String value) {
     ...
     * 
     */
    public List<PaymentTransaction126> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new ArrayList<PaymentTransaction126>();
        }
     ...
     * 
     */
    public OriginalPaymentInstruction38 addStsRsnInf(StatusReasonInformation12 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction38 addNbOfTxsPerSts(NumberOfTransactionsPerStatus5 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction38 addTxInfAndSts(PaymentTransaction126 txInfAndSts) {
