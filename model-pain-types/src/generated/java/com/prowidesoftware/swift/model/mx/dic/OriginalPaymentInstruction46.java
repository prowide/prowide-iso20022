...
public class OriginalPaymentInstruction46 {
     ...
     *     
     */
    public OriginalPaymentInstruction46 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction46 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction46 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction46 setPmtInfSts(String value) {
     ...
     * 
     */
    public OriginalPaymentInstruction46 addStsRsnInf(StatusReasonInformation12 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction46 addNbOfTxsPerSts(NumberOfTransactionsPerStatus5 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction46 addTxInfAndSts(PaymentTransaction145 txInfAndSts) {
