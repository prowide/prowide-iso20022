...
@XmlType(name = "CreditorPaymentActivationRequestStatusReportV04", propOrder = {
    "grpHdr",
    "orgnlGrpInfAndSts",
    "orgnlPmtInfAndSts",
    "splmtryData"
...
public class CreditorPaymentActivationRequestStatusReportV04 {
    ...
    protected List<OriginalPaymentInstruction14> orgnlPmtInfAndSts;
     ...
     *     
     */
    public CreditorPaymentActivationRequestStatusReportV04 setGrpHdr(GroupHeader46 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public CreditorPaymentActivationRequestStatusReportV04 setOrgnlGrpInfAndSts(OriginalGroupInformation25 value) {
     ...
     * {@link OriginalPaymentInstruction14 }
     * 
     * 
     */
    public List<OriginalPaymentInstruction14> getOrgnlPmtInfAndSts() {
        if (orgnlPmtInfAndSts == null) {
            orgnlPmtInfAndSts = new ArrayList<OriginalPaymentInstruction14>();
        }
     ...
     * 
     */
    public CreditorPaymentActivationRequestStatusReportV04 addOrgnlPmtInfAndSts(OriginalPaymentInstruction14 orgnlPmtInfAndSts) {
     ...
     * 
     */
    public CreditorPaymentActivationRequestStatusReportV04 addSplmtryData(SupplementaryData1 splmtryData) {
