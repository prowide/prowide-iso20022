...
public class OriginalGroupInformation25 {
     ...
     *     
     */
    public OriginalGroupInformation25 setOrgnlMsgId(String value) {
     ...
     *     
     */
    public OriginalGroupInformation25 setOrgnlMsgNmId(String value) {
     ...
     *     
     */
    public OriginalGroupInformation25 setOrgnlCreDtTm(XMLGregorianCalendar value) {
     ...
     *     
     */
    public OriginalGroupInformation25 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalGroupInformation25 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalGroupInformation25 setGrpSts(TransactionGroupStatus3Code value) {
        this.grpSts = value;
        return this;
    }
     ...
     * 
     */
    public OriginalGroupInformation25 addStsRsnInf(StatusReasonInformation9 stsRsnInf) {
     ...
     * 
     */
    public OriginalGroupInformation25 addNbOfTxsPerSts(NumberOfTransactionsPerStatus3 nbOfTxsPerSts) {
