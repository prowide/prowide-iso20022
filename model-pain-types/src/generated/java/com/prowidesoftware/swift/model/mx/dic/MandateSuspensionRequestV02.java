...
@XmlType(name = "MandateSuspensionRequestV02", propOrder = {
    "grpHdr",
    "undrlygSspnsnDtls",
    "splmtryData"
})
public class MandateSuspensionRequestV02 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader80 grpHdr;
    @XmlElement(name = "UndrlygSspnsnDtls", required = true)
    protected List<MandateSuspension2> undrlygSspnsnDtls;
     ...
     *     
     */
    public MandateSuspensionRequestV02 setGrpHdr(GroupHeader80 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link MandateSuspension2 }
     * 
     * 
     */
    public List<MandateSuspension2> getUndrlygSspnsnDtls() {
        if (undrlygSspnsnDtls == null) {
            undrlygSspnsnDtls = new ArrayList<MandateSuspension2>();
        }
     ...
     * 
     */
    public MandateSuspensionRequestV02 addUndrlygSspnsnDtls(MandateSuspension2 undrlygSspnsnDtls) {
     ...
     * 
     */
    public MandateSuspensionRequestV02 addSplmtryData(SupplementaryData1 splmtryData) {
