...
@XmlType(name = "MandateAmendmentRequestV03", propOrder = {
    "grpHdr",
    "undrlygAmdmntDtls",
    "splmtryData"
})
public class MandateAmendmentRequestV03 {
    ...
    protected List<MandateAmendment3> undrlygAmdmntDtls;
     ...
     *     
     */
    public MandateAmendmentRequestV03 setGrpHdr(GroupHeader47 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link MandateAmendment3 }
     * 
     * 
     */
    public List<MandateAmendment3> getUndrlygAmdmntDtls() {
        if (undrlygAmdmntDtls == null) {
            undrlygAmdmntDtls = new ArrayList<MandateAmendment3>();
        }
     ...
     * 
     */
    public MandateAmendmentRequestV03 addUndrlygAmdmntDtls(MandateAmendment3 undrlygAmdmntDtls) {
     ...
     * 
     */
    public MandateAmendmentRequestV03 addSplmtryData(SupplementaryData1 splmtryData) {
