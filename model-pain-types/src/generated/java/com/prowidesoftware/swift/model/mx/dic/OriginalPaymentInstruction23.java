...
@XmlType(name = "OriginalPaymentInstruction23", propOrder = {
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
    "pmtInfSts",
...
public class OriginalPaymentInstruction23 {
    ...
    protected List<PaymentTransaction82> txInfAndSts;
     ...
     *     
     */
    public OriginalPaymentInstruction23 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction23 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction23 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction23 setPmtInfSts(String value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction82 }
     * 
     * 
     */
    public List<PaymentTransaction82> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new ArrayList<PaymentTransaction82>();
        }
     ...
     * 
     */
    public OriginalPaymentInstruction23 addStsRsnInf(StatusReasonInformation9 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction23 addNbOfTxsPerSts(NumberOfTransactionsPerStatus5 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction23 addTxInfAndSts(PaymentTransaction82 txInfAndSts) {
