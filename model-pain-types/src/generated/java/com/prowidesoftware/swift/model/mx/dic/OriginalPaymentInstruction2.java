...
@XmlType(name = "OriginalPaymentInstruction2", propOrder = {
    "rvslPmtInfId",
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
...
public class OriginalPaymentInstruction2 {
    ...
    protected List<PaymentTransaction35> txInf;
     ...
     *     
     */
    public OriginalPaymentInstruction2 setRvslPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction2 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction2 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction2 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction2 setBtchBookg(Boolean value) {
     ...
     *     
     */
    public OriginalPaymentInstruction2 setPmtInfRvsl(Boolean value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction35 }
     * 
     * 
     */
    public List<PaymentTransaction35> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction35>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public OriginalPaymentInstruction2 addRvslRsnInf(PaymentReversalReason7 rvslRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction2 addTxInf(PaymentTransaction35 txInf) {
        getTxInf().add(txInf);
        return this;
    }
