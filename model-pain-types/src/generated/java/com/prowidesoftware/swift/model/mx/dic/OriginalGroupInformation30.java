...
public class OriginalGroupInformation30 {
     ...
     *     
     */
    public OriginalGroupInformation30 setOrgnlMsgId(String value) {
     ...
     *     
     */
    public OriginalGroupInformation30 setOrgnlMsgNmId(String value) {
     ...
     *     
     */
    public OriginalGroupInformation30 setOrgnlCreDtTm(XMLGregorianCalendar value) {
     ...
     *     
     */
    public OriginalGroupInformation30 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalGroupInformation30 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalGroupInformation30 setGrpSts(String value) {
        this.grpSts = value;
        return this;
    }
     ...
     * 
     */
    public OriginalGroupInformation30 addStsRsnInf(StatusReasonInformation12 stsRsnInf) {
     ...
     * 
     */
    public OriginalGroupInformation30 addNbOfTxsPerSts(NumberOfTransactionsPerStatus5 nbOfTxsPerSts) {
