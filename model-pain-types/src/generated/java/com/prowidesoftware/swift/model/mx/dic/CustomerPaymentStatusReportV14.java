...
@XmlType(name = "CustomerPaymentStatusReportV14", propOrder = {
    "grpHdr",
    "orgnlGrpInfAndSts",
    "orgnlPmtInfAndSts",
    "splmtryData"
})
public class CustomerPaymentStatusReportV14 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader128 grpHdr;
    @XmlElement(name = "OrgnlGrpInfAndSts", required = true)
    protected OriginalGroupHeader22 orgnlGrpInfAndSts;
    @XmlElement(name = "OrgnlPmtInfAndSts")
    protected List<OriginalPaymentInstruction51> orgnlPmtInfAndSts;
     ...
     *     
     */
    public GroupHeader128 getGrpHdr() {
        return grpHdr;
    }
     ...
     *     
     */
    public CustomerPaymentStatusReportV14 setGrpHdr(GroupHeader128 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public OriginalGroupHeader22 getOrgnlGrpInfAndSts() {
     ...
     *     
     */
    public CustomerPaymentStatusReportV14 setOrgnlGrpInfAndSts(OriginalGroupHeader22 value) {
     ...
     * {@link OriginalPaymentInstruction51 }
     * 
     * 
     */
    public List<OriginalPaymentInstruction51> getOrgnlPmtInfAndSts() {
        if (orgnlPmtInfAndSts == null) {
            orgnlPmtInfAndSts = new ArrayList<OriginalPaymentInstruction51>();
        }
     ...
     * 
     */
    public CustomerPaymentStatusReportV14 addOrgnlPmtInfAndSts(OriginalPaymentInstruction51 orgnlPmtInfAndSts) {
     ...
     * 
     */
    public CustomerPaymentStatusReportV14 addSplmtryData(SupplementaryData1 splmtryData) {
