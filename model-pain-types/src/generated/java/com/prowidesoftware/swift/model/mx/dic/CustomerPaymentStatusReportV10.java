...
public class CustomerPaymentStatusReportV10 {
    ...
    protected List<OriginalPaymentInstruction32> orgnlPmtInfAndSts;
     ...
     *     
     */
    public CustomerPaymentStatusReportV10 setGrpHdr(GroupHeader86 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public CustomerPaymentStatusReportV10 setOrgnlGrpInfAndSts(OriginalGroupHeader17 value) {
     ...
     * {@link OriginalPaymentInstruction32 }
     * 
     * 
     */
    public List<OriginalPaymentInstruction32> getOrgnlPmtInfAndSts() {
        if (orgnlPmtInfAndSts == null) {
            orgnlPmtInfAndSts = new ArrayList<OriginalPaymentInstruction32>();
        }
     ...
     * 
     */
    public CustomerPaymentStatusReportV10 addOrgnlPmtInfAndSts(OriginalPaymentInstruction32 orgnlPmtInfAndSts) {
     ...
     * 
     */
    public CustomerPaymentStatusReportV10 addSplmtryData(SupplementaryData1 splmtryData) {
