...
@XmlType(name = "CustomerPaymentStatusReportV06", propOrder = {
    "grpHdr",
    "orgnlGrpInfAndSts",
    "orgnlPmtInfAndSts",
    "splmtryData"
...
public class CustomerPaymentStatusReportV06 {
     ...
     *     
     */
    public CustomerPaymentStatusReportV06 setGrpHdr(GroupHeader52 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public CustomerPaymentStatusReportV06 setOrgnlGrpInfAndSts(OriginalGroupHeader1 value) {
     ...
     * {@link OriginalPaymentInstruction12 }
     * 
     * 
     */
    public List<OriginalPaymentInstruction12> getOrgnlPmtInfAndSts() {
        if (orgnlPmtInfAndSts == null) {
            orgnlPmtInfAndSts = new ArrayList<OriginalPaymentInstruction12>();
        }
     ...
     * 
     */
    public CustomerPaymentStatusReportV06 addOrgnlPmtInfAndSts(OriginalPaymentInstruction12 orgnlPmtInfAndSts) {
     ...
     * 
     */
    public CustomerPaymentStatusReportV06 addSplmtryData(SupplementaryData1 splmtryData) {
