...
public class OriginalPaymentInstruction18 {
     ...
     *     
     */
    public OriginalPaymentInstruction18 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction18 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction18 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction18 setPmtInfSts(TransactionGroupStatus3Code value) {
     ...
     * 
     */
    public OriginalPaymentInstruction18 addStsRsnInf(StatusReasonInformation9 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction18 addNbOfTxsPerSts(NumberOfTransactionsPerStatus3 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction18 addTxInfAndSts(PaymentTransaction68 txInfAndSts) {
