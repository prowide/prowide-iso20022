...
@XmlType(name = "OriginalPaymentInstruction45", propOrder = {
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
    "pmtInfSts",
...
public class OriginalPaymentInstruction45 {
    ...
    protected List<PaymentTransaction144> txInfAndSts;
     ...
     *     
     */
    public OriginalPaymentInstruction45 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction45 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction45 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction45 setPmtInfSts(String value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction144 }
     * 
     * 
     */
    public List<PaymentTransaction144> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new ArrayList<PaymentTransaction144>();
        }
     ...
     * 
     */
    public OriginalPaymentInstruction45 addStsRsnInf(StatusReasonInformation12 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction45 addNbOfTxsPerSts(NumberOfTransactionsPerStatus5 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction45 addTxInfAndSts(PaymentTransaction144 txInfAndSts) {
