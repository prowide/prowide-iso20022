...
@XmlType(name = "CreditorPaymentActivationRequestV04", propOrder = {
    "grpHdr",
    "pmtInf",
    "splmtryData"
})
public class CreditorPaymentActivationRequestV04 {
    ...
    protected List<PaymentInstruction17> pmtInf;
     ...
     *     
     */
    public CreditorPaymentActivationRequestV04 setGrpHdr(GroupHeader45 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link PaymentInstruction17 }
     * 
     * 
     */
    public List<PaymentInstruction17> getPmtInf() {
        if (pmtInf == null) {
            pmtInf = new ArrayList<PaymentInstruction17>();
        }
        return this.pmtInf;
    }
     ...
     * 
     */
    public CreditorPaymentActivationRequestV04 addPmtInf(PaymentInstruction17 pmtInf) {
     ...
     * 
     */
    public CreditorPaymentActivationRequestV04 addSplmtryData(SupplementaryData1 splmtryData) {
