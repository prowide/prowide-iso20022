...
@XmlType(name = "CustomerPaymentReversalV08", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "orgnlPmtInfAndRvsl",
    "splmtryData"
...
public class CustomerPaymentReversalV08 {
    ...
    protected GroupHeader75 grpHdr;
    @XmlElement(name = "OrgnlGrpInf", required = true)
    protected OriginalGroupHeader11 orgnlGrpInf;
    @XmlElement(name = "OrgnlPmtInfAndRvsl")
    protected List<OriginalPaymentInstruction28> orgnlPmtInfAndRvsl;
     ...
     *     
     */
    public GroupHeader75 getGrpHdr() {
        return grpHdr;
    }
     ...
     *     
     */
    public CustomerPaymentReversalV08 setGrpHdr(GroupHeader75 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link OriginalGroupHeader11 }
     *     
     */
    public OriginalGroupHeader11 getOrgnlGrpInf() {
        return orgnlGrpInf;
    }
     ...
     *     
     */
    public CustomerPaymentReversalV08 setOrgnlGrpInf(OriginalGroupHeader11 value) {
     ...
     * {@link OriginalPaymentInstruction28 }
     * 
     * 
     */
    public List<OriginalPaymentInstruction28> getOrgnlPmtInfAndRvsl() {
        if (orgnlPmtInfAndRvsl == null) {
            orgnlPmtInfAndRvsl = new ArrayList<OriginalPaymentInstruction28>();
        }
     ...
     * 
     */
    public CustomerPaymentReversalV08 addOrgnlPmtInfAndRvsl(OriginalPaymentInstruction28 orgnlPmtInfAndRvsl) {
     ...
     * 
     */
    public CustomerPaymentReversalV08 addSplmtryData(SupplementaryData1 splmtryData) {
