...
@XmlType(name = "OriginalPaymentInstruction53", propOrder = {
    "rvslPmtInfId",
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
...
public class OriginalPaymentInstruction53 {
    ...
    protected List<PaymentTransaction174> txInf;
     ...
     *     
     */
    public OriginalPaymentInstruction53 setRvslPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction53 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction53 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction53 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction53 setBtchBookg(Boolean value) {
     ...
     *     
     */
    public OriginalPaymentInstruction53 setPmtInfRvsl(Boolean value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction174 }
     * 
     * 
     * @return
     *     The value of the txInf property.
     */
    public List<PaymentTransaction174> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<>();
        }
        return this.txInf;
     ...
     * 
     */
    public OriginalPaymentInstruction53 addRvslRsnInf(PaymentReversalReason10 rvslRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction53 addTxInf(PaymentTransaction174 txInf) {
        getTxInf().add(txInf);
        return this;
    }
