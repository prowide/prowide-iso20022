...
@XmlType(name = "CustomerPaymentReversalV07", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "orgnlPmtInfAndRvsl",
    "splmtryData"
...
public class CustomerPaymentReversalV07 {
    ...
    protected List<OriginalPaymentInstruction21> orgnlPmtInfAndRvsl;
     ...
     *     
     */
    public CustomerPaymentReversalV07 setGrpHdr(GroupHeader56 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public CustomerPaymentReversalV07 setOrgnlGrpInf(OriginalGroupHeader3 value) {
     ...
     * {@link OriginalPaymentInstruction21 }
     * 
     * 
     */
    public List<OriginalPaymentInstruction21> getOrgnlPmtInfAndRvsl() {
        if (orgnlPmtInfAndRvsl == null) {
            orgnlPmtInfAndRvsl = new ArrayList<OriginalPaymentInstruction21>();
        }
     ...
     * 
     */
    public CustomerPaymentReversalV07 addOrgnlPmtInfAndRvsl(OriginalPaymentInstruction21 orgnlPmtInfAndRvsl) {
     ...
     * 
     */
    public CustomerPaymentReversalV07 addSplmtryData(SupplementaryData1 splmtryData) {
