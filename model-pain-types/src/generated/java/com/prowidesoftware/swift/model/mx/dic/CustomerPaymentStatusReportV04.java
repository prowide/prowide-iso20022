...
@XmlType(name = "CustomerPaymentStatusReportV04", propOrder = {
    "grpHdr",
    "orgnlGrpInfAndSts",
    "orgnlPmtInfAndSts",
    "splmtryData"
...
public class CustomerPaymentStatusReportV04 {
    ...
    protected List<OriginalPaymentInstruction1> orgnlPmtInfAndSts;
     ...
     *     
     */
    public CustomerPaymentStatusReportV04 setGrpHdr(GroupHeader52 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public CustomerPaymentStatusReportV04 setOrgnlGrpInfAndSts(OriginalGroupHeader1 value) {
     ...
     * {@link OriginalPaymentInstruction1 }
     * 
     * 
     */
    public List<OriginalPaymentInstruction1> getOrgnlPmtInfAndSts() {
        if (orgnlPmtInfAndSts == null) {
            orgnlPmtInfAndSts = new ArrayList<OriginalPaymentInstruction1>();
        }
     ...
     * 
     */
    public CustomerPaymentStatusReportV04 addOrgnlPmtInfAndSts(OriginalPaymentInstruction1 orgnlPmtInfAndSts) {
     ...
     * 
     */
    public CustomerPaymentStatusReportV04 addSplmtryData(SupplementaryData1 splmtryData) {
