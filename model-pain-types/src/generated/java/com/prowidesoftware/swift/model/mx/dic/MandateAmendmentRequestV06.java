...
@XmlType(name = "MandateAmendmentRequestV06", propOrder = {
    "grpHdr",
    "undrlygAmdmntDtls",
    "splmtryData"
})
public class MandateAmendmentRequestV06 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader80 grpHdr;
    @XmlElement(name = "UndrlygAmdmntDtls", required = true)
    protected List<MandateAmendment6> undrlygAmdmntDtls;
     ...
     *     
     */
    public MandateAmendmentRequestV06 setGrpHdr(GroupHeader80 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link MandateAmendment6 }
     * 
     * 
     */
    public List<MandateAmendment6> getUndrlygAmdmntDtls() {
        if (undrlygAmdmntDtls == null) {
            undrlygAmdmntDtls = new ArrayList<MandateAmendment6>();
        }
     ...
     * 
     */
    public MandateAmendmentRequestV06 addUndrlygAmdmntDtls(MandateAmendment6 undrlygAmdmntDtls) {
     ...
     * 
     */
    public MandateAmendmentRequestV06 addSplmtryData(SupplementaryData1 splmtryData) {
