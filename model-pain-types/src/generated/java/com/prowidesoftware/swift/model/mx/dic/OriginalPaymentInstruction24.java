...
@XmlType(name = "OriginalPaymentInstruction24", propOrder = {
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
    "pmtInfSts",
...
public class OriginalPaymentInstruction24 {
    ...
    protected List<PaymentTransaction83> txInfAndSts;
     ...
     *     
     */
    public OriginalPaymentInstruction24 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction24 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction24 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction24 setPmtInfSts(String value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction83 }
     * 
     * 
     */
    public List<PaymentTransaction83> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new ArrayList<PaymentTransaction83>();
        }
     ...
     * 
     */
    public OriginalPaymentInstruction24 addStsRsnInf(StatusReasonInformation9 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction24 addNbOfTxsPerSts(NumberOfTransactionsPerStatus5 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction24 addTxInfAndSts(PaymentTransaction83 txInfAndSts) {
