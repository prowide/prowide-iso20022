...
@XmlType(name = "CustomerPaymentReversalV09", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "orgnlPmtInfAndRvsl",
    "splmtryData"
})
public class CustomerPaymentReversalV09 {
    ...
    protected List<OriginalPaymentInstruction33> orgnlPmtInfAndRvsl;
     ...
     *     
     */
    public CustomerPaymentReversalV09 setGrpHdr(GroupHeader88 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public CustomerPaymentReversalV09 setOrgnlGrpInf(OriginalGroupHeader16 value) {
     ...
     * {@link OriginalPaymentInstruction33 }
     * 
     * 
     */
    public List<OriginalPaymentInstruction33> getOrgnlPmtInfAndRvsl() {
        if (orgnlPmtInfAndRvsl == null) {
            orgnlPmtInfAndRvsl = new ArrayList<OriginalPaymentInstruction33>();
        }
     ...
     * 
     */
    public CustomerPaymentReversalV09 addOrgnlPmtInfAndRvsl(OriginalPaymentInstruction33 orgnlPmtInfAndRvsl) {
     ...
     * 
     */
    public CustomerPaymentReversalV09 addSplmtryData(SupplementaryData1 splmtryData) {
