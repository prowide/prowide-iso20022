...
@XmlType(name = "MandateAcceptanceReportV07", propOrder = {
    "grpHdr",
    "undrlygAccptncDtls",
    "splmtryData"
})
public class MandateAcceptanceReportV07 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader80 grpHdr;
    @XmlElement(name = "UndrlygAccptncDtls", required = true)
    protected List<MandateAcceptance7> undrlygAccptncDtls;
     ...
     *     
     */
    public MandateAcceptanceReportV07 setGrpHdr(GroupHeader80 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * This is why there is not a {@code set} method for the undrlygAccptncDtls property.
     * 
     * <p>
     ...
     * {@link MandateAcceptance7 }
     * 
     * 
     * @return
     *     The value of the undrlygAccptncDtls property.
     */
    public List<MandateAcceptance7> getUndrlygAccptncDtls() {
        if (undrlygAccptncDtls == null) {
            undrlygAccptncDtls = new ArrayList<>();
        }
     ...
     * 
     */
    public MandateAcceptanceReportV07 addUndrlygAccptncDtls(MandateAcceptance7 undrlygAccptncDtls) {
     ...
     * 
     */
    public MandateAcceptanceReportV07 addSplmtryData(SupplementaryData1 splmtryData) {
