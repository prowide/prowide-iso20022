...
@XmlType(name = "CustomerCreditTransferInitiationV04", propOrder = {
    "grpHdr",
    "pmtInf",
    "splmtryData"
})
public class CustomerCreditTransferInitiationV04 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader48 grpHdr;
    @XmlElement(name = "PmtInf", required = true)
    protected List<PaymentInstruction6> pmtInf;
     ...
     *     
     */
    public CustomerCreditTransferInitiationV04 setGrpHdr(GroupHeader48 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link PaymentInstruction6 }
     * 
     * 
     */
    public List<PaymentInstruction6> getPmtInf() {
        if (pmtInf == null) {
            pmtInf = new ArrayList<PaymentInstruction6>();
        }
        return this.pmtInf;
    }
     ...
     * 
     */
    public CustomerCreditTransferInitiationV04 addPmtInf(PaymentInstruction6 pmtInf) {
     ...
     * 
     */
    public CustomerCreditTransferInitiationV04 addSplmtryData(SupplementaryData1 splmtryData) {
