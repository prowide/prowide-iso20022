...
@XmlType(name = "CreditorPaymentActivationRequestV02", propOrder = {
    "grpHdr",
    "pmtInf",
    "splmtryData"
})
public class CreditorPaymentActivationRequestV02 {
    ...
    protected List<PaymentInstruction8> pmtInf;
     ...
     *     
     */
    public CreditorPaymentActivationRequestV02 setGrpHdr(GroupHeader45 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link PaymentInstruction8 }
     * 
     * 
     */
    public List<PaymentInstruction8> getPmtInf() {
        if (pmtInf == null) {
            pmtInf = new ArrayList<PaymentInstruction8>();
        }
        return this.pmtInf;
    }
     ...
     * 
     */
    public CreditorPaymentActivationRequestV02 addPmtInf(PaymentInstruction8 pmtInf) {
     ...
     * 
     */
    public CreditorPaymentActivationRequestV02 addSplmtryData(SupplementaryData1 splmtryData) {
