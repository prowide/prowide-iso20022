...
@XmlType(name = "OriginalMandate7Choice", propOrder = {
    "orgnlMndtId",
    "orgnlMndt"
})
public class OriginalMandate7Choice {

    @XmlElement(name = "OrgnlMndtId")
    protected String orgnlMndtId;
    @XmlElement(name = "OrgnlMndt")
    protected Mandate15 orgnlMndt;
     ...
     *     
     */
    public OriginalMandate7Choice setOrgnlMndtId(String value) {
     ...
     *     
     */
    public OriginalMandate7Choice setOrgnlMndt(Mandate15 value) {
