...
@XmlType(name = "MandateSuspension2", propOrder = {
    "sspnsnReqId",
    "orgnlMsgInf",
    "sspnsnRsn",
    "orgnlMndt",
...
public class MandateSuspension2 {
     ...
     *     
     */
    public MandateSuspension2 setSspnsnReqId(String value) {
     ...
     *     
     */
    public MandateSuspension2 setOrgnlMsgInf(OriginalMessageInformation1 value) {
     ...
     *     
     */
    public MandateSuspension2 setSspnsnRsn(MandateSuspensionReason2 value) {
     ...
     *     
     */
    public MandateSuspension2 setOrgnlMndt(OriginalMandate6Choice value) {
     ...
     * 
     */
    public MandateSuspension2 addSplmtryData(SupplementaryData1 splmtryData) {
