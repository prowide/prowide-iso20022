...
@XmlType(name = "OriginalPaymentInstruction37", propOrder = {
    "rvslPmtInfId",
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
...
public class OriginalPaymentInstruction37 {
    ...
    protected List<PaymentTransaction125> txInf;
     ...
     *     
     */
    public OriginalPaymentInstruction37 setRvslPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction37 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction37 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction37 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction37 setBtchBookg(Boolean value) {
     ...
     *     
     */
    public OriginalPaymentInstruction37 setPmtInfRvsl(Boolean value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction125 }
     * 
     * 
     */
    public List<PaymentTransaction125> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction125>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public OriginalPaymentInstruction37 addRvslRsnInf(PaymentReversalReason9 rvslRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction37 addTxInf(PaymentTransaction125 txInf) {
        getTxInf().add(txInf);
        return this;
    }
