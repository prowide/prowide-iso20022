...
@XmlType(name = "MandateCopyRequestV01", propOrder = {
    "grpHdr",
    "undrlygCpyReqDtls",
    "splmtryData"
})
public class MandateCopyRequestV01 {
    ...
    protected List<MandateCopy1> undrlygCpyReqDtls;
     ...
     *     
     */
    public MandateCopyRequestV01 setGrpHdr(GroupHeader47 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public List<MandateCopy1> getUndrlygCpyReqDtls() {
        if (undrlygCpyReqDtls == null) {
            undrlygCpyReqDtls = new ArrayList<MandateCopy1>();
        }
     ...
     * 
     */
    public MandateCopyRequestV01 addUndrlygCpyReqDtls(MandateCopy1 undrlygCpyReqDtls) {
     ...
     * 
     */
    public MandateCopyRequestV01 addSplmtryData(SupplementaryData1 splmtryData) {
