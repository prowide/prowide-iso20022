...
@XmlType(name = "CreditorPaymentActivationRequestV03", propOrder = {
    "grpHdr",
    "pmtInf",
    "splmtryData"
})
public class CreditorPaymentActivationRequestV03 {
    ...
    protected List<PaymentInstruction11> pmtInf;
     ...
     *     
     */
    public CreditorPaymentActivationRequestV03 setGrpHdr(GroupHeader45 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link PaymentInstruction11 }
     * 
     * 
     */
    public List<PaymentInstruction11> getPmtInf() {
        if (pmtInf == null) {
            pmtInf = new ArrayList<PaymentInstruction11>();
        }
        return this.pmtInf;
    }
     ...
     * 
     */
    public CreditorPaymentActivationRequestV03 addPmtInf(PaymentInstruction11 pmtInf) {
     ...
     * 
     */
    public CreditorPaymentActivationRequestV03 addSplmtryData(SupplementaryData1 splmtryData) {
