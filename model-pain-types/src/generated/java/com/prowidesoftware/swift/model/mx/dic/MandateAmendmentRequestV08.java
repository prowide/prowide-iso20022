...
@XmlType(name = "MandateAmendmentRequestV08", propOrder = {
    "grpHdr",
    "undrlygAmdmntDtls",
    "splmtryData"
})
public class MandateAmendmentRequestV08 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader110 grpHdr;
    @XmlElement(name = "UndrlygAmdmntDtls", required = true)
    protected List<MandateAmendment8> undrlygAmdmntDtls;
     ...
     *     
     */
    public MandateAmendmentRequestV08 setGrpHdr(GroupHeader110 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link MandateAmendment8 }
     * 
     * 
     * @return
     *     The value of the undrlygAmdmntDtls property.
     */
    public List<MandateAmendment8> getUndrlygAmdmntDtls() {
     ...
     * 
     */
    public MandateAmendmentRequestV08 addUndrlygAmdmntDtls(MandateAmendment8 undrlygAmdmntDtls) {
     ...
     * 
     */
    public MandateAmendmentRequestV08 addSplmtryData(SupplementaryData1 splmtryData) {
