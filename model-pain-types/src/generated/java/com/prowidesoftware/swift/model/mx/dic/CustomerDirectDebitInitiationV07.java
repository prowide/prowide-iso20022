...
@XmlType(name = "CustomerDirectDebitInitiationV07", propOrder = {
    "grpHdr",
    "pmtInf",
    "splmtryData"
})
public class CustomerDirectDebitInitiationV07 {
    ...
    protected List<PaymentInstruction21> pmtInf;
     ...
     *     
     */
    public CustomerDirectDebitInitiationV07 setGrpHdr(GroupHeader55 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link PaymentInstruction21 }
     * 
     * 
     */
    public List<PaymentInstruction21> getPmtInf() {
        if (pmtInf == null) {
            pmtInf = new ArrayList<PaymentInstruction21>();
        }
        return this.pmtInf;
    }
     ...
     * 
     */
    public CustomerDirectDebitInitiationV07 addPmtInf(PaymentInstruction21 pmtInf) {
     ...
     * 
     */
    public CustomerDirectDebitInitiationV07 addSplmtryData(SupplementaryData1 splmtryData) {
