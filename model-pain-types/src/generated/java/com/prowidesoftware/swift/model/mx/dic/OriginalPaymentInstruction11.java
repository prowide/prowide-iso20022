...
@XmlType(name = "OriginalPaymentInstruction11", propOrder = {
    "rvslPmtInfId",
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
...
public class OriginalPaymentInstruction11 {
     ...
     *     
     */
    public OriginalPaymentInstruction11 setRvslPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction11 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction11 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction11 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction11 setBtchBookg(Boolean value) {
     ...
     *     
     */
    public OriginalPaymentInstruction11 setPmtInfRvsl(Boolean value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction56 }
     * 
     * 
     */
    public List<PaymentTransaction56> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction56>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public OriginalPaymentInstruction11 addRvslRsnInf(PaymentReversalReason7 rvslRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction11 addTxInf(PaymentTransaction56 txInf) {
        getTxInf().add(txInf);
        return this;
    }
