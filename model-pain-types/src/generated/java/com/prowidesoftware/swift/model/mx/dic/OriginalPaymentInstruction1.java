...
@XmlType(name = "OriginalPaymentInstruction1", propOrder = {
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
    "pmtInfSts",
...
public class OriginalPaymentInstruction1 {
    ...
    protected List<PaymentTransaction32> txInfAndSts;
     ...
     *     
     */
    public OriginalPaymentInstruction1 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction1 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction1 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction1 setPmtInfSts(TransactionGroupStatus3Code value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction32 }
     * 
     * 
     */
    public List<PaymentTransaction32> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new ArrayList<PaymentTransaction32>();
        }
     ...
     * 
     */
    public OriginalPaymentInstruction1 addStsRsnInf(StatusReasonInformation9 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction1 addNbOfTxsPerSts(NumberOfTransactionsPerStatus3 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction1 addTxInfAndSts(PaymentTransaction32 txInfAndSts) {
