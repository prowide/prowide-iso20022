...
@XmlType(name = "CustomerDirectDebitInitiationV06", propOrder = {
    "grpHdr",
    "pmtInf",
    "splmtryData"
})
public class CustomerDirectDebitInitiationV06 {
    ...
    protected List<PaymentInstruction18> pmtInf;
     ...
     *     
     */
    public CustomerDirectDebitInitiationV06 setGrpHdr(GroupHeader55 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link PaymentInstruction18 }
     * 
     * 
     */
    public List<PaymentInstruction18> getPmtInf() {
        if (pmtInf == null) {
            pmtInf = new ArrayList<PaymentInstruction18>();
        }
        return this.pmtInf;
    }
     ...
     * 
     */
    public CustomerDirectDebitInitiationV06 addPmtInf(PaymentInstruction18 pmtInf) {
     ...
     * 
     */
    public CustomerDirectDebitInitiationV06 addSplmtryData(SupplementaryData1 splmtryData) {
