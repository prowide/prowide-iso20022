...
@XmlType(name = "OriginalPaymentInstruction52", propOrder = {
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
    "pmtInfSts",
...
public class OriginalPaymentInstruction52 {
    ...
    protected List<PaymentTransaction169> txInfAndSts;
     ...
     *     
     */
    public OriginalPaymentInstruction52 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction52 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction52 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction52 setPmtInfSts(String value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction169 }
     * 
     * 
     * @return
     *     The value of the txInfAndSts property.
     */
    public List<PaymentTransaction169> getTxInfAndSts() {
        if (txInfAndSts == null) {
     ...
     * 
     */
    public OriginalPaymentInstruction52 addStsRsnInf(StatusReasonInformation14 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction52 addNbOfTxsPerSts(NumberOfTransactionsPerStatus5 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction52 addTxInfAndSts(PaymentTransaction169 txInfAndSts) {
