...
@XmlType(name = "MandateInitiationRequestV08", propOrder = {
    "grpHdr",
    "mndt",
    "splmtryData"
})
public class MandateInitiationRequestV08 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader110 grpHdr;
    @XmlElement(name = "Mndt", required = true)
    protected List<Mandate23> mndt;
     ...
     *     
     */
    public MandateInitiationRequestV08 setGrpHdr(GroupHeader110 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public List<Mandate23> getMndt() {
        if (mndt == null) {
            mndt = new ArrayList<Mandate23>();
        }
        return this.mndt;
    }
     ...
     * 
     */
    public MandateInitiationRequestV08 addMndt(Mandate23 mndt) {
        getMndt().add(mndt);
        return this;
    }
     ...
     * 
     */
    public MandateInitiationRequestV08 addSplmtryData(SupplementaryData1 splmtryData) {
