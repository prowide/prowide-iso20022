...
public class OriginalPaymentInstruction31 {
     ...
     *     
     */
    public OriginalPaymentInstruction31 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction31 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction31 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction31 setPmtInfSts(String value) {
     ...
     * 
     */
    public OriginalPaymentInstruction31 addStsRsnInf(StatusReasonInformation12 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction31 addNbOfTxsPerSts(NumberOfTransactionsPerStatus5 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction31 addTxInfAndSts(PaymentTransaction104 txInfAndSts) {
