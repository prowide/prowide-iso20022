...
public class PaymentInstruction16 {
     ...
     *     
     */
    public PaymentInstruction16 setReqdExctnDt(XMLGregorianCalendar value) {
     ...
     *     
     */
    public PaymentInstruction16 setPoolgAdjstmntDt(XMLGregorianCalendar value) {
    ...
    public List<CreditTransferTransaction20> getCdtTrfTxInf() {
        if (cdtTrfTxInf == null) {
            cdtTrfTxInf = new ArrayList<CreditTransferTransaction20>();
        }
