...
@XmlType(name = "CustomerCreditTransferInitiationV13", propOrder = {
    "grpHdr",
    "pmtInf",
    "splmtryData"
})
public class CustomerCreditTransferInitiationV13 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader114 grpHdr;
    @XmlElement(name = "PmtInf", required = true)
    protected List<PaymentInstruction51> pmtInf;
     ...
     *     
     */
    public CustomerCreditTransferInitiationV13 setGrpHdr(GroupHeader114 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link PaymentInstruction51 }
     * 
     * 
     * @return
     *     The value of the pmtInf property.
     */
    public List<PaymentInstruction51> getPmtInf() {
        if (pmtInf == null) {
     ...
     * 
     */
    public CustomerCreditTransferInitiationV13 addPmtInf(PaymentInstruction51 pmtInf) {
     ...
     * 
     */
    public CustomerCreditTransferInitiationV13 addSplmtryData(SupplementaryData1 splmtryData) {
