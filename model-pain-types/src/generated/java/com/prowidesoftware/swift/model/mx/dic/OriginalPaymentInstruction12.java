...
public class OriginalPaymentInstruction12 {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction57 }
     * 
     * 
     */
    public List<PaymentTransaction57> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new ArrayList<PaymentTransaction57>();
        }
     ...
     * 
     */
    public OriginalPaymentInstruction12 addStsRsnInf(StatusReasonInformation9 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction12 addNbOfTxsPerSts(NumberOfTransactionsPerStatus3 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction12 addTxInfAndSts(PaymentTransaction57 txInfAndSts) {
