...
public class MandateCopyRequestV03 {
     ...
     *     
     */
    public MandateCopyRequestV03 setGrpHdr(GroupHeader80 value) {
        this.grpHdr = value;
        return this;
    }
    ...
    public List<MandateCopy3> getUndrlygCpyReqDtls() {
        if (undrlygCpyReqDtls == null) {
            undrlygCpyReqDtls = new ArrayList<MandateCopy3>();
        }
     ...
     * 
     */
    public MandateCopyRequestV03 addUndrlygCpyReqDtls(MandateCopy3 undrlygCpyReqDtls) {
     ...
     * 
     */
    public MandateCopyRequestV03 addSplmtryData(SupplementaryData1 splmtryData) {
