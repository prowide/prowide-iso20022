...
@XmlType(name = "CustomerDirectDebitInitiationV12", propOrder = {
    "grpHdr",
    "pmtInf",
    "splmtryData"
})
public class CustomerDirectDebitInitiationV12 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader118 grpHdr;
    @XmlElement(name = "PmtInf", required = true)
    protected List<PaymentInstruction50> pmtInf;
     ...
     *     
     */
    public CustomerDirectDebitInitiationV12 setGrpHdr(GroupHeader118 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link PaymentInstruction50 }
     * 
     * 
     * @return
     *     The value of the pmtInf property.
     */
    public List<PaymentInstruction50> getPmtInf() {
        if (pmtInf == null) {
     ...
     * 
     */
    public CustomerDirectDebitInitiationV12 addPmtInf(PaymentInstruction50 pmtInf) {
     ...
     * 
     */
    public CustomerDirectDebitInitiationV12 addSplmtryData(SupplementaryData1 splmtryData) {
