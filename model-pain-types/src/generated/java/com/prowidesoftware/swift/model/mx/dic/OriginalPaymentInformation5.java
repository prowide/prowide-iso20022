...
@XmlType(name = "OriginalPaymentInformation5", propOrder = {
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
    "pmtInfSts",
...
public class OriginalPaymentInformation5 {
    ...
    protected List<PaymentTransactionInformation34> txInfAndSts;
     ...
     *     
     */
    public OriginalPaymentInformation5 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInformation5 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInformation5 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInformation5 setPmtInfSts(TransactionGroupStatus3Code value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransactionInformation34 }
     * 
     * 
     */
    public List<PaymentTransactionInformation34> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new ArrayList<PaymentTransactionInformation34>();
        }
     ...
     * 
     */
    public OriginalPaymentInformation5 addStsRsnInf(StatusReasonInformation9 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInformation5 addNbOfTxsPerSts(NumberOfTransactionsPerStatus3 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInformation5 addTxInfAndSts(PaymentTransactionInformation34 txInfAndSts) {
