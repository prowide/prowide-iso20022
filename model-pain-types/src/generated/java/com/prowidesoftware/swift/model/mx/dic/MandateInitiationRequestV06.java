...
@XmlType(name = "MandateInitiationRequestV06", propOrder = {
    "grpHdr",
    "mndt",
    "splmtryData"
})
public class MandateInitiationRequestV06 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader80 grpHdr;
    @XmlElement(name = "Mndt", required = true)
    protected List<Mandate13> mndt;
     ...
     *     
     */
    public MandateInitiationRequestV06 setGrpHdr(GroupHeader80 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public List<Mandate13> getMndt() {
        if (mndt == null) {
            mndt = new ArrayList<Mandate13>();
        }
        return this.mndt;
    }
     ...
     * 
     */
    public MandateInitiationRequestV06 addMndt(Mandate13 mndt) {
        getMndt().add(mndt);
        return this;
    }
     ...
     * 
     */
    public MandateInitiationRequestV06 addSplmtryData(SupplementaryData1 splmtryData) {
