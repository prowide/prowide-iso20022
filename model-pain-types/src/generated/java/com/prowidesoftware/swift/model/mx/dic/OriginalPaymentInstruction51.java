...
@XmlType(name = "OriginalPaymentInstruction51", propOrder = {
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
    "pmtInfSts",
...
public class OriginalPaymentInstruction51 {
    ...
    protected List<PaymentTransaction160> txInfAndSts;
     ...
     *     
     */
    public OriginalPaymentInstruction51 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction51 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction51 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction51 setPmtInfSts(String value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction160 }
     * 
     * 
     */
    public List<PaymentTransaction160> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new ArrayList<PaymentTransaction160>();
        }
     ...
     * 
     */
    public OriginalPaymentInstruction51 addStsRsnInf(StatusReasonInformation14 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction51 addNbOfTxsPerSts(NumberOfTransactionsPerStatus5 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction51 addTxInfAndSts(PaymentTransaction160 txInfAndSts) {
