...
public class MandateAmendmentRequestV07 {
     ...
     *     
     */
    public MandateAmendmentRequestV07 setGrpHdr(GroupHeader80 value) {
        this.grpHdr = value;
        return this;
    }
    ...
    public List<MandateAmendment7> getUndrlygAmdmntDtls() {
        if (undrlygAmdmntDtls == null) {
            undrlygAmdmntDtls = new ArrayList<MandateAmendment7>();
        }
     ...
     * 
     */
    public MandateAmendmentRequestV07 addUndrlygAmdmntDtls(MandateAmendment7 undrlygAmdmntDtls) {
     ...
     * 
     */
    public MandateAmendmentRequestV07 addSplmtryData(SupplementaryData1 splmtryData) {
