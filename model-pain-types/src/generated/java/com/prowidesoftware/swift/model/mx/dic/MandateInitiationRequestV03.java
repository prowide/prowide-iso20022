...
@XmlType(name = "MandateInitiationRequestV03", propOrder = {
    "grpHdr",
    "mndt",
    "splmtryData"
})
public class MandateInitiationRequestV03 {
     ...
     *     
     */
    public MandateInitiationRequestV03 setGrpHdr(GroupHeader47 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public List<Mandate4> getMndt() {
        if (mndt == null) {
            mndt = new ArrayList<Mandate4>();
        }
        return this.mndt;
    }
     ...
     * 
     */
    public MandateInitiationRequestV03 addMndt(Mandate4 mndt) {
        getMndt().add(mndt);
        return this;
    }
     ...
     * 
     */
    public MandateInitiationRequestV03 addSplmtryData(SupplementaryData1 splmtryData) {
