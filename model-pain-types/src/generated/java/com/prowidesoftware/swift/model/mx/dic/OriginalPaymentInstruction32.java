...
@XmlType(name = "OriginalPaymentInstruction32", propOrder = {
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
    "pmtInfSts",
...
public class OriginalPaymentInstruction32 {
     ...
     *     
     */
    public OriginalPaymentInstruction32 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction32 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction32 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction32 setPmtInfSts(String value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction105 }
     * 
     * 
     */
    public List<PaymentTransaction105> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new ArrayList<PaymentTransaction105>();
        }
     ...
     * 
     */
    public OriginalPaymentInstruction32 addStsRsnInf(StatusReasonInformation12 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction32 addNbOfTxsPerSts(NumberOfTransactionsPerStatus5 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction32 addTxInfAndSts(PaymentTransaction105 txInfAndSts) {
