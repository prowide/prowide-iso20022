...
@XmlType(name = "CreditorPaymentActivationRequestStatusReportV02", propOrder = {
    "grpHdr",
    "orgnlGrpInfAndSts",
    "orgnlPmtInfAndSts",
    "splmtryData"
...
public class CreditorPaymentActivationRequestStatusReportV02 {
    ...
    protected List<OriginalPaymentInstruction5> orgnlPmtInfAndSts;
     ...
     *     
     */
    public CreditorPaymentActivationRequestStatusReportV02 setGrpHdr(GroupHeader46 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public CreditorPaymentActivationRequestStatusReportV02 setOrgnlGrpInfAndSts(OriginalGroupInformation25 value) {
     ...
     * {@link OriginalPaymentInstruction5 }
     * 
     * 
     */
    public List<OriginalPaymentInstruction5> getOrgnlPmtInfAndSts() {
        if (orgnlPmtInfAndSts == null) {
            orgnlPmtInfAndSts = new ArrayList<OriginalPaymentInstruction5>();
        }
     ...
     * 
     */
    public CreditorPaymentActivationRequestStatusReportV02 addOrgnlPmtInfAndSts(OriginalPaymentInstruction5 orgnlPmtInfAndSts) {
     ...
     * 
     */
    public CreditorPaymentActivationRequestStatusReportV02 addSplmtryData(SupplementaryData1 splmtryData) {
