...
public class OriginalPaymentInstruction40 {
     ...
     *     
     */
    public OriginalPaymentInstruction40 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction40 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction40 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction40 setPmtInfSts(String value) {
     ...
     * 
     */
    public OriginalPaymentInstruction40 addStsRsnInf(StatusReasonInformation12 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction40 addNbOfTxsPerSts(NumberOfTransactionsPerStatus5 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction40 addTxInfAndSts(PaymentTransaction129 txInfAndSts) {
