...
@XmlType(name = "CustomerCreditTransferInitiationV07", propOrder = {
    "grpHdr",
    "pmtInf",
    "splmtryData"
})
public class CustomerCreditTransferInitiationV07 {
    ...
    protected List<PaymentInstruction20> pmtInf;
     ...
     *     
     */
    public CustomerCreditTransferInitiationV07 setGrpHdr(GroupHeader48 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link PaymentInstruction20 }
     * 
     * 
     */
    public List<PaymentInstruction20> getPmtInf() {
        if (pmtInf == null) {
            pmtInf = new ArrayList<PaymentInstruction20>();
        }
        return this.pmtInf;
    }
     ...
     * 
     */
    public CustomerCreditTransferInitiationV07 addPmtInf(PaymentInstruction20 pmtInf) {
     ...
     * 
     */
    public CustomerCreditTransferInitiationV07 addSplmtryData(SupplementaryData1 splmtryData) {
