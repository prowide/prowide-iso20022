...
@XmlType(name = "CustomerDirectDebitInitiationV03", propOrder = {
    "grpHdr",
    "pmtInf",
    "splmtryData"
})
public class CustomerDirectDebitInitiationV03 {
    ...
    protected List<PaymentInstruction7> pmtInf;
     ...
     *     
     */
    public CustomerDirectDebitInitiationV03 setGrpHdr(GroupHeader55 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link PaymentInstruction7 }
     * 
     * 
     */
    public List<PaymentInstruction7> getPmtInf() {
        if (pmtInf == null) {
            pmtInf = new ArrayList<PaymentInstruction7>();
        }
        return this.pmtInf;
    }
     ...
     * 
     */
    public CustomerDirectDebitInitiationV03 addPmtInf(PaymentInstruction7 pmtInf) {
     ...
     * 
     */
    public CustomerDirectDebitInitiationV03 addSplmtryData(SupplementaryData1 splmtryData) {
