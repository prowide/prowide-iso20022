...
public class OriginalPaymentInstruction6 {
     ...
     *     
     */
    public OriginalPaymentInstruction6 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction6 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction6 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction6 setPmtInfSts(TransactionGroupStatus3Code value) {
     ...
     * 
     */
    public OriginalPaymentInstruction6 addStsRsnInf(StatusReasonInformation9 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction6 addNbOfTxsPerSts(NumberOfTransactionsPerStatus3 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction6 addTxInfAndSts(PaymentTransaction46 txInfAndSts) {
