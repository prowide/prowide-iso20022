...
@XmlType(name = "CustomerPaymentReversalV04", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "orgnlPmtInfAndRvsl",
    "splmtryData"
...
public class CustomerPaymentReversalV04 {
    ...
    protected List<OriginalPaymentInstruction7> orgnlPmtInfAndRvsl;
     ...
     *     
     */
    public CustomerPaymentReversalV04 setGrpHdr(GroupHeader56 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public CustomerPaymentReversalV04 setOrgnlGrpInf(OriginalGroupHeader3 value) {
     ...
     * {@link OriginalPaymentInstruction7 }
     * 
     * 
     */
    public List<OriginalPaymentInstruction7> getOrgnlPmtInfAndRvsl() {
        if (orgnlPmtInfAndRvsl == null) {
            orgnlPmtInfAndRvsl = new ArrayList<OriginalPaymentInstruction7>();
        }
     ...
     * 
     */
    public CustomerPaymentReversalV04 addOrgnlPmtInfAndRvsl(OriginalPaymentInstruction7 orgnlPmtInfAndRvsl) {
     ...
     * 
     */
    public CustomerPaymentReversalV04 addSplmtryData(SupplementaryData1 splmtryData) {
