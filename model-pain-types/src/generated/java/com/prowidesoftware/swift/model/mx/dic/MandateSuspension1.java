...
@XmlType(name = "MandateSuspension1", propOrder = {
    "sspnsnReqId",
    "orgnlMsgInf",
    "sspnsnRsn",
    "orgnlMndt",
...
public class MandateSuspension1 {
     ...
     *     
     */
    public MandateSuspension1 setSspnsnReqId(String value) {
     ...
     *     
     */
    public MandateSuspension1 setOrgnlMsgInf(OriginalMessageInformation1 value) {
     ...
     *     
     */
    public MandateSuspension1 setSspnsnRsn(MandateSuspensionReason1 value) {
     ...
     *     
     */
    public MandateSuspension1 setOrgnlMndt(OriginalMandate4Choice value) {
     ...
     * 
     */
    public MandateSuspension1 addSplmtryData(SupplementaryData1 splmtryData) {
