...
@XmlType(name = "OriginalPaymentInstruction27", propOrder = {
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
    "pmtInfSts",
...
public class OriginalPaymentInstruction27 {
     ...
     *     
     */
    public OriginalPaymentInstruction27 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction27 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction27 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction27 setPmtInfSts(String value) {
     ...
     * 
     */
    public OriginalPaymentInstruction27 addStsRsnInf(StatusReasonInformation11 stsRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction27 addNbOfTxsPerSts(NumberOfTransactionsPerStatus5 nbOfTxsPerSts) {
     ...
     * 
     */
    public OriginalPaymentInstruction27 addTxInfAndSts(PaymentTransaction92 txInfAndSts) {
