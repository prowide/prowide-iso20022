...
@XmlType(name = "OriginalPaymentInstruction33", propOrder = {
    "rvslPmtInfId",
    "orgnlPmtInfId",
    "orgnlNbOfTxs",
    "orgnlCtrlSum",
...
public class OriginalPaymentInstruction33 {
    ...
    protected List<PaymentTransaction108> txInf;
     ...
     *     
     */
    public OriginalPaymentInstruction33 setRvslPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction33 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction33 setOrgnlNbOfTxs(String value) {
     ...
     *     
     */
    public OriginalPaymentInstruction33 setOrgnlCtrlSum(BigDecimal value) {
     ...
     *     
     */
    public OriginalPaymentInstruction33 setBtchBookg(Boolean value) {
     ...
     *     
     */
    public OriginalPaymentInstruction33 setPmtInfRvsl(Boolean value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction108 }
     * 
     * 
     */
    public List<PaymentTransaction108> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction108>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public OriginalPaymentInstruction33 addRvslRsnInf(PaymentReversalReason9 rvslRsnInf) {
     ...
     * 
     */
    public OriginalPaymentInstruction33 addTxInf(PaymentTransaction108 txInf) {
        getTxInf().add(txInf);
        return this;
    }
