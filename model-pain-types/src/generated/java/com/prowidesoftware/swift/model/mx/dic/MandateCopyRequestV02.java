...
@XmlType(name = "MandateCopyRequestV02", propOrder = {
    "grpHdr",
    "undrlygCpyReqDtls",
    "splmtryData"
})
public class MandateCopyRequestV02 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader80 grpHdr;
    @XmlElement(name = "UndrlygCpyReqDtls", required = true)
    protected List<MandateCopy2> undrlygCpyReqDtls;
     ...
     *     
     */
    public MandateCopyRequestV02 setGrpHdr(GroupHeader80 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public List<MandateCopy2> getUndrlygCpyReqDtls() {
        if (undrlygCpyReqDtls == null) {
            undrlygCpyReqDtls = new ArrayList<MandateCopy2>();
        }
     ...
     * 
     */
    public MandateCopyRequestV02 addUndrlygCpyReqDtls(MandateCopy2 undrlygCpyReqDtls) {
     ...
     * 
     */
    public MandateCopyRequestV02 addSplmtryData(SupplementaryData1 splmtryData) {
