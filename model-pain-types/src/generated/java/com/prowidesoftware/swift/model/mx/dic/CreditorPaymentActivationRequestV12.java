...
@XmlType(name = "CreditorPaymentActivationRequestV12", propOrder = {
    "grpHdr",
    "pmtInf",
    "splmtryData"
})
public class CreditorPaymentActivationRequestV12 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader112 grpHdr;
    @XmlElement(name = "PmtInf", required = true)
    protected List<PaymentInstruction48> pmtInf;
     ...
     *     
     */
    public CreditorPaymentActivationRequestV12 setGrpHdr(GroupHeader112 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link PaymentInstruction48 }
     * 
     * 
     * @return
     *     The value of the pmtInf property.
     */
    public List<PaymentInstruction48> getPmtInf() {
        if (pmtInf == null) {
     ...
     * 
     */
    public CreditorPaymentActivationRequestV12 addPmtInf(PaymentInstruction48 pmtInf) {
     ...
     * 
     */
    public CreditorPaymentActivationRequestV12 addSplmtryData(SupplementaryData1 splmtryData) {
