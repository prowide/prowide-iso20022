    ...
    extends AbstractMX
{
    ...
    public static MxTrck00300101 parse(String xml) {
        return ((MxTrck00300101) MxReadImpl.parse(MxTrck00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrck00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00300101) MxReadImpl.parse(MxTrck00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrck00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrck00300101 .class);
    }
