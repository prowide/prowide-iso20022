    ...
    extends AbstractMX
{
    ...
    public static MxTrck00200103 parse(String xml) {
        return ((MxTrck00200103) MxReadImpl.parse(MxTrck00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrck00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00200103) MxReadImpl.parse(MxTrck00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrck00200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrck00200103 .class);
    }
