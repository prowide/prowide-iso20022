    ...
    extends AbstractMX
{
    ...
    public static MxTrck00400101 parse(String xml) {
        return ((MxTrck00400101) MxReadImpl.parse(MxTrck00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrck00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00400101) MxReadImpl.parse(MxTrck00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrck00400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrck00400101 .class);
    }
