    ...
    extends AbstractMX
{
    ...
    public static MxTrck00200101 parse(String xml) {
        return ((MxTrck00200101) MxReadImpl.parse(MxTrck00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrck00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00200101) MxReadImpl.parse(MxTrck00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrck00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrck00200101 .class);
    }
