    ...
    extends AbstractMX
{
    ...
    public static MxTrck00100101 parse(String xml) {
        return ((MxTrck00100101) MxReadImpl.parse(MxTrck00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrck00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00100101) MxReadImpl.parse(MxTrck00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrck00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrck00100101 .class);
    }
