    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:trck.005.001.02";
    ...
    public static MxTrck00500102 parse(String xml) {
        return ((MxTrck00500102) MxReadImpl.parse(MxTrck00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrck00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00500102) MxReadImpl.parse(MxTrck00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTrck00500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrck00500102 .class);
    }
