...
/**
 * Class for trck.004.001.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxTrck00400103(final String xml) {
        this();
        MxTrck00400103 tmp = parse(xml);
     ...
     * 
     */
    public MxTrck00400103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link PaymentStatusCustomerTrackerReportV03 }
     *     
     */
    public PaymentStatusCustomerTrackerReportV03 getPmtStsCstmrTrckrRpt() {
     ...
     *     
     */
    public MxTrck00400103 setPmtStsCstmrTrckrRpt(PaymentStatusCustomerTrackerReportV03 value) {
     ...
     * 
     */
    public static MxTrck00400103 parse(String xml) {
        return ((MxTrck00400103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTrck00400103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxTrck00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00400103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTrck00400103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxTrck00400103 parse(String xml, MxRead parserImpl) {
        return ((MxTrck00400103) parserImpl.read(MxTrck00400103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxTrck00400103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxTrck00400103 message
     * @return
     *     a new instance of MxTrck00400103
     */
    public static final MxTrck00400103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxTrck00400103 .class);
    }
