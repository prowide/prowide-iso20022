    ...
    extends AbstractMX
{
    ...
    public static MxTrck00400103 parse(String xml) {
        return ((MxTrck00400103) MxReadImpl.parse(MxTrck00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrck00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00400103) MxReadImpl.parse(MxTrck00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrck00400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrck00400103 .class);
    }
