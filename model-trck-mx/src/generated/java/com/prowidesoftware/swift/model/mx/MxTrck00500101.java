    ...
    extends AbstractMX
{
    ...
    public static MxTrck00500101 parse(String xml) {
        return ((MxTrck00500101) MxReadImpl.parse(MxTrck00500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrck00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00500101) MxReadImpl.parse(MxTrck00500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrck00500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrck00500101 .class);
    }
