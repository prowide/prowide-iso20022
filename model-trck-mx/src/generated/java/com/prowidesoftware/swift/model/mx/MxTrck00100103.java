    ...
    extends AbstractMX
{
    ...
    public static MxTrck00100103 parse(String xml) {
        return ((MxTrck00100103) MxReadImpl.parse(MxTrck00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrck00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00100103) MxReadImpl.parse(MxTrck00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrck00100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrck00100103 .class);
    }
