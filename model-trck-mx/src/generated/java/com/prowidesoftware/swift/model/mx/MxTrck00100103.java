...
/**
 * Class for trck.001.001.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxTrck00100103(final String xml) {
        this();
        MxTrck00100103 tmp = parse(xml);
     ...
     * 
     */
    public MxTrck00100103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link PaymentStatusTrackerUpdateV03 }
     *     
     */
    public PaymentStatusTrackerUpdateV03 getPmtStsTrckrUpd() {
     ...
     *     
     */
    public MxTrck00100103 setPmtStsTrckrUpd(PaymentStatusTrackerUpdateV03 value) {
     ...
     * 
     */
    public static MxTrck00100103 parse(String xml) {
        return ((MxTrck00100103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTrck00100103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxTrck00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00100103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTrck00100103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxTrck00100103 parse(String xml, MxRead parserImpl) {
        return ((MxTrck00100103) parserImpl.read(MxTrck00100103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxTrck00100103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxTrck00100103 message
     * @return
     *     a new instance of MxTrck00100103
     */
    public static final MxTrck00100103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxTrck00100103 .class);
    }
