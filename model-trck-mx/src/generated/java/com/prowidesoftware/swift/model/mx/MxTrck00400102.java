    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:trck.004.001.02";
    ...
    public static MxTrck00400102 parse(String xml) {
        return ((MxTrck00400102) MxReadImpl.parse(MxTrck00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrck00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00400102) MxReadImpl.parse(MxTrck00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTrck00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrck00400102 .class);
    }
