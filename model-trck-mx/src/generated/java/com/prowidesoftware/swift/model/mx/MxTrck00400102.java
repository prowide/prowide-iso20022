...
/**
 * Class for trck.004.001.02 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxTrck00400102(final String xml) {
        this();
        MxTrck00400102 tmp = parse(xml);
     ...
     * 
     */
    public MxTrck00400102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link PaymentStatusCustomerTrackerReportV02 }
     *     
     */
    public PaymentStatusCustomerTrackerReportV02 getPmtStsCstmrTrckrRpt() {
     ...
     *     
     */
    public MxTrck00400102 setPmtStsCstmrTrckrRpt(PaymentStatusCustomerTrackerReportV02 value) {
     ...
     * 
     */
    public static MxTrck00400102 parse(String xml) {
        return ((MxTrck00400102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTrck00400102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxTrck00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00400102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTrck00400102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxTrck00400102 parse(String xml, MxRead parserImpl) {
        return ((MxTrck00400102) parserImpl.read(MxTrck00400102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxTrck00400102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxTrck00400102 message
     * @return
     *     a new instance of MxTrck00400102
     */
    public final static MxTrck00400102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxTrck00400102 .class);
    }
