    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:trck.001.001.02";
    ...
    public static MxTrck00100102 parse(String xml) {
        return ((MxTrck00100102) MxReadImpl.parse(MxTrck00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrck00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00100102) MxReadImpl.parse(MxTrck00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTrck00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrck00100102 .class);
    }
