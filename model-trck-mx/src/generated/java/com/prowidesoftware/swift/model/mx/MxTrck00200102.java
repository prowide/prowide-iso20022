    ...
    extends AbstractMX
{
    ...
    public static MxTrck00200102 parse(String xml) {
        return ((MxTrck00200102) MxReadImpl.parse(MxTrck00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrck00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00200102) MxReadImpl.parse(MxTrck00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrck00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrck00200102 .class);
    }
