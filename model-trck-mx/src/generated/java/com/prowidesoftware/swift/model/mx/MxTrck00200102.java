...
/**
 * Class for trck.002.001.02 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:swift:xsd:trck.002.001.02")
public class MxTrck00200102
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "PmtStsTrckrRpt", required = true)
    protected PaymentStatusTrackerReportV02 pmtStsTrckrRpt;
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:trck.002.001.02";

    public MxTrck00200102() {
        super();
    }
     ...
     * 
     */
    public MxTrck00200102(final String xml) {
        this();
        MxTrck00200102 tmp = parse(xml);
     ...
     * 
     */
    public MxTrck00200102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link PaymentStatusTrackerReportV02 }
     *     
     */
    public PaymentStatusTrackerReportV02 getPmtStsTrckrRpt() {
     ...
     *     
     */
    public MxTrck00200102 setPmtStsTrckrRpt(PaymentStatusTrackerReportV02 value) {
     ...
     * 
     */
    public static MxTrck00200102 parse(String xml) {
        return ((MxTrck00200102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTrck00200102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxTrck00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00200102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTrck00200102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxTrck00200102 parse(String xml, MxRead parserImpl) {
        return ((MxTrck00200102) parserImpl.read(MxTrck00200102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxTrck00200102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxTrck00200102 message
     * @return
     *     a new instance of MxTrck00200102
     */
    public final static MxTrck00200102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxTrck00200102 .class);
    }
