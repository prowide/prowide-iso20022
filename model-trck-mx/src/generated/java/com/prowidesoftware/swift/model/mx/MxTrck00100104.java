...
/**
 * Class for trck.001.001.04 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxTrck00100104(final String xml) {
        this();
        MxTrck00100104 tmp = parse(xml);
     ...
     * 
     */
    public MxTrck00100104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link PaymentStatusTrackerUpdateV04 }
     *     
     */
    public PaymentStatusTrackerUpdateV04 getPmtStsTrckrUpd() {
     ...
     *     
     */
    public MxTrck00100104 setPmtStsTrckrUpd(PaymentStatusTrackerUpdateV04 value) {
     ...
     * 
     */
    public static MxTrck00100104 parse(String xml) {
        return ((MxTrck00100104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTrck00100104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxTrck00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00100104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxTrck00100104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxTrck00100104 parse(String xml, MxRead parserImpl) {
        return ((MxTrck00100104) parserImpl.read(MxTrck00100104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxTrck00100104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxTrck00100104 message
     * @return
     *     a new instance of MxTrck00100104
     */
    public static final MxTrck00100104 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxTrck00100104 .class);
    }
