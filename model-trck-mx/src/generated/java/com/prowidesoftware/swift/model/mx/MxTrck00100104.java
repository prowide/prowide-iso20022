    ...
    extends AbstractMX
{
    ...
    public static MxTrck00100104 parse(String xml) {
        return ((MxTrck00100104) MxReadImpl.parse(MxTrck00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrck00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrck00100104) MxReadImpl.parse(MxTrck00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrck00100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrck00100104 .class);
    }
