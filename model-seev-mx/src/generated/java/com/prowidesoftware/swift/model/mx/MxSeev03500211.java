    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500211 parse(String xml) {
        return ((MxSeev03500211) MxReadImpl.parse(MxSeev03500211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500211) MxReadImpl.parse(MxSeev03500211 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03500211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500211 .class);
    }
