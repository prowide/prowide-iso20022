    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:seev.031.002.04";
    ...
    public static MxSeev03100204 parse(String xml) {
        return ((MxSeev03100204) MxReadImpl.parse(MxSeev03100204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100204) MxReadImpl.parse(MxSeev03100204 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03100204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100204 .class);
    }
