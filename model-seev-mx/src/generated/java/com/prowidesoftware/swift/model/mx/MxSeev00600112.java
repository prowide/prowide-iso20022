    ...
    extends AbstractMX
{
    ...
    public static MxSeev00600112 parse(String xml) {
        return ((MxSeev00600112) MxReadImpl.parse(MxSeev00600112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00600112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00600112) MxReadImpl.parse(MxSeev00600112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00600112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00600112 .class);
    }
