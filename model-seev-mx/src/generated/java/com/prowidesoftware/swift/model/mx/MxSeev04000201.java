    ...
    extends AbstractMX
{
    ...
    public static MxSeev04000201 parse(String xml) {
        return ((MxSeev04000201) MxReadImpl.parse(MxSeev04000201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04000201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04000201) MxReadImpl.parse(MxSeev04000201 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04000201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04000201 .class);
    }
