    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600206 parse(String xml) {
        return ((MxSeev03600206) MxReadImpl.parse(MxSeev03600206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600206) MxReadImpl.parse(MxSeev03600206 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03600206 fromJson(String json) {
