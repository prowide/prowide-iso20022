    ...
    extends AbstractMX
{
    ...
    public static MxSeev04000108 parse(String xml) {
        return ((MxSeev04000108) MxReadImpl.parse(MxSeev04000108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04000108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04000108) MxReadImpl.parse(MxSeev04000108 .class, xml, _classes, new MxReadParams(conf)));
    }
