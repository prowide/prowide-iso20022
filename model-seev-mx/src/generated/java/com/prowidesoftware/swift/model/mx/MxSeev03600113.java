    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600113 parse(String xml) {
        return ((MxSeev03600113) MxReadImpl.parse(MxSeev03600113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600113 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600113) MxReadImpl.parse(MxSeev03600113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600113 .class);
    }
