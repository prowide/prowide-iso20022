...
/**
 * Class for seev.037.002.10 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev03700210(final String xml) {
        this();
        MxSeev03700210 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev03700210(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionMovementReversalAdvice002V10 }
     *     
     */
    public CorporateActionMovementReversalAdvice002V10 getCorpActnMvmntRvslAdvc() {
     ...
     *     
     */
    public MxSeev03700210 setCorpActnMvmntRvslAdvc(CorporateActionMovementReversalAdvice002V10 value) {
     ...
     * 
     */
    public static MxSeev03700210 parse(String xml) {
        return ((MxSeev03700210) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03700210 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev03700210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700210) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03700210 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev03700210 parse(String xml, MxRead parserImpl) {
        return ((MxSeev03700210) parserImpl.read(MxSeev03700210 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev03700210 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev03700210 message
     * @return
     *     a new instance of MxSeev03700210
     */
    public final static MxSeev03700210 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev03700210 .class);
    }
