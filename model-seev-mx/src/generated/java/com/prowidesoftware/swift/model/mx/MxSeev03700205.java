...
/**
 * Class for seev.037.002.05 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxSeev03700205(final String xml) {
        this();
        MxSeev03700205 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev03700205(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionMovementReversalAdvice002V05 }
     *     
     */
    public CorporateActionMovementReversalAdvice002V05 getCorpActnMvmntRvslAdvc() {
     ...
     *     
     */
    public MxSeev03700205 setCorpActnMvmntRvslAdvc(CorporateActionMovementReversalAdvice002V05 value) {
    ...
    public static MxSeev03700205 parse(String xml) {
        return ((MxSeev03700205) MxReadImpl.parse(MxSeev03700205 .class, xml, _classes));
    }
     ...
     */
    public static MxSeev03700205 parse(String xml, MxRead parserImpl) {
        return ((MxSeev03700205) parserImpl.read(MxSeev03700205 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev03700205 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev03700205 message
     * @return
