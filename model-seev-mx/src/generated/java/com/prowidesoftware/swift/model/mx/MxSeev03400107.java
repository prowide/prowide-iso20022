    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.034.001.07";
    ...
    public static MxSeev03400107 parse(String xml) {
        return ((MxSeev03400107) MxReadImpl.parse(MxSeev03400107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400107) MxReadImpl.parse(MxSeev03400107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03400107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400107 .class);
    }
