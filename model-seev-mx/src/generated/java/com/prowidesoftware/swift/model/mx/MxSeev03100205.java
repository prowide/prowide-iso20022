    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100205 parse(String xml) {
        return ((MxSeev03100205) MxReadImpl.parse(MxSeev03100205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100205) MxReadImpl.parse(MxSeev03100205 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03100205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100205 .class);
    }
