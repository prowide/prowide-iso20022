    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600108 parse(String xml) {
        return ((MxSeev03600108) MxReadImpl.parse(MxSeev03600108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600108) MxReadImpl.parse(MxSeev03600108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600108 .class);
    }
