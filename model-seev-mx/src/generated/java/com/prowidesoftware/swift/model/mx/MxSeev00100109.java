    ...
    extends AbstractMX
{
    ...
    public static MxSeev00100109 parse(String xml) {
        return ((MxSeev00100109) MxReadImpl.parse(MxSeev00100109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00100109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100109) MxReadImpl.parse(MxSeev00100109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00100109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00100109 .class);
    }
