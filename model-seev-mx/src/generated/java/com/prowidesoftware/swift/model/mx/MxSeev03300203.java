    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:seev.033.002.03";
    ...
    public static MxSeev03300203 parse(String xml) {
        return ((MxSeev03300203) MxReadImpl.parse(MxSeev03300203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300203) MxReadImpl.parse(MxSeev03300203 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03300203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300203 .class);
    }
