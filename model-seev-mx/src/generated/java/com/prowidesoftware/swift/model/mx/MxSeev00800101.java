    ...
    extends AbstractMX
{
    ...
    public static MxSeev00800101 parse(String xml) {
        return ((MxSeev00800101) MxReadImpl.parse(MxSeev00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00800101) MxReadImpl.parse(MxSeev00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
