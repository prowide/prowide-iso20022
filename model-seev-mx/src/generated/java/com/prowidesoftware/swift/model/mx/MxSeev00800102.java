    ...
    extends AbstractMX
{
    ...
    public static MxSeev00800102 parse(String xml) {
        return ((MxSeev00800102) MxReadImpl.parse(MxSeev00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00800102) MxReadImpl.parse(MxSeev00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
