    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.039.001.11";
    ...
    public static MxSeev03900111 parse(String xml) {
        return ((MxSeev03900111) MxReadImpl.parse(MxSeev03900111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900111) MxReadImpl.parse(MxSeev03900111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03900111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900111 .class);
    }
