    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100209 parse(String xml) {
        return ((MxSeev03100209) MxReadImpl.parse(MxSeev03100209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100209) MxReadImpl.parse(MxSeev03100209 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03100209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100209 .class);
    }
