    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200210 parse(String xml) {
        return ((MxSeev04200210) MxReadImpl.parse(MxSeev04200210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200210) MxReadImpl.parse(MxSeev04200210 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04200210 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04200210 .class);
    }
