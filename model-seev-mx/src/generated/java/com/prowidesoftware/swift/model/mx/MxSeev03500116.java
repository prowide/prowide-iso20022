    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.035.001.16";
    ...
    public static MxSeev03500116 parse(String xml) {
        return ((MxSeev03500116) MxReadImpl.parse(MxSeev03500116 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500116 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500116) MxReadImpl.parse(MxSeev03500116 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03500116 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500116 .class);
    }
