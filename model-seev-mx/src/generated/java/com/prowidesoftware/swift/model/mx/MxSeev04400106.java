    ...
    extends AbstractMX
{
    ...
    public static MxSeev04400106 parse(String xml) {
        return ((MxSeev04400106) MxReadImpl.parse(MxSeev04400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400106) MxReadImpl.parse(MxSeev04400106 .class, xml, _classes, new MxReadParams(conf)));
    }
