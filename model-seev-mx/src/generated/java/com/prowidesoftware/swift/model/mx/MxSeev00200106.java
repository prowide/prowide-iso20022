    ...
    extends AbstractMX
{
    ...
    public static MxSeev00200106 parse(String xml) {
        return ((MxSeev00200106) MxReadImpl.parse(MxSeev00200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00200106) MxReadImpl.parse(MxSeev00200106 .class, xml, _classes, new MxReadParams(conf)));
    }
