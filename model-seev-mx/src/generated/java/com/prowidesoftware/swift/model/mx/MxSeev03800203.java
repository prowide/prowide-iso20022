    ...
    extends AbstractMX
{
    ...
    public static MxSeev03800203 parse(String xml) {
        return ((MxSeev03800203) MxReadImpl.parse(MxSeev03800203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03800203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03800203) MxReadImpl.parse(MxSeev03800203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03800203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03800203 .class);
    }
