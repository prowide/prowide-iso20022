    ...
    extends AbstractMX
{
    ...
    public static MxSeev03800204 parse(String xml) {
        return ((MxSeev03800204) MxReadImpl.parse(MxSeev03800204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03800204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03800204) MxReadImpl.parse(MxSeev03800204 .class, xml, _classes, new MxReadParams(conf)));
    }
