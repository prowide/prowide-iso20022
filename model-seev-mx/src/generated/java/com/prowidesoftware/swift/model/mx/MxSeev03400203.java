    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400203 parse(String xml) {
        return ((MxSeev03400203) MxReadImpl.parse(MxSeev03400203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400203) MxReadImpl.parse(MxSeev03400203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03400203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400203 .class);
    }
