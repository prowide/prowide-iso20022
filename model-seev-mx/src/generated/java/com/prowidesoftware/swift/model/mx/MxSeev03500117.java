    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500117 parse(String xml) {
        return ((MxSeev03500117) MxReadImpl.parse(MxSeev03500117 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500117 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500117) MxReadImpl.parse(MxSeev03500117 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03500117 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500117 .class);
    }
