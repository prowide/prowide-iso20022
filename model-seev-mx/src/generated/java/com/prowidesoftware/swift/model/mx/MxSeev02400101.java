    ...
    extends AbstractMX
{
    ...
    public static MxSeev02400101 parse(String xml) {
        return ((MxSeev02400101) MxReadImpl.parse(MxSeev02400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev02400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev02400101) MxReadImpl.parse(MxSeev02400101 .class, xml, _classes, new MxReadParams(conf)));
    }
