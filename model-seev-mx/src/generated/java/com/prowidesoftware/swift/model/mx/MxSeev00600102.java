    ...
    extends AbstractMX
{
    ...
    public static MxSeev00600102 parse(String xml) {
        return ((MxSeev00600102) MxReadImpl.parse(MxSeev00600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00600102) MxReadImpl.parse(MxSeev00600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00600102 .class);
    }
