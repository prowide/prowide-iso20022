    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400213 parse(String xml) {
        return ((MxSeev03400213) MxReadImpl.parse(MxSeev03400213 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400213 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400213) MxReadImpl.parse(MxSeev03400213 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03400213 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400213 .class);
    }
