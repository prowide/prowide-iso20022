    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600110 parse(String xml) {
        return ((MxSeev03600110) MxReadImpl.parse(MxSeev03600110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600110) MxReadImpl.parse(MxSeev03600110 .class, xml, _classes, new MxReadParams(conf)));
    }
