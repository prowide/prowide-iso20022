    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.038.001.06";
    ...
    public static MxSeev03800106 parse(String xml) {
        return ((MxSeev03800106) MxReadImpl.parse(MxSeev03800106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03800106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03800106) MxReadImpl.parse(MxSeev03800106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03800106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03800106 .class);
    }
