    ...
    extends AbstractMX
{
    ...
    public static MxSeev05100102 parse(String xml) {
        return ((MxSeev05100102) MxReadImpl.parse(MxSeev05100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev05100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev05100102) MxReadImpl.parse(MxSeev05100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev05100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev05100102 .class);
    }
