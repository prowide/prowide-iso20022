    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300212 parse(String xml) {
        return ((MxSeev03300212) MxReadImpl.parse(MxSeev03300212 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300212 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300212) MxReadImpl.parse(MxSeev03300212 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03300212 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300212 .class);
    }
