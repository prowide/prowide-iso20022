    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300112 parse(String xml) {
        return ((MxSeev03300112) MxReadImpl.parse(MxSeev03300112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300112) MxReadImpl.parse(MxSeev03300112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03300112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300112 .class);
    }
