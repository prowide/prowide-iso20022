    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:seev.033.002.04";
    ...
    public static MxSeev03300204 parse(String xml) {
        return ((MxSeev03300204) MxReadImpl.parse(MxSeev03300204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300204) MxReadImpl.parse(MxSeev03300204 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03300204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300204 .class);
    }
