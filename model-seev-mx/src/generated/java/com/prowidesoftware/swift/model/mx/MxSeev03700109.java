    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700109 parse(String xml) {
        return ((MxSeev03700109) MxReadImpl.parse(MxSeev03700109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700109) MxReadImpl.parse(MxSeev03700109 .class, xml, _classes, new MxReadParams(conf)));
    }
