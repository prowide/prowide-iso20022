    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200103 parse(String xml) {
        return ((MxSeev04200103) MxReadImpl.parse(MxSeev04200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200103) MxReadImpl.parse(MxSeev04200103 .class, xml, _classes, new MxReadParams(conf)));
    }
