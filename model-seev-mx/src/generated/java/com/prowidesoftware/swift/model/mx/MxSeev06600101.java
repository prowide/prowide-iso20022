    ...
    extends AbstractMX
{
    ...
    public static MxSeev06600101 parse(String xml) {
        return ((MxSeev06600101) MxReadImpl.parse(MxSeev06600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev06600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev06600101) MxReadImpl.parse(MxSeev06600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev06600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev06600101 .class);
    }
