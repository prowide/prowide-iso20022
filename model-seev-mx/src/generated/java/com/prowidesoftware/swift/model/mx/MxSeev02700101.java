    ...
    extends AbstractMX
{
    ...
    public static MxSeev02700101 parse(String xml) {
        return ((MxSeev02700101) MxReadImpl.parse(MxSeev02700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev02700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev02700101) MxReadImpl.parse(MxSeev02700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev02700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev02700101 .class);
    }
