    ...
    extends AbstractMX
{
    ...
    public static MxSeev04400109 parse(String xml) {
        return ((MxSeev04400109) MxReadImpl.parse(MxSeev04400109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400109) MxReadImpl.parse(MxSeev04400109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04400109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04400109 .class);
    }
