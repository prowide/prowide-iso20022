    ...
    extends AbstractMX
{
    ...
    public static MxSeev00400102 parse(String xml) {
        return ((MxSeev00400102) MxReadImpl.parse(MxSeev00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00400102) MxReadImpl.parse(MxSeev00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00400102 .class);
    }
