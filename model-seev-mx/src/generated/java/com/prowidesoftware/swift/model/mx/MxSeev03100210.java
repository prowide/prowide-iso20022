    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.031.002.10";
    ...
    public static MxSeev03100210 parse(String xml) {
        return ((MxSeev03100210) MxReadImpl.parse(MxSeev03100210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100210) MxReadImpl.parse(MxSeev03100210 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03100210 fromJson(String json) {
