    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.036.002.11";
    ...
    public static MxSeev03600211 parse(String xml) {
        return ((MxSeev03600211) MxReadImpl.parse(MxSeev03600211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600211) MxReadImpl.parse(MxSeev03600211 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03600211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600211 .class);
    }
