    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500208 parse(String xml) {
        return ((MxSeev03500208) MxReadImpl.parse(MxSeev03500208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500208) MxReadImpl.parse(MxSeev03500208 .class, xml, _classes, new MxReadParams(conf)));
    }
