    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.041.001.06";
    ...
    public static MxSeev04100106 parse(String xml) {
        return ((MxSeev04100106) MxReadImpl.parse(MxSeev04100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100106) MxReadImpl.parse(MxSeev04100106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04100106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04100106 .class);
    }
