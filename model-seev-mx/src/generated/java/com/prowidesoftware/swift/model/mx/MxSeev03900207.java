    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900207 parse(String xml) {
        return ((MxSeev03900207) MxReadImpl.parse(MxSeev03900207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900207) MxReadImpl.parse(MxSeev03900207 .class, xml, _classes, new MxReadParams(conf)));
    }
