    ...
    extends AbstractMX
{
    ...
    public static MxSeev03200106 parse(String xml) {
        return ((MxSeev03200106) MxReadImpl.parse(MxSeev03200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03200106) MxReadImpl.parse(MxSeev03200106 .class, xml, _classes, new MxReadParams(conf)));
    }
