    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.044.001.07";
    ...
    public static MxSeev04400107 parse(String xml) {
        return ((MxSeev04400107) MxReadImpl.parse(MxSeev04400107 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev04400107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04400107 .class);
    }
