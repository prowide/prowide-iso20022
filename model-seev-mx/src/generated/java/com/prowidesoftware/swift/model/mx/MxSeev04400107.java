    ...
    extends AbstractMX
{
    ...
    public static MxSeev04400107 parse(String xml) {
        return ((MxSeev04400107) MxReadImpl.parse(MxSeev04400107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400107) MxReadImpl.parse(MxSeev04400107 .class, xml, _classes, new MxReadParams(conf)));
    }
