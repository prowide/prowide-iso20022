    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.047.001.01";
    ...
    public static MxSeev04700101 parse(String xml) {
        return ((MxSeev04700101) MxReadImpl.parse(MxSeev04700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04700101) MxReadImpl.parse(MxSeev04700101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04700101 fromJson(String json) {
