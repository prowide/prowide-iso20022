    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400205 parse(String xml) {
        return ((MxSeev03400205) MxReadImpl.parse(MxSeev03400205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400205) MxReadImpl.parse(MxSeev03400205 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03400205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400205 .class);
    }
