    ...
    extends AbstractMX
{
    ...
    public static MxSeev00300103 parse(String xml) {
        return ((MxSeev00300103) MxReadImpl.parse(MxSeev00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00300103) MxReadImpl.parse(MxSeev00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev00300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00300103 .class);
    }
