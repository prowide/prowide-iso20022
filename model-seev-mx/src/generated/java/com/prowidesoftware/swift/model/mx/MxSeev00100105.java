    ...
    extends AbstractMX
{
    ...
    public static MxSeev00100105 parse(String xml) {
        return ((MxSeev00100105) MxReadImpl.parse(MxSeev00100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100105) MxReadImpl.parse(MxSeev00100105 .class, xml, _classes, new MxReadParams(conf)));
    }
