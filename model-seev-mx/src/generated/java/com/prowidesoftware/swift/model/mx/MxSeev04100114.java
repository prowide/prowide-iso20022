    ...
    extends AbstractMX
{
    ...
    public static MxSeev04100114 parse(String xml) {
        return ((MxSeev04100114) MxReadImpl.parse(MxSeev04100114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100114 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100114) MxReadImpl.parse(MxSeev04100114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04100114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04100114 .class);
    }
