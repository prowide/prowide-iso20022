    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900204 parse(String xml) {
        return ((MxSeev03900204) MxReadImpl.parse(MxSeev03900204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900204) MxReadImpl.parse(MxSeev03900204 .class, xml, _classes, new MxReadParams(conf)));
    }
