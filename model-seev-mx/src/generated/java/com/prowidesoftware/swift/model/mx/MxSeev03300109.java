    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300109 parse(String xml) {
        return ((MxSeev03300109) MxReadImpl.parse(MxSeev03300109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300109) MxReadImpl.parse(MxSeev03300109 .class, xml, _classes, new MxReadParams(conf)));
    }
