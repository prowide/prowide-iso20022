    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.036.001.03";
    ...
    public static MxSeev03600103 parse(String xml) {
        return ((MxSeev03600103) MxReadImpl.parse(MxSeev03600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600103) MxReadImpl.parse(MxSeev03600103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600103 .class);
    }
