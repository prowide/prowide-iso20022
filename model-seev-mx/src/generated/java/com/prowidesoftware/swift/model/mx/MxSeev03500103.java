    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500103 parse(String xml) {
        return ((MxSeev03500103) MxReadImpl.parse(MxSeev03500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500103) MxReadImpl.parse(MxSeev03500103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500103 .class);
    }
