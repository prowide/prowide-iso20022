    ...
    extends AbstractMX
{
    ...
    public static MxSeev04100110 parse(String xml) {
        return ((MxSeev04100110) MxReadImpl.parse(MxSeev04100110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100110) MxReadImpl.parse(MxSeev04100110 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04100110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04100110 .class);
    }
