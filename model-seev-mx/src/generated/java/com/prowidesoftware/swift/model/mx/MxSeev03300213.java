    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.033.002.13";
    ...
    public static MxSeev03300213 parse(String xml) {
        return ((MxSeev03300213) MxReadImpl.parse(MxSeev03300213 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300213 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300213) MxReadImpl.parse(MxSeev03300213 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03300213 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300213 .class);
    }
