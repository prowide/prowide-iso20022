    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.016.001.01";
    ...
    public static MxSeev01600101 parse(String xml) {
        return ((MxSeev01600101) MxReadImpl.parse(MxSeev01600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev01600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev01600101) MxReadImpl.parse(MxSeev01600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev01600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev01600101 .class);
    }
