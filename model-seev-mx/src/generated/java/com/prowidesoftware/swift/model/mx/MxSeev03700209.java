    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700209 parse(String xml) {
        return ((MxSeev03700209) MxReadImpl.parse(MxSeev03700209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700209) MxReadImpl.parse(MxSeev03700209 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03700209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03700209 .class);
    }
