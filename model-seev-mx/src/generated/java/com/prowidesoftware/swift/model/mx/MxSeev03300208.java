    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300208 parse(String xml) {
        return ((MxSeev03300208) MxReadImpl.parse(MxSeev03300208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300208) MxReadImpl.parse(MxSeev03300208 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03300208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300208 .class);
    }
