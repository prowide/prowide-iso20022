    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700101 parse(String xml) {
        return ((MxSeev03700101) MxReadImpl.parse(MxSeev03700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700101) MxReadImpl.parse(MxSeev03700101 .class, xml, _classes, new MxReadParams(conf)));
    }
