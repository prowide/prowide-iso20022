    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600111 parse(String xml) {
        return ((MxSeev03600111) MxReadImpl.parse(MxSeev03600111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600111) MxReadImpl.parse(MxSeev03600111 .class, xml, _classes, new MxReadParams(conf)));
    }
