    ...
    extends AbstractMX
{
    ...
    public static MxSeev04100211 parse(String xml) {
        return ((MxSeev04100211) MxReadImpl.parse(MxSeev04100211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100211) MxReadImpl.parse(MxSeev04100211 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04100211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04100211 .class);
    }
