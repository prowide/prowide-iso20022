    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600216 parse(String xml) {
        return ((MxSeev03600216) MxReadImpl.parse(MxSeev03600216 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600216 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600216) MxReadImpl.parse(MxSeev03600216 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600216 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600216 .class);
    }
