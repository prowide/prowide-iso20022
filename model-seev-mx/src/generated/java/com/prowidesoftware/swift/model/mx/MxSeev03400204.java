    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400204 parse(String xml) {
        return ((MxSeev03400204) MxReadImpl.parse(MxSeev03400204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400204) MxReadImpl.parse(MxSeev03400204 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03400204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400204 .class);
    }
