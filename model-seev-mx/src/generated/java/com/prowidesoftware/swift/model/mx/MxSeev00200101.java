    ...
    extends AbstractMX
{
    ...
    public static MxSeev00200101 parse(String xml) {
        return ((MxSeev00200101) MxReadImpl.parse(MxSeev00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00200101) MxReadImpl.parse(MxSeev00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
