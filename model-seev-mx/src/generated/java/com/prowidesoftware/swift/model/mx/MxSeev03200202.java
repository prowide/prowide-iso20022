    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:seev.032.002.02";
    ...
    public static MxSeev03200202 parse(String xml) {
        return ((MxSeev03200202) MxReadImpl.parse(MxSeev03200202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03200202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03200202) MxReadImpl.parse(MxSeev03200202 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03200202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03200202 .class);
    }
