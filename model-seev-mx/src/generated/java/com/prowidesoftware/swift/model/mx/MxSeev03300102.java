    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300102 parse(String xml) {
        return ((MxSeev03300102) MxReadImpl.parse(MxSeev03300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300102) MxReadImpl.parse(MxSeev03300102 .class, xml, _classes, new MxReadParams(conf)));
    }
