    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.032.001.05";
    ...
    public static MxSeev03200105 parse(String xml) {
        return ((MxSeev03200105) MxReadImpl.parse(MxSeev03200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03200105) MxReadImpl.parse(MxSeev03200105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03200105 .class);
    }
