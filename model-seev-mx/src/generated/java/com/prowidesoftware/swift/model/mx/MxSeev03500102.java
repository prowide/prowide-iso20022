    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500102 parse(String xml) {
        return ((MxSeev03500102) MxReadImpl.parse(MxSeev03500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500102) MxReadImpl.parse(MxSeev03500102 .class, xml, _classes, new MxReadParams(conf)));
    }
