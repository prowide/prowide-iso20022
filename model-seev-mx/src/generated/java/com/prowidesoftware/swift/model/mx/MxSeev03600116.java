    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600116 parse(String xml) {
        return ((MxSeev03600116) MxReadImpl.parse(MxSeev03600116 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600116 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600116) MxReadImpl.parse(MxSeev03600116 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600116 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600116 .class);
    }
