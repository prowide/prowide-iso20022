    ...
    extends AbstractMX
{
    ...
    public static MxSeev03800108 parse(String xml) {
        return ((MxSeev03800108) MxReadImpl.parse(MxSeev03800108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03800108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03800108) MxReadImpl.parse(MxSeev03800108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03800108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03800108 .class);
    }
