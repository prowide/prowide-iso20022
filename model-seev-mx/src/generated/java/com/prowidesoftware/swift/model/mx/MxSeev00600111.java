...
/**
 * Class for seev.006.001.11 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev00600111(final String xml) {
        this();
        MxSeev00600111 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev00600111(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link MeetingInstructionStatusV11 }
     *     
     */
    public MeetingInstructionStatusV11 getMtgInstrSts() {
        return mtgInstrSts;
    }
     ...
     */
    public static MxSeev00600111 parse(String xml, MxRead parserImpl) {
        return ((MxSeev00600111) parserImpl.read(MxSeev00600111 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev00600111 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev00600111 message
     * @return
