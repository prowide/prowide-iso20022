    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900110 parse(String xml) {
        return ((MxSeev03900110) MxReadImpl.parse(MxSeev03900110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900110) MxReadImpl.parse(MxSeev03900110 .class, xml, _classes, new MxReadParams(conf)));
    }
