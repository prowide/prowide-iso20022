    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.039.001.10";
    ...
    public static MxSeev03900110 parse(String xml) {
        return ((MxSeev03900110) MxReadImpl.parse(MxSeev03900110 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03900110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900110 .class);
    }
