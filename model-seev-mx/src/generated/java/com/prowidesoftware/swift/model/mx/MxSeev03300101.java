    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300101 parse(String xml) {
        return ((MxSeev03300101) MxReadImpl.parse(MxSeev03300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300101) MxReadImpl.parse(MxSeev03300101 .class, xml, _classes, new MxReadParams(conf)));
    }
