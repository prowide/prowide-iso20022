    ...
    extends AbstractMX
{
    ...
    public static MxSeev05300101 parse(String xml) {
        return ((MxSeev05300101) MxReadImpl.parse(MxSeev05300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev05300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev05300101) MxReadImpl.parse(MxSeev05300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev05300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev05300101 .class);
    }
