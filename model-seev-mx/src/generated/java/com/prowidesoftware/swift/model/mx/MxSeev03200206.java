    ...
    extends AbstractMX
{
    ...
    public static MxSeev03200206 parse(String xml) {
        return ((MxSeev03200206) MxReadImpl.parse(MxSeev03200206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03200206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03200206) MxReadImpl.parse(MxSeev03200206 .class, xml, _classes, new MxReadParams(conf)));
    }
