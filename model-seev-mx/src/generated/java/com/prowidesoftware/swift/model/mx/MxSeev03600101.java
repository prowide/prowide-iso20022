    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600101 parse(String xml) {
        return ((MxSeev03600101) MxReadImpl.parse(MxSeev03600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600101) MxReadImpl.parse(MxSeev03600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600101 .class);
    }
