    ...
    extends AbstractMX
{
    ...
    public static MxSeev00900102 parse(String xml) {
        return ((MxSeev00900102) MxReadImpl.parse(MxSeev00900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00900102) MxReadImpl.parse(MxSeev00900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00900102 .class);
    }
