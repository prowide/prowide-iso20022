    ...
    extends AbstractMX
{
    ...
    public static MxSeev00400103 parse(String xml) {
        return ((MxSeev00400103) MxReadImpl.parse(MxSeev00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00400103) MxReadImpl.parse(MxSeev00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
