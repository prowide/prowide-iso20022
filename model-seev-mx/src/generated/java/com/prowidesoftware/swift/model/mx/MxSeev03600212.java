    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600212 parse(String xml) {
        return ((MxSeev03600212) MxReadImpl.parse(MxSeev03600212 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600212 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600212) MxReadImpl.parse(MxSeev03600212 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600212 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600212 .class);
    }
