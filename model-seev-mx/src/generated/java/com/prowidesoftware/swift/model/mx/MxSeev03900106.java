    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900106 parse(String xml) {
        return ((MxSeev03900106) MxReadImpl.parse(MxSeev03900106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900106) MxReadImpl.parse(MxSeev03900106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03900106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900106 .class);
    }
