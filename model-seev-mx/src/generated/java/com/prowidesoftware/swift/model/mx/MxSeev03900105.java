    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.039.001.05";
    ...
    public static MxSeev03900105 parse(String xml) {
        return ((MxSeev03900105) MxReadImpl.parse(MxSeev03900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900105) MxReadImpl.parse(MxSeev03900105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900105 .class);
    }
