    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400215 parse(String xml) {
        return ((MxSeev03400215) MxReadImpl.parse(MxSeev03400215 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400215 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400215) MxReadImpl.parse(MxSeev03400215 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03400215 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400215 .class);
    }
