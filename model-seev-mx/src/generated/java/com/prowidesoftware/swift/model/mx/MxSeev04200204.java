    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200204 parse(String xml) {
        return ((MxSeev04200204) MxReadImpl.parse(MxSeev04200204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200204) MxReadImpl.parse(MxSeev04200204 .class, xml, _classes, new MxReadParams(conf)));
    }
