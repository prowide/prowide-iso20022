    ...
    extends AbstractMX
{
    ...
    public static MxSeev00400108 parse(String xml) {
        return ((MxSeev00400108) MxReadImpl.parse(MxSeev00400108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00400108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00400108) MxReadImpl.parse(MxSeev00400108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00400108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00400108 .class);
    }
