    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100105 parse(String xml) {
        return ((MxSeev03100105) MxReadImpl.parse(MxSeev03100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100105) MxReadImpl.parse(MxSeev03100105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100105 .class);
    }
