    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.004.001.04";
    ...
    public static MxSeev00400104 parse(String xml) {
        return ((MxSeev00400104) MxReadImpl.parse(MxSeev00400104 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev00400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00400104 .class);
    }
