    ...
    extends AbstractMX
{
    ...
    public static MxSeev00400104 parse(String xml) {
        return ((MxSeev00400104) MxReadImpl.parse(MxSeev00400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00400104) MxReadImpl.parse(MxSeev00400104 .class, xml, _classes, new MxReadParams(conf)));
    }
