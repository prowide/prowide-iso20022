    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:seev.003.001.01";
    ...
    public static MxSeev00300101 parse(String xml) {
        return ((MxSeev00300101) MxReadImpl.parse(MxSeev00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00300101) MxReadImpl.parse(MxSeev00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00300101 .class);
    }
