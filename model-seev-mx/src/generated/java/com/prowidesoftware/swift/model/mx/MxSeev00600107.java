    ...
    extends AbstractMX
{
    ...
    public static MxSeev00600107 parse(String xml) {
        return ((MxSeev00600107) MxReadImpl.parse(MxSeev00600107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00600107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00600107) MxReadImpl.parse(MxSeev00600107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00600107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00600107 .class);
    }
