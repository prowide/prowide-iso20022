    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.008.001.09";
    ...
    public static MxSeev00800109 parse(String xml) {
        return ((MxSeev00800109) MxReadImpl.parse(MxSeev00800109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00800109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00800109) MxReadImpl.parse(MxSeev00800109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev00800109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00800109 .class);
    }
