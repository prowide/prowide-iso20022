    ...
    extends AbstractMX
{
    ...
    public static MxSeev03200101 parse(String xml) {
        return ((MxSeev03200101) MxReadImpl.parse(MxSeev03200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03200101) MxReadImpl.parse(MxSeev03200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03200101 .class);
    }
