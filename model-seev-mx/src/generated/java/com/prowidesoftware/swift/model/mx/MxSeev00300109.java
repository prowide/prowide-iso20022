    ...
    extends AbstractMX
{
    ...
    public static MxSeev00300109 parse(String xml) {
        return ((MxSeev00300109) MxReadImpl.parse(MxSeev00300109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00300109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00300109) MxReadImpl.parse(MxSeev00300109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00300109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00300109 .class);
    }
