    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900209 parse(String xml) {
        return ((MxSeev03900209) MxReadImpl.parse(MxSeev03900209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900209) MxReadImpl.parse(MxSeev03900209 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03900209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900209 .class);
    }
