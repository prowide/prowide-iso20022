...
/**
 * Class for seev.039.002.09 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:seev.039.002.09")
public class MxSeev03900209
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.039.002.09";
     ...
     * 
     */
    public MxSeev03900209(final String xml) {
        this();
        MxSeev03900209 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev03900209(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionCancellationAdvice002V09 }
     *     
     */
     ...
     *     
     */
    public MxSeev03900209 setCorpActnCxlAdvc(CorporateActionCancellationAdvice002V09 value) {
     ...
     * 
     */
    public static MxSeev03900209 parse(String xml) {
        return ((MxSeev03900209) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03900209 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev03900209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900209) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03900209 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev03900209 parse(String xml, MxRead parserImpl) {
        return ((MxSeev03900209) parserImpl.read(MxSeev03900209 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev03900209 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev03900209 message
     * @return
     *     a new instance of MxSeev03900209
     */
    public final static MxSeev03900209 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev03900209 .class);
    }
