    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:seev.036.002.04";
    ...
    public static MxSeev03600204 parse(String xml) {
        return ((MxSeev03600204) MxReadImpl.parse(MxSeev03600204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600204) MxReadImpl.parse(MxSeev03600204 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03600204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600204 .class);
    }
