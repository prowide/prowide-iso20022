    ...
    extends AbstractMX
{
    ...
    public static MxSeev00100103 parse(String xml) {
        return ((MxSeev00100103) MxReadImpl.parse(MxSeev00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100103) MxReadImpl.parse(MxSeev00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
