    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100213 parse(String xml) {
        return ((MxSeev03100213) MxReadImpl.parse(MxSeev03100213 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100213 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100213) MxReadImpl.parse(MxSeev03100213 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03100213 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100213 .class);
    }
