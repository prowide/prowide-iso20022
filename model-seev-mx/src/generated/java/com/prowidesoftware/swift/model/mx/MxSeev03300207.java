    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.033.002.07";
    ...
    public static MxSeev03300207 parse(String xml) {
        return ((MxSeev03300207) MxReadImpl.parse(MxSeev03300207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300207) MxReadImpl.parse(MxSeev03300207 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03300207 fromJson(String json) {
