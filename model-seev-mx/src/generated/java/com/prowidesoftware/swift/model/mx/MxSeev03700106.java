    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.037.001.06";
    ...
    public static MxSeev03700106 parse(String xml) {
        return ((MxSeev03700106) MxReadImpl.parse(MxSeev03700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700106) MxReadImpl.parse(MxSeev03700106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03700106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03700106 .class);
    }
