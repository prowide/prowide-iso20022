    ...
    extends AbstractMX
{
    ...
    public static MxSeev01400101 parse(String xml) {
        return ((MxSeev01400101) MxReadImpl.parse(MxSeev01400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev01400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev01400101) MxReadImpl.parse(MxSeev01400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev01400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev01400101 .class);
    }
