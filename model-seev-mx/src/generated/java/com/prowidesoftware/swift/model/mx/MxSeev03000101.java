    ...
    extends AbstractMX
{
    ...
    public static MxSeev03000101 parse(String xml) {
        return ((MxSeev03000101) MxReadImpl.parse(MxSeev03000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03000101) MxReadImpl.parse(MxSeev03000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03000101 .class);
    }
