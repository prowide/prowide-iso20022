    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200105 parse(String xml) {
        return ((MxSeev04200105) MxReadImpl.parse(MxSeev04200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200105) MxReadImpl.parse(MxSeev04200105 .class, xml, _classes, new MxReadParams(conf)));
    }
