    ...
    extends AbstractMX
{
    ...
    public static MxSeev04100115 parse(String xml) {
        return ((MxSeev04100115) MxReadImpl.parse(MxSeev04100115 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100115 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100115) MxReadImpl.parse(MxSeev04100115 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04100115 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04100115 .class);
    }
