    ...
    extends AbstractMX
{
    ...
    public static MxSeev04000206 parse(String xml) {
        return ((MxSeev04000206) MxReadImpl.parse(MxSeev04000206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04000206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04000206) MxReadImpl.parse(MxSeev04000206 .class, xml, _classes, new MxReadParams(conf)));
    }
