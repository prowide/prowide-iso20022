    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.039.002.08";
    ...
    public static MxSeev03900208 parse(String xml) {
        return ((MxSeev03900208) MxReadImpl.parse(MxSeev03900208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900208) MxReadImpl.parse(MxSeev03900208 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03900208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900208 .class);
    }
