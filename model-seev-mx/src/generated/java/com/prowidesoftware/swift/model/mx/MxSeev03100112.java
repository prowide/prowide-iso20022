    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100112 parse(String xml) {
        return ((MxSeev03100112) MxReadImpl.parse(MxSeev03100112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100112) MxReadImpl.parse(MxSeev03100112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03100112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100112 .class);
    }
