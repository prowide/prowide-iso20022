    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:seev.035.002.02";
    ...
    public static MxSeev03500202 parse(String xml) {
        return ((MxSeev03500202) MxReadImpl.parse(MxSeev03500202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500202) MxReadImpl.parse(MxSeev03500202 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03500202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500202 .class);
    }
