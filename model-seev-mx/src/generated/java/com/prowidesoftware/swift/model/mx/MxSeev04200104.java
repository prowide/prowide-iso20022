    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.042.001.04";
    ...
    public static MxSeev04200104 parse(String xml) {
        return ((MxSeev04200104) MxReadImpl.parse(MxSeev04200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200104) MxReadImpl.parse(MxSeev04200104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04200104 .class);
    }
