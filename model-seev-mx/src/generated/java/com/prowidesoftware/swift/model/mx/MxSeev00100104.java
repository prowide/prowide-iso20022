    ...
    extends AbstractMX
{
    ...
    public static MxSeev00100104 parse(String xml) {
        return ((MxSeev00100104) MxReadImpl.parse(MxSeev00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100104) MxReadImpl.parse(MxSeev00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
