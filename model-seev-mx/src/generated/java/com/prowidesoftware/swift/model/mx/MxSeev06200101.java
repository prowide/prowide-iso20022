    ...
    extends AbstractMX
{
    ...
    public static MxSeev06200101 parse(String xml) {
        return ((MxSeev06200101) MxReadImpl.parse(MxSeev06200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev06200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev06200101) MxReadImpl.parse(MxSeev06200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev06200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev06200101 .class);
    }
