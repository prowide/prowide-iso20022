    ...
    extends AbstractMX
{
    ...
    public static MxSeev04400204 parse(String xml) {
        return ((MxSeev04400204) MxReadImpl.parse(MxSeev04400204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400204) MxReadImpl.parse(MxSeev04400204 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04400204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04400204 .class);
    }
