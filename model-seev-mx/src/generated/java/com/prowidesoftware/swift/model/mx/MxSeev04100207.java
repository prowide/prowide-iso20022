    ...
    extends AbstractMX
{
    ...
    public static MxSeev04100207 parse(String xml) {
        return ((MxSeev04100207) MxReadImpl.parse(MxSeev04100207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100207) MxReadImpl.parse(MxSeev04100207 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04100207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04100207 .class);
    }
