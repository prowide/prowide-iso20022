    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.001.001.08";
    ...
    public static MxSeev00100108 parse(String xml) {
        return ((MxSeev00100108) MxReadImpl.parse(MxSeev00100108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00100108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100108) MxReadImpl.parse(MxSeev00100108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev00100108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00100108 .class);
    }
