    ...
    extends AbstractMX
{
    ...
    public static MxSeev04100205 parse(String xml) {
        return ((MxSeev04100205) MxReadImpl.parse(MxSeev04100205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100205) MxReadImpl.parse(MxSeev04100205 .class, xml, _classes, new MxReadParams(conf)));
    }
