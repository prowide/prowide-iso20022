    ...
    extends AbstractMX
{
    ...
    public static MxSeev06500101 parse(String xml) {
        return ((MxSeev06500101) MxReadImpl.parse(MxSeev06500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev06500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev06500101) MxReadImpl.parse(MxSeev06500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev06500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev06500101 .class);
    }
