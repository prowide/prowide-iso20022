    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:seev.044.002.02";
    ...
    public static MxSeev04400202 parse(String xml) {
        return ((MxSeev04400202) MxReadImpl.parse(MxSeev04400202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400202) MxReadImpl.parse(MxSeev04400202 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04400202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04400202 .class);
    }
