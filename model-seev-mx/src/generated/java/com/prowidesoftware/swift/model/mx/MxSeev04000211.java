    ...
    extends AbstractMX
{
    ...
    public static MxSeev04000211 parse(String xml) {
        return ((MxSeev04000211) MxReadImpl.parse(MxSeev04000211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04000211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04000211) MxReadImpl.parse(MxSeev04000211 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04000211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04000211 .class);
    }
