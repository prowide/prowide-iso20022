    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.036.002.07";
    ...
    public static MxSeev03600207 parse(String xml) {
        return ((MxSeev03600207) MxReadImpl.parse(MxSeev03600207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600207) MxReadImpl.parse(MxSeev03600207 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03600207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600207 .class);
    }
