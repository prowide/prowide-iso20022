    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600109 parse(String xml) {
        return ((MxSeev03600109) MxReadImpl.parse(MxSeev03600109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600109) MxReadImpl.parse(MxSeev03600109 .class, xml, _classes, new MxReadParams(conf)));
    }
