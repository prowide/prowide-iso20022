    ...
    extends AbstractMX
{
    ...
    public static MxSeev00700101 parse(String xml) {
        return ((MxSeev00700101) MxReadImpl.parse(MxSeev00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00700101) MxReadImpl.parse(MxSeev00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
