    ...
    extends AbstractMX
{
    ...
    public static MxSeev00700108 parse(String xml) {
        return ((MxSeev00700108) MxReadImpl.parse(MxSeev00700108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00700108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00700108) MxReadImpl.parse(MxSeev00700108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00700108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00700108 .class);
    }
