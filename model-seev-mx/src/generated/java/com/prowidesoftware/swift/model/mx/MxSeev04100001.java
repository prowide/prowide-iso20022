...
/**
 * Class for seev.041.000.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev04100001(final String xml) {
        this();
        MxSeev04100001 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev04100001(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionInstructionCancellationRequestStatusAdviceV1 }
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdviceV1 getCorpActnInstrCxlReqStsAdvc() {
     ...
     *     
     */
    public MxSeev04100001 setCorpActnInstrCxlReqStsAdvc(CorporateActionInstructionCancellationRequestStatusAdviceV1 value) {
     ...
     * 
     */
    public static MxSeev04100001 parse(String xml) {
        return ((MxSeev04100001) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev04100001 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev04100001 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100001) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev04100001 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev04100001 parse(String xml, MxRead parserImpl) {
        return ((MxSeev04100001) parserImpl.read(MxSeev04100001 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev04100001 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev04100001 message
     * @return
     *     a new instance of MxSeev04100001
     */
    public final static MxSeev04100001 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev04100001 .class);
    }
