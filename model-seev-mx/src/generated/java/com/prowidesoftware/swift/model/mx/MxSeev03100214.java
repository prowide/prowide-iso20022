    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100214 parse(String xml) {
        return ((MxSeev03100214) MxReadImpl.parse(MxSeev03100214 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100214 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100214) MxReadImpl.parse(MxSeev03100214 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03100214 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100214 .class);
    }
