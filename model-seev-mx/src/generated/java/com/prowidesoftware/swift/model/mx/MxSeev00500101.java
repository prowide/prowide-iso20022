    ...
    extends AbstractMX
{
    ...
    public static MxSeev00500101 parse(String xml) {
        return ((MxSeev00500101) MxReadImpl.parse(MxSeev00500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00500101) MxReadImpl.parse(MxSeev00500101 .class, xml, _classes, new MxReadParams(conf)));
    }
