    ...
    extends AbstractMX
{
    ...
    public static MxSeev03800102 parse(String xml) {
        return ((MxSeev03800102) MxReadImpl.parse(MxSeev03800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03800102) MxReadImpl.parse(MxSeev03800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03800102 .class);
    }
