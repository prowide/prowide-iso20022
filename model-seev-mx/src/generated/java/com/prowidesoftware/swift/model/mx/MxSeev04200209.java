    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200209 parse(String xml) {
        return ((MxSeev04200209) MxReadImpl.parse(MxSeev04200209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200209) MxReadImpl.parse(MxSeev04200209 .class, xml, _classes, new MxReadParams(conf)));
    }
