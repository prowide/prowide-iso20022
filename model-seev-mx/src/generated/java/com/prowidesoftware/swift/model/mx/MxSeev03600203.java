    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600203 parse(String xml) {
        return ((MxSeev03600203) MxReadImpl.parse(MxSeev03600203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600203) MxReadImpl.parse(MxSeev03600203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600203 .class);
    }
