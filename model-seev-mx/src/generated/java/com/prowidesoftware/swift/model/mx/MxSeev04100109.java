    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.041.001.09";
    ...
    public static MxSeev04100109 parse(String xml) {
        return ((MxSeev04100109) MxReadImpl.parse(MxSeev04100109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100109) MxReadImpl.parse(MxSeev04100109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04100109 fromJson(String json) {
