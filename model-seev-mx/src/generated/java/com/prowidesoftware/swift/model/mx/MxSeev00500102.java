    ...
    extends AbstractMX
{
    ...
    public static MxSeev00500102 parse(String xml) {
        return ((MxSeev00500102) MxReadImpl.parse(MxSeev00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00500102) MxReadImpl.parse(MxSeev00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
