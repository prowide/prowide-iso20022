    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400110 parse(String xml) {
        return ((MxSeev03400110) MxReadImpl.parse(MxSeev03400110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400110) MxReadImpl.parse(MxSeev03400110 .class, xml, _classes, new MxReadParams(conf)));
    }
