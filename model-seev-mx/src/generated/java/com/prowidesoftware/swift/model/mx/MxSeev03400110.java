    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.034.001.10";
    ...
    public static MxSeev03400110 parse(String xml) {
        return ((MxSeev03400110) MxReadImpl.parse(MxSeev03400110 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03400110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400110 .class);
    }
