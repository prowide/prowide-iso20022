    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200205 parse(String xml) {
        return ((MxSeev04200205) MxReadImpl.parse(MxSeev04200205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200205) MxReadImpl.parse(MxSeev04200205 .class, xml, _classes, new MxReadParams(conf)));
    }
