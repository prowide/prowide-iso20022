    ...
    extends AbstractMX
{
    ...
    public static MxSeev03800209 parse(String xml) {
        return ((MxSeev03800209) MxReadImpl.parse(MxSeev03800209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03800209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03800209) MxReadImpl.parse(MxSeev03800209 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03800209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03800209 .class);
    }
