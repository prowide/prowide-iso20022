    ...
    extends AbstractMX
{
    ...
    public static MxSeev00700106 parse(String xml) {
        return ((MxSeev00700106) MxReadImpl.parse(MxSeev00700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00700106) MxReadImpl.parse(MxSeev00700106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00700106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00700106 .class);
    }
