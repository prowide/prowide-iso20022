    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500110 parse(String xml) {
        return ((MxSeev03500110) MxReadImpl.parse(MxSeev03500110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500110) MxReadImpl.parse(MxSeev03500110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03500110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500110 .class);
    }
