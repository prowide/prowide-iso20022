...
/**
 * Class for seev.035.001.10 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:seev.035.001.10")
public class MxSeev03500110
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.035.001.10";
     ...
     * 
     */
    public MxSeev03500110(final String xml) {
        this();
        MxSeev03500110 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev03500110(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionMovementPreliminaryAdviceV10 }
     *     
     */
     ...
     *     
     */
    public MxSeev03500110 setCorpActnMvmntPrlimryAdvc(CorporateActionMovementPreliminaryAdviceV10 value) {
     ...
     * 
     */
    public static MxSeev03500110 parse(String xml) {
        return ((MxSeev03500110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03500110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev03500110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03500110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev03500110 parse(String xml, MxRead parserImpl) {
        return ((MxSeev03500110) parserImpl.read(MxSeev03500110 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev03500110 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev03500110 message
     * @return
     *     a new instance of MxSeev03500110
     */
    public final static MxSeev03500110 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev03500110 .class);
    }
