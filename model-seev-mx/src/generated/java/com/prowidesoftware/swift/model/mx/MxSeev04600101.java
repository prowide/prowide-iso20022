    ...
    extends AbstractMX
{
    ...
    public static MxSeev04600101 parse(String xml) {
        return ((MxSeev04600101) MxReadImpl.parse(MxSeev04600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04600101) MxReadImpl.parse(MxSeev04600101 .class, xml, _classes, new MxReadParams(conf)));
    }
