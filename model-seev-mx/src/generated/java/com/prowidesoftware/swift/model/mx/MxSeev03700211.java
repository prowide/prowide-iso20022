    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700211 parse(String xml) {
        return ((MxSeev03700211) MxReadImpl.parse(MxSeev03700211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700211) MxReadImpl.parse(MxSeev03700211 .class, xml, _classes, new MxReadParams(conf)));
    }
