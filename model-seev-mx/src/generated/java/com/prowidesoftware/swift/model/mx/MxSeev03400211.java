    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.034.002.11";
    ...
    public static MxSeev03400211 parse(String xml) {
        return ((MxSeev03400211) MxReadImpl.parse(MxSeev03400211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400211) MxReadImpl.parse(MxSeev03400211 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03400211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400211 .class);
    }
