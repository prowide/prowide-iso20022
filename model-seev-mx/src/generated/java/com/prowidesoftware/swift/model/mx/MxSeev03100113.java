    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100113 parse(String xml) {
        return ((MxSeev03100113) MxReadImpl.parse(MxSeev03100113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100113 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100113) MxReadImpl.parse(MxSeev03100113 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03100113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100113 .class);
    }
