    ...
    extends AbstractMX
{
    ...
    public static MxSeev01500101 parse(String xml) {
        return ((MxSeev01500101) MxReadImpl.parse(MxSeev01500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev01500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev01500101) MxReadImpl.parse(MxSeev01500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev01500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev01500101 .class);
    }
