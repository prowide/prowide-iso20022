    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400112 parse(String xml) {
        return ((MxSeev03400112) MxReadImpl.parse(MxSeev03400112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400112) MxReadImpl.parse(MxSeev03400112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03400112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400112 .class);
    }
