    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.034.002.07";
    ...
    public static MxSeev03400207 parse(String xml) {
        return ((MxSeev03400207) MxReadImpl.parse(MxSeev03400207 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03400207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400207 .class);
    }
