    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400207 parse(String xml) {
        return ((MxSeev03400207) MxReadImpl.parse(MxSeev03400207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400207) MxReadImpl.parse(MxSeev03400207 .class, xml, _classes, new MxReadParams(conf)));
    }
