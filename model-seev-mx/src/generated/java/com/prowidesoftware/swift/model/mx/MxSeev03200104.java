    ...
    extends AbstractMX
{
    ...
    public static MxSeev03200104 parse(String xml) {
        return ((MxSeev03200104) MxReadImpl.parse(MxSeev03200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03200104) MxReadImpl.parse(MxSeev03200104 .class, xml, _classes, new MxReadParams(conf)));
    }
