    ...
    extends AbstractMX
{
    ...
    public static MxSeev03800201 parse(String xml) {
        return ((MxSeev03800201) MxReadImpl.parse(MxSeev03800201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03800201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03800201) MxReadImpl.parse(MxSeev03800201 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03800201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03800201 .class);
    }
