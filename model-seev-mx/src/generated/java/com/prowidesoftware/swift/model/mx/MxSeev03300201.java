    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300201 parse(String xml) {
        return ((MxSeev03300201) MxReadImpl.parse(MxSeev03300201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300201) MxReadImpl.parse(MxSeev03300201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03300201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300201 .class);
    }
