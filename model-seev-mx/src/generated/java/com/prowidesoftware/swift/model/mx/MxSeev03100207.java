...
/**
 * Class for seev.031.002.07 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:seev.031.002.07")
public class MxSeev03100207
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.031.002.07";
     ...
     * 
     */
    public MxSeev03100207(final String xml) {
        this();
        MxSeev03100207 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev03100207(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionNotification002V07 }
     *     
     */
     ...
     *     
     */
    public MxSeev03100207 setCorpActnNtfctn(CorporateActionNotification002V07 value) {
     ...
     * 
     */
    public static MxSeev03100207 parse(String xml) {
        return ((MxSeev03100207) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03100207 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev03100207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100207) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03100207 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev03100207 parse(String xml, MxRead parserImpl) {
        return ((MxSeev03100207) parserImpl.read(MxSeev03100207 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev03100207 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev03100207 message
     * @return
     *     a new instance of MxSeev03100207
     */
    public final static MxSeev03100207 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev03100207 .class);
    }
