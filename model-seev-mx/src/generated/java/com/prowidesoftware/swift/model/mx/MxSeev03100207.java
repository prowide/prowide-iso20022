    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100207 parse(String xml) {
        return ((MxSeev03100207) MxReadImpl.parse(MxSeev03100207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100207) MxReadImpl.parse(MxSeev03100207 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03100207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100207 .class);
    }
