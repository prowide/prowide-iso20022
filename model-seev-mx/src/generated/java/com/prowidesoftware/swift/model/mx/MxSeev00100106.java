    ...
    extends AbstractMX
{
    ...
    public static MxSeev00100106 parse(String xml) {
        return ((MxSeev00100106) MxReadImpl.parse(MxSeev00100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100106) MxReadImpl.parse(MxSeev00100106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00100106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00100106 .class);
    }
