...
/**
 * Class for seev.001.001.06 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev00100106(final String xml) {
        this();
        MxSeev00100106 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev00100106(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link MeetingNotificationV06 }
     *     
     */
    public MeetingNotificationV06 getMtgNtfctn() {
        return mtgNtfctn;
    }
     ...
     *     
     */
    public MxSeev00100106 setMtgNtfctn(MeetingNotificationV06 value) {
     ...
     * 
     */
    public static MxSeev00100106 parse(String xml) {
        return ((MxSeev00100106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev00100106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev00100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev00100106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev00100106 parse(String xml, MxRead parserImpl) {
        return ((MxSeev00100106) parserImpl.read(MxSeev00100106 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev00100106 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev00100106 message
     * @return
     *     a new instance of MxSeev00100106
     */
    public final static MxSeev00100106 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev00100106 .class);
    }
