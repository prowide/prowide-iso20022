    ...
    extends AbstractMX
{
    ...
    public static MxSeev03200203 parse(String xml) {
        return ((MxSeev03200203) MxReadImpl.parse(MxSeev03200203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03200203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03200203) MxReadImpl.parse(MxSeev03200203 .class, xml, _classes, new MxReadParams(conf)));
    }
