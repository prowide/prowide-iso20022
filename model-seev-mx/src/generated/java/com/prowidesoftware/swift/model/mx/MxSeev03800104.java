    ...
    extends AbstractMX
{
    ...
    public static MxSeev03800104 parse(String xml) {
        return ((MxSeev03800104) MxReadImpl.parse(MxSeev03800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03800104) MxReadImpl.parse(MxSeev03800104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03800104 .class);
    }
