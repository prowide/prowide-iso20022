    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900205 parse(String xml) {
        return ((MxSeev03900205) MxReadImpl.parse(MxSeev03900205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900205) MxReadImpl.parse(MxSeev03900205 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03900205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900205 .class);
    }
