    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:seev.039.002.05";
    ...
    public static MxSeev03900205 parse(String xml) {
        return ((MxSeev03900205) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03900205 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev03900205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900205) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03900205 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03900205 fromJson(String json) {
