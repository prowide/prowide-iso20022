    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300107 parse(String xml) {
        return ((MxSeev03300107) MxReadImpl.parse(MxSeev03300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300107) MxReadImpl.parse(MxSeev03300107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03300107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300107 .class);
    }
