    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.011.001.01";
    ...
    public static MxSeev01100101 parse(String xml) {
        return ((MxSeev01100101) MxReadImpl.parse(MxSeev01100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev01100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev01100101) MxReadImpl.parse(MxSeev01100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev01100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev01100101 .class);
    }
