    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.040.001.05";
    ...
    public static MxSeev04000105 parse(String xml) {
        return ((MxSeev04000105) MxReadImpl.parse(MxSeev04000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04000105) MxReadImpl.parse(MxSeev04000105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04000105 fromJson(String json) {
