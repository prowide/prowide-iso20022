    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500115 parse(String xml) {
        return ((MxSeev03500115) MxReadImpl.parse(MxSeev03500115 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500115 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500115) MxReadImpl.parse(MxSeev03500115 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03500115 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500115 .class);
    }
