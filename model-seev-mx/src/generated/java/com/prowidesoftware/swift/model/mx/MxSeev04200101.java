    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200101 parse(String xml) {
        return ((MxSeev04200101) MxReadImpl.parse(MxSeev04200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200101) MxReadImpl.parse(MxSeev04200101 .class, xml, _classes, new MxReadParams(conf)));
    }
