    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.042.001.01";
    ...
    public static MxSeev04200101 parse(String xml) {
        return ((MxSeev04200101) MxReadImpl.parse(MxSeev04200101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev04200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04200101 .class);
    }
