    ...
    extends AbstractMX
{
    ...
    public static MxSeev00100102 parse(String xml) {
        return ((MxSeev00100102) MxReadImpl.parse(MxSeev00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100102) MxReadImpl.parse(MxSeev00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
