    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300111 parse(String xml) {
        return ((MxSeev03300111) MxReadImpl.parse(MxSeev03300111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300111) MxReadImpl.parse(MxSeev03300111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03300111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300111 .class);
    }
