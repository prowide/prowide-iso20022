    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500206 parse(String xml) {
        return ((MxSeev03500206) MxReadImpl.parse(MxSeev03500206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500206) MxReadImpl.parse(MxSeev03500206 .class, xml, _classes, new MxReadParams(conf)));
    }
