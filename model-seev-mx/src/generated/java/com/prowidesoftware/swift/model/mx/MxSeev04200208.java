    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200208 parse(String xml) {
        return ((MxSeev04200208) MxReadImpl.parse(MxSeev04200208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200208) MxReadImpl.parse(MxSeev04200208 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04200208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04200208 .class);
    }
