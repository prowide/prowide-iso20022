    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100208 parse(String xml) {
        return ((MxSeev03100208) MxReadImpl.parse(MxSeev03100208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100208) MxReadImpl.parse(MxSeev03100208 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03100208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100208 .class);
    }
