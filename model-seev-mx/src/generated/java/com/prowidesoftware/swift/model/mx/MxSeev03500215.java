    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.035.002.15";
    ...
    public static MxSeev03500215 parse(String xml) {
        return ((MxSeev03500215) MxReadImpl.parse(MxSeev03500215 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500215 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500215) MxReadImpl.parse(MxSeev03500215 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03500215 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500215 .class);
    }
