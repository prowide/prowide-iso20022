    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300113 parse(String xml) {
        return ((MxSeev03300113) MxReadImpl.parse(MxSeev03300113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300113 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300113) MxReadImpl.parse(MxSeev03300113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03300113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300113 .class);
    }
