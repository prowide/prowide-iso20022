    ...
    extends AbstractMX
{
    ...
    public static MxSeev00500106 parse(String xml) {
        return ((MxSeev00500106) MxReadImpl.parse(MxSeev00500106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00500106) MxReadImpl.parse(MxSeev00500106 .class, xml, _classes, new MxReadParams(conf)));
    }
