    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.003.001.06";
    ...
    public static MxSeev00300106 parse(String xml) {
        return ((MxSeev00300106) MxReadImpl.parse(MxSeev00300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00300106) MxReadImpl.parse(MxSeev00300106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev00300106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00300106 .class);
    }
