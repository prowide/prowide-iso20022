    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.045.001.03";
    ...
    public static MxSeev04500103 parse(String xml) {
        return ((MxSeev04500103) MxReadImpl.parse(MxSeev04500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04500103) MxReadImpl.parse(MxSeev04500103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04500103 .class);
    }
