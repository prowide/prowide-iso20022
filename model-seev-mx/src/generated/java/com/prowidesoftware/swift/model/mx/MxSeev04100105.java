    ...
    extends AbstractMX
{
    ...
    public static MxSeev04100105 parse(String xml) {
        return ((MxSeev04100105) MxReadImpl.parse(MxSeev04100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100105) MxReadImpl.parse(MxSeev04100105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04100105 .class);
    }
