    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600208 parse(String xml) {
        return ((MxSeev03600208) MxReadImpl.parse(MxSeev03600208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600208) MxReadImpl.parse(MxSeev03600208 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600208 .class);
    }
