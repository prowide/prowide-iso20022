    ...
    extends AbstractMX
{
    ...
    public static MxSeev04700103 parse(String xml) {
        return ((MxSeev04700103) MxReadImpl.parse(MxSeev04700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04700103) MxReadImpl.parse(MxSeev04700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04700103 .class);
    }
