    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.008.001.04";
    ...
    public static MxSeev00800104 parse(String xml) {
        return ((MxSeev00800104) MxReadImpl.parse(MxSeev00800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00800104) MxReadImpl.parse(MxSeev00800104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev00800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00800104 .class);
    }
