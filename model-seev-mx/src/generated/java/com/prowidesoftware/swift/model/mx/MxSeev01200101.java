    ...
    extends AbstractMX
{
    ...
    public static MxSeev01200101 parse(String xml) {
        return ((MxSeev01200101) MxReadImpl.parse(MxSeev01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev01200101) MxReadImpl.parse(MxSeev01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
