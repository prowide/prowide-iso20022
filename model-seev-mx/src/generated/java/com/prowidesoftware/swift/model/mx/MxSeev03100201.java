    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100201 parse(String xml) {
        return ((MxSeev03100201) MxReadImpl.parse(MxSeev03100201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100201) MxReadImpl.parse(MxSeev03100201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03100201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100201 .class);
    }
