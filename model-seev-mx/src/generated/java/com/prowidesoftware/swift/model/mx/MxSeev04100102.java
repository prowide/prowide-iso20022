    ...
    extends AbstractMX
{
    ...
    public static MxSeev04100102 parse(String xml) {
        return ((MxSeev04100102) MxReadImpl.parse(MxSeev04100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100102) MxReadImpl.parse(MxSeev04100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04100102 .class);
    }
