    ...
    extends AbstractMX
{
    ...
    public static MxSeev00300107 parse(String xml) {
        return ((MxSeev00300107) MxReadImpl.parse(MxSeev00300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00300107) MxReadImpl.parse(MxSeev00300107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00300107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00300107 .class);
    }
