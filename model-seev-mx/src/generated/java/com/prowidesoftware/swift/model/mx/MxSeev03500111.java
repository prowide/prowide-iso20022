    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500111 parse(String xml) {
        return ((MxSeev03500111) MxReadImpl.parse(MxSeev03500111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500111) MxReadImpl.parse(MxSeev03500111 .class, xml, _classes, new MxReadParams(conf)));
    }
