    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600215 parse(String xml) {
        return ((MxSeev03600215) MxReadImpl.parse(MxSeev03600215 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600215 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600215) MxReadImpl.parse(MxSeev03600215 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600215 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600215 .class);
    }
