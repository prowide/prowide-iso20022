    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400210 parse(String xml) {
        return ((MxSeev03400210) MxReadImpl.parse(MxSeev03400210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400210) MxReadImpl.parse(MxSeev03400210 .class, xml, _classes, new MxReadParams(conf)));
    }
