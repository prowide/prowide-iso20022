    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400202 parse(String xml) {
        return ((MxSeev03400202) MxReadImpl.parse(MxSeev03400202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400202) MxReadImpl.parse(MxSeev03400202 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03400202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400202 .class);
    }
