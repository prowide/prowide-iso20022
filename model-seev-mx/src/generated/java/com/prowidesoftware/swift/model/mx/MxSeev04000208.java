    ...
    extends AbstractMX
{
    ...
    public static MxSeev04000208 parse(String xml) {
        return ((MxSeev04000208) MxReadImpl.parse(MxSeev04000208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04000208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04000208) MxReadImpl.parse(MxSeev04000208 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04000208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04000208 .class);
    }
