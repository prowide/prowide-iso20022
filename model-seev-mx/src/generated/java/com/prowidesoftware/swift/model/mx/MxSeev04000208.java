...
/**
 * Class for seev.040.002.08 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:seev.040.002.08")
public class MxSeev04000208
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev04000208(final String xml) {
        this();
        MxSeev04000208 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev04000208(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionInstructionCancellationRequest002V08 }
     *     
     */
    public CorporateActionInstructionCancellationRequest002V08 getCorpActnInstrCxlReq() {
     ...
     * 
     */
    public static MxSeev04000208 parse(String xml) {
        return ((MxSeev04000208) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev04000208 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev04000208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04000208) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev04000208 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev04000208 parse(String xml, MxRead parserImpl) {
        return ((MxSeev04000208) parserImpl.read(MxSeev04000208 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev04000208 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev04000208 message
     * @return
