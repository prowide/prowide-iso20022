    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500205 parse(String xml) {
        return ((MxSeev03500205) MxReadImpl.parse(MxSeev03500205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500205) MxReadImpl.parse(MxSeev03500205 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03500205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500205 .class);
    }
