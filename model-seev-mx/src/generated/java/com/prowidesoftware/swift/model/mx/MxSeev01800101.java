    ...
    extends AbstractMX
{
    ...
    public static MxSeev01800101 parse(String xml) {
        return ((MxSeev01800101) MxReadImpl.parse(MxSeev01800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev01800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev01800101) MxReadImpl.parse(MxSeev01800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev01800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev01800101 .class);
    }
