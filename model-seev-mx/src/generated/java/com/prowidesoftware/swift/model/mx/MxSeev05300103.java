...
/**
 * Class for seev.053.001.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev05300103(final String xml) {
        this();
        MxSeev05300103 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev05300103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link MarketClaimCancellationRequestStatusAdviceV03 }
     *     
     */
    public MarketClaimCancellationRequestStatusAdviceV03 getMktClmCxlReqStsAdvc() {
     ...
     *     
     */
    public MxSeev05300103 setMktClmCxlReqStsAdvc(MarketClaimCancellationRequestStatusAdviceV03 value) {
     ...
     */
    public static MxSeev05300103 parse(String xml, MxRead parserImpl) {
        return ((MxSeev05300103) parserImpl.read(MxSeev05300103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev05300103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev05300103 message
     * @return
