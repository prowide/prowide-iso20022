...
/**
 * Class for seev.001.001.12 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:seev.001.001.12")
public class MxSeev00100112
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev00100112(final String xml) {
        this();
        MxSeev00100112 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev00100112(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link MeetingNotificationV12 }
     *     
     */
    public MeetingNotificationV12 getMtgNtfctn() {
        return mtgNtfctn;
    }
     ...
     * 
     */
    public static MxSeev00100112 parse(String xml) {
        return ((MxSeev00100112) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev00100112 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev00100112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100112) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev00100112 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev00100112 parse(String xml, MxRead parserImpl) {
        return ((MxSeev00100112) parserImpl.read(MxSeev00100112 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev00100112 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev00100112 message
     * @return
