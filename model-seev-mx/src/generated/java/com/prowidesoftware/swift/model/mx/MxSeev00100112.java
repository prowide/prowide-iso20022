    ...
    extends AbstractMX
{
    ...
    public static MxSeev00100112 parse(String xml) {
        return ((MxSeev00100112) MxReadImpl.parse(MxSeev00100112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00100112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100112) MxReadImpl.parse(MxSeev00100112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00100112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00100112 .class);
    }
