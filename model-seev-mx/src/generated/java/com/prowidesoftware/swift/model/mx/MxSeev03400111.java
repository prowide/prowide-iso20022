    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.034.001.11";
    ...
    public static MxSeev03400111 parse(String xml) {
        return ((MxSeev03400111) MxReadImpl.parse(MxSeev03400111 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03400111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400111 .class);
    }
