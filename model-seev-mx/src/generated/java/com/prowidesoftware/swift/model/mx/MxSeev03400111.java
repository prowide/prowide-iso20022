    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400111 parse(String xml) {
        return ((MxSeev03400111) MxReadImpl.parse(MxSeev03400111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400111) MxReadImpl.parse(MxSeev03400111 .class, xml, _classes, new MxReadParams(conf)));
    }
