...
/**
 * Class for seev.036.002.14 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:seev.036.002.14")
public class MxSeev03600214
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev03600214(final String xml) {
        this();
        MxSeev03600214 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev03600214(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxSeev03600214 setCorpActnMvmntConf(CorporateActionMovementConfirmation002V14 value) {
     ...
     * 
     */
    public static MxSeev03600214 parse(String xml) {
        return ((MxSeev03600214) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03600214 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev03600214 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600214) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03600214 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev03600214 parse(String xml, MxRead parserImpl) {
        return ((MxSeev03600214) parserImpl.read(MxSeev03600214 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev03600214 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev03600214 message
     * @return
     *     a new instance of MxSeev03600214
     */
    public final static MxSeev03600214 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev03600214 .class);
    }
