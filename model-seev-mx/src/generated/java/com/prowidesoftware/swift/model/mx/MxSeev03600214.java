    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600214 parse(String xml) {
        return ((MxSeev03600214) MxReadImpl.parse(MxSeev03600214 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600214 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600214) MxReadImpl.parse(MxSeev03600214 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600214 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600214 .class);
    }
