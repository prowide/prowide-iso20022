    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.042.001.11";
    ...
    public static MxSeev04200111 parse(String xml) {
        return ((MxSeev04200111) MxReadImpl.parse(MxSeev04200111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200111) MxReadImpl.parse(MxSeev04200111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04200111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04200111 .class);
    }
