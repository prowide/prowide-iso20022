    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:seev.039.002.03";
    ...
    public static MxSeev03900203 parse(String xml) {
        return ((MxSeev03900203) MxReadImpl.parse(MxSeev03900203 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03900203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900203 .class);
    }
