    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900203 parse(String xml) {
        return ((MxSeev03900203) MxReadImpl.parse(MxSeev03900203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900203) MxReadImpl.parse(MxSeev03900203 .class, xml, _classes, new MxReadParams(conf)));
    }
