    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500114 parse(String xml) {
        return ((MxSeev03500114) MxReadImpl.parse(MxSeev03500114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500114 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500114) MxReadImpl.parse(MxSeev03500114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03500114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500114 .class);
    }
