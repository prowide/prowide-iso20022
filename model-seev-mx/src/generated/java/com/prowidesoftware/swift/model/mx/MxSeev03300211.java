    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300211 parse(String xml) {
        return ((MxSeev03300211) MxReadImpl.parse(MxSeev03300211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300211) MxReadImpl.parse(MxSeev03300211 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03300211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300211 .class);
    }
