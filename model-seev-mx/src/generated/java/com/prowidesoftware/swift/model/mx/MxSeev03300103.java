    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.033.001.03";
    ...
    public static MxSeev03300103 parse(String xml) {
        return ((MxSeev03300103) MxReadImpl.parse(MxSeev03300103 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300103 .class);
    }
