    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300103 parse(String xml) {
        return ((MxSeev03300103) MxReadImpl.parse(MxSeev03300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300103) MxReadImpl.parse(MxSeev03300103 .class, xml, _classes, new MxReadParams(conf)));
    }
