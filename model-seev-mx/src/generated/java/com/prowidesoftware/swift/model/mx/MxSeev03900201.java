    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900201 parse(String xml) {
        return ((MxSeev03900201) MxReadImpl.parse(MxSeev03900201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900201) MxReadImpl.parse(MxSeev03900201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03900201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900201 .class);
    }
