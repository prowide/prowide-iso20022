    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600106 parse(String xml) {
        return ((MxSeev03600106) MxReadImpl.parse(MxSeev03600106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600106) MxReadImpl.parse(MxSeev03600106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600106 .class);
    }
