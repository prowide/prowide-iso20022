    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100107 parse(String xml) {
        return ((MxSeev03100107) MxReadImpl.parse(MxSeev03100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100107) MxReadImpl.parse(MxSeev03100107 .class, xml, _classes, new MxReadParams(conf)));
    }
