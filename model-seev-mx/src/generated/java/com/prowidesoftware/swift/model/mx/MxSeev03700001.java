...
/**
 * Class for seev.037.000.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev03700001(final String xml) {
        this();
        MxSeev03700001 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev03700001(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionMovementReversalAdviceV1 }
     *     
     */
    public CorporateActionMovementReversalAdviceV1 getCorpActnMvmntRvslAdvc() {
     ...
     *     
     */
    public MxSeev03700001 setCorpActnMvmntRvslAdvc(CorporateActionMovementReversalAdviceV1 value) {
     ...
     * 
     */
    public static MxSeev03700001 parse(String xml) {
        return ((MxSeev03700001) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03700001 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev03700001 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700001) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03700001 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev03700001 parse(String xml, MxRead parserImpl) {
        return ((MxSeev03700001) parserImpl.read(MxSeev03700001 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev03700001 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev03700001 message
     * @return
     *     a new instance of MxSeev03700001
     */
    public final static MxSeev03700001 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev03700001 .class);
    }
