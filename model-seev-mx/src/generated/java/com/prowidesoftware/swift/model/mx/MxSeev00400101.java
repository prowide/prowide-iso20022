    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:seev.004.001.01";
    ...
    public static MxSeev00400101 parse(String xml) {
        return ((MxSeev00400101) MxReadImpl.parse(MxSeev00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00400101) MxReadImpl.parse(MxSeev00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev00400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00400101 .class);
    }
