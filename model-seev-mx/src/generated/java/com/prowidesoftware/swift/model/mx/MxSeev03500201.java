    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:seev.035.002.01";
    ...
    public static MxSeev03500201 parse(String xml) {
        return ((MxSeev03500201) MxReadImpl.parse(MxSeev03500201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500201) MxReadImpl.parse(MxSeev03500201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03500201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500201 .class);
    }
