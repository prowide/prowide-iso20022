    ...
    extends AbstractMX
{
    ...
    public static MxSeev00800108 parse(String xml) {
        return ((MxSeev00800108) MxReadImpl.parse(MxSeev00800108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00800108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00800108) MxReadImpl.parse(MxSeev00800108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00800108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00800108 .class);
    }
