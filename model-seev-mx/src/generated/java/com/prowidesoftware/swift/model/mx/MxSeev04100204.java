...
/**
 * Class for seev.041.002.04 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev04100204(final String xml) {
        this();
        MxSeev04100204 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev04100204(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionInstructionCancellationRequestStatusAdvice002V04 }
     *     
     */
    public CorporateActionInstructionCancellationRequestStatusAdvice002V04 getCorpActnInstrCxlReqStsAdvc() {
     ...
     *     
     */
    public MxSeev04100204 setCorpActnInstrCxlReqStsAdvc(CorporateActionInstructionCancellationRequestStatusAdvice002V04 value) {
     ...
     * 
     */
    public static MxSeev04100204 parse(String xml) {
        return ((MxSeev04100204) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev04100204 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev04100204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100204) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev04100204 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev04100204 parse(String xml, MxRead parserImpl) {
        return ((MxSeev04100204) parserImpl.read(MxSeev04100204 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev04100204 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev04100204 message
     * @return
     *     a new instance of MxSeev04100204
     */
    public final static MxSeev04100204 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev04100204 .class);
    }
