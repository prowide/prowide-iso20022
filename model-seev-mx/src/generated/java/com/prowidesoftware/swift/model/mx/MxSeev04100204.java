    ...
    extends AbstractMX
{
    ...
    public static MxSeev04100204 parse(String xml) {
        return ((MxSeev04100204) MxReadImpl.parse(MxSeev04100204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100204) MxReadImpl.parse(MxSeev04100204 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04100204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04100204 .class);
    }
