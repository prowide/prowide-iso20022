    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600112 parse(String xml) {
        return ((MxSeev03600112) MxReadImpl.parse(MxSeev03600112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600112) MxReadImpl.parse(MxSeev03600112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600112 .class);
    }
