    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:seev.040.002.04";
    ...
    public static MxSeev04000204 parse(String xml) {
        return ((MxSeev04000204) MxReadImpl.parse(MxSeev04000204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04000204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04000204) MxReadImpl.parse(MxSeev04000204 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04000204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04000204 .class);
    }
