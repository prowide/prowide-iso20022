    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.042.002.12";
    ...
    public static MxSeev04200212 parse(String xml) {
        return ((MxSeev04200212) MxReadImpl.parse(MxSeev04200212 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200212 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200212) MxReadImpl.parse(MxSeev04200212 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04200212 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04200212 .class);
    }
