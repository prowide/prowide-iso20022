    ...
    extends AbstractMX
{
    ...
    public static MxSeev04500104 parse(String xml) {
        return ((MxSeev04500104) MxReadImpl.parse(MxSeev04500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04500104) MxReadImpl.parse(MxSeev04500104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04500104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04500104 .class);
    }
