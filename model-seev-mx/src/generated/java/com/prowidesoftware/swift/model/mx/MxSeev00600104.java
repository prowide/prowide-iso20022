    ...
    extends AbstractMX
{
    ...
    public static MxSeev00600104 parse(String xml) {
        return ((MxSeev00600104) MxReadImpl.parse(MxSeev00600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00600104) MxReadImpl.parse(MxSeev00600104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00600104 .class);
    }
