    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.023.001.01";
    ...
    public static MxSeev02300101 parse(String xml) {
        return ((MxSeev02300101) MxReadImpl.parse(MxSeev02300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev02300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev02300101) MxReadImpl.parse(MxSeev02300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev02300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev02300101 .class);
    }
