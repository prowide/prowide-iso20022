    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600115 parse(String xml) {
        return ((MxSeev03600115) MxReadImpl.parse(MxSeev03600115 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600115 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600115) MxReadImpl.parse(MxSeev03600115 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600115 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600115 .class);
    }
