    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.003.001.04";
    ...
    public static MxSeev00300104 parse(String xml) {
        return ((MxSeev00300104) MxReadImpl.parse(MxSeev00300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00300104) MxReadImpl.parse(MxSeev00300104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev00300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00300104 .class);
    }
