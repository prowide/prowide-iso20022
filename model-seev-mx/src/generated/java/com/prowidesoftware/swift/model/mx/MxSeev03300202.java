    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300202 parse(String xml) {
        return ((MxSeev03300202) MxReadImpl.parse(MxSeev03300202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300202) MxReadImpl.parse(MxSeev03300202 .class, xml, _classes, new MxReadParams(conf)));
    }
