    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:seev.033.002.02";
    ...
    public static MxSeev03300202 parse(String xml) {
        return ((MxSeev03300202) MxReadImpl.parse(MxSeev03300202 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03300202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300202 .class);
    }
