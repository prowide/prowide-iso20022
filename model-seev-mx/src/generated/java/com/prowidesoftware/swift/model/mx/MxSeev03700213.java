    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.037.002.13";
    ...
    public static MxSeev03700213 parse(String xml) {
        return ((MxSeev03700213) MxReadImpl.parse(MxSeev03700213 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700213 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700213) MxReadImpl.parse(MxSeev03700213 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03700213 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03700213 .class);
    }
