    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600107 parse(String xml) {
        return ((MxSeev03600107) MxReadImpl.parse(MxSeev03600107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600107) MxReadImpl.parse(MxSeev03600107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600107 .class);
    }
