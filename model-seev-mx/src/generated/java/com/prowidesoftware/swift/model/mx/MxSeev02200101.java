    ...
    extends AbstractMX
{
    ...
    public static MxSeev02200101 parse(String xml) {
        return ((MxSeev02200101) MxReadImpl.parse(MxSeev02200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev02200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev02200101) MxReadImpl.parse(MxSeev02200101 .class, xml, _classes, new MxReadParams(conf)));
    }
