    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900108 parse(String xml) {
        return ((MxSeev03900108) MxReadImpl.parse(MxSeev03900108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900108) MxReadImpl.parse(MxSeev03900108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03900108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900108 .class);
    }
