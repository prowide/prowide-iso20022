    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.013.001.01";
    ...
    public static MxSeev01300101 parse(String xml) {
        return ((MxSeev01300101) MxReadImpl.parse(MxSeev01300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev01300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev01300101) MxReadImpl.parse(MxSeev01300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev01300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev01300101 .class);
    }
