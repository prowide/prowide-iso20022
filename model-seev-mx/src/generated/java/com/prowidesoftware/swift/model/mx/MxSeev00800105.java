    ...
    extends AbstractMX
{
    ...
    public static MxSeev00800105 parse(String xml) {
        return ((MxSeev00800105) MxReadImpl.parse(MxSeev00800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00800105) MxReadImpl.parse(MxSeev00800105 .class, xml, _classes, new MxReadParams(conf)));
    }
