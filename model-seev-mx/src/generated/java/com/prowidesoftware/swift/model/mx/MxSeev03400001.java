...
/**
 * Class for seev.034.000.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev03400001(final String xml) {
        this();
        MxSeev03400001 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev03400001(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionInstructionStatusAdviceV1 }
     *     
     */
    public CorporateActionInstructionStatusAdviceV1 getCorpActnInstrStsAdvc() {
     ...
     *     
     */
    public MxSeev03400001 setCorpActnInstrStsAdvc(CorporateActionInstructionStatusAdviceV1 value) {
     ...
     * 
     */
    public static MxSeev03400001 parse(String xml) {
        return ((MxSeev03400001) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03400001 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev03400001 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400001) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03400001 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev03400001 parse(String xml, MxRead parserImpl) {
        return ((MxSeev03400001) parserImpl.read(MxSeev03400001 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev03400001 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev03400001 message
     * @return
     *     a new instance of MxSeev03400001
     */
    public final static MxSeev03400001 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev03400001 .class);
    }
