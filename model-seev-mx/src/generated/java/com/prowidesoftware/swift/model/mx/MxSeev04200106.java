    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200106 parse(String xml) {
        return ((MxSeev04200106) MxReadImpl.parse(MxSeev04200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200106) MxReadImpl.parse(MxSeev04200106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04200106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04200106 .class);
    }
