    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900213 parse(String xml) {
        return ((MxSeev03900213) MxReadImpl.parse(MxSeev03900213 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900213 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900213) MxReadImpl.parse(MxSeev03900213 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03900213 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900213 .class);
    }
