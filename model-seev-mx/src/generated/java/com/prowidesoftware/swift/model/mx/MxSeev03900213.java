...
/**
 * Class for seev.039.002.13 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:seev.039.002.13")
public class MxSeev03900213
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev03900213(final String xml) {
        this();
        MxSeev03900213 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev03900213(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionCancellationAdvice002V13 }
     *     
     */
    public CorporateActionCancellationAdvice002V13 getCorpActnCxlAdvc() {
     ...
     * 
     */
    public static MxSeev03900213 parse(String xml) {
        return ((MxSeev03900213) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03900213 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev03900213 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900213) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03900213 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev03900213 parse(String xml, MxRead parserImpl) {
        return ((MxSeev03900213) parserImpl.read(MxSeev03900213 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev03900213 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev03900213 message
     * @return
