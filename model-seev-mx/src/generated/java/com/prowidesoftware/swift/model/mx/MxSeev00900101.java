    ...
    extends AbstractMX
{
    ...
    public static MxSeev00900101 parse(String xml) {
        return ((MxSeev00900101) MxReadImpl.parse(MxSeev00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00900101) MxReadImpl.parse(MxSeev00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
