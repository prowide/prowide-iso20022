    ...
    extends AbstractMX
{
    ...
    public static MxSeev04100103 parse(String xml) {
        return ((MxSeev04100103) MxReadImpl.parse(MxSeev04100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100103) MxReadImpl.parse(MxSeev04100103 .class, xml, _classes, new MxReadParams(conf)));
    }
