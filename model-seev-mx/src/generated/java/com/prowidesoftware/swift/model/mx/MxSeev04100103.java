    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.041.001.03";
    ...
    public static MxSeev04100103 parse(String xml) {
        return ((MxSeev04100103) MxReadImpl.parse(MxSeev04100103 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev04100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04100103 .class);
    }
