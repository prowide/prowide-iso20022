    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.004.001.05";
    ...
    public static MxSeev00400105 parse(String xml) {
        return ((MxSeev00400105) MxReadImpl.parse(MxSeev00400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00400105) MxReadImpl.parse(MxSeev00400105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev00400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00400105 .class);
    }
