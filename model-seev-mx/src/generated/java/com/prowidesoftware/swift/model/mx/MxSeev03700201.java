    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700201 parse(String xml) {
        return ((MxSeev03700201) MxReadImpl.parse(MxSeev03700201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700201) MxReadImpl.parse(MxSeev03700201 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03700201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03700201 .class);
    }
