    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.001.001.11";
    ...
    public static MxSeev00100111 parse(String xml) {
        return ((MxSeev00100111) MxReadImpl.parse(MxSeev00100111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00100111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100111) MxReadImpl.parse(MxSeev00100111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev00100111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00100111 .class);
    }
