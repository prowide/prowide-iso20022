    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.044.001.03";
    ...
    public static MxSeev04400103 parse(String xml) {
        return ((MxSeev04400103) MxReadImpl.parse(MxSeev04400103 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev04400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04400103 .class);
    }
