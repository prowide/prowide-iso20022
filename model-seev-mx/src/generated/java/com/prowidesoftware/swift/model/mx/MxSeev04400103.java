    ...
    extends AbstractMX
{
    ...
    public static MxSeev04400103 parse(String xml) {
        return ((MxSeev04400103) MxReadImpl.parse(MxSeev04400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400103) MxReadImpl.parse(MxSeev04400103 .class, xml, _classes, new MxReadParams(conf)));
    }
