    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500209 parse(String xml) {
        return ((MxSeev03500209) MxReadImpl.parse(MxSeev03500209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500209) MxReadImpl.parse(MxSeev03500209 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03500209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500209 .class);
    }
