    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200102 parse(String xml) {
        return ((MxSeev04200102) MxReadImpl.parse(MxSeev04200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200102) MxReadImpl.parse(MxSeev04200102 .class, xml, _classes, new MxReadParams(conf)));
    }
