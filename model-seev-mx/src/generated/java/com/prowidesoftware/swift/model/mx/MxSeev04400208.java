    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.044.002.08";
    ...
    public static MxSeev04400208 parse(String xml) {
        return ((MxSeev04400208) MxReadImpl.parse(MxSeev04400208 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev04400208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04400208 .class);
    }
