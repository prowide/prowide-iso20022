    ...
    extends AbstractMX
{
    ...
    public static MxSeev04400208 parse(String xml) {
        return ((MxSeev04400208) MxReadImpl.parse(MxSeev04400208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400208) MxReadImpl.parse(MxSeev04400208 .class, xml, _classes, new MxReadParams(conf)));
    }
