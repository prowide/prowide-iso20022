    ...
    extends AbstractMX
{
    ...
    public static MxSeev00200104 parse(String xml) {
        return ((MxSeev00200104) MxReadImpl.parse(MxSeev00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00200104) MxReadImpl.parse(MxSeev00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00200104 .class);
    }
