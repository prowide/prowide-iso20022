    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.031.001.11";
    ...
    public static MxSeev03100111 parse(String xml) {
        return ((MxSeev03100111) MxReadImpl.parse(MxSeev03100111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100111) MxReadImpl.parse(MxSeev03100111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03100111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100111 .class);
    }
