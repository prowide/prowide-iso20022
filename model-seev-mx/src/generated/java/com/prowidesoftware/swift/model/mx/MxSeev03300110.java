    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300110 parse(String xml) {
        return ((MxSeev03300110) MxReadImpl.parse(MxSeev03300110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300110) MxReadImpl.parse(MxSeev03300110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03300110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300110 .class);
    }
