    ...
    extends AbstractMX
{
    ...
    public static MxSeev03200204 parse(String xml) {
        return ((MxSeev03200204) MxReadImpl.parse(MxSeev03200204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03200204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03200204) MxReadImpl.parse(MxSeev03200204 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03200204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03200204 .class);
    }
