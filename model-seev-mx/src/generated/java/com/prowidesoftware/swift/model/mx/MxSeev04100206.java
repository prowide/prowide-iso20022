    ...
    extends AbstractMX
{
    ...
    public static MxSeev04100206 parse(String xml) {
        return ((MxSeev04100206) MxReadImpl.parse(MxSeev04100206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100206) MxReadImpl.parse(MxSeev04100206 .class, xml, _classes, new MxReadParams(conf)));
    }
