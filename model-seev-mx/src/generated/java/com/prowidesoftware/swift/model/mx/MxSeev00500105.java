    ...
    extends AbstractMX
{
    ...
    public static MxSeev00500105 parse(String xml) {
        return ((MxSeev00500105) MxReadImpl.parse(MxSeev00500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00500105) MxReadImpl.parse(MxSeev00500105 .class, xml, _classes, new MxReadParams(conf)));
    }
