    ...
    extends AbstractMX
{
    ...
    public static MxSeev03200208 parse(String xml) {
        return ((MxSeev03200208) MxReadImpl.parse(MxSeev03200208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03200208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03200208) MxReadImpl.parse(MxSeev03200208 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03200208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03200208 .class);
    }
