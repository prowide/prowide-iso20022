    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100101 parse(String xml) {
        return ((MxSeev03100101) MxReadImpl.parse(MxSeev03100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100101) MxReadImpl.parse(MxSeev03100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100101 .class);
    }
