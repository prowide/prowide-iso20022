    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900104 parse(String xml) {
        return ((MxSeev03900104) MxReadImpl.parse(MxSeev03900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900104) MxReadImpl.parse(MxSeev03900104 .class, xml, _classes, new MxReadParams(conf)));
    }
