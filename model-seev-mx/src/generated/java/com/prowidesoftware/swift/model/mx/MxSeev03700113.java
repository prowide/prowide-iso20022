    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700113 parse(String xml) {
        return ((MxSeev03700113) MxReadImpl.parse(MxSeev03700113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700113 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700113) MxReadImpl.parse(MxSeev03700113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03700113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03700113 .class);
    }
