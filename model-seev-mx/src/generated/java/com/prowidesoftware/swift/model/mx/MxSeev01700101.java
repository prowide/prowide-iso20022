    ...
    extends AbstractMX
{
    ...
    public static MxSeev01700101 parse(String xml) {
        return ((MxSeev01700101) MxReadImpl.parse(MxSeev01700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev01700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev01700101) MxReadImpl.parse(MxSeev01700101 .class, xml, _classes, new MxReadParams(conf)));
    }
