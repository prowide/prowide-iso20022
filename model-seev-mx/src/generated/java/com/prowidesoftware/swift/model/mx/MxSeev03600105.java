...
/**
 * Class for seev.036.001.05 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.036.001.05";
     ...
     * 
     */
    public MxSeev03600105(final String xml) {
        this();
        MxSeev03600105 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev03600105(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionMovementConfirmationV05 }
     *     
     */
     ...
     *     
     */
    public MxSeev03600105 setCorpActnMvmntConf(CorporateActionMovementConfirmationV05 value) {
     ...
     * 
     */
    public static MxSeev03600105 parse(String xml) {
        return ((MxSeev03600105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03600105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev03600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03600105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev03600105 parse(String xml, MxRead parserImpl) {
        return ((MxSeev03600105) parserImpl.read(MxSeev03600105 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev03600105 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev03600105 message
     * @return
     *     a new instance of MxSeev03600105
     */
    public final static MxSeev03600105 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev03600105 .class);
    }
