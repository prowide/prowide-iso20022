    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600105 parse(String xml) {
        return ((MxSeev03600105) MxReadImpl.parse(MxSeev03600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600105) MxReadImpl.parse(MxSeev03600105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600105 .class);
    }
