    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:seev.040.002.05";
    ...
    public static MxSeev04000205 parse(String xml) {
        return ((MxSeev04000205) MxReadImpl.parse(MxSeev04000205 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev04000205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04000205 .class);
    }
