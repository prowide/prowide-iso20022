    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300105 parse(String xml) {
        return ((MxSeev03300105) MxReadImpl.parse(MxSeev03300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300105) MxReadImpl.parse(MxSeev03300105 .class, xml, _classes, new MxReadParams(conf)));
    }
