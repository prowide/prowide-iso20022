    ...
    extends AbstractMX
{
    ...
    public static MxSeev04400102 parse(String xml) {
        return ((MxSeev04400102) MxReadImpl.parse(MxSeev04400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400102) MxReadImpl.parse(MxSeev04400102 .class, xml, _classes, new MxReadParams(conf)));
    }
