    ...
    extends AbstractMX
{
    ...
    public static MxSeev04000111 parse(String xml) {
        return ((MxSeev04000111) MxReadImpl.parse(MxSeev04000111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04000111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04000111) MxReadImpl.parse(MxSeev04000111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04000111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04000111 .class);
    }
