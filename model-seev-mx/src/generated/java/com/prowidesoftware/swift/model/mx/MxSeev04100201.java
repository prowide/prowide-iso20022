    ...
    extends AbstractMX
{
    ...
    public static MxSeev04100201 parse(String xml) {
        return ((MxSeev04100201) MxReadImpl.parse(MxSeev04100201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100201) MxReadImpl.parse(MxSeev04100201 .class, xml, _classes, new MxReadParams(conf)));
    }
