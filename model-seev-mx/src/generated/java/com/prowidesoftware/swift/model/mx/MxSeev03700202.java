    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:seev.037.002.02";
    ...
    public static MxSeev03700202 parse(String xml) {
        return ((MxSeev03700202) MxReadImpl.parse(MxSeev03700202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700202) MxReadImpl.parse(MxSeev03700202 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03700202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03700202 .class);
    }
