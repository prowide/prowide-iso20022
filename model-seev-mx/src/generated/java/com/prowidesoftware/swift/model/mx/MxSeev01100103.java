    ...
    extends AbstractMX
{
    ...
    public static MxSeev01100103 parse(String xml) {
        return ((MxSeev01100103) MxReadImpl.parse(MxSeev01100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev01100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev01100103) MxReadImpl.parse(MxSeev01100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev01100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev01100103 .class);
    }
