...
/**
 * Class for seev.011.001.03 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:seev.011.001.03")
public class MxSeev01100103
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev01100103(final String xml) {
        this();
        MxSeev01100103 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev01100103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AgentCANotificationStatusAdviceV03 }
     *     
     */
    public AgentCANotificationStatusAdviceV03 getAgtCANtfctnStsAdvc() {
     ...
     * 
     */
    public static MxSeev01100103 parse(String xml) {
        return ((MxSeev01100103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev01100103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev01100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev01100103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev01100103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev01100103 parse(String xml, MxRead parserImpl) {
        return ((MxSeev01100103) parserImpl.read(MxSeev01100103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev01100103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev01100103 message
     * @return
