    ...
    extends AbstractMX
{
    ...
    public static MxSeev04000113 parse(String xml) {
        return ((MxSeev04000113) MxReadImpl.parse(MxSeev04000113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04000113 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04000113) MxReadImpl.parse(MxSeev04000113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04000113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04000113 .class);
    }
