    ...
    extends AbstractMX
{
    ...
    public static MxSeev04100108 parse(String xml) {
        return ((MxSeev04100108) MxReadImpl.parse(MxSeev04100108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100108) MxReadImpl.parse(MxSeev04100108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04100108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04100108 .class);
    }
