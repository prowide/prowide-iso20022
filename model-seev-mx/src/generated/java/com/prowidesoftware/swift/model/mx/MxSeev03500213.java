    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500213 parse(String xml) {
        return ((MxSeev03500213) MxReadImpl.parse(MxSeev03500213 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500213 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500213) MxReadImpl.parse(MxSeev03500213 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03500213 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500213 .class);
    }
