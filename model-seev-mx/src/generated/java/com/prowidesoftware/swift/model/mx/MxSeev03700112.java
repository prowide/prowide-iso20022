    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700112 parse(String xml) {
        return ((MxSeev03700112) MxReadImpl.parse(MxSeev03700112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700112) MxReadImpl.parse(MxSeev03700112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03700112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03700112 .class);
    }
