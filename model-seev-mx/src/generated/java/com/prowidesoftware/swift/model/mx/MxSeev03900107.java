    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900107 parse(String xml) {
        return ((MxSeev03900107) MxReadImpl.parse(MxSeev03900107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900107) MxReadImpl.parse(MxSeev03900107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03900107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900107 .class);
    }
