    ...
    extends AbstractMX
{
    ...
    public static MxSeev04000110 parse(String xml) {
        return ((MxSeev04000110) MxReadImpl.parse(MxSeev04000110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04000110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04000110) MxReadImpl.parse(MxSeev04000110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04000110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04000110 .class);
    }
