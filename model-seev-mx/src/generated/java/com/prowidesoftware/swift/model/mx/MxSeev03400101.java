    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400101 parse(String xml) {
        return ((MxSeev03400101) MxReadImpl.parse(MxSeev03400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400101) MxReadImpl.parse(MxSeev03400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400101 .class);
    }
