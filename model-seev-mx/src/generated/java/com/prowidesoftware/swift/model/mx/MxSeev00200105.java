    ...
    extends AbstractMX
{
    ...
    public static MxSeev00200105 parse(String xml) {
        return ((MxSeev00200105) MxReadImpl.parse(MxSeev00200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00200105) MxReadImpl.parse(MxSeev00200105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00200105 .class);
    }
