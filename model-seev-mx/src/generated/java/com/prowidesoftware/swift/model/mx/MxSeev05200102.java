    ...
    extends AbstractMX
{
    ...
    public static MxSeev05200102 parse(String xml) {
        return ((MxSeev05200102) MxReadImpl.parse(MxSeev05200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev05200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev05200102) MxReadImpl.parse(MxSeev05200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev05200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev05200102 .class);
    }
