    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.034.001.04";
    ...
    public static MxSeev03400104 parse(String xml) {
        return ((MxSeev03400104) MxReadImpl.parse(MxSeev03400104 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400104 .class);
    }
