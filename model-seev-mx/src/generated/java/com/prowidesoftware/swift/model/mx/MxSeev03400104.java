    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400104 parse(String xml) {
        return ((MxSeev03400104) MxReadImpl.parse(MxSeev03400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400104) MxReadImpl.parse(MxSeev03400104 .class, xml, _classes, new MxReadParams(conf)));
    }
