    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200211 parse(String xml) {
        return ((MxSeev04200211) MxReadImpl.parse(MxSeev04200211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200211) MxReadImpl.parse(MxSeev04200211 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04200211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04200211 .class);
    }
