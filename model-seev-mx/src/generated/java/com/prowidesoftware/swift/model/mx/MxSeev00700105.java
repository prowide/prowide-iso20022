    ...
    extends AbstractMX
{
    ...
    public static MxSeev00700105 parse(String xml) {
        return ((MxSeev00700105) MxReadImpl.parse(MxSeev00700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00700105) MxReadImpl.parse(MxSeev00700105 .class, xml, _classes, new MxReadParams(conf)));
    }
