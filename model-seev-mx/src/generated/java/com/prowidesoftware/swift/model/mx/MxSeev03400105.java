    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400105 parse(String xml) {
        return ((MxSeev03400105) MxReadImpl.parse(MxSeev03400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400105) MxReadImpl.parse(MxSeev03400105 .class, xml, _classes, new MxReadParams(conf)));
    }
