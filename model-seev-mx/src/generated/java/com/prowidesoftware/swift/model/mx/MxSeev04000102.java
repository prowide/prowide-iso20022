    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.040.001.02";
    ...
    public static MxSeev04000102 parse(String xml) {
        return ((MxSeev04000102) MxReadImpl.parse(MxSeev04000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04000102) MxReadImpl.parse(MxSeev04000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04000102 .class);
    }
