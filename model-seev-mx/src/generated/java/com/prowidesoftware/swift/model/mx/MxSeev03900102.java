    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900102 parse(String xml) {
        return ((MxSeev03900102) MxReadImpl.parse(MxSeev03900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900102) MxReadImpl.parse(MxSeev03900102 .class, xml, _classes, new MxReadParams(conf)));
    }
