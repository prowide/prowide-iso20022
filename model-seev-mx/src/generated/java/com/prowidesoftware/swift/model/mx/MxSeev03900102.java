    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.039.001.02";
    ...
    public static MxSeev03900102 parse(String xml) {
        return ((MxSeev03900102) MxReadImpl.parse(MxSeev03900102 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900102 .class);
    }
