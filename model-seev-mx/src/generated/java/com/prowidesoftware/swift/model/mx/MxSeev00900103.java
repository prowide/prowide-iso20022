    ...
    extends AbstractMX
{
    ...
    public static MxSeev00900103 parse(String xml) {
        return ((MxSeev00900103) MxReadImpl.parse(MxSeev00900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00900103) MxReadImpl.parse(MxSeev00900103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00900103 .class);
    }
