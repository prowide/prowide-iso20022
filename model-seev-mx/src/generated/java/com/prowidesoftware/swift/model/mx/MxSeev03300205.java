    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300205 parse(String xml) {
        return ((MxSeev03300205) MxReadImpl.parse(MxSeev03300205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300205) MxReadImpl.parse(MxSeev03300205 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03300205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300205 .class);
    }
