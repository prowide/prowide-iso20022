    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500214 parse(String xml) {
        return ((MxSeev03500214) MxReadImpl.parse(MxSeev03500214 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500214 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500214) MxReadImpl.parse(MxSeev03500214 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03500214 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500214 .class);
    }
