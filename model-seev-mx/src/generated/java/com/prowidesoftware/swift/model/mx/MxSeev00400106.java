    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.004.001.06";
    ...
    public static MxSeev00400106 parse(String xml) {
        return ((MxSeev00400106) MxReadImpl.parse(MxSeev00400106 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev00400106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00400106 .class);
    }
