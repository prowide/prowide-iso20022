    ...
    extends AbstractMX
{
    ...
    public static MxSeev00400106 parse(String xml) {
        return ((MxSeev00400106) MxReadImpl.parse(MxSeev00400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00400106) MxReadImpl.parse(MxSeev00400106 .class, xml, _classes, new MxReadParams(conf)));
    }
