    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500112 parse(String xml) {
        return ((MxSeev03500112) MxReadImpl.parse(MxSeev03500112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500112) MxReadImpl.parse(MxSeev03500112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03500112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500112 .class);
    }
