    ...
    extends AbstractMX
{
    ...
    public static MxSeev03200201 parse(String xml) {
        return ((MxSeev03200201) MxReadImpl.parse(MxSeev03200201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03200201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03200201) MxReadImpl.parse(MxSeev03200201 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03200201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03200201 .class);
    }
