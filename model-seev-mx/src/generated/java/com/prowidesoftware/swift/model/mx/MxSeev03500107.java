    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500107 parse(String xml) {
        return ((MxSeev03500107) MxReadImpl.parse(MxSeev03500107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500107) MxReadImpl.parse(MxSeev03500107 .class, xml, _classes, new MxReadParams(conf)));
    }
