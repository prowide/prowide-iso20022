    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.035.001.07";
    ...
    public static MxSeev03500107 parse(String xml) {
        return ((MxSeev03500107) MxReadImpl.parse(MxSeev03500107 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03500107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500107 .class);
    }
