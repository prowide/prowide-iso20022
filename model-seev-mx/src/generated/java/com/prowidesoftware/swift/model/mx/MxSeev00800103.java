    ...
    extends AbstractMX
{
    ...
    public static MxSeev00800103 parse(String xml) {
        return ((MxSeev00800103) MxReadImpl.parse(MxSeev00800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00800103) MxReadImpl.parse(MxSeev00800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00800103 .class);
    }
