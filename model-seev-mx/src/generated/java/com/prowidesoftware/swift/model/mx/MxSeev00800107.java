    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.008.001.07";
    ...
    public static MxSeev00800107 parse(String xml) {
        return ((MxSeev00800107) MxReadImpl.parse(MxSeev00800107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00800107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00800107) MxReadImpl.parse(MxSeev00800107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev00800107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00800107 .class);
    }
