    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300104 parse(String xml) {
        return ((MxSeev03300104) MxReadImpl.parse(MxSeev03300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300104) MxReadImpl.parse(MxSeev03300104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300104 .class);
    }
