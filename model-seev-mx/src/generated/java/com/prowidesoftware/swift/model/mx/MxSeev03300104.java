...
/**
 * Class for seev.033.001.04 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev03300104(final String xml) {
        this();
        MxSeev03300104 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev03300104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionInstructionV04 }
     *     
     */
    public CorporateActionInstructionV04 getCorpActnInstr() {
     ...
     *     
     */
    public MxSeev03300104 setCorpActnInstr(CorporateActionInstructionV04 value) {
     ...
     * 
     */
    public static MxSeev03300104 parse(String xml) {
        return ((MxSeev03300104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03300104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev03300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03300104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev03300104 parse(String xml, MxRead parserImpl) {
        return ((MxSeev03300104) parserImpl.read(MxSeev03300104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev03300104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev03300104 message
     * @return
     *     a new instance of MxSeev03300104
     */
    public final static MxSeev03300104 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev03300104 .class);
    }
