...
/**
 * Class for seev.037.002.16 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:seev.037.002.16")
public class MxSeev03700216
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev03700216(final String xml) {
        this();
        MxSeev03700216 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev03700216(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionMovementReversalAdvice002V16 }
     *     
     */
    public CorporateActionMovementReversalAdvice002V16 getCorpActnMvmntRvslAdvc() {
     ...
     * 
     */
    public static MxSeev03700216 parse(String xml) {
        return ((MxSeev03700216) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03700216 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev03700216 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700216) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03700216 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev03700216 parse(String xml, MxRead parserImpl) {
        return ((MxSeev03700216) parserImpl.read(MxSeev03700216 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev03700216 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev03700216 message
     * @return
