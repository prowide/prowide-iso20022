    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700216 parse(String xml) {
        return ((MxSeev03700216) MxReadImpl.parse(MxSeev03700216 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700216 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700216) MxReadImpl.parse(MxSeev03700216 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03700216 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03700216 .class);
    }
