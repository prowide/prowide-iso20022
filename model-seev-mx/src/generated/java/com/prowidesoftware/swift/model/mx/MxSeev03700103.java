    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700103 parse(String xml) {
        return ((MxSeev03700103) MxReadImpl.parse(MxSeev03700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700103) MxReadImpl.parse(MxSeev03700103 .class, xml, _classes, new MxReadParams(conf)));
    }
