    ...
    extends AbstractMX
{
    ...
    public static MxSeev06100101 parse(String xml) {
        return ((MxSeev06100101) MxReadImpl.parse(MxSeev06100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev06100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev06100101) MxReadImpl.parse(MxSeev06100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev06100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev06100101 .class);
    }
