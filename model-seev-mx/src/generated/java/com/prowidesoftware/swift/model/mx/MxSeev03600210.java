    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600210 parse(String xml) {
        return ((MxSeev03600210) MxReadImpl.parse(MxSeev03600210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600210) MxReadImpl.parse(MxSeev03600210 .class, xml, _classes, new MxReadParams(conf)));
    }
