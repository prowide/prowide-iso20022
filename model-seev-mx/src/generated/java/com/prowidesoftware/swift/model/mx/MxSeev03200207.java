    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.032.002.07";
    ...
    public static MxSeev03200207 parse(String xml) {
        return ((MxSeev03200207) MxReadImpl.parse(MxSeev03200207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03200207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03200207) MxReadImpl.parse(MxSeev03200207 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03200207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03200207 .class);
    }
