    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.029.001.01";
    ...
    public static MxSeev02900101 parse(String xml) {
        return ((MxSeev02900101) MxReadImpl.parse(MxSeev02900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev02900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev02900101) MxReadImpl.parse(MxSeev02900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev02900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev02900101 .class);
    }
