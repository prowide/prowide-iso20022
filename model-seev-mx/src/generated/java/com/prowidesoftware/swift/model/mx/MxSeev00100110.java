...
/**
 * Class for seev.001.001.10 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev00100110(final String xml) {
        this();
        MxSeev00100110 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev00100110(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link MeetingNotificationV10 }
     *     
     */
    public MeetingNotificationV10 getMtgNtfctn() {
        return mtgNtfctn;
    }
     ...
     *     
     */
    public MxSeev00100110 setMtgNtfctn(MeetingNotificationV10 value) {
     ...
     * 
     */
    public static MxSeev00100110 parse(String xml) {
        return ((MxSeev00100110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev00100110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev00100110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev00100110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev00100110 parse(String xml, MxRead parserImpl) {
        return ((MxSeev00100110) parserImpl.read(MxSeev00100110 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev00100110 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev00100110 message
     * @return
     *     a new instance of MxSeev00100110
     */
    public final static MxSeev00100110 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev00100110 .class);
    }
