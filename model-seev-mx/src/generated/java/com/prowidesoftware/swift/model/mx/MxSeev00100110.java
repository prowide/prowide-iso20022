    ...
    extends AbstractMX
{
    ...
    public static MxSeev00100110 parse(String xml) {
        return ((MxSeev00100110) MxReadImpl.parse(MxSeev00100110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00100110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100110) MxReadImpl.parse(MxSeev00100110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00100110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00100110 .class);
    }
