    ...
    extends AbstractMX
{
    ...
    public static MxSeev00100113 parse(String xml) {
        return ((MxSeev00100113) MxReadImpl.parse(MxSeev00100113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00100113 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100113) MxReadImpl.parse(MxSeev00100113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00100113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00100113 .class);
    }
