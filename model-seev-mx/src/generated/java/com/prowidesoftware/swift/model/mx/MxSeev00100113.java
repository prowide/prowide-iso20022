...
/**
 * Class for seev.001.001.13 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev00100113(final String xml) {
        this();
        MxSeev00100113 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev00100113(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link MeetingNotificationV13 }
     *     
     */
    public MeetingNotificationV13 getMtgNtfctn() {
        return mtgNtfctn;
    }
     ...
     *     
     */
    public MxSeev00100113 setMtgNtfctn(MeetingNotificationV13 value) {
     ...
     * 
     */
    public static MxSeev00100113 parse(String xml) {
        return ((MxSeev00100113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev00100113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev00100113 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00100113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev00100113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev00100113 parse(String xml, MxRead parserImpl) {
        return ((MxSeev00100113) parserImpl.read(MxSeev00100113 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev00100113 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev00100113 message
     * @return
     *     a new instance of MxSeev00100113
     */
    public static final MxSeev00100113 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev00100113 .class);
    }
