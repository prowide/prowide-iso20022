    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.006.001.10";
    ...
    public static MxSeev00600110 parse(String xml) {
        return ((MxSeev00600110) MxReadImpl.parse(MxSeev00600110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00600110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00600110) MxReadImpl.parse(MxSeev00600110 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev00600110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00600110 .class);
    }
