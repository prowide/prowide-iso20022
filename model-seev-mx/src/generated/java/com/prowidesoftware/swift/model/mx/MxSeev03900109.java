    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900109 parse(String xml) {
        return ((MxSeev03900109) MxReadImpl.parse(MxSeev03900109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900109) MxReadImpl.parse(MxSeev03900109 .class, xml, _classes, new MxReadParams(conf)));
    }
