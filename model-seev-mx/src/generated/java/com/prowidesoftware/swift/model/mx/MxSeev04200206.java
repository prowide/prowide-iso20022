    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200206 parse(String xml) {
        return ((MxSeev04200206) MxReadImpl.parse(MxSeev04200206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200206) MxReadImpl.parse(MxSeev04200206 .class, xml, _classes, new MxReadParams(conf)));
    }
