    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.042.002.06";
    ...
    public static MxSeev04200206 parse(String xml) {
        return ((MxSeev04200206) MxReadImpl.parse(MxSeev04200206 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev04200206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04200206 .class);
    }
