    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100104 parse(String xml) {
        return ((MxSeev03100104) MxReadImpl.parse(MxSeev03100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100104) MxReadImpl.parse(MxSeev03100104 .class, xml, _classes, new MxReadParams(conf)));
    }
