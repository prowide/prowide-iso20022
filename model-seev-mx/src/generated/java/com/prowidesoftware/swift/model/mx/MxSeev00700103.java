    ...
    extends AbstractMX
{
    ...
    public static MxSeev00700103 parse(String xml) {
        return ((MxSeev00700103) MxReadImpl.parse(MxSeev00700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00700103) MxReadImpl.parse(MxSeev00700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00700103 .class);
    }
