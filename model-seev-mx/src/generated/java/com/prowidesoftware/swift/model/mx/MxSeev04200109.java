    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200109 parse(String xml) {
        return ((MxSeev04200109) MxReadImpl.parse(MxSeev04200109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200109) MxReadImpl.parse(MxSeev04200109 .class, xml, _classes, new MxReadParams(conf)));
    }
