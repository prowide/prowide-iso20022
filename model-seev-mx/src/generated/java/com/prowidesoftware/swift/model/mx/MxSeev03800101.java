    ...
    extends AbstractMX
{
    ...
    public static MxSeev03800101 parse(String xml) {
        return ((MxSeev03800101) MxReadImpl.parse(MxSeev03800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03800101) MxReadImpl.parse(MxSeev03800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03800101 .class);
    }
