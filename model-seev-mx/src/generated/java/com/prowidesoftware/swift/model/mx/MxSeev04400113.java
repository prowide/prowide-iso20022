    ...
    extends AbstractMX
{
    ...
    public static MxSeev04400113 parse(String xml) {
        return ((MxSeev04400113) MxReadImpl.parse(MxSeev04400113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400113 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400113) MxReadImpl.parse(MxSeev04400113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04400113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04400113 .class);
    }
