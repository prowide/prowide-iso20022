    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200113 parse(String xml) {
        return ((MxSeev04200113) MxReadImpl.parse(MxSeev04200113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200113 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200113) MxReadImpl.parse(MxSeev04200113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04200113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04200113 .class);
    }
