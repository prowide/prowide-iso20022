    ...
    extends AbstractMX
{
    ...
    public static MxSeev02600101 parse(String xml) {
        return ((MxSeev02600101) MxReadImpl.parse(MxSeev02600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev02600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev02600101) MxReadImpl.parse(MxSeev02600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev02600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev02600101 .class);
    }
