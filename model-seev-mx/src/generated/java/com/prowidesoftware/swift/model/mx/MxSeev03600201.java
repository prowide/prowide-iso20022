    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600201 parse(String xml) {
        return ((MxSeev03600201) MxReadImpl.parse(MxSeev03600201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600201) MxReadImpl.parse(MxSeev03600201 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600201 .class);
    }
