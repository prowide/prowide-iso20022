    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900212 parse(String xml) {
        return ((MxSeev03900212) MxReadImpl.parse(MxSeev03900212 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900212 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900212) MxReadImpl.parse(MxSeev03900212 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03900212 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900212 .class);
    }
