    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500207 parse(String xml) {
        return ((MxSeev03500207) MxReadImpl.parse(MxSeev03500207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500207) MxReadImpl.parse(MxSeev03500207 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03500207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500207 .class);
    }
