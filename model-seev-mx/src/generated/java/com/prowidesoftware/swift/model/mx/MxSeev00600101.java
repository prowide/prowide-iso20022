    ...
    extends AbstractMX
{
    ...
    public static MxSeev00600101 parse(String xml) {
        return ((MxSeev00600101) MxReadImpl.parse(MxSeev00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00600101) MxReadImpl.parse(MxSeev00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
