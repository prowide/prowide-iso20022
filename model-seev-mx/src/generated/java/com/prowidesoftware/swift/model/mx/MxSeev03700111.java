    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700111 parse(String xml) {
        return ((MxSeev03700111) MxReadImpl.parse(MxSeev03700111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700111) MxReadImpl.parse(MxSeev03700111 .class, xml, _classes, new MxReadParams(conf)));
    }
