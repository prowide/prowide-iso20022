    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.037.001.11";
    ...
    public static MxSeev03700111 parse(String xml) {
        return ((MxSeev03700111) MxReadImpl.parse(MxSeev03700111 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03700111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03700111 .class);
    }
