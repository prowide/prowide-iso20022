    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300106 parse(String xml) {
        return ((MxSeev03300106) MxReadImpl.parse(MxSeev03300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300106) MxReadImpl.parse(MxSeev03300106 .class, xml, _classes, new MxReadParams(conf)));
    }
