    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.033.001.06";
    ...
    public static MxSeev03300106 parse(String xml) {
        return ((MxSeev03300106) MxReadImpl.parse(MxSeev03300106 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03300106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300106 .class);
    }
