    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100106 parse(String xml) {
        return ((MxSeev03100106) MxReadImpl.parse(MxSeev03100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100106) MxReadImpl.parse(MxSeev03100106 .class, xml, _classes, new MxReadParams(conf)));
    }
