    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.031.001.06";
    ...
    public static MxSeev03100106 parse(String xml) {
        return ((MxSeev03100106) MxReadImpl.parse(MxSeev03100106 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03100106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100106 .class);
    }
