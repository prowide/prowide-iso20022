    ...
    extends AbstractMX
{
    ...
    public static MxSeev00600105 parse(String xml) {
        return ((MxSeev00600105) MxReadImpl.parse(MxSeev00600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00600105) MxReadImpl.parse(MxSeev00600105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00600105 .class);
    }
