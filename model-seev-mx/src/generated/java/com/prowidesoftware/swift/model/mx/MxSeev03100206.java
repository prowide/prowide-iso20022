    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.031.002.06";
    ...
    public static MxSeev03100206 parse(String xml) {
        return ((MxSeev03100206) MxReadImpl.parse(MxSeev03100206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100206) MxReadImpl.parse(MxSeev03100206 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03100206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100206 .class);
    }
