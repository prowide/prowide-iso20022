    ...
    extends AbstractMX
{
    ...
    public static MxSeev05300102 parse(String xml) {
        return ((MxSeev05300102) MxReadImpl.parse(MxSeev05300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev05300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev05300102) MxReadImpl.parse(MxSeev05300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev05300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev05300102 .class);
    }
