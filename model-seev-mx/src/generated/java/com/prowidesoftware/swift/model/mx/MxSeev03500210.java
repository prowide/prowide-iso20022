    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.035.002.10";
    ...
    public static MxSeev03500210 parse(String xml) {
        return ((MxSeev03500210) MxReadImpl.parse(MxSeev03500210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500210) MxReadImpl.parse(MxSeev03500210 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03500210 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500210 .class);
    }
