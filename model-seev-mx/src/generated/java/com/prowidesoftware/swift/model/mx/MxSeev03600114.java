    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600114 parse(String xml) {
        return ((MxSeev03600114) MxReadImpl.parse(MxSeev03600114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600114 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600114) MxReadImpl.parse(MxSeev03600114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600114 .class);
    }
