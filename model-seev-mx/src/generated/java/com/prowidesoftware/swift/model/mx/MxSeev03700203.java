    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700203 parse(String xml) {
        return ((MxSeev03700203) MxReadImpl.parse(MxSeev03700203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700203) MxReadImpl.parse(MxSeev03700203 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03700203 fromJson(String json) {
