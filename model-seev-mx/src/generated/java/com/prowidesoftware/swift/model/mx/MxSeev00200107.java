    ...
    extends AbstractMX
{
    ...
    public static MxSeev00200107 parse(String xml) {
        return ((MxSeev00200107) MxReadImpl.parse(MxSeev00200107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00200107) MxReadImpl.parse(MxSeev00200107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00200107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00200107 .class);
    }
