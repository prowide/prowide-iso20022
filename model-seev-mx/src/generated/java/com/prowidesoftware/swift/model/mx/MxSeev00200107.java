...
/**
 * Class for seev.002.001.07 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:seev.002.001.07")
public class MxSeev00200107
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeev00200107(final String xml) {
        this();
        MxSeev00200107 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev00200107(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxSeev00200107 setMtgCxl(MeetingCancellationV07 value) {
        this.mtgCxl = value;
        return this;
    }
     ...
     * 
     */
    public static MxSeev00200107 parse(String xml) {
        return ((MxSeev00200107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev00200107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev00200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00200107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev00200107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev00200107 parse(String xml, MxRead parserImpl) {
        return ((MxSeev00200107) parserImpl.read(MxSeev00200107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev00200107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev00200107 message
     * @return
     *     a new instance of MxSeev00200107
     */
    public final static MxSeev00200107 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev00200107 .class);
    }
