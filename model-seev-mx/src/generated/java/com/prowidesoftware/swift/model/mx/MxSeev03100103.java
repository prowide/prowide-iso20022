    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.031.001.03";
    ...
    public static MxSeev03100103 parse(String xml) {
        return ((MxSeev03100103) MxReadImpl.parse(MxSeev03100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100103) MxReadImpl.parse(MxSeev03100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03100103 fromJson(String json) {
