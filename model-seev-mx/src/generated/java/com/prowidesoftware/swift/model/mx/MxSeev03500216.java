    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500216 parse(String xml) {
        return ((MxSeev03500216) MxReadImpl.parse(MxSeev03500216 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500216 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500216) MxReadImpl.parse(MxSeev03500216 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03500216 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500216 .class);
    }
