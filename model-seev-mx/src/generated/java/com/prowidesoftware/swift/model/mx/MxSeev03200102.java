    ...
    extends AbstractMX
{
    ...
    public static MxSeev03200102 parse(String xml) {
        return ((MxSeev03200102) MxReadImpl.parse(MxSeev03200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03200102) MxReadImpl.parse(MxSeev03200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03200102 .class);
    }
