...
/**
 * Class for seev.034.002.14 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:seev.034.002.14")
public class MxSeev03400214
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.034.002.14";
     ...
     * 
     */
    public MxSeev03400214(final String xml) {
        this();
        MxSeev03400214 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev03400214(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionInstructionStatusAdvice002V14 }
     *     
     */
     ...
     *     
     */
    public MxSeev03400214 setCorpActnInstrStsAdvc(CorporateActionInstructionStatusAdvice002V14 value) {
     ...
     * 
     */
    public static MxSeev03400214 parse(String xml) {
        return ((MxSeev03400214) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03400214 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev03400214 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400214) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03400214 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev03400214 parse(String xml, MxRead parserImpl) {
        return ((MxSeev03400214) parserImpl.read(MxSeev03400214 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev03400214 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev03400214 message
     * @return
     *     a new instance of MxSeev03400214
     */
    public final static MxSeev03400214 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev03400214 .class);
    }
