    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400214 parse(String xml) {
        return ((MxSeev03400214) MxReadImpl.parse(MxSeev03400214 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400214 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400214) MxReadImpl.parse(MxSeev03400214 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03400214 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400214 .class);
    }
