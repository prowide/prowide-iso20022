    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.007.001.09";
    ...
    public static MxSeev00700109 parse(String xml) {
        return ((MxSeev00700109) MxReadImpl.parse(MxSeev00700109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00700109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00700109) MxReadImpl.parse(MxSeev00700109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev00700109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00700109 .class);
    }
