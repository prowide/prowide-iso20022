    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.044.002.07";
    ...
    public static MxSeev04400207 parse(String xml) {
        return ((MxSeev04400207) MxReadImpl.parse(MxSeev04400207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400207) MxReadImpl.parse(MxSeev04400207 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04400207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04400207 .class);
    }
