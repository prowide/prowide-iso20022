    ...
    extends AbstractMX
{
    ...
    public static MxSeev02800101 parse(String xml) {
        return ((MxSeev02800101) MxReadImpl.parse(MxSeev02800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev02800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev02800101) MxReadImpl.parse(MxSeev02800101 .class, xml, _classes, new MxReadParams(conf)));
    }
