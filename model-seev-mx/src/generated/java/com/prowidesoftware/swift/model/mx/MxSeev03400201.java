    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400201 parse(String xml) {
        return ((MxSeev03400201) MxReadImpl.parse(MxSeev03400201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400201) MxReadImpl.parse(MxSeev03400201 .class, xml, _classes, new MxReadParams(conf)));
    }
