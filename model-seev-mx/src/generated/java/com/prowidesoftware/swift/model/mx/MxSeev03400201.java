    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:seev.034.002.01";
    ...
    public static MxSeev03400201 parse(String xml) {
        return ((MxSeev03400201) MxReadImpl.parse(MxSeev03400201 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03400201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400201 .class);
    }
