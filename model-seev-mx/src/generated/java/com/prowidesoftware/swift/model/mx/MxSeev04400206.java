    ...
    extends AbstractMX
{
    ...
    public static MxSeev04400206 parse(String xml) {
        return ((MxSeev04400206) MxReadImpl.parse(MxSeev04400206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400206) MxReadImpl.parse(MxSeev04400206 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04400206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04400206 .class);
    }
