    ...
    extends AbstractMX
{
    ...
    public static MxSeev03400114 parse(String xml) {
        return ((MxSeev03400114) MxReadImpl.parse(MxSeev03400114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03400114 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03400114) MxReadImpl.parse(MxSeev03400114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03400114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03400114 .class);
    }
