    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.038.002.07";
    ...
    public static MxSeev03800207 parse(String xml) {
        return ((MxSeev03800207) MxReadImpl.parse(MxSeev03800207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03800207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03800207) MxReadImpl.parse(MxSeev03800207 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03800207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03800207 .class);
    }
