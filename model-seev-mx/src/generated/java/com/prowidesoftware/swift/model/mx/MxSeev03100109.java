    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.031.001.09";
    ...
    public static MxSeev03100109 parse(String xml) {
        return ((MxSeev03100109) MxReadImpl.parse(MxSeev03100109 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03100109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100109 .class);
    }
