    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100109 parse(String xml) {
        return ((MxSeev03100109) MxReadImpl.parse(MxSeev03100109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100109) MxReadImpl.parse(MxSeev03100109 .class, xml, _classes, new MxReadParams(conf)));
    }
