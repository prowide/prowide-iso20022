    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100203 parse(String xml) {
        return ((MxSeev03100203) MxReadImpl.parse(MxSeev03100203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100203) MxReadImpl.parse(MxSeev03100203 .class, xml, _classes, new MxReadParams(conf)));
    }
