    ...
    extends AbstractMX
{
    ...
    public static MxSeev03300206 parse(String xml) {
        return ((MxSeev03300206) MxReadImpl.parse(MxSeev03300206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03300206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03300206) MxReadImpl.parse(MxSeev03300206 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03300206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03300206 .class);
    }
