    ...
    extends AbstractMX
{
    ...
    public static MxSeev00400107 parse(String xml) {
        return ((MxSeev00400107) MxReadImpl.parse(MxSeev00400107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00400107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00400107) MxReadImpl.parse(MxSeev00400107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00400107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00400107 .class);
    }
