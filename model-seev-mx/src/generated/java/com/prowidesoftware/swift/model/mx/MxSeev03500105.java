    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500105 parse(String xml) {
        return ((MxSeev03500105) MxReadImpl.parse(MxSeev03500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500105) MxReadImpl.parse(MxSeev03500105 .class, xml, _classes, new MxReadParams(conf)));
    }
