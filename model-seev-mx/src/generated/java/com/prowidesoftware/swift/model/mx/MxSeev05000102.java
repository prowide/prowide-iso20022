    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.050.001.02";
    ...
    public static MxSeev05000102 parse(String xml) {
        return ((MxSeev05000102) MxReadImpl.parse(MxSeev05000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev05000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev05000102) MxReadImpl.parse(MxSeev05000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev05000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev05000102 .class);
    }
