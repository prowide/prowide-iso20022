    ...
    extends AbstractMX
{
    ...
    public static MxSeev00700111 parse(String xml) {
        return ((MxSeev00700111) MxReadImpl.parse(MxSeev00700111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00700111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00700111) MxReadImpl.parse(MxSeev00700111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev00700111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00700111 .class);
    }
