    ...
    extends AbstractMX
{
    ...
    public static MxSeev03800202 parse(String xml) {
        return ((MxSeev03800202) MxReadImpl.parse(MxSeev03800202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03800202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03800202) MxReadImpl.parse(MxSeev03800202 .class, xml, _classes, new MxReadParams(conf)));
    }
