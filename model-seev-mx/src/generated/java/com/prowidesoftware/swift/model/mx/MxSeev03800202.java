    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:seev.038.002.02";
    ...
    public static MxSeev03800202 parse(String xml) {
        return ((MxSeev03800202) MxReadImpl.parse(MxSeev03800202 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03800202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03800202 .class);
    }
