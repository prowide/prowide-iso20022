    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.050.001.01";
    ...
    public static MxSeev05000101 parse(String xml) {
        return ((MxSeev05000101) MxReadImpl.parse(MxSeev05000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev05000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev05000101) MxReadImpl.parse(MxSeev05000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev05000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev05000101 .class);
    }
