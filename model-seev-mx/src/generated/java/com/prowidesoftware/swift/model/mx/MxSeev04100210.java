    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.041.002.10";
    ...
    public static MxSeev04100210 parse(String xml) {
        return ((MxSeev04100210) MxReadImpl.parse(MxSeev04100210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100210) MxReadImpl.parse(MxSeev04100210 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04100210 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04100210 .class);
    }
