    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.003.001.02";
    ...
    public static MxSeev00300102 parse(String xml) {
        return ((MxSeev00300102) MxReadImpl.parse(MxSeev00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev00300102) MxReadImpl.parse(MxSeev00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev00300102 .class);
    }
