    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700110 parse(String xml) {
        return ((MxSeev03700110) MxReadImpl.parse(MxSeev03700110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700110) MxReadImpl.parse(MxSeev03700110 .class, xml, _classes, new MxReadParams(conf)));
    }
