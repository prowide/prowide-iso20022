    ...
    extends AbstractMX
{
    ...
    public static MxSeev04400201 parse(String xml) {
        return ((MxSeev04400201) MxReadImpl.parse(MxSeev04400201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400201) MxReadImpl.parse(MxSeev04400201 .class, xml, _classes, new MxReadParams(conf)));
    }
