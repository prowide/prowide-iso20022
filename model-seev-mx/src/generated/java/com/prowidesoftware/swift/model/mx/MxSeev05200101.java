    ...
    extends AbstractMX
{
    ...
    public static MxSeev05200101 parse(String xml) {
        return ((MxSeev05200101) MxReadImpl.parse(MxSeev05200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev05200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev05200101) MxReadImpl.parse(MxSeev05200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev05200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev05200101 .class);
    }
