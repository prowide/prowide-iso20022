    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.036.001.02";
    ...
    public static MxSeev03600102 parse(String xml) {
        return ((MxSeev03600102) MxReadImpl.parse(MxSeev03600102 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600102 .class);
    }
