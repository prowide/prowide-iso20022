    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600102 parse(String xml) {
        return ((MxSeev03600102) MxReadImpl.parse(MxSeev03600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600102) MxReadImpl.parse(MxSeev03600102 .class, xml, _classes, new MxReadParams(conf)));
    }
