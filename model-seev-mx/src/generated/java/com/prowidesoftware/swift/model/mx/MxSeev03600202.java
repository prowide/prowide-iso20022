    ...
    extends AbstractMX
{
    ...
    public static MxSeev03600202 parse(String xml) {
        return ((MxSeev03600202) MxReadImpl.parse(MxSeev03600202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03600202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03600202) MxReadImpl.parse(MxSeev03600202 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03600202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03600202 .class);
    }
