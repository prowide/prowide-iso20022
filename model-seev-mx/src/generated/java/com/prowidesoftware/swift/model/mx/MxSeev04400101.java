    ...
    extends AbstractMX
{
    ...
    public static MxSeev04400101 parse(String xml) {
        return ((MxSeev04400101) MxReadImpl.parse(MxSeev04400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400101) MxReadImpl.parse(MxSeev04400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04400101 .class);
    }
