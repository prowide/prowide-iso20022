    ...
    extends AbstractMX
{
    ...
    public static MxSeev05100101 parse(String xml) {
        return ((MxSeev05100101) MxReadImpl.parse(MxSeev05100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev05100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev05100101) MxReadImpl.parse(MxSeev05100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev05100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev05100101 .class);
    }
