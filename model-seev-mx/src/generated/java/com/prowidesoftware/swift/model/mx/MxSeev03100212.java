    ...
    extends AbstractMX
{
    ...
    public static MxSeev03100212 parse(String xml) {
        return ((MxSeev03100212) MxReadImpl.parse(MxSeev03100212 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100212 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100212) MxReadImpl.parse(MxSeev03100212 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03100212 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100212 .class);
    }
