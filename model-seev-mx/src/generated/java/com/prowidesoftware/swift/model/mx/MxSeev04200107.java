    ...
    extends AbstractMX
{
    ...
    public static MxSeev04200107 parse(String xml) {
        return ((MxSeev04200107) MxReadImpl.parse(MxSeev04200107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200107) MxReadImpl.parse(MxSeev04200107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04200107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04200107 .class);
    }
