    ...
    extends AbstractMX
{
    ...
    public static MxSeev04500101 parse(String xml) {
        return ((MxSeev04500101) MxReadImpl.parse(MxSeev04500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04500101) MxReadImpl.parse(MxSeev04500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04500101 .class);
    }
