    ...
    extends AbstractMX
{
    ...
    public static MxSeev02100101 parse(String xml) {
        return ((MxSeev02100101) MxReadImpl.parse(MxSeev02100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev02100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev02100101) MxReadImpl.parse(MxSeev02100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev02100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev02100101 .class);
    }
