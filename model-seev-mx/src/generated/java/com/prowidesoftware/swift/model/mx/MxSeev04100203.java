    ...
    extends AbstractMX
{
    ...
    public static MxSeev04100203 parse(String xml) {
        return ((MxSeev04100203) MxReadImpl.parse(MxSeev04100203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04100203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04100203) MxReadImpl.parse(MxSeev04100203 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04100203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04100203 .class);
    }
