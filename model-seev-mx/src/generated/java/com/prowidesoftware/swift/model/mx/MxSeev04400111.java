    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.044.001.11";
    ...
    public static MxSeev04400111 parse(String xml) {
        return ((MxSeev04400111) MxReadImpl.parse(MxSeev04400111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400111) MxReadImpl.parse(MxSeev04400111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04400111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04400111 .class);
    }
