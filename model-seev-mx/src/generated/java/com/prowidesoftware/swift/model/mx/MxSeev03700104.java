    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.037.001.04";
    ...
    public static MxSeev03700104 parse(String xml) {
        return ((MxSeev03700104) MxReadImpl.parse(MxSeev03700104 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03700104 .class);
    }
