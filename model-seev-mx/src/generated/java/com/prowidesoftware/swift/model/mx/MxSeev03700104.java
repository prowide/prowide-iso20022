    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700104 parse(String xml) {
        return ((MxSeev03700104) MxReadImpl.parse(MxSeev03700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700104) MxReadImpl.parse(MxSeev03700104 .class, xml, _classes, new MxReadParams(conf)));
    }
