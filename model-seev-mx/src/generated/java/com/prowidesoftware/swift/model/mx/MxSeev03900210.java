    ...
    extends AbstractMX
{
    ...
    public static MxSeev03900210 parse(String xml) {
        return ((MxSeev03900210) MxReadImpl.parse(MxSeev03900210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03900210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03900210) MxReadImpl.parse(MxSeev03900210 .class, xml, _classes, new MxReadParams(conf)));
    }
