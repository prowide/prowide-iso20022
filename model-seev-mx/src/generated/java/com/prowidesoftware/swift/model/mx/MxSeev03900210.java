    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.039.002.10";
    ...
    public static MxSeev03900210 parse(String xml) {
        return ((MxSeev03900210) MxReadImpl.parse(MxSeev03900210 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev03900210 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03900210 .class);
    }
