    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500203 parse(String xml) {
        return ((MxSeev03500203) MxReadImpl.parse(MxSeev03500203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500203) MxReadImpl.parse(MxSeev03500203 .class, xml, _classes, new MxReadParams(conf)));
    }
