    ...
    extends AbstractMX
{
    ...
    public static MxSeev04400105 parse(String xml) {
        return ((MxSeev04400105) MxReadImpl.parse(MxSeev04400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04400105) MxReadImpl.parse(MxSeev04400105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04400105 .class);
    }
