    ...
    extends AbstractMX
{
    ...
    public static MxSeev01000101 parse(String xml) {
        return ((MxSeev01000101) MxReadImpl.parse(MxSeev01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev01000101) MxReadImpl.parse(MxSeev01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
