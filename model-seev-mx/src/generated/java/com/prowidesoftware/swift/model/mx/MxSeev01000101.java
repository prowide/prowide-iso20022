    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.010.001.01";
    ...
    public static MxSeev01000101 parse(String xml) {
        return ((MxSeev01000101) MxReadImpl.parse(MxSeev01000101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev01000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev01000101 .class);
    }
