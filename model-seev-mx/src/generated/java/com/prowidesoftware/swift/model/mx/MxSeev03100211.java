    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.031.002.11";
    ...
    public static MxSeev03100211 parse(String xml) {
        return ((MxSeev03100211) MxReadImpl.parse(MxSeev03100211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03100211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03100211) MxReadImpl.parse(MxSeev03100211 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev03100211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03100211 .class);
    }
