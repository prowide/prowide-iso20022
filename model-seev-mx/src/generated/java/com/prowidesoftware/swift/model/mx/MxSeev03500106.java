    ...
    extends AbstractMX
{
    ...
    public static MxSeev03500106 parse(String xml) {
        return ((MxSeev03500106) MxReadImpl.parse(MxSeev03500106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500106) MxReadImpl.parse(MxSeev03500106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03500106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03500106 .class);
    }
