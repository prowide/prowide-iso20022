...
/**
 * Class for seev.035.001.06 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.035.001.06";
     ...
     * 
     */
    public MxSeev03500106(final String xml) {
        this();
        MxSeev03500106 tmp = parse(xml);
     ...
     * 
     */
    public MxSeev03500106(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link CorporateActionMovementPreliminaryAdviceV06 }
     *     
     */
     ...
     *     
     */
    public MxSeev03500106 setCorpActnMvmntPrlimryAdvc(CorporateActionMovementPreliminaryAdviceV06 value) {
     ...
     * 
     */
    public static MxSeev03500106 parse(String xml) {
        return ((MxSeev03500106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03500106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeev03500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03500106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeev03500106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeev03500106 parse(String xml, MxRead parserImpl) {
        return ((MxSeev03500106) parserImpl.read(MxSeev03500106 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeev03500106 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeev03500106 message
     * @return
     *     a new instance of MxSeev03500106
     */
    public final static MxSeev03500106 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeev03500106 .class);
    }
