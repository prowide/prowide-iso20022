    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:seev.042.002.02";
    ...
    public static MxSeev04200202 parse(String xml) {
        return ((MxSeev04200202) MxReadImpl.parse(MxSeev04200202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04200202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04200202) MxReadImpl.parse(MxSeev04200202 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeev04200202 fromJson(String json) {
