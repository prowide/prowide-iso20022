    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700215 parse(String xml) {
        return ((MxSeev03700215) MxReadImpl.parse(MxSeev03700215 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700215 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700215) MxReadImpl.parse(MxSeev03700215 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03700215 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03700215 .class);
    }
