    ...
    extends AbstractMX
{
    ...
    public static MxSeev04000207 parse(String xml) {
        return ((MxSeev04000207) MxReadImpl.parse(MxSeev04000207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04000207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04000207) MxReadImpl.parse(MxSeev04000207 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04000207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04000207 .class);
    }
