    ...
    extends AbstractMX
{
    ...
    public static MxSeev03700212 parse(String xml) {
        return ((MxSeev03700212) MxReadImpl.parse(MxSeev03700212 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev03700212 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev03700212) MxReadImpl.parse(MxSeev03700212 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev03700212 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev03700212 .class);
    }
