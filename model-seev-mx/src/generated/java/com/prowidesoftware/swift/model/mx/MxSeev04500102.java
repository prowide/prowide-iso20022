    ...
    extends AbstractMX
{
    ...
    public static MxSeev04500102 parse(String xml) {
        return ((MxSeev04500102) MxReadImpl.parse(MxSeev04500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev04500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev04500102) MxReadImpl.parse(MxSeev04500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeev04500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev04500102 .class);
    }
