    ...
    extends AbstractMX
{
    ...
    public static MxSeev01900101 parse(String xml) {
        return ((MxSeev01900101) MxReadImpl.parse(MxSeev01900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeev01900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeev01900101) MxReadImpl.parse(MxSeev01900101 .class, xml, _classes, new MxReadParams(conf)));
    }
