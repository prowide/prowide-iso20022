    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seev.019.001.01";
    ...
    public static MxSeev01900101 parse(String xml) {
        return ((MxSeev01900101) MxReadImpl.parse(MxSeev01900101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeev01900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeev01900101 .class);
    }
