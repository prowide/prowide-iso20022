    ...
    extends AbstractMX
{
    ...
    public static MxSetr04900102 parse(String xml) {
        return ((MxSetr04900102) MxReadImpl.parse(MxSetr04900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr04900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04900102) MxReadImpl.parse(MxSetr04900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr04900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr04900102 .class);
    }
