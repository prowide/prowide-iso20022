    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:setr.002.001.02";
    ...
    public static MxSetr00200102 parse(String xml) {
        return ((MxSetr00200102) MxReadImpl.parse(MxSetr00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00200102) MxReadImpl.parse(MxSetr00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00200102 .class);
    }
