    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:setr.006.001.02";
    ...
    public static MxSetr00600102 parse(String xml) {
        return ((MxSetr00600102) MxReadImpl.parse(MxSetr00600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00600102) MxReadImpl.parse(MxSetr00600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr00600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00600102 .class);
    }
