    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:setr.050.001.01";
    ...
    public static MxSetr05000101 parse(String xml) {
        return ((MxSetr05000101) MxReadImpl.parse(MxSetr05000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr05000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr05000101) MxReadImpl.parse(MxSetr05000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr05000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr05000101 .class);
    }
