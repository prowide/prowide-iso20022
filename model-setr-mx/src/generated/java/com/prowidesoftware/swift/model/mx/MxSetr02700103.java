    ...
    extends AbstractMX
{
    ...
    public static MxSetr02700103 parse(String xml) {
        return ((MxSetr02700103) MxReadImpl.parse(MxSetr02700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr02700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr02700103) MxReadImpl.parse(MxSetr02700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr02700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr02700103 .class);
    }
