    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:setr.015.001.02";
    ...
    public static MxSetr01500102 parse(String xml) {
        return ((MxSetr01500102) MxReadImpl.parse(MxSetr01500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01500102) MxReadImpl.parse(MxSetr01500102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr01500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01500102 .class);
    }
