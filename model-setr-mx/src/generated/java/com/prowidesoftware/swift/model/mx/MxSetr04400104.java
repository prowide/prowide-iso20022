    ...
    extends AbstractMX
{
    ...
    public static MxSetr04400104 parse(String xml) {
        return ((MxSetr04400104) MxReadImpl.parse(MxSetr04400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr04400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04400104) MxReadImpl.parse(MxSetr04400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr04400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr04400104 .class);
    }
