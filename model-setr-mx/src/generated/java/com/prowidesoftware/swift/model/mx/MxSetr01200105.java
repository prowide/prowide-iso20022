    ...
    extends AbstractMX
{
    ...
    public static MxSetr01200105 parse(String xml) {
        return ((MxSetr01200105) MxReadImpl.parse(MxSetr01200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01200105) MxReadImpl.parse(MxSetr01200105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01200105 .class);
    }
