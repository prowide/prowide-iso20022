    ...
    extends AbstractMX
{
    ...
    public static MxSetr05100102 parse(String xml) {
        return ((MxSetr05100102) MxReadImpl.parse(MxSetr05100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr05100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr05100102) MxReadImpl.parse(MxSetr05100102 .class, xml, _classes, new MxReadParams(conf)));
    }
