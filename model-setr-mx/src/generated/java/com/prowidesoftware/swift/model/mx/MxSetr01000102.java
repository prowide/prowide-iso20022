    ...
    extends AbstractMX
{
    ...
    public static MxSetr01000102 parse(String xml) {
        return ((MxSetr01000102) MxReadImpl.parse(MxSetr01000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01000102) MxReadImpl.parse(MxSetr01000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01000102 .class);
    }
