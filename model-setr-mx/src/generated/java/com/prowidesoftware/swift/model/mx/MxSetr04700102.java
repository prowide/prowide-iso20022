    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.047.001.02";
    ...
    public static MxSetr04700102 parse(String xml) {
        return ((MxSetr04700102) MxReadImpl.parse(MxSetr04700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr04700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04700102) MxReadImpl.parse(MxSetr04700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr04700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr04700102 .class);
    }
