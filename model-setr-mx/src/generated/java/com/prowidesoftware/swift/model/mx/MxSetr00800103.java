    ...
    extends AbstractMX
{
    ...
    public static MxSetr00800103 parse(String xml) {
        return ((MxSetr00800103) MxReadImpl.parse(MxSetr00800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00800103) MxReadImpl.parse(MxSetr00800103 .class, xml, _classes, new MxReadParams(conf)));
    }
