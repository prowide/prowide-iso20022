    ...
    extends AbstractMX
{
    ...
    public static MxSetr01100102 parse(String xml) {
        return ((MxSetr01100102) MxReadImpl.parse(MxSetr01100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01100102) MxReadImpl.parse(MxSetr01100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01100102 .class);
    }
