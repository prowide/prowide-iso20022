    ...
    extends AbstractMX
{
    ...
    public static MxSetr05500101 parse(String xml) {
        return ((MxSetr05500101) MxReadImpl.parse(MxSetr05500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr05500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr05500101) MxReadImpl.parse(MxSetr05500101 .class, xml, _classes, new MxReadParams(conf)));
    }
