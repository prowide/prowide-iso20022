    ...
    extends AbstractMX
{
    ...
    public static MxSetr00900102 parse(String xml) {
        return ((MxSetr00900102) MxReadImpl.parse(MxSetr00900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00900102) MxReadImpl.parse(MxSetr00900102 .class, xml, _classes, new MxReadParams(conf)));
    }
