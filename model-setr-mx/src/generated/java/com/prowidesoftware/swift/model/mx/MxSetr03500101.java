    ...
    extends AbstractMX
{
    ...
    public static MxSetr03500101 parse(String xml) {
        return ((MxSetr03500101) MxReadImpl.parse(MxSetr03500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr03500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr03500101) MxReadImpl.parse(MxSetr03500101 .class, xml, _classes, new MxReadParams(conf)));
    }
