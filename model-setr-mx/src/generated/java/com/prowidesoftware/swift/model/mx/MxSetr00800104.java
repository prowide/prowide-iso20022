    ...
    extends AbstractMX
{
    ...
    public static MxSetr00800104 parse(String xml) {
        return ((MxSetr00800104) MxReadImpl.parse(MxSetr00800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00800104) MxReadImpl.parse(MxSetr00800104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr00800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00800104 .class);
    }
