    ...
    extends AbstractMX
{
    ...
    public static MxSetr01100103 parse(String xml) {
        return ((MxSetr01100103) MxReadImpl.parse(MxSetr01100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01100103) MxReadImpl.parse(MxSetr01100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01100103 .class);
    }
