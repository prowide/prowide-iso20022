    ...
    extends AbstractMX
{
    ...
    public static MxSetr00400104 parse(String xml) {
        return ((MxSetr00400104) MxReadImpl.parse(MxSetr00400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00400104) MxReadImpl.parse(MxSetr00400104 .class, xml, _classes, new MxReadParams(conf)));
    }
