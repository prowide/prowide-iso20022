    ...
    extends AbstractMX
{
    ...
    public static MxSetr00100105 parse(String xml) {
        return ((MxSetr00100105) MxReadImpl.parse(MxSetr00100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00100105) MxReadImpl.parse(MxSetr00100105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr00100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00100105 .class);
    }
