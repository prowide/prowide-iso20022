    ...
    extends AbstractMX
{
    ...
    public static MxSetr00700102 parse(String xml) {
        return ((MxSetr00700102) MxReadImpl.parse(MxSetr00700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00700102) MxReadImpl.parse(MxSetr00700102 .class, xml, _classes, new MxReadParams(conf)));
    }
