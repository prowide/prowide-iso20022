    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:setr.053.001.01";
    ...
    public static MxSetr05300101 parse(String xml) {
        return ((MxSetr05300101) MxReadImpl.parse(MxSetr05300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr05300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr05300101) MxReadImpl.parse(MxSetr05300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr05300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr05300101 .class);
    }
