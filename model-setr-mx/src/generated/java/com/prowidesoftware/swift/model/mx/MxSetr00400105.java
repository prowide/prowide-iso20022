...
/**
 * Class for setr.004.001.05 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSetr00400105(final String xml) {
        this();
        MxSetr00400105 tmp = parse(xml);
     ...
     * 
     */
    public MxSetr00400105(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link RedemptionOrderV05 }
     *     
     */
    public RedemptionOrderV05 getRedOrdr() {
        return redOrdr;
    }
     ...
     *     
     */
    public MxSetr00400105 setRedOrdr(RedemptionOrderV05 value) {
        this.redOrdr = value;
        return this;
    }
     ...
     * 
     */
    public static MxSetr00400105 parse(String xml) {
        return ((MxSetr00400105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSetr00400105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSetr00400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00400105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSetr00400105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSetr00400105 parse(String xml, MxRead parserImpl) {
        return ((MxSetr00400105) parserImpl.read(MxSetr00400105 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSetr00400105 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSetr00400105 message
     * @return
     *     a new instance of MxSetr00400105
     */
    public static final MxSetr00400105 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSetr00400105 .class);
    }
