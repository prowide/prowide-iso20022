    ...
    extends AbstractMX
{
    ...
    public static MxSetr00400105 parse(String xml) {
        return ((MxSetr00400105) MxReadImpl.parse(MxSetr00400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00400105) MxReadImpl.parse(MxSetr00400105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr00400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00400105 .class);
    }
