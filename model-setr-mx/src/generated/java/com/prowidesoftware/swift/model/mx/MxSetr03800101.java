    ...
    extends AbstractMX
{
    ...
    public static MxSetr03800101 parse(String xml) {
        return ((MxSetr03800101) MxReadImpl.parse(MxSetr03800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr03800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr03800101) MxReadImpl.parse(MxSetr03800101 .class, xml, _classes, new MxReadParams(conf)));
    }
