    ...
    extends AbstractMX
{
    ...
    public static MxSetr00300104 parse(String xml) {
        return ((MxSetr00300104) MxReadImpl.parse(MxSetr00300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00300104) MxReadImpl.parse(MxSetr00300104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr00300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00300104 .class);
    }
