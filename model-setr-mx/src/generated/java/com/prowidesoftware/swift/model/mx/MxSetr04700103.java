    ...
    extends AbstractMX
{
    ...
    public static MxSetr04700103 parse(String xml) {
        return ((MxSetr04700103) MxReadImpl.parse(MxSetr04700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr04700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04700103) MxReadImpl.parse(MxSetr04700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr04700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr04700103 .class);
    }
