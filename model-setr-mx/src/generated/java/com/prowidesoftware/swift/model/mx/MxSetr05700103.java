    ...
    extends AbstractMX
{
    ...
    public static MxSetr05700103 parse(String xml) {
        return ((MxSetr05700103) MxReadImpl.parse(MxSetr05700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr05700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr05700103) MxReadImpl.parse(MxSetr05700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr05700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr05700103 .class);
    }
