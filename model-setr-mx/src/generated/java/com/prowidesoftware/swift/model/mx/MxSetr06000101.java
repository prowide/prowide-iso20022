    ...
    extends AbstractMX
{
    ...
    public static MxSetr06000101 parse(String xml) {
        return ((MxSetr06000101) MxReadImpl.parse(MxSetr06000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr06000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr06000101) MxReadImpl.parse(MxSetr06000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr06000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr06000101 .class);
    }
