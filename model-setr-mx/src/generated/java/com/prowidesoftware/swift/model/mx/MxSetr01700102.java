    ...
    extends AbstractMX
{
    ...
    public static MxSetr01700102 parse(String xml) {
        return ((MxSetr01700102) MxReadImpl.parse(MxSetr01700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01700102) MxReadImpl.parse(MxSetr01700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01700102 .class);
    }
