    ...
    extends AbstractMX
{
    ...
    public static MxSetr02900101 parse(String xml) {
        return ((MxSetr02900101) MxReadImpl.parse(MxSetr02900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr02900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr02900101) MxReadImpl.parse(MxSetr02900101 .class, xml, _classes, new MxReadParams(conf)));
    }
