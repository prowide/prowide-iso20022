    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.029.001.01";
    ...
    public static MxSetr02900101 parse(String xml) {
        return ((MxSetr02900101) MxReadImpl.parse(MxSetr02900101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSetr02900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr02900101 .class);
    }
