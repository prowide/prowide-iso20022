    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:setr.005.001.03";
    ...
    public static MxSetr00500103 parse(String xml) {
        return ((MxSetr00500103) MxReadImpl.parse(MxSetr00500103 .class, xml, _classes));
    }
     ...
     */
    public final static MxSetr00500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00500103 .class);
    }
