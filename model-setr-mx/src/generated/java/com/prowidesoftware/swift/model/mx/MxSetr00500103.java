    ...
    extends AbstractMX
{
    ...
    public static MxSetr00500103 parse(String xml) {
        return ((MxSetr00500103) MxReadImpl.parse(MxSetr00500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00500103) MxReadImpl.parse(MxSetr00500103 .class, xml, _classes, new MxReadParams(conf)));
    }
