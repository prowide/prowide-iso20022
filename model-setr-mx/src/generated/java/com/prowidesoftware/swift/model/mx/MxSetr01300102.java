    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:setr.013.001.02";
    ...
    public static MxSetr01300102 parse(String xml) {
        return ((MxSetr01300102) MxReadImpl.parse(MxSetr01300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01300102) MxReadImpl.parse(MxSetr01300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr01300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01300102 .class);
    }
