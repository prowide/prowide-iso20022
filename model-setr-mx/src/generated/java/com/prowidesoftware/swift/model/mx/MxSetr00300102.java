    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:setr.003.001.02";
    ...
    public static MxSetr00300102 parse(String xml) {
        return ((MxSetr00300102) MxReadImpl.parse(MxSetr00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00300102) MxReadImpl.parse(MxSetr00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00300102 .class);
    }
