    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.022.001.01";
    ...
    public static MxSetr02200101 parse(String xml) {
        return ((MxSetr02200101) MxReadImpl.parse(MxSetr02200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr02200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr02200101) MxReadImpl.parse(MxSetr02200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr02200101 fromJson(String json) {
