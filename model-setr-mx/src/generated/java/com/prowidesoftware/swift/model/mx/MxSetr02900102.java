    ...
    extends AbstractMX
{
    ...
    public static MxSetr02900102 parse(String xml) {
        return ((MxSetr02900102) MxReadImpl.parse(MxSetr02900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr02900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr02900102) MxReadImpl.parse(MxSetr02900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr02900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr02900102 .class);
    }
