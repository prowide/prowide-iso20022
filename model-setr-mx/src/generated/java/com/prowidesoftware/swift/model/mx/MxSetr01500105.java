    ...
    extends AbstractMX
{
    ...
    public static MxSetr01500105 parse(String xml) {
        return ((MxSetr01500105) MxReadImpl.parse(MxSetr01500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01500105) MxReadImpl.parse(MxSetr01500105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01500105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01500105 .class);
    }
