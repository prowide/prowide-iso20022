    ...
    extends AbstractMX
{
    ...
    public static MxSetr01200106 parse(String xml) {
        return ((MxSetr01200106) MxReadImpl.parse(MxSetr01200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01200106) MxReadImpl.parse(MxSetr01200106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01200106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01200106 .class);
    }
