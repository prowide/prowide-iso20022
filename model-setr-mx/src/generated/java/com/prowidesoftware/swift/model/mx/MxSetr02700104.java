    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.027.001.04";
    ...
    public static MxSetr02700104 parse(String xml) {
        return ((MxSetr02700104) MxReadImpl.parse(MxSetr02700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr02700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr02700104) MxReadImpl.parse(MxSetr02700104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr02700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr02700104 .class);
    }
