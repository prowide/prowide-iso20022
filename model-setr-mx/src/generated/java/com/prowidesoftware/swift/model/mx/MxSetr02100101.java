    ...
    extends AbstractMX
{
    ...
    public static MxSetr02100101 parse(String xml) {
        return ((MxSetr02100101) MxReadImpl.parse(MxSetr02100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr02100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr02100101) MxReadImpl.parse(MxSetr02100101 .class, xml, _classes, new MxReadParams(conf)));
    }
