    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.030.001.03";
    ...
    public static MxSetr03000103 parse(String xml) {
        return ((MxSetr03000103) MxReadImpl.parse(MxSetr03000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr03000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr03000103) MxReadImpl.parse(MxSetr03000103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr03000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr03000103 .class);
    }
