    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.001.001.04";
    ...
    public static MxSetr00100104 parse(String xml) {
        return ((MxSetr00100104) MxReadImpl.parse(MxSetr00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00100104) MxReadImpl.parse(MxSetr00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr00100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00100104 .class);
    }
