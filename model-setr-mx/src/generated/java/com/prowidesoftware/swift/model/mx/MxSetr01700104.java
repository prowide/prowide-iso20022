    ...
    extends AbstractMX
{
    ...
    public static MxSetr01700104 parse(String xml) {
        return ((MxSetr01700104) MxReadImpl.parse(MxSetr01700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01700104) MxReadImpl.parse(MxSetr01700104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01700104 .class);
    }
