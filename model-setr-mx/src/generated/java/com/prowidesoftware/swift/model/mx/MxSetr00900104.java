    ...
    extends AbstractMX
{
    ...
    public static MxSetr00900104 parse(String xml) {
        return ((MxSetr00900104) MxReadImpl.parse(MxSetr00900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00900104) MxReadImpl.parse(MxSetr00900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr00900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00900104 .class);
    }
