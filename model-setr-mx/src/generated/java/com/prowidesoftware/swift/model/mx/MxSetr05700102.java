    ...
    extends AbstractMX
{
    ...
    public static MxSetr05700102 parse(String xml) {
        return ((MxSetr05700102) MxReadImpl.parse(MxSetr05700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr05700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr05700102) MxReadImpl.parse(MxSetr05700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr05700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr05700102 .class);
    }
