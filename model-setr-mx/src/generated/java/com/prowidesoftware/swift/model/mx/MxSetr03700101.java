    ...
    extends AbstractMX
{
    ...
    public static MxSetr03700101 parse(String xml) {
        return ((MxSetr03700101) MxReadImpl.parse(MxSetr03700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr03700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr03700101) MxReadImpl.parse(MxSetr03700101 .class, xml, _classes, new MxReadParams(conf)));
    }
