    ...
    extends AbstractMX
{
    ...
    public final static transient Class[] _classes = new Class[] {CopyDuplicate1Code.class, DateAndDateTimeChoice.class, DocumentIdentification11 .class, ListExecuteInstruction.class, ListExecution1 .class, MxSetr03700101 .class };
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.037.001.01";
    ...
    public static MxSetr03700101 parse(String xml) {
        return ((MxSetr03700101) MxReadImpl.parse(MxSetr03700101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSetr03700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr03700101 .class);
    }
