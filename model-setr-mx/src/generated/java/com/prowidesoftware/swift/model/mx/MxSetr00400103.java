    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:setr.004.001.03";
    ...
    public static MxSetr00400103 parse(String xml) {
        return ((MxSetr00400103) MxReadImpl.parse(MxSetr00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00400103) MxReadImpl.parse(MxSetr00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr00400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00400103 .class);
    }
