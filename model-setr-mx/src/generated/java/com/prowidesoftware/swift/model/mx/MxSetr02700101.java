    ...
    extends AbstractMX
{
    ...
    public static MxSetr02700101 parse(String xml) {
        return ((MxSetr02700101) MxReadImpl.parse(MxSetr02700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr02700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr02700101) MxReadImpl.parse(MxSetr02700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr02700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr02700101 .class);
    }
