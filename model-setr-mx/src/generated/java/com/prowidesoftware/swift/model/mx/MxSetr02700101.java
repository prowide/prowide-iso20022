...
/**
 * Class for setr.027.001.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSetr02700101(final String xml) {
        this();
        MxSetr02700101 tmp = parse(xml);
     ...
     * 
     */
    public MxSetr02700101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesTradeConfirmationV01 }
     *     
     */
    public SecuritiesTradeConfirmationV01 getSctiesTradConf() {
     ...
     *     
     */
    public MxSetr02700101 setSctiesTradConf(SecuritiesTradeConfirmationV01 value) {
     ...
     * 
     */
    public static MxSetr02700101 parse(String xml) {
        return ((MxSetr02700101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSetr02700101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSetr02700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr02700101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSetr02700101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSetr02700101 parse(String xml, MxRead parserImpl) {
        return ((MxSetr02700101) parserImpl.read(MxSetr02700101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSetr02700101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSetr02700101 message
     * @return
     *     a new instance of MxSetr02700101
     */
    public final static MxSetr02700101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSetr02700101 .class);
    }
