    ...
    extends AbstractMX
{
    ...
    public static MxSetr01400105 parse(String xml) {
        return ((MxSetr01400105) MxReadImpl.parse(MxSetr01400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01400105) MxReadImpl.parse(MxSetr01400105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01400105 .class);
    }
