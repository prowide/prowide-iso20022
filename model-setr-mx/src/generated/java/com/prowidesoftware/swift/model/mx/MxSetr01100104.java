    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.011.001.04";
    ...
    public static MxSetr01100104 parse(String xml) {
        return ((MxSetr01100104) MxReadImpl.parse(MxSetr01100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01100104) MxReadImpl.parse(MxSetr01100104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr01100104 fromJson(String json) {
