...
/**
 * Class for setr.007.001.05 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSetr00700105(final String xml) {
        this();
        MxSetr00700105 tmp = parse(xml);
     ...
     * 
     */
    public MxSetr00700105(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SubscriptionBulkOrderV05 }
     *     
     */
    public SubscriptionBulkOrderV05 getSbcptBlkOrdr() {
        return sbcptBlkOrdr;
    }
     ...
     *     
     */
    public MxSetr00700105 setSbcptBlkOrdr(SubscriptionBulkOrderV05 value) {
     ...
     * 
     */
    public static MxSetr00700105 parse(String xml) {
        return ((MxSetr00700105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSetr00700105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSetr00700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00700105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSetr00700105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSetr00700105 parse(String xml, MxRead parserImpl) {
        return ((MxSetr00700105) parserImpl.read(MxSetr00700105 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSetr00700105 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSetr00700105 message
     * @return
     *     a new instance of MxSetr00700105
     */
    public static final MxSetr00700105 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSetr00700105 .class);
    }
