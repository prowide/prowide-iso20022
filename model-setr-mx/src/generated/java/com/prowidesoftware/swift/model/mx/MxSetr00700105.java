    ...
    extends AbstractMX
{
    ...
    public static MxSetr00700105 parse(String xml) {
        return ((MxSetr00700105) MxReadImpl.parse(MxSetr00700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00700105) MxReadImpl.parse(MxSetr00700105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr00700105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00700105 .class);
    }
