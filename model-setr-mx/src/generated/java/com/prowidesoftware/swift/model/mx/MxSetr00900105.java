    ...
    extends AbstractMX
{
    ...
    public static MxSetr00900105 parse(String xml) {
        return ((MxSetr00900105) MxReadImpl.parse(MxSetr00900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00900105) MxReadImpl.parse(MxSetr00900105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr00900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00900105 .class);
    }
