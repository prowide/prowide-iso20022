    ...
    extends AbstractMX
{
    ...
    public static MxSetr01400104 parse(String xml) {
        return ((MxSetr01400104) MxReadImpl.parse(MxSetr01400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01400104) MxReadImpl.parse(MxSetr01400104 .class, xml, _classes, new MxReadParams(conf)));
    }
