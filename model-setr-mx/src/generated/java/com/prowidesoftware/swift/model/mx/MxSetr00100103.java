    ...
    extends AbstractMX
{
    ...
    public static MxSetr00100103 parse(String xml) {
        return ((MxSetr00100103) MxReadImpl.parse(MxSetr00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00100103) MxReadImpl.parse(MxSetr00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
