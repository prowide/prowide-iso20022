    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:setr.001.001.03";
    ...
    public static MxSetr00100103 parse(String xml) {
        return ((MxSetr00100103) MxReadImpl.parse(MxSetr00100103 .class, xml, _classes));
    }
     ...
     */
    public final static MxSetr00100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00100103 .class);
    }
