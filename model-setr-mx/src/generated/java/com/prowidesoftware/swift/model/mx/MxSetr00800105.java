    ...
    extends AbstractMX
{
    ...
    public static MxSetr00800105 parse(String xml) {
        return ((MxSetr00800105) MxReadImpl.parse(MxSetr00800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00800105) MxReadImpl.parse(MxSetr00800105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr00800105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00800105 .class);
    }
