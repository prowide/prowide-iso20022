    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.046.001.01";
    ...
    public static MxSetr04600101 parse(String xml) {
        return ((MxSetr04600101) MxReadImpl.parse(MxSetr04600101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSetr04600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr04600101 .class);
    }
