    ...
    extends AbstractMX
{
    ...
    public static MxSetr04600101 parse(String xml) {
        return ((MxSetr04600101) MxReadImpl.parse(MxSetr04600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr04600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04600101) MxReadImpl.parse(MxSetr04600101 .class, xml, _classes, new MxReadParams(conf)));
    }
