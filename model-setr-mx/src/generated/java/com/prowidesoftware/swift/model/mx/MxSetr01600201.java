    ...
    extends AbstractMX
{
    ...
    public static MxSetr01600201 parse(String xml) {
        return ((MxSetr01600201) MxReadImpl.parse(MxSetr01600201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01600201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01600201) MxReadImpl.parse(MxSetr01600201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr01600201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01600201 .class);
    }
