    ...
    extends AbstractMX
{
    ...
    public static MxSetr04000101 parse(String xml) {
        return ((MxSetr04000101) MxReadImpl.parse(MxSetr04000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr04000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04000101) MxReadImpl.parse(MxSetr04000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr04000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr04000101 .class);
    }
