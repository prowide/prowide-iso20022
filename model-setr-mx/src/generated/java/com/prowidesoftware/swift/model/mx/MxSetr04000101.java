...
/**
 * Class for setr.040.001.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSetr04000101(final String xml) {
        this();
        MxSetr04000101 tmp = parse(xml);
        crossOrdrModReq = tmp.getCrossOrdrModReq();
    }
     ...
     * 
     */
    public MxSetr04000101(final MxSwiftMessage mxSwiftMessage) {
        this(mxSwiftMessage.message());
    }

    /**
     * Gets the value of the crossOrdrModReq property.
     * 
     * @return
     *     possible object is
     *     {@link CrossOrderModificationRequest }
     *     
     */
    public CrossOrderModificationRequest getCrossOrdrModReq() {
        return crossOrdrModReq;
    }

    /**
     * Sets the value of the crossOrdrModReq property.
     * 
     * @param value
     *     allowed object is
     *     {@link CrossOrderModificationRequest }
     *     
     */
    public MxSetr04000101 setCrossOrdrModReq(CrossOrderModificationRequest value) {
        this.crossOrdrModReq = value;
        return this;
    }
     ...
     * 
     */
    public static MxSetr04000101 parse(String xml) {
        return ((MxSetr04000101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSetr04000101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSetr04000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04000101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSetr04000101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSetr04000101 parse(String xml, MxRead parserImpl) {
        return ((MxSetr04000101) parserImpl.read(MxSetr04000101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSetr04000101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSetr04000101 message
     * @return
     *     a new instance of MxSetr04000101
     */
    public final static MxSetr04000101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSetr04000101 .class);
    }
