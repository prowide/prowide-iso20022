    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:setr.051.001.01";
    ...
    public static MxSetr05100101 parse(String xml) {
        return ((MxSetr05100101) MxReadImpl.parse(MxSetr05100101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSetr05100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr05100101 .class);
    }
