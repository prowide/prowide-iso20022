    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.013.001.04";
    ...
    public static MxSetr01300104 parse(String xml) {
        return ((MxSetr01300104) MxReadImpl.parse(MxSetr01300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01300104) MxReadImpl.parse(MxSetr01300104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr01300104 fromJson(String json) {
