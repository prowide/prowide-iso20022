    ...
    extends AbstractMX
{
    ...
    public static MxSetr01000104 parse(String xml) {
        return ((MxSetr01000104) MxReadImpl.parse(MxSetr01000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01000104) MxReadImpl.parse(MxSetr01000104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01000104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01000104 .class);
    }
