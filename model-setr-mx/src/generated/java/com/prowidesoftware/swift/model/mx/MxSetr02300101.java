    ...
    extends AbstractMX
{
    ...
    public static MxSetr02300101 parse(String xml) {
        return ((MxSetr02300101) MxReadImpl.parse(MxSetr02300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr02300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr02300101) MxReadImpl.parse(MxSetr02300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr02300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr02300101 .class);
    }
