    ...
    extends AbstractMX
{
    ...
    public static MxSetr04400102 parse(String xml) {
        return ((MxSetr04400102) MxReadImpl.parse(MxSetr04400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr04400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04400102) MxReadImpl.parse(MxSetr04400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr04400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr04400102 .class);
    }
