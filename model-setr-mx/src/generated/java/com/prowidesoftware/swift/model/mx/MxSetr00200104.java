    ...
    extends AbstractMX
{
    ...
    public static MxSetr00200104 parse(String xml) {
        return ((MxSetr00200104) MxReadImpl.parse(MxSetr00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00200104) MxReadImpl.parse(MxSetr00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
