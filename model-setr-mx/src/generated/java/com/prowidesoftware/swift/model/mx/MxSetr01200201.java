    ...
    extends AbstractMX
{
    ...
    public static MxSetr01200201 parse(String xml) {
        return ((MxSetr01200201) MxReadImpl.parse(MxSetr01200201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01200201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01200201) MxReadImpl.parse(MxSetr01200201 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01200201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01200201 .class);
    }
