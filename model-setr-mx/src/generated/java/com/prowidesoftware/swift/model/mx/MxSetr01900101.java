    ...
    extends AbstractMX
{
    ...
    public static MxSetr01900101 parse(String xml) {
        return ((MxSetr01900101) MxReadImpl.parse(MxSetr01900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01900101) MxReadImpl.parse(MxSetr01900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01900101 .class);
    }
