    ...
    extends AbstractMX
{
    ...
    public static MxSetr00800102 parse(String xml) {
        return ((MxSetr00800102) MxReadImpl.parse(MxSetr00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00800102) MxReadImpl.parse(MxSetr00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
