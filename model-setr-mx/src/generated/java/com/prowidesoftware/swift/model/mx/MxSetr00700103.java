    ...
    extends AbstractMX
{
    ...
    public static MxSetr00700103 parse(String xml) {
        return ((MxSetr00700103) MxReadImpl.parse(MxSetr00700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00700103) MxReadImpl.parse(MxSetr00700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr00700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00700103 .class);
    }
