    ...
    extends AbstractMX
{
    ...
    public static MxSetr06400101 parse(String xml) {
        return ((MxSetr06400101) MxReadImpl.parse(MxSetr06400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr06400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr06400101) MxReadImpl.parse(MxSetr06400101 .class, xml, _classes, new MxReadParams(conf)));
    }
