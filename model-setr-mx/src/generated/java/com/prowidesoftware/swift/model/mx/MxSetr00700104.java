    ...
    extends AbstractMX
{
    ...
    public static MxSetr00700104 parse(String xml) {
        return ((MxSetr00700104) MxReadImpl.parse(MxSetr00700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00700104) MxReadImpl.parse(MxSetr00700104 .class, xml, _classes, new MxReadParams(conf)));
    }
