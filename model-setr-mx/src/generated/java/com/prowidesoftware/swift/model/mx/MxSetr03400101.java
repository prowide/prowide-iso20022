    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.034.001.01";
    ...
    public static MxSetr03400101 parse(String xml) {
        return ((MxSetr03400101) MxReadImpl.parse(MxSetr03400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr03400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr03400101) MxReadImpl.parse(MxSetr03400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr03400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr03400101 .class);
    }
