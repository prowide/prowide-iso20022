    ...
    extends AbstractMX
{
    ...
    public static MxSetr01400102 parse(String xml) {
        return ((MxSetr01400102) MxReadImpl.parse(MxSetr01400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01400102) MxReadImpl.parse(MxSetr01400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01400102 .class);
    }
