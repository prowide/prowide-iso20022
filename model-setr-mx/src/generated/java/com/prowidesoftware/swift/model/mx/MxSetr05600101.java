    ...
    extends AbstractMX
{
    ...
    public static MxSetr05600101 parse(String xml) {
        return ((MxSetr05600101) MxReadImpl.parse(MxSetr05600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr05600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr05600101) MxReadImpl.parse(MxSetr05600101 .class, xml, _classes, new MxReadParams(conf)));
    }
