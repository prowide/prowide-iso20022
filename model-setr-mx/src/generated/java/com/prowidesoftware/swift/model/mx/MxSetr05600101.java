    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:setr.056.001.01";
    ...
    public static MxSetr05600101 parse(String xml) {
        return ((MxSetr05600101) MxReadImpl.parse(MxSetr05600101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSetr05600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr05600101 .class);
    }
