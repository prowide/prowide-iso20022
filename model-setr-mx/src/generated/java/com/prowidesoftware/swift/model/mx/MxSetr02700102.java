    ...
    extends AbstractMX
{
    ...
    public static MxSetr02700102 parse(String xml) {
        return ((MxSetr02700102) MxReadImpl.parse(MxSetr02700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr02700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr02700102) MxReadImpl.parse(MxSetr02700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr02700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr02700102 .class);
    }
