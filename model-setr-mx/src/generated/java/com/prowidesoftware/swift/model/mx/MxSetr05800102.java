    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.058.001.02";
    ...
    public static MxSetr05800102 parse(String xml) {
        return ((MxSetr05800102) MxReadImpl.parse(MxSetr05800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr05800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr05800102) MxReadImpl.parse(MxSetr05800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr05800102 fromJson(String json) {
