    ...
    extends AbstractMX
{
    ...
    public static MxSetr05700101 parse(String xml) {
        return ((MxSetr05700101) MxReadImpl.parse(MxSetr05700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr05700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr05700101) MxReadImpl.parse(MxSetr05700101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr05700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr05700101 .class);
    }
