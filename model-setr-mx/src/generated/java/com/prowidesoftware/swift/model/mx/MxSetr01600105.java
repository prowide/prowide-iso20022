    ...
    extends AbstractMX
{
    ...
    public static MxSetr01600105 parse(String xml) {
        return ((MxSetr01600105) MxReadImpl.parse(MxSetr01600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01600105) MxReadImpl.parse(MxSetr01600105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01600105 .class);
    }
