    ...
    extends AbstractMX
{
    ...
    public static MxSetr00600105 parse(String xml) {
        return ((MxSetr00600105) MxReadImpl.parse(MxSetr00600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00600105) MxReadImpl.parse(MxSetr00600105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr00600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00600105 .class);
    }
