    ...
    extends AbstractMX
{
    ...
    public static MxSetr00600104 parse(String xml) {
        return ((MxSetr00600104) MxReadImpl.parse(MxSetr00600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00600104) MxReadImpl.parse(MxSetr00600104 .class, xml, _classes, new MxReadParams(conf)));
    }
