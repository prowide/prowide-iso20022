    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:setr.012.001.02";
    ...
    public static MxSetr01200102 parse(String xml) {
        return ((MxSetr01200102) MxReadImpl.parse(MxSetr01200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01200102) MxReadImpl.parse(MxSetr01200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr01200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01200102 .class);
    }
