    ...
    extends AbstractMX
{
    ...
    public static MxSetr01200103 parse(String xml) {
        return ((MxSetr01200103) MxReadImpl.parse(MxSetr01200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01200103) MxReadImpl.parse(MxSetr01200103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr01200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01200103 .class);
    }
