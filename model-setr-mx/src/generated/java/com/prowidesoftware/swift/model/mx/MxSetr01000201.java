    ...
    extends AbstractMX
{
    ...
    public static MxSetr01000201 parse(String xml) {
        return ((MxSetr01000201) MxReadImpl.parse(MxSetr01000201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01000201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01000201) MxReadImpl.parse(MxSetr01000201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr01000201 fromJson(String json) {
