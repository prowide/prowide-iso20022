    ...
    extends AbstractMX
{
    ...
    public static MxSetr04400103 parse(String xml) {
        return ((MxSetr04400103) MxReadImpl.parse(MxSetr04400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr04400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04400103) MxReadImpl.parse(MxSetr04400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr04400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr04400103 .class);
    }
