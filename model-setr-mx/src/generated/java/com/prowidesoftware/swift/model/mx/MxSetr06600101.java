    ...
    extends AbstractMX
{
    ...
    public static MxSetr06600101 parse(String xml) {
        return ((MxSetr06600101) MxReadImpl.parse(MxSetr06600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr06600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr06600101) MxReadImpl.parse(MxSetr06600101 .class, xml, _classes, new MxReadParams(conf)));
    }
