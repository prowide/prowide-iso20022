    ...
    extends AbstractMX
{
    ...
    public static MxSetr00500102 parse(String xml) {
        return ((MxSetr00500102) MxReadImpl.parse(MxSetr00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00500102) MxReadImpl.parse(MxSetr00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
