    ...
    extends AbstractMX
{
    ...
    public static MxSetr03900101 parse(String xml) {
        return ((MxSetr03900101) MxReadImpl.parse(MxSetr03900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr03900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr03900101) MxReadImpl.parse(MxSetr03900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr03900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr03900101 .class);
    }
