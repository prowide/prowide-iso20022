    ...
    extends AbstractMX
{
    ...
    public static MxSetr06100101 parse(String xml) {
        return ((MxSetr06100101) MxReadImpl.parse(MxSetr06100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr06100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr06100101) MxReadImpl.parse(MxSetr06100101 .class, xml, _classes, new MxReadParams(conf)));
    }
