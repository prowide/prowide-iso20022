    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.061.001.01";
    ...
    public static MxSetr06100101 parse(String xml) {
        return ((MxSetr06100101) MxReadImpl.parse(MxSetr06100101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSetr06100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr06100101 .class);
    }
