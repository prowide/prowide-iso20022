    ...
    extends AbstractMX
{
    ...
    public static MxSetr02000101 parse(String xml) {
        return ((MxSetr02000101) MxReadImpl.parse(MxSetr02000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr02000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr02000101) MxReadImpl.parse(MxSetr02000101 .class, xml, _classes, new MxReadParams(conf)));
    }
