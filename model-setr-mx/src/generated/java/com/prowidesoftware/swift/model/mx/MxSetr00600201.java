    ...
    extends AbstractMX
{
    ...
    public static MxSetr00600201 parse(String xml) {
        return ((MxSetr00600201) MxReadImpl.parse(MxSetr00600201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr00600201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr00600201) MxReadImpl.parse(MxSetr00600201 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr00600201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr00600201 .class);
    }
