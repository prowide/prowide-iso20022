    ...
    extends AbstractMX
{
    ...
    public static MxSetr01200104 parse(String xml) {
        return ((MxSetr01200104) MxReadImpl.parse(MxSetr01200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01200104) MxReadImpl.parse(MxSetr01200104 .class, xml, _classes, new MxReadParams(conf)));
    }
