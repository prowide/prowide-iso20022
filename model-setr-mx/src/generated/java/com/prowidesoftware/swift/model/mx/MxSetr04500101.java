    ...
    extends AbstractMX
{
    ...
    public static MxSetr04500101 parse(String xml) {
        return ((MxSetr04500101) MxReadImpl.parse(MxSetr04500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr04500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04500101) MxReadImpl.parse(MxSetr04500101 .class, xml, _classes, new MxReadParams(conf)));
    }
