    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSetr04900101(final String xml) {
        this();
        MxSetr04900101 tmp = parse(xml);
        sbcptBlkOrdrConfCxlInstrV01 = tmp.getSbcptBlkOrdrConfCxlInstrV01();
    }
     ...
     * 
     */
    public MxSetr04900101(final MxSwiftMessage mxSwiftMessage) {
        this(mxSwiftMessage.message());
    }

    /**
     * Gets the value of the sbcptBlkOrdrConfCxlInstrV01 property.
     * 
     * @return
     *     possible object is
     *     {@link SubscriptionBulkOrderConfirmationCancellationInstructionV01 }
     *     
     */
    public SubscriptionBulkOrderConfirmationCancellationInstructionV01 getSbcptBlkOrdrConfCxlInstrV01() {
        return sbcptBlkOrdrConfCxlInstrV01;
    }

    /**
     * Sets the value of the sbcptBlkOrdrConfCxlInstrV01 property.
     * 
     * @param value
     *     allowed object is
     *     {@link SubscriptionBulkOrderConfirmationCancellationInstructionV01 }
     *     
     */
    public MxSetr04900101 setSbcptBlkOrdrConfCxlInstrV01(SubscriptionBulkOrderConfirmationCancellationInstructionV01 value) {
        this.sbcptBlkOrdrConfCxlInstrV01 = value;
        return this;
    }
     ...
     * 
     */
    public static MxSetr04900101 parse(String xml) {
        return ((MxSetr04900101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSetr04900101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSetr04900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04900101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSetr04900101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSetr04900101 parse(String xml, MxRead parserImpl) {
        return ((MxSetr04900101) parserImpl.read(MxSetr04900101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSetr04900101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSetr04900101 message
     * @return
     *     a new instance of MxSetr04900101
     */
    public final static MxSetr04900101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSetr04900101 .class);
    }
