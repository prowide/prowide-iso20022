    ...
    extends AbstractMX
{
    ...
    public static MxSetr04900101 parse(String xml) {
        return ((MxSetr04900101) MxReadImpl.parse(MxSetr04900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr04900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04900101) MxReadImpl.parse(MxSetr04900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr04900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr04900101 .class);
    }
