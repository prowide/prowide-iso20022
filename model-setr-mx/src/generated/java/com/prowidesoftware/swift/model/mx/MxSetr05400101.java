    ...
    extends AbstractMX
{
    ...
    public static MxSetr05400101 parse(String xml) {
        return ((MxSetr05400101) MxReadImpl.parse(MxSetr05400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr05400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr05400101) MxReadImpl.parse(MxSetr05400101 .class, xml, _classes, new MxReadParams(conf)));
    }
