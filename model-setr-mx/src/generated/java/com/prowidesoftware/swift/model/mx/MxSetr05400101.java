    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:setr.054.001.01";
    ...
    public static MxSetr05400101 parse(String xml) {
        return ((MxSetr05400101) MxReadImpl.parse(MxSetr05400101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSetr05400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr05400101 .class);
    }
