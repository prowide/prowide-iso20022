    ...
    extends AbstractMX
{
    ...
    public static MxSetr05800101 parse(String xml) {
        return ((MxSetr05800101) MxReadImpl.parse(MxSetr05800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr05800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr05800101) MxReadImpl.parse(MxSetr05800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr05800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr05800101 .class);
    }
