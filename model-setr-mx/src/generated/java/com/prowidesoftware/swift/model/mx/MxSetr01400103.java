    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:setr.014.001.03";
    ...
    public static MxSetr01400103 parse(String xml) {
        return ((MxSetr01400103) MxReadImpl.parse(MxSetr01400103 .class, xml, _classes));
    }
     ...
     */
    public final static MxSetr01400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01400103 .class);
    }
