    ...
    extends AbstractMX
{
    ...
    public static MxSetr01400103 parse(String xml) {
        return ((MxSetr01400103) MxReadImpl.parse(MxSetr01400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01400103) MxReadImpl.parse(MxSetr01400103 .class, xml, _classes, new MxReadParams(conf)));
    }
