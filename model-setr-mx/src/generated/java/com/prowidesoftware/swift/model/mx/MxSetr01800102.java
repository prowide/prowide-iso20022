    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:setr.018.001.02";
    ...
    public static MxSetr01800102 parse(String xml) {
        return ((MxSetr01800102) MxReadImpl.parse(MxSetr01800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01800102) MxReadImpl.parse(MxSetr01800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr01800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01800102 .class);
    }
