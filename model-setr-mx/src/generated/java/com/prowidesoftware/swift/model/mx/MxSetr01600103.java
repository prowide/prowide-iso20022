    ...
    extends AbstractMX
{
    ...
    public static MxSetr01600103 parse(String xml) {
        return ((MxSetr01600103) MxReadImpl.parse(MxSetr01600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01600103) MxReadImpl.parse(MxSetr01600103 .class, xml, _classes, new MxReadParams(conf)));
    }
