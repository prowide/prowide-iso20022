    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.015.001.04";
    ...
    public static MxSetr01500104 parse(String xml) {
        return ((MxSetr01500104) MxReadImpl.parse(MxSetr01500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01500104) MxReadImpl.parse(MxSetr01500104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr01500104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr01500104 .class);
    }
