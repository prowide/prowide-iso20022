    ...
    extends AbstractMX
{
    ...
    public static MxSetr01000103 parse(String xml) {
        return ((MxSetr01000103) MxReadImpl.parse(MxSetr01000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01000103) MxReadImpl.parse(MxSetr01000103 .class, xml, _classes, new MxReadParams(conf)));
    }
