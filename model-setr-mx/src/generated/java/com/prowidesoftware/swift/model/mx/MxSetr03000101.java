    ...
    extends AbstractMX
{
    ...
    public static MxSetr03000101 parse(String xml) {
        return ((MxSetr03000101) MxReadImpl.parse(MxSetr03000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr03000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr03000101) MxReadImpl.parse(MxSetr03000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr03000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr03000101 .class);
    }
