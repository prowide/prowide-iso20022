    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.059.001.01";
    ...
    public static MxSetr05900101 parse(String xml) {
        return ((MxSetr05900101) MxReadImpl.parse(MxSetr05900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr05900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr05900101) MxReadImpl.parse(MxSetr05900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr05900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr05900101 .class);
    }
