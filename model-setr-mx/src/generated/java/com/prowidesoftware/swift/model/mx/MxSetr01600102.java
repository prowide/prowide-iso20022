    ...
    extends AbstractMX
{
    ...
    public static MxSetr01600102 parse(String xml) {
        return ((MxSetr01600102) MxReadImpl.parse(MxSetr01600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01600102) MxReadImpl.parse(MxSetr01600102 .class, xml, _classes, new MxReadParams(conf)));
    }
