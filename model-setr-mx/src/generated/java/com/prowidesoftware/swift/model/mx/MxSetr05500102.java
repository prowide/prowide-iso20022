    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:setr.055.001.02";
    ...
    public static MxSetr05500102 parse(String xml) {
        return ((MxSetr05500102) MxReadImpl.parse(MxSetr05500102 .class, xml, _classes, new MxReadParams()));
    }
     ...
     * 
     */
    public static MxSetr05500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr05500102) MxReadImpl.parse(MxSetr05500102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr05500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr05500102 .class);
    }
