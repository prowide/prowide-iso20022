    ...
    extends AbstractMX
{
    ...
    public static MxSetr01700103 parse(String xml) {
        return ((MxSetr01700103) MxReadImpl.parse(MxSetr01700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr01700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr01700103) MxReadImpl.parse(MxSetr01700103 .class, xml, _classes, new MxReadParams(conf)));
    }
