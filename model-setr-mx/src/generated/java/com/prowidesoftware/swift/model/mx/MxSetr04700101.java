    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:setr.047.001.01";
    ...
    public static MxSetr04700101 parse(String xml) {
        return ((MxSetr04700101) MxReadImpl.parse(MxSetr04700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr04700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04700101) MxReadImpl.parse(MxSetr04700101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSetr04700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr04700101 .class);
    }
