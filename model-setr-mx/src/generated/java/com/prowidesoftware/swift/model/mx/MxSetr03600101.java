    ...
    extends AbstractMX
{
    ...
    public static MxSetr03600101 parse(String xml) {
        return ((MxSetr03600101) MxReadImpl.parse(MxSetr03600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr03600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr03600101) MxReadImpl.parse(MxSetr03600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr03600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr03600101 .class);
    }
