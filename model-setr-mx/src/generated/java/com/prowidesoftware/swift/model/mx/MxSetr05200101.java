    ...
    extends AbstractMX
{
    ...
    public static MxSetr05200101 parse(String xml) {
        return ((MxSetr05200101) MxReadImpl.parse(MxSetr05200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr05200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr05200101) MxReadImpl.parse(MxSetr05200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr05200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr05200101 .class);
    }
