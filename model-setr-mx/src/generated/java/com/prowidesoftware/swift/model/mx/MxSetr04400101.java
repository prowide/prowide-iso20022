    ...
    extends AbstractMX
{
    ...
    public static MxSetr04400101 parse(String xml) {
        return ((MxSetr04400101) MxReadImpl.parse(MxSetr04400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSetr04400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04400101) MxReadImpl.parse(MxSetr04400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSetr04400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSetr04400101 .class);
    }
