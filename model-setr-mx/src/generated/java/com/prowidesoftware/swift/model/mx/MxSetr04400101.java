...
/**
 * Class for setr.044.001.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSetr04400101(final String xml) {
        this();
        MxSetr04400101 tmp = parse(xml);
     ...
     * 
     */
    public MxSetr04400101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesTradeConfirmationStatusAdviceV01 }
     *     
     */
    public SecuritiesTradeConfirmationStatusAdviceV01 getSctiesTradConfStsAdvc() {
     ...
     * 
     */
    public static MxSetr04400101 parse(String xml) {
        return ((MxSetr04400101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSetr04400101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSetr04400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSetr04400101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSetr04400101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSetr04400101 parse(String xml, MxRead parserImpl) {
        return ((MxSetr04400101) parserImpl.read(MxSetr04400101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSetr04400101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSetr04400101 message
     * @return
