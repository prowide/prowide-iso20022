...
@XmlType(name = "ManagementPlanContent14", propOrder = {
    "tmChllng",
    "keyNcphrmntCert",
    "actn"
})
public class ManagementPlanContent14 {
     ...
     *     byte[]
     */
    public ManagementPlanContent14 setTMChllng(byte[] value) {
        this.tmChllng = value;
        return this;
    }
     ...
     * 
     */
    public ManagementPlanContent14 addKeyNcphrmntCert(byte[] keyNcphrmntCert) {
     ...
     * 
     */
    public ManagementPlanContent14 addActn(TMSAction14 actn) {
        getActn().add(actn);
        return this;
    }
