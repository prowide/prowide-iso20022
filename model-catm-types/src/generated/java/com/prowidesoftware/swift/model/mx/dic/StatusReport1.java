...
@XmlType(name = "StatusReport1", propOrder = {
    "poiId",
    "termnlMgrId",
    "dataSet"
})
public class StatusReport1 {
     ...
     *     
     */
    public StatusReport1 setPOIId(GenericIdentification35 value) {
        this.poiId = value;
        return this;
    }
     ...
     *     
     */
    public StatusReport1 setTermnlMgrId(GenericIdentification35 value) {
     ...
     * {@link TerminalManagementDataSet1 }
     * 
     * 
     */
    public List<TerminalManagementDataSet1> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<TerminalManagementDataSet1>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public StatusReport1 addDataSet(TerminalManagementDataSet1 dataSet) {
