...
@XmlType(name = "AcceptorConfiguration14", propOrder = {
    "termnlMgrId",
    "poiGrpId",
    "dataSet"
})
public class AcceptorConfiguration14 {
    ...
    protected List<AcceptorConfigurationDataSet6> dataSet;
     ...
     *     
     */
    public AcceptorConfiguration14 setTermnlMgrId(GenericIdentification176 value) {
     ...
     * 
     */
    public List<AcceptorConfigurationDataSet6> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<AcceptorConfigurationDataSet6>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public AcceptorConfiguration14 addPOIGrpId(String pOIGrpId) {
     ...
     * 
     */
    public AcceptorConfiguration14 addDataSet(AcceptorConfigurationDataSet6 dataSet) {
