...
@XmlType(name = "AcquirerHostConfiguration1", propOrder = {
    "hstId",
    "msgToSnd"
})
public class AcquirerHostConfiguration1 {
     ...
     *     
     */
    public AcquirerHostConfiguration1 setHstId(String value) {
        this.hstId = value;
        return this;
    }
     ...
     * 
     */
    public AcquirerHostConfiguration1 addMsgToSnd(MessageFunction3Code msgToSnd) {
