...
@XmlType(name = "ServiceProviderParameters5", propOrder = {
    "actnTp",
    "svcPrvdrId",
    "vrsn",
    "applId",
...
public class ServiceProviderParameters5 {
     ...
     *     
     */
    public ServiceProviderParameters5 setActnTp(TerminalManagementAction3Code value) {
        this.actnTp = value;
        return this;
    }
     ...
     *     
     */
    public ServiceProviderParameters5 setVrsn(String value) {
        this.vrsn = value;
        return this;
    }
     ...
     * 
     */
    public ServiceProviderParameters5 addSvcPrvdrId(GenericIdentification176 svcPrvdrId) {
     ...
     * 
     */
    public ServiceProviderParameters5 addApplId(String applId) {
     ...
     * 
     */
    public ServiceProviderParameters5 addHst(AcquirerHostConfiguration11 hst) {
        getHst().add(hst);
        return this;
    }
     ...
     * 
     */
    public ServiceProviderParameters5 addNonFinActnSpprtd(NonFinancialRequestType2Code nonFinActnSpprtd) {
