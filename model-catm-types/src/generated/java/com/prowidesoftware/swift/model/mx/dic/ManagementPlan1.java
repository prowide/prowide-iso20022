...
@XmlType(name = "ManagementPlan1", propOrder = {
    "poiId",
    "termnlMgrId",
    "dataSet"
})
public class ManagementPlan1 {
    ...
    protected List<TerminalManagementDataSet2> dataSet;
     ...
     *     
     */
    public ManagementPlan1 setPOIId(GenericIdentification35 value) {
        this.poiId = value;
        return this;
    }
     ...
     *     
     */
    public ManagementPlan1 setTermnlMgrId(GenericIdentification35 value) {
     ...
     * {@link TerminalManagementDataSet2 }
     * 
     * 
     */
    public List<TerminalManagementDataSet2> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<TerminalManagementDataSet2>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public ManagementPlan1 addDataSet(TerminalManagementDataSet2 dataSet) {
