...
@XmlType(name = "AcquirerHostConfiguration5", propOrder = {
    "hstId",
    "msgToSnd"
})
public class AcquirerHostConfiguration5 {
     ...
     *     
     */
    public AcquirerHostConfiguration5 setHstId(String value) {
        this.hstId = value;
        return this;
    }
     ...
     * 
     */
    public AcquirerHostConfiguration5 addMsgToSnd(MessageFunction15Code msgToSnd) {
