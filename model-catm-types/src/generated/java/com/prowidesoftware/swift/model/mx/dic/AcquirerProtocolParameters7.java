...
@XmlType(name = "AcquirerProtocolParameters7", propOrder = {
    "acqrrId",
    "vrsn",
    "applId",
    "hst",
...
public class AcquirerProtocolParameters7 {
     ...
     *     
     */
    public AcquirerProtocolParameters7 setVrsn(String value) {
        this.vrsn = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters7 setOnLineTx(AcquirerProtocolParameters8 value) {
        this.onLineTx = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters7 setOffLineTx(AcquirerProtocolParameters8 value) {
     ...
     *     
     */
    public AcquirerProtocolParameters7 setRcncltnXchg(ExchangeConfiguration6 value) {
     ...
     *     
     */
    public AcquirerProtocolParameters7 setRcncltnByAcqrr(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters7 setTtlsPerCcy(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters7 setSpltTtls(Boolean value) {
        this.spltTtls = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters7 setCardDataVrfctn(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters7 setNtfyOffLineCxl(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters7 setFileTrfBtch(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters7 setBtchDgtlSgntr(Boolean value) {
     ...
     * 
     */
    public AcquirerProtocolParameters7 setPrtctCardData(boolean value) {
     ...
     * 
     */
    public AcquirerProtocolParameters7 addAcqrrId(GenericIdentification53 acqrrId) {
     ...
     * 
     */
    public AcquirerProtocolParameters7 addApplId(String applId) {
     ...
     * 
     */
    public AcquirerProtocolParameters7 addHst(AcquirerHostConfiguration3 hst) {
        getHst().add(hst);
        return this;
    }
     ...
     * 
     */
    public AcquirerProtocolParameters7 addBtchTrfCntt(BatchTransactionType1Code btchTrfCntt) {
     ...
     * 
     */
    public AcquirerProtocolParameters7 addMsgItm(MessageItemCondition1 msgItm) {
