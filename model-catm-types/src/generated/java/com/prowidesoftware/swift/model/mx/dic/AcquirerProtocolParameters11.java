...
@XmlType(name = "AcquirerProtocolParameters11", propOrder = {
    "actnTp",
    "acqrrId",
    "vrsn",
    "applId",
...
public class AcquirerProtocolParameters11 {
    ...
    @XmlElement(name = "Hst")
    protected List<AcquirerHostConfiguration5> hst;
     ...
     *     
     */
    public AcquirerProtocolParameters11 setActnTp(TerminalManagementAction3Code value) {
        this.actnTp = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters11 setVrsn(String value) {
        this.vrsn = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AcquirerHostConfiguration5 }
     * 
     * 
     */
    public List<AcquirerHostConfiguration5> getHst() {
        if (hst == null) {
            hst = new ArrayList<AcquirerHostConfiguration5>();
        }
        return this.hst;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters11 setOnLineTx(AcquirerProtocolParameters8 value) {
        this.onLineTx = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters11 setOffLineTx(AcquirerProtocolParameters8 value) {
     ...
     *     
     */
    public AcquirerProtocolParameters11 setRcncltnXchg(ExchangeConfiguration6 value) {
     ...
     *     
     */
    public AcquirerProtocolParameters11 setRcncltnByAcqrr(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters11 setTtlsPerCcy(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters11 setSpltTtls(Boolean value) {
        this.spltTtls = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters11 setRcncltnErr(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters11 setCardDataVrfctn(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters11 setNtfyOffLineCxl(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters11 setFileTrfBtch(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters11 setBtchDgtlSgntr(Boolean value) {
     ...
     * 
     */
    public AcquirerProtocolParameters11 setPrtctCardData(boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters11 setPrvtCardData(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters11 setMndtrySctyTrlr(Boolean value) {
     ...
     * 
     */
    public AcquirerProtocolParameters11 addAcqrrId(GenericIdentification53 acqrrId) {
     ...
     * 
     */
    public AcquirerProtocolParameters11 addApplId(String applId) {
     ...
     * 
     */
    public AcquirerProtocolParameters11 addHst(AcquirerHostConfiguration5 hst) {
        getHst().add(hst);
        return this;
    }
     ...
     * 
     */
    public AcquirerProtocolParameters11 addBtchTrfCntt(BatchTransactionType1Code btchTrfCntt) {
     ...
     * 
     */
    public AcquirerProtocolParameters11 addMsgItm(MessageItemCondition1 msgItm) {
