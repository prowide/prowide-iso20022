...
@XmlType(name = "AcquirerProtocolParameters14", propOrder = {
    "actnTp",
    "acqrrId",
    "vrsn",
    "applId",
...
public class AcquirerProtocolParameters14 {
     ...
     *     
     */
    public AcquirerProtocolParameters14 setActnTp(TerminalManagementAction3Code value) {
        this.actnTp = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters14 setVrsn(String value) {
        this.vrsn = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters14 setOnLineTx(AcquirerProtocolExchangeBehavior2 value) {
        this.onLineTx = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters14 setOffLineTx(AcquirerProtocolExchangeBehavior2 value) {
     ...
     *     
     */
    public AcquirerProtocolParameters14 setRcncltnXchg(ExchangeConfiguration9 value) {
     ...
     *     
     */
    public AcquirerProtocolParameters14 setRcncltnByAcqrr(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters14 setTtlsPerCcy(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters14 setSpltTtls(Boolean value) {
        this.spltTtls = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters14 setCmpltnAdvcMndtd(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters14 setRcncltnErr(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters14 setCardDataVrfctn(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters14 setNtfyOffLineCxl(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters14 setFileTrfBtch(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters14 setBtchDgtlSgntr(Boolean value) {
     ...
     * 
     */
    public AcquirerProtocolParameters14 setPrtctCardData(boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters14 setPrvtCardData(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters14 setMndtrySctyTrlr(Boolean value) {
     ...
     * 
     */
    public AcquirerProtocolParameters14 addAcqrrId(GenericIdentification176 acqrrId) {
     ...
     * 
     */
    public AcquirerProtocolParameters14 addApplId(String applId) {
     ...
     * 
     */
    public AcquirerProtocolParameters14 addHst(AcquirerHostConfiguration8 hst) {
        getHst().add(hst);
        return this;
    }
     ...
     * 
     */
    public AcquirerProtocolParameters14 addSpltTtlCrit(ReconciliationCriteria1Code spltTtlCrit) {
     ...
     * 
     */
    public AcquirerProtocolParameters14 addAmtQlfrForRsvatn(TypeOfAmount8Code amtQlfrForRsvatn) {
     ...
     * 
     */
    public AcquirerProtocolParameters14 addBtchTrfCntt(BatchTransactionType1Code btchTrfCntt) {
     ...
     * 
     */
    public AcquirerProtocolParameters14 addMsgItm(MessageItemCondition1 msgItm) {
