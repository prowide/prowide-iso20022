...
public class MaintenanceDelegateAction8 {
     ...
     *     
     */
    public MaintenanceDelegateAction8 setPrdcActn(Boolean value) {
        this.prdcActn = value;
        return this;
    }
     ...
     *     
     */
    public MaintenanceDelegateAction8 setTMRmotAccs(NetworkParameters7 value) {
     ...
     *     
     */
    public MaintenanceDelegateAction8 setTMSPrtcol(String value) {
     ...
     *     
     */
    public MaintenanceDelegateAction8 setTMSPrtcolVrsn(String value) {
     ...
     *     
     */
    public MaintenanceDelegateAction8 setDataSetId(DataSetIdentification10 value) {
     ...
     *     
     */
    public MaintenanceDelegateAction8 setReTry(ProcessRetry3 value) {
        this.reTry = value;
        return this;
    }
    ...
    public List<TMSAction11> getActn() {
        if (actn == null) {
            actn = new ArrayList<TMSAction11>();
        }
        return this.actn;
    }
     ...
     * 
     */
    public MaintenanceDelegateAction8 addAddtlInf(byte[] addtlInf) {
     ...
     * 
     */
    public MaintenanceDelegateAction8 addActn(TMSAction11 actn) {
        getActn().add(actn);
        return this;
    }
