...
public class ServiceProviderParameters3 {
     ...
     *     
     */
    public ServiceProviderParameters3 setActnTp(TerminalManagementAction3Code value) {
        this.actnTp = value;
        return this;
    }
     ...
     *     
     */
    public ServiceProviderParameters3 setVrsn(String value) {
        this.vrsn = value;
        return this;
    }
     ...
     * 
     */
    public ServiceProviderParameters3 addSvcPrvdrId(GenericIdentification176 svcPrvdrId) {
     ...
     * 
     */
    public ServiceProviderParameters3 addApplId(String applId) {
     ...
     * 
     */
    public ServiceProviderParameters3 addHst(AcquirerHostConfiguration9 hst) {
        getHst().add(hst);
        return this;
    }
     ...
     * 
     */
    public ServiceProviderParameters3 addNonFinActnSpprtd(NonFinancialRequestType2Code nonFinActnSpprtd) {
