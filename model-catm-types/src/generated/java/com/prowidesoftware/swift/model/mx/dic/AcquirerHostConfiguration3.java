...
@XmlType(name = "AcquirerHostConfiguration3", propOrder = {
    "hstId",
    "msgToSnd"
})
public class AcquirerHostConfiguration3 {
    ...
    protected List<MessageFunction5Code> msgToSnd;
     ...
     *     
     */
    public AcquirerHostConfiguration3 setHstId(String value) {
        this.hstId = value;
        return this;
    }
     ...
     * {@link MessageFunction5Code }
     * 
     * 
     */
    public List<MessageFunction5Code> getMsgToSnd() {
        if (msgToSnd == null) {
            msgToSnd = new ArrayList<MessageFunction5Code>();
        }
     ...
     * 
     */
    public AcquirerHostConfiguration3 addMsgToSnd(MessageFunction5Code msgToSnd) {
