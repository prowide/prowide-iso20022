...
@XmlType(name = "DeviceInputResponse3", propOrder = {
    "outptRslt",
    "inptRslt"
})
public class DeviceInputResponse3 {

    @XmlElement(name = "OutptRslt")
    protected OutputResult2 outptRslt;
    @XmlElement(name = "InptRslt", required = true)
    protected InputResult3 inptRslt;
     ...
     *     
     */
    public DeviceInputResponse3 setOutptRslt(OutputResult2 value) {
     ...
     *     
     */
    public InputResult3 getInptRslt() {
        return inptRslt;
    }
     ...
     *     
     */
    public DeviceInputResponse3 setInptRslt(InputResult3 value) {
        this.inptRslt = value;
        return this;
    }
