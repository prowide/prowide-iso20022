...
@XmlType(name = "AcquirerHostConfiguration10", propOrder = {
    "hstId",
    "msgToSnd",
    "prtcolVrsn",
    "xtrnlyTpSpprtd"
})
public class AcquirerHostConfiguration10 {

    @XmlElement(name = "HstId", required = true)
    protected String hstId;
    @XmlElement(name = "MsgToSnd")
    @XmlSchemaType(name = "string")
    protected List<MessageFunction47Code> msgToSnd;
     ...
     *     
     */
    public AcquirerHostConfiguration10 setHstId(String value) {
        this.hstId = value;
        return this;
    }
     ...
     * {@link MessageFunction47Code }
     * 
     * 
     */
    public List<MessageFunction47Code> getMsgToSnd() {
        if (msgToSnd == null) {
            msgToSnd = new ArrayList<MessageFunction47Code>();
        }
     ...
     *     
     */
    public AcquirerHostConfiguration10 setPrtcolVrsn(String value) {
     ...
     * 
     */
    public AcquirerHostConfiguration10 addMsgToSnd(MessageFunction47Code msgToSnd) {
     ...
     * 
     */
    public AcquirerHostConfiguration10 addXtrnlyTpSpprtd(String xtrnlyTpSpprtd) {
