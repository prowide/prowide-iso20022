...
@XmlType(name = "MaintenanceDelegationRequestV12", propOrder = {
    "hdr",
    "mntncDlgtnReq",
    "sctyTrlr"
})
public class MaintenanceDelegationRequestV12 {

    @XmlElement(name = "Hdr")
    protected TMSHeader1 hdr;
    @XmlElement(name = "MntncDlgtnReq", required = true)
    protected MaintenanceDelegationRequest12 mntncDlgtnReq;
     ...
     *     
     */
    public MaintenanceDelegationRequestV12 setHdr(TMSHeader1 value) {
        this.hdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link MaintenanceDelegationRequest12 }
     *     
     */
    public MaintenanceDelegationRequest12 getMntncDlgtnReq() {
     ...
     *     
     */
    public MaintenanceDelegationRequestV12 setMntncDlgtnReq(MaintenanceDelegationRequest12 value) {
     ...
     *     
     */
    public MaintenanceDelegationRequestV12 setSctyTrlr(ContentInformationType38 value) {
        this.sctyTrlr = value;
        return this;
    }
