...
@XmlType(name = "MaintenanceDelegateAction10", propOrder = {
    "prdcActn",
    "tmRmotAccs",
    "tmsPrtcol",
    "tmsPrtcolVrsn",
...
public class MaintenanceDelegateAction10 {
    ...
    protected List<TMSAction13> actn;
     ...
     *     
     */
    public MaintenanceDelegateAction10 setPrdcActn(Boolean value) {
        this.prdcActn = value;
        return this;
    }
     ...
     *     
     */
    public MaintenanceDelegateAction10 setTMRmotAccs(NetworkParameters7 value) {
     ...
     *     
     */
    public MaintenanceDelegateAction10 setTMSPrtcol(String value) {
     ...
     *     
     */
    public MaintenanceDelegateAction10 setTMSPrtcolVrsn(String value) {
     ...
     *     
     */
    public MaintenanceDelegateAction10 setDataSetId(DataSetIdentification11 value) {
     ...
     *     
     */
    public MaintenanceDelegateAction10 setReTry(ProcessRetry3 value) {
        this.reTry = value;
        return this;
    }
     ...
     * 
     */
    public List<TMSAction13> getActn() {
        if (actn == null) {
            actn = new ArrayList<TMSAction13>();
        }
        return this.actn;
    }
     ...
     * 
     */
    public MaintenanceDelegateAction10 addAddtlInf(byte[] addtlInf) {
     ...
     * 
     */
    public MaintenanceDelegateAction10 addActn(TMSAction13 actn) {
        getActn().add(actn);
        return this;
    }
