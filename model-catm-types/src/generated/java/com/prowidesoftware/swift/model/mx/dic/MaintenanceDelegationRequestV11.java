...
@XmlType(name = "MaintenanceDelegationRequestV11", propOrder = {
    "hdr",
    "mntncDlgtnReq",
    "sctyTrlr"
})
public class MaintenanceDelegationRequestV11 {

    @XmlElement(name = "Hdr")
    protected TMSHeader1 hdr;
    @XmlElement(name = "MntncDlgtnReq", required = true)
    protected MaintenanceDelegationRequest11 mntncDlgtnReq;
     ...
     *     
     */
    public MaintenanceDelegationRequestV11 setHdr(TMSHeader1 value) {
        this.hdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link MaintenanceDelegationRequest11 }
     *     
     */
    public MaintenanceDelegationRequest11 getMntncDlgtnReq() {
     ...
     *     
     */
    public MaintenanceDelegationRequestV11 setMntncDlgtnReq(MaintenanceDelegationRequest11 value) {
     ...
     *     
     */
    public MaintenanceDelegationRequestV11 setSctyTrlr(ContentInformationType38 value) {
        this.sctyTrlr = value;
        return this;
    }
