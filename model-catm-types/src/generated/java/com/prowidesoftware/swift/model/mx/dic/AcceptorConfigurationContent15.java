...
@XmlType(name = "AcceptorConfigurationContent15", propOrder = {
    "rplcCfgtn",
    "tmsPrtcolParams",
    "acqrrPrtcolParams",
    "svcPrvdrParams",
...
public class AcceptorConfigurationContent15 {

    @XmlElement(name = "RplcCfgtn")
    protected Boolean rplcCfgtn;
    @XmlElement(name = "TMSPrtcolParams")
    protected List<TMSProtocolParameters8> tmsPrtcolParams;
    @XmlElement(name = "AcqrrPrtcolParams")
    protected List<AcquirerProtocolParameters18> acqrrPrtcolParams;
    @XmlElement(name = "SvcPrvdrParams")
    protected List<ServiceProviderParameters5> svcPrvdrParams;
    ...
    protected List<HostCommunicationParameter8> hstComParams;
    @XmlElement(name = "SctyParams")
    protected List<SecurityParameters17> sctyParams;
    @XmlElement(name = "SaleToPOIParams")
    protected List<SaleToPOIProtocolParameter4> saleToPOIParams;
     ...
     *     
     */
    public AcceptorConfigurationContent15 setRplcCfgtn(Boolean value) {
     ...
     * {@link TMSProtocolParameters8 }
     * 
     * 
     * @return
     *     The value of the tmsPrtcolParams property.
     */
    public List<TMSProtocolParameters8> getTMSPrtcolParams() {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AcquirerProtocolParameters18 }
     * 
     * 
     * @return
     *     The value of the acqrrPrtcolParams property.
     */
    public List<AcquirerProtocolParameters18> getAcqrrPrtcolParams() {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ServiceProviderParameters5 }
     * 
     * 
     * @return
     *     The value of the svcPrvdrParams property.
     */
    public List<ServiceProviderParameters5> getSvcPrvdrParams() {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link HostCommunicationParameter8 }
     * 
     * 
     * @return
     *     The value of the hstComParams property.
     */
    public List<HostCommunicationParameter8> getHstComParams() {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SecurityParameters17 }
     * 
     * 
     * @return
     *     The value of the sctyParams property.
     */
    public List<SecurityParameters17> getSctyParams() {
        if (sctyParams == null) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SaleToPOIProtocolParameter4 }
     * 
     * 
     * @return
     *     The value of the saleToPOIParams property.
     */
    public List<SaleToPOIProtocolParameter4> getSaleToPOIParams() {
     ...
     * 
     */
    public AcceptorConfigurationContent15 addTMSPrtcolParams(TMSProtocolParameters8 tMSPrtcolParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent15 addAcqrrPrtcolParams(AcquirerProtocolParameters18 acqrrPrtcolParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent15 addSvcPrvdrParams(ServiceProviderParameters5 svcPrvdrParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent15 addMrchntParams(MerchantConfigurationParameters6 mrchntParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent15 addTermnlParams(PaymentTerminalParameters8 termnlParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent15 addApplParams(ApplicationParameters13 applParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent15 addHstComParams(HostCommunicationParameter8 hstComParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent15 addSctyParams(SecurityParameters17 sctyParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent15 addSaleToPOIParams(SaleToPOIProtocolParameter4 saleToPOIParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent15 addTermnlPackg(TerminalPackageType5 termnlPackg) {
