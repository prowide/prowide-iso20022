...
@XmlType(name = "TerminalPackageType5", propOrder = {
    "poiCmpntId",
    "packg"
})
public class TerminalPackageType5 {
     ...
     * 
     */
    public TerminalPackageType5 addPOICmpntId(PointOfInteractionComponentIdentification2 pOICmpntId) {
     ...
     * 
     */
    public TerminalPackageType5 addPackg(PackageType5 packg) {
        getPackg().add(packg);
        return this;
    }
