...
@XmlType(name = "MaintenanceDelegateAction11", propOrder = {
    "prdcActn",
    "tmRmotAccs",
    "tmsPrtcol",
    "tmsPrtcolVrsn",
...
public class MaintenanceDelegateAction11 {
    ...
    protected List<TMSAction14> actn;
     ...
     *     
     */
    public MaintenanceDelegateAction11 setPrdcActn(Boolean value) {
        this.prdcActn = value;
        return this;
    }
     ...
     *     
     */
    public MaintenanceDelegateAction11 setTMRmotAccs(NetworkParameters7 value) {
     ...
     *     
     */
    public MaintenanceDelegateAction11 setTMSPrtcol(String value) {
     ...
     *     
     */
    public MaintenanceDelegateAction11 setTMSPrtcolVrsn(String value) {
     ...
     *     
     */
    public MaintenanceDelegateAction11 setDataSetId(DataSetIdentification11 value) {
     ...
     *     
     */
    public MaintenanceDelegateAction11 setReTry(ProcessRetry3 value) {
        this.reTry = value;
        return this;
    }
     ...
     */
    public List<TMSAction14> getActn() {
        if (actn == null) {
            actn = new ArrayList<>();
        }
        return this.actn;
     ...
     * 
     */
    public MaintenanceDelegateAction11 addAddtlInf(byte[] addtlInf) {
     ...
     * 
     */
    public MaintenanceDelegateAction11 addActn(TMSAction14 actn) {
        getActn().add(actn);
        return this;
    }
