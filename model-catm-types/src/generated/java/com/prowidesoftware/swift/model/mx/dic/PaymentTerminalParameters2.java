...
@XmlType(name = "PaymentTerminalParameters2", propOrder = {
    "vndrId",
    "vrsn",
    "clckSynctn",
    "tmZoneLine",
...
public class PaymentTerminalParameters2 {
     ...
     *     
     */
    public PaymentTerminalParameters2 setVndrId(String value) {
        this.vndrId = value;
        return this;
    }
     ...
     *     
     */
    public PaymentTerminalParameters2 setVrsn(String value) {
        this.vrsn = value;
        return this;
    }
     ...
     *     
     */
    public PaymentTerminalParameters2 setClckSynctn(ClockSynchronisation1 value) {
     ...
     *     byte[]
     */
    public PaymentTerminalParameters2 setOthrParams(byte[] value) {
     ...
     * 
     */
    public PaymentTerminalParameters2 addTmZoneLine(String tmZoneLine) {
     ...
     * 
     */
    public PaymentTerminalParameters2 addLclDtTm(LocalDateTime1 lclDtTm) {
