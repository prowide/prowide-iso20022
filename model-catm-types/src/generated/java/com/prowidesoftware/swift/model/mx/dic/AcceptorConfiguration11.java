...
@XmlType(name = "AcceptorConfiguration11", propOrder = {
    "termnlMgrId",
    "poiGrpId",
    "dataSet"
})
public class AcceptorConfiguration11 {
    ...
    protected List<AcceptorConfigurationDataSet3> dataSet;
     ...
     *     
     */
    public AcceptorConfiguration11 setTermnlMgrId(GenericIdentification176 value) {
     ...
     * 
     */
    public List<AcceptorConfigurationDataSet3> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<AcceptorConfigurationDataSet3>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public AcceptorConfiguration11 addPOIGrpId(String pOIGrpId) {
     ...
     * 
     */
    public AcceptorConfiguration11 addDataSet(AcceptorConfigurationDataSet3 dataSet) {
