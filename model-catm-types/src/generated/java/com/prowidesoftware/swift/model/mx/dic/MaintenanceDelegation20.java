...
@XmlType(name = "MaintenanceDelegation20", propOrder = {
    "dlgtnTp",
    "mntncSvc",
    "prtlDlgtn",
    "poiSubset",
...
public class MaintenanceDelegation20 {
    ...
    protected MaintenanceDelegateAction11 dlgtdActn;
    ...
    protected List<CryptographicKey19> smmtrcKey;
    @XmlElement(name = "ParamDataSet")
    protected AcceptorConfigurationDataSet7 paramDataSet;
     ...
     *     
     */
    public MaintenanceDelegation20 setDlgtnTp(TerminalManagementAction3Code value) {
        this.dlgtnTp = value;
        return this;
    }
     ...
     *     
     */
    public MaintenanceDelegation20 setPrtlDlgtn(Boolean value) {
     ...
     * @return
     *     possible object is
     *     {@link MaintenanceDelegateAction11 }
     *     
     */
    public MaintenanceDelegateAction11 getDlgtdActn() {
        return dlgtdActn;
    }
     ...
     *     
     */
    public MaintenanceDelegation20 setDlgtdActn(MaintenanceDelegateAction11 value) {
     ...
     *     
     */
    public MaintenanceDelegation20 setDlgtnScpId(String value) {
     ...
     *     byte[]
     */
    public MaintenanceDelegation20 setDlgtnScpDef(byte[] value) {
     ...
     */
    public List<CryptographicKey19> getSmmtrcKey() {
        if (smmtrcKey == null) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorConfigurationDataSet7 }
     *     
     */
    public AcceptorConfigurationDataSet7 getParamDataSet() {
        return paramDataSet;
    }
     ...
     *     
     */
    public MaintenanceDelegation20 setParamDataSet(AcceptorConfigurationDataSet7 value) {
     ...
     * 
     */
    public MaintenanceDelegation20 addMntncSvc(DataSetCategory19Code mntncSvc) {
     ...
     * 
     */
    public MaintenanceDelegation20 addPOISubset(String pOISubset) {
     ...
     * 
     */
    public MaintenanceDelegation20 addCert(byte[] cert) {
        getCert().add(cert);
        return this;
    }
     ...
     * 
     */
    public MaintenanceDelegation20 addPOIIdAssoctn(MaintenanceIdentificationAssociation1 pOIIdAssoctn) {
     ...
     * 
     */
    public MaintenanceDelegation20 addSmmtrcKey(CryptographicKey19 smmtrcKey) {
