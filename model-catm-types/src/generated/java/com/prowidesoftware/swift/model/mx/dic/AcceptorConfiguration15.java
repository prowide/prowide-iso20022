...
@XmlType(name = "AcceptorConfiguration15", propOrder = {
    "termnlMgrId",
    "poiGrpId",
    "dataSet"
})
public class AcceptorConfiguration15 {
    ...
    protected List<AcceptorConfigurationDataSet7> dataSet;
     ...
     *     
     */
    public AcceptorConfiguration15 setTermnlMgrId(GenericIdentification176 value) {
     ...
     */
    public List<AcceptorConfigurationDataSet7> getDataSet() {
        if (dataSet == null) {
     ...
     * 
     */
    public AcceptorConfiguration15 addPOIGrpId(String pOIGrpId) {
     ...
     * 
     */
    public AcceptorConfiguration15 addDataSet(AcceptorConfigurationDataSet7 dataSet) {
