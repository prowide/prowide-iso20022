...
@XmlType(name = "MaintenanceDelegateAction2", propOrder = {
    "prdcActn",
    "tmRmotAccs",
    "tmsPrtcol",
    "tmsPrtcolVrsn",
...
public class MaintenanceDelegateAction2 {
     ...
     *     
     */
    public MaintenanceDelegateAction2 setPrdcActn(Boolean value) {
        this.prdcActn = value;
        return this;
    }
     ...
     *     
     */
    public MaintenanceDelegateAction2 setTMRmotAccs(NetworkParameters5 value) {
     ...
     *     
     */
    public MaintenanceDelegateAction2 setTMSPrtcol(String value) {
     ...
     *     
     */
    public MaintenanceDelegateAction2 setTMSPrtcolVrsn(String value) {
     ...
     *     
     */
    public MaintenanceDelegateAction2 setDataSetId(DataSetIdentification6 value) {
     ...
     *     
     */
    public MaintenanceDelegateAction2 setReTry(ProcessRetry2 value) {
        this.reTry = value;
        return this;
    }
     ...
     * 
     */
    public MaintenanceDelegateAction2 addAddtlInf(byte[] addtlInf) {
     ...
     * 
     */
    public MaintenanceDelegateAction2 addActn(TMSAction5 actn) {
        getActn().add(actn);
        return this;
    }
