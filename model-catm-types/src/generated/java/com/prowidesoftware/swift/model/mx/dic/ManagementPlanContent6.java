...
@XmlType(name = "ManagementPlanContent6", propOrder = {
    "tmChllng",
    "keyNcphrmntCert",
    "actn"
})
public class ManagementPlanContent6 {
     ...
     *     byte[]
     */
    public ManagementPlanContent6 setTMChllng(byte[] value) {
        this.tmChllng = value;
        return this;
    }
     ...
     * 
     */
    public ManagementPlanContent6 addKeyNcphrmntCert(byte[] keyNcphrmntCert) {
     ...
     * 
     */
    public ManagementPlanContent6 addActn(TMSAction6 actn) {
        getActn().add(actn);
        return this;
    }
