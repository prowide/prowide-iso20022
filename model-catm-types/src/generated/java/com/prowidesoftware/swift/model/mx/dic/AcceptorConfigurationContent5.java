...
@XmlType(name = "AcceptorConfigurationContent5", propOrder = {
    "rplcCfgtn",
    "tmsPrtcolParams",
    "acqrrPrtcolParams",
    "mrchntParams",
...
public class AcceptorConfigurationContent5 {
    ...
    protected List<AcquirerProtocolParameters9> acqrrPrtcolParams;
    @XmlElement(name = "MrchntParams")
    protected List<MerchantConfigurationParameters2> mrchntParams;
    @XmlElement(name = "TermnlParams")
    protected List<PaymentTerminalParameters3> termnlParams;
    @XmlElement(name = "ApplParams")
    protected List<ApplicationParameters5> applParams;
     ...
     *     
     */
    public AcceptorConfigurationContent5 setRplcCfgtn(Boolean value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AcquirerProtocolParameters9 }
     * 
     * 
     */
    public List<AcquirerProtocolParameters9> getAcqrrPrtcolParams() {
        if (acqrrPrtcolParams == null) {
            acqrrPrtcolParams = new ArrayList<AcquirerProtocolParameters9>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MerchantConfigurationParameters2 }
     * 
     * 
     */
    public List<MerchantConfigurationParameters2> getMrchntParams() {
        if (mrchntParams == null) {
            mrchntParams = new ArrayList<MerchantConfigurationParameters2>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTerminalParameters3 }
     * 
     * 
     */
    public List<PaymentTerminalParameters3> getTermnlParams() {
        if (termnlParams == null) {
            termnlParams = new ArrayList<PaymentTerminalParameters3>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ApplicationParameters5 }
     * 
     * 
     */
    public List<ApplicationParameters5> getApplParams() {
        if (applParams == null) {
            applParams = new ArrayList<ApplicationParameters5>();
        }
     ...
     * 
     */
    public AcceptorConfigurationContent5 addTMSPrtcolParams(TMSProtocolParameters2 tMSPrtcolParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent5 addAcqrrPrtcolParams(AcquirerProtocolParameters9 acqrrPrtcolParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent5 addMrchntParams(MerchantConfigurationParameters2 mrchntParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent5 addTermnlParams(PaymentTerminalParameters3 termnlParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent5 addApplParams(ApplicationParameters5 applParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent5 addHstComParams(HostCommunicationParameter4 hstComParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent5 addSctyParams(SecurityParameters6 sctyParams) {
