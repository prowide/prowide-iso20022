...
@XmlType(name = "TerminalPackageType2", propOrder = {
    "poiCmpntId",
    "packg"
})
public class TerminalPackageType2 {
    ...
    public List<PackageType2> getPackg() {
        if (packg == null) {
            packg = new ArrayList<PackageType2>();
        }
        return this.packg;
    }
     ...
     * 
     */
    public TerminalPackageType2 addPOICmpntId(PointOfInteractionComponentIdentification2 pOICmpntId) {
     ...
     * 
     */
    public TerminalPackageType2 addPackg(PackageType2 packg) {
        getPackg().add(packg);
        return this;
    }
