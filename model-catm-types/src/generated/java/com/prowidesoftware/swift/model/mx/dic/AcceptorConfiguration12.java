...
public class AcceptorConfiguration12 {
     ...
     *     
     */
    public AcceptorConfiguration12 setTermnlMgrId(GenericIdentification176 value) {
    ...
    public List<AcceptorConfigurationDataSet4> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<AcceptorConfigurationDataSet4>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public AcceptorConfiguration12 addPOIGrpId(String pOIGrpId) {
     ...
     * 
     */
    public AcceptorConfiguration12 addDataSet(AcceptorConfigurationDataSet4 dataSet) {
