...
@XmlType(name = "AcceptorConfiguration2", propOrder = {
    "poiId",
    "termnlMgrId",
    "dataSet"
})
public class AcceptorConfiguration2 {
     ...
     *     
     */
    public AcceptorConfiguration2 setPOIId(GenericIdentification35 value) {
        this.poiId = value;
        return this;
    }
     ...
     *     
     */
    public AcceptorConfiguration2 setTermnlMgrId(GenericIdentification35 value) {
     ...
     * {@link TerminalManagementDataSet6 }
     * 
     * 
     */
    public List<TerminalManagementDataSet6> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<TerminalManagementDataSet6>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public AcceptorConfiguration2 addDataSet(TerminalManagementDataSet6 dataSet) {
