...
@XmlType(name = "AcquirerProtocolParameters18", propOrder = {
    "actnTp",
    "acqrrId",
    "vrsn",
    "applId",
...
public class AcquirerProtocolParameters18 {
    ...
    @XmlElement(name = "Hst")
    protected List<AcquirerHostConfiguration11> hst;
     ...
     *     
     */
    public AcquirerProtocolParameters18 setActnTp(TerminalManagementAction3Code value) {
        this.actnTp = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters18 setVrsn(String value) {
        this.vrsn = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AcquirerHostConfiguration11 }
     * 
     * 
     * @return
     *     The value of the hst property.
     */
    public List<AcquirerHostConfiguration11> getHst() {
        if (hst == null) {
            hst = new ArrayList<>();
        }
        return this.hst;
     ...
     *     
     */
    public AcquirerProtocolParameters18 setOnLineTx(AcquirerProtocolExchangeBehavior2 value) {
        this.onLineTx = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters18 setOffLineTx(AcquirerProtocolExchangeBehavior2 value) {
     ...
     *     
     */
    public AcquirerProtocolParameters18 setRcncltnXchg(ExchangeConfiguration9 value) {
     ...
     *     
     */
    public AcquirerProtocolParameters18 setRcncltnByAcqrr(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters18 setTtlsPerCcy(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters18 setSpltTtls(Boolean value) {
        this.spltTtls = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters18 setCmpltnAdvcMndtd(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters18 setRcncltnErr(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters18 setCardDataVrfctn(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters18 setNtfyOffLineCxl(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters18 setFileTrfBtch(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters18 setBtchDgtlSgntr(Boolean value) {
     ...
     * 
     */
    public AcquirerProtocolParameters18 setPrtctCardData(boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters18 setPrvtCardData(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters18 setMndtrySctyTrlr(Boolean value) {
     ...
     * 
     */
    public AcquirerProtocolParameters18 addAcqrrId(GenericIdentification176 acqrrId) {
     ...
     * 
     */
    public AcquirerProtocolParameters18 addApplId(String applId) {
     ...
     * 
     */
    public AcquirerProtocolParameters18 addHst(AcquirerHostConfiguration11 hst) {
        getHst().add(hst);
        return this;
    }
     ...
     * 
     */
    public AcquirerProtocolParameters18 addSpltTtlCrit(ReconciliationCriteria1Code spltTtlCrit) {
     ...
     * 
     */
    public AcquirerProtocolParameters18 addAmtQlfrForRsvatn(TypeOfAmount8Code amtQlfrForRsvatn) {
     ...
     * 
     */
    public AcquirerProtocolParameters18 addBtchTrfCntt(BatchTransactionType1Code btchTrfCntt) {
     ...
     * 
     */
    public AcquirerProtocolParameters18 addMsgItm(MessageItemCondition2 msgItm) {
