...
@XmlType(name = "TMSAction14", propOrder = {
    "tp",
    "rmotAccs",
    "key",
    "termnlMgrId",
...
public class TMSAction14 {
    ...
    @XmlElement(name = "Key")
    protected List<CryptographicKey19> key;
    ...
    @XmlSchemaType(name = "string")
    protected List<DataSetCategory20Code> cmpntTp;
    ...
    protected DeviceRequest9 dvcReq;
     ...
     *     
     */
    public TMSAction14 setTp(TerminalManagementAction5Code value) {
        this.tp = value;
        return this;
    }
     ...
     *     
     */
    public TMSAction14 setRmotAccs(NetworkParameters7 value) {
        this.rmotAccs = value;
        return this;
    }
     ...
     * {@link CryptographicKey19 }
     * 
     * 
     * @return
     *     The value of the key property.
     */
    public List<CryptographicKey19> getKey() {
        if (key == null) {
            key = new ArrayList<>();
        }
        return this.key;
     ...
     *     
     */
    public TMSAction14 setTermnlMgrId(GenericIdentification176 value) {
     ...
     *     
     */
    public TMSAction14 setTMSPrtcol(String value) {
     ...
     *     
     */
    public TMSAction14 setTMSPrtcolVrsn(String value) {
     ...
     *     
     */
    public TMSAction14 setDataSetId(DataSetIdentification11 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DataSetCategory20Code }
     * 
     * 
     * @return
     *     The value of the cmpntTp property.
     */
    public List<DataSetCategory20Code> getCmpntTp() {
        if (cmpntTp == null) {
     ...
     *     
     */
    public TMSAction14 setDlgtnScpId(String value) {
     ...
     *     byte[]
     */
    public TMSAction14 setDlgtnScpDef(byte[] value) {
     ...
     *     byte[]
     */
    public TMSAction14 setDlgtnProof(byte[] value) {
     ...
     *     
     */
    public TMSAction14 setPrtctdDlgtnProof(ContentInformationType39 value) {
     ...
     *     
     */
    public TMSAction14 setTrggr(TerminalManagementActionTrigger1Code value) {
        this.trggr = value;
        return this;
    }
     ...
     *     
     */
    public TMSAction14 setReTry(ProcessRetry3 value) {
        this.reTry = value;
        return this;
    }
     ...
     *     
     */
    public TMSAction14 setTmCond(ProcessTiming5 value) {
        this.tmCond = value;
        return this;
    }
     ...
     *     byte[]
     */
    public TMSAction14 setTMChllng(byte[] value) {
        this.tmChllng = value;
        return this;
    }
     ...
     *     
     */
    public DeviceRequest9 getDvcReq() {
        return dvcReq;
    }
     ...
     *     
     */
    public TMSAction14 setDvcReq(DeviceRequest9 value) {
        this.dvcReq = value;
        return this;
    }
     ...
     * 
     */
    public TMSAction14 addKey(CryptographicKey19 key) {
        getKey().add(key);
        return this;
    }
     ...
     * 
     */
    public TMSAction14 addCmpntTp(DataSetCategory20Code cmpntTp) {
     ...
     * 
     */
    public TMSAction14 addAddtlPrc(TerminalManagementAdditionalProcess1Code addtlPrc) {
     ...
     * 
     */
    public TMSAction14 addKeyNcphrmntCert(byte[] keyNcphrmntCert) {
     ...
     * 
     */
    public TMSAction14 addErrActn(ErrorAction5 errActn) {
     ...
     * 
     */
    public TMSAction14 addAddtlInf(byte[] addtlInf) {
     ...
     * 
     */
    public TMSAction14 addMsgItm(MessageItemCondition2 msgItm) {
