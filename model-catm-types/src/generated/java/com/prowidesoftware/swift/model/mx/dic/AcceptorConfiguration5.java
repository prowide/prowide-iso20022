...
@XmlType(name = "AcceptorConfiguration5", propOrder = {
    "termnlMgrId",
    "dataSet"
})
public class AcceptorConfiguration5 {
    ...
    protected List<TerminalManagementDataSet19> dataSet;
     ...
     *     
     */
    public AcceptorConfiguration5 setTermnlMgrId(GenericIdentification71 value) {
    ...
    public List<TerminalManagementDataSet19> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<TerminalManagementDataSet19>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public AcceptorConfiguration5 addDataSet(TerminalManagementDataSet19 dataSet) {
