...
@XmlType(name = "AcceptorConfigurationContent2", propOrder = {
    "acqrrPrtcolParams",
    "mrchntParams",
    "termnlParams",
    "applParams",
...
public class AcceptorConfigurationContent2 {
     ...
     * {@link AcquirerProtocolParameters3 }
     * 
     * 
     */
    public List<AcquirerProtocolParameters3> getAcqrrPrtcolParams() {
        if (acqrrPrtcolParams == null) {
            acqrrPrtcolParams = new ArrayList<AcquirerProtocolParameters3>();
        }
    ...
    public List<byte[]> getTermnlParams() {
        if (termnlParams == null) {
            termnlParams = new ArrayList<byte[]>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ApplicationParameters2 }
     * 
     * 
     */
    public List<ApplicationParameters2> getApplParams() {
        if (applParams == null) {
            applParams = new ArrayList<ApplicationParameters2>();
        }
    ...
    public List<HostCommunicationParameter2> getHstComParams() {
        if (hstComParams == null) {
            hstComParams = new ArrayList<HostCommunicationParameter2>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SecurityParameters1 }
     * 
     * 
     */
    public List<SecurityParameters1> getSctyParams() {
        if (sctyParams == null) {
            sctyParams = new ArrayList<SecurityParameters1>();
        }
     ...
     * 
     */
    public AcceptorConfigurationContent2 addAcqrrPrtcolParams(AcquirerProtocolParameters3 acqrrPrtcolParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent2 addMrchntParams(byte[] mrchntParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent2 addTermnlParams(byte[] termnlParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent2 addApplParams(ApplicationParameters2 applParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent2 addHstComParams(HostCommunicationParameter2 hstComParams) {
     ...
     * 
     */
    public AcceptorConfigurationContent2 addSctyParams(SecurityParameters1 sctyParams) {
