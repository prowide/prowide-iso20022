...
@XmlType(name = "TMSAction4", propOrder = {
    "tp",
    "rmotAccs",
    "termnlMgrId",
    "tmsPrtcol",
...
public class TMSAction4 {
     ...
     *     
     */
    public TMSAction4 setTp(TerminalManagementAction1Code value) {
        this.tp = value;
        return this;
    }
     ...
     *     
     */
    public TMSAction4 setRmotAccs(NetworkParameters3 value) {
        this.rmotAccs = value;
        return this;
    }
     ...
     *     
     */
    public TMSAction4 setTermnlMgrId(GenericIdentification71 value) {
     ...
     *     
     */
    public TMSAction4 setTMSPrtcol(String value) {
     ...
     *     
     */
    public TMSAction4 setTMSPrtcolVrsn(String value) {
     ...
     *     
     */
    public TMSAction4 setDataSetId(DataSetIdentification4 value) {
    ...
    public List<DataSetCategory4Code> getCmpntTp() {
        if (cmpntTp == null) {
            cmpntTp = new ArrayList<DataSetCategory4Code>();
        }
        return this.cmpntTp;
    }
     ...
     *     
     */
    public TMSAction4 setParamsSubsetId(String value) {
     ...
     *     byte[]
     */
    public TMSAction4 setParamsSubsetDef(byte[] value) {
     ...
     *     byte[]
     */
    public TMSAction4 setDlgtnProof(byte[] value) {
     ...
     *     
     */
    public TMSAction4 setPrtctdDlgtnProof(ContentInformationType12 value) {
     ...
     *     
     */
    public TMSAction4 setTrggr(TerminalManagementActionTrigger1Code value) {
        this.trggr = value;
        return this;
    }
     ...
     *     
     */
    public TMSAction4 setReTry(ProcessRetry2 value) {
        this.reTry = value;
        return this;
    }
     ...
     *     
     */
    public TMSAction4 setTmCond(ProcessTiming3 value) {
        this.tmCond = value;
        return this;
    }
     ...
     *     byte[]
     */
    public TMSAction4 setTMChllng(byte[] value) {
        this.tmChllng = value;
        return this;
    }
     ...
     * 
     */
    public TMSAction4 addCmpntTp(DataSetCategory4Code cmpntTp) {
     ...
     * 
     */
    public TMSAction4 addAddtlPrc(TerminalManagementAdditionalProcess1Code addtlPrc) {
     ...
     * 
     */
    public TMSAction4 addKeyNcphrmntCert(byte[] keyNcphrmntCert) {
     ...
     * 
     */
    public TMSAction4 addErrActn(ErrorAction2 errActn) {
     ...
     * 
     */
    public TMSAction4 addAddtlInf(byte[] addtlInf) {
