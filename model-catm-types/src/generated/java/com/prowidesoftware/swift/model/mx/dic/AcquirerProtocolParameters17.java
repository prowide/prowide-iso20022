...
@XmlType(name = "AcquirerProtocolParameters17", propOrder = {
    "actnTp",
    "acqrrId",
    "vrsn",
    "applId",
...
public class AcquirerProtocolParameters17 {
     ...
     *     
     */
    public AcquirerProtocolParameters17 setActnTp(TerminalManagementAction3Code value) {
        this.actnTp = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters17 setVrsn(String value) {
        this.vrsn = value;
        return this;
    }
    ...
    public List<AcquirerHostConfiguration10> getHst() {
        if (hst == null) {
            hst = new ArrayList<AcquirerHostConfiguration10>();
        }
        return this.hst;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters17 setOnLineTx(AcquirerProtocolExchangeBehavior2 value) {
        this.onLineTx = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerProtocolParameters17 setOffLineTx(AcquirerProtocolExchangeBehavior2 value) {
     ...
     *     
     */
    public AcquirerProtocolParameters17 setRcncltnXchg(ExchangeConfiguration9 value) {
     ...
     *     
     */
    public AcquirerProtocolParameters17 setRcncltnByAcqrr(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters17 setTtlsPerCcy(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters17 setSpltTtls(Boolean value) {
        this.spltTtls = value;
        return this;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the spltTtlCrit property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<ReconciliationCriteria1Code> getSpltTtlCrit() {
        if (spltTtlCrit == null) {
            spltTtlCrit = new ArrayList<ReconciliationCriteria1Code>();
        }
     ...
     *     
     */
    public AcquirerProtocolParameters17 setCmpltnAdvcMndtd(Boolean value) {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the amtQlfrForRsvatn property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<TypeOfAmount8Code> getAmtQlfrForRsvatn() {
        if (amtQlfrForRsvatn == null) {
            amtQlfrForRsvatn = new ArrayList<TypeOfAmount8Code>();
        }
     ...
     *     
     */
    public AcquirerProtocolParameters17 setRcncltnErr(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters17 setCardDataVrfctn(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters17 setNtfyOffLineCxl(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters17 setFileTrfBtch(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters17 setBtchDgtlSgntr(Boolean value) {
    ...
    public List<MessageItemCondition2> getMsgItm() {
        if (msgItm == null) {
            msgItm = new ArrayList<MessageItemCondition2>();
        }
        return this.msgItm;
    }
     ...
     * 
     */
    public AcquirerProtocolParameters17 setPrtctCardData(boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters17 setPrvtCardData(Boolean value) {
     ...
     *     
     */
    public AcquirerProtocolParameters17 setMndtrySctyTrlr(Boolean value) {
     ...
     * 
     */
    public AcquirerProtocolParameters17 addAcqrrId(GenericIdentification176 acqrrId) {
     ...
     * 
     */
    public AcquirerProtocolParameters17 addApplId(String applId) {
     ...
     * 
     */
    public AcquirerProtocolParameters17 addHst(AcquirerHostConfiguration10 hst) {
        getHst().add(hst);
        return this;
    }
     ...
     * 
     */
    public AcquirerProtocolParameters17 addSpltTtlCrit(ReconciliationCriteria1Code spltTtlCrit) {
     ...
     * 
     */
    public AcquirerProtocolParameters17 addAmtQlfrForRsvatn(TypeOfAmount8Code amtQlfrForRsvatn) {
     ...
     * 
     */
    public AcquirerProtocolParameters17 addBtchTrfCntt(BatchTransactionType1Code btchTrfCntt) {
     ...
     * 
     */
    public AcquirerProtocolParameters17 addMsgItm(MessageItemCondition2 msgItm) {
