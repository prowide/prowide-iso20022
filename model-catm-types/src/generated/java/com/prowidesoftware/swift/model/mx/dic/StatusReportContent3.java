...
@XmlType(name = "StatusReportContent3", propOrder = {
    "poiCpblties",
    "poiCmpnt",
    "attndncCntxt",
    "poiDtTm",
...
public class StatusReportContent3 {
    ...
    protected PointOfInteractionCapabilities2 poiCpblties;
    ...
    protected TerminalManagementDataSet8 dataSetReqrd;
    @XmlElement(name = "Evt")
     ...
     *     
     */
    public PointOfInteractionCapabilities2 getPOICpblties() {
        return poiCpblties;
    }
     ...
     *     
     */
    public StatusReportContent3 setPOICpblties(PointOfInteractionCapabilities2 value) {
     ...
     *     
     */
    public StatusReportContent3 setAttndncCntxt(AttendanceContext1Code value) {
     ...
     *     
     */
    public StatusReportContent3 setPOIDtTm(OffsetDateTime value) {
        this.poiDtTm = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link TerminalManagementDataSet8 }
     *     
     */
    public TerminalManagementDataSet8 getDataSetReqrd() {
        return dataSetReqrd;
    }
     ...
     *     
     */
    public StatusReportContent3 setDataSetReqrd(TerminalManagementDataSet8 value) {
     ...
     * 
     */
    public StatusReportContent3 addPOICmpnt(PointOfInteractionComponent4 pOICmpnt) {
     ...
     * 
     */
    public StatusReportContent3 addEvt(TMSEvent2 evt) {
        getEvt().add(evt);
        return this;
    }
     ...
     * 
     */
    public StatusReportContent3 addErrs(String errs) {
        getErrs().add(errs);
        return this;
    }
