...
@XmlType(name = "ManagementPlanContent8", propOrder = {
    "tmChllng",
    "keyNcphrmntCert",
    "actn"
})
public class ManagementPlanContent8 {
     ...
     *     byte[]
     */
    public ManagementPlanContent8 setTMChllng(byte[] value) {
        this.tmChllng = value;
        return this;
    }
     ...
     * 
     */
    public ManagementPlanContent8 addKeyNcphrmntCert(byte[] keyNcphrmntCert) {
     ...
     * 
     */
    public ManagementPlanContent8 addActn(TMSAction8 actn) {
        getActn().add(actn);
        return this;
    }
