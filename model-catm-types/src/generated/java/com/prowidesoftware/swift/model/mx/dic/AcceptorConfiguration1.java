...
@XmlType(name = "AcceptorConfiguration1", propOrder = {
    "poiId",
    "termnlMgrId",
    "dataSet"
})
public class AcceptorConfiguration1 {
    ...
    protected List<TerminalManagementDataSet3> dataSet;
     ...
     *     
     */
    public AcceptorConfiguration1 setPOIId(GenericIdentification35 value) {
        this.poiId = value;
        return this;
    }
     ...
     *     
     */
    public AcceptorConfiguration1 setTermnlMgrId(GenericIdentification35 value) {
     ...
     * {@link TerminalManagementDataSet3 }
     * 
     * 
     */
    public List<TerminalManagementDataSet3> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<TerminalManagementDataSet3>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public AcceptorConfiguration1 addDataSet(TerminalManagementDataSet3 dataSet) {
