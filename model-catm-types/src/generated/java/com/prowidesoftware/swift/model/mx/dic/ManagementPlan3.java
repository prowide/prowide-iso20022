...
@XmlType(name = "ManagementPlan3", propOrder = {
    "poiId",
    "termnlMgrId",
    "dataSet"
})
public class ManagementPlan3 {
    ...
    protected List<TerminalManagementDataSet10> dataSet;
     ...
     *     
     */
    public ManagementPlan3 setPOIId(GenericIdentification35 value) {
        this.poiId = value;
        return this;
    }
     ...
     *     
     */
    public ManagementPlan3 setTermnlMgrId(GenericIdentification35 value) {
     ...
     * {@link TerminalManagementDataSet10 }
     * 
     * 
     */
    public List<TerminalManagementDataSet10> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<TerminalManagementDataSet10>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public ManagementPlan3 addDataSet(TerminalManagementDataSet10 dataSet) {
