...
@XmlType(name = "MaintenanceDelegationRequest1", propOrder = {
    "tmId",
    "mstrTMId",
    "reqdDlgtn"
})
public class MaintenanceDelegationRequest1 {
    ...
    protected List<MaintenanceDelegation1> reqdDlgtn;
     ...
     *     
     */
    public MaintenanceDelegationRequest1 setTMId(GenericIdentification72 value) {
        this.tmId = value;
        return this;
    }
     ...
     *     
     */
    public MaintenanceDelegationRequest1 setMstrTMId(GenericIdentification72 value) {
        this.mstrTMId = value;
        return this;
    }
     ...
     * {@link MaintenanceDelegation1 }
     * 
     * 
     */
    public List<MaintenanceDelegation1> getReqdDlgtn() {
        if (reqdDlgtn == null) {
            reqdDlgtn = new ArrayList<MaintenanceDelegation1>();
        }
     ...
     * 
     */
    public MaintenanceDelegationRequest1 addReqdDlgtn(MaintenanceDelegation1 reqdDlgtn) {
