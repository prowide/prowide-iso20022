...
@XmlType(name = "MaintenanceDelegation7", propOrder = {
    "dlgtnTp",
    "mntncSvc",
    "prtlDlgtn",
    "poiSubset",
...
public class MaintenanceDelegation7 {
     ...
     *     
     */
    public MaintenanceDelegation7 setDlgtnTp(TerminalManagementAction3Code value) {
        this.dlgtnTp = value;
        return this;
    }
    ...
    public List<DataSetCategory13Code> getMntncSvc() {
        if (mntncSvc == null) {
            mntncSvc = new ArrayList<DataSetCategory13Code>();
        }
     ...
     *     
     */
    public MaintenanceDelegation7 setPrtlDlgtn(Boolean value) {
     ...
     *     
     */
    public MaintenanceDelegation7 setDlgtdActn(MaintenanceDelegateAction4 value) {
     ...
     *     
     */
    public MaintenanceDelegation7 setDlgtnScpId(String value) {
     ...
     *     byte[]
     */
    public MaintenanceDelegation7 setDlgtnScpDef(byte[] value) {
     ...
     *     
     */
    public MaintenanceDelegation7 setParamDataSet(TerminalManagementDataSet23 value) {
     ...
     * 
     */
    public MaintenanceDelegation7 addMntncSvc(DataSetCategory13Code mntncSvc) {
     ...
     * 
     */
    public MaintenanceDelegation7 addPOISubset(String pOISubset) {
     ...
     * 
     */
    public MaintenanceDelegation7 addCert(byte[] cert) {
        getCert().add(cert);
        return this;
    }
     ...
     * 
     */
    public MaintenanceDelegation7 addPOIIdAssoctn(MaintenanceIdentificationAssociation1 pOIIdAssoctn) {
     ...
     * 
     */
    public MaintenanceDelegation7 addSmmtrcKey(KEKIdentifier5 smmtrcKey) {
