...
@XmlType(name = "StatusReportContent5", propOrder = {
    "poiCpblties",
    "poiCmpnt",
    "attndncCntxt",
    "poiDtTm",
...
public class StatusReportContent5 {
     ...
     *     
     */
    public StatusReportContent5 setPOICpblties(PointOfInteractionCapabilities6 value) {
     ...
     *     
     */
    public StatusReportContent5 setAttndncCntxt(AttendanceContext1Code value) {
     ...
     *     
     */
    public StatusReportContent5 setPOIDtTm(OffsetDateTime value) {
        this.poiDtTm = value;
        return this;
    }
     ...
     *     
     */
    public StatusReportContent5 setDataSetReqrd(TerminalManagementDataSet17 value) {
     ...
     * 
     */
    public StatusReportContent5 addPOICmpnt(PointOfInteractionComponent6 pOICmpnt) {
     ...
     * 
     */
    public StatusReportContent5 addEvt(TMSEvent4 evt) {
        getEvt().add(evt);
        return this;
    }
     ...
     * 
     */
    public StatusReportContent5 addErrs(String errs) {
        getErrs().add(errs);
        return this;
    }
