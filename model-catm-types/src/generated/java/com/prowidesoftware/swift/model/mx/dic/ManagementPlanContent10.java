...
@XmlType(name = "ManagementPlanContent10", propOrder = {
    "tmChllng",
    "keyNcphrmntCert",
    "actn"
})
public class ManagementPlanContent10 {
     ...
     *     byte[]
     */
    public ManagementPlanContent10 setTMChllng(byte[] value) {
        this.tmChllng = value;
        return this;
    }
     ...
     * 
     */
    public ManagementPlanContent10 addKeyNcphrmntCert(byte[] keyNcphrmntCert) {
     ...
     * 
     */
    public ManagementPlanContent10 addActn(TMSAction10 actn) {
        getActn().add(actn);
        return this;
    }
