...
@XmlType(name = "SecurityParameters3", propOrder = {
    "vrsn",
    "poiChllng",
    "tmChllng",
    "smmtrcKey"
...
public class SecurityParameters3 {
     ...
     *     
     */
    public SecurityParameters3 setVrsn(String value) {
        this.vrsn = value;
        return this;
    }
     ...
     *     byte[]
     */
    public SecurityParameters3 setPOIChllng(byte[] value) {
     ...
     *     byte[]
     */
    public SecurityParameters3 setTMChllng(byte[] value) {
        this.tmChllng = value;
        return this;
    }
     ...
     * 
     */
    public SecurityParameters3 addSmmtrcKey(CryptographicKey5 smmtrcKey) {
