...
/**
 * Java class for ResolveGapSnFRequest complex type.
 * 
 * 
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ResolveGapSnFRequest", propOrder = {
    "inputChannel",
    "snFInputSeq",
    "token"
})
public class SwResolveGapSnFRequest {
     ...
     *     
     */
    public SwResolveGapSnFRequest setInputChannel(String value) {
     ...
     *     
     */
    public SwResolveGapSnFRequest setSnFInputSeq(String value) {
     ...
     *     
     */
    public SwResolveGapSnFRequest setToken(String value) {
        this.token = value;
        return this;
    }
