...
public class MessageListXsys00903 {

    @XmlElement(name = "Msg", required = true)
    protected List<MessageXsys00903> msg;
     ...
     * {@link MessageXsys00903 }
     * 
     * 
     * @return
     *     The value of the msg property.
     */
    public List<MessageXsys00903> getMsg() {
        if (msg == null) {
            msg = new ArrayList<>();
        }
        return this.msg;
     ...
     * 
     */
    public MessageListXsys00903 addMsg(MessageXsys00903 msg) {
        getMsg().add(msg);
        return this;
    }
