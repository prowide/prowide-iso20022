...
@XmlType(name = "FetchFileResponse", propOrder = {
    "transferRef",
    "status"
})
public class SwFetchFileResponse {
     ...
     *     
     */
    public SwFetchFileResponse setTransferRef(String value) {
     ...
     *     
     */
    public SwFetchFileResponse setStatus(SwGblStatus value) {
        this.status = value;
        return this;
    }
