...
public class SwGetLastReplicationTimeSnFResponseHandle {
     ...
     * This is why there is not a {@code set} method for the snFLastReplicationTime property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the snFLastReplicationTime property.
     */
    public List<String> getSnFLastReplicationTime() {
        if (snFLastReplicationTime == null) {
            snFLastReplicationTime = new ArrayList<>();
        }
