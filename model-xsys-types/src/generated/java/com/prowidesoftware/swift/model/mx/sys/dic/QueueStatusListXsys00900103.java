...
public class QueueStatusListXsys00900103 {

    @XmlElement(name = "QSts", required = true)
    protected List<QueueStatusXsys00900103> qSts;
     ...
     * {@link QueueStatusXsys00900103 }
     * 
     * 
     * @return
     *     The value of the qSts property.
     */
    public List<QueueStatusXsys00900103> getQSts() {
        if (qSts == null) {
            qSts = new ArrayList<>();
        }
        return this.qSts;
     ...
     * 
     */
    public QueueStatusListXsys00900103 addQSts(QueueStatusXsys00900103 qSts) {
        getQSts().add(qSts);
        return this;
    }
