...
/**
 * Java class for HandleFileRequest complex type.
 * 
 * 
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "HandleFileRequest", propOrder = {
    "fileRequestHandle",
    "status"
})
public class SwHandleFileRequest {
     ...
     *     
     */
    public SwHandleFileRequest setFileRequestHandle(SwFileRequestHandle value) {
     ...
     *     
     */
    public SwHandleFileRequest setStatus(SwGblStatus value) {
        this.status = value;
        return this;
    }
