...
@XmlType(name = "CardPaymentDataSet40", propOrder = {
    "dataSetId",
    "tracblt",
    "dataSetInitr",
    "txTtls",
...
public class CardPaymentDataSet40 {
    ...
    protected CommonData14 cmonData;
    @XmlElement(name = "Tx", required = true)
    protected List<CardPaymentDataSetTransaction13Choice> tx;
     ...
     *     
     */
    public CardPaymentDataSet40 setDataSetId(DataSetIdentification5 value) {
     ...
     *     
     */
    public CardPaymentDataSet40 setDataSetInitr(GenericIdentification176 value) {
     ...
     *     
     */
    public CommonData14 getCmonData() {
        return cmonData;
    }
     ...
     *     
     */
    public CardPaymentDataSet40 setCmonData(CommonData14 value) {
        this.cmonData = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSetTransaction13Choice }
     * 
     * 
     */
    public List<CardPaymentDataSetTransaction13Choice> getTx() {
        if (tx == null) {
            tx = new ArrayList<CardPaymentDataSetTransaction13Choice>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public CardPaymentDataSet40 addTracblt(Traceability8 tracblt) {
     ...
     * 
     */
    public CardPaymentDataSet40 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentDataSet40 addTx(CardPaymentDataSetTransaction13Choice tx) {
        getTx().add(tx);
        return this;
    }
