...
@XmlType(name = "CardPaymentBatchTransfer4", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransfer4 {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet13 }
     * 
     * 
     */
    public List<CardPaymentDataSet13> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<CardPaymentDataSet13>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public CardPaymentBatchTransfer4 addTxTtls(TransactionTotals7 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransfer4 addDataSet(CardPaymentDataSet13 dataSet) {
