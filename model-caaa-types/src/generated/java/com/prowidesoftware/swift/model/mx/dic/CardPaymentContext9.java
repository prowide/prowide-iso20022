...
@XmlType(name = "CardPaymentContext9", propOrder = {
    "pmtCntxt",
    "saleCntxt"
})
public class CardPaymentContext9 {

    @XmlElement(name = "PmtCntxt", required = true)
    protected PaymentContext9 pmtCntxt;
     ...
     * @return
     *     possible object is
     *     {@link PaymentContext9 }
     *     
     */
    public PaymentContext9 getPmtCntxt() {
        return pmtCntxt;
    }
     ...
     *     
     */
    public CardPaymentContext9 setPmtCntxt(PaymentContext9 value) {
        this.pmtCntxt = value;
        return this;
    }
     ...
     *     
     */
    public CardPaymentContext9 setSaleCntxt(SaleContext1 value) {
