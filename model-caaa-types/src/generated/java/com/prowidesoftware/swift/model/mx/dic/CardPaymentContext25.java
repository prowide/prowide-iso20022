...
@XmlType(name = "CardPaymentContext25", propOrder = {
    "pmtCntxt",
    "saleCntxt"
})
public class CardPaymentContext25 {
    ...
    protected PaymentContext25 pmtCntxt;
     ...
     * @return
     *     possible object is
     *     {@link PaymentContext25 }
     *     
     */
    public PaymentContext25 getPmtCntxt() {
        return pmtCntxt;
    }
     ...
     *     
     */
    public CardPaymentContext25 setPmtCntxt(PaymentContext25 value) {
        this.pmtCntxt = value;
        return this;
    }
     ...
     *     
     */
    public CardPaymentContext25 setSaleCntxt(SaleContext2 value) {
