...
@XmlType(name = "CardPaymentBatchTransfer1", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransfer1 {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet4 }
     * 
     * 
     */
    public List<CardPaymentDataSet4> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<CardPaymentDataSet4>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public CardPaymentBatchTransfer1 addTxTtls(TransactionTotals2 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransfer1 addDataSet(CardPaymentDataSet4 dataSet) {
