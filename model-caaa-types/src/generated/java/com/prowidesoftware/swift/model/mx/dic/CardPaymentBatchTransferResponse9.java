...
@XmlType(name = "CardPaymentBatchTransferResponse9", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransferResponse9 {

    @XmlElement(name = "TxTtls")
    protected List<TransactionTotals12> txTtls;
    @XmlElement(name = "DataSet")
    protected List<CardPaymentDataSet31> dataSet;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet31 }
     * 
     * 
     */
    public List<CardPaymentDataSet31> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<CardPaymentDataSet31>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public CardPaymentBatchTransferResponse9 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransferResponse9 addDataSet(CardPaymentDataSet31 dataSet) {
