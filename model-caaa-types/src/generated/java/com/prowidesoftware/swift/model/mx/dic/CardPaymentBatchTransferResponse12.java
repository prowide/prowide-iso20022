...
@XmlType(name = "CardPaymentBatchTransferResponse12", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransferResponse12 {

    @XmlElement(name = "TxTtls")
    protected List<TransactionTotals12> txTtls;
    @XmlElement(name = "DataSet")
    protected List<CardPaymentDataSet39> dataSet;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet39 }
     * 
     * 
     */
    public List<CardPaymentDataSet39> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<CardPaymentDataSet39>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public CardPaymentBatchTransferResponse12 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransferResponse12 addDataSet(CardPaymentDataSet39 dataSet) {
