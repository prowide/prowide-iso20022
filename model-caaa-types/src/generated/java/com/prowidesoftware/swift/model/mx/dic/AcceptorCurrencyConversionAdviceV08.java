...
@XmlType(name = "AcceptorCurrencyConversionAdviceV08", propOrder = {
    "hdr",
    "accptrCcyConvsAdvc",
    "sctyTrlr"
})
public class AcceptorCurrencyConversionAdviceV08 {

    @XmlElement(name = "Hdr", required = true)
    protected Header70 hdr;
    @XmlElement(name = "AccptrCcyConvsAdvc", required = true)
    protected AcceptorCurrencyConversionAdvice8 accptrCcyConvsAdvc;
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceV08 setHdr(Header70 value) {
        this.hdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCurrencyConversionAdvice8 }
     *     
     */
    public AcceptorCurrencyConversionAdvice8 getAccptrCcyConvsAdvc() {
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceV08 setAccptrCcyConvsAdvc(AcceptorCurrencyConversionAdvice8 value) {
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceV08 setSctyTrlr(ContentInformationType37 value) {
        this.sctyTrlr = value;
        return this;
    }
