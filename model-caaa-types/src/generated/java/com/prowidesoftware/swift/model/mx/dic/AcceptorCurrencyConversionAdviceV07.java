...
@XmlType(name = "AcceptorCurrencyConversionAdviceV07", propOrder = {
    "hdr",
    "accptrCcyConvsAdvc",
    "sctyTrlr"
})
public class AcceptorCurrencyConversionAdviceV07 {

    @XmlElement(name = "Hdr", required = true)
    protected Header70 hdr;
    @XmlElement(name = "AccptrCcyConvsAdvc", required = true)
    protected AcceptorCurrencyConversionAdvice7 accptrCcyConvsAdvc;
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceV07 setHdr(Header70 value) {
        this.hdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCurrencyConversionAdvice7 }
     *     
     */
    public AcceptorCurrencyConversionAdvice7 getAccptrCcyConvsAdvc() {
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceV07 setAccptrCcyConvsAdvc(AcceptorCurrencyConversionAdvice7 value) {
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceV07 setSctyTrlr(ContentInformationType36 value) {
        this.sctyTrlr = value;
        return this;
    }
