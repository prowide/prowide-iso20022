...
@XmlType(name = "CardPaymentBatchTransferResponse3", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransferResponse3 {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet12 }
     * 
     * 
     */
    public List<CardPaymentDataSet12> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<CardPaymentDataSet12>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public CardPaymentBatchTransferResponse3 addTxTtls(TransactionTotals3 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransferResponse3 addDataSet(CardPaymentDataSet12 dataSet) {
