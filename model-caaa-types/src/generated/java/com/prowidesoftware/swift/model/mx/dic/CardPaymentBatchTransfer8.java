...
@XmlType(name = "CardPaymentBatchTransfer8", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransfer8 {

    @XmlElement(name = "TxTtls")
    protected List<TransactionTotals7> txTtls;
    @XmlElement(name = "DataSet")
    protected List<CardPaymentDataSet23> dataSet;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet23 }
     * 
     * 
     */
    public List<CardPaymentDataSet23> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<CardPaymentDataSet23>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public CardPaymentBatchTransfer8 addTxTtls(TransactionTotals7 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransfer8 addDataSet(CardPaymentDataSet23 dataSet) {
