...
@XmlType(name = "CardPaymentTransaction54", propOrder = {
    "authstnRslt",
    "txVrfctnRslt",
    "allwdPdctCd",
    "notAllwdPdctCd",
...
public class CardPaymentTransaction54 {
    ...
    protected CurrencyConversion6 ccyConvsElgblty;
     ...
     *     
     */
    public CardPaymentTransaction54 setAuthstnRslt(AuthorisationResult10 value) {
     ...
     *     
     */
    public CardPaymentTransaction54 setBal(AmountAndDirection41 value) {
        this.bal = value;
        return this;
    }
     ...
     *     
     */
    public CardPaymentTransaction54 setPrtctdBal(ContentInformationType10 value) {
     ...
     *     
     */
    public CurrencyConversion6 getCcyConvsElgblty() {
     ...
     *     
     */
    public CardPaymentTransaction54 setCcyConvsElgblty(CurrencyConversion6 value) {
     ...
     * 
     */
    public CardPaymentTransaction54 addTxVrfctnRslt(TransactionVerificationResult4 txVrfctnRslt) {
     ...
     * 
     */
    public CardPaymentTransaction54 addAllwdPdctCd(Product4 allwdPdctCd) {
     ...
     * 
     */
    public CardPaymentTransaction54 addNotAllwdPdctCd(Product4 notAllwdPdctCd) {
     ...
     * 
     */
    public CardPaymentTransaction54 addAddtlAvlblPdct(Product5 addtlAvlblPdct) {
     ...
     * 
     */
    public CardPaymentTransaction54 addActn(Action6 actn) {
        getActn().add(actn);
        return this;
    }
