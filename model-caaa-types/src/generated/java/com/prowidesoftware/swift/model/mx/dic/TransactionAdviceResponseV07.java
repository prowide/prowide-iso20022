...
@XmlType(name = "TransactionAdviceResponseV07", propOrder = {
    "hdr",
    "txAdvcRspn",
    "sctyTrlr"
})
public class TransactionAdviceResponseV07 {

    @XmlElement(name = "Hdr", required = true)
    protected Header70 hdr;
    @XmlElement(name = "TxAdvcRspn", required = true)
    protected AcceptorCompletionAdviceResponse14 txAdvcRspn;
     ...
     *     
     */
    public TransactionAdviceResponseV07 setHdr(Header70 value) {
        this.hdr = value;
        return this;
    }
     ...
     *     
     */
    public AcceptorCompletionAdviceResponse14 getTxAdvcRspn() {
        return txAdvcRspn;
    }
     ...
     *     
     */
    public TransactionAdviceResponseV07 setTxAdvcRspn(AcceptorCompletionAdviceResponse14 value) {
     ...
     *     
     */
    public TransactionAdviceResponseV07 setSctyTrlr(ContentInformationType37 value) {
        this.sctyTrlr = value;
        return this;
    }
