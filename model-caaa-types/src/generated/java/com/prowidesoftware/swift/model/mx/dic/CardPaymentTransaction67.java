...
public class CardPaymentTransaction67 {
     ...
     *     
     */
    public CardPaymentTransaction67 setBal(AmountAndDirection41 value) {
        this.bal = value;
        return this;
    }
     ...
     *     
     */
    public CardPaymentTransaction67 setPrtctdBal(ContentInformationType10 value) {
     ...
     *     
     */
    public CardPaymentTransaction67 setCcyConvsElgblty(CurrencyConversion12 value) {
     ...
     * 
     */
    public CardPaymentTransaction67 addTxVrfctnRslt(TransactionVerificationResult4 txVrfctnRslt) {
     ...
     * 
     */
    public CardPaymentTransaction67 addAllwdPdctCd(Product4 allwdPdctCd) {
     ...
     * 
     */
    public CardPaymentTransaction67 addNotAllwdPdctCd(Product4 notAllwdPdctCd) {
     ...
     * 
     */
    public CardPaymentTransaction67 addAddtlAvlblPdct(Product5 addtlAvlblPdct) {
     ...
     * 
     */
    public CardPaymentTransaction67 addActn(Action8 actn) {
        getActn().add(actn);
        return this;
    }
