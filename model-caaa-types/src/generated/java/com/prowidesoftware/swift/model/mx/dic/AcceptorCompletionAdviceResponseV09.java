...
@XmlType(name = "AcceptorCompletionAdviceResponseV09", propOrder = {
    "hdr",
    "cmpltnAdvcRspn",
    "sctyTrlr"
})
public class AcceptorCompletionAdviceResponseV09 {

    @XmlElement(name = "Hdr", required = true)
    protected Header59 hdr;
    @XmlElement(name = "CmpltnAdvcRspn", required = true)
    protected AcceptorCompletionAdviceResponse9 cmpltnAdvcRspn;
     ...
     *     
     */
    public AcceptorCompletionAdviceResponseV09 setHdr(Header59 value) {
        this.hdr = value;
        return this;
    }
     ...
     *     
     */
    public AcceptorCompletionAdviceResponse9 getCmpltnAdvcRspn() {
     ...
     *     
     */
    public AcceptorCompletionAdviceResponseV09 setCmpltnAdvcRspn(AcceptorCompletionAdviceResponse9 value) {
     ...
     *     
     */
    public AcceptorCompletionAdviceResponseV09 setSctyTrlr(ContentInformationType27 value) {
        this.sctyTrlr = value;
        return this;
    }
