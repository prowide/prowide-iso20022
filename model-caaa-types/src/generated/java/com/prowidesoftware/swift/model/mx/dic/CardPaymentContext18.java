...
@XmlType(name = "CardPaymentContext18", propOrder = {
    "pmtCntxt",
    "saleCntxt"
})
public class CardPaymentContext18 {
    ...
    protected PaymentContext18 pmtCntxt;
     ...
     * @return
     *     possible object is
     *     {@link PaymentContext18 }
     *     
     */
    public PaymentContext18 getPmtCntxt() {
        return pmtCntxt;
    }
     ...
     *     
     */
    public CardPaymentContext18 setPmtCntxt(PaymentContext18 value) {
        this.pmtCntxt = value;
        return this;
    }
     ...
     *     
     */
    public CardPaymentContext18 setSaleCntxt(SaleContext2 value) {
