...
@XmlType(name = "NonFinancialResponseContentComponent4", propOrder = {
    "nonFinReqTp",
    "acqrrSelctd",
    "rskMgmtRslt",
    "instlmt",
...
public class NonFinancialResponseContentComponent4 {
     ...
     *     
     */
    public NonFinancialResponseContentComponent4 setNonFinReqTp(NonFinancialRequestType2Code value) {
     ...
     *     
     */
    public NonFinancialResponseContentComponent4 setAcqrrSelctd(Acquirer10 value) {
     ...
     *     
     */
    public NonFinancialResponseContentComponent4 setRskMgmtRslt(NonFinancialResponseRisk1Code value) {
     ...
     *     
     */
    public NonFinancialResponseContentComponent4 setRspn(ResponseType11 value) {
        this.rspn = value;
        return this;
    }
     ...
     * 
     */
    public NonFinancialResponseContentComponent4 addInstlmt(RecurringTransaction6 instlmt) {
     ...
     * 
     */
    public NonFinancialResponseContentComponent4 addAddtlRspn(ExternallyDefinedData5 addtlRspn) {
     ...
     * 
     */
    public NonFinancialResponseContentComponent4 addActn(Action15 actn) {
        getActn().add(actn);
        return this;
    }
