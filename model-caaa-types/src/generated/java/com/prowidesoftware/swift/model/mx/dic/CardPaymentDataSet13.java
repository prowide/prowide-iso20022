...
@XmlType(name = "CardPaymentDataSet13", propOrder = {
    "dataSetId",
    "tracblt",
    "dataSetInitr",
    "txTtls",
...
public class CardPaymentDataSet13 {
    ...
    protected CommonData5 cmonData;
    @XmlElement(name = "Tx", required = true)
    protected List<CardPaymentDataSetTransaction4Choice> tx;
     ...
     *     
     */
    public CardPaymentDataSet13 setDataSetId(DataSetIdentification5 value) {
     ...
     *     
     */
    public CardPaymentDataSet13 setDataSetInitr(GenericIdentification53 value) {
     ...
     *     
     */
    public CommonData5 getCmonData() {
        return cmonData;
    }
     ...
     *     
     */
    public CardPaymentDataSet13 setCmonData(CommonData5 value) {
        this.cmonData = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSetTransaction4Choice }
     * 
     * 
     */
    public List<CardPaymentDataSetTransaction4Choice> getTx() {
        if (tx == null) {
            tx = new ArrayList<CardPaymentDataSetTransaction4Choice>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public CardPaymentDataSet13 addTracblt(Traceability5 tracblt) {
     ...
     * 
     */
    public CardPaymentDataSet13 addTxTtls(TransactionTotals7 txTtls) {
     ...
     * 
     */
    public CardPaymentDataSet13 addTx(CardPaymentDataSetTransaction4Choice tx) {
        getTx().add(tx);
        return this;
    }
