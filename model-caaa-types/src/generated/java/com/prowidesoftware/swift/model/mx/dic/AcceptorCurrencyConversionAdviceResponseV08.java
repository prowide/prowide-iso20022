...
@XmlType(name = "AcceptorCurrencyConversionAdviceResponseV08", propOrder = {
    "hdr",
    "ccyConvsAdvcRspn",
    "sctyTrlr"
})
public class AcceptorCurrencyConversionAdviceResponseV08 {

    @XmlElement(name = "Hdr", required = true)
    protected Header70 hdr;
    @XmlElement(name = "CcyConvsAdvcRspn", required = true)
    protected AcceptorCancellationAdviceResponse13 ccyConvsAdvcRspn;
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceResponseV08 setHdr(Header70 value) {
        this.hdr = value;
        return this;
    }
     ...
     *     
     */
    public AcceptorCancellationAdviceResponse13 getCcyConvsAdvcRspn() {
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceResponseV08 setCcyConvsAdvcRspn(AcceptorCancellationAdviceResponse13 value) {
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceResponseV08 setSctyTrlr(ContentInformationType37 value) {
        this.sctyTrlr = value;
        return this;
    }
