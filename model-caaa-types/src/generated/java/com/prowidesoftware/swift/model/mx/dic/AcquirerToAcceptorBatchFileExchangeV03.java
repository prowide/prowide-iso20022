...
@XmlType(name = "AcquirerToAcceptorBatchFileExchangeV03", propOrder = {
    "hdr",
    "bodyElmt",
    "rspn",
    "sctyTrlr"
})
public class AcquirerToAcceptorBatchFileExchangeV03 {

    @XmlElement(name = "Hdr", required = true)
    protected Header56 hdr;
    @XmlElement(name = "BodyElmt")
    protected List<AcquirerToAcceptorFileBody3> bodyElmt;
     ...
     *     
     */
    public AcquirerToAcceptorBatchFileExchangeV03 setHdr(Header56 value) {
        this.hdr = value;
        return this;
    }
     ...
     * {@link AcquirerToAcceptorFileBody3 }
     * 
     * 
     * @return
     *     The value of the bodyElmt property.
     */
    public List<AcquirerToAcceptorFileBody3> getBodyElmt() {
        if (bodyElmt == null) {
     ...
     *     
     */
    public AcquirerToAcceptorBatchFileExchangeV03 setRspn(ResponseType11 value) {
        this.rspn = value;
        return this;
    }
     ...
     *     
     */
    public AcquirerToAcceptorBatchFileExchangeV03 setSctyTrlr(ContentInformationType38 value) {
        this.sctyTrlr = value;
        return this;
    }
     ...
     * 
     */
    public AcquirerToAcceptorBatchFileExchangeV03 addBodyElmt(AcquirerToAcceptorFileBody3 bodyElmt) {
