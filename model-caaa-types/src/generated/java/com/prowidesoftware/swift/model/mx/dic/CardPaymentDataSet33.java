...
public class CardPaymentDataSet33 {
    ...
    public List<CardPaymentDataSet32> getRjctdTx() {
        if (rjctdTx == null) {
            rjctdTx = new ArrayList<CardPaymentDataSet32>();
        }
        return this.rjctdTx;
    }
    ...
    public List<CardPaymentDataSet32> getSspdTx() {
        if (sspdTx == null) {
            sspdTx = new ArrayList<CardPaymentDataSet32>();
        }
        return this.sspdTx;
    }
    ...
    public List<CardPaymentDataSet32> getRsmdApprvl() {
        if (rsmdApprvl == null) {
            rsmdApprvl = new ArrayList<CardPaymentDataSet32>();
        }
    ...
    public List<CardPaymentDataSet32> getRsmdRjctn() {
        if (rsmdRjctn == null) {
            rsmdRjctn = new ArrayList<CardPaymentDataSet32>();
        }
