...
@XmlType(name = "CardPaymentTransaction27", propOrder = {
    "authstnRslt",
    "actn"
})
public class CardPaymentTransaction27 {
     ...
     *     
     */
    public CardPaymentTransaction27 setAuthstnRslt(AuthorisationResult3 value) {
     ...
     * 
     */
    public CardPaymentTransaction27 addActn(Action1 actn) {
        getActn().add(actn);
        return this;
    }
