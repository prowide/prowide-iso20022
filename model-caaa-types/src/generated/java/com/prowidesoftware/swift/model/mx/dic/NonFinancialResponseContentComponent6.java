...
@XmlType(name = "NonFinancialResponseContentComponent6", propOrder = {
    "nonFinReqTp",
    "acqrrSelctd",
    "rskMgmtRslt",
    "instlmt",
...
public class NonFinancialResponseContentComponent6 {
     ...
     *     
     */
    public NonFinancialResponseContentComponent6 setNonFinReqTp(NonFinancialRequestType2Code value) {
     ...
     *     
     */
    public NonFinancialResponseContentComponent6 setAcqrrSelctd(Acquirer10 value) {
     ...
     *     
     */
    public NonFinancialResponseContentComponent6 setRskMgmtRslt(NonFinancialResponseRisk1Code value) {
     ...
     */
    public List<RecurringTransaction7> getInstlmt() {
        if (instlmt == null) {
     ...
     *     
     */
    public NonFinancialResponseContentComponent6 setRspn(ResponseType11 value) {
        this.rspn = value;
        return this;
    }
     ...
     * 
     */
    public NonFinancialResponseContentComponent6 addInstlmt(RecurringTransaction7 instlmt) {
     ...
     * 
     */
    public NonFinancialResponseContentComponent6 addAddtlRspn(ExternallyDefinedData5 addtlRspn) {
     ...
     * 
     */
    public NonFinancialResponseContentComponent6 addActn(Action18 actn) {
        getActn().add(actn);
        return this;
    }
