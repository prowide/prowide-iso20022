...
@XmlType(name = "CardPaymentBatchTransfer14", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransfer14 {

    @XmlElement(name = "TxTtls")
    protected List<TransactionTotals12> txTtls;
    @XmlElement(name = "DataSet")
    protected List<CardPaymentDataSet43> dataSet;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet43 }
     * 
     * 
     * @return
     *     The value of the dataSet property.
     */
    public List<CardPaymentDataSet43> getDataSet() {
        if (dataSet == null) {
     ...
     * 
     */
    public CardPaymentBatchTransfer14 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransfer14 addDataSet(CardPaymentDataSet43 dataSet) {
