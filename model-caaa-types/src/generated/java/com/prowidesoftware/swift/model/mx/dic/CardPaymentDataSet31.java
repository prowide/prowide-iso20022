...
@XmlType(name = "CardPaymentDataSet31", propOrder = {
    "dataSetId",
    "dataSetRslt",
    "rmvDataSet",
    "dataSetInitr",
...
public class CardPaymentDataSet31 {
    ...
    protected List<CardPaymentDataSet30> rjctdTx;
    @XmlElement(name = "SspdTx")
    protected List<CardPaymentDataSet30> sspdTx;
    @XmlElement(name = "RsmdApprvl")
    protected List<CardPaymentDataSet30> rsmdApprvl;
    @XmlElement(name = "RsmdRjctn")
    protected List<CardPaymentDataSet30> rsmdRjctn;
     ...
     *     
     */
    public CardPaymentDataSet31 setDataSetId(DataSetIdentification5 value) {
     ...
     *     
     */
    public CardPaymentDataSet31 setDataSetRslt(ResponseType10 value) {
     ...
     * 
     */
    public CardPaymentDataSet31 setRmvDataSet(boolean value) {
     ...
     *     
     */
    public CardPaymentDataSet31 setDataSetInitr(GenericIdentification176 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet30 }
     * 
     * 
     */
    public List<CardPaymentDataSet30> getRjctdTx() {
        if (rjctdTx == null) {
            rjctdTx = new ArrayList<CardPaymentDataSet30>();
        }
        return this.rjctdTx;
    }
     ...
     * 
     */
    public List<CardPaymentDataSet30> getSspdTx() {
        if (sspdTx == null) {
            sspdTx = new ArrayList<CardPaymentDataSet30>();
        }
        return this.sspdTx;
    }
     ...
     * 
     */
    public List<CardPaymentDataSet30> getRsmdApprvl() {
        if (rsmdApprvl == null) {
            rsmdApprvl = new ArrayList<CardPaymentDataSet30>();
        }
     ...
     * 
     */
    public List<CardPaymentDataSet30> getRsmdRjctn() {
        if (rsmdRjctn == null) {
            rsmdRjctn = new ArrayList<CardPaymentDataSet30>();
        }
     ...
     * 
     */
    public CardPaymentDataSet31 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentDataSet31 addRjctdTx(CardPaymentDataSet30 rjctdTx) {
     ...
     * 
     */
    public CardPaymentDataSet31 addSspdTx(CardPaymentDataSet30 sspdTx) {
     ...
     * 
     */
    public CardPaymentDataSet31 addRsmdApprvl(CardPaymentDataSet30 rsmdApprvl) {
     ...
     * 
     */
    public CardPaymentDataSet31 addRsmdRjctn(CardPaymentDataSet30 rsmdRjctn) {
