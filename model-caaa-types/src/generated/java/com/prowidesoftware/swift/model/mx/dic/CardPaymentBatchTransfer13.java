...
@XmlType(name = "CardPaymentBatchTransfer13", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransfer13 {

    @XmlElement(name = "TxTtls")
    protected List<TransactionTotals12> txTtls;
    @XmlElement(name = "DataSet")
    protected List<CardPaymentDataSet40> dataSet;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet40 }
     * 
     * 
     */
    public List<CardPaymentDataSet40> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<CardPaymentDataSet40>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public CardPaymentBatchTransfer13 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransfer13 addDataSet(CardPaymentDataSet40 dataSet) {
