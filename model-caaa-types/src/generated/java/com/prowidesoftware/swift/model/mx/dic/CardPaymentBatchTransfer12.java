...
@XmlType(name = "CardPaymentBatchTransfer12", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransfer12 {

    @XmlElement(name = "TxTtls")
    protected List<TransactionTotals12> txTtls;
    @XmlElement(name = "DataSet")
    protected List<CardPaymentDataSet37> dataSet;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet37 }
     * 
     * 
     */
    public List<CardPaymentDataSet37> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<CardPaymentDataSet37>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public CardPaymentBatchTransfer12 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransfer12 addDataSet(CardPaymentDataSet37 dataSet) {
