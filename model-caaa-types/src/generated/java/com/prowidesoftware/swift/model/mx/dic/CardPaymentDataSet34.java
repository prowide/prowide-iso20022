...
public class CardPaymentDataSet34 {
     ...
     *     
     */
    public CardPaymentDataSet34 setDataSetId(DataSetIdentification5 value) {
     ...
     *     
     */
    public CardPaymentDataSet34 setDataSetInitr(GenericIdentification176 value) {
     ...
     *     
     */
    public CardPaymentDataSet34 setCmonData(CommonData12 value) {
        this.cmonData = value;
        return this;
    }
    ...
    public List<CardPaymentDataSetTransaction11Choice> getTx() {
        if (tx == null) {
            tx = new ArrayList<CardPaymentDataSetTransaction11Choice>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public CardPaymentDataSet34 addTracblt(Traceability8 tracblt) {
     ...
     * 
     */
    public CardPaymentDataSet34 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentDataSet34 addTx(CardPaymentDataSetTransaction11Choice tx) {
        getTx().add(tx);
        return this;
    }
