...
@XmlType(name = "AcceptorToAcquirerBatchFileExchangeV03", propOrder = {
    "hdr",
    "bodyElmt",
    "sctyTrlr"
})
public class AcceptorToAcquirerBatchFileExchangeV03 {

    @XmlElement(name = "Hdr", required = true)
    protected Header56 hdr;
    @XmlElement(name = "BodyElmt", required = true)
    protected List<AcceptorToAcquirerFileBody3> bodyElmt;
     ...
     *     
     */
    public AcceptorToAcquirerBatchFileExchangeV03 setHdr(Header56 value) {
        this.hdr = value;
        return this;
    }
     ...
     * {@link AcceptorToAcquirerFileBody3 }
     * 
     * 
     * @return
     *     The value of the bodyElmt property.
     */
    public List<AcceptorToAcquirerFileBody3> getBodyElmt() {
        if (bodyElmt == null) {
     ...
     *     
     */
    public AcceptorToAcquirerBatchFileExchangeV03 setSctyTrlr(ContentInformationType38 value) {
        this.sctyTrlr = value;
        return this;
    }
     ...
     * 
     */
    public AcceptorToAcquirerBatchFileExchangeV03 addBodyElmt(AcceptorToAcquirerFileBody3 bodyElmt) {
