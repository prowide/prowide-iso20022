...
public class CardPaymentDataSet24 {
    ...
    public List<CardPaymentDataSet25> getRjctdTx() {
        if (rjctdTx == null) {
            rjctdTx = new ArrayList<CardPaymentDataSet25>();
        }
        return this.rjctdTx;
    }
    ...
    public List<CardPaymentDataSet25> getSspdTx() {
        if (sspdTx == null) {
            sspdTx = new ArrayList<CardPaymentDataSet25>();
        }
        return this.sspdTx;
    }
    ...
    public List<CardPaymentDataSet25> getRsmdApprvl() {
        if (rsmdApprvl == null) {
            rsmdApprvl = new ArrayList<CardPaymentDataSet25>();
        }
    ...
    public List<CardPaymentDataSet25> getRsmdRjctn() {
        if (rsmdRjctn == null) {
            rsmdRjctn = new ArrayList<CardPaymentDataSet25>();
        }
