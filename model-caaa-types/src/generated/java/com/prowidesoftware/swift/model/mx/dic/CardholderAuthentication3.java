...
@XmlType(name = "CardholderAuthentication3", propOrder = {
    "authntcnMtd",
    "authntcnNtty",
    "authntcnVal",
    "crdhldrOnLinePIN",
...
public class CardholderAuthentication3 {
     ...
     *     
     */
    public CardholderAuthentication3 setAuthntcnMtd(AuthenticationMethod2Code value) {
     ...
     *     
     */
    public CardholderAuthentication3 setAuthntcnNtty(AuthenticationEntity1Code value) {
     ...
     *     
     */
    public CardholderAuthentication3 setAuthntcnVal(String value) {
     ...
     *     
     */
    public CardholderAuthentication3 setCrdhldrOnLinePIN(OnLinePIN2 value) {
     ...
     *     
     */
    public CardholderAuthentication3 setAuthntcnColltnInd(String value) {
