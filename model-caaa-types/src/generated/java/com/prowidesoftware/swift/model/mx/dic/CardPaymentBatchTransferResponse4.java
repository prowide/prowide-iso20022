...
@XmlType(name = "CardPaymentBatchTransferResponse4", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransferResponse4 {
    ...
    protected List<CardPaymentDataSet14> dataSet;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet14 }
     * 
     * 
     */
    public List<CardPaymentDataSet14> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<CardPaymentDataSet14>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public CardPaymentBatchTransferResponse4 addTxTtls(TransactionTotals7 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransferResponse4 addDataSet(CardPaymentDataSet14 dataSet) {
