...
@XmlType(name = "AcceptorCurrencyConversionAdviceV09", propOrder = {
    "hdr",
    "accptrCcyConvsAdvc",
    "sctyTrlr"
})
public class AcceptorCurrencyConversionAdviceV09 {

    @XmlElement(name = "Hdr", required = true)
    protected Header70 hdr;
    @XmlElement(name = "AccptrCcyConvsAdvc", required = true)
    protected AcceptorCurrencyConversionAdvice9 accptrCcyConvsAdvc;
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceV09 setHdr(Header70 value) {
        this.hdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCurrencyConversionAdvice9 }
     *     
     */
    public AcceptorCurrencyConversionAdvice9 getAccptrCcyConvsAdvc() {
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceV09 setAccptrCcyConvsAdvc(AcceptorCurrencyConversionAdvice9 value) {
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceV09 setSctyTrlr(ContentInformationType37 value) {
        this.sctyTrlr = value;
        return this;
    }
