...
@XmlType(name = "CardPaymentBatchTransfer11", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransfer11 {

    @XmlElement(name = "TxTtls")
    protected List<TransactionTotals12> txTtls;
    @XmlElement(name = "DataSet")
    protected List<CardPaymentDataSet34> dataSet;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet34 }
     * 
     * 
     */
    public List<CardPaymentDataSet34> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<CardPaymentDataSet34>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public CardPaymentBatchTransfer11 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransfer11 addDataSet(CardPaymentDataSet34 dataSet) {
