...
@XmlType(name = "CardPaymentDataSet42", propOrder = {
    "dataSetId",
    "dataSetRslt",
    "rmvDataSet",
    "dataSetInitr",
...
public class CardPaymentDataSet42 {
    ...
    protected List<CardPaymentDataSet41> rjctdTx;
    @XmlElement(name = "SspdTx")
    protected List<CardPaymentDataSet41> sspdTx;
    @XmlElement(name = "RsmdApprvl")
    protected List<CardPaymentDataSet41> rsmdApprvl;
    @XmlElement(name = "RsmdRjctn")
    protected List<CardPaymentDataSet41> rsmdRjctn;
     ...
     *     
     */
    public CardPaymentDataSet42 setDataSetId(DataSetIdentification5 value) {
     ...
     *     
     */
    public CardPaymentDataSet42 setDataSetRslt(ResponseType10 value) {
     ...
     * 
     */
    public CardPaymentDataSet42 setRmvDataSet(boolean value) {
     ...
     *     
     */
    public CardPaymentDataSet42 setDataSetInitr(GenericIdentification176 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet41 }
     * 
     * 
     * @return
     *     The value of the rjctdTx property.
     */
    public List<CardPaymentDataSet41> getRjctdTx() {
        if (rjctdTx == null) {
     ...
     */
    public List<CardPaymentDataSet41> getSspdTx() {
        if (sspdTx == null) {
     ...
     */
    public List<CardPaymentDataSet41> getRsmdApprvl() {
        if (rsmdApprvl == null) {
     ...
     */
    public List<CardPaymentDataSet41> getRsmdRjctn() {
        if (rsmdRjctn == null) {
     ...
     * 
     */
    public CardPaymentDataSet42 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentDataSet42 addRjctdTx(CardPaymentDataSet41 rjctdTx) {
     ...
     * 
     */
    public CardPaymentDataSet42 addSspdTx(CardPaymentDataSet41 sspdTx) {
     ...
     * 
     */
    public CardPaymentDataSet42 addRsmdApprvl(CardPaymentDataSet41 rsmdApprvl) {
     ...
     * 
     */
    public CardPaymentDataSet42 addRsmdRjctn(CardPaymentDataSet41 rsmdRjctn) {
