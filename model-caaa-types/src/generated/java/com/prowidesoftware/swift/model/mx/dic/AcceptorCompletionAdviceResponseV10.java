...
@XmlType(name = "AcceptorCompletionAdviceResponseV10", propOrder = {
    "hdr",
    "cmpltnAdvcRspn",
    "sctyTrlr"
})
public class AcceptorCompletionAdviceResponseV10 {

    @XmlElement(name = "Hdr", required = true)
    protected Header59 hdr;
    @XmlElement(name = "CmpltnAdvcRspn", required = true)
    protected AcceptorCompletionAdviceResponse10 cmpltnAdvcRspn;
     ...
     *     
     */
    public AcceptorCompletionAdviceResponseV10 setHdr(Header59 value) {
        this.hdr = value;
        return this;
    }
     ...
     *     
     */
    public AcceptorCompletionAdviceResponse10 getCmpltnAdvcRspn() {
     ...
     *     
     */
    public AcceptorCompletionAdviceResponseV10 setCmpltnAdvcRspn(AcceptorCompletionAdviceResponse10 value) {
     ...
     *     
     */
    public AcceptorCompletionAdviceResponseV10 setSctyTrlr(ContentInformationType31 value) {
        this.sctyTrlr = value;
        return this;
    }
