...
@XmlType(name = "AcceptorCurrencyConversionAdviceV06", propOrder = {
    "hdr",
    "accptrCcyConvsAdvc",
    "sctyTrlr"
})
public class AcceptorCurrencyConversionAdviceV06 {

    @XmlElement(name = "Hdr", required = true)
    protected Header59 hdr;
    @XmlElement(name = "AccptrCcyConvsAdvc", required = true)
    protected AcceptorCurrencyConversionAdvice6 accptrCcyConvsAdvc;
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceV06 setHdr(Header59 value) {
        this.hdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCurrencyConversionAdvice6 }
     *     
     */
    public AcceptorCurrencyConversionAdvice6 getAccptrCcyConvsAdvc() {
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceV06 setAccptrCcyConvsAdvc(AcceptorCurrencyConversionAdvice6 value) {
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceV06 setSctyTrlr(ContentInformationType31 value) {
        this.sctyTrlr = value;
        return this;
    }
