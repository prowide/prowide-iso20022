...
@XmlType(name = "CardPaymentBatchTransferResponse13", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransferResponse13 {

    @XmlElement(name = "TxTtls")
    protected List<TransactionTotals12> txTtls;
    @XmlElement(name = "DataSet")
    protected List<CardPaymentDataSet42> dataSet;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet42 }
     * 
     * 
     * @return
     *     The value of the dataSet property.
     */
    public List<CardPaymentDataSet42> getDataSet() {
        if (dataSet == null) {
     ...
     * 
     */
    public CardPaymentBatchTransferResponse13 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransferResponse13 addDataSet(CardPaymentDataSet42 dataSet) {
