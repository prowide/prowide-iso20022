...
@XmlType(name = "AcceptorCurrencyConversionAdviceResponseV09", propOrder = {
    "hdr",
    "ccyConvsAdvcRspn",
    "sctyTrlr"
})
public class AcceptorCurrencyConversionAdviceResponseV09 {

    @XmlElement(name = "Hdr", required = true)
    protected Header70 hdr;
    @XmlElement(name = "CcyConvsAdvcRspn", required = true)
    protected AcceptorCancellationAdviceResponse14 ccyConvsAdvcRspn;
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceResponseV09 setHdr(Header70 value) {
        this.hdr = value;
        return this;
    }
     ...
     *     
     */
    public AcceptorCancellationAdviceResponse14 getCcyConvsAdvcRspn() {
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceResponseV09 setCcyConvsAdvcRspn(AcceptorCancellationAdviceResponse14 value) {
     ...
     *     
     */
    public AcceptorCurrencyConversionAdviceResponseV09 setSctyTrlr(ContentInformationType37 value) {
        this.sctyTrlr = value;
        return this;
    }
