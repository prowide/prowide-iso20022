...
public class CardPaymentBatchTransferResponse10 {
    ...
    public List<CardPaymentDataSet33> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<CardPaymentDataSet33>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public CardPaymentBatchTransferResponse10 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransferResponse10 addDataSet(CardPaymentDataSet33 dataSet) {
