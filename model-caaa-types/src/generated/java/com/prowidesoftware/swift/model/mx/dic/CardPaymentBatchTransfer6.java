...
@XmlType(name = "CardPaymentBatchTransfer6", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransfer6 {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet19 }
     * 
     * 
     */
    public List<CardPaymentDataSet19> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<CardPaymentDataSet19>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public CardPaymentBatchTransfer6 addTxTtls(TransactionTotals7 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransfer6 addDataSet(CardPaymentDataSet19 dataSet) {
