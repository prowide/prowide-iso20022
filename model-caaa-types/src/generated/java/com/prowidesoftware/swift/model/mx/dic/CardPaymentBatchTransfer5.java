...
@XmlType(name = "CardPaymentBatchTransfer5", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransfer5 {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet16 }
     * 
     * 
     */
    public List<CardPaymentDataSet16> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<CardPaymentDataSet16>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public CardPaymentBatchTransfer5 addTxTtls(TransactionTotals7 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransfer5 addDataSet(CardPaymentDataSet16 dataSet) {
