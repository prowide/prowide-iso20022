...
@XmlType(name = "CardPaymentDataSet37", propOrder = {
    "dataSetId",
    "tracblt",
    "dataSetInitr",
    "txTtls",
...
public class CardPaymentDataSet37 {
    ...
    protected CommonData13 cmonData;
    @XmlElement(name = "Tx", required = true)
    protected List<CardPaymentDataSetTransaction12Choice> tx;
     ...
     *     
     */
    public CardPaymentDataSet37 setDataSetId(DataSetIdentification5 value) {
     ...
     *     
     */
    public CardPaymentDataSet37 setDataSetInitr(GenericIdentification176 value) {
     ...
     *     
     */
    public CommonData13 getCmonData() {
        return cmonData;
    }
     ...
     *     
     */
    public CardPaymentDataSet37 setCmonData(CommonData13 value) {
        this.cmonData = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSetTransaction12Choice }
     * 
     * 
     */
    public List<CardPaymentDataSetTransaction12Choice> getTx() {
        if (tx == null) {
            tx = new ArrayList<CardPaymentDataSetTransaction12Choice>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public CardPaymentDataSet37 addTracblt(Traceability8 tracblt) {
     ...
     * 
     */
    public CardPaymentDataSet37 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentDataSet37 addTx(CardPaymentDataSetTransaction12Choice tx) {
        getTx().add(tx);
        return this;
    }
