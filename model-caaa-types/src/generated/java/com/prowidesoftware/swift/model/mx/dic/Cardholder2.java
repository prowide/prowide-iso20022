...
@XmlType(name = "Cardholder2", propOrder = {
    "id",
    "nm",
    "authntcn",
    "adrVrfctn",
...
public class Cardholder2 {
    ...
    protected List<CardholderAuthentication2> authntcn;
     ...
     *     
     */
    public Cardholder2 setNm(String value) {
        this.nm = value;
        return this;
    }
     ...
     * 
     */
    public List<CardholderAuthentication2> getAuthntcn() {
        if (authntcn == null) {
            authntcn = new ArrayList<CardholderAuthentication2>();
        }
     ...
     *     
     */
    public Cardholder2 setAdrVrfctn(AddressVerification1 value) {
     ...
     *     
     */
    public Cardholder2 setPrsnlData(String value) {
     ...
     * 
     */
    public Cardholder2 addId(CardholderIdentification1 id) {
        getId().add(id);
        return this;
    }
     ...
     * 
     */
    public Cardholder2 addAuthntcn(CardholderAuthentication2 authntcn) {
