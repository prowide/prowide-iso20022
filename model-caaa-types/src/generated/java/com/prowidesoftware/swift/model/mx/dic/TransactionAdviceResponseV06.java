...
@XmlType(name = "TransactionAdviceResponseV06", propOrder = {
    "hdr",
    "txAdvcRspn",
    "sctyTrlr"
})
public class TransactionAdviceResponseV06 {

    @XmlElement(name = "Hdr", required = true)
    protected Header70 hdr;
    @XmlElement(name = "TxAdvcRspn", required = true)
    protected AcceptorCompletionAdviceResponse13 txAdvcRspn;
     ...
     *     
     */
    public TransactionAdviceResponseV06 setHdr(Header70 value) {
        this.hdr = value;
        return this;
    }
     ...
     *     
     */
    public AcceptorCompletionAdviceResponse13 getTxAdvcRspn() {
        return txAdvcRspn;
    }
     ...
     *     
     */
    public TransactionAdviceResponseV06 setTxAdvcRspn(AcceptorCompletionAdviceResponse13 value) {
     ...
     *     
     */
    public TransactionAdviceResponseV06 setSctyTrlr(ContentInformationType37 value) {
        this.sctyTrlr = value;
        return this;
    }
