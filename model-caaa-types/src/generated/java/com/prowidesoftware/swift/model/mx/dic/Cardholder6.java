...
@XmlType(name = "Cardholder6", propOrder = {
    "id",
    "nm",
    "authntcn",
    "adrVrfctn",
...
public class Cardholder6 {
    ...
    @XmlElement(name = "Id")
    protected List<PersonIdentification7> id;
    @XmlElement(name = "Nm")
    protected String nm;
     ...
     *     
     */
    public Cardholder6 setNm(String value) {
        this.nm = value;
        return this;
    }
     ...
     *     
     */
    public Cardholder6 setAdrVrfctn(AddressVerification1 value) {
     ...
     *     
     */
    public Cardholder6 setPrsnlData(String value) {
     ...
     * 
     */
    public Cardholder6 addId(PersonIdentification7 id) {
        getId().add(id);
        return this;
    }
     ...
     * 
     */
    public Cardholder6 addAuthntcn(CardholderAuthentication4 authntcn) {
