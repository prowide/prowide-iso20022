...
@XmlType(name = "CardPaymentBatchTransfer9", propOrder = {
    "txTtls",
    "dataSet"
})
public class CardPaymentBatchTransfer9 {

    @XmlElement(name = "TxTtls")
    protected List<TransactionTotals12> txTtls;
    @XmlElement(name = "DataSet")
    protected List<CardPaymentDataSet26> dataSet;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet26 }
     * 
     * 
     */
    public List<CardPaymentDataSet26> getDataSet() {
        if (dataSet == null) {
            dataSet = new ArrayList<CardPaymentDataSet26>();
        }
        return this.dataSet;
    }
     ...
     * 
     */
    public CardPaymentBatchTransfer9 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentBatchTransfer9 addDataSet(CardPaymentDataSet26 dataSet) {
