...
@XmlType(name = "CardPaymentDataSet39", propOrder = {
    "dataSetId",
    "dataSetRslt",
    "rmvDataSet",
    "dataSetInitr",
...
public class CardPaymentDataSet39 {
    ...
    protected List<CardPaymentDataSet38> rjctdTx;
    @XmlElement(name = "SspdTx")
    protected List<CardPaymentDataSet38> sspdTx;
    @XmlElement(name = "RsmdApprvl")
    protected List<CardPaymentDataSet38> rsmdApprvl;
    @XmlElement(name = "RsmdRjctn")
    protected List<CardPaymentDataSet38> rsmdRjctn;
     ...
     *     
     */
    public CardPaymentDataSet39 setDataSetId(DataSetIdentification5 value) {
     ...
     *     
     */
    public CardPaymentDataSet39 setDataSetRslt(ResponseType10 value) {
     ...
     * 
     */
    public CardPaymentDataSet39 setRmvDataSet(boolean value) {
     ...
     *     
     */
    public CardPaymentDataSet39 setDataSetInitr(GenericIdentification176 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSet38 }
     * 
     * 
     */
    public List<CardPaymentDataSet38> getRjctdTx() {
        if (rjctdTx == null) {
            rjctdTx = new ArrayList<CardPaymentDataSet38>();
        }
        return this.rjctdTx;
    }
     ...
     * 
     */
    public List<CardPaymentDataSet38> getSspdTx() {
        if (sspdTx == null) {
            sspdTx = new ArrayList<CardPaymentDataSet38>();
        }
        return this.sspdTx;
    }
     ...
     * 
     */
    public List<CardPaymentDataSet38> getRsmdApprvl() {
        if (rsmdApprvl == null) {
            rsmdApprvl = new ArrayList<CardPaymentDataSet38>();
        }
     ...
     * 
     */
    public List<CardPaymentDataSet38> getRsmdRjctn() {
        if (rsmdRjctn == null) {
            rsmdRjctn = new ArrayList<CardPaymentDataSet38>();
        }
     ...
     * 
     */
    public CardPaymentDataSet39 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentDataSet39 addRjctdTx(CardPaymentDataSet38 rjctdTx) {
     ...
     * 
     */
    public CardPaymentDataSet39 addSspdTx(CardPaymentDataSet38 sspdTx) {
     ...
     * 
     */
    public CardPaymentDataSet39 addRsmdApprvl(CardPaymentDataSet38 rsmdApprvl) {
     ...
     * 
     */
    public CardPaymentDataSet39 addRsmdRjctn(CardPaymentDataSet38 rsmdRjctn) {
