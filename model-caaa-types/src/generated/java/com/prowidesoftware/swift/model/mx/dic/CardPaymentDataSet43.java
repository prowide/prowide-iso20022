...
@XmlType(name = "CardPaymentDataSet43", propOrder = {
    "dataSetId",
    "tracblt",
    "dataSetInitr",
    "txTtls",
...
public class CardPaymentDataSet43 {
    ...
    protected CommonData15 cmonData;
    @XmlElement(name = "Tx", required = true)
    protected List<CardPaymentDataSetTransaction14Choice> tx;
     ...
     *     
     */
    public CardPaymentDataSet43 setDataSetId(DataSetIdentification5 value) {
     ...
     *     
     */
    public CardPaymentDataSet43 setDataSetInitr(GenericIdentification176 value) {
     ...
     *     
     */
    public CommonData15 getCmonData() {
        return cmonData;
    }
     ...
     *     
     */
    public CardPaymentDataSet43 setCmonData(CommonData15 value) {
        this.cmonData = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSetTransaction14Choice }
     * 
     * 
     * @return
     *     The value of the tx property.
     */
    public List<CardPaymentDataSetTransaction14Choice> getTx() {
        if (tx == null) {
            tx = new ArrayList<>();
        }
        return this.tx;
     ...
     * 
     */
    public CardPaymentDataSet43 addTracblt(Traceability8 tracblt) {
     ...
     * 
     */
    public CardPaymentDataSet43 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentDataSet43 addTx(CardPaymentDataSetTransaction14Choice tx) {
        getTx().add(tx);
        return this;
    }
