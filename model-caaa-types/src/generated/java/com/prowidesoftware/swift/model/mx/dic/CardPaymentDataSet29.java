...
@XmlType(name = "CardPaymentDataSet29", propOrder = {
    "dataSetId",
    "tracblt",
    "dataSetInitr",
    "txTtls",
...
public class CardPaymentDataSet29 {
     ...
     *     
     */
    public CardPaymentDataSet29 setDataSetId(DataSetIdentification5 value) {
     ...
     *     
     */
    public CardPaymentDataSet29 setDataSetInitr(GenericIdentification176 value) {
     ...
     *     
     */
    public CardPaymentDataSet29 setCmonData(CommonData11 value) {
        this.cmonData = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CardPaymentDataSetTransaction10Choice }
     * 
     * 
     */
    public List<CardPaymentDataSetTransaction10Choice> getTx() {
        if (tx == null) {
            tx = new ArrayList<CardPaymentDataSetTransaction10Choice>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public CardPaymentDataSet29 addTracblt(Traceability8 tracblt) {
     ...
     * 
     */
    public CardPaymentDataSet29 addTxTtls(TransactionTotals12 txTtls) {
     ...
     * 
     */
    public CardPaymentDataSet29 addTx(CardPaymentDataSetTransaction10Choice tx) {
        getTx().add(tx);
        return this;
    }
