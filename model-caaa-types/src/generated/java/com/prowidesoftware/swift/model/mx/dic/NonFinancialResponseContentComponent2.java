...
@XmlType(name = "NonFinancialResponseContentComponent2", propOrder = {
    "nonFinReqTp",
    "acqrrSelctd",
    "rskMgmtRslt",
    "actn",
...
public class NonFinancialResponseContentComponent2 {
     ...
     *     
     */
    public NonFinancialResponseContentComponent2 setNonFinReqTp(NonFinancialRequestType1Code value) {
     ...
     *     
     */
    public NonFinancialResponseContentComponent2 setAcqrrSelctd(Acquirer10 value) {
     ...
     *     
     */
    public NonFinancialResponseContentComponent2 setRskMgmtRslt(NonFinancialResponseRisk1Code value) {
     ...
     *     
     */
    public NonFinancialResponseContentComponent2 setRspn(ResponseType11 value) {
        this.rspn = value;
        return this;
    }
     ...
     * 
     */
    public NonFinancialResponseContentComponent2 addActn(Action12 actn) {
        getActn().add(actn);
        return this;
    }
