    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Admi00100101 .class, BulkReportBody.class, BulkReportHeader.class, MxAdmi00100101 .class, ProprietaryReportData.class, ReportHeader1 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:admi.001.001.01";
    ...
    public static MxAdmi00100101 parse(String xml) {
        return ((MxAdmi00100101) MxReadImpl.parse(MxAdmi00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi00100101) MxReadImpl.parse(MxAdmi00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAdmi00100101 fromJson(String json) {
