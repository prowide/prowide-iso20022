    ...
    extends AbstractMX
{
    ...
    public static MxAdmi00700101 parse(String xml) {
        return ((MxAdmi00700101) MxReadImpl.parse(MxAdmi00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi00700101) MxReadImpl.parse(MxAdmi00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAdmi00700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi00700101 .class);
    }
