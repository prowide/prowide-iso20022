    ...
    extends AbstractMX
{
    ...
    public static MxAdmi00400102 parse(String xml) {
        return ((MxAdmi00400102) MxReadImpl.parse(MxAdmi00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi00400102) MxReadImpl.parse(MxAdmi00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
