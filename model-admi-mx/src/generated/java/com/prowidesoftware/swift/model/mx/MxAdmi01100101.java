    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Event1 .class, MxAdmi01100101 .class, SupplementaryData1 .class, SupplementaryDataEnvelope1 .class, SystemEventAcknowledgementV01 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:admi.011.001.01";
    ...
    public static MxAdmi01100101 parse(String xml) {
        return ((MxAdmi01100101) MxReadImpl.parse(MxAdmi01100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi01100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi01100101) MxReadImpl.parse(MxAdmi01100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAdmi01100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi01100101 .class);
    }
