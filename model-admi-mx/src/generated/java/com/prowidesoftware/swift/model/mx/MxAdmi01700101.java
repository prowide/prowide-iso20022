    ...
    extends AbstractMX
{
    ...
    public static MxAdmi01700101 parse(String xml) {
        return ((MxAdmi01700101) MxReadImpl.parse(MxAdmi01700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi01700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi01700101) MxReadImpl.parse(MxAdmi01700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAdmi01700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi01700101 .class);
    }
