    ...
    extends AbstractMX
{
    ...
    public static MxAdmi00200101 parse(String xml) {
        return ((MxAdmi00200101) MxReadImpl.parse(MxAdmi00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi00200101) MxReadImpl.parse(MxAdmi00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
