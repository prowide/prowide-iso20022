    ...
    extends AbstractMX
{
    ...
    public final static transient Class[] _classes = new Class[] {MessageReference.class, MessageRejectV01 .class, MxAdmi00200101 .class, RejectionReason2 .class };
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:admi.002.001.01";
     ...
     */
    public final static MxAdmi00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi00200101 .class);
    }
