    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Admi00300101 .class, MessageReference.class, MxAdmi00300101 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:admi.003.001.01";
    ...
    public static MxAdmi00300101 parse(String xml) {
        return ((MxAdmi00300101) MxReadImpl.parse(MxAdmi00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi00300101) MxReadImpl.parse(MxAdmi00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAdmi00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi00300101 .class);
    }
