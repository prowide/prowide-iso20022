    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:admi.017.001.02";
    ...
    public static MxAdmi01700102 parse(String xml) {
        return ((MxAdmi01700102) MxReadImpl.parse(MxAdmi01700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi01700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi01700102) MxReadImpl.parse(MxAdmi01700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAdmi01700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi01700102 .class);
    }
