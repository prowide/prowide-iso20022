    ...
    extends AbstractMX
{
    ...
    public final static transient Class[] _classes = new Class[] {MxAdmi01000102 .class, ReportParameter1 .class, RequestDetails4 .class, RequestDetails5 .class, StaticDataReportV02 .class, SupplementaryData1 .class, SupplementaryDataEnvelope1 .class };
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:admi.010.001.02";
     ...
     */
    public final static MxAdmi01000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi01000102 .class);
    }
