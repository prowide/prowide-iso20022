    ...
    extends AbstractMX
{
    ...
    public static MxAdmi01000102 parse(String xml) {
        return ((MxAdmi01000102) MxReadImpl.parse(MxAdmi01000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi01000102) MxReadImpl.parse(MxAdmi01000102 .class, xml, _classes, new MxReadParams(conf)));
    }
