    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:admi.014.001.01";
    ...
    public static MxAdmi01400101 parse(String xml) {
        return ((MxAdmi01400101) MxReadImpl.parse(MxAdmi01400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi01400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi01400101) MxReadImpl.parse(MxAdmi01400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAdmi01400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi01400101 .class);
    }
