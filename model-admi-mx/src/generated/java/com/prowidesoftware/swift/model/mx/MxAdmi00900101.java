    ...
    extends AbstractMX
{
    ...
    public static MxAdmi00900101 parse(String xml) {
        return ((MxAdmi00900101) MxReadImpl.parse(MxAdmi00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi00900101) MxReadImpl.parse(MxAdmi00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
