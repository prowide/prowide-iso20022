    ...
    extends AbstractMX
{
    ...
    public static MxAdmi00500102 parse(String xml) {
        return ((MxAdmi00500102) MxReadImpl.parse(MxAdmi00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi00500102) MxReadImpl.parse(MxAdmi00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAdmi00500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi00500102 .class);
    }
