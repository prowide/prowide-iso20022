    ...
    extends AbstractMX
{
    ...
    public static MxAdmi01400102 parse(String xml) {
        return ((MxAdmi01400102) MxReadImpl.parse(MxAdmi01400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi01400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi01400102) MxReadImpl.parse(MxAdmi01400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAdmi01400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi01400102 .class);
    }
