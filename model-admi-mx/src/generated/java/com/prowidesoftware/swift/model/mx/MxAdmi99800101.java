    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Admi99800101 .class, MessageReference.class, MxAdmi99800101 .class, ProprietaryData.class };
    public static final transient String NAMESPACE = "urn:swift:xsd:admi.998.001.01";
    ...
    public static MxAdmi99800101 parse(String xml) {
        return ((MxAdmi99800101) MxReadImpl.parse(MxAdmi99800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi99800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi99800101) MxReadImpl.parse(MxAdmi99800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAdmi99800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi99800101 .class);
    }
