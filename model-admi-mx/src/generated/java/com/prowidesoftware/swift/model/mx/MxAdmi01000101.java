    ...
    extends AbstractMX
{
    ...
    public static MxAdmi01000101 parse(String xml) {
        return ((MxAdmi01000101) MxReadImpl.parse(MxAdmi01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi01000101) MxReadImpl.parse(MxAdmi01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAdmi01000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi01000101 .class);
    }
