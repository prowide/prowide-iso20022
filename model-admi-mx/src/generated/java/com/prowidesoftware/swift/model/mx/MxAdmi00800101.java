    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {GeneralInformation3 .class, MessageFunction2Code.class, MxAdmi00800101 .class, RequestorDetails1 .class, ResponderDetails1 .class, SystemStatusRequestOrNotificationV01 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:admi.008.001.01";
    ...
    public static MxAdmi00800101 parse(String xml) {
        return ((MxAdmi00800101) MxReadImpl.parse(MxAdmi00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi00800101) MxReadImpl.parse(MxAdmi00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAdmi00800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi00800101 .class);
    }
