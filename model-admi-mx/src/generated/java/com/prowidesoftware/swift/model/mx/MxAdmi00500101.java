    ...
    extends AbstractMX
{
    ...
    public static MxAdmi00500101 parse(String xml) {
        return ((MxAdmi00500101) MxReadImpl.parse(MxAdmi00500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi00500101) MxReadImpl.parse(MxAdmi00500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAdmi00500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi00500101 .class);
    }
