    ...
    extends AbstractMX
{
    ...
    public static MxAdmi01600101 parse(String xml) {
        return ((MxAdmi01600101) MxReadImpl.parse(MxAdmi01600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi01600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi01600101) MxReadImpl.parse(MxAdmi01600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAdmi01600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi01600101 .class);
    }
