    ...
    extends AbstractMX
{
    ...
    public static MxAdmi00600101 parse(String xml) {
        return ((MxAdmi00600101) MxReadImpl.parse(MxAdmi00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi00600101) MxReadImpl.parse(MxAdmi00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAdmi00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi00600101 .class);
    }
