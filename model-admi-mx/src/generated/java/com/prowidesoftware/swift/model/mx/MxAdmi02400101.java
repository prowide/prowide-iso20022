    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:admi.024.001.01";
    ...
    public static MxAdmi02400101 parse(String xml) {
        return ((MxAdmi02400101) MxReadImpl.parse(MxAdmi02400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi02400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi02400101) MxReadImpl.parse(MxAdmi02400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAdmi02400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi02400101 .class);
    }
