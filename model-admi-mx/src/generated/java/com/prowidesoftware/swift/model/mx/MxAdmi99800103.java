    ...
    extends AbstractMX
{
    ...
    public static MxAdmi99800103 parse(String xml) {
        return ((MxAdmi99800103) MxReadImpl.parse(MxAdmi99800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi99800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi99800103) MxReadImpl.parse(MxAdmi99800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxAdmi99800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi99800103 .class);
    }
