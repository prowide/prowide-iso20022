    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {AdministrationProprietaryMessageV02 .class, MessageReference.class, MxAdmi99800102 .class, ProprietaryData5 .class, SupplementaryDataEnvelope1 .class };
    public static final transient String NAMESPACE = "urn:swift:xsd:admi.998.001.02";
    ...
    public static MxAdmi99800102 parse(String xml) {
        return ((MxAdmi99800102) MxReadImpl.parse(MxAdmi99800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi99800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi99800102) MxReadImpl.parse(MxAdmi99800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAdmi99800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi99800102 .class);
    }
