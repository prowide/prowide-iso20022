    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {Admi00400101 .class, Event1 .class, MxAdmi00400101 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:admi.004.001.01";
    ...
    public static MxAdmi00400101 parse(String xml) {
        return ((MxAdmi00400101) MxReadImpl.parse(MxAdmi00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi00400101) MxReadImpl.parse(MxAdmi00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxAdmi00400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi00400101 .class);
    }
