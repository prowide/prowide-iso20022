    ...
    extends AbstractMX
{
    ...
    public final static transient Class[] _classes = new Class[] {MxAdmi00900102 .class, RequestDetails3 .class, StaticDataRequestV02 .class, SupplementaryData1 .class, SupplementaryDataEnvelope1 .class };
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:admi.009.001.02";
     ...
     */
    public final static MxAdmi00900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxAdmi00900102 .class);
    }
