    ...
    extends AbstractMX
{
    ...
    public static MxAdmi00900102 parse(String xml) {
        return ((MxAdmi00900102) MxReadImpl.parse(MxAdmi00900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxAdmi00900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxAdmi00900102) MxReadImpl.parse(MxAdmi00900102 .class, xml, _classes, new MxReadParams(conf)));
    }
