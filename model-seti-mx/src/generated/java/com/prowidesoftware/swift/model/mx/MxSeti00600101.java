    ...
    extends AbstractMX
{
    ...
    public static MxSeti00600101 parse(String xml) {
        return ((MxSeti00600101) MxReadImpl.parse(MxSeti00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeti00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeti00600101) MxReadImpl.parse(MxSeti00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeti00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeti00600101 .class);
    }
