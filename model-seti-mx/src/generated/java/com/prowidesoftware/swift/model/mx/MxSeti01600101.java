    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seti.016.001.01";
    ...
    public static MxSeti01600101 parse(String xml) {
        return ((MxSeti01600101) MxReadImpl.parse(MxSeti01600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeti01600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeti01600101) MxReadImpl.parse(MxSeti01600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSeti01600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeti01600101 .class);
    }
