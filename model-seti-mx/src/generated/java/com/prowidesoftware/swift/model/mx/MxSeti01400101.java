    ...
    extends AbstractMX
{
    ...
    public static MxSeti01400101 parse(String xml) {
        return ((MxSeti01400101) MxReadImpl.parse(MxSeti01400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeti01400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeti01400101) MxReadImpl.parse(MxSeti01400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeti01400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeti01400101 .class);
    }
