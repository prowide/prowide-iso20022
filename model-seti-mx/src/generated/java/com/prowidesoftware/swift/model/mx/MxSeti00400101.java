    ...
    extends AbstractMX
{
    ...
    public static MxSeti00400101 parse(String xml) {
        return ((MxSeti00400101) MxReadImpl.parse(MxSeti00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeti00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeti00400101) MxReadImpl.parse(MxSeti00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeti00400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeti00400101 .class);
    }
