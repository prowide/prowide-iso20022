    ...
    extends AbstractMX
{
    ...
    public static MxSeti00900101 parse(String xml) {
        return ((MxSeti00900101) MxReadImpl.parse(MxSeti00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeti00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeti00900101) MxReadImpl.parse(MxSeti00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeti00900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeti00900101 .class);
    }
