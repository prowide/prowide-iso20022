    ...
    extends AbstractMX
{
    ...
    public static MxSeti01200101 parse(String xml) {
        return ((MxSeti01200101) MxReadImpl.parse(MxSeti01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeti01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeti01200101) MxReadImpl.parse(MxSeti01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
