    ...
    extends AbstractMX
{
    ...
    public static MxSeti00200101 parse(String xml) {
        return ((MxSeti00200101) MxReadImpl.parse(MxSeti00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeti00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeti00200101) MxReadImpl.parse(MxSeti00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeti00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeti00200101 .class);
    }
