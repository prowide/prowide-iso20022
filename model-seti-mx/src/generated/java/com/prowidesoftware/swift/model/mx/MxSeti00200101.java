...
/**
 * Class for seti.002.001.01 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:seti.002.001.01")
public class MxSeti00200101
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{

    @XmlElement(name = "Qt", required = true)
    protected Quote qt;
     ...
     * 
     */
    public MxSeti00200101(final String xml) {
        this();
        MxSeti00200101 tmp = parse(xml);
        qt = tmp.getQt();
    }
     ...
     * 
     */
    public MxSeti00200101(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxSeti00200101 setQt(Quote value) {
        this.qt = value;
        return this;
    }
     ...
     * 
     */
    public static MxSeti00200101 parse(String xml) {
        return ((MxSeti00200101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeti00200101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeti00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeti00200101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeti00200101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeti00200101 parse(String xml, MxRead parserImpl) {
        return ((MxSeti00200101) parserImpl.read(MxSeti00200101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeti00200101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeti00200101 message
     * @return
     *     a new instance of MxSeti00200101
     */
    public final static MxSeti00200101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeti00200101 .class);
    }
