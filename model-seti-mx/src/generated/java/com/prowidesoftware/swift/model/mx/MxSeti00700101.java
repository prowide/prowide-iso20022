    ...
    extends AbstractMX
{
    ...
    public static MxSeti00700101 parse(String xml) {
        return ((MxSeti00700101) MxReadImpl.parse(MxSeti00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeti00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeti00700101) MxReadImpl.parse(MxSeti00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
