    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seti.007.001.01";
    ...
    public static MxSeti00700101 parse(String xml) {
        return ((MxSeti00700101) MxReadImpl.parse(MxSeti00700101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeti00700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeti00700101 .class);
    }
