    ...
    extends AbstractMX
{
    ...
    public static MxSeti01300101 parse(String xml) {
        return ((MxSeti01300101) MxReadImpl.parse(MxSeti01300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeti01300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeti01300101) MxReadImpl.parse(MxSeti01300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeti01300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeti01300101 .class);
    }
