    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:seti.001.001.01";
    ...
    public static MxSeti00100101 parse(String xml) {
        return ((MxSeti00100101) MxReadImpl.parse(MxSeti00100101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSeti00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeti00100101 .class);
    }
