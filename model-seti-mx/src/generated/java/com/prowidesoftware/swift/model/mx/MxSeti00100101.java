    ...
    extends AbstractMX
{
    ...
    public static MxSeti00100101 parse(String xml) {
        return ((MxSeti00100101) MxReadImpl.parse(MxSeti00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeti00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeti00100101) MxReadImpl.parse(MxSeti00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
