...
/**
 * Class for seti.005.001.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSeti00500101(final String xml) {
        this();
        MxSeti00500101 tmp = parse(xml);
        qtReqRjct = tmp.getQtReqRjct();
    }
     ...
     * 
     */
    public MxSeti00500101(final MxSwiftMessage mxSwiftMessage) {
        this(mxSwiftMessage.message());
    }

    /**
     * Gets the value of the qtReqRjct property.
     * 
     * @return
     *     possible object is
     *     {@link QuoteRequestReject }
     *     
     */
    public QuoteRequestReject getQtReqRjct() {
        return qtReqRjct;
    }

    /**
     * Sets the value of the qtReqRjct property.
     * 
     * @param value
     *     allowed object is
     *     {@link QuoteRequestReject }
     *     
     */
    public MxSeti00500101 setQtReqRjct(QuoteRequestReject value) {
        this.qtReqRjct = value;
        return this;
    }
     ...
     * 
     */
    public static MxSeti00500101 parse(String xml) {
        return ((MxSeti00500101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeti00500101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSeti00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeti00500101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSeti00500101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSeti00500101 parse(String xml, MxRead parserImpl) {
        return ((MxSeti00500101) parserImpl.read(MxSeti00500101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSeti00500101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSeti00500101 message
     * @return
     *     a new instance of MxSeti00500101
     */
    public final static MxSeti00500101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSeti00500101 .class);
    }
