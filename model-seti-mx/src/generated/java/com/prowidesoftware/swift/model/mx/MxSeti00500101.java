    ...
    extends AbstractMX
{
    ...
    public static MxSeti00500101 parse(String xml) {
        return ((MxSeti00500101) MxReadImpl.parse(MxSeti00500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeti00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeti00500101) MxReadImpl.parse(MxSeti00500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSeti00500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSeti00500101 .class);
    }
