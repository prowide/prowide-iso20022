    ...
    extends AbstractMX
{
    ...
    public static MxSeti01500101 parse(String xml) {
        return ((MxSeti01500101) MxReadImpl.parse(MxSeti01500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSeti01500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSeti01500101) MxReadImpl.parse(MxSeti01500101 .class, xml, _classes, new MxReadParams(conf)));
    }
