    ...
    extends AbstractMX
{
    ...
    public static MxCatp01000103 parse(String xml) {
        return ((MxCatp01000103) MxReadImpl.parse(MxCatp01000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp01000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp01000103) MxReadImpl.parse(MxCatp01000103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatp01000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp01000103 .class);
    }
