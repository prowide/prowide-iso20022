    ...
    extends AbstractMX
{
    ...
    public static MxCatp00800103 parse(String xml) {
        return ((MxCatp00800103) MxReadImpl.parse(MxCatp00800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00800103) MxReadImpl.parse(MxCatp00800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatp00800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00800103 .class);
    }
