    ...
    extends AbstractMX
{
    ...
    public static MxCatp00700103 parse(String xml) {
        return ((MxCatp00700103) MxReadImpl.parse(MxCatp00700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00700103) MxReadImpl.parse(MxCatp00700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatp00700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00700103 .class);
    }
