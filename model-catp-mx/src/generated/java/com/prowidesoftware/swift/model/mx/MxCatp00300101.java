    ...
    extends AbstractMX
{
    ...
    public static MxCatp00300101 parse(String xml) {
        return ((MxCatp00300101) MxReadImpl.parse(MxCatp00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00300101) MxReadImpl.parse(MxCatp00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatp00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00300101 .class);
    }
