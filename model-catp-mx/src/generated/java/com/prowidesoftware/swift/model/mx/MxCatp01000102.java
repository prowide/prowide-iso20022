    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catp.010.001.02";
    ...
    public static MxCatp01000102 parse(String xml) {
        return ((MxCatp01000102) MxReadImpl.parse(MxCatp01000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp01000102) MxReadImpl.parse(MxCatp01000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp01000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp01000102 .class);
    }
