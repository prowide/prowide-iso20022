    ...
    extends AbstractMX
{
    ...
    public static MxCatp00600101 parse(String xml) {
        return ((MxCatp00600101) MxReadImpl.parse(MxCatp00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00600101) MxReadImpl.parse(MxCatp00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatp00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00600101 .class);
    }
