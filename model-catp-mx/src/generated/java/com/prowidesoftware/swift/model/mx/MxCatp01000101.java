    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catp.010.001.01";
    ...
    public static MxCatp01000101 parse(String xml) {
        return ((MxCatp01000101) MxReadImpl.parse(MxCatp01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp01000101) MxReadImpl.parse(MxCatp01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp01000101 fromJson(String json) {
