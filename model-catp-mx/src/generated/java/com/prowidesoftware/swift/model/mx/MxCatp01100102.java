    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catp.011.001.02";
    ...
    public static MxCatp01100102 parse(String xml) {
        return ((MxCatp01100102) MxReadImpl.parse(MxCatp01100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp01100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp01100102) MxReadImpl.parse(MxCatp01100102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp01100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp01100102 .class);
    }
