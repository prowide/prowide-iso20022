    ...
    extends AbstractMX
{
    ...
    public static MxCatp00900102 parse(String xml) {
        return ((MxCatp00900102) MxReadImpl.parse(MxCatp00900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00900102) MxReadImpl.parse(MxCatp00900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatp00900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00900102 .class);
    }
