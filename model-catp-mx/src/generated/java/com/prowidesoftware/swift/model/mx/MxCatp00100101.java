    ...
    extends AbstractMX
{
    ...
    public static MxCatp00100101 parse(String xml) {
        return ((MxCatp00100101) MxReadImpl.parse(MxCatp00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00100101) MxReadImpl.parse(MxCatp00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp00100101 fromJson(String json) {
