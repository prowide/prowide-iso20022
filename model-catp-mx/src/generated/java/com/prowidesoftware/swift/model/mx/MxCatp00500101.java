    ...
    extends AbstractMX
{
    ...
    public static MxCatp00500101 parse(String xml) {
        return ((MxCatp00500101) MxReadImpl.parse(MxCatp00500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00500101) MxReadImpl.parse(MxCatp00500101 .class, xml, _classes, new MxReadParams(conf)));
    }
