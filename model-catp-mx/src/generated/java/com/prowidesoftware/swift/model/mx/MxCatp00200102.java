    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catp.002.001.02";
    ...
    public static MxCatp00200102 parse(String xml) {
        return ((MxCatp00200102) MxReadImpl.parse(MxCatp00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00200102) MxReadImpl.parse(MxCatp00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp00200102 fromJson(String json) {
