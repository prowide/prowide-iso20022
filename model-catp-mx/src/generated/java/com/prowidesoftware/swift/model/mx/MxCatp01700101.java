    ...
    extends AbstractMX
{
    ...
    public static MxCatp01700101 parse(String xml) {
        return ((MxCatp01700101) MxReadImpl.parse(MxCatp01700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp01700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp01700101) MxReadImpl.parse(MxCatp01700101 .class, xml, _classes, new MxReadParams(conf)));
    }
