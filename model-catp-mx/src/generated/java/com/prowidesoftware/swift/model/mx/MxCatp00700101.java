    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catp.007.001.01";
    ...
    public static MxCatp00700101 parse(String xml) {
        return ((MxCatp00700101) MxReadImpl.parse(MxCatp00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00700101) MxReadImpl.parse(MxCatp00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp00700101 fromJson(String json) {
