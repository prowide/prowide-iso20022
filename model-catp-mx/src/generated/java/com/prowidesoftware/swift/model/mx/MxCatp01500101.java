    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catp.015.001.01";
    ...
    public static MxCatp01500101 parse(String xml) {
        return ((MxCatp01500101) MxReadImpl.parse(MxCatp01500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp01500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp01500101) MxReadImpl.parse(MxCatp01500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp01500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp01500101 .class);
    }
