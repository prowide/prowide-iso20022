    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catp.008.001.02";
    ...
    public static MxCatp00800102 parse(String xml) {
        return ((MxCatp00800102) MxReadImpl.parse(MxCatp00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00800102) MxReadImpl.parse(MxCatp00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp00800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00800102 .class);
    }
