    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catp.006.001.03";
    ...
    public static MxCatp00600103 parse(String xml) {
        return ((MxCatp00600103) MxReadImpl.parse(MxCatp00600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00600103) MxReadImpl.parse(MxCatp00600103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp00600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00600103 .class);
    }
