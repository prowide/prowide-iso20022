    ...
    extends AbstractMX
{
    ...
    public static MxCatp00800101 parse(String xml) {
        return ((MxCatp00800101) MxReadImpl.parse(MxCatp00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00800101) MxReadImpl.parse(MxCatp00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
