    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catp.009.001.01";
    ...
    public static MxCatp00900101 parse(String xml) {
        return ((MxCatp00900101) MxReadImpl.parse(MxCatp00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00900101) MxReadImpl.parse(MxCatp00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp00900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00900101 .class);
    }
