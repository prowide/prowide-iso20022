    ...
    extends AbstractMX
{
    ...
    public static MxCatp00600102 parse(String xml) {
        return ((MxCatp00600102) MxReadImpl.parse(MxCatp00600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00600102) MxReadImpl.parse(MxCatp00600102 .class, xml, _classes, new MxReadParams(conf)));
    }
