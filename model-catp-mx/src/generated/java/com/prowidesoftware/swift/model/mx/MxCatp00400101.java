    ...
    extends AbstractMX
{
    ...
    public static MxCatp00400101 parse(String xml) {
        return ((MxCatp00400101) MxReadImpl.parse(MxCatp00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00400101) MxReadImpl.parse(MxCatp00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatp00400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00400101 .class);
    }
