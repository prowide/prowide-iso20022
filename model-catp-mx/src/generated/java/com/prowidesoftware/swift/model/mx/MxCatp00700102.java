    ...
    extends AbstractMX
{
    ...
    public static MxCatp00700102 parse(String xml) {
        return ((MxCatp00700102) MxReadImpl.parse(MxCatp00700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00700102) MxReadImpl.parse(MxCatp00700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp00700102 fromJson(String json) {
