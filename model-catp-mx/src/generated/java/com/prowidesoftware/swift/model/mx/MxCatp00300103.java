    ...
    extends AbstractMX
{
    ...
    public static MxCatp00300103 parse(String xml) {
        return ((MxCatp00300103) MxReadImpl.parse(MxCatp00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00300103) MxReadImpl.parse(MxCatp00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatp00300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00300103 .class);
    }
