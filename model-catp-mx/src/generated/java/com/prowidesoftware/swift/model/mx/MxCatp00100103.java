    ...
    extends AbstractMX
{
    ...
    public static MxCatp00100103 parse(String xml) {
        return ((MxCatp00100103) MxReadImpl.parse(MxCatp00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00100103) MxReadImpl.parse(MxCatp00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatp00100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00100103 .class);
    }
