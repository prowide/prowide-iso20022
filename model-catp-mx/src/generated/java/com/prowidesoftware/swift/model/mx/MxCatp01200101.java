    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catp.012.001.01";
    ...
    public static MxCatp01200101 parse(String xml) {
        return ((MxCatp01200101) MxReadImpl.parse(MxCatp01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp01200101) MxReadImpl.parse(MxCatp01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp01200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp01200101 .class);
    }
