    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catp.004.001.02";
    ...
    public static MxCatp00400102 parse(String xml) {
        return ((MxCatp00400102) MxReadImpl.parse(MxCatp00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00400102) MxReadImpl.parse(MxCatp00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00400102 .class);
    }
