    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catp.005.001.02";
    ...
    public static MxCatp00500102 parse(String xml) {
        return ((MxCatp00500102) MxReadImpl.parse(MxCatp00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00500102) MxReadImpl.parse(MxCatp00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp00500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00500102 .class);
    }
