    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:catp.009.001.03";
    ...
    public static MxCatp00900103 parse(String xml) {
        return ((MxCatp00900103) MxReadImpl.parse(MxCatp00900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00900103) MxReadImpl.parse(MxCatp00900103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCatp00900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00900103 .class);
    }
