    ...
    extends AbstractMX
{
    ...
    public static MxCatp00200103 parse(String xml) {
        return ((MxCatp00200103) MxReadImpl.parse(MxCatp00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCatp00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCatp00200103) MxReadImpl.parse(MxCatp00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCatp00200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCatp00200103 .class);
    }
