...
@XmlType(name = "SubscriptionOrderConfirmation1", propOrder = {
    "amdmntInd",
    "mltplExctnDtls",
    "rltdPtyDtls",
    "xtnsn"
...
public class SubscriptionOrderConfirmation1 {
     ...
     * 
     */
    public SubscriptionOrderConfirmation1 setAmdmntInd(boolean value) {
     ...
     *     
     */
    public SubscriptionOrderConfirmation1 setMltplExctnDtls(SubscriptionMultipleExecution3 value) {
     ...
     * 
     */
    public SubscriptionOrderConfirmation1 addRltdPtyDtls(Intermediary9 rltdPtyDtls) {
     ...
     * 
     */
    public SubscriptionOrderConfirmation1 addXtnsn(Extension1 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
