...
@XmlType(name = "TotalCharges3", propOrder = {
    "ttlAmtOfChrgs",
    "chrgDtls"
})
public class TotalCharges3 {
     ...
     *     
     */
    public TotalCharges3 setTtlAmtOfChrgs(ActiveCurrencyAnd13DecimalAmount value) {
    ...
    public List<Charge18> getChrgDtls() {
        if (chrgDtls == null) {
            chrgDtls = new ArrayList<Charge18>();
        }
     ...
     * 
     */
    public TotalCharges3 addChrgDtls(Charge18 chrgDtls) {
