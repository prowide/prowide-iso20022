...
@XmlType(name = "setr.002.001.02", propOrder = {
    "mstrRef",
    "poolRef",
    "prvsRef",
    "ordrToBeCanc"
...
public class Setr00200102 {
    ...
    protected RedemptionBulkOrderInstruction1 ordrToBeCanc;
     ...
     *     
     */
    public Setr00200102 setMstrRef(AdditionalReference3 value) {
        this.mstrRef = value;
        return this;
    }
     ...
     *     
     */
    public Setr00200102 setPoolRef(AdditionalReference3 value) {
        this.poolRef = value;
        return this;
    }
     ...
     *     
     */
    public Setr00200102 setPrvsRef(AdditionalReference3 value) {
        this.prvsRef = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link RedemptionBulkOrderInstruction1 }
     *     
     */
    public RedemptionBulkOrderInstruction1 getOrdrToBeCanc() {
        return ordrToBeCanc;
    }
     ...
     *     
     */
    public Setr00200102 setOrdrToBeCanc(RedemptionBulkOrderInstruction1 value) {
