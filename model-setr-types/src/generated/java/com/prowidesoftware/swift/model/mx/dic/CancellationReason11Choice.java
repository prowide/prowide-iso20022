...
@XmlType(name = "CancellationReason11Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class CancellationReason11Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<AwaitingCancellationReason1> rsn;
     ...
     *     
     */
    public CancellationReason11Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link AwaitingCancellationReason1 }
     * 
     * 
     */
    public List<AwaitingCancellationReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<AwaitingCancellationReason1>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public CancellationReason11Choice addRsn(AwaitingCancellationReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
