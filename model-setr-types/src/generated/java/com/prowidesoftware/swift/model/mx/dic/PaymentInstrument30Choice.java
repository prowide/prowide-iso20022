...
@XmlType(name = "PaymentInstrument30Choice", propOrder = {
    "pmtCardDtls",
    "cdtTrfDtls",
    "drctDbtDtls",
    "chqDtls",
...
public class PaymentInstrument30Choice {
     ...
     *     
     */
    public PaymentInstrument30Choice setPmtCardDtls(PaymentCard34 value) {
     ...
     *     
     */
    public PaymentInstrument30Choice setCdtTrfDtls(CreditTransfer12 value) {
     ...
     *     
     */
    public PaymentInstrument30Choice setDrctDbtDtls(DirectDebitMandate9 value) {
     ...
     *     
     */
    public PaymentInstrument30Choice setChqDtls(Cheque10 value) {
        this.chqDtls = value;
        return this;
    }
     ...
     *     
     */
    public PaymentInstrument30Choice setBkrsDrftDtls(Cheque10 value) {
     ...
     *     
     */
    public PaymentInstrument30Choice setCshAcctDtls(InvestmentAccount60 value) {
     ...
     *     
     */
    public PaymentInstrument30Choice setBlckChainCshWllt(BlockChainAddressWallet14 value) {
