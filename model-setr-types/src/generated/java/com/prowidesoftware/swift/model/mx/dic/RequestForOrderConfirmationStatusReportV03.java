...
@XmlType(name = "RequestForOrderConfirmationStatusReportV03", propOrder = {
    "msgId",
    "reqDtls",
    "xtnsn"
})
public class RequestForOrderConfirmationStatusReportV03 {

    @XmlElement(name = "MsgId", required = true)
    protected MessageIdentification1 msgId;
    @XmlElement(name = "ReqDtls", required = true)
    protected List<MessageAndBusinessReference15> reqDtls;
     ...
     *     
     */
    public RequestForOrderConfirmationStatusReportV03 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
     ...
     * {@link MessageAndBusinessReference15 }
     * 
     * 
     * @return
     *     The value of the reqDtls property.
     */
    public List<MessageAndBusinessReference15> getReqDtls() {
        if (reqDtls == null) {
     ...
     * 
     */
    public RequestForOrderConfirmationStatusReportV03 addReqDtls(MessageAndBusinessReference15 reqDtls) {
     ...
     * 
     */
    public RequestForOrderConfirmationStatusReportV03 addXtnsn(Extension1 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
