...
@XmlType(name = "setr.008.001.02", propOrder = {
    "mstrRef",
    "poolRef",
    "prvsRef",
    "ordrToBeCanc"
...
public class Setr00800102 {
    ...
    protected SubscriptionBulkOrderInstruction1 ordrToBeCanc;
     ...
     *     
     */
    public Setr00800102 setMstrRef(AdditionalReference3 value) {
        this.mstrRef = value;
        return this;
    }
     ...
     *     
     */
    public Setr00800102 setPoolRef(AdditionalReference3 value) {
        this.poolRef = value;
        return this;
    }
     ...
     *     
     */
    public Setr00800102 setPrvsRef(AdditionalReference3 value) {
        this.prvsRef = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link SubscriptionBulkOrderInstruction1 }
     *     
     */
    public SubscriptionBulkOrderInstruction1 getOrdrToBeCanc() {
        return ordrToBeCanc;
    }
     ...
     *     
     */
    public Setr00800102 setOrdrToBeCanc(SubscriptionBulkOrderInstruction1 value) {
