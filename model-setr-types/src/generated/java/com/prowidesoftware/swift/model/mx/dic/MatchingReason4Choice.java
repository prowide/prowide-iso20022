...
@XmlType(name = "MatchingReason4Choice", propOrder = {
    "rsn",
    "noSpcfdRsn"
})
public class MatchingReason4Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<AllegementMatchingReason1> rsn;
     ...
     * {@link AllegementMatchingReason1 }
     * 
     * 
     */
    public List<AllegementMatchingReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<AllegementMatchingReason1>();
        }
        return this.rsn;
    }
     ...
     *     
     */
    public MatchingReason4Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public MatchingReason4Choice addRsn(AllegementMatchingReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
