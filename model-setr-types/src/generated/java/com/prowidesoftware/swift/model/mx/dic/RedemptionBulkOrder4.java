...
@XmlType(name = "RedemptionBulkOrder4", propOrder = {
    "mstrRef",
    "plcOfTrad",
    "ordrDtTm",
    "xpryDtTm",
...
public class RedemptionBulkOrder4 {
    ...
    protected List<RedemptionOrder7> indvOrdrDtls;
     ...
     *     
     */
    public RedemptionBulkOrder4 setMstrRef(String value) {
        this.mstrRef = value;
        return this;
    }
     ...
     *     
     */
    public RedemptionBulkOrder4 setPlcOfTrad(PlaceOfTradeIdentification1Choice value) {
     ...
     *     
     */
    public RedemptionBulkOrder4 setOrdrDtTm(XMLGregorianCalendar value) {
        this.ordrDtTm = value;
        return this;
    }
     ...
     *     
     */
    public RedemptionBulkOrder4 setXpryDtTm(DateAndDateTimeChoice value) {
        this.xpryDtTm = value;
        return this;
    }
     ...
     *     
     */
    public RedemptionBulkOrder4 setReqdFutrTradDt(XMLGregorianCalendar value) {
     ...
     *     
     */
    public RedemptionBulkOrder4 setCxlRght(CancellationRight1Code value) {
        this.cxlRght = value;
        return this;
    }
     ...
     *     
     */
    public RedemptionBulkOrder4 setXtndedCxlRght(String value) {
     ...
     *     
     */
    public RedemptionBulkOrder4 setFinInstrmDtls(FinancialInstrument10 value) {
     ...
     * {@link RedemptionOrder7 }
     * 
     * 
     */
    public List<RedemptionOrder7> getIndvOrdrDtls() {
        if (indvOrdrDtls == null) {
            indvOrdrDtls = new ArrayList<RedemptionOrder7>();
        }
     ...
     *     
     */
    public RedemptionBulkOrder4 setReqdSttlmCcy(String value) {
     ...
     *     
     */
    public RedemptionBulkOrder4 setReqdNAVCcy(String value) {
     ...
     *     
     */
    public RedemptionBulkOrder4 setTtlSttlmAmt(ActiveCurrencyAndAmount value) {
     ...
     *     
     */
    public RedemptionBulkOrder4 setCshSttlmDt(XMLGregorianCalendar value) {
     ...
     *     
     */
    public RedemptionBulkOrder4 setBlkCshSttlmDtls(PaymentTransaction21 value) {
     ...
     * 
     */
    public RedemptionBulkOrder4 addIndvOrdrDtls(RedemptionOrder7 indvOrdrDtls) {
