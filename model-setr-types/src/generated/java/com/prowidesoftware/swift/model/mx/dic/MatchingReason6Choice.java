...
@XmlType(name = "MatchingReason6Choice", propOrder = {
    "rsn",
    "noSpcfdRsn"
})
public class MatchingReason6Choice {

    @XmlElement(name = "Rsn")
    protected List<UnmatchedReason23> rsn;
     ...
     * {@link UnmatchedReason23 }
     * 
     * 
     */
    public List<UnmatchedReason23> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<UnmatchedReason23>();
        }
        return this.rsn;
    }
     ...
     *     
     */
    public MatchingReason6Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public MatchingReason6Choice addRsn(UnmatchedReason23 rsn) {
        getRsn().add(rsn);
        return this;
    }
