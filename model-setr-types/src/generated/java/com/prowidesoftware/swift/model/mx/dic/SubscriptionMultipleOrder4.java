...
@XmlType(name = "SubscriptionMultipleOrder4", propOrder = {
    "mstrRef",
    "plcOfTrad",
    "ordrDtTm",
    "xpryDtTm",
...
public class SubscriptionMultipleOrder4 {
    ...
    protected List<SubscriptionOrder8> indvOrdrDtls;
     ...
     *     
     */
    public SubscriptionMultipleOrder4 setMstrRef(String value) {
        this.mstrRef = value;
        return this;
    }
     ...
     *     
     */
    public SubscriptionMultipleOrder4 setPlcOfTrad(PlaceOfTradeIdentification1Choice value) {
     ...
     *     
     */
    public SubscriptionMultipleOrder4 setOrdrDtTm(XMLGregorianCalendar value) {
        this.ordrDtTm = value;
        return this;
    }
     ...
     *     
     */
    public SubscriptionMultipleOrder4 setXpryDtTm(DateAndDateTimeChoice value) {
        this.xpryDtTm = value;
        return this;
    }
     ...
     *     
     */
    public SubscriptionMultipleOrder4 setReqdFutrTradDt(XMLGregorianCalendar value) {
     ...
     *     
     */
    public SubscriptionMultipleOrder4 setCxlRght(CancellationRight1Code value) {
        this.cxlRght = value;
        return this;
    }
     ...
     *     
     */
    public SubscriptionMultipleOrder4 setXtndedCxlRght(String value) {
     ...
     *     
     */
    public SubscriptionMultipleOrder4 setInvstmtAcctDtls(InvestmentAccount21 value) {
     ...
     *     
     */
    public SubscriptionMultipleOrder4 setBnfcryDtls(IndividualPerson9 value) {
     ...
     * {@link SubscriptionOrder8 }
     * 
     * 
     */
    public List<SubscriptionOrder8> getIndvOrdrDtls() {
        if (indvOrdrDtls == null) {
            indvOrdrDtls = new ArrayList<SubscriptionOrder8>();
        }
     ...
     *     
     */
    public SubscriptionMultipleOrder4 setTtlSttlmAmt(ActiveCurrencyAndAmount value) {
     ...
     *     
     */
    public SubscriptionMultipleOrder4 setCshSttlmDt(XMLGregorianCalendar value) {
     ...
     *     
     */
    public SubscriptionMultipleOrder4 setBlkCshSttlmDtls(PaymentTransaction23 value) {
     ...
     * 
     */
    public SubscriptionMultipleOrder4 addIndvOrdrDtls(SubscriptionOrder8 indvOrdrDtls) {
