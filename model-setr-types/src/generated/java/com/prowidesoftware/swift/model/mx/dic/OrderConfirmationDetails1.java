...
@XmlType(name = "OrderConfirmationDetails1", propOrder = {
    "amdmntInd",
    "blkExctnDtls",
    "rltdPtyDtls",
    "xtnsn"
...
public class OrderConfirmationDetails1 {
     ...
     * 
     */
    public OrderConfirmationDetails1 setAmdmntInd(boolean value) {
     ...
     *     
     */
    public OrderConfirmationDetails1 setBlkExctnDtls(RedemptionBulkExecution3 value) {
     ...
     * 
     */
    public OrderConfirmationDetails1 addRltdPtyDtls(Intermediary9 rltdPtyDtls) {
     ...
     * 
     */
    public OrderConfirmationDetails1 addXtnsn(Extension1 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
