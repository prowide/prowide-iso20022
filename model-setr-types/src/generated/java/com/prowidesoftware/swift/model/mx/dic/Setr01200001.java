 ...
 * USAGE
 * 
 * The SubscriptionOrderConfirmation message is sent by the executing party to the instructing party, after the price has been determined, to confirm the execution of one or more individual orders. 
 * 
 ...
 * 
 * Each individual order confirmation specified is identified in DealReference. The reference of the original individual order is specified in OrderReference. The message reference (MessageIdentification) of the SubscriptionOrder message in which the individual order/s was conveyed may also be quoted in RelatedReference, but this is not recommended.
 * 
 ...
 * 
 * A SubscriptionOrder must in all cases be responded to by a SubscriptionOrderConfirmation message/s and in no circumstances by a SubscriptionBulkOrderConfirmation message/s.
 * 
...
@XmlType(name = "setr.012.000.01", propOrder = {
    "msgId",
    "poolRef",
    "prvsRef",
    "rltdRef",
...
public class Setr01200001 {
    ...
    protected SubscriptionMultipleExecution3 mltplExctnDtls;
     ...
     *     
     */
    public Setr01200001 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
     ...
     *     
     */
    public Setr01200001 setPoolRef(AdditionalReference3 value) {
        this.poolRef = value;
        return this;
    }
     ...
     *     
     */
    public Setr01200001 setRltdRef(AdditionalReference3 value) {
        this.rltdRef = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link SubscriptionMultipleExecution3 }
     *     
     */
    public SubscriptionMultipleExecution3 getMltplExctnDtls() {
     ...
     *     
     */
    public Setr01200001 setMltplExctnDtls(SubscriptionMultipleExecution3 value) {
     ...
     *     
     */
    public Setr01200001 setCpyDtls(CopyInformation2 value) {
        this.cpyDtls = value;
        return this;
    }
     ...
     * 
     */
    public Setr01200001 addPrvsRef(AdditionalReference3 prvsRef) {
     ...
     * 
     */
    public Setr01200001 addRltdPtyDtls(Intermediary9 rltdPtyDtls) {
     ...
     * 
     */
    public Setr01200001 addXtnsn(Extension1 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
