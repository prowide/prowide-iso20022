...
@XmlType(name = "SubscriptionMultipleExecution6", propOrder = {
    "amdmntInd",
    "mstrRef",
    "plcOfTrad",
    "ordrDtTm",
...
public class SubscriptionMultipleExecution6 {
    ...
    protected List<SubscriptionExecution14> indvExctnDtls;
    @XmlElement(name = "TtlSttlmAmt")
    protected ActiveCurrencyAndAmount ttlSttlmAmt;
    @XmlElement(name = "BlkCshSttlmDtls")
    protected PaymentTransaction162 blkCshSttlmDtls;
     ...
     *     
     */
    public SubscriptionMultipleExecution6 setAmdmntInd(Boolean value) {
     ...
     *     
     */
    public SubscriptionMultipleExecution6 setMstrRef(String value) {
        this.mstrRef = value;
        return this;
    }
     ...
     *     
     */
    public SubscriptionMultipleExecution6 setPlcOfTrad(PlaceOfTradeIdentification4Choice value) {
     ...
     *     
     */
    public SubscriptionMultipleExecution6 setOrdrDtTm(XMLGregorianCalendar value) {
        this.ordrDtTm = value;
        return this;
    }
     ...
     *     
     */
    public SubscriptionMultipleExecution6 setRcvdDtTm(XMLGregorianCalendar value) {
        this.rcvdDtTm = value;
        return this;
    }
     ...
     *     
     */
    public SubscriptionMultipleExecution6 setReqdFutrTradDt(XMLGregorianCalendar value) {
     ...
     *     
     */
    public SubscriptionMultipleExecution6 setCxlRght(CancellationRight1Choice value) {
        this.cxlRght = value;
        return this;
    }
     ...
     *     
     */
    public SubscriptionMultipleExecution6 setInvstmtAcctDtls(InvestmentAccount78 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubscriptionExecution14 }
     * 
     * 
     */
    public List<SubscriptionExecution14> getIndvExctnDtls() {
        if (indvExctnDtls == null) {
            indvExctnDtls = new ArrayList<SubscriptionExecution14>();
        }
     ...
     *     
     */
    public SubscriptionMultipleExecution6 setTtlSttlmAmt(ActiveCurrencyAndAmount value) {
     ...
     *     
     */
    public PaymentTransaction162 getBlkCshSttlmDtls() {
     ...
     *     
     */
    public SubscriptionMultipleExecution6 setBlkCshSttlmDtls(PaymentTransaction162 value) {
     ...
     * 
     */
    public SubscriptionMultipleExecution6 addBnfcryDtls(IndividualPerson32 bnfcryDtls) {
     ...
     * 
     */
    public SubscriptionMultipleExecution6 addIndvExctnDtls(SubscriptionExecution14 indvExctnDtls) {
