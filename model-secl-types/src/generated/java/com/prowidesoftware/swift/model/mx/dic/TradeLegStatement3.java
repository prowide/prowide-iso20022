...
public class TradeLegStatement3 {
     ...
     *     
     */
    public TradeLegStatement3 setClrAcct(SecuritiesAccount18 value) {
        this.clrAcct = value;
        return this;
    }
     ...
     *     
     */
    public TradeLegStatement3 setClrSgmt(PartyIdentification35Choice value) {
        this.clrSgmt = value;
        return this;
    }
     ...
     *     
     */
    public TradeLegStatement3 setNonClrMmb(PartyIdentificationAndAccount31 value) {
    ...
    public List<TradeLeg9> getTradLegsDtls() {
        if (tradLegsDtls == null) {
            tradLegsDtls = new ArrayList<TradeLeg9>();
        }
     ...
     * 
     */
    public TradeLegStatement3 addTradLegsDtls(TradeLeg9 tradLegsDtls) {
