...
@XmlType(name = "TradeLegStatement5", propOrder = {
    "clrAcct",
    "clrSgmt",
    "nonClrMmb",
    "tradLegsDtls"
})
public class TradeLegStatement5 {
    ...
    protected List<TradeLeg15> tradLegsDtls;
     ...
     *     
     */
    public TradeLegStatement5 setClrAcct(SecuritiesAccount18 value) {
        this.clrAcct = value;
        return this;
    }
     ...
     *     
     */
    public TradeLegStatement5 setClrSgmt(PartyIdentification253Choice value) {
        this.clrSgmt = value;
        return this;
    }
     ...
     *     
     */
    public TradeLegStatement5 setNonClrMmb(PartyIdentificationAndAccount227 value) {
     ...
     */
    public List<TradeLeg15> getTradLegsDtls() {
     ...
     * 
     */
    public TradeLegStatement5 addTradLegsDtls(TradeLeg15 tradLegsDtls) {
