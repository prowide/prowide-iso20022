...
@XmlType(name = "TradeLegStatement4", propOrder = {
    "clrAcct",
    "clrSgmt",
    "nonClrMmb",
    "tradLegsDtls"
})
public class TradeLegStatement4 {
    ...
    protected List<TradeLeg12> tradLegsDtls;
     ...
     *     
     */
    public TradeLegStatement4 setClrAcct(SecuritiesAccount18 value) {
        this.clrAcct = value;
        return this;
    }
     ...
     *     
     */
    public TradeLegStatement4 setClrSgmt(PartyIdentification253Choice value) {
        this.clrSgmt = value;
        return this;
    }
     ...
     *     
     */
    public TradeLegStatement4 setNonClrMmb(PartyIdentificationAndAccount227 value) {
     ...
     * 
     */
    public List<TradeLeg12> getTradLegsDtls() {
        if (tradLegsDtls == null) {
            tradLegsDtls = new ArrayList<TradeLeg12>();
        }
     ...
     * 
     */
    public TradeLegStatement4 addTradLegsDtls(TradeLeg12 tradLegsDtls) {
