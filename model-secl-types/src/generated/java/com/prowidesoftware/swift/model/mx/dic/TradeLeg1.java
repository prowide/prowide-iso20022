...
public class TradeLeg1 {
     ...
     *     
     */
    public TradeLeg1 setTradDt(OffsetDateTime value) {
        this.tradDt = value;
        return this;
    }
     ...
     * This is why there is not a {@code set} method for the dealPric property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the dealPric property.
     */
    public List<Price4> getDealPric() {
        if (dealPric == null) {
            dealPric = new ArrayList<>();
        }
