...
@XmlType(name = "TradeLegStatementV05", propOrder = {
    "stmtParams",
    "pgntn",
    "clrMmb",
    "clrAcct",
...
public class TradeLegStatementV05 {

    @XmlElement(name = "StmtParams", required = true)
    protected Statement86 stmtParams;
    ...
    protected List<TradeLegStatement5> stmtDtls;
     ...
     *     
     */
    public Statement86 getStmtParams() {
        return stmtParams;
    }
     ...
     *     
     */
    public TradeLegStatementV05 setStmtParams(Statement86 value) {
     ...
     *     
     */
    public TradeLegStatementV05 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public TradeLegStatementV05 setClrMmb(PartyIdentification253Choice value) {
        this.clrMmb = value;
        return this;
    }
     ...
     *     
     */
    public TradeLegStatementV05 setClrAcct(SecuritiesAccount18 value) {
        this.clrAcct = value;
        return this;
    }
     ...
     * {@link TradeLegStatement5 }
     * 
     * 
     * @return
     *     The value of the stmtDtls property.
     */
    public List<TradeLegStatement5> getStmtDtls() {
        if (stmtDtls == null) {
     ...
     * 
     */
    public TradeLegStatementV05 addStmtDtls(TradeLegStatement5 stmtDtls) {
     ...
     * 
     */
    public TradeLegStatementV05 addSplmtryData(SupplementaryData1 splmtryData) {
