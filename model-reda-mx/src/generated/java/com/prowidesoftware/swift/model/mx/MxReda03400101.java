    ...
    extends AbstractMX
{
    ...
    public static MxReda03400101 parse(String xml) {
        return ((MxReda03400101) MxReadImpl.parse(MxReda03400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda03400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda03400101) MxReadImpl.parse(MxReda03400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda03400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda03400101 .class);
    }
