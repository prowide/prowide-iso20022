    ...
    extends AbstractMX
{
    ...
    public static MxReda01800101 parse(String xml) {
        return ((MxReda01800101) MxReadImpl.parse(MxReda01800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda01800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda01800101) MxReadImpl.parse(MxReda01800101 .class, xml, _classes, new MxReadParams(conf)));
    }
