    ...
    extends AbstractMX
{
    ...
    public static MxReda00400103 parse(String xml) {
        return ((MxReda00400103) MxReadImpl.parse(MxReda00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00400103) MxReadImpl.parse(MxReda00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
