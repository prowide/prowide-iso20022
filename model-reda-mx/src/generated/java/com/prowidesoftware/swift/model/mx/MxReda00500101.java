    ...
    extends AbstractMX
{
    ...
    public static MxReda00500101 parse(String xml) {
        return ((MxReda00500101) MxReadImpl.parse(MxReda00500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00500101) MxReadImpl.parse(MxReda00500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda00500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00500101 .class);
    }
