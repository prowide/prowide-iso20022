    ...
    extends AbstractMX
{
    ...
    public static MxReda06800102 parse(String xml) {
        return ((MxReda06800102) MxReadImpl.parse(MxReda06800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda06800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda06800102) MxReadImpl.parse(MxReda06800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda06800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda06800102 .class);
    }
