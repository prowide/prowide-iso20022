    ...
    extends AbstractMX
{
    ...
    public static MxReda03100101 parse(String xml) {
        return ((MxReda03100101) MxReadImpl.parse(MxReda03100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda03100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda03100101) MxReadImpl.parse(MxReda03100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda03100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda03100101 .class);
    }
