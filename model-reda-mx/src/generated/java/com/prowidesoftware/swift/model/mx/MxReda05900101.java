    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.059.001.01";
    ...
    public static MxReda05900101 parse(String xml) {
        return ((MxReda05900101) MxReadImpl.parse(MxReda05900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda05900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda05900101) MxReadImpl.parse(MxReda05900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda05900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda05900101 .class);
    }
