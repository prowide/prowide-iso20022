    ...
    extends AbstractMX
{
    ...
    public static MxReda06100101 parse(String xml) {
        return ((MxReda06100101) MxReadImpl.parse(MxReda06100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda06100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda06100101) MxReadImpl.parse(MxReda06100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda06100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda06100101 .class);
    }
