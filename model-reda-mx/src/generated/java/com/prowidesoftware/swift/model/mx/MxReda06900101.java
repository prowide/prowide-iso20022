    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.069.001.01";
    ...
    public static MxReda06900101 parse(String xml) {
        return ((MxReda06900101) MxReadImpl.parse(MxReda06900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda06900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda06900101) MxReadImpl.parse(MxReda06900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda06900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda06900101 .class);
    }
