    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.047.001.01";
    ...
    public static MxReda04700101 parse(String xml) {
        return ((MxReda04700101) MxReadImpl.parse(MxReda04700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda04700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda04700101) MxReadImpl.parse(MxReda04700101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda04700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda04700101 .class);
    }
