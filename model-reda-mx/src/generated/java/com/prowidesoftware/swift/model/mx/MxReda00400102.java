    ...
    extends AbstractMX
{
    ...
    public static MxReda00400102 parse(String xml) {
        return ((MxReda00400102) MxReadImpl.parse(MxReda00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00400102) MxReadImpl.parse(MxReda00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00400102 .class);
    }
