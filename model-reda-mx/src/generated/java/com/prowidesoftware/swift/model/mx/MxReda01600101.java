    ...
    extends AbstractMX
{
    ...
    public static MxReda01600101 parse(String xml) {
        return ((MxReda01600101) MxReadImpl.parse(MxReda01600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda01600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda01600101) MxReadImpl.parse(MxReda01600101 .class, xml, _classes, new MxReadParams(conf)));
    }
