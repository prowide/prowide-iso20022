    ...
    extends AbstractMX
{
    ...
    public static MxReda00300103 parse(String xml) {
        return ((MxReda00300103) MxReadImpl.parse(MxReda00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00300103) MxReadImpl.parse(MxReda00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
