    ...
    extends AbstractMX
{
    ...
    public static MxReda00500103 parse(String xml) {
        return ((MxReda00500103) MxReadImpl.parse(MxReda00500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00500103) MxReadImpl.parse(MxReda00500103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda00500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00500103 .class);
    }
