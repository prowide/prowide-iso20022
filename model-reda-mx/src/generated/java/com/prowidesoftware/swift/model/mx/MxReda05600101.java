    ...
    extends AbstractMX
{
    ...
    public static MxReda05600101 parse(String xml) {
        return ((MxReda05600101) MxReadImpl.parse(MxReda05600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda05600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda05600101) MxReadImpl.parse(MxReda05600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda05600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda05600101 .class);
    }
