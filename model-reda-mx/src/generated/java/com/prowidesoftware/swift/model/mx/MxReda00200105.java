    ...
    extends AbstractMX
{
    ...
    public static MxReda00200105 parse(String xml) {
        return ((MxReda00200105) MxReadImpl.parse(MxReda00200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00200105) MxReadImpl.parse(MxReda00200105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda00200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00200105 .class);
    }
