    ...
    extends AbstractMX
{
    ...
    public static MxReda00400104 parse(String xml) {
        return ((MxReda00400104) MxReadImpl.parse(MxReda00400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00400104) MxReadImpl.parse(MxReda00400104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda00400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00400104 .class);
    }
