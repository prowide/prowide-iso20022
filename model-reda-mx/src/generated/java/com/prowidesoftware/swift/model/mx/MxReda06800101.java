    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.068.001.01";
    ...
    public static MxReda06800101 parse(String xml) {
        return ((MxReda06800101) MxReadImpl.parse(MxReda06800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda06800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda06800101) MxReadImpl.parse(MxReda06800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda06800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda06800101 .class);
    }
