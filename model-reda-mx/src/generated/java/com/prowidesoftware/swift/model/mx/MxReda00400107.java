    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.004.001.07";
    ...
    public static MxReda00400107 parse(String xml) {
        return ((MxReda00400107) MxReadImpl.parse(MxReda00400107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00400107 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00400107) MxReadImpl.parse(MxReda00400107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda00400107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00400107 .class);
    }
