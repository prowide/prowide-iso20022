    ...
    extends AbstractMX
{
    ...
    public static MxReda05000101 parse(String xml) {
        return ((MxReda05000101) MxReadImpl.parse(MxReda05000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda05000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda05000101) MxReadImpl.parse(MxReda05000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda05000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda05000101 .class);
    }
