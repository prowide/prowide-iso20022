    ...
    extends AbstractMX
{
    ...
    public static MxReda06000102 parse(String xml) {
        return ((MxReda06000102) MxReadImpl.parse(MxReda06000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda06000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda06000102) MxReadImpl.parse(MxReda06000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda06000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda06000102 .class);
    }
