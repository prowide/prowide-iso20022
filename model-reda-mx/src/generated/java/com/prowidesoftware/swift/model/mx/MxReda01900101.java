    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.019.001.01";
    ...
    public static MxReda01900101 parse(String xml) {
        return ((MxReda01900101) MxReadImpl.parse(MxReda01900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda01900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda01900101) MxReadImpl.parse(MxReda01900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda01900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda01900101 .class);
    }
