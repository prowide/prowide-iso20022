    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.014.001.01";
    ...
    public static MxReda01400101 parse(String xml) {
        return ((MxReda01400101) MxReadImpl.parse(MxReda01400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda01400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda01400101) MxReadImpl.parse(MxReda01400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda01400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda01400101 .class);
    }
