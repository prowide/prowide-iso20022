    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.036.001.01";
    ...
    public static MxReda03600101 parse(String xml) {
        return ((MxReda03600101) MxReadImpl.parse(MxReda03600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda03600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda03600101) MxReadImpl.parse(MxReda03600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda03600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda03600101 .class);
    }
