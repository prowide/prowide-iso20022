    ...
    extends AbstractMX
{
    ...
    public static MxReda04200101 parse(String xml) {
        return ((MxReda04200101) MxReadImpl.parse(MxReda04200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda04200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda04200101) MxReadImpl.parse(MxReda04200101 .class, xml, _classes, new MxReadParams(conf)));
    }
