    ...
    extends AbstractMX
{
    ...
    public static MxReda04900101 parse(String xml) {
        return ((MxReda04900101) MxReadImpl.parse(MxReda04900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda04900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda04900101) MxReadImpl.parse(MxReda04900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda04900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda04900101 .class);
    }
