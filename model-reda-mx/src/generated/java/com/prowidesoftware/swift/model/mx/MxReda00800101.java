    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.008.001.01";
    ...
    public static MxReda00800101 parse(String xml) {
        return ((MxReda00800101) MxReadImpl.parse(MxReda00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00800101) MxReadImpl.parse(MxReda00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda00800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00800101 .class);
    }
