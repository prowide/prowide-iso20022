    ...
    extends AbstractMX
{
    ...
    public static MxReda00100105 parse(String xml) {
        return ((MxReda00100105) MxReadImpl.parse(MxReda00100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00100105) MxReadImpl.parse(MxReda00100105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda00100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00100105 .class);
    }
