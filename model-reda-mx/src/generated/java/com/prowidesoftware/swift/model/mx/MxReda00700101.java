    ...
    extends AbstractMX
{
    ...
    public static MxReda00700101 parse(String xml) {
        return ((MxReda00700101) MxReadImpl.parse(MxReda00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00700101) MxReadImpl.parse(MxReda00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda00700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00700101 .class);
    }
