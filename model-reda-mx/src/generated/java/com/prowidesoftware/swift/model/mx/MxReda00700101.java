...
/**
 * Class for reda.007.001.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxReda00700101(final String xml) {
        this();
        MxReda00700101 tmp = parse(xml);
        sctyMntncReq = tmp.getSctyMntncReq();
    }
     ...
     * 
     */
    public MxReda00700101(final MxSwiftMessage mxSwiftMessage) {
        this(mxSwiftMessage.message());
    }

    /**
     * Gets the value of the sctyMntncReq property.
     * 
     * @return
     *     possible object is
     *     {@link SecurityMaintenanceRequestV01 }
     *     
     */
    public SecurityMaintenanceRequestV01 getSctyMntncReq() {
        return sctyMntncReq;
    }

    /**
     * Sets the value of the sctyMntncReq property.
     * 
     * @param value
     *     allowed object is
     *     {@link SecurityMaintenanceRequestV01 }
     *     
     */
    public MxReda00700101 setSctyMntncReq(SecurityMaintenanceRequestV01 value) {
        this.sctyMntncReq = value;
        return this;
    }
     ...
     * 
     */
    public static MxReda00700101 parse(String xml) {
        return ((MxReda00700101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxReda00700101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxReda00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00700101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxReda00700101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxReda00700101 parse(String xml, MxRead parserImpl) {
        return ((MxReda00700101) parserImpl.read(MxReda00700101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxReda00700101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxReda00700101 message
     * @return
     *     a new instance of MxReda00700101
     */
    public static final MxReda00700101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxReda00700101 .class);
    }
