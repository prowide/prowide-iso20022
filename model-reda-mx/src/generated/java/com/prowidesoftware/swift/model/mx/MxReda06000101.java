    ...
    extends AbstractMX
{
    ...
    public static MxReda06000101 parse(String xml) {
        return ((MxReda06000101) MxReadImpl.parse(MxReda06000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda06000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda06000101) MxReadImpl.parse(MxReda06000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda06000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda06000101 .class);
    }
