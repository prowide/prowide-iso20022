    ...
    extends AbstractMX
{
    ...
    public static MxReda06900102 parse(String xml) {
        return ((MxReda06900102) MxReadImpl.parse(MxReda06900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda06900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda06900102) MxReadImpl.parse(MxReda06900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda06900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda06900102 .class);
    }
