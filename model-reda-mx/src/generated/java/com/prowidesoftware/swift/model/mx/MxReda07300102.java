    ...
    extends AbstractMX
{
    ...
    public static MxReda07300102 parse(String xml) {
        return ((MxReda07300102) MxReadImpl.parse(MxReda07300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda07300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda07300102) MxReadImpl.parse(MxReda07300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda07300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda07300102 .class);
    }
