    ...
    extends AbstractMX
{
    ...
    public static MxReda07000101 parse(String xml) {
        return ((MxReda07000101) MxReadImpl.parse(MxReda07000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda07000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda07000101) MxReadImpl.parse(MxReda07000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda07000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda07000101 .class);
    }
