    ...
    extends AbstractMX
{
    ...
    public static MxReda00400105 parse(String xml) {
        return ((MxReda00400105) MxReadImpl.parse(MxReda00400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00400105) MxReadImpl.parse(MxReda00400105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda00400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00400105 .class);
    }
