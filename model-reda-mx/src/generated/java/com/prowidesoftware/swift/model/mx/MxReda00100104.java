    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:reda.001.001.04";
    ...
    public static MxReda00100104 parse(String xml) {
        return ((MxReda00100104) MxReadImpl.parse(MxReda00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00100104) MxReadImpl.parse(MxReda00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda00100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00100104 .class);
    }
