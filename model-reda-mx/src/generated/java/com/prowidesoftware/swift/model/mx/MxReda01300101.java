    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {IdentificationSource3Choice.class, MessageHeader1 .class, MxReda01300101 .class, OtherIdentification1 .class, SecurityDeletionRequestV01 .class, SecurityIdentification39 .class, SupplementaryData1 .class, SupplementaryDataEnvelope1 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.013.001.01";
    ...
    public static MxReda01300101 parse(String xml) {
        return ((MxReda01300101) MxReadImpl.parse(MxReda01300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda01300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda01300101) MxReadImpl.parse(MxReda01300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda01300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda01300101 .class);
    }
