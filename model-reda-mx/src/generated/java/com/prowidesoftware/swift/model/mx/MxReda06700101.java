    ...
    extends AbstractMX
{
    ...
    public static MxReda06700101 parse(String xml) {
        return ((MxReda06700101) MxReadImpl.parse(MxReda06700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda06700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda06700101) MxReadImpl.parse(MxReda06700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda06700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda06700101 .class);
    }
