    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.043.001.01";
    ...
    public static MxReda04300101 parse(String xml) {
        return ((MxReda04300101) MxReadImpl.parse(MxReda04300101 .class, xml, _classes));
    }
     ...
     */
    public final static MxReda04300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda04300101 .class);
    }
