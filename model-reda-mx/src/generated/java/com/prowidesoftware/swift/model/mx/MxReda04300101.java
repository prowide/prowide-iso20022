    ...
    extends AbstractMX
{
    ...
    public static MxReda04300101 parse(String xml) {
        return ((MxReda04300101) MxReadImpl.parse(MxReda04300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda04300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda04300101) MxReadImpl.parse(MxReda04300101 .class, xml, _classes, new MxReadParams(conf)));
    }
