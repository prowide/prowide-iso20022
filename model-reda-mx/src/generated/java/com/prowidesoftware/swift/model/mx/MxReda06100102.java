    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.061.001.02";
    ...
    public static MxReda06100102 parse(String xml) {
        return ((MxReda06100102) MxReadImpl.parse(MxReda06100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda06100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda06100102) MxReadImpl.parse(MxReda06100102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda06100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda06100102 .class);
    }
