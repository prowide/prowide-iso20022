    ...
    extends AbstractMX
{
    ...
    public static MxReda00200102 parse(String xml) {
        return ((MxReda00200102) MxReadImpl.parse(MxReda00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00200102) MxReadImpl.parse(MxReda00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
