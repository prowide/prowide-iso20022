    ...
    extends AbstractMX
{
    ...
    public static MxReda01500101 parse(String xml) {
        return ((MxReda01500101) MxReadImpl.parse(MxReda01500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda01500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda01500101) MxReadImpl.parse(MxReda01500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda01500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda01500101 .class);
    }
