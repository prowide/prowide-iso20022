    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.030.001.01";
    ...
    public static MxReda03000101 parse(String xml) {
        return ((MxReda03000101) MxReadImpl.parse(MxReda03000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda03000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda03000101) MxReadImpl.parse(MxReda03000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda03000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda03000101 .class);
    }
