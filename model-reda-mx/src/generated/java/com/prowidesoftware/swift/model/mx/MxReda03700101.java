    ...
    extends AbstractMX
{
    ...
    public static MxReda03700101 parse(String xml) {
        return ((MxReda03700101) MxReadImpl.parse(MxReda03700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda03700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda03700101) MxReadImpl.parse(MxReda03700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda03700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda03700101 .class);
    }
