    ...
    extends AbstractMX
{
    ...
    public static MxReda02000101 parse(String xml) {
        return ((MxReda02000101) MxReadImpl.parse(MxReda02000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda02000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda02000101) MxReadImpl.parse(MxReda02000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda02000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda02000101 .class);
    }
