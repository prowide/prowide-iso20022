    ...
    extends AbstractMX
{
    ...
    public static MxReda01200101 parse(String xml) {
        return ((MxReda01200101) MxReadImpl.parse(MxReda01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda01200101) MxReadImpl.parse(MxReda01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda01200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda01200101 .class);
    }
