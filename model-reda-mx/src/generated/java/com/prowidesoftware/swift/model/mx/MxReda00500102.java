    ...
    extends AbstractMX
{
    ...
    public static MxReda00500102 parse(String xml) {
        return ((MxReda00500102) MxReadImpl.parse(MxReda00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00500102) MxReadImpl.parse(MxReda00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda00500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00500102 .class);
    }
