    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {GenericIdentification30 .class, MessageHeader1 .class, MxReda03200101 .class, SecuritiesAccount19 .class, SecuritiesAccountDeletionRequestV01 .class, SupplementaryData1 .class, SupplementaryDataEnvelope1 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.032.001.01";
    ...
    public static MxReda03200101 parse(String xml) {
        return ((MxReda03200101) MxReadImpl.parse(MxReda03200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda03200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda03200101) MxReadImpl.parse(MxReda03200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda03200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda03200101 .class);
    }
