    ...
    extends AbstractMX
{
    ...
    public static MxReda05800101 parse(String xml) {
        return ((MxReda05800101) MxReadImpl.parse(MxReda05800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda05800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda05800101) MxReadImpl.parse(MxReda05800101 .class, xml, _classes, new MxReadParams(conf)));
    }
