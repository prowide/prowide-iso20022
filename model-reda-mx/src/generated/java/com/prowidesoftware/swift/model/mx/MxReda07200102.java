    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.072.001.02";
    ...
    public static MxReda07200102 parse(String xml) {
        return ((MxReda07200102) MxReadImpl.parse(MxReda07200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda07200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda07200102) MxReadImpl.parse(MxReda07200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda07200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda07200102 .class);
    }
