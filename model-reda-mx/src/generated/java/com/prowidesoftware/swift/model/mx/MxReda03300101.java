    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.033.001.01";
    ...
    public static MxReda03300101 parse(String xml) {
        return ((MxReda03300101) MxReadImpl.parse(MxReda03300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda03300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda03300101) MxReadImpl.parse(MxReda03300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda03300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda03300101 .class);
    }
