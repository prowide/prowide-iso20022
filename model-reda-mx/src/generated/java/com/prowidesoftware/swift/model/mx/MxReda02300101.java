    ...
    extends AbstractMX
{
    ...
    public static MxReda02300101 parse(String xml) {
        return ((MxReda02300101) MxReadImpl.parse(MxReda02300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda02300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda02300101) MxReadImpl.parse(MxReda02300101 .class, xml, _classes, new MxReadParams(conf)));
    }
