    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.066.001.01";
    ...
    public static MxReda06600101 parse(String xml) {
        return ((MxReda06600101) MxReadImpl.parse(MxReda06600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda06600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda06600101) MxReadImpl.parse(MxReda06600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda06600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda06600101 .class);
    }
