    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.071.001.01";
    ...
    public static MxReda07100101 parse(String xml) {
        return ((MxReda07100101) MxReadImpl.parse(MxReda07100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda07100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda07100101) MxReadImpl.parse(MxReda07100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda07100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda07100101 .class);
    }
