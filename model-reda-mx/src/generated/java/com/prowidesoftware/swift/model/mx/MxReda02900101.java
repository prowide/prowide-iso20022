    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.029.001.01";
    ...
    public static MxReda02900101 parse(String xml) {
        return ((MxReda02900101) MxReadImpl.parse(MxReda02900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda02900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda02900101) MxReadImpl.parse(MxReda02900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda02900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda02900101 .class);
    }
