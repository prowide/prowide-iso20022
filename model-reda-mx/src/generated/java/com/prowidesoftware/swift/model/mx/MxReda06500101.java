    ...
    extends AbstractMX
{
    ...
    public static MxReda06500101 parse(String xml) {
        return ((MxReda06500101) MxReadImpl.parse(MxReda06500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda06500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda06500101) MxReadImpl.parse(MxReda06500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda06500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda06500101 .class);
    }
