    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.066.001.02";
    ...
    public static MxReda06600102 parse(String xml) {
        return ((MxReda06600102) MxReadImpl.parse(MxReda06600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda06600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda06600102) MxReadImpl.parse(MxReda06600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda06600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda06600102 .class);
    }
