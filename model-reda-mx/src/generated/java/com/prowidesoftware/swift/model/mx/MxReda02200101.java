    ...
    extends AbstractMX
{
    ...
    public static MxReda02200101 parse(String xml) {
        return ((MxReda02200101) MxReadImpl.parse(MxReda02200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda02200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda02200101) MxReadImpl.parse(MxReda02200101 .class, xml, _classes, new MxReadParams(conf)));
    }
