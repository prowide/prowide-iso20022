    ...
    extends AbstractMX
{
    ...
    public static MxReda05700101 parse(String xml) {
        return ((MxReda05700101) MxReadImpl.parse(MxReda05700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda05700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda05700101) MxReadImpl.parse(MxReda05700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda05700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda05700101 .class);
    }
