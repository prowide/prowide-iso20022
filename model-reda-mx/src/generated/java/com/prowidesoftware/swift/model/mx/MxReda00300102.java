    ...
    extends AbstractMX
{
    ...
    public static MxReda00300102 parse(String xml) {
        return ((MxReda00300102) MxReadImpl.parse(MxReda00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00300102) MxReadImpl.parse(MxReda00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
