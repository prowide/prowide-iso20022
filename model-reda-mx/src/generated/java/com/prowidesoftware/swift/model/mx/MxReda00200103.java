    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:reda.002.001.03";
    ...
    public static MxReda00200103 parse(String xml) {
        return ((MxReda00200103) MxReadImpl.parse(MxReda00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00200103) MxReadImpl.parse(MxReda00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda00200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00200103 .class);
    }
