    ...
    extends AbstractMX
{
    ...
    public static MxReda00100102 parse(String xml) {
        return ((MxReda00100102) MxReadImpl.parse(MxReda00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00100102) MxReadImpl.parse(MxReda00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
