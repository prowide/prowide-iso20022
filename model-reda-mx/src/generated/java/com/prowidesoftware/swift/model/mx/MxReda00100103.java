    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:reda.001.001.03";
    ...
    public static MxReda00100103 parse(String xml) {
        return ((MxReda00100103) MxReadImpl.parse(MxReda00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00100103) MxReadImpl.parse(MxReda00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda00100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00100103 .class);
    }
