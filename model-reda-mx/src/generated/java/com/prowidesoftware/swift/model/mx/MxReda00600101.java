    ...
    extends AbstractMX
{
    ...
    public static MxReda00600101 parse(String xml) {
        return ((MxReda00600101) MxReadImpl.parse(MxReda00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00600101) MxReadImpl.parse(MxReda00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00600101 .class);
    }
