    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.070.001.02";
    ...
    public static MxReda07000102 parse(String xml) {
        return ((MxReda07000102) MxReadImpl.parse(MxReda07000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda07000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda07000102) MxReadImpl.parse(MxReda07000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda07000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda07000102 .class);
    }
