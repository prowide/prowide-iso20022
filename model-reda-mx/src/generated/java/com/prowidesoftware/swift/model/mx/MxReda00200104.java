    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:reda.002.001.04";
    ...
    public static MxReda00200104 parse(String xml) {
        return ((MxReda00200104) MxReadImpl.parse(MxReda00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda00200104) MxReadImpl.parse(MxReda00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda00200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda00200104 .class);
    }
