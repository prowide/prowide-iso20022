    ...
    extends AbstractMX
{
    ...
    public static MxReda06400101 parse(String xml) {
        return ((MxReda06400101) MxReadImpl.parse(MxReda06400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda06400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda06400101) MxReadImpl.parse(MxReda06400101 .class, xml, _classes, new MxReadParams(conf)));
    }
