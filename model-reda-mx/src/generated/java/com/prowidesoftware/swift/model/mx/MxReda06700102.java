    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:reda.067.001.02";
    ...
    public static MxReda06700102 parse(String xml) {
        return ((MxReda06700102) MxReadImpl.parse(MxReda06700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda06700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda06700102) MxReadImpl.parse(MxReda06700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxReda06700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda06700102 .class);
    }
