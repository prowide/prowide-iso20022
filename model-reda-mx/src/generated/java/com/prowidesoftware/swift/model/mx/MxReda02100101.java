    ...
    extends AbstractMX
{
    ...
    public static MxReda02100101 parse(String xml) {
        return ((MxReda02100101) MxReadImpl.parse(MxReda02100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda02100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda02100101) MxReadImpl.parse(MxReda02100101 .class, xml, _classes, new MxReadParams(conf)));
    }
