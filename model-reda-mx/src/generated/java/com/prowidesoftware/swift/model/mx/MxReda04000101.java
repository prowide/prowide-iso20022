    ...
    extends AbstractMX
{
    ...
    public static MxReda04000101 parse(String xml) {
        return ((MxReda04000101) MxReadImpl.parse(MxReda04000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxReda04000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxReda04000101) MxReadImpl.parse(MxReda04000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxReda04000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxReda04000101 .class);
    }
