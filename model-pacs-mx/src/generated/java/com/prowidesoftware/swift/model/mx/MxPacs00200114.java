    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.14";
    ...
    public static MxPacs00200114 parse(String xml) {
        return ((MxPacs00200114) MxReadImpl.parse(MxPacs00200114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00200114 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00200114) MxReadImpl.parse(MxPacs00200114 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00200114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00200114 .class);
    }
