    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.05";
    ...
    public static MxPacs00900105 parse(String xml) {
        return ((MxPacs00900105) MxReadImpl.parse(MxPacs00900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00900105) MxReadImpl.parse(MxPacs00900105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00900105 fromJson(String json) {
