    ...
    extends AbstractMX
{
    ...
    public static MxPacs00300102 parse(String xml) {
        return ((MxPacs00300102) MxReadImpl.parse(MxPacs00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00300102) MxReadImpl.parse(MxPacs00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00300102 .class);
    }
