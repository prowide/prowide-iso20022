    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.10";
    ...
    public static MxPacs00900110 parse(String xml) {
        return ((MxPacs00900110) MxReadImpl.parse(MxPacs00900110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00900110 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00900110) MxReadImpl.parse(MxPacs00900110 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00900110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00900110 .class);
    }
