...
/**
 * Class for pacs.004.001.03 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxPacs00400103(final String xml) {
        this();
        MxPacs00400103 tmp = parse(xml);
     ...
     * 
     */
    public MxPacs00400103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link PaymentReturnV03 }
     *     
     */
    public PaymentReturnV03 getPmtRtr() {
        return pmtRtr;
    }
     ...
     *     
     */
    public MxPacs00400103 setPmtRtr(PaymentReturnV03 value) {
        this.pmtRtr = value;
        return this;
    }
    ...
    public static MxPacs00400103 parse(String xml) {
        return ((MxPacs00400103) MxReadImpl.parse(MxPacs00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00400103) MxReadImpl.parse(MxPacs00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxPacs00400103 parse(String xml, MxRead parserImpl) {
        return ((MxPacs00400103) parserImpl.read(MxPacs00400103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxPacs00400103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxPacs00400103 message
     * @return
     *     a new instance of MxPacs00400103
     */
    public static final MxPacs00400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00400103 .class);
    }
