    ...
    extends AbstractMX
{
    ...
    public static MxPacs00400106 parse(String xml) {
        return ((MxPacs00400106) MxReadImpl.parse(MxPacs00400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00400106) MxReadImpl.parse(MxPacs00400106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00400106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00400106 .class);
    }
