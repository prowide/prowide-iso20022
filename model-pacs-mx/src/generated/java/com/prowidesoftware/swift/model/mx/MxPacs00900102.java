    ...
    extends AbstractMX
{
    ...
    public static MxPacs00900102 parse(String xml) {
        return ((MxPacs00900102) MxReadImpl.parse(MxPacs00900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00900102) MxReadImpl.parse(MxPacs00900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00900102 .class);
    }
