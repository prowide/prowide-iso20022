    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.029.001.01";
    ...
    public static MxPacs02900101 parse(String xml) {
        return ((MxPacs02900101) MxReadImpl.parse(MxPacs02900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs02900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs02900101) MxReadImpl.parse(MxPacs02900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs02900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs02900101 .class);
    }
