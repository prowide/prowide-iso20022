    ...
    extends AbstractMX
{
    ...
    public static MxPacs00900111 parse(String xml) {
        return ((MxPacs00900111) MxReadImpl.parse(MxPacs00900111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00900111 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00900111) MxReadImpl.parse(MxPacs00900111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00900111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00900111 .class);
    }
