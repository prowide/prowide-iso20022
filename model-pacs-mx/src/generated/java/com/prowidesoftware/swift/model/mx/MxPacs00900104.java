    ...
    extends AbstractMX
{
    ...
    public static MxPacs00900104 parse(String xml) {
        return ((MxPacs00900104) MxReadImpl.parse(MxPacs00900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00900104) MxReadImpl.parse(MxPacs00900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00900104 .class);
    }
