    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.08";
    ...
    public static MxPacs00700108 parse(String xml) {
        return ((MxPacs00700108) MxReadImpl.parse(MxPacs00700108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00700108 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00700108) MxReadImpl.parse(MxPacs00700108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00700108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00700108 .class);
    }
