    ...
    extends AbstractMX
{
    ...
    public static MxPacs00800103 parse(String xml) {
        return ((MxPacs00800103) MxReadImpl.parse(MxPacs00800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00800103) MxReadImpl.parse(MxPacs00800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00800103 .class);
    }
