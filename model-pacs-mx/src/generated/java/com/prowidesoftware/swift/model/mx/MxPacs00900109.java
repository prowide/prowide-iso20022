    ...
    extends AbstractMX
{
    ...
    public static MxPacs00900109 parse(String xml) {
        return ((MxPacs00900109) MxReadImpl.parse(MxPacs00900109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00900109 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00900109) MxReadImpl.parse(MxPacs00900109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00900109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00900109 .class);
    }
