    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.004.001.04";
    ...
    public static MxPacs00400104 parse(String xml) {
        return ((MxPacs00400104) MxReadImpl.parse(MxPacs00400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00400104) MxReadImpl.parse(MxPacs00400104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00400104 .class);
    }
