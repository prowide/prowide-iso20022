    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.08";
    ...
    public static MxPacs00200108 parse(String xml) {
        return ((MxPacs00200108) MxReadImpl.parse(MxPacs00200108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00200108 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00200108) MxReadImpl.parse(MxPacs00200108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00200108 fromJson(String json) {
