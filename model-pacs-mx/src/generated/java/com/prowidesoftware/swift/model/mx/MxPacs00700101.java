    ...
    extends AbstractMX
{
    ...
    public static MxPacs00700101 parse(String xml) {
        return ((MxPacs00700101) MxReadImpl.parse(MxPacs00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00700101) MxReadImpl.parse(MxPacs00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
