    ...
    extends AbstractMX
{
    ...
    public static MxPacs01000105 parse(String xml) {
        return ((MxPacs01000105) MxReadImpl.parse(MxPacs01000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs01000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs01000105) MxReadImpl.parse(MxPacs01000105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs01000105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs01000105 .class);
    }
