    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.028.001.01";
    ...
    public static MxPacs02800101 parse(String xml) {
        return ((MxPacs02800101) MxReadImpl.parse(MxPacs02800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs02800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs02800101) MxReadImpl.parse(MxPacs02800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs02800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs02800101 .class);
    }
