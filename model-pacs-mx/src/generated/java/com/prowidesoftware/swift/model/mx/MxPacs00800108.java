    ...
    extends AbstractMX
{
    ...
    public static MxPacs00800108 parse(String xml) {
        return ((MxPacs00800108) MxReadImpl.parse(MxPacs00800108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00800108 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00800108) MxReadImpl.parse(MxPacs00800108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00800108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00800108 .class);
    }
