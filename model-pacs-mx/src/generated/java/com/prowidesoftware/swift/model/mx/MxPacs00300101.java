    ...
    extends AbstractMX
{
    ...
    public static MxPacs00300101 parse(String xml) {
        return ((MxPacs00300101) MxReadImpl.parse(MxPacs00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00300101) MxReadImpl.parse(MxPacs00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
