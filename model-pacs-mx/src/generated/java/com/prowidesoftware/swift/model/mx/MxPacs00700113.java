    ...
    extends AbstractMX
{
    ...
    public static MxPacs00700113 parse(String xml) {
        return ((MxPacs00700113) MxReadImpl.parse(MxPacs00700113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00700113 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00700113) MxReadImpl.parse(MxPacs00700113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00700113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00700113 .class);
    }
