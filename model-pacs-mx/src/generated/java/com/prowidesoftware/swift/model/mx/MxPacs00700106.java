    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.06";
    ...
    public static MxPacs00700106 parse(String xml) {
        return ((MxPacs00700106) MxReadImpl.parse(MxPacs00700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00700106) MxReadImpl.parse(MxPacs00700106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00700106 fromJson(String json) {
