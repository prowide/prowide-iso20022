    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.06";
    ...
    public static MxPacs00300106 parse(String xml) {
        return ((MxPacs00300106) MxReadImpl.parse(MxPacs00300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00300106) MxReadImpl.parse(MxPacs00300106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00300106 fromJson(String json) {
