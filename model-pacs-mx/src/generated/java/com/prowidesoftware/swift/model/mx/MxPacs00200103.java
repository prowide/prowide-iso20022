    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.03";
    ...
    public static MxPacs00200103 parse(String xml) {
        return ((MxPacs00200103) MxReadImpl.parse(MxPacs00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00200103) MxReadImpl.parse(MxPacs00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00200103 .class);
    }
