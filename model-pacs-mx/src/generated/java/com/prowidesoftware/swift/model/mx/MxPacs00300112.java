    ...
    extends AbstractMX
{
    ...
    public static MxPacs00300112 parse(String xml) {
        return ((MxPacs00300112) MxReadImpl.parse(MxPacs00300112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00300112 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00300112) MxReadImpl.parse(MxPacs00300112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00300112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00300112 .class);
    }
