    ...
    extends AbstractMX
{
    ...
    public static MxPacs00900107 parse(String xml) {
        return ((MxPacs00900107) MxReadImpl.parse(MxPacs00900107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00900107 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00900107) MxReadImpl.parse(MxPacs00900107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00900107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00900107 .class);
    }
