    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.010.001.06";
    ...
    public static MxPacs01000106 parse(String xml) {
        return ((MxPacs01000106) MxReadImpl.parse(MxPacs01000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs01000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs01000106) MxReadImpl.parse(MxPacs01000106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs01000106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs01000106 .class);
    }
