    ...
    extends AbstractMX
{
    ...
    public static MxPacs00400101 parse(String xml) {
        return ((MxPacs00400101) MxReadImpl.parse(MxPacs00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00400101) MxReadImpl.parse(MxPacs00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00400101 fromJson(String json) {
