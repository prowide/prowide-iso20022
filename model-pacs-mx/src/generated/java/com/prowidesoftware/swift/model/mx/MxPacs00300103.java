    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.03";
    ...
    public static MxPacs00300103 parse(String xml) {
        return ((MxPacs00300103) MxReadImpl.parse(MxPacs00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00300103) MxReadImpl.parse(MxPacs00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00300103 .class);
    }
