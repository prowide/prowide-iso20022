    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.10";
    ...
    public static MxPacs00800110 parse(String xml) {
        return ((MxPacs00800110) MxReadImpl.parse(MxPacs00800110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00800110 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00800110) MxReadImpl.parse(MxPacs00800110 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00800110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00800110 .class);
    }
