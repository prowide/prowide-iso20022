    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.05";
    ...
    public static MxPacs00300105 parse(String xml) {
        return ((MxPacs00300105) MxReadImpl.parse(MxPacs00300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00300105) MxReadImpl.parse(MxPacs00300105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00300105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00300105 .class);
    }
