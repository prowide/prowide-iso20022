...
/**
 * Class for pacs.002.001.07 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.07")
public class MxPacs00200107
    extends AbstractMX
{
     ...
     * 
     */
    public MxPacs00200107(final String xml) {
        this();
        MxPacs00200107 tmp = parse(xml);
     ...
     * 
     */
    public MxPacs00200107(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxPacs00200107 setFIToFIPmtStsRpt(FIToFIPaymentStatusReportV07 value) {
    ...
    public static MxPacs00200107 parse(String xml) {
        return ((MxPacs00200107) MxReadImpl.parse(MxPacs00200107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00200107) MxReadImpl.parse(MxPacs00200107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxPacs00200107 parse(String xml, MxRead parserImpl) {
        return ((MxPacs00200107) parserImpl.read(MxPacs00200107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxPacs00200107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxPacs00200107 message
     * @return
     *     a new instance of MxPacs00200107
     */
    public static final MxPacs00200107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00200107 .class);
    }
