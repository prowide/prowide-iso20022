    ...
    extends AbstractMX
{
    ...
    public static MxPacs00300111 parse(String xml) {
        return ((MxPacs00300111) MxReadImpl.parse(MxPacs00300111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00300111 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00300111) MxReadImpl.parse(MxPacs00300111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00300111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00300111 .class);
    }
