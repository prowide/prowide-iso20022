    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.02";
    ...
    public static MxPacs00200102 parse(String xml) {
        return ((MxPacs00200102) MxReadImpl.parse(MxPacs00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00200102) MxReadImpl.parse(MxPacs00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00200102 fromJson(String json) {
