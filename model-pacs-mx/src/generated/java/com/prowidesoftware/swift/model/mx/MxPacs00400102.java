    ...
    extends AbstractMX
{
    ...
    public static MxPacs00400102 parse(String xml) {
        return ((MxPacs00400102) MxReadImpl.parse(MxPacs00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00400102) MxReadImpl.parse(MxPacs00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00400102 .class);
    }
