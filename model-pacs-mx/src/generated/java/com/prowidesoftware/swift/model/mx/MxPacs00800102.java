    ...
    extends AbstractMX
{
    ...
    public static MxPacs00800102 parse(String xml) {
        return ((MxPacs00800102) MxReadImpl.parse(MxPacs00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00800102) MxReadImpl.parse(MxPacs00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00800102 .class);
    }
