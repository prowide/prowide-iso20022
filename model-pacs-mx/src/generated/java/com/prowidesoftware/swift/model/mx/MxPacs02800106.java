    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.028.001.06";
    ...
    public static MxPacs02800106 parse(String xml) {
        return ((MxPacs02800106) MxReadImpl.parse(MxPacs02800106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs02800106 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs02800106) MxReadImpl.parse(MxPacs02800106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs02800106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs02800106 .class);
    }
