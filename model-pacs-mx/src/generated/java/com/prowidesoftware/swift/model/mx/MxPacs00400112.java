    ...
    extends AbstractMX
{
    ...
    public static MxPacs00400112 parse(String xml) {
        return ((MxPacs00400112) MxReadImpl.parse(MxPacs00400112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00400112 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00400112) MxReadImpl.parse(MxPacs00400112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00400112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00400112 .class);
    }
