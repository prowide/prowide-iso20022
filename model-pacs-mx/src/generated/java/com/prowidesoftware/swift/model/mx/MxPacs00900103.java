    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.03";
    ...
    public static MxPacs00900103 parse(String xml) {
        return ((MxPacs00900103) MxReadImpl.parse(MxPacs00900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00900103) MxReadImpl.parse(MxPacs00900103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00900103 fromJson(String json) {
