    ...
    extends AbstractMX
{
    ...
    public static MxPacs00800112 parse(String xml) {
        return ((MxPacs00800112) MxReadImpl.parse(MxPacs00800112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00800112 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00800112) MxReadImpl.parse(MxPacs00800112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00800112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00800112 .class);
    }
