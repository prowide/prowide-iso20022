    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.010.001.03";
    ...
    public static MxPacs01000103 parse(String xml) {
        return ((MxPacs01000103) MxReadImpl.parse(MxPacs01000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs01000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs01000103) MxReadImpl.parse(MxPacs01000103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs01000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs01000103 .class);
    }
