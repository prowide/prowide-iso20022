    ...
    extends AbstractMX
{
    ...
    public static MxPacs00300104 parse(String xml) {
        return ((MxPacs00300104) MxReadImpl.parse(MxPacs00300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00300104) MxReadImpl.parse(MxPacs00300104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00300104 .class);
    }
