    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.05";
    ...
    public static MxPacs00200105 parse(String xml) {
        return ((MxPacs00200105) MxReadImpl.parse(MxPacs00200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00200105) MxReadImpl.parse(MxPacs00200105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00200105 fromJson(String json) {
