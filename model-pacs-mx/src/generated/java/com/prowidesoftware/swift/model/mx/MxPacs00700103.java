...
/**
 * Class for pacs.007.001.03 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxPacs00700103(final String xml) {
        this();
        MxPacs00700103 tmp = parse(xml);
     ...
     * 
     */
    public MxPacs00700103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link FIToFIPaymentReversalV03 }
     *     
     */
    public FIToFIPaymentReversalV03 getFIToFIPmtRvsl() {
     ...
     *     
     */
    public MxPacs00700103 setFIToFIPmtRvsl(FIToFIPaymentReversalV03 value) {
    ...
    public static MxPacs00700103 parse(String xml) {
        return ((MxPacs00700103) MxReadImpl.parse(MxPacs00700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00700103) MxReadImpl.parse(MxPacs00700103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxPacs00700103 parse(String xml, MxRead parserImpl) {
        return ((MxPacs00700103) parserImpl.read(MxPacs00700103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxPacs00700103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxPacs00700103 message
     * @return
     *     a new instance of MxPacs00700103
     */
    public static final MxPacs00700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00700103 .class);
    }
