    ...
    extends AbstractMX
{
    ...
    public static MxPacs00200115 parse(String xml) {
        return ((MxPacs00200115) MxReadImpl.parse(MxPacs00200115 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00200115 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00200115) MxReadImpl.parse(MxPacs00200115 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00200115 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00200115 .class);
    }
