...
/**
 * Class for pacs.002.001.15 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.15")
public class MxPacs00200115
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxPacs00200115(final String xml) {
        this();
        MxPacs00200115 tmp = parse(xml);
     ...
     * 
     */
    public MxPacs00200115(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxPacs00200115 setFIToFIPmtStsRpt(FIToFIPaymentStatusReportV15 value) {
     ...
     * 
     */
    public static MxPacs00200115 parse(String xml) {
        return ((MxPacs00200115) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxPacs00200115 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxPacs00200115 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00200115) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxPacs00200115 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxPacs00200115 parse(String xml, MxRead parserImpl) {
        return ((MxPacs00200115) parserImpl.read(MxPacs00200115 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxPacs00200115 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxPacs00200115 message
     * @return
     *     a new instance of MxPacs00200115
     */
    public final static MxPacs00200115 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxPacs00200115 .class);
    }
