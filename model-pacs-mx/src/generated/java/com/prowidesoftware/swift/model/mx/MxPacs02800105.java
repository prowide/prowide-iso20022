    ...
    extends AbstractMX
{
    ...
    public static MxPacs02800105 parse(String xml) {
        return ((MxPacs02800105) MxReadImpl.parse(MxPacs02800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs02800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs02800105) MxReadImpl.parse(MxPacs02800105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs02800105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs02800105 .class);
    }
