    ...
    extends AbstractMX
{
    ...
    public static MxPacs00800101 parse(String xml) {
        return ((MxPacs00800101) MxReadImpl.parse(MxPacs00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00800101) MxReadImpl.parse(MxPacs00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
