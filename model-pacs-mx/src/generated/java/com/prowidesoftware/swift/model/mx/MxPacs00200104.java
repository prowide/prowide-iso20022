    ...
    extends AbstractMX
{
    ...
    public static MxPacs00200104 parse(String xml) {
        return ((MxPacs00200104) MxReadImpl.parse(MxPacs00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00200104) MxReadImpl.parse(MxPacs00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00200104 .class);
    }
