    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.006.001.01";
    ...
    public static MxPacs00600101 parse(String xml) {
        return ((MxPacs00600101) MxReadImpl.parse(MxPacs00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00600101) MxReadImpl.parse(MxPacs00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00600101 .class);
    }
