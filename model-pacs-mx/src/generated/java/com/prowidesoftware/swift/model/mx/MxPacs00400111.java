...
/**
 * Class for pacs.004.001.11 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxPacs00400111(final String xml) {
        this();
        MxPacs00400111 tmp = parse(xml);
     ...
     * 
     */
    public MxPacs00400111(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxPacs00400111 setPmtRtr(PaymentReturnV11 value) {
        this.pmtRtr = value;
        return this;
    }
    ...
    public static MxPacs00400111 parse(String xml) {
        return ((MxPacs00400111) MxReadImpl.parse(MxPacs00400111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00400111 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00400111) MxReadImpl.parse(MxPacs00400111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxPacs00400111 parse(String xml, MxRead parserImpl) {
        return ((MxPacs00400111) parserImpl.read(MxPacs00400111 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxPacs00400111 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxPacs00400111 message
     * @return
     *     a new instance of MxPacs00400111
     */
    public static final MxPacs00400111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00400111 .class);
    }
