    ...
    extends AbstractMX
{
    ...
    public static MxPacs00700104 parse(String xml) {
        return ((MxPacs00700104) MxReadImpl.parse(MxPacs00700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00700104) MxReadImpl.parse(MxPacs00700104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00700104 .class);
    }
