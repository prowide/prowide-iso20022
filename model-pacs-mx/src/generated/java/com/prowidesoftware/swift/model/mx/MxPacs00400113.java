    ...
    extends AbstractMX
{
    ...
    public static MxPacs00400113 parse(String xml) {
        return ((MxPacs00400113) MxReadImpl.parse(MxPacs00400113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00400113 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00400113) MxReadImpl.parse(MxPacs00400113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00400113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00400113 .class);
    }
