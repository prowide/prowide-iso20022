    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.07";
    ...
    public static MxPacs00700107 parse(String xml) {
        return ((MxPacs00700107) MxReadImpl.parse(MxPacs00700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00700107) MxReadImpl.parse(MxPacs00700107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxPacs00700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00700107 .class);
    }
