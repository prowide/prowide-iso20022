...
/**
 * Class for pacs.009.001.06 ISO 20022 message.
 * 
 */
...
public class MxPacs00900106
    extends AbstractMX
{

    @XmlElement(name = "FICdtTrf", required = true)
    protected FinancialInstitutionCreditTransferV06 fiCdtTrf;
     ...
     * 
     */
    public MxPacs00900106(final String xml) {
        this();
        MxPacs00900106 tmp = parse(xml);
     ...
     * 
     */
    public MxPacs00900106(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link FinancialInstitutionCreditTransferV06 }
     *     
     */
     ...
     *     
     */
    public MxPacs00900106 setFICdtTrf(FinancialInstitutionCreditTransferV06 value) {
        this.fiCdtTrf = value;
        return this;
    }
    ...
    public static MxPacs00900106 parse(String xml) {
        return ((MxPacs00900106) MxReadImpl.parse(MxPacs00900106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00900106) MxReadImpl.parse(MxPacs00900106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxPacs00900106 parse(String xml, MxRead parserImpl) {
        return ((MxPacs00900106) parserImpl.read(MxPacs00900106 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxPacs00900106 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxPacs00900106 message
     * @return
     *     a new instance of MxPacs00900106
     */
    public static final MxPacs00900106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00900106 .class);
    }
