    ...
    extends AbstractMX
{
    ...
    public static MxPacs00300107 parse(String xml) {
        return ((MxPacs00300107) MxReadImpl.parse(MxPacs00300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxPacs00300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxPacs00300107) MxReadImpl.parse(MxPacs00300107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxPacs00300107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxPacs00300107 .class);
    }
