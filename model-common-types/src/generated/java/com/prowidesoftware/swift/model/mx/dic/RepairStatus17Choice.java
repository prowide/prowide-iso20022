...
@XmlType(name = "RepairStatus17Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RepairStatus17Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RepairReason13> rsn;
     ...
     *     
     */
    public RepairStatus17Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<RepairReason13> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RepairReason13>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RepairStatus17Choice addRsn(RepairReason13 rsn) {
        getRsn().add(rsn);
        return this;
    }
