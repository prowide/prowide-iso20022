...
@XmlType(name = "CurrencyConversion18", propOrder = {
    "rslt",
    "rsltRsn",
    "convsDtls"
})
public class CurrencyConversion18 {
    ...
    protected List<CurrencyConversion19> convsDtls;
     ...
     *     
     */
    public CurrencyConversion18 setRslt(CurrencyConversionResponse3Code value) {
        this.rslt = value;
        return this;
    }
     ...
     *     
     */
    public CurrencyConversion18 setRsltRsn(String value) {
        this.rsltRsn = value;
        return this;
    }
     ...
     * 
     */
    public List<CurrencyConversion19> getConvsDtls() {
        if (convsDtls == null) {
            convsDtls = new ArrayList<CurrencyConversion19>();
        }
     ...
     * 
     */
    public CurrencyConversion18 addConvsDtls(CurrencyConversion19 convsDtls) {
