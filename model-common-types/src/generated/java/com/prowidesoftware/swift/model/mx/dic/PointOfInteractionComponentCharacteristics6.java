...
@XmlType(name = "PointOfInteractionComponentCharacteristics6", propOrder = {
    "mmry",
    "com",
    "sctyAccsMdls",
    "sbcbrIdntyMdls",
...
public class PointOfInteractionComponentCharacteristics6 {
    ...
    protected List<CryptographicKey14> sctyElmt;
     ...
     *     
     */
    public PointOfInteractionComponentCharacteristics6 setSctyAccsMdls(BigDecimal value) {
     ...
     *     
     */
    public PointOfInteractionComponentCharacteristics6 setSbcbrIdntyMdls(BigDecimal value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CryptographicKey14 }
     * 
     * 
     */
    public List<CryptographicKey14> getSctyElmt() {
        if (sctyElmt == null) {
            sctyElmt = new ArrayList<CryptographicKey14>();
        }
     ...
     * 
     */
    public PointOfInteractionComponentCharacteristics6 addMmry(MemoryCharacteristics1 mmry) {
        getMmry().add(mmry);
        return this;
    }
     ...
     * 
     */
    public PointOfInteractionComponentCharacteristics6 addCom(CommunicationCharacteristics5 com) {
        getCom().add(com);
        return this;
    }
     ...
     * 
     */
    public PointOfInteractionComponentCharacteristics6 addSctyElmt(CryptographicKey14 sctyElmt) {
