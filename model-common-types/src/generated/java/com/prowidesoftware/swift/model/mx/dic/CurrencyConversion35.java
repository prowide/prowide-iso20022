...
@XmlType(name = "CurrencyConversion35", propOrder = {
    "accptdByCrdhldr",
    "convs"
})
public class CurrencyConversion35 {

    @XmlElement(name = "AccptdByCrdhldr")
    protected Boolean accptdByCrdhldr;
    @XmlElement(name = "Convs")
    protected CurrencyConversion34 convs;
     ...
     *     
     */
    public CurrencyConversion35 setAccptdByCrdhldr(Boolean value) {
     ...
     *     
     */
    public CurrencyConversion34 getConvs() {
        return convs;
    }
     ...
     *     
     */
    public CurrencyConversion35 setConvs(CurrencyConversion34 value) {
        this.convs = value;
        return this;
    }
