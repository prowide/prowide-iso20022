...
@XmlType(name = "PendingStatus81Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus81Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingReason35> rsn;
     ...
     *     
     */
    public PendingStatus81Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingReason35 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingReason35> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingStatus81Choice addRsn(PendingReason35 rsn) {
        getRsn().add(rsn);
        return this;
    }
