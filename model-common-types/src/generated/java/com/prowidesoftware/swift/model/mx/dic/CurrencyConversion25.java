...
@XmlType(name = "CurrencyConversion25", propOrder = {
    "rslt",
    "rsltRsn",
    "convsDtls"
})
public class CurrencyConversion25 {
    ...
    protected List<CurrencyConversion23> convsDtls;
     ...
     *     
     */
    public CurrencyConversion25 setRslt(CurrencyConversionResponse3Code value) {
        this.rslt = value;
        return this;
    }
     ...
     *     
     */
    public CurrencyConversion25 setRsltRsn(String value) {
        this.rsltRsn = value;
        return this;
    }
     ...
     * 
     */
    public List<CurrencyConversion23> getConvsDtls() {
        if (convsDtls == null) {
            convsDtls = new ArrayList<CurrencyConversion23>();
        }
     ...
     * 
     */
    public CurrencyConversion25 addConvsDtls(CurrencyConversion23 convsDtls) {
