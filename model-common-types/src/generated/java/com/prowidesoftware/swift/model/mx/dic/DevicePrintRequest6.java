...
@XmlType(name = "DevicePrintRequest6", propOrder = {
    "docQlfr",
    "rspnMd",
    "intgrtdPrtFlg",
    "reqrdSgntrFlg",
...
public class DevicePrintRequest6 {
     ...
     *     
     */
    public DevicePrintRequest6 setDocQlfr(DocumentType7Code value) {
        this.docQlfr = value;
        return this;
    }
     ...
     *     
     */
    public DevicePrintRequest6 setRspnMd(ResponseMode2Code value) {
        this.rspnMd = value;
        return this;
    }
     ...
     *     
     */
    public DevicePrintRequest6 setIntgrtdPrtFlg(Boolean value) {
     ...
     *     
     */
    public DevicePrintRequest6 setReqrdSgntrFlg(Boolean value) {
     ...
     *     
     */
    public DevicePrintRequest6 setOutptCntt(ActionMessage11 value) {
