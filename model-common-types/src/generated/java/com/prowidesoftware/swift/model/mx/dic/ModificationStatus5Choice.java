...
@XmlType(name = "ModificationStatus5Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class ModificationStatus5Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<ModificationReason5> rsn;
     ...
     *     
     */
    public ModificationStatus5Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public ModificationStatus5Choice addRsn(ModificationReason5 rsn) {
        getRsn().add(rsn);
        return this;
    }
