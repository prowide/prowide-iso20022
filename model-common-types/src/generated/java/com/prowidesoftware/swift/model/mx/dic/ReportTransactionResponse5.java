...
public class ReportTransactionResponse5 {
     ...
     *     
     */
    public ReportTransactionResponse5 setRptFullSz(BigDecimal value) {
     ...
     *     
     */
    public ReportTransactionResponse5 setBlckStart(BigDecimal value) {
     ...
     *     
     */
    public ReportTransactionResponse5 setBlckStop(BigDecimal value) {
        this.blckStop = value;
        return this;
    }
    ...
    public List<ServiceResponse7> getTxRpt() {
        if (txRpt == null) {
            txRpt = new ArrayList<ServiceResponse7>();
        }
        return this.txRpt;
    }
     ...
     * 
     */
    public ReportTransactionResponse5 addTxRpt(ServiceResponse7 txRpt) {
        getTxRpt().add(txRpt);
        return this;
    }
