...
@XmlType(name = "UnmatchedStatus5Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class UnmatchedStatus5Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<UnmatchedReason6> rsn;
     ...
     *     
     */
    public UnmatchedStatus5Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link UnmatchedReason6 }
     * 
     * 
     */
    public List<UnmatchedReason6> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<UnmatchedReason6>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public UnmatchedStatus5Choice addRsn(UnmatchedReason6 rsn) {
        getRsn().add(rsn);
        return this;
    }
