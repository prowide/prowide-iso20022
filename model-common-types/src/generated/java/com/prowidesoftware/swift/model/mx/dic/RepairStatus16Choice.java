...
@XmlType(name = "RepairStatus16Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RepairStatus16Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RepairReason12> rsn;
     ...
     *     
     */
    public RepairStatus16Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<RepairReason12> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RepairReason12>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RepairStatus16Choice addRsn(RepairReason12 rsn) {
        getRsn().add(rsn);
        return this;
    }
