...
@XmlType(name = "DevicePoweroffCardReaderRequest6", propOrder = {
    "pwrOffMaxWtgTm",
    "dispOutpt"
})
public class DevicePoweroffCardReaderRequest6 {
     ...
     *     
     */
    public DevicePoweroffCardReaderRequest6 setPwrOffMaxWtgTm(BigDecimal value) {
     ...
     *     
     */
    public DevicePoweroffCardReaderRequest6 setDispOutpt(ActionMessage11 value) {
