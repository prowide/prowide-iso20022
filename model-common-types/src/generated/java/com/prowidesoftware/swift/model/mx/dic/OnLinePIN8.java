...
@XmlType(name = "OnLinePIN8", propOrder = {
    "ncrptdPINBlck",
    "pinFrmt",
    "addtlInpt"
})
public class OnLinePIN8 {

    @XmlElement(name = "NcrptdPINBlck", required = true)
    protected ContentInformationType28 ncrptdPINBlck;
     ...
     *     
     */
    public ContentInformationType28 getNcrptdPINBlck() {
     ...
     *     
     */
    public OnLinePIN8 setNcrptdPINBlck(ContentInformationType28 value) {
     ...
     *     
     */
    public OnLinePIN8 setPINFrmt(PINFormat3Code value) {
        this.pinFrmt = value;
        return this;
    }
     ...
     *     
     */
    public OnLinePIN8 setAddtlInpt(String value) {
