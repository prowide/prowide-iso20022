...
@XmlType(name = "BatchResponse8", propOrder = {
    "saleBtchId",
    "poiBtchId",
    "prfrmdTx"
})
public class BatchResponse8 {
    ...
    protected List<PerformedTransaction8> prfrmdTx;
     ...
     *     
     */
    public BatchResponse8 setSaleBtchId(TransactionIdentifier1 value) {
     ...
     *     
     */
    public BatchResponse8 setPOIBtchId(TransactionIdentifier1 value) {
     ...
     * {@link PerformedTransaction8 }
     * 
     * 
     * @return
     *     The value of the prfrmdTx property.
     */
    public List<PerformedTransaction8> getPrfrmdTx() {
        if (prfrmdTx == null) {
     ...
     * 
     */
    public BatchResponse8 addPrfrmdTx(PerformedTransaction8 prfrmdTx) {
