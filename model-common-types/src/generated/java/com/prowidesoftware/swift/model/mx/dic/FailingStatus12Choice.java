...
@XmlType(name = "FailingStatus12Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class FailingStatus12Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<FailingReason10> rsn;
     ...
     *     
     */
    public FailingStatus12Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link FailingReason10 }
     * 
     * 
     */
    public List<FailingReason10> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<FailingReason10>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public FailingStatus12Choice addRsn(FailingReason10 rsn) {
        getRsn().add(rsn);
        return this;
    }
