...
@XmlType(name = "FailingStatus9Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class FailingStatus9Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<FailingReason7> rsn;
     ...
     *     
     */
    public FailingStatus9Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<FailingReason7> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<FailingReason7>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public FailingStatus9Choice addRsn(FailingReason7 rsn) {
        getRsn().add(rsn);
        return this;
    }
