...
@XmlType(name = "ReportTransactionResponse6", propOrder = {
    "rptFullSz",
    "blckStart",
    "blckStop",
    "txRpt"
})
public class ReportTransactionResponse6 {
    ...
    protected List<ServiceResponse8> txRpt;
     ...
     *     
     */
    public ReportTransactionResponse6 setRptFullSz(BigDecimal value) {
     ...
     *     
     */
    public ReportTransactionResponse6 setBlckStart(BigDecimal value) {
     ...
     *     
     */
    public ReportTransactionResponse6 setBlckStop(BigDecimal value) {
        this.blckStop = value;
        return this;
    }
     ...
     * 
     */
    public List<ServiceResponse8> getTxRpt() {
        if (txRpt == null) {
            txRpt = new ArrayList<ServiceResponse8>();
        }
        return this.txRpt;
    }
     ...
     * 
     */
    public ReportTransactionResponse6 addTxRpt(ServiceResponse8 txRpt) {
        getTxRpt().add(txRpt);
        return this;
    }
