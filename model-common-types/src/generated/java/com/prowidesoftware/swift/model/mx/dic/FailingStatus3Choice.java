...
@XmlType(name = "FailingStatus3Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class FailingStatus3Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<FailingReason3> rsn;
     ...
     *     
     */
    public FailingStatus3Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<FailingReason3> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<FailingReason3>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public FailingStatus3Choice addRsn(FailingReason3 rsn) {
        getRsn().add(rsn);
        return this;
    }
