...
@XmlType(name = "PendingStatus9Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus9Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingReason5> rsn;
     ...
     *     
     */
    public PendingStatus9Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<PendingReason5> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingReason5>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus9Choice addRsn(PendingReason5 rsn) {
        getRsn().add(rsn);
        return this;
    }
