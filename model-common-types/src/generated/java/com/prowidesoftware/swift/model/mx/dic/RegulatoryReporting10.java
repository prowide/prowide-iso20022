...
@XmlType(name = "RegulatoryReporting10", propOrder = {
    "dbtCdtRptgInd",
    "authrty",
    "dtls"
})
public class RegulatoryReporting10 {
    ...
    protected List<StructuredRegulatoryReporting5> dtls;
     ...
     *     
     */
    public RegulatoryReporting10 setDbtCdtRptgInd(RegulatoryReportingType1Code value) {
     ...
     *     
     */
    public RegulatoryReporting10 setAuthrty(RegulatoryAuthority2 value) {
        this.authrty = value;
        return this;
    }
     ...
     * {@link StructuredRegulatoryReporting5 }
     * 
     * 
     * @return
     *     The value of the dtls property.
     */
    public List<StructuredRegulatoryReporting5> getDtls() {
        if (dtls == null) {
            dtls = new ArrayList<>();
        }
        return this.dtls;
     ...
     * 
     */
    public RegulatoryReporting10 addDtls(StructuredRegulatoryReporting5 dtls) {
        getDtls().add(dtls);
        return this;
    }
