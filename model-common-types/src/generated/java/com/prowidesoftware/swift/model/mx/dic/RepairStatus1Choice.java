...
@XmlType(name = "RepairStatus1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RepairStatus1Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RepairReason1> rsn;
     ...
     *     
     */
    public RepairStatus1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<RepairReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RepairReason1>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RepairStatus1Choice addRsn(RepairReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
