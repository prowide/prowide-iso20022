...
@XmlType(name = "SignedQuantityFormat9", propOrder = {
    "shrtLngPos",
    "qty"
})
public class SignedQuantityFormat9 {
     ...
     *     
     */
    public SignedQuantityFormat9 setShrtLngPos(ShortLong1Code value) {
     ...
     *     
     */
    public SignedQuantityFormat9 setQty(FinancialInstrumentQuantity15Choice value) {
        this.qty = value;
        return this;
    }
