...
@XmlType(name = "DeviceDisplayResponse3", propOrder = {
    "outptRslt"
})
public class DeviceDisplayResponse3 {

    @XmlElement(name = "OutptRslt", required = true)
    protected List<OutputResult3> outptRslt;
     ...
     */
    public List<OutputResult3> getOutptRslt() {
        if (outptRslt == null) {
     ...
     * 
     */
    public DeviceDisplayResponse3 addOutptRslt(OutputResult3 outptRslt) {
