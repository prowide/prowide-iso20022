...
@XmlType(name = "OnLinePIN7", propOrder = {
    "ncrptdPINBlck",
    "pinFrmt",
    "addtlInpt"
})
public class OnLinePIN7 {

    @XmlElement(name = "NcrptdPINBlck", required = true)
    protected ContentInformationType22 ncrptdPINBlck;
     ...
     *     
     */
    public ContentInformationType22 getNcrptdPINBlck() {
     ...
     *     
     */
    public OnLinePIN7 setNcrptdPINBlck(ContentInformationType22 value) {
     ...
     *     
     */
    public OnLinePIN7 setPINFrmt(PINFormat3Code value) {
        this.pinFrmt = value;
        return this;
    }
     ...
     *     
     */
    public OnLinePIN7 setAddtlInpt(String value) {
