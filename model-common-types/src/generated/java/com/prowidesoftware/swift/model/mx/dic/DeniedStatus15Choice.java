...
@XmlType(name = "DeniedStatus15Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus15Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<DeniedReason10> rsn;
     ...
     *     
     */
    public DeniedStatus15Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason10> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason10>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus15Choice addRsn(DeniedReason10 rsn) {
        getRsn().add(rsn);
        return this;
    }
