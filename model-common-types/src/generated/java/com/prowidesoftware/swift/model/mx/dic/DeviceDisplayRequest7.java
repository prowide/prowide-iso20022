...
@XmlType(name = "DeviceDisplayRequest7", propOrder = {
    "dispOutpt"
})
public class DeviceDisplayRequest7 {

    @XmlElement(name = "DispOutpt", required = true)
    protected List<ActionMessage12> dispOutpt;
     ...
     */
    public List<ActionMessage12> getDispOutpt() {
        if (dispOutpt == null) {
     ...
     * 
     */
    public DeviceDisplayRequest7 addDispOutpt(ActionMessage12 dispOutpt) {
