...
@XmlType(name = "ModificationStatus6Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class ModificationStatus6Choice {
     ...
     *     
     */
    public ModificationStatus6Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public ModificationStatus6Choice addRsn(ModificationReason4 rsn) {
        getRsn().add(rsn);
        return this;
    }
