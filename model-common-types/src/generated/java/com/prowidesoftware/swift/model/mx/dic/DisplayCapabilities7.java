...
@XmlType(name = "DisplayCapabilities7", propOrder = {
    "dstn",
    "avlblFrmt",
    "nbOfLines",
    "lineWidth",
...
public class DisplayCapabilities7 {

    @XmlElement(name = "Dstn", required = true)
    @XmlSchemaType(name = "string")
    protected List<UserInterface9Code> dstn;
     ...
     */
    public List<UserInterface9Code> getDstn() {
        if (dstn == null) {
            dstn = new ArrayList<>();
        }
        return this.dstn;
     ...
     *     
     */
    public DisplayCapabilities7 setNbOfLines(BigDecimal value) {
     ...
     *     
     */
    public DisplayCapabilities7 setLineWidth(BigDecimal value) {
     ...
     * 
     */
    public DisplayCapabilities7 addDstn(UserInterface9Code dstn) {
        getDstn().add(dstn);
        return this;
    }
     ...
     * 
     */
    public DisplayCapabilities7 addAvlblFrmt(OutputFormat1Code avlblFrmt) {
     ...
     * 
     */
    public DisplayCapabilities7 addAvlblLang(String avlblLang) {
