...
@XmlType(name = "CurrencyConversion36", propOrder = {
    "rslt",
    "rsltRsn",
    "convsDtls"
})
public class CurrencyConversion36 {
    ...
    protected List<CurrencyConversion34> convsDtls;
     ...
     *     
     */
    public CurrencyConversion36 setRslt(CurrencyConversionResponse3Code value) {
        this.rslt = value;
        return this;
    }
     ...
     *     
     */
    public CurrencyConversion36 setRsltRsn(String value) {
        this.rsltRsn = value;
        return this;
    }
     ...
     */
    public List<CurrencyConversion34> getConvsDtls() {
        if (convsDtls == null) {
     ...
     * 
     */
    public CurrencyConversion36 addConvsDtls(CurrencyConversion34 convsDtls) {
