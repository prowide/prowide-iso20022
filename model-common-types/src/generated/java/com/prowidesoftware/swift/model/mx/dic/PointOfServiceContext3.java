...
@XmlType(name = "PointOfServiceContext3", propOrder = {
    "cardPres",
    "crdhldrPres",
    "crdhldrActvtd",
    "trnspndrInittd",
...
public class PointOfServiceContext3 {
     ...
     *     
     */
    public PointOfServiceContext3 setCardPres(Boolean value) {
        this.cardPres = value;
        return this;
    }
     ...
     *     
     */
    public PointOfServiceContext3 setCrdhldrPres(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext3 setCrdhldrActvtd(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext3 setTrnspndrInittd(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext3 setAttnddInd(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext3 setUattnddLvlCtgy(String value) {
     ...
     *     
     */
    public PointOfServiceContext3 setEComrcInd(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext3 setMOTOCd(MOTO1Code value) {
        this.motoCd = value;
        return this;
    }
     ...
     *     
     */
    public PointOfServiceContext3 setTrnstInd(Boolean value) {
        this.trnstInd = value;
        return this;
    }
     ...
     *     
     */
    public PointOfServiceContext3 setPrtlApprvlSpprtd(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext3 setDelydAuthstnInd(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext3 setOthrSctyChrtcs(String value) {
     ...
     *     
     */
    public PointOfServiceContext3 setCardDataNtryMd(CardDataReading10Code value) {
     ...
     *     
     */
    public PointOfServiceContext3 setOthrCardDataNtryMd(String value) {
     ...
     *     
     */
    public PointOfServiceContext3 setQRCdPresntmntMd(QRCodePresentmentMode1Code value) {
     ...
     *     
     */
    public PointOfServiceContext3 setOthrQRCdPresntmntMd(String value) {
     ...
     *     
     */
    public PointOfServiceContext3 setTempScrCardDataReusd(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext3 setStorgLctn(String value) {
     ...
     * 
     */
    public PointOfServiceContext3 addEComrcData(ECommerceData1 eComrcData) {
     ...
     * 
     */
    public PointOfServiceContext3 addSctyChrtcs(SecurityCharacteristics1Code sctyChrtcs) {
     ...
     * 
     */
    public PointOfServiceContext3 addSpclConds(SpecialConditions1 spclConds) {
     ...
     * 
     */
    public PointOfServiceContext3 addAddtlData(AdditionalData1 addtlData) {
