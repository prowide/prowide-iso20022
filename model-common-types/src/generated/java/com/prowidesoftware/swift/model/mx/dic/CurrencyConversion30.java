...
@XmlType(name = "CurrencyConversion30", propOrder = {
    "accptdByCrdhldr",
    "convs"
})
public class CurrencyConversion30 {

    @XmlElement(name = "AccptdByCrdhldr")
    protected Boolean accptdByCrdhldr;
    @XmlElement(name = "Convs")
    protected CurrencyConversion29 convs;
     ...
     *     
     */
    public CurrencyConversion30 setAccptdByCrdhldr(Boolean value) {
     ...
     *     
     */
    public CurrencyConversion29 getConvs() {
        return convs;
    }
     ...
     *     
     */
    public CurrencyConversion30 setConvs(CurrencyConversion29 value) {
        this.convs = value;
        return this;
    }
