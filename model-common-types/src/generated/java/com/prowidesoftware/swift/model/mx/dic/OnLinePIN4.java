...
@XmlType(name = "OnLinePIN4", propOrder = {
    "ncrptdPINBlck",
    "pinFrmt",
    "addtlInpt"
})
public class OnLinePIN4 {
     ...
     *     
     */
    public OnLinePIN4 setNcrptdPINBlck(ContentInformationType10 value) {
     ...
     *     
     */
    public OnLinePIN4 setPINFrmt(PINFormat3Code value) {
        this.pinFrmt = value;
        return this;
    }
     ...
     *     
     */
    public OnLinePIN4 setAddtlInpt(String value) {
