...
@XmlType(name = "FailingStatus1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class FailingStatus1Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<FailingReason1> rsn;
     ...
     *     
     */
    public FailingStatus1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<FailingReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<FailingReason1>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public FailingStatus1Choice addRsn(FailingReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
