...
@XmlType(name = "RepairStatus8Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RepairStatus8Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RepairReason6> rsn;
     ...
     *     
     */
    public RepairStatus8Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<RepairReason6> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RepairReason6>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RepairStatus8Choice addRsn(RepairReason6 rsn) {
        getRsn().add(rsn);
        return this;
    }
