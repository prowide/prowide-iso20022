...
@XmlType(name = "PointOfInteractionCapabilities11", propOrder = {
    "cardRdngCpblties",
...
public class PointOfInteractionCapabilities11 {
    ...
    protected List<DisplayCapabilities7> msgCpblties;
     ...
     *     
     */
    public PointOfInteractionCapabilities11 setPINLngthCpblties(BigDecimal value) {
     ...
     *     
     */
    public PointOfInteractionCapabilities11 setApprvlCdLngth(BigDecimal value) {
     ...
     *     
     */
    public PointOfInteractionCapabilities11 setMxScrptLngth(BigDecimal value) {
     ...
     *     
     */
    public PointOfInteractionCapabilities11 setCardCaptrCpbl(Boolean value) {
     ...
     *     
     */
    public PointOfInteractionCapabilities11 setOnLineCpblties(OnLineCapability1Code value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DisplayCapabilities7 }
     * 
     * 
     * @return
     *     The value of the msgCpblties property.
     */
    public List<DisplayCapabilities7> getMsgCpblties() {
        if (msgCpblties == null) {
     ...
     * 
     */
    public PointOfInteractionCapabilities11 addCardRdngCpblties(CardDataReading8Code cardRdngCpblties) {
     ...
     * 
     */
    public PointOfInteractionCapabilities11 addCrdhldrVrfctnCpblties(CardholderVerificationCapability4Code crdhldrVrfctnCpblties) {
     ...
     * 
     */
    public PointOfInteractionCapabilities11 addMsgCpblties(DisplayCapabilities7 msgCpblties) {
