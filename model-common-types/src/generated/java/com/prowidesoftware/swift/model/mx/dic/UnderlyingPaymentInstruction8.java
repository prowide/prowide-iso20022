...
public class UnderlyingPaymentInstruction8 {
     ...
     *     
     */
    public UnderlyingPaymentInstruction8 setOrgnlGrpInf(UnderlyingGroupInformation1 value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction8 setOrgnlPmtInfId(String value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction8 setOrgnlInstrId(String value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction8 setOrgnlEndToEndId(String value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction8 setOrgnlUETR(String value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction8 setOrgnlInstdAmt(ActiveOrHistoricCurrencyAndAmount value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction8 setReqdExctnDt(DateAndDateTime2Choice value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction8 setReqdColltnDt(XMLGregorianCalendar value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction8 setOrgnlTxRef(OriginalTransactionReference35 value) {
     ...
     *     
     */
    public UnderlyingPaymentInstruction8 setOrgnlSvcLvl(ServiceLevel8Choice value) {
