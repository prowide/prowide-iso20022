...
@XmlType(name = "DeniedStatus10Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus10Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason5> rsn;
     ...
     *     
     */
    public DeniedStatus10Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason5> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason5>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus10Choice addRsn(DeniedReason5 rsn) {
        getRsn().add(rsn);
        return this;
    }
