...
@XmlType(name = "FailingStatus2Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class FailingStatus2Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<FailingReason2> rsn;
     ...
     *     
     */
    public FailingStatus2Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<FailingReason2> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<FailingReason2>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public FailingStatus2Choice addRsn(FailingReason2 rsn) {
        getRsn().add(rsn);
        return this;
    }
