...
@XmlType(name = "PendingStatus13Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus13Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingReason2> rsn;
     ...
     *     
     */
    public PendingStatus13Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<PendingReason2> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingReason2>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus13Choice addRsn(PendingReason2 rsn) {
        getRsn().add(rsn);
        return this;
    }
