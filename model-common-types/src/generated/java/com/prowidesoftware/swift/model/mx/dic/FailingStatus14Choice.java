...
@XmlType(name = "FailingStatus14Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class FailingStatus14Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<FailingReason12> rsn;
     ...
     *     
     */
    public FailingStatus14Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link FailingReason12 }
     * 
     * 
     */
    public List<FailingReason12> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<FailingReason12>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public FailingStatus14Choice addRsn(FailingReason12 rsn) {
        getRsn().add(rsn);
        return this;
    }
