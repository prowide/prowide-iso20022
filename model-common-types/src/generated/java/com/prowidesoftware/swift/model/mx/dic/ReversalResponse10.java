...
@XmlType(name = "ReversalResponse10", propOrder = {
    "saleTxId",
    "saleRefId",
    "poiTxId",
    "poiRcncltnId",
...
public class ReversalResponse10 {
    ...
    protected RetailerReversalResult8 rvslTxRslt;
    @XmlElement(name = "RvsdAmt")
    protected BigDecimal rvsdAmt;
    @XmlElement(name = "Rct")
    protected List<PaymentReceipt7> rct;
     ...
     *     
     */
    public ReversalResponse10 setSaleTxId(TransactionIdentifier1 value) {
        this.saleTxId = value;
        return this;
    }
     ...
     *     
     */
    public ReversalResponse10 setSaleRefId(String value) {
     ...
     *     
     */
    public ReversalResponse10 setPOITxId(TransactionIdentifier1 value) {
        this.poiTxId = value;
        return this;
    }
     ...
     *     
     */
    public ReversalResponse10 setPOIRcncltnId(String value) {
     ...
     *     
     */
    public ReversalResponse10 setIssrRefData(String value) {
     ...
     * @return
     *     possible object is
     *     {@link RetailerReversalResult8 }
     *     
     */
    public RetailerReversalResult8 getRvslTxRslt() {
        return rvslTxRslt;
    }
     ...
     *     
     */
    public ReversalResponse10 setRvslTxRslt(RetailerReversalResult8 value) {
     ...
     *     
     */
    public ReversalResponse10 setRvsdAmt(BigDecimal value) {
        this.rvsdAmt = value;
        return this;
    }
     ...
     */
    public List<PaymentReceipt7> getRct() {
        if (rct == null) {
            rct = new ArrayList<>();
        }
        return this.rct;
     ...
     * 
     */
    public ReversalResponse10 addRct(PaymentReceipt7 rct) {
        getRct().add(rct);
        return this;
    }
