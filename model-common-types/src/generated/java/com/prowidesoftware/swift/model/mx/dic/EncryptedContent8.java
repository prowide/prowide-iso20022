...
@XmlType(name = "EncryptedContent8", propOrder = {
    "cnttTp",
    "cnttNcrptnAlgo",
    "ncrptdDataElmt"
})
public class EncryptedContent8 {
    ...
    protected List<EncryptedDataElement2> ncrptdDataElmt;
     ...
     *     
     */
    public EncryptedContent8 setCnttTp(ContentType2Code value) {
        this.cnttTp = value;
        return this;
    }
     ...
     *     
     */
    public EncryptedContent8 setCnttNcrptnAlgo(AlgorithmIdentification25 value) {
     ...
     * 
     */
    public List<EncryptedDataElement2> getNcrptdDataElmt() {
        if (ncrptdDataElmt == null) {
            ncrptdDataElmt = new ArrayList<EncryptedDataElement2>();
        }
     ...
     * 
     */
    public EncryptedContent8 addNcrptdDataElmt(EncryptedDataElement2 ncrptdDataElmt) {
