...
public class SignedData9 {
     ...
     *     
     */
    public SignedData9 setVrsn(BigDecimal value) {
        this.vrsn = value;
        return this;
    }
     ...
     *     
     */
    public SignedData9 setNcpsltdCntt(EncapsulatedContent3 value) {
     ...
     * 
     */
    public SignedData9 addDgstAlgo(AlgorithmIdentification36 dgstAlgo) {
     ...
     * 
     */
    public SignedData9 addCert(byte[] cert) {
        getCert().add(cert);
        return this;
    }
     ...
     * 
     */
    public SignedData9 addSgnr(Signer8 sgnr) {
        getSgnr().add(sgnr);
        return this;
    }
