...
@XmlType(name = "UnmatchedStatus21Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class UnmatchedStatus21Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<UnmatchedReason20> rsn;
     ...
     *     
     */
    public UnmatchedStatus21Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link UnmatchedReason20 }
     * 
     * 
     */
    public List<UnmatchedReason20> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<UnmatchedReason20>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public UnmatchedStatus21Choice addRsn(UnmatchedReason20 rsn) {
        getRsn().add(rsn);
        return this;
    }
