...
@XmlType(name = "DeviceInitialisationCardReaderRequest3", propOrder = {
    "warmRstFlg",
    "forceNtryMd",
    "leavCardFlg",
    "maxWtgTm",
...
public class DeviceInitialisationCardReaderRequest3 {
     ...
     *     
     */
    public DeviceInitialisationCardReaderRequest3 setWarmRstFlg(Boolean value) {
     ...
     *     
     */
    public DeviceInitialisationCardReaderRequest3 setLeavCardFlg(Boolean value) {
     ...
     *     
     */
    public DeviceInitialisationCardReaderRequest3 setMaxWtgTm(BigDecimal value) {
        this.maxWtgTm = value;
        return this;
    }
     ...
     *     
     */
    public DeviceInitialisationCardReaderRequest3 setDispOutpt(ActionMessage8 value) {
     ...
     * 
     */
    public DeviceInitialisationCardReaderRequest3 addForceNtryMd(CardDataReading8Code forceNtryMd) {
