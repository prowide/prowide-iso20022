...
@XmlType(name = "PaymentResponse8", propOrder = {
    "saleTxId",
    "saleRefId",
    "poiTxId",
    "poiRcncltnId",
...
public class PaymentResponse8 {
    ...
    protected RetailerPaymentResult8 rtlrPmtRslt;
    @XmlElement(name = "PmtRct")
    protected List<PaymentReceipt7> pmtRct;
     ...
     *     
     */
    public PaymentResponse8 setSaleTxId(TransactionIdentifier1 value) {
        this.saleTxId = value;
        return this;
    }
     ...
     *     
     */
    public PaymentResponse8 setSaleRefId(String value) {
     ...
     *     
     */
    public PaymentResponse8 setPOITxId(TransactionIdentifier1 value) {
        this.poiTxId = value;
        return this;
    }
     ...
     *     
     */
    public PaymentResponse8 setPOIRcncltnId(String value) {
     ...
     *     
     */
    public PaymentResponse8 setIssrRefData(String value) {
     ...
     * @return
     *     possible object is
     *     {@link RetailerPaymentResult8 }
     *     
     */
    public RetailerPaymentResult8 getRtlrPmtRslt() {
        return rtlrPmtRslt;
    }
     ...
     *     
     */
    public PaymentResponse8 setRtlrPmtRslt(RetailerPaymentResult8 value) {
     ...
     * {@link PaymentReceipt7 }
     * 
     * 
     * @return
     *     The value of the pmtRct property.
     */
    public List<PaymentReceipt7> getPmtRct() {
        if (pmtRct == null) {
     ...
     * 
     */
    public PaymentResponse8 addPmtRct(PaymentReceipt7 pmtRct) {
     ...
     * 
     */
    public PaymentResponse8 addLltyRslt(LoyaltyResult3 lltyRslt) {
     ...
     * 
     */
    public PaymentResponse8 addCstmrOrdr(CustomerOrder1 cstmrOrdr) {
