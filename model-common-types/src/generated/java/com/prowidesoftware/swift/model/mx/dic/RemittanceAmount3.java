...
public class RemittanceAmount3 {
     ...
     *     
     */
    public RemittanceAmount3 setDuePyblAmt(ActiveOrHistoricCurrencyAndAmount value) {
     ...
     *     
     */
    public RemittanceAmount3 setCdtNoteAmt(ActiveOrHistoricCurrencyAndAmount value) {
     ...
     *     
     */
    public RemittanceAmount3 setRmtdAmt(ActiveOrHistoricCurrencyAndAmount value) {
        this.rmtdAmt = value;
        return this;
    }
     ...
     * 
     */
    public RemittanceAmount3 addDscntApldAmt(DiscountAmountAndType1 dscntApldAmt) {
     ...
     * 
     */
    public RemittanceAmount3 addTaxAmt(TaxAmountAndType1 taxAmt) {
     ...
     * 
     */
    public RemittanceAmount3 addAdjstmntAmtAndRsn(DocumentAdjustment1 adjstmntAmtAndRsn) {
