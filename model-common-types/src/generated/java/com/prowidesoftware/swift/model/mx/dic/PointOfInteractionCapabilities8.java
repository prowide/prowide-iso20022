...
public class PointOfInteractionCapabilities8 {
     ...
     *     
     */
    public PointOfInteractionCapabilities8 setPINLngthCpblties(BigDecimal value) {
     ...
     *     
     */
    public PointOfInteractionCapabilities8 setApprvlCdLngth(BigDecimal value) {
     ...
     *     
     */
    public PointOfInteractionCapabilities8 setMxScrptLngth(BigDecimal value) {
     ...
     *     
     */
    public PointOfInteractionCapabilities8 setCardCaptrCpbl(Boolean value) {
     ...
     *     
     */
    public PointOfInteractionCapabilities8 setOnLineCpblties(OnLineCapability1Code value) {
     ...
     * 
     */
    public PointOfInteractionCapabilities8 addCardRdngCpblties(CardDataReading6Code cardRdngCpblties) {
     ...
     * 
     */
    public PointOfInteractionCapabilities8 addCrdhldrVrfctnCpblties(CardholderVerificationCapability4Code crdhldrVrfctnCpblties) {
     ...
     * 
     */
    public PointOfInteractionCapabilities8 addMsgCpblties(DisplayCapabilities4 msgCpblties) {
