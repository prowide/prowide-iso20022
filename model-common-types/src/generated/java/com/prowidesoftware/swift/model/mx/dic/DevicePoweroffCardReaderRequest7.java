...
@XmlType(name = "DevicePoweroffCardReaderRequest7", propOrder = {
    "pwrOffMaxWtgTm",
    "dispOutpt"
})
public class DevicePoweroffCardReaderRequest7 {
     ...
     *     
     */
    public DevicePoweroffCardReaderRequest7 setPwrOffMaxWtgTm(BigDecimal value) {
     ...
     *     
     */
    public DevicePoweroffCardReaderRequest7 setDispOutpt(ActionMessage12 value) {
