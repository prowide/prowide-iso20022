...
@XmlType(name = "DeniedStatus16Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus16Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason11> rsn;
     ...
     *     
     */
    public DeniedStatus16Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason11> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason11>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus16Choice addRsn(DeniedReason11 rsn) {
        getRsn().add(rsn);
        return this;
    }
