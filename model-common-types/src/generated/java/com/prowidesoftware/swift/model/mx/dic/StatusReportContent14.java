...
@XmlType(name = "StatusReportContent14", propOrder = {
    "poiCpblties",
    "poiCmpnt",
    "poiGrpId",
    "attndncCntxt",
...
public class StatusReportContent14 {

    @XmlElement(name = "POICpblties")
    protected PointOfInteractionCapabilities9 poiCpblties;
    @XmlElement(name = "POICmpnt")
    protected List<PointOfInteractionComponent17> poiCmpnt;
    ...
    protected List<DataSetRequest6> dataSetReqrd;
    @XmlElement(name = "Evt")
    protected List<TMSEvent12> evt;
     ...
     *     
     */
    public StatusReportContent14 setPOICpblties(PointOfInteractionCapabilities9 value) {
     ...
     *     
     */
    public StatusReportContent14 setAttndncCntxt(AttendanceContext1Code value) {
     ...
     *     
     */
    public StatusReportContent14 setPOIDtTm(XMLGregorianCalendar value) {
        this.poiDtTm = value;
        return this;
    }
     ...
     * 
     */
    public StatusReportContent14 addPOICmpnt(PointOfInteractionComponent17 pOICmpnt) {
     ...
     * 
     */
    public StatusReportContent14 addPOIGrpId(String pOIGrpId) {
     ...
     * 
     */
    public StatusReportContent14 addDataSetReqrd(DataSetRequest6 dataSetReqrd) {
     ...
     * 
     */
    public StatusReportContent14 addEvt(TMSEvent12 evt) {
        getEvt().add(evt);
        return this;
    }
     ...
     * 
     */
    public StatusReportContent14 addErrs(String errs) {
        getErrs().add(errs);
        return this;
    }
