...
@XmlType(name = "RepairStatus10Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RepairStatus10Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RepairReason2> rsn;
     ...
     *     
     */
    public RepairStatus10Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<RepairReason2> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RepairReason2>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RepairStatus10Choice addRsn(RepairReason2 rsn) {
        getRsn().add(rsn);
        return this;
    }
