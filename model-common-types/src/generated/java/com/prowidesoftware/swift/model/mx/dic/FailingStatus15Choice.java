...
@XmlType(name = "FailingStatus15Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class FailingStatus15Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<FailingReason13> rsn;
     ...
     *     
     */
    public FailingStatus15Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link FailingReason13 }
     * 
     * 
     */
    public List<FailingReason13> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<FailingReason13>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public FailingStatus15Choice addRsn(FailingReason13 rsn) {
        getRsn().add(rsn);
        return this;
    }
