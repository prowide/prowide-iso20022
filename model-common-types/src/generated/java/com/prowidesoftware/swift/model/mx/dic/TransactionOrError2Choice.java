...
@XmlType(name = "TransactionOrError2Choice", propOrder = {
    "tx",
    "bizErr"
})
public class TransactionOrError2Choice {
     ...
     *     
     */
    public TransactionOrError2Choice setTx(Transaction33 value) {
        this.tx = value;
        return this;
    }
     ...
     * 
     */
    public TransactionOrError2Choice addBizErr(ErrorHandling4 bizErr) {
