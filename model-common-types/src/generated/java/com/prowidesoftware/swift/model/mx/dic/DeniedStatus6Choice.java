...
@XmlType(name = "DeniedStatus6Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus6Choice {
     ...
     *     
     */
    public DeniedStatus6Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public DeniedStatus6Choice addRsn(DeniedReason2 rsn) {
        getRsn().add(rsn);
        return this;
    }
