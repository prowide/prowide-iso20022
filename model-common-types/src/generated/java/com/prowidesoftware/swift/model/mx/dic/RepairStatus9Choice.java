...
@XmlType(name = "RepairStatus9Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RepairStatus9Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RepairReason7> rsn;
     ...
     *     
     */
    public RepairStatus9Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<RepairReason7> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RepairReason7>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RepairStatus9Choice addRsn(RepairReason7 rsn) {
        getRsn().add(rsn);
        return this;
    }
