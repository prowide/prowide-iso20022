...
@XmlType(name = "TransactionReportOrError2Choice", propOrder = {
    "bizRpt",
    "oprlErr"
})
public class TransactionReportOrError2Choice {
    ...
    protected Transactions6 bizRpt;
     ...
     *     
     */
    public Transactions6 getBizRpt() {
        return bizRpt;
    }
     ...
     *     
     */
    public TransactionReportOrError2Choice setBizRpt(Transactions6 value) {
        this.bizRpt = value;
        return this;
    }
     ...
     * 
     */
    public TransactionReportOrError2Choice addOprlErr(ErrorHandling4 oprlErr) {
