...
@XmlType(name = "ProprietaryStatusAndReason7", propOrder = {
    "prtrySts",
    "prtryRsn"
})
public class ProprietaryStatusAndReason7 {
    ...
    protected GenericIdentification47 prtrySts;
    @XmlElement(name = "PrtryRsn")
    protected List<ProprietaryReason5> prtryRsn;
     ...
     *     
     */
    public GenericIdentification47 getPrtrySts() {
        return prtrySts;
    }
     ...
     *     
     */
    public ProprietaryStatusAndReason7 setPrtrySts(GenericIdentification47 value) {
        this.prtrySts = value;
        return this;
    }
     ...
     * 
     */
    public List<ProprietaryReason5> getPrtryRsn() {
        if (prtryRsn == null) {
            prtryRsn = new ArrayList<ProprietaryReason5>();
        }
     ...
     * 
     */
    public ProprietaryStatusAndReason7 addPrtryRsn(ProprietaryReason5 prtryRsn) {
