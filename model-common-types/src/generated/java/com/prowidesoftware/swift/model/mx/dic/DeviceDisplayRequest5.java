...
@XmlType(name = "DeviceDisplayRequest5", propOrder = {
    "dispOutpt"
})
public class DeviceDisplayRequest5 {

    @XmlElement(name = "DispOutpt", required = true)
    protected List<ActionMessage10> dispOutpt;
     ...
     * 
     */
    public List<ActionMessage10> getDispOutpt() {
        if (dispOutpt == null) {
            dispOutpt = new ArrayList<ActionMessage10>();
        }
     ...
     * 
     */
    public DeviceDisplayRequest5 addDispOutpt(ActionMessage10 dispOutpt) {
