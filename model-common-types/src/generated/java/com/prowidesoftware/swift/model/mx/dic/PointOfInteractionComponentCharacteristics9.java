...
public class PointOfInteractionComponentCharacteristics9 {
     ...
     *     
     */
    public PointOfInteractionComponentCharacteristics9 setSctyAccsMdls(BigDecimal value) {
     ...
     *     
     */
    public PointOfInteractionComponentCharacteristics9 setSbcbrIdntyMdls(BigDecimal value) {
    ...
    public List<CryptographicKey17> getSctyElmt() {
        if (sctyElmt == null) {
            sctyElmt = new ArrayList<CryptographicKey17>();
        }
     ...
     * 
     */
    public PointOfInteractionComponentCharacteristics9 addMmry(MemoryCharacteristics1 mmry) {
        getMmry().add(mmry);
        return this;
    }
     ...
     * 
     */
    public PointOfInteractionComponentCharacteristics9 addCom(CommunicationCharacteristics5 com) {
        getCom().add(com);
        return this;
    }
     ...
     * 
     */
    public PointOfInteractionComponentCharacteristics9 addSctyElmt(CryptographicKey17 sctyElmt) {
