...
@XmlType(name = "PendingStatus11Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus11Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingReason7> rsn;
     ...
     *     
     */
    public PendingStatus11Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<PendingReason7> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingReason7>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus11Choice addRsn(PendingReason7 rsn) {
        getRsn().add(rsn);
        return this;
    }
