...
@XmlType(name = "StoredValueResponse9", propOrder = {
    "saleTxId",
    "poiTxId",
    "rslt",
    "rct"
})
public class StoredValueResponse9 {
    ...
    protected List<StoredValueData9> rslt;
    @XmlElement(name = "Rct")
     ...
     *     
     */
    public StoredValueResponse9 setSaleTxId(TransactionIdentifier1 value) {
        this.saleTxId = value;
        return this;
    }
     ...
     *     
     */
    public StoredValueResponse9 setPOITxId(TransactionIdentifier1 value) {
        this.poiTxId = value;
        return this;
    }
     ...
     * {@link StoredValueData9 }
     * 
     * 
     * @return
     *     The value of the rslt property.
     */
    public List<StoredValueData9> getRslt() {
        if (rslt == null) {
            rslt = new ArrayList<>();
        }
        return this.rslt;
     ...
     * 
     */
    public StoredValueResponse9 addRslt(StoredValueData9 rslt) {
        getRslt().add(rslt);
        return this;
    }
     ...
     * 
     */
    public StoredValueResponse9 addRct(PaymentReceipt7 rct) {
        getRct().add(rct);
        return this;
    }
