...
@XmlType(name = "PaymentResponse4", propOrder = {
    "saleTxId",
    "saleRefId",
    "poiTxId",
    "poiRcncltnId",
...
public class PaymentResponse4 {
    ...
    protected RetailerPaymentResult4 rtlrPmtRslt;
    @XmlElement(name = "PmtRct")
    protected List<PaymentReceipt4> pmtRct;
     ...
     *     
     */
    public PaymentResponse4 setSaleTxId(TransactionIdentifier1 value) {
        this.saleTxId = value;
        return this;
    }
     ...
     *     
     */
    public PaymentResponse4 setSaleRefId(String value) {
     ...
     *     
     */
    public PaymentResponse4 setPOITxId(TransactionIdentifier1 value) {
        this.poiTxId = value;
        return this;
    }
     ...
     *     
     */
    public PaymentResponse4 setPOIRcncltnId(String value) {
     ...
     *     
     */
    public PaymentResponse4 setIssrRefData(String value) {
     ...
     *     
     */
    public RetailerPaymentResult4 getRtlrPmtRslt() {
        return rtlrPmtRslt;
    }
     ...
     *     
     */
    public PaymentResponse4 setRtlrPmtRslt(RetailerPaymentResult4 value) {
     ...
     * 
     */
    public List<PaymentReceipt4> getPmtRct() {
        if (pmtRct == null) {
            pmtRct = new ArrayList<PaymentReceipt4>();
        }
        return this.pmtRct;
    }
     ...
     * 
     */
    public PaymentResponse4 addPmtRct(PaymentReceipt4 pmtRct) {
     ...
     * 
     */
    public PaymentResponse4 addLltyRslt(LoyaltyResult3 lltyRslt) {
     ...
     * 
     */
    public PaymentResponse4 addCstmrOrdr(CustomerOrder1 cstmrOrdr) {
