...
@XmlType(name = "DeniedStatus9Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus9Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason4> rsn;
     ...
     *     
     */
    public DeniedStatus9Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason4> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason4>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus9Choice addRsn(DeniedReason4 rsn) {
        getRsn().add(rsn);
        return this;
    }
