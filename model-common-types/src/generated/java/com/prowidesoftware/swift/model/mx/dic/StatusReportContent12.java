...
public class StatusReportContent12 {
     ...
     *     
     */
    public StatusReportContent12 setPOICpblties(PointOfInteractionCapabilities9 value) {
    ...
    public List<PointOfInteractionComponent14> getPOICmpnt() {
        if (poiCmpnt == null) {
            poiCmpnt = new ArrayList<PointOfInteractionComponent14>();
        }
     ...
     *     
     */
    public StatusReportContent12 setAttndncCntxt(AttendanceContext1Code value) {
     ...
     *     
     */
    public StatusReportContent12 setPOIDtTm(XMLGregorianCalendar value) {
        this.poiDtTm = value;
        return this;
    }
    ...
    public List<DataSetRequest4> getDataSetReqrd() {
        if (dataSetReqrd == null) {
            dataSetReqrd = new ArrayList<DataSetRequest4>();
        }
     ...
     * 
     */
    public StatusReportContent12 addPOICmpnt(PointOfInteractionComponent14 pOICmpnt) {
     ...
     * 
     */
    public StatusReportContent12 addPOIGrpId(String pOIGrpId) {
     ...
     * 
     */
    public StatusReportContent12 addDataSetReqrd(DataSetRequest4 dataSetReqrd) {
     ...
     * 
     */
    public StatusReportContent12 addEvt(TMSEvent10 evt) {
        getEvt().add(evt);
        return this;
    }
     ...
     * 
     */
    public StatusReportContent12 addErrs(String errs) {
        getErrs().add(errs);
        return this;
    }
