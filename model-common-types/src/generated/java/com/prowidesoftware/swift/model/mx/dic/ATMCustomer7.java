...
@XmlType(name = "ATMCustomer7", propOrder = {
    "prfl",
    "selctdLang",
    "authntcnRslt"
})
public class ATMCustomer7 {
     ...
     *     
     */
    public ATMCustomer7 setPrfl(ATMCustomerProfile6 value) {
        this.prfl = value;
        return this;
    }
     ...
     *     
     */
    public ATMCustomer7 setSelctdLang(String value) {
     ...
     * 
     */
    public ATMCustomer7 addAuthntcnRslt(TransactionVerificationResult5 authntcnRslt) {
