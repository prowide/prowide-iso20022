...
@XmlType(name = "DevicePrintRequest7", propOrder = {
    "docQlfr",
    "rspnMd",
    "intgrtdPrtFlg",
    "reqrdSgntrFlg",
...
public class DevicePrintRequest7 {
    ...
    protected ActionMessage12 outptCntt;
     ...
     *     
     */
    public DevicePrintRequest7 setDocQlfr(DocumentType7Code value) {
        this.docQlfr = value;
        return this;
    }
     ...
     *     
     */
    public DevicePrintRequest7 setRspnMd(ResponseMode2Code value) {
        this.rspnMd = value;
        return this;
    }
     ...
     *     
     */
    public DevicePrintRequest7 setIntgrtdPrtFlg(Boolean value) {
     ...
     *     
     */
    public DevicePrintRequest7 setReqrdSgntrFlg(Boolean value) {
     ...
     *     
     */
    public ActionMessage12 getOutptCntt() {
        return outptCntt;
    }
     ...
     *     
     */
    public DevicePrintRequest7 setOutptCntt(ActionMessage12 value) {
