...
@XmlType(name = "Traceability7", propOrder = {
    "rlayId",
    "tracDtTmIn",
    "tracDtTmOut"
})
public class Traceability7 {

    @XmlElement(name = "RlayId", required = true)
    protected GenericIdentification172 rlayId;
     ...
     *     
     */
    public GenericIdentification172 getRlayId() {
        return rlayId;
    }
     ...
     *     
     */
    public Traceability7 setRlayId(GenericIdentification172 value) {
        this.rlayId = value;
        return this;
    }
     ...
     *     
     */
    public Traceability7 setTracDtTmIn(XMLGregorianCalendar value) {
     ...
     *     
     */
    public Traceability7 setTracDtTmOut(XMLGregorianCalendar value) {
