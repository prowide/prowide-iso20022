...
@XmlType(name = "PointOfInteractionComponentCharacteristics11", propOrder = {
    "mmry",
    "com",
    "sctyAccsMdls",
    "sbcbrIdntyMdls",
...
public class PointOfInteractionComponentCharacteristics11 {
    ...
    protected List<CryptographicKey19> sctyElmt;
     ...
     *     
     */
    public PointOfInteractionComponentCharacteristics11 setSctyAccsMdls(BigDecimal value) {
     ...
     *     
     */
    public PointOfInteractionComponentCharacteristics11 setSbcbrIdntyMdls(BigDecimal value) {
     ...
     */
    public List<CryptographicKey19> getSctyElmt() {
        if (sctyElmt == null) {
     ...
     * 
     */
    public PointOfInteractionComponentCharacteristics11 addMmry(MemoryCharacteristics1 mmry) {
        getMmry().add(mmry);
        return this;
    }
     ...
     * 
     */
    public PointOfInteractionComponentCharacteristics11 addCom(CommunicationCharacteristics5 com) {
        getCom().add(com);
        return this;
    }
     ...
     * 
     */
    public PointOfInteractionComponentCharacteristics11 addSctyElmt(CryptographicKey19 sctyElmt) {
