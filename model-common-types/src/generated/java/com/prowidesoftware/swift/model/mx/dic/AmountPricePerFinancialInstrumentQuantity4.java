...
@XmlType(name = "AmountPricePerFinancialInstrumentQuantity4", propOrder = {
    "amtPricTp",
    "pricVal",
    "finInstrmQty"
})
public class AmountPricePerFinancialInstrumentQuantity4 {
     ...
     *     
     */
    public AmountPricePerFinancialInstrumentQuantity4 setAmtPricTp(AmountPriceType1Code value) {
     ...
     *     
     */
    public AmountPricePerFinancialInstrumentQuantity4 setPricVal(RestrictedFINActiveCurrencyAnd13DecimalAmount value) {
        this.pricVal = value;
        return this;
    }
     ...
     *     
     */
    public AmountPricePerFinancialInstrumentQuantity4 setFinInstrmQty(FinancialInstrumentQuantity15Choice value) {
