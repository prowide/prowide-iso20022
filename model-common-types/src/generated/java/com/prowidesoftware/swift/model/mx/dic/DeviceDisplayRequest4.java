...
@XmlType(name = "DeviceDisplayRequest4", propOrder = {
    "dispOutpt"
})
public class DeviceDisplayRequest4 {

    @XmlElement(name = "DispOutpt", required = true)
    protected List<ActionMessage9> dispOutpt;
     ...
     * 
     */
    public List<ActionMessage9> getDispOutpt() {
        if (dispOutpt == null) {
            dispOutpt = new ArrayList<ActionMessage9>();
        }
     ...
     * 
     */
    public DeviceDisplayRequest4 addDispOutpt(ActionMessage9 dispOutpt) {
