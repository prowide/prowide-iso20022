...
@XmlType(name = "StatusReportContent15", propOrder = {
    "poiCpblties",
    "poiCmpnt",
    "poiGrpId",
    "attndncCntxt",
...
public class StatusReportContent15 {

    @XmlElement(name = "POICpblties")
    protected PointOfInteractionCapabilities11 poiCpblties;
    @XmlElement(name = "POICmpnt")
    protected List<PointOfInteractionComponent18> poiCmpnt;
    ...
    protected List<DataSetRequest7> dataSetReqrd;
    @XmlElement(name = "Evt")
    protected List<TMSEvent13> evt;
     ...
     * @return
     *     possible object is
     *     {@link PointOfInteractionCapabilities11 }
     *     
     */
    public PointOfInteractionCapabilities11 getPOICpblties() {
        return poiCpblties;
    }
     ...
     *     
     */
    public StatusReportContent15 setPOICpblties(PointOfInteractionCapabilities11 value) {
     ...
     * {@link PointOfInteractionComponent18 }
     * 
     * 
     * @return
     *     The value of the poiCmpnt property.
     */
    public List<PointOfInteractionComponent18> getPOICmpnt() {
        if (poiCmpnt == null) {
     ...
     *     
     */
    public StatusReportContent15 setAttndncCntxt(AttendanceContext1Code value) {
     ...
     *     
     */
    public StatusReportContent15 setPOIDtTm(OffsetDateTime value) {
        this.poiDtTm = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DataSetRequest7 }
     * 
     * 
     * @return
     *     The value of the dataSetReqrd property.
     */
    public List<DataSetRequest7> getDataSetReqrd() {
     ...
     * 
     */
    public StatusReportContent15 addPOICmpnt(PointOfInteractionComponent18 pOICmpnt) {
     ...
     * 
     */
    public StatusReportContent15 addPOIGrpId(String pOIGrpId) {
     ...
     * 
     */
    public StatusReportContent15 addDataSetReqrd(DataSetRequest7 dataSetReqrd) {
     ...
     * 
     */
    public StatusReportContent15 addEvt(TMSEvent13 evt) {
        getEvt().add(evt);
        return this;
    }
     ...
     * 
     */
    public StatusReportContent15 addErrs(String errs) {
        getErrs().add(errs);
        return this;
    }
