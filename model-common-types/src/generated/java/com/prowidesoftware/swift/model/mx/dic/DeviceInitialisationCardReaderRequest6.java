...
@XmlType(name = "DeviceInitialisationCardReaderRequest6", propOrder = {
    "warmRstFlg",
    "forceNtryMd",
    "leavCardFlg",
    "maxWtgTm",
...
public class DeviceInitialisationCardReaderRequest6 {
     ...
     *     
     */
    public DeviceInitialisationCardReaderRequest6 setWarmRstFlg(Boolean value) {
     ...
     *     
     */
    public DeviceInitialisationCardReaderRequest6 setLeavCardFlg(Boolean value) {
     ...
     *     
     */
    public DeviceInitialisationCardReaderRequest6 setMaxWtgTm(BigDecimal value) {
        this.maxWtgTm = value;
        return this;
    }
     ...
     *     
     */
    public DeviceInitialisationCardReaderRequest6 setDispOutpt(ActionMessage11 value) {
     ...
     * 
     */
    public DeviceInitialisationCardReaderRequest6 addForceNtryMd(CardDataReading8Code forceNtryMd) {
