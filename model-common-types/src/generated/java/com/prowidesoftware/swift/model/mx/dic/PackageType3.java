...
@XmlType(name = "PackageType3", propOrder = {
    "packgId",
    "packgLngth",
    "offsetStart",
    "offsetEnd",
...
public class PackageType3 {
    ...
    protected List<ExternallyDefinedData3> packgBlck;
     ...
     *     
     */
    public PackageType3 setPackgId(GenericIdentification176 value) {
        this.packgId = value;
        return this;
    }
     ...
     *     
     */
    public PackageType3 setPackgLngth(BigDecimal value) {
     ...
     *     
     */
    public PackageType3 setOffsetStart(BigDecimal value) {
     ...
     *     
     */
    public PackageType3 setOffsetEnd(BigDecimal value) {
     ...
     * 
     */
    public List<ExternallyDefinedData3> getPackgBlck() {
        if (packgBlck == null) {
            packgBlck = new ArrayList<ExternallyDefinedData3>();
        }
     ...
     * 
     */
    public PackageType3 addPackgBlck(ExternallyDefinedData3 packgBlck) {
