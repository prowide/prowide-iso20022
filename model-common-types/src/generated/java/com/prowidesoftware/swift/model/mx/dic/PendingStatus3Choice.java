...
@XmlType(name = "PendingStatus3Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus3Choice {
     ...
     *     
     */
    public PendingStatus3Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public PendingStatus3Choice addRsn(PendingReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
