...
public class BatchResponse5 {
     ...
     *     
     */
    public BatchResponse5 setSaleBtchId(TransactionIdentifier1 value) {
     ...
     *     
     */
    public BatchResponse5 setPOIBtchId(TransactionIdentifier1 value) {
    ...
    public List<PerformedTransaction5> getPrfrmdTx() {
        if (prfrmdTx == null) {
            prfrmdTx = new ArrayList<PerformedTransaction5>();
        }
     ...
     * 
     */
    public BatchResponse5 addPrfrmdTx(PerformedTransaction5 prfrmdTx) {
