...
@XmlType(name = "RejectionStatus5Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectionStatus5Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<RejectionReason10> rsn;
     ...
     *     
     */
    public RejectionStatus5Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectionReason10 }
     * 
     * 
     */
    public List<RejectionReason10> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectionReason10>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectionStatus5Choice addRsn(RejectionReason10 rsn) {
        getRsn().add(rsn);
        return this;
    }
