...
@XmlType(name = "RetailerReversalResult6", propOrder = {
    "poiRcncltnId",
    "orgnlPmtTx",
    "cstmrOrdr"
})
public class RetailerReversalResult6 {

    @XmlElement(name = "POIRcncltnId")
    protected String poiRcncltnId;
    @XmlElement(name = "OrgnlPmtTx")
    protected CardPaymentTransaction136 orgnlPmtTx;
     ...
     *     
     */
    public RetailerReversalResult6 setPOIRcncltnId(String value) {
     ...
     *     
     */
    public CardPaymentTransaction136 getOrgnlPmtTx() {
        return orgnlPmtTx;
    }
     ...
     *     
     */
    public RetailerReversalResult6 setOrgnlPmtTx(CardPaymentTransaction136 value) {
     ...
     * 
     */
    public RetailerReversalResult6 addCstmrOrdr(CustomerOrder1 cstmrOrdr) {
