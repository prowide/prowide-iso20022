...
@XmlType(name = "StoredValueResponse7", propOrder = {
    "saleTxId",
    "poiTxId",
    "rslt",
    "rct"
})
public class StoredValueResponse7 {
    ...
    protected List<StoredValueData7> rslt;
    @XmlElement(name = "Rct")
     ...
     *     
     */
    public StoredValueResponse7 setSaleTxId(TransactionIdentifier1 value) {
        this.saleTxId = value;
        return this;
    }
     ...
     *     
     */
    public StoredValueResponse7 setPOITxId(TransactionIdentifier1 value) {
        this.poiTxId = value;
        return this;
    }
     ...
     * 
     */
    public List<StoredValueData7> getRslt() {
        if (rslt == null) {
            rslt = new ArrayList<StoredValueData7>();
        }
        return this.rslt;
    }
     ...
     * 
     */
    public StoredValueResponse7 addRslt(StoredValueData7 rslt) {
        getRslt().add(rslt);
        return this;
    }
     ...
     * 
     */
    public StoredValueResponse7 addRct(PaymentReceipt6 rct) {
        getRct().add(rct);
        return this;
    }
