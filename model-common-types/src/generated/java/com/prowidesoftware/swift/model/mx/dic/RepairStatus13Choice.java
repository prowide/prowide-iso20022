...
@XmlType(name = "RepairStatus13Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RepairStatus13Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RepairReason9> rsn;
     ...
     *     
     */
    public RepairStatus13Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<RepairReason9> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RepairReason9>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RepairStatus13Choice addRsn(RepairReason9 rsn) {
        getRsn().add(rsn);
        return this;
    }
