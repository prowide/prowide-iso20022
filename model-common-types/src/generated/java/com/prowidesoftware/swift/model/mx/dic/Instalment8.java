...
@XmlType(name = "Instalment8", propOrder = {
    "pmtSeqNb",
    "plan"
})
public class Instalment8 {

    @XmlElement(name = "PmtSeqNb")
    protected BigDecimal pmtSeqNb;
    @XmlElement(name = "Plan")
    protected List<InstalmentPlan1> plan;
     ...
     *     
     */
    public Instalment8 setPmtSeqNb(BigDecimal value) {
        this.pmtSeqNb = value;
        return this;
    }
     ...
     * {@link InstalmentPlan1 }
     * 
     * 
     * @return
     *     The value of the plan property.
     */
    public List<InstalmentPlan1> getPlan() {
        if (plan == null) {
            plan = new ArrayList<>();
        }
        return this.plan;
     ...
     * 
     */
    public Instalment8 addPlan(InstalmentPlan1 plan) {
        getPlan().add(plan);
        return this;
    }
