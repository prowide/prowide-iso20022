...
@XmlType(name = "StructuredRemittanceInformation22", propOrder = {
    "rfrdDocInf",
    "rfrdDocAmt",
    "cdtrRefInf",
    "invcr",
...
public class StructuredRemittanceInformation22 {
    ...
    @XmlElement(name = "SctiesData")
    protected List<SecuritiesAttributes1> sctiesData;
     ...
     *     
     */
    public StructuredRemittanceInformation22 setRfrdDocAmt(RemittanceAmount4 value) {
     ...
     *     
     */
    public StructuredRemittanceInformation22 setCdtrRefInf(CreditorReferenceInformation3 value) {
     ...
     *     
     */
    public StructuredRemittanceInformation22 setInvcr(PartyIdentification272 value) {
        this.invcr = value;
        return this;
    }
     ...
     *     
     */
    public StructuredRemittanceInformation22 setInvcee(PartyIdentification272 value) {
        this.invcee = value;
        return this;
    }
     ...
     *     
     */
    public StructuredRemittanceInformation22 setTaxRmt(TaxData1 value) {
        this.taxRmt = value;
        return this;
    }
     ...
     *     
     */
    public StructuredRemittanceInformation22 setGrnshmtRmt(Garnishment4 value) {
        this.grnshmtRmt = value;
        return this;
    }

    /**
     * Gets the value of the sctiesData property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the sctiesData property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSctiesData().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SecuritiesAttributes1 }
     * 
     * 
     * @return
     *     The value of the sctiesData property.
     */
    public List<SecuritiesAttributes1> getSctiesData() {
        if (sctiesData == null) {
            sctiesData = new ArrayList<>();
        }
        return this.sctiesData;
    }
     ...
     * 
     */
    public StructuredRemittanceInformation22 addRfrdDocInf(ReferredDocumentInformation8 rfrdDocInf) {
        getRfrdDocInf().add(rfrdDocInf);
        return this;
    }

    /**
     * Adds a new item to the sctiesData list.
     * @see #getSctiesData()
     * 
     */
    public StructuredRemittanceInformation22 addSctiesData(SecuritiesAttributes1 sctiesData) {
        getSctiesData().add(sctiesData);
        return this;
    }
     ...
     * 
     */
    public StructuredRemittanceInformation22 addAddtlRmtInf(String addtlRmtInf) {
