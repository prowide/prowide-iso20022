...
@XmlType(name = "PendingStatus24Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus24Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingReason3> rsn;
     ...
     *     
     */
    public PendingStatus24Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<PendingReason3> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingReason3>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus24Choice addRsn(PendingReason3 rsn) {
        getRsn().add(rsn);
        return this;
    }
