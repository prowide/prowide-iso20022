...
@XmlType(name = "StatusReportContent13", propOrder = {
    "poiCpblties",
    "poiCmpnt",
    "poiGrpId",
    "attndncCntxt",
...
public class StatusReportContent13 {

    @XmlElement(name = "POICpblties")
    protected PointOfInteractionCapabilities9 poiCpblties;
    @XmlElement(name = "POICmpnt")
    protected List<PointOfInteractionComponent15> poiCmpnt;
    ...
    protected List<DataSetRequest5> dataSetReqrd;
    @XmlElement(name = "Evt")
    protected List<TMSEvent11> evt;
     ...
     *     
     */
    public StatusReportContent13 setPOICpblties(PointOfInteractionCapabilities9 value) {
     ...
     * 
     */
    public List<PointOfInteractionComponent15> getPOICmpnt() {
        if (poiCmpnt == null) {
            poiCmpnt = new ArrayList<PointOfInteractionComponent15>();
        }
     ...
     *     
     */
    public StatusReportContent13 setAttndncCntxt(AttendanceContext1Code value) {
     ...
     *     
     */
    public StatusReportContent13 setPOIDtTm(XMLGregorianCalendar value) {
        this.poiDtTm = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DataSetRequest5 }
     * 
     * 
     */
    public List<DataSetRequest5> getDataSetReqrd() {
        if (dataSetReqrd == null) {
            dataSetReqrd = new ArrayList<DataSetRequest5>();
        }
     ...
     * 
     */
    public List<TMSEvent11> getEvt() {
        if (evt == null) {
            evt = new ArrayList<TMSEvent11>();
        }
        return this.evt;
    }
     ...
     * 
     */
    public StatusReportContent13 addPOICmpnt(PointOfInteractionComponent15 pOICmpnt) {
     ...
     * 
     */
    public StatusReportContent13 addPOIGrpId(String pOIGrpId) {
     ...
     * 
     */
    public StatusReportContent13 addDataSetReqrd(DataSetRequest5 dataSetReqrd) {
     ...
     * 
     */
    public StatusReportContent13 addEvt(TMSEvent11 evt) {
        getEvt().add(evt);
        return this;
    }
     ...
     * 
     */
    public StatusReportContent13 addErrs(String errs) {
        getErrs().add(errs);
        return this;
    }
