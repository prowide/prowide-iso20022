...
@XmlType(name = "KeyTransport7", propOrder = {
    "vrsn",
    "rcptId",
    "keyNcrptnAlgo",
    "ncrptdKey"
})
public class KeyTransport7 {

    @XmlElement(name = "Vrsn")
    protected BigDecimal vrsn;
    @XmlElement(name = "RcptId", required = true)
    protected Recipient9Choice rcptId;
     ...
     *     
     */
    public KeyTransport7 setVrsn(BigDecimal value) {
        this.vrsn = value;
        return this;
    }
     ...
     *     
     */
    public Recipient9Choice getRcptId() {
        return rcptId;
    }
     ...
     *     
     */
    public KeyTransport7 setRcptId(Recipient9Choice value) {
        this.rcptId = value;
        return this;
    }
     ...
     *     
     */
    public KeyTransport7 setKeyNcrptnAlgo(AlgorithmIdentification19 value) {
     ...
     *     byte[]
     */
    public KeyTransport7 setNcrptdKey(byte[] value) {
