...
@XmlType(name = "DeniedStatus19Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus19Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason17> rsn;
     ...
     *     
     */
    public DeniedStatus19Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason17> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason17>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus19Choice addRsn(DeniedReason17 rsn) {
        getRsn().add(rsn);
        return this;
    }
