...
@XmlType(name = "UnderlyingPaymentTransaction11", propOrder = {
    "orgnlGrpInf",
    "orgnlInstrId",
    "orgnlEndToEndId",
    "orgnlTxId",
...
public class UnderlyingPaymentTransaction11 {
     ...
     *     
     */
    public UnderlyingPaymentTransaction11 setOrgnlGrpInf(UnderlyingGroupInformation1 value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction11 setOrgnlInstrId(String value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction11 setOrgnlEndToEndId(String value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction11 setOrgnlTxId(String value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction11 setOrgnlUETR(String value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction11 setOrgnlIntrBkSttlmAmt(ActiveOrHistoricCurrencyAndAmount value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction11 setOrgnlIntrBkSttlmDt(LocalDate value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction11 setOrgnlTxRef(OriginalTransactionReference48 value) {
     ...
     *     
     */
    public UnderlyingPaymentTransaction11 setOrgnlSvcLvl(ServiceLevel8Choice value) {
