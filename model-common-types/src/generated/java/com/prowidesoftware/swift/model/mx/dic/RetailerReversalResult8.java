...
@XmlType(name = "RetailerReversalResult8", propOrder = {
    "poiRcncltnId",
    "orgnlPmtTx",
    "cstmrOrdr"
})
public class RetailerReversalResult8 {

    @XmlElement(name = "POIRcncltnId")
    protected String poiRcncltnId;
    @XmlElement(name = "OrgnlPmtTx")
    protected PaymentTransaction183 orgnlPmtTx;
     ...
     *     
     */
    public RetailerReversalResult8 setPOIRcncltnId(String value) {
     ...
     *     
     */
    public PaymentTransaction183 getOrgnlPmtTx() {
        return orgnlPmtTx;
    }
     ...
     *     
     */
    public RetailerReversalResult8 setOrgnlPmtTx(PaymentTransaction183 value) {
     ...
     * 
     */
    public RetailerReversalResult8 addCstmrOrdr(CustomerOrder1 cstmrOrdr) {
