...
@XmlType(name = "ReportTransactionResponse8", propOrder = {
    "rptFullSz",
    "blckStart",
    "blckStop",
    "txRpt"
})
public class ReportTransactionResponse8 {
    ...
    protected List<ServiceResponse10> txRpt;
     ...
     *     
     */
    public ReportTransactionResponse8 setRptFullSz(BigDecimal value) {
     ...
     *     
     */
    public ReportTransactionResponse8 setBlckStart(BigDecimal value) {
     ...
     *     
     */
    public ReportTransactionResponse8 setBlckStop(BigDecimal value) {
        this.blckStop = value;
        return this;
    }
     ...
     * {@link ServiceResponse10 }
     * 
     * 
     * @return
     *     The value of the txRpt property.
     */
    public List<ServiceResponse10> getTxRpt() {
        if (txRpt == null) {
            txRpt = new ArrayList<>();
        }
        return this.txRpt;
     ...
     * 
     */
    public ReportTransactionResponse8 addTxRpt(ServiceResponse10 txRpt) {
        getTxRpt().add(txRpt);
        return this;
    }
