...
public class AmendmentInformationDetails11 {
     ...
     *     
     */
    public AmendmentInformationDetails11 setOrgnlMndtId(String value) {
     ...
     *     
     */
    public AmendmentInformationDetails11 setOrgnlCdtrSchmeId(PartyIdentification43 value) {
     ...
     *     
     */
    public AmendmentInformationDetails11 setOrgnlCdtrAgt(BranchAndFinancialInstitutionIdentification5 value) {
     ...
     *     
     */
    public AmendmentInformationDetails11 setOrgnlCdtrAgtAcct(CashAccount24 value) {
     ...
     *     
     */
    public AmendmentInformationDetails11 setOrgnlDbtr(PartyIdentification43 value) {
     ...
     *     
     */
    public AmendmentInformationDetails11 setOrgnlDbtrAcct(CashAccount24 value) {
     ...
     *     
     */
    public AmendmentInformationDetails11 setOrgnlDbtrAgt(BranchAndFinancialInstitutionIdentification5 value) {
     ...
     *     
     */
    public AmendmentInformationDetails11 setOrgnlDbtrAgtAcct(CashAccount24 value) {
     ...
     *     
     */
    public AmendmentInformationDetails11 setOrgnlFnlColltnDt(LocalDate value) {
     ...
     *     
     */
    public AmendmentInformationDetails11 setOrgnlFrqcy(Frequency36Choice value) {
     ...
     *     
     */
    public AmendmentInformationDetails11 setOrgnlRsn(MandateSetupReason1Choice value) {
        this.orgnlRsn = value;
        return this;
    }
     ...
     *     
     */
    public AmendmentInformationDetails11 setOrgnlTrckgDays(String value) {
