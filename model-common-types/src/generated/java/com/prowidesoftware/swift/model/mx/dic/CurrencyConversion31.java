...
@XmlType(name = "CurrencyConversion31", propOrder = {
    "rslt",
    "rsltRsn",
    "convsDtls"
})
public class CurrencyConversion31 {
    ...
    protected List<CurrencyConversion29> convsDtls;
     ...
     *     
     */
    public CurrencyConversion31 setRslt(CurrencyConversionResponse3Code value) {
        this.rslt = value;
        return this;
    }
     ...
     *     
     */
    public CurrencyConversion31 setRsltRsn(String value) {
        this.rsltRsn = value;
        return this;
    }
     ...
     * 
     */
    public List<CurrencyConversion29> getConvsDtls() {
        if (convsDtls == null) {
            convsDtls = new ArrayList<CurrencyConversion29>();
        }
     ...
     * 
     */
    public CurrencyConversion31 addConvsDtls(CurrencyConversion29 convsDtls) {
