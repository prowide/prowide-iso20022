...
@XmlType(name = "SettlementDetails125", propOrder = {
    "hldInd",
    "sctiesTxTp",
    "sttlmTxCond",
    "prtlSttlmInd",
...
public class SettlementDetails125 {

    @XmlElement(name = "HldInd")
    protected Boolean hldInd;
    @XmlElement(name = "SctiesTxTp", required = true)
    protected SecuritiesTransactionType33Choice sctiesTxTp;
     ...
     *     
     */
    public SettlementDetails125 setHldInd(Boolean value) {
        this.hldInd = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesTransactionType33Choice }
     *     
     */
    public SecuritiesTransactionType33Choice getSctiesTxTp() {
        return sctiesTxTp;
    }
     ...
     *     
     */
    public SettlementDetails125 setSctiesTxTp(SecuritiesTransactionType33Choice value) {
    ...
    public List<SettlementTransactionCondition17Choice> getSttlmTxCond() {
        if (sttlmTxCond == null) {
            sttlmTxCond = new ArrayList<SettlementTransactionCondition17Choice>();
        }
     ...
     *     
     */
    public SettlementDetails125 setPrtlSttlmInd(SettlementTransactionCondition5Code value) {
     ...
     *     
     */
    public SettlementDetails125 setBnfclOwnrsh(BeneficialOwnership4Choice value) {
     ...
     *     
     */
    public SettlementDetails125 setCshClrSys(CashSettlementSystem4Choice value) {
     ...
     *     
     */
    public SettlementDetails125 setMktClntSd(MarketClientSide4Choice value) {
     ...
     *     
     */
    public SettlementDetails125 setRegn(Registration9Choice value) {
        this.regn = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails125 setRpTp(RepurchaseType13Choice value) {
        this.rpTp = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails125 setSctiesRTGS(SecuritiesRTGS4Choice value) {
     ...
     *     
     */
    public SettlementDetails125 setStmpDtyTaxBsis(GenericIdentification30 value) {
     ...
     * 
     */
    public SettlementDetails125 addSttlmTxCond(SettlementTransactionCondition17Choice sttlmTxCond) {
