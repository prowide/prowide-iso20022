...
@XmlType(name = "FailingStatus8Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class FailingStatus8Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<FailingReason5> rsn;
     ...
     *     
     */
    public FailingStatus8Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<FailingReason5> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<FailingReason5>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public FailingStatus8Choice addRsn(FailingReason5 rsn) {
        getRsn().add(rsn);
        return this;
    }
