...
@XmlType(name = "EncryptedContent2", propOrder = {
    "cnttTp",
    "cnttNcrptnAlgo",
    "ncrptdData"
})
public class EncryptedContent2 {
    ...
    protected AlgorithmIdentification6 cnttNcrptnAlgo;
     ...
     *     
     */
    public EncryptedContent2 setCnttTp(ContentType1Code value) {
        this.cnttTp = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link AlgorithmIdentification6 }
     *     
     */
    public AlgorithmIdentification6 getCnttNcrptnAlgo() {
     ...
     *     
     */
    public EncryptedContent2 setCnttNcrptnAlgo(AlgorithmIdentification6 value) {
     ...
     *     byte[]
     */
    public EncryptedContent2 setNcrptdData(byte[] value) {
