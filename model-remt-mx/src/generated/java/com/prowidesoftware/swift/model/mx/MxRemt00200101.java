    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:remt.002.001.01";
    ...
    public static MxRemt00200101 parse(String xml) {
        return ((MxRemt00200101) MxReadImpl.parse(MxRemt00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxRemt00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxRemt00200101) MxReadImpl.parse(MxRemt00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxRemt00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxRemt00200101 .class);
    }
