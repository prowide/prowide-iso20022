    ...
    extends AbstractMX
{
    ...
    public static MxRemt00200103 parse(String xml) {
        return ((MxRemt00200103) MxReadImpl.parse(MxRemt00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxRemt00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxRemt00200103) MxReadImpl.parse(MxRemt00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxRemt00200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxRemt00200103 .class);
    }
