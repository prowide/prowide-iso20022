    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:remt.001.001.03";
    ...
    public static MxRemt00100103 parse(String xml) {
        return ((MxRemt00100103) MxReadImpl.parse(MxRemt00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxRemt00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxRemt00100103) MxReadImpl.parse(MxRemt00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxRemt00100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxRemt00100103 .class);
    }
