    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:remt.001.001.01";
    ...
    public static MxRemt00100101 parse(String xml) {
        return ((MxRemt00100101) MxReadImpl.parse(MxRemt00100101 .class, xml, _classes));
    }
     ...
     */
    public final static MxRemt00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxRemt00100101 .class);
    }
