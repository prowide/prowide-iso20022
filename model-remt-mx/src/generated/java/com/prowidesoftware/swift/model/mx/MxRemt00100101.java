    ...
    extends AbstractMX
{
    ...
    public static MxRemt00100101 parse(String xml) {
        return ((MxRemt00100101) MxReadImpl.parse(MxRemt00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxRemt00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxRemt00100101) MxReadImpl.parse(MxRemt00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
