    ...
    extends AbstractMX
{
    ...
    public static MxRemt00100105 parse(String xml) {
        return ((MxRemt00100105) MxReadImpl.parse(MxRemt00100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxRemt00100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxRemt00100105) MxReadImpl.parse(MxRemt00100105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxRemt00100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxRemt00100105 .class);
    }
