    ...
    extends AbstractMX
{
    ...
    public static MxRemt00100104 parse(String xml) {
        return ((MxRemt00100104) MxReadImpl.parse(MxRemt00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxRemt00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxRemt00100104) MxReadImpl.parse(MxRemt00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
