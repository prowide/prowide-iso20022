...
public class Sale4 {
    ...
    protected List<SaleItem5> lineItm;
     ...
     *     
     */
    public Sale4 setSummryCmmdtyId(String value) {
     ...
     *     
     */
    public Sale4 setLltyPrgrmm(LoyaltyProgramme4 value) {
     ...
     */
    public List<SaleItem5> getLineItm() {
        if (lineItm == null) {
     ...
     * 
     */
    public Sale4 addAdjstmnt(Adjustment13 adjstmnt) {
     ...
     * 
     */
    public Sale4 addLineItm(SaleItem5 lineItm) {
