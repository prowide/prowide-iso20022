...
@XmlType(name = "Context25", propOrder = {
    "cardDataNtryMd",
    "othrCardDataNtryMd",
    "qrCdPresntmntMd",
    "mrchntCtgyCd",
...
public class Context25 {
     ...
     *     
     */
    public Context25 setCardDataNtryMd(CardDataReading11Code value) {
     ...
     *     
     */
    public Context25 setOthrCardDataNtryMd(String value) {
     ...
     *     
     */
    public Context25 setQRCdPresntmntMd(QRCodePresentmentMode2Code value) {
     ...
     *     
     */
    public Context25 setMrchntCtgyCd(String value) {
     ...
     *     
     */
    public Context25 setMrchntCtgySpcfcData(String value) {
     ...
     *     
     */
    public Context25 setOthrMrchntCtgy(String value) {
     ...
     *     
     */
    public Context25 setPOSCondCd(String value) {
     ...
     *     
     */
    public Context25 setCardPres(Boolean value) {
        this.cardPres = value;
        return this;
    }
     ...
     *     
     */
    public Context25 setCrdhldrPres(Boolean value) {
     ...
     *     
     */
    public Context25 setCrdhldrActvtd(Boolean value) {
     ...
     *     
     */
    public Context25 setTrnspndrInittd(Boolean value) {
     ...
     *     
     */
    public Context25 setTrnst(Boolean value) {
        this.trnst = value;
        return this;
    }
     ...
     *     
     */
    public Context25 setAttndd(Boolean value) {
        this.attndd = value;
        return this;
    }
     ...
     *     
     */
    public Context25 setUattnddLvlCtgy(String value) {
     ...
     *     
     */
    public Context25 setEComrc(Boolean value) {
        this.eComrc = value;
        return this;
    }
     ...
     *     
     */
    public Context25 setEComrcIndApld(String value) {
     ...
     *     
     */
    public Context25 setEComrcData(ATICALaxProcessing value) {
     ...
     *     
     */
    public Context25 setMOTOCd(MOTO2Code value) {
        this.motoCd = value;
        return this;
    }
     ...
     *     
     */
    public Context25 setTxInitr(TransactionInitiator1Code value) {
        this.txInitr = value;
        return this;
    }
     ...
     *     
     */
    public Context25 setDelydChrgs(Boolean value) {
     ...
     *     
     */
    public Context25 setNoShow(Boolean value) {
        this.noShow = value;
        return this;
    }
     ...
     *     
     */
    public Context25 setReauthstn(Boolean value) {
     ...
     *     
     */
    public Context25 setReSubmissn(Boolean value) {
     ...
     *     
     */
    public Context25 setDelydAuthstn(Boolean value) {
     ...
     *     
     */
    public Context25 setLatePresntmnt(Boolean value) {
     ...
     *     
     */
    public Context25 setDfrrdDlvry(Boolean value) {
     ...
     *     
     */
    public Context25 setPrtlShipmnt(Boolean value) {
     ...
     *     
     */
    public Context25 setSpltPmt(Boolean value) {
        this.spltPmt = value;
        return this;
    }
     ...
     *     
     */
    public Context25 setPrtlApprvlSpprtd(Boolean value) {
     ...
     *     
     */
    public Context25 setStorgLctn(String value) {
     ...
     *     
     */
    public Context25 setAuthntcnOutg(Boolean value) {
     ...
     *     
     */
    public Context25 setPmtCrdntlMrchntRltsh(Boolean value) {
     ...
     *     
     */
    public Context25 setCaptrDt(LocalDate value) {
        this.captrDt = value;
        return this;
    }
     ...
     *     
     */
    public Context25 setDtAntcptd(LocalDate value) {
     ...
     *     
     */
    public Context25 setICCFllbck(Boolean value) {
     ...
     * 
     */
    public Context25 addSctyChrtcs(SecurityCharacteristics2Code sctyChrtcs) {
     ...
     * 
     */
    public Context25 addPrvtData(ATICALaxProcessing prvtData) {
     ...
     * 
     */
    public Context25 addNtlData(ATICALaxProcessing ntlData) {
