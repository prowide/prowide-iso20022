...
@XmlType(name = "FleetSummary1", propOrder = {
    "drvr",
    "vhcl",
    "drvrOrVhclCard",
    "cardFuelPrmptCd",
...
public class FleetSummary1 {
    ...
    protected List<PaymentTransaction117> txRltdData;
     ...
     *     
     */
    public FleetSummary1 setDrvr(Driver1 value) {
        this.drvr = value;
        return this;
    }
     ...
     *     
     */
    public FleetSummary1 setVhcl(Vehicle5 value) {
        this.vhcl = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link PlainCardData20 }
     *     
     */
    public PlainCardData20 getDrvrOrVhclCard() {
     ...
     *     
     */
    public FleetSummary1 setDrvrOrVhclCard(PlainCardData20 value) {
     ...
     *     
     */
    public FleetSummary1 setCardFuelPrmptCd(BigDecimal value) {
     ...
     *     
     */
    public FleetSummary1 setAgtFuelPrmptCd(String value) {
     ...
     *     
     */
    public FleetSummary1 setTripInf(TripInformation1 value) {
        this.tripInf = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction117 }
     * 
     * 
     */
    public List<PaymentTransaction117> getTxRltdData() {
        if (txRltdData == null) {
            txRltdData = new ArrayList<PaymentTransaction117>();
        }
     ...
     *     
     */
    public FleetSummary1 setAddtlData(AdditionalInformation19 value) {
     ...
     * 
     */
    public FleetSummary1 addLclAmnty(LocalAmenity1 lclAmnty) {
     ...
     * 
     */
    public FleetSummary1 addTxRltdData(PaymentTransaction117 txRltdData) {
