...
@XmlType(name = "ProcessingResult5", propOrder = {
    "rsltData",
    "orgnlRsltData",
    "actnReqrd",
    "actn",
...
public class ProcessingResult5 {
     ...
     *     
     */
    public ProcessingResult5 setRsltData(ResultData1 value) {
        this.rsltData = value;
        return this;
    }
     ...
     *     
     */
    public ProcessingResult5 setOrgnlRsltData(ResultData1 value) {
     ...
     *     
     */
    public ProcessingResult5 setActnReqrd(Boolean value) {
     ...
     * 
     */
    public ProcessingResult5 addActn(Action9 actn) {
        getActn().add(actn);
        return this;
    }
     ...
     * 
     */
    public ProcessingResult5 addAddtlActn(AdditionalAction1 addtlActn) {
     ...
     * 
     */
    public ProcessingResult5 addAddtlInf(AdditionalInformation20 addtlInf) {
