...
@XmlType(name = "AccountBalance4", propOrder = {
    "acctTp",
    "bal"
})
public class AccountBalance4 {
    ...
    protected List<CardAccountBalance1> bal;
     ...
     *     
     */
    public AccountBalance4 setAcctTp(String value) {
        this.acctTp = value;
        return this;
    }
     ...
     * {@link CardAccountBalance1 }
     * 
     * 
     * @return
     *     The value of the bal property.
     */
    public List<CardAccountBalance1> getBal() {
        if (bal == null) {
            bal = new ArrayList<>();
        }
        return this.bal;
     ...
     * 
     */
    public AccountBalance4 addBal(CardAccountBalance1 bal) {
        getBal().add(bal);
        return this;
    }
