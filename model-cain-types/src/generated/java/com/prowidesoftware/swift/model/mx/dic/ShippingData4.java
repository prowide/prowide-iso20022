...
@XmlType(name = "ShippingData4", propOrder = {
    "invcNb",
    "invcCreDtTm",
    "svcDscrptrCd",
    "incntivAmt",
...
public class ShippingData4 {
    ...
    protected List<ShippingPackage4> packg;
     ...
     *     
     */
    public ShippingData4 setInvcNb(String value) {
        this.invcNb = value;
        return this;
    }
     ...
     *     
     */
    public ShippingData4 setInvcCreDtTm(OffsetDateTime value) {
     ...
     *     
     */
    public ShippingData4 setSvcDscrptrCd(String value) {
     ...
     *     
     */
    public ShippingData4 setIncntivAmt(BigDecimal value) {
     ...
     *     
     */
    public ShippingData4 setMiscExpnss(BigDecimal value) {
     ...
     *     
     */
    public ShippingData4 setInsrnc(Boolean value) {
        this.insrnc = value;
        return this;
    }
     ...
     *     
     */
    public ShippingData4 setInsrncAmt(BigDecimal value) {
     ...
     *     
     */
    public ShippingData4 setNetAmt(BigDecimal value) {
        this.netAmt = value;
        return this;
    }
     ...
     *     
     */
    public ShippingData4 setSummryCmmdtyId(String value) {
     ...
     *     
     */
    public ShippingData4 setNbOfPackgs(String value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ShippingPackage4 }
     * 
     * 
     * @return
     *     The value of the packg property.
     */
    public List<ShippingPackage4> getPackg() {
        if (packg == null) {
            packg = new ArrayList<>();
        }
        return this.packg;
     ...
     * 
     */
    public ShippingData4 addTax(Tax44 tax) {
        getTax().add(tax);
        return this;
    }
     ...
     * 
     */
    public ShippingData4 addPackg(ShippingPackage4 packg) {
        getPackg().add(packg);
        return this;
    }
     ...
     * 
     */
    public ShippingData4 addPrvtData(ATICALaxProcessing prvtData) {
     ...
     * 
     */
    public ShippingData4 addNtlData(ATICALaxProcessing ntlData) {
