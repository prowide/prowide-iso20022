...
@XmlType(name = "Instalment3", propOrder = {
    "pmtSeqNb",
    "plan"
})
public class Instalment3 {

    @XmlElement(name = "PmtSeqNb")
    protected BigDecimal pmtSeqNb;
    @XmlElement(name = "Plan")
    protected List<Plan1> plan;
     ...
     *     
     */
    public Instalment3 setPmtSeqNb(BigDecimal value) {
        this.pmtSeqNb = value;
        return this;
    }
     ...
     * 
     */
    public List<Plan1> getPlan() {
        if (plan == null) {
            plan = new ArrayList<Plan1>();
        }
        return this.plan;
    }
     ...
     * 
     */
    public Instalment3 addPlan(Plan1 plan) {
        getPlan().add(plan);
        return this;
    }
