...
@XmlType(name = "ProcessingResult11", propOrder = {
    "rsltData",
    "orgnlRsltData",
    "actnReqrd",
    "actn",
...
public class ProcessingResult11 {
     ...
     *     
     */
    public ProcessingResult11 setRsltData(ResultData7 value) {
        this.rsltData = value;
        return this;
    }
     ...
     *     
     */
    public ProcessingResult11 setOrgnlRsltData(ResultData7 value) {
     ...
     *     
     */
    public ProcessingResult11 setActnReqrd(Boolean value) {
     ...
     * 
     */
    public ProcessingResult11 addActn(Action13 actn) {
        getActn().add(actn);
        return this;
    }
     ...
     * 
     */
    public ProcessingResult11 addAddtlActn(AdditionalAction1 addtlActn) {
     ...
     * 
     */
    public ProcessingResult11 addAddtlInf(AdditionalInformation29 addtlInf) {
