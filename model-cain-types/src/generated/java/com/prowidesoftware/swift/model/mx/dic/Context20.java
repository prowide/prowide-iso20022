...
@XmlType(name = "Context20", propOrder = {
    "cardDataNtryMd",
    "othrCardDataNtryMd",
    "qrCdPresntmntMd",
    "othrQRCdPresntmntMd",
...
public class Context20 {
     ...
     *     
     */
    public Context20 setCardDataNtryMd(CardDataReading10Code value) {
     ...
     *     
     */
    public Context20 setOthrCardDataNtryMd(String value) {
     ...
     *     
     */
    public Context20 setQRCdPresntmntMd(QRCodePresentmentMode1Code value) {
     ...
     *     
     */
    public Context20 setOthrQRCdPresntmntMd(String value) {
     ...
     *     
     */
    public Context20 setMrchntCtgyCd(String value) {
     ...
     *     
     */
    public Context20 setMrchntCtgySpcfcData(String value) {
     ...
     *     
     */
    public Context20 setOthrMrchntCtgy(String value) {
     ...
     *     
     */
    public Context20 setCardPres(Boolean value) {
        this.cardPres = value;
        return this;
    }
     ...
     *     
     */
    public Context20 setCrdhldrPres(Boolean value) {
     ...
     *     
     */
    public Context20 setCrdhldrActvtd(Boolean value) {
     ...
     *     
     */
    public Context20 setTrnspndrInittd(Boolean value) {
     ...
     *     
     */
    public Context20 setTrnst(Boolean value) {
        this.trnst = value;
        return this;
    }
     ...
     *     
     */
    public Context20 setAttndd(Boolean value) {
        this.attndd = value;
        return this;
    }
     ...
     *     
     */
    public Context20 setUattnddLvlCtgy(String value) {
     ...
     *     
     */
    public Context20 setEComrc(Boolean value) {
        this.eComrc = value;
        return this;
    }
     ...
     *     
     */
    public Context20 setEComrcIndPropsd(String value) {
     ...
     *     
     */
    public Context20 setEComrcIndApld(String value) {
     ...
     *     
     */
    public Context20 setMOTOCd(MOTO2Code value) {
        this.motoCd = value;
        return this;
    }
     ...
     *     
     */
    public Context20 setTxInitr(TransactionInitiator1Code value) {
        this.txInitr = value;
        return this;
    }
     ...
     *     
     */
    public Context20 setDelydAuthstn(Boolean value) {
     ...
     *     
     */
    public Context20 setDelydChrgs(Boolean value) {
     ...
     *     
     */
    public Context20 setNoShow(Boolean value) {
        this.noShow = value;
        return this;
    }
     ...
     *     
     */
    public Context20 setReauthstn(Boolean value) {
     ...
     *     
     */
    public Context20 setReSubmissn(Boolean value) {
     ...
     *     
     */
    public Context20 setPrtlShipmnt(Boolean value) {
     ...
     *     
     */
    public Context20 setPrtlApprvlSpprtd(Boolean value) {
     ...
     *     
     */
    public Context20 setOthrSctyChrtcs(String value) {
     ...
     *     
     */
    public Context20 setTempScrCardDataReusd(Boolean value) {
     ...
     *     
     */
    public Context20 setStorgLctn(String value) {
     ...
     *     
     */
    public Context20 setPmtCrdntlMrchntRltsh(Boolean value) {
     ...
     * 
     */
    public Context20 addEComrcData(ECommerceData1 eComrcData) {
     ...
     * 
     */
    public Context20 addSctyChrtcs(SecurityCharacteristics1Code sctyChrtcs) {
