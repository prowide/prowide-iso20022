...
public class PointOfServiceContext4 {
     ...
     *     
     */
    public PointOfServiceContext4 setCardPres(Boolean value) {
        this.cardPres = value;
        return this;
    }
     ...
     *     
     */
    public PointOfServiceContext4 setCrdhldrPres(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext4 setCrdhldrActvtd(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext4 setTrnspndrInittd(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext4 setAttnddInd(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext4 setUattnddLvlCtgy(String value) {
     ...
     *     
     */
    public PointOfServiceContext4 setEComrcInd(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext4 setMOTOCd(MOTO1Code value) {
        this.motoCd = value;
        return this;
    }
     ...
     *     
     */
    public PointOfServiceContext4 setTrnstInd(Boolean value) {
        this.trnstInd = value;
        return this;
    }
     ...
     *     
     */
    public PointOfServiceContext4 setPrtlApprvlSpprtd(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext4 setDelydAuthstnInd(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext4 setOthrSctyChrtcs(String value) {
     ...
     *     
     */
    public PointOfServiceContext4 setCardDataNtryMd(CardDataReading10Code value) {
     ...
     *     
     */
    public PointOfServiceContext4 setOthrCardDataNtryMd(String value) {
     ...
     *     
     */
    public PointOfServiceContext4 setQRCdPresntmntMd(QRCodePresentmentMode1Code value) {
     ...
     *     
     */
    public PointOfServiceContext4 setOthrQRCdPresntmntMd(String value) {
     ...
     *     
     */
    public PointOfServiceContext4 setTempScrCardDataReusd(Boolean value) {
     ...
     *     
     */
    public PointOfServiceContext4 setStorgLctn(String value) {
     ...
     * 
     */
    public PointOfServiceContext4 addEComrcData(ECommerceData1 eComrcData) {
     ...
     * 
     */
    public PointOfServiceContext4 addSctyChrtcs(SecurityCharacteristics1Code sctyChrtcs) {
     ...
     * 
     */
    public PointOfServiceContext4 addSpclConds(SpecialConditions1 spclConds) {
