...
@XmlType(name = "ProcessingResult2", propOrder = {
    "apprvlData",
    "rsltData",
    "orgnlRsltData",
    "actnReqrd",
...
public class ProcessingResult2 {
     ...
     *     
     */
    public ProcessingResult2 setApprvlData(ApprovalData1 value) {
     ...
     *     
     */
    public ProcessingResult2 setRsltData(ResultData1 value) {
        this.rsltData = value;
        return this;
    }
     ...
     *     
     */
    public ProcessingResult2 setOrgnlRsltData(ResultData1 value) {
     ...
     *     
     */
    public ProcessingResult2 setActnReqrd(Boolean value) {
     ...
     * 
     */
    public ProcessingResult2 addActn(Action9 actn) {
        getActn().add(actn);
        return this;
    }
     ...
     * 
     */
    public ProcessingResult2 addAddtlActn(AdditionalAction1 addtlActn) {
     ...
     * 
     */
    public ProcessingResult2 addAddtlInf(AdditionalInformation20 addtlInf) {
