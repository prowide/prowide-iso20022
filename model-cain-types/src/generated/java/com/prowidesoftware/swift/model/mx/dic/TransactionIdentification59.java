...
@XmlType(name = "TransactionIdentification59", propOrder = {
    "lclDt",
    "lclTm",
    "tmZone",
    "purchsIdrTp",
...
public class TransactionIdentification59 {
     ...
     *     
     */
    public TransactionIdentification59 setTmZone(String value) {
        this.tmZone = value;
        return this;
    }
     ...
     *     
     */
    public TransactionIdentification59 setPurchsIdrTp(PurchaseIdentifierType3Code value) {
     ...
     *     
     */
    public TransactionIdentification59 setPurchsIdr(String value) {
     ...
     *     
     */
    public TransactionIdentification59 setSysTracAudtNb(String value) {
     ...
     *     
     */
    public TransactionIdentification59 setRtrvlRefNb(String value) {
     ...
     *     
     */
    public TransactionIdentification59 setLifeCyclSpprt(LifeCycleSupport1Code value) {
     ...
     *     
     */
    public TransactionIdentification59 setLifeCyclId(String value) {
     ...
     *     
     */
    public TransactionIdentification59 setAuthstnSeqNb(String value) {
     ...
     *     
     */
    public TransactionIdentification59 setPresntmntSeqNb(String value) {
     ...
     *     
     */
    public TransactionIdentification59 setPresntmntSeqCnt(String value) {
     ...
     *     
     */
    public TransactionIdentification59 setAuthntcnTkn(String value) {
     ...
     *     
     */
    public TransactionIdentification59 setLifeCyclIdMssng(String value) {
     ...
     *     
     */
    public TransactionIdentification59 setAcqrrRefData(String value) {
     ...
     *     
     */
    public TransactionIdentification59 setAcqrrRefNb(String value) {
     ...
     *     
     */
    public TransactionIdentification59 setIssrRefData(String value) {
     ...
     *     
     */
    public TransactionIdentification59 setAssoctdData(Boolean value) {
     ...
     *     
     */
    public TransactionIdentification59 setAssoctdDataRef(String value) {
     ...
     *     
     */
    public TransactionIdentification59 setAssoctdDataDstn(String value) {
     ...
     * 
     */
    public TransactionIdentification59 addPrvtData(ATICALaxProcessing prvtData) {
     ...
     * 
     */
    public TransactionIdentification59 addNtlData(ATICALaxProcessing ntlData) {
