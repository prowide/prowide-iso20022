...
@XmlType(name = "Invoice1", propOrder = {
    "summry",
    "lineItm"
})
public class Invoice1 {
    ...
    protected InvoiceSummary1 summry;
    @XmlElement(name = "LineItm")
    protected List<InvoiceLineItem1> lineItm;
     ...
     * @return
     *     possible object is
     *     {@link InvoiceSummary1 }
     *     
     */
    public InvoiceSummary1 getSummry() {
        return summry;
    }
     ...
     *     
     */
    public Invoice1 setSummry(InvoiceSummary1 value) {
        this.summry = value;
        return this;
    }
     ...
     * {@link InvoiceLineItem1 }
     * 
     * 
     */
    public List<InvoiceLineItem1> getLineItm() {
        if (lineItm == null) {
            lineItm = new ArrayList<InvoiceLineItem1>();
        }
        return this.lineItm;
    }
     ...
     * 
     */
    public Invoice1 addLineItm(InvoiceLineItem1 lineItm) {
