...
@XmlType(name = "SecuritiesTransactionPendingReport002V03", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPendingReport002V03 {
    ...
    @XmlElement(name = "Sts")
    protected List<StatusAndReason13> sts;
    @XmlElement(name = "Txs")
    protected List<Transaction22> txs;
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V03 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V03 setStmtGnlDtls(Statement26 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V03 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V03 setSfkpgAcct(SecuritiesAccount17 value) {
     ...
     * {@link StatusAndReason13 }
     * 
     * 
     */
    public List<StatusAndReason13> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason13>();
        }
        return this.sts;
    }
     ...
     * 
     */
    public List<Transaction22> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction22>();
        }
        return this.txs;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V03 addSts(StatusAndReason13 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V03 addTxs(Transaction22 txs) {
        getTxs().add(txs);
        return this;
    }
