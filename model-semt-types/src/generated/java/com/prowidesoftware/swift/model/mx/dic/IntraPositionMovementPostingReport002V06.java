...
@XmlType(name = "IntraPositionMovementPostingReport002V06", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class IntraPositionMovementPostingReport002V06 {
    ...
    protected Statement49 stmtGnlDtls;
    ...
    protected List<FinancialInstrumentDetails26> finInstrm;
     ...
     *     
     */
    public IntraPositionMovementPostingReport002V06 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public Statement49 getStmtGnlDtls() {
        return stmtGnlDtls;
    }
     ...
     *     
     */
    public IntraPositionMovementPostingReport002V06 setStmtGnlDtls(Statement49 value) {
     ...
     *     
     */
    public IntraPositionMovementPostingReport002V06 setAcctOwnr(PartyIdentification103Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public IntraPositionMovementPostingReport002V06 setSfkpgAcct(SecuritiesAccount27 value) {
     ...
     * {@link FinancialInstrumentDetails26 }
     * 
     * 
     */
    public List<FinancialInstrumentDetails26> getFinInstrm() {
        if (finInstrm == null) {
            finInstrm = new ArrayList<FinancialInstrumentDetails26>();
        }
     ...
     * 
     */
    public IntraPositionMovementPostingReport002V06 addFinInstrm(FinancialInstrumentDetails26 finInstrm) {
