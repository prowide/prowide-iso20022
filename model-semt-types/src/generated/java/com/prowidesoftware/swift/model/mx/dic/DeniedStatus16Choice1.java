...
@XmlType(name = "DeniedStatus16Choice__1", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus16Choice1 {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason111> rsn;
     ...
     *     
     */
    public DeniedStatus16Choice1 setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link DeniedReason111 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<DeniedReason111> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public DeniedStatus16Choice1 addRsn(DeniedReason111 rsn) {
        getRsn().add(rsn);
        return this;
    }
