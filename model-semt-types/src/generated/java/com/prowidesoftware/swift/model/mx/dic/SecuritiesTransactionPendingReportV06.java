...
@XmlType(name = "SecuritiesTransactionPendingReportV06", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPendingReportV06 {
    ...
    @XmlElement(name = "Sts")
    protected List<StatusAndReason25> sts;
    @XmlElement(name = "Txs")
    protected List<Transaction41> txs;
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV06 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV06 setStmtGnlDtls(Statement14 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV06 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV06 setSfkpgAcct(SecuritiesAccount13 value) {
     ...
     * {@link StatusAndReason25 }
     * 
     * 
     */
    public List<StatusAndReason25> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason25>();
        }
        return this.sts;
    }
     ...
     * 
     */
    public List<Transaction41> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction41>();
        }
        return this.txs;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReportV06 addSts(StatusAndReason25 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReportV06 addTxs(Transaction41 txs) {
        getTxs().add(txs);
        return this;
    }
