...
public class SubAccountIdentification5 {
     ...
     *     
     */
    public SubAccountIdentification5 setId(AccountIdentificationFormatChoice value) {
        this.id = value;
        return this;
    }
     ...
     * 
     */
    public SubAccountIdentification5 setFngbInd(boolean value) {
        this.fngbInd = value;
        return this;
    }
     ...
     * 
     */
    public SubAccountIdentification5 setActvtyInd(boolean value) {
    ...
    public List<AggregateBalanceInformation4> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation4>();
        }
     ...
     * 
     */
    public SubAccountIdentification5 addBalForSubAcct(AggregateBalanceInformation4 balForSubAcct) {
