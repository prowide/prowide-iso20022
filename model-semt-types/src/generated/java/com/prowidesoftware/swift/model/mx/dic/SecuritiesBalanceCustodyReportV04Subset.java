...
@XmlType(name = "SecuritiesBalanceCustodyReportV04Subset", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "acctSvcr",
...
public class SecuritiesBalanceCustodyReportV04Subset {
    ...
    protected List<AggregateBalanceInformation14> balForAcct;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification19> subAcctDtls;
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV04Subset setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV04Subset setStmtGnlDtls(Statement23 value) {
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV04Subset setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV04Subset setAcctSvcr(PartyIdentification59Choice value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV04Subset setSfkpgAcct(SecuritiesAccount15 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalanceInformation14 }
     * 
     * 
     */
    public List<AggregateBalanceInformation14> getBalForAcct() {
        if (balForAcct == null) {
            balForAcct = new ArrayList<AggregateBalanceInformation14>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification19 }
     * 
     * 
     */
    public List<SubAccountIdentification19> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification19>();
        }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV04Subset setAcctBaseCcyTtlAmts(TotalValueInPageAndStatement3 value) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV04Subset addIntrmyInf(Intermediary22 intrmyInf) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV04Subset addBalForAcct(AggregateBalanceInformation14 balForAcct) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV04Subset addSubAcctDtls(SubAccountIdentification19 subAcctDtls) {
