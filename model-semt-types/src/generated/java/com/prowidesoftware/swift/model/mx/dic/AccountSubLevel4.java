...
@XmlType(name = "AccountSubLevel4", propOrder = {
    "acctId",
    "acctOwnr",
    "acctSvcr",
    "bnfclOwnr",
...
public class AccountSubLevel4 {
    ...
    protected List<AccountSubLevel5> acctSubLvl5;
     ...
     *     
     */
    public AccountSubLevel4 setAcctId(SecuritiesAccount19 value) {
        this.acctId = value;
        return this;
    }
     ...
     *     
     */
    public AccountSubLevel4 setAcctOwnr(PartyIdentification100 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public AccountSubLevel4 setAcctSvcr(PartyIdentification100 value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AccountSubLevel5 }
     * 
     * 
     */
    public List<AccountSubLevel5> getAcctSubLvl5() {
        if (acctSubLvl5 == null) {
            acctSubLvl5 = new ArrayList<AccountSubLevel5>();
        }
     ...
     * 
     */
    public AccountSubLevel4 addBnfclOwnr(BeneficialOwner2 bnfclOwnr) {
     ...
     * 
     */
    public AccountSubLevel4 addBalForAcct(AggregateHoldingBalance1 balForAcct) {
     ...
     * 
     */
    public AccountSubLevel4 addAcctSubLvl5(AccountSubLevel5 acctSubLvl5) {
     ...
     * 
     */
    public AccountSubLevel4 addAcctSubLvl5Diff(AggregateHoldingBalance2 acctSubLvl5Diff) {
     ...
     * 
     */
    public AccountSubLevel4 addAgt(Intermediary29 agt) {
        getAgt().add(agt);
        return this;
    }
     ...
     * 
     */
    public AccountSubLevel4 addSplmtryData(SupplementaryData1 splmtryData) {
