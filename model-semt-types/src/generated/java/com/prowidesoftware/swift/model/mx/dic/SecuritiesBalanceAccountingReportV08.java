...
@XmlType(name = "SecuritiesBalanceAccountingReportV08", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "acctSvcr",
...
public class SecuritiesBalanceAccountingReportV08 {
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV08 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV08 setStmtGnlDtls(Statement20 value) {
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV08 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV08 setAcctSvcr(PartyIdentification49Choice value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV08 setSfkpgAcct(SecuritiesAccount11 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalanceInformation26 }
     * 
     * 
     */
    public List<AggregateBalanceInformation26> getBalForAcct() {
        if (balForAcct == null) {
            balForAcct = new ArrayList<AggregateBalanceInformation26>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification38 }
     * 
     * 
     */
    public List<SubAccountIdentification38> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification38>();
        }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV08 setAcctBaseCcyTtlAmts(TotalValueInPageAndStatement2 value) {
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV08 setAltrnRptgCcyTtlAmts(TotalValueInPageAndStatement2 value) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReportV08 addIntrmyInf(Intermediary23 intrmyInf) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReportV08 addBalForAcct(AggregateBalanceInformation26 balForAcct) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReportV08 addSubAcctDtls(SubAccountIdentification38 subAcctDtls) {
