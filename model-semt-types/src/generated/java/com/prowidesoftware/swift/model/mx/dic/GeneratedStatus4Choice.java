...
@XmlType(name = "GeneratedStatus4Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class GeneratedStatus4Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<GeneratedReason2> rsn;
     ...
     *     
     */
    public GeneratedStatus4Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<GeneratedReason2> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<GeneratedReason2>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public GeneratedStatus4Choice addRsn(GeneratedReason2 rsn) {
        getRsn().add(rsn);
        return this;
    }
