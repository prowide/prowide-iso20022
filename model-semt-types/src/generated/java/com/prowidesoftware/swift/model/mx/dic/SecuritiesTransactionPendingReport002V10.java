...
@XmlType(name = "SecuritiesTransactionPendingReport002V10", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPendingReport002V10 {
    ...
    @XmlElement(name = "Sts")
    protected List<StatusAndReason37> sts;
    @XmlElement(name = "Txs")
    protected List<Transaction71> txs;
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V10 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V10 setStmtGnlDtls(Statement70 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V10 setAcctOwnr(PartyIdentification156 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V10 setSfkpgAcct(SecuritiesAccount30 value) {
     ...
     * {@link StatusAndReason37 }
     * 
     * 
     */
    public List<StatusAndReason37> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason37>();
        }
        return this.sts;
    }
     ...
     * 
     */
    public List<Transaction71> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction71>();
        }
        return this.txs;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V10 addSts(StatusAndReason37 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V10 addTxs(Transaction71 txs) {
        getTxs().add(txs);
        return this;
    }
