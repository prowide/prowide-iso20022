...
@XmlType(name = "AdditionalQueryParameters6", propOrder = {
    "sts",
    "rsn",
    "finInstrmId"
})
public class AdditionalQueryParameters6 {
    ...
    @XmlElement(name = "Rsn")
    protected List<Reason11Choice> rsn;
     ...
     *     
     */
    public AdditionalQueryParameters6 setSts(Status10Choice value) {
        this.sts = value;
        return this;
    }
     ...
     * 
     */
    public List<Reason11Choice> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<Reason11Choice>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AdditionalQueryParameters6 addRsn(Reason11Choice rsn) {
        getRsn().add(rsn);
        return this;
    }
     ...
     * 
     */
    public AdditionalQueryParameters6 addFinInstrmId(SecurityIdentification15 finInstrmId) {
