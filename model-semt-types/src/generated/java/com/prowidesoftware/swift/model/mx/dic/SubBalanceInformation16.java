...
@XmlType(name = "SubBalanceInformation16", propOrder = {
    "subBalTp",
    "qty",
    "subBalAddtlDtls",
    "addtlBalBrkdwnDtls"
...
public class SubBalanceInformation16 {
     ...
     *     
     */
    public SubBalanceInformation16 setSubBalTp(SubBalanceType13Choice value) {
        this.subBalTp = value;
        return this;
    }
     ...
     *     
     */
    public SubBalanceInformation16 setQty(SubBalanceQuantity7Choice value) {
        this.qty = value;
        return this;
    }
     ...
     *     
     */
    public SubBalanceInformation16 setSubBalAddtlDtls(String value) {
    ...
    public List<AdditionalBalanceInformation16> getAddtlBalBrkdwnDtls() {
        if (addtlBalBrkdwnDtls == null) {
            addtlBalBrkdwnDtls = new ArrayList<AdditionalBalanceInformation16>();
        }
     ...
     * 
     */
    public SubBalanceInformation16 addAddtlBalBrkdwnDtls(AdditionalBalanceInformation16 addtlBalBrkdwnDtls) {
