...
@XmlType(name = "SubAccountIdentification38", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "actvtyInd",
    "balForSubAcct"
...
public class SubAccountIdentification38 {
    ...
    protected List<AggregateBalanceInformation26> balForSubAcct;
     ...
     *     
     */
    public SubAccountIdentification38 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification38 setSfkpgAcct(SecuritiesAccount14 value) {
     ...
     * 
     */
    public SubAccountIdentification38 setActvtyInd(boolean value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation26> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation26>();
        }
     ...
     * 
     */
    public SubAccountIdentification38 addBalForSubAcct(AggregateBalanceInformation26 balForSubAcct) {
