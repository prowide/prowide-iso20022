...
@XmlType(name = "SubAccountIdentification43", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "actvtyInd",
    "balForSubAcct"
...
public class SubAccountIdentification43 {
    ...
    protected List<AggregateBalanceInformation31> balForSubAcct;
     ...
     *     
     */
    public SubAccountIdentification43 setAcctOwnr(PartyIdentification98 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification43 setSfkpgAcct(SecuritiesAccount25 value) {
     ...
     * 
     */
    public SubAccountIdentification43 setActvtyInd(boolean value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation31> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation31>();
        }
     ...
     * 
     */
    public SubAccountIdentification43 addBalForSubAcct(AggregateBalanceInformation31 balForSubAcct) {
