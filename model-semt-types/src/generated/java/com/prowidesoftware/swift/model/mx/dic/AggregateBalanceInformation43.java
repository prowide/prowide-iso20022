...
@XmlType(name = "AggregateBalanceInformation43", propOrder = {
    "finInstrmId",
    "finInstrmAttrbts",
...
public class AggregateBalanceInformation43 {
    ...
    protected List<AggregateBalancePerSafekeepingPlace40> balAtSfkpgPlc;
     ...
     *     
     */
    public AggregateBalanceInformation43 setFinInstrmId(SecurityIdentification20 value) {
     ...
     *     
     */
    public AggregateBalanceInformation43 setFinInstrmAttrbts(FinancialInstrumentAttributes122 value) {
     ...
     *     
     */
    public AggregateBalanceInformation43 setInvstmtFndsFinInstrmAttrbts(FinancialInstrument22 value) {
     ...
     *     
     */
    public AggregateBalanceInformation43 setAddtlDerivAttrbts(DerivativeBasicAttributes2 value) {
     ...
     *     
     */
    public AggregateBalanceInformation43 setAggtBal(Balance22 value) {
        this.aggtBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation43 setSfkpgPlc(SafeKeepingPlace4 value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation43 setCorpActnOptnTp(CorporateActionOption5Code value) {
     ...
     *     
     */
    public AggregateBalanceInformation43 setDaysAcrd(BigDecimal value) {
        this.daysAcrd = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation43 setAcctBaseCcyAmts(BalanceAmounts5 value) {
     ...
     *     
     */
    public AggregateBalanceInformation43 setInstrmCcyAmts(BalanceAmounts5 value) {
     ...
     *     
     */
    public AggregateBalanceInformation43 setAltrnRptgCcyAmts(BalanceAmounts5 value) {
    ...
    public List<QuantityBreakdown70> getQtyBrkdwn() {
        if (qtyBrkdwn == null) {
            qtyBrkdwn = new ArrayList<QuantityBreakdown70>();
        }
    ...
    public List<SubBalanceInformation23> getBalBrkdwn() {
        if (balBrkdwn == null) {
            balBrkdwn = new ArrayList<SubBalanceInformation23>();
        }
    ...
    public List<AdditionalBalanceInformation23> getAddtlBalBrkdwn() {
        if (addtlBalBrkdwn == null) {
            addtlBalBrkdwn = new ArrayList<AdditionalBalanceInformation23>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalancePerSafekeepingPlace40 }
     * 
     * 
     */
    public List<AggregateBalancePerSafekeepingPlace40> getBalAtSfkpgPlc() {
        if (balAtSfkpgPlc == null) {
            balAtSfkpgPlc = new ArrayList<AggregateBalancePerSafekeepingPlace40>();
        }
     ...
     *     
     */
    public AggregateBalanceInformation43 setHldgAddtlDtls(String value) {
     ...
     * 
     */
    public AggregateBalanceInformation43 addPricDtls(PriceInformation22 pricDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation43 addFXDtls(ForeignExchangeTerms35 fXDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation43 addQtyBrkdwn(QuantityBreakdown70 qtyBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation43 addBalBrkdwn(SubBalanceInformation23 balBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation43 addAddtlBalBrkdwn(AdditionalBalanceInformation23 addtlBalBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation43 addBalAtSfkpgPlc(AggregateBalancePerSafekeepingPlace40 balAtSfkpgPlc) {
     ...
     * 
     */
    public AggregateBalanceInformation43 addSplmtryData(SupplementaryData1 splmtryData) {
