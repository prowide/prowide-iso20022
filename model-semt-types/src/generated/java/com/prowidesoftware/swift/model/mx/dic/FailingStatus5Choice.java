...
@XmlType(name = "FailingStatus5Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class FailingStatus5Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<FailingReason6> rsn;
     ...
     *     
     */
    public FailingStatus5Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<FailingReason6> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<FailingReason6>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public FailingStatus5Choice addRsn(FailingReason6 rsn) {
        getRsn().add(rsn);
        return this;
    }
