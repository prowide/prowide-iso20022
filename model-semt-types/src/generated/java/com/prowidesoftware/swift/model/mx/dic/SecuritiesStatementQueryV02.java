...
@XmlType(name = "SecuritiesStatementQueryV02", propOrder = {
    "stmtReqd",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesStatementQueryV02 {
    ...
    protected List<AdditionalQueryParameters3> addtlQryParams;
     ...
     *     
     */
    public SecuritiesStatementQueryV02 setStmtReqd(DocumentNumber1 value) {
        this.stmtReqd = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesStatementQueryV02 setStmtGnlDtls(Statement16 value) {
     ...
     *     
     */
    public SecuritiesStatementQueryV02 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesStatementQueryV02 setSfkpgAcct(SecuritiesAccount13 value) {
     ...
     * {@link AdditionalQueryParameters3 }
     * 
     * 
     */
    public List<AdditionalQueryParameters3> getAddtlQryParams() {
        if (addtlQryParams == null) {
            addtlQryParams = new ArrayList<AdditionalQueryParameters3>();
        }
     ...
     * 
     */
    public SecuritiesStatementQueryV02 addAddtlQryParams(AdditionalQueryParameters3 addtlQryParams) {
     ...
     * 
     */
    public SecuritiesStatementQueryV02 addSplmtryData(SupplementaryData1 splmtryData) {
