...
@XmlType(name = "SubAccountIdentification45", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "actvtyInd",
    "balForSubAcct"
})
public class SubAccountIdentification45 {
    ...
    protected List<AggregateBalanceInformation32> balForSubAcct;
     ...
     *     
     */
    public SubAccountIdentification45 setAcctOwnr(PartyIdentification109 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification45 setSfkpgAcct(SecuritiesAccount34 value) {
     ...
     * 
     */
    public SubAccountIdentification45 setActvtyInd(boolean value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation32> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation32>();
        }
     ...
     * 
     */
    public SubAccountIdentification45 addBalForSubAcct(AggregateBalanceInformation32 balForSubAcct) {
