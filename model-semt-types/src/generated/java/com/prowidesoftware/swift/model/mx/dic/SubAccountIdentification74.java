...
@XmlType(name = "SubAccountIdentification74", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "blckChainAdrOrWllt",
    "actvtyInd",
...
public class SubAccountIdentification74 {
    ...
    protected List<FinancialInstrumentDetails49> finInstrmDtls;
     ...
     *     
     */
    public SubAccountIdentification74 setAcctOwnr(PartyIdentification144 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification74 setSfkpgAcct(SecuritiesAccount25 value) {
     ...
     *     
     */
    public SubAccountIdentification74 setBlckChainAdrOrWllt(BlockChainAddressWallet2 value) {
     ...
     * 
     */
    public SubAccountIdentification74 setActvtyInd(boolean value) {
     ...
     * {@link FinancialInstrumentDetails49 }
     * 
     * 
     * @return
     *     The value of the finInstrmDtls property.
     */
    public List<FinancialInstrumentDetails49> getFinInstrmDtls() {
     ...
     * 
     */
    public SubAccountIdentification74 addFinInstrmDtls(FinancialInstrumentDetails49 finInstrmDtls) {
