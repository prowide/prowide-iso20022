...
@XmlType(name = "StatusAndReason47", propOrder = {
    "stsAndRsn",
    "tx"
})
public class StatusAndReason47 {

    @XmlElement(name = "StsAndRsn", required = true)
    protected Status38Choice stsAndRsn;
    @XmlElement(name = "Tx")
    protected List<Transaction162> tx;
     ...
     *     
     */
    public StatusAndReason47 setStsAndRsn(Status38Choice value) {
     ...
     * 
     */
    public List<Transaction162> getTx() {
        if (tx == null) {
            tx = new ArrayList<Transaction162>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public StatusAndReason47 addTx(Transaction162 tx) {
        getTx().add(tx);
        return this;
    }
