...
@XmlType(name = "SecuritiesBalanceCustodyReport002V05", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "acctSvcr",
...
public class SecuritiesBalanceCustodyReport002V05 {
    ...
    protected List<AggregateBalanceInformation18> balForAcct;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification25> subAcctDtls;
     ...
     *     
     */
    public SecuritiesBalanceCustodyReport002V05 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReport002V05 setStmtGnlDtls(Statement34 value) {
     ...
     *     
     */
    public SecuritiesBalanceCustodyReport002V05 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReport002V05 setAcctSvcr(PartyIdentification59Choice value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReport002V05 setSfkpgAcct(SecuritiesAccount15 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalanceInformation18 }
     * 
     * 
     */
    public List<AggregateBalanceInformation18> getBalForAcct() {
        if (balForAcct == null) {
            balForAcct = new ArrayList<AggregateBalanceInformation18>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification25 }
     * 
     * 
     */
    public List<SubAccountIdentification25> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification25>();
        }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReport002V05 setAcctBaseCcyTtlAmts(TotalValueInPageAndStatement3 value) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReport002V05 addIntrmyInf(Intermediary22 intrmyInf) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReport002V05 addBalForAcct(AggregateBalanceInformation18 balForAcct) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReport002V05 addSubAcctDtls(SubAccountIdentification25 subAcctDtls) {
