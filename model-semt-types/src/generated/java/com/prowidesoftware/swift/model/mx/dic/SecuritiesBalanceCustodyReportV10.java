...
@XmlType(name = "SecuritiesBalanceCustodyReportV10", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "acctSvcr",
...
public class SecuritiesBalanceCustodyReportV10 {
    ...
    protected List<AggregateBalanceInformation35> balForAcct;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification55> subAcctDtls;
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV10 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV10 setStmtGnlDtls(Statement73 value) {
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV10 setAcctOwnr(PartyIdentification144 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV10 setAcctSvcr(PartyIdentification136 value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV10 setSfkpgAcct(SecuritiesAccount26 value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation35> getBalForAcct() {
        if (balForAcct == null) {
            balForAcct = new ArrayList<AggregateBalanceInformation35>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification55 }
     * 
     * 
     */
    public List<SubAccountIdentification55> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification55>();
        }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV10 setAcctBaseCcyTtlAmts(TotalValueInPageAndStatement1 value) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV10 addIntrmyInf(Intermediary44 intrmyInf) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV10 addBalForAcct(AggregateBalanceInformation35 balForAcct) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV10 addSubAcctDtls(SubAccountIdentification55 subAcctDtls) {
