...
@XmlType(name = "AccountSubLevel1", propOrder = {
    "acctId",
    "acctOwnr",
    "acctSvcr",
    "bnfclOwnr",
...
public class AccountSubLevel1 {
    ...
    protected List<AccountSubLevel2> acctSubLvl2;
     ...
     *     
     */
    public AccountSubLevel1 setAcctId(SecuritiesAccount19 value) {
        this.acctId = value;
        return this;
    }
     ...
     *     
     */
    public AccountSubLevel1 setAcctOwnr(PartyIdentification100 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public AccountSubLevel1 setAcctSvcr(PartyIdentification100 value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AccountSubLevel2 }
     * 
     * 
     */
    public List<AccountSubLevel2> getAcctSubLvl2() {
        if (acctSubLvl2 == null) {
            acctSubLvl2 = new ArrayList<AccountSubLevel2>();
        }
     ...
     * 
     */
    public AccountSubLevel1 addBnfclOwnr(BeneficialOwner2 bnfclOwnr) {
     ...
     * 
     */
    public AccountSubLevel1 addBalForAcct(AggregateHoldingBalance1 balForAcct) {
     ...
     * 
     */
    public AccountSubLevel1 addAcctSubLvl2(AccountSubLevel2 acctSubLvl2) {
     ...
     * 
     */
    public AccountSubLevel1 addAcctSubLvl2Diff(AggregateHoldingBalance2 acctSubLvl2Diff) {
     ...
     * 
     */
    public AccountSubLevel1 addAgt(Intermediary29 agt) {
        getAgt().add(agt);
        return this;
    }
     ...
     * 
     */
    public AccountSubLevel1 addSplmtryData(SupplementaryData1 splmtryData) {
