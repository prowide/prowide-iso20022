...
@XmlType(name = "PendingStatus12Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus12Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingReason8> rsn;
     ...
     *     
     */
    public PendingStatus12Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<PendingReason8> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingReason8>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus12Choice addRsn(PendingReason8 rsn) {
        getRsn().add(rsn);
        return this;
    }
