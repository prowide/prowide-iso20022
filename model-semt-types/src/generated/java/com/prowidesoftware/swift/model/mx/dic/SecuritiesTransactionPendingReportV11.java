...
@XmlType(name = "SecuritiesTransactionPendingReportV11", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPendingReportV11 {
    ...
    @XmlElement(name = "Sts")
    protected List<StatusAndReason40> sts;
    @XmlElement(name = "Txs")
    protected List<Transaction109> txs;
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV11 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV11 setStmtGnlDtls(Statement64 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV11 setAcctOwnr(PartyIdentification144 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV11 setSfkpgAcct(SecuritiesAccount19 value) {
     ...
     * {@link StatusAndReason40 }
     * 
     * 
     */
    public List<StatusAndReason40> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason40>();
        }
        return this.sts;
    }
     ...
     * 
     */
    public List<Transaction109> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction109>();
        }
        return this.txs;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReportV11 addSts(StatusAndReason40 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReportV11 addTxs(Transaction109 txs) {
        getTxs().add(txs);
        return this;
    }
