...
@XmlType(name = "SecuritiesTransactionPendingReport002V04", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPendingReport002V04 {
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V04 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V04 setStmtGnlDtls(Statement26 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V04 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V04 setSfkpgAcct(SecuritiesAccount17 value) {
     ...
     * {@link StatusAndReason17 }
     * 
     * 
     */
    public List<StatusAndReason17> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason17>();
        }
        return this.sts;
    }
    ...
    public List<Transaction31> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction31>();
        }
        return this.txs;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V04 addSts(StatusAndReason17 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V04 addTxs(Transaction31 txs) {
        getTxs().add(txs);
        return this;
    }
