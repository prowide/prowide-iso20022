...
@XmlType(name = "GeneratedStatus7Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class GeneratedStatus7Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<GeneratedReason5> rsn;
     ...
     *     
     */
    public GeneratedStatus7Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<GeneratedReason5> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<GeneratedReason5>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public GeneratedStatus7Choice addRsn(GeneratedReason5 rsn) {
        getRsn().add(rsn);
        return this;
    }
