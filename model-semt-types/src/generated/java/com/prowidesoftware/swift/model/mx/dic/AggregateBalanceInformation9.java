...
@XmlType(name = "AggregateBalanceInformation9", propOrder = {
    "finInstrmId",
    "finInstrmAttrbts",
...
public class AggregateBalanceInformation9 {
    ...
    protected List<ForeignExchangeTerms1> fxDtls;
    ...
    protected List<SubBalanceInformation5> balBrkdwn;
    @XmlElement(name = "AddtlBalBrkdwn")
    protected List<AdditionalBalanceInformation5> addtlBalBrkdwn;
    @XmlElement(name = "BalAtSfkpgPlc")
    protected List<AggregateBalancePerSafekeepingPlace8> balAtSfkpgPlc;
     ...
     *     
     */
    public AggregateBalanceInformation9 setFinInstrmId(SecurityIdentification11 value) {
     ...
     *     
     */
    public AggregateBalanceInformation9 setFinInstrmAttrbts(FinancialInstrumentAttributes8 value) {
     ...
     *     
     */
    public AggregateBalanceInformation9 setInvstmtFndsFinInstrmAttrbts(FinancialInstrument21 value) {
     ...
     *     
     */
    public AggregateBalanceInformation9 setValtnHrcutDtls(BasicCollateralValuation1Details value) {
     ...
     *     
     */
    public AggregateBalanceInformation9 setAggtBal(Balance1 value) {
        this.aggtBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation9 setAvlblBal(BalanceQuantity5Choice value) {
        this.avlblBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation9 setNotAvlblBal(BalanceQuantity5Choice value) {
     ...
     *     
     */
    public AggregateBalanceInformation9 setSfkpgPlc(SafekeepingPlaceFormat3Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation9 setCorpActnOptnTp(CorporateActionOption5Code value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ForeignExchangeTerms1 }
     * 
     * 
     */
    public List<ForeignExchangeTerms1> getFXDtls() {
        if (fxDtls == null) {
            fxDtls = new ArrayList<ForeignExchangeTerms1>();
        }
        return this.fxDtls;
    }
     ...
     *     
     */
    public AggregateBalanceInformation9 setDaysAcrd(BigDecimal value) {
        this.daysAcrd = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation9 setAcctBaseCcyAmts(BalanceAmounts3 value) {
     ...
     *     
     */
    public AggregateBalanceInformation9 setInstrmCcyAmts(BalanceAmounts3 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubBalanceInformation5 }
     * 
     * 
     */
    public List<SubBalanceInformation5> getBalBrkdwn() {
        if (balBrkdwn == null) {
            balBrkdwn = new ArrayList<SubBalanceInformation5>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AdditionalBalanceInformation5 }
     * 
     * 
     */
    public List<AdditionalBalanceInformation5> getAddtlBalBrkdwn() {
        if (addtlBalBrkdwn == null) {
            addtlBalBrkdwn = new ArrayList<AdditionalBalanceInformation5>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalancePerSafekeepingPlace8 }
     * 
     * 
     */
    public List<AggregateBalancePerSafekeepingPlace8> getBalAtSfkpgPlc() {
        if (balAtSfkpgPlc == null) {
            balAtSfkpgPlc = new ArrayList<AggregateBalancePerSafekeepingPlace8>();
        }
     ...
     *     
     */
    public AggregateBalanceInformation9 setHldgAddtlDtls(String value) {
     ...
     * 
     */
    public AggregateBalanceInformation9 addPricDtls(PriceInformation5 pricDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation9 addFXDtls(ForeignExchangeTerms1 fXDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation9 addQtyBrkdwn(QuantityBreakdown3 qtyBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation9 addBalBrkdwn(SubBalanceInformation5 balBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation9 addAddtlBalBrkdwn(AdditionalBalanceInformation5 addtlBalBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation9 addBalAtSfkpgPlc(AggregateBalancePerSafekeepingPlace8 balAtSfkpgPlc) {
     ...
     * 
     */
    public AggregateBalanceInformation9 addXtnsn(Extension2 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
