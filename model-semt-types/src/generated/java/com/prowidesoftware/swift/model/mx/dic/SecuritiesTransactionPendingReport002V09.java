...
@XmlType(name = "SecuritiesTransactionPendingReport002V09", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPendingReport002V09 {
    ...
    @XmlElement(name = "Sts")
    protected List<StatusAndReason35> sts;
    @XmlElement(name = "Txs")
    protected List<Transaction64> txs;
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V09 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V09 setStmtGnlDtls(Statement70 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V09 setAcctOwnr(PartyIdentification119 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V09 setSfkpgAcct(SecuritiesAccount30 value) {
     ...
     * {@link StatusAndReason35 }
     * 
     * 
     */
    public List<StatusAndReason35> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason35>();
        }
        return this.sts;
    }
     ...
     * 
     */
    public List<Transaction64> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction64>();
        }
        return this.txs;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V09 addSts(StatusAndReason35 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V09 addTxs(Transaction64 txs) {
        getTxs().add(txs);
        return this;
    }
