...
@XmlType(name = "StatusAndReason33", propOrder = {
    "stsAndRsn",
    "tx"
})
public class StatusAndReason33 {
    ...
    @XmlElement(name = "Tx")
    protected List<Transaction56> tx;
     ...
     *     
     */
    public StatusAndReason33 setStsAndRsn(Status23Choice value) {
     ...
     * 
     */
    public List<Transaction56> getTx() {
        if (tx == null) {
            tx = new ArrayList<Transaction56>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public StatusAndReason33 addTx(Transaction56 tx) {
        getTx().add(tx);
        return this;
    }
