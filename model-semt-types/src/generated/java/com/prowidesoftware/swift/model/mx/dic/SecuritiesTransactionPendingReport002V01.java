...
@XmlType(name = "SecuritiesTransactionPendingReport.002V01", propOrder = {
    "id",
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
...
public class SecuritiesTransactionPendingReport002V01 {
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V01 setId(DocumentIdentification16 value) {
        this.id = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V01 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V01 setStmtGnlDtls(Statement26 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V01 setAcctOwnr(PartyIdentification18Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V01 setSfkpgAcct(SecuritiesAccount17 value) {
     ...
     * {@link StatusAndReason4 }
     * 
     * 
     */
    public List<StatusAndReason4> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason4>();
        }
        return this.sts;
    }
    ...
    public List<Transaction10> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction10>();
        }
        return this.txs;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V01 setMsgOrgtr(PartyIdentification16Choice value) {
        this.msgOrgtr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V01 setMsgRcpt(PartyIdentification16Choice value) {
        this.msgRcpt = value;
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V01 addSts(StatusAndReason4 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V01 addTxs(Transaction10 txs) {
        getTxs().add(txs);
        return this;
    }
