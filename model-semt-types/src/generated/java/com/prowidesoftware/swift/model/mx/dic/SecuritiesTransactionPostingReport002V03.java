...
@XmlType(name = "SecuritiesTransactionPostingReport002V03", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPostingReport002V03 {
    ...
    protected List<FinancialInstrumentDetails11> finInstrmDtls;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification24> subAcctDtls;
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V03 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V03 setStmtGnlDtls(Statement27 value) {
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V03 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V03 setSfkpgAcct(SecuritiesAccount17 value) {
     ...
     * {@link FinancialInstrumentDetails11 }
     * 
     * 
     */
    public List<FinancialInstrumentDetails11> getFinInstrmDtls() {
        if (finInstrmDtls == null) {
            finInstrmDtls = new ArrayList<FinancialInstrumentDetails11>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification24 }
     * 
     * 
     */
    public List<SubAccountIdentification24> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification24>();
        }
     ...
     * 
     */
    public SecuritiesTransactionPostingReport002V03 addFinInstrmDtls(FinancialInstrumentDetails11 finInstrmDtls) {
     ...
     * 
     */
    public SecuritiesTransactionPostingReport002V03 addSubAcctDtls(SubAccountIdentification24 subAcctDtls) {
