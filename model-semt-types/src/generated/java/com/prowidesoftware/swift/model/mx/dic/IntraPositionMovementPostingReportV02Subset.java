...
@XmlType(name = "IntraPositionMovementPostingReportV02Subset", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class IntraPositionMovementPostingReportV02Subset {
    ...
    protected List<FinancialInstrumentDetails7> finInstrm;
     ...
     *     
     */
    public IntraPositionMovementPostingReportV02Subset setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public IntraPositionMovementPostingReportV02Subset setStmtGnlDtls(Statement22 value) {
     ...
     *     
     */
    public IntraPositionMovementPostingReportV02Subset setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public IntraPositionMovementPostingReportV02Subset setSfkpgAcct(SecuritiesAccount17 value) {
     ...
     * {@link FinancialInstrumentDetails7 }
     * 
     * 
     */
    public List<FinancialInstrumentDetails7> getFinInstrm() {
        if (finInstrm == null) {
            finInstrm = new ArrayList<FinancialInstrumentDetails7>();
        }
     ...
     * 
     */
    public IntraPositionMovementPostingReportV02Subset addFinInstrm(FinancialInstrumentDetails7 finInstrm) {
