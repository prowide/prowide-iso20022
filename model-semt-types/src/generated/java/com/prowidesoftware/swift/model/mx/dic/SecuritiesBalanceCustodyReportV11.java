...
public class SecuritiesBalanceCustodyReportV11 {
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV11 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV11 setStmtGnlDtls(Statement73 value) {
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV11 setAcctOwnr(PartyIdentification144 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV11 setAcctSvcr(PartyIdentification136 value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV11 setSfkpgAcct(SecuritiesAccount26 value) {
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV11 setBlckChainAdrOrWllt(BlockChainAddressWallet1 value) {
    ...
    public List<AggregateBalanceInformation42> getBalForAcct() {
        if (balForAcct == null) {
            balForAcct = new ArrayList<AggregateBalanceInformation42>();
        }
    ...
    public List<SubAccountIdentification67> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification67>();
        }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV11 setAcctBaseCcyTtlAmts(TotalValueInPageAndStatement1 value) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV11 addIntrmyInf(Intermediary44 intrmyInf) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV11 addBalForAcct(AggregateBalanceInformation42 balForAcct) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV11 addSubAcctDtls(SubAccountIdentification67 subAcctDtls) {
