...
@XmlType(name = "AggregateBalanceInformation8", propOrder = {
    "finInstrmId",
    "finInstrmAttrbts",
...
public class AggregateBalanceInformation8 {
    ...
    protected List<AggregateBalancePerSafekeepingPlace7> balAtSfkpgPlc;
     ...
     *     
     */
    public AggregateBalanceInformation8 setFinInstrmId(SecurityIdentification11 value) {
     ...
     *     
     */
    public AggregateBalanceInformation8 setFinInstrmAttrbts(FinancialInstrumentAttributes8 value) {
     ...
     *     
     */
    public AggregateBalanceInformation8 setInvstmtFndsFinInstrmAttrbts(FinancialInstrument21 value) {
     ...
     *     
     */
    public AggregateBalanceInformation8 setAddtlDerivAttrbts(DerivativeBasicAttributes1 value) {
     ...
     *     
     */
    public AggregateBalanceInformation8 setAggtBal(Balance1 value) {
        this.aggtBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation8 setSfkpgPlc(SafekeepingPlaceFormat3Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation8 setCorpActnOptnTp(CorporateActionOption5Code value) {
     ...
     *     
     */
    public AggregateBalanceInformation8 setDaysAcrd(BigDecimal value) {
        this.daysAcrd = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation8 setAcctBaseCcyAmts(BalanceAmounts1 value) {
     ...
     *     
     */
    public AggregateBalanceInformation8 setInstrmCcyAmts(BalanceAmounts1 value) {
     ...
     *     
     */
    public AggregateBalanceInformation8 setAltrnRptgCcyAmts(BalanceAmounts1 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalancePerSafekeepingPlace7 }
     * 
     * 
     */
    public List<AggregateBalancePerSafekeepingPlace7> getBalAtSfkpgPlc() {
        if (balAtSfkpgPlc == null) {
            balAtSfkpgPlc = new ArrayList<AggregateBalancePerSafekeepingPlace7>();
        }
     ...
     *     
     */
    public AggregateBalanceInformation8 setHldgAddtlDtls(String value) {
     ...
     * 
     */
    public AggregateBalanceInformation8 addPricDtls(PriceInformation5 pricDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation8 addFXDtls(ForeignExchangeTerms1 fXDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation8 addQtyBrkdwn(QuantityBreakdown4 qtyBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation8 addBalBrkdwn(SubBalanceInformation6 balBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation8 addAddtlBalBrkdwn(AdditionalBalanceInformation6 addtlBalBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation8 addBalAtSfkpgPlc(AggregateBalancePerSafekeepingPlace7 balAtSfkpgPlc) {
     ...
     * 
     */
    public AggregateBalanceInformation8 addXtnsn(Extension2 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
