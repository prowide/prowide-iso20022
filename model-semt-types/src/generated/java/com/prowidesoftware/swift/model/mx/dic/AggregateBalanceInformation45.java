...
@XmlType(name = "AggregateBalanceInformation45", propOrder = {
    "finInstrmId",
    "finInstrmAttrbts",
...
public class AggregateBalanceInformation45 {
    ...
    protected List<PriceInformation29> pricDtls;
    ...
    protected List<AggregateBalancePerSafekeepingPlace42> balAtSfkpgPlc;
     ...
     *     
     */
    public AggregateBalanceInformation45 setFinInstrmId(SecurityIdentification19 value) {
     ...
     *     
     */
    public AggregateBalanceInformation45 setFinInstrmAttrbts(FinancialInstrumentAttributes111 value) {
     ...
     *     
     */
    public AggregateBalanceInformation45 setInvstmtFndsFinInstrmAttrbts(FinancialInstrument21 value) {
     ...
     *     
     */
    public AggregateBalanceInformation45 setAddtlDerivAttrbts(DerivativeBasicAttributes1 value) {
     ...
     *     
     */
    public AggregateBalanceInformation45 setAggtBal(Balance17 value) {
        this.aggtBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation45 setSfkpgPlc(SafeKeepingPlace5 value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation45 setCorpActnOptnTp(CorporateActionOption5Code value) {
     ...
     * {@link PriceInformation29 }
     * 
     * 
     */
    public List<PriceInformation29> getPricDtls() {
        if (pricDtls == null) {
            pricDtls = new ArrayList<PriceInformation29>();
        }
     ...
     *     
     */
    public AggregateBalanceInformation45 setDaysAcrd(BigDecimal value) {
        this.daysAcrd = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation45 setAcctBaseCcyAmts(BalanceAmounts1 value) {
     ...
     *     
     */
    public AggregateBalanceInformation45 setInstrmCcyAmts(BalanceAmounts1 value) {
     ...
     *     
     */
    public AggregateBalanceInformation45 setAltrnRptgCcyAmts(BalanceAmounts1 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalancePerSafekeepingPlace42 }
     * 
     * 
     */
    public List<AggregateBalancePerSafekeepingPlace42> getBalAtSfkpgPlc() {
        if (balAtSfkpgPlc == null) {
            balAtSfkpgPlc = new ArrayList<AggregateBalancePerSafekeepingPlace42>();
        }
     ...
     *     
     */
    public AggregateBalanceInformation45 setHldgAddtlDtls(String value) {
     ...
     * 
     */
    public AggregateBalanceInformation45 addPricDtls(PriceInformation29 pricDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation45 addFXDtls(ForeignExchangeTerms34 fXDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation45 addQtyBrkdwn(QuantityBreakdown58 qtyBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation45 addBalBrkdwn(SubBalanceInformation22 balBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation45 addAddtlBalBrkdwn(AdditionalBalanceInformation22 addtlBalBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation45 addBalAtSfkpgPlc(AggregateBalancePerSafekeepingPlace42 balAtSfkpgPlc) {
     ...
     * 
     */
    public AggregateBalanceInformation45 addSplmtryData(SupplementaryData1 splmtryData) {
