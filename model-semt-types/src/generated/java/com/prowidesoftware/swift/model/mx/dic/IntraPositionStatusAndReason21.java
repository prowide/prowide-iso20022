...
@XmlType(name = "IntraPositionStatusAndReason2__1", propOrder = {
    "prcgSts",
    "sttlmSts",
    "sttld"
})
public class IntraPositionStatusAndReason21 {

    @XmlElement(name = "PrcgSts")
    protected List<ProcessingStatus67Choice1> prcgSts;
    @XmlElement(name = "SttlmSts")
    protected List<SettlementStatus16Choice1> sttlmSts;
     ...
     * {@link ProcessingStatus67Choice1 }
     * 
     * 
     * @return
     *     The value of the prcgSts property.
     */
    public List<ProcessingStatus67Choice1> getPrcgSts() {
        if (prcgSts == null) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SettlementStatus16Choice1 }
     * 
     * 
     * @return
     *     The value of the sttlmSts property.
     */
    public List<SettlementStatus16Choice1> getSttlmSts() {
        if (sttlmSts == null) {
     ...
     *     
     */
    public IntraPositionStatusAndReason21 setSttld(ProprietaryReason41 value) {
        this.sttld = value;
        return this;
    }
     ...
     * 
     */
    public IntraPositionStatusAndReason21 addPrcgSts(ProcessingStatus67Choice1 prcgSts) {
     ...
     * 
     */
    public IntraPositionStatusAndReason21 addSttlmSts(SettlementStatus16Choice1 sttlmSts) {
