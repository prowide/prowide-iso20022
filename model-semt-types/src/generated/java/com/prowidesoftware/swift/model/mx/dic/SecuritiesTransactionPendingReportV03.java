...
@XmlType(name = "SecuritiesTransactionPendingReportV03", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPendingReportV03 {
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV03 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV03 setStmtGnlDtls(Statement14 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV03 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV03 setSfkpgAcct(SecuritiesAccount13 value) {
     ...
     * {@link StatusAndReason9 }
     * 
     * 
     */
    public List<StatusAndReason9> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason9>();
        }
        return this.sts;
    }
    ...
    public List<Transaction19> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction19>();
        }
        return this.txs;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReportV03 addSts(StatusAndReason9 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReportV03 addTxs(Transaction19 txs) {
        getTxs().add(txs);
        return this;
    }
