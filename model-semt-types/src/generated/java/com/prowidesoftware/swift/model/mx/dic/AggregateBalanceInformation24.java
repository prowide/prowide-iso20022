...
@XmlType(name = "AggregateBalanceInformation24", propOrder = {
    "finInstrmId",
    "finInstrmAttrbts",
...
public class AggregateBalanceInformation24 {
    ...
    protected List<AggregateBalancePerSafekeepingPlace23> balAtSfkpgPlc;
     ...
     *     
     */
    public AggregateBalanceInformation24 setFinInstrmId(SecurityIdentification15 value) {
     ...
     *     
     */
    public AggregateBalanceInformation24 setFinInstrmAttrbts(FinancialInstrumentAttributes41 value) {
     ...
     *     
     */
    public AggregateBalanceInformation24 setInvstmtFndsFinInstrmAttrbts(FinancialInstrument22 value) {
     ...
     *     
     */
    public AggregateBalanceInformation24 setValtnHrcutDtls(BasicCollateralValuation1Details value) {
     ...
     *     
     */
    public AggregateBalanceInformation24 setAggtBal(Balance2 value) {
        this.aggtBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation24 setAvlblBal(BalanceQuantity7Choice value) {
        this.avlblBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation24 setNotAvlblBal(BalanceQuantity7Choice value) {
     ...
     *     
     */
    public AggregateBalanceInformation24 setSfkpgPlc(SafekeepingPlaceFormat4Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation24 setCorpActnOptnTp(CorporateActionOption5Code value) {
     ...
     *     
     */
    public AggregateBalanceInformation24 setDaysAcrd(BigDecimal value) {
        this.daysAcrd = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation24 setAcctBaseCcyAmts(BalanceAmounts4 value) {
     ...
     *     
     */
    public AggregateBalanceInformation24 setInstrmCcyAmts(BalanceAmounts4 value) {
    ...
    public List<SubBalanceInformation12> getBalBrkdwn() {
        if (balBrkdwn == null) {
            balBrkdwn = new ArrayList<SubBalanceInformation12>();
        }
    ...
    public List<AdditionalBalanceInformation12> getAddtlBalBrkdwn() {
        if (addtlBalBrkdwn == null) {
            addtlBalBrkdwn = new ArrayList<AdditionalBalanceInformation12>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalancePerSafekeepingPlace23 }
     * 
     * 
     */
    public List<AggregateBalancePerSafekeepingPlace23> getBalAtSfkpgPlc() {
        if (balAtSfkpgPlc == null) {
            balAtSfkpgPlc = new ArrayList<AggregateBalancePerSafekeepingPlace23>();
        }
     ...
     *     
     */
    public AggregateBalanceInformation24 setHldgAddtlDtls(String value) {
     ...
     * 
     */
    public AggregateBalanceInformation24 addPricDtls(PriceInformation7 pricDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation24 addFXDtls(ForeignExchangeTerms16 fXDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation24 addQtyBrkdwn(QuantityBreakdown26 qtyBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation24 addBalBrkdwn(SubBalanceInformation12 balBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation24 addAddtlBalBrkdwn(AdditionalBalanceInformation12 addtlBalBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation24 addBalAtSfkpgPlc(AggregateBalancePerSafekeepingPlace23 balAtSfkpgPlc) {
     ...
     * 
     */
    public AggregateBalanceInformation24 addSplmtryData(SupplementaryData1 splmtryData) {
