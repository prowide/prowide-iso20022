...
@XmlType(name = "SecuritiesTransactionPostingReport002V05", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPostingReport002V05 {
    ...
    protected List<FinancialInstrumentDetails18> finInstrmDtls;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification35> subAcctDtls;
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V05 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V05 setStmtGnlDtls(Statement27 value) {
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V05 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V05 setSfkpgAcct(SecuritiesAccount17 value) {
     ...
     * {@link FinancialInstrumentDetails18 }
     * 
     * 
     */
    public List<FinancialInstrumentDetails18> getFinInstrmDtls() {
        if (finInstrmDtls == null) {
            finInstrmDtls = new ArrayList<FinancialInstrumentDetails18>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification35 }
     * 
     * 
     */
    public List<SubAccountIdentification35> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification35>();
        }
     ...
     * 
     */
    public SecuritiesTransactionPostingReport002V05 addFinInstrmDtls(FinancialInstrumentDetails18 finInstrmDtls) {
     ...
     * 
     */
    public SecuritiesTransactionPostingReport002V05 addSubAcctDtls(SubAccountIdentification35 subAcctDtls) {
