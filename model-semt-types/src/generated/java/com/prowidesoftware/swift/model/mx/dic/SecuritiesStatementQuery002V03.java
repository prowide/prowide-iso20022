...
@XmlType(name = "SecuritiesStatementQuery002V03", propOrder = {
    "stmtReqd",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesStatementQuery002V03 {
    ...
    protected List<AdditionalQueryParameters6> addtlQryParams;
     ...
     *     
     */
    public SecuritiesStatementQuery002V03 setStmtReqd(DocumentNumber3 value) {
        this.stmtReqd = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesStatementQuery002V03 setStmtGnlDtls(Statement29 value) {
     ...
     *     
     */
    public SecuritiesStatementQuery002V03 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesStatementQuery002V03 setSfkpgAcct(SecuritiesAccount17 value) {
     ...
     * {@link AdditionalQueryParameters6 }
     * 
     * 
     */
    public List<AdditionalQueryParameters6> getAddtlQryParams() {
        if (addtlQryParams == null) {
            addtlQryParams = new ArrayList<AdditionalQueryParameters6>();
        }
     ...
     * 
     */
    public SecuritiesStatementQuery002V03 addAddtlQryParams(AdditionalQueryParameters6 addtlQryParams) {
     ...
     * 
     */
    public SecuritiesStatementQuery002V03 addSplmtryData(SupplementaryData1 splmtryData) {
