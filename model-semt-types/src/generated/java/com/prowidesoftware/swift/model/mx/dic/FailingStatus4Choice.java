...
@XmlType(name = "FailingStatus4Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class FailingStatus4Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<FailingReason4> rsn;
     ...
     *     
     */
    public FailingStatus4Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<FailingReason4> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<FailingReason4>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public FailingStatus4Choice addRsn(FailingReason4 rsn) {
        getRsn().add(rsn);
        return this;
    }
