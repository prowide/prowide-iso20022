...
@XmlType(name = "SecuritiesTransactionPendingReport002V11", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPendingReport002V11 {
    ...
    @XmlElement(name = "Sts")
    protected List<StatusAndReason41> sts;
    @XmlElement(name = "Txs")
    protected List<Transaction112> txs;
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V11 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V11 setStmtGnlDtls(Statement70 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V11 setAcctOwnr(PartyIdentification156 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V11 setSfkpgAcct(SecuritiesAccount30 value) {
     ...
     * {@link StatusAndReason41 }
     * 
     * 
     */
    public List<StatusAndReason41> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason41>();
        }
        return this.sts;
    }
     ...
     * 
     */
    public List<Transaction112> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction112>();
        }
        return this.txs;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V11 addSts(StatusAndReason41 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V11 addTxs(Transaction112 txs) {
        getTxs().add(txs);
        return this;
    }
