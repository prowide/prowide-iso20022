...
@XmlType(name = "StatusAndReason8", propOrder = {
    "stsAndRsn",
    "tx"
})
public class StatusAndReason8 {
    ...
    @XmlElement(name = "Tx")
    protected List<Transaction15> tx;
     ...
     *     
     */
    public StatusAndReason8 setStsAndRsn(Status4Choice value) {
     ...
     * 
     */
    public List<Transaction15> getTx() {
        if (tx == null) {
            tx = new ArrayList<Transaction15>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public StatusAndReason8 addTx(Transaction15 tx) {
        getTx().add(tx);
        return this;
    }
