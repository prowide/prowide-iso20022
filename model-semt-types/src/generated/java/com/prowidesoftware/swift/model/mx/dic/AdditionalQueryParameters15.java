...
@XmlType(name = "AdditionalQueryParameters15", propOrder = {
    "sts",
    "rsn",
    "finInstrmId"
})
public class AdditionalQueryParameters15 {

    @XmlElement(name = "Sts")
    protected Status19Choice sts;
    @XmlElement(name = "Rsn")
    protected List<Reason21Choice> rsn;
     ...
     *     
     */
    public AdditionalQueryParameters15 setSts(Status19Choice value) {
        this.sts = value;
        return this;
    }
     ...
     */
    public List<Reason21Choice> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public AdditionalQueryParameters15 addRsn(Reason21Choice rsn) {
        getRsn().add(rsn);
        return this;
    }
     ...
     * 
     */
    public AdditionalQueryParameters15 addFinInstrmId(SecurityIdentification19 finInstrmId) {
