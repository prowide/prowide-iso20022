...
public class SubAccountIdentification65 {
     ...
     *     
     */
    public SubAccountIdentification65 setAcctOwnr(PartyIdentification144 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification65 setSfkpgAcct(SecuritiesAccount25 value) {
     ...
     *     
     */
    public SubAccountIdentification65 setBlckChainAdrOrWllt(BlockChainAddressWallet2 value) {
     ...
     * 
     */
    public SubAccountIdentification65 setActvtyInd(boolean value) {
    ...
    public List<AggregateBalanceInformation40> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation40>();
        }
     ...
     * 
     */
    public SubAccountIdentification65 addBalForSubAcct(AggregateBalanceInformation40 balForSubAcct) {
