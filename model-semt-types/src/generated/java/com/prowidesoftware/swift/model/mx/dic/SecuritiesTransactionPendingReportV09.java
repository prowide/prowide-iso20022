...
@XmlType(name = "SecuritiesTransactionPendingReportV09", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPendingReportV09 {
    ...
    @XmlElement(name = "Sts")
    protected List<StatusAndReason34> sts;
    @XmlElement(name = "Txs")
    protected List<Transaction60> txs;
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV09 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV09 setStmtGnlDtls(Statement64 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV09 setAcctOwnr(PartyIdentification98 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV09 setSfkpgAcct(SecuritiesAccount19 value) {
     ...
     * {@link StatusAndReason34 }
     * 
     * 
     */
    public List<StatusAndReason34> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason34>();
        }
        return this.sts;
    }
     ...
     * 
     */
    public List<Transaction60> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction60>();
        }
        return this.txs;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReportV09 addSts(StatusAndReason34 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReportV09 addTxs(Transaction60 txs) {
        getTxs().add(txs);
        return this;
    }
