...
@XmlType(name = "FailingStatus9Choice__1", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class FailingStatus9Choice1 {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<FailingReason71> rsn;
     ...
     *     
     */
    public FailingStatus9Choice1 setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link FailingReason71 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<FailingReason71> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public FailingStatus9Choice1 addRsn(FailingReason71 rsn) {
        getRsn().add(rsn);
        return this;
    }
