...
@XmlType(name = "SecuritiesBalanceAccountingReport002V06", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "acctSvcr",
...
public class SecuritiesBalanceAccountingReport002V06 {
    ...
    protected List<AggregateBalanceInformation23> balForAcct;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification31> subAcctDtls;
     ...
     *     
     */
    public SecuritiesBalanceAccountingReport002V06 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReport002V06 setStmtGnlDtls(Statement24 value) {
     ...
     *     
     */
    public SecuritiesBalanceAccountingReport002V06 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReport002V06 setAcctSvcr(PartyIdentification59Choice value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReport002V06 setSfkpgAcct(SecuritiesAccount15 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalanceInformation23 }
     * 
     * 
     */
    public List<AggregateBalanceInformation23> getBalForAcct() {
        if (balForAcct == null) {
            balForAcct = new ArrayList<AggregateBalanceInformation23>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification31 }
     * 
     * 
     */
    public List<SubAccountIdentification31> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification31>();
        }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReport002V06 setAcctBaseCcyTtlAmts(TotalValueInPageAndStatement4 value) {
     ...
     *     
     */
    public SecuritiesBalanceAccountingReport002V06 setAltrnRptgCcyTtlAmts(TotalValueInPageAndStatement4 value) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReport002V06 addIntrmyInf(Intermediary22 intrmyInf) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReport002V06 addBalForAcct(AggregateBalanceInformation23 balForAcct) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReport002V06 addSubAcctDtls(SubAccountIdentification31 subAcctDtls) {
