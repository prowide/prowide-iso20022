...
@XmlType(name = "SecuritiesTransactionPostingReportV1", propOrder = {
    "id",
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
...
public class SecuritiesTransactionPostingReportV1 {
    ...
    protected Statement11 stmtGnlDtls;
    @XmlElement(name = "AcctOwnr")
    protected PartyIdentification13Choice acctOwnr;
    @XmlElement(name = "SfkpgAcct", required = true)
    protected SecuritiesAccount13 sfkpgAcct;
    @XmlElement(name = "FinInstrmDtls")
    protected List<FinancialInstrumentDetails2> finInstrmDtls;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification9> subAcctDtls;
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV1 setId(DocumentIdentification11 value) {
        this.id = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV1 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public Statement11 getStmtGnlDtls() {
        return stmtGnlDtls;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV1 setStmtGnlDtls(Statement11 value) {
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV1 setAcctOwnr(PartyIdentification13Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV1 setSfkpgAcct(SecuritiesAccount13 value) {
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV1 setMsgOrgtr(PartyIdentification10Choice value) {
        this.msgOrgtr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV1 setMsgRcpt(PartyIdentification10Choice value) {
        this.msgRcpt = value;
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPostingReportV1 addFinInstrmDtls(FinancialInstrumentDetails2 finInstrmDtls) {
     ...
     * 
     */
    public SecuritiesTransactionPostingReportV1 addSubAcctDtls(SubAccountIdentification9 subAcctDtls) {
