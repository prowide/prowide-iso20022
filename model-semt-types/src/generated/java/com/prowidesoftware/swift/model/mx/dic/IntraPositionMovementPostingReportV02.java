...
@XmlType(name = "IntraPositionMovementPostingReportV02", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class IntraPositionMovementPostingReportV02 {
    ...
    protected List<FinancialInstrumentDetails6> finInstrm;
     ...
     *     
     */
    public IntraPositionMovementPostingReportV02 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public IntraPositionMovementPostingReportV02 setStmtGnlDtls(Statement15 value) {
     ...
     *     
     */
    public IntraPositionMovementPostingReportV02 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public IntraPositionMovementPostingReportV02 setSfkpgAcct(SecuritiesAccount13 value) {
     ...
     * {@link FinancialInstrumentDetails6 }
     * 
     * 
     */
    public List<FinancialInstrumentDetails6> getFinInstrm() {
        if (finInstrm == null) {
            finInstrm = new ArrayList<FinancialInstrumentDetails6>();
        }
     ...
     * 
     */
    public IntraPositionMovementPostingReportV02 addFinInstrm(FinancialInstrumentDetails6 finInstrm) {
