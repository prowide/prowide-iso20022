...
@XmlType(name = "SecuritiesTransactionPostingReportV02Subset", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPostingReportV02Subset {
    ...
    protected List<FinancialInstrumentDetails8> finInstrmDtls;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification18> subAcctDtls;
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV02Subset setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV02Subset setStmtGnlDtls(Statement27 value) {
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV02Subset setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV02Subset setSfkpgAcct(SecuritiesAccount17 value) {
     ...
     * 
     */
    public List<FinancialInstrumentDetails8> getFinInstrmDtls() {
        if (finInstrmDtls == null) {
            finInstrmDtls = new ArrayList<FinancialInstrumentDetails8>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification18 }
     * 
     * 
     */
    public List<SubAccountIdentification18> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification18>();
        }
     ...
     * 
     */
    public SecuritiesTransactionPostingReportV02Subset addFinInstrmDtls(FinancialInstrumentDetails8 finInstrmDtls) {
     ...
     * 
     */
    public SecuritiesTransactionPostingReportV02Subset addSubAcctDtls(SubAccountIdentification18 subAcctDtls) {
