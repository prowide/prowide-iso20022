...
@XmlType(name = "AggregateBalanceInformation19", propOrder = {
    "finInstrmId",
    "finInstrmAttrbts",
...
public class AggregateBalanceInformation19 {
     ...
     *     
     */
    public AggregateBalanceInformation19 setFinInstrmId(SecurityIdentification15 value) {
     ...
     *     
     */
    public AggregateBalanceInformation19 setFinInstrmAttrbts(FinancialInstrumentAttributes41 value) {
     ...
     *     
     */
    public AggregateBalanceInformation19 setInvstmtFndsFinInstrmAttrbts(FinancialInstrument22 value) {
     ...
     *     
     */
    public AggregateBalanceInformation19 setAddtlDerivAttrbts(DerivativeBasicAttributes2 value) {
     ...
     *     
     */
    public AggregateBalanceInformation19 setAggtBal(Balance2 value) {
        this.aggtBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation19 setSfkpgPlc(SafekeepingPlaceFormat4Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation19 setCorpActnOptnTp(CorporateActionOption5Code value) {
     ...
     *     
     */
    public AggregateBalanceInformation19 setDaysAcrd(BigDecimal value) {
        this.daysAcrd = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation19 setAcctBaseCcyAmts(BalanceAmounts5 value) {
     ...
     *     
     */
    public AggregateBalanceInformation19 setInstrmCcyAmts(BalanceAmounts5 value) {
     ...
     *     
     */
    public AggregateBalanceInformation19 setAltrnRptgCcyAmts(BalanceAmounts5 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link QuantityBreakdown19 }
     * 
     * 
     */
    public List<QuantityBreakdown19> getQtyBrkdwn() {
        if (qtyBrkdwn == null) {
            qtyBrkdwn = new ArrayList<QuantityBreakdown19>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalancePerSafekeepingPlace18 }
     * 
     * 
     */
    public List<AggregateBalancePerSafekeepingPlace18> getBalAtSfkpgPlc() {
        if (balAtSfkpgPlc == null) {
            balAtSfkpgPlc = new ArrayList<AggregateBalancePerSafekeepingPlace18>();
        }
     ...
     *     
     */
    public AggregateBalanceInformation19 setHldgAddtlDtls(String value) {
     ...
     * 
     */
    public AggregateBalanceInformation19 addPricDtls(PriceInformation7 pricDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation19 addFXDtls(ForeignExchangeTerms16 fXDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation19 addQtyBrkdwn(QuantityBreakdown19 qtyBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation19 addBalBrkdwn(SubBalanceInformation7 balBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation19 addAddtlBalBrkdwn(AdditionalBalanceInformation7 addtlBalBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation19 addBalAtSfkpgPlc(AggregateBalancePerSafekeepingPlace18 balAtSfkpgPlc) {
     ...
     * 
     */
    public AggregateBalanceInformation19 addSplmtryData(SupplementaryData1 splmtryData) {
