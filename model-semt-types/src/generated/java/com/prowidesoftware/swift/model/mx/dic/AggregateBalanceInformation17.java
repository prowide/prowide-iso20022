...
@XmlType(name = "AggregateBalanceInformation17", propOrder = {
    "finInstrmId",
    "finInstrmAttrbts",
...
public class AggregateBalanceInformation17 {
     ...
     *     
     */
    public AggregateBalanceInformation17 setFinInstrmId(SecurityIdentification14 value) {
     ...
     *     
     */
    public AggregateBalanceInformation17 setFinInstrmAttrbts(FinancialInstrumentAttributes35 value) {
     ...
     *     
     */
    public AggregateBalanceInformation17 setInvstmtFndsFinInstrmAttrbts(FinancialInstrument21 value) {
     ...
     *     
     */
    public AggregateBalanceInformation17 setAddtlDerivAttrbts(DerivativeBasicAttributes1 value) {
     ...
     *     
     */
    public AggregateBalanceInformation17 setAggtBal(Balance1 value) {
        this.aggtBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation17 setSfkpgPlc(SafekeepingPlaceFormat3Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation17 setCorpActnOptnTp(CorporateActionOption5Code value) {
     ...
     *     
     */
    public AggregateBalanceInformation17 setDaysAcrd(BigDecimal value) {
        this.daysAcrd = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation17 setAcctBaseCcyAmts(BalanceAmounts1 value) {
     ...
     *     
     */
    public AggregateBalanceInformation17 setInstrmCcyAmts(BalanceAmounts1 value) {
     ...
     *     
     */
    public AggregateBalanceInformation17 setAltrnRptgCcyAmts(BalanceAmounts1 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link QuantityBreakdown14 }
     * 
     * 
     */
    public List<QuantityBreakdown14> getQtyBrkdwn() {
        if (qtyBrkdwn == null) {
            qtyBrkdwn = new ArrayList<QuantityBreakdown14>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalancePerSafekeepingPlace16 }
     * 
     * 
     */
    public List<AggregateBalancePerSafekeepingPlace16> getBalAtSfkpgPlc() {
        if (balAtSfkpgPlc == null) {
            balAtSfkpgPlc = new ArrayList<AggregateBalancePerSafekeepingPlace16>();
        }
     ...
     *     
     */
    public AggregateBalanceInformation17 setHldgAddtlDtls(String value) {
     ...
     * 
     */
    public AggregateBalanceInformation17 addPricDtls(PriceInformation5 pricDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation17 addFXDtls(ForeignExchangeTerms14 fXDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation17 addQtyBrkdwn(QuantityBreakdown14 qtyBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation17 addBalBrkdwn(SubBalanceInformation6 balBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation17 addAddtlBalBrkdwn(AdditionalBalanceInformation6 addtlBalBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation17 addBalAtSfkpgPlc(AggregateBalancePerSafekeepingPlace16 balAtSfkpgPlc) {
     ...
     * 
     */
    public AggregateBalanceInformation17 addSplmtryData(SupplementaryData1 splmtryData) {
