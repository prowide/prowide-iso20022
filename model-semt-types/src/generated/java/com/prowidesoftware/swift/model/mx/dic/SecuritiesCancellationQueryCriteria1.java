...
@XmlType(name = "SecuritiesCancellationQueryCriteria1", propOrder = {
    "cxlReqId",
    "instrQryTp",
    "prcgSts",
    "sfkpgAcct",
...
public class SecuritiesCancellationQueryCriteria1 {
     ...
     *     
     */
    public SecuritiesCancellationQueryCriteria1 setInstrQryTp(InstructionQueryType1Code value) {
     ...
     *     
     */
    public SecuritiesCancellationQueryCriteria1 setCreDtTm(DateAndDateTimeSearch5Choice value) {
        this.creDtTm = value;
        return this;
    }
     ...
     * 
     */
    public SecuritiesCancellationQueryCriteria1 addCxlReqId(String cxlReqId) {
     ...
     * 
     */
    public SecuritiesCancellationQueryCriteria1 addPrcgSts(CancellationProcessingStatus9Choice prcgSts) {
     ...
     * 
     */
    public SecuritiesCancellationQueryCriteria1 addSfkpgAcct(SecuritiesAccount19 sfkpgAcct) {
     ...
     * 
     */
    public SecuritiesCancellationQueryCriteria1 addAcctOwnr(SystemPartyIdentification8 acctOwnr) {
     ...
     * 
     */
    public SecuritiesCancellationQueryCriteria1 addMsgOrgtr(SystemPartyIdentification8 msgOrgtr) {
