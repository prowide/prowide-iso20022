...
@XmlType(name = "PendingStatus39Choice__1", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus39Choice1 {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingReason171> rsn;
     ...
     *     
     */
    public PendingStatus39Choice1 setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingReason171 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingReason171> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingStatus39Choice1 addRsn(PendingReason171 rsn) {
        getRsn().add(rsn);
        return this;
    }
