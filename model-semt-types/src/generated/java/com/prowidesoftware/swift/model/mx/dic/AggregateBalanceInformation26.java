...
@XmlType(name = "AggregateBalanceInformation26", propOrder = {
    "finInstrmId",
    "finInstrmAttrbts",
...
public class AggregateBalanceInformation26 {
    ...
    protected List<AggregateBalancePerSafekeepingPlace25> balAtSfkpgPlc;
     ...
     *     
     */
    public AggregateBalanceInformation26 setFinInstrmId(SecurityIdentification14 value) {
     ...
     *     
     */
    public AggregateBalanceInformation26 setFinInstrmAttrbts(FinancialInstrumentAttributes35 value) {
     ...
     *     
     */
    public AggregateBalanceInformation26 setInvstmtFndsFinInstrmAttrbts(FinancialInstrument21 value) {
     ...
     *     
     */
    public AggregateBalanceInformation26 setAddtlDerivAttrbts(DerivativeBasicAttributes1 value) {
     ...
     *     
     */
    public AggregateBalanceInformation26 setAggtBal(Balance1 value) {
        this.aggtBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation26 setSfkpgPlc(SafekeepingPlaceFormat3Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation26 setCorpActnOptnTp(CorporateActionOption5Code value) {
     ...
     *     
     */
    public AggregateBalanceInformation26 setDaysAcrd(BigDecimal value) {
        this.daysAcrd = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation26 setAcctBaseCcyAmts(BalanceAmounts1 value) {
     ...
     *     
     */
    public AggregateBalanceInformation26 setInstrmCcyAmts(BalanceAmounts1 value) {
     ...
     *     
     */
    public AggregateBalanceInformation26 setAltrnRptgCcyAmts(BalanceAmounts1 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalancePerSafekeepingPlace25 }
     * 
     * 
     */
    public List<AggregateBalancePerSafekeepingPlace25> getBalAtSfkpgPlc() {
        if (balAtSfkpgPlc == null) {
            balAtSfkpgPlc = new ArrayList<AggregateBalancePerSafekeepingPlace25>();
        }
     ...
     *     
     */
    public AggregateBalanceInformation26 setHldgAddtlDtls(String value) {
     ...
     * 
     */
    public AggregateBalanceInformation26 addPricDtls(PriceInformation5 pricDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation26 addFXDtls(ForeignExchangeTerms14 fXDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation26 addQtyBrkdwn(QuantityBreakdown24 qtyBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation26 addBalBrkdwn(SubBalanceInformation6 balBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation26 addAddtlBalBrkdwn(AdditionalBalanceInformation6 addtlBalBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation26 addBalAtSfkpgPlc(AggregateBalancePerSafekeepingPlace25 balAtSfkpgPlc) {
     ...
     * 
     */
    public AggregateBalanceInformation26 addSplmtryData(SupplementaryData1 splmtryData) {
