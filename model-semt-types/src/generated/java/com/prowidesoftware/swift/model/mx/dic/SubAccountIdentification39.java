...
@XmlType(name = "SubAccountIdentification39", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "actvtyInd",
    "balForSubAcct"
})
public class SubAccountIdentification39 {
    ...
    protected List<AggregateBalanceInformation27> balForSubAcct;
     ...
     *     
     */
    public SubAccountIdentification39 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification39 setSfkpgAcct(SecuritiesAccount16 value) {
     ...
     * 
     */
    public SubAccountIdentification39 setActvtyInd(boolean value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation27> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation27>();
        }
     ...
     * 
     */
    public SubAccountIdentification39 addBalForSubAcct(AggregateBalanceInformation27 balForSubAcct) {
