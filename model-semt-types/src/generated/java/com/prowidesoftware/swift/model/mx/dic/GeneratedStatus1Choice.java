...
@XmlType(name = "GeneratedStatus1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class GeneratedStatus1Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<GeneratedReason1> rsn;
     ...
     *     
     */
    public GeneratedStatus1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<GeneratedReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<GeneratedReason1>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public GeneratedStatus1Choice addRsn(GeneratedReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
