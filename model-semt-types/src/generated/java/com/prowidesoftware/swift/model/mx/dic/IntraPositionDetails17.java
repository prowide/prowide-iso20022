...
@XmlType(name = "IntraPositionDetails17", propOrder = {
    "sfkpgPlc",
    "balFr",
    "intraPosMvmnt"
})
public class IntraPositionDetails17 {
    ...
    protected List<IntraPositionMovementDetails5> intraPosMvmnt;
     ...
     *     
     */
    public IntraPositionDetails17 setSfkpgPlc(SafekeepingPlaceFormat3Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public IntraPositionDetails17 setBalFr(SecuritiesBalanceType3Choice value) {
        this.balFr = value;
        return this;
    }
     ...
     * {@link IntraPositionMovementDetails5 }
     * 
     * 
     */
    public List<IntraPositionMovementDetails5> getIntraPosMvmnt() {
        if (intraPosMvmnt == null) {
            intraPosMvmnt = new ArrayList<IntraPositionMovementDetails5>();
        }
     ...
     * 
     */
    public IntraPositionDetails17 addIntraPosMvmnt(IntraPositionMovementDetails5 intraPosMvmnt) {
