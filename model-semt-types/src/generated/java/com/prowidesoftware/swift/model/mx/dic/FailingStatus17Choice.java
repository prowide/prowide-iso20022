...
@XmlType(name = "FailingStatus17Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class FailingStatus17Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<FailingReason15> rsn;
     ...
     *     
     */
    public FailingStatus17Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link FailingReason15 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<FailingReason15> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public FailingStatus17Choice addRsn(FailingReason15 rsn) {
        getRsn().add(rsn);
        return this;
    }
