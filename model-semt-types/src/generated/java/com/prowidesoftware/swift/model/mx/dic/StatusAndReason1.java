...
@XmlType(name = "StatusAndReason1", propOrder = {
    "stsAndRsn",
    "tx"
})
public class StatusAndReason1 {

    @XmlElement(name = "StsAndRsn", required = true)
    protected Status2Choice stsAndRsn;
    @XmlElement(name = "Tx")
    protected List<Transaction7> tx;
     ...
     *     
     */
    public StatusAndReason1 setStsAndRsn(Status2Choice value) {
     ...
     * 
     */
    public List<Transaction7> getTx() {
        if (tx == null) {
            tx = new ArrayList<Transaction7>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public StatusAndReason1 addTx(Transaction7 tx) {
        getTx().add(tx);
        return this;
    }
