...
@XmlType(name = "AggregateBalanceInformation21", propOrder = {
    "finInstrmId",
    "finInstrmAttrbts",
...
public class AggregateBalanceInformation21 {
    ...
    protected List<AggregateBalancePerSafekeepingPlace20> balAtSfkpgPlc;
     ...
     *     
     */
    public AggregateBalanceInformation21 setFinInstrmId(SecurityIdentification14 value) {
     ...
     *     
     */
    public AggregateBalanceInformation21 setFinInstrmAttrbts(FinancialInstrumentAttributes35 value) {
     ...
     *     
     */
    public AggregateBalanceInformation21 setInvstmtFndsFinInstrmAttrbts(FinancialInstrument21 value) {
     ...
     *     
     */
    public AggregateBalanceInformation21 setValtnHrcutDtls(BasicCollateralValuation1Details value) {
     ...
     *     
     */
    public AggregateBalanceInformation21 setAggtBal(Balance1 value) {
        this.aggtBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation21 setAvlblBal(BalanceQuantity5Choice value) {
        this.avlblBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation21 setNotAvlblBal(BalanceQuantity5Choice value) {
     ...
     *     
     */
    public AggregateBalanceInformation21 setSfkpgPlc(SafekeepingPlaceFormat3Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation21 setCorpActnOptnTp(CorporateActionOption5Code value) {
     ...
     *     
     */
    public AggregateBalanceInformation21 setDaysAcrd(BigDecimal value) {
        this.daysAcrd = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation21 setAcctBaseCcyAmts(BalanceAmounts3 value) {
     ...
     *     
     */
    public AggregateBalanceInformation21 setInstrmCcyAmts(BalanceAmounts3 value) {
    ...
    public List<QuantityBreakdown23> getQtyBrkdwn() {
        if (qtyBrkdwn == null) {
            qtyBrkdwn = new ArrayList<QuantityBreakdown23>();
        }
    ...
    public List<SubBalanceInformation11> getBalBrkdwn() {
        if (balBrkdwn == null) {
            balBrkdwn = new ArrayList<SubBalanceInformation11>();
        }
    ...
    public List<AdditionalBalanceInformation11> getAddtlBalBrkdwn() {
        if (addtlBalBrkdwn == null) {
            addtlBalBrkdwn = new ArrayList<AdditionalBalanceInformation11>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalancePerSafekeepingPlace20 }
     * 
     * 
     */
    public List<AggregateBalancePerSafekeepingPlace20> getBalAtSfkpgPlc() {
        if (balAtSfkpgPlc == null) {
            balAtSfkpgPlc = new ArrayList<AggregateBalancePerSafekeepingPlace20>();
        }
     ...
     *     
     */
    public AggregateBalanceInformation21 setHldgAddtlDtls(String value) {
     ...
     * 
     */
    public AggregateBalanceInformation21 addPricDtls(PriceInformation5 pricDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation21 addFXDtls(ForeignExchangeTerms14 fXDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation21 addQtyBrkdwn(QuantityBreakdown23 qtyBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation21 addBalBrkdwn(SubBalanceInformation11 balBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation21 addAddtlBalBrkdwn(AdditionalBalanceInformation11 addtlBalBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation21 addBalAtSfkpgPlc(AggregateBalancePerSafekeepingPlace20 balAtSfkpgPlc) {
     ...
     * 
     */
    public AggregateBalanceInformation21 addSplmtryData(SupplementaryData1 splmtryData) {
