...
@XmlType(name = "AggregateBalanceInformation32", propOrder = {
    "finInstrmId",
    "finInstrmAttrbts",
...
public class AggregateBalanceInformation32 {
    ...
    protected List<QuantityBreakdown39> qtyBrkdwn;
    ...
    protected List<AggregateBalancePerSafekeepingPlace30> balAtSfkpgPlc;
     ...
     *     
     */
    public AggregateBalanceInformation32 setFinInstrmId(SecurityIdentification20 value) {
     ...
     *     
     */
    public AggregateBalanceInformation32 setFinInstrmAttrbts(FinancialInstrumentAttributes78 value) {
     ...
     *     
     */
    public AggregateBalanceInformation32 setInvstmtFndsFinInstrmAttrbts(FinancialInstrument22 value) {
     ...
     *     
     */
    public AggregateBalanceInformation32 setAddtlDerivAttrbts(DerivativeBasicAttributes2 value) {
     ...
     *     
     */
    public AggregateBalanceInformation32 setAggtBal(Balance10 value) {
        this.aggtBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation32 setSfkpgPlc(SafeKeepingPlace2 value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation32 setCorpActnOptnTp(CorporateActionOption5Code value) {
     ...
     *     
     */
    public AggregateBalanceInformation32 setDaysAcrd(BigDecimal value) {
        this.daysAcrd = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation32 setAcctBaseCcyAmts(BalanceAmounts5 value) {
     ...
     *     
     */
    public AggregateBalanceInformation32 setInstrmCcyAmts(BalanceAmounts5 value) {
     ...
     *     
     */
    public AggregateBalanceInformation32 setAltrnRptgCcyAmts(BalanceAmounts5 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link QuantityBreakdown39 }
     * 
     * 
     */
    public List<QuantityBreakdown39> getQtyBrkdwn() {
        if (qtyBrkdwn == null) {
            qtyBrkdwn = new ArrayList<QuantityBreakdown39>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalancePerSafekeepingPlace30 }
     * 
     * 
     */
    public List<AggregateBalancePerSafekeepingPlace30> getBalAtSfkpgPlc() {
        if (balAtSfkpgPlc == null) {
            balAtSfkpgPlc = new ArrayList<AggregateBalancePerSafekeepingPlace30>();
        }
     ...
     *     
     */
    public AggregateBalanceInformation32 setHldgAddtlDtls(String value) {
     ...
     * 
     */
    public AggregateBalanceInformation32 addPricDtls(PriceInformation14 pricDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation32 addFXDtls(ForeignExchangeTerms31 fXDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation32 addQtyBrkdwn(QuantityBreakdown39 qtyBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation32 addBalBrkdwn(SubBalanceInformation16 balBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation32 addAddtlBalBrkdwn(AdditionalBalanceInformation16 addtlBalBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation32 addBalAtSfkpgPlc(AggregateBalancePerSafekeepingPlace30 balAtSfkpgPlc) {
     ...
     * 
     */
    public AggregateBalanceInformation32 addSplmtryData(SupplementaryData1 splmtryData) {
