...
@XmlType(name = "StatusAndReason35", propOrder = {
    "stsAndRsn",
    "tx"
})
public class StatusAndReason35 {
    ...
    @XmlElement(name = "Tx")
    protected List<Transaction63> tx;
     ...
     *     
     */
    public StatusAndReason35 setStsAndRsn(Status23Choice value) {
     ...
     * 
     */
    public List<Transaction63> getTx() {
        if (tx == null) {
            tx = new ArrayList<Transaction63>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public StatusAndReason35 addTx(Transaction63 tx) {
        getTx().add(tx);
        return this;
    }
