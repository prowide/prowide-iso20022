...
@XmlType(name = "SecuritiesTransactionPostingReportV14", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPostingReportV14 {
    ...
    protected List<FinancialInstrumentDetails48> finInstrmDtls;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification74> subAcctDtls;
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV14 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV14 setStmtGnlDtls(Statement79 value) {
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV14 setAcctOwnr(PartyIdentification144 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV14 setSfkpgAcct(SecuritiesAccount36 value) {
     ...
     *     
     */
    public SecuritiesTransactionPostingReportV14 setBlckChainAdrOrWllt(BlockChainAddressWallet4 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FinancialInstrumentDetails48 }
     * 
     * 
     * @return
     *     The value of the finInstrmDtls property.
     */
    public List<FinancialInstrumentDetails48> getFinInstrmDtls() {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification74 }
     * 
     * 
     * @return
     *     The value of the subAcctDtls property.
     */
    public List<SubAccountIdentification74> getSubAcctDtls() {
        if (subAcctDtls == null) {
     ...
     * 
     */
    public SecuritiesTransactionPostingReportV14 addIntrmyInf(Intermediary44 intrmyInf) {
     ...
     * 
     */
    public SecuritiesTransactionPostingReportV14 addFinInstrmDtls(FinancialInstrumentDetails48 finInstrmDtls) {
     ...
     * 
     */
    public SecuritiesTransactionPostingReportV14 addSubAcctDtls(SubAccountIdentification74 subAcctDtls) {
