...
@XmlType(name = "FailingStatus11Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class FailingStatus11Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<FailingReason9> rsn;
     ...
     *     
     */
    public FailingStatus11Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<FailingReason9> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<FailingReason9>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public FailingStatus11Choice addRsn(FailingReason9 rsn) {
        getRsn().add(rsn);
        return this;
    }
