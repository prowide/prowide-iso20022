...
@XmlType(name = "DeniedStatus12Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus12Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason7> rsn;
     ...
     *     
     */
    public DeniedStatus12Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason7> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason7>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus12Choice addRsn(DeniedReason7 rsn) {
        getRsn().add(rsn);
        return this;
    }
