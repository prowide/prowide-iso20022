...
@XmlType(name = "RejectionOrRepairReason27", propOrder = {
    "cd",
    "addtlRsnInf"
})
public class RejectionOrRepairReason27 {
    ...
    @XmlElement(name = "Cd")
    protected List<RejectionAndRepairReason27Choice> cd;
     ...
     *     
     */
    public RejectionOrRepairReason27 setAddtlRsnInf(String value) {
     ...
     * 
     */
    public RejectionOrRepairReason27 addCd(RejectionAndRepairReason27Choice cd) {
        getCd().add(cd);
        return this;
    }
