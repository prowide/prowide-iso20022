...
@XmlType(name = "SubBalanceInformation7", propOrder = {
    "subBalTp",
    "qty",
    "subBalAddtlDtls",
    "addtlBalBrkdwnDtls"
})
public class SubBalanceInformation7 {
    ...
    protected List<AdditionalBalanceInformation7> addtlBalBrkdwnDtls;
     ...
     *     
     */
    public SubBalanceInformation7 setSubBalTp(SubBalanceType7Choice value) {
        this.subBalTp = value;
        return this;
    }
     ...
     *     
     */
    public SubBalanceInformation7 setQty(SubBalanceQuantity4Choice value) {
        this.qty = value;
        return this;
    }
     ...
     *     
     */
    public SubBalanceInformation7 setSubBalAddtlDtls(String value) {
     ...
     * 
     */
    public List<AdditionalBalanceInformation7> getAddtlBalBrkdwnDtls() {
        if (addtlBalBrkdwnDtls == null) {
            addtlBalBrkdwnDtls = new ArrayList<AdditionalBalanceInformation7>();
        }
     ...
     * 
     */
    public SubBalanceInformation7 addAddtlBalBrkdwnDtls(AdditionalBalanceInformation7 addtlBalBrkdwnDtls) {
