...
@XmlType(name = "SecuritiesBalanceCustodyReportV04", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "acctSvcr",
...
public class SecuritiesBalanceCustodyReportV04 {
    ...
    protected List<AggregateBalanceInformation12> balForAcct;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification17> subAcctDtls;
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV04 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV04 setStmtGnlDtls(Statement21 value) {
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV04 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV04 setAcctSvcr(PartyIdentification49Choice value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV04 setSfkpgAcct(SecuritiesAccount11 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalanceInformation12 }
     * 
     * 
     */
    public List<AggregateBalanceInformation12> getBalForAcct() {
        if (balForAcct == null) {
            balForAcct = new ArrayList<AggregateBalanceInformation12>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification17 }
     * 
     * 
     */
    public List<SubAccountIdentification17> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification17>();
        }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV04 setAcctBaseCcyTtlAmts(TotalValueInPageAndStatement1 value) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV04 addIntrmyInf(Intermediary21 intrmyInf) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV04 addBalForAcct(AggregateBalanceInformation12 balForAcct) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV04 addSubAcctDtls(SubAccountIdentification17 subAcctDtls) {
