...
@XmlType(name = "SubAccountIdentification58", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "actvtyInd",
    "balForSubAcct"
})
public class SubAccountIdentification58 {
    ...
    protected List<AggregateBalanceInformation39> balForSubAcct;
     ...
     *     
     */
    public SubAccountIdentification58 setAcctOwnr(PartyIdentification156 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification58 setSfkpgAcct(SecuritiesAccount34 value) {
     ...
     * 
     */
    public SubAccountIdentification58 setActvtyInd(boolean value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation39> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation39>();
        }
     ...
     * 
     */
    public SubAccountIdentification58 addBalForSubAcct(AggregateBalanceInformation39 balForSubAcct) {
