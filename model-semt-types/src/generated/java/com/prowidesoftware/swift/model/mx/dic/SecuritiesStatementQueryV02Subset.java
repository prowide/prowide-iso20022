...
@XmlType(name = "SecuritiesStatementQueryV02Subset", propOrder = {
    "stmtReqd",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesStatementQueryV02Subset {
    ...
    protected List<AdditionalQueryParameters4> addtlQryParams;
     ...
     *     
     */
    public SecuritiesStatementQueryV02Subset setStmtReqd(DocumentNumber3 value) {
        this.stmtReqd = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesStatementQueryV02Subset setStmtGnlDtls(Statement29 value) {
     ...
     *     
     */
    public SecuritiesStatementQueryV02Subset setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesStatementQueryV02Subset setSfkpgAcct(SecuritiesAccount17 value) {
     ...
     * {@link AdditionalQueryParameters4 }
     * 
     * 
     */
    public List<AdditionalQueryParameters4> getAddtlQryParams() {
        if (addtlQryParams == null) {
            addtlQryParams = new ArrayList<AdditionalQueryParameters4>();
        }
     ...
     * 
     */
    public SecuritiesStatementQueryV02Subset addAddtlQryParams(AdditionalQueryParameters4 addtlQryParams) {
     ...
     * 
     */
    public SecuritiesStatementQueryV02Subset addSplmtryData(SupplementaryData1 splmtryData) {
