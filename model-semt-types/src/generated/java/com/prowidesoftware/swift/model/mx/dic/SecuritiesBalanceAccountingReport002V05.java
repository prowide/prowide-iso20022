...
@XmlType(name = "SecuritiesBalanceAccountingReport002V05", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "acctSvcr",
...
public class SecuritiesBalanceAccountingReport002V05 {
    ...
    protected List<AggregateBalanceInformation19> balForAcct;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification26> subAcctDtls;
     ...
     *     
     */
    public SecuritiesBalanceAccountingReport002V05 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReport002V05 setStmtGnlDtls(Statement24 value) {
     ...
     *     
     */
    public SecuritiesBalanceAccountingReport002V05 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReport002V05 setAcctSvcr(PartyIdentification59Choice value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReport002V05 setSfkpgAcct(SecuritiesAccount15 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalanceInformation19 }
     * 
     * 
     */
    public List<AggregateBalanceInformation19> getBalForAcct() {
        if (balForAcct == null) {
            balForAcct = new ArrayList<AggregateBalanceInformation19>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification26 }
     * 
     * 
     */
    public List<SubAccountIdentification26> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification26>();
        }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReport002V05 setAcctBaseCcyTtlAmts(TotalValueInPageAndStatement4 value) {
     ...
     *     
     */
    public SecuritiesBalanceAccountingReport002V05 setAltrnRptgCcyTtlAmts(TotalValueInPageAndStatement4 value) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReport002V05 addIntrmyInf(Intermediary22 intrmyInf) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReport002V05 addBalForAcct(AggregateBalanceInformation19 balForAcct) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReport002V05 addSubAcctDtls(SubAccountIdentification26 subAcctDtls) {
