...
@XmlType(name = "SecuritiesTransactionPostingReport002V10", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPostingReport002V10 {
    ...
    protected List<SubAccountIdentification61> subAcctDtls;
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V10 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V10 setStmtGnlDtls(Statement82 value) {
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V10 setAcctOwnr(PartyIdentification156 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V10 setSfkpgAcct(SecuritiesAccount40 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification61 }
     * 
     * 
     */
    public List<SubAccountIdentification61> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification61>();
        }
     ...
     * 
     */
    public SecuritiesTransactionPostingReport002V10 addIntrmyInf(Intermediary45 intrmyInf) {
     ...
     * 
     */
    public SecuritiesTransactionPostingReport002V10 addFinInstrmDtls(FinancialInstrumentDetails37 finInstrmDtls) {
     ...
     * 
     */
    public SecuritiesTransactionPostingReport002V10 addSubAcctDtls(SubAccountIdentification61 subAcctDtls) {
