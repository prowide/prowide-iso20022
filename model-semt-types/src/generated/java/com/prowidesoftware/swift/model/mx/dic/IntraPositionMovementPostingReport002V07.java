...
@XmlType(name = "IntraPositionMovementPostingReport002V07", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class IntraPositionMovementPostingReport002V07 {
    ...
    protected Statement67 stmtGnlDtls;
    ...
    protected List<FinancialInstrumentDetails30> finInstrm;
     ...
     *     
     */
    public IntraPositionMovementPostingReport002V07 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public Statement67 getStmtGnlDtls() {
        return stmtGnlDtls;
    }
     ...
     *     
     */
    public IntraPositionMovementPostingReport002V07 setStmtGnlDtls(Statement67 value) {
     ...
     *     
     */
    public IntraPositionMovementPostingReport002V07 setAcctOwnr(PartyIdentification103Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public IntraPositionMovementPostingReport002V07 setSfkpgAcct(SecuritiesAccount30 value) {
     ...
     * {@link FinancialInstrumentDetails30 }
     * 
     * 
     */
    public List<FinancialInstrumentDetails30> getFinInstrm() {
        if (finInstrm == null) {
            finInstrm = new ArrayList<FinancialInstrumentDetails30>();
        }
     ...
     * 
     */
    public IntraPositionMovementPostingReport002V07 addFinInstrm(FinancialInstrumentDetails30 finInstrm) {
