...
@XmlType(name = "SecuritiesTransactionPendingReport002V12", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPendingReport002V12 {
    ...
    @XmlElement(name = "Sts")
    protected List<StatusAndReason43> sts;
    @XmlElement(name = "Txs")
    protected List<Transaction118> txs;
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V12 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V12 setStmtGnlDtls(Statement70 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V12 setAcctOwnr(PartyIdentification156 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V12 setSfkpgAcct(SecuritiesAccount30 value) {
     ...
     * {@link StatusAndReason43 }
     * 
     * 
     */
    public List<StatusAndReason43> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason43>();
        }
        return this.sts;
    }
     ...
     * 
     */
    public List<Transaction118> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction118>();
        }
        return this.txs;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V12 addSts(StatusAndReason43 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V12 addTxs(Transaction118 txs) {
        getTxs().add(txs);
        return this;
    }
