...
@XmlType(name = "IntraPositionStatusAndReason4", propOrder = {
    "prcgSts",
    "sttlmSts",
    "sttld"
})
public class IntraPositionStatusAndReason4 {

    @XmlElement(name = "PrcgSts")
    protected List<ProcessingStatus99Choice> prcgSts;
    @XmlElement(name = "SttlmSts")
    protected List<SettlementStatus34Choice> sttlmSts;
     ...
     * {@link ProcessingStatus99Choice }
     * 
     * 
     * @return
     *     The value of the prcgSts property.
     */
    public List<ProcessingStatus99Choice> getPrcgSts() {
        if (prcgSts == null) {
     ...
     */
    public List<SettlementStatus34Choice> getSttlmSts() {
        if (sttlmSts == null) {
     ...
     *     
     */
    public IntraPositionStatusAndReason4 setSttld(ProprietaryReason4 value) {
        this.sttld = value;
        return this;
    }
     ...
     * 
     */
    public IntraPositionStatusAndReason4 addPrcgSts(ProcessingStatus99Choice prcgSts) {
     ...
     * 
     */
    public IntraPositionStatusAndReason4 addSttlmSts(SettlementStatus34Choice sttlmSts) {
