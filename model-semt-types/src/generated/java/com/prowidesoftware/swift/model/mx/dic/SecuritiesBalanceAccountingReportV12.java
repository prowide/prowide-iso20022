...
@XmlType(name = "SecuritiesBalanceAccountingReportV12", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "acctSvcr",
...
public class SecuritiesBalanceAccountingReportV12 {
    ...
    protected List<AggregateBalanceInformation45> balForAcct;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification72> subAcctDtls;
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV12 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV12 setStmtGnlDtls(Statement74 value) {
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV12 setAcctOwnr(PartyIdentification144 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV12 setAcctSvcr(PartyIdentification136 value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV12 setSfkpgAcct(SecuritiesAccount26 value) {
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV12 setBlckChainAdrOrWllt(BlockChainAddressWallet1 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalanceInformation45 }
     * 
     * 
     */
    public List<AggregateBalanceInformation45> getBalForAcct() {
        if (balForAcct == null) {
            balForAcct = new ArrayList<AggregateBalanceInformation45>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification72 }
     * 
     * 
     */
    public List<SubAccountIdentification72> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification72>();
        }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV12 setAcctBaseCcyTtlAmts(TotalValueInPageAndStatement2 value) {
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV12 setAltrnRptgCcyTtlAmts(TotalValueInPageAndStatement2 value) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReportV12 addIntrmyInf(Intermediary44 intrmyInf) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReportV12 addBalForAcct(AggregateBalanceInformation45 balForAcct) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReportV12 addSubAcctDtls(SubAccountIdentification72 subAcctDtls) {
