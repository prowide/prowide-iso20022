...
@XmlType(name = "AggregateBalanceInformation46", propOrder = {
    "finInstrmId",
    "finInstrmAttrbts",
...
public class AggregateBalanceInformation46 {
    ...
    protected List<AggregateBalancePerSafekeepingPlace43> balAtSfkpgPlc;
     ...
     *     
     */
    public AggregateBalanceInformation46 setFinInstrmId(SecurityIdentification19 value) {
     ...
     *     
     */
    public AggregateBalanceInformation46 setFinInstrmAttrbts(FinancialInstrumentAttributes111 value) {
     ...
     *     
     */
    public AggregateBalanceInformation46 setInvstmtFndsFinInstrmAttrbts(FinancialInstrument21 value) {
     ...
     *     
     */
    public AggregateBalanceInformation46 setValtnHrcutDtls(BasicCollateralValuation1Details value) {
     ...
     *     
     */
    public AggregateBalanceInformation46 setAggtBal(Balance17 value) {
        this.aggtBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation46 setAvlblBal(Balance18 value) {
        this.avlblBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation46 setNotAvlblBal(BalanceQuantity14Choice value) {
     ...
     *     
     */
    public AggregateBalanceInformation46 setSfkpgPlc(SafeKeepingPlace5 value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation46 setCorpActnOptnTp(CorporateActionOption5Code value) {
     ...
     *     
     */
    public AggregateBalanceInformation46 setDaysAcrd(BigDecimal value) {
        this.daysAcrd = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation46 setAcctBaseCcyAmts(BalanceAmounts3 value) {
     ...
     *     
     */
    public AggregateBalanceInformation46 setInstrmCcyAmts(BalanceAmounts3 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalancePerSafekeepingPlace43 }
     * 
     * 
     * @return
     *     The value of the balAtSfkpgPlc property.
     */
    public List<AggregateBalancePerSafekeepingPlace43> getBalAtSfkpgPlc() {
     ...
     *     
     */
    public AggregateBalanceInformation46 setHldgAddtlDtls(String value) {
     ...
     * 
     */
    public AggregateBalanceInformation46 addPricDtls(PriceInformation29 pricDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation46 addFXDtls(ForeignExchangeTerms34 fXDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation46 addQtyBrkdwn(QuantityBreakdown57 qtyBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation46 addBalBrkdwn(SubBalanceInformation20 balBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation46 addAddtlBalBrkdwn(AdditionalBalanceInformation20 addtlBalBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation46 addBalAtSfkpgPlc(AggregateBalancePerSafekeepingPlace43 balAtSfkpgPlc) {
     ...
     * 
     */
    public AggregateBalanceInformation46 addSplmtryData(SupplementaryData1 splmtryData) {
