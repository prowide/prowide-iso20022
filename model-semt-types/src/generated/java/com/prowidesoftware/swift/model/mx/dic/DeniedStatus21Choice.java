...
@XmlType(name = "DeniedStatus21Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus21Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason16> rsn;
     ...
     *     
     */
    public DeniedStatus21Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason16> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason16>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus21Choice addRsn(DeniedReason16 rsn) {
        getRsn().add(rsn);
        return this;
    }
