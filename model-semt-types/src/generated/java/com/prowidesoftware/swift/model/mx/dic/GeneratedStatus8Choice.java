...
@XmlType(name = "GeneratedStatus8Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class GeneratedStatus8Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<GeneratedReason6> rsn;
     ...
     *     
     */
    public GeneratedStatus8Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<GeneratedReason6> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<GeneratedReason6>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public GeneratedStatus8Choice addRsn(GeneratedReason6 rsn) {
        getRsn().add(rsn);
        return this;
    }
