...
@XmlType(name = "AdditionalQueryParameters12", propOrder = {
    "sts",
    "rsn",
    "finInstrmId"
})
public class AdditionalQueryParameters12 {
    ...
    @XmlElement(name = "Rsn")
    protected List<Reason17Choice> rsn;
     ...
     *     
     */
    public AdditionalQueryParameters12 setSts(Status22Choice value) {
        this.sts = value;
        return this;
    }
     ...
     * 
     */
    public List<Reason17Choice> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<Reason17Choice>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AdditionalQueryParameters12 addRsn(Reason17Choice rsn) {
        getRsn().add(rsn);
        return this;
    }
     ...
     * 
     */
    public AdditionalQueryParameters12 addFinInstrmId(SecurityIdentification20 finInstrmId) {
