...
@XmlType(name = "SubAccountIdentification57", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "actvtyInd",
    "balForSubAcct"
})
public class SubAccountIdentification57 {
    ...
    protected List<AggregateBalanceInformation38> balForSubAcct;
     ...
     *     
     */
    public SubAccountIdentification57 setAcctOwnr(PartyIdentification156 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification57 setSfkpgAcct(SecuritiesAccount34 value) {
     ...
     * 
     */
    public SubAccountIdentification57 setActvtyInd(boolean value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation38> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation38>();
        }
     ...
     * 
     */
    public SubAccountIdentification57 addBalForSubAcct(AggregateBalanceInformation38 balForSubAcct) {
