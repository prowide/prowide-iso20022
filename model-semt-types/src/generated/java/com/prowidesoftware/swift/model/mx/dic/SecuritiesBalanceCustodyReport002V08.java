...
@XmlType(name = "SecuritiesBalanceCustodyReport002V08", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "acctSvcr",
...
public class SecuritiesBalanceCustodyReport002V08 {
    ...
    protected List<AggregateBalanceInformation28> balForAcct;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification40> subAcctDtls;
     ...
     *     
     */
    public SecuritiesBalanceCustodyReport002V08 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReport002V08 setStmtGnlDtls(Statement34 value) {
     ...
     *     
     */
    public SecuritiesBalanceCustodyReport002V08 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReport002V08 setAcctSvcr(PartyIdentification59Choice value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReport002V08 setSfkpgAcct(SecuritiesAccount15 value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation28> getBalForAcct() {
        if (balForAcct == null) {
            balForAcct = new ArrayList<AggregateBalanceInformation28>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification40 }
     * 
     * 
     */
    public List<SubAccountIdentification40> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification40>();
        }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReport002V08 setAcctBaseCcyTtlAmts(TotalValueInPageAndStatement3 value) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReport002V08 addIntrmyInf(Intermediary22 intrmyInf) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReport002V08 addBalForAcct(AggregateBalanceInformation28 balForAcct) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReport002V08 addSubAcctDtls(SubAccountIdentification40 subAcctDtls) {
