...
@XmlType(name = "SubBalanceInformation14", propOrder = {
    "subBalTp",
    "qty",
    "subBalAddtlDtls",
    "addtlBalBrkdwnDtls"
...
public class SubBalanceInformation14 {
    ...
    protected List<AdditionalBalanceInformation14> addtlBalBrkdwnDtls;
     ...
     *     
     */
    public SubBalanceInformation14 setSubBalTp(SubBalanceType11Choice value) {
        this.subBalTp = value;
        return this;
    }
     ...
     *     
     */
    public SubBalanceInformation14 setQty(SubBalanceQuantity6Choice value) {
        this.qty = value;
        return this;
    }
     ...
     *     
     */
    public SubBalanceInformation14 setSubBalAddtlDtls(String value) {
     ...
     * 
     */
    public List<AdditionalBalanceInformation14> getAddtlBalBrkdwnDtls() {
        if (addtlBalBrkdwnDtls == null) {
            addtlBalBrkdwnDtls = new ArrayList<AdditionalBalanceInformation14>();
        }
     ...
     * 
     */
    public SubBalanceInformation14 addAddtlBalBrkdwnDtls(AdditionalBalanceInformation14 addtlBalBrkdwnDtls) {
