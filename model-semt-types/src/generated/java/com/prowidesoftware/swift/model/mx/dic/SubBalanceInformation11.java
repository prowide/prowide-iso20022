...
@XmlType(name = "SubBalanceInformation11", propOrder = {
    "subBalTp",
    "qty",
    "subBalAddtlDtls",
    "qtyBrkdwn",
...
public class SubBalanceInformation11 {
    ...
    protected List<AdditionalBalanceInformation11> addtlBalBrkdwnDtls;
     ...
     *     
     */
    public SubBalanceInformation11 setSubBalTp(SubBalanceType5Choice value) {
        this.subBalTp = value;
        return this;
    }
     ...
     *     
     */
    public SubBalanceInformation11 setQty(SubBalanceQuantity3Choice value) {
        this.qty = value;
        return this;
    }
     ...
     *     
     */
    public SubBalanceInformation11 setSubBalAddtlDtls(String value) {
     ...
     * 
     */
    public List<AdditionalBalanceInformation11> getAddtlBalBrkdwnDtls() {
        if (addtlBalBrkdwnDtls == null) {
            addtlBalBrkdwnDtls = new ArrayList<AdditionalBalanceInformation11>();
        }
     ...
     * 
     */
    public SubBalanceInformation11 addQtyBrkdwn(QuantityBreakdown23 qtyBrkdwn) {
     ...
     * 
     */
    public SubBalanceInformation11 addAddtlBalBrkdwnDtls(AdditionalBalanceInformation11 addtlBalBrkdwnDtls) {
