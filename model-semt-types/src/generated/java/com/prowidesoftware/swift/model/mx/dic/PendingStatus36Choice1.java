...
@XmlType(name = "PendingStatus36Choice__1", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus36Choice1 {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingReason141> rsn;
     ...
     *     
     */
    public PendingStatus36Choice1 setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingReason141 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingReason141> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingStatus36Choice1 addRsn(PendingReason141 rsn) {
        getRsn().add(rsn);
        return this;
    }
