...
@XmlType(name = "SecuritiesBalanceCustodyReportV05", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "acctSvcr",
...
public class SecuritiesBalanceCustodyReportV05 {
    ...
    protected List<AggregateBalanceInformation16> balForAcct;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification22> subAcctDtls;
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV05 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV05 setStmtGnlDtls(Statement33 value) {
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV05 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV05 setAcctSvcr(PartyIdentification49Choice value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV05 setSfkpgAcct(SecuritiesAccount11 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalanceInformation16 }
     * 
     * 
     */
    public List<AggregateBalanceInformation16> getBalForAcct() {
        if (balForAcct == null) {
            balForAcct = new ArrayList<AggregateBalanceInformation16>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification22 }
     * 
     * 
     */
    public List<SubAccountIdentification22> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification22>();
        }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV05 setAcctBaseCcyTtlAmts(TotalValueInPageAndStatement1 value) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV05 addIntrmyInf(Intermediary21 intrmyInf) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV05 addBalForAcct(AggregateBalanceInformation16 balForAcct) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV05 addSubAcctDtls(SubAccountIdentification22 subAcctDtls) {
