...
@XmlType(name = "SecuritiesTransactionPostingReport002V04", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPostingReport002V04 {
    ...
    protected List<FinancialInstrumentDetails16> finInstrmDtls;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification33> subAcctDtls;
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V04 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V04 setStmtGnlDtls(Statement27 value) {
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V04 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPostingReport002V04 setSfkpgAcct(SecuritiesAccount17 value) {
     ...
     * {@link FinancialInstrumentDetails16 }
     * 
     * 
     */
    public List<FinancialInstrumentDetails16> getFinInstrmDtls() {
        if (finInstrmDtls == null) {
            finInstrmDtls = new ArrayList<FinancialInstrumentDetails16>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification33 }
     * 
     * 
     */
    public List<SubAccountIdentification33> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification33>();
        }
     ...
     * 
     */
    public SecuritiesTransactionPostingReport002V04 addFinInstrmDtls(FinancialInstrumentDetails16 finInstrmDtls) {
     ...
     * 
     */
    public SecuritiesTransactionPostingReport002V04 addSubAcctDtls(SubAccountIdentification33 subAcctDtls) {
