...
@XmlType(name = "PendingStatus79Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus79Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingReason34> rsn;
     ...
     *     
     */
    public PendingStatus79Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingReason34 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingReason34> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingStatus79Choice addRsn(PendingReason34 rsn) {
        getRsn().add(rsn);
        return this;
    }
