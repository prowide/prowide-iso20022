...
@XmlType(name = "SecuritiesBalanceAccountingReportV05", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "acctSvcr",
...
public class SecuritiesBalanceAccountingReportV05 {
    ...
    protected List<Intermediary21> intrmyInf;
    @XmlElement(name = "BalForAcct")
    protected List<AggregateBalanceInformation17> balForAcct;
    @XmlElement(name = "SubAcctDtls")
    protected List<SubAccountIdentification23> subAcctDtls;
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV05 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV05 setStmtGnlDtls(Statement20 value) {
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV05 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV05 setAcctSvcr(PartyIdentification49Choice value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV05 setSfkpgAcct(SecuritiesAccount11 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalanceInformation17 }
     * 
     * 
     */
    public List<AggregateBalanceInformation17> getBalForAcct() {
        if (balForAcct == null) {
            balForAcct = new ArrayList<AggregateBalanceInformation17>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubAccountIdentification23 }
     * 
     * 
     */
    public List<SubAccountIdentification23> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification23>();
        }
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV05 setAcctBaseCcyTtlAmts(TotalValueInPageAndStatement2 value) {
     ...
     *     
     */
    public SecuritiesBalanceAccountingReportV05 setAltrnRptgCcyTtlAmts(TotalValueInPageAndStatement2 value) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReportV05 addIntrmyInf(Intermediary21 intrmyInf) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReportV05 addBalForAcct(AggregateBalanceInformation17 balForAcct) {
     ...
     * 
     */
    public SecuritiesBalanceAccountingReportV05 addSubAcctDtls(SubAccountIdentification23 subAcctDtls) {
