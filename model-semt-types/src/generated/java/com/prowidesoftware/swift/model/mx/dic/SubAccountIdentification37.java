...
@XmlType(name = "SubAccountIdentification37", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "actvtyInd",
    "balForSubAcct"
})
public class SubAccountIdentification37 {
    ...
    protected List<AggregateBalanceInformation25> balForSubAcct;
     ...
     *     
     */
    public SubAccountIdentification37 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification37 setSfkpgAcct(SecuritiesAccount14 value) {
     ...
     * 
     */
    public SubAccountIdentification37 setActvtyInd(boolean value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation25> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation25>();
        }
     ...
     * 
     */
    public SubAccountIdentification37 addBalForSubAcct(AggregateBalanceInformation25 balForSubAcct) {
