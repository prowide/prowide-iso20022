...
@XmlType(name = "References20Choice", propOrder = {
    "sctiesSttlmTxConfId",
    "intraPosMvmntConfId",
    "sctiesBalAcctgRptId",
    "sctiesBalCtdyRptId",
...
public class References20Choice {
    ...
    protected SettlementTypeAndIdentification7 sctiesSttlmTxConfId;
    ...
    protected SettlementTypeAndIdentification7 sctiesFincgConfId;
    ...
    protected SettlementTypeAndIdentification7 sctiesSttlmTxAllgmtNtfctnTxId;
    @XmlElement(name = "PrtflTrfNtfctnId")
    protected String prtflTrfNtfctnId;
    @XmlElement(name = "SctiesSttlmTxGnrtnNtfctnId")
    protected SettlementTypeAndIdentification7 sctiesSttlmTxGnrtnNtfctnId;
     ...
     *     
     */
    public SettlementTypeAndIdentification7 getSctiesSttlmTxConfId() {
     ...
     *     
     */
    public References20Choice setSctiesSttlmTxConfId(SettlementTypeAndIdentification7 value) {
     ...
     *     
     */
    public References20Choice setIntraPosMvmntConfId(String value) {
     ...
     *     
     */
    public References20Choice setSctiesBalAcctgRptId(String value) {
     ...
     *     
     */
    public References20Choice setSctiesBalCtdyRptId(String value) {
     ...
     *     
     */
    public References20Choice setIntraPosMvmntPstngRptId(String value) {
     ...
     *     
     */
    public SettlementTypeAndIdentification7 getSctiesFincgConfId() {
     ...
     *     
     */
    public References20Choice setSctiesFincgConfId(SettlementTypeAndIdentification7 value) {
     ...
     *     
     */
    public References20Choice setSctiesTxPdgRptId(String value) {
     ...
     *     
     */
    public References20Choice setSctiesTxPstngRptId(String value) {
     ...
     *     
     */
    public References20Choice setSctiesSttlmTxAllgmtRptId(String value) {
     ...
     *     
     */
    public SettlementTypeAndIdentification7 getSctiesSttlmTxAllgmtNtfctnTxId() {
     ...
     *     
     */
    public References20Choice setSctiesSttlmTxAllgmtNtfctnTxId(SettlementTypeAndIdentification7 value) {
     ...
     *     
     */
    public References20Choice setPrtflTrfNtfctnId(String value) {
     ...
     *     
     */
    public SettlementTypeAndIdentification7 getSctiesSttlmTxGnrtnNtfctnId() {
     ...
     *     
     */
    public References20Choice setSctiesSttlmTxGnrtnNtfctnId(SettlementTypeAndIdentification7 value) {
     ...
     *     
     */
    public References20Choice setOthrMsgId(String value) {
