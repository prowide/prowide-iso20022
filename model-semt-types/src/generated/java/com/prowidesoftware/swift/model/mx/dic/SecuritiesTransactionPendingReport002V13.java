...
@XmlType(name = "SecuritiesTransactionPendingReport002V13", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPendingReport002V13 {
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V13 setPgntn(Pagination1 value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V13 setStmtGnlDtls(Statement70 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V13 setAcctOwnr(PartyIdentification156 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V13 setSfkpgAcct(SecuritiesAccount30 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V13 setBlckChainAdrOrWllt(BlockChainAddressWallet7 value) {
     ...
     * {@link StatusAndReason45 }
     * 
     * 
     */
    public List<StatusAndReason45> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason45>();
        }
        return this.sts;
    }
    ...
    public List<Transaction125> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction125>();
        }
        return this.txs;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V13 addSts(StatusAndReason45 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V13 addTxs(Transaction125 txs) {
        getTxs().add(txs);
        return this;
    }
