...
@XmlType(name = "AggregateBalanceInformation33", propOrder = {
    "finInstrmId",
    "finInstrmAttrbts",
...
public class AggregateBalanceInformation33 {
    ...
    protected List<AggregateBalancePerSafekeepingPlace31> balAtSfkpgPlc;
     ...
     *     
     */
    public AggregateBalanceInformation33 setFinInstrmId(SecurityIdentification20 value) {
     ...
     *     
     */
    public AggregateBalanceInformation33 setFinInstrmAttrbts(FinancialInstrumentAttributes78 value) {
     ...
     *     
     */
    public AggregateBalanceInformation33 setInvstmtFndsFinInstrmAttrbts(FinancialInstrument22 value) {
     ...
     *     
     */
    public AggregateBalanceInformation33 setValtnHrcutDtls(BasicCollateralValuation1Details value) {
     ...
     *     
     */
    public AggregateBalanceInformation33 setAggtBal(Balance10 value) {
        this.aggtBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation33 setAvlblBal(Balance12 value) {
        this.avlblBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation33 setNotAvlblBal(BalanceQuantity12Choice value) {
     ...
     *     
     */
    public AggregateBalanceInformation33 setSfkpgPlc(SafeKeepingPlace2 value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation33 setCorpActnOptnTp(CorporateActionOption5Code value) {
     ...
     * {@link PriceInformation14 }
     * 
     * 
     */
    public List<PriceInformation14> getPricDtls() {
        if (pricDtls == null) {
            pricDtls = new ArrayList<PriceInformation14>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ForeignExchangeTerms31 }
     * 
     * 
     */
    public List<ForeignExchangeTerms31> getFXDtls() {
        if (fxDtls == null) {
            fxDtls = new ArrayList<ForeignExchangeTerms31>();
        }
        return this.fxDtls;
    }
     ...
     *     
     */
    public AggregateBalanceInformation33 setDaysAcrd(BigDecimal value) {
        this.daysAcrd = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation33 setAcctBaseCcyAmts(BalanceAmounts4 value) {
     ...
     *     
     */
    public AggregateBalanceInformation33 setInstrmCcyAmts(BalanceAmounts4 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubBalanceInformation17 }
     * 
     * 
     */
    public List<SubBalanceInformation17> getBalBrkdwn() {
        if (balBrkdwn == null) {
            balBrkdwn = new ArrayList<SubBalanceInformation17>();
        }
    ...
    public List<AdditionalBalanceInformation17> getAddtlBalBrkdwn() {
        if (addtlBalBrkdwn == null) {
            addtlBalBrkdwn = new ArrayList<AdditionalBalanceInformation17>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalancePerSafekeepingPlace31 }
     * 
     * 
     */
    public List<AggregateBalancePerSafekeepingPlace31> getBalAtSfkpgPlc() {
        if (balAtSfkpgPlc == null) {
            balAtSfkpgPlc = new ArrayList<AggregateBalancePerSafekeepingPlace31>();
        }
     ...
     *     
     */
    public AggregateBalanceInformation33 setHldgAddtlDtls(String value) {
     ...
     * 
     */
    public AggregateBalanceInformation33 addPricDtls(PriceInformation14 pricDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation33 addFXDtls(ForeignExchangeTerms31 fXDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation33 addQtyBrkdwn(QuantityBreakdown40 qtyBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation33 addBalBrkdwn(SubBalanceInformation17 balBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation33 addAddtlBalBrkdwn(AdditionalBalanceInformation17 addtlBalBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation33 addBalAtSfkpgPlc(AggregateBalancePerSafekeepingPlace31 balAtSfkpgPlc) {
     ...
     * 
     */
    public AggregateBalanceInformation33 addSplmtryData(SupplementaryData1 splmtryData) {
