...
@XmlType(name = "SubAccountIdentification10", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "actvtyInd",
    "balForSubAcct"
})
public class SubAccountIdentification10 {
    ...
    protected List<AggregateBalanceInformation8> balForSubAcct;
     ...
     *     
     */
    public SubAccountIdentification10 setAcctOwnr(PartyIdentification13Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification10 setSfkpgAcct(SecuritiesAccount14 value) {
     ...
     * 
     */
    public SubAccountIdentification10 setActvtyInd(boolean value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation8> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation8>();
        }
     ...
     * 
     */
    public SubAccountIdentification10 addBalForSubAcct(AggregateBalanceInformation8 balForSubAcct) {
