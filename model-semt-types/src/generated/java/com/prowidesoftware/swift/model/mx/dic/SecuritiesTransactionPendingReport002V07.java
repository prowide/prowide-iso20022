...
@XmlType(name = "SecuritiesTransactionPendingReport002V07", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPendingReport002V07 {
    ...
    @XmlElement(name = "Sts")
    protected List<StatusAndReason30> sts;
    @XmlElement(name = "Txs")
    protected List<Transaction49> txs;
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V07 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V07 setStmtGnlDtls(Statement55 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V07 setAcctOwnr(PartyIdentification109 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReport002V07 setSfkpgAcct(SecuritiesAccount27 value) {
     ...
     * {@link StatusAndReason30 }
     * 
     * 
     */
    public List<StatusAndReason30> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason30>();
        }
        return this.sts;
    }
     ...
     * 
     */
    public List<Transaction49> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction49>();
        }
        return this.txs;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V07 addSts(StatusAndReason30 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReport002V07 addTxs(Transaction49 txs) {
        getTxs().add(txs);
        return this;
    }
