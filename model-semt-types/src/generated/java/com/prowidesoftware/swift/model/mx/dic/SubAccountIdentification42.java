...
@XmlType(name = "SubAccountIdentification42", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "actvtyInd",
    "balForSubAcct"
})
public class SubAccountIdentification42 {
    ...
    protected List<AggregateBalanceInformation30> balForSubAcct;
     ...
     *     
     */
    public SubAccountIdentification42 setAcctOwnr(PartyIdentification98 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification42 setSfkpgAcct(SecuritiesAccount25 value) {
     ...
     * 
     */
    public SubAccountIdentification42 setActvtyInd(boolean value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation30> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation30>();
        }
     ...
     * 
     */
    public SubAccountIdentification42 addBalForSubAcct(AggregateBalanceInformation30 balForSubAcct) {
