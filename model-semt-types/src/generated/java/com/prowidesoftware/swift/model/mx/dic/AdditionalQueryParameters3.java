...
@XmlType(name = "AdditionalQueryParameters3", propOrder = {
    "sts",
    "rsn",
    "finInstrmId"
})
public class AdditionalQueryParameters3 {
    ...
    @XmlElement(name = "Rsn")
    protected List<Reason6Choice> rsn;
     ...
     *     
     */
    public AdditionalQueryParameters3 setSts(Status8Choice value) {
        this.sts = value;
        return this;
    }
     ...
     * 
     */
    public List<Reason6Choice> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<Reason6Choice>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AdditionalQueryParameters3 addRsn(Reason6Choice rsn) {
        getRsn().add(rsn);
        return this;
    }
     ...
     * 
     */
    public AdditionalQueryParameters3 addFinInstrmId(SecurityIdentification14 finInstrmId) {
