...
public class RejectionOrRepairReason36 {
    ...
    public List<RejectionAndRepairReason36Choice> getCd() {
        if (cd == null) {
            cd = new ArrayList<RejectionAndRepairReason36Choice>();
        }
        return this.cd;
    }
     ...
     *     
     */
    public RejectionOrRepairReason36 setAddtlRsnInf(String value) {
     ...
     * 
     */
    public RejectionOrRepairReason36 addCd(RejectionAndRepairReason36Choice cd) {
        getCd().add(cd);
        return this;
    }
