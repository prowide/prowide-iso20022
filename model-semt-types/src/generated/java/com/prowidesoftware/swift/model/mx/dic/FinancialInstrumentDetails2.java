...
@XmlType(name = "FinancialInstrumentDetails2", propOrder = {
    "finInstrmId",
    "pricDtls",
    "sfkpgPlc",
    "opngBal",
...
public class FinancialInstrumentDetails2 {
    ...
    protected List<Transaction6> tx;
     ...
     *     
     */
    public FinancialInstrumentDetails2 setFinInstrmId(SecurityIdentification11 value) {
     ...
     *     
     */
    public FinancialInstrumentDetails2 setPricDtls(PriceInformation6 value) {
        this.pricDtls = value;
        return this;
    }
     ...
     *     
     */
    public FinancialInstrumentDetails2 setSfkpgPlc(SafekeepingPlaceFormat3Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public FinancialInstrumentDetails2 setOpngBal(OpeningBalance1 value) {
        this.opngBal = value;
        return this;
    }
     ...
     *     
     */
    public FinancialInstrumentDetails2 setClsgBal(ClosingBalance1 value) {
        this.clsgBal = value;
        return this;
    }
     ...
     * 
     */
    public List<Transaction6> getTx() {
        if (tx == null) {
            tx = new ArrayList<Transaction6>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public FinancialInstrumentDetails2 addTx(Transaction6 tx) {
        getTx().add(tx);
        return this;
    }
