...
@XmlType(name = "SecuritiesTransactionPendingReportV08", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPendingReportV08 {
    ...
    @XmlElement(name = "Sts")
    protected List<StatusAndReason32> sts;
    @XmlElement(name = "Txs")
    protected List<Transaction53> txs;
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV08 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV08 setStmtGnlDtls(Statement41 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV08 setAcctOwnr(PartyIdentification98 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV08 setSfkpgAcct(SecuritiesAccount24 value) {
     ...
     * {@link StatusAndReason32 }
     * 
     * 
     */
    public List<StatusAndReason32> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason32>();
        }
        return this.sts;
    }
     ...
     * 
     */
    public List<Transaction53> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction53>();
        }
        return this.txs;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReportV08 addSts(StatusAndReason32 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReportV08 addTxs(Transaction53 txs) {
        getTxs().add(txs);
        return this;
    }
