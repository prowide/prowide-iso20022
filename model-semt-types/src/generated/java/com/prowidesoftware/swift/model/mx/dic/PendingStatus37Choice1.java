...
@XmlType(name = "PendingStatus37Choice__1", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus37Choice1 {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingReason151> rsn;
     ...
     *     
     */
    public PendingStatus37Choice1 setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingReason151 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingReason151> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingStatus37Choice1 addRsn(PendingReason151 rsn) {
        getRsn().add(rsn);
        return this;
    }
