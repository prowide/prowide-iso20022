...
@XmlType(name = "AggregateBalanceInformation10", propOrder = {
    "finInstrmId",
    "finInstrmAttrbts",
...
public class AggregateBalanceInformation10 {
    ...
    protected List<AggregateBalancePerSafekeepingPlace9> balAtSfkpgPlc;
     ...
     *     
     */
    public AggregateBalanceInformation10 setFinInstrmId(SecurityIdentification12 value) {
     ...
     *     
     */
    public AggregateBalanceInformation10 setFinInstrmAttrbts(FinancialInstrumentAttributes14 value) {
     ...
     *     
     */
    public AggregateBalanceInformation10 setInvstmtFndsFinInstrmAttrbts(FinancialInstrument22 value) {
     ...
     *     
     */
    public AggregateBalanceInformation10 setValtnHrcutDtls(BasicCollateralValuation1Details value) {
     ...
     *     
     */
    public AggregateBalanceInformation10 setAggtBal(Balance2 value) {
        this.aggtBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation10 setAvlblBal(BalanceQuantity7Choice value) {
        this.avlblBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation10 setNotAvlblBal(BalanceQuantity7Choice value) {
     ...
     *     
     */
    public AggregateBalanceInformation10 setSfkpgPlc(SafekeepingPlaceFormat4Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation10 setCorpActnOptnTp(CorporateActionOption5Code value) {
     ...
     *     
     */
    public AggregateBalanceInformation10 setDaysAcrd(BigDecimal value) {
        this.daysAcrd = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation10 setAcctBaseCcyAmts(BalanceAmounts4 value) {
     ...
     *     
     */
    public AggregateBalanceInformation10 setInstrmCcyAmts(BalanceAmounts4 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalancePerSafekeepingPlace9 }
     * 
     * 
     */
    public List<AggregateBalancePerSafekeepingPlace9> getBalAtSfkpgPlc() {
        if (balAtSfkpgPlc == null) {
            balAtSfkpgPlc = new ArrayList<AggregateBalancePerSafekeepingPlace9>();
        }
     ...
     *     
     */
    public AggregateBalanceInformation10 setHldgAddtlDtls(String value) {
     ...
     * 
     */
    public AggregateBalanceInformation10 addPricDtls(PriceInformation7 pricDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation10 addFXDtls(ForeignExchangeTerms2 fXDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation10 addQtyBrkdwn(QuantityBreakdown7 qtyBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation10 addBalBrkdwn(SubBalanceInformation8 balBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation10 addAddtlBalBrkdwn(AdditionalBalanceInformation8 addtlBalBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation10 addBalAtSfkpgPlc(AggregateBalancePerSafekeepingPlace9 balAtSfkpgPlc) {
     ...
     * 
     */
    public AggregateBalanceInformation10 addXtnsn(Extension2 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
