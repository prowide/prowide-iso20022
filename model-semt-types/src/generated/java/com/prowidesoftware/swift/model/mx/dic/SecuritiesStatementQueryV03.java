...
@XmlType(name = "SecuritiesStatementQueryV03", propOrder = {
    "stmtReqd",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesStatementQueryV03 {
     ...
     *     
     */
    public SecuritiesStatementQueryV03 setStmtReqd(DocumentNumber1 value) {
        this.stmtReqd = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesStatementQueryV03 setStmtGnlDtls(Statement16 value) {
     ...
     *     
     */
    public SecuritiesStatementQueryV03 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesStatementQueryV03 setSfkpgAcct(SecuritiesAccount13 value) {
     ...
     * {@link AdditionalQueryParameters5 }
     * 
     * 
     */
    public List<AdditionalQueryParameters5> getAddtlQryParams() {
        if (addtlQryParams == null) {
            addtlQryParams = new ArrayList<AdditionalQueryParameters5>();
        }
     ...
     * 
     */
    public SecuritiesStatementQueryV03 addAddtlQryParams(AdditionalQueryParameters5 addtlQryParams) {
     ...
     * 
     */
    public SecuritiesStatementQueryV03 addSplmtryData(SupplementaryData1 splmtryData) {
