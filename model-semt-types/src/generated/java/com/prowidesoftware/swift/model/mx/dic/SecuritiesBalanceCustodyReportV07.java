...
@XmlType(name = "SecuritiesBalanceCustodyReportV07", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "acctSvcr",
...
public class SecuritiesBalanceCustodyReportV07 {
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV07 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV07 setStmtGnlDtls(Statement33 value) {
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV07 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV07 setAcctSvcr(PartyIdentification49Choice value) {
        this.acctSvcr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV07 setSfkpgAcct(SecuritiesAccount11 value) {
    ...
    public List<AggregateBalanceInformation21> getBalForAcct() {
        if (balForAcct == null) {
            balForAcct = new ArrayList<AggregateBalanceInformation21>();
        }
    ...
    public List<SubAccountIdentification28> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification28>();
        }
     ...
     *     
     */
    public SecuritiesBalanceCustodyReportV07 setAcctBaseCcyTtlAmts(TotalValueInPageAndStatement1 value) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV07 addIntrmyInf(Intermediary23 intrmyInf) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV07 addBalForAcct(AggregateBalanceInformation21 balForAcct) {
     ...
     * 
     */
    public SecuritiesBalanceCustodyReportV07 addSubAcctDtls(SubAccountIdentification28 subAcctDtls) {
