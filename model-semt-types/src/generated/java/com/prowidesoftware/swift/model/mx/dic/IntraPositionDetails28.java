...
@XmlType(name = "IntraPositionDetails28", propOrder = {
    "sfkpgPlc",
    "balFr",
    "intraPosMvmnt"
})
public class IntraPositionDetails28 {
    ...
    protected List<IntraPositionMovementDetails9> intraPosMvmnt;
     ...
     *     
     */
    public IntraPositionDetails28 setSfkpgPlc(SafekeepingPlaceFormat3Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public IntraPositionDetails28 setBalFr(SecuritiesBalanceType3Choice value) {
        this.balFr = value;
        return this;
    }
     ...
     * {@link IntraPositionMovementDetails9 }
     * 
     * 
     */
    public List<IntraPositionMovementDetails9> getIntraPosMvmnt() {
        if (intraPosMvmnt == null) {
            intraPosMvmnt = new ArrayList<IntraPositionMovementDetails9>();
        }
     ...
     * 
     */
    public IntraPositionDetails28 addIntraPosMvmnt(IntraPositionMovementDetails9 intraPosMvmnt) {
