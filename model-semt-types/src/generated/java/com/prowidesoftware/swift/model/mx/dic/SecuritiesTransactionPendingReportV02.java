...
@XmlType(name = "SecuritiesTransactionPendingReportV02", propOrder = {
    "pgntn",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesTransactionPendingReportV02 {
    ...
    @XmlElement(name = "Sts")
    protected List<StatusAndReason7> sts;
    @XmlElement(name = "Txs")
    protected List<Transaction12> txs;
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV02 setPgntn(Pagination value) {
        this.pgntn = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV02 setStmtGnlDtls(Statement14 value) {
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV02 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesTransactionPendingReportV02 setSfkpgAcct(SecuritiesAccount13 value) {
     ...
     * {@link StatusAndReason7 }
     * 
     * 
     */
    public List<StatusAndReason7> getSts() {
        if (sts == null) {
            sts = new ArrayList<StatusAndReason7>();
        }
        return this.sts;
    }
     ...
     * 
     */
    public List<Transaction12> getTxs() {
        if (txs == null) {
            txs = new ArrayList<Transaction12>();
        }
        return this.txs;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReportV02 addSts(StatusAndReason7 sts) {
        getSts().add(sts);
        return this;
    }
     ...
     * 
     */
    public SecuritiesTransactionPendingReportV02 addTxs(Transaction12 txs) {
        getTxs().add(txs);
        return this;
    }
