...
@XmlType(name = "AdditionalQueryParameters9", propOrder = {
    "sts",
    "rsn",
    "finInstrmId"
})
public class AdditionalQueryParameters9 {
    ...
    @XmlElement(name = "Rsn")
    protected List<Reason14Choice> rsn;
     ...
     *     
     */
    public AdditionalQueryParameters9 setSts(Status8Choice value) {
        this.sts = value;
        return this;
    }
     ...
     * 
     */
    public List<Reason14Choice> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<Reason14Choice>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AdditionalQueryParameters9 addRsn(Reason14Choice rsn) {
        getRsn().add(rsn);
        return this;
    }
     ...
     * 
     */
    public AdditionalQueryParameters9 addFinInstrmId(SecurityIdentification14 finInstrmId) {
