...
@XmlType(name = "IntraPositionDetails18", propOrder = {
    "sfkpgPlc",
    "balFr",
    "intraPosMvmnt"
})
public class IntraPositionDetails18 {
    ...
    protected List<IntraPositionMovementDetails6> intraPosMvmnt;
     ...
     *     
     */
    public IntraPositionDetails18 setSfkpgPlc(SafekeepingPlaceFormat4Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public IntraPositionDetails18 setBalFr(SecuritiesBalanceType5Choice value) {
        this.balFr = value;
        return this;
    }
     ...
     * {@link IntraPositionMovementDetails6 }
     * 
     * 
     */
    public List<IntraPositionMovementDetails6> getIntraPosMvmnt() {
        if (intraPosMvmnt == null) {
            intraPosMvmnt = new ArrayList<IntraPositionMovementDetails6>();
        }
     ...
     * 
     */
    public IntraPositionDetails18 addIntraPosMvmnt(IntraPositionMovementDetails6 intraPosMvmnt) {
