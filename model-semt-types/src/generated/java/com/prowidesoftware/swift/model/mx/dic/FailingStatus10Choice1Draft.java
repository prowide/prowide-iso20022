...
@XmlType(name = "FailingStatus10Choice__1", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class FailingStatus10Choice1Draft {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<FailingReason81> rsn;
     ...
     *     
     */
    public FailingStatus10Choice1Draft setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link FailingReason81 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<FailingReason81> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public FailingStatus10Choice1Draft addRsn(FailingReason81 rsn) {
        getRsn().add(rsn);
        return this;
    }
