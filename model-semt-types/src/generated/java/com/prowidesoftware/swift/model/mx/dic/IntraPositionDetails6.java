...
@XmlType(name = "IntraPositionDetails6", propOrder = {
    "sfkpgPlc",
    "balFr",
    "intraPosMvmnt"
})
public class IntraPositionDetails6 {
    ...
    protected List<IntraPositionMovementDetails2> intraPosMvmnt;
     ...
     *     
     */
    public IntraPositionDetails6 setSfkpgPlc(SafekeepingPlaceFormat4Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public IntraPositionDetails6 setBalFr(SecuritiesBalanceType5Choice value) {
        this.balFr = value;
        return this;
    }
     ...
     * {@link IntraPositionMovementDetails2 }
     * 
     * 
     */
    public List<IntraPositionMovementDetails2> getIntraPosMvmnt() {
        if (intraPosMvmnt == null) {
            intraPosMvmnt = new ArrayList<IntraPositionMovementDetails2>();
        }
     ...
     * 
     */
    public IntraPositionDetails6 addIntraPosMvmnt(IntraPositionMovementDetails2 intraPosMvmnt) {
