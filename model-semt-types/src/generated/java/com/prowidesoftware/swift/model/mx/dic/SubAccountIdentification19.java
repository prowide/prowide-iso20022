...
@XmlType(name = "SubAccountIdentification19", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "actvtyInd",
    "balForSubAcct"
...
public class SubAccountIdentification19 {
    ...
    protected List<AggregateBalanceInformation14> balForSubAcct;
     ...
     *     
     */
    public SubAccountIdentification19 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification19 setSfkpgAcct(SecuritiesAccount16 value) {
     ...
     * 
     */
    public SubAccountIdentification19 setActvtyInd(boolean value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation14> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation14>();
        }
     ...
     * 
     */
    public SubAccountIdentification19 addBalForSubAcct(AggregateBalanceInformation14 balForSubAcct) {
