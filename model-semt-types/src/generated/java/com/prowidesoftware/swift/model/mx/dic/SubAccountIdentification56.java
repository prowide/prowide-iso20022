...
@XmlType(name = "SubAccountIdentification56", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "actvtyInd",
    "balForSubAcct"
})
public class SubAccountIdentification56 {
    ...
    protected List<AggregateBalanceInformation37> balForSubAcct;
     ...
     *     
     */
    public SubAccountIdentification56 setAcctOwnr(PartyIdentification144 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification56 setSfkpgAcct(SecuritiesAccount25 value) {
     ...
     * 
     */
    public SubAccountIdentification56 setActvtyInd(boolean value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation37> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation37>();
        }
     ...
     * 
     */
    public SubAccountIdentification56 addBalForSubAcct(AggregateBalanceInformation37 balForSubAcct) {
