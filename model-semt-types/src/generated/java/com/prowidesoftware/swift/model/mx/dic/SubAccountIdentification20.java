...
@XmlType(name = "SubAccountIdentification20", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "actvtyInd",
    "balForSubAcct"
})
public class SubAccountIdentification20 {
    ...
    protected List<AggregateBalanceInformation15> balForSubAcct;
     ...
     *     
     */
    public SubAccountIdentification20 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification20 setSfkpgAcct(SecuritiesAccount16 value) {
     ...
     * 
     */
    public SubAccountIdentification20 setActvtyInd(boolean value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation15> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation15>();
        }
     ...
     * 
     */
    public SubAccountIdentification20 addBalForSubAcct(AggregateBalanceInformation15 balForSubAcct) {
