...
public class SecuritiesSubBalanceTypeAndQuantityBreakdown5 {
     ...
     *     
     */
    public SecuritiesSubBalanceTypeAndQuantityBreakdown5 setTp(SecuritiesBalanceType6Choice value) {
        this.tp = value;
        return this;
    }
    ...
    public List<QuantityBreakdown61> getQtyBrkdwn() {
        if (qtyBrkdwn == null) {
            qtyBrkdwn = new ArrayList<QuantityBreakdown61>();
        }
     ...
     * 
     */
    public SecuritiesSubBalanceTypeAndQuantityBreakdown5 addQtyBrkdwn(QuantityBreakdown61 qtyBrkdwn) {
