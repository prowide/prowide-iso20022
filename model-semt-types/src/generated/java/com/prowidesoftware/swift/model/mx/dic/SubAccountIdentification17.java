...
@XmlType(name = "SubAccountIdentification17", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "actvtyInd",
    "balForSubAcct"
...
public class SubAccountIdentification17 {
    ...
    protected List<AggregateBalanceInformation12> balForSubAcct;
     ...
     *     
     */
    public SubAccountIdentification17 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification17 setSfkpgAcct(SecuritiesAccount14 value) {
     ...
     * 
     */
    public SubAccountIdentification17 setActvtyInd(boolean value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation12> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation12>();
        }
     ...
     * 
     */
    public SubAccountIdentification17 addBalForSubAcct(AggregateBalanceInformation12 balForSubAcct) {
