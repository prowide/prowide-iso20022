...
@XmlType(name = "AdditionalQueryParameters11", propOrder = {
    "sts",
    "rsn",
    "finInstrmId"
})
public class AdditionalQueryParameters11 {
    ...
    @XmlElement(name = "Rsn")
    protected List<Reason16Choice> rsn;
     ...
     *     
     */
    public AdditionalQueryParameters11 setSts(Status19Choice value) {
        this.sts = value;
        return this;
    }
     ...
     * 
     */
    public List<Reason16Choice> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<Reason16Choice>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AdditionalQueryParameters11 addRsn(Reason16Choice rsn) {
        getRsn().add(rsn);
        return this;
    }
     ...
     * 
     */
    public AdditionalQueryParameters11 addFinInstrmId(SecurityIdentification19 finInstrmId) {
