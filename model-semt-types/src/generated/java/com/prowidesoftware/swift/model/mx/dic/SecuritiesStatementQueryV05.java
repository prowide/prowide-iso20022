...
@XmlType(name = "SecuritiesStatementQueryV05", propOrder = {
    "stmtReqd",
    "stmtGnlDtls",
    "acctOwnr",
    "sfkpgAcct",
...
public class SecuritiesStatementQueryV05 {
    ...
    protected List<AdditionalQueryParameters9> addtlQryParams;
     ...
     *     
     */
    public SecuritiesStatementQueryV05 setStmtReqd(DocumentNumber1 value) {
        this.stmtReqd = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesStatementQueryV05 setStmtGnlDtls(Statement16 value) {
     ...
     *     
     */
    public SecuritiesStatementQueryV05 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesStatementQueryV05 setSfkpgAcct(SecuritiesAccount13 value) {
     ...
     * {@link AdditionalQueryParameters9 }
     * 
     * 
     */
    public List<AdditionalQueryParameters9> getAddtlQryParams() {
        if (addtlQryParams == null) {
            addtlQryParams = new ArrayList<AdditionalQueryParameters9>();
        }
     ...
     * 
     */
    public SecuritiesStatementQueryV05 addAddtlQryParams(AdditionalQueryParameters9 addtlQryParams) {
     ...
     * 
     */
    public SecuritiesStatementQueryV05 addSplmtryData(SupplementaryData1 splmtryData) {
