...
@XmlType(name = "IntraPositionQueryCriteria8", propOrder = {
    "refs",
    "sts",
    "finInstrmId",
    "sfkpgAcctOwnr",
...
public class IntraPositionQueryCriteria8 {

    @XmlElement(name = "Refs")
    protected List<References82Choice> refs;
    @XmlElement(name = "Sts")
    protected IntraPositionQueryStatus3 sts;
    @XmlElement(name = "FinInstrmId")
    protected List<SecurityIdentification19> finInstrmId;
    @XmlElement(name = "SfkpgAcctOwnr")
    protected List<SystemPartyIdentification8> sfkpgAcctOwnr;
    @XmlElement(name = "SfkpgAcct")
    protected List<SecuritiesAccount19> sfkpgAcct;
    @XmlElement(name = "BalTp")
    protected List<IntraPositionType2> balTp;
    @XmlElement(name = "SctiesSubBalId")
    protected List<GenericIdentification37> sctiesSubBalId;
     ...
     * {@link References82Choice }
     * 
     * 
     * @return
     *     The value of the refs property.
     */
    public List<References82Choice> getRefs() {
        if (refs == null) {
            refs = new ArrayList<>();
        }
        return this.refs;
     ...
     * @return
     *     possible object is
     *     {@link IntraPositionQueryStatus3 }
     *     
     */
    public IntraPositionQueryStatus3 getSts() {
        return sts;
    }
     ...
     *     
     */
    public IntraPositionQueryCriteria8 setSts(IntraPositionQueryStatus3 value) {
        this.sts = value;
        return this;
    }
     ...
     */
    public List<SystemPartyIdentification8> getSfkpgAcctOwnr() {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link IntraPositionType2 }
     * 
     * 
     * @return
     *     The value of the balTp property.
     */
    public List<IntraPositionType2> getBalTp() {
        if (balTp == null) {
            balTp = new ArrayList<>();
        }
        return this.balTp;
     ...
     */
    public List<GenericIdentification37> getSctiesSubBalId() {
     ...
     *     
     */
    public IntraPositionQueryCriteria8 setSttlmQty(QuantitySearch2Choice value) {
        this.sttlmQty = value;
        return this;
    }
     ...
     *     
     */
    public IntraPositionQueryCriteria8 setSttldQty(QuantitySearch2Choice value) {
        this.sttldQty = value;
        return this;
    }
     ...
     *     
     */
    public IntraPositionQueryCriteria8 setIntnddSttlmDt(DateAndDateTimeSearch5Choice value) {
     ...
     *     
     */
    public IntraPositionQueryCriteria8 setFctvSttlmDt(DateAndDateTimeSearch5Choice value) {
     ...
     *     
     */
    public IntraPositionQueryCriteria8 setCreDtTm(DateAndDateTimeSearch5Choice value) {
        this.creDtTm = value;
        return this;
    }
     ...
     * 
     */
    public IntraPositionQueryCriteria8 addRefs(References82Choice refs) {
        getRefs().add(refs);
        return this;
    }
     ...
     * 
     */
    public IntraPositionQueryCriteria8 addFinInstrmId(SecurityIdentification19 finInstrmId) {
     ...
     * 
     */
    public IntraPositionQueryCriteria8 addSfkpgAcctOwnr(SystemPartyIdentification8 sfkpgAcctOwnr) {
     ...
     * 
     */
    public IntraPositionQueryCriteria8 addSfkpgAcct(SecuritiesAccount19 sfkpgAcct) {
     ...
     * 
     */
    public IntraPositionQueryCriteria8 addBalTp(IntraPositionType2 balTp) {
        getBalTp().add(balTp);
        return this;
    }
     ...
     * 
     */
    public IntraPositionQueryCriteria8 addSctiesSubBalId(GenericIdentification37 sctiesSubBalId) {
     ...
     * 
     */
    public IntraPositionQueryCriteria8 addPrty(PriorityNumeric4Choice prty) {
        getPrty().add(prty);
        return this;
    }
     ...
     * 
     */
    public IntraPositionQueryCriteria8 addCtryOfIsse(String ctryOfIsse) {
     ...
     * 
     */
    public IntraPositionQueryCriteria8 addMsgOrgtr(SystemPartyIdentification8 msgOrgtr) {
