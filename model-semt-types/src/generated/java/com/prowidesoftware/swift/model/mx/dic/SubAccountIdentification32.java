...
@XmlType(name = "SubAccountIdentification32", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "actvtyInd",
    "balForSubAcct"
...
public class SubAccountIdentification32 {
    ...
    protected List<AggregateBalanceInformation24> balForSubAcct;
     ...
     *     
     */
    public SubAccountIdentification32 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SubAccountIdentification32 setSfkpgAcct(SecuritiesAccount16 value) {
     ...
     * 
     */
    public SubAccountIdentification32 setActvtyInd(boolean value) {
     ...
     * 
     */
    public List<AggregateBalanceInformation24> getBalForSubAcct() {
        if (balForSubAcct == null) {
            balForSubAcct = new ArrayList<AggregateBalanceInformation24>();
        }
     ...
     * 
     */
    public SubAccountIdentification32 addBalForSubAcct(AggregateBalanceInformation24 balForSubAcct) {
