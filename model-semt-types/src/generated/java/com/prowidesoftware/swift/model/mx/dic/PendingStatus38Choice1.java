...
@XmlType(name = "PendingStatus38Choice__1", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus38Choice1 {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingReason161> rsn;
     ...
     *     
     */
    public PendingStatus38Choice1 setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingReason161 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingReason161> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingStatus38Choice1 addRsn(PendingReason161 rsn) {
        getRsn().add(rsn);
        return this;
    }
