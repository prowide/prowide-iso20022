...
@XmlType(name = "GeneratedStatus5Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class GeneratedStatus5Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<GeneratedReason3> rsn;
     ...
     *     
     */
    public GeneratedStatus5Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<GeneratedReason3> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<GeneratedReason3>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public GeneratedStatus5Choice addRsn(GeneratedReason3 rsn) {
        getRsn().add(rsn);
        return this;
    }
