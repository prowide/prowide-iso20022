...
public class SecuritiesTransactionPostingReportV10 {
    ...
    protected List<SubAccountIdentification60> subAcctDtls;
     ...
     * 
     */
    public List<SubAccountIdentification60> getSubAcctDtls() {
        if (subAcctDtls == null) {
            subAcctDtls = new ArrayList<SubAccountIdentification60>();
        }
