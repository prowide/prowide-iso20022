...
@XmlType(name = "PendingStatusAndReason4", propOrder = {
    "prcgSts",
    "sttlmSts"
})
public class PendingStatusAndReason4 {

    @XmlElement(name = "PrcgSts")
    protected List<ProcessingStatus100Choice> prcgSts;
     ...
     * {@link ProcessingStatus100Choice }
     * 
     * 
     * @return
     *     The value of the prcgSts property.
     */
    public List<ProcessingStatus100Choice> getPrcgSts() {
        if (prcgSts == null) {
     ...
     * 
     */
    public PendingStatusAndReason4 addPrcgSts(ProcessingStatus100Choice prcgSts) {
     ...
     * 
     */
    public PendingStatusAndReason4 addSttlmSts(SettlementStatus34Choice sttlmSts) {
