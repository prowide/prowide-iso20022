...
@XmlType(name = "AggregateBalanceInformation11", propOrder = {
    "finInstrmId",
    "finInstrmAttrbts",
...
public class AggregateBalanceInformation11 {
    ...
    protected List<ForeignExchangeTerms2> fxDtls;
    ...
    protected List<QuantityBreakdown8> qtyBrkdwn;
    ...
    protected List<AggregateBalancePerSafekeepingPlace10> balAtSfkpgPlc;
     ...
     *     
     */
    public AggregateBalanceInformation11 setFinInstrmId(SecurityIdentification12 value) {
     ...
     *     
     */
    public AggregateBalanceInformation11 setFinInstrmAttrbts(FinancialInstrumentAttributes14 value) {
     ...
     *     
     */
    public AggregateBalanceInformation11 setInvstmtFndsFinInstrmAttrbts(FinancialInstrument22 value) {
     ...
     *     
     */
    public AggregateBalanceInformation11 setAddtlDerivAttrbts(DerivativeBasicAttributes2 value) {
     ...
     *     
     */
    public AggregateBalanceInformation11 setAggtBal(Balance2 value) {
        this.aggtBal = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation11 setSfkpgPlc(SafekeepingPlaceFormat4Choice value) {
        this.sfkpgPlc = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation11 setCorpActnOptnTp(CorporateActionOption5Code value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ForeignExchangeTerms2 }
     * 
     * 
     */
    public List<ForeignExchangeTerms2> getFXDtls() {
        if (fxDtls == null) {
            fxDtls = new ArrayList<ForeignExchangeTerms2>();
        }
        return this.fxDtls;
    }
     ...
     *     
     */
    public AggregateBalanceInformation11 setDaysAcrd(BigDecimal value) {
        this.daysAcrd = value;
        return this;
    }
     ...
     *     
     */
    public AggregateBalanceInformation11 setAcctBaseCcyAmts(BalanceAmounts5 value) {
     ...
     *     
     */
    public AggregateBalanceInformation11 setInstrmCcyAmts(BalanceAmounts5 value) {
     ...
     *     
     */
    public AggregateBalanceInformation11 setAltrnRptgCcyAmts(BalanceAmounts5 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link QuantityBreakdown8 }
     * 
     * 
     */
    public List<QuantityBreakdown8> getQtyBrkdwn() {
        if (qtyBrkdwn == null) {
            qtyBrkdwn = new ArrayList<QuantityBreakdown8>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregateBalancePerSafekeepingPlace10 }
     * 
     * 
     */
    public List<AggregateBalancePerSafekeepingPlace10> getBalAtSfkpgPlc() {
        if (balAtSfkpgPlc == null) {
            balAtSfkpgPlc = new ArrayList<AggregateBalancePerSafekeepingPlace10>();
        }
     ...
     *     
     */
    public AggregateBalanceInformation11 setHldgAddtlDtls(String value) {
     ...
     * 
     */
    public AggregateBalanceInformation11 addPricDtls(PriceInformation7 pricDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation11 addFXDtls(ForeignExchangeTerms2 fXDtls) {
     ...
     * 
     */
    public AggregateBalanceInformation11 addQtyBrkdwn(QuantityBreakdown8 qtyBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation11 addBalBrkdwn(SubBalanceInformation7 balBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation11 addAddtlBalBrkdwn(AdditionalBalanceInformation7 addtlBalBrkdwn) {
     ...
     * 
     */
    public AggregateBalanceInformation11 addBalAtSfkpgPlc(AggregateBalancePerSafekeepingPlace10 balAtSfkpgPlc) {
     ...
     * 
     */
    public AggregateBalanceInformation11 addXtnsn(Extension2 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
