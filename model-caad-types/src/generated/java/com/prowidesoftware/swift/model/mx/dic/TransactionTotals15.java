...
@XmlType(name = "TransactionTotals15", propOrder = {
    "id",
    "dt",
    "chckptRef",
    "fin",
...
public class TransactionTotals15 {
    ...
    @XmlElement(name = "Fin")
    protected List<FinancialReconciliation4> fin;
    @XmlElement(name = "Msg")
    protected List<MessageReconciliation4> msg;
    @XmlElement(name = "AddtlFeeRcncltn")
    protected List<AdditionalFeeReconciliation4> addtlFeeRcncltn;
     ...
     *     
     */
    public TransactionTotals15 setId(String value) {
        this.id = value;
        return this;
    }
     ...
     *     
     */
    public TransactionTotals15 setDt(LocalDate value) {
        this.dt = value;
        return this;
    }
     ...
     *     
     */
    public TransactionTotals15 setChckptRef(String value) {
     ...
     * {@link FinancialReconciliation4 }
     * 
     * 
     * @return
     *     The value of the fin property.
     */
    public List<FinancialReconciliation4> getFin() {
        if (fin == null) {
            fin = new ArrayList<>();
        }
        return this.fin;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MessageReconciliation4 }
     * 
     * 
     * @return
     *     The value of the msg property.
     */
    public List<MessageReconciliation4> getMsg() {
        if (msg == null) {
            msg = new ArrayList<>();
        }
        return this.msg;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AdditionalFeeReconciliation4 }
     * 
     * 
     * @return
     *     The value of the addtlFeeRcncltn property.
     */
    public List<AdditionalFeeReconciliation4> getAddtlFeeRcncltn() {
     ...
     *     
     */
    public TransactionTotals15 setCcy(String value) {
        this.ccy = value;
        return this;
    }
     ...
     *     
     */
    public TransactionTotals15 setAmt(BigDecimal value) {
        this.amt = value;
        return this;
    }
     ...
     *     
     */
    public TransactionTotals15 setCdtDbt(CreditDebit3Code value) {
        this.cdtDbt = value;
        return this;
    }
     ...
     * 
     */
    public TransactionTotals15 addFin(FinancialReconciliation4 fin) {
        getFin().add(fin);
        return this;
    }
     ...
     * 
     */
    public TransactionTotals15 addMsg(MessageReconciliation4 msg) {
        getMsg().add(msg);
        return this;
    }
     ...
     * 
     */
    public TransactionTotals15 addAddtlFeeRcncltn(AdditionalFeeReconciliation4 addtlFeeRcncltn) {
