    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsrv.015.001.01";
    ...
    public static MxTsrv01500101 parse(String xml) {
        return ((MxTsrv01500101) MxReadImpl.parse(MxTsrv01500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv01500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv01500101) MxReadImpl.parse(MxTsrv01500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsrv01500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsrv01500101 .class);
    }
