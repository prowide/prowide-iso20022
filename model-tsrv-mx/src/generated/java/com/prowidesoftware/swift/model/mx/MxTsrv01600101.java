    ...
    extends AbstractMX
{
    ...
    public static MxTsrv01600101 parse(String xml) {
        return ((MxTsrv01600101) MxReadImpl.parse(MxTsrv01600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv01600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv01600101) MxReadImpl.parse(MxTsrv01600101 .class, xml, _classes, new MxReadParams(conf)));
    }
