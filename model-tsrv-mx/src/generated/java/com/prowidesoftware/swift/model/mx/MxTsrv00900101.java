    ...
    extends AbstractMX
{
    ...
    public static MxTsrv00900101 parse(String xml) {
        return ((MxTsrv00900101) MxReadImpl.parse(MxTsrv00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv00900101) MxReadImpl.parse(MxTsrv00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsrv00900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsrv00900101 .class);
    }
