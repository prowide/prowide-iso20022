    ...
    extends AbstractMX
{
    ...
    public static MxTsrv01400101 parse(String xml) {
        return ((MxTsrv01400101) MxReadImpl.parse(MxTsrv01400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv01400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv01400101) MxReadImpl.parse(MxTsrv01400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsrv01400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsrv01400101 .class);
    }
