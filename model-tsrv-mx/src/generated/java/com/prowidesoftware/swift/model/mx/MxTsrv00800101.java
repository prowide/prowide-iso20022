    ...
    extends AbstractMX
{
    ...
    public static MxTsrv00800101 parse(String xml) {
        return ((MxTsrv00800101) MxReadImpl.parse(MxTsrv00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv00800101) MxReadImpl.parse(MxTsrv00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
