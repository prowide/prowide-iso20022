    ...
    extends AbstractMX
{
    ...
    public static MxTsrv01200101 parse(String xml) {
        return ((MxTsrv01200101) MxReadImpl.parse(MxTsrv01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv01200101) MxReadImpl.parse(MxTsrv01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
