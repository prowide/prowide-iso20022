    ...
    extends AbstractMX
{
    ...
    public static MxTsrv01800101 parse(String xml) {
        return ((MxTsrv01800101) MxReadImpl.parse(MxTsrv01800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv01800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv01800101) MxReadImpl.parse(MxTsrv01800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsrv01800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsrv01800101 .class);
    }
