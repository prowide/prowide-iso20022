    ...
    extends AbstractMX
{
    ...
    public static MxTsrv00400101 parse(String xml) {
        return ((MxTsrv00400101) MxReadImpl.parse(MxTsrv00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv00400101) MxReadImpl.parse(MxTsrv00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsrv00400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsrv00400101 .class);
    }
