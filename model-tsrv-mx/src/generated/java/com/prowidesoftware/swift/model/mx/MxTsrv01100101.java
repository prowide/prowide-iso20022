    ...
    extends AbstractMX
{
    ...
    public static MxTsrv01100101 parse(String xml) {
        return ((MxTsrv01100101) MxReadImpl.parse(MxTsrv01100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv01100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv01100101) MxReadImpl.parse(MxTsrv01100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsrv01100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsrv01100101 .class);
    }
