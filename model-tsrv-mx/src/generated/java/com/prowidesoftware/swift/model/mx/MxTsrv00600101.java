    ...
    extends AbstractMX
{
    ...
    public static MxTsrv00600101 parse(String xml) {
        return ((MxTsrv00600101) MxReadImpl.parse(MxTsrv00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv00600101) MxReadImpl.parse(MxTsrv00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsrv00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsrv00600101 .class);
    }
