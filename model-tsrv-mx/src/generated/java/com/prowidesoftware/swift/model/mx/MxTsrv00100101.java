    ...
    extends AbstractMX
{
    ...
    public static MxTsrv00100101 parse(String xml) {
        return ((MxTsrv00100101) MxReadImpl.parse(MxTsrv00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv00100101) MxReadImpl.parse(MxTsrv00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
