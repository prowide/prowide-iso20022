    ...
    extends AbstractMX
{
    ...
    public static MxTsrv00300101 parse(String xml) {
        return ((MxTsrv00300101) MxReadImpl.parse(MxTsrv00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv00300101) MxReadImpl.parse(MxTsrv00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
