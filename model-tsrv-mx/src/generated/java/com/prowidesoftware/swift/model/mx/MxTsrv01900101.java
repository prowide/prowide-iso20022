    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:tsrv.019.001.01";
    ...
    public static MxTsrv01900101 parse(String xml) {
        return ((MxTsrv01900101) MxReadImpl.parse(MxTsrv01900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv01900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv01900101) MxReadImpl.parse(MxTsrv01900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTsrv01900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsrv01900101 .class);
    }
