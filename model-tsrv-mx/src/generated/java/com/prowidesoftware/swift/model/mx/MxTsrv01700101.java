    ...
    extends AbstractMX
{
    ...
    public static MxTsrv01700101 parse(String xml) {
        return ((MxTsrv01700101) MxReadImpl.parse(MxTsrv01700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv01700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv01700101) MxReadImpl.parse(MxTsrv01700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsrv01700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsrv01700101 .class);
    }
