    ...
    extends AbstractMX
{
    ...
    public static MxTsrv01000101 parse(String xml) {
        return ((MxTsrv01000101) MxReadImpl.parse(MxTsrv01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTsrv01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTsrv01000101) MxReadImpl.parse(MxTsrv01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTsrv01000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTsrv01000101 .class);
    }
