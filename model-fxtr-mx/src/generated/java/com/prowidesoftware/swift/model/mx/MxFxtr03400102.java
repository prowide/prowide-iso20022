    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.02";
    ...
    public static MxFxtr03400102 parse(String xml) {
        return ((MxFxtr03400102) MxReadImpl.parse(MxFxtr03400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03400102) MxReadImpl.parse(MxFxtr03400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr03400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03400102 .class);
    }
