    ...
    extends AbstractMX
{
    ...
    public static MxFxtr03800101 parse(String xml) {
        return ((MxFxtr03800101) MxReadImpl.parse(MxFxtr03800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03800101) MxReadImpl.parse(MxFxtr03800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr03800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03800101 .class);
    }
