    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {ForeignExchangeTradeWithdrawalNotificationV03 .class, MxFxtr01300103 .class, SupplementaryData1 .class, SupplementaryDataEnvelope1 .class, WithdrawalReason1 .class, WithdrawalReason1Code.class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:fxtr.013.001.03";
    ...
    public static MxFxtr01300103 parse(String xml) {
        return ((MxFxtr01300103) MxReadImpl.parse(MxFxtr01300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01300103) MxReadImpl.parse(MxFxtr01300103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr01300103 fromJson(String json) {
