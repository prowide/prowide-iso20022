    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:fxtr.008.001.04";
    ...
    public static MxFxtr00800104 parse(String xml) {
        return ((MxFxtr00800104) MxReadImpl.parse(MxFxtr00800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr00800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr00800104) MxReadImpl.parse(MxFxtr00800104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr00800104 fromJson(String json) {
