    ...
    extends AbstractMX
{
    ...
    public static MxFxtr03200101 parse(String xml) {
        return ((MxFxtr03200101) MxReadImpl.parse(MxFxtr03200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03200101) MxReadImpl.parse(MxFxtr03200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr03200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03200101 .class);
    }
