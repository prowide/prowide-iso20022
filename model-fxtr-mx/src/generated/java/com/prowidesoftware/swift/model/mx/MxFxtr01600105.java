    ...
    extends AbstractMX
{
    ...
    public static MxFxtr01600105 parse(String xml) {
        return ((MxFxtr01600105) MxReadImpl.parse(MxFxtr01600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01600105) MxReadImpl.parse(MxFxtr01600105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr01600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr01600105 .class);
    }
