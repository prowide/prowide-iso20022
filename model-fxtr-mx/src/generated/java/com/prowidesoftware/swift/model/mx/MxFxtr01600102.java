    ...
    extends AbstractMX
{
    ...
    public static MxFxtr01600102 parse(String xml) {
        return ((MxFxtr01600102) MxReadImpl.parse(MxFxtr01600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01600102) MxReadImpl.parse(MxFxtr01600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr01600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr01600102 .class);
    }
