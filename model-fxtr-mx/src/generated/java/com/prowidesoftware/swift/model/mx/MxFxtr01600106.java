    ...
    extends AbstractMX
{
    ...
    public static MxFxtr01600106 parse(String xml) {
        return ((MxFxtr01600106) MxReadImpl.parse(MxFxtr01600106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01600106 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01600106) MxReadImpl.parse(MxFxtr01600106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr01600106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr01600106 .class);
    }
