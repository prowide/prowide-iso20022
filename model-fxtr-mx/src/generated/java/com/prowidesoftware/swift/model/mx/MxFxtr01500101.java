    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:fxtr.015.001.01";
    ...
    public static MxFxtr01500101 parse(String xml) {
        return ((MxFxtr01500101) MxReadImpl.parse(MxFxtr01500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01500101) MxReadImpl.parse(MxFxtr01500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr01500101 fromJson(String json) {
