    ...
    extends AbstractMX
{
    ...
    public static MxFxtr01300102 parse(String xml) {
        return ((MxFxtr01300102) MxReadImpl.parse(MxFxtr01300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01300102) MxReadImpl.parse(MxFxtr01300102 .class, xml, _classes, new MxReadParams(conf)));
    }
