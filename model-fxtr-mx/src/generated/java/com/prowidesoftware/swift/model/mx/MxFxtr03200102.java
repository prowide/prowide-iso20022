    ...
    extends AbstractMX
{
    ...
    public static MxFxtr03200102 parse(String xml) {
        return ((MxFxtr03200102) MxReadImpl.parse(MxFxtr03200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03200102) MxReadImpl.parse(MxFxtr03200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr03200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03200102 .class);
    }
