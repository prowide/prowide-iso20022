    ...
    extends AbstractMX
{
    ...
    public static MxFxtr03500102 parse(String xml) {
        return ((MxFxtr03500102) MxReadImpl.parse(MxFxtr03500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03500102) MxReadImpl.parse(MxFxtr03500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr03500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03500102 .class);
    }
