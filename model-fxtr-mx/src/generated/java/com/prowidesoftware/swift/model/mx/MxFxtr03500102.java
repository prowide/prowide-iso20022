...
/**
 * Class for fxtr.035.001.02 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.02")
public class MxFxtr03500102
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxFxtr03500102(final String xml) {
        this();
        MxFxtr03500102 tmp = parse(xml);
     ...
     * 
     */
    public MxFxtr03500102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link ForeignExchangeTradeConfirmationRequestAmendmentRequestV02 }
     *     
     */
    public ForeignExchangeTradeConfirmationRequestAmendmentRequestV02 getFXTradConfReqAmdmntReq() {
     ...
     * 
     */
    public static MxFxtr03500102 parse(String xml) {
        return ((MxFxtr03500102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxFxtr03500102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxFxtr03500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03500102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxFxtr03500102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxFxtr03500102 parse(String xml, MxRead parserImpl) {
        return ((MxFxtr03500102) parserImpl.read(MxFxtr03500102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxFxtr03500102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxFxtr03500102 message
     * @return
