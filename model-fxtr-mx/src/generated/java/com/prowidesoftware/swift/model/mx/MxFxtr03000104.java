    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:fxtr.030.001.04";
    ...
    public static MxFxtr03000104 parse(String xml) {
        return ((MxFxtr03000104) MxReadImpl.parse(MxFxtr03000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03000104) MxReadImpl.parse(MxFxtr03000104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr03000104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03000104 .class);
    }
