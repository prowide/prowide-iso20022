    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:fxtr.031.001.01";
    ...
    public static MxFxtr03100101 parse(String xml) {
        return ((MxFxtr03100101) MxReadImpl.parse(MxFxtr03100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03100101) MxReadImpl.parse(MxFxtr03100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr03100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03100101 .class);
    }
