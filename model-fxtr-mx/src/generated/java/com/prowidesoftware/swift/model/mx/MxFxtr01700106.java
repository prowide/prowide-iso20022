    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.06";
    ...
    public static MxFxtr01700106 parse(String xml) {
        return ((MxFxtr01700106) MxReadImpl.parse(MxFxtr01700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01700106) MxReadImpl.parse(MxFxtr01700106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr01700106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr01700106 .class);
    }
