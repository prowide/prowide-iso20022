    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:fxtr.016.001.03";
    ...
    public static MxFxtr01600103 parse(String xml) {
        return ((MxFxtr01600103) MxReadImpl.parse(MxFxtr01600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01600103) MxReadImpl.parse(MxFxtr01600103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr01600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr01600103 .class);
    }
