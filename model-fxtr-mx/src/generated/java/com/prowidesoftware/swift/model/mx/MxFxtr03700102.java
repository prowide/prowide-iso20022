    ...
    extends AbstractMX
{
    ...
    public static MxFxtr03700102 parse(String xml) {
        return ((MxFxtr03700102) MxReadImpl.parse(MxFxtr03700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03700102) MxReadImpl.parse(MxFxtr03700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr03700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03700102 .class);
    }
