    ...
    extends AbstractMX
{
    ...
    public static MxFxtr01200105 parse(String xml) {
        return ((MxFxtr01200105) MxReadImpl.parse(MxFxtr01200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01200105) MxReadImpl.parse(MxFxtr01200105 .class, xml, _classes, new MxReadParams(conf)));
    }
