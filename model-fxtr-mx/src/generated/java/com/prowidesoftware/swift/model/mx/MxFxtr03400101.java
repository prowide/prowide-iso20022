    ...
    extends AbstractMX
{
    ...
    public static MxFxtr03400101 parse(String xml) {
        return ((MxFxtr03400101) MxReadImpl.parse(MxFxtr03400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03400101) MxReadImpl.parse(MxFxtr03400101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr03400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03400101 .class);
    }
