    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.05";
    ...
    public static MxFxtr01500105 parse(String xml) {
        return ((MxFxtr01500105) MxReadImpl.parse(MxFxtr01500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01500105) MxReadImpl.parse(MxFxtr01500105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr01500105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr01500105 .class);
    }
