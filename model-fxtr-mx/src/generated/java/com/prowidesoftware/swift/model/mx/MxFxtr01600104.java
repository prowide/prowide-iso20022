...
/**
 * Class for fxtr.016.001.04 ISO 20022 message.
 * 
 */
...
public class MxFxtr01600104
    extends AbstractMX
{

    @XmlElement(name = "FXTradInstrCxl", required = true)
    protected ForeignExchangeTradeInstructionCancellationV04 fxTradInstrCxl;
     ...
     * 
     */
    public MxFxtr01600104(final String xml) {
        this();
        MxFxtr01600104 tmp = parse(xml);
     ...
     * 
     */
    public MxFxtr01600104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link ForeignExchangeTradeInstructionCancellationV04 }
     *     
     */
    public ForeignExchangeTradeInstructionCancellationV04 getFXTradInstrCxl() {
     ...
     *     
     */
    public MxFxtr01600104 setFXTradInstrCxl(ForeignExchangeTradeInstructionCancellationV04 value) {
    ...
    public static MxFxtr01600104 parse(String xml) {
        return ((MxFxtr01600104) MxReadImpl.parse(MxFxtr01600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01600104) MxReadImpl.parse(MxFxtr01600104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxFxtr01600104 parse(String xml, MxRead parserImpl) {
        return ((MxFxtr01600104) parserImpl.read(MxFxtr01600104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxFxtr01600104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxFxtr01600104 message
     * @return
     *     a new instance of MxFxtr01600104
     */
    public static final MxFxtr01600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr01600104 .class);
    }
