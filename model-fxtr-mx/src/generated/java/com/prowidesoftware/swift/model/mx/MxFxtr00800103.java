    ...
    extends AbstractMX
{
    ...
    public static MxFxtr00800103 parse(String xml) {
        return ((MxFxtr00800103) MxReadImpl.parse(MxFxtr00800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr00800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr00800103) MxReadImpl.parse(MxFxtr00800103 .class, xml, _classes, new MxReadParams(conf)));
    }
