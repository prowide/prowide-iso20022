    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:fxtr.014.001.03";
    ...
    public static MxFxtr01400103 parse(String xml) {
        return ((MxFxtr01400103) MxReadImpl.parse(MxFxtr01400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01400103) MxReadImpl.parse(MxFxtr01400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr01400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr01400103 .class);
    }
