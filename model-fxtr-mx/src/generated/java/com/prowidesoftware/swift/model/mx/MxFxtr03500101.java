    ...
    extends AbstractMX
{
    ...
    public static MxFxtr03500101 parse(String xml) {
        return ((MxFxtr03500101) MxReadImpl.parse(MxFxtr03500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03500101) MxReadImpl.parse(MxFxtr03500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr03500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03500101 .class);
    }
