    ...
    extends AbstractMX
{
    ...
    public static MxFxtr01600101 parse(String xml) {
        return ((MxFxtr01600101) MxReadImpl.parse(MxFxtr01600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01600101) MxReadImpl.parse(MxFxtr01600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr01600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr01600101 .class);
    }
