    ...
    extends AbstractMX
{
    ...
    public static MxFxtr00700103 parse(String xml) {
        return ((MxFxtr00700103) MxReadImpl.parse(MxFxtr00700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr00700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr00700103) MxReadImpl.parse(MxFxtr00700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr00700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr00700103 .class);
    }
