    ...
    extends AbstractMX
{
    ...
    public static MxFxtr01400105 parse(String xml) {
        return ((MxFxtr01400105) MxReadImpl.parse(MxFxtr01400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01400105) MxReadImpl.parse(MxFxtr01400105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr01400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr01400105 .class);
    }
