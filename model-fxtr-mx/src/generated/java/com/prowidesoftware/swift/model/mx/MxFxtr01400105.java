...
/**
 * Class for fxtr.014.001.05 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:fxtr.014.001.05")
public class MxFxtr01400105
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxFxtr01400105(final String xml) {
        this();
        MxFxtr01400105 tmp = parse(xml);
     ...
     * 
     */
    public MxFxtr01400105(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link ForeignExchangeTradeInstructionV05 }
     *     
     */
     ...
     *     
     */
    public MxFxtr01400105 setFXTradInstr(ForeignExchangeTradeInstructionV05 value) {
     ...
     * 
     */
    public static MxFxtr01400105 parse(String xml) {
        return ((MxFxtr01400105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxFxtr01400105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxFxtr01400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01400105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxFxtr01400105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxFxtr01400105 parse(String xml, MxRead parserImpl) {
        return ((MxFxtr01400105) parserImpl.read(MxFxtr01400105 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxFxtr01400105 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxFxtr01400105 message
     * @return
     *     a new instance of MxFxtr01400105
     */
    public static final MxFxtr01400105 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxFxtr01400105 .class);
    }
