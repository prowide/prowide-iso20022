    ...
    extends AbstractMX
{
    ...
    public static MxFxtr01500106 parse(String xml) {
        return ((MxFxtr01500106) MxReadImpl.parse(MxFxtr01500106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01500106) MxReadImpl.parse(MxFxtr01500106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr01500106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr01500106 .class);
    }
