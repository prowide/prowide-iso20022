    ...
    extends AbstractMX
{
    ...
    public static MxFxtr01700101 parse(String xml) {
        return ((MxFxtr01700101) MxReadImpl.parse(MxFxtr01700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01700101) MxReadImpl.parse(MxFxtr01700101 .class, xml, _classes, new MxReadParams(conf)));
    }
