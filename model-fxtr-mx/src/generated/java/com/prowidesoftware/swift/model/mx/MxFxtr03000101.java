    ...
    extends AbstractMX
{
    ...
    public static MxFxtr03000101 parse(String xml) {
        return ((MxFxtr03000101) MxReadImpl.parse(MxFxtr03000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03000101) MxReadImpl.parse(MxFxtr03000101 .class, xml, _classes, new MxReadParams(conf)));
    }
