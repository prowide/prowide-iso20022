    ...
    extends AbstractMX
{
    ...
    public final static transient Class[] _classes = new Class[] {ForeignExchangeTradeBulkStatusNotificationV01 .class, MxFxtr03000101 .class, Pagination.class, Status5Choice.class, TradeData4 .class, TradeData5 .class, TradeStatus3Code.class };
    public final static transient String NAMESPACE = "urn:swift:xsd:fxtr.030.001.01";
     ...
     */
    public final static MxFxtr03000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03000101 .class);
    }
