    ...
    extends AbstractMX
{
    ...
    public static MxFxtr00800108 parse(String xml) {
        return ((MxFxtr00800108) MxReadImpl.parse(MxFxtr00800108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr00800108 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr00800108) MxReadImpl.parse(MxFxtr00800108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr00800108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr00800108 .class);
    }
