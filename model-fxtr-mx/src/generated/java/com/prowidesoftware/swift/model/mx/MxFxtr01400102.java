    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:fxtr.014.001.02";
    ...
    public static MxFxtr01400102 parse(String xml) {
        return ((MxFxtr01400102) MxReadImpl.parse(MxFxtr01400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01400102) MxReadImpl.parse(MxFxtr01400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr01400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr01400102 .class);
    }
