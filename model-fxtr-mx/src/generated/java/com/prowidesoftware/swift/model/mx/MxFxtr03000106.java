    ...
    extends AbstractMX
{
    ...
    public static MxFxtr03000106 parse(String xml) {
        return ((MxFxtr03000106) MxReadImpl.parse(MxFxtr03000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03000106) MxReadImpl.parse(MxFxtr03000106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr03000106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03000106 .class);
    }
