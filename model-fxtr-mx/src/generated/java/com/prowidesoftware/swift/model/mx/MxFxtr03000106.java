...
/**
 * Class for fxtr.030.001.06 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:fxtr.030.001.06")
public class MxFxtr03000106
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxFxtr03000106(final String xml) {
        this();
        MxFxtr03000106 tmp = parse(xml);
     ...
     * 
     */
    public MxFxtr03000106(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link ForeignExchangeTradeBulkStatusNotificationV06 }
     *     
     */
    public ForeignExchangeTradeBulkStatusNotificationV06 getFXTradBlkStsNtfctn() {
     ...
     * 
     */
    public static MxFxtr03000106 parse(String xml) {
        return ((MxFxtr03000106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxFxtr03000106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxFxtr03000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03000106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxFxtr03000106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxFxtr03000106 parse(String xml, MxRead parserImpl) {
        return ((MxFxtr03000106) parserImpl.read(MxFxtr03000106 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxFxtr03000106 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxFxtr03000106 message
     * @return
