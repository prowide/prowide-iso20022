    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:fxtr.008.001.06";
    ...
    public static MxFxtr00800106 parse(String xml) {
        return ((MxFxtr00800106) MxReadImpl.parse(MxFxtr00800106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr00800106 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr00800106) MxReadImpl.parse(MxFxtr00800106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr00800106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr00800106 .class);
    }
