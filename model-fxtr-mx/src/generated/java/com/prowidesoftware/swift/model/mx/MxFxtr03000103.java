    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:fxtr.030.001.03";
    ...
    public static MxFxtr03000103 parse(String xml) {
        return ((MxFxtr03000103) MxReadImpl.parse(MxFxtr03000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03000103) MxReadImpl.parse(MxFxtr03000103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr03000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03000103 .class);
    }
