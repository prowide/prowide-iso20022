    ...
    extends AbstractMX
{
    ...
    public static MxFxtr03700101 parse(String xml) {
        return ((MxFxtr03700101) MxReadImpl.parse(MxFxtr03700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03700101) MxReadImpl.parse(MxFxtr03700101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr03700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03700101 .class);
    }
