    ...
    extends AbstractMX
{
    ...
    public static MxFxtr01700103 parse(String xml) {
        return ((MxFxtr01700103) MxReadImpl.parse(MxFxtr01700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr01700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr01700103) MxReadImpl.parse(MxFxtr01700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxFxtr01700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr01700103 .class);
    }
