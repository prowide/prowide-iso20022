    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {AdditionalReferences2 .class, ForeignExchangeTradeCaptureReportAcknowledgementV02 .class, MessageIdentification1 .class, MxFxtr03300102 .class, Status5Code.class, SupplementaryData1 .class, SupplementaryDataEnvelope1 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:fxtr.033.001.02";
    ...
    public static MxFxtr03300102 parse(String xml) {
        return ((MxFxtr03300102) MxReadImpl.parse(MxFxtr03300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxFxtr03300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxFxtr03300102) MxReadImpl.parse(MxFxtr03300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxFxtr03300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxFxtr03300102 .class);
    }
