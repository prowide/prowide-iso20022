    ...
    extends AbstractMX
{
    ...
    public static MxSecl00700101 parse(String xml) {
        return ((MxSecl00700101) MxReadImpl.parse(MxSecl00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00700101) MxReadImpl.parse(MxSecl00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
