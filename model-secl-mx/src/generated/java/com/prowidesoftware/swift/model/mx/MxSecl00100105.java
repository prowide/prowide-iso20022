    ...
    extends AbstractMX
{
    ...
    public static MxSecl00100105 parse(String xml) {
        return ((MxSecl00100105) MxReadImpl.parse(MxSecl00100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00100105) MxReadImpl.parse(MxSecl00100105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSecl00100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSecl00100105 .class);
    }
