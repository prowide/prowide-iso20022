    ...
    extends AbstractMX
{
    ...
    public static MxSecl00400102 parse(String xml) {
        return ((MxSecl00400102) MxReadImpl.parse(MxSecl00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00400102) MxReadImpl.parse(MxSecl00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
