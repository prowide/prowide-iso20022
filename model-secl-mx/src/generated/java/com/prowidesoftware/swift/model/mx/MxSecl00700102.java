    ...
    extends AbstractMX
{
    ...
    public static MxSecl00700102 parse(String xml) {
        return ((MxSecl00700102) MxReadImpl.parse(MxSecl00700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00700102) MxReadImpl.parse(MxSecl00700102 .class, xml, _classes, new MxReadParams(conf)));
    }
