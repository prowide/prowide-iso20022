    ...
    extends AbstractMX
{
    ...
    public static MxSecl01000103 parse(String xml) {
        return ((MxSecl01000103) MxReadImpl.parse(MxSecl01000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl01000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl01000103) MxReadImpl.parse(MxSecl01000103 .class, xml, _classes, new MxReadParams(conf)));
    }
