    ...
    extends AbstractMX
{
    ...
    public static MxSecl00900102 parse(String xml) {
        return ((MxSecl00900102) MxReadImpl.parse(MxSecl00900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00900102) MxReadImpl.parse(MxSecl00900102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSecl00900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSecl00900102 .class);
    }
