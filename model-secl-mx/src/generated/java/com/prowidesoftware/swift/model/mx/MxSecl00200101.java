    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:secl.002.001.01";
    ...
    public static MxSecl00200101 parse(String xml) {
        return ((MxSecl00200101) MxReadImpl.parse(MxSecl00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00200101) MxReadImpl.parse(MxSecl00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSecl00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSecl00200101 .class);
    }
