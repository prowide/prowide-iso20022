    ...
    extends AbstractMX
{
    ...
    public static MxSecl00800101 parse(String xml) {
        return ((MxSecl00800101) MxReadImpl.parse(MxSecl00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00800101) MxReadImpl.parse(MxSecl00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSecl00800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSecl00800101 .class);
    }
