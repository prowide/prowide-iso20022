    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:secl.006.001.01";
    ...
    public static MxSecl00600101 parse(String xml) {
        return ((MxSecl00600101) MxReadImpl.parse(MxSecl00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00600101) MxReadImpl.parse(MxSecl00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSecl00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSecl00600101 .class);
    }
