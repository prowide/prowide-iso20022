    ...
    extends AbstractMX
{
    ...
    public static MxSecl00800102 parse(String xml) {
        return ((MxSecl00800102) MxReadImpl.parse(MxSecl00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00800102) MxReadImpl.parse(MxSecl00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
