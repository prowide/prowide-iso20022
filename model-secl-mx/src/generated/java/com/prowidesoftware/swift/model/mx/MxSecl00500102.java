    ...
    extends AbstractMX
{
    ...
    public static MxSecl00500102 parse(String xml) {
        return ((MxSecl00500102) MxReadImpl.parse(MxSecl00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00500102) MxReadImpl.parse(MxSecl00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
