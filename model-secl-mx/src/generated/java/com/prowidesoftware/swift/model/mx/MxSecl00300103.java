    ...
    extends AbstractMX
{
    ...
    public static MxSecl00300103 parse(String xml) {
        return ((MxSecl00300103) MxReadImpl.parse(MxSecl00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00300103) MxReadImpl.parse(MxSecl00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSecl00300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSecl00300103 .class);
    }
