    ...
    extends AbstractMX
{
    ...
    public static MxSecl00100101 parse(String xml) {
        return ((MxSecl00100101) MxReadImpl.parse(MxSecl00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00100101) MxReadImpl.parse(MxSecl00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
