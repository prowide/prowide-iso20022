    ...
    extends AbstractMX
{
    ...
    public static MxSecl00300102 parse(String xml) {
        return ((MxSecl00300102) MxReadImpl.parse(MxSecl00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00300102) MxReadImpl.parse(MxSecl00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
