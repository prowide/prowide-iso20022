    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:secl.003.001.02";
    ...
    public static MxSecl00300102 parse(String xml) {
        return ((MxSecl00300102) MxReadImpl.parse(MxSecl00300102 .class, xml, _classes));
    }
     ...
     */
    public final static MxSecl00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSecl00300102 .class);
    }
