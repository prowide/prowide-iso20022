    ...
    extends AbstractMX
{
    ...
    public static MxSecl00200102 parse(String xml) {
        return ((MxSecl00200102) MxReadImpl.parse(MxSecl00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00200102) MxReadImpl.parse(MxSecl00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSecl00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSecl00200102 .class);
    }
