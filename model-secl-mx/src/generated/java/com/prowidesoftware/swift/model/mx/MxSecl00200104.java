    ...
    extends AbstractMX
{
    ...
    public static MxSecl00200104 parse(String xml) {
        return ((MxSecl00200104) MxReadImpl.parse(MxSecl00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00200104) MxReadImpl.parse(MxSecl00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSecl00200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSecl00200104 .class);
    }
