    ...
    extends AbstractMX
{
    ...
    public static MxSecl00400101 parse(String xml) {
        return ((MxSecl00400101) MxReadImpl.parse(MxSecl00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00400101) MxReadImpl.parse(MxSecl00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
