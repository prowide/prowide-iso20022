    ...
    extends AbstractMX
{
    ...
    public static MxSecl00500101 parse(String xml) {
        return ((MxSecl00500101) MxReadImpl.parse(MxSecl00500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00500101) MxReadImpl.parse(MxSecl00500101 .class, xml, _classes, new MxReadParams(conf)));
    }
