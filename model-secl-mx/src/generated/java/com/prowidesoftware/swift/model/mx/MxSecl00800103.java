    ...
    extends AbstractMX
{
    ...
    public static MxSecl00800103 parse(String xml) {
        return ((MxSecl00800103) MxReadImpl.parse(MxSecl00800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00800103) MxReadImpl.parse(MxSecl00800103 .class, xml, _classes, new MxReadParams(conf)));
    }
