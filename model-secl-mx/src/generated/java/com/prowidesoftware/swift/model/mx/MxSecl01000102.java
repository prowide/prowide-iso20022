    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:secl.010.001.02";
    ...
    public static MxSecl01000102 parse(String xml) {
        return ((MxSecl01000102) MxReadImpl.parse(MxSecl01000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl01000102) MxReadImpl.parse(MxSecl01000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSecl01000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSecl01000102 .class);
    }
