    ...
    extends AbstractMX
{
    ...
    public static MxSecl01300101 parse(String xml) {
        return ((MxSecl01300101) MxReadImpl.parse(MxSecl01300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl01300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl01300101) MxReadImpl.parse(MxSecl01300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSecl01300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSecl01300101 .class);
    }
