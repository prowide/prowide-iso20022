    ...
    extends AbstractMX
{
    ...
    public static MxSecl00700103 parse(String xml) {
        return ((MxSecl00700103) MxReadImpl.parse(MxSecl00700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00700103) MxReadImpl.parse(MxSecl00700103 .class, xml, _classes, new MxReadParams(conf)));
    }
