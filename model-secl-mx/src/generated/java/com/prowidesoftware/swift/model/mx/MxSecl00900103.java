    ...
    extends AbstractMX
{
    ...
    public static MxSecl00900103 parse(String xml) {
        return ((MxSecl00900103) MxReadImpl.parse(MxSecl00900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00900103) MxReadImpl.parse(MxSecl00900103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSecl00900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSecl00900103 .class);
    }
