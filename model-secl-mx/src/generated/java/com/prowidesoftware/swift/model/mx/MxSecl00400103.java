    ...
    extends AbstractMX
{
    ...
    public static MxSecl00400103 parse(String xml) {
        return ((MxSecl00400103) MxReadImpl.parse(MxSecl00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00400103) MxReadImpl.parse(MxSecl00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSecl00400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSecl00400103 .class);
    }
