    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:secl.003.001.04";
    ...
    public static MxSecl00300104 parse(String xml) {
        return ((MxSecl00300104) MxReadImpl.parse(MxSecl00300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00300104) MxReadImpl.parse(MxSecl00300104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSecl00300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSecl00300104 .class);
    }
