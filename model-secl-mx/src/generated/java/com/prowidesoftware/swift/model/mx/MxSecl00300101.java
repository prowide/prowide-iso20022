    ...
    extends AbstractMX
{
    ...
    public static MxSecl00300101 parse(String xml) {
        return ((MxSecl00300101) MxReadImpl.parse(MxSecl00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSecl00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSecl00300101) MxReadImpl.parse(MxSecl00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
