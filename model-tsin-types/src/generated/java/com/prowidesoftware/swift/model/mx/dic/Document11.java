...
@XmlType(name = "Document11", propOrder = {
    "tp",
    "wrdg",
    "elctrncDtls"
})
public class Document11 {
     ...
     *     
     */
    public Document11 setTp(PresentationDocumentFormat1Choice value) {
        this.tp = value;
        return this;
    }
     ...
     *     
     */
    public Document11 setWrdg(String value) {
        this.wrdg = value;
        return this;
    }
     ...
     * This is why there is not a {@code set} method for the elctrncDtls property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the elctrncDtls property.
     */
    public List<Presentation3> getElctrncDtls() {
        if (elctrncDtls == null) {
            elctrncDtls = new ArrayList<>();
        }
     ...
     * 
     */
    public Document11 addElctrncDtls(Presentation3 elctrncDtls) {
