...
public class FinancingItemList1 {
     ...
     *     
     */
    public FinancingItemList1 setIsseDt(XMLGregorianCalendar value) {
        this.isseDt = value;
        return this;
    }
     ...
     *     
     */
    public FinancingItemList1 setAmtCutOffDt(XMLGregorianCalendar value) {
    ...
    public List<FinancingNotificationParties1Tsin00600101> getNtfctnInf() {
        if (ntfctnInf == null) {
            ntfctnInf = new ArrayList<FinancingNotificationParties1Tsin00600101>();
        }
    ...
    public List<FinancialItem1Tsin00600101> getFinItm() {
        if (finItm == null) {
            finItm = new ArrayList<FinancialItem1Tsin00600101>();
        }
        return this.finItm;
    }
