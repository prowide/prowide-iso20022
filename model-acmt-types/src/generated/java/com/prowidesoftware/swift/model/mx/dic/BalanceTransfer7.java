...
@XmlType(name = "BalanceTransfer7", propOrder = {
    "balTrfRef",
    "balTrfMtd",
    "balTrfFndgLmt"
})
public class BalanceTransfer7 {

    @XmlElement(name = "BalTrfRef")
    protected BalanceTransferReference1 balTrfRef;
    @XmlElement(name = "BalTrfMtd")
    protected SettlementMethod7Choice balTrfMtd;
     ...
     *     
     */
    public BalanceTransfer7 setBalTrfRef(BalanceTransferReference1 value) {
     ...
     * @return
     *     possible object is
     *     {@link SettlementMethod7Choice }
     *     
     */
    public SettlementMethod7Choice getBalTrfMtd() {
        return balTrfMtd;
    }
     ...
     *     
     */
    public BalanceTransfer7 setBalTrfMtd(SettlementMethod7Choice value) {
     ...
     *     
     */
    public BalanceTransfer7 setBalTrfFndgLmt(BalanceTransferFundingLimit1 value) {
