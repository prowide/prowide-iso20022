...
@XmlType(name = "Status20Choice", propOrder = {
    "sts",
    "rjctd"
})
public class Status20Choice {
     ...
     *     
     */
    public Status20Choice setSts(AccountManagementStatus1Code value) {
        this.sts = value;
        return this;
    }
    ...
    public List<RejectionReason31> getRjctd() {
        if (rjctd == null) {
            rjctd = new ArrayList<RejectionReason31>();
        }
        return this.rjctd;
    }
     ...
     * 
     */
    public Status20Choice addRjctd(RejectionReason31 rjctd) {
        getRjctd().add(rjctd);
        return this;
    }
