...
@XmlType(name = "AccountManagementStatusReportV05", propOrder = {
    "msgId",
    "rltdRef",
    "stsRpt",
    "mktPrctcVrsn",
...
public class AccountManagementStatusReportV05 {
    ...
    protected AccountManagementStatusAndReason4 stsRpt;
     ...
     *     
     */
    public AccountManagementStatusReportV05 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
    ...
    public List<AdditionalReference6> getRltdRef() {
        if (rltdRef == null) {
            rltdRef = new ArrayList<AdditionalReference6>();
        }
        return this.rltdRef;
    }
     ...
     * @return
     *     possible object is
     *     {@link AccountManagementStatusAndReason4 }
     *     
     */
    public AccountManagementStatusAndReason4 getStsRpt() {
        return stsRpt;
    }
     ...
     *     
     */
    public AccountManagementStatusReportV05 setStsRpt(AccountManagementStatusAndReason4 value) {
        this.stsRpt = value;
        return this;
    }
     ...
     *     
     */
    public AccountManagementStatusReportV05 setMktPrctcVrsn(MarketPracticeVersion1 value) {
     ...
     * 
     */
    public AccountManagementStatusReportV05 addRltdRef(AdditionalReference6 rltdRef) {
     ...
     * 
     */
    public AccountManagementStatusReportV05 addXtnsn(Extension1 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
