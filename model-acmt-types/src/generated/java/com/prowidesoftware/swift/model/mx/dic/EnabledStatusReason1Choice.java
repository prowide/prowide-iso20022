...
@XmlType(name = "EnabledStatusReason1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class EnabledStatusReason1Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<EnabledStatusReason1> rsn;
     ...
     *     
     */
    public EnabledStatusReason1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link EnabledStatusReason1 }
     * 
     * 
     */
    public List<EnabledStatusReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<EnabledStatusReason1>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public EnabledStatusReason1Choice addRsn(EnabledStatusReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
