...
@XmlType(name = "IndividualPerson19", propOrder = {
    "curNm",
    "prvsNm",
    "gndr",
    "lang",
...
public class IndividualPerson19 {
    ...
    protected IndividualPersonNameLong1 curNm;
    @XmlElement(name = "PrvsNm")
    protected List<IndividualPersonNameLong1> prvsNm;
    ...
    protected List<PostalAddress6> pstlAdr;
     ...
     * @return
     *     possible object is
     *     {@link IndividualPersonNameLong1 }
     *     
     */
    public IndividualPersonNameLong1 getCurNm() {
        return curNm;
    }
     ...
     *     
     */
    public IndividualPerson19 setCurNm(IndividualPersonNameLong1 value) {
        this.curNm = value;
        return this;
    }
     ...
     * 
     */
    public List<IndividualPersonNameLong1> getPrvsNm() {
        if (prvsNm == null) {
            prvsNm = new ArrayList<IndividualPersonNameLong1>();
        }
        return this.prvsNm;
    }
     ...
     *     
     */
    public IndividualPerson19 setGndr(Gender1Code value) {
        this.gndr = value;
        return this;
    }
     ...
     *     
     */
    public IndividualPerson19 setLang(String value) {
        this.lang = value;
        return this;
    }
     ...
     *     
     */
    public IndividualPerson19 setCtryOfBirth(String value) {
     ...
     *     
     */
    public IndividualPerson19 setPrvcOfBirth(String value) {
     ...
     *     
     */
    public IndividualPerson19 setCityOfBirth(String value) {
     ...
     *     
     */
    public IndividualPerson19 setTaxtnCtry(String value) {
     ...
     *     
     */
    public IndividualPerson19 setCtryAndResdtlSts(CountryAndResidentialStatusType1 value) {
     ...
     *     
     */
    public IndividualPerson19 setSclSctyNb(String value) {
     ...
     * 
     */
    public List<PostalAddress6> getPstlAdr() {
        if (pstlAdr == null) {
            pstlAdr = new ArrayList<PostalAddress6>();
        }
        return this.pstlAdr;
    }
     ...
     *     
     */
    public IndividualPerson19 setPmryComAdr(CommunicationAddress3 value) {
     ...
     *     
     */
    public IndividualPerson19 setScndryComAdr(CommunicationAddress3 value) {
     ...
     * 
     */
    public IndividualPerson19 addPrvsNm(IndividualPersonNameLong1 prvsNm) {
     ...
     * 
     */
    public IndividualPerson19 addPstlAdr(PostalAddress6 pstlAdr) {
     ...
     * 
     */
    public IndividualPerson19 addCtznshInf(CitizenshipInformation1 ctznshInf) {
     ...
     * 
     */
    public IndividualPerson19 addOthrId(GenericIdentification44 othrId) {
     ...
     * 
     */
    public IndividualPerson19 addOthrDtls(TransferInstruction1 othrDtls) {
