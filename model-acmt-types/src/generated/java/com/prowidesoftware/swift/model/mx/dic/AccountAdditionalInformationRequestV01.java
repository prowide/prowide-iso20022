...
@XmlType(name = "AccountAdditionalInformationRequestV01", propOrder = {
    "refs",
    "orgId",
    "acctSvcrId",
    "acctId",
...
public class AccountAdditionalInformationRequestV01 {
     ...
     *     
     */
    public AccountAdditionalInformationRequestV01 setRefs(References3 value) {
        this.refs = value;
        return this;
    }
     ...
     *     
     */
    public AccountAdditionalInformationRequestV01 setAcctSvcrId(BranchAndFinancialInstitutionIdentification4 value) {
     ...
     *     
     */
    public AccountAdditionalInformationRequestV01 setAcctId(AccountForAction1 value) {
        this.acctId = value;
        return this;
    }
     ...
     * 
     */
    public AccountAdditionalInformationRequestV01 addOrgId(OrganisationIdentification6 orgId) {
        getOrgId().add(orgId);
        return this;
    }
     ...
     * 
     */
    public AccountAdditionalInformationRequestV01 addDgtlSgntr(PartyAndSignature1 dgtlSgntr) {
