...
public class OperationMandate5 {
     ...
     *     
     */
    public OperationMandate5 setModCd(Modification1Code value) {
        this.modCd = value;
        return this;
    }
     ...
     *     
     */
    public OperationMandate5 setId(String value) {
        this.id = value;
        return this;
    }
     ...
     *     
     */
    public OperationMandate5 setReqrdSgntrNb(String value) {
     ...
     * 
     */
    public OperationMandate5 setSgntrOrdrInd(boolean value) {
    ...
    public List<PartyAndAuthorisation5> getMndtHldr() {
        if (mndtHldr == null) {
            mndtHldr = new ArrayList<PartyAndAuthorisation5>();
        }
     ...
     * 
     */
    public OperationMandate5 addAplblChanl(Channel2Choice aplblChanl) {
     ...
     * 
     */
    public OperationMandate5 addMndtHldr(PartyAndAuthorisation5 mndtHldr) {
     ...
     * 
     */
    public OperationMandate5 addBkOpr(BankTransactionCodeStructure4 bkOpr) {
        getBkOpr().add(bkOpr);
        return this;
    }
