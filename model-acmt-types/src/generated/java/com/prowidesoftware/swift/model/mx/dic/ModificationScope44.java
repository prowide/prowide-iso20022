...
@XmlType(name = "ModificationScope44", propOrder = {
    "modScpIndctn",
    "svcLvlAgrmt"
})
public class ModificationScope44 {

    @XmlElement(name = "ModScpIndctn", required = true)
    @XmlSchemaType(name = "string")
    protected DataModification1Code modScpIndctn;
    @XmlElement(name = "SvcLvlAgrmt", required = true)
    protected DocumentToSend4 svcLvlAgrmt;
     ...
     *     
     */
    public ModificationScope44 setModScpIndctn(DataModification1Code value) {
     ...
     *     
     */
    public DocumentToSend4 getSvcLvlAgrmt() {
        return svcLvlAgrmt;
    }
     ...
     *     
     */
    public ModificationScope44 setSvcLvlAgrmt(DocumentToSend4 value) {
