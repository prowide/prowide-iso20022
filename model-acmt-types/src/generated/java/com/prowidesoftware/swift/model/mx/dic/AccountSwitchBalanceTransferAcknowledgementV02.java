...
@XmlType(name = "AccountSwitchBalanceTransferAcknowledgementV02", propOrder = {
    "msgId",
    "acctSwtchDtls",
    "odAcct",
    "odAcctBal",
...
public class AccountSwitchBalanceTransferAcknowledgementV02 {
    ...
    protected List<BalanceTransfer2> balTrf;
     ...
     *     
     */
    public AccountSwitchBalanceTransferAcknowledgementV02 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
     ...
     *     
     */
    public AccountSwitchBalanceTransferAcknowledgementV02 setAcctSwtchDtls(AccountSwitchDetails1 value) {
     ...
     *     
     */
    public AccountSwitchBalanceTransferAcknowledgementV02 setOdAcct(CashAccount39 value) {
        this.odAcct = value;
        return this;
    }
     ...
     *     
     */
    public AccountSwitchBalanceTransferAcknowledgementV02 setOdAcctBal(AmountAndDirection5 value) {
     ...
     * {@link BalanceTransfer2 }
     * 
     * 
     */
    public List<BalanceTransfer2> getBalTrf() {
        if (balTrf == null) {
            balTrf = new ArrayList<BalanceTransfer2>();
        }
        return this.balTrf;
    }
     ...
     * 
     */
    public AccountSwitchBalanceTransferAcknowledgementV02 addBalTrf(BalanceTransfer2 balTrf) {
     ...
     * 
     */
    public AccountSwitchBalanceTransferAcknowledgementV02 addSplmtryData(SupplementaryData1 splmtryData) {
