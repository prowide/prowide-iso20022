...
@XmlType(name = "ModificationScope46", propOrder = {
    "modScpIndctn",
    "invstrPrfl"
})
public class ModificationScope46 {

    @XmlElement(name = "ModScpIndctn", required = true)
    @XmlSchemaType(name = "string")
    protected DataModification1Code modScpIndctn;
    @XmlElement(name = "InvstrPrfl", required = true)
    protected InvestorProfile2 invstrPrfl;
     ...
     *     
     */
    public ModificationScope46 setModScpIndctn(DataModification1Code value) {
     ...
     *     
     */
    public InvestorProfile2 getInvstrPrfl() {
        return invstrPrfl;
    }
     ...
     *     
     */
    public ModificationScope46 setInvstrPrfl(InvestorProfile2 value) {
