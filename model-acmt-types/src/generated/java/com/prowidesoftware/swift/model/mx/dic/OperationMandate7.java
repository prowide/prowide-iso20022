...
@XmlType(name = "OperationMandate7", propOrder = {
    "id",
    "aplblChanl",
    "reqrdSgntrNb",
    "sgntrOrdrInd",
...
public class OperationMandate7 {
    ...
    protected List<PartyAndAuthorisation7> mndtHldr;
     ...
     *     
     */
    public OperationMandate7 setId(String value) {
        this.id = value;
        return this;
    }
     ...
     *     
     */
    public OperationMandate7 setReqrdSgntrNb(String value) {
     ...
     * 
     */
    public OperationMandate7 setSgntrOrdrInd(boolean value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartyAndAuthorisation7 }
     * 
     * 
     */
    public List<PartyAndAuthorisation7> getMndtHldr() {
        if (mndtHldr == null) {
            mndtHldr = new ArrayList<PartyAndAuthorisation7>();
        }
     ...
     *     
     */
    public OperationMandate7 setStartDt(XMLGregorianCalendar value) {
        this.startDt = value;
        return this;
    }
     ...
     *     
     */
    public OperationMandate7 setEndDt(XMLGregorianCalendar value) {
        this.endDt = value;
        return this;
    }
     ...
     * 
     */
    public OperationMandate7 addAplblChanl(Channel2Choice aplblChanl) {
     ...
     * 
     */
    public OperationMandate7 addMndtHldr(PartyAndAuthorisation7 mndtHldr) {
     ...
     * 
     */
    public OperationMandate7 addBkOpr(BankTransactionCodeStructure4 bkOpr) {
        getBkOpr().add(bkOpr);
        return this;
    }
