...
@XmlType(name = "AccountReportOrError3Choice", propOrder = {
    "err",
    "acctRpt"
})
public class AccountReportOrError3Choice {

    @XmlElement(name = "Err")
    protected List<ErrorHandling5> err;
    @XmlElement(name = "AcctRpt")
    protected List<AccountReport26> acctRpt;
     ...
     */
    public List<ErrorHandling5> getErr() {
        if (err == null) {
            err = new ArrayList<>();
        }
        return this.err;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AccountReport26 }
     * 
     * 
     * @return
     *     The value of the acctRpt property.
     */
    public List<AccountReport26> getAcctRpt() {
        if (acctRpt == null) {
     ...
     * 
     */
    public AccountReportOrError3Choice addErr(ErrorHandling5 err) {
        getErr().add(err);
        return this;
    }
     ...
     * 
     */
    public AccountReportOrError3Choice addAcctRpt(AccountReport26 acctRpt) {
