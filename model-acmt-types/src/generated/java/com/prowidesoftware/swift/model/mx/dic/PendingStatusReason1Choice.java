...
@XmlType(name = "PendingStatusReason1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatusReason1Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<PendingStatusReason14> rsn;
     ...
     *     
     */
    public PendingStatusReason1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingStatusReason14 }
     * 
     * 
     */
    public List<PendingStatusReason14> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingStatusReason14>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatusReason1Choice addRsn(PendingStatusReason14 rsn) {
        getRsn().add(rsn);
        return this;
    }
