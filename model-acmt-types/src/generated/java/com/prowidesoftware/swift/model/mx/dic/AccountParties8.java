...
public class AccountParties8 {
    ...
    public List<InvestmentAccountOwnershipInformation8> getScndryOwnr() {
        if (scndryOwnr == null) {
            scndryOwnr = new ArrayList<InvestmentAccountOwnershipInformation8>();
        }
    ...
    public List<InvestmentAccountOwnershipInformation8> getBnfcry() {
        if (bnfcry == null) {
            bnfcry = new ArrayList<InvestmentAccountOwnershipInformation8>();
        }
        return this.bnfcry;
    }
    ...
    public List<InvestmentAccountOwnershipInformation8> getPwrOfAttny() {
        if (pwrOfAttny == null) {
            pwrOfAttny = new ArrayList<InvestmentAccountOwnershipInformation8>();
        }
    ...
    public List<InvestmentAccountOwnershipInformation8> getLglGuardn() {
        if (lglGuardn == null) {
            lglGuardn = new ArrayList<InvestmentAccountOwnershipInformation8>();
        }
    ...
    public List<InvestmentAccountOwnershipInformation8> getAdmstr() {
        if (admstr == null) {
            admstr = new ArrayList<InvestmentAccountOwnershipInformation8>();
        }
        return this.admstr;
    }
    ...
    public List<ExtendedParty5> getOthrPty() {
        if (othrPty == null) {
            othrPty = new ArrayList<ExtendedParty5>();
        }
        return this.othrPty;
    }
    ...
    public List<InvestmentAccountOwnershipInformation8> getGrntr() {
        if (grntr == null) {
            grntr = new ArrayList<InvestmentAccountOwnershipInformation8>();
        }
        return this.grntr;
    }
    ...
    public List<InvestmentAccountOwnershipInformation8> getSttlr() {
        if (sttlr == null) {
            sttlr = new ArrayList<InvestmentAccountOwnershipInformation8>();
        }
        return this.sttlr;
    }
