...
@XmlType(name = "ModificationScope5", propOrder = {
    "modScpIndctn",
    "invstmtPlan"
})
public class ModificationScope5 {
    ...
    protected InvestmentPlan3 invstmtPlan;
     ...
     *     
     */
    public ModificationScope5 setModScpIndctn(DataModification1Code value) {
     ...
     * @return
     *     possible object is
     *     {@link InvestmentPlan3 }
     *     
     */
    public InvestmentPlan3 getInvstmtPlan() {
        return invstmtPlan;
    }
     ...
     *     
     */
    public ModificationScope5 setInvstmtPlan(InvestmentPlan3 value) {
