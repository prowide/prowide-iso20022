...
@XmlType(name = "RemittanceInformation14", propOrder = {
    "ustrd",
    "strd"
})
public class RemittanceInformation14 {
    ...
    protected List<StructuredRemittanceInformation14> strd;
     ...
     * 
     */
    public RemittanceInformation14 addUstrd(String ustrd) {
        getUstrd().add(ustrd);
        return this;
    }
     ...
     * 
     */
    public RemittanceInformation14 addStrd(StructuredRemittanceInformation14 strd) {
        getStrd().add(strd);
        return this;
    }
