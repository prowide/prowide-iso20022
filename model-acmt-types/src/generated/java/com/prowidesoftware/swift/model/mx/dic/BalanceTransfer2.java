...
@XmlType(name = "BalanceTransfer2", propOrder = {
    "balTrfRef",
    "balTrfMtd",
    "balTrfFndgLmt"
})
public class BalanceTransfer2 {

    @XmlElement(name = "BalTrfRef")
    protected BalanceTransferReference1 balTrfRef;
    @XmlElement(name = "BalTrfMtd")
    protected SettlementMethod2Choice balTrfMtd;
     ...
     *     
     */
    public BalanceTransfer2 setBalTrfRef(BalanceTransferReference1 value) {
     ...
     * @return
     *     possible object is
     *     {@link SettlementMethod2Choice }
     *     
     */
    public SettlementMethod2Choice getBalTrfMtd() {
        return balTrfMtd;
    }
     ...
     *     
     */
    public BalanceTransfer2 setBalTrfMtd(SettlementMethod2Choice value) {
     ...
     *     
     */
    public BalanceTransfer2 setBalTrfFndgLmt(BalanceTransferFundingLimit1 value) {
