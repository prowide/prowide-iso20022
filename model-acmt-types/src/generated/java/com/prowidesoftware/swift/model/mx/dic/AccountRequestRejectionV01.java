...
@XmlType(name = "AccountRequestRejectionV01", propOrder = {
    "refs",
    "acctSvcrId",
    "acctId",
    "orgId",
...
public class AccountRequestRejectionV01 {
     ...
     *     
     */
    public AccountRequestRejectionV01 setRefs(References6 value) {
        this.refs = value;
        return this;
    }
     ...
     *     
     */
    public AccountRequestRejectionV01 setAcctSvcrId(BranchAndFinancialInstitutionIdentification4 value) {
     ...
     * 
     */
    public AccountRequestRejectionV01 addAcctId(AccountForAction1 acctId) {
     ...
     * 
     */
    public AccountRequestRejectionV01 addOrgId(OrganisationIdentification6 orgId) {
        getOrgId().add(orgId);
        return this;
    }
     ...
     * 
     */
    public AccountRequestRejectionV01 addDgtlSgntr(PartyAndSignature1 dgtlSgntr) {
