...
@XmlType(name = "BlockedStatusReason2Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class BlockedStatusReason2Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<BlockedStatusReason2> rsn;
     ...
     *     
     */
    public BlockedStatusReason2Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link BlockedStatusReason2 }
     * 
     * 
     */
    public List<BlockedStatusReason2> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<BlockedStatusReason2>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public BlockedStatusReason2Choice addRsn(BlockedStatusReason2 rsn) {
        getRsn().add(rsn);
        return this;
    }
