...
@XmlType(name = "Status12Choice", propOrder = {
    "sts",
    "rjctd"
})
public class Status12Choice {
    ...
    protected List<RejectedReason3Choice> rjctd;
     ...
     *     
     */
    public Status12Choice setSts(AccountManagementStatus1Code value) {
        this.sts = value;
        return this;
    }
     ...
     * {@link RejectedReason3Choice }
     * 
     * 
     */
    public List<RejectedReason3Choice> getRjctd() {
        if (rjctd == null) {
            rjctd = new ArrayList<RejectedReason3Choice>();
        }
        return this.rjctd;
    }
     ...
     * 
     */
    public Status12Choice addRjctd(RejectedReason3Choice rjctd) {
        getRjctd().add(rjctd);
        return this;
    }
