...
public class AccountParties5 {
    ...
    public List<InvestmentAccountOwnershipInformation5> getTrstee() {
        if (trstee == null) {
            trstee = new ArrayList<InvestmentAccountOwnershipInformation5>();
        }
        return this.trstee;
    }
    ...
    public List<InvestmentAccountOwnershipInformation5> getJntOwnr() {
        if (jntOwnr == null) {
            jntOwnr = new ArrayList<InvestmentAccountOwnershipInformation5>();
        }
        return this.jntOwnr;
    }
    ...
    public List<InvestmentAccountOwnershipInformation5> getScndryOwnr() {
        if (scndryOwnr == null) {
            scndryOwnr = new ArrayList<InvestmentAccountOwnershipInformation5>();
        }
    ...
    public List<InvestmentAccountOwnershipInformation5> getBnfcry() {
        if (bnfcry == null) {
            bnfcry = new ArrayList<InvestmentAccountOwnershipInformation5>();
        }
        return this.bnfcry;
    }
    ...
    public List<InvestmentAccountOwnershipInformation5> getPwrOfAttny() {
        if (pwrOfAttny == null) {
            pwrOfAttny = new ArrayList<InvestmentAccountOwnershipInformation5>();
        }
    ...
    public List<InvestmentAccountOwnershipInformation5> getLglGuardn() {
        if (lglGuardn == null) {
            lglGuardn = new ArrayList<InvestmentAccountOwnershipInformation5>();
        }
    ...
    public List<InvestmentAccountOwnershipInformation5> getSucssrOnDth() {
        if (sucssrOnDth == null) {
            sucssrOnDth = new ArrayList<InvestmentAccountOwnershipInformation5>();
        }
    ...
    public List<ExtendedParty2> getOthrPty() {
        if (othrPty == null) {
            othrPty = new ArrayList<ExtendedParty2>();
        }
        return this.othrPty;
    }
    ...
    public List<InvestmentAccountOwnershipInformation5> getGrntr() {
        if (grntr == null) {
            grntr = new ArrayList<InvestmentAccountOwnershipInformation5>();
        }
        return this.grntr;
    }
    ...
    public List<InvestmentAccountOwnershipInformation5> getSttlr() {
        if (sttlr == null) {
            sttlr = new ArrayList<InvestmentAccountOwnershipInformation5>();
        }
        return this.sttlr;
    }
