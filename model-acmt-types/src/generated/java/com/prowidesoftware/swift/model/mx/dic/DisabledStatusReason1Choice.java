...
@XmlType(name = "DisabledStatusReason1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DisabledStatusReason1Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<DisabledStatusReason1> rsn;
     ...
     *     
     */
    public DisabledStatusReason1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link DisabledStatusReason1 }
     * 
     * 
     */
    public List<DisabledStatusReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DisabledStatusReason1>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DisabledStatusReason1Choice addRsn(DisabledStatusReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
