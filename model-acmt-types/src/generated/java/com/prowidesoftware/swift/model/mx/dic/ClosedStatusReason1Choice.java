...
@XmlType(name = "ClosedStatusReason1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class ClosedStatusReason1Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<ClosedStatusReason1> rsn;
     ...
     *     
     */
    public ClosedStatusReason1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link ClosedStatusReason1 }
     * 
     * 
     */
    public List<ClosedStatusReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<ClosedStatusReason1>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public ClosedStatusReason1Choice addRsn(ClosedStatusReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
