...
@XmlType(name = "ClosurePendingStatusReason1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class ClosurePendingStatusReason1Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<ClosurePendingStatusReason1> rsn;
     ...
     *     
     */
    public ClosurePendingStatusReason1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link ClosurePendingStatusReason1 }
     * 
     * 
     */
    public List<ClosurePendingStatusReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<ClosurePendingStatusReason1>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public ClosurePendingStatusReason1Choice addRsn(ClosurePendingStatusReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
