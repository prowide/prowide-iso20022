...
public class Organisation33 {
    ...
    public List<PartyIdentification137> getRprtvOffcr() {
        if (rprtvOffcr == null) {
            rprtvOffcr = new ArrayList<PartyIdentification137>();
        }
    ...
    public List<PartyIdentification137> getMainMndtHldr() {
        if (mainMndtHldr == null) {
            mainMndtHldr = new ArrayList<PartyIdentification137>();
        }
    ...
    public List<PartyIdentification137> getSndr() {
        if (sndr == null) {
            sndr = new ArrayList<PartyIdentification137>();
        }
        return this.sndr;
    }
    ...
    public List<PartyIdentification137> getLglRprtv() {
        if (lglRprtv == null) {
            lglRprtv = new ArrayList<PartyIdentification137>();
        }
