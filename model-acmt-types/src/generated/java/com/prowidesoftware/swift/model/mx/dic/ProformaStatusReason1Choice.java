...
@XmlType(name = "ProformaStatusReason1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class ProformaStatusReason1Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<ProformaStatusReason1> rsn;
     ...
     *     
     */
    public ProformaStatusReason1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link ProformaStatusReason1 }
     * 
     * 
     */
    public List<ProformaStatusReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<ProformaStatusReason1>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public ProformaStatusReason1Choice addRsn(ProformaStatusReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
