...
@XmlType(name = "PendingOpeningStatusReason1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingOpeningStatusReason1Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<PendingOpeningStatusReason1> rsn;
     ...
     *     
     */
    public PendingOpeningStatusReason1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingOpeningStatusReason1 }
     * 
     * 
     */
    public List<PendingOpeningStatusReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingOpeningStatusReason1>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingOpeningStatusReason1Choice addRsn(PendingOpeningStatusReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
