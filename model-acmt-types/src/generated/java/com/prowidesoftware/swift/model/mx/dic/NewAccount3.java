...
public class NewAccount3 {
     ...
     *     
     */
    public NewAccount3 setAcct(CashAccount41 value) {
        this.acct = value;
        return this;
    }
     ...
     * This is why there is not a <CODE>set</CODE> method for the acctPty property.
     * 
     * <p>
    ...
    public List<IndividualPerson36> getAcctPty() {
        if (acctPty == null) {
            acctPty = new ArrayList<IndividualPerson36>();
        }
        return this.acctPty;
    }
     ...
     *     
     */
    public NewAccount3 setOrg(Organisation35 value) {
        this.org = value;
        return this;
    }
     ...
     * 
     */
    public NewAccount3 addAcctPty(IndividualPerson36 acctPty) {
