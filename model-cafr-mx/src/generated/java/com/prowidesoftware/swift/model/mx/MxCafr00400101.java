    ...
    extends AbstractMX
{
    ...
    public static MxCafr00400101 parse(String xml) {
        return ((MxCafr00400101) MxReadImpl.parse(MxCafr00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafr00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafr00400101) MxReadImpl.parse(MxCafr00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCafr00400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafr00400101 .class);
    }
