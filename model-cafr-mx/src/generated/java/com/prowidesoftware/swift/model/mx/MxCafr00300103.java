    ...
    extends AbstractMX
{
    ...
    public static MxCafr00300103 parse(String xml) {
        return ((MxCafr00300103) MxReadImpl.parse(MxCafr00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafr00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafr00300103) MxReadImpl.parse(MxCafr00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCafr00300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafr00300103 .class);
    }
