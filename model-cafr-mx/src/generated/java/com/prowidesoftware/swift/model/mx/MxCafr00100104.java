    ...
    extends AbstractMX
{
    ...
    public static MxCafr00100104 parse(String xml) {
        return ((MxCafr00100104) MxReadImpl.parse(MxCafr00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafr00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafr00100104) MxReadImpl.parse(MxCafr00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCafr00100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafr00100104 .class);
    }
