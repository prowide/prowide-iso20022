    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cafr.002.001.01";
    ...
    public static MxCafr00200101 parse(String xml) {
        return ((MxCafr00200101) MxReadImpl.parse(MxCafr00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafr00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafr00200101) MxReadImpl.parse(MxCafr00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCafr00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafr00200101 .class);
    }
