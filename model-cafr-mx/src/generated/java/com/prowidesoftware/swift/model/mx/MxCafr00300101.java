    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cafr.003.001.01";
    ...
    public static MxCafr00300101 parse(String xml) {
        return ((MxCafr00300101) MxReadImpl.parse(MxCafr00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafr00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafr00300101) MxReadImpl.parse(MxCafr00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCafr00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafr00300101 .class);
    }
