    ...
    extends AbstractMX
{
    ...
    public static MxCafr00200102 parse(String xml) {
        return ((MxCafr00200102) MxReadImpl.parse(MxCafr00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafr00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafr00200102) MxReadImpl.parse(MxCafr00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCafr00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafr00200102 .class);
    }
