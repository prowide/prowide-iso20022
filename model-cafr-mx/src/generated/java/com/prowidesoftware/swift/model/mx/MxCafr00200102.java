...
/**
 * Class for cafr.002.001.02 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:cafr.002.001.02")
public class MxCafr00200102
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCafr00200102(final String xml) {
        this();
        MxCafr00200102 tmp = parse(xml);
     ...
     * 
     */
    public MxCafr00200102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * 
     */
    public static MxCafr00200102 parse(String xml) {
        return ((MxCafr00200102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCafr00200102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCafr00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafr00200102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCafr00200102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCafr00200102 parse(String xml, MxRead parserImpl) {
        return ((MxCafr00200102) parserImpl.read(MxCafr00200102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCafr00200102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCafr00200102 message
     * @return
