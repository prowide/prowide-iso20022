    ...
    extends AbstractMX
{
    ...
    public static MxCafr00100102 parse(String xml) {
        return ((MxCafr00100102) MxReadImpl.parse(MxCafr00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafr00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafr00100102) MxReadImpl.parse(MxCafr00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCafr00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafr00100102 .class);
    }
