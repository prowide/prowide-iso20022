    ...
    extends AbstractMX
{
    ...
    public static MxCafr00400103 parse(String xml) {
        return ((MxCafr00400103) MxReadImpl.parse(MxCafr00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafr00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafr00400103) MxReadImpl.parse(MxCafr00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCafr00400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafr00400103 .class);
    }
