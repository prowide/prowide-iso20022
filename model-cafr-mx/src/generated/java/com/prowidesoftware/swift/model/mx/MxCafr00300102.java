    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cafr.003.001.02";
    ...
    public static MxCafr00300102 parse(String xml) {
        return ((MxCafr00300102) MxReadImpl.parse(MxCafr00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafr00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafr00300102) MxReadImpl.parse(MxCafr00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCafr00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafr00300102 .class);
    }
