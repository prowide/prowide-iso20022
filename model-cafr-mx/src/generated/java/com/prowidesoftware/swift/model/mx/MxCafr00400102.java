    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:cafr.004.001.02";
    ...
    public static MxCafr00400102 parse(String xml) {
        return ((MxCafr00400102) MxReadImpl.parse(MxCafr00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafr00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafr00400102) MxReadImpl.parse(MxCafr00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCafr00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafr00400102 .class);
    }
