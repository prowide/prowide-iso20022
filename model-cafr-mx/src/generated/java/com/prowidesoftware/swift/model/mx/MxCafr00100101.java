    ...
    extends AbstractMX
{
    ...
    public static MxCafr00100101 parse(String xml) {
        return ((MxCafr00100101) MxReadImpl.parse(MxCafr00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCafr00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCafr00100101) MxReadImpl.parse(MxCafr00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCafr00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCafr00100101 .class);
    }
