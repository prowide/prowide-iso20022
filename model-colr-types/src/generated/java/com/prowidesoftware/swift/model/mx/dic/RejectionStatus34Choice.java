...
@XmlType(name = "RejectionStatus34Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectionStatus34Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectionReason55> rsn;
     ...
     *     
     */
    public RejectionStatus34Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectionReason55 }
     * 
     * 
     */
    public List<RejectionReason55> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectionReason55>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectionStatus34Choice addRsn(RejectionReason55 rsn) {
        getRsn().add(rsn);
        return this;
    }
