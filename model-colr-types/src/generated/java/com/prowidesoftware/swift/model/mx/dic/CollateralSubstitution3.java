...
@XmlType(name = "CollateralSubstitution3", propOrder = {
    "collSbstitnSeq",
    "sbstitnRqrmnt",
    "collSbstitnTp",
    "stdSttlmInstrs",
...
public class CollateralSubstitution3 {
     ...
     *     
     */
    public CollateralSubstitution3 setCollSbstitnSeq(CollateralSubstitutionSequence1Code value) {
     ...
     *     
     */
    public CollateralSubstitution3 setSbstitnRqrmnt(ActiveCurrencyAndAmount value) {
     ...
     *     
     */
    public CollateralSubstitution3 setCollSbstitnTp(CollateralSubstitutionType1Code value) {
     ...
     *     
     */
    public CollateralSubstitution3 setStdSttlmInstrs(String value) {
     ...
     *     
     */
    public CollateralSubstitution3 setLkdRefs(Reference17 value) {
        this.lkdRefs = value;
        return this;
    }
     ...
     * 
     */
    public CollateralSubstitution3 addSctiesColl(SecuritiesCollateral3 sctiesColl) {
     ...
     * 
     */
    public CollateralSubstitution3 addCshColl(CashCollateral3 cshColl) {
     ...
     * 
     */
    public CollateralSubstitution3 addOthrColl(OtherCollateral2 othrColl) {
