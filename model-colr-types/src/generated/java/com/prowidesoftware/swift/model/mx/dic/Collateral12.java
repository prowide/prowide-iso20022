...
@XmlType(name = "Collateral12", propOrder = {
    "mrgnCallReqId",
    "mrgnCallRspnId",
    "stdSttlmInstrs",
    "collPrpslRspnId",
...
public class Collateral12 {
     ...
     *     
     */
    public Collateral12 setMrgnCallReqId(String value) {
     ...
     *     
     */
    public Collateral12 setMrgnCallRspnId(String value) {
     ...
     *     
     */
    public Collateral12 setStdSttlmInstrs(String value) {
     ...
     *     
     */
    public Collateral12 setCollPrpslRspnId(String value) {
     ...
     * 
     */
    public Collateral12 addSctiesColl(SecuritiesCollateral5 sctiesColl) {
     ...
     * 
     */
    public Collateral12 addCshColl(CashCollateral3 cshColl) {
     ...
     * 
     */
    public Collateral12 addOthrColl(OtherCollateral5 othrColl) {
