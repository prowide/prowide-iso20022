...
@XmlType(name = "Collateral13", propOrder = {
    "acctId",
    "rptSummry",
    "collValtn"
})
public class Collateral13 {
     ...
     *     
     */
    public CollateralAccount2 getAcctId() {
        return acctId;
    }
     ...
     *     
     */
    public Collateral13 setAcctId(CollateralAccount2 value) {
        this.acctId = value;
        return this;
    }
     ...
     *     
     */
    public Collateral13 setRptSummry(Summary1 value) {
     ...
     * {@link CollateralValuation5 }
     * 
     * 
     */
    public List<CollateralValuation5> getCollValtn() {
        if (collValtn == null) {
            collValtn = new ArrayList<CollateralValuation5>();
        }
     ...
     * 
     */
    public Collateral13 addCollValtn(CollateralValuation5 collValtn) {
