...
@XmlType(name = "RejectionStatus33Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectionStatus33Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectionReason54> rsn;
     ...
     *     
     */
    public RejectionStatus33Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectionReason54 }
     * 
     * 
     */
    public List<RejectionReason54> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectionReason54>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectionStatus33Choice addRsn(RejectionReason54 rsn) {
        getRsn().add(rsn);
        return this;
    }
