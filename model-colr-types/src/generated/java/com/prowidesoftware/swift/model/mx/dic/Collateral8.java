...
public class Collateral8 {
     ...
     * 
     */
    public Collateral8 addSctiesColl(SecuritiesCollateral3 sctiesColl) {
     ...
     * 
     */
    public Collateral8 addCshColl(CashCollateral3 cshColl) {
     ...
     * 
     */
    public Collateral8 addOthrColl(OtherCollateral2 othrColl) {
