...
@XmlType(name = "CollateralMovement12", propOrder = {
    "agrdAmt",
    "mvmntDrctn"
})
public class CollateralMovement12 {

    @XmlElement(name = "AgrdAmt", required = true)
    protected ActiveCurrencyAndAmount agrdAmt;
    @XmlElement(name = "MvmntDrctn")
    protected List<CollateralMovement6Choice> mvmntDrctn;
     ...
     *     
     */
    public CollateralMovement12 setAgrdAmt(ActiveCurrencyAndAmount value) {
        this.agrdAmt = value;
        return this;
    }
     ...
     * {@link CollateralMovement6Choice }
     * 
     * 
     */
    public List<CollateralMovement6Choice> getMvmntDrctn() {
        if (mvmntDrctn == null) {
            mvmntDrctn = new ArrayList<CollateralMovement6Choice>();
        }
     ...
     * 
     */
    public CollateralMovement12 addMvmntDrctn(CollateralMovement6Choice mvmntDrctn) {
