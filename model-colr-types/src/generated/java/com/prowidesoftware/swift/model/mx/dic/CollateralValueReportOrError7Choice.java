...
@XmlType(name = "CollateralValueReportOrError7Choice", propOrder = {
    "bizRpt",
    "oprlErr"
})
public class CollateralValueReportOrError7Choice {

    @XmlElement(name = "BizRpt")
    protected List<CollateralValueReport4> bizRpt;
     ...
     * 
     */
    public CollateralValueReportOrError7Choice addBizRpt(CollateralValueReport4 bizRpt) {
     ...
     * 
     */
    public CollateralValueReportOrError7Choice addOprlErr(ErrorHandling5 oprlErr) {
