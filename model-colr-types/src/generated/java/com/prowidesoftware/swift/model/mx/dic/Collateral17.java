...
@XmlType(name = "Collateral17", propOrder = {
    "mrgnCallReqId",
    "mrgnCallRspnId",
    "stdSttlmInstrs",
    "collPrpslRspnId",
...
public class Collateral17 {
     ...
     *     
     */
    public Collateral17 setMrgnCallReqId(String value) {
     ...
     *     
     */
    public Collateral17 setMrgnCallRspnId(String value) {
     ...
     *     
     */
    public Collateral17 setStdSttlmInstrs(String value) {
     ...
     *     
     */
    public Collateral17 setCollPrpslRspnId(String value) {
     ...
     * 
     */
    public Collateral17 addSctiesColl(SecuritiesCollateral8 sctiesColl) {
     ...
     * 
     */
    public Collateral17 addCshColl(CashCollateral2 cshColl) {
     ...
     * 
     */
    public Collateral17 addOthrColl(OtherCollateral5 othrColl) {
