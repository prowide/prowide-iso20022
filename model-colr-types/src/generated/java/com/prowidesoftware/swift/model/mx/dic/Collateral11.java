...
@XmlType(name = "Collateral11", propOrder = {
    "mrgnCallReqId",
    "mrgnCallRspnId",
    "stdSttlmInstrs",
    "collPrpslRspnId",
...
public class Collateral11 {
     ...
     *     
     */
    public Collateral11 setMrgnCallReqId(String value) {
     ...
     *     
     */
    public Collateral11 setMrgnCallRspnId(String value) {
     ...
     *     
     */
    public Collateral11 setStdSttlmInstrs(String value) {
     ...
     *     
     */
    public Collateral11 setCollPrpslRspnId(String value) {
     ...
     * 
     */
    public Collateral11 addSctiesColl(SecuritiesCollateral5 sctiesColl) {
     ...
     * 
     */
    public Collateral11 addCshColl(CashCollateral2 cshColl) {
     ...
     * 
     */
    public Collateral11 addOthrColl(OtherCollateral5 othrColl) {
