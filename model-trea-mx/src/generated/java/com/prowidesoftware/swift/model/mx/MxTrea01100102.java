    ...
    extends AbstractMX
{
    ...
    public static MxTrea01100102 parse(String xml) {
        return ((MxTrea01100102) MxReadImpl.parse(MxTrea01100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea01100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea01100102) MxReadImpl.parse(MxTrea01100102 .class, xml, _classes, new MxReadParams(conf)));
    }
