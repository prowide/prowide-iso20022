    ...
    extends AbstractMX
{
    ...
    public static MxTrea01200104 parse(String xml) {
        return ((MxTrea01200104) MxReadImpl.parse(MxTrea01200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea01200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea01200104) MxReadImpl.parse(MxTrea01200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrea01200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrea01200104 .class);
    }
