    ...
    extends AbstractMX
{
    ...
    public static MxTrea01100103 parse(String xml) {
        return ((MxTrea01100103) MxReadImpl.parse(MxTrea01100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea01100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea01100103) MxReadImpl.parse(MxTrea01100103 .class, xml, _classes, new MxReadParams(conf)));
    }
