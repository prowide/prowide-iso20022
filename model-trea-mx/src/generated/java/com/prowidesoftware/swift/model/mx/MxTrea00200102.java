    ...
    extends AbstractMX
{
    ...
    public static MxTrea00200102 parse(String xml) {
        return ((MxTrea00200102) MxReadImpl.parse(MxTrea00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea00200102) MxReadImpl.parse(MxTrea00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
