    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {MxTrea00800102 .class, TradeData1 .class, TradeStatus1Code.class, Trea00800102 .class };
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:trea.008.001.02";
    ...
    public static MxTrea00800102 parse(String xml) {
        return ((MxTrea00800102) MxReadImpl.parse(MxTrea00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea00800102) MxReadImpl.parse(MxTrea00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTrea00800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrea00800102 .class);
    }
