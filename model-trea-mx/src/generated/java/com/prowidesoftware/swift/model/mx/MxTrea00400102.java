    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:trea.004.001.02";
    ...
    public static MxTrea00400102 parse(String xml) {
        return ((MxTrea00400102) MxReadImpl.parse(MxTrea00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea00400102) MxReadImpl.parse(MxTrea00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxTrea00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrea00400102 .class);
    }
