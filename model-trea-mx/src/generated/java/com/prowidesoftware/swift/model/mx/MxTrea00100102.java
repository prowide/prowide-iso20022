    ...
    extends AbstractMX
{
    ...
    public static MxTrea00100102 parse(String xml) {
        return ((MxTrea00100102) MxReadImpl.parse(MxTrea00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea00100102) MxReadImpl.parse(MxTrea00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
