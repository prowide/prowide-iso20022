    ...
    extends AbstractMX
{
    ...
    public static MxTrea01300101 parse(String xml) {
        return ((MxTrea01300101) MxReadImpl.parse(MxTrea01300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea01300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea01300101) MxReadImpl.parse(MxTrea01300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrea01300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrea01300101 .class);
    }
