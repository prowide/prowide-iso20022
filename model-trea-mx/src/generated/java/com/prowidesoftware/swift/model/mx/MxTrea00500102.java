    ...
    extends AbstractMX
{
    ...
    public static MxTrea00500102 parse(String xml) {
        return ((MxTrea00500102) MxReadImpl.parse(MxTrea00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea00500102) MxReadImpl.parse(MxTrea00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
