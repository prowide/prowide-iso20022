    ...
    extends AbstractMX
{
    ...
    public static MxTrea01000102 parse(String xml) {
        return ((MxTrea01000102) MxReadImpl.parse(MxTrea01000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea01000102) MxReadImpl.parse(MxTrea01000102 .class, xml, _classes, new MxReadParams(conf)));
    }
