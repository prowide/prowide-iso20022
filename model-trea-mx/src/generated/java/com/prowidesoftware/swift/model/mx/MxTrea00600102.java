    ...
    extends AbstractMX
{
    ...
    public static MxTrea00600102 parse(String xml) {
        return ((MxTrea00600102) MxReadImpl.parse(MxTrea00600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea00600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea00600102) MxReadImpl.parse(MxTrea00600102 .class, xml, _classes, new MxReadParams(conf)));
    }
