    ...
    extends AbstractMX
{
    ...
    public static MxTrea00900103 parse(String xml) {
        return ((MxTrea00900103) MxReadImpl.parse(MxTrea00900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea00900103) MxReadImpl.parse(MxTrea00900103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrea00900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrea00900103 .class);
    }
