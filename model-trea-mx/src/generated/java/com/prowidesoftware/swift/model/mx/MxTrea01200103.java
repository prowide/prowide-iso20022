    ...
    extends AbstractMX
{
    ...
    public static MxTrea01200103 parse(String xml) {
        return ((MxTrea01200103) MxReadImpl.parse(MxTrea01200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea01200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea01200103) MxReadImpl.parse(MxTrea01200103 .class, xml, _classes, new MxReadParams(conf)));
    }
