    ...
    extends AbstractMX
{
    ...
    public static MxTrea01000103 parse(String xml) {
        return ((MxTrea01000103) MxReadImpl.parse(MxTrea01000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea01000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea01000103) MxReadImpl.parse(MxTrea01000103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrea01000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrea01000103 .class);
    }
