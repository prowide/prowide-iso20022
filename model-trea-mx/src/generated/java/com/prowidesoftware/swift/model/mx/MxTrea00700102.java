    ...
    extends AbstractMX
{
    ...
    public static MxTrea00700102 parse(String xml) {
        return ((MxTrea00700102) MxReadImpl.parse(MxTrea00700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea00700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea00700102) MxReadImpl.parse(MxTrea00700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrea00700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrea00700102 .class);
    }
