    ...
    extends AbstractMX
{
    ...
    public static MxTrea01200102 parse(String xml) {
        return ((MxTrea01200102) MxReadImpl.parse(MxTrea01200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea01200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea01200102) MxReadImpl.parse(MxTrea01200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrea01200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrea01200102 .class);
    }
