    ...
    extends AbstractMX
{
    ...
    public static MxTrea00900102 parse(String xml) {
        return ((MxTrea00900102) MxReadImpl.parse(MxTrea00900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxTrea00900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxTrea00900102) MxReadImpl.parse(MxTrea00900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxTrea00900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxTrea00900102 .class);
    }
