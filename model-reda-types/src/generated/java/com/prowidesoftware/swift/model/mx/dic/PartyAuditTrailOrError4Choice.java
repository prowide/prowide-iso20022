...
@XmlType(name = "PartyAuditTrailOrError4Choice", propOrder = {
    "audtTrl",
    "bizErr"
})
public class PartyAuditTrailOrError4Choice {

    @XmlElement(name = "AudtTrl")
    protected List<PartyAuditTrail2> audtTrl;
     ...
     * {@link PartyAuditTrail2 }
     * 
     * 
     */
    public List<PartyAuditTrail2> getAudtTrl() {
        if (audtTrl == null) {
            audtTrl = new ArrayList<PartyAuditTrail2>();
        }
        return this.audtTrl;
    }
     ...
     * 
     */
    public PartyAuditTrailOrError4Choice addAudtTrl(PartyAuditTrail2 audtTrl) {
     ...
     * 
     */
    public PartyAuditTrailOrError4Choice addBizErr(ErrorHandling5 bizErr) {
