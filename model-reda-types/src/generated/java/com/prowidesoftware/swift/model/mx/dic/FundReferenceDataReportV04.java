...
@XmlType(name = "FundReferenceDataReportV04", propOrder = {
    "msgId",
    "prvsRef",
    "rltdRef",
    "fndRefDataRptId",
...
public class FundReferenceDataReportV04 {
    ...
    protected List<FundReferenceDataReport2> rpt;
     ...
     *     
     */
    public FundReferenceDataReportV04 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
     ...
     *     
     */
    public FundReferenceDataReportV04 setRltdRef(AdditionalReference10 value) {
        this.rltdRef = value;
        return this;
    }
     ...
     *     
     */
    public FundReferenceDataReportV04 setFndRefDataRptId(String value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FundReferenceDataReport2 }
     * 
     * 
     */
    public List<FundReferenceDataReport2> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<FundReferenceDataReport2>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public FundReferenceDataReportV04 addPrvsRef(AdditionalReference10 prvsRef) {
     ...
     * 
     */
    public FundReferenceDataReportV04 addRpt(FundReferenceDataReport2 rpt) {
        getRpt().add(rpt);
        return this;
    }
