...
@XmlType(name = "DeniedStatus22Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus22Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason18> rsn;
     ...
     *     
     */
    public DeniedStatus22Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason18> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason18>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus22Choice addRsn(DeniedReason18 rsn) {
        getRsn().add(rsn);
        return this;
    }
