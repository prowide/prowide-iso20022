...
@XmlType(name = "LocalMarketAnnex4", propOrder = {
    "ctry",
    "lclOrdrDsk",
    "sbcptPrcgChrtcs",
    "redPrcgChrtcs",
...
public class LocalMarketAnnex4 {
     ...
     *     
     */
    public LocalMarketAnnex4 setLclOrdrDsk(OrderDesk1 value) {
     ...
     *     
     */
    public LocalMarketAnnex4 setSbcptPrcgChrtcs(ProcessingCharacteristics8 value) {
     ...
     *     
     */
    public LocalMarketAnnex4 setRedPrcgChrtcs(ProcessingCharacteristics5 value) {
     ...
     *     
     */
    public LocalMarketAnnex4 setSwtchPrcgChrtcs(ProcessingCharacteristics6 value) {
     ...
     * 
     */
    public LocalMarketAnnex4 addCtry(String ctry) {
        getCtry().add(ctry);
        return this;
    }
     ...
     * 
     */
    public LocalMarketAnnex4 addCshSttlmDtls(CashAccount202 cshSttlmDtls) {
     ...
     * 
     */
    public LocalMarketAnnex4 addAddtlInf(AdditionalInformation15 addtlInf) {
