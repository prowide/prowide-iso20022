...
@XmlType(name = "RequestToPayDebtorActivationRequestV02", propOrder = {
    "hdr",
    "dbtrActvtn",
    "elctrncInvcData",
    "splmtryData"
})
public class RequestToPayDebtorActivationRequestV02 {

    @XmlElement(name = "Hdr", required = true)
    protected ActivationHeader3 hdr;
    @XmlElement(name = "DbtrActvtn", required = true)
    protected List<DebtorActivation5> dbtrActvtn;
     ...
     *     
     */
    public RequestToPayDebtorActivationRequestV02 setHdr(ActivationHeader3 value) {
        this.hdr = value;
        return this;
    }
     ...
     * This is why there is not a <CODE>set</CODE> method for the dbtrActvtn property.
     * 
     * <p>
     ...
     * 
     */
    public List<DebtorActivation5> getDbtrActvtn() {
        if (dbtrActvtn == null) {
            dbtrActvtn = new ArrayList<DebtorActivation5>();
        }
     ...
     *     
     */
    public RequestToPayDebtorActivationRequestV02 setElctrncInvcData(ElectronicInvoice1 value) {
     ...
     * 
     */
    public RequestToPayDebtorActivationRequestV02 addDbtrActvtn(DebtorActivation5 dbtrActvtn) {
     ...
     * 
     */
    public RequestToPayDebtorActivationRequestV02 addSplmtryData(SupplementaryData1 splmtryData) {
