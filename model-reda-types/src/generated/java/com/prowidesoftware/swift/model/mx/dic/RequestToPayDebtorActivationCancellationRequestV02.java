...
@XmlType(name = "RequestToPayDebtorActivationCancellationRequestV02", propOrder = {
    "hdr",
    "cxlData",
    "splmtryData"
})
public class RequestToPayDebtorActivationCancellationRequestV02 {

    @XmlElement(name = "Hdr", required = true)
    protected ActivationHeader3 hdr;
    @XmlElement(name = "CxlData", required = true)
    protected List<DebtorActivationCancellation3> cxlData;
     ...
     *     
     */
    public RequestToPayDebtorActivationCancellationRequestV02 setHdr(ActivationHeader3 value) {
        this.hdr = value;
        return this;
    }
     ...
     * {@link DebtorActivationCancellation3 }
     * 
     * 
     */
    public List<DebtorActivationCancellation3> getCxlData() {
        if (cxlData == null) {
            cxlData = new ArrayList<DebtorActivationCancellation3>();
        }
        return this.cxlData;
    }
     ...
     * 
     */
    public RequestToPayDebtorActivationCancellationRequestV02 addCxlData(DebtorActivationCancellation3 cxlData) {
     ...
     * 
     */
    public RequestToPayDebtorActivationCancellationRequestV02 addSplmtryData(SupplementaryData1 splmtryData) {
