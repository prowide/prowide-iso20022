...
@XmlType(name = "CollateralStatusReason1", propOrder = {
    "sts",
    "rsn"
})
public class CollateralStatusReason1 {
    ...
    @XmlElement(name = "Rsn")
    protected List<StatusReasonInformation10> rsn;
     ...
     *     
     */
    public CollateralStatusReason1 setSts(Status6Code value) {
        this.sts = value;
        return this;
    }
     ...
     */
    public List<StatusReasonInformation10> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public CollateralStatusReason1 addRsn(StatusReasonInformation10 rsn) {
        getRsn().add(rsn);
        return this;
    }
