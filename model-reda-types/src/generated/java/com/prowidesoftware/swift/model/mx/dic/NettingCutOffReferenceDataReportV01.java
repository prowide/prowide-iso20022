...
public class NettingCutOffReferenceDataReportV01 {
     ...
     * This is why there is not a {@code set} method for the ptcptNetgCutOffData property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the ptcptNetgCutOffData property.
     */
    public List<CutOffData1> getPtcptNetgCutOffData() {
        if (ptcptNetgCutOffData == null) {
            ptcptNetgCutOffData = new ArrayList<>();
        }
