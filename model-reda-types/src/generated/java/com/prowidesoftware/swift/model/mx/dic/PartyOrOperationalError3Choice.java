...
public class PartyOrOperationalError3Choice {
    ...
    public List<PartyReport3> getPtyRpt() {
        if (ptyRpt == null) {
            ptyRpt = new ArrayList<PartyReport3>();
        }
        return this.ptyRpt;
    }
     ...
     * 
     */
    public PartyOrOperationalError3Choice addPtyRpt(PartyReport3 ptyRpt) {
     ...
     * 
     */
    public PartyOrOperationalError3Choice addOprlErr(ErrorHandling5 oprlErr) {
