...
@XmlType(name = "PartyOrBusinessError3Choice", propOrder = {
    "sysPty",
    "bizErr"
})
public class PartyOrBusinessError3Choice {

    @XmlElement(name = "SysPty")
    protected SystemParty5 sysPty;
     ...
     *     
     */
    public PartyOrBusinessError3Choice setSysPty(SystemParty5 value) {
        this.sysPty = value;
        return this;
    }
     ...
     * 
     */
    public PartyOrBusinessError3Choice addBizErr(ErrorHandling4 bizErr) {
