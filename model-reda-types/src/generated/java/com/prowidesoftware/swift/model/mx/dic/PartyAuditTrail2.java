...
@XmlType(name = "PartyAuditTrail2", propOrder = {
    "rcrd",
    "oprTmStmp",
    "instgUsr",
    "apprvgUsr"
...
public class PartyAuditTrail2 {
     ...
     *     
     */
    public PartyAuditTrail2 setInstgUsr(String value) {
        this.instgUsr = value;
        return this;
    }
     ...
     *     
     */
    public PartyAuditTrail2 setApprvgUsr(String value) {
     ...
     * 
     */
    public PartyAuditTrail2 addRcrd(UpdateLogPartyRecord2Choice rcrd) {
        getRcrd().add(rcrd);
        return this;
    }
