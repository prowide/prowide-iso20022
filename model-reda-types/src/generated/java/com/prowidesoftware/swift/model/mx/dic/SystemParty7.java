...
@XmlType(name = "SystemParty7", propOrder = {
    "ptyId",
    "adr",
    "ctctDtls",
    "opngDt",
...
public class SystemParty7 {

    @XmlElement(name = "PtyId", required = true)
    protected SystemPartyIdentification9 ptyId;
    @XmlElement(name = "Adr")
    protected List<PostalAddress28> adr;
     ...
     *     
     */
    public SystemParty7 setPtyId(SystemPartyIdentification9 value) {
        this.ptyId = value;
        return this;
    }
     ...
     * 
     */
    public List<PostalAddress28> getAdr() {
        if (adr == null) {
            adr = new ArrayList<PostalAddress28>();
        }
        return this.adr;
    }
    ...
    public List<Contact14> getCtctDtls() {
        if (ctctDtls == null) {
            ctctDtls = new ArrayList<Contact14>();
        }
     ...
     *     
     */
    public SystemParty7 setOpngDt(XMLGregorianCalendar value) {
        this.opngDt = value;
        return this;
    }
     ...
     *     
     */
    public SystemParty7 setClsgDt(XMLGregorianCalendar value) {
        this.clsgDt = value;
        return this;
    }
     ...
     *     
     */
    public SystemParty7 setTp(SystemPartyType1Choice value) {
        this.tp = value;
        return this;
    }
     ...
     *     
     */
    public SystemParty7 setNm(PartyName4 value) {
        this.nm = value;
        return this;
    }
     ...
     *     
     */
    public SystemParty7 setResTp(ResidenceType1Code value) {
        this.resTp = value;
        return this;
    }
     ...
     *     
     */
    public SystemParty7 setLckSts(PartyLockStatus1 value) {
        this.lckSts = value;
        return this;
    }
     ...
     * 
     */
    public SystemParty7 addAdr(PostalAddress28 adr) {
        getAdr().add(adr);
        return this;
    }
     ...
     * 
     */
    public SystemParty7 addCtctDtls(Contact14 ctctDtls) {
     ...
     * 
     */
    public SystemParty7 addTechAdr(TechnicalIdentification2Choice techAdr) {
     ...
     * 
     */
    public SystemParty7 addMktSpcfcAttr(MarketSpecificAttribute1 mktSpcfcAttr) {
     ...
     * 
     */
    public SystemParty7 addRstrctn(SystemRestriction1 rstrctn) {
