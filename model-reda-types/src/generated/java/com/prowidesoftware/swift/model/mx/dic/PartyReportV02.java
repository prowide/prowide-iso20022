...
@XmlType(name = "PartyReportV02", propOrder = {
    "msgHdr",
    "rptOrErr",
    "splmtryData"
})
public class PartyReportV02 {

    @XmlElement(name = "MsgHdr")
    protected MessageHeader3 msgHdr;
    @XmlElement(name = "RptOrErr", required = true)
    protected PartyOrOperationalError4Choice rptOrErr;
     ...
     *     
     */
    public PartyReportV02 setMsgHdr(MessageHeader3 value) {
        this.msgHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link PartyOrOperationalError4Choice }
     *     
     */
    public PartyOrOperationalError4Choice getRptOrErr() {
        return rptOrErr;
    }
     ...
     *     
     */
    public PartyReportV02 setRptOrErr(PartyOrOperationalError4Choice value) {
        this.rptOrErr = value;
        return this;
    }
     ...
     * 
     */
    public PartyReportV02 addSplmtryData(SupplementaryData1 splmtryData) {
