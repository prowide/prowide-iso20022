...
@XmlType(name = "CashAccountStatement2", propOrder = {
    "sysDt",
    "chng"
})
public class CashAccountStatement2 {
    ...
    protected List<CashAccountReferenceDataChange2> chng;
     ...
     *     
     */
    public CashAccountStatement2 setSysDt(LocalDate value) {
        this.sysDt = value;
        return this;
    }
     ...
     * {@link CashAccountReferenceDataChange2 }
     * 
     * 
     * @return
     *     The value of the chng property.
     */
    public List<CashAccountReferenceDataChange2> getChng() {
        if (chng == null) {
            chng = new ArrayList<>();
        }
        return this.chng;
     ...
     * 
     */
    public CashAccountStatement2 addChng(CashAccountReferenceDataChange2 chng) {
        getChng().add(chng);
        return this;
    }
