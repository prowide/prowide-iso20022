...
@XmlType(name = "CreditorInvoice4", propOrder = {
    "ltdPresntmntInd",
    "cstmrIdTp",
    "ctrctFrmtTp",
    "ctrctRefTp",
...
public class CreditorInvoice4 {
     ...
     *     
     */
    public CreditorInvoice4 setLtdPresntmntInd(Boolean value) {
     ...
     *     
     */
    public CreditorInvoice4 setCstmrIdTp(CustomerTypeRequest2 value) {
     ...
     *     
     */
    public CreditorInvoice4 setCdtrInstr(String value) {
     ...
     *     
     */
    public CreditorInvoice4 setActvtnReqDlvryPty(RTPPartyIdentification1 value) {
     ...
     * 
     */
    public CreditorInvoice4 addCtrctFrmtTp(DocumentFormat2Choice ctrctFrmtTp) {
     ...
     * 
     */
    public CreditorInvoice4 addCtrctRefTp(DocumentType1Choice ctrctRefTp) {
