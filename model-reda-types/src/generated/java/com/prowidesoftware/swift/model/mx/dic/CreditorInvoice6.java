...
@XmlType(name = "CreditorInvoice6", propOrder = {
    "ltdPresntmntInd",
    "cstmrIdTp",
    "ctrctFrmtTp",
    "ctrctRefTp",
...
public class CreditorInvoice6 {
     ...
     * 
     */
    public CreditorInvoice6 setLtdPresntmntInd(boolean value) {
     ...
     *     
     */
    public CreditorInvoice6 setCstmrIdTp(CustomerTypeRequest2 value) {
     ...
     *     
     */
    public CreditorInvoice6 setCdtrInstr(String value) {
     ...
     *     
     */
    public CreditorInvoice6 setActvtnReqDlvryPty(RTPPartyIdentification2 value) {
     ...
     * 
     */
    public CreditorInvoice6 addCtrctFrmtTp(DocumentFormat2Choice ctrctFrmtTp) {
     ...
     * 
     */
    public CreditorInvoice6 addCtrctRefTp(DocumentType1Choice ctrctRefTp) {
