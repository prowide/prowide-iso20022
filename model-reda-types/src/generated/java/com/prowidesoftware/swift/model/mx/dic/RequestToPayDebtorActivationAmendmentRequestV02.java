...
@XmlType(name = "RequestToPayDebtorActivationAmendmentRequestV02", propOrder = {
    "hdr",
    "amdmntData",
    "splmtryData"
})
public class RequestToPayDebtorActivationAmendmentRequestV02 {

    @XmlElement(name = "Hdr", required = true)
    protected ActivationHeader3 hdr;
    @XmlElement(name = "AmdmntData", required = true)
    protected List<DebtorActivationAmendment5> amdmntData;
     ...
     *     
     */
    public RequestToPayDebtorActivationAmendmentRequestV02 setHdr(ActivationHeader3 value) {
        this.hdr = value;
        return this;
    }
     ...
     * {@link DebtorActivationAmendment5 }
     * 
     * 
     */
    public List<DebtorActivationAmendment5> getAmdmntData() {
        if (amdmntData == null) {
            amdmntData = new ArrayList<DebtorActivationAmendment5>();
        }
     ...
     * 
     */
    public RequestToPayDebtorActivationAmendmentRequestV02 addAmdmntData(DebtorActivationAmendment5 amdmntData) {
     ...
     * 
     */
    public RequestToPayDebtorActivationAmendmentRequestV02 addSplmtryData(SupplementaryData1 splmtryData) {
