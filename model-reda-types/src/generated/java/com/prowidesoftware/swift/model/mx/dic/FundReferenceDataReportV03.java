...
@XmlType(name = "FundReferenceDataReportV03", propOrder = {
    "msgId",
    "prvsRef",
    "rltdRef",
    "fndRefDataRptId",
...
public class FundReferenceDataReportV03 {
    ...
    protected List<FundReferenceDataReport1> rpt;
     ...
     *     
     */
    public FundReferenceDataReportV03 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
     ...
     *     
     */
    public FundReferenceDataReportV03 setRltdRef(AdditionalReference10 value) {
        this.rltdRef = value;
        return this;
    }
     ...
     *     
     */
    public FundReferenceDataReportV03 setFndRefDataRptId(String value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FundReferenceDataReport1 }
     * 
     * 
     */
    public List<FundReferenceDataReport1> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<FundReferenceDataReport1>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public FundReferenceDataReportV03 addPrvsRef(AdditionalReference10 prvsRef) {
     ...
     * 
     */
    public FundReferenceDataReportV03 addRpt(FundReferenceDataReport1 rpt) {
        getRpt().add(rpt);
        return this;
    }
