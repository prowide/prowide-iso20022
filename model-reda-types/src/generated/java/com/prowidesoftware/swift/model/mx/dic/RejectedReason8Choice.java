...
@XmlType(name = "RejectedReason8Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedReason8Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RejectedReason7Choice> rsn;
     ...
     *     
     */
    public RejectedReason8Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link RejectedReason7Choice }
     * 
     * 
     */
    public List<RejectedReason7Choice> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectedReason7Choice>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedReason8Choice addRsn(RejectedReason7Choice rsn) {
        getRsn().add(rsn);
        return this;
    }
