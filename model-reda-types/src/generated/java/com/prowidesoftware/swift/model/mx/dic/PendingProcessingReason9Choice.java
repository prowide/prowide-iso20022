...
@XmlType(name = "PendingProcessingReason9Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingProcessingReason9Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<PendingProcessingReason8Choice> rsn;
     ...
     *     
     */
    public PendingProcessingReason9Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public PendingProcessingReason9Choice addRsn(PendingProcessingReason8Choice rsn) {
        getRsn().add(rsn);
        return this;
    }
