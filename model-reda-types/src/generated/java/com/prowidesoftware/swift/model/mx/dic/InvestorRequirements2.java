...
@XmlType(name = "InvestorRequirements2", propOrder = {
    "rtrPrflPrsrvtn",
    "rtrPrflGrwth",
    "rtrPrflIncm",
    "rtrPrflHdgg",
...
public class InvestorRequirements2 {
     ...
     *     
     */
    public InvestorRequirements2 setRtrPrflPrsrvtn(TargetMarket1Code value) {
     ...
     *     
     */
    public InvestorRequirements2 setRtrPrflGrwth(TargetMarket1Code value) {
     ...
     *     
     */
    public InvestorRequirements2 setRtrPrflIncm(TargetMarket1Code value) {
     ...
     *     
     */
    public InvestorRequirements2 setRtrPrflHdgg(TargetMarket1Code value) {
     ...
     *     
     */
    public InvestorRequirements2 setOptnOrLvrgdRtrPrfl(TargetMarket1Code value) {
     ...
     *     
     */
    public InvestorRequirements2 setRtrPrflPnsnSchmeDE(TargetMarket1Code value) {
     ...
     *     
     */
    public InvestorRequirements2 setMinHldgPrd(TimeHorizon2Choice value) {
     ...
     *     
     */
    public InvestorRequirements2 setESGPrefs(TargetMarket2Code value) {
        this.esgPrefs = value;
        return this;
    }
     ...
     *     
     */
    public InvestorRequirements2 setOthrSpcfcInvstmtNeed(InvestmentNeed2Choice value) {
     ...
     * 
     */
    public InvestorRequirements2 addOthr(OtherInvestmentNeed1 othr) {
        getOthr().add(othr);
        return this;
    }
