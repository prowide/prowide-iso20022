...
public class FundReferenceDataReportV06 {
     ...
     *     
     */
    public FundReferenceDataReportV06 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
     ...
     *     
     */
    public FundReferenceDataReportV06 setRltdRef(AdditionalReference10 value) {
        this.rltdRef = value;
        return this;
    }
     ...
     *     
     */
    public FundReferenceDataReportV06 setFndRefDataRptId(String value) {
    ...
    public List<FundReferenceDataReport4> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<FundReferenceDataReport4>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public FundReferenceDataReportV06 addPrvsRef(AdditionalReference10 prvsRef) {
     ...
     * 
     */
    public FundReferenceDataReportV06 addRpt(FundReferenceDataReport4 rpt) {
        getRpt().add(rpt);
        return this;
    }
