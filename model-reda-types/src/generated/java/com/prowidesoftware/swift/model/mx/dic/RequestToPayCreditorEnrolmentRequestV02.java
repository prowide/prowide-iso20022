...
@XmlType(name = "RequestToPayCreditorEnrolmentRequestV02", propOrder = {
    "hdr",
    "cdtrEnrlmnt",
    "actvtnData",
    "splmtryData"
})
public class RequestToPayCreditorEnrolmentRequestV02 {

    @XmlElement(name = "Hdr", required = true)
    protected EnrolmentHeader3 hdr;
    @XmlElement(name = "CdtrEnrlmnt", required = true)
    protected List<CreditorEnrolment5> cdtrEnrlmnt;
    @XmlElement(name = "ActvtnData", required = true)
    protected CreditorInvoice6 actvtnData;
     ...
     *     
     */
    public RequestToPayCreditorEnrolmentRequestV02 setHdr(EnrolmentHeader3 value) {
        this.hdr = value;
        return this;
    }
     ...
     * This is why there is not a <CODE>set</CODE> method for the cdtrEnrlmnt property.
     * 
     * <p>
     ...
     * 
     */
    public List<CreditorEnrolment5> getCdtrEnrlmnt() {
        if (cdtrEnrlmnt == null) {
            cdtrEnrlmnt = new ArrayList<CreditorEnrolment5>();
        }
     ...
     * @return
     *     possible object is
     *     {@link CreditorInvoice6 }
     *     
     */
    public CreditorInvoice6 getActvtnData() {
        return actvtnData;
    }
     ...
     *     
     */
    public RequestToPayCreditorEnrolmentRequestV02 setActvtnData(CreditorInvoice6 value) {
     ...
     * 
     */
    public RequestToPayCreditorEnrolmentRequestV02 addCdtrEnrlmnt(CreditorEnrolment5 cdtrEnrlmnt) {
     ...
     * 
     */
    public RequestToPayCreditorEnrolmentRequestV02 addSplmtryData(SupplementaryData1 splmtryData) {
