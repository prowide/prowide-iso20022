...
@XmlType(name = "ProprietaryReason1Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class ProprietaryReason1Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<GenericIdentification36> rsn;
     ...
     *     
     */
    public ProprietaryReason1Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<GenericIdentification36> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<GenericIdentification36>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public ProprietaryReason1Choice addRsn(GenericIdentification36 rsn) {
        getRsn().add(rsn);
        return this;
    }
