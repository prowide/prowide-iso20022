    ...
    extends AbstractMX
{
    ...
    public static MxCanm00400103 parse(String xml) {
        return ((MxCanm00400103) MxReadImpl.parse(MxCanm00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCanm00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCanm00400103) MxReadImpl.parse(MxCanm00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCanm00400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCanm00400103 .class);
    }
