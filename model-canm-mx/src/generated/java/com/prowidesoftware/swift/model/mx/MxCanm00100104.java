    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:canm.001.001.04";
    ...
    public static MxCanm00100104 parse(String xml) {
        return ((MxCanm00100104) MxReadImpl.parse(MxCanm00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCanm00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCanm00100104) MxReadImpl.parse(MxCanm00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCanm00100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCanm00100104 .class);
    }
