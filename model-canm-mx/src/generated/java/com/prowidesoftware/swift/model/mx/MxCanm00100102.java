    ...
    extends AbstractMX
{
    ...
    public static MxCanm00100102 parse(String xml) {
        return ((MxCanm00100102) MxReadImpl.parse(MxCanm00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCanm00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCanm00100102) MxReadImpl.parse(MxCanm00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCanm00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCanm00100102 .class);
    }
