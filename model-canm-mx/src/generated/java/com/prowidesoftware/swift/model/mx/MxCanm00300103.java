    ...
    extends AbstractMX
{
    ...
    public static MxCanm00300103 parse(String xml) {
        return ((MxCanm00300103) MxReadImpl.parse(MxCanm00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCanm00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCanm00300103) MxReadImpl.parse(MxCanm00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCanm00300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCanm00300103 .class);
    }
