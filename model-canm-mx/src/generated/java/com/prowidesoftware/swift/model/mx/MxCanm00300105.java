    ...
    extends AbstractMX
{
    ...
    public static MxCanm00300105 parse(String xml) {
        return ((MxCanm00300105) MxReadImpl.parse(MxCanm00300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCanm00300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCanm00300105) MxReadImpl.parse(MxCanm00300105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCanm00300105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCanm00300105 .class);
    }
