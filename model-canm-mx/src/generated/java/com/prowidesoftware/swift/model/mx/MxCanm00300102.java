    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:canm.003.001.02";
    ...
    public static MxCanm00300102 parse(String xml) {
        return ((MxCanm00300102) MxReadImpl.parse(MxCanm00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCanm00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCanm00300102) MxReadImpl.parse(MxCanm00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCanm00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCanm00300102 .class);
    }
