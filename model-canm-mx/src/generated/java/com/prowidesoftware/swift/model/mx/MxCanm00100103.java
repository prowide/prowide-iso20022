    ...
    extends AbstractMX
{
    ...
    public static MxCanm00100103 parse(String xml) {
        return ((MxCanm00100103) MxReadImpl.parse(MxCanm00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCanm00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCanm00100103) MxReadImpl.parse(MxCanm00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCanm00100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCanm00100103 .class);
    }
