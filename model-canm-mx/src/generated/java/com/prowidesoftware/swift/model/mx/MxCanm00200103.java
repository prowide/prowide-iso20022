    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:canm.002.001.03";
    ...
    public static MxCanm00200103 parse(String xml) {
        return ((MxCanm00200103) MxReadImpl.parse(MxCanm00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCanm00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCanm00200103) MxReadImpl.parse(MxCanm00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCanm00200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCanm00200103 .class);
    }
