...
/**
 * Scope
 * An account owner sends a SecuritiesFinancingModificationInstruction to a securities financing transaction account servicer to notify the securities financing transaction account servicer of an update in the details of a repurchase agreement, reverse repurchase agreement, securities lending or securities borrowing transaction that does not impact the original transaction securities quantity or the instrument itself. Examples of such a change may be: 
 ...
 * - the providing of a new rate (repo rate), 
...
@XmlType(name = "SecuritiesFinancingModificationInstructionV1", propOrder = {
    "id",
...
public class SecuritiesFinancingModificationInstructionV1 {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstructionV1 setId(DocumentIdentification11 value) {
        this.id = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesFinancingModificationInstructionV1 setTxTpAndModAddtlParams(TransactionTypeAndAdditionalParameters2 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstructionV1 setTradDtls(SecuritiesTradeDetails5 value) {
        this.tradDtls = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesFinancingModificationInstructionV1 setFinInstrmId(SecurityIdentification11 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstructionV1 setQtyAndAcctDtls(QuantityAndAccount7 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstructionV1 setSctiesFincgAddtlDtls(SecuritiesFinancingTransactionDetails1 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstructionV1 setSttlmParams(SettlementDetails3 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstructionV1 setDlvrgSttlmPties(SettlementParties5 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstructionV1 setRcvgSttlmPties(SettlementParties5 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstructionV1 setOpngSttlmAmt(AmountAndDirection10 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstructionV1 setMsgOrgtr(PartyIdentification10Choice value) {
        this.msgOrgtr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesFinancingModificationInstructionV1 setMsgRcpt(PartyIdentification10Choice value) {
        this.msgRcpt = value;
        return this;
    }
     ...
     * 
     */
    public SecuritiesFinancingModificationInstructionV1 addXtnsn(Extension2 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
