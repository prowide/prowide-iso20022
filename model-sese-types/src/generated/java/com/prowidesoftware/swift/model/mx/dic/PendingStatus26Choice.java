...
@XmlType(name = "PendingStatus26Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus26Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingReason4> rsn;
     ...
     *     
     */
    public PendingStatus26Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<PendingReason4> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingReason4>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus26Choice addRsn(PendingReason4 rsn) {
        getRsn().add(rsn);
        return this;
    }
