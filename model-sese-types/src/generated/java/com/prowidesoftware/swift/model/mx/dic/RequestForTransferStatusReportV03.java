...
@XmlType(name = "RequestForTransferStatusReportV03", propOrder = {
    "msgId",
    "reqDtls",
    "xtnsn"
})
public class RequestForTransferStatusReportV03 {
     ...
     *     
     */
    public RequestForTransferStatusReportV03 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
    ...
    public List<MessageAndBusinessReference6> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<MessageAndBusinessReference6>();
        }
        return this.reqDtls;
    }
     ...
     * 
     */
    public RequestForTransferStatusReportV03 addReqDtls(MessageAndBusinessReference6 reqDtls) {
     ...
     * 
     */
    public RequestForTransferStatusReportV03 addXtnsn(Extension1 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
