...
@XmlType(name = "AcceptedStatus4Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class AcceptedStatus4Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<AcceptedStatusReason4> rsn;
     ...
     *     
     */
    public AcceptedStatus4Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link AcceptedStatusReason4 }
     * 
     * 
     */
    public List<AcceptedStatusReason4> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<AcceptedStatusReason4>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AcceptedStatus4Choice addRsn(AcceptedStatusReason4 rsn) {
        getRsn().add(rsn);
        return this;
    }
