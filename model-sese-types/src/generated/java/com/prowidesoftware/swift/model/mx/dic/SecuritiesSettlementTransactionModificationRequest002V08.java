...
@XmlType(name = "SecuritiesSettlementTransactionModificationRequest002V08", propOrder = {
    "modfdTxDtls",
    "updTp"
})
public class SecuritiesSettlementTransactionModificationRequest002V08 {

    @XmlElement(name = "ModfdTxDtls", required = true)
    protected TransactionDetails119 modfdTxDtls;
    @XmlElement(name = "UpdTp", required = true)
    protected List<UpdateType34Choice> updTp;
     ...
     *     
     */
    public SecuritiesSettlementTransactionModificationRequest002V08 setModfdTxDtls(TransactionDetails119 value) {
     ...
     * {@link UpdateType34Choice }
     * 
     * 
     */
    public List<UpdateType34Choice> getUpdTp() {
        if (updTp == null) {
            updTp = new ArrayList<UpdateType34Choice>();
        }
        return this.updTp;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionModificationRequest002V08 addUpdTp(UpdateType34Choice updTp) {
        getUpdTp().add(updTp);
        return this;
    }
