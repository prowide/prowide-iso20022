...
@XmlType(name = "DocumentNumber4", propOrder = {
    "nb",
    "refs"
})
public class DocumentNumber4 {
     ...
     *     
     */
    public DocumentNumber4 setNb(DocumentNumber2Choice value) {
        this.nb = value;
        return this;
    }
     ...
     * {@link Identification5 }
     * 
     * 
     */
    public List<Identification5> getRefs() {
        if (refs == null) {
            refs = new ArrayList<Identification5>();
        }
        return this.refs;
    }
     ...
     * 
     */
    public DocumentNumber4 addRefs(Identification5 refs) {
        getRefs().add(refs);
        return this;
    }
