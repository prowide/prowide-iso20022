...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequestV04", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "reqDtls",
    "addtlInf",
...
public class SecuritiesSettlementConditionsModificationRequestV04 {
    ...
    protected List<RequestDetails11> reqDtls;
    @XmlElement(name = "AddtlInf")
    protected List<AdditionalInformation7> addtlInf;
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV04 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV04 setSfkpgAcct(SecuritiesAccount13 value) {
     ...
     * {@link RequestDetails11 }
     * 
     * 
     */
    public List<RequestDetails11> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<RequestDetails11>();
        }
        return this.reqDtls;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AdditionalInformation7 }
     * 
     * 
     */
    public List<AdditionalInformation7> getAddtlInf() {
        if (addtlInf == null) {
            addtlInf = new ArrayList<AdditionalInformation7>();
        }
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV04 addReqDtls(RequestDetails11 reqDtls) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV04 addAddtlInf(AdditionalInformation7 addtlInf) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV04 addSplmtryData(SupplementaryData1 splmtryData) {
