...
@XmlType(name = "TransferOutCancellationRequestV05", propOrder = {
    "msgId",
    "refs",
    "cxl",
    "mktPrctcVrsn",
...
public class TransferOutCancellationRequestV05 {
     ...
     *     
     */
    public TransferOutCancellationRequestV05 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Cancellation4Choice }
     * 
     * 
     */
    public List<Cancellation4Choice> getCxl() {
        if (cxl == null) {
            cxl = new ArrayList<Cancellation4Choice>();
        }
        return this.cxl;
    }
     ...
     *     
     */
    public TransferOutCancellationRequestV05 setMktPrctcVrsn(MarketPracticeVersion1 value) {
     ...
     *     
     */
    public TransferOutCancellationRequestV05 setCpyDtls(CopyInformation2 value) {
        this.cpyDtls = value;
        return this;
    }
     ...
     * 
     */
    public TransferOutCancellationRequestV05 addRefs(References15 refs) {
        getRefs().add(refs);
        return this;
    }
     ...
     * 
     */
    public TransferOutCancellationRequestV05 addCxl(Cancellation4Choice cxl) {
        getCxl().add(cxl);
        return this;
    }
