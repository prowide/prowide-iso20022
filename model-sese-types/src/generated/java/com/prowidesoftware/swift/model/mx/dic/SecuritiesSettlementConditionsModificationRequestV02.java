...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequestV02", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "reqDtls",
    "addtlInf",
...
public class SecuritiesSettlementConditionsModificationRequestV02 {
    ...
    protected List<RequestDetails6> reqDtls;
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV02 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV02 setSfkpgAcct(SecuritiesAccount13 value) {
     ...
     * 
     */
    public List<RequestDetails6> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<RequestDetails6>();
        }
        return this.reqDtls;
    }
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV02 addReqDtls(RequestDetails6 reqDtls) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV02 addAddtlInf(AdditionalInformation7 addtlInf) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV02 addSplmtryData(SupplementaryData1 splmtryData) {
