...
@XmlType(name = "SecuritiesSettlementTransactionDetails33", propOrder = {
...
public class SecuritiesSettlementTransactionDetails33 {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails33 setSttlmTpAndAddtlParams(SettlementTypeAndAdditionalParameters13 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails33 setTradDtls(SecuritiesTradeDetails78 value) {
        this.tradDtls = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails33 setFinInstrmAttrbts(FinancialInstrumentAttributes91 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails33 setQtyAndAcctDtls(QuantityAndAccount66 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails33 setSttlmParams(SettlementDetails146 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails33 setStgSttlmInstrDtls(StandingSettlementInstruction14 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails33 setDlvrgSttlmPties(SettlementParties63 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails33 setRcvgSttlmPties(SettlementParties63 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails33 setCshPties(CashParties26 value) {
        this.cshPties = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails33 setSttlmAmt(AmountAndDirection89 value) {
        this.sttlmAmt = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails33 setOthrAmts(OtherAmounts39 value) {
        this.othrAmts = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails33 setOthrBizPties(OtherParties27 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails33 setAddtlPhysOrRegnDtls(RegistrationParameters6 value) {
     ...
     * 
     */
    public SecuritiesSettlementTransactionDetails33 addLnkgs(Linkages40 lnkgs) {
        getLnkgs().add(lnkgs);
        return this;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionDetails33 addSplmtryData(SupplementaryData1 splmtryData) {
