...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequestV1", propOrder = {
    "id",
    "acctOwnr",
    "sfkpgAcct",
    "reqDtls",
...
public class SecuritiesSettlementConditionsModificationRequestV1 {
    ...
    protected List<RequestDetails1> reqDtls;
    @XmlElement(name = "AddtlInf")
    protected List<AdditionalInformation3> addtlInf;
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV1 setId(DocumentIdentification11 value) {
        this.id = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV1 setAcctOwnr(PartyIdentification13Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV1 setSfkpgAcct(SecuritiesAccount13 value) {
     ...
     * 
     */
    public List<RequestDetails1> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<RequestDetails1>();
        }
        return this.reqDtls;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AdditionalInformation3 }
     * 
     * 
     */
    public List<AdditionalInformation3> getAddtlInf() {
        if (addtlInf == null) {
            addtlInf = new ArrayList<AdditionalInformation3>();
        }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV1 setMsgOrgtr(PartyIdentification10Choice value) {
        this.msgOrgtr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV1 setMsgRcpt(PartyIdentification10Choice value) {
        this.msgRcpt = value;
        return this;
    }
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV1 addReqDtls(RequestDetails1 reqDtls) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV1 addAddtlInf(AdditionalInformation3 addtlInf) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV1 addXtnsn(Extension2 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
