...
@XmlType(name = "PendingStatus83Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus83Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingReason37> rsn;
     ...
     *     
     */
    public PendingStatus83Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingReason37 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingReason37> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingStatus83Choice addRsn(PendingReason37 rsn) {
        getRsn().add(rsn);
        return this;
    }
