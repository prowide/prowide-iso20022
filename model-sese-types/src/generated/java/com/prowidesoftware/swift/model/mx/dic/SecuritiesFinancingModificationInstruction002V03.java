...
@XmlType(name = "SecuritiesFinancingModificationInstruction002V03", propOrder = {
...
public class SecuritiesFinancingModificationInstruction002V03 {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstruction002V03 setTxTpAndModAddtlParams(TransactionTypeAndAdditionalParameters8 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstruction002V03 setTradDtls(SecuritiesTradeDetails12 value) {
        this.tradDtls = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesFinancingModificationInstruction002V03 setFinInstrmId(SecurityIdentification15 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstruction002V03 setQtyAndAcctDtls(QuantityAndAccount21 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstruction002V03 setSctiesFincgAddtlDtls(SecuritiesFinancingTransactionDetails20 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstruction002V03 setSttlmParams(SettlementDetails65 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstruction002V03 setDlvrgSttlmPties(SettlementParties17 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstruction002V03 setRcvgSttlmPties(SettlementParties17 value) {
     ...
     *     
     */
    public SecuritiesFinancingModificationInstruction002V03 setOpngSttlmAmt(AmountAndDirection11 value) {
     ...
     * 
     */
    public SecuritiesFinancingModificationInstruction002V03 addSplmtryData(SupplementaryData1 splmtryData) {
