...
@XmlType(name = "SecuritiesSettlementTransactionModificationRequestV02", propOrder = {
    "modfdTxDtls",
    "updTp"
})
public class SecuritiesSettlementTransactionModificationRequestV02 {
    ...
    protected List<UpdateType9Choice> updTp;
     ...
     *     
     */
    public SecuritiesSettlementTransactionModificationRequestV02 setModfdTxDtls(TransactionDetails41 value) {
     ...
     * {@link UpdateType9Choice }
     * 
     * 
     */
    public List<UpdateType9Choice> getUpdTp() {
        if (updTp == null) {
            updTp = new ArrayList<UpdateType9Choice>();
        }
        return this.updTp;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionModificationRequestV02 addUpdTp(UpdateType9Choice updTp) {
        getUpdTp().add(updTp);
        return this;
    }
