...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequestV07", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "reqDtls",
    "addtlInf",
...
public class SecuritiesSettlementConditionsModificationRequestV07 {
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV07 setAcctOwnr(PartyIdentification98 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV07 setSfkpgAcct(SecuritiesAccount19 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AdditionalInformation13 }
     * 
     * 
     */
    public List<AdditionalInformation13> getAddtlInf() {
        if (addtlInf == null) {
            addtlInf = new ArrayList<AdditionalInformation13>();
        }
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV07 addReqDtls(RequestDetails15 reqDtls) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV07 addAddtlInf(AdditionalInformation13 addtlInf) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV07 addSplmtryData(SupplementaryData1 splmtryData) {
