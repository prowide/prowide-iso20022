...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequest002V07", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "reqDtls",
    "addtlInf",
...
public class SecuritiesSettlementConditionsModificationRequest002V07 {
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequest002V07 setAcctOwnr(PartyIdentification119 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequest002V07 setSfkpgAcct(SecuritiesAccount30 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AdditionalInformation14 }
     * 
     * 
     */
    public List<AdditionalInformation14> getAddtlInf() {
        if (addtlInf == null) {
            addtlInf = new ArrayList<AdditionalInformation14>();
        }
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V07 addReqDtls(RequestDetails16 reqDtls) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V07 addAddtlInf(AdditionalInformation14 addtlInf) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V07 addSplmtryData(SupplementaryData1 splmtryData) {
