...
@XmlType(name = "PendingStatus15Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus15Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<PendingReason1> rsn;
     ...
     *     
     */
    public PendingStatus15Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<PendingReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<PendingReason1>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public PendingStatus15Choice addRsn(PendingReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
