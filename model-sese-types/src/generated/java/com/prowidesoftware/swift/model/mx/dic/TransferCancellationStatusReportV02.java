...
@XmlType(name = "TransferCancellationStatusReportV02", propOrder = {
    "msgId",
    "rltdRef",
    "othrRef",
    "stsRpt",
...
public class TransferCancellationStatusReportV02 {
     ...
     *     
     */
    public TransferCancellationStatusReportV02 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
     ...
     *     
     */
    public TransferCancellationStatusReportV02 setStsRpt(CancellationStatusAndReason2 value) {
        this.stsRpt = value;
        return this;
    }
     ...
     * 
     */
    public TransferCancellationStatusReportV02 addRltdRef(AdditionalReference3 rltdRef) {
     ...
     * 
     */
    public TransferCancellationStatusReportV02 addOthrRef(AdditionalReference3 othrRef) {
     ...
     * 
     */
    public TransferCancellationStatusReportV02 addXtnsn(Extension1 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
