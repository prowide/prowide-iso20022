...
@XmlType(name = "SecuritiesSettlementTransactionModificationRequest002V05", propOrder = {
    "modfdTxDtls",
    "updTp"
})
public class SecuritiesSettlementTransactionModificationRequest002V05 {
    ...
    protected TransactionDetails101 modfdTxDtls;
    @XmlElement(name = "UpdTp", required = true)
    protected List<UpdateType26Choice> updTp;
     ...
     * @return
     *     possible object is
     *     {@link TransactionDetails101 }
     *     
     */
    public TransactionDetails101 getModfdTxDtls() {
        return modfdTxDtls;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionModificationRequest002V05 setModfdTxDtls(TransactionDetails101 value) {
     ...
     * {@link UpdateType26Choice }
     * 
     * 
     */
    public List<UpdateType26Choice> getUpdTp() {
        if (updTp == null) {
            updTp = new ArrayList<UpdateType26Choice>();
        }
        return this.updTp;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionModificationRequest002V05 addUpdTp(UpdateType26Choice updTp) {
        getUpdTp().add(updTp);
        return this;
    }
