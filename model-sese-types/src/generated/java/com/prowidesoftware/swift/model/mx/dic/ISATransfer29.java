...
@XmlType(name = "ISATransfer29", propOrder = {
    "mstrRef",
    "trfId",
    "trfConfId",
    "clntRef",
...
public class ISATransfer29 {
    ...
    protected List<FinancialInstrument60> finInstrmAsstForTrf;
     ...
     *     
     */
    public ISATransfer29 setMstrRef(String value) {
        this.mstrRef = value;
        return this;
    }
     ...
     *     
     */
    public ISATransfer29 setTrfId(String value) {
        this.trfId = value;
        return this;
    }
     ...
     *     
     */
    public ISATransfer29 setTrfConfId(String value) {
     ...
     *     
     */
    public ISATransfer29 setClntRef(AdditionalReference8 value) {
        this.clntRef = value;
        return this;
    }
     ...
     *     
     */
    public ISATransfer29 setCtrPtyRef(AdditionalReference8 value) {
     ...
     *     
     */
    public ISATransfer29 setBizFlowTp(BusinessFlowType1Code value) {
     ...
     *     
     */
    public ISATransfer29 setReqdTrfDt(DateFormat1Choice value) {
     ...
     *     
     */
    public ISATransfer29 setPrtfl(ISAPortfolio1Choice value) {
        this.prtfl = value;
        return this;
    }
     ...
     *     
     */
    public ISATransfer29 setRsdlCsh(ResidualCash1Code value) {
        this.rsdlCsh = value;
        return this;
    }
     ...
     *     
     */
    public ISATransfer29 setAllOthrCsh(AllOtherCash1Code value) {
     ...
     * {@link FinancialInstrument60 }
     * 
     * 
     */
    public List<FinancialInstrument60> getFinInstrmAsstForTrf() {
        if (finInstrmAsstForTrf == null) {
            finInstrmAsstForTrf = new ArrayList<FinancialInstrument60>();
        }
     ...
     * 
     */
    public ISATransfer29 addFinInstrmAsstForTrf(FinancialInstrument60 finInstrmAsstForTrf) {
