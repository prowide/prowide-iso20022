...
@XmlType(name = "StandingSettlementInstruction20", propOrder = {
    "sttlmStgInstrDB",
    "ctrPty",
    "vndr",
    "othrDlvrgSttlmPties",
...
public class StandingSettlementInstruction20 {
    ...
    protected SettlementParties126 othrDlvrgSttlmPties;
    @XmlElement(name = "OthrRcvgSttlmPties")
    protected SettlementParties126 othrRcvgSttlmPties;
     ...
     *     
     */
    public StandingSettlementInstruction20 setSttlmStgInstrDB(SettlementStandingInstructionDatabase4Choice value) {
     ...
     *     
     */
    public StandingSettlementInstruction20 setCtrPty(Counterparty15Choice value) {
        this.ctrPty = value;
        return this;
    }
     ...
     *     
     */
    public StandingSettlementInstruction20 setVndr(PartyIdentification136 value) {
        this.vndr = value;
        return this;
    }
     ...
     *     
     */
    public SettlementParties126 getOthrDlvrgSttlmPties() {
     ...
     *     
     */
    public StandingSettlementInstruction20 setOthrDlvrgSttlmPties(SettlementParties126 value) {
     ...
     *     
     */
    public SettlementParties126 getOthrRcvgSttlmPties() {
     ...
     *     
     */
    public StandingSettlementInstruction20 setOthrRcvgSttlmPties(SettlementParties126 value) {
