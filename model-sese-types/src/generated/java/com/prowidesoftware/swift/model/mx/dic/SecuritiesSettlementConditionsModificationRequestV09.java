...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequestV09", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "blckChainAdrOrWllt",
    "reqDtls",
...
public class SecuritiesSettlementConditionsModificationRequestV09 {
    ...
    protected List<RequestDetails27> reqDtls;
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV09 setAcctOwnr(PartyIdentification144 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV09 setSfkpgAcct(SecuritiesAccount19 value) {
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV09 setBlckChainAdrOrWllt(BlockChainAddressWallet3 value) {
     ...
     * 
     */
    public List<RequestDetails27> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<RequestDetails27>();
        }
        return this.reqDtls;
    }
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV09 addReqDtls(RequestDetails27 reqDtls) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV09 addAddtlInf(AdditionalInformation26 addtlInf) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV09 addSplmtryData(SupplementaryData1 splmtryData) {
