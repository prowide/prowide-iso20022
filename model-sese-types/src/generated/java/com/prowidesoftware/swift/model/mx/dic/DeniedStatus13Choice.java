...
@XmlType(name = "DeniedStatus13Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus13Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason8> rsn;
     ...
     *     
     */
    public DeniedStatus13Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason8> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason8>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus13Choice addRsn(DeniedReason8 rsn) {
        getRsn().add(rsn);
        return this;
    }
