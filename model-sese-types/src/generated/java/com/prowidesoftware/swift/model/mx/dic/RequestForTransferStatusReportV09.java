...
@XmlType(name = "RequestForTransferStatusReportV09", propOrder = {
    "msgId",
    "reqDtls",
    "mktPrctcVrsn",
    "xtnsn"
})
public class RequestForTransferStatusReportV09 {

    @XmlElement(name = "MsgId", required = true)
    protected MessageIdentification1 msgId;
    @XmlElement(name = "ReqDtls", required = true)
    protected List<MessageAndBusinessReference14> reqDtls;
     ...
     *     
     */
    public RequestForTransferStatusReportV09 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
     ...
     * {@link MessageAndBusinessReference14 }
     * 
     * 
     * @return
     *     The value of the reqDtls property.
     */
    public List<MessageAndBusinessReference14> getReqDtls() {
        if (reqDtls == null) {
     ...
     *     
     */
    public RequestForTransferStatusReportV09 setMktPrctcVrsn(MarketPracticeVersion1 value) {
     ...
     * 
     */
    public RequestForTransferStatusReportV09 addReqDtls(MessageAndBusinessReference14 reqDtls) {
     ...
     * 
     */
    public RequestForTransferStatusReportV09 addXtnsn(Extension1 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
