...
@XmlType(name = "DeniedStatus2Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus2Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason2> rsn;
     ...
     *     
     */
    public DeniedStatus2Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason2> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason2>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus2Choice addRsn(DeniedReason2 rsn) {
        getRsn().add(rsn);
        return this;
    }
