...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequestV10", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "blckChainAdrOrWllt",
    "reqDtls",
...
public class SecuritiesSettlementConditionsModificationRequestV10 {
    ...
    protected List<RequestDetails31> reqDtls;
    @XmlElement(name = "AddtlInf")
    protected List<AdditionalInformation26> addtlInf;
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV10 setAcctOwnr(PartyIdentification144 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV10 setSfkpgAcct(SecuritiesAccount19 value) {
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV10 setBlckChainAdrOrWllt(BlockChainAddressWallet3 value) {
     ...
     * 
     */
    public List<RequestDetails31> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<RequestDetails31>();
        }
        return this.reqDtls;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AdditionalInformation26 }
     * 
     * 
     */
    public List<AdditionalInformation26> getAddtlInf() {
        if (addtlInf == null) {
            addtlInf = new ArrayList<AdditionalInformation26>();
        }
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV10 addReqDtls(RequestDetails31 reqDtls) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV10 addAddtlInf(AdditionalInformation26 addtlInf) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV10 addSplmtryData(SupplementaryData1 splmtryData) {
