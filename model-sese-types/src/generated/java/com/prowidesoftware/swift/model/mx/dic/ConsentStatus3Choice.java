...
@XmlType(name = "ConsentStatus3Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class ConsentStatus3Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<ConsentReason3> rsn;
     ...
     *     
     */
    public ConsentStatus3Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<ConsentReason3> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<ConsentReason3>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public ConsentStatus3Choice addRsn(ConsentReason3 rsn) {
        getRsn().add(rsn);
        return this;
    }
