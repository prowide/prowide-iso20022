...
@XmlType(name = "PendingStatus82Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class PendingStatus82Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<PendingReason36> rsn;
     ...
     *     
     */
    public PendingStatus82Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link PendingReason36 }
     * 
     * 
     * @return
     *     The value of the rsn property.
     */
    public List<PendingReason36> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<>();
        }
        return this.rsn;
     ...
     * 
     */
    public PendingStatus82Choice addRsn(PendingReason36 rsn) {
        getRsn().add(rsn);
        return this;
    }
