...
@XmlType(name = "RejectedStatus3Choice", propOrder = {
    "rsn",
    "dataSrcSchme"
})
public class RejectedStatus3Choice {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the dataSrcSchme property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public RejectedStatus3Choice addRsn(RejectedStatusReason5 rsn) {
        getRsn().add(rsn);
        return this;
    }
     ...
     * 
     */
    public RejectedStatus3Choice addDataSrcSchme(GenericIdentification1 dataSrcSchme) {
