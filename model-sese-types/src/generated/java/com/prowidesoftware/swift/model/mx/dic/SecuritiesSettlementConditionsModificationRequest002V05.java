 ...
 * account owner. The fields in that sequence cannot be used to amend a trade or event detail unless authorised by country market practice.
 * 
...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequest002V05", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "reqDtls",
    "addtlInf",
...
public class SecuritiesSettlementConditionsModificationRequest002V05 {
    ...
    protected List<RequestDetails14> reqDtls;
    @XmlElement(name = "AddtlInf")
    protected List<AdditionalInformation10> addtlInf;
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequest002V05 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequest002V05 setSfkpgAcct(SecuritiesAccount17 value) {
     ...
     * {@link RequestDetails14 }
     * 
     * 
     */
    public List<RequestDetails14> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<RequestDetails14>();
        }
        return this.reqDtls;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AdditionalInformation10 }
     * 
     * 
     */
    public List<AdditionalInformation10> getAddtlInf() {
        if (addtlInf == null) {
            addtlInf = new ArrayList<AdditionalInformation10>();
        }
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V05 addReqDtls(RequestDetails14 reqDtls) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V05 addAddtlInf(AdditionalInformation10 addtlInf) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V05 addSplmtryData(SupplementaryData1 splmtryData) {
