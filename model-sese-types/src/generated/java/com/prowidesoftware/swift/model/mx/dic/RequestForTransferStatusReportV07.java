...
@XmlType(name = "RequestForTransferStatusReportV07", propOrder = {
    "msgId",
    "reqDtls",
    "mktPrctcVrsn",
    "xtnsn"
})
public class RequestForTransferStatusReportV07 {

    @XmlElement(name = "MsgId", required = true)
    protected MessageIdentification1 msgId;
    @XmlElement(name = "ReqDtls", required = true)
    protected List<MessageAndBusinessReference12> reqDtls;
     ...
     *     
     */
    public RequestForTransferStatusReportV07 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
     ...
     * {@link MessageAndBusinessReference12 }
     * 
     * 
     */
    public List<MessageAndBusinessReference12> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<MessageAndBusinessReference12>();
        }
        return this.reqDtls;
    }
     ...
     *     
     */
    public RequestForTransferStatusReportV07 setMktPrctcVrsn(MarketPracticeVersion1 value) {
     ...
     * 
     */
    public RequestForTransferStatusReportV07 addReqDtls(MessageAndBusinessReference12 reqDtls) {
     ...
     * 
     */
    public RequestForTransferStatusReportV07 addXtnsn(Extension1 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
