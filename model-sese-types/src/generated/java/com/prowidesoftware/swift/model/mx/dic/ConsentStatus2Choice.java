...
@XmlType(name = "ConsentStatus2Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class ConsentStatus2Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<ConsentReason2> rsn;
     ...
     *     
     */
    public ConsentStatus2Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<ConsentReason2> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<ConsentReason2>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public ConsentStatus2Choice addRsn(ConsentReason2 rsn) {
        getRsn().add(rsn);
        return this;
    }
