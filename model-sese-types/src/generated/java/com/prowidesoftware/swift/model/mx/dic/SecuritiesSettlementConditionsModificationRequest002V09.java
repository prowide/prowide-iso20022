...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequest002V09", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "blckChainAdrOrWllt",
    "reqDtls",
...
public class SecuritiesSettlementConditionsModificationRequest002V09 {
    ...
    protected List<RequestDetails29> reqDtls;
    @XmlElement(name = "AddtlInf")
    protected List<AdditionalInformation28> addtlInf;
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequest002V09 setAcctOwnr(PartyIdentification156 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequest002V09 setSfkpgAcct(SecuritiesAccount30 value) {
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequest002V09 setBlckChainAdrOrWllt(BlockChainAddressWallet7 value) {
     ...
     * 
     */
    public List<RequestDetails29> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<RequestDetails29>();
        }
        return this.reqDtls;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AdditionalInformation28 }
     * 
     * 
     */
    public List<AdditionalInformation28> getAddtlInf() {
        if (addtlInf == null) {
            addtlInf = new ArrayList<AdditionalInformation28>();
        }
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V09 addReqDtls(RequestDetails29 reqDtls) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V09 addAddtlInf(AdditionalInformation28 addtlInf) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V09 addSplmtryData(SupplementaryData1 splmtryData) {
