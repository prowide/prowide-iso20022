...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequest002V06", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "reqDtls",
    "addtlInf",
...
public class SecuritiesSettlementConditionsModificationRequest002V06 {
    ...
    protected List<AdditionalInformation12> addtlInf;
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequest002V06 setAcctOwnr(PartyIdentification109 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequest002V06 setSfkpgAcct(SecuritiesAccount30 value) {
     ...
     * {@link RequestDetails16 }
     * 
     * 
     */
    public List<RequestDetails16> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<RequestDetails16>();
        }
        return this.reqDtls;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AdditionalInformation12 }
     * 
     * 
     */
    public List<AdditionalInformation12> getAddtlInf() {
        if (addtlInf == null) {
            addtlInf = new ArrayList<AdditionalInformation12>();
        }
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V06 addReqDtls(RequestDetails16 reqDtls) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V06 addAddtlInf(AdditionalInformation12 addtlInf) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V06 addSplmtryData(SupplementaryData1 splmtryData) {
