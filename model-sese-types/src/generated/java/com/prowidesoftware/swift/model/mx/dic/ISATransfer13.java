...
@XmlType(name = "ISATransfer13", propOrder = {
    "mstrRef",
    "trfConfId",
    "trfInstrRef",
    "actlTrfDt",
...
public class ISATransfer13 {
    ...
    protected List<FinancialInstrument35> finInstrmAsstForTrf;
     ...
     *     
     */
    public ISATransfer13 setMstrRef(String value) {
        this.mstrRef = value;
        return this;
    }
     ...
     *     
     */
    public ISATransfer13 setTrfConfId(String value) {
     ...
     *     
     */
    public ISATransfer13 setTrfInstrRef(String value) {
     ...
     *     
     */
    public ISATransfer13 setActlTrfDt(XMLGregorianCalendar value) {
     ...
     *     
     */
    public ISATransfer13 setRsdlCsh(ResidualCash1Code value) {
        this.rsdlCsh = value;
        return this;
    }
     ...
     *     
     */
    public ISATransfer13 setPrtfl(ISAPortfolio2Choice value) {
        this.prtfl = value;
        return this;
    }
     ...
     * 
     */
    public ISATransfer13 setAllOthrCsh(boolean value) {
     ...
     * {@link FinancialInstrument35 }
     * 
     * 
     */
    public List<FinancialInstrument35> getFinInstrmAsstForTrf() {
        if (finInstrmAsstForTrf == null) {
            finInstrmAsstForTrf = new ArrayList<FinancialInstrument35>();
        }
     ...
     * 
     */
    public ISATransfer13 addFinInstrmAsstForTrf(FinancialInstrument35 finInstrmAsstForTrf) {
