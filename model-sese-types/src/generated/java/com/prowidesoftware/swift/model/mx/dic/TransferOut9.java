...
@XmlType(name = "TransferOut9", propOrder = {
    "reqdTrfDt",
    "trfDtls",
    "acctDtls",
    "sttlmDtls",
...
public class TransferOut9 {
    ...
    protected List<Transfer20> trfDtls;
     ...
     *     
     */
    public TransferOut9 setReqdTrfDt(DateFormat1Choice value) {
     ...
     * 
     */
    public List<Transfer20> getTrfDtls() {
        if (trfDtls == null) {
            trfDtls = new ArrayList<Transfer20>();
        }
        return this.trfDtls;
    }
     ...
     *     
     */
    public TransferOut9 setAcctDtls(InvestmentAccount22 value) {
        this.acctDtls = value;
        return this;
    }
     ...
     *     
     */
    public TransferOut9 setSttlmDtls(ReceiveInformation9 value) {
     ...
     * 
     */
    public TransferOut9 addTrfDtls(Transfer20 trfDtls) {
     ...
     * 
     */
    public TransferOut9 addXtnsn(Extension1 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
