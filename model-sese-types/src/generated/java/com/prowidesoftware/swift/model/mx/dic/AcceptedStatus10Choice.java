...
@XmlType(name = "AcceptedStatus10Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class AcceptedStatus10Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<AcceptedStatusReason11> rsn;
     ...
     *     
     */
    public AcceptedStatus10Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link AcceptedStatusReason11 }
     * 
     * 
     */
    public List<AcceptedStatusReason11> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<AcceptedStatusReason11>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AcceptedStatus10Choice addRsn(AcceptedStatusReason11 rsn) {
        getRsn().add(rsn);
        return this;
    }
