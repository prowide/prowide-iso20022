...
@XmlType(name = "RequestForTransferStatusReportV05", propOrder = {
    "msgId",
    "reqDtls",
    "mktPrctcVrsn",
    "xtnsn"
...
public class RequestForTransferStatusReportV05 {
    ...
    protected List<MessageAndBusinessReference8> reqDtls;
     ...
     *     
     */
    public RequestForTransferStatusReportV05 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
     ...
     * {@link MessageAndBusinessReference8 }
     * 
     * 
     */
    public List<MessageAndBusinessReference8> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<MessageAndBusinessReference8>();
        }
        return this.reqDtls;
    }
     ...
     *     
     */
    public RequestForTransferStatusReportV05 setMktPrctcVrsn(MarketPracticeVersion1 value) {
     ...
     * 
     */
    public RequestForTransferStatusReportV05 addReqDtls(MessageAndBusinessReference8 reqDtls) {
     ...
     * 
     */
    public RequestForTransferStatusReportV05 addXtnsn(Extension1 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
