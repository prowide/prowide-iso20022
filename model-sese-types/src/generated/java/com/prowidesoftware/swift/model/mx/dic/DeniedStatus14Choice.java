...
@XmlType(name = "DeniedStatus14Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus14Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason9> rsn;
     ...
     *     
     */
    public DeniedStatus14Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason9> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason9>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus14Choice addRsn(DeniedReason9 rsn) {
        getRsn().add(rsn);
        return this;
    }
