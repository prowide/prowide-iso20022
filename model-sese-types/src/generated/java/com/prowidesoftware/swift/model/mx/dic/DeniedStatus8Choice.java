...
@XmlType(name = "DeniedStatus8Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus8Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason3> rsn;
     ...
     *     
     */
    public DeniedStatus8Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason3> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason3>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus8Choice addRsn(DeniedReason3 rsn) {
        getRsn().add(rsn);
        return this;
    }
