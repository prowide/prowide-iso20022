...
@XmlType(name = "TransferIn16", propOrder = {
    "cxlRef",
    "trfDtls"
})
public class TransferIn16 {
     ...
     *     
     */
    public TransferIn16 setCxlRef(String value) {
        this.cxlRef = value;
        return this;
    }
    ...
    public List<Transfer32> getTrfDtls() {
        if (trfDtls == null) {
            trfDtls = new ArrayList<Transfer32>();
        }
        return this.trfDtls;
    }
     ...
     * 
     */
    public TransferIn16 addTrfDtls(Transfer32 trfDtls) {
