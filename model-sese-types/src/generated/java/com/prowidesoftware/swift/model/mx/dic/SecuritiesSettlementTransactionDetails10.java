...
@XmlType(name = "SecuritiesSettlementTransactionDetails10", propOrder = {
...
public class SecuritiesSettlementTransactionDetails10 {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails10 setSttlmTpAndAddtlParams(SettlementTypeAndAdditionalParameters5 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails10 setTradDtls(SecuritiesTradeDetails26 value) {
        this.tradDtls = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails10 setFinInstrmId(SecurityIdentification14 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails10 setFinInstrmAttrbts(FinancialInstrumentAttributes35 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails10 setQtyAndAcctDtls(QuantityAndAccount30 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails10 setSttlmParams(SettlementDetails50 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails10 setStgSttlmInstrDtls(StandingSettlementInstruction4 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails10 setDlvrgSttlmPties(SettlementParties11 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails10 setRcvgSttlmPties(SettlementParties11 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails10 setCshPties(CashParties17 value) {
        this.cshPties = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails10 setSttlmAmt(AmountAndDirection32 value) {
        this.sttlmAmt = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails10 setOthrAmts(OtherAmounts14 value) {
        this.othrAmts = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails10 setOthrBizPties(OtherParties19 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails10 setAddtlPhysOrRegnDtls(RegistrationParameters1 value) {
     ...
     * 
     */
    public SecuritiesSettlementTransactionDetails10 addLnkgs(Linkages1 lnkgs) {
        getLnkgs().add(lnkgs);
        return this;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionDetails10 addSplmtryData(SupplementaryData1 splmtryData) {
