...
@XmlType(name = "SettlementDetails236", propOrder = {
    "sttlmTxCond",
    "regn",
    "lglRstrctns",
    "sctiesRTGS",
...
public class SettlementDetails236 {

    @XmlElement(name = "SttlmTxCond")
    protected List<SettlementTransactionCondition47Choice> sttlmTxCond;
     ...
     * {@link SettlementTransactionCondition47Choice }
     * 
     * 
     * @return
     *     The value of the sttlmTxCond property.
     */
    public List<SettlementTransactionCondition47Choice> getSttlmTxCond() {
        if (sttlmTxCond == null) {
     ...
     *     
     */
    public SettlementDetails236 setRegn(Registration9Choice value) {
        this.regn = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails236 setLglRstrctns(Restriction5Choice value) {
     ...
     *     
     */
    public SettlementDetails236 setSctiesRTGS(SecuritiesRTGS4Choice value) {
     ...
     *     
     */
    public SettlementDetails236 setSttlmSysMtd(SettlementSystemMethod4Choice value) {
     ...
     *     
     */
    public SettlementDetails236 setTaxCpcty(TaxCapacityParty4Choice value) {
        this.taxCpcty = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails236 setStmpDtyTaxBsis(GenericIdentification30 value) {
     ...
     * 
     */
    public SettlementDetails236 addSttlmTxCond(SettlementTransactionCondition47Choice sttlmTxCond) {
