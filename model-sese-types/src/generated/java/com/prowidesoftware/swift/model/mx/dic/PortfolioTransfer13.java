...
public class PortfolioTransfer13 {
     ...
     *     
     */
    public PortfolioTransfer13 setActlTrfDt(XMLGregorianCalendar value) {
     ...
     *     
     */
    public PortfolioTransfer13 setTaxDt(XMLGregorianCalendar value) {
        this.taxDt = value;
        return this;
    }
    ...
    public List<FinancialInstrument105> getFinInstrmAsstForTrf() {
        if (finInstrmAsstForTrf == null) {
            finInstrmAsstForTrf = new ArrayList<FinancialInstrument105>();
        }
