...
@XmlType(name = "SecuritiesSettlementTransactionDetails15", propOrder = {
...
public class SecuritiesSettlementTransactionDetails15 {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails15 setSttlmTpAndAddtlParams(SettlementTypeAndAdditionalParameters6 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails15 setTradDtls(SecuritiesTradeDetails32 value) {
        this.tradDtls = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails15 setFinInstrmAttrbts(FinancialInstrumentAttributes35 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails15 setQtyAndAcctDtls(QuantityAndAccount29 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails15 setSttlmParams(SettlementDetails68 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails15 setStgSttlmInstrDtls(StandingSettlementInstruction4 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails15 setDlvrgSttlmPties(SettlementParties26 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails15 setRcvgSttlmPties(SettlementParties26 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails15 setCshPties(CashParties17 value) {
        this.cshPties = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails15 setSttlmAmt(AmountAndDirection37 value) {
        this.sttlmAmt = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails15 setOthrAmts(OtherAmounts14 value) {
        this.othrAmts = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails15 setOthrBizPties(OtherParties19 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails15 setAddtlPhysOrRegnDtls(RegistrationParameters1 value) {
     ...
     * 
     */
    public SecuritiesSettlementTransactionDetails15 addLnkgs(Linkages1 lnkgs) {
        getLnkgs().add(lnkgs);
        return this;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionDetails15 addSplmtryData(SupplementaryData1 splmtryData) {
