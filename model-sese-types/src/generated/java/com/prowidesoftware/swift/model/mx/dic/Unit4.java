...
public class Unit4 {
     ...
     *     
     */
    public Unit4 setTtlUnitsNb(FinancialInstrumentQuantity1 value) {
     ...
     * 
     */
    public List<Unit5> getUnitDtls() {
        if (unitDtls == null) {
            unitDtls = new ArrayList<Unit5>();
        }
     ...
     * 
     */
    public Unit4 addUnitDtls(Unit5 unitDtls) {
