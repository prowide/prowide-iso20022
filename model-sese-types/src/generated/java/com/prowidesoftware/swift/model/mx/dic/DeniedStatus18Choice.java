...
@XmlType(name = "DeniedStatus18Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus18Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason13> rsn;
     ...
     *     
     */
    public DeniedStatus18Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason13> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason13>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus18Choice addRsn(DeniedReason13 rsn) {
        getRsn().add(rsn);
        return this;
    }
