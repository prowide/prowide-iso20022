...
@XmlType(name = "RepairStatus14Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RepairStatus14Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<RepairReason10> rsn;
     ...
     *     
     */
    public RepairStatus14Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<RepairReason10> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RepairReason10>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RepairStatus14Choice addRsn(RepairReason10 rsn) {
        getRsn().add(rsn);
        return this;
    }
