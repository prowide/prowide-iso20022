...
@XmlType(name = "SecuritiesSettlementTransactionDetails26", propOrder = {
...
public class SecuritiesSettlementTransactionDetails26 {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails26 setSttlmTpAndAddtlParams(SettlementTypeAndAdditionalParameters13 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails26 setTradDtls(SecuritiesTradeDetails50 value) {
        this.tradDtls = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails26 setFinInstrmAttrbts(FinancialInstrumentAttributes64 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails26 setQtyAndAcctDtls(QuantityAndAccount44 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails26 setSttlmParams(SettlementDetails122 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails26 setStgSttlmInstrDtls(StandingSettlementInstruction11 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails26 setDlvrgSttlmPties(SettlementParties39 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails26 setRcvgSttlmPties(SettlementParties39 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails26 setCshPties(CashParties26 value) {
        this.cshPties = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails26 setSttlmAmt(AmountAndDirection45 value) {
        this.sttlmAmt = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails26 setOthrAmts(OtherAmounts28 value) {
        this.othrAmts = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails26 setOthrBizPties(OtherParties27 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails26 setAddtlPhysOrRegnDtls(RegistrationParameters4 value) {
     ...
     * 
     */
    public SecuritiesSettlementTransactionDetails26 addLnkgs(Linkages38 lnkgs) {
        getLnkgs().add(lnkgs);
        return this;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionDetails26 addSplmtryData(SupplementaryData1 splmtryData) {
