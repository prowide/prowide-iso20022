...
@XmlType(name = "RepairStatus11Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RepairStatus11Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RepairReason4> rsn;
     ...
     *     
     */
    public RepairStatus11Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<RepairReason4> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RepairReason4>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RepairStatus11Choice addRsn(RepairReason4 rsn) {
        getRsn().add(rsn);
        return this;
    }
