...
@XmlType(name = "DeniedStatus11Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus11Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason6> rsn;
     ...
     *     
     */
    public DeniedStatus11Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason6> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason6>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus11Choice addRsn(DeniedReason6 rsn) {
        getRsn().add(rsn);
        return this;
    }
