...
@XmlType(name = "SecuritiesSettlementTransactionModificationRequestV04", propOrder = {
    "modfdTxDtls",
    "updTp"
})
public class SecuritiesSettlementTransactionModificationRequestV04 {
    ...
    protected List<UpdateType14Choice> updTp;
     ...
     *     
     */
    public SecuritiesSettlementTransactionModificationRequestV04 setModfdTxDtls(TransactionDetails76 value) {
     ...
     * {@link UpdateType14Choice }
     * 
     * 
     */
    public List<UpdateType14Choice> getUpdTp() {
        if (updTp == null) {
            updTp = new ArrayList<UpdateType14Choice>();
        }
        return this.updTp;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionModificationRequestV04 addUpdTp(UpdateType14Choice updTp) {
        getUpdTp().add(updTp);
        return this;
    }
