...
@XmlType(name = "AcceptedStatus7Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class AcceptedStatus7Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<AcceptedStatusReason8> rsn;
     ...
     *     
     */
    public AcceptedStatus7Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link AcceptedStatusReason8 }
     * 
     * 
     */
    public List<AcceptedStatusReason8> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<AcceptedStatusReason8>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AcceptedStatus7Choice addRsn(AcceptedStatusReason8 rsn) {
        getRsn().add(rsn);
        return this;
    }
