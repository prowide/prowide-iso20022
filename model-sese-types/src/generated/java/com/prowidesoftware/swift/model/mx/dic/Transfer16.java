...
@XmlType(name = "Transfer16", propOrder = {
    "trfDt",
    "hldgsPlanTp",
    "finInstrmDtls",
    "ttlUnitsNb",
...
public class Transfer16 {
     ...
     *     
     */
    public Transfer16 setTrfDt(DateFormat1Choice value) {
        this.trfDt = value;
        return this;
    }
     ...
     *     
     */
    public Transfer16 setFinInstrmDtls(FinancialInstrument13 value) {
     ...
     *     
     */
    public Transfer16 setTtlUnitsNb(FinancialInstrumentQuantity1 value) {
     ...
     *     
     */
    public Transfer16 setOwnAcctTrfInd(Boolean value) {
     ...
     *     
     */
    public Transfer16 setNonStdSttlmInf(String value) {
     ...
     * 
     */
    public Transfer16 addHldgsPlanTp(HoldingsPlanType1Code hldgsPlanTp) {
