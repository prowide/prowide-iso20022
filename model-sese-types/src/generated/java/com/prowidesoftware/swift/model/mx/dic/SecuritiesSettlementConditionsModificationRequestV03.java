...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequestV03", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "reqDtls",
    "addtlInf",
...
public class SecuritiesSettlementConditionsModificationRequestV03 {
    ...
    protected List<RequestDetails8> reqDtls;
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV03 setAcctOwnr(PartyIdentification36Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV03 setSfkpgAcct(SecuritiesAccount13 value) {
     ...
     * 
     */
    public List<RequestDetails8> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<RequestDetails8>();
        }
        return this.reqDtls;
    }
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV03 addReqDtls(RequestDetails8 reqDtls) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV03 addAddtlInf(AdditionalInformation7 addtlInf) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV03 addSplmtryData(SupplementaryData1 splmtryData) {
