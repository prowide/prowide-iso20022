...
@XmlType(name = "FundPortfolio7Choice", propOrder = {
    "taxEffcntPdct",
    "gnlInvstmt",
    "pnsn"
})
public class FundPortfolio7Choice {

    @XmlElement(name = "TaxEffcntPdct")
    protected TaxEfficientProduct7 taxEffcntPdct;
    @XmlElement(name = "GnlInvstmt")
    protected GeneralInvestment2 gnlInvstmt;
    @XmlElement(name = "Pnsn")
    protected Pension5 pnsn;
     ...
     * @return
     *     possible object is
     *     {@link TaxEfficientProduct7 }
     *     
     */
    public TaxEfficientProduct7 getTaxEffcntPdct() {
     ...
     *     
     */
    public FundPortfolio7Choice setTaxEffcntPdct(TaxEfficientProduct7 value) {
     ...
     *     
     */
    public FundPortfolio7Choice setGnlInvstmt(GeneralInvestment2 value) {
     ...
     *     
     */
    public FundPortfolio7Choice setPnsn(Pension5 value) {
        this.pnsn = value;
        return this;
    }
