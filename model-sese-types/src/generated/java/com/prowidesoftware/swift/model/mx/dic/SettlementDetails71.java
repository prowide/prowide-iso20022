...
@XmlType(name = "SettlementDetails71", propOrder = {
    "prty",
    "sttlmTxCond",
    "sttlgCpcty",
    "stmpDtyTaxBsis",
...
public class SettlementDetails71 {
     ...
     *     
     */
    public SettlementDetails71 setPrty(PriorityNumeric1Choice value) {
        this.prty = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails71 setSttlgCpcty(SettlingCapacity4Choice value) {
     ...
     *     
     */
    public SettlementDetails71 setStmpDtyTaxBsis(GenericIdentification20 value) {
     ...
     *     
     */
    public SettlementDetails71 setSctiesRTGS(SecuritiesRTGS1Choice value) {
     ...
     *     
     */
    public SettlementDetails71 setBnfclOwnrsh(BeneficialOwnership1Choice value) {
     ...
     *     
     */
    public SettlementDetails71 setCshClrSys(CashSettlementSystem1Choice value) {
     ...
     *     
     */
    public SettlementDetails71 setTaxCpcty(TaxCapacityParty1Choice value) {
        this.taxCpcty = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails71 setMktClntSd(MarketClientSide1Choice value) {
     ...
     *     
     */
    public SettlementDetails71 setBlckTrad(BlockTrade1Choice value) {
        this.blckTrad = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails71 setLglRstrctns(Restriction1Choice value) {
     ...
     *     
     */
    public SettlementDetails71 setSttlmSysMtd(SettlementSystemMethod1Choice value) {
     ...
     *     
     */
    public SettlementDetails71 setNetgElgblty(NettingEligibility1Choice value) {
     ...
     *     
     */
    public SettlementDetails71 setCCPElgblty(CentralCounterPartyEligibility1Choice value) {
     ...
     *     
     */
    public SettlementDetails71 setAutomtcBrrwg(AutomaticBorrowing1Choice value) {
     ...
     *     
     */
    public SettlementDetails71 setPrtlSttlmInd(SettlementTransactionCondition5Code value) {
     ...
     *     
     */
    public SettlementDetails71 setElgblForColl(Boolean value) {
     ...
     * 
     */
    public SettlementDetails71 addSttlmTxCond(SettlementTransactionCondition7Choice sttlmTxCond) {
