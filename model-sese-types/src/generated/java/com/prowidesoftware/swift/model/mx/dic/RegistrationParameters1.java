...
@XmlType(name = "RegistrationParameters1", propOrder = {
    "certfctnId",
    "certfctnDtTm",
    "regarAcct",
    "certNb"
...
public class RegistrationParameters1 {
     ...
     *     
     */
    public RegistrationParameters1 setCertfctnId(String value) {
     ...
     *     
     */
    public RegistrationParameters1 setCertfctnDtTm(DateAndDateTimeChoice value) {
     ...
     *     
     */
    public RegistrationParameters1 setRegarAcct(String value) {
     ...
     * 
     */
    public RegistrationParameters1 addCertNb(SecuritiesCertificate1 certNb) {
