...
@XmlType(name = "Cancellation9Choice", propOrder = {
    "refs",
    "trfInDtls"
})
public class Cancellation9Choice {
    ...
    protected TransferIn13 trfInDtls;
     ...
     *     
     */
    public TransferIn13 getTrfInDtls() {
        return trfInDtls;
    }
     ...
     *     
     */
    public Cancellation9Choice setTrfInDtls(TransferIn13 value) {
     ...
     * 
     */
    public Cancellation9Choice addRefs(TransferReference5 refs) {
        getRefs().add(refs);
        return this;
    }
