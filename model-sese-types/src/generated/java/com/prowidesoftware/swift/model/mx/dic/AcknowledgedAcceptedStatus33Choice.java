...
public class AcknowledgedAcceptedStatus33Choice {
     ...
     *     
     */
    public AcknowledgedAcceptedStatus33Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public AcknowledgedAcceptedStatus33Choice addRsn(AcknowledgementReason21 rsn) {
        getRsn().add(rsn);
        return this;
    }
