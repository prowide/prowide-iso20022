...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequest002V08", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "reqDtls",
    "addtlInf",
...
public class SecuritiesSettlementConditionsModificationRequest002V08 {
    ...
    protected List<RequestDetails21> reqDtls;
    @XmlElement(name = "AddtlInf")
    protected List<AdditionalInformation17> addtlInf;
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequest002V08 setAcctOwnr(PartyIdentification156 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequest002V08 setSfkpgAcct(SecuritiesAccount30 value) {
     ...
     * 
     */
    public List<RequestDetails21> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<RequestDetails21>();
        }
        return this.reqDtls;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AdditionalInformation17 }
     * 
     * 
     */
    public List<AdditionalInformation17> getAddtlInf() {
        if (addtlInf == null) {
            addtlInf = new ArrayList<AdditionalInformation17>();
        }
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V08 addReqDtls(RequestDetails21 reqDtls) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V08 addAddtlInf(AdditionalInformation17 addtlInf) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V08 addSplmtryData(SupplementaryData1 splmtryData) {
