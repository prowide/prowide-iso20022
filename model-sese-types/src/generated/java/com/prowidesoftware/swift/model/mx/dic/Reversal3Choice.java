...
@XmlType(name = "Reversal3Choice", propOrder = {
    "refs",
    "trfOutConfDtls"
})
public class Reversal3Choice {
    ...
    protected TransferOut12 trfOutConfDtls;
     ...
     *     
     */
    public TransferOut12 getTrfOutConfDtls() {
     ...
     *     
     */
    public Reversal3Choice setTrfOutConfDtls(TransferOut12 value) {
     ...
     * 
     */
    public Reversal3Choice addRefs(TransferReference6 refs) {
        getRefs().add(refs);
        return this;
    }
