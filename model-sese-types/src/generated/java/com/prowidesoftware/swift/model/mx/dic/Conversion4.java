...
@XmlType(name = "Conversion4", propOrder = {
    "srcScty",
    "ttlUnitsNb",
    "unitsDtls",
    "addtlInf"
...
public class Conversion4 {
    ...
    protected FinancialInstrumentIdentification7 srcScty;
    @XmlElement(name = "TtlUnitsNb")
    protected BigDecimal ttlUnitsNb;
    @XmlElement(name = "UnitsDtls")
    protected List<Unit15> unitsDtls;
     ...
     * @return
     *     possible object is
     *     {@link FinancialInstrumentIdentification7 }
     *     
     */
    public FinancialInstrumentIdentification7 getSrcScty() {
        return srcScty;
    }
     ...
     *     
     */
    public Conversion4 setSrcScty(FinancialInstrumentIdentification7 value) {
        this.srcScty = value;
        return this;
    }
     ...
     *     
     */
    public Conversion4 setTtlUnitsNb(BigDecimal value) {
     ...
     */
    public List<Unit15> getUnitsDtls() {
        if (unitsDtls == null) {
     ...
     * 
     */
    public Conversion4 addUnitsDtls(Unit15 unitsDtls) {
     ...
     * 
     */
    public Conversion4 addAddtlInf(AdditionalInformation15 addtlInf) {
