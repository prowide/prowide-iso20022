...
@XmlType(name = "SettlementDetails187", propOrder = {
    "hldInd",
    "sctiesTxTp",
    "sttlmTxCond",
    "prtlSttlmInd",
...
public class SettlementDetails187 {
    ...
    protected List<SettlementTransactionCondition35Choice> sttlmTxCond;
     ...
     *     
     */
    public SettlementDetails187 setHldInd(Boolean value) {
        this.hldInd = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails187 setSctiesTxTp(SecuritiesTransactionType45Choice value) {
     ...
     * {@link SettlementTransactionCondition35Choice }
     * 
     * 
     */
    public List<SettlementTransactionCondition35Choice> getSttlmTxCond() {
        if (sttlmTxCond == null) {
            sttlmTxCond = new ArrayList<SettlementTransactionCondition35Choice>();
        }
     ...
     *     
     */
    public SettlementDetails187 setPrtlSttlmInd(SettlementTransactionCondition5Code value) {
     ...
     *     
     */
    public SettlementDetails187 setBnfclOwnrsh(BeneficialOwnership4Choice value) {
     ...
     *     
     */
    public SettlementDetails187 setCshClrSys(CashSettlementSystem4Choice value) {
     ...
     *     
     */
    public SettlementDetails187 setMktClntSd(MarketClientSide6Choice value) {
     ...
     *     
     */
    public SettlementDetails187 setRegn(Registration9Choice value) {
        this.regn = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails187 setRpTp(RepurchaseType13Choice value) {
        this.rpTp = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails187 setSctiesRTGS(SecuritiesRTGS4Choice value) {
     ...
     *     
     */
    public SettlementDetails187 setStmpDtyTaxBsis(GenericIdentification30 value) {
     ...
     * 
     */
    public SettlementDetails187 addSttlmTxCond(SettlementTransactionCondition35Choice sttlmTxCond) {
