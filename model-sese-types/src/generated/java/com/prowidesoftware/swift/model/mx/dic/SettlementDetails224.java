...
@XmlType(name = "SettlementDetails224", propOrder = {
    "hldInd",
    "sctiesTxTp",
    "sttlmTxCond",
    "prtlSttlmInd",
...
public class SettlementDetails224 {
    ...
    protected List<SettlementTransactionCondition43Choice> sttlmTxCond;
     ...
     *     
     */
    public SettlementDetails224 setHldInd(Boolean value) {
        this.hldInd = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails224 setSctiesTxTp(SecuritiesTransactionType45Choice value) {
     ...
     * {@link SettlementTransactionCondition43Choice }
     * 
     * 
     * @return
     *     The value of the sttlmTxCond property.
     */
    public List<SettlementTransactionCondition43Choice> getSttlmTxCond() {
        if (sttlmTxCond == null) {
     ...
     *     
     */
    public SettlementDetails224 setPrtlSttlmInd(SettlementTransactionCondition5Code value) {
     ...
     *     
     */
    public SettlementDetails224 setBnfclOwnrsh(BeneficialOwnership4Choice value) {
     ...
     *     
     */
    public SettlementDetails224 setCshClrSys(CashSettlementSystem6Choice value) {
     ...
     *     
     */
    public SettlementDetails224 setMktClntSd(MarketClientSide6Choice value) {
     ...
     *     
     */
    public SettlementDetails224 setRegn(Registration9Choice value) {
        this.regn = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails224 setRpTp(RepurchaseType13Choice value) {
        this.rpTp = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails224 setSctiesRTGS(SecuritiesRTGS4Choice value) {
     ...
     *     
     */
    public SettlementDetails224 setStmpDtyTaxBsis(GenericIdentification30 value) {
     ...
     * 
     */
    public SettlementDetails224 addSttlmTxCond(SettlementTransactionCondition43Choice sttlmTxCond) {
