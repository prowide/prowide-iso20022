...
@XmlType(name = "SecuritiesSettlementTransactionDetails11", propOrder = {
...
public class SecuritiesSettlementTransactionDetails11 {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails11 setSttlmTpAndAddtlParams(SettlementTypeAndAdditionalParameters7 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails11 setTradDtls(SecuritiesTradeDetails27 value) {
        this.tradDtls = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails11 setFinInstrmAttrbts(FinancialInstrumentAttributes41 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails11 setQtyAndAcctDtls(QuantityAndAccount32 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails11 setSttlmParams(SettlementDetails51 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails11 setStgSttlmInstrDtls(StandingSettlementInstruction7 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails11 setDlvrgSttlmPties(SettlementParties27 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails11 setRcvgSttlmPties(SettlementParties27 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails11 setCshPties(CashParties19 value) {
        this.cshPties = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails11 setSttlmAmt(AmountAndDirection33 value) {
        this.sttlmAmt = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails11 setOthrAmts(OtherAmounts20 value) {
        this.othrAmts = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails11 setOthrBizPties(OtherParties24 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails11 setAddtlPhysOrRegnDtls(RegistrationParameters2 value) {
     ...
     * 
     */
    public SecuritiesSettlementTransactionDetails11 addLnkgs(Linkages4 lnkgs) {
        getLnkgs().add(lnkgs);
        return this;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionDetails11 addSplmtryData(SupplementaryData1 splmtryData) {
