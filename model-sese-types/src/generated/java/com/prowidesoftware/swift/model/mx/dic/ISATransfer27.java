...
@XmlType(name = "ISATransfer27", propOrder = {
    "mstrRef",
    "trfId",
    "prtfl",
    "allOthrCsh",
...
public class ISATransfer27 {
    ...
    protected ISAPortfolio3Choice prtfl;
    @XmlElement(name = "AllOthrCsh")
    @XmlSchemaType(name = "string")
    protected AllOtherCash1Code allOthrCsh;
    @XmlElement(name = "FinInstrmAsstForTrf")
    protected List<FinancialInstrument50> finInstrmAsstForTrf;
     ...
     *     
     */
    public ISATransfer27 setMstrRef(String value) {
        this.mstrRef = value;
        return this;
    }
     ...
     *     
     */
    public ISATransfer27 setTrfId(String value) {
        this.trfId = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link ISAPortfolio3Choice }
     *     
     */
    public ISAPortfolio3Choice getPrtfl() {
        return prtfl;
    }
     ...
     *     
     */
    public ISATransfer27 setPrtfl(ISAPortfolio3Choice value) {
        this.prtfl = value;
        return this;
    }
     ...
     *     
     */
    public ISATransfer27 setAllOthrCsh(AllOtherCash1Code value) {
     ...
     * {@link FinancialInstrument50 }
     * 
     * 
     */
    public List<FinancialInstrument50> getFinInstrmAsstForTrf() {
        if (finInstrmAsstForTrf == null) {
            finInstrmAsstForTrf = new ArrayList<FinancialInstrument50>();
        }
     ...
     * 
     */
    public ISATransfer27 addFinInstrmAsstForTrf(FinancialInstrument50 finInstrmAsstForTrf) {
