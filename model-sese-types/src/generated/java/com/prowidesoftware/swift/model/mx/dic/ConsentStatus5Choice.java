...
@XmlType(name = "ConsentStatus5Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class ConsentStatus5Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<ConsentReason5> rsn;
     ...
     *     
     */
    public ConsentStatus5Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<ConsentReason5> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<ConsentReason5>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public ConsentStatus5Choice addRsn(ConsentReason5 rsn) {
        getRsn().add(rsn);
        return this;
    }
