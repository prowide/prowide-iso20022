...
@XmlType(name = "DeniedStatus17Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus17Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason12> rsn;
     ...
     *     
     */
    public DeniedStatus17Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason12> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason12>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus17Choice addRsn(DeniedReason12 rsn) {
        getRsn().add(rsn);
        return this;
    }
