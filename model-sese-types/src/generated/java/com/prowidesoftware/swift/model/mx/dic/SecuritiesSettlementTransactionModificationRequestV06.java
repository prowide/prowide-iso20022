...
@XmlType(name = "SecuritiesSettlementTransactionModificationRequestV06", propOrder = {
    "modfdTxDtls",
    "updTp"
})
public class SecuritiesSettlementTransactionModificationRequestV06 {
    ...
    protected TransactionDetails106 modfdTxDtls;
    @XmlElement(name = "UpdTp", required = true)
    protected List<UpdateType27Choice> updTp;
     ...
     * @return
     *     possible object is
     *     {@link TransactionDetails106 }
     *     
     */
    public TransactionDetails106 getModfdTxDtls() {
        return modfdTxDtls;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionModificationRequestV06 setModfdTxDtls(TransactionDetails106 value) {
     ...
     * {@link UpdateType27Choice }
     * 
     * 
     */
    public List<UpdateType27Choice> getUpdTp() {
        if (updTp == null) {
            updTp = new ArrayList<UpdateType27Choice>();
        }
        return this.updTp;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionModificationRequestV06 addUpdTp(UpdateType27Choice updTp) {
        getUpdTp().add(updTp);
        return this;
    }
