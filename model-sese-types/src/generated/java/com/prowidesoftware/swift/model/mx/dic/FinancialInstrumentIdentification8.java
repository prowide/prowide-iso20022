...
@XmlType(name = "FinancialInstrumentIdentification8", propOrder = {
    "id",
    "nm",
    "shrtNm",
    "clssfctnTp",
...
public class FinancialInstrumentIdentification8 {
    ...
    protected List<FinancialInstrumentIdentification9> altrnScty;
     ...
     *     
     */
    public FinancialInstrumentIdentification8 setId(SecurityIdentification46Choice value) {
        this.id = value;
        return this;
    }
     ...
     *     
     */
    public FinancialInstrumentIdentification8 setNm(String value) {
        this.nm = value;
        return this;
    }
     ...
     *     
     */
    public FinancialInstrumentIdentification8 setShrtNm(String value) {
        this.shrtNm = value;
        return this;
    }
     ...
     *     
     */
    public FinancialInstrumentIdentification8 setClssfctnTp(ClassificationType32Choice value) {
     ...
     *     
     */
    public FinancialInstrumentIdentification8 setRstrctdInd(Boolean value) {
     ...
     * {@link FinancialInstrumentIdentification9 }
     * 
     * 
     * @return
     *     The value of the altrnScty property.
     */
    public List<FinancialInstrumentIdentification9> getAltrnScty() {
        if (altrnScty == null) {
     ...
     * 
     */
    public FinancialInstrumentIdentification8 addAltrnScty(FinancialInstrumentIdentification9 altrnScty) {
