...
@XmlType(name = "ConsentStatus4Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class ConsentStatus4Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<ConsentReason4> rsn;
     ...
     *     
     */
    public ConsentStatus4Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<ConsentReason4> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<ConsentReason4>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public ConsentStatus4Choice addRsn(ConsentReason4 rsn) {
        getRsn().add(rsn);
        return this;
    }
