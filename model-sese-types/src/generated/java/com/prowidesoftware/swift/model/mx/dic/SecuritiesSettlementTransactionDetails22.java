...
@XmlType(name = "SecuritiesSettlementTransactionDetails22", propOrder = {
...
public class SecuritiesSettlementTransactionDetails22 {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails22 setSttlmTpAndAddtlParams(SettlementTypeAndAdditionalParameters14 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails22 setTradDtls(SecuritiesTradeDetails52 value) {
        this.tradDtls = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails22 setFinInstrmId(SecurityIdentification19 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails22 setFinInstrmAttrbts(FinancialInstrumentAttributes64 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails22 setQtyAndAcctDtls(QuantityAndAccount43 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails22 setSttlmParams(SettlementDetails94 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails22 setStgSttlmInstrDtls(StandingSettlementInstruction11 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails22 setDlvrgSttlmPties(SettlementParties36 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails22 setRcvgSttlmPties(SettlementParties36 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails22 setCshPties(CashParties26 value) {
        this.cshPties = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails22 setSttlmAmt(AmountAndDirection45 value) {
        this.sttlmAmt = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails22 setOthrAmts(OtherAmounts28 value) {
        this.othrAmts = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails22 setOthrBizPties(OtherParties27 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails22 setAddtlPhysOrRegnDtls(RegistrationParameters4 value) {
     ...
     * 
     */
    public SecuritiesSettlementTransactionDetails22 addLnkgs(Linkages38 lnkgs) {
        getLnkgs().add(lnkgs);
        return this;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionDetails22 addSplmtryData(SupplementaryData1 splmtryData) {
