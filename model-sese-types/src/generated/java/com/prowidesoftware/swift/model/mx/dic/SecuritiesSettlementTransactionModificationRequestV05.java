...
@XmlType(name = "SecuritiesSettlementTransactionModificationRequestV05", propOrder = {
    "modfdTxDtls",
    "updTp"
})
public class SecuritiesSettlementTransactionModificationRequestV05 {
     ...
     *     
     */
    public SecuritiesSettlementTransactionModificationRequestV05 setModfdTxDtls(TransactionDetails76 value) {
     ...
     * {@link UpdateType25Choice }
     * 
     * 
     */
    public List<UpdateType25Choice> getUpdTp() {
        if (updTp == null) {
            updTp = new ArrayList<UpdateType25Choice>();
        }
        return this.updTp;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionModificationRequestV05 addUpdTp(UpdateType25Choice updTp) {
        getUpdTp().add(updTp);
        return this;
    }
