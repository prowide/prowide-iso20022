...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequestV02Subset", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "reqDtls",
    "addtlInf",
...
public class SecuritiesSettlementConditionsModificationRequestV02Subset {
    ...
    protected List<RequestDetails7> reqDtls;
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV02Subset setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequestV02Subset setSfkpgAcct(SecuritiesAccount17 value) {
     ...
     * 
     */
    public List<RequestDetails7> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<RequestDetails7>();
        }
        return this.reqDtls;
    }
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV02Subset addReqDtls(RequestDetails7 reqDtls) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV02Subset addAddtlInf(AdditionalInformation8 addtlInf) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequestV02Subset addSplmtryData(SupplementaryData1 splmtryData) {
