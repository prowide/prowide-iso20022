...
@XmlType(name = "SecuritiesSettlementTransactionModificationRequestV08", propOrder = {
    "modfdTxDtls",
    "updTp"
})
public class SecuritiesSettlementTransactionModificationRequestV08 {

    @XmlElement(name = "ModfdTxDtls", required = true)
    protected TransactionDetails116 modfdTxDtls;
    @XmlElement(name = "UpdTp", required = true)
    protected List<UpdateType33Choice> updTp;
     ...
     * @return
     *     possible object is
     *     {@link TransactionDetails116 }
     *     
     */
    public TransactionDetails116 getModfdTxDtls() {
        return modfdTxDtls;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionModificationRequestV08 setModfdTxDtls(TransactionDetails116 value) {
     ...
     * {@link UpdateType33Choice }
     * 
     * 
     */
    public List<UpdateType33Choice> getUpdTp() {
        if (updTp == null) {
            updTp = new ArrayList<UpdateType33Choice>();
        }
        return this.updTp;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionModificationRequestV08 addUpdTp(UpdateType33Choice updTp) {
        getUpdTp().add(updTp);
        return this;
    }
