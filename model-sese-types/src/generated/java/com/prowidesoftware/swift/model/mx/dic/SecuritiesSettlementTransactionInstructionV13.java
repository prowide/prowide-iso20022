...
@XmlType(name = "SecuritiesSettlementTransactionInstructionV13", propOrder = {
    "txId",
...
public class SecuritiesSettlementTransactionInstructionV13 {

    @XmlElement(name = "TxId", required = true)
    protected String txId;
    @XmlElement(name = "SttlmTpAndAddtlParams", required = true)
    protected SettlementTypeAndAdditionalParameters23 sttlmTpAndAddtlParams;
    @XmlElement(name = "NbCounts")
    protected NumberCount2Choice nbCounts;
    @XmlElement(name = "Lnkgs")
    protected List<Linkages79> lnkgs;
    @XmlElement(name = "TradDtls", required = true)
    protected SecuritiesTradeDetails149 tradDtls;
    @XmlElement(name = "FinInstrmId", required = true)
    protected SecurityIdentification19 finInstrmId;
    @XmlElement(name = "FinInstrmAttrbts")
    protected FinancialInstrumentAttributes111 finInstrmAttrbts;
    @XmlElement(name = "QtyAndAcctDtls", required = true)
    protected QuantityAndAccount117 qtyAndAcctDtls;
    @XmlElement(name = "SttlmParams", required = true)
    protected SettlementDetails220 sttlmParams;
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setTxId(String value) {
        this.txId = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link SettlementTypeAndAdditionalParameters23 }
     *     
     */
    public SettlementTypeAndAdditionalParameters23 getSttlmTpAndAddtlParams() {
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setSttlmTpAndAddtlParams(SettlementTypeAndAdditionalParameters23 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setNbCounts(NumberCount2Choice value) {
        this.nbCounts = value;
        return this;
    }
     ...
     */
    public List<Linkages79> getLnkgs() {
        if (lnkgs == null) {
            lnkgs = new ArrayList<>();
        }
        return this.lnkgs;
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesTradeDetails149 }
     *     
     */
    public SecuritiesTradeDetails149 getTradDtls() {
        return tradDtls;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setTradDtls(SecuritiesTradeDetails149 value) {
        this.tradDtls = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setFinInstrmId(SecurityIdentification19 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setFinInstrmAttrbts(FinancialInstrumentAttributes111 value) {
     ...
     *     
     */
    public QuantityAndAccount117 getQtyAndAcctDtls() {
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setQtyAndAcctDtls(QuantityAndAccount117 value) {
     ...
     * @return
     *     possible object is
     *     {@link SettlementDetails220 }
     *     
     */
    public SettlementDetails220 getSttlmParams() {
        return sttlmParams;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setSttlmParams(SettlementDetails220 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setStgSttlmInstrDtls(StandingSettlementInstruction20 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setDlvrgSttlmPties(SettlementParties126 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setRcvgSttlmPties(SettlementParties126 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setCshPties(CashParties41 value) {
        this.cshPties = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setSttlmAmt(AmountAndDirection94 value) {
        this.sttlmAmt = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setOthrAmts(OtherAmounts45 value) {
        this.othrAmts = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setOthrBizPties(OtherParties43 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionInstructionV13 setAddtlPhysOrRegnDtls(RegistrationParameters6 value) {
     ...
     * 
     */
    public SecuritiesSettlementTransactionInstructionV13 addLnkgs(Linkages79 lnkgs) {
        getLnkgs().add(lnkgs);
        return this;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionInstructionV13 addDgtlPmtSttlm(DigitalPaymentSettlement1 dgtlPmtSttlm) {
     ...
     * 
     */
    public SecuritiesSettlementTransactionInstructionV13 addSplmtryData(SupplementaryData1 splmtryData) {
