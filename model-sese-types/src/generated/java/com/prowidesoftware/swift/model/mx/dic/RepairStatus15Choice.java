...
@XmlType(name = "RepairStatus15Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RepairStatus15Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RepairReason11> rsn;
     ...
     *     
     */
    public RepairStatus15Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<RepairReason11> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RepairReason11>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RepairStatus15Choice addRsn(RepairReason11 rsn) {
        getRsn().add(rsn);
        return this;
    }
