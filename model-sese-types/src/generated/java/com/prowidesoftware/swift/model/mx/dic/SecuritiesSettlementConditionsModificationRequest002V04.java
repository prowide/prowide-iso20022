...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequest002V04", propOrder = {
    "acctOwnr",
    "sfkpgAcct",
    "reqDtls",
    "addtlInf",
...
public class SecuritiesSettlementConditionsModificationRequest002V04 {
    ...
    protected List<RequestDetails12> reqDtls;
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequest002V04 setAcctOwnr(PartyIdentification51Choice value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementConditionsModificationRequest002V04 setSfkpgAcct(SecuritiesAccount17 value) {
     ...
     * 
     */
    public List<RequestDetails12> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<RequestDetails12>();
        }
        return this.reqDtls;
    }
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V04 addReqDtls(RequestDetails12 reqDtls) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V04 addAddtlInf(AdditionalInformation8 addtlInf) {
     ...
     * 
     */
    public SecuritiesSettlementConditionsModificationRequest002V04 addSplmtryData(SupplementaryData1 splmtryData) {
