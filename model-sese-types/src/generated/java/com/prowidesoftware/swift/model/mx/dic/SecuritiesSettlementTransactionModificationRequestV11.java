...
@XmlType(name = "SecuritiesSettlementTransactionModificationRequestV11", propOrder = {
    "modfdTxDtls",
    "updTp"
})
public class SecuritiesSettlementTransactionModificationRequestV11 {

    @XmlElement(name = "ModfdTxDtls", required = true)
    protected TransactionDetails181 modfdTxDtls;
    @XmlElement(name = "UpdTp", required = true)
    protected List<UpdateType40Choice> updTp;
     ...
     * @return
     *     possible object is
     *     {@link TransactionDetails181 }
     *     
     */
    public TransactionDetails181 getModfdTxDtls() {
        return modfdTxDtls;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionModificationRequestV11 setModfdTxDtls(TransactionDetails181 value) {
     ...
     * {@link UpdateType40Choice }
     * 
     * 
     * @return
     *     The value of the updTp property.
     */
    public List<UpdateType40Choice> getUpdTp() {
        if (updTp == null) {
            updTp = new ArrayList<>();
        }
        return this.updTp;
     ...
     * 
     */
    public SecuritiesSettlementTransactionModificationRequestV11 addUpdTp(UpdateType40Choice updTp) {
        getUpdTp().add(updTp);
        return this;
    }
