...
@XmlType(name = "RequestForTransferStatusReportV06", propOrder = {
    "msgId",
    "reqDtls",
    "mktPrctcVrsn",
    "xtnsn"
...
public class RequestForTransferStatusReportV06 {
    ...
    protected List<MessageAndBusinessReference11> reqDtls;
     ...
     *     
     */
    public RequestForTransferStatusReportV06 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
     ...
     * {@link MessageAndBusinessReference11 }
     * 
     * 
     */
    public List<MessageAndBusinessReference11> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<MessageAndBusinessReference11>();
        }
        return this.reqDtls;
    }
     ...
     *     
     */
    public RequestForTransferStatusReportV06 setMktPrctcVrsn(MarketPracticeVersion1 value) {
     ...
     * 
     */
    public RequestForTransferStatusReportV06 addReqDtls(MessageAndBusinessReference11 reqDtls) {
     ...
     * 
     */
    public RequestForTransferStatusReportV06 addXtnsn(Extension1 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
