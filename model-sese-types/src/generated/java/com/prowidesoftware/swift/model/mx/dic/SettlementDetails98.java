...
@XmlType(name = "SettlementDetails98", propOrder = {
    "hldInd",
    "sttlmTxCond",
    "sttlgCpcty",
    "stmpDtyTaxBsis",
...
public class SettlementDetails98 {
     ...
     *     
     */
    public SettlementDetails98 setHldInd(Boolean value) {
        this.hldInd = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails98 setSttlgCpcty(SettlingCapacity7Choice value) {
     ...
     *     
     */
    public SettlementDetails98 setStmpDtyTaxBsis(GenericIdentification30 value) {
     ...
     *     
     */
    public SettlementDetails98 setSctiesRTGS(SecuritiesRTGS4Choice value) {
     ...
     *     
     */
    public SettlementDetails98 setBnfclOwnrsh(BeneficialOwnership4Choice value) {
     ...
     *     
     */
    public SettlementDetails98 setCshClrSys(CashSettlementSystem4Choice value) {
     ...
     *     
     */
    public SettlementDetails98 setTaxCpcty(TaxCapacityParty4Choice value) {
        this.taxCpcty = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails98 setMktClntSd(MarketClientSide4Choice value) {
     ...
     *     
     */
    public SettlementDetails98 setBlckTrad(BlockTrade4Choice value) {
        this.blckTrad = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails98 setLglRstrctns(Restriction5Choice value) {
     ...
     *     
     */
    public SettlementDetails98 setSttlmSysMtd(SettlementSystemMethod4Choice value) {
     ...
     *     
     */
    public SettlementDetails98 setNetgElgblty(NettingEligibility4Choice value) {
     ...
     *     
     */
    public SettlementDetails98 setCCPElgblty(CentralCounterPartyEligibility4Choice value) {
     ...
     *     
     */
    public SettlementDetails98 setPrtlSttlmInd(SettlementTransactionCondition5Code value) {
     ...
     *     
     */
    public SettlementDetails98 setElgblForColl(Boolean value) {
     ...
     * 
     */
    public SettlementDetails98 addSttlmTxCond(SettlementTransactionCondition18Choice sttlmTxCond) {
