...
@XmlType(name = "DeniedStatus5Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class DeniedStatus5Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<DeniedReason1> rsn;
     ...
     *     
     */
    public DeniedStatus5Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<DeniedReason1> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<DeniedReason1>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public DeniedStatus5Choice addRsn(DeniedReason1 rsn) {
        getRsn().add(rsn);
        return this;
    }
