...
@XmlType(name = "SecuritiesSettlementTransactionModificationRequest002V01", propOrder = {
    "modfdTxDtls",
    "updTp"
})
public class SecuritiesSettlementTransactionModificationRequest002V01 {

    @XmlElement(name = "ModfdTxDtls", required = true)
    protected TransactionDetails43 modfdTxDtls;
    @XmlElement(name = "UpdTp", required = true)
    protected List<UpdateType6Choice> updTp;
     ...
     *     
     */
    public SecuritiesSettlementTransactionModificationRequest002V01 setModfdTxDtls(TransactionDetails43 value) {
     ...
     * {@link UpdateType6Choice }
     * 
     * 
     */
    public List<UpdateType6Choice> getUpdTp() {
        if (updTp == null) {
            updTp = new ArrayList<UpdateType6Choice>();
        }
        return this.updTp;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionModificationRequest002V01 addUpdTp(UpdateType6Choice updTp) {
        getUpdTp().add(updTp);
        return this;
    }
