...
@XmlType(name = "FundPortfolio1Choice", propOrder = {
    "taxEffcntPdct",
    "gnlInvstmt",
    "pnsn"
})
public class FundPortfolio1Choice {

    @XmlElement(name = "TaxEffcntPdct")
    protected TaxEfficientProduct1 taxEffcntPdct;
     ...
     * @return
     *     possible object is
     *     {@link TaxEfficientProduct1 }
     *     
     */
    public TaxEfficientProduct1 getTaxEffcntPdct() {
     ...
     *     
     */
    public FundPortfolio1Choice setTaxEffcntPdct(TaxEfficientProduct1 value) {
     ...
     *     
     */
    public FundPortfolio1Choice setGnlInvstmt(GeneralInvestment1 value) {
     ...
     *     
     */
    public FundPortfolio1Choice setPnsn(Pension1 value) {
        this.pnsn = value;
        return this;
    }
