...
@XmlType(name = "SecuritiesSettlementTransactionModificationRequest002V06", propOrder = {
    "modfdTxDtls",
    "updTp"
})
public class SecuritiesSettlementTransactionModificationRequest002V06 {
    ...
    protected TransactionDetails108 modfdTxDtls;
    @XmlElement(name = "UpdTp", required = true)
    protected List<UpdateType28Choice> updTp;
     ...
     * @return
     *     possible object is
     *     {@link TransactionDetails108 }
     *     
     */
    public TransactionDetails108 getModfdTxDtls() {
        return modfdTxDtls;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionModificationRequest002V06 setModfdTxDtls(TransactionDetails108 value) {
     ...
     * {@link UpdateType28Choice }
     * 
     * 
     */
    public List<UpdateType28Choice> getUpdTp() {
        if (updTp == null) {
            updTp = new ArrayList<UpdateType28Choice>();
        }
        return this.updTp;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionModificationRequest002V06 addUpdTp(UpdateType28Choice updTp) {
        getUpdTp().add(updTp);
        return this;
    }
