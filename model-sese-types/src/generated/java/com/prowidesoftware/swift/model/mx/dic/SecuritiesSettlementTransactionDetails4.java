...
@XmlType(name = "SecuritiesSettlementTransactionDetails4", propOrder = {
...
public class SecuritiesSettlementTransactionDetails4 {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails4 setSttlmTpAndAddtlParams(SettlementTypeAndAdditionalParameters6 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails4 setTradDtls(SecuritiesTradeDetails25 value) {
        this.tradDtls = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails4 setFinInstrmAttrbts(FinancialInstrumentAttributes35 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails4 setQtyAndAcctDtls(QuantityAndAccount29 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails4 setSttlmParams(SettlementDetails50 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails4 setStgSttlmInstrDtls(StandingSettlementInstruction4 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails4 setDlvrgSttlmPties(SettlementParties26 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails4 setRcvgSttlmPties(SettlementParties26 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails4 setCshPties(CashParties8 value) {
        this.cshPties = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails4 setSttlmAmt(AmountAndDirection32 value) {
        this.sttlmAmt = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails4 setOthrAmts(OtherAmounts14 value) {
        this.othrAmts = value;
        return this;
    }
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails4 setOthrBizPties(OtherParties19 value) {
     ...
     *     
     */
    public SecuritiesSettlementTransactionDetails4 setAddtlPhysOrRegnDtls(RegistrationParameters1 value) {
     ...
     * 
     */
    public SecuritiesSettlementTransactionDetails4 addLnkgs(Linkages21 lnkgs) {
        getLnkgs().add(lnkgs);
        return this;
    }
     ...
     * 
     */
    public SecuritiesSettlementTransactionDetails4 addSplmtryData(SupplementaryData1 splmtryData) {
