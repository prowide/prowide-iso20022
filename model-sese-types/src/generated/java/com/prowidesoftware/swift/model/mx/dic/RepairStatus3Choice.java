...
@XmlType(name = "RepairStatus3Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RepairStatus3Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<RepairReason3> rsn;
     ...
     *     
     */
    public RepairStatus3Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<RepairReason3> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RepairReason3>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RepairStatus3Choice addRsn(RepairReason3 rsn) {
        getRsn().add(rsn);
        return this;
    }
