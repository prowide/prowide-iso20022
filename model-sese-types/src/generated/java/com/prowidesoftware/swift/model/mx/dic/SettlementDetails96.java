...
@XmlType(name = "SettlementDetails96", propOrder = {
    "prty",
    "sttlmTxCond",
    "sttlgCpcty",
    "stmpDtyTaxBsis",
...
public class SettlementDetails96 {
     ...
     *     
     */
    public SettlementDetails96 setPrty(PriorityNumeric4Choice value) {
        this.prty = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails96 setSttlgCpcty(SettlingCapacity7Choice value) {
     ...
     *     
     */
    public SettlementDetails96 setStmpDtyTaxBsis(GenericIdentification30 value) {
     ...
     *     
     */
    public SettlementDetails96 setSctiesRTGS(SecuritiesRTGS4Choice value) {
     ...
     *     
     */
    public SettlementDetails96 setBnfclOwnrsh(BeneficialOwnership4Choice value) {
     ...
     *     
     */
    public SettlementDetails96 setCshClrSys(CashSettlementSystem4Choice value) {
     ...
     *     
     */
    public SettlementDetails96 setTaxCpcty(TaxCapacityParty4Choice value) {
        this.taxCpcty = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails96 setMktClntSd(MarketClientSide4Choice value) {
     ...
     *     
     */
    public SettlementDetails96 setBlckTrad(BlockTrade4Choice value) {
        this.blckTrad = value;
        return this;
    }
     ...
     *     
     */
    public SettlementDetails96 setLglRstrctns(Restriction5Choice value) {
     ...
     *     
     */
    public SettlementDetails96 setSttlmSysMtd(SettlementSystemMethod4Choice value) {
     ...
     *     
     */
    public SettlementDetails96 setNetgElgblty(NettingEligibility4Choice value) {
     ...
     *     
     */
    public SettlementDetails96 setCCPElgblty(CentralCounterPartyEligibility4Choice value) {
     ...
     *     
     */
    public SettlementDetails96 setAutomtcBrrwg(AutomaticBorrowing6Choice value) {
     ...
     *     
     */
    public SettlementDetails96 setPrtlSttlmInd(SettlementTransactionCondition5Code value) {
     ...
     *     
     */
    public SettlementDetails96 setElgblForColl(Boolean value) {
     ...
     * 
     */
    public SettlementDetails96 addSttlmTxCond(SettlementTransactionCondition18Choice sttlmTxCond) {
