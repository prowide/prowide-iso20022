...
@XmlType(name = "SecuritiesSettlementTransactionModificationRequestV07", propOrder = {
    "modfdTxDtls",
    "updTp"
})
public class SecuritiesSettlementTransactionModificationRequestV07 {

    @XmlElement(name = "ModfdTxDtls", required = true)
    protected TransactionDetails116 modfdTxDtls;
    @XmlElement(name = "UpdTp", required = true)
    protected List<UpdateType29Choice> updTp;
     ...
     *     
     */
    public SecuritiesSettlementTransactionModificationRequestV07 setModfdTxDtls(TransactionDetails116 value) {
     ...
     * 
     */
    public SecuritiesSettlementTransactionModificationRequestV07 addUpdTp(UpdateType29Choice updTp) {
        getUpdTp().add(updTp);
        return this;
    }
