...
@XmlType(name = "PEPISATransfer11", propOrder = {
    "pmryIndvInvstr",
    "scndryIndvInvstr",
    "othrIndvInvstr",
    "pmryCorpInvstr",
...
public class PEPISATransfer11 {
    ...
    protected List<ISATransfer3> pdctTrf;
     ...
     *     
     */
    public PEPISATransfer11 setPmryIndvInvstr(IndividualPerson8 value) {
     ...
     *     
     */
    public PEPISATransfer11 setScndryIndvInvstr(IndividualPerson8 value) {
     ...
     *     
     */
    public PEPISATransfer11 setPmryCorpInvstr(Organisation4 value) {
     ...
     *     
     */
    public PEPISATransfer11 setScndryCorpInvstr(Organisation4 value) {
     ...
     *     
     */
    public PEPISATransfer11 setTrfrAcct(Account5 value) {
        this.trfrAcct = value;
        return this;
    }
     ...
     *     
     */
    public PEPISATransfer11 setNmneeAcct(Account6 value) {
     ...
     *     
     */
    public PEPISATransfer11 setTrfee(PartyIdentification2Choice value) {
        this.trfee = value;
        return this;
    }
     ...
     *     
     */
    public PEPISATransfer11 setCshAcct(CashAccount11 value) {
        this.cshAcct = value;
        return this;
    }
     ...
     * 
     */
    public List<ISATransfer3> getPdctTrf() {
        if (pdctTrf == null) {
            pdctTrf = new ArrayList<ISATransfer3>();
        }
        return this.pdctTrf;
    }
     ...
     * 
     */
    public PEPISATransfer11 addOthrIndvInvstr(IndividualPerson8 othrIndvInvstr) {
     ...
     * 
     */
    public PEPISATransfer11 addOthrCorpInvstr(Organisation4 othrCorpInvstr) {
     ...
     * 
     */
    public PEPISATransfer11 addPdctTrf(ISATransfer3 pdctTrf) {
     ...
     * 
     */
    public PEPISATransfer11 addXtnsn(Extension1 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
