...
@XmlType(name = "AcceptedStatus6Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class AcceptedStatus6Choice {

    @XmlElement(name = "NoSpcfdRsn")
    @XmlSchemaType(name = "string")
    protected NoReasonCode noSpcfdRsn;
    @XmlElement(name = "Rsn")
    protected List<AcceptedStatusReason6> rsn;
     ...
     *     
     */
    public AcceptedStatus6Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * {@link AcceptedStatusReason6 }
     * 
     * 
     */
    public List<AcceptedStatusReason6> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<AcceptedStatusReason6>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public AcceptedStatus6Choice addRsn(AcceptedStatusReason6 rsn) {
        getRsn().add(rsn);
        return this;
    }
