...
@XmlType(name = "RequestForTransferStatusReportV04", propOrder = {
    "msgId",
    "reqDtls",
    "mktPrctcVrsn",
    "xtnsn"
...
public class RequestForTransferStatusReportV04 {
    ...
    protected List<MessageAndBusinessReference7> reqDtls;
     ...
     *     
     */
    public RequestForTransferStatusReportV04 setMsgId(MessageIdentification1 value) {
        this.msgId = value;
        return this;
    }
     ...
     * {@link MessageAndBusinessReference7 }
     * 
     * 
     */
    public List<MessageAndBusinessReference7> getReqDtls() {
        if (reqDtls == null) {
            reqDtls = new ArrayList<MessageAndBusinessReference7>();
        }
        return this.reqDtls;
    }
     ...
     *     
     */
    public RequestForTransferStatusReportV04 setMktPrctcVrsn(MarketPracticeVersion1 value) {
     ...
     * 
     */
    public RequestForTransferStatusReportV04 addReqDtls(MessageAndBusinessReference7 reqDtls) {
     ...
     * 
     */
    public RequestForTransferStatusReportV04 addXtnsn(Extension1 xtnsn) {
        getXtnsn().add(xtnsn);
        return this;
    }
