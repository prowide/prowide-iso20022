...
@XmlType(name = "RejectedStatus12Choice", propOrder = {
    "noSpcfdRsn",
    "rsn"
})
public class RejectedStatus12Choice {
    ...
    @XmlElement(name = "Rsn")
    protected List<RejectionReason21> rsn;
     ...
     *     
     */
    public RejectedStatus12Choice setNoSpcfdRsn(NoReasonCode value) {
     ...
     * 
     */
    public List<RejectionReason21> getRsn() {
        if (rsn == null) {
            rsn = new ArrayList<RejectionReason21>();
        }
        return this.rsn;
    }
     ...
     * 
     */
    public RejectedStatus12Choice addRsn(RejectionReason21 rsn) {
        getRsn().add(rsn);
        return this;
    }
