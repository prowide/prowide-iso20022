...
@XmlType(name = "RetailerReversalResult4", propOrder = {
    "poiRcncltnId",
    "orgnlPmtTx",
    "cstmrOrdr"
})
public class RetailerReversalResult4 {

    @XmlElement(name = "POIRcncltnId")
    protected String poiRcncltnId;
    @XmlElement(name = "OrgnlPmtTx")
    protected CardPaymentTransaction120 orgnlPmtTx;
     ...
     *     
     */
    public RetailerReversalResult4 setPOIRcncltnId(String value) {
     ...
     *     
     */
    public CardPaymentTransaction120 getOrgnlPmtTx() {
        return orgnlPmtTx;
    }
     ...
     *     
     */
    public RetailerReversalResult4 setOrgnlPmtTx(CardPaymentTransaction120 value) {
     ...
     * 
     */
    public RetailerReversalResult4 addCstmrOrdr(CustomerOrder1 cstmrOrdr) {
