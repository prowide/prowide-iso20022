...
@XmlType(name = "BatchRequest8", propOrder = {
    "saleBtchId",
    "rmvAllFlg",
    "txToPrfrm"
})
public class BatchRequest8 {
    ...
    protected List<TransactionToPerform8Choice> txToPrfrm;
     ...
     *     
     */
    public BatchRequest8 setSaleBtchId(TransactionIdentifier1 value) {
     ...
     *     
     */
    public BatchRequest8 setRmvAllFlg(Boolean value) {
     ...
     * {@link TransactionToPerform8Choice }
     * 
     * 
     * @return
     *     The value of the txToPrfrm property.
     */
    public List<TransactionToPerform8Choice> getTxToPrfrm() {
        if (txToPrfrm == null) {
     ...
     * 
     */
    public BatchRequest8 addTxToPrfrm(TransactionToPerform8Choice txToPrfrm) {
