...
@XmlType(name = "BatchResponse4", propOrder = {
    "saleBtchId",
    "poiBtchId",
    "prfrmdTx"
})
public class BatchResponse4 {
    ...
    protected List<PerformedTransaction4> prfrmdTx;
     ...
     *     
     */
    public BatchResponse4 setSaleBtchId(TransactionIdentifier1 value) {
     ...
     *     
     */
    public BatchResponse4 setPOIBtchId(TransactionIdentifier1 value) {
     ...
     * {@link PerformedTransaction4 }
     * 
     * 
     */
    public List<PerformedTransaction4> getPrfrmdTx() {
        if (prfrmdTx == null) {
            prfrmdTx = new ArrayList<PerformedTransaction4>();
        }
     ...
     * 
     */
    public BatchResponse4 addPrfrmdTx(PerformedTransaction4 prfrmdTx) {
