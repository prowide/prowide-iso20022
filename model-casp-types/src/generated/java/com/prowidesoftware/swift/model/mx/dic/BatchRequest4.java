...
@XmlType(name = "BatchRequest4", propOrder = {
    "saleBtchId",
    "rmvAllFlg",
    "txToPrfrm"
})
public class BatchRequest4 {
    ...
    protected List<TransactionToPerform4Choice> txToPrfrm;
     ...
     *     
     */
    public BatchRequest4 setSaleBtchId(TransactionIdentifier1 value) {
     ...
     *     
     */
    public BatchRequest4 setRmvAllFlg(Boolean value) {
     ...
     * {@link TransactionToPerform4Choice }
     * 
     * 
     */
    public List<TransactionToPerform4Choice> getTxToPrfrm() {
        if (txToPrfrm == null) {
            txToPrfrm = new ArrayList<TransactionToPerform4Choice>();
        }
     ...
     * 
     */
    public BatchRequest4 addTxToPrfrm(TransactionToPerform4Choice txToPrfrm) {
