...
@XmlType(name = "PaymentResponse1", propOrder = {
    "saleTxId",
    "saleRefId",
    "poiTxId",
    "poiRcncltnId",
...
public class PaymentResponse1 {
     ...
     *     
     */
    public PaymentResponse1 setSaleTxId(TransactionIdentifier1 value) {
        this.saleTxId = value;
        return this;
    }
     ...
     *     
     */
    public PaymentResponse1 setSaleRefId(String value) {
     ...
     *     
     */
    public PaymentResponse1 setPOITxId(TransactionIdentifier1 value) {
        this.poiTxId = value;
        return this;
    }
     ...
     *     
     */
    public PaymentResponse1 setPOIRcncltnId(String value) {
     ...
     *     
     */
    public PaymentResponse1 setIssrRefData(String value) {
     ...
     *     
     */
    public PaymentResponse1 setRtlrPmtRslt(RetailerPaymentResult1 value) {
    ...
    public List<PaymentReceipt1> getPmtRct() {
        if (pmtRct == null) {
            pmtRct = new ArrayList<PaymentReceipt1>();
        }
        return this.pmtRct;
    }
    ...
    public List<LoyaltyResult1> getLltyRslt() {
        if (lltyRslt == null) {
            lltyRslt = new ArrayList<LoyaltyResult1>();
        }
     ...
     * 
     */
    public PaymentResponse1 addPmtRct(PaymentReceipt1 pmtRct) {
     ...
     * 
     */
    public PaymentResponse1 addLltyRslt(LoyaltyResult1 lltyRslt) {
     ...
     * 
     */
    public PaymentResponse1 addCstmrOrdr(CustomerOrder1 cstmrOrdr) {
