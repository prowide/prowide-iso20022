...
@XmlType(name = "RetailerEvent8", propOrder = {
    "evtTmStmp",
    "evtToNtfy",
    "evtCntxt",
    "addtlEvtInf"
})
public class RetailerEvent8 {
    ...
    protected EventContext8 evtCntxt;
     ...
     *     
     */
    public RetailerEvent8 setEvtTmStmp(OffsetDateTime value) {
     ...
     *     
     */
    public RetailerEvent8 setEvtToNtfy(EventToNotify2Code value) {
     ...
     *     
     */
    public EventContext8 getEvtCntxt() {
        return evtCntxt;
    }
     ...
     *     
     */
    public RetailerEvent8 setEvtCntxt(EventContext8 value) {
        this.evtCntxt = value;
        return this;
    }
     ...
     *     
     */
    public RetailerEvent8 setAddtlEvtInf(String value) {
