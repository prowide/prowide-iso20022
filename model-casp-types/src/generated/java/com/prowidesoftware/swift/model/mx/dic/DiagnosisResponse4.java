...
@XmlType(name = "DiagnosisResponse4", propOrder = {
    "lggdSaleId",
    "poiSts",
    "hstSts"
})
public class DiagnosisResponse4 {

    @XmlElement(name = "LggdSaleId")
    protected List<String> lggdSaleId;
    @XmlElement(name = "POISts")
    protected StatusReportContent11 poiSts;
     ...
     *     
     */
    public StatusReportContent11 getPOISts() {
        return poiSts;
    }
     ...
     *     
     */
    public DiagnosisResponse4 setPOISts(StatusReportContent11 value) {
        this.poiSts = value;
        return this;
    }
     ...
     * 
     */
    public DiagnosisResponse4 addLggdSaleId(String lggdSaleId) {
     ...
     * 
     */
    public DiagnosisResponse4 addHstSts(HostStatus1 hstSts) {
