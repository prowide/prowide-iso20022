...
@XmlType(name = "LoginResponse8", propOrder = {
    "poiDtTm",
    "poiSftwr",
    "poiCpblties",
    "outptDisp"
})
public class LoginResponse8 {
    ...
    protected List<PointOfInteractionComponent18> poiSftwr;
     ...
     *     
     */
    public LoginResponse8 setPOIDtTm(OffsetDateTime value) {
        this.poiDtTm = value;
        return this;
    }
     ...
     */
    public List<PointOfInteractionComponent18> getPOISftwr() {
        if (poiSftwr == null) {
     ...
     *     
     */
    public LoginResponse8 setPOICpblties(PointOfInteractionCapabilities9 value) {
     ...
     *     
     */
    public LoginResponse8 setOutptDisp(ActionMessage12 value) {
     ...
     * 
     */
    public LoginResponse8 addPOISftwr(PointOfInteractionComponent18 pOISftwr) {
