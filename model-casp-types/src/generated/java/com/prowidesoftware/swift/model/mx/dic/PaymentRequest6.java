...
@XmlType(name = "PaymentRequest6", propOrder = {
    "pmtTx",
    "lltyData"
})
public class PaymentRequest6 {

    @XmlElement(name = "PmtTx")
    protected CardPaymentTransaction136 pmtTx;
     ...
     *     
     */
    public CardPaymentTransaction136 getPmtTx() {
        return pmtTx;
    }
     ...
     *     
     */
    public PaymentRequest6 setPmtTx(CardPaymentTransaction136 value) {
        this.pmtTx = value;
        return this;
    }
     ...
     * 
     */
    public PaymentRequest6 addLltyData(LoyaltyRequestData3 lltyData) {
