...
@XmlType(name = "LoyaltyRequest8", propOrder = {
    "cstmrOrdr",
    "tx",
    "data"
})
public class LoyaltyRequest8 {

    @XmlElement(name = "CstmrOrdr")
    protected CustomerOrder1 cstmrOrdr;
    @XmlElement(name = "Tx", required = true)
    protected LoyaltyTransaction8 tx;
     ...
     *     
     */
    public LoyaltyRequest8 setCstmrOrdr(CustomerOrder1 value) {
     ...
     * @return
     *     possible object is
     *     {@link LoyaltyTransaction8 }
     *     
     */
    public LoyaltyTransaction8 getTx() {
        return tx;
    }
     ...
     *     
     */
    public LoyaltyRequest8 setTx(LoyaltyTransaction8 value) {
        this.tx = value;
        return this;
    }
     ...
     * 
     */
    public LoyaltyRequest8 addData(LoyaltyRequestData3 data) {
        getData().add(data);
        return this;
    }
