...
@XmlType(name = "CardholderAuthentication12", propOrder = {
    "authntcnMtd",
    "authntcnVal",
    "prtctdAuthntcnVal",
    "crdhldrOnLinePIN",
...
public class CardholderAuthentication12 {
     ...
     *     
     */
    public CardholderAuthentication12 setAuthntcnMtd(AuthenticationMethod8Code value) {
     ...
     *     byte[]
     */
    public CardholderAuthentication12 setAuthntcnVal(byte[] value) {
     ...
     *     
     */
    public CardholderAuthentication12 setPrtctdAuthntcnVal(ContentInformationType17 value) {
     ...
     *     
     */
    public CardholderAuthentication12 setCrdhldrOnLinePIN(OnLinePIN6 value) {
     ...
     *     
     */
    public CardholderAuthentication12 setCrdhldrId(PersonIdentification15 value) {
     ...
     *     
     */
    public CardholderAuthentication12 setAdrVrfctn(AddressVerification1 value) {
     ...
     *     
     */
    public CardholderAuthentication12 setAuthntcnTp(String value) {
     ...
     *     
     */
    public CardholderAuthentication12 setAuthntcnLvl(String value) {
     ...
     *     
     */
    public CardholderAuthentication12 setAuthntcnRslt(AuthenticationResult1Code value) {
     ...
     *     
     */
    public CardholderAuthentication12 setAuthntcnAddtlInf(String value) {
