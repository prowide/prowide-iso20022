...
@XmlType(name = "EventNotificationData8", propOrder = {
    "rtlrEvt",
    "mntncReqrdFlg",
    "cstmrLang",
    "dispOutpt"
})
public class EventNotificationData8 {

    @XmlElement(name = "RtlrEvt", required = true)
    protected RetailerEvent8 rtlrEvt;
     ...
     *     
     */
    public RetailerEvent8 getRtlrEvt() {
        return rtlrEvt;
    }
     ...
     *     
     */
    public EventNotificationData8 setRtlrEvt(RetailerEvent8 value) {
        this.rtlrEvt = value;
        return this;
    }
     ...
     *     
     */
    public EventNotificationData8 setMntncReqrdFlg(Boolean value) {
     ...
     *     
     */
    public EventNotificationData8 setCstmrLang(String value) {
     ...
     *     
     */
    public EventNotificationData8 setDispOutpt(ActionMessage12 value) {
