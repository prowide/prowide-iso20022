...
@XmlType(name = "DeviceDisplayRequest1", propOrder = {
    "dispOutpt"
})
public class DeviceDisplayRequest1 {

    @XmlElement(name = "DispOutpt", required = true)
    protected List<ActionMessage6> dispOutpt;
     ...
     * 
     */
    public DeviceDisplayRequest1 addDispOutpt(ActionMessage6 dispOutpt) {
