...
public class LoyaltyRequest5 {
     ...
     *     
     */
    public LoyaltyRequest5 setCstmrOrdr(CustomerOrder1 value) {
     ...
     *     
     */
    public LoyaltyRequest5 setTx(LoyaltyTransaction5 value) {
        this.tx = value;
        return this;
    }
     ...
     * 
     */
    public LoyaltyRequest5 addData(LoyaltyRequestData3 data) {
        getData().add(data);
        return this;
    }
