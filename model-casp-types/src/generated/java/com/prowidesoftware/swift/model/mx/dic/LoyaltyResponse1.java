...
@XmlType(name = "LoyaltyResponse1", propOrder = {
    "saleTxId",
    "poiTxId",
    "poiRcncltnId",
    "rslt"
})
public class LoyaltyResponse1 {
    ...
    protected List<LoyaltyResult1> rslt;
     ...
     *     
     */
    public LoyaltyResponse1 setSaleTxId(TransactionIdentifier1 value) {
        this.saleTxId = value;
        return this;
    }
     ...
     *     
     */
    public LoyaltyResponse1 setPOITxId(TransactionIdentifier1 value) {
        this.poiTxId = value;
        return this;
    }
     ...
     *     
     */
    public LoyaltyResponse1 setPOIRcncltnId(String value) {
     ...
     * 
     */
    public List<LoyaltyResult1> getRslt() {
        if (rslt == null) {
            rslt = new ArrayList<LoyaltyResult1>();
        }
        return this.rslt;
    }
     ...
     * 
     */
    public LoyaltyResponse1 addRslt(LoyaltyResult1 rslt) {
        getRslt().add(rslt);
        return this;
    }
