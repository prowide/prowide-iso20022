...
@XmlType(name = "StoredValueRequest9", propOrder = {
    "saleTxId",
    "data"
})
public class StoredValueRequest9 {

    @XmlElement(name = "SaleTxId")
    protected TransactionIdentifier1 saleTxId;
    @XmlElement(name = "Data", required = true)
    protected List<StoredValueData9> data;
     ...
     *     
     */
    public StoredValueRequest9 setSaleTxId(TransactionIdentifier1 value) {
        this.saleTxId = value;
        return this;
    }
     ...
     */
    public List<StoredValueData9> getData() {
        if (data == null) {
            data = new ArrayList<>();
        }
        return this.data;
     ...
     * 
     */
    public StoredValueRequest9 addData(StoredValueData9 data) {
        getData().add(data);
        return this;
    }
