...
@XmlType(name = "LoginResponse4", propOrder = {
    "poiDtTm",
    "poiSftwr",
    "poiCpblties",
    "outptDisp"
...
public class LoginResponse4 {
    ...
    protected List<PointOfInteractionComponent12> poiSftwr;
     ...
     *     
     */
    public LoginResponse4 setPOIDtTm(XMLGregorianCalendar value) {
        this.poiDtTm = value;
        return this;
    }
     ...
     * 
     */
    public List<PointOfInteractionComponent12> getPOISftwr() {
        if (poiSftwr == null) {
            poiSftwr = new ArrayList<PointOfInteractionComponent12>();
        }
     ...
     *     
     */
    public LoginResponse4 setPOICpblties(PointOfInteractionCapabilities9 value) {
     ...
     *     
     */
    public LoginResponse4 setOutptDisp(ActionMessage9 value) {
     ...
     * 
     */
    public LoginResponse4 addPOISftwr(PointOfInteractionComponent12 pOISftwr) {
