...
@XmlType(name = "PaymentRequest8", propOrder = {
    "pmtTx",
    "lltyData"
})
public class PaymentRequest8 {

    @XmlElement(name = "PmtTx")
    protected PaymentTransaction183 pmtTx;
     ...
     *     
     */
    public PaymentTransaction183 getPmtTx() {
        return pmtTx;
    }
     ...
     *     
     */
    public PaymentRequest8 setPmtTx(PaymentTransaction183 value) {
        this.pmtTx = value;
        return this;
    }
     ...
     * 
     */
    public PaymentRequest8 addLltyData(LoyaltyRequestData3 lltyData) {
