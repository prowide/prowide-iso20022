...
@XmlType(name = "DiagnosisResponse7", propOrder = {
    "lggdSaleId",
    "poiSts",
    "hstSts"
})
public class DiagnosisResponse7 {

    @XmlElement(name = "LggdSaleId")
    protected List<String> lggdSaleId;
    @XmlElement(name = "POISts")
    protected StatusReportContent14 poiSts;
     ...
     *     
     */
    public StatusReportContent14 getPOISts() {
        return poiSts;
    }
     ...
     *     
     */
    public DiagnosisResponse7 setPOISts(StatusReportContent14 value) {
        this.poiSts = value;
        return this;
    }
     ...
     * 
     */
    public DiagnosisResponse7 addLggdSaleId(String lggdSaleId) {
     ...
     * 
     */
    public DiagnosisResponse7 addHstSts(HostStatus1 hstSts) {
