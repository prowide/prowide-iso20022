...
@XmlType(name = "LoginResponse6", propOrder = {
    "poiDtTm",
    "poiSftwr",
    "poiCpblties",
    "outptDisp"
})
public class LoginResponse6 {
    ...
    protected List<PointOfInteractionComponent15> poiSftwr;
     ...
     *     
     */
    public LoginResponse6 setPOIDtTm(OffsetDateTime value) {
        this.poiDtTm = value;
        return this;
    }
     ...
     */
    public List<PointOfInteractionComponent15> getPOISftwr() {
        if (poiSftwr == null) {
     ...
     *     
     */
    public LoginResponse6 setPOICpblties(PointOfInteractionCapabilities9 value) {
     ...
     *     
     */
    public LoginResponse6 setOutptDisp(ActionMessage11 value) {
     ...
     * 
     */
    public LoginResponse6 addPOISftwr(PointOfInteractionComponent15 pOISftwr) {
