...
@XmlType(name = "LoginResponse7", propOrder = {
    "poiDtTm",
    "poiSftwr",
    "poiCpblties",
    "outptDisp"
})
public class LoginResponse7 {
    ...
    protected List<PointOfInteractionComponent17> poiSftwr;
     ...
     *     
     */
    public LoginResponse7 setPOIDtTm(XMLGregorianCalendar value) {
        this.poiDtTm = value;
        return this;
    }
     ...
     * 
     */
    public List<PointOfInteractionComponent17> getPOISftwr() {
        if (poiSftwr == null) {
            poiSftwr = new ArrayList<PointOfInteractionComponent17>();
        }
     ...
     *     
     */
    public LoginResponse7 setPOICpblties(PointOfInteractionCapabilities9 value) {
     ...
     *     
     */
    public LoginResponse7 setOutptDisp(ActionMessage11 value) {
     ...
     * 
     */
    public LoginResponse7 addPOISftwr(PointOfInteractionComponent17 pOISftwr) {
