...
@XmlType(name = "BatchRequest7", propOrder = {
    "saleBtchId",
    "rmvAllFlg",
    "txToPrfrm"
})
public class BatchRequest7 {
    ...
    protected List<TransactionToPerform7Choice> txToPrfrm;
     ...
     *     
     */
    public BatchRequest7 setSaleBtchId(TransactionIdentifier1 value) {
     ...
     *     
     */
    public BatchRequest7 setRmvAllFlg(Boolean value) {
     ...
     * {@link TransactionToPerform7Choice }
     * 
     * 
     */
    public List<TransactionToPerform7Choice> getTxToPrfrm() {
        if (txToPrfrm == null) {
            txToPrfrm = new ArrayList<TransactionToPerform7Choice>();
        }
     ...
     * 
     */
    public BatchRequest7 addTxToPrfrm(TransactionToPerform7Choice txToPrfrm) {
