...
@XmlType(name = "StoredValueResponse5", propOrder = {
    "saleTxId",
    "poiTxId",
    "rslt",
    "rct"
})
public class StoredValueResponse5 {
    ...
    protected List<StoredValueData5> rslt;
    @XmlElement(name = "Rct")
     ...
     *     
     */
    public StoredValueResponse5 setSaleTxId(TransactionIdentifier1 value) {
        this.saleTxId = value;
        return this;
    }
     ...
     *     
     */
    public StoredValueResponse5 setPOITxId(TransactionIdentifier1 value) {
        this.poiTxId = value;
        return this;
    }
     ...
     * 
     */
    public List<StoredValueData5> getRslt() {
        if (rslt == null) {
            rslt = new ArrayList<StoredValueData5>();
        }
        return this.rslt;
    }
     ...
     * 
     */
    public StoredValueResponse5 addRslt(StoredValueData5 rslt) {
        getRslt().add(rslt);
        return this;
    }
     ...
     * 
     */
    public StoredValueResponse5 addRct(PaymentReceipt4 rct) {
        getRct().add(rct);
        return this;
    }
