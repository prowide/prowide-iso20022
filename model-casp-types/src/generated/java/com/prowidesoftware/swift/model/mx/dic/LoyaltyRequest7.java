...
@XmlType(name = "LoyaltyRequest7", propOrder = {
    "cstmrOrdr",
    "tx",
    "data"
})
public class LoyaltyRequest7 {

    @XmlElement(name = "CstmrOrdr")
    protected CustomerOrder1 cstmrOrdr;
    @XmlElement(name = "Tx", required = true)
    protected LoyaltyTransaction7 tx;
     ...
     *     
     */
    public LoyaltyRequest7 setCstmrOrdr(CustomerOrder1 value) {
     ...
     * @return
     *     possible object is
     *     {@link LoyaltyTransaction7 }
     *     
     */
    public LoyaltyTransaction7 getTx() {
        return tx;
    }
     ...
     *     
     */
    public LoyaltyRequest7 setTx(LoyaltyTransaction7 value) {
        this.tx = value;
        return this;
    }
     ...
     * 
     */
    public LoyaltyRequest7 addData(LoyaltyRequestData3 data) {
        getData().add(data);
        return this;
    }
