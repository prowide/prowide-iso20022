...
@XmlType(name = "DiagnosisResponse2", propOrder = {
    "lggdSaleId",
    "poiSts",
    "hstSts"
})
public class DiagnosisResponse2 {

    @XmlElement(name = "LggdSaleId")
    protected List<String> lggdSaleId;
    @XmlElement(name = "POISts")
    protected StatusReportContent9 poiSts;
     ...
     *     
     */
    public StatusReportContent9 getPOISts() {
        return poiSts;
    }
     ...
     *     
     */
    public DiagnosisResponse2 setPOISts(StatusReportContent9 value) {
        this.poiSts = value;
        return this;
    }
     ...
     * 
     */
    public DiagnosisResponse2 addLggdSaleId(String lggdSaleId) {
     ...
     * 
     */
    public DiagnosisResponse2 addHstSts(HostStatus1 hstSts) {
