...
@XmlType(name = "RetailerEvent7", propOrder = {
    "evtTmStmp",
    "evtToNtfy",
    "evtCntxt",
    "addtlEvtInf"
})
public class RetailerEvent7 {
    ...
    protected EventContext7 evtCntxt;
     ...
     *     
     */
    public RetailerEvent7 setEvtTmStmp(XMLGregorianCalendar value) {
     ...
     *     
     */
    public RetailerEvent7 setEvtToNtfy(EventToNotify2Code value) {
     ...
     *     
     */
    public EventContext7 getEvtCntxt() {
        return evtCntxt;
    }
     ...
     *     
     */
    public RetailerEvent7 setEvtCntxt(EventContext7 value) {
        this.evtCntxt = value;
        return this;
    }
     ...
     *     
     */
    public RetailerEvent7 setAddtlEvtInf(String value) {
