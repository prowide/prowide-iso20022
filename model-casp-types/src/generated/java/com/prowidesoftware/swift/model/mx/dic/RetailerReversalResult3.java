...
@XmlType(name = "RetailerReversalResult3", propOrder = {
    "poiRcncltnId",
    "orgnlPmtTx",
    "cstmrOrdr"
})
public class RetailerReversalResult3 {

    @XmlElement(name = "POIRcncltnId")
    protected String poiRcncltnId;
    @XmlElement(name = "OrgnlPmtTx")
    protected CardPaymentTransaction110 orgnlPmtTx;
     ...
     *     
     */
    public RetailerReversalResult3 setPOIRcncltnId(String value) {
     ...
     *     
     */
    public CardPaymentTransaction110 getOrgnlPmtTx() {
        return orgnlPmtTx;
    }
     ...
     *     
     */
    public RetailerReversalResult3 setOrgnlPmtTx(CardPaymentTransaction110 value) {
     ...
     * 
     */
    public RetailerReversalResult3 addCstmrOrdr(CustomerOrder1 cstmrOrdr) {
