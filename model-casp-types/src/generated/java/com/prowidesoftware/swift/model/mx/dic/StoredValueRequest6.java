...
public class StoredValueRequest6 {
     ...
     *     
     */
    public StoredValueRequest6 setSaleTxId(TransactionIdentifier1 value) {
        this.saleTxId = value;
        return this;
    }
    ...
    public List<StoredValueData6> getData() {
        if (data == null) {
            data = new ArrayList<StoredValueData6>();
        }
        return this.data;
    }
     ...
     * 
     */
    public StoredValueRequest6 addData(StoredValueData6 data) {
        getData().add(data);
        return this;
    }
