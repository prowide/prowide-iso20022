...
@XmlType(name = "DiagnosisResponse8", propOrder = {
    "lggdSaleId",
    "poiSts",
    "hstSts"
})
public class DiagnosisResponse8 {

    @XmlElement(name = "LggdSaleId")
    protected List<String> lggdSaleId;
    @XmlElement(name = "POISts")
    protected StatusReportContent15 poiSts;
     ...
     *     
     */
    public StatusReportContent15 getPOISts() {
        return poiSts;
    }
     ...
     *     
     */
    public DiagnosisResponse8 setPOISts(StatusReportContent15 value) {
        this.poiSts = value;
        return this;
    }
     ...
     * 
     */
    public DiagnosisResponse8 addLggdSaleId(String lggdSaleId) {
     ...
     * 
     */
    public DiagnosisResponse8 addHstSts(HostStatus1 hstSts) {
