...
@XmlType(name = "TrackerStatusAndTransaction13", propOrder = {
    "txSts",
    "tx"
})
public class TrackerStatusAndTransaction13 {
     ...
     *     
     */
    public TrackerStatusAndTransaction13 setTxSts(TrackerStatus4 value) {
        this.txSts = value;
        return this;
    }
    ...
    public List<TrackerPaymentTransaction11> getTx() {
        if (tx == null) {
            tx = new ArrayList<TrackerPaymentTransaction11>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public TrackerStatusAndTransaction13 addTx(TrackerPaymentTransaction11 tx) {
        getTx().add(tx);
        return this;
    }
