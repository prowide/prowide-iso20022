...
@XmlType(name = "PaymentStatusCustomerTrackerReportV04", propOrder = {
    "grpHdr",
    "trckrStsAndTx",
    "splmtryData"
})
public class PaymentStatusCustomerTrackerReportV04 {

    @XmlElement(name = "GrpHdr", required = true)
    protected TrackerHeader5 grpHdr;
    @XmlElement(name = "TrckrStsAndTx", required = true)
    protected List<TrackerStatusAndTransaction21> trckrStsAndTx;
     ...
     *     
     */
    public PaymentStatusCustomerTrackerReportV04 setGrpHdr(TrackerHeader5 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link TrackerStatusAndTransaction21 }
     * 
     * 
     * @return
     *     The value of the trckrStsAndTx property.
     */
    public List<TrackerStatusAndTransaction21> getTrckrStsAndTx() {
     ...
     * 
     */
    public PaymentStatusCustomerTrackerReportV04 addTrckrStsAndTx(TrackerStatusAndTransaction21 trckrStsAndTx) {
     ...
     * 
     */
    public PaymentStatusCustomerTrackerReportV04 addSplmtryData(SupplementaryData1 splmtryData) {
