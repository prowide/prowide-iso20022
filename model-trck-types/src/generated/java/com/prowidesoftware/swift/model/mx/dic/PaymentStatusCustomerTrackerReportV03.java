...
@XmlType(name = "PaymentStatusCustomerTrackerReportV03", propOrder = {
    "grpHdr",
    "trckrStsAndTx",
    "splmtryData"
})
public class PaymentStatusCustomerTrackerReportV03 {

    @XmlElement(name = "GrpHdr", required = true)
    protected TrackerHeader5 grpHdr;
    @XmlElement(name = "TrckrStsAndTx", required = true)
    protected List<TrackerStatusAndTransaction18> trckrStsAndTx;
     ...
     *     
     */
    public PaymentStatusCustomerTrackerReportV03 setGrpHdr(TrackerHeader5 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link TrackerStatusAndTransaction18 }
     * 
     * 
     * @return
     *     The value of the trckrStsAndTx property.
     */
    public List<TrackerStatusAndTransaction18> getTrckrStsAndTx() {
     ...
     * 
     */
    public PaymentStatusCustomerTrackerReportV03 addTrckrStsAndTx(TrackerStatusAndTransaction18 trckrStsAndTx) {
     ...
     * 
     */
    public PaymentStatusCustomerTrackerReportV03 addSplmtryData(SupplementaryData1 splmtryData) {
