...
@XmlType(name = "PaymentStatusTrackerUpdateV05", propOrder = {
    "grpHdr",
    "trckrStsAndTx",
    "splmtryData"
})
public class PaymentStatusTrackerUpdateV05 {

    @XmlElement(name = "GrpHdr", required = true)
    protected TrackerHeader6 grpHdr;
    @XmlElement(name = "TrckrStsAndTx", required = true)
    protected List<TrackerStatusAndTransaction22> trckrStsAndTx;
     ...
     *     
     */
    public PaymentStatusTrackerUpdateV05 setGrpHdr(TrackerHeader6 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link TrackerStatusAndTransaction22 }
     * 
     * 
     * @return
     *     The value of the trckrStsAndTx property.
     */
    public List<TrackerStatusAndTransaction22> getTrckrStsAndTx() {
     ...
     * 
     */
    public PaymentStatusTrackerUpdateV05 addTrckrStsAndTx(TrackerStatusAndTransaction22 trckrStsAndTx) {
     ...
     * 
     */
    public PaymentStatusTrackerUpdateV05 addSplmtryData(SupplementaryData1 splmtryData) {
