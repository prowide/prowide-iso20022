...
@XmlType(name = "PaymentStatusTrackerUpdateV03", propOrder = {
    "grpHdr",
    "trckrStsAndTx",
    "splmtryData"
})
public class PaymentStatusTrackerUpdateV03 {

    @XmlElement(name = "GrpHdr", required = true)
    protected TrackerHeader6 grpHdr;
    @XmlElement(name = "TrckrStsAndTx", required = true)
    protected List<TrackerStatusAndTransaction14> trckrStsAndTx;
     ...
     *     
     */
    public PaymentStatusTrackerUpdateV03 setGrpHdr(TrackerHeader6 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link TrackerStatusAndTransaction14 }
     * 
     * 
     */
    public List<TrackerStatusAndTransaction14> getTrckrStsAndTx() {
        if (trckrStsAndTx == null) {
            trckrStsAndTx = new ArrayList<TrackerStatusAndTransaction14>();
        }
     ...
     * 
     */
    public PaymentStatusTrackerUpdateV03 addTrckrStsAndTx(TrackerStatusAndTransaction14 trckrStsAndTx) {
     ...
     * 
     */
    public PaymentStatusTrackerUpdateV03 addSplmtryData(SupplementaryData1 splmtryData) {
