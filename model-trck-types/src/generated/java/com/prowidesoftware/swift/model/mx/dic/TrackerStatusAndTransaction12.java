...
@XmlType(name = "TrackerStatusAndTransaction12", propOrder = {
    "txSts",
    "tx"
})
public class TrackerStatusAndTransaction12 {
     ...
     *     
     */
    public TrackerStatusAndTransaction12 setTxSts(TrackerStatus1 value) {
        this.txSts = value;
        return this;
    }
    ...
    public List<TrackerPaymentTransaction10> getTx() {
        if (tx == null) {
            tx = new ArrayList<TrackerPaymentTransaction10>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public TrackerStatusAndTransaction12 addTx(TrackerPaymentTransaction10 tx) {
        getTx().add(tx);
        return this;
    }
