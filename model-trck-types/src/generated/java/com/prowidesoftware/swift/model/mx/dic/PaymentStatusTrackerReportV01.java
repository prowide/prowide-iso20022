...
@XmlType(name = "PaymentStatusTrackerReportV01", propOrder = {
    "grpHdr",
    "trckrStsAndTx",
    "splmtryData"
})
public class PaymentStatusTrackerReportV01 {
     ...
     *     
     */
    public PaymentStatusTrackerReportV01 setGrpHdr(TrackerHeader5 value) {
        this.grpHdr = value;
        return this;
    }
    ...
    public List<TrackerStatusAndTransaction11> getTrckrStsAndTx() {
        if (trckrStsAndTx == null) {
            trckrStsAndTx = new ArrayList<TrackerStatusAndTransaction11>();
        }
     ...
     * 
     */
    public PaymentStatusTrackerReportV01 addTrckrStsAndTx(TrackerStatusAndTransaction11 trckrStsAndTx) {
     ...
     * 
     */
    public PaymentStatusTrackerReportV01 addSplmtryData(SupplementaryData1 splmtryData) {
