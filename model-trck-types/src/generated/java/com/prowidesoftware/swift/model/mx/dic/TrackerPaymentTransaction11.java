...
public class TrackerPaymentTransaction11 {
     ...
     *     
     */
    public TrackerPaymentTransaction11 setIntrBkSttlmDt(XMLGregorianCalendar value) {
     ...
     *     
     */
    public TrackerPaymentTransaction11 setAccptncDtTm(XMLGregorianCalendar value) {
     ...
     *     
     */
    public TrackerPaymentTransaction11 setPoolgAdjstmntDt(XMLGregorianCalendar value) {
    ...
    public List<TrackerRecord6> getTrckrRcrd() {
        if (trckrRcrd == null) {
            trckrRcrd = new ArrayList<TrackerRecord6>();
        }
