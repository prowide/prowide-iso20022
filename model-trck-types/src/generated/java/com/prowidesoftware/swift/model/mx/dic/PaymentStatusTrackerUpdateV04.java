...
@XmlType(name = "PaymentStatusTrackerUpdateV04", propOrder = {
    "grpHdr",
    "trckrStsAndTx",
    "splmtryData"
})
public class PaymentStatusTrackerUpdateV04 {

    @XmlElement(name = "GrpHdr", required = true)
    protected TrackerHeader6 grpHdr;
    @XmlElement(name = "TrckrStsAndTx", required = true)
    protected List<TrackerStatusAndTransaction19> trckrStsAndTx;
     ...
     *     
     */
    public PaymentStatusTrackerUpdateV04 setGrpHdr(TrackerHeader6 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link TrackerStatusAndTransaction19 }
     * 
     * 
     * @return
     *     The value of the trckrStsAndTx property.
     */
    public List<TrackerStatusAndTransaction19> getTrckrStsAndTx() {
     ...
     * 
     */
    public PaymentStatusTrackerUpdateV04 addTrckrStsAndTx(TrackerStatusAndTransaction19 trckrStsAndTx) {
     ...
     * 
     */
    public PaymentStatusTrackerUpdateV04 addSplmtryData(SupplementaryData1 splmtryData) {
