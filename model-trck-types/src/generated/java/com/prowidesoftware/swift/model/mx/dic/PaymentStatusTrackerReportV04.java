...
@XmlType(name = "PaymentStatusTrackerReportV04", propOrder = {
    "grpHdr",
    "trckrStsAndTx",
    "splmtryData"
})
public class PaymentStatusTrackerReportV04 {
     ...
     *     
     */
    public PaymentStatusTrackerReportV04 setGrpHdr(TrackerHeader5 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public PaymentStatusTrackerReportV04 addTrckrStsAndTx(TrackerStatusAndTransaction21 trckrStsAndTx) {
     ...
     * 
     */
    public PaymentStatusTrackerReportV04 addSplmtryData(SupplementaryData1 splmtryData) {
