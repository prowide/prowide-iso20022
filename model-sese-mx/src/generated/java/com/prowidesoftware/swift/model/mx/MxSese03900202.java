    ...
    extends AbstractMX
{
    ...
    public static MxSese03900202 parse(String xml) {
        return ((MxSese03900202) MxReadImpl.parse(MxSese03900202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03900202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03900202) MxReadImpl.parse(MxSese03900202 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03900202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03900202 .class);
    }
