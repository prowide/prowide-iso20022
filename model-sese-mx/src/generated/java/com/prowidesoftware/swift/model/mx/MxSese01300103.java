    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.013.001.03";
    ...
    public static MxSese01300103 parse(String xml) {
        return ((MxSese01300103) MxReadImpl.parse(MxSese01300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01300103) MxReadImpl.parse(MxSese01300103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01300103 .class);
    }
