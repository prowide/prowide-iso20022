    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.012.001.08";
    ...
    public static MxSese01200108 parse(String xml) {
        return ((MxSese01200108) MxReadImpl.parse(MxSese01200108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01200108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01200108) MxReadImpl.parse(MxSese01200108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01200108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01200108 .class);
    }
