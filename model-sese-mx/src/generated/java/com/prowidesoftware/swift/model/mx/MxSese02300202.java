    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.023.002.02";
    ...
    public static MxSese02300202 parse(String xml) {
        return ((MxSese02300202) MxReadImpl.parse(MxSese02300202 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02300202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300202 .class);
    }
