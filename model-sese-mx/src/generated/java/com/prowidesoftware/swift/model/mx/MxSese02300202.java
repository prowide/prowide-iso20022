    ...
    extends AbstractMX
{
    ...
    public static MxSese02300202 parse(String xml) {
        return ((MxSese02300202) MxReadImpl.parse(MxSese02300202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300202) MxReadImpl.parse(MxSese02300202 .class, xml, _classes, new MxReadParams(conf)));
    }
