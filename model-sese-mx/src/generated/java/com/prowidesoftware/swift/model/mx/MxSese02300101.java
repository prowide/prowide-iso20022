    ...
    extends AbstractMX
{
    ...
    public static MxSese02300101 parse(String xml) {
        return ((MxSese02300101) MxReadImpl.parse(MxSese02300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300101) MxReadImpl.parse(MxSese02300101 .class, xml, _classes, new MxReadParams(conf)));
    }
