    ...
    extends AbstractMX
{
    ...
    public static MxSese02600108 parse(String xml) {
        return ((MxSese02600108) MxReadImpl.parse(MxSese02600108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600108) MxReadImpl.parse(MxSese02600108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02600108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600108 .class);
    }
