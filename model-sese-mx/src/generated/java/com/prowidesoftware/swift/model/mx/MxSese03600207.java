    ...
    extends AbstractMX
{
    ...
    public static MxSese03600207 parse(String xml) {
        return ((MxSese03600207) MxReadImpl.parse(MxSese03600207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03600207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03600207) MxReadImpl.parse(MxSese03600207 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03600207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03600207 .class);
    }
