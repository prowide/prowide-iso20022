    ...
    extends AbstractMX
{
    ...
    public static MxSese02800105 parse(String xml) {
        return ((MxSese02800105) MxReadImpl.parse(MxSese02800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800105) MxReadImpl.parse(MxSese02800105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02800105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02800105 .class);
    }
