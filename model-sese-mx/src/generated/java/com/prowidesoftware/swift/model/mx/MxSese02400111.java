    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.024.001.11";
    ...
    public static MxSese02400111 parse(String xml) {
        return ((MxSese02400111) MxReadImpl.parse(MxSese02400111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400111) MxReadImpl.parse(MxSese02400111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02400111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400111 .class);
    }
