    ...
    extends AbstractMX
{
    ...
    public static MxSese01100105 parse(String xml) {
        return ((MxSese01100105) MxReadImpl.parse(MxSese01100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01100105) MxReadImpl.parse(MxSese01100105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01100105 .class);
    }
