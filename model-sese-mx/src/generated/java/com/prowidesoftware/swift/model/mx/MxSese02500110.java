    ...
    extends AbstractMX
{
    ...
    public static MxSese02500110 parse(String xml) {
        return ((MxSese02500110) MxReadImpl.parse(MxSese02500110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500110) MxReadImpl.parse(MxSese02500110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02500110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500110 .class);
    }
