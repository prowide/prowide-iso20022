    ...
    extends AbstractMX
{
    ...
    public static MxSese03700205 parse(String xml) {
        return ((MxSese03700205) MxReadImpl.parse(MxSese03700205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03700205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03700205) MxReadImpl.parse(MxSese03700205 .class, xml, _classes, new MxReadParams(conf)));
    }
