    ...
    extends AbstractMX
{
    ...
    public static MxSese02200201 parse(String xml) {
        return ((MxSese02200201) MxReadImpl.parse(MxSese02200201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02200201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02200201) MxReadImpl.parse(MxSese02200201 .class, xml, _classes, new MxReadParams(conf)));
    }
