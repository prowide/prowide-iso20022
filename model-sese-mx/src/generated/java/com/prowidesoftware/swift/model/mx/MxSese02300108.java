    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.023.001.08";
    ...
    public static MxSese02300108 parse(String xml) {
        return ((MxSese02300108) MxReadImpl.parse(MxSese02300108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300108) MxReadImpl.parse(MxSese02300108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02300108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300108 .class);
    }
