    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.025.002.11";
    ...
    public static MxSese02500211 parse(String xml) {
        return ((MxSese02500211) MxReadImpl.parse(MxSese02500211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500211) MxReadImpl.parse(MxSese02500211 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02500211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500211 .class);
    }
