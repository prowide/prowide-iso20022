    ...
    extends AbstractMX
{
    ...
    public static MxSese02700103 parse(String xml) {
        return ((MxSese02700103) MxReadImpl.parse(MxSese02700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02700103) MxReadImpl.parse(MxSese02700103 .class, xml, _classes, new MxReadParams(conf)));
    }
