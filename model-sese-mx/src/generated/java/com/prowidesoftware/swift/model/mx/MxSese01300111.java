    ...
    extends AbstractMX
{
    ...
    public static MxSese01300111 parse(String xml) {
        return ((MxSese01300111) MxReadImpl.parse(MxSese01300111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01300111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01300111) MxReadImpl.parse(MxSese01300111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01300111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01300111 .class);
    }
