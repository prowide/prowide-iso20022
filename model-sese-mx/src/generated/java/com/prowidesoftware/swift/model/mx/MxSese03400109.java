    ...
    extends AbstractMX
{
    ...
    public static MxSese03400109 parse(String xml) {
        return ((MxSese03400109) MxReadImpl.parse(MxSese03400109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400109) MxReadImpl.parse(MxSese03400109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03400109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03400109 .class);
    }
