    ...
    extends AbstractMX
{
    ...
    public static MxSese00900108 parse(String xml) {
        return ((MxSese00900108) MxReadImpl.parse(MxSese00900108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00900108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00900108) MxReadImpl.parse(MxSese00900108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00900108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00900108 .class);
    }
