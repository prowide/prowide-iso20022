    ...
    extends AbstractMX
{
    ...
    public static MxSese02900101 parse(String xml) {
        return ((MxSese02900101) MxReadImpl.parse(MxSese02900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02900101) MxReadImpl.parse(MxSese02900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02900101 .class);
    }
