    ...
    extends AbstractMX
{
    ...
    public static MxSese01400106 parse(String xml) {
        return ((MxSese01400106) MxReadImpl.parse(MxSese01400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01400106) MxReadImpl.parse(MxSese01400106 .class, xml, _classes, new MxReadParams(conf)));
    }
