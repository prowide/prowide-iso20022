    ...
    extends AbstractMX
{
    ...
    public static MxSese03500108 parse(String xml) {
        return ((MxSese03500108) MxReadImpl.parse(MxSese03500108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500108) MxReadImpl.parse(MxSese03500108 .class, xml, _classes, new MxReadParams(conf)));
    }
