    ...
    extends AbstractMX
{
    ...
    public static MxSese00900106 parse(String xml) {
        return ((MxSese00900106) MxReadImpl.parse(MxSese00900106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00900106) MxReadImpl.parse(MxSese00900106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00900106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00900106 .class);
    }
