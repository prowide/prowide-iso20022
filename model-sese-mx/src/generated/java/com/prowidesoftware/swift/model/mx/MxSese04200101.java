    ...
    extends AbstractMX
{
    ...
    public static MxSese04200101 parse(String xml) {
        return ((MxSese04200101) MxReadImpl.parse(MxSese04200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese04200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese04200101) MxReadImpl.parse(MxSese04200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese04200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese04200101 .class);
    }
