    ...
    extends AbstractMX
{
    ...
    public static MxSese03600101 parse(String xml) {
        return ((MxSese03600101) MxReadImpl.parse(MxSese03600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03600101) MxReadImpl.parse(MxSese03600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03600101 .class);
    }
