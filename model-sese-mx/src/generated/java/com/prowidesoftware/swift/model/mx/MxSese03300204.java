    ...
    extends AbstractMX
{
    ...
    public static MxSese03300204 parse(String xml) {
        return ((MxSese03300204) MxReadImpl.parse(MxSese03300204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300204) MxReadImpl.parse(MxSese03300204 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03300204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300204 .class);
    }
