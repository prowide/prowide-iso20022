    ...
    extends AbstractMX
{
    ...
    public static MxSese03300201 parse(String xml) {
        return ((MxSese03300201) MxReadImpl.parse(MxSese03300201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300201) MxReadImpl.parse(MxSese03300201 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03300201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300201 .class);
    }
