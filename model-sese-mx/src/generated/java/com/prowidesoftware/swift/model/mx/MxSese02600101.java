    ...
    extends AbstractMX
{
    ...
    public static MxSese02600101 parse(String xml) {
        return ((MxSese02600101) MxReadImpl.parse(MxSese02600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600101) MxReadImpl.parse(MxSese02600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600101 .class);
    }
