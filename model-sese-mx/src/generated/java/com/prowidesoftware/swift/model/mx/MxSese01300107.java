    ...
    extends AbstractMX
{
    ...
    public static MxSese01300107 parse(String xml) {
        return ((MxSese01300107) MxReadImpl.parse(MxSese01300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01300107) MxReadImpl.parse(MxSese01300107 .class, xml, _classes, new MxReadParams(conf)));
    }
