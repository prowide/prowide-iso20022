...
/**
 * Class for sese.026.000.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese02600001(final String xml) {
        this();
        MxSese02600001 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02600001(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionReversalAdviceV1 }
     *     
     */
    public SecuritiesSettlementTransactionReversalAdviceV1 getSctiesSttlmTxRvslAdvc() {
     ...
     *     
     */
    public MxSese02600001 setSctiesSttlmTxRvslAdvc(SecuritiesSettlementTransactionReversalAdviceV1 value) {
     ...
     * 
     */
    public static MxSese02600001 parse(String xml) {
        return ((MxSese02600001) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02600001 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02600001 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600001) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02600001 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02600001 parse(String xml, MxRead parserImpl) {
        return ((MxSese02600001) parserImpl.read(MxSese02600001 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02600001 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02600001 message
     * @return
     *     a new instance of MxSese02600001
     */
    public static final MxSese02600001 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02600001 .class);
    }
