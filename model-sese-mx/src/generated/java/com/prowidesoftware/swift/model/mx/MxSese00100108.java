    ...
    extends AbstractMX
{
    ...
    public static MxSese00100108 parse(String xml) {
        return ((MxSese00100108) MxReadImpl.parse(MxSese00100108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00100108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00100108) MxReadImpl.parse(MxSese00100108 .class, xml, _classes, new MxReadParams(conf)));
    }
