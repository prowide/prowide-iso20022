    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.001.001.08";
    ...
    public static MxSese00100108 parse(String xml) {
        return ((MxSese00100108) MxReadImpl.parse(MxSese00100108 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese00100108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00100108 .class);
    }
