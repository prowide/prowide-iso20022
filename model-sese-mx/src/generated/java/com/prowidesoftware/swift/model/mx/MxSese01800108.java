...
/**
 * Class for sese.018.001.08 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:sese.018.001.08")
public class MxSese01800108
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese01800108(final String xml) {
        this();
        MxSese01800108 tmp = parse(xml);
     ...
     * 
     */
    public MxSese01800108(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AccountHoldingInformationV08 }
     *     
     */
     ...
     *     
     */
    public MxSese01800108 setAcctHldgInf(AccountHoldingInformationV08 value) {
     ...
     * 
     */
    public static MxSese01800108 parse(String xml) {
        return ((MxSese01800108) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese01800108 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese01800108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01800108) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese01800108 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese01800108 parse(String xml, MxRead parserImpl) {
        return ((MxSese01800108) parserImpl.read(MxSese01800108 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese01800108 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese01800108 message
     * @return
     *     a new instance of MxSese01800108
     */
    public final static MxSese01800108 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese01800108 .class);
    }
