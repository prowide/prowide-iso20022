    ...
    extends AbstractMX
{
    ...
    public static MxSese01800108 parse(String xml) {
        return ((MxSese01800108) MxReadImpl.parse(MxSese01800108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01800108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01800108) MxReadImpl.parse(MxSese01800108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01800108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01800108 .class);
    }
