    ...
    extends AbstractMX
{
    ...
    public static MxSese02800208 parse(String xml) {
        return ((MxSese02800208) MxReadImpl.parse(MxSese02800208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800208) MxReadImpl.parse(MxSese02800208 .class, xml, _classes, new MxReadParams(conf)));
    }
