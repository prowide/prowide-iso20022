    ...
    extends AbstractMX
{
    ...
    public static MxSese03500210 parse(String xml) {
        return ((MxSese03500210) MxReadImpl.parse(MxSese03500210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500210) MxReadImpl.parse(MxSese03500210 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03500210 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500210 .class);
    }
