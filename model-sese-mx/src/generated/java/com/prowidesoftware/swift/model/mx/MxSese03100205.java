    ...
    extends AbstractMX
{
    ...
    public static MxSese03100205 parse(String xml) {
        return ((MxSese03100205) MxReadImpl.parse(MxSese03100205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03100205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03100205) MxReadImpl.parse(MxSese03100205 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03100205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03100205 .class);
    }
