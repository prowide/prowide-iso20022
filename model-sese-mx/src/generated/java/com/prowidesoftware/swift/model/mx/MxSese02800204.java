    ...
    extends AbstractMX
{
    ...
    public static MxSese02800204 parse(String xml) {
        return ((MxSese02800204) MxReadImpl.parse(MxSese02800204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800204) MxReadImpl.parse(MxSese02800204 .class, xml, _classes, new MxReadParams(conf)));
    }
