    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.033.002.03";
    ...
    public static MxSese03300203 parse(String xml) {
        return ((MxSese03300203) MxReadImpl.parse(MxSese03300203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300203) MxReadImpl.parse(MxSese03300203 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03300203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300203 .class);
    }
