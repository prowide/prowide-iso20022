    ...
    extends AbstractMX
{
    ...
    public static MxSese02000102 parse(String xml) {
        return ((MxSese02000102) MxReadImpl.parse(MxSese02000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02000102) MxReadImpl.parse(MxSese02000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02000102 .class);
    }
