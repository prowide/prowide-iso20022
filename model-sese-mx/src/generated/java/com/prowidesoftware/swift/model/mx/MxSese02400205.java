    ...
    extends AbstractMX
{
    ...
    public static MxSese02400205 parse(String xml) {
        return ((MxSese02400205) MxReadImpl.parse(MxSese02400205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400205) MxReadImpl.parse(MxSese02400205 .class, xml, _classes, new MxReadParams(conf)));
    }
