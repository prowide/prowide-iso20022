    ...
    extends AbstractMX
{
    ...
    public static MxSese01900106 parse(String xml) {
        return ((MxSese01900106) MxReadImpl.parse(MxSese01900106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01900106) MxReadImpl.parse(MxSese01900106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01900106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01900106 .class);
    }
