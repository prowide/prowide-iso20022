    ...
    extends AbstractMX
{
    ...
    public static MxSese03800201 parse(String xml) {
        return ((MxSese03800201) MxReadImpl.parse(MxSese03800201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03800201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03800201) MxReadImpl.parse(MxSese03800201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03800201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03800201 .class);
    }
