    ...
    extends AbstractMX
{
    ...
    public static MxSese03600208 parse(String xml) {
        return ((MxSese03600208) MxReadImpl.parse(MxSese03600208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03600208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03600208) MxReadImpl.parse(MxSese03600208 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03600208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03600208 .class);
    }
