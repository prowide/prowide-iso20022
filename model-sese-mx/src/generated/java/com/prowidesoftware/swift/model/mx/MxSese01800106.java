    ...
    extends AbstractMX
{
    ...
    public static MxSese01800106 parse(String xml) {
        return ((MxSese01800106) MxReadImpl.parse(MxSese01800106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01800106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01800106) MxReadImpl.parse(MxSese01800106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01800106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01800106 .class);
    }
