    ...
    extends AbstractMX
{
    ...
    public static MxSese03400208 parse(String xml) {
        return ((MxSese03400208) MxReadImpl.parse(MxSese03400208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400208) MxReadImpl.parse(MxSese03400208 .class, xml, _classes, new MxReadParams(conf)));
    }
