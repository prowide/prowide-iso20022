    ...
    extends AbstractMX
{
    ...
    public static MxSese02400104 parse(String xml) {
        return ((MxSese02400104) MxReadImpl.parse(MxSese02400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400104) MxReadImpl.parse(MxSese02400104 .class, xml, _classes, new MxReadParams(conf)));
    }
