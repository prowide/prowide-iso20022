    ...
    extends AbstractMX
{
    ...
    public static MxSese02200106 parse(String xml) {
        return ((MxSese02200106) MxReadImpl.parse(MxSese02200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02200106) MxReadImpl.parse(MxSese02200106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02200106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02200106 .class);
    }
