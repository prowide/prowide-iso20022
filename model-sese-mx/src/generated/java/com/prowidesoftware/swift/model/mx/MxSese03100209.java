    ...
    extends AbstractMX
{
    ...
    public static MxSese03100209 parse(String xml) {
        return ((MxSese03100209) MxReadImpl.parse(MxSese03100209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03100209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03100209) MxReadImpl.parse(MxSese03100209 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03100209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03100209 .class);
    }
