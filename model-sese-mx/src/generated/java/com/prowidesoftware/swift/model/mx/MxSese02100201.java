    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.021.002.01";
    ...
    public static MxSese02100201 parse(String xml) {
        return ((MxSese02100201) MxReadImpl.parse(MxSese02100201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02100201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02100201) MxReadImpl.parse(MxSese02100201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02100201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02100201 .class);
    }
