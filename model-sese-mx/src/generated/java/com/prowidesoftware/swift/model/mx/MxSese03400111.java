    ...
    extends AbstractMX
{
    ...
    public static MxSese03400111 parse(String xml) {
        return ((MxSese03400111) MxReadImpl.parse(MxSese03400111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400111) MxReadImpl.parse(MxSese03400111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03400111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03400111 .class);
    }
