    ...
    extends AbstractMX
{
    ...
    public static MxSese02300111 parse(String xml) {
        return ((MxSese02300111) MxReadImpl.parse(MxSese02300111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300111) MxReadImpl.parse(MxSese02300111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02300111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300111 .class);
    }
