    ...
    extends AbstractMX
{
    ...
    public static MxSese03600107 parse(String xml) {
        return ((MxSese03600107) MxReadImpl.parse(MxSese03600107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03600107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03600107) MxReadImpl.parse(MxSese03600107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03600107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03600107 .class);
    }
