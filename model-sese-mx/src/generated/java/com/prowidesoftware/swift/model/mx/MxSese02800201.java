    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.028.002.01";
    ...
    public static MxSese02800201 parse(String xml) {
        return ((MxSese02800201) MxReadImpl.parse(MxSese02800201 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02800201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02800201 .class);
    }
