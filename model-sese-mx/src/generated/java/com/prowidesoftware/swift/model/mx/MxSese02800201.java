    ...
    extends AbstractMX
{
    ...
    public static MxSese02800201 parse(String xml) {
        return ((MxSese02800201) MxReadImpl.parse(MxSese02800201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800201) MxReadImpl.parse(MxSese02800201 .class, xml, _classes, new MxReadParams(conf)));
    }
