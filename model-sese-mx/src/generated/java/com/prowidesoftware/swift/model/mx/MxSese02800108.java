    ...
    extends AbstractMX
{
    ...
    public static MxSese02800108 parse(String xml) {
        return ((MxSese02800108) MxReadImpl.parse(MxSese02800108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800108) MxReadImpl.parse(MxSese02800108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02800108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02800108 .class);
    }
