    ...
    extends AbstractMX
{
    ...
    public static MxSese03000208 parse(String xml) {
        return ((MxSese03000208) MxReadImpl.parse(MxSese03000208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03000208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03000208) MxReadImpl.parse(MxSese03000208 .class, xml, _classes, new MxReadParams(conf)));
    }
