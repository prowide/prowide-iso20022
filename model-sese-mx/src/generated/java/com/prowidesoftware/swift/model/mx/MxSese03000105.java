    ...
    extends AbstractMX
{
    ...
    public static MxSese03000105 parse(String xml) {
        return ((MxSese03000105) MxReadImpl.parse(MxSese03000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03000105) MxReadImpl.parse(MxSese03000105 .class, xml, _classes, new MxReadParams(conf)));
    }
