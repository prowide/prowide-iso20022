...
/**
 * Class for sese.036.000.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese03600001(final String xml) {
        this();
        MxSese03600001 tmp = parse(xml);
     ...
     * 
     */
    public MxSese03600001(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesFinancingModificationInstructionV1 }
     *     
     */
    public SecuritiesFinancingModificationInstructionV1 getSctiesFincgModInstr() {
     ...
     *     
     */
    public MxSese03600001 setSctiesFincgModInstr(SecuritiesFinancingModificationInstructionV1 value) {
     ...
     * 
     */
    public static MxSese03600001 parse(String xml) {
        return ((MxSese03600001) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese03600001 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese03600001 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03600001) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese03600001 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese03600001 parse(String xml, MxRead parserImpl) {
        return ((MxSese03600001) parserImpl.read(MxSese03600001 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese03600001 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese03600001 message
     * @return
     *     a new instance of MxSese03600001
     */
    public final static MxSese03600001 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese03600001 .class);
    }
