    ...
    extends AbstractMX
{
    ...
    public static MxSese03500104 parse(String xml) {
        return ((MxSese03500104) MxReadImpl.parse(MxSese03500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500104) MxReadImpl.parse(MxSese03500104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03500104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500104 .class);
    }
