    ...
    extends AbstractMX
{
    ...
    public static MxSese02300109 parse(String xml) {
        return ((MxSese02300109) MxReadImpl.parse(MxSese02300109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300109) MxReadImpl.parse(MxSese02300109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02300109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300109 .class);
    }
