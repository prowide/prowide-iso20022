...
/**
 * Class for sese.023.001.09 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:sese.023.001.09")
public class MxSese02300109
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese02300109(final String xml) {
        this();
        MxSese02300109 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02300109(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxSese02300109 setSctiesSttlmTxInstr(SecuritiesSettlementTransactionInstructionV09 value) {
     ...
     * 
     */
    public static MxSese02300109 parse(String xml) {
        return ((MxSese02300109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02300109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02300109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02300109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02300109 parse(String xml, MxRead parserImpl) {
        return ((MxSese02300109) parserImpl.read(MxSese02300109 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02300109 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02300109 message
     * @return
     *     a new instance of MxSese02300109
     */
    public static final MxSese02300109 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02300109 .class);
    }
