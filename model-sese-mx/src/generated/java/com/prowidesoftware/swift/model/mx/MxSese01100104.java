    ...
    extends AbstractMX
{
    ...
    public static MxSese01100104 parse(String xml) {
        return ((MxSese01100104) MxReadImpl.parse(MxSese01100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01100104) MxReadImpl.parse(MxSese01100104 .class, xml, _classes, new MxReadParams(conf)));
    }
