    ...
    extends AbstractMX
{
    ...
    public static MxSese00300102 parse(String xml) {
        return ((MxSese00300102) MxReadImpl.parse(MxSese00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00300102) MxReadImpl.parse(MxSese00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
