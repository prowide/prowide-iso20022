    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.035.001.05";
    ...
    public static MxSese03500105 parse(String xml) {
        return ((MxSese03500105) MxReadImpl.parse(MxSese03500105 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03500105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500105 .class);
    }
