    ...
    extends AbstractMX
{
    ...
    public static MxSese03500105 parse(String xml) {
        return ((MxSese03500105) MxReadImpl.parse(MxSese03500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500105) MxReadImpl.parse(MxSese03500105 .class, xml, _classes, new MxReadParams(conf)));
    }
