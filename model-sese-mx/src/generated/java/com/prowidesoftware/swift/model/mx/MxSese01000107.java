    ...
    extends AbstractMX
{
    ...
    public static MxSese01000107 parse(String xml) {
        return ((MxSese01000107) MxReadImpl.parse(MxSese01000107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01000107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01000107) MxReadImpl.parse(MxSese01000107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01000107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01000107 .class);
    }
