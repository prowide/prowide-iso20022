    ...
    extends AbstractMX
{
    ...
    public static MxSese02700106 parse(String xml) {
        return ((MxSese02700106) MxReadImpl.parse(MxSese02700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02700106) MxReadImpl.parse(MxSese02700106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02700106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02700106 .class);
    }
