    ...
    extends AbstractMX
{
    ...
    public static MxSese03200106 parse(String xml) {
        return ((MxSese03200106) MxReadImpl.parse(MxSese03200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200106) MxReadImpl.parse(MxSese03200106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03200106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200106 .class);
    }
