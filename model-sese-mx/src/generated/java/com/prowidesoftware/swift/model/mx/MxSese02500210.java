    ...
    extends AbstractMX
{
    ...
    public static MxSese02500210 parse(String xml) {
        return ((MxSese02500210) MxReadImpl.parse(MxSese02500210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500210) MxReadImpl.parse(MxSese02500210 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02500210 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500210 .class);
    }
