...
/**
 * Class for sese.025.002.10 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese02500210(final String xml) {
        this();
        MxSese02500210 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02500210(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionConfirmation002V10 }
     *     
     */
    public SecuritiesSettlementTransactionConfirmation002V10 getSctiesSttlmTxConf() {
     ...
     *     
     */
    public MxSese02500210 setSctiesSttlmTxConf(SecuritiesSettlementTransactionConfirmation002V10 value) {
     ...
     * 
     */
    public static MxSese02500210 parse(String xml) {
        return ((MxSese02500210) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02500210 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02500210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500210) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02500210 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02500210 parse(String xml, MxRead parserImpl) {
        return ((MxSese02500210) parserImpl.read(MxSese02500210 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02500210 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02500210 message
     * @return
     *     a new instance of MxSese02500210
     */
    public final static MxSese02500210 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02500210 .class);
    }
