    ...
    extends AbstractMX
{
    ...
    public static MxSese03200209 parse(String xml) {
        return ((MxSese03200209) MxReadImpl.parse(MxSese03200209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200209) MxReadImpl.parse(MxSese03200209 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03200209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200209 .class);
    }
