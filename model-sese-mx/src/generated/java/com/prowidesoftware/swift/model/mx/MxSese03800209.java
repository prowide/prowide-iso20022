    ...
    extends AbstractMX
{
    ...
    public static MxSese03800209 parse(String xml) {
        return ((MxSese03800209) MxReadImpl.parse(MxSese03800209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03800209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03800209) MxReadImpl.parse(MxSese03800209 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03800209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03800209 .class);
    }
