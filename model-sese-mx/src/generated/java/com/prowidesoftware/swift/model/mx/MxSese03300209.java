    ...
    extends AbstractMX
{
    ...
    public static MxSese03300209 parse(String xml) {
        return ((MxSese03300209) MxReadImpl.parse(MxSese03300209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300209) MxReadImpl.parse(MxSese03300209 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03300209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300209 .class);
    }
