    ...
    extends AbstractMX
{
    ...
    public static MxSese03100108 parse(String xml) {
        return ((MxSese03100108) MxReadImpl.parse(MxSese03100108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03100108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03100108) MxReadImpl.parse(MxSese03100108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03100108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03100108 .class);
    }
