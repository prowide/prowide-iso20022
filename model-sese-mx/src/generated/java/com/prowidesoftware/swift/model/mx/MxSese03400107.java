    ...
    extends AbstractMX
{
    ...
    public static MxSese03400107 parse(String xml) {
        return ((MxSese03400107) MxReadImpl.parse(MxSese03400107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400107) MxReadImpl.parse(MxSese03400107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03400107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03400107 .class);
    }
