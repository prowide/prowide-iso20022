    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.002.001.05";
    ...
    public static MxSese00200105 parse(String xml) {
        return ((MxSese00200105) MxReadImpl.parse(MxSese00200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00200105) MxReadImpl.parse(MxSese00200105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00200105 .class);
    }
