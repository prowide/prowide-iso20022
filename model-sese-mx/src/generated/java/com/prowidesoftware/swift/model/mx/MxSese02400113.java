    ...
    extends AbstractMX
{
    ...
    public static MxSese02400113 parse(String xml) {
        return ((MxSese02400113) MxReadImpl.parse(MxSese02400113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400113 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400113) MxReadImpl.parse(MxSese02400113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02400113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400113 .class);
    }
