    ...
    extends AbstractMX
{
    ...
    public static MxSese03800202 parse(String xml) {
        return ((MxSese03800202) MxReadImpl.parse(MxSese03800202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03800202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03800202) MxReadImpl.parse(MxSese03800202 .class, xml, _classes, new MxReadParams(conf)));
    }
