    ...
    extends AbstractMX
{
    ...
    public static MxSese02600102 parse(String xml) {
        return ((MxSese02600102) MxReadImpl.parse(MxSese02600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600102) MxReadImpl.parse(MxSese02600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600102 .class);
    }
