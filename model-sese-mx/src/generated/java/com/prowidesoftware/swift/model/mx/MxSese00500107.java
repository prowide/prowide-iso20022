    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.005.001.07";
    ...
    public static MxSese00500107 parse(String xml) {
        return ((MxSese00500107) MxReadImpl.parse(MxSese00500107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00500107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00500107) MxReadImpl.parse(MxSese00500107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00500107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00500107 .class);
    }
