    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.034.001.02";
    ...
    public static MxSese03400102 parse(String xml) {
        return ((MxSese03400102) MxReadImpl.parse(MxSese03400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400102) MxReadImpl.parse(MxSese03400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03400102 .class);
    }
