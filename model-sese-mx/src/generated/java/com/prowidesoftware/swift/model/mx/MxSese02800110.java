    ...
    extends AbstractMX
{
    ...
    public static MxSese02800110 parse(String xml) {
        return ((MxSese02800110) MxReadImpl.parse(MxSese02800110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800110) MxReadImpl.parse(MxSese02800110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02800110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02800110 .class);
    }
