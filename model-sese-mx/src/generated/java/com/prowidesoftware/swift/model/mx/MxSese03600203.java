    ...
    extends AbstractMX
{
    ...
    public static MxSese03600203 parse(String xml) {
        return ((MxSese03600203) MxReadImpl.parse(MxSese03600203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03600203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03600203) MxReadImpl.parse(MxSese03600203 .class, xml, _classes, new MxReadParams(conf)));
    }
