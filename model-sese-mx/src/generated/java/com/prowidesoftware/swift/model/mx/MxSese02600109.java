    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.026.001.09";
    ...
    public static MxSese02600109 parse(String xml) {
        return ((MxSese02600109) MxReadImpl.parse(MxSese02600109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600109) MxReadImpl.parse(MxSese02600109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02600109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600109 .class);
    }
