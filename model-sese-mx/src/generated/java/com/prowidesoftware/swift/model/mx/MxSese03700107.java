    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.037.001.07";
    ...
    public static MxSese03700107 parse(String xml) {
        return ((MxSese03700107) MxReadImpl.parse(MxSese03700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03700107) MxReadImpl.parse(MxSese03700107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03700107 .class);
    }
