    ...
    extends AbstractMX
{
    ...
    public static MxSese03600105 parse(String xml) {
        return ((MxSese03600105) MxReadImpl.parse(MxSese03600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03600105) MxReadImpl.parse(MxSese03600105 .class, xml, _classes, new MxReadParams(conf)));
    }
