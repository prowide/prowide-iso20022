    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.036.001.05";
    ...
    public static MxSese03600105 parse(String xml) {
        return ((MxSese03600105) MxReadImpl.parse(MxSese03600105 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03600105 .class);
    }
