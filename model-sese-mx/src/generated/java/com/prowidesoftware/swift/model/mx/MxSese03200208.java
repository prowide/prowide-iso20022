    ...
    extends AbstractMX
{
    ...
    public static MxSese03200208 parse(String xml) {
        return ((MxSese03200208) MxReadImpl.parse(MxSese03200208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200208) MxReadImpl.parse(MxSese03200208 .class, xml, _classes, new MxReadParams(conf)));
    }
