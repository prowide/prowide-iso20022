    ...
    extends AbstractMX
{
    ...
    public static MxSese02800207 parse(String xml) {
        return ((MxSese02800207) MxReadImpl.parse(MxSese02800207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800207) MxReadImpl.parse(MxSese02800207 .class, xml, _classes, new MxReadParams(conf)));
    }
