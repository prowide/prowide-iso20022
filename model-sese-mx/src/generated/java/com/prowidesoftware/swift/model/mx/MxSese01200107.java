    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.012.001.07";
    ...
    public static MxSese01200107 parse(String xml) {
        return ((MxSese01200107) MxReadImpl.parse(MxSese01200107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01200107) MxReadImpl.parse(MxSese01200107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01200107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01200107 .class);
    }
