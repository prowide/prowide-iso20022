    ...
    extends AbstractMX
{
    ...
    public static MxSese01300104 parse(String xml) {
        return ((MxSese01300104) MxReadImpl.parse(MxSese01300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01300104) MxReadImpl.parse(MxSese01300104 .class, xml, _classes, new MxReadParams(conf)));
    }
