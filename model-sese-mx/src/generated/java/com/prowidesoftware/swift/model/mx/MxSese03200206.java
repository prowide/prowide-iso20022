    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.032.002.06";
    ...
    public static MxSese03200206 parse(String xml) {
        return ((MxSese03200206) MxReadImpl.parse(MxSese03200206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200206) MxReadImpl.parse(MxSese03200206 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03200206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200206 .class);
    }
