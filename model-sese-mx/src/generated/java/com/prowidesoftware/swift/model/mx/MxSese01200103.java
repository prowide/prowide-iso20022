    ...
    extends AbstractMX
{
    ...
    public static MxSese01200103 parse(String xml) {
        return ((MxSese01200103) MxReadImpl.parse(MxSese01200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01200103) MxReadImpl.parse(MxSese01200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01200103 .class);
    }
