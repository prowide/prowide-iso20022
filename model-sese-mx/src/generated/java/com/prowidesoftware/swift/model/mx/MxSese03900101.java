    ...
    extends AbstractMX
{
    ...
    public static MxSese03900101 parse(String xml) {
        return ((MxSese03900101) MxReadImpl.parse(MxSese03900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03900101) MxReadImpl.parse(MxSese03900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03900101 .class);
    }
