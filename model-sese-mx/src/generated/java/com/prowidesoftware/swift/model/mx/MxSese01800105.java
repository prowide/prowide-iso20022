    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.018.001.05";
    ...
    public static MxSese01800105 parse(String xml) {
        return ((MxSese01800105) MxReadImpl.parse(MxSese01800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01800105) MxReadImpl.parse(MxSese01800105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01800105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01800105 .class);
    }
