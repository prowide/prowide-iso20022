    ...
    extends AbstractMX
{
    ...
    public static MxSese04100101 parse(String xml) {
        return ((MxSese04100101) MxReadImpl.parse(MxSese04100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese04100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese04100101) MxReadImpl.parse(MxSese04100101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese04100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese04100101 .class);
    }
