    ...
    extends AbstractMX
{
    ...
    public static MxSese01000103 parse(String xml) {
        return ((MxSese01000103) MxReadImpl.parse(MxSese01000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01000103) MxReadImpl.parse(MxSese01000103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01000103 .class);
    }
