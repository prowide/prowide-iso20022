    ...
    extends AbstractMX
{
    ...
    public static MxSese01100103 parse(String xml) {
        return ((MxSese01100103) MxReadImpl.parse(MxSese01100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01100103) MxReadImpl.parse(MxSese01100103 .class, xml, _classes, new MxReadParams(conf)));
    }
