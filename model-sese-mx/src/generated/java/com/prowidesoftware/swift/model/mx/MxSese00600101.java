    ...
    extends AbstractMX
{
    ...
    public static MxSese00600101 parse(String xml) {
        return ((MxSese00600101) MxReadImpl.parse(MxSese00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00600101) MxReadImpl.parse(MxSese00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
