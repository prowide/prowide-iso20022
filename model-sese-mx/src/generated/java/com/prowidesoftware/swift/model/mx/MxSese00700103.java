    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.007.001.03";
    ...
    public static MxSese00700103 parse(String xml) {
        return ((MxSese00700103) MxReadImpl.parse(MxSese00700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00700103) MxReadImpl.parse(MxSese00700103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00700103 .class);
    }
