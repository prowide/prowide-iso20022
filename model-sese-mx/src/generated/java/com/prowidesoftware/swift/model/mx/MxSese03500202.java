    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.035.002.02";
    ...
    public static MxSese03500202 parse(String xml) {
        return ((MxSese03500202) MxReadImpl.parse(MxSese03500202 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03500202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500202 .class);
    }
