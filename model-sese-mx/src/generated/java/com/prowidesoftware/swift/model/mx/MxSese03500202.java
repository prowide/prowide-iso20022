    ...
    extends AbstractMX
{
    ...
    public static MxSese03500202 parse(String xml) {
        return ((MxSese03500202) MxReadImpl.parse(MxSese03500202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500202) MxReadImpl.parse(MxSese03500202 .class, xml, _classes, new MxReadParams(conf)));
    }
