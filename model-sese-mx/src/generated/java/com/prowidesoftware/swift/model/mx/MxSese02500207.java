    ...
    extends AbstractMX
{
    ...
    public static MxSese02500207 parse(String xml) {
        return ((MxSese02500207) MxReadImpl.parse(MxSese02500207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500207) MxReadImpl.parse(MxSese02500207 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02500207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500207 .class);
    }
