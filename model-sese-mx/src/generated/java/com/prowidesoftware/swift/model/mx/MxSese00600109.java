    ...
    extends AbstractMX
{
    ...
    public static MxSese00600109 parse(String xml) {
        return ((MxSese00600109) MxReadImpl.parse(MxSese00600109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00600109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00600109) MxReadImpl.parse(MxSese00600109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00600109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00600109 .class);
    }
