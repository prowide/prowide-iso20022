    ...
    extends AbstractMX
{
    ...
    public static MxSese03400204 parse(String xml) {
        return ((MxSese03400204) MxReadImpl.parse(MxSese03400204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400204) MxReadImpl.parse(MxSese03400204 .class, xml, _classes, new MxReadParams(conf)));
    }
