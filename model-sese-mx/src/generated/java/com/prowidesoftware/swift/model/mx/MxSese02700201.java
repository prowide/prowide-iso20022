    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.027.002.01";
    ...
    public static MxSese02700201 parse(String xml) {
        return ((MxSese02700201) MxReadImpl.parse(MxSese02700201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02700201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02700201) MxReadImpl.parse(MxSese02700201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02700201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02700201 .class);
    }
