    ...
    extends AbstractMX
{
    ...
    public static MxSese01900102 parse(String xml) {
        return ((MxSese01900102) MxReadImpl.parse(MxSese01900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01900102) MxReadImpl.parse(MxSese01900102 .class, xml, _classes, new MxReadParams(conf)));
    }
