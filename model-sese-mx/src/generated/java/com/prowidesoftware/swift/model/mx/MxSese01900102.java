    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.019.001.02";
    ...
    public static MxSese01900102 parse(String xml) {
        return ((MxSese01900102) MxReadImpl.parse(MxSese01900102 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese01900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01900102 .class);
    }
