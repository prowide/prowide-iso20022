    ...
    extends AbstractMX
{
    ...
    public static MxSese01100107 parse(String xml) {
        return ((MxSese01100107) MxReadImpl.parse(MxSese01100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01100107) MxReadImpl.parse(MxSese01100107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01100107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01100107 .class);
    }
