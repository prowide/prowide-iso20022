    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.007.001.09";
    ...
    public static MxSese00700109 parse(String xml) {
        return ((MxSese00700109) MxReadImpl.parse(MxSese00700109 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese00700109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00700109 .class);
    }
