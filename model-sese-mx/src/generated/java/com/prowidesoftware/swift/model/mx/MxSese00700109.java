    ...
    extends AbstractMX
{
    ...
    public static MxSese00700109 parse(String xml) {
        return ((MxSese00700109) MxReadImpl.parse(MxSese00700109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00700109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00700109) MxReadImpl.parse(MxSese00700109 .class, xml, _classes, new MxReadParams(conf)));
    }
