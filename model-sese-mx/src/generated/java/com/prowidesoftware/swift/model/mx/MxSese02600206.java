    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.026.002.06";
    ...
    public static MxSese02600206 parse(String xml) {
        return ((MxSese02600206) MxReadImpl.parse(MxSese02600206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600206) MxReadImpl.parse(MxSese02600206 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02600206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600206 .class);
    }
