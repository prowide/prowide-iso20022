    ...
    extends AbstractMX
{
    ...
    public static MxSese03800105 parse(String xml) {
        return ((MxSese03800105) MxReadImpl.parse(MxSese03800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03800105) MxReadImpl.parse(MxSese03800105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03800105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03800105 .class);
    }
