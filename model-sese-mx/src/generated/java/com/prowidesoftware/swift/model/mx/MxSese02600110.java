    ...
    extends AbstractMX
{
    ...
    public static MxSese02600110 parse(String xml) {
        return ((MxSese02600110) MxReadImpl.parse(MxSese02600110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600110) MxReadImpl.parse(MxSese02600110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02600110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600110 .class);
    }
