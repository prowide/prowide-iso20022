    ...
    extends AbstractMX
{
    ...
    public static MxSese03500107 parse(String xml) {
        return ((MxSese03500107) MxReadImpl.parse(MxSese03500107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500107) MxReadImpl.parse(MxSese03500107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03500107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500107 .class);
    }
