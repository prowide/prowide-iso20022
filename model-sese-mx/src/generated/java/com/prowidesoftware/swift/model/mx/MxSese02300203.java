    ...
    extends AbstractMX
{
    ...
    public static MxSese02300203 parse(String xml) {
        return ((MxSese02300203) MxReadImpl.parse(MxSese02300203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300203) MxReadImpl.parse(MxSese02300203 .class, xml, _classes, new MxReadParams(conf)));
    }
