    ...
    extends AbstractMX
{
    ...
    public static MxSese02900204 parse(String xml) {
        return ((MxSese02900204) MxReadImpl.parse(MxSese02900204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02900204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02900204) MxReadImpl.parse(MxSese02900204 .class, xml, _classes, new MxReadParams(conf)));
    }
