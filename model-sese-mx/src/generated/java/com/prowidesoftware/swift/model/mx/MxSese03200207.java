    ...
    extends AbstractMX
{
    ...
    public static MxSese03200207 parse(String xml) {
        return ((MxSese03200207) MxReadImpl.parse(MxSese03200207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200207) MxReadImpl.parse(MxSese03200207 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03200207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200207 .class);
    }
