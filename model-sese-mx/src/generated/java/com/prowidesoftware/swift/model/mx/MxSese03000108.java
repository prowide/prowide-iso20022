    ...
    extends AbstractMX
{
    ...
    public static MxSese03000108 parse(String xml) {
        return ((MxSese03000108) MxReadImpl.parse(MxSese03000108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03000108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03000108) MxReadImpl.parse(MxSese03000108 .class, xml, _classes, new MxReadParams(conf)));
    }
