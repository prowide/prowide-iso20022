    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.030.001.08";
    ...
    public static MxSese03000108 parse(String xml) {
        return ((MxSese03000108) MxReadImpl.parse(MxSese03000108 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03000108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03000108 .class);
    }
