    ...
    extends AbstractMX
{
    ...
    public static MxSese03200210 parse(String xml) {
        return ((MxSese03200210) MxReadImpl.parse(MxSese03200210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200210) MxReadImpl.parse(MxSese03200210 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03200210 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200210 .class);
    }
