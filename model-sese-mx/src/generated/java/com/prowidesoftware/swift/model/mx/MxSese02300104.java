    ...
    extends AbstractMX
{
    ...
    public static MxSese02300104 parse(String xml) {
        return ((MxSese02300104) MxReadImpl.parse(MxSese02300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300104) MxReadImpl.parse(MxSese02300104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300104 .class);
    }
