    ...
    extends AbstractMX
{
    ...
    public static MxSese02400109 parse(String xml) {
        return ((MxSese02400109) MxReadImpl.parse(MxSese02400109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400109) MxReadImpl.parse(MxSese02400109 .class, xml, _classes, new MxReadParams(conf)));
    }
