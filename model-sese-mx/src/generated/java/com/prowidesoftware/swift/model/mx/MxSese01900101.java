    ...
    extends AbstractMX
{
    ...
    public static MxSese01900101 parse(String xml) {
        return ((MxSese01900101) MxReadImpl.parse(MxSese01900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01900101) MxReadImpl.parse(MxSese01900101 .class, xml, _classes, new MxReadParams(conf)));
    }
