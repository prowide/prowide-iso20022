    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.038.001.04";
    ...
    public static MxSese03800104 parse(String xml) {
        return ((MxSese03800104) MxReadImpl.parse(MxSese03800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03800104) MxReadImpl.parse(MxSese03800104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03800104 .class);
    }
