    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.030.001.07";
    ...
    public static MxSese03000107 parse(String xml) {
        return ((MxSese03000107) MxReadImpl.parse(MxSese03000107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03000107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03000107) MxReadImpl.parse(MxSese03000107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03000107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03000107 .class);
    }
