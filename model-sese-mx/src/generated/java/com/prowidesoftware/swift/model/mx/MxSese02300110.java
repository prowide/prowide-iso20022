    ...
    extends AbstractMX
{
    ...
    public static MxSese02300110 parse(String xml) {
        return ((MxSese02300110) MxReadImpl.parse(MxSese02300110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300110) MxReadImpl.parse(MxSese02300110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02300110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300110 .class);
    }
