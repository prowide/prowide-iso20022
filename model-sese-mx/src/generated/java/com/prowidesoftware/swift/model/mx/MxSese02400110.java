    ...
    extends AbstractMX
{
    ...
    public static MxSese02400110 parse(String xml) {
        return ((MxSese02400110) MxReadImpl.parse(MxSese02400110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400110) MxReadImpl.parse(MxSese02400110 .class, xml, _classes, new MxReadParams(conf)));
    }
