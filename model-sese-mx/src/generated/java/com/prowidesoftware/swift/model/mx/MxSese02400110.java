    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.024.001.10";
    ...
    public static MxSese02400110 parse(String xml) {
        return ((MxSese02400110) MxReadImpl.parse(MxSese02400110 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02400110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400110 .class);
    }
