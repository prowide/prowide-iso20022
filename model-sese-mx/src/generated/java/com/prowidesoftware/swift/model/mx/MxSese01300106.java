    ...
    extends AbstractMX
{
    ...
    public static MxSese01300106 parse(String xml) {
        return ((MxSese01300106) MxReadImpl.parse(MxSese01300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01300106) MxReadImpl.parse(MxSese01300106 .class, xml, _classes, new MxReadParams(conf)));
    }
