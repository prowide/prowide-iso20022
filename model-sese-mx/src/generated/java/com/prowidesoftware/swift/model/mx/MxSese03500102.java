    ...
    extends AbstractMX
{
    ...
    public static MxSese03500102 parse(String xml) {
        return ((MxSese03500102) MxReadImpl.parse(MxSese03500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500102) MxReadImpl.parse(MxSese03500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500102 .class);
    }
