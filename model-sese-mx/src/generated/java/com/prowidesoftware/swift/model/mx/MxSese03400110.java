    ...
    extends AbstractMX
{
    ...
    public static MxSese03400110 parse(String xml) {
        return ((MxSese03400110) MxReadImpl.parse(MxSese03400110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400110) MxReadImpl.parse(MxSese03400110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03400110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03400110 .class);
    }
