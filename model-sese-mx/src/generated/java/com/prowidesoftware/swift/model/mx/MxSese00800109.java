    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.008.001.09";
    ...
    public static MxSese00800109 parse(String xml) {
        return ((MxSese00800109) MxReadImpl.parse(MxSese00800109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00800109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00800109) MxReadImpl.parse(MxSese00800109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00800109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00800109 .class);
    }
