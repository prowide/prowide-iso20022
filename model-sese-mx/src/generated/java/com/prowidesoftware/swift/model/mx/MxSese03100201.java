    ...
    extends AbstractMX
{
    ...
    public static MxSese03100201 parse(String xml) {
        return ((MxSese03100201) MxReadImpl.parse(MxSese03100201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03100201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03100201) MxReadImpl.parse(MxSese03100201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03100201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03100201 .class);
    }
