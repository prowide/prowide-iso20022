    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.020.001.08";
    ...
    public static MxSese02000108 parse(String xml) {
        return ((MxSese02000108) MxReadImpl.parse(MxSese02000108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02000108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02000108) MxReadImpl.parse(MxSese02000108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02000108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02000108 .class);
    }
