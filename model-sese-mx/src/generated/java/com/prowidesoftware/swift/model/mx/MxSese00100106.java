    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.001.001.06";
    ...
    public static MxSese00100106 parse(String xml) {
        return ((MxSese00100106) MxReadImpl.parse(MxSese00100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00100106) MxReadImpl.parse(MxSese00100106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00100106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00100106 .class);
    }
