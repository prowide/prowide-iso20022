    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.036.001.03";
    ...
    public static MxSese03600103 parse(String xml) {
        return ((MxSese03600103) MxReadImpl.parse(MxSese03600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03600103) MxReadImpl.parse(MxSese03600103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03600103 .class);
    }
