    ...
    extends AbstractMX
{
    ...
    public static MxSese00700106 parse(String xml) {
        return ((MxSese00700106) MxReadImpl.parse(MxSese00700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00700106) MxReadImpl.parse(MxSese00700106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00700106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00700106 .class);
    }
