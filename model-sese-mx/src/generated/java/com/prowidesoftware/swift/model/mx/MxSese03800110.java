    ...
    extends AbstractMX
{
    ...
    public static MxSese03800110 parse(String xml) {
        return ((MxSese03800110) MxReadImpl.parse(MxSese03800110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03800110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03800110) MxReadImpl.parse(MxSese03800110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03800110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03800110 .class);
    }
