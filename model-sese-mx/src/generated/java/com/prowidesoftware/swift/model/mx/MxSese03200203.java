    ...
    extends AbstractMX
{
    ...
    public static MxSese03200203 parse(String xml) {
        return ((MxSese03200203) MxReadImpl.parse(MxSese03200203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200203) MxReadImpl.parse(MxSese03200203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03200203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200203 .class);
    }
