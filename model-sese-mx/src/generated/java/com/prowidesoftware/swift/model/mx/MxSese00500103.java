    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.005.001.03";
    ...
    public static MxSese00500103 parse(String xml) {
        return ((MxSese00500103) MxReadImpl.parse(MxSese00500103 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese00500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00500103 .class);
    }
