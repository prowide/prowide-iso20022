    ...
    extends AbstractMX
{
    ...
    public static MxSese00500103 parse(String xml) {
        return ((MxSese00500103) MxReadImpl.parse(MxSese00500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00500103) MxReadImpl.parse(MxSese00500103 .class, xml, _classes, new MxReadParams(conf)));
    }
