...
/**
 * Class for sese.030.002.07 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxSese03000207(final String xml) {
        this();
        MxSese03000207 tmp = parse(xml);
     ...
     * 
     */
    public MxSese03000207(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementConditionsModificationRequest002V07 }
     *     
     */
    public SecuritiesSettlementConditionsModificationRequest002V07 getSctiesSttlmCondsModReq() {
     ...
     *     
     */
    public MxSese03000207 setSctiesSttlmCondsModReq(SecuritiesSettlementConditionsModificationRequest002V07 value) {
    ...
    public static MxSese03000207 parse(String xml) {
        return ((MxSese03000207) MxReadImpl.parse(MxSese03000207 .class, xml, _classes));
    }
     ...
     */
    public static MxSese03000207 parse(String xml, MxRead parserImpl) {
        return ((MxSese03000207) parserImpl.read(MxSese03000207 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese03000207 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese03000207 message
     * @return
