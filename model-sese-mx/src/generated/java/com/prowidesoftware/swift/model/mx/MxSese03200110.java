    ...
    extends AbstractMX
{
    ...
    public static MxSese03200110 parse(String xml) {
        return ((MxSese03200110) MxReadImpl.parse(MxSese03200110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200110) MxReadImpl.parse(MxSese03200110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03200110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200110 .class);
    }
