    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.037.002.01";
    ...
    public static MxSese03700201 parse(String xml) {
        return ((MxSese03700201) MxReadImpl.parse(MxSese03700201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03700201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03700201) MxReadImpl.parse(MxSese03700201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03700201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03700201 .class);
    }
