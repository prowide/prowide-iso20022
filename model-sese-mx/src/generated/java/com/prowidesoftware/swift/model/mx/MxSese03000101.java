    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.030.001.01";
    ...
    public static MxSese03000101 parse(String xml) {
        return ((MxSese03000101) MxReadImpl.parse(MxSese03000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03000101) MxReadImpl.parse(MxSese03000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03000101 .class);
    }
