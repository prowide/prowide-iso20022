    ...
    extends AbstractMX
{
    ...
    public static MxSese00300106 parse(String xml) {
        return ((MxSese00300106) MxReadImpl.parse(MxSese00300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00300106) MxReadImpl.parse(MxSese00300106 .class, xml, _classes, new MxReadParams(conf)));
    }
