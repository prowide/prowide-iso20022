    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.006.001.08";
    ...
    public static MxSese00600108 parse(String xml) {
        return ((MxSese00600108) MxReadImpl.parse(MxSese00600108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00600108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00600108) MxReadImpl.parse(MxSese00600108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00600108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00600108 .class);
    }
