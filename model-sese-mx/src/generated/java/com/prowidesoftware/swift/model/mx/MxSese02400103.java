    ...
    extends AbstractMX
{
    ...
    public static MxSese02400103 parse(String xml) {
        return ((MxSese02400103) MxReadImpl.parse(MxSese02400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400103) MxReadImpl.parse(MxSese02400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400103 .class);
    }
