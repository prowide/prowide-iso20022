...
/**
 * Class for sese.024.001.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese02400103(final String xml) {
        this();
        MxSese02400103 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02400103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionStatusAdviceV03 }
     *     
     */
    public SecuritiesSettlementTransactionStatusAdviceV03 getSctiesSttlmTxStsAdvc() {
     ...
     *     
     */
    public MxSese02400103 setSctiesSttlmTxStsAdvc(SecuritiesSettlementTransactionStatusAdviceV03 value) {
     ...
     * 
     */
    public static MxSese02400103 parse(String xml) {
        return ((MxSese02400103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02400103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02400103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02400103 parse(String xml, MxRead parserImpl) {
        return ((MxSese02400103) parserImpl.read(MxSese02400103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02400103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02400103 message
     * @return
     *     a new instance of MxSese02400103
     */
    public final static MxSese02400103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02400103 .class);
    }
