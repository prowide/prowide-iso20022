    ...
    extends AbstractMX
{
    ...
    public static MxSese01100102 parse(String xml) {
        return ((MxSese01100102) MxReadImpl.parse(MxSese01100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01100102) MxReadImpl.parse(MxSese01100102 .class, xml, _classes, new MxReadParams(conf)));
    }
