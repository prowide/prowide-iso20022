    ...
    extends AbstractMX
{
    ...
    public static MxSese04000203 parse(String xml) {
        return ((MxSese04000203) MxReadImpl.parse(MxSese04000203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese04000203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese04000203) MxReadImpl.parse(MxSese04000203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese04000203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese04000203 .class);
    }
