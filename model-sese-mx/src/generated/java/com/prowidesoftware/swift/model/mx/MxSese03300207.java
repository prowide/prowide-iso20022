    ...
    extends AbstractMX
{
    ...
    public static MxSese03300207 parse(String xml) {
        return ((MxSese03300207) MxReadImpl.parse(MxSese03300207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300207) MxReadImpl.parse(MxSese03300207 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03300207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300207 .class);
    }
