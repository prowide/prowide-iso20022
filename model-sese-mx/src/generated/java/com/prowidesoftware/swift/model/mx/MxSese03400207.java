    ...
    extends AbstractMX
{
    ...
    public static MxSese03400207 parse(String xml) {
        return ((MxSese03400207) MxReadImpl.parse(MxSese03400207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400207) MxReadImpl.parse(MxSese03400207 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03400207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03400207 .class);
    }
