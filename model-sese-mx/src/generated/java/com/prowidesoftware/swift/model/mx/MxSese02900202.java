    ...
    extends AbstractMX
{
    ...
    public static MxSese02900202 parse(String xml) {
        return ((MxSese02900202) MxReadImpl.parse(MxSese02900202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02900202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02900202) MxReadImpl.parse(MxSese02900202 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02900202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02900202 .class);
    }
