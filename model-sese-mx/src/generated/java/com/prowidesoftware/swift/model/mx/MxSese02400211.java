    ...
    extends AbstractMX
{
    ...
    public static MxSese02400211 parse(String xml) {
        return ((MxSese02400211) MxReadImpl.parse(MxSese02400211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400211) MxReadImpl.parse(MxSese02400211 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02400211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400211 .class);
    }
