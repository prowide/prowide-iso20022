    ...
    extends AbstractMX
{
    ...
    public static MxSese04000201 parse(String xml) {
        return ((MxSese04000201) MxReadImpl.parse(MxSese04000201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese04000201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese04000201) MxReadImpl.parse(MxSese04000201 .class, xml, _classes, new MxReadParams(conf)));
    }
