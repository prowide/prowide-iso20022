    ...
    extends AbstractMX
{
    ...
    public static MxSese02300107 parse(String xml) {
        return ((MxSese02300107) MxReadImpl.parse(MxSese02300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300107) MxReadImpl.parse(MxSese02300107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02300107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300107 .class);
    }
