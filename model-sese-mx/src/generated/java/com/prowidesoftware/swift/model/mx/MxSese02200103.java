    ...
    extends AbstractMX
{
    ...
    public static MxSese02200103 parse(String xml) {
        return ((MxSese02200103) MxReadImpl.parse(MxSese02200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02200103) MxReadImpl.parse(MxSese02200103 .class, xml, _classes, new MxReadParams(conf)));
    }
