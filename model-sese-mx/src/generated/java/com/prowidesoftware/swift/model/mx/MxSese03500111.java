    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.035.001.11";
    ...
    public static MxSese03500111 parse(String xml) {
        return ((MxSese03500111) MxReadImpl.parse(MxSese03500111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500111) MxReadImpl.parse(MxSese03500111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03500111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500111 .class);
    }
