    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.035.002.01";
    ...
    public static MxSese03500201 parse(String xml) {
        return ((MxSese03500201) MxReadImpl.parse(MxSese03500201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500201) MxReadImpl.parse(MxSese03500201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03500201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500201 .class);
    }
