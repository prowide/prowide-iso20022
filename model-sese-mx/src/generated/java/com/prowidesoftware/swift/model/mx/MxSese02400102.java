    ...
    extends AbstractMX
{
    ...
    public static MxSese02400102 parse(String xml) {
        return ((MxSese02400102) MxReadImpl.parse(MxSese02400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400102) MxReadImpl.parse(MxSese02400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400102 .class);
    }
