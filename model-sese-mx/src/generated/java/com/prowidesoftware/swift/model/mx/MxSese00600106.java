    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.006.001.06";
    ...
    public static MxSese00600106 parse(String xml) {
        return ((MxSese00600106) MxReadImpl.parse(MxSese00600106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00600106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00600106) MxReadImpl.parse(MxSese00600106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00600106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00600106 .class);
    }
