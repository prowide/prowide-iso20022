    ...
    extends AbstractMX
{
    ...
    public static MxSese03100206 parse(String xml) {
        return ((MxSese03100206) MxReadImpl.parse(MxSese03100206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03100206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03100206) MxReadImpl.parse(MxSese03100206 .class, xml, _classes, new MxReadParams(conf)));
    }
