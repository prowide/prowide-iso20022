    ...
    extends AbstractMX
{
    ...
    public static MxSese02800101 parse(String xml) {
        return ((MxSese02800101) MxReadImpl.parse(MxSese02800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800101) MxReadImpl.parse(MxSese02800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02800101 .class);
    }
