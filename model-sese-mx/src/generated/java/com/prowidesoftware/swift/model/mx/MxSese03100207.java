    ...
    extends AbstractMX
{
    ...
    public static MxSese03100207 parse(String xml) {
        return ((MxSese03100207) MxReadImpl.parse(MxSese03100207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03100207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03100207) MxReadImpl.parse(MxSese03100207 .class, xml, _classes, new MxReadParams(conf)));
    }
