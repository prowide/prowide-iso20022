    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.034.001.03";
    ...
    public static MxSese03400103 parse(String xml) {
        return ((MxSese03400103) MxReadImpl.parse(MxSese03400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400103) MxReadImpl.parse(MxSese03400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03400103 .class);
    }
