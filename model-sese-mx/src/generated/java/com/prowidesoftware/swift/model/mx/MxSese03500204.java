    ...
    extends AbstractMX
{
    ...
    public static MxSese03500204 parse(String xml) {
        return ((MxSese03500204) MxReadImpl.parse(MxSese03500204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500204) MxReadImpl.parse(MxSese03500204 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03500204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500204 .class);
    }
