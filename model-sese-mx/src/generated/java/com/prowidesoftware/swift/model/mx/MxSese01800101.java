    ...
    extends AbstractMX
{
    ...
    public static MxSese01800101 parse(String xml) {
        return ((MxSese01800101) MxReadImpl.parse(MxSese01800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01800101) MxReadImpl.parse(MxSese01800101 .class, xml, _classes, new MxReadParams(conf)));
    }
