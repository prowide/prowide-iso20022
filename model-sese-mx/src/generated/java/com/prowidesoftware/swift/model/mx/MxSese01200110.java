    ...
    extends AbstractMX
{
    ...
    public static MxSese01200110 parse(String xml) {
        return ((MxSese01200110) MxReadImpl.parse(MxSese01200110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01200110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01200110) MxReadImpl.parse(MxSese01200110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01200110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01200110 .class);
    }
