    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.036.002.01";
    ...
    public static MxSese03600201 parse(String xml) {
        return ((MxSese03600201) MxReadImpl.parse(MxSese03600201 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03600201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03600201 .class);
    }
