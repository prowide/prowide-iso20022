    ...
    extends AbstractMX
{
    ...
    public static MxSese03600201 parse(String xml) {
        return ((MxSese03600201) MxReadImpl.parse(MxSese03600201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03600201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03600201) MxReadImpl.parse(MxSese03600201 .class, xml, _classes, new MxReadParams(conf)));
    }
