    ...
    extends AbstractMX
{
    ...
    public static MxSese01800107 parse(String xml) {
        return ((MxSese01800107) MxReadImpl.parse(MxSese01800107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01800107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01800107) MxReadImpl.parse(MxSese01800107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01800107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01800107 .class);
    }
