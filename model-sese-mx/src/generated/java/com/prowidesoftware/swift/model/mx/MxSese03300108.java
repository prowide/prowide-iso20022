    ...
    extends AbstractMX
{
    ...
    public static MxSese03300108 parse(String xml) {
        return ((MxSese03300108) MxReadImpl.parse(MxSese03300108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300108) MxReadImpl.parse(MxSese03300108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03300108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300108 .class);
    }
