    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.028.001.04";
    ...
    public static MxSese02800104 parse(String xml) {
        return ((MxSese02800104) MxReadImpl.parse(MxSese02800104 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02800104 .class);
    }
