    ...
    extends AbstractMX
{
    ...
    public static MxSese02800104 parse(String xml) {
        return ((MxSese02800104) MxReadImpl.parse(MxSese02800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800104) MxReadImpl.parse(MxSese02800104 .class, xml, _classes, new MxReadParams(conf)));
    }
