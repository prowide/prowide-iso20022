    ...
    extends AbstractMX
{
    ...
    public static MxSese02600103 parse(String xml) {
        return ((MxSese02600103) MxReadImpl.parse(MxSese02600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600103) MxReadImpl.parse(MxSese02600103 .class, xml, _classes, new MxReadParams(conf)));
    }
