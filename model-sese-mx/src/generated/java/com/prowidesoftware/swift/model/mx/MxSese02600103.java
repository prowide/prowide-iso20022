    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.026.001.03";
    ...
    public static MxSese02600103 parse(String xml) {
        return ((MxSese02600103) MxReadImpl.parse(MxSese02600103 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600103 .class);
    }
