    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.002.001.07";
    ...
    public static MxSese00200107 parse(String xml) {
        return ((MxSese00200107) MxReadImpl.parse(MxSese00200107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00200107) MxReadImpl.parse(MxSese00200107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00200107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00200107 .class);
    }
