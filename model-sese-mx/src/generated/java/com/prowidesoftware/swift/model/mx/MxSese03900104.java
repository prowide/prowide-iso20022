    ...
    extends AbstractMX
{
    ...
    public static MxSese03900104 parse(String xml) {
        return ((MxSese03900104) MxReadImpl.parse(MxSese03900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03900104) MxReadImpl.parse(MxSese03900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03900104 .class);
    }
