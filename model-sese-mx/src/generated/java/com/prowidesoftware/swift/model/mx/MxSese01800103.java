    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.018.001.03";
    ...
    public static MxSese01800103 parse(String xml) {
        return ((MxSese01800103) MxReadImpl.parse(MxSese01800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01800103) MxReadImpl.parse(MxSese01800103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01800103 .class);
    }
