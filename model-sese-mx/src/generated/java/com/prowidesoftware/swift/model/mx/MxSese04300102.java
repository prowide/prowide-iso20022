    ...
    extends AbstractMX
{
    ...
    public static MxSese04300102 parse(String xml) {
        return ((MxSese04300102) MxReadImpl.parse(MxSese04300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese04300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese04300102) MxReadImpl.parse(MxSese04300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese04300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese04300102 .class);
    }
