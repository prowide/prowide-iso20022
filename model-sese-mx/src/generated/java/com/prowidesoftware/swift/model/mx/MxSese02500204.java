    ...
    extends AbstractMX
{
    ...
    public static MxSese02500204 parse(String xml) {
        return ((MxSese02500204) MxReadImpl.parse(MxSese02500204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500204) MxReadImpl.parse(MxSese02500204 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02500204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500204 .class);
    }
