    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.030.001.02";
    ...
    public static MxSese03000102 parse(String xml) {
        return ((MxSese03000102) MxReadImpl.parse(MxSese03000102 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03000102 .class);
    }
