    ...
    extends AbstractMX
{
    ...
    public static MxSese03000102 parse(String xml) {
        return ((MxSese03000102) MxReadImpl.parse(MxSese03000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03000102) MxReadImpl.parse(MxSese03000102 .class, xml, _classes, new MxReadParams(conf)));
    }
