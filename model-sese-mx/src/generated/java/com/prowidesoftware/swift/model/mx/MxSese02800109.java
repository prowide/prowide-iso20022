    ...
    extends AbstractMX
{
    ...
    public static MxSese02800109 parse(String xml) {
        return ((MxSese02800109) MxReadImpl.parse(MxSese02800109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800109) MxReadImpl.parse(MxSese02800109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02800109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02800109 .class);
    }
