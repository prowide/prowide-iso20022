    ...
    extends AbstractMX
{
    ...
    public static MxSese00200106 parse(String xml) {
        return ((MxSese00200106) MxReadImpl.parse(MxSese00200106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00200106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00200106) MxReadImpl.parse(MxSese00200106 .class, xml, _classes, new MxReadParams(conf)));
    }
