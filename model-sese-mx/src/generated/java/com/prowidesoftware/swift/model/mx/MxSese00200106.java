    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.002.001.06";
    ...
    public static MxSese00200106 parse(String xml) {
        return ((MxSese00200106) MxReadImpl.parse(MxSese00200106 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese00200106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00200106 .class);
    }
