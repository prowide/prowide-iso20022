    ...
    extends AbstractMX
{
    ...
    public static MxSese03200105 parse(String xml) {
        return ((MxSese03200105) MxReadImpl.parse(MxSese03200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200105) MxReadImpl.parse(MxSese03200105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200105 .class);
    }
