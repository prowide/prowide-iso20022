    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.025.002.05";
    ...
    public static MxSese02500205 parse(String xml) {
        return ((MxSese02500205) MxReadImpl.parse(MxSese02500205 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02500205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500205 .class);
    }
