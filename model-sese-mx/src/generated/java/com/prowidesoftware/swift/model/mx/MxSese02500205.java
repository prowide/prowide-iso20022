    ...
    extends AbstractMX
{
    ...
    public static MxSese02500205 parse(String xml) {
        return ((MxSese02500205) MxReadImpl.parse(MxSese02500205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500205) MxReadImpl.parse(MxSese02500205 .class, xml, _classes, new MxReadParams(conf)));
    }
