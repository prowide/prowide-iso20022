    ...
    extends AbstractMX
{
    ...
    public static MxSese03300205 parse(String xml) {
        return ((MxSese03300205) MxReadImpl.parse(MxSese03300205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300205) MxReadImpl.parse(MxSese03300205 .class, xml, _classes, new MxReadParams(conf)));
    }
