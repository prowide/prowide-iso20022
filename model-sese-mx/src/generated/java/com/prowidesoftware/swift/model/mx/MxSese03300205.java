    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.033.002.05";
    ...
    public static MxSese03300205 parse(String xml) {
        return ((MxSese03300205) MxReadImpl.parse(MxSese03300205 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03300205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300205 .class);
    }
