    ...
    extends AbstractMX
{
    ...
    public static MxSese02100206 parse(String xml) {
        return ((MxSese02100206) MxReadImpl.parse(MxSese02100206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02100206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02100206) MxReadImpl.parse(MxSese02100206 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02100206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02100206 .class);
    }
