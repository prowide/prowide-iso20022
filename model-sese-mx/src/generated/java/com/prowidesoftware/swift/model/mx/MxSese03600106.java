    ...
    extends AbstractMX
{
    ...
    public static MxSese03600106 parse(String xml) {
        return ((MxSese03600106) MxReadImpl.parse(MxSese03600106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03600106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03600106) MxReadImpl.parse(MxSese03600106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03600106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03600106 .class);
    }
