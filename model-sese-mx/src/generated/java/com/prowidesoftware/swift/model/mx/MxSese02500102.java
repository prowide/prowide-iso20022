    ...
    extends AbstractMX
{
    ...
    public static MxSese02500102 parse(String xml) {
        return ((MxSese02500102) MxReadImpl.parse(MxSese02500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500102) MxReadImpl.parse(MxSese02500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500102 .class);
    }
