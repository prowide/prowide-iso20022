    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.033.002.02";
    ...
    public static MxSese03300202 parse(String xml) {
        return ((MxSese03300202) MxReadImpl.parse(MxSese03300202 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03300202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300202 .class);
    }
