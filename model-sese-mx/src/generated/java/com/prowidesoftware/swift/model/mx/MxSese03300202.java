    ...
    extends AbstractMX
{
    ...
    public static MxSese03300202 parse(String xml) {
        return ((MxSese03300202) MxReadImpl.parse(MxSese03300202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300202) MxReadImpl.parse(MxSese03300202 .class, xml, _classes, new MxReadParams(conf)));
    }
