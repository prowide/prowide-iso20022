    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.032.002.02";
    ...
    public static MxSese03200202 parse(String xml) {
        return ((MxSese03200202) MxReadImpl.parse(MxSese03200202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200202) MxReadImpl.parse(MxSese03200202 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03200202 fromJson(String json) {
