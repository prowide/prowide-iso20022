    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.003.001.08";
    ...
    public static MxSese00300108 parse(String xml) {
        return ((MxSese00300108) MxReadImpl.parse(MxSese00300108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00300108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00300108) MxReadImpl.parse(MxSese00300108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00300108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00300108 .class);
    }
