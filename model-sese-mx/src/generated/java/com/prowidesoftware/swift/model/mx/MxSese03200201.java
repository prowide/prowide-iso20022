    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.032.002.01";
    ...
    public static MxSese03200201 parse(String xml) {
        return ((MxSese03200201) MxReadImpl.parse(MxSese03200201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200201) MxReadImpl.parse(MxSese03200201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03200201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200201 .class);
    }
