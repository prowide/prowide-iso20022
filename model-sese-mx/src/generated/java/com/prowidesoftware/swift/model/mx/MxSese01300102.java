    ...
    extends AbstractMX
{
    ...
    public static MxSese01300102 parse(String xml) {
        return ((MxSese01300102) MxReadImpl.parse(MxSese01300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01300102) MxReadImpl.parse(MxSese01300102 .class, xml, _classes, new MxReadParams(conf)));
    }
