    ...
    extends AbstractMX
{
    ...
    public static MxSese00300104 parse(String xml) {
        return ((MxSese00300104) MxReadImpl.parse(MxSese00300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00300104) MxReadImpl.parse(MxSese00300104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00300104 .class);
    }
