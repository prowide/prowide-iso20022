    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.020.002.01";
    ...
    public static MxSese02000201 parse(String xml) {
        return ((MxSese02000201) MxReadImpl.parse(MxSese02000201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02000201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02000201) MxReadImpl.parse(MxSese02000201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02000201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02000201 .class);
    }
