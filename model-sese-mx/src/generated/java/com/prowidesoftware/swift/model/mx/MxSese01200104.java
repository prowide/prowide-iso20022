    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.012.001.04";
    ...
    public static MxSese01200104 parse(String xml) {
        return ((MxSese01200104) MxReadImpl.parse(MxSese01200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01200104) MxReadImpl.parse(MxSese01200104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01200104 .class);
    }
