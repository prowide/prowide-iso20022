    ...
    extends AbstractMX
{
    ...
    public static MxSese02500111 parse(String xml) {
        return ((MxSese02500111) MxReadImpl.parse(MxSese02500111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500111) MxReadImpl.parse(MxSese02500111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02500111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500111 .class);
    }
