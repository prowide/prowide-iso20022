    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.021.001.06";
    ...
    public static MxSese02100106 parse(String xml) {
        return ((MxSese02100106) MxReadImpl.parse(MxSese02100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02100106) MxReadImpl.parse(MxSese02100106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02100106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02100106 .class);
    }
