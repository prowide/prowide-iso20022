    ...
    extends AbstractMX
{
    ...
    public static MxSese02400106 parse(String xml) {
        return ((MxSese02400106) MxReadImpl.parse(MxSese02400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400106) MxReadImpl.parse(MxSese02400106 .class, xml, _classes, new MxReadParams(conf)));
    }
