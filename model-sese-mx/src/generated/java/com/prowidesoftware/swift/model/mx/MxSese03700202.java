    ...
    extends AbstractMX
{
    ...
    public static MxSese03700202 parse(String xml) {
        return ((MxSese03700202) MxReadImpl.parse(MxSese03700202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03700202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03700202) MxReadImpl.parse(MxSese03700202 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03700202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03700202 .class);
    }
