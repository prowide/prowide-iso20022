    ...
    extends AbstractMX
{
    ...
    public static MxSese03500211 parse(String xml) {
        return ((MxSese03500211) MxReadImpl.parse(MxSese03500211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500211) MxReadImpl.parse(MxSese03500211 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03500211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500211 .class);
    }
