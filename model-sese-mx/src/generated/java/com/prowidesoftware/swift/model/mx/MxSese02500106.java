    ...
    extends AbstractMX
{
    ...
    public static MxSese02500106 parse(String xml) {
        return ((MxSese02500106) MxReadImpl.parse(MxSese02500106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500106) MxReadImpl.parse(MxSese02500106 .class, xml, _classes, new MxReadParams(conf)));
    }
