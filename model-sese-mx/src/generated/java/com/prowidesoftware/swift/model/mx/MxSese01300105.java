    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.013.001.05";
    ...
    public static MxSese01300105 parse(String xml) {
        return ((MxSese01300105) MxReadImpl.parse(MxSese01300105 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese01300105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01300105 .class);
    }
