    ...
    extends AbstractMX
{
    ...
    public static MxSese01300105 parse(String xml) {
        return ((MxSese01300105) MxReadImpl.parse(MxSese01300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01300105) MxReadImpl.parse(MxSese01300105 .class, xml, _classes, new MxReadParams(conf)));
    }
