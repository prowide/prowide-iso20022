    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.034.001.05";
    ...
    public static MxSese03400105 parse(String xml) {
        return ((MxSese03400105) MxReadImpl.parse(MxSese03400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400105) MxReadImpl.parse(MxSese03400105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03400105 fromJson(String json) {
