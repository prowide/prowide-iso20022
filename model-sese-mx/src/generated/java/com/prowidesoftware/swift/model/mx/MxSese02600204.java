    ...
    extends AbstractMX
{
    ...
    public static MxSese02600204 parse(String xml) {
        return ((MxSese02600204) MxReadImpl.parse(MxSese02600204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600204) MxReadImpl.parse(MxSese02600204 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02600204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600204 .class);
    }
