    ...
    extends AbstractMX
{
    ...
    public static MxSese02500105 parse(String xml) {
        return ((MxSese02500105) MxReadImpl.parse(MxSese02500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500105) MxReadImpl.parse(MxSese02500105 .class, xml, _classes, new MxReadParams(conf)));
    }
