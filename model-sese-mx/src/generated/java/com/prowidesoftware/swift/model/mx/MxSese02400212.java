    ...
    extends AbstractMX
{
    ...
    public static MxSese02400212 parse(String xml) {
        return ((MxSese02400212) MxReadImpl.parse(MxSese02400212 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400212 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400212) MxReadImpl.parse(MxSese02400212 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02400212 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400212 .class);
    }
