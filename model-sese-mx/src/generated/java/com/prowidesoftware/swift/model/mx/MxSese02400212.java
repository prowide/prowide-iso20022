...
/**
 * Class for sese.024.002.12 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:sese.024.002.12")
public class MxSese02400212
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.024.002.12";
     ...
     * 
     */
    public MxSese02400212(final String xml) {
        this();
        MxSese02400212 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02400212(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionStatusAdvice002V12 }
     *     
     */
     ...
     *     
     */
    public MxSese02400212 setSctiesSttlmTxStsAdvc(SecuritiesSettlementTransactionStatusAdvice002V12 value) {
     ...
     * 
     */
    public static MxSese02400212 parse(String xml) {
        return ((MxSese02400212) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02400212 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02400212 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400212) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02400212 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02400212 parse(String xml, MxRead parserImpl) {
        return ((MxSese02400212) parserImpl.read(MxSese02400212 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02400212 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02400212 message
     * @return
     *     a new instance of MxSese02400212
     */
    public final static MxSese02400212 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02400212 .class);
    }
