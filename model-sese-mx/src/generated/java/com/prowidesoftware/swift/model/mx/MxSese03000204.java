    ...
    extends AbstractMX
{
    ...
    public static MxSese03000204 parse(String xml) {
        return ((MxSese03000204) MxReadImpl.parse(MxSese03000204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03000204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03000204) MxReadImpl.parse(MxSese03000204 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03000204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03000204 .class);
    }
