    ...
    extends AbstractMX
{
    ...
    public static MxSese02300204 parse(String xml) {
        return ((MxSese02300204) MxReadImpl.parse(MxSese02300204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300204) MxReadImpl.parse(MxSese02300204 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02300204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300204 .class);
    }
