    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.035.001.06";
    ...
    public static MxSese03500106 parse(String xml) {
        return ((MxSese03500106) MxReadImpl.parse(MxSese03500106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500106) MxReadImpl.parse(MxSese03500106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03500106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500106 .class);
    }
