    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.028.002.10";
    ...
    public static MxSese02800210 parse(String xml) {
        return ((MxSese02800210) MxReadImpl.parse(MxSese02800210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800210) MxReadImpl.parse(MxSese02800210 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02800210 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02800210 .class);
    }
