    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.025.001.03";
    ...
    public static MxSese02500103 parse(String xml) {
        return ((MxSese02500103) MxReadImpl.parse(MxSese02500103 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500103 .class);
    }
