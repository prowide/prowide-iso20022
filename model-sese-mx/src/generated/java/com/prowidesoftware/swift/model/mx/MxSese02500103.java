    ...
    extends AbstractMX
{
    ...
    public static MxSese02500103 parse(String xml) {
        return ((MxSese02500103) MxReadImpl.parse(MxSese02500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500103) MxReadImpl.parse(MxSese02500103 .class, xml, _classes, new MxReadParams(conf)));
    }
