    ...
    extends AbstractMX
{
    ...
    public static MxSese02600205 parse(String xml) {
        return ((MxSese02600205) MxReadImpl.parse(MxSese02600205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600205) MxReadImpl.parse(MxSese02600205 .class, xml, _classes, new MxReadParams(conf)));
    }
