    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.026.002.05";
    ...
    public static MxSese02600205 parse(String xml) {
        return ((MxSese02600205) MxReadImpl.parse(MxSese02600205 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02600205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600205 .class);
    }
