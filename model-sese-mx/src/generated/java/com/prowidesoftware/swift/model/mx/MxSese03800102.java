    ...
    extends AbstractMX
{
    ...
    public static MxSese03800102 parse(String xml) {
        return ((MxSese03800102) MxReadImpl.parse(MxSese03800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03800102) MxReadImpl.parse(MxSese03800102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03800102 .class);
    }
