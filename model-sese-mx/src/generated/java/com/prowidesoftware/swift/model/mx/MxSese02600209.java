    ...
    extends AbstractMX
{
    ...
    public static MxSese02600209 parse(String xml) {
        return ((MxSese02600209) MxReadImpl.parse(MxSese02600209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600209) MxReadImpl.parse(MxSese02600209 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02600209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600209 .class);
    }
