    ...
    extends AbstractMX
{
    ...
    public static MxSese03100103 parse(String xml) {
        return ((MxSese03100103) MxReadImpl.parse(MxSese03100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03100103) MxReadImpl.parse(MxSese03100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03100103 .class);
    }
