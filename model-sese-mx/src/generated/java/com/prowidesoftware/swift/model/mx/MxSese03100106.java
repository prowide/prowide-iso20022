    ...
    extends AbstractMX
{
    ...
    public static MxSese03100106 parse(String xml) {
        return ((MxSese03100106) MxReadImpl.parse(MxSese03100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03100106) MxReadImpl.parse(MxSese03100106 .class, xml, _classes, new MxReadParams(conf)));
    }
