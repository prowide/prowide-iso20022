    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.032.001.12";
    ...
    public static MxSese03200112 parse(String xml) {
        return ((MxSese03200112) MxReadImpl.parse(MxSese03200112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200112) MxReadImpl.parse(MxSese03200112 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03200112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200112 .class);
    }
