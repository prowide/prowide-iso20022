    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.024.002.09";
    ...
    public static MxSese02400209 parse(String xml) {
        return ((MxSese02400209) MxReadImpl.parse(MxSese02400209 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02400209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400209 .class);
    }
