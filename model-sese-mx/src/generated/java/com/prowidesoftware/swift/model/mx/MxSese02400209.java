    ...
    extends AbstractMX
{
    ...
    public static MxSese02400209 parse(String xml) {
        return ((MxSese02400209) MxReadImpl.parse(MxSese02400209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400209) MxReadImpl.parse(MxSese02400209 .class, xml, _classes, new MxReadParams(conf)));
    }
