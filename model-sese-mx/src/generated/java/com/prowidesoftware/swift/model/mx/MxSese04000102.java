    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.040.001.02";
    ...
    public static MxSese04000102 parse(String xml) {
        return ((MxSese04000102) MxReadImpl.parse(MxSese04000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese04000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese04000102) MxReadImpl.parse(MxSese04000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese04000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese04000102 .class);
    }
