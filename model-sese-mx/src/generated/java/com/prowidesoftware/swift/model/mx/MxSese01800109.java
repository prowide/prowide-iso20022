    ...
    extends AbstractMX
{
    ...
    public static MxSese01800109 parse(String xml) {
        return ((MxSese01800109) MxReadImpl.parse(MxSese01800109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01800109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01800109) MxReadImpl.parse(MxSese01800109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01800109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01800109 .class);
    }
