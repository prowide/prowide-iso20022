    ...
    extends AbstractMX
{
    ...
    public static MxSese01400108 parse(String xml) {
        return ((MxSese01400108) MxReadImpl.parse(MxSese01400108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01400108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01400108) MxReadImpl.parse(MxSese01400108 .class, xml, _classes, new MxReadParams(conf)));
    }
