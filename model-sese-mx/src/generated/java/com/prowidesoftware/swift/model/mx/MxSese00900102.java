    ...
    extends AbstractMX
{
    ...
    public static MxSese00900102 parse(String xml) {
        return ((MxSese00900102) MxReadImpl.parse(MxSese00900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00900102) MxReadImpl.parse(MxSese00900102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00900102 .class);
    }
