    ...
    extends AbstractMX
{
    ...
    public static MxSese03400202 parse(String xml) {
        return ((MxSese03400202) MxReadImpl.parse(MxSese03400202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400202) MxReadImpl.parse(MxSese03400202 .class, xml, _classes, new MxReadParams(conf)));
    }
