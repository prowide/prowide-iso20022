    ...
    extends AbstractMX
{
    ...
    public static MxSese03400206 parse(String xml) {
        return ((MxSese03400206) MxReadImpl.parse(MxSese03400206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400206) MxReadImpl.parse(MxSese03400206 .class, xml, _classes, new MxReadParams(conf)));
    }
