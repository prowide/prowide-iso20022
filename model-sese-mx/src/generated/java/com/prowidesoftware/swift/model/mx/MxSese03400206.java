    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.034.002.06";
    ...
    public static MxSese03400206 parse(String xml) {
        return ((MxSese03400206) MxReadImpl.parse(MxSese03400206 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03400206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03400206 .class);
    }
