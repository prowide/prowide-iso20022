    ...
    extends AbstractMX
{
    ...
    public static MxSese00600104 parse(String xml) {
        return ((MxSese00600104) MxReadImpl.parse(MxSese00600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00600104) MxReadImpl.parse(MxSese00600104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00600104 .class);
    }
