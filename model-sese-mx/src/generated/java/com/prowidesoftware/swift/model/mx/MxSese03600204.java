    ...
    extends AbstractMX
{
    ...
    public static MxSese03600204 parse(String xml) {
        return ((MxSese03600204) MxReadImpl.parse(MxSese03600204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03600204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03600204) MxReadImpl.parse(MxSese03600204 .class, xml, _classes, new MxReadParams(conf)));
    }
