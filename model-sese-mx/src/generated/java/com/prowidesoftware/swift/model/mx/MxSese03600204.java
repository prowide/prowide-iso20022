    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.036.002.04";
    ...
    public static MxSese03600204 parse(String xml) {
        return ((MxSese03600204) MxReadImpl.parse(MxSese03600204 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03600204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03600204 .class);
    }
