    ...
    extends AbstractMX
{
    ...
    public static MxSese02500104 parse(String xml) {
        return ((MxSese02500104) MxReadImpl.parse(MxSese02500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500104) MxReadImpl.parse(MxSese02500104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02500104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500104 .class);
    }
