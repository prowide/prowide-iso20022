    ...
    extends AbstractMX
{
    ...
    public static MxSese03100203 parse(String xml) {
        return ((MxSese03100203) MxReadImpl.parse(MxSese03100203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03100203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03100203) MxReadImpl.parse(MxSese03100203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03100203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03100203 .class);
    }
