    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.027.001.01";
    ...
    public static MxSese02700101 parse(String xml) {
        return ((MxSese02700101) MxReadImpl.parse(MxSese02700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02700101) MxReadImpl.parse(MxSese02700101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02700101 .class);
    }
