    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.027.001.05";
    ...
    public static MxSese02700105 parse(String xml) {
        return ((MxSese02700105) MxReadImpl.parse(MxSese02700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02700105) MxReadImpl.parse(MxSese02700105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02700105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02700105 .class);
    }
