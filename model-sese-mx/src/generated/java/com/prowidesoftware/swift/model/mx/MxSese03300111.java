    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.033.001.11";
    ...
    public static MxSese03300111 parse(String xml) {
        return ((MxSese03300111) MxReadImpl.parse(MxSese03300111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300111) MxReadImpl.parse(MxSese03300111 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03300111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300111 .class);
    }
