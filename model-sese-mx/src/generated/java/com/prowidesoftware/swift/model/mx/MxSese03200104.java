    ...
    extends AbstractMX
{
    ...
    public static MxSese03200104 parse(String xml) {
        return ((MxSese03200104) MxReadImpl.parse(MxSese03200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200104) MxReadImpl.parse(MxSese03200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200104 .class);
    }
