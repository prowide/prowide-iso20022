    ...
    extends AbstractMX
{
    ...
    public static MxSese00300109 parse(String xml) {
        return ((MxSese00300109) MxReadImpl.parse(MxSese00300109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00300109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00300109) MxReadImpl.parse(MxSese00300109 .class, xml, _classes, new MxReadParams(conf)));
    }
