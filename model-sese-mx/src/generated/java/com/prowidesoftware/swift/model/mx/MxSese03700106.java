    ...
    extends AbstractMX
{
    ...
    public static MxSese03700106 parse(String xml) {
        return ((MxSese03700106) MxReadImpl.parse(MxSese03700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03700106) MxReadImpl.parse(MxSese03700106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03700106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03700106 .class);
    }
