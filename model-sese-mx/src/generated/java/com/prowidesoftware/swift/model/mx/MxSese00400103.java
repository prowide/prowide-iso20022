    ...
    extends AbstractMX
{
    ...
    public static MxSese00400103 parse(String xml) {
        return ((MxSese00400103) MxReadImpl.parse(MxSese00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00400103) MxReadImpl.parse(MxSese00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
