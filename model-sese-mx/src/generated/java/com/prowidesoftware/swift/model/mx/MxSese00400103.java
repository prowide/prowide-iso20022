    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.004.001.03";
    ...
    public static MxSese00400103 parse(String xml) {
        return ((MxSese00400103) MxReadImpl.parse(MxSese00400103 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese00400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00400103 .class);
    }
