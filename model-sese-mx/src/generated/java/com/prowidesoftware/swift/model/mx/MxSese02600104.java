    ...
    extends AbstractMX
{
    ...
    public static MxSese02600104 parse(String xml) {
        return ((MxSese02600104) MxReadImpl.parse(MxSese02600104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600104) MxReadImpl.parse(MxSese02600104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02600104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600104 .class);
    }
