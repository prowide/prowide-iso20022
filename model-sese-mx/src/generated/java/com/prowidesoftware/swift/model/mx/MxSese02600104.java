...
/**
 * Class for sese.026.001.04 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.026.001.04";
     ...
     * 
     */
    public MxSese02600104(final String xml) {
        this();
        MxSese02600104 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02600104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionReversalAdviceV04 }
     *     
     */
     ...
     *     
     */
    public MxSese02600104 setSctiesSttlmTxRvslAdvc(SecuritiesSettlementTransactionReversalAdviceV04 value) {
     ...
     * 
     */
    public static MxSese02600104 parse(String xml) {
        return ((MxSese02600104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02600104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02600104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02600104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02600104 parse(String xml, MxRead parserImpl) {
        return ((MxSese02600104) parserImpl.read(MxSese02600104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02600104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02600104 message
     * @return
     *     a new instance of MxSese02600104
     */
    public final static MxSese02600104 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02600104 .class);
    }
