    ...
    extends AbstractMX
{
    ...
    public static MxSese03300101 parse(String xml) {
        return ((MxSese03300101) MxReadImpl.parse(MxSese03300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300101) MxReadImpl.parse(MxSese03300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300101 .class);
    }
