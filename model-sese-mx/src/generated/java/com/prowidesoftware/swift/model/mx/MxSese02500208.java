    ...
    extends AbstractMX
{
    ...
    public static MxSese02500208 parse(String xml) {
        return ((MxSese02500208) MxReadImpl.parse(MxSese02500208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500208) MxReadImpl.parse(MxSese02500208 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02500208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500208 .class);
    }
