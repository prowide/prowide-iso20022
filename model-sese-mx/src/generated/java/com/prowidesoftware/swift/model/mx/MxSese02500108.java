    ...
    extends AbstractMX
{
    ...
    public static MxSese02500108 parse(String xml) {
        return ((MxSese02500108) MxReadImpl.parse(MxSese02500108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500108) MxReadImpl.parse(MxSese02500108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02500108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500108 .class);
    }
