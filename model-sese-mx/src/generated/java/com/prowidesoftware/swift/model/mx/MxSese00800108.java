    ...
    extends AbstractMX
{
    ...
    public static MxSese00800108 parse(String xml) {
        return ((MxSese00800108) MxReadImpl.parse(MxSese00800108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00800108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00800108) MxReadImpl.parse(MxSese00800108 .class, xml, _classes, new MxReadParams(conf)));
    }
