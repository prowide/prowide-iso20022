    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.028.001.03";
    ...
    public static MxSese02800103 parse(String xml) {
        return ((MxSese02800103) MxReadImpl.parse(MxSese02800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800103) MxReadImpl.parse(MxSese02800103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02800103 .class);
    }
