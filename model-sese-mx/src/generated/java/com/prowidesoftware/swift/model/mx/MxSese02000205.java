    ...
    extends AbstractMX
{
    ...
    public static MxSese02000205 parse(String xml) {
        return ((MxSese02000205) MxReadImpl.parse(MxSese02000205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02000205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02000205) MxReadImpl.parse(MxSese02000205 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02000205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02000205 .class);
    }
