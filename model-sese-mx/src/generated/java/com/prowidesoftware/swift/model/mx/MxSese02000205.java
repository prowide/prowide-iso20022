    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.020.002.05";
    ...
    public static MxSese02000205 parse(String xml) {
        return ((MxSese02000205) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02000205 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02000205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02000205) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02000205 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02000205 fromJson(String json) {
