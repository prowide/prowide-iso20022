    ...
    extends AbstractMX
{
    ...
    public static MxSese00100103 parse(String xml) {
        return ((MxSese00100103) MxReadImpl.parse(MxSese00100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00100103) MxReadImpl.parse(MxSese00100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00100103 .class);
    }
