    ...
    extends AbstractMX
{
    ...
    public static MxSese02300210 parse(String xml) {
        return ((MxSese02300210) MxReadImpl.parse(MxSese02300210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300210) MxReadImpl.parse(MxSese02300210 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02300210 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300210 .class);
    }
