...
/**
 * Class for sese.023.002.10 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese02300210(final String xml) {
        this();
        MxSese02300210 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02300210(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionInstruction002V10 }
     *     
     */
    public SecuritiesSettlementTransactionInstruction002V10 getSctiesSttlmTxInstr() {
     ...
     *     
     */
    public MxSese02300210 setSctiesSttlmTxInstr(SecuritiesSettlementTransactionInstruction002V10 value) {
     ...
     * 
     */
    public static MxSese02300210 parse(String xml) {
        return ((MxSese02300210) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02300210 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02300210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300210) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02300210 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02300210 parse(String xml, MxRead parserImpl) {
        return ((MxSese02300210) parserImpl.read(MxSese02300210 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02300210 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02300210 message
     * @return
     *     a new instance of MxSese02300210
     */
    public final static MxSese02300210 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02300210 .class);
    }
