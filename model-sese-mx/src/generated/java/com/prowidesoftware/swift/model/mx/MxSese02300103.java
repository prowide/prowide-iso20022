    ...
    extends AbstractMX
{
    ...
    public static MxSese02300103 parse(String xml) {
        return ((MxSese02300103) MxReadImpl.parse(MxSese02300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300103) MxReadImpl.parse(MxSese02300103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300103 .class);
    }
