    ...
    extends AbstractMX
{
    ...
    public static MxSese01300108 parse(String xml) {
        return ((MxSese01300108) MxReadImpl.parse(MxSese01300108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01300108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01300108) MxReadImpl.parse(MxSese01300108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01300108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01300108 .class);
    }
