    ...
    extends AbstractMX
{
    ...
    public static MxSese03000206 parse(String xml) {
        return ((MxSese03000206) MxReadImpl.parse(MxSese03000206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03000206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03000206) MxReadImpl.parse(MxSese03000206 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03000206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03000206 .class);
    }
