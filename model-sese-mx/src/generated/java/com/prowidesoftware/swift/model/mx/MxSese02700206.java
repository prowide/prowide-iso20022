    ...
    extends AbstractMX
{
    ...
    public static MxSese02700206 parse(String xml) {
        return ((MxSese02700206) MxReadImpl.parse(MxSese02700206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02700206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02700206) MxReadImpl.parse(MxSese02700206 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02700206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02700206 .class);
    }
