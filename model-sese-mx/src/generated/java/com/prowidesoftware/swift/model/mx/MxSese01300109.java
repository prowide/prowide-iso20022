    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.013.001.09";
    ...
    public static MxSese01300109 parse(String xml) {
        return ((MxSese01300109) MxReadImpl.parse(MxSese01300109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01300109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01300109) MxReadImpl.parse(MxSese01300109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01300109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01300109 .class);
    }
