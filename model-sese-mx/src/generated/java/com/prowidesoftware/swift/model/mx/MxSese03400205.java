    ...
    extends AbstractMX
{
    ...
    public static MxSese03400205 parse(String xml) {
        return ((MxSese03400205) MxReadImpl.parse(MxSese03400205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400205) MxReadImpl.parse(MxSese03400205 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03400205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03400205 .class);
    }
