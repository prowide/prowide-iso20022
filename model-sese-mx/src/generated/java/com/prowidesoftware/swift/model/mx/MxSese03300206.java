    ...
    extends AbstractMX
{
    ...
    public static MxSese03300206 parse(String xml) {
        return ((MxSese03300206) MxReadImpl.parse(MxSese03300206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300206) MxReadImpl.parse(MxSese03300206 .class, xml, _classes, new MxReadParams(conf)));
    }
