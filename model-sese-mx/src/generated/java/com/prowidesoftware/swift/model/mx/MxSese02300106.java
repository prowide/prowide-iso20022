    ...
    extends AbstractMX
{
    ...
    public static MxSese02300106 parse(String xml) {
        return ((MxSese02300106) MxReadImpl.parse(MxSese02300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300106) MxReadImpl.parse(MxSese02300106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02300106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300106 .class);
    }
