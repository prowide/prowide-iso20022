    ...
    extends AbstractMX
{
    ...
    public static MxSese00800107 parse(String xml) {
        return ((MxSese00800107) MxReadImpl.parse(MxSese00800107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00800107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00800107) MxReadImpl.parse(MxSese00800107 .class, xml, _classes, new MxReadParams(conf)));
    }
