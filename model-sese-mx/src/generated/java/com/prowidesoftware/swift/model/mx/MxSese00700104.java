    ...
    extends AbstractMX
{
    ...
    public static MxSese00700104 parse(String xml) {
        return ((MxSese00700104) MxReadImpl.parse(MxSese00700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00700104) MxReadImpl.parse(MxSese00700104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00700104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00700104 .class);
    }
