    ...
    extends AbstractMX
{
    ...
    public static MxSese04200102 parse(String xml) {
        return ((MxSese04200102) MxReadImpl.parse(MxSese04200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese04200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese04200102) MxReadImpl.parse(MxSese04200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese04200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese04200102 .class);
    }
