    ...
    extends AbstractMX
{
    ...
    public static MxSese03200108 parse(String xml) {
        return ((MxSese03200108) MxReadImpl.parse(MxSese03200108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200108) MxReadImpl.parse(MxSese03200108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03200108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200108 .class);
    }
