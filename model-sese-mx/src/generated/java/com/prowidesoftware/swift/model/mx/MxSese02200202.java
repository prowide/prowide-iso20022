    ...
    extends AbstractMX
{
    ...
    public static MxSese02200202 parse(String xml) {
        return ((MxSese02200202) MxReadImpl.parse(MxSese02200202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02200202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02200202) MxReadImpl.parse(MxSese02200202 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02200202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02200202 .class);
    }
