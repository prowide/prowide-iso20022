    ...
    extends AbstractMX
{
    ...
    public static MxSese01000105 parse(String xml) {
        return ((MxSese01000105) MxReadImpl.parse(MxSese01000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01000105) MxReadImpl.parse(MxSese01000105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01000105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01000105 .class);
    }
