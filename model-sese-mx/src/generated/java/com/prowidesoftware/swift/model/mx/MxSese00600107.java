    ...
    extends AbstractMX
{
    ...
    public static MxSese00600107 parse(String xml) {
        return ((MxSese00600107) MxReadImpl.parse(MxSese00600107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00600107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00600107) MxReadImpl.parse(MxSese00600107 .class, xml, _classes, new MxReadParams(conf)));
    }
