    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.006.001.07";
    ...
    public static MxSese00600107 parse(String xml) {
        return ((MxSese00600107) MxReadImpl.parse(MxSese00600107 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese00600107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00600107 .class);
    }
