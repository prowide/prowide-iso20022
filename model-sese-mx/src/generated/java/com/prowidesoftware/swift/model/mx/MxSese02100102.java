    ...
    extends AbstractMX
{
    ...
    public static MxSese02100102 parse(String xml) {
        return ((MxSese02100102) MxReadImpl.parse(MxSese02100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02100102) MxReadImpl.parse(MxSese02100102 .class, xml, _classes, new MxReadParams(conf)));
    }
