    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.010.001.06";
    ...
    public static MxSese01000106 parse(String xml) {
        return ((MxSese01000106) MxReadImpl.parse(MxSese01000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01000106) MxReadImpl.parse(MxSese01000106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01000106 fromJson(String json) {
