    ...
    extends AbstractMX
{
    ...
    public static MxSese03500101 parse(String xml) {
        return ((MxSese03500101) MxReadImpl.parse(MxSese03500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500101) MxReadImpl.parse(MxSese03500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500101 .class);
    }
