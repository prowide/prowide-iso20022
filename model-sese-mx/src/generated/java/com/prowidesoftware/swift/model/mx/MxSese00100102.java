    ...
    extends AbstractMX
{
    ...
    public static MxSese00100102 parse(String xml) {
        return ((MxSese00100102) MxReadImpl.parse(MxSese00100102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00100102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00100102) MxReadImpl.parse(MxSese00100102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00100102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00100102 .class);
    }
