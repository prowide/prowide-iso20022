    ...
    extends AbstractMX
{
    ...
    public static MxSese02800206 parse(String xml) {
        return ((MxSese02800206) MxReadImpl.parse(MxSese02800206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800206) MxReadImpl.parse(MxSese02800206 .class, xml, _classes, new MxReadParams(conf)));
    }
