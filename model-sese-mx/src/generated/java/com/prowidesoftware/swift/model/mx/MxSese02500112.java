    ...
    extends AbstractMX
{
    ...
    public static MxSese02500112 parse(String xml) {
        return ((MxSese02500112) MxReadImpl.parse(MxSese02500112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500112) MxReadImpl.parse(MxSese02500112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02500112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500112 .class);
    }
