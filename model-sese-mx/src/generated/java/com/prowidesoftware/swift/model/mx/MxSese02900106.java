    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.029.001.06";
    ...
    public static MxSese02900106 parse(String xml) {
        return ((MxSese02900106) MxReadImpl.parse(MxSese02900106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02900106) MxReadImpl.parse(MxSese02900106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02900106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02900106 .class);
    }
