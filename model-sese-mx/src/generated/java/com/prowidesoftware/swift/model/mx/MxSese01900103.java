    ...
    extends AbstractMX
{
    ...
    public static MxSese01900103 parse(String xml) {
        return ((MxSese01900103) MxReadImpl.parse(MxSese01900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01900103) MxReadImpl.parse(MxSese01900103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01900103 .class);
    }
