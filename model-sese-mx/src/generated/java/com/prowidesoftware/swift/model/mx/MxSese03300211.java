    ...
    extends AbstractMX
{
    ...
    public static MxSese03300211 parse(String xml) {
        return ((MxSese03300211) MxReadImpl.parse(MxSese03300211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300211) MxReadImpl.parse(MxSese03300211 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03300211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300211 .class);
    }
