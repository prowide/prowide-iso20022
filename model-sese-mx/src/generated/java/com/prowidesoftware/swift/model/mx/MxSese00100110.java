    ...
    extends AbstractMX
{
    ...
    public static MxSese00100110 parse(String xml) {
        return ((MxSese00100110) MxReadImpl.parse(MxSese00100110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00100110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00100110) MxReadImpl.parse(MxSese00100110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00100110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00100110 .class);
    }
