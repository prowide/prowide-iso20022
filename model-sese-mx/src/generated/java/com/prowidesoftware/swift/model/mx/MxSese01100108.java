    ...
    extends AbstractMX
{
    ...
    public static MxSese01100108 parse(String xml) {
        return ((MxSese01100108) MxReadImpl.parse(MxSese01100108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01100108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01100108) MxReadImpl.parse(MxSese01100108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01100108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01100108 .class);
    }
