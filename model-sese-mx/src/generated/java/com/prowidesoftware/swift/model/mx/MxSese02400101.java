...
/**
 * Class for sese.024.001.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese02400101(final String xml) {
        this();
        MxSese02400101 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02400101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionStatusAdviceV01 }
     *     
     */
    public SecuritiesSettlementTransactionStatusAdviceV01 getSctiesSttlmTxStsAdvc() {
     ...
     *     
     */
    public MxSese02400101 setSctiesSttlmTxStsAdvc(SecuritiesSettlementTransactionStatusAdviceV01 value) {
     ...
     * 
     */
    public static MxSese02400101 parse(String xml) {
        return ((MxSese02400101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02400101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02400101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02400101 parse(String xml, MxRead parserImpl) {
        return ((MxSese02400101) parserImpl.read(MxSese02400101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02400101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02400101 message
     * @return
     *     a new instance of MxSese02400101
     */
    public final static MxSese02400101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02400101 .class);
    }
