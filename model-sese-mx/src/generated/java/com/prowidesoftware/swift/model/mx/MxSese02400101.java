    ...
    extends AbstractMX
{
    ...
    public static MxSese02400101 parse(String xml) {
        return ((MxSese02400101) MxReadImpl.parse(MxSese02400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400101) MxReadImpl.parse(MxSese02400101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02400101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400101 .class);
    }
