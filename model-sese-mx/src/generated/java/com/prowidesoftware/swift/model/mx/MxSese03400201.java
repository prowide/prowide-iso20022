    ...
    extends AbstractMX
{
    ...
    public static MxSese03400201 parse(String xml) {
        return ((MxSese03400201) MxReadImpl.parse(MxSese03400201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400201) MxReadImpl.parse(MxSese03400201 .class, xml, _classes, new MxReadParams(conf)));
    }
