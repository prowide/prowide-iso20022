    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.034.002.01";
    ...
    public static MxSese03400201 parse(String xml) {
        return ((MxSese03400201) MxReadImpl.parse(MxSese03400201 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03400201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03400201 .class);
    }
