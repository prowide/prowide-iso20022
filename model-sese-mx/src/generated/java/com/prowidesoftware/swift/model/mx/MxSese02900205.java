    ...
    extends AbstractMX
{
    ...
    public static MxSese02900205 parse(String xml) {
        return ((MxSese02900205) MxReadImpl.parse(MxSese02900205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02900205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02900205) MxReadImpl.parse(MxSese02900205 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02900205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02900205 .class);
    }
