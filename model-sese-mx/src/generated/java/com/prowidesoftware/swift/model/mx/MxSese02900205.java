    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.029.002.05";
    ...
    public static MxSese02900205 parse(String xml) {
        return ((MxSese02900205) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02900205 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02900205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02900205) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02900205 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02900205 fromJson(String json) {
