    ...
    extends AbstractMX
{
    ...
    public static MxSese02300206 parse(String xml) {
        return ((MxSese02300206) MxReadImpl.parse(MxSese02300206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300206) MxReadImpl.parse(MxSese02300206 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02300206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300206 .class);
    }
