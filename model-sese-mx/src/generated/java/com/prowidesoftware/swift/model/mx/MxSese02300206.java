...
/**
 * Class for sese.023.002.06 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese02300206(final String xml) {
        this();
        MxSese02300206 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02300206(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionInstruction002V06 }
     *     
     */
    public SecuritiesSettlementTransactionInstruction002V06 getSctiesSttlmTxInstr() {
     ...
     *     
     */
    public MxSese02300206 setSctiesSttlmTxInstr(SecuritiesSettlementTransactionInstruction002V06 value) {
     ...
     * 
     */
    public static MxSese02300206 parse(String xml) {
        return ((MxSese02300206) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02300206 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02300206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300206) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02300206 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02300206 parse(String xml, MxRead parserImpl) {
        return ((MxSese02300206) parserImpl.read(MxSese02300206 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02300206 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02300206 message
     * @return
     *     a new instance of MxSese02300206
     */
    public final static MxSese02300206 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02300206 .class);
    }
