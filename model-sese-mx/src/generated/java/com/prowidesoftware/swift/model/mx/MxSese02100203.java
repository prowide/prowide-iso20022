    ...
    extends AbstractMX
{
    ...
    public static MxSese02100203 parse(String xml) {
        return ((MxSese02100203) MxReadImpl.parse(MxSese02100203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02100203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02100203) MxReadImpl.parse(MxSese02100203 .class, xml, _classes, new MxReadParams(conf)));
    }
