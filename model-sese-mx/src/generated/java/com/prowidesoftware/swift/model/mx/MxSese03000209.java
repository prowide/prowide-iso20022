...
/**
 * Class for sese.030.002.09 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:sese.030.002.09")
public class MxSese03000209
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese03000209(final String xml) {
        this();
        MxSese03000209 tmp = parse(xml);
     ...
     * 
     */
    public MxSese03000209(final MxSwiftMessage mxSwiftMessage) {
     ...
     * 
     */
    public static MxSese03000209 parse(String xml) {
        return ((MxSese03000209) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese03000209 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese03000209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03000209) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese03000209 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese03000209 parse(String xml, MxRead parserImpl) {
        return ((MxSese03000209) parserImpl.read(MxSese03000209 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese03000209 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese03000209 message
     * @return
