    ...
    extends AbstractMX
{
    ...
    public static MxSese03000209 parse(String xml) {
        return ((MxSese03000209) MxReadImpl.parse(MxSese03000209 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03000209 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03000209) MxReadImpl.parse(MxSese03000209 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03000209 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03000209 .class);
    }
