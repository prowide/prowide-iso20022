    ...
    extends AbstractMX
{
    ...
    public static MxSese03300105 parse(String xml) {
        return ((MxSese03300105) MxReadImpl.parse(MxSese03300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300105) MxReadImpl.parse(MxSese03300105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03300105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300105 .class);
    }
