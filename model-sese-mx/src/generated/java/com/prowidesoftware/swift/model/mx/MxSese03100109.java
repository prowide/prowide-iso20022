    ...
    extends AbstractMX
{
    ...
    public static MxSese03100109 parse(String xml) {
        return ((MxSese03100109) MxReadImpl.parse(MxSese03100109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03100109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03100109) MxReadImpl.parse(MxSese03100109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03100109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03100109 .class);
    }
