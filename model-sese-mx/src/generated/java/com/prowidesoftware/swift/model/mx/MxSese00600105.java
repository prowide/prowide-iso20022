    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.006.001.05";
    ...
    public static MxSese00600105 parse(String xml) {
        return ((MxSese00600105) MxReadImpl.parse(MxSese00600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00600105) MxReadImpl.parse(MxSese00600105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00600105 .class);
    }
