    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.020.001.04";
    ...
    public static MxSese02000104 parse(String xml) {
        return ((MxSese02000104) MxReadImpl.parse(MxSese02000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02000104) MxReadImpl.parse(MxSese02000104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02000104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02000104 .class);
    }
