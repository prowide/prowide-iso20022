    ...
    extends AbstractMX
{
    ...
    public static MxSese00300107 parse(String xml) {
        return ((MxSese00300107) MxReadImpl.parse(MxSese00300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00300107) MxReadImpl.parse(MxSese00300107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00300107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00300107 .class);
    }
