    ...
    extends AbstractMX
{
    ...
    public static MxSese02400202 parse(String xml) {
        return ((MxSese02400202) MxReadImpl.parse(MxSese02400202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400202) MxReadImpl.parse(MxSese02400202 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02400202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400202 .class);
    }
