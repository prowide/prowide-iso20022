...
/**
 * Class for sese.024.002.02 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:swift:xsd:sese.024.002.02")
public class MxSese02400202
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.024.002.02";
     ...
     * 
     */
    public MxSese02400202(final String xml) {
        this();
        MxSese02400202 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02400202(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionStatusAdviceV02Subset }
     *     
     */
     ...
     *     
     */
    public MxSese02400202 setSctiesSttlmTxStsAdvc(SecuritiesSettlementTransactionStatusAdviceV02Subset value) {
     ...
     * 
     */
    public static MxSese02400202 parse(String xml) {
        return ((MxSese02400202) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02400202 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02400202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400202) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02400202 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02400202 parse(String xml, MxRead parserImpl) {
        return ((MxSese02400202) parserImpl.read(MxSese02400202 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02400202 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02400202 message
     * @return
     *     a new instance of MxSese02400202
     */
    public final static MxSese02400202 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02400202 .class);
    }
