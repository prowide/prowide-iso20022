    ...
    extends AbstractMX
{
    ...
    public static MxSese02900103 parse(String xml) {
        return ((MxSese02900103) MxReadImpl.parse(MxSese02900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02900103) MxReadImpl.parse(MxSese02900103 .class, xml, _classes, new MxReadParams(conf)));
    }
