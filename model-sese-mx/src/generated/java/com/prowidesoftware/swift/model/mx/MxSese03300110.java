    ...
    extends AbstractMX
{
    ...
    public static MxSese03300110 parse(String xml) {
        return ((MxSese03300110) MxReadImpl.parse(MxSese03300110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300110) MxReadImpl.parse(MxSese03300110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03300110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300110 .class);
    }
