    ...
    extends AbstractMX
{
    ...
    public static MxSese03900205 parse(String xml) {
        return ((MxSese03900205) MxReadImpl.parse(MxSese03900205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03900205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03900205) MxReadImpl.parse(MxSese03900205 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03900205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03900205 .class);
    }
