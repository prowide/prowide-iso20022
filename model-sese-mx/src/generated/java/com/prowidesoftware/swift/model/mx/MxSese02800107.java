    ...
    extends AbstractMX
{
    ...
    public static MxSese02800107 parse(String xml) {
        return ((MxSese02800107) MxReadImpl.parse(MxSese02800107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800107) MxReadImpl.parse(MxSese02800107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02800107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02800107 .class);
    }
