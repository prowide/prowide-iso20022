    ...
    extends AbstractMX
{
    ...
    public static MxSese00500108 parse(String xml) {
        return ((MxSese00500108) MxReadImpl.parse(MxSese00500108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00500108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00500108) MxReadImpl.parse(MxSese00500108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00500108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00500108 .class);
    }
