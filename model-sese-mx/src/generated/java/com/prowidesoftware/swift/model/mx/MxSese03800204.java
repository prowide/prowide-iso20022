    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.038.002.04";
    ...
    public static MxSese03800204 parse(String xml) {
        return ((MxSese03800204) MxReadImpl.parse(MxSese03800204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03800204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03800204) MxReadImpl.parse(MxSese03800204 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03800204 fromJson(String json) {
