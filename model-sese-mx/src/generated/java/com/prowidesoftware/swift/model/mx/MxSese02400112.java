    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.024.001.12";
    ...
    public static MxSese02400112 parse(String xml) {
        return ((MxSese02400112) MxReadImpl.parse(MxSese02400112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400112) MxReadImpl.parse(MxSese02400112 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02400112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400112 .class);
    }
