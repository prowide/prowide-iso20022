    ...
    extends AbstractMX
{
    ...
    public static MxSese02300211 parse(String xml) {
        return ((MxSese02300211) MxReadImpl.parse(MxSese02300211 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300211 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300211) MxReadImpl.parse(MxSese02300211 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02300211 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300211 .class);
    }
