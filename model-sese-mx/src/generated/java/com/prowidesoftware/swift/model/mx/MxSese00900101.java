    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.009.001.01";
    ...
    public static MxSese00900101 parse(String xml) {
        return ((MxSese00900101) MxReadImpl.parse(MxSese00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00900101) MxReadImpl.parse(MxSese00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00900101 .class);
    }
