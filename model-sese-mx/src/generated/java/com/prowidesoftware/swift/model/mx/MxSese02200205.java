    ...
    extends AbstractMX
{
    ...
    public static MxSese02200205 parse(String xml) {
        return ((MxSese02200205) MxReadImpl.parse(MxSese02200205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02200205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02200205) MxReadImpl.parse(MxSese02200205 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02200205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02200205 .class);
    }
