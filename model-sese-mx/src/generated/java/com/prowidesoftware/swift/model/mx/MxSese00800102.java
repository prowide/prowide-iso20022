    ...
    extends AbstractMX
{
    ...
    public static MxSese00800102 parse(String xml) {
        return ((MxSese00800102) MxReadImpl.parse(MxSese00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00800102) MxReadImpl.parse(MxSese00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
