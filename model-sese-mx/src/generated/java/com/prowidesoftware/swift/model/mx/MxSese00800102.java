    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.008.001.02";
    ...
    public static MxSese00800102 parse(String xml) {
        return ((MxSese00800102) MxReadImpl.parse(MxSese00800102 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese00800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00800102 .class);
    }
