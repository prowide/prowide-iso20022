    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.020.002.07";
    ...
    public static MxSese02000207 parse(String xml) {
        return ((MxSese02000207) MxReadImpl.parse(MxSese02000207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02000207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02000207) MxReadImpl.parse(MxSese02000207 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02000207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02000207 .class);
    }
