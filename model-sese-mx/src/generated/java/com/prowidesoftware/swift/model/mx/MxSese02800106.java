    ...
    extends AbstractMX
{
    ...
    public static MxSese02800106 parse(String xml) {
        return ((MxSese02800106) MxReadImpl.parse(MxSese02800106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800106) MxReadImpl.parse(MxSese02800106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02800106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02800106 .class);
    }
