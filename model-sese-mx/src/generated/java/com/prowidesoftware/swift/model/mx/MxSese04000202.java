    ...
    extends AbstractMX
{
    ...
    public static MxSese04000202 parse(String xml) {
        return ((MxSese04000202) MxReadImpl.parse(MxSese04000202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese04000202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese04000202) MxReadImpl.parse(MxSese04000202 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese04000202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese04000202 .class);
    }
