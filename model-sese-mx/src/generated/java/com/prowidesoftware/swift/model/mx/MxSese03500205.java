    ...
    extends AbstractMX
{
    ...
    public static MxSese03500205 parse(String xml) {
        return ((MxSese03500205) MxReadImpl.parse(MxSese03500205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500205) MxReadImpl.parse(MxSese03500205 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03500205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500205 .class);
    }
