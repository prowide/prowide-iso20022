    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.038.001.08";
    ...
    public static MxSese03800108 parse(String xml) {
        return ((MxSese03800108) MxReadImpl.parse(MxSese03800108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03800108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03800108) MxReadImpl.parse(MxSese03800108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03800108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03800108 .class);
    }
