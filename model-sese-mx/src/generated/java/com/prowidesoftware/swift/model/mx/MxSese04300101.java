    ...
    extends AbstractMX
{
    ...
    public static MxSese04300101 parse(String xml) {
        return ((MxSese04300101) MxReadImpl.parse(MxSese04300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese04300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese04300101) MxReadImpl.parse(MxSese04300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese04300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese04300101 .class);
    }
