    ...
    extends AbstractMX
{
    ...
    public static MxSese03100204 parse(String xml) {
        return ((MxSese03100204) MxReadImpl.parse(MxSese03100204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03100204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03100204) MxReadImpl.parse(MxSese03100204 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03100204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03100204 .class);
    }
