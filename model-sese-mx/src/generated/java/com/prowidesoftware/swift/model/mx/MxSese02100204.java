    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.021.002.04";
    ...
    public static MxSese02100204 parse(String xml) {
        return ((MxSese02100204) MxReadImpl.parse(MxSese02100204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02100204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02100204) MxReadImpl.parse(MxSese02100204 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02100204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02100204 .class);
    }
