    ...
    extends AbstractMX
{
    ...
    public static MxSese00400109 parse(String xml) {
        return ((MxSese00400109) MxReadImpl.parse(MxSese00400109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00400109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00400109) MxReadImpl.parse(MxSese00400109 .class, xml, _classes, new MxReadParams(conf)));
    }
