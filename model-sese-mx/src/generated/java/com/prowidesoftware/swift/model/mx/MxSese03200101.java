    ...
    extends AbstractMX
{
    ...
    public static MxSese03200101 parse(String xml) {
        return ((MxSese03200101) MxReadImpl.parse(MxSese03200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200101) MxReadImpl.parse(MxSese03200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200101 .class);
    }
