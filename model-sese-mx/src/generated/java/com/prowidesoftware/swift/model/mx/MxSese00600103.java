    ...
    extends AbstractMX
{
    ...
    public static MxSese00600103 parse(String xml) {
        return ((MxSese00600103) MxReadImpl.parse(MxSese00600103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00600103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00600103) MxReadImpl.parse(MxSese00600103 .class, xml, _classes, new MxReadParams(conf)));
    }
