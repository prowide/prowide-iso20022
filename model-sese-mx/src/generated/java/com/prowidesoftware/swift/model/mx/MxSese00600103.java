    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.006.001.03";
    ...
    public static MxSese00600103 parse(String xml) {
        return ((MxSese00600103) MxReadImpl.parse(MxSese00600103 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese00600103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00600103 .class);
    }
