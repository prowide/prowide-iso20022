    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.035.002.08";
    ...
    public static MxSese03500208 parse(String xml) {
        return ((MxSese03500208) MxReadImpl.parse(MxSese03500208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500208) MxReadImpl.parse(MxSese03500208 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03500208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500208 .class);
    }
