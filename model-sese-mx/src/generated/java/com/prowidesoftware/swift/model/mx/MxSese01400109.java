    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.014.001.09";
    ...
    public static MxSese01400109 parse(String xml) {
        return ((MxSese01400109) MxReadImpl.parse(MxSese01400109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01400109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01400109) MxReadImpl.parse(MxSese01400109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01400109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01400109 .class);
    }
