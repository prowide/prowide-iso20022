    ...
    extends AbstractMX
{
    ...
    public static MxSese03800203 parse(String xml) {
        return ((MxSese03800203) MxReadImpl.parse(MxSese03800203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03800203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03800203) MxReadImpl.parse(MxSese03800203 .class, xml, _classes, new MxReadParams(conf)));
    }
