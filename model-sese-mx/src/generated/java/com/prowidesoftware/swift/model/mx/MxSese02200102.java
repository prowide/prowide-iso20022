    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.022.001.02";
    ...
    public static MxSese02200102 parse(String xml) {
        return ((MxSese02200102) MxReadImpl.parse(MxSese02200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02200102) MxReadImpl.parse(MxSese02200102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02200102 .class);
    }
