    ...
    extends AbstractMX
{
    ...
    public static MxSese00900107 parse(String xml) {
        return ((MxSese00900107) MxReadImpl.parse(MxSese00900107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00900107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00900107) MxReadImpl.parse(MxSese00900107 .class, xml, _classes, new MxReadParams(conf)));
    }
