    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.025.002.02";
    ...
    public static MxSese02500202 parse(String xml) {
        return ((MxSese02500202) MxReadImpl.parse(MxSese02500202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500202) MxReadImpl.parse(MxSese02500202 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02500202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500202 .class);
    }
