    ...
    extends AbstractMX
{
    ...
    public static MxSese03700105 parse(String xml) {
        return ((MxSese03700105) MxReadImpl.parse(MxSese03700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03700105) MxReadImpl.parse(MxSese03700105 .class, xml, _classes, new MxReadParams(conf)));
    }
