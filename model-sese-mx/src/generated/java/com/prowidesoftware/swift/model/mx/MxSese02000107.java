    ...
    extends AbstractMX
{
    ...
    public static MxSese02000107 parse(String xml) {
        return ((MxSese02000107) MxReadImpl.parse(MxSese02000107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02000107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02000107) MxReadImpl.parse(MxSese02000107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02000107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02000107 .class);
    }
