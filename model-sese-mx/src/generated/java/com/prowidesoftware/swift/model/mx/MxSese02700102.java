    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.027.001.02";
    ...
    public static MxSese02700102 parse(String xml) {
        return ((MxSese02700102) MxReadImpl.parse(MxSese02700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02700102) MxReadImpl.parse(MxSese02700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02700102 .class);
    }
