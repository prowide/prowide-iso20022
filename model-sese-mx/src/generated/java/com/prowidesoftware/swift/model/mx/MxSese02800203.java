    ...
    extends AbstractMX
{
    ...
    public static MxSese02800203 parse(String xml) {
        return ((MxSese02800203) MxReadImpl.parse(MxSese02800203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800203) MxReadImpl.parse(MxSese02800203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02800203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02800203 .class);
    }
