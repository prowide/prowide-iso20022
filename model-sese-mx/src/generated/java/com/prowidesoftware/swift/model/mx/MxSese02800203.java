...
/**
 * Class for sese.028.002.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese02800203(final String xml) {
        this();
        MxSese02800203 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02800203(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionAllegementNotification002V03 }
     *     
     */
    public SecuritiesSettlementTransactionAllegementNotification002V03 getSctiesSttlmTxAllgmtNtfctn() {
     ...
     *     
     */
    public MxSese02800203 setSctiesSttlmTxAllgmtNtfctn(SecuritiesSettlementTransactionAllegementNotification002V03 value) {
     ...
     * 
     */
    public static MxSese02800203 parse(String xml) {
        return ((MxSese02800203) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02800203 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02800203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800203) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02800203 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02800203 parse(String xml, MxRead parserImpl) {
        return ((MxSese02800203) parserImpl.read(MxSese02800203 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02800203 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02800203 message
     * @return
     *     a new instance of MxSese02800203
     */
    public final static MxSese02800203 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02800203 .class);
    }
