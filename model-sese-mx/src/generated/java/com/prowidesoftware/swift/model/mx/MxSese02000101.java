    ...
    extends AbstractMX
{
    ...
    public static MxSese02000101 parse(String xml) {
        return ((MxSese02000101) MxReadImpl.parse(MxSese02000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02000101) MxReadImpl.parse(MxSese02000101 .class, xml, _classes, new MxReadParams(conf)));
    }
