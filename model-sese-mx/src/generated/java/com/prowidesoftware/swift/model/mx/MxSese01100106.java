    ...
    extends AbstractMX
{
    ...
    public static MxSese01100106 parse(String xml) {
        return ((MxSese01100106) MxReadImpl.parse(MxSese01100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01100106) MxReadImpl.parse(MxSese01100106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01100106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01100106 .class);
    }
