    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.029.002.03";
    ...
    public static MxSese02900203 parse(String xml) {
        return ((MxSese02900203) MxReadImpl.parse(MxSese02900203 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02900203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02900203 .class);
    }
