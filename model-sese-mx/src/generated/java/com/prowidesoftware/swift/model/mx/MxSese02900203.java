    ...
    extends AbstractMX
{
    ...
    public static MxSese02900203 parse(String xml) {
        return ((MxSese02900203) MxReadImpl.parse(MxSese02900203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02900203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02900203) MxReadImpl.parse(MxSese02900203 .class, xml, _classes, new MxReadParams(conf)));
    }
