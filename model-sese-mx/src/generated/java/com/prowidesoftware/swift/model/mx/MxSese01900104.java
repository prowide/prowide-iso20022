    ...
    extends AbstractMX
{
    ...
    public static MxSese01900104 parse(String xml) {
        return ((MxSese01900104) MxReadImpl.parse(MxSese01900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01900104) MxReadImpl.parse(MxSese01900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01900104 .class);
    }
