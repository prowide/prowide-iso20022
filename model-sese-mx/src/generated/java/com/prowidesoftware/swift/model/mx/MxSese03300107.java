    ...
    extends AbstractMX
{
    ...
    public static MxSese03300107 parse(String xml) {
        return ((MxSese03300107) MxReadImpl.parse(MxSese03300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300107) MxReadImpl.parse(MxSese03300107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03300107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300107 .class);
    }
