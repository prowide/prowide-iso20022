    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.005.001.06";
    ...
    public static MxSese00500106 parse(String xml) {
        return ((MxSese00500106) MxReadImpl.parse(MxSese00500106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00500106) MxReadImpl.parse(MxSese00500106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00500106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00500106 .class);
    }
