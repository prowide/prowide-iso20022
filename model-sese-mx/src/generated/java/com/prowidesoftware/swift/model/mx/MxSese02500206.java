    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.025.002.06";
    ...
    public static MxSese02500206 parse(String xml) {
        return ((MxSese02500206) MxReadImpl.parse(MxSese02500206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500206) MxReadImpl.parse(MxSese02500206 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02500206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500206 .class);
    }
