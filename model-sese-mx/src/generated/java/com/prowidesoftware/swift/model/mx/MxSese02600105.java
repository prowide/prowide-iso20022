    ...
    extends AbstractMX
{
    ...
    public static MxSese02600105 parse(String xml) {
        return ((MxSese02600105) MxReadImpl.parse(MxSese02600105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600105) MxReadImpl.parse(MxSese02600105 .class, xml, _classes, new MxReadParams(conf)));
    }
