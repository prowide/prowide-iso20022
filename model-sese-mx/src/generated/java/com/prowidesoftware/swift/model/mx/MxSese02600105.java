    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.026.001.05";
    ...
    public static MxSese02600105 parse(String xml) {
        return ((MxSese02600105) MxReadImpl.parse(MxSese02600105 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02600105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600105 .class);
    }
