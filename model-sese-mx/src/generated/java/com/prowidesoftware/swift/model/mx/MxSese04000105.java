    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.040.001.05";
    ...
    public static MxSese04000105 parse(String xml) {
        return ((MxSese04000105) MxReadImpl.parse(MxSese04000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese04000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese04000105) MxReadImpl.parse(MxSese04000105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese04000105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese04000105 .class);
    }
