    ...
    extends AbstractMX
{
    ...
    public static MxSese03500110 parse(String xml) {
        return ((MxSese03500110) MxReadImpl.parse(MxSese03500110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500110) MxReadImpl.parse(MxSese03500110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03500110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500110 .class);
    }
