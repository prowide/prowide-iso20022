...
/**
 * Class for sese.035.001.10 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:sese.035.001.10")
public class MxSese03500110
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.035.001.10";
     ...
     * 
     */
    public MxSese03500110(final String xml) {
        this();
        MxSese03500110 tmp = parse(xml);
     ...
     * 
     */
    public MxSese03500110(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesFinancingConfirmationV10 }
     *     
     */
     ...
     *     
     */
    public MxSese03500110 setSctiesFincgConf(SecuritiesFinancingConfirmationV10 value) {
     ...
     * 
     */
    public static MxSese03500110 parse(String xml) {
        return ((MxSese03500110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese03500110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese03500110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese03500110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese03500110 parse(String xml, MxRead parserImpl) {
        return ((MxSese03500110) parserImpl.read(MxSese03500110 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese03500110 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese03500110 message
     * @return
     *     a new instance of MxSese03500110
     */
    public final static MxSese03500110 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese03500110 .class);
    }
