    ...
    extends AbstractMX
{
    ...
    public static MxSese00500101 parse(String xml) {
        return ((MxSese00500101) MxReadImpl.parse(MxSese00500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00500101) MxReadImpl.parse(MxSese00500101 .class, xml, _classes, new MxReadParams(conf)));
    }
