    ...
    extends AbstractMX
{
    ...
    public static MxSese03300106 parse(String xml) {
        return ((MxSese03300106) MxReadImpl.parse(MxSese03300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300106) MxReadImpl.parse(MxSese03300106 .class, xml, _classes, new MxReadParams(conf)));
    }
