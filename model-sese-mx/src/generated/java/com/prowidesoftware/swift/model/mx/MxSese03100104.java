    ...
    extends AbstractMX
{
    ...
    public static MxSese03100104 parse(String xml) {
        return ((MxSese03100104) MxReadImpl.parse(MxSese03100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03100104) MxReadImpl.parse(MxSese03100104 .class, xml, _classes, new MxReadParams(conf)));
    }
