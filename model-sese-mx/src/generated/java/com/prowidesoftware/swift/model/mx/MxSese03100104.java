    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.031.001.04";
    ...
    public static MxSese03100104 parse(String xml) {
        return ((MxSese03100104) MxReadImpl.parse(MxSese03100104 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03100104 .class);
    }
