    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.002.001.04";
    ...
    public static MxSese00200104 parse(String xml) {
        return ((MxSese00200104) MxReadImpl.parse(MxSese00200104 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese00200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00200104 .class);
    }
