    ...
    extends AbstractMX
{
    ...
    public static MxSese00200104 parse(String xml) {
        return ((MxSese00200104) MxReadImpl.parse(MxSese00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00200104) MxReadImpl.parse(MxSese00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
