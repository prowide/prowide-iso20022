    ...
    extends AbstractMX
{
    ...
    public static MxSese03700103 parse(String xml) {
        return ((MxSese03700103) MxReadImpl.parse(MxSese03700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03700103) MxReadImpl.parse(MxSese03700103 .class, xml, _classes, new MxReadParams(conf)));
    }
