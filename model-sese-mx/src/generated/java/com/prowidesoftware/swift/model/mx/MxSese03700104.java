    ...
    extends AbstractMX
{
    ...
    public static MxSese03700104 parse(String xml) {
        return ((MxSese03700104) MxReadImpl.parse(MxSese03700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03700104) MxReadImpl.parse(MxSese03700104 .class, xml, _classes, new MxReadParams(conf)));
    }
