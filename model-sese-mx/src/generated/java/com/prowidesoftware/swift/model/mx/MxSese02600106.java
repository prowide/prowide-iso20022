    ...
    extends AbstractMX
{
    ...
    public static MxSese02600106 parse(String xml) {
        return ((MxSese02600106) MxReadImpl.parse(MxSese02600106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600106) MxReadImpl.parse(MxSese02600106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02600106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600106 .class);
    }
