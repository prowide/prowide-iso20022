    ...
    extends AbstractMX
{
    ...
    public static MxSese02700108 parse(String xml) {
        return ((MxSese02700108) MxReadImpl.parse(MxSese02700108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02700108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02700108) MxReadImpl.parse(MxSese02700108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02700108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02700108 .class);
    }
