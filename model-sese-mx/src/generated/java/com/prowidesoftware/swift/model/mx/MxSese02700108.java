...
/**
 * Class for sese.027.001.08 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese02700108(final String xml) {
        this();
        MxSese02700108 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02700108(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesTransactionCancellationRequestStatusAdviceV08 }
     *     
     */
    public SecuritiesTransactionCancellationRequestStatusAdviceV08 getSctiesTxCxlReqStsAdvc() {
     ...
     *     
     */
    public MxSese02700108 setSctiesTxCxlReqStsAdvc(SecuritiesTransactionCancellationRequestStatusAdviceV08 value) {
     ...
     * 
     */
    public static MxSese02700108 parse(String xml) {
        return ((MxSese02700108) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02700108 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02700108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02700108) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02700108 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02700108 parse(String xml, MxRead parserImpl) {
        return ((MxSese02700108) parserImpl.read(MxSese02700108 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02700108 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02700108 message
     * @return
     *     a new instance of MxSese02700108
     */
    public static final MxSese02700108 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02700108 .class);
    }
