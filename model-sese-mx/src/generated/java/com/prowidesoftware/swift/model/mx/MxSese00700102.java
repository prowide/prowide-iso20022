    ...
    extends AbstractMX
{
    ...
    public static MxSese00700102 parse(String xml) {
        return ((MxSese00700102) MxReadImpl.parse(MxSese00700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00700102) MxReadImpl.parse(MxSese00700102 .class, xml, _classes, new MxReadParams(conf)));
    }
