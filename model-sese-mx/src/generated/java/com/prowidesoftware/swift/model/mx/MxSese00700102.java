    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.007.001.02";
    ...
    public static MxSese00700102 parse(String xml) {
        return ((MxSese00700102) MxReadImpl.parse(MxSese00700102 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese00700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00700102 .class);
    }
