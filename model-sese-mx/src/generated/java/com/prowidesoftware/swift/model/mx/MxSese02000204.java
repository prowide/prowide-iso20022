    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.020.002.04";
    ...
    public static MxSese02000204 parse(String xml) {
        return ((MxSese02000204) MxReadImpl.parse(MxSese02000204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02000204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02000204) MxReadImpl.parse(MxSese02000204 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02000204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02000204 .class);
    }
