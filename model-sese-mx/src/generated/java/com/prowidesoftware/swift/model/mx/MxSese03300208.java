    ...
    extends AbstractMX
{
    ...
    public static MxSese03300208 parse(String xml) {
        return ((MxSese03300208) MxReadImpl.parse(MxSese03300208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300208) MxReadImpl.parse(MxSese03300208 .class, xml, _classes, new MxReadParams(conf)));
    }
