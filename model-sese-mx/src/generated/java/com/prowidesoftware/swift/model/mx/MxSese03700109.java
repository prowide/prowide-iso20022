    ...
    extends AbstractMX
{
    ...
    public static MxSese03700109 parse(String xml) {
        return ((MxSese03700109) MxReadImpl.parse(MxSese03700109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03700109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03700109) MxReadImpl.parse(MxSese03700109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03700109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03700109 .class);
    }
