    ...
    extends AbstractMX
{
    ...
    public static MxSese02500203 parse(String xml) {
        return ((MxSese02500203) MxReadImpl.parse(MxSese02500203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500203) MxReadImpl.parse(MxSese02500203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02500203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500203 .class);
    }
