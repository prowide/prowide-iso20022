    ...
    extends AbstractMX
{
    ...
    public static MxSese03700207 parse(String xml) {
        return ((MxSese03700207) MxReadImpl.parse(MxSese03700207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03700207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03700207) MxReadImpl.parse(MxSese03700207 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03700207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03700207 .class);
    }
