    ...
    extends AbstractMX
{
    ...
    public static MxSese00700105 parse(String xml) {
        return ((MxSese00700105) MxReadImpl.parse(MxSese00700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00700105) MxReadImpl.parse(MxSese00700105 .class, xml, _classes, new MxReadParams(conf)));
    }
