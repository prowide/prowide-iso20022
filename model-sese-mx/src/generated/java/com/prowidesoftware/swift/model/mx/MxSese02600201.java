    ...
    extends AbstractMX
{
    ...
    public static MxSese02600201 parse(String xml) {
        return ((MxSese02600201) MxReadImpl.parse(MxSese02600201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600201) MxReadImpl.parse(MxSese02600201 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02600201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600201 .class);
    }
