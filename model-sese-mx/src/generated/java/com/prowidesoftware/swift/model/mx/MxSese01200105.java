    ...
    extends AbstractMX
{
    ...
    public static MxSese01200105 parse(String xml) {
        return ((MxSese01200105) MxReadImpl.parse(MxSese01200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01200105) MxReadImpl.parse(MxSese01200105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01200105 .class);
    }
