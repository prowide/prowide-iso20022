    ...
    extends AbstractMX
{
    ...
    public static MxSese00500109 parse(String xml) {
        return ((MxSese00500109) MxReadImpl.parse(MxSese00500109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00500109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00500109) MxReadImpl.parse(MxSese00500109 .class, xml, _classes, new MxReadParams(conf)));
    }
