    ...
    extends AbstractMX
{
    ...
    public static MxSese01200102 parse(String xml) {
        return ((MxSese01200102) MxReadImpl.parse(MxSese01200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01200102) MxReadImpl.parse(MxSese01200102 .class, xml, _classes, new MxReadParams(conf)));
    }
