    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.012.001.02";
    ...
    public static MxSese01200102 parse(String xml) {
        return ((MxSese01200102) MxReadImpl.parse(MxSese01200102 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese01200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01200102 .class);
    }
