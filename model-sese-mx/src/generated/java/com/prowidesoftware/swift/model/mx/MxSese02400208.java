    ...
    extends AbstractMX
{
    ...
    public static MxSese02400208 parse(String xml) {
        return ((MxSese02400208) MxReadImpl.parse(MxSese02400208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400208) MxReadImpl.parse(MxSese02400208 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02400208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400208 .class);
    }
