...
/**
 * Class for sese.024.002.08 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese02400208(final String xml) {
        this();
        MxSese02400208 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02400208(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionStatusAdvice002V08 }
     *     
     */
    public SecuritiesSettlementTransactionStatusAdvice002V08 getSctiesSttlmTxStsAdvc() {
     ...
     *     
     */
    public MxSese02400208 setSctiesSttlmTxStsAdvc(SecuritiesSettlementTransactionStatusAdvice002V08 value) {
     ...
     * 
     */
    public static MxSese02400208 parse(String xml) {
        return ((MxSese02400208) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02400208 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02400208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400208) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02400208 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02400208 parse(String xml, MxRead parserImpl) {
        return ((MxSese02400208) parserImpl.read(MxSese02400208 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02400208 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02400208 message
     * @return
     *     a new instance of MxSese02400208
     */
    public static final MxSese02400208 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02400208 .class);
    }
