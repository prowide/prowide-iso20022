    ...
    extends AbstractMX
{
    ...
    public static MxSese00400101 parse(String xml) {
        return ((MxSese00400101) MxReadImpl.parse(MxSese00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00400101) MxReadImpl.parse(MxSese00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
