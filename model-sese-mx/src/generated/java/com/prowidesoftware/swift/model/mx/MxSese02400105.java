    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.024.001.05";
    ...
    public static MxSese02400105 parse(String xml) {
        return ((MxSese02400105) MxReadImpl.parse(MxSese02400105 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400105 .class);
    }
