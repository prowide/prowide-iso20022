    ...
    extends AbstractMX
{
    ...
    public static MxSese02400105 parse(String xml) {
        return ((MxSese02400105) MxReadImpl.parse(MxSese02400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400105) MxReadImpl.parse(MxSese02400105 .class, xml, _classes, new MxReadParams(conf)));
    }
