    ...
    extends AbstractMX
{
    ...
    public static MxSese03400104 parse(String xml) {
        return ((MxSese03400104) MxReadImpl.parse(MxSese03400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400104) MxReadImpl.parse(MxSese03400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03400104 .class);
    }
