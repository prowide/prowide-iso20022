    ...
    extends AbstractMX
{
    ...
    public static MxSese02100104 parse(String xml) {
        return ((MxSese02100104) MxReadImpl.parse(MxSese02100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02100104) MxReadImpl.parse(MxSese02100104 .class, xml, _classes, new MxReadParams(conf)));
    }
