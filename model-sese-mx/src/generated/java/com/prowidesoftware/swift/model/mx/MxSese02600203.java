    ...
    extends AbstractMX
{
    ...
    public static MxSese02600203 parse(String xml) {
        return ((MxSese02600203) MxReadImpl.parse(MxSese02600203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600203) MxReadImpl.parse(MxSese02600203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02600203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600203 .class);
    }
