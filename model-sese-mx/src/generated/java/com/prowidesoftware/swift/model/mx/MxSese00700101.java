    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.007.001.01";
    ...
    public static MxSese00700101 parse(String xml) {
        return ((MxSese00700101) MxReadImpl.parse(MxSese00700101 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese00700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00700101 .class);
    }
