    ...
    extends AbstractMX
{
    ...
    public static MxSese00700101 parse(String xml) {
        return ((MxSese00700101) MxReadImpl.parse(MxSese00700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00700101) MxReadImpl.parse(MxSese00700101 .class, xml, _classes, new MxReadParams(conf)));
    }
