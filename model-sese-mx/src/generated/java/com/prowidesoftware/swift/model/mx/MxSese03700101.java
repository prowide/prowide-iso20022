    ...
    extends AbstractMX
{
    ...
    public static MxSese03700101 parse(String xml) {
        return ((MxSese03700101) MxReadImpl.parse(MxSese03700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03700101) MxReadImpl.parse(MxSese03700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03700101 .class);
    }
