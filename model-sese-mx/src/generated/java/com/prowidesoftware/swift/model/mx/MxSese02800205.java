    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.028.002.05";
    ...
    public static MxSese02800205 parse(String xml) {
        return ((MxSese02800205) MxReadImpl.parse(MxSese02800205 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02800205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02800205 .class);
    }
