    ...
    extends AbstractMX
{
    ...
    public static MxSese02800205 parse(String xml) {
        return ((MxSese02800205) MxReadImpl.parse(MxSese02800205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800205) MxReadImpl.parse(MxSese02800205 .class, xml, _classes, new MxReadParams(conf)));
    }
