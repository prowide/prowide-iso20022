    ...
    extends AbstractMX
{
    ...
    public static MxSese03300103 parse(String xml) {
        return ((MxSese03300103) MxReadImpl.parse(MxSese03300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300103) MxReadImpl.parse(MxSese03300103 .class, xml, _classes, new MxReadParams(conf)));
    }
