    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.033.001.03";
    ...
    public static MxSese03300103 parse(String xml) {
        return ((MxSese03300103) MxReadImpl.parse(MxSese03300103 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300103 .class);
    }
