    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.014.001.07";
    ...
    public static MxSese01400107 parse(String xml) {
        return ((MxSese01400107) MxReadImpl.parse(MxSese01400107 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese01400107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01400107 .class);
    }
