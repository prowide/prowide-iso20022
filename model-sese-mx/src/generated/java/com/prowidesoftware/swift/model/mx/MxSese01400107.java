    ...
    extends AbstractMX
{
    ...
    public static MxSese01400107 parse(String xml) {
        return ((MxSese01400107) MxReadImpl.parse(MxSese01400107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01400107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01400107) MxReadImpl.parse(MxSese01400107 .class, xml, _classes, new MxReadParams(conf)));
    }
