    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.022.002.06";
    ...
    public static MxSese02200206 parse(String xml) {
        return ((MxSese02200206) MxReadImpl.parse(MxSese02200206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02200206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02200206) MxReadImpl.parse(MxSese02200206 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02200206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02200206 .class);
    }
