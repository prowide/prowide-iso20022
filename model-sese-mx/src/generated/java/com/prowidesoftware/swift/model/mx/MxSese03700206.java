...
/**
 * Class for sese.037.002.06 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxSese03700206(final String xml) {
        this();
        MxSese03700206 tmp = parse(xml);
     ...
     * 
     */
    public MxSese03700206(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link PortfolioTransferNotification002V06 }
     *     
     */
    public PortfolioTransferNotification002V06 getPrtflTrfNtfctn() {
     ...
     *     
     */
    public MxSese03700206 setPrtflTrfNtfctn(PortfolioTransferNotification002V06 value) {
    ...
    public static MxSese03700206 parse(String xml) {
        return ((MxSese03700206) MxReadImpl.parse(MxSese03700206 .class, xml, _classes));
    }
     ...
     */
    public static MxSese03700206 parse(String xml, MxRead parserImpl) {
        return ((MxSese03700206) parserImpl.read(MxSese03700206 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese03700206 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese03700206 message
     * @return
