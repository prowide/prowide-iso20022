    ...
    extends AbstractMX
{
    ...
    public static MxSese03200204 parse(String xml) {
        return ((MxSese03200204) MxReadImpl.parse(MxSese03200204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200204) MxReadImpl.parse(MxSese03200204 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03200204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200204 .class);
    }
