...
/**
 * Class for sese.034.000.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese03400001(final String xml) {
        this();
        MxSese03400001 tmp = parse(xml);
     ...
     * 
     */
    public MxSese03400001(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesFinancingStatusAdviceV1 }
     *     
     */
    public SecuritiesFinancingStatusAdviceV1 getSctiesFincgStsAdvc() {
     ...
     *     
     */
    public MxSese03400001 setSctiesFincgStsAdvc(SecuritiesFinancingStatusAdviceV1 value) {
     ...
     * 
     */
    public static MxSese03400001 parse(String xml) {
        return ((MxSese03400001) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese03400001 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese03400001 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400001) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese03400001 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese03400001 parse(String xml, MxRead parserImpl) {
        return ((MxSese03400001) parserImpl.read(MxSese03400001 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese03400001 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese03400001 message
     * @return
     *     a new instance of MxSese03400001
     */
    public final static MxSese03400001 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese03400001 .class);
    }
