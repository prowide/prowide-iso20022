    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.001.001.09";
    ...
    public static MxSese00100109 parse(String xml) {
        return ((MxSese00100109) MxReadImpl.parse(MxSese00100109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00100109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00100109) MxReadImpl.parse(MxSese00100109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00100109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00100109 .class);
    }
