    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.028.002.02";
    ...
    public static MxSese02800202 parse(String xml) {
        return ((MxSese02800202) MxReadImpl.parse(MxSese02800202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02800202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02800202) MxReadImpl.parse(MxSese02800202 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02800202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02800202 .class);
    }
