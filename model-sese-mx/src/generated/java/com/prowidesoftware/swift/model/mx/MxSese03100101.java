    ...
    extends AbstractMX
{
    ...
    public static MxSese03100101 parse(String xml) {
        return ((MxSese03100101) MxReadImpl.parse(MxSese03100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03100101) MxReadImpl.parse(MxSese03100101 .class, xml, _classes, new MxReadParams(conf)));
    }
