    ...
    extends AbstractMX
{
    ...
    public static MxSese02100103 parse(String xml) {
        return ((MxSese02100103) MxReadImpl.parse(MxSese02100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02100103) MxReadImpl.parse(MxSese02100103 .class, xml, _classes, new MxReadParams(conf)));
    }
