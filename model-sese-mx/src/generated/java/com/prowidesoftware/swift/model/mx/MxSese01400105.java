    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.014.001.05";
    ...
    public static MxSese01400105 parse(String xml) {
        return ((MxSese01400105) MxReadImpl.parse(MxSese01400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01400105) MxReadImpl.parse(MxSese01400105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01400105 .class);
    }
