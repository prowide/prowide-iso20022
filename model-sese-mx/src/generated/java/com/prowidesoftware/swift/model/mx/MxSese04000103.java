    ...
    extends AbstractMX
{
    ...
    public static MxSese04000103 parse(String xml) {
        return ((MxSese04000103) MxReadImpl.parse(MxSese04000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese04000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese04000103) MxReadImpl.parse(MxSese04000103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese04000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese04000103 .class);
    }
