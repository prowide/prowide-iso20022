    ...
    extends AbstractMX
{
    ...
    public static MxSese00100104 parse(String xml) {
        return ((MxSese00100104) MxReadImpl.parse(MxSese00100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00100104) MxReadImpl.parse(MxSese00100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00100104 .class);
    }
