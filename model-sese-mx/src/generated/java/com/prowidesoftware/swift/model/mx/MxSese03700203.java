    ...
    extends AbstractMX
{
    ...
    public static MxSese03700203 parse(String xml) {
        return ((MxSese03700203) MxReadImpl.parse(MxSese03700203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03700203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03700203) MxReadImpl.parse(MxSese03700203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03700203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03700203 .class);
    }
