    ...
    extends AbstractMX
{
    ...
    public static MxSese00400108 parse(String xml) {
        return ((MxSese00400108) MxReadImpl.parse(MxSese00400108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00400108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00400108) MxReadImpl.parse(MxSese00400108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00400108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00400108 .class);
    }
