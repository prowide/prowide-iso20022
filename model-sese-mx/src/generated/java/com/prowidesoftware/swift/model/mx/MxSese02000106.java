    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.020.001.06";
    ...
    public static MxSese02000106 parse(String xml) {
        return ((MxSese02000106) MxReadImpl.parse(MxSese02000106 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02000106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02000106 .class);
    }
