    ...
    extends AbstractMX
{
    ...
    public static MxSese02000106 parse(String xml) {
        return ((MxSese02000106) MxReadImpl.parse(MxSese02000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02000106) MxReadImpl.parse(MxSese02000106 .class, xml, _classes, new MxReadParams(conf)));
    }
