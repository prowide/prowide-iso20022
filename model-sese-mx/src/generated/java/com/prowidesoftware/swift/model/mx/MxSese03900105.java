    ...
    extends AbstractMX
{
    ...
    public static MxSese03900105 parse(String xml) {
        return ((MxSese03900105) MxReadImpl.parse(MxSese03900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03900105) MxReadImpl.parse(MxSese03900105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03900105 .class);
    }
