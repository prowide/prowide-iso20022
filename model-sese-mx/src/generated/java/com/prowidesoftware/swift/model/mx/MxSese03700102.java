    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.037.001.02";
    ...
    public static MxSese03700102 parse(String xml) {
        return ((MxSese03700102) MxReadImpl.parse(MxSese03700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03700102) MxReadImpl.parse(MxSese03700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03700102 .class);
    }
