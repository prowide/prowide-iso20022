    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.024.002.01";
    ...
    public static MxSese02400201 parse(String xml) {
        return ((MxSese02400201) MxReadImpl.parse(MxSese02400201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400201) MxReadImpl.parse(MxSese02400201 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02400201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400201 .class);
    }
