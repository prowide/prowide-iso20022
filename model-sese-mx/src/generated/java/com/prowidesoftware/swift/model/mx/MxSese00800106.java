    ...
    extends AbstractMX
{
    ...
    public static MxSese00800106 parse(String xml) {
        return ((MxSese00800106) MxReadImpl.parse(MxSese00800106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00800106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00800106) MxReadImpl.parse(MxSese00800106 .class, xml, _classes, new MxReadParams(conf)));
    }
