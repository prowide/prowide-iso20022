    ...
    extends AbstractMX
{
    ...
    public static MxSese01100101 parse(String xml) {
        return ((MxSese01100101) MxReadImpl.parse(MxSese01100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01100101) MxReadImpl.parse(MxSese01100101 .class, xml, _classes, new MxReadParams(conf)));
    }
