    ...
    extends AbstractMX
{
    ...
    public static MxSese00700108 parse(String xml) {
        return ((MxSese00700108) MxReadImpl.parse(MxSese00700108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00700108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00700108) MxReadImpl.parse(MxSese00700108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00700108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00700108 .class);
    }
