    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.039.002.03";
    ...
    public static MxSese03900203 parse(String xml) {
        return ((MxSese03900203) MxReadImpl.parse(MxSese03900203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03900203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03900203) MxReadImpl.parse(MxSese03900203 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03900203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03900203 .class);
    }
