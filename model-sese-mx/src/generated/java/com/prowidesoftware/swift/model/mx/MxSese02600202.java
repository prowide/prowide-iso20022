    ...
    extends AbstractMX
{
    ...
    public static MxSese02600202 parse(String xml) {
        return ((MxSese02600202) MxReadImpl.parse(MxSese02600202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600202) MxReadImpl.parse(MxSese02600202 .class, xml, _classes, new MxReadParams(conf)));
    }
