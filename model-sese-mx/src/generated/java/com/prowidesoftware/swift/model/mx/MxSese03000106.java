    ...
    extends AbstractMX
{
    ...
    public static MxSese03000106 parse(String xml) {
        return ((MxSese03000106) MxReadImpl.parse(MxSese03000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03000106) MxReadImpl.parse(MxSese03000106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03000106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03000106 .class);
    }
