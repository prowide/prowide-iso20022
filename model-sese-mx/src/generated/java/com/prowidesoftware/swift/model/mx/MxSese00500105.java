    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.005.001.05";
    ...
    public static MxSese00500105 parse(String xml) {
        return ((MxSese00500105) MxReadImpl.parse(MxSese00500105 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese00500105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00500105 .class);
    }
