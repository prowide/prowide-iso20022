    ...
    extends AbstractMX
{
    ...
    public static MxSese00500105 parse(String xml) {
        return ((MxSese00500105) MxReadImpl.parse(MxSese00500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00500105) MxReadImpl.parse(MxSese00500105 .class, xml, _classes, new MxReadParams(conf)));
    }
