    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.019.001.07";
    ...
    public static MxSese01900107 parse(String xml) {
        return ((MxSese01900107) MxReadImpl.parse(MxSese01900107 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese01900107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01900107 .class);
    }
