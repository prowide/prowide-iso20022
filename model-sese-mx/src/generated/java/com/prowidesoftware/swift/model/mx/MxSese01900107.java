    ...
    extends AbstractMX
{
    ...
    public static MxSese01900107 parse(String xml) {
        return ((MxSese01900107) MxReadImpl.parse(MxSese01900107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01900107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01900107) MxReadImpl.parse(MxSese01900107 .class, xml, _classes, new MxReadParams(conf)));
    }
