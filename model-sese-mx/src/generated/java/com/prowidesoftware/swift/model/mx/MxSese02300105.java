    ...
    extends AbstractMX
{
    ...
    public static MxSese02300105 parse(String xml) {
        return ((MxSese02300105) MxReadImpl.parse(MxSese02300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300105) MxReadImpl.parse(MxSese02300105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02300105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300105 .class);
    }
