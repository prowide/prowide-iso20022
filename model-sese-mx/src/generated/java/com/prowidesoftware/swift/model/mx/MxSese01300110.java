    ...
    extends AbstractMX
{
    ...
    public static MxSese01300110 parse(String xml) {
        return ((MxSese01300110) MxReadImpl.parse(MxSese01300110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01300110 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01300110) MxReadImpl.parse(MxSese01300110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01300110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01300110 .class);
    }
