    ...
    extends AbstractMX
{
    ...
    public static MxSese01900105 parse(String xml) {
        return ((MxSese01900105) MxReadImpl.parse(MxSese01900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01900105) MxReadImpl.parse(MxSese01900105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01900105 .class);
    }
