    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.036.002.05";
    ...
    public static MxSese03600205 parse(String xml) {
        return ((MxSese03600205) MxReadImpl.parse(MxSese03600205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03600205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03600205) MxReadImpl.parse(MxSese03600205 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03600205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03600205 .class);
    }
