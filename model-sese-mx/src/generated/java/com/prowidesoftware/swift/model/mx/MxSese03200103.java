    ...
    extends AbstractMX
{
    ...
    public static MxSese03200103 parse(String xml) {
        return ((MxSese03200103) MxReadImpl.parse(MxSese03200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200103) MxReadImpl.parse(MxSese03200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200103 .class);
    }
