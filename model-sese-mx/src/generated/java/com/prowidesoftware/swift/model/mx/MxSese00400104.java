    ...
    extends AbstractMX
{
    ...
    public static MxSese00400104 parse(String xml) {
        return ((MxSese00400104) MxReadImpl.parse(MxSese00400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00400104) MxReadImpl.parse(MxSese00400104 .class, xml, _classes, new MxReadParams(conf)));
    }
