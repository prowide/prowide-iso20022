...
/**
 * Class for sese.007.001.07 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:swift:xsd:sese.007.001.07")
public class MxSese00700107
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.007.001.07";
     ...
     * 
     */
    public MxSese00700107(final String xml) {
        this();
        MxSese00700107 tmp = parse(xml);
     ...
     * 
     */
    public MxSese00700107(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link TransferInConfirmationV07 }
     *     
     */
     ...
     *     
     */
    public MxSese00700107 setTrfInConf(TransferInConfirmationV07 value) {
     ...
     * 
     */
    public static MxSese00700107 parse(String xml) {
        return ((MxSese00700107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese00700107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese00700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00700107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese00700107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese00700107 parse(String xml, MxRead parserImpl) {
        return ((MxSese00700107) parserImpl.read(MxSese00700107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese00700107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese00700107 message
     * @return
     *     a new instance of MxSese00700107
     */
    public final static MxSese00700107 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese00700107 .class);
    }
