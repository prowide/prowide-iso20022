    ...
    extends AbstractMX
{
    ...
    public static MxSese00700107 parse(String xml) {
        return ((MxSese00700107) MxReadImpl.parse(MxSese00700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00700107) MxReadImpl.parse(MxSese00700107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00700107 .class);
    }
