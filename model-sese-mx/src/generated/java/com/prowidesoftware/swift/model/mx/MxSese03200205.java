    ...
    extends AbstractMX
{
    ...
    public static MxSese03200205 parse(String xml) {
        return ((MxSese03200205) MxReadImpl.parse(MxSese03200205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200205) MxReadImpl.parse(MxSese03200205 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03200205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200205 .class);
    }
