    ...
    extends AbstractMX
{
    ...
    public static MxSese03000201 parse(String xml) {
        return ((MxSese03000201) MxReadImpl.parse(MxSese03000201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03000201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03000201) MxReadImpl.parse(MxSese03000201 .class, xml, _classes, new MxReadParams(conf)));
    }
