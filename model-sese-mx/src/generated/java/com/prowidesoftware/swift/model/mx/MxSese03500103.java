    ...
    extends AbstractMX
{
    ...
    public static MxSese03500103 parse(String xml) {
        return ((MxSese03500103) MxReadImpl.parse(MxSese03500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500103) MxReadImpl.parse(MxSese03500103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500103 .class);
    }
