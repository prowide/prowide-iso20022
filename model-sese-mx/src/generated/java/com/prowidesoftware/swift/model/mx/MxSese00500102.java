    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.005.001.02";
    ...
    public static MxSese00500102 parse(String xml) {
        return ((MxSese00500102) MxReadImpl.parse(MxSese00500102 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese00500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00500102 .class);
    }
