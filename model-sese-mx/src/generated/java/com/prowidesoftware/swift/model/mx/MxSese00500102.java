    ...
    extends AbstractMX
{
    ...
    public static MxSese00500102 parse(String xml) {
        return ((MxSese00500102) MxReadImpl.parse(MxSese00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00500102) MxReadImpl.parse(MxSese00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
