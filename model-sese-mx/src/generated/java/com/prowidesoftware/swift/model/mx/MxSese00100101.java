    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.001.001.01";
    ...
    public static MxSese00100101 parse(String xml) {
        return ((MxSese00100101) MxReadImpl.parse(MxSese00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00100101) MxReadImpl.parse(MxSese00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00100101 .class);
    }
