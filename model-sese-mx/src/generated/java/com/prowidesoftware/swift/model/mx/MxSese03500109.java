    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.035.001.09";
    ...
    public static MxSese03500109 parse(String xml) {
        return ((MxSese03500109) MxReadImpl.parse(MxSese03500109 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03500109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500109 .class);
    }
