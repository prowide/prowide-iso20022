    ...
    extends AbstractMX
{
    ...
    public static MxSese03500109 parse(String xml) {
        return ((MxSese03500109) MxReadImpl.parse(MxSese03500109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500109) MxReadImpl.parse(MxSese03500109 .class, xml, _classes, new MxReadParams(conf)));
    }
