    ...
    extends AbstractMX
{
    ...
    public static MxSese00900105 parse(String xml) {
        return ((MxSese00900105) MxReadImpl.parse(MxSese00900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00900105) MxReadImpl.parse(MxSese00900105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00900105 .class);
    }
