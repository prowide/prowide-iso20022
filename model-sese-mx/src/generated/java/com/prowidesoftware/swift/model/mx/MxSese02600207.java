    ...
    extends AbstractMX
{
    ...
    public static MxSese02600207 parse(String xml) {
        return ((MxSese02600207) MxReadImpl.parse(MxSese02600207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600207) MxReadImpl.parse(MxSese02600207 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02600207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600207 .class);
    }
