    ...
    extends AbstractMX
{
    ...
    public static MxSese01400103 parse(String xml) {
        return ((MxSese01400103) MxReadImpl.parse(MxSese01400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01400103) MxReadImpl.parse(MxSese01400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01400103 .class);
    }
