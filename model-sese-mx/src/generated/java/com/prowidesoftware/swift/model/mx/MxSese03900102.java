    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.039.001.02";
    ...
    public static MxSese03900102 parse(String xml) {
        return ((MxSese03900102) MxReadImpl.parse(MxSese03900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03900102) MxReadImpl.parse(MxSese03900102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03900102 .class);
    }
