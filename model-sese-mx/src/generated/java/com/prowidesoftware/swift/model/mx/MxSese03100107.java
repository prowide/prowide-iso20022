    ...
    extends AbstractMX
{
    ...
    public static MxSese03100107 parse(String xml) {
        return ((MxSese03100107) MxReadImpl.parse(MxSese03100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03100107) MxReadImpl.parse(MxSese03100107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03100107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03100107 .class);
    }
