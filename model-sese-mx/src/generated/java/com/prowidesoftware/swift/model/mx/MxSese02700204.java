    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.027.002.04";
    ...
    public static MxSese02700204 parse(String xml) {
        return ((MxSese02700204) MxReadImpl.parse(MxSese02700204 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02700204 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02700204) MxReadImpl.parse(MxSese02700204 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02700204 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02700204 .class);
    }
