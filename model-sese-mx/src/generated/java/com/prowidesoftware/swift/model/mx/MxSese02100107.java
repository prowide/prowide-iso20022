    ...
    extends AbstractMX
{
    ...
    public static MxSese02100107 parse(String xml) {
        return ((MxSese02100107) MxReadImpl.parse(MxSese02100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02100107) MxReadImpl.parse(MxSese02100107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02100107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02100107 .class);
    }
