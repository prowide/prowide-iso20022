    ...
    extends AbstractMX
{
    ...
    public static MxSese01000102 parse(String xml) {
        return ((MxSese01000102) MxReadImpl.parse(MxSese01000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01000102) MxReadImpl.parse(MxSese01000102 .class, xml, _classes, new MxReadParams(conf)));
    }
