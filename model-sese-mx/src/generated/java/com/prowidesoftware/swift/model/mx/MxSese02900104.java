    ...
    extends AbstractMX
{
    ...
    public static MxSese02900104 parse(String xml) {
        return ((MxSese02900104) MxReadImpl.parse(MxSese02900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02900104) MxReadImpl.parse(MxSese02900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02900104 .class);
    }
