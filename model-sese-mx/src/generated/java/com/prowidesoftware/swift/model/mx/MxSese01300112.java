    ...
    extends AbstractMX
{
    ...
    public static MxSese01300112 parse(String xml) {
        return ((MxSese01300112) MxReadImpl.parse(MxSese01300112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01300112 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01300112) MxReadImpl.parse(MxSese01300112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01300112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01300112 .class);
    }
