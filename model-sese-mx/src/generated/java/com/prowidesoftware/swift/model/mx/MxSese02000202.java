    ...
    extends AbstractMX
{
    ...
    public static MxSese02000202 parse(String xml) {
        return ((MxSese02000202) MxReadImpl.parse(MxSese02000202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02000202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02000202) MxReadImpl.parse(MxSese02000202 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02000202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02000202 .class);
    }
