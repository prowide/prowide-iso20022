    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.020.002.02";
    ...
    public static MxSese02000202 parse(String xml) {
        return ((MxSese02000202) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02000202 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02000202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02000202) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02000202 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02000202 fromJson(String json) {
