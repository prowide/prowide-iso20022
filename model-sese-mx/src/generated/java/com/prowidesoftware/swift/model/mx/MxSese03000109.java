    ...
    extends AbstractMX
{
    ...
    public static MxSese03000109 parse(String xml) {
        return ((MxSese03000109) MxReadImpl.parse(MxSese03000109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03000109 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03000109) MxReadImpl.parse(MxSese03000109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03000109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03000109 .class);
    }
