    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.003.001.05";
    ...
    public static MxSese00300105 parse(String xml) {
        return ((MxSese00300105) MxReadImpl.parse(MxSese00300105 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese00300105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00300105 .class);
    }
