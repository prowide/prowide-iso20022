    ...
    extends AbstractMX
{
    ...
    public static MxSese00300105 parse(String xml) {
        return ((MxSese00300105) MxReadImpl.parse(MxSese00300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00300105) MxReadImpl.parse(MxSese00300105 .class, xml, _classes, new MxReadParams(conf)));
    }
