    ...
    extends AbstractMX
{
    ...
    public static MxSese02300102 parse(String xml) {
        return ((MxSese02300102) MxReadImpl.parse(MxSese02300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300102) MxReadImpl.parse(MxSese02300102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300102 .class);
    }
