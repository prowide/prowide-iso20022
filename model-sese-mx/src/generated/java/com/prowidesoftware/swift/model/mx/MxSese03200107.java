    ...
    extends AbstractMX
{
    ...
    public static MxSese03200107 parse(String xml) {
        return ((MxSese03200107) MxReadImpl.parse(MxSese03200107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03200107) MxReadImpl.parse(MxSese03200107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03200107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03200107 .class);
    }
