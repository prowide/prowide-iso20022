    ...
    extends AbstractMX
{
    ...
    public static MxSese03300210 parse(String xml) {
        return ((MxSese03300210) MxReadImpl.parse(MxSese03300210 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03300210 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03300210) MxReadImpl.parse(MxSese03300210 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03300210 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03300210 .class);
    }
