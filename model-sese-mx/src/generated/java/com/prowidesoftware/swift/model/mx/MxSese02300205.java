    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.023.002.05";
    ...
    public static MxSese02300205 parse(String xml) {
        return ((MxSese02300205) MxReadImpl.parse(MxSese02300205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02300205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02300205) MxReadImpl.parse(MxSese02300205 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02300205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02300205 .class);
    }
