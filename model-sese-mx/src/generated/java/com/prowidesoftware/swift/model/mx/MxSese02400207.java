    ...
    extends AbstractMX
{
    ...
    public static MxSese02400207 parse(String xml) {
        return ((MxSese02400207) MxReadImpl.parse(MxSese02400207 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400207 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400207) MxReadImpl.parse(MxSese02400207 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02400207 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400207 .class);
    }
