    ...
    extends AbstractMX
{
    ...
    public static MxSese02100202 parse(String xml) {
        return ((MxSese02100202) MxReadImpl.parse(MxSese02100202 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02100202 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02100202) MxReadImpl.parse(MxSese02100202 .class, xml, _classes, new MxReadParams(conf)));
    }
