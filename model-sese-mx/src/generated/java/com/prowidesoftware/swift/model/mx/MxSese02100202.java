    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:swift:xsd:sese.021.002.02";
    ...
    public static MxSese02100202 parse(String xml) {
        return ((MxSese02100202) MxReadImpl.parse(MxSese02100202 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02100202 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02100202 .class);
    }
