    ...
    extends AbstractMX
{
    ...
    public static MxSese01800104 parse(String xml) {
        return ((MxSese01800104) MxReadImpl.parse(MxSese01800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01800104) MxReadImpl.parse(MxSese01800104 .class, xml, _classes, new MxReadParams(conf)));
    }
