    ...
    extends AbstractMX
{
    ...
    public static MxSese03500203 parse(String xml) {
        return ((MxSese03500203) MxReadImpl.parse(MxSese03500203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03500203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03500203) MxReadImpl.parse(MxSese03500203 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03500203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03500203 .class);
    }
