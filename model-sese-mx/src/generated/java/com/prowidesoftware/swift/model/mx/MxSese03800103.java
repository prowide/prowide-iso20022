    ...
    extends AbstractMX
{
    ...
    public static MxSese03800103 parse(String xml) {
        return ((MxSese03800103) MxReadImpl.parse(MxSese03800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03800103) MxReadImpl.parse(MxSese03800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese03800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03800103 .class);
    }
