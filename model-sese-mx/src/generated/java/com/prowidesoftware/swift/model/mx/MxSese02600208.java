...
/**
 * Class for sese.026.002.08 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:sese.026.002.08")
public class MxSese02600208
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.026.002.08";
     ...
     * 
     */
    public MxSese02600208(final String xml) {
        this();
        MxSese02600208 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02600208(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionReversalAdvice002V08 }
     *     
     */
     ...
     *     
     */
    public MxSese02600208 setSctiesSttlmTxRvslAdvc(SecuritiesSettlementTransactionReversalAdvice002V08 value) {
     ...
     * 
     */
    public static MxSese02600208 parse(String xml) {
        return ((MxSese02600208) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02600208 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02600208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600208) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02600208 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02600208 parse(String xml, MxRead parserImpl) {
        return ((MxSese02600208) parserImpl.read(MxSese02600208 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02600208 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02600208 message
     * @return
     *     a new instance of MxSese02600208
     */
    public final static MxSese02600208 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02600208 .class);
    }
