    ...
    extends AbstractMX
{
    ...
    public static MxSese02600208 parse(String xml) {
        return ((MxSese02600208) MxReadImpl.parse(MxSese02600208 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02600208 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02600208) MxReadImpl.parse(MxSese02600208 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02600208 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02600208 .class);
    }
