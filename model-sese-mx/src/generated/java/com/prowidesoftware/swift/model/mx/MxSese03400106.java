    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.034.001.06";
    ...
    public static MxSese03400106 parse(String xml) {
        return ((MxSese03400106) MxReadImpl.parse(MxSese03400106 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese03400106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03400106 .class);
    }
