    ...
    extends AbstractMX
{
    ...
    public static MxSese03400106 parse(String xml) {
        return ((MxSese03400106) MxReadImpl.parse(MxSese03400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03400106) MxReadImpl.parse(MxSese03400106 .class, xml, _classes, new MxReadParams(conf)));
    }
