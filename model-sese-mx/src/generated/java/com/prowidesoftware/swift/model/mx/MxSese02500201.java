    ...
    extends AbstractMX
{
    ...
    public static MxSese02500201 parse(String xml) {
        return ((MxSese02500201) MxReadImpl.parse(MxSese02500201 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500201 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500201) MxReadImpl.parse(MxSese02500201 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02500201 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500201 .class);
    }
