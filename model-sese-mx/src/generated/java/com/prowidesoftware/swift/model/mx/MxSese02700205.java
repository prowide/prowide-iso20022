    ...
    extends AbstractMX
{
    ...
    public static MxSese02700205 parse(String xml) {
        return ((MxSese02700205) MxReadImpl.parse(MxSese02700205 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02700205 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02700205) MxReadImpl.parse(MxSese02700205 .class, xml, _classes, new MxReadParams(conf)));
    }
