    ...
    extends AbstractMX
{
    ...
    public final static transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.027.002.05";
    ...
    public static MxSese02700205 parse(String xml) {
        return ((MxSese02700205) MxReadImpl.parse(MxSese02700205 .class, xml, _classes));
    }
     ...
     */
    public final static MxSese02700205 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02700205 .class);
    }
