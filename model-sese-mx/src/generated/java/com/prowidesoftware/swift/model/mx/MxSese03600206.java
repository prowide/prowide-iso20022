    ...
    extends AbstractMX
{
    ...
    public static MxSese03600206 parse(String xml) {
        return ((MxSese03600206) MxReadImpl.parse(MxSese03600206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03600206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03600206) MxReadImpl.parse(MxSese03600206 .class, xml, _classes, new MxReadParams(conf)));
    }
