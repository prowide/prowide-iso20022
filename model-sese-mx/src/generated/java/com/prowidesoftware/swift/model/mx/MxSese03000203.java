    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.030.002.03";
    ...
    public static MxSese03000203 parse(String xml) {
        return ((MxSese03000203) MxReadImpl.parse(MxSese03000203 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese03000203 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese03000203) MxReadImpl.parse(MxSese03000203 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese03000203 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese03000203 .class);
    }
