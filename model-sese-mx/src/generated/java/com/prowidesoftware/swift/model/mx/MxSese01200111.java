    ...
    extends AbstractMX
{
    ...
    public static MxSese01200111 parse(String xml) {
        return ((MxSese01200111) MxReadImpl.parse(MxSese01200111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01200111 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01200111) MxReadImpl.parse(MxSese01200111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01200111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01200111 .class);
    }
