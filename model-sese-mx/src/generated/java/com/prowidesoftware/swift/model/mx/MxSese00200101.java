    ...
    extends AbstractMX
{
    ...
    public static MxSese00200101 parse(String xml) {
        return ((MxSese00200101) MxReadImpl.parse(MxSese00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese00200101) MxReadImpl.parse(MxSese00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese00200101 .class);
    }
