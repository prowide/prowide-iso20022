    ...
    extends AbstractMX
{
    ...
    public static MxSese02500101 parse(String xml) {
        return ((MxSese02500101) MxReadImpl.parse(MxSese02500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02500101) MxReadImpl.parse(MxSese02500101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese02500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02500101 .class);
    }
