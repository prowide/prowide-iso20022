    ...
    extends AbstractMX
{
    ...
    public static MxSese01000101 parse(String xml) {
        return ((MxSese01000101) MxReadImpl.parse(MxSese01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01000101) MxReadImpl.parse(MxSese01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxSese01000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01000101 .class);
    }
