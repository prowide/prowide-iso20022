    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:sese.019.001.08";
    ...
    public static MxSese01900108 parse(String xml) {
        return ((MxSese01900108) MxReadImpl.parse(MxSese01900108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese01900108 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese01900108) MxReadImpl.parse(MxSese01900108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese01900108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese01900108 .class);
    }
