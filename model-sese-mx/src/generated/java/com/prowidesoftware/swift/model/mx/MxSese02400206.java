    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:swift:xsd:sese.024.002.06";
    ...
    public static MxSese02400206 parse(String xml) {
        return ((MxSese02400206) MxReadImpl.parse(MxSese02400206 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxSese02400206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400206) MxReadImpl.parse(MxSese02400206 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxSese02400206 fromJson(String json) {
        return AbstractMX.fromJson(json, MxSese02400206 .class);
    }
