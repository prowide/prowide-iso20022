...
/**
 * Class for sese.024.002.06 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxSese02400206(final String xml) {
        this();
        MxSese02400206 tmp = parse(xml);
     ...
     * 
     */
    public MxSese02400206(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link SecuritiesSettlementTransactionStatusAdvice002V06 }
     *     
     */
    public SecuritiesSettlementTransactionStatusAdvice002V06 getSctiesSttlmTxStsAdvc() {
     ...
     *     
     */
    public MxSese02400206 setSctiesSttlmTxStsAdvc(SecuritiesSettlementTransactionStatusAdvice002V06 value) {
     ...
     * 
     */
    public static MxSese02400206 parse(String xml) {
        return ((MxSese02400206) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02400206 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxSese02400206 parse(String xml, MxReadConfiguration conf) {
        return ((MxSese02400206) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxSese02400206 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxSese02400206 parse(String xml, MxRead parserImpl) {
        return ((MxSese02400206) parserImpl.read(MxSese02400206 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxSese02400206 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxSese02400206 message
     * @return
     *     a new instance of MxSese02400206
     */
    public final static MxSese02400206 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxSese02400206 .class);
    }
