...
@XmlType(name = "FIToFICustomerDirectDebitV03", propOrder = {
    "grpHdr",
    "drctDbtTxInf",
    "splmtryData"
})
public class FIToFICustomerDirectDebitV03 {
    ...
    protected List<DirectDebitTransactionInformation12> drctDbtTxInf;
     ...
     *     
     */
    public FIToFICustomerDirectDebitV03 setGrpHdr(GroupHeader50 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link DirectDebitTransactionInformation12 }
     * 
     * 
     */
    public List<DirectDebitTransactionInformation12> getDrctDbtTxInf() {
        if (drctDbtTxInf == null) {
            drctDbtTxInf = new ArrayList<DirectDebitTransactionInformation12>();
        }
     ...
     * 
     */
    public FIToFICustomerDirectDebitV03 addDrctDbtTxInf(DirectDebitTransactionInformation12 drctDbtTxInf) {
     ...
     * 
     */
    public FIToFICustomerDirectDebitV03 addSplmtryData(SupplementaryData1 splmtryData) {
