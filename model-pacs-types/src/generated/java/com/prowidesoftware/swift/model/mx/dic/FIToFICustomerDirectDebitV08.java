...
@XmlType(name = "FIToFICustomerDirectDebitV08", propOrder = {
    "grpHdr",
    "drctDbtTxInf",
    "splmtryData"
})
public class FIToFICustomerDirectDebitV08 {
    ...
    protected GroupHeader94 grpHdr;
    @XmlElement(name = "DrctDbtTxInf", required = true)
    protected List<DirectDebitTransactionInformation24> drctDbtTxInf;
     ...
     *     
     */
    public GroupHeader94 getGrpHdr() {
        return grpHdr;
    }
     ...
     *     
     */
    public FIToFICustomerDirectDebitV08 setGrpHdr(GroupHeader94 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link DirectDebitTransactionInformation24 }
     * 
     * 
     */
    public List<DirectDebitTransactionInformation24> getDrctDbtTxInf() {
        if (drctDbtTxInf == null) {
            drctDbtTxInf = new ArrayList<DirectDebitTransactionInformation24>();
        }
     ...
     * 
     */
    public FIToFICustomerDirectDebitV08 addDrctDbtTxInf(DirectDebitTransactionInformation24 drctDbtTxInf) {
     ...
     * 
     */
    public FIToFICustomerDirectDebitV08 addSplmtryData(SupplementaryData1 splmtryData) {
