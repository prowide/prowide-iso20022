...
@XmlType(name = "FinancialInstitutionCreditTransferV07", propOrder = {
    "grpHdr",
    "cdtTrfTxInf",
    "splmtryData"
})
public class FinancialInstitutionCreditTransferV07 {
    ...
    protected List<CreditTransferTransaction31> cdtTrfTxInf;
     ...
     *     
     */
    public FinancialInstitutionCreditTransferV07 setGrpHdr(GroupHeader70 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link CreditTransferTransaction31 }
     * 
     * 
     */
    public List<CreditTransferTransaction31> getCdtTrfTxInf() {
        if (cdtTrfTxInf == null) {
            cdtTrfTxInf = new ArrayList<CreditTransferTransaction31>();
        }
     ...
     * 
     */
    public FinancialInstitutionCreditTransferV07 addCdtTrfTxInf(CreditTransferTransaction31 cdtTrfTxInf) {
     ...
     * 
     */
    public FinancialInstitutionCreditTransferV07 addSplmtryData(SupplementaryData1 splmtryData) {
