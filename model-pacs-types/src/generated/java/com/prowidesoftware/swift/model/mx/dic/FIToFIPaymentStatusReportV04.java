...
@XmlType(name = "FIToFIPaymentStatusReportV04", propOrder = {
    "grpHdr",
    "orgnlGrpInfAndSts",
    "txInfAndSts",
    "splmtryData"
...
public class FIToFIPaymentStatusReportV04 {
    ...
    protected List<PaymentTransaction33> txInfAndSts;
     ...
     *     
     */
    public FIToFIPaymentStatusReportV04 setGrpHdr(GroupHeader53 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public FIToFIPaymentStatusReportV04 setOrgnlGrpInfAndSts(OriginalGroupHeader1 value) {
     ...
     * {@link PaymentTransaction33 }
     * 
     * 
     */
    public List<PaymentTransaction33> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new ArrayList<PaymentTransaction33>();
        }
     ...
     * 
     */
    public FIToFIPaymentStatusReportV04 addTxInfAndSts(PaymentTransaction33 txInfAndSts) {
     ...
     * 
     */
    public FIToFIPaymentStatusReportV04 addSplmtryData(SupplementaryData1 splmtryData) {
