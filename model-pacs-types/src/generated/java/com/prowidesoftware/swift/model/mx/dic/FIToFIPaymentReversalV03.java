...
@XmlType(name = "FIToFIPaymentReversalV03", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "txInf",
    "splmtryData"
...
public class FIToFIPaymentReversalV03 {
    ...
    protected List<PaymentTransaction36> txInf;
     ...
     *     
     */
    public FIToFIPaymentReversalV03 setGrpHdr(GroupHeader57 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public FIToFIPaymentReversalV03 setOrgnlGrpInf(OriginalGroupHeader3 value) {
     ...
     * {@link PaymentTransaction36 }
     * 
     * 
     */
    public List<PaymentTransaction36> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction36>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public FIToFIPaymentReversalV03 addTxInf(PaymentTransaction36 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public FIToFIPaymentReversalV03 addSplmtryData(SupplementaryData1 splmtryData) {
