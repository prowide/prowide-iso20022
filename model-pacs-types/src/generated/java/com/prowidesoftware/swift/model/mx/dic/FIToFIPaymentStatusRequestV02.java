...
public class FIToFIPaymentStatusRequestV02 {
    ...
    protected List<PaymentTransaction94> txInf;
     ...
     *     
     */
    public FIToFIPaymentStatusRequestV02 setGrpHdr(GroupHeader53 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public List<PaymentTransaction94> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction94>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV02 addOrgnlGrpInf(OriginalGroupInformation27 orgnlGrpInf) {
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV02 addTxInf(PaymentTransaction94 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV02 addSplmtryData(SupplementaryData1 splmtryData) {
