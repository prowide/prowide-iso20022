...
@XmlType(name = "FinancialInstitutionCreditTransferV13", propOrder = {
    "grpHdr",
    "cdtTrfTxInf",
    "splmtryData"
})
public class FinancialInstitutionCreditTransferV13 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader131 grpHdr;
    @XmlElement(name = "CdtTrfTxInf", required = true)
    protected List<CreditTransferTransaction79> cdtTrfTxInf;
     ...
     *     
     */
    public FinancialInstitutionCreditTransferV13 setGrpHdr(GroupHeader131 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link CreditTransferTransaction79 }
     * 
     * 
     * @return
     *     The value of the cdtTrfTxInf property.
     */
    public List<CreditTransferTransaction79> getCdtTrfTxInf() {
        if (cdtTrfTxInf == null) {
     ...
     * 
     */
    public FinancialInstitutionCreditTransferV13 addCdtTrfTxInf(CreditTransferTransaction79 cdtTrfTxInf) {
     ...
     * 
     */
    public FinancialInstitutionCreditTransferV13 addSplmtryData(SupplementaryData1 splmtryData) {
