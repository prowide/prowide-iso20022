...
@XmlType(name = "FIToFICustomerDirectDebitV12", propOrder = {
    "grpHdr",
    "drctDbtTxInf",
    "splmtryData"
})
public class FIToFICustomerDirectDebitV12 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader125 grpHdr;
    @XmlElement(name = "DrctDbtTxInf", required = true)
    protected List<DirectDebitTransactionInformation35> drctDbtTxInf;
     ...
     *     
     */
    public FIToFICustomerDirectDebitV12 setGrpHdr(GroupHeader125 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link DirectDebitTransactionInformation35 }
     * 
     * 
     * @return
     *     The value of the drctDbtTxInf property.
     */
    public List<DirectDebitTransactionInformation35> getDrctDbtTxInf() {
     ...
     * 
     */
    public FIToFICustomerDirectDebitV12 addDrctDbtTxInf(DirectDebitTransactionInformation35 drctDbtTxInf) {
     ...
     * 
     */
    public FIToFICustomerDirectDebitV12 addSplmtryData(SupplementaryData1 splmtryData) {
