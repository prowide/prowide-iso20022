...
@XmlType(name = "FIToFIPaymentReversalV14", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "txInf",
    "splmtryData"
})
public class FIToFIPaymentReversalV14 {
    ...
    protected List<PaymentTransaction182> txInf;
     ...
     *     
     */
    public FIToFIPaymentReversalV14 setGrpHdr(GroupHeader127 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public FIToFIPaymentReversalV14 setOrgnlGrpInf(OriginalGroupHeader20 value) {
     ...
     * {@link PaymentTransaction182 }
     * 
     * 
     * @return
     *     The value of the txInf property.
     */
    public List<PaymentTransaction182> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<>();
        }
        return this.txInf;
     ...
     * 
     */
    public FIToFIPaymentReversalV14 addTxInf(PaymentTransaction182 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public FIToFIPaymentReversalV14 addSplmtryData(SupplementaryData1 splmtryData) {
