...
public class FinancialInstitutionCreditTransferV02 {
    ...
    protected List<CreditTransferTransactionInformation13> cdtTrfTxInf;
     ...
     *     
     */
    public FinancialInstitutionCreditTransferV02 setGrpHdr(GroupHeader35 value) {
        this.grpHdr = value;
        return this;
    }
    ...
    public List<CreditTransferTransactionInformation13> getCdtTrfTxInf() {
        if (cdtTrfTxInf == null) {
            cdtTrfTxInf = new ArrayList<CreditTransferTransactionInformation13>();
        }
     ...
     * 
     */
    public FinancialInstitutionCreditTransferV02 addCdtTrfTxInf(CreditTransferTransactionInformation13 cdtTrfTxInf) {
