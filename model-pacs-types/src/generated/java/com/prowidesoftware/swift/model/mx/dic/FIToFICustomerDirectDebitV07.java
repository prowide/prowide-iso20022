...
public class FIToFICustomerDirectDebitV07 {
    ...
    protected List<DirectDebitTransactionInformation21> drctDbtTxInf;
     ...
     *     
     */
    public FIToFICustomerDirectDebitV07 setGrpHdr(GroupHeader50 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link DirectDebitTransactionInformation21 }
     * 
     * 
     */
    public List<DirectDebitTransactionInformation21> getDrctDbtTxInf() {
        if (drctDbtTxInf == null) {
            drctDbtTxInf = new ArrayList<DirectDebitTransactionInformation21>();
        }
     ...
     * 
     */
    public FIToFICustomerDirectDebitV07 addDrctDbtTxInf(DirectDebitTransactionInformation21 drctDbtTxInf) {
     ...
     * 
     */
    public FIToFICustomerDirectDebitV07 addSplmtryData(SupplementaryData1 splmtryData) {
