...
@XmlType(name = "PaymentReturnV14", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "txInf",
    "splmtryData"
})
public class PaymentReturnV14 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader123 grpHdr;
    @XmlElement(name = "OrgnlGrpInf")
    protected OriginalGroupHeader19 orgnlGrpInf;
    @XmlElement(name = "TxInf")
    protected List<PaymentTransaction163> txInf;
     ...
     *     
     */
    public GroupHeader123 getGrpHdr() {
        return grpHdr;
    }
     ...
     *     
     */
    public PaymentReturnV14 setGrpHdr(GroupHeader123 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link OriginalGroupHeader19 }
     *     
     */
    public OriginalGroupHeader19 getOrgnlGrpInf() {
        return orgnlGrpInf;
    }
     ...
     *     
     */
    public PaymentReturnV14 setOrgnlGrpInf(OriginalGroupHeader19 value) {
     ...
     * {@link PaymentTransaction163 }
     * 
     * 
     */
    public List<PaymentTransaction163> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction163>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public PaymentReturnV14 addTxInf(PaymentTransaction163 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public PaymentReturnV14 addSplmtryData(SupplementaryData1 splmtryData) {
