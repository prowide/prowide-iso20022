...
@XmlType(name = "RemittanceInformation4", propOrder = {
    "ustrd",
    "strd"
})
public class RemittanceInformation4 {
     ...
     * 
     */
    public RemittanceInformation4 addUstrd(String ustrd) {
        getUstrd().add(ustrd);
        return this;
    }
     ...
     * 
     */
    public RemittanceInformation4 addStrd(StructuredRemittanceInformation6 strd) {
        getStrd().add(strd);
        return this;
    }
