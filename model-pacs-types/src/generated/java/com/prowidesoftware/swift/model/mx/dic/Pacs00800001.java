...
/**
 * FIToFICustomerCreditTransferTemplateV01 is an exact copy of the ISO message version.
 * 
 * 
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "pacs.008.000.01", propOrder = {
    "grpHdr",
    "cdtTrfTxInf"
})
public class Pacs00800001 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader2 grpHdr;
     ...
     *     
     */
    public Pacs00800001 setGrpHdr(GroupHeader2 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public Pacs00800001 addCdtTrfTxInf(CreditTransferTransactionInformation2 cdtTrfTxInf) {
