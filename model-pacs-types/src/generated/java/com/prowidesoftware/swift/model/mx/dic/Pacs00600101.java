...
@XmlType(name = "pacs.006.001.01", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "txInf"
})
public class Pacs00600101 {
     ...
     *     
     */
    public Pacs00600101 setGrpHdr(GroupHeader7 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public Pacs00600101 setOrgnlGrpInf(OriginalGroupInformation4 value) {
     ...
     * 
     */
    public Pacs00600101 addTxInf(PaymentTransactionInformation3 txInf) {
        getTxInf().add(txInf);
        return this;
    }
