...
@XmlType(name = "pacs.007.001.01", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "txInf"
})
public class Pacs00700101 {
     ...
     *     
     */
    public Pacs00700101 setGrpHdr(GroupHeader9 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public Pacs00700101 setOrgnlGrpInf(OriginalGroupInformation5 value) {
     ...
     * 
     */
    public Pacs00700101 addTxInf(PaymentTransactionInformation5 txInf) {
        getTxInf().add(txInf);
        return this;
    }
