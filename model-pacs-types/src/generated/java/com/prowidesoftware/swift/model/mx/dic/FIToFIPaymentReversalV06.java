...
@XmlType(name = "FIToFIPaymentReversalV06", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "txInf",
    "splmtryData"
...
public class FIToFIPaymentReversalV06 {
    ...
    protected List<PaymentTransaction60> txInf;
     ...
     *     
     */
    public FIToFIPaymentReversalV06 setGrpHdr(GroupHeader71 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public FIToFIPaymentReversalV06 setOrgnlGrpInf(OriginalGroupHeader3 value) {
     ...
     * {@link PaymentTransaction60 }
     * 
     * 
     */
    public List<PaymentTransaction60> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction60>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public FIToFIPaymentReversalV06 addTxInf(PaymentTransaction60 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public FIToFIPaymentReversalV06 addSplmtryData(SupplementaryData1 splmtryData) {
