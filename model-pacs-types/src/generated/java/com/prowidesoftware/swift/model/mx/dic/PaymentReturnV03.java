...
@XmlType(name = "PaymentReturnV03", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "txInf",
    "splmtryData"
...
public class PaymentReturnV03 {
    ...
    protected List<PaymentTransaction34> txInf;
     ...
     *     
     */
    public PaymentReturnV03 setGrpHdr(GroupHeader54 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public PaymentReturnV03 setOrgnlGrpInf(OriginalGroupHeader2 value) {
     ...
     * {@link PaymentTransaction34 }
     * 
     * 
     */
    public List<PaymentTransaction34> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction34>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public PaymentReturnV03 addTxInf(PaymentTransaction34 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public PaymentReturnV03 addSplmtryData(SupplementaryData1 splmtryData) {
