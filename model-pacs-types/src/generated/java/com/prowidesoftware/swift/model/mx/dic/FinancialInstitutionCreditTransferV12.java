...
public class FinancialInstitutionCreditTransferV12 {
     ...
     *     
     */
    public FinancialInstitutionCreditTransferV12 setGrpHdr(GroupHeader131 value) {
        this.grpHdr = value;
        return this;
    }
    ...
    public List<CreditTransferTransaction67> getCdtTrfTxInf() {
        if (cdtTrfTxInf == null) {
            cdtTrfTxInf = new ArrayList<CreditTransferTransaction67>();
        }
     ...
     * 
     */
    public FinancialInstitutionCreditTransferV12 addCdtTrfTxInf(CreditTransferTransaction67 cdtTrfTxInf) {
     ...
     * 
     */
    public FinancialInstitutionCreditTransferV12 addSplmtryData(SupplementaryData1 splmtryData) {
