...
public class FIToFICustomerCreditTransferV03 {
    ...
    protected List<CreditTransferTransaction2> cdtTrfTxInf;
     ...
     *     
     */
    public FIToFICustomerCreditTransferV03 setGrpHdr(GroupHeader49 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public List<CreditTransferTransaction2> getCdtTrfTxInf() {
        if (cdtTrfTxInf == null) {
            cdtTrfTxInf = new ArrayList<CreditTransferTransaction2>();
        }
     ...
     * 
     */
    public FIToFICustomerCreditTransferV03 addCdtTrfTxInf(CreditTransferTransaction2 cdtTrfTxInf) {
     ...
     * 
     */
    public FIToFICustomerCreditTransferV03 addSplmtryData(SupplementaryData1 splmtryData) {
