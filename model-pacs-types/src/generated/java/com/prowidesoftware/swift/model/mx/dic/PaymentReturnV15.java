...
@XmlType(name = "PaymentReturnV15", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "txInf",
    "splmtryData"
})
public class PaymentReturnV15 {
    ...
    protected List<PaymentTransaction168> txInf;
     ...
     *     
     */
    public PaymentReturnV15 setGrpHdr(GroupHeader123 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public PaymentReturnV15 setOrgnlGrpInf(OriginalGroupHeader19 value) {
     ...
     * {@link PaymentTransaction168 }
     * 
     * 
     * @return
     *     The value of the txInf property.
     */
    public List<PaymentTransaction168> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<>();
        }
        return this.txInf;
     ...
     * 
     */
    public PaymentReturnV15 addTxInf(PaymentTransaction168 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public PaymentReturnV15 addSplmtryData(SupplementaryData1 splmtryData) {
