...
@XmlType(name = "FIToFICustomerCreditTransferV14", propOrder = {
    "grpHdr",
    "cdtTrfTxInf",
    "splmtryData"
})
public class FIToFICustomerCreditTransferV14 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader131 grpHdr;
    @XmlElement(name = "CdtTrfTxInf", required = true)
    protected List<CreditTransferTransaction73> cdtTrfTxInf;
     ...
     *     
     */
    public FIToFICustomerCreditTransferV14 setGrpHdr(GroupHeader131 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link CreditTransferTransaction73 }
     * 
     * 
     * @return
     *     The value of the cdtTrfTxInf property.
     */
    public List<CreditTransferTransaction73> getCdtTrfTxInf() {
        if (cdtTrfTxInf == null) {
     ...
     * 
     */
    public FIToFICustomerCreditTransferV14 addCdtTrfTxInf(CreditTransferTransaction73 cdtTrfTxInf) {
     ...
     * 
     */
    public FIToFICustomerCreditTransferV14 addSplmtryData(SupplementaryData1 splmtryData) {
