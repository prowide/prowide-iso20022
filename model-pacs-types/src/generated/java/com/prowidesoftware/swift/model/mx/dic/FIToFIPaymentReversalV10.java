...
@XmlType(name = "FIToFIPaymentReversalV10", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "txInf",
    "splmtryData"
...
public class FIToFIPaymentReversalV10 {
    ...
    protected List<PaymentTransaction119> txInf;
     ...
     *     
     */
    public FIToFIPaymentReversalV10 setGrpHdr(GroupHeader89 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public FIToFIPaymentReversalV10 setOrgnlGrpInf(OriginalGroupHeader16 value) {
     ...
     * {@link PaymentTransaction119 }
     * 
     * 
     */
    public List<PaymentTransaction119> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction119>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public FIToFIPaymentReversalV10 addTxInf(PaymentTransaction119 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public FIToFIPaymentReversalV10 addSplmtryData(SupplementaryData1 splmtryData) {
