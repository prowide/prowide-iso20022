...
@XmlType(name = "FinancialInstitutionCreditTransferV09", propOrder = {
    "grpHdr",
    "cdtTrfTxInf",
    "splmtryData"
})
public class FinancialInstitutionCreditTransferV09 {
     ...
     *     
     */
    public FinancialInstitutionCreditTransferV09 setGrpHdr(GroupHeader93 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link CreditTransferTransaction44 }
     * 
     * 
     */
    public List<CreditTransferTransaction44> getCdtTrfTxInf() {
        if (cdtTrfTxInf == null) {
            cdtTrfTxInf = new ArrayList<CreditTransferTransaction44>();
        }
     ...
     * 
     */
    public FinancialInstitutionCreditTransferV09 addCdtTrfTxInf(CreditTransferTransaction44 cdtTrfTxInf) {
     ...
     * 
     */
    public FinancialInstitutionCreditTransferV09 addSplmtryData(SupplementaryData1 splmtryData) {
