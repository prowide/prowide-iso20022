...
@XmlType(name = "FIToFIPaymentReversalV09", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "txInf",
    "splmtryData"
...
public class FIToFIPaymentReversalV09 {
    ...
    protected GroupHeader89 grpHdr;
    @XmlElement(name = "OrgnlGrpInf")
    protected OriginalGroupHeader16 orgnlGrpInf;
    @XmlElement(name = "TxInf")
    protected List<PaymentTransaction111> txInf;
     ...
     *     
     */
    public GroupHeader89 getGrpHdr() {
        return grpHdr;
    }
     ...
     *     
     */
    public FIToFIPaymentReversalV09 setGrpHdr(GroupHeader89 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public FIToFIPaymentReversalV09 setOrgnlGrpInf(OriginalGroupHeader16 value) {
     ...
     * {@link PaymentTransaction111 }
     * 
     * 
     */
    public List<PaymentTransaction111> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction111>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public FIToFIPaymentReversalV09 addTxInf(PaymentTransaction111 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public FIToFIPaymentReversalV09 addSplmtryData(SupplementaryData1 splmtryData) {
