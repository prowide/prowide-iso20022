...
@XmlType(name = "PaymentReturnV06", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "txInf",
    "splmtryData"
...
public class PaymentReturnV06 {
    ...
    protected List<PaymentTransaction65> txInf;
     ...
     *     
     */
    public PaymentReturnV06 setGrpHdr(GroupHeader72 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public PaymentReturnV06 setOrgnlGrpInf(OriginalGroupHeader2 value) {
     ...
     * {@link PaymentTransaction65 }
     * 
     * 
     */
    public List<PaymentTransaction65> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction65>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public PaymentReturnV06 addTxInf(PaymentTransaction65 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public PaymentReturnV06 addSplmtryData(SupplementaryData1 splmtryData) {
