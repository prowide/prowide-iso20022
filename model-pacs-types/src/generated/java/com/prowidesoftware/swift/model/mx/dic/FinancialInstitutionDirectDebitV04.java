...
public class FinancialInstitutionDirectDebitV04 {
    ...
    protected List<CreditTransferTransaction47> cdtInstr;
     ...
     * 
     */
    public List<CreditTransferTransaction47> getCdtInstr() {
        if (cdtInstr == null) {
            cdtInstr = new ArrayList<CreditTransferTransaction47>();
        }
