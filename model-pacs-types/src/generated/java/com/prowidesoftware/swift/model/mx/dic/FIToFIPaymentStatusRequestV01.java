...
public class FIToFIPaymentStatusRequestV01 {
     ...
     *     
     */
    public FIToFIPaymentStatusRequestV01 setGrpHdr(GroupHeader53 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV01 addOrgnlGrpInf(OriginalGroupInformation27 orgnlGrpInf) {
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV01 addTxInf(PaymentTransaction73 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV01 addSplmtryData(SupplementaryData1 splmtryData) {
