...
public class FinancialInstitutionCreditTransferV08 {
    ...
    protected List<CreditTransferTransaction36> cdtTrfTxInf;
     ...
     *     
     */
    public FinancialInstitutionCreditTransferV08 setGrpHdr(GroupHeader93 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public List<CreditTransferTransaction36> getCdtTrfTxInf() {
        if (cdtTrfTxInf == null) {
            cdtTrfTxInf = new ArrayList<CreditTransferTransaction36>();
        }
     ...
     * 
     */
    public FinancialInstitutionCreditTransferV08 addCdtTrfTxInf(CreditTransferTransaction36 cdtTrfTxInf) {
     ...
     * 
     */
    public FinancialInstitutionCreditTransferV08 addSplmtryData(SupplementaryData1 splmtryData) {
