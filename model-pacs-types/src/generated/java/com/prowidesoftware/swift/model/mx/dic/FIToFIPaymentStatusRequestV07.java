...
@XmlType(name = "FIToFIPaymentStatusRequestV07", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "txInf",
    "splmtryData"
})
public class FIToFIPaymentStatusRequestV07 {
    ...
    protected List<PaymentTransaction171> txInf;
     ...
     *     
     */
    public FIToFIPaymentStatusRequestV07 setGrpHdr(GroupHeader109 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction171 }
     * 
     * 
     * @return
     *     The value of the txInf property.
     */
    public List<PaymentTransaction171> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<>();
        }
        return this.txInf;
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV07 addOrgnlGrpInf(OriginalGroupInformation27 orgnlGrpInf) {
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV07 addTxInf(PaymentTransaction171 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV07 addSplmtryData(SupplementaryData1 splmtryData) {
