...
public class FIToFIPaymentStatusRequestV05 {
     ...
     *     
     */
    public FIToFIPaymentStatusRequestV05 setGrpHdr(GroupHeader91 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV05 addOrgnlGrpInf(OriginalGroupInformation27 orgnlGrpInf) {
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV05 addTxInf(PaymentTransaction131 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV05 addSplmtryData(SupplementaryData1 splmtryData) {
