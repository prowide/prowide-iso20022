...
@XmlType(name = "FIToFIPaymentStatusRequestV06", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "txInf",
    "splmtryData"
})
public class FIToFIPaymentStatusRequestV06 {

    @XmlElement(name = "GrpHdr", required = true)
    protected GroupHeader109 grpHdr;
    @XmlElement(name = "OrgnlGrpInf")
    protected List<OriginalGroupInformation27> orgnlGrpInf;
    @XmlElement(name = "TxInf")
    protected List<PaymentTransaction158> txInf;
     ...
     *     
     */
    public GroupHeader109 getGrpHdr() {
        return grpHdr;
    }
     ...
     *     
     */
    public FIToFIPaymentStatusRequestV06 setGrpHdr(GroupHeader109 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction158 }
     * 
     * 
     */
    public List<PaymentTransaction158> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction158>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV06 addOrgnlGrpInf(OriginalGroupInformation27 orgnlGrpInf) {
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV06 addTxInf(PaymentTransaction158 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public FIToFIPaymentStatusRequestV06 addSplmtryData(SupplementaryData1 splmtryData) {
