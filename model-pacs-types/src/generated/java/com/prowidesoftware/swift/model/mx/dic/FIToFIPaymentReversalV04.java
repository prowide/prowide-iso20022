...
@XmlType(name = "FIToFIPaymentReversalV04", propOrder = {
    "grpHdr",
    "orgnlGrpInf",
    "txInf",
    "splmtryData"
...
public class FIToFIPaymentReversalV04 {
    ...
    protected List<PaymentTransaction45> txInf;
     ...
     *     
     */
    public FIToFIPaymentReversalV04 setGrpHdr(GroupHeader57 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public FIToFIPaymentReversalV04 setOrgnlGrpInf(OriginalGroupHeader3 value) {
     ...
     * {@link PaymentTransaction45 }
     * 
     * 
     */
    public List<PaymentTransaction45> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction45>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public FIToFIPaymentReversalV04 addTxInf(PaymentTransaction45 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public FIToFIPaymentReversalV04 addSplmtryData(SupplementaryData1 splmtryData) {
