...
public class PaymentReturnV12 {
     ...
     *     
     */
    public PaymentReturnV12 setGrpHdr(GroupHeader99 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public PaymentReturnV12 setOrgnlGrpInf(OriginalGroupHeader18 value) {
    ...
    public List<PaymentTransaction146> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction146>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public PaymentReturnV12 addTxInf(PaymentTransaction146 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public PaymentReturnV12 addSplmtryData(SupplementaryData1 splmtryData) {
