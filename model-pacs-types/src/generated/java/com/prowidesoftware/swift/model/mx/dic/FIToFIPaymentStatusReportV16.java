...
@XmlType(name = "FIToFIPaymentStatusReportV16", propOrder = {
    "grpHdr",
    "orgnlGrpInfAndSts",
    "txInfAndSts",
    "splmtryData"
})
public class FIToFIPaymentStatusReportV16 {
    ...
    protected List<PaymentTransaction177> txInfAndSts;
     ...
     *     
     */
    public FIToFIPaymentStatusReportV16 setGrpHdr(GroupHeader120 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentTransaction177 }
     * 
     * 
     * @return
     *     The value of the txInfAndSts property.
     */
    public List<PaymentTransaction177> getTxInfAndSts() {
        if (txInfAndSts == null) {
     ...
     * 
     */
    public FIToFIPaymentStatusReportV16 addOrgnlGrpInfAndSts(OriginalGroupHeader22 orgnlGrpInfAndSts) {
     ...
     * 
     */
    public FIToFIPaymentStatusReportV16 addTxInfAndSts(PaymentTransaction177 txInfAndSts) {
     ...
     * 
     */
    public FIToFIPaymentStatusReportV16 addSplmtryData(SupplementaryData1 splmtryData) {
