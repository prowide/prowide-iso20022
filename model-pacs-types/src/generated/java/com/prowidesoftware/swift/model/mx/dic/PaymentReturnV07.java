...
public class PaymentReturnV07 {
    ...
    protected List<PaymentTransaction76> txInf;
     ...
     *     
     */
    public PaymentReturnV07 setGrpHdr(GroupHeader72 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     *     
     */
    public PaymentReturnV07 setOrgnlGrpInf(OriginalGroupHeader2 value) {
     ...
     * 
     */
    public List<PaymentTransaction76> getTxInf() {
        if (txInf == null) {
            txInf = new ArrayList<PaymentTransaction76>();
        }
        return this.txInf;
    }
     ...
     * 
     */
    public PaymentReturnV07 addTxInf(PaymentTransaction76 txInf) {
        getTxInf().add(txInf);
        return this;
    }
     ...
     * 
     */
    public PaymentReturnV07 addSplmtryData(SupplementaryData1 splmtryData) {
