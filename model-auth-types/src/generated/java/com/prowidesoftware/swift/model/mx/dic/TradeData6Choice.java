...
@XmlType(name = "TradeData6Choice", propOrder = {
    "dataSetActn",
    "rpt"
})
public class TradeData6Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Rpt")
    protected List<TradeReport6Choice> rpt;
     ...
     *     
     */
    public TradeData6Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * {@link TradeReport6Choice }
     * 
     * 
     */
    public List<TradeReport6Choice> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<TradeReport6Choice>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public TradeData6Choice addRpt(TradeReport6Choice rpt) {
        getRpt().add(rpt);
        return this;
    }
