...
public class TradeData39Choice {
     ...
     *     
     */
    public TradeData39Choice setDataSetActn(ReportPeriodActivity1Code value) {
    ...
    public List<TradeReport21Choice> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<TradeReport21Choice>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public TradeData39Choice addRpt(TradeReport21Choice rpt) {
        getRpt().add(rpt);
        return this;
    }
