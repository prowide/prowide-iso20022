...
@XmlType(name = "TradeStateReport2Choice", propOrder = {
    "dataSetActn",
    "stat"
})
public class TradeStateReport2Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Stat")
    protected List<TradeStateReport9> stat;
     ...
     *     
     */
    public TradeStateReport2Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * {@link TradeStateReport9 }
     * 
     * 
     */
    public List<TradeStateReport9> getStat() {
        if (stat == null) {
            stat = new ArrayList<TradeStateReport9>();
        }
        return this.stat;
    }
     ...
     * 
     */
    public TradeStateReport2Choice addStat(TradeStateReport9 stat) {
        getStat().add(stat);
        return this;
    }
