...
@XmlType(name = "TradeData59Choice", propOrder = {
    "dataSetActn",
    "rpt"
})
public class TradeData59Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Rpt")
    protected List<TradeReport33Choice> rpt;
     ...
     *     
     */
    public TradeData59Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * {@link TradeReport33Choice }
     * 
     * 
     */
    public List<TradeReport33Choice> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<TradeReport33Choice>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public TradeData59Choice addRpt(TradeReport33Choice rpt) {
        getRpt().add(rpt);
        return this;
    }
