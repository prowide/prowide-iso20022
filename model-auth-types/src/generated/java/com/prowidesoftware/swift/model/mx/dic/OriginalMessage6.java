...
@XmlType(name = "OriginalMessage6", propOrder = {
    "orgnlSndr",
    "orgnlMsgId",
    "orgnlMsgNmId",
    "orgnlCreDtTm",
...
public class OriginalMessage6 {

    @XmlElement(name = "OrgnlSndr")
    protected Party50Choice orgnlSndr;
     ...
     *     
     */
    public Party50Choice getOrgnlSndr() {
        return orgnlSndr;
    }
     ...
     *     
     */
    public OriginalMessage6 setOrgnlSndr(Party50Choice value) {
     ...
     *     
     */
    public OriginalMessage6 setOrgnlMsgId(String value) {
     ...
     *     
     */
    public OriginalMessage6 setOrgnlMsgNmId(String value) {
     ...
     *     
     */
    public OriginalMessage6 setOrgnlCreDtTm(XMLGregorianCalendar value) {
     ...
     *     
     */
    public OriginalMessage6 setOrgnlPackgId(String value) {
     ...
     *     
     */
    public OriginalMessage6 setOrgnlRcrdId(String value) {
