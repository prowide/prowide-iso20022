...
@XmlType(name = "TradePositionOther5", propOrder = {
    "ctrPtySpcfcData",
    "cmonTradData",
    "techAttrbts",
    "splmtryData"
})
public class TradePositionOther5 {
     ...
     *     
     */
    public TradePositionOther5 setCmonTradData(CommonTradeDataReport37 value) {
     ...
     *     
     */
    public TradePositionOther5 setTechAttrbts(TechnicalAttributes1 value) {
     ...
     * 
     */
    public TradePositionOther5 addCtrPtySpcfcData(CounterpartySpecificData22 ctrPtySpcfcData) {
     ...
     * 
     */
    public TradePositionOther5 addSplmtryData(SupplementaryData1 splmtryData) {
