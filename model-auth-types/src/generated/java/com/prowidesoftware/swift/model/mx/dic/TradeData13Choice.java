...
@XmlType(name = "TradeData13Choice", propOrder = {
    "dataSetActn",
    "stat"
})
public class TradeData13Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Stat")
    protected List<CollateralMarginNew7> stat;
     ...
     *     
     */
    public TradeData13Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * {@link CollateralMarginNew7 }
     * 
     * 
     */
    public List<CollateralMarginNew7> getStat() {
        if (stat == null) {
            stat = new ArrayList<CollateralMarginNew7>();
        }
        return this.stat;
    }
     ...
     * 
     */
    public TradeData13Choice addStat(CollateralMarginNew7 stat) {
        getStat().add(stat);
        return this;
    }
