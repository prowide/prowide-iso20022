...
@XmlType(name = "ReuseDataReportCorrection4", propOrder = {
    "techRcrdId",
    "rptgDtTm",
    "ctrPtyData",
    "collCmpnt",
...
public class ReuseDataReportCorrection4 {
     ...
     *     
     */
    public ReuseDataReportCorrection4 setTechRcrdId(String value) {
     ...
     *     
     */
    public ReuseDataReportCorrection4 setCtrPtyData(CounterpartyData46 value) {
     ...
     * 
     */
    public ReuseDataReportCorrection4 addCollCmpnt(CollateralType6Choice collCmpnt) {
     ...
     * 
     */
    public ReuseDataReportCorrection4 addFndgSrc(FundingSource1 fndgSrc) {
     ...
     * 
     */
    public ReuseDataReportCorrection4 addSplmtryData(SupplementaryData1 splmtryData) {
