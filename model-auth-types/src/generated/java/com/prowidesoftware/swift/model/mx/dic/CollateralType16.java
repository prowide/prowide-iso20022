...
@XmlType(name = "CollateralType16", propOrder = {
    "scty",
    "csh",
    "cmmdty"
})
public class CollateralType16 {

    @XmlElement(name = "Scty")
    protected List<Security14> scty;
    @XmlElement(name = "Csh")
     ...
     * 
     */
    public List<Security14> getScty() {
        if (scty == null) {
            scty = new ArrayList<Security14>();
        }
        return this.scty;
    }
     ...
     * 
     */
    public CollateralType16 addScty(Security14 scty) {
        getScty().add(scty);
        return this;
    }
     ...
     * 
     */
    public CollateralType16 addCsh(AmountHaircutMargin1 csh) {
        getCsh().add(csh);
        return this;
    }
     ...
     * 
     */
    public CollateralType16 addCmmdty(Commodity20 cmmdty) {
