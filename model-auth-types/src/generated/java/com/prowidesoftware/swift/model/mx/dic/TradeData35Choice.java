...
@XmlType(name = "TradeData35Choice", propOrder = {
    "dataSetActn",
    "rpt"
})
public class TradeData35Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Rpt")
    protected List<TradeData29> rpt;
     ...
     *     
     */
    public TradeData35Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * 
     */
    public List<TradeData29> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<TradeData29>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public TradeData35Choice addRpt(TradeData29 rpt) {
        getRpt().add(rpt);
        return this;
    }
