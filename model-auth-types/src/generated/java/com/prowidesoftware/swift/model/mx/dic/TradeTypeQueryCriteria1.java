...
@XmlType(name = "TradeTypeQueryCriteria1", propOrder = {
    "oprtr",
    "sctiesFincgTxTp",
    "collCmpntTp"
})
public class TradeTypeQueryCriteria1 {
    ...
    @XmlSchemaType(name = "string")
    protected List<ExposureType6Code> sctiesFincgTxTp;
     ...
     *     
     */
    public TradeTypeQueryCriteria1 setOprtr(Operation3Code value) {
        this.oprtr = value;
        return this;
    }
     ...
     * 
     */
    public TradeTypeQueryCriteria1 addSctiesFincgTxTp(ExposureType6Code sctiesFincgTxTp) {
     ...
     * 
     */
    public TradeTypeQueryCriteria1 addCollCmpntTp(CollateralType6Code collCmpntTp) {
