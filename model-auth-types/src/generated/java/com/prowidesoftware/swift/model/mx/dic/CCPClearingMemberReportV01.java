...
@XmlType(name = "CCPClearingMemberReportV01", propOrder = {
    "clrMmb",
    "splmtryData"
})
public class CCPClearingMemberReportV01 {
    ...
    protected List<ClearingMember1> clrMmb;
     ...
     * {@link ClearingMember1 }
     * 
     * 
     */
    public List<ClearingMember1> getClrMmb() {
        if (clrMmb == null) {
            clrMmb = new ArrayList<ClearingMember1>();
        }
        return this.clrMmb;
    }
     ...
     * 
     */
    public CCPClearingMemberReportV01 addClrMmb(ClearingMember1 clrMmb) {
     ...
     * 
     */
    public CCPClearingMemberReportV01 addSplmtryData(SupplementaryData1 splmtryData) {
