...
public class FinancialInstrumentReportingMarketIdentificationCodeReportV02 {
    ...
    public List<MarketIdentification95> getMktId() {
        if (mktId == null) {
            mktId = new ArrayList<MarketIdentification95>();
        }
        return this.mktId;
    }
     ...
     * 
     */
    public FinancialInstrumentReportingMarketIdentificationCodeReportV02 addMktId(MarketIdentification95 mktId) {
        getMktId().add(mktId);
        return this;
    }
     ...
     * 
     */
    public FinancialInstrumentReportingMarketIdentificationCodeReportV02 addSplmtryData(SupplementaryData1 splmtryData) {
