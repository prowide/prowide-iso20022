...
@XmlType(name = "SecuredMarketReport4Choice", propOrder = {
    "dataSetActn",
    "tx"
})
public class SecuredMarketReport4Choice {
    ...
    @XmlElement(name = "Tx")
    protected List<SecuredMarketTransaction4> tx;
     ...
     *     
     */
    public SecuredMarketReport4Choice setDataSetActn(ReportPeriodActivity3Code value) {
     ...
     * {@link SecuredMarketTransaction4 }
     * 
     * 
     */
    public List<SecuredMarketTransaction4> getTx() {
        if (tx == null) {
            tx = new ArrayList<SecuredMarketTransaction4>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public SecuredMarketReport4Choice addTx(SecuredMarketTransaction4 tx) {
        getTx().add(tx);
        return this;
    }
