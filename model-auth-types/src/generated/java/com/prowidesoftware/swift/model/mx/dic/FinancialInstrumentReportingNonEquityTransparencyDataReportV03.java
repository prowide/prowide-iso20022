...
@XmlType(name = "FinancialInstrumentReportingNonEquityTransparencyDataReportV03", propOrder = {
    "rptHdr",
    "nonEqtyTrnsprncyData",
    "splmtryData"
})
public class FinancialInstrumentReportingNonEquityTransparencyDataReportV03 {

    @XmlElement(name = "RptHdr", required = true)
    protected SecuritiesMarketReportHeader1 rptHdr;
    @XmlElement(name = "NonEqtyTrnsprncyData", required = true)
    protected List<TransparencyDataReport21> nonEqtyTrnsprncyData;
     ...
     *     
     */
    public FinancialInstrumentReportingNonEquityTransparencyDataReportV03 setRptHdr(SecuritiesMarketReportHeader1 value) {
        this.rptHdr = value;
        return this;
    }
     ...
     * {@link TransparencyDataReport21 }
     * 
     * 
     */
    public List<TransparencyDataReport21> getNonEqtyTrnsprncyData() {
        if (nonEqtyTrnsprncyData == null) {
            nonEqtyTrnsprncyData = new ArrayList<TransparencyDataReport21>();
        }
     ...
     * 
     */
    public FinancialInstrumentReportingNonEquityTransparencyDataReportV03 addNonEqtyTrnsprncyData(TransparencyDataReport21 nonEqtyTrnsprncyData) {
     ...
     * 
     */
    public FinancialInstrumentReportingNonEquityTransparencyDataReportV03 addSplmtryData(SupplementaryData1 splmtryData) {
