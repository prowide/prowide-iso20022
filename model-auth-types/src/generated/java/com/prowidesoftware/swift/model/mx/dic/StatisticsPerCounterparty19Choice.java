...
public class StatisticsPerCounterparty19Choice {
    ...
    @XmlElement(name = "Rpt")
    protected List<ReconciliationStatisticsPerCounterparty4> rpt;
     ...
     * 
     */
    public List<ReconciliationStatisticsPerCounterparty4> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<ReconciliationStatisticsPerCounterparty4>();
        }
        return this.rpt;
    }
