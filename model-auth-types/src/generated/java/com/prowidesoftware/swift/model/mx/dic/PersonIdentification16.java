...
@XmlType(name = "PersonIdentification16", propOrder = {
    "dtAndPlcOfBirth",
    "othr"
})
public class PersonIdentification16 {
     ...
     *     
     */
    public PersonIdentification16 setDtAndPlcOfBirth(DateAndPlaceOfBirth2 value) {
     ...
     * 
     */
    public PersonIdentification16 addOthr(GenericPersonIdentification1 othr) {
        getOthr().add(othr);
        return this;
    }
