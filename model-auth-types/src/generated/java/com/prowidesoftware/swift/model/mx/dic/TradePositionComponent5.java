...
@XmlType(name = "TradePositionComponent5", propOrder = {
    "ctrPtySpcfcData",
    "cmonTradData",
    "techAttrbts",
    "splmtryData"
})
public class TradePositionComponent5 {

    @XmlElement(name = "CtrPtySpcfcData", required = true)
    protected List<CounterpartySpecificData24> ctrPtySpcfcData;
    @XmlElement(name = "CmonTradData", required = true)
    protected CommonTradeDataReport38 cmonTradData;
     ...
     * {@link CounterpartySpecificData24 }
     * 
     * 
     */
    public List<CounterpartySpecificData24> getCtrPtySpcfcData() {
        if (ctrPtySpcfcData == null) {
            ctrPtySpcfcData = new ArrayList<CounterpartySpecificData24>();
        }
     ...
     * @return
     *     possible object is
     *     {@link CommonTradeDataReport38 }
     *     
     */
    public CommonTradeDataReport38 getCmonTradData() {
        return cmonTradData;
    }
     ...
     *     
     */
    public TradePositionComponent5 setCmonTradData(CommonTradeDataReport38 value) {
     ...
     *     
     */
    public TradePositionComponent5 setTechAttrbts(TechnicalAttributes1 value) {
     ...
     * 
     */
    public TradePositionComponent5 addCtrPtySpcfcData(CounterpartySpecificData24 ctrPtySpcfcData) {
     ...
     * 
     */
    public TradePositionComponent5 addSplmtryData(SupplementaryData1 splmtryData) {
