...
@XmlType(name = "TradeData58Choice", propOrder = {
    "dataSetActn",
    "stat"
})
public class TradeData58Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Stat")
    protected List<TradeStateReport22> stat;
     ...
     *     
     */
    public TradeData58Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * {@link TradeStateReport22 }
     * 
     * 
     */
    public List<TradeStateReport22> getStat() {
        if (stat == null) {
            stat = new ArrayList<TradeStateReport22>();
        }
        return this.stat;
    }
     ...
     * 
     */
    public TradeData58Choice addStat(TradeStateReport22 stat) {
        getStat().add(stat);
        return this;
    }
