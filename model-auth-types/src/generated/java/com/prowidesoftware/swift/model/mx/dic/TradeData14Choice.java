...
@XmlType(name = "TradeData14Choice", propOrder = {
    "dataSetActn",
    "rpt"
})
public class TradeData14Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Rpt")
    protected List<TradeData21> rpt;
     ...
     *     
     */
    public TradeData14Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * 
     */
    public TradeData14Choice addRpt(TradeData21 rpt) {
        getRpt().add(rpt);
        return this;
    }
