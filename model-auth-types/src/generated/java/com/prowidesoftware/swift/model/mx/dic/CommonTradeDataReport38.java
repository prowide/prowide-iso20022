...
@XmlType(name = "CommonTradeDataReport38", propOrder = {
    "ctrctData",
    "txData"
})
public class CommonTradeDataReport38 {

    @XmlElement(name = "CtrctData")
    protected ContractType8 ctrctData;
    @XmlElement(name = "TxData", required = true)
    protected TradeTransaction28 txData;
     ...
     *     
     */
    public CommonTradeDataReport38 setCtrctData(ContractType8 value) {
     ...
     * @return
     *     possible object is
     *     {@link TradeTransaction28 }
     *     
     */
    public TradeTransaction28 getTxData() {
        return txData;
    }
     ...
     *     
     */
    public CommonTradeDataReport38 setTxData(TradeTransaction28 value) {
        this.txData = value;
        return this;
    }
