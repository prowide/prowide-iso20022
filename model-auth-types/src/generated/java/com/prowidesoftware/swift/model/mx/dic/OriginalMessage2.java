...
@XmlType(name = "OriginalMessage2", propOrder = {
    "orgnlSndr",
    "orgnlMsgId",
    "orgnlMsgNmId",
    "orgnlCreDtTm",
...
public class OriginalMessage2 {
     ...
     *     
     */
    public OriginalMessage2 setOrgnlSndr(Party28Choice value) {
     ...
     *     
     */
    public OriginalMessage2 setOrgnlMsgId(String value) {
     ...
     *     
     */
    public OriginalMessage2 setOrgnlMsgNmId(String value) {
     ...
     *     
     */
    public OriginalMessage2 setOrgnlCreDtTm(OffsetDateTime value) {
     ...
     *     
     */
    public OriginalMessage2 setOrgnlPackgId(String value) {
     ...
     *     
     */
    public OriginalMessage2 setOrgnlRcrdId(String value) {
