...
@XmlType(name = "TradeData15Choice", propOrder = {
    "dataSetActn",
    "rpt"
})
public class TradeData15Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Rpt")
    protected List<TradeReport10Choice> rpt;
     ...
     *     
     */
    public TradeData15Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * {@link TradeReport10Choice }
     * 
     * 
     */
    public List<TradeReport10Choice> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<TradeReport10Choice>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public TradeData15Choice addRpt(TradeReport10Choice rpt) {
        getRpt().add(rpt);
        return this;
    }
