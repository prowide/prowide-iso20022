...
@XmlType(name = "TradeAdditionalQueryCriteria4", propOrder = {
    "actnTp",
    "exctnVn",
    "ntrOfCtrPty",
    "corpSctr"
})
public class TradeAdditionalQueryCriteria4 {
     ...
     *     
     */
    public TradeAdditionalQueryCriteria4 setExctnVn(SecuritiesTradeVenueCriteria1Choice value) {
        this.exctnVn = value;
        return this;
    }
    ...
    public List<CorporateSectorCriteria4> getCorpSctr() {
        if (corpSctr == null) {
            corpSctr = new ArrayList<CorporateSectorCriteria4>();
        }
     ...
     * 
     */
    public TradeAdditionalQueryCriteria4 addActnTp(TransactionOperationType3Code actnTp) {
     ...
     * 
     */
    public TradeAdditionalQueryCriteria4 addNtrOfCtrPty(PartyNatureType1Code ntrOfCtrPty) {
     ...
     * 
     */
    public TradeAdditionalQueryCriteria4 addCorpSctr(CorporateSectorCriteria4 corpSctr) {
