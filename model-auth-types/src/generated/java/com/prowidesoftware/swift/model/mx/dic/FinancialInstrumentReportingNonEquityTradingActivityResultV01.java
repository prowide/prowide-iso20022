...
@XmlType(name = "FinancialInstrumentReportingNonEquityTradingActivityResultV01", propOrder = {
    "rptHdr",
...
public class FinancialInstrumentReportingNonEquityTradingActivityResultV01 {
    ...
    protected List<TransparencyDataReport14> nonEqtyTrnsprncyData;
     ...
     *     
     */
    public FinancialInstrumentReportingNonEquityTradingActivityResultV01 setRptHdr(SecuritiesMarketReportHeader1 value) {
        this.rptHdr = value;
        return this;
    }
     ...
     * {@link TransparencyDataReport14 }
     * 
     * 
     */
    public List<TransparencyDataReport14> getNonEqtyTrnsprncyData() {
        if (nonEqtyTrnsprncyData == null) {
            nonEqtyTrnsprncyData = new ArrayList<TransparencyDataReport14>();
        }
     ...
     * 
     */
    public FinancialInstrumentReportingNonEquityTradingActivityResultV01 addNonEqtyTrnsprncyData(TransparencyDataReport14 nonEqtyTrnsprncyData) {
     ...
     * 
     */
    public FinancialInstrumentReportingNonEquityTradingActivityResultV01 addSplmtryData(SupplementaryData1 splmtryData) {
