...
@XmlType(name = "ForeignExchangeSwap3Choice", propOrder = {
    "dataSetActn",
    "tx"
})
public class ForeignExchangeSwap3Choice {
    ...
    @XmlElement(name = "Tx")
    protected List<ForeignExchangeSwapTransaction3> tx;
     ...
     *     
     */
    public ForeignExchangeSwap3Choice setDataSetActn(ReportPeriodActivity3Code value) {
     ...
     * {@link ForeignExchangeSwapTransaction3 }
     * 
     * 
     */
    public List<ForeignExchangeSwapTransaction3> getTx() {
        if (tx == null) {
            tx = new ArrayList<ForeignExchangeSwapTransaction3>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public ForeignExchangeSwap3Choice addTx(ForeignExchangeSwapTransaction3 tx) {
        getTx().add(tx);
        return this;
    }
