...
@XmlType(name = "TradeData62Choice", propOrder = {
    "dataSetActn",
    "stat"
})
public class TradeData62Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Stat")
    protected List<MarginReportData10> stat;
     ...
     *     
     */
    public TradeData62Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * {@link MarginReportData10 }
     * 
     * 
     */
    public List<MarginReportData10> getStat() {
        if (stat == null) {
            stat = new ArrayList<MarginReportData10>();
        }
        return this.stat;
    }
     ...
     * 
     */
    public TradeData62Choice addStat(MarginReportData10 stat) {
        getStat().add(stat);
        return this;
    }
