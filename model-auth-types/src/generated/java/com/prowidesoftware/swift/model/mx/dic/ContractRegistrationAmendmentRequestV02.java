...
@XmlType(name = "ContractRegistrationAmendmentRequestV02", propOrder = {
    "grpHdr",
    "ctrctRegnAmdmnt",
    "splmtryData"
})
public class ContractRegistrationAmendmentRequestV02 {

    @XmlElement(name = "GrpHdr", required = true)
    protected CurrencyControlHeader4 grpHdr;
    @XmlElement(name = "CtrctRegnAmdmnt", required = true)
    protected List<RegisteredContract9> ctrctRegnAmdmnt;
     ...
     *     
     */
    public ContractRegistrationAmendmentRequestV02 setGrpHdr(CurrencyControlHeader4 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link RegisteredContract9 }
     * 
     * 
     */
    public List<RegisteredContract9> getCtrctRegnAmdmnt() {
        if (ctrctRegnAmdmnt == null) {
            ctrctRegnAmdmnt = new ArrayList<RegisteredContract9>();
        }
     ...
     * 
     */
    public ContractRegistrationAmendmentRequestV02 addCtrctRegnAmdmnt(RegisteredContract9 ctrctRegnAmdmnt) {
     ...
     * 
     */
    public ContractRegistrationAmendmentRequestV02 addSplmtryData(SupplementaryData1 splmtryData) {
