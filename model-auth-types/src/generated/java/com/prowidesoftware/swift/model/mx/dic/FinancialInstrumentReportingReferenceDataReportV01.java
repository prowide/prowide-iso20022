...
public class FinancialInstrumentReportingReferenceDataReportV01 {
    ...
    protected List<SecuritiesReferenceDataReport5> refData;
     ...
     *     
     */
    public FinancialInstrumentReportingReferenceDataReportV01 setRptHdr(SecuritiesMarketReportHeader1 value) {
        this.rptHdr = value;
        return this;
    }
     ...
     */
    public List<SecuritiesReferenceDataReport5> getRefData() {
        if (refData == null) {
     ...
     * 
     */
    public FinancialInstrumentReportingReferenceDataReportV01 addRefData(SecuritiesReferenceDataReport5 refData) {
     ...
     * 
     */
    public FinancialInstrumentReportingReferenceDataReportV01 addSplmtryData(SupplementaryData1 splmtryData) {
