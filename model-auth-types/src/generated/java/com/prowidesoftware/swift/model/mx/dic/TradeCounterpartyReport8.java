...
@XmlType(name = "TradeCounterpartyReport8", propOrder = {
    "rptgCtrPty",
    "othrCtrPty",
    "brkr",
    "submitgAgt",
...
public class TradeCounterpartyReport8 {

    @XmlElement(name = "RptgCtrPty", required = true)
    protected Counterparty25 rptgCtrPty;
     ...
     *     
     */
    public Counterparty25 getRptgCtrPty() {
        return rptgCtrPty;
    }
     ...
     *     
     */
    public TradeCounterpartyReport8 setRptgCtrPty(Counterparty25 value) {
     ...
     *     
     */
    public TradeCounterpartyReport8 setOthrCtrPty(Counterparty28 value) {
     ...
     *     
     */
    public TradeCounterpartyReport8 setBrkr(OrganisationIdentification9Choice value) {
        this.brkr = value;
        return this;
    }
     ...
     *     
     */
    public TradeCounterpartyReport8 setSubmitgAgt(OrganisationIdentification9Choice value) {
     ...
     *     
     */
    public TradeCounterpartyReport8 setClrMmb(OrganisationIdentification9Choice value) {
        this.clrMmb = value;
        return this;
    }
     ...
     *     
     */
    public TradeCounterpartyReport8 setBnfcry(OrganisationIdentification9Choice value) {
        this.bnfcry = value;
        return this;
    }
