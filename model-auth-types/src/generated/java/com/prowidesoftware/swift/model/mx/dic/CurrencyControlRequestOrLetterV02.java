...
@XmlType(name = "CurrencyControlRequestOrLetterV02", propOrder = {
    "grpHdr",
    "reqOrLttr",
    "splmtryData"
})
public class CurrencyControlRequestOrLetterV02 {

    @XmlElement(name = "GrpHdr", required = true)
    protected CurrencyControlHeader5 grpHdr;
    @XmlElement(name = "ReqOrLttr", required = true)
    protected List<SupportingDocumentRequestOrLetter2> reqOrLttr;
     ...
     *     
     */
    public CurrencyControlRequestOrLetterV02 setGrpHdr(CurrencyControlHeader5 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link SupportingDocumentRequestOrLetter2 }
     * 
     * 
     */
    public List<SupportingDocumentRequestOrLetter2> getReqOrLttr() {
        if (reqOrLttr == null) {
            reqOrLttr = new ArrayList<SupportingDocumentRequestOrLetter2>();
        }
     ...
     * 
     */
    public CurrencyControlRequestOrLetterV02 addReqOrLttr(SupportingDocumentRequestOrLetter2 reqOrLttr) {
     ...
     * 
     */
    public CurrencyControlRequestOrLetterV02 addSplmtryData(SupplementaryData1 splmtryData) {
