...
@XmlType(name = "TradeData11Choice", propOrder = {
    "dataSetActn",
    "rpt"
})
public class TradeData11Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Rpt")
    protected List<TradeData20> rpt;
     ...
     *     
     */
    public TradeData11Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * 
     */
    public List<TradeData20> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<TradeData20>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public TradeData11Choice addRpt(TradeData20 rpt) {
        getRpt().add(rpt);
        return this;
    }
