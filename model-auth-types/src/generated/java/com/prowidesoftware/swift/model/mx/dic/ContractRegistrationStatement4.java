...
@XmlType(name = "ContractRegistrationStatement4", propOrder = {
    "stmtId",
    "rptgPty",
    "regnAgt",
    "rptgPrd",
...
public class ContractRegistrationStatement4 {
    ...
    protected RegisteredContract18 regdCtrct;
    @XmlElement(name = "TxJrnl")
    protected List<TransactionCertificate4> txJrnl;
    @XmlElement(name = "SpprtgDocJrnl")
    protected List<SupportingDocument4> spprtgDocJrnl;
    @XmlElement(name = "AddtlSpprtgDocJrnl")
    protected List<SupportingDocument4> addtlSpprtgDocJrnl;
     ...
     *     
     */
    public ContractRegistrationStatement4 setStmtId(String value) {
        this.stmtId = value;
        return this;
    }
     ...
     *     
     */
    public ContractRegistrationStatement4 setRptgPty(TradeParty6 value) {
        this.rptgPty = value;
        return this;
    }
     ...
     *     
     */
    public ContractRegistrationStatement4 setRegnAgt(BranchAndFinancialInstitutionIdentification8 value) {
        this.regnAgt = value;
        return this;
    }
     ...
     *     
     */
    public ContractRegistrationStatement4 setRptgPrd(ReportingPeriod4 value) {
        this.rptgPrd = value;
        return this;
    }
     ...
     * @return
     *     possible object is
     *     {@link RegisteredContract18 }
     *     
     */
    public RegisteredContract18 getRegdCtrct() {
        return regdCtrct;
    }
     ...
     *     
     */
    public ContractRegistrationStatement4 setRegdCtrct(RegisteredContract18 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SupportingDocument4 }
     * 
     * 
     */
    public List<SupportingDocument4> getSpprtgDocJrnl() {
        if (spprtgDocJrnl == null) {
            spprtgDocJrnl = new ArrayList<SupportingDocument4>();
        }
     ...
     * 
     */
    public List<SupportingDocument4> getAddtlSpprtgDocJrnl() {
        if (addtlSpprtgDocJrnl == null) {
            addtlSpprtgDocJrnl = new ArrayList<SupportingDocument4>();
        }
     ...
     *     
     */
    public ContractRegistrationStatement4 setTtlCtrctTrnvrSum(ActiveCurrencyAndAmount value) {
     ...
     * 
     */
    public ContractRegistrationStatement4 addTxJrnl(TransactionCertificate4 txJrnl) {
     ...
     * 
     */
    public ContractRegistrationStatement4 addSpprtgDocJrnl(SupportingDocument4 spprtgDocJrnl) {
     ...
     * 
     */
    public ContractRegistrationStatement4 addAddtlSpprtgDocJrnl(SupportingDocument4 addtlSpprtgDocJrnl) {
     ...
     * 
     */
    public ContractRegistrationStatement4 addRgltryRuleVldtn(GenericValidationRuleIdentification1 rgltryRuleVldtn) {
     ...
     * 
     */
    public ContractRegistrationStatement4 addSplmtryData(SupplementaryData1 splmtryData) {
