...
@XmlType(name = "CurrencyControlStatusAdviceV02", propOrder = {
    "grpHdr",
    "grpSts",
    "packgSts",
    "splmtryData"
})
public class CurrencyControlStatusAdviceV02 {
     ...
     *     
     */
    public CurrencyControlStatusAdviceV02 setGrpHdr(CurrencyControlHeader6 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * 
     */
    public CurrencyControlStatusAdviceV02 addGrpSts(CurrencyControlGroupStatus2 grpSts) {
     ...
     * 
     */
    public CurrencyControlStatusAdviceV02 addPackgSts(CurrencyControlPackageStatus2 packgSts) {
     ...
     * 
     */
    public CurrencyControlStatusAdviceV02 addSplmtryData(SupplementaryData1 splmtryData) {
