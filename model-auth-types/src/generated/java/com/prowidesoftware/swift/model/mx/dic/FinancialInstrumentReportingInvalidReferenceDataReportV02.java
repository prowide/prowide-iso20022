...
public class FinancialInstrumentReportingInvalidReferenceDataReportV02 {
     ...
     *     
     */
    public FinancialInstrumentReportingInvalidReferenceDataReportV02 setDtPrd(Period4Choice value) {
        this.dtPrd = value;
        return this;
    }
     ...
     *     
     */
    public FinancialInstrumentReportingInvalidReferenceDataReportV02 setNbOfRcrds(BigDecimal value) {
     ...
     * This is why there is not a <CODE>set</CODE> method for the finInstrms property.
     * 
     * <p>
    ...
    public List<SecuritiesInvalidReferenceDataReport4> getFinInstrms() {
        if (finInstrms == null) {
            finInstrms = new ArrayList<SecuritiesInvalidReferenceDataReport4>();
        }
     ...
     * 
     */
    public FinancialInstrumentReportingInvalidReferenceDataReportV02 addFinInstrms(SecuritiesInvalidReferenceDataReport4 finInstrms) {
     ...
     * 
     */
    public FinancialInstrumentReportingInvalidReferenceDataReportV02 addSplmtryData(SupplementaryData1 splmtryData) {
