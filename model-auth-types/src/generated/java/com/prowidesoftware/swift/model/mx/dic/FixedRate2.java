...
@XmlType(name = "FixedRate2", propOrder = {
    "rate",
    "dayCntBsis"
})
public class FixedRate2 {
     ...
     *     
     */
    public FixedRate2 setRate(BigDecimal value) {
        this.rate = value;
        return this;
    }
     ...
     *     
     */
    public FixedRate2 setDayCntBsis(InterestComputationMethodFormat6Choice value) {
