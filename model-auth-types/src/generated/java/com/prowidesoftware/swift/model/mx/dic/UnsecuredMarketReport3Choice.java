...
@XmlType(name = "UnsecuredMarketReport3Choice", propOrder = {
    "dataSetActn",
    "tx"
})
public class UnsecuredMarketReport3Choice {
    ...
    @XmlElement(name = "Tx")
    protected List<UnsecuredMarketTransaction3> tx;
     ...
     *     
     */
    public UnsecuredMarketReport3Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * {@link UnsecuredMarketTransaction3 }
     * 
     * 
     */
    public List<UnsecuredMarketTransaction3> getTx() {
        if (tx == null) {
            tx = new ArrayList<UnsecuredMarketTransaction3>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public UnsecuredMarketReport3Choice addTx(UnsecuredMarketTransaction3 tx) {
        getTx().add(tx);
        return this;
    }
