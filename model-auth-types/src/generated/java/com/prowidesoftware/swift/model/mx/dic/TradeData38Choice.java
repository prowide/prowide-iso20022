...
@XmlType(name = "TradeData38Choice", propOrder = {
    "dataSetActn",
    "stat"
})
public class TradeData38Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Stat")
    protected List<CollateralMarginNew10> stat;
     ...
     *     
     */
    public TradeData38Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * {@link CollateralMarginNew10 }
     * 
     * 
     */
    public List<CollateralMarginNew10> getStat() {
        if (stat == null) {
            stat = new ArrayList<CollateralMarginNew10>();
        }
        return this.stat;
    }
     ...
     * 
     */
    public TradeData38Choice addStat(CollateralMarginNew10 stat) {
        getStat().add(stat);
        return this;
    }
