...
@XmlType(name = "TradeData61Choice", propOrder = {
    "dataSetActn",
    "rpt"
})
public class TradeData61Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Rpt")
    protected List<TradeReport34Choice> rpt;
     ...
     *     
     */
    public TradeData61Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * {@link TradeReport34Choice }
     * 
     * 
     */
    public List<TradeReport34Choice> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<TradeReport34Choice>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public TradeData61Choice addRpt(TradeReport34Choice rpt) {
        getRpt().add(rpt);
        return this;
    }
