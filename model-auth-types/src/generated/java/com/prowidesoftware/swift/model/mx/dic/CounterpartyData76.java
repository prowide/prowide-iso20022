...
@XmlType(name = "CounterpartyData76", propOrder = {
    "rptgDtTm",
    "rptSubmitgNtty",
    "ctrPtyData"
})
public class CounterpartyData76 {
    ...
    protected List<CounterpartyData77> ctrPtyData;
     ...
     *     
     */
    public CounterpartyData76 setRptgDtTm(Calendar value) {
        this.rptgDtTm = value;
        return this;
    }
     ...
     *     
     */
    public CounterpartyData76 setRptSubmitgNtty(OrganisationIdentification9Choice value) {
     ...
     * 
     */
    public CounterpartyData76 addCtrPtyData(CounterpartyData77 ctrPtyData) {
