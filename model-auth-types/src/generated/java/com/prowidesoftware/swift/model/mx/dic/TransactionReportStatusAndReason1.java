...
/**
 * Information about report and transaction statistics.
 * 
 * 
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "TransactionReportStatusAndReason1", propOrder = {
    "rptSttstcs",
    "txSttstcs",
    "splmtryData"
})
public class TransactionReportStatusAndReason1 {
    ...
    protected List<DetailedTransactionStatistics6> txSttstcs;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DetailedTransactionStatistics6 }
     * 
     * 
     */
    public List<DetailedTransactionStatistics6> getTxSttstcs() {
        if (txSttstcs == null) {
            txSttstcs = new ArrayList<DetailedTransactionStatistics6>();
        }
     ...
     * 
     */
    public TransactionReportStatusAndReason1 addRptSttstcs(DetailedReportStatistics5 rptSttstcs) {
     ...
     * 
     */
    public TransactionReportStatusAndReason1 addTxSttstcs(DetailedTransactionStatistics6 txSttstcs) {
     ...
     * 
     */
    public TransactionReportStatusAndReason1 addSplmtryData(SupplementaryData1 splmtryData) {
