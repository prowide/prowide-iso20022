...
public class ContractRegistrationRequestV03 {
     ...
     *     
     */
    public ContractRegistrationRequestV03 setGrpHdr(CurrencyControlHeader4 value) {
        this.grpHdr = value;
        return this;
    }
    ...
    public List<ContractRegistration5> getCtrctRegn() {
        if (ctrctRegn == null) {
            ctrctRegn = new ArrayList<ContractRegistration5>();
        }
     ...
     * 
     */
    public ContractRegistrationRequestV03 addCtrctRegn(ContractRegistration5 ctrctRegn) {
     ...
     * 
     */
    public ContractRegistrationRequestV03 addSplmtryData(SupplementaryData1 splmtryData) {
