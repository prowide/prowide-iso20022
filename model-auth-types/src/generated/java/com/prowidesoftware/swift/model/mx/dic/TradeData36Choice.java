...
@XmlType(name = "TradeData36Choice", propOrder = {
    "dataSetActn",
    "rpt"
})
public class TradeData36Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Rpt")
    protected List<ReuseDataReport6Choice> rpt;
     ...
     *     
     */
    public TradeData36Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * {@link ReuseDataReport6Choice }
     * 
     * 
     */
    public List<ReuseDataReport6Choice> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<ReuseDataReport6Choice>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public TradeData36Choice addRpt(ReuseDataReport6Choice rpt) {
        getRpt().add(rpt);
        return this;
    }
