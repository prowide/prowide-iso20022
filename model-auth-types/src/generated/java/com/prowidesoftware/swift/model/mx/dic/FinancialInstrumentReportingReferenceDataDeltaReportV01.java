...
public class FinancialInstrumentReportingReferenceDataDeltaReportV01 {
    ...
    protected List<SecuritiesReferenceDeltaStatusReport2Choice> finInstrm;
     ...
     *     
     */
    public FinancialInstrumentReportingReferenceDataDeltaReportV01 setRptHdr(SecuritiesMarketReportHeader1 value) {
        this.rptHdr = value;
        return this;
    }
     ...
     * {@link SecuritiesReferenceDeltaStatusReport2Choice }
     * 
     * 
     */
    public List<SecuritiesReferenceDeltaStatusReport2Choice> getFinInstrm() {
        if (finInstrm == null) {
            finInstrm = new ArrayList<SecuritiesReferenceDeltaStatusReport2Choice>();
        }
     ...
     * 
     */
    public FinancialInstrumentReportingReferenceDataDeltaReportV01 addFinInstrm(SecuritiesReferenceDeltaStatusReport2Choice finInstrm) {
     ...
     * 
     */
    public FinancialInstrumentReportingReferenceDataDeltaReportV01 addSplmtryData(SupplementaryData1 splmtryData) {
