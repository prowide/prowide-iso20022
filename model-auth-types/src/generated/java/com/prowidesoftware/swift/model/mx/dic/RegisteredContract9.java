...
@XmlType(name = "RegisteredContract9", propOrder = {
    "ctrctRegnAmdmntId",
    "rptgPty",
    "regnAgt",
    "regdCtrctAmdmnt",
...
public class RegisteredContract9 {
    ...
    protected List<RegisteredContract10> regdCtrctAmdmnt;
     ...
     *     
     */
    public RegisteredContract9 setCtrctRegnAmdmntId(String value) {
     ...
     *     
     */
    public RegisteredContract9 setRptgPty(TradeParty5 value) {
        this.rptgPty = value;
        return this;
    }
     ...
     *     
     */
    public RegisteredContract9 setRegnAgt(BranchAndFinancialInstitutionIdentification6 value) {
        this.regnAgt = value;
        return this;
    }
     ...
     * {@link RegisteredContract10 }
     * 
     * 
     */
    public List<RegisteredContract10> getRegdCtrctAmdmnt() {
        if (regdCtrctAmdmnt == null) {
            regdCtrctAmdmnt = new ArrayList<RegisteredContract10>();
        }
     ...
     * 
     */
    public RegisteredContract9 addRegdCtrctAmdmnt(RegisteredContract10 regdCtrctAmdmnt) {
     ...
     * 
     */
    public RegisteredContract9 addSplmtryData(SupplementaryData1 splmtryData) {
