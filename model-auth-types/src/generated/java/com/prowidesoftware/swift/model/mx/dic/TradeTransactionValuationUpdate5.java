...
@XmlType(name = "TradeTransactionValuationUpdate5", propOrder = {
    "ctrPtySpcfcData",
    "cmonTradData",
    "techAttrbts",
    "splmtryData"
})
public class TradeTransactionValuationUpdate5 {
    ...
    public List<CounterpartySpecificData23> getCtrPtySpcfcData() {
        if (ctrPtySpcfcData == null) {
            ctrPtySpcfcData = new ArrayList<CounterpartySpecificData23>();
        }
     ...
     *     
     */
    public TradeTransactionValuationUpdate5 setCmonTradData(CommonTradeDataReport36 value) {
     ...
     *     
     */
    public TradeTransactionValuationUpdate5 setTechAttrbts(TechnicalAttributes1 value) {
     ...
     * 
     */
    public TradeTransactionValuationUpdate5 addCtrPtySpcfcData(CounterpartySpecificData23 ctrPtySpcfcData) {
     ...
     * 
     */
    public TradeTransactionValuationUpdate5 addSplmtryData(SupplementaryData1 splmtryData) {
