...
public class RegulatoryReportingNotification3 {
     ...
     *     
     */
    public RegulatoryReportingNotification3 setTxNtfctnId(String value) {
     ...
     *     
     */
    public RegulatoryReportingNotification3 setAcctOwnr(PartyIdentification135 value) {
        this.acctOwnr = value;
        return this;
    }
     ...
     *     
     */
    public RegulatoryReportingNotification3 setAcctSvcr(BranchAndFinancialInstitutionIdentification6 value) {
        this.acctSvcr = value;
        return this;
    }
    ...
    public List<TransactionCertificate4> getTxCert() {
        if (txCert == null) {
            txCert = new ArrayList<TransactionCertificate4>();
        }
        return this.txCert;
    }
     ...
     * 
     */
    public RegulatoryReportingNotification3 addTxCert(TransactionCertificate4 txCert) {
