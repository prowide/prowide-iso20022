...
@XmlType(name = "TradeData12Choice", propOrder = {
    "dataSetActn",
    "rpt"
})
public class TradeData12Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Rpt")
    protected List<ReuseDataReportCorrection9> rpt;
     ...
     *     
     */
    public TradeData12Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * {@link ReuseDataReportCorrection9 }
     * 
     * 
     */
    public List<ReuseDataReportCorrection9> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<ReuseDataReportCorrection9>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public TradeData12Choice addRpt(ReuseDataReportCorrection9 rpt) {
        getRpt().add(rpt);
        return this;
    }
