...
@XmlType(name = "TradeNewTransaction10", propOrder = {
    "ctrPtySpcfcData",
    "cmonTradData",
    "techAttrbts",
    "splmtryData"
})
public class TradeNewTransaction10 {
     ...
     *     
     */
    public TradeNewTransaction10 setCmonTradData(CommonTradeDataReport38 value) {
     ...
     *     
     */
    public TradeNewTransaction10 setTechAttrbts(TechnicalAttributes1 value) {
     ...
     * 
     */
    public TradeNewTransaction10 addCtrPtySpcfcData(CounterpartySpecificData24 ctrPtySpcfcData) {
     ...
     * 
     */
    public TradeNewTransaction10 addSplmtryData(SupplementaryData1 splmtryData) {
