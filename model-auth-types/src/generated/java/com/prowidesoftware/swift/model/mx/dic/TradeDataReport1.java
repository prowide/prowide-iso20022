...
@XmlType(name = "TradeDataReport1", propOrder = {
    "ctrPtySpcfcData",
    "cmonTradData",
    "techAttrbts",
    "splmtryData"
})
public class TradeDataReport1 {
    ...
    protected CommonTradeDataReport34 cmonTradData;
     ...
     * @return
     *     possible object is
     *     {@link CommonTradeDataReport34 }
     *     
     */
    public CommonTradeDataReport34 getCmonTradData() {
        return cmonTradData;
    }
     ...
     *     
     */
    public TradeDataReport1 setCmonTradData(CommonTradeDataReport34 value) {
     ...
     *     
     */
    public TradeDataReport1 setTechAttrbts(TechnicalAttributes1 value) {
     ...
     * 
     */
    public TradeDataReport1 addCtrPtySpcfcData(CounterpartySpecificData22 ctrPtySpcfcData) {
     ...
     * 
     */
    public TradeDataReport1 addSplmtryData(SupplementaryData1 splmtryData) {
