...
public class PartyIdentification195 {
     ...
     * This is why there is not a <CODE>set</CODE> method for the fndMgmtCpnyAuthrtyRegnNb property.
     * 
     * <p>
    ...
    public List<GenericOrganisationIdentification1> getFndMgmtCpnyAuthrtyRegnNb() {
        if (fndMgmtCpnyAuthrtyRegnNb == null) {
            fndMgmtCpnyAuthrtyRegnNb = new ArrayList<GenericOrganisationIdentification1>();
        }
