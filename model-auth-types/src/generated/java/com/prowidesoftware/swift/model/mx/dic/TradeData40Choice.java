...
@XmlType(name = "TradeData40Choice", propOrder = {
    "dataSetActn",
    "rpt"
})
public class TradeData40Choice {

    @XmlElement(name = "DataSetActn")
    @XmlSchemaType(name = "string")
    protected ReportPeriodActivity1Code dataSetActn;
    @XmlElement(name = "Rpt")
    protected List<TradeReport22Choice> rpt;
     ...
     *     
     */
    public TradeData40Choice setDataSetActn(ReportPeriodActivity1Code value) {
     ...
     * {@link TradeReport22Choice }
     * 
     * 
     */
    public List<TradeReport22Choice> getRpt() {
        if (rpt == null) {
            rpt = new ArrayList<TradeReport22Choice>();
        }
        return this.rpt;
    }
     ...
     * 
     */
    public TradeData40Choice addRpt(TradeReport22Choice rpt) {
        getRpt().add(rpt);
        return this;
    }
