...
@XmlType(name = "PaymentRegulatoryInformationNotificationV04", propOrder = {
    "grpHdr",
    "txNtfctn",
    "splmtryData"
})
public class PaymentRegulatoryInformationNotificationV04 {

    @XmlElement(name = "GrpHdr", required = true)
    protected CurrencyControlHeader9 grpHdr;
    @XmlElement(name = "TxNtfctn", required = true)
    protected List<RegulatoryReportingNotification4> txNtfctn;
     ...
     *     
     */
    public PaymentRegulatoryInformationNotificationV04 setGrpHdr(CurrencyControlHeader9 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link RegulatoryReportingNotification4 }
     * 
     * 
     */
    public List<RegulatoryReportingNotification4> getTxNtfctn() {
        if (txNtfctn == null) {
            txNtfctn = new ArrayList<RegulatoryReportingNotification4>();
        }
     ...
     * 
     */
    public PaymentRegulatoryInformationNotificationV04 addTxNtfctn(RegulatoryReportingNotification4 txNtfctn) {
     ...
     * 
     */
    public PaymentRegulatoryInformationNotificationV04 addSplmtryData(SupplementaryData1 splmtryData) {
