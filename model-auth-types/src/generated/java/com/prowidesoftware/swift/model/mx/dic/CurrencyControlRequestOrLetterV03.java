...
@XmlType(name = "CurrencyControlRequestOrLetterV03", propOrder = {
    "grpHdr",
    "reqOrLttr",
    "splmtryData"
})
public class CurrencyControlRequestOrLetterV03 {

    @XmlElement(name = "GrpHdr", required = true)
    protected CurrencyControlHeader5 grpHdr;
    @XmlElement(name = "ReqOrLttr", required = true)
    protected List<SupportingDocumentRequestOrLetter3> reqOrLttr;
     ...
     *     
     */
    public CurrencyControlRequestOrLetterV03 setGrpHdr(CurrencyControlHeader5 value) {
        this.grpHdr = value;
        return this;
    }
     ...
     * {@link SupportingDocumentRequestOrLetter3 }
     * 
     * 
     */
    public List<SupportingDocumentRequestOrLetter3> getReqOrLttr() {
        if (reqOrLttr == null) {
            reqOrLttr = new ArrayList<SupportingDocumentRequestOrLetter3>();
        }
     ...
     * 
     */
    public CurrencyControlRequestOrLetterV03 addReqOrLttr(SupportingDocumentRequestOrLetter3 reqOrLttr) {
     ...
     * 
     */
    public CurrencyControlRequestOrLetterV03 addSplmtryData(SupplementaryData1 splmtryData) {
