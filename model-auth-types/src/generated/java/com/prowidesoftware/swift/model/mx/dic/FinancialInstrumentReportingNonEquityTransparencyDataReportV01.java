...
@XmlType(name = "FinancialInstrumentReportingNonEquityTransparencyDataReportV01", propOrder = {
    "rptHdr",
...
public class FinancialInstrumentReportingNonEquityTransparencyDataReportV01 {
    ...
    protected List<TransparencyDataReport10> nonEqtyTrnsprncyData;
     ...
     *     
     */
    public FinancialInstrumentReportingNonEquityTransparencyDataReportV01 setRptHdr(SecuritiesMarketReportHeader1 value) {
        this.rptHdr = value;
        return this;
    }
     ...
     * {@link TransparencyDataReport10 }
     * 
     * 
     */
    public List<TransparencyDataReport10> getNonEqtyTrnsprncyData() {
        if (nonEqtyTrnsprncyData == null) {
            nonEqtyTrnsprncyData = new ArrayList<TransparencyDataReport10>();
        }
     ...
     * 
     */
    public FinancialInstrumentReportingNonEquityTransparencyDataReportV01 addNonEqtyTrnsprncyData(TransparencyDataReport10 nonEqtyTrnsprncyData) {
     ...
     * 
     */
    public FinancialInstrumentReportingNonEquityTransparencyDataReportV01 addSplmtryData(SupplementaryData1 splmtryData) {
