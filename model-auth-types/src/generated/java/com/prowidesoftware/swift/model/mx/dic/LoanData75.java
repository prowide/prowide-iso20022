...
@XmlType(name = "LoanData75", propOrder = {
    "unqTradIdr",
    "evtDt",
    "exctnDtTm",
    "tradgVn",
...
public class LoanData75 {
     ...
     *     
     */
    public LoanData75 setUnqTradIdr(String value) {
     ...
     *     
     */
    public LoanData75 setEvtDt(XMLGregorianCalendar value) {
        this.evtDt = value;
        return this;
    }
     ...
     *     
     */
    public LoanData75 setExctnDtTm(XMLGregorianCalendar value) {
     ...
     *     
     */
    public LoanData75 setTradgVn(String value) {
        this.tradgVn = value;
        return this;
    }
     ...
     *     
     */
    public LoanData75 setCollDlvryMtd(CollateralDeliveryMethod1Code value) {
     ...
     *     
     */
    public LoanData75 setOutsdngMrgnLnAmt(ActiveOrHistoricCurrencyAndAmount value) {
     ...
     *     
     */
    public LoanData75 setShrtMktValAmt(ActiveOrHistoricCurrencyAndAmount value) {
    ...
    public List<InterestRate3> getMrgnLnAttr() {
        if (mrgnLnAttr == null) {
            mrgnLnAttr = new ArrayList<InterestRate3>();
        }
     ...
     *     
     */
    public LoanData75 setTermntnDt(XMLGregorianCalendar value) {
     ...
     * 
     */
    public LoanData75 addMrgnLnAttr(InterestRate3 mrgnLnAttr) {
