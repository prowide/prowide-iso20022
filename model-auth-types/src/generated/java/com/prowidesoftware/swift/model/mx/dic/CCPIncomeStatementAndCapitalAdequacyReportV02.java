 ...
 * 
 * V02 adds a clearing member id to break down the ClrFees by the clearing member from whom the fee income is being received. The change is motivated by a supervisory need to understand from which jurisdictions clearing fees are paid to the CCP.
 * 
 * 
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "CCPIncomeStatementAndCapitalAdequacyReportV02", propOrder = {
    "incmStmt",
    "cptlRqrmnts",
    "ttlCptl",
    "lqdFinRsrcs",
...
public class CCPIncomeStatementAndCapitalAdequacyReportV02 {

    @XmlElement(name = "IncmStmt", required = true)
    protected IncomeStatement2 incmStmt;
     ...
     * @return
     *     possible object is
     *     {@link IncomeStatement2 }
     *     
     */
    public IncomeStatement2 getIncmStmt() {
        return incmStmt;
    }
     ...
     *     
     */
    public CCPIncomeStatementAndCapitalAdequacyReportV02 setIncmStmt(IncomeStatement2 value) {
        this.incmStmt = value;
        return this;
    }
     ...
     *     
     */
    public CCPIncomeStatementAndCapitalAdequacyReportV02 setCptlRqrmnts(CapitalRequirement1 value) {
     ...
     *     
     */
    public CCPIncomeStatementAndCapitalAdequacyReportV02 setTtlCptl(ActiveCurrencyAndAmount value) {
        this.ttlCptl = value;
        return this;
    }
     ...
     *     
     */
    public CCPIncomeStatementAndCapitalAdequacyReportV02 setLqdFinRsrcs(ActiveCurrencyAndAmount value) {
     ...
     * 
     */
    public CCPIncomeStatementAndCapitalAdequacyReportV02 addHpthtclCptlMeasr(HypotheticalCapitalMeasure1 hpthtclCptlMeasr) {
     ...
     * 
     */
    public CCPIncomeStatementAndCapitalAdequacyReportV02 addSplmtryData(SupplementaryData1 splmtryData) {
