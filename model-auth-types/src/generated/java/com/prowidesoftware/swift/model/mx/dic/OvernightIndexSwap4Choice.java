...
@XmlType(name = "OvernightIndexSwap4Choice", propOrder = {
    "dataSetActn",
    "tx"
})
public class OvernightIndexSwap4Choice {
    ...
    @XmlElement(name = "Tx")
    protected List<OvernightIndexSwapTransaction4> tx;
     ...
     *     
     */
    public OvernightIndexSwap4Choice setDataSetActn(ReportPeriodActivity3Code value) {
     ...
     * {@link OvernightIndexSwapTransaction4 }
     * 
     * 
     */
    public List<OvernightIndexSwapTransaction4> getTx() {
        if (tx == null) {
            tx = new ArrayList<OvernightIndexSwapTransaction4>();
        }
        return this.tx;
    }
     ...
     * 
     */
    public OvernightIndexSwap4Choice addTx(OvernightIndexSwapTransaction4 tx) {
        getTx().add(tx);
        return this;
    }
