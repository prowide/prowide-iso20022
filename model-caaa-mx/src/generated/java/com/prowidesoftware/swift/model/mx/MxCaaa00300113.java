    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00300113 parse(String xml) {
        return ((MxCaaa00300113) MxReadImpl.parse(MxCaaa00300113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00300113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300113) MxReadImpl.parse(MxCaaa00300113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00300113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00300113 .class);
    }
