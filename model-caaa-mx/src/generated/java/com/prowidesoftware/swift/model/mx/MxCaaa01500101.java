    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01500101 parse(String xml) {
        return ((MxCaaa01500101) MxReadImpl.parse(MxCaaa01500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01500101) MxReadImpl.parse(MxCaaa01500101 .class, xml, _classes, new MxReadParams(conf)));
    }
