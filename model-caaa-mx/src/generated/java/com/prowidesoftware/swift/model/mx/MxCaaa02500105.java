    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02500105 parse(String xml) {
        return ((MxCaaa02500105) MxReadImpl.parse(MxCaaa02500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02500105) MxReadImpl.parse(MxCaaa02500105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02500105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02500105 .class);
    }
