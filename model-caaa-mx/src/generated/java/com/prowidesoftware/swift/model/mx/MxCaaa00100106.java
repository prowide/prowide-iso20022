    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.001.001.06";
    ...
    public static MxCaaa00100106 parse(String xml) {
        return ((MxCaaa00100106) MxReadImpl.parse(MxCaaa00100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00100106) MxReadImpl.parse(MxCaaa00100106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00100106 fromJson(String json) {
