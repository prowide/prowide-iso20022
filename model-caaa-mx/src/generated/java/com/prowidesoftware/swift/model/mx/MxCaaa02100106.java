...
/**
 * Class for caaa.021.001.06 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02100106(final String xml) {
        this();
        MxCaaa02100106 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02100106(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link TransactionAdviceResponseV06 }
     *     
     */
    public TransactionAdviceResponseV06 getTxAdvcRspn() {
        return txAdvcRspn;
    }
     ...
     *     
     */
    public MxCaaa02100106 setTxAdvcRspn(TransactionAdviceResponseV06 value) {
     ...
     * 
     */
    public static MxCaaa02100106 parse(String xml) {
        return ((MxCaaa02100106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02100106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02100106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02100106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02100106 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02100106) parserImpl.read(MxCaaa02100106 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02100106 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02100106 message
     * @return
     *     a new instance of MxCaaa02100106
     */
    public final static MxCaaa02100106 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02100106 .class);
    }
