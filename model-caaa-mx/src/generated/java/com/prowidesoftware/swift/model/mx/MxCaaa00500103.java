    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00500103 parse(String xml) {
        return ((MxCaaa00500103) MxReadImpl.parse(MxCaaa00500103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00500103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00500103) MxReadImpl.parse(MxCaaa00500103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00500103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00500103 .class);
    }
