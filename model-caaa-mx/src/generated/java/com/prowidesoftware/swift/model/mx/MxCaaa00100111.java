    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00100111 parse(String xml) {
        return ((MxCaaa00100111) MxReadImpl.parse(MxCaaa00100111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00100111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00100111) MxReadImpl.parse(MxCaaa00100111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00100111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00100111 .class);
    }
