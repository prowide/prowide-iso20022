    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.019.001.02";
    ...
    public static MxCaaa01900102 parse(String xml) {
        return ((MxCaaa01900102) MxReadImpl.parse(MxCaaa01900102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01900102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01900102) MxReadImpl.parse(MxCaaa01900102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01900102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01900102 .class);
    }
