    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.012.001.12";
    ...
    public static MxCaaa01200112 parse(String xml) {
        return ((MxCaaa01200112) MxReadImpl.parse(MxCaaa01200112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01200112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01200112) MxReadImpl.parse(MxCaaa01200112 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01200112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01200112 .class);
    }
