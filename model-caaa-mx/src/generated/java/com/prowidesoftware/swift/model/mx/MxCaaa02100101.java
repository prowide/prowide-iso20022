    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.021.001.01";
    ...
    public static MxCaaa02100101 parse(String xml) {
        return ((MxCaaa02100101) MxReadImpl.parse(MxCaaa02100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02100101) MxReadImpl.parse(MxCaaa02100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa02100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02100101 .class);
    }
