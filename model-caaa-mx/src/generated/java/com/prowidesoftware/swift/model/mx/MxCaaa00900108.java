    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.009.001.08";
    ...
    public static MxCaaa00900108 parse(String xml) {
        return ((MxCaaa00900108) MxReadImpl.parse(MxCaaa00900108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00900108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900108) MxReadImpl.parse(MxCaaa00900108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00900108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00900108 .class);
    }
