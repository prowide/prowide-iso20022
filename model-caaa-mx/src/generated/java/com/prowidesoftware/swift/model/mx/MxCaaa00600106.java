    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.006.001.06";
    ...
    public static MxCaaa00600106 parse(String xml) {
        return ((MxCaaa00600106) MxReadImpl.parse(MxCaaa00600106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00600106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00600106) MxReadImpl.parse(MxCaaa00600106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00600106 fromJson(String json) {
