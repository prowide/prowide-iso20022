    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01100109 parse(String xml) {
        return ((MxCaaa01100109) MxReadImpl.parse(MxCaaa01100109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01100109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01100109) MxReadImpl.parse(MxCaaa01100109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01100109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01100109 .class);
    }
