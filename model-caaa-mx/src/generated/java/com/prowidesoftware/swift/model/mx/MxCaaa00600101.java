    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.006.001.01";
    ...
    public static MxCaaa00600101 parse(String xml) {
        return ((MxCaaa00600101) MxReadImpl.parse(MxCaaa00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00600101) MxReadImpl.parse(MxCaaa00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00600101 .class);
    }
