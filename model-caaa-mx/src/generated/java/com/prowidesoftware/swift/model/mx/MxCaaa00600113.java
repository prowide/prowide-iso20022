    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00600113 parse(String xml) {
        return ((MxCaaa00600113) MxReadImpl.parse(MxCaaa00600113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00600113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00600113) MxReadImpl.parse(MxCaaa00600113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00600113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00600113 .class);
    }
