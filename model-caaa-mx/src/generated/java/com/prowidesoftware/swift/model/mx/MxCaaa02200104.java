    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02200104 parse(String xml) {
        return ((MxCaaa02200104) MxReadImpl.parse(MxCaaa02200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02200104) MxReadImpl.parse(MxCaaa02200104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02200104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02200104 .class);
    }
