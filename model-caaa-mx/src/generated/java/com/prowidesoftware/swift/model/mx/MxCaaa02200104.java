...
/**
 * Class for caaa.022.001.04 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02200104(final String xml) {
        this();
        MxCaaa02200104 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02200104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorNonFinancialRequestV04 }
     *     
     */
    public AcceptorNonFinancialRequestV04 getAccptrNonFinReq() {
     ...
     *     
     */
    public MxCaaa02200104 setAccptrNonFinReq(AcceptorNonFinancialRequestV04 value) {
     ...
     * 
     */
    public static MxCaaa02200104 parse(String xml) {
        return ((MxCaaa02200104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02200104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02200104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02200104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02200104 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02200104) parserImpl.read(MxCaaa02200104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02200104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02200104 message
     * @return
     *     a new instance of MxCaaa02200104
     */
    public static final MxCaaa02200104 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02200104 .class);
    }
