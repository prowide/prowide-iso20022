    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01800105 parse(String xml) {
        return ((MxCaaa01800105) MxReadImpl.parse(MxCaaa01800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01800105) MxReadImpl.parse(MxCaaa01800105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01800105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01800105 .class);
    }
