    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00700113 parse(String xml) {
        return ((MxCaaa00700113) MxReadImpl.parse(MxCaaa00700113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00700113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00700113) MxReadImpl.parse(MxCaaa00700113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00700113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00700113 .class);
    }
