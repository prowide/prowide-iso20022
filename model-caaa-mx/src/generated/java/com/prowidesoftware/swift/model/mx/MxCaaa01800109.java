    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01800109 parse(String xml) {
        return ((MxCaaa01800109) MxReadImpl.parse(MxCaaa01800109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01800109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01800109) MxReadImpl.parse(MxCaaa01800109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01800109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01800109 .class);
    }
