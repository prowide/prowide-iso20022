...
/**
 * Class for caaa.021.001.07 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02100107(final String xml) {
        this();
        MxCaaa02100107 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02100107(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link TransactionAdviceResponseV07 }
     *     
     */
    public TransactionAdviceResponseV07 getTxAdvcRspn() {
        return txAdvcRspn;
    }
     ...
     *     
     */
    public MxCaaa02100107 setTxAdvcRspn(TransactionAdviceResponseV07 value) {
     ...
     * 
     */
    public static MxCaaa02100107 parse(String xml) {
        return ((MxCaaa02100107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02100107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02100107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02100107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02100107 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02100107) parserImpl.read(MxCaaa02100107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02100107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02100107 message
     * @return
     *     a new instance of MxCaaa02100107
     */
    public static final MxCaaa02100107 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02100107 .class);
    }
