    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02100107 parse(String xml) {
        return ((MxCaaa02100107) MxReadImpl.parse(MxCaaa02100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02100107) MxReadImpl.parse(MxCaaa02100107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02100107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02100107 .class);
    }
