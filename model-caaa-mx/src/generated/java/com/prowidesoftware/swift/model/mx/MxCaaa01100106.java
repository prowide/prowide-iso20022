    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01100106 parse(String xml) {
        return ((MxCaaa01100106) MxReadImpl.parse(MxCaaa01100106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01100106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01100106) MxReadImpl.parse(MxCaaa01100106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01100106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01100106 .class);
    }
