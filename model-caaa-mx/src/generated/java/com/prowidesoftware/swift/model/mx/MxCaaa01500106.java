    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01500106 parse(String xml) {
        return ((MxCaaa01500106) MxReadImpl.parse(MxCaaa01500106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01500106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01500106) MxReadImpl.parse(MxCaaa01500106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01500106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01500106 .class);
    }
