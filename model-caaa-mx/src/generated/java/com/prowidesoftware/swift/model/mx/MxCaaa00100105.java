...
/**
 * Class for caaa.001.001.05 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCaaa00100105(final String xml) {
        this();
        MxCaaa00100105 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00100105(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorAuthorisationRequestV05 }
     *     
     */
    public AcceptorAuthorisationRequestV05 getAccptrAuthstnReq() {
     ...
     *     
     */
    public MxCaaa00100105 setAccptrAuthstnReq(AcceptorAuthorisationRequestV05 value) {
    ...
    public static MxCaaa00100105 parse(String xml) {
        return ((MxCaaa00100105) MxReadImpl.parse(MxCaaa00100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00100105) MxReadImpl.parse(MxCaaa00100105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00100105 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00100105) parserImpl.read(MxCaaa00100105 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00100105 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00100105 message
     * @return
     *     a new instance of MxCaaa00100105
     */
    public static final MxCaaa00100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00100105 .class);
    }
