    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.004.001.07";
    ...
    public static MxCaaa00400107 parse(String xml) {
        return ((MxCaaa00400107) MxReadImpl.parse(MxCaaa00400107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00400107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400107) MxReadImpl.parse(MxCaaa00400107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00400107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00400107 .class);
    }
