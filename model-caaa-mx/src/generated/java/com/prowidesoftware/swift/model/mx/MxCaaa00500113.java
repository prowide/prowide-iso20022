    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.005.001.13";
    ...
    public static MxCaaa00500113 parse(String xml) {
        return ((MxCaaa00500113) MxReadImpl.parse(MxCaaa00500113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00500113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00500113) MxReadImpl.parse(MxCaaa00500113 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00500113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00500113 .class);
    }
