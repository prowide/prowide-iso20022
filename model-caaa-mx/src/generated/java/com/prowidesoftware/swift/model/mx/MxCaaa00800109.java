    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00800109 parse(String xml) {
        return ((MxCaaa00800109) MxReadImpl.parse(MxCaaa00800109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00800109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00800109) MxReadImpl.parse(MxCaaa00800109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00800109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00800109 .class);
    }
