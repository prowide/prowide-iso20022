    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.011.001.04";
    ...
    public static MxCaaa01100104 parse(String xml) {
        return ((MxCaaa01100104) MxReadImpl.parse(MxCaaa01100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01100104) MxReadImpl.parse(MxCaaa01100104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01100104 .class);
    }
