    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01600109 parse(String xml) {
        return ((MxCaaa01600109) MxReadImpl.parse(MxCaaa01600109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01600109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01600109) MxReadImpl.parse(MxCaaa01600109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01600109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01600109 .class);
    }
