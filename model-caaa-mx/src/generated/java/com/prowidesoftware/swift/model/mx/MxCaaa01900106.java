    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01900106 parse(String xml) {
        return ((MxCaaa01900106) MxReadImpl.parse(MxCaaa01900106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01900106) MxReadImpl.parse(MxCaaa01900106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01900106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01900106 .class);
    }
