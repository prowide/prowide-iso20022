    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00800107 parse(String xml) {
        return ((MxCaaa00800107) MxReadImpl.parse(MxCaaa00800107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00800107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00800107) MxReadImpl.parse(MxCaaa00800107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00800107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00800107 .class);
    }
