    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01200107 parse(String xml) {
        return ((MxCaaa01200107) MxReadImpl.parse(MxCaaa01200107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01200107) MxReadImpl.parse(MxCaaa01200107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01200107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01200107 .class);
    }
