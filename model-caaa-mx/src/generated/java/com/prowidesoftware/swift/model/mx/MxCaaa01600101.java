    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.016.001.01";
    ...
    public static MxCaaa01600101 parse(String xml) {
        return ((MxCaaa01600101) MxReadImpl.parse(MxCaaa01600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01600101) MxReadImpl.parse(MxCaaa01600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01600101 .class);
    }
