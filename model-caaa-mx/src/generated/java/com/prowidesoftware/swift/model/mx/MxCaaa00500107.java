    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00500107 parse(String xml) {
        return ((MxCaaa00500107) MxReadImpl.parse(MxCaaa00500107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00500107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00500107) MxReadImpl.parse(MxCaaa00500107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00500107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00500107 .class);
    }
