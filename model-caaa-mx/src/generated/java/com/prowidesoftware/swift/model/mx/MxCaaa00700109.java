    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.007.001.09";
    ...
    public static MxCaaa00700109 parse(String xml) {
        return ((MxCaaa00700109) MxReadImpl.parse(MxCaaa00700109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00700109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00700109) MxReadImpl.parse(MxCaaa00700109 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00700109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00700109 .class);
    }
