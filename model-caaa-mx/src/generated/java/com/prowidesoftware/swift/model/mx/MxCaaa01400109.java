    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01400109 parse(String xml) {
        return ((MxCaaa01400109) MxReadImpl.parse(MxCaaa01400109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01400109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400109) MxReadImpl.parse(MxCaaa01400109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01400109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01400109 .class);
    }
