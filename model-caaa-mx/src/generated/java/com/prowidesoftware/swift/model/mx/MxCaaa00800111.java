    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00800111 parse(String xml) {
        return ((MxCaaa00800111) MxReadImpl.parse(MxCaaa00800111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00800111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00800111) MxReadImpl.parse(MxCaaa00800111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00800111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00800111 .class);
    }
