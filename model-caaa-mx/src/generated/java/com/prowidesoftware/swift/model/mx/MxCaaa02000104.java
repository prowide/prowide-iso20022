    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02000104 parse(String xml) {
        return ((MxCaaa02000104) MxReadImpl.parse(MxCaaa02000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02000104) MxReadImpl.parse(MxCaaa02000104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02000104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02000104 .class);
    }
