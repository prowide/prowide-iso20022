    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01400108 parse(String xml) {
        return ((MxCaaa01400108) MxReadImpl.parse(MxCaaa01400108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01400108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400108) MxReadImpl.parse(MxCaaa01400108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01400108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01400108 .class);
    }
