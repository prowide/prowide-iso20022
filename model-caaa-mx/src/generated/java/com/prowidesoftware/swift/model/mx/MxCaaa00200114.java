    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00200114 parse(String xml) {
        return ((MxCaaa00200114) MxReadImpl.parse(MxCaaa00200114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00200114 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00200114) MxReadImpl.parse(MxCaaa00200114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00200114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00200114 .class);
    }
