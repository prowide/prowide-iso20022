    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01600102 parse(String xml) {
        return ((MxCaaa01600102) MxReadImpl.parse(MxCaaa01600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01600102) MxReadImpl.parse(MxCaaa01600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01600102 .class);
    }
