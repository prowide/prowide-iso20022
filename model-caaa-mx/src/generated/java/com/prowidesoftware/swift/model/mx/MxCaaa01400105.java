    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01400105 parse(String xml) {
        return ((MxCaaa01400105) MxReadImpl.parse(MxCaaa01400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400105) MxReadImpl.parse(MxCaaa01400105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01400105 .class);
    }
