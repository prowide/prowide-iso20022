    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00800114 parse(String xml) {
        return ((MxCaaa00800114) MxReadImpl.parse(MxCaaa00800114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00800114 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00800114) MxReadImpl.parse(MxCaaa00800114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00800114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00800114 .class);
    }
