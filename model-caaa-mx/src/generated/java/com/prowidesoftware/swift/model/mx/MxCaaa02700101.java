    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02700101 parse(String xml) {
        return ((MxCaaa02700101) MxReadImpl.parse(MxCaaa02700101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02700101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02700101) MxReadImpl.parse(MxCaaa02700101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02700101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02700101 .class);
    }
