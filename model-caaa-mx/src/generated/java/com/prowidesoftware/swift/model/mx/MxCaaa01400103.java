    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01400103 parse(String xml) {
        return ((MxCaaa01400103) MxReadImpl.parse(MxCaaa01400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400103) MxReadImpl.parse(MxCaaa01400103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01400103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01400103 .class);
    }
