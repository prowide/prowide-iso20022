    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01500104 parse(String xml) {
        return ((MxCaaa01500104) MxReadImpl.parse(MxCaaa01500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01500104) MxReadImpl.parse(MxCaaa01500104 .class, xml, _classes, new MxReadParams(conf)));
    }
