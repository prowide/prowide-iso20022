    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00300101 parse(String xml) {
        return ((MxCaaa00300101) MxReadImpl.parse(MxCaaa00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300101) MxReadImpl.parse(MxCaaa00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00300101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00300101 .class);
    }
