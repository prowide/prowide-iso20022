    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.007.001.02";
    ...
    public static MxCaaa00700102 parse(String xml) {
        return ((MxCaaa00700102) MxReadImpl.parse(MxCaaa00700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00700102) MxReadImpl.parse(MxCaaa00700102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00700102 fromJson(String json) {
