    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01300110 parse(String xml) {
        return ((MxCaaa01300110) MxReadImpl.parse(MxCaaa01300110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01300110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01300110) MxReadImpl.parse(MxCaaa01300110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01300110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01300110 .class);
    }
