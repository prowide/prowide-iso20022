    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02700103 parse(String xml) {
        return ((MxCaaa02700103) MxReadImpl.parse(MxCaaa02700103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02700103) MxReadImpl.parse(MxCaaa02700103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02700103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02700103 .class);
    }
