...
/**
 * Class for caaa.027.001.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02700103(final String xml) {
        this();
        MxCaaa02700103 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02700103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcquirerToAcceptorBatchFileExchangeV03 }
     *     
     */
    public AcquirerToAcceptorBatchFileExchangeV03 getAcqrrToAccptrBtchFileXchg() {
     ...
     *     
     */
    public MxCaaa02700103 setAcqrrToAccptrBtchFileXchg(AcquirerToAcceptorBatchFileExchangeV03 value) {
     ...
     * 
     */
    public static MxCaaa02700103 parse(String xml) {
        return ((MxCaaa02700103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02700103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02700103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02700103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02700103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02700103 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02700103) parserImpl.read(MxCaaa02700103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02700103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02700103 message
     * @return
     *     a new instance of MxCaaa02700103
     */
    public static final MxCaaa02700103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02700103 .class);
    }
