    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00600108 parse(String xml) {
        return ((MxCaaa00600108) MxReadImpl.parse(MxCaaa00600108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00600108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00600108) MxReadImpl.parse(MxCaaa00600108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00600108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00600108 .class);
    }
