    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.009.001.03";
    ...
    public static MxCaaa00900103 parse(String xml) {
        return ((MxCaaa00900103) MxReadImpl.parse(MxCaaa00900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900103) MxReadImpl.parse(MxCaaa00900103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00900103 fromJson(String json) {
