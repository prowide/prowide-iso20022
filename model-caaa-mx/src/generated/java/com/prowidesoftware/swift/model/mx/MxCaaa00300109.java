...
/**
 * Class for caaa.003.001.09 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa00300109(final String xml) {
        this();
        MxCaaa00300109 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00300109(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCompletionAdviceV09 }
     *     
     */
    public AcceptorCompletionAdviceV09 getAccptrCmpltnAdvc() {
     ...
     *     
     */
    public MxCaaa00300109 setAccptrCmpltnAdvc(AcceptorCompletionAdviceV09 value) {
     ...
     * 
     */
    public static MxCaaa00300109 parse(String xml) {
        return ((MxCaaa00300109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00300109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa00300109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00300109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00300109 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00300109) parserImpl.read(MxCaaa00300109 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00300109 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00300109 message
     * @return
     *     a new instance of MxCaaa00300109
     */
    public final static MxCaaa00300109 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa00300109 .class);
    }
