    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00300109 parse(String xml) {
        return ((MxCaaa00300109) MxReadImpl.parse(MxCaaa00300109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00300109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300109) MxReadImpl.parse(MxCaaa00300109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00300109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00300109 .class);
    }
