...
/**
 * Class for caaa.010.001.07 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01000107(final String xml) {
        this();
        MxCaaa01000107 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01000107(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorReconciliationResponseV07 }
     *     
     */
    public AcceptorReconciliationResponseV07 getAccptrRcncltnRspn() {
     ...
     *     
     */
    public MxCaaa01000107 setAccptrRcncltnRspn(AcceptorReconciliationResponseV07 value) {
     ...
     * 
     */
    public static MxCaaa01000107 parse(String xml) {
        return ((MxCaaa01000107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01000107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01000107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01000107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01000107 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01000107) parserImpl.read(MxCaaa01000107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01000107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01000107 message
     * @return
     *     a new instance of MxCaaa01000107
     */
    public final static MxCaaa01000107 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01000107 .class);
    }
