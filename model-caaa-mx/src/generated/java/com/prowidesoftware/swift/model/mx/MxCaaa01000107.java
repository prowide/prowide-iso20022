    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01000107 parse(String xml) {
        return ((MxCaaa01000107) MxReadImpl.parse(MxCaaa01000107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01000107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000107) MxReadImpl.parse(MxCaaa01000107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01000107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01000107 .class);
    }
