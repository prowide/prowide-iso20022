    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00900104 parse(String xml) {
        return ((MxCaaa00900104) MxReadImpl.parse(MxCaaa00900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900104) MxReadImpl.parse(MxCaaa00900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00900104 .class);
    }
