    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01000109 parse(String xml) {
        return ((MxCaaa01000109) MxReadImpl.parse(MxCaaa01000109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01000109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000109) MxReadImpl.parse(MxCaaa01000109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01000109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01000109 .class);
    }
