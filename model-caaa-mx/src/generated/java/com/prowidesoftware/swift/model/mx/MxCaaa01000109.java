...
/**
 * Class for caaa.010.001.09 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01000109(final String xml) {
        this();
        MxCaaa01000109 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01000109(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorReconciliationResponseV09 }
     *     
     */
    public AcceptorReconciliationResponseV09 getAccptrRcncltnRspn() {
     ...
     *     
     */
    public MxCaaa01000109 setAccptrRcncltnRspn(AcceptorReconciliationResponseV09 value) {
     ...
     * 
     */
    public static MxCaaa01000109 parse(String xml) {
        return ((MxCaaa01000109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01000109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01000109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01000109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01000109 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01000109) parserImpl.read(MxCaaa01000109 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01000109 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01000109 message
     * @return
     *     a new instance of MxCaaa01000109
     */
    public final static MxCaaa01000109 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01000109 .class);
    }
