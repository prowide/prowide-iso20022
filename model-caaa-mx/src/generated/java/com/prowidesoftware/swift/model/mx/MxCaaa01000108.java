    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.010.001.08";
    ...
    public static MxCaaa01000108 parse(String xml) {
        return ((MxCaaa01000108) MxReadImpl.parse(MxCaaa01000108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01000108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000108) MxReadImpl.parse(MxCaaa01000108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01000108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01000108 .class);
    }
