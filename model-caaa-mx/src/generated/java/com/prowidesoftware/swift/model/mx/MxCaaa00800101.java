    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.008.001.01";
    ...
    public static MxCaaa00800101 parse(String xml) {
        return ((MxCaaa00800101) MxReadImpl.parse(MxCaaa00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00800101) MxReadImpl.parse(MxCaaa00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00800101 fromJson(String json) {
