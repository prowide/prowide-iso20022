    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.003.001.08";
    ...
    public static MxCaaa00300108 parse(String xml) {
        return ((MxCaaa00300108) MxReadImpl.parse(MxCaaa00300108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00300108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300108) MxReadImpl.parse(MxCaaa00300108 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00300108 fromJson(String json) {
