    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01300107 parse(String xml) {
        return ((MxCaaa01300107) MxReadImpl.parse(MxCaaa01300107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01300107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01300107) MxReadImpl.parse(MxCaaa01300107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01300107 fromJson(String json) {
