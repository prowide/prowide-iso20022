...
/**
 * Class for caaa.004.001.10 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa00400110(final String xml) {
        this();
        MxCaaa00400110 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00400110(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCompletionAdviceResponseV10 }
     *     
     */
    public AcceptorCompletionAdviceResponseV10 getAccptrCmpltnAdvcRspn() {
     ...
     *     
     */
    public MxCaaa00400110 setAccptrCmpltnAdvcRspn(AcceptorCompletionAdviceResponseV10 value) {
     ...
     * 
     */
    public static MxCaaa00400110 parse(String xml) {
        return ((MxCaaa00400110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00400110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa00400110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00400110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00400110 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00400110) parserImpl.read(MxCaaa00400110 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00400110 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00400110 message
     * @return
     *     a new instance of MxCaaa00400110
     */
    public final static MxCaaa00400110 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa00400110 .class);
    }
