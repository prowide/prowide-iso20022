    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00400110 parse(String xml) {
        return ((MxCaaa00400110) MxReadImpl.parse(MxCaaa00400110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00400110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400110) MxReadImpl.parse(MxCaaa00400110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00400110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00400110 .class);
    }
