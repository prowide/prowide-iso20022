    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.025.001.01";
    ...
    public static MxCaaa02500101 parse(String xml) {
        return ((MxCaaa02500101) MxReadImpl.parse(MxCaaa02500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02500101) MxReadImpl.parse(MxCaaa02500101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa02500101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02500101 .class);
    }
