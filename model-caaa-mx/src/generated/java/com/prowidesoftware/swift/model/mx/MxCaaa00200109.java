    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00200109 parse(String xml) {
        return ((MxCaaa00200109) MxReadImpl.parse(MxCaaa00200109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00200109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00200109) MxReadImpl.parse(MxCaaa00200109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00200109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00200109 .class);
    }
