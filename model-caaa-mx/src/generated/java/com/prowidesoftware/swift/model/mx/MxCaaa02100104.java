    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02100104 parse(String xml) {
        return ((MxCaaa02100104) MxReadImpl.parse(MxCaaa02100104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02100104) MxReadImpl.parse(MxCaaa02100104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02100104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02100104 .class);
    }
