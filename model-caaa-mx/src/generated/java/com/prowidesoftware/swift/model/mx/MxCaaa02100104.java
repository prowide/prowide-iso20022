...
/**
 * Class for caaa.021.001.04 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:caaa.021.001.04")
public class MxCaaa02100104
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02100104(final String xml) {
        this();
        MxCaaa02100104 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02100104(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCaaa02100104 setTxAdvcRspn(TransactionAdviceResponseV04 value) {
     ...
     * 
     */
    public static MxCaaa02100104 parse(String xml) {
        return ((MxCaaa02100104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02100104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02100104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02100104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02100104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02100104 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02100104) parserImpl.read(MxCaaa02100104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02100104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02100104 message
     * @return
     *     a new instance of MxCaaa02100104
     */
    public final static MxCaaa02100104 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02100104 .class);
    }
