    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.004.001.03";
    ...
    public static MxCaaa00400103 parse(String xml) {
        return ((MxCaaa00400103) MxReadImpl.parse(MxCaaa00400103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00400103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400103) MxReadImpl.parse(MxCaaa00400103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00400103 fromJson(String json) {
