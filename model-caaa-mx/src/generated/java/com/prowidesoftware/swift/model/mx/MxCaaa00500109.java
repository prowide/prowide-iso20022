    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00500109 parse(String xml) {
        return ((MxCaaa00500109) MxReadImpl.parse(MxCaaa00500109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00500109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00500109) MxReadImpl.parse(MxCaaa00500109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00500109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00500109 .class);
    }
