    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00100114 parse(String xml) {
        return ((MxCaaa00100114) MxReadImpl.parse(MxCaaa00100114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00100114 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00100114) MxReadImpl.parse(MxCaaa00100114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00100114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00100114 .class);
    }
