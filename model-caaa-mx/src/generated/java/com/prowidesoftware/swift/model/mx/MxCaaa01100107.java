    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.011.001.07";
    ...
    public static MxCaaa01100107 parse(String xml) {
        return ((MxCaaa01100107) MxReadImpl.parse(MxCaaa01100107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01100107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01100107) MxReadImpl.parse(MxCaaa01100107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01100107 fromJson(String json) {
