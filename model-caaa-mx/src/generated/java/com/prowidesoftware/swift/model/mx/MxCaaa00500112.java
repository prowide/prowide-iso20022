    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00500112 parse(String xml) {
        return ((MxCaaa00500112) MxReadImpl.parse(MxCaaa00500112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00500112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00500112) MxReadImpl.parse(MxCaaa00500112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00500112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00500112 .class);
    }
