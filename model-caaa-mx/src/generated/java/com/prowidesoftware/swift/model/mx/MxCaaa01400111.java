    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01400111 parse(String xml) {
        return ((MxCaaa01400111) MxReadImpl.parse(MxCaaa01400111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01400111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400111) MxReadImpl.parse(MxCaaa01400111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01400111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01400111 .class);
    }
