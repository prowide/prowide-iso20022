...
/**
 * Class for caaa.014.001.11 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01400111(final String xml) {
        this();
        MxCaaa01400111 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01400111(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorDiagnosticResponseV11 }
     *     
     */
    public AcceptorDiagnosticResponseV11 getAccptrDgnstcRspn() {
     ...
     *     
     */
    public MxCaaa01400111 setAccptrDgnstcRspn(AcceptorDiagnosticResponseV11 value) {
     ...
     * 
     */
    public static MxCaaa01400111 parse(String xml) {
        return ((MxCaaa01400111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01400111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01400111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01400111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01400111 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01400111) parserImpl.read(MxCaaa01400111 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01400111 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01400111 message
     * @return
     *     a new instance of MxCaaa01400111
     */
    public static final MxCaaa01400111 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01400111 .class);
    }
