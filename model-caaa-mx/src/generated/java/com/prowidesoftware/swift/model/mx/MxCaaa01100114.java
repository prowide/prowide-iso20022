    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01100114 parse(String xml) {
        return ((MxCaaa01100114) MxReadImpl.parse(MxCaaa01100114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01100114 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01100114) MxReadImpl.parse(MxCaaa01100114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01100114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01100114 .class);
    }
