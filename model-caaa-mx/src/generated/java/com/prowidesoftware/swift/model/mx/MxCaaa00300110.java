    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00300110 parse(String xml) {
        return ((MxCaaa00300110) MxReadImpl.parse(MxCaaa00300110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00300110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300110) MxReadImpl.parse(MxCaaa00300110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00300110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00300110 .class);
    }
