...
/**
 * Class for caaa.009.001.14 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa00900114(final String xml) {
        this();
        MxCaaa00900114 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00900114(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorReconciliationRequestV14 }
     *     
     */
    public AcceptorReconciliationRequestV14 getAccptrRcncltnReq() {
     ...
     *     
     */
    public MxCaaa00900114 setAccptrRcncltnReq(AcceptorReconciliationRequestV14 value) {
     ...
     * 
     */
    public static MxCaaa00900114 parse(String xml) {
        return ((MxCaaa00900114) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00900114 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa00900114 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900114) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00900114 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00900114 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00900114) parserImpl.read(MxCaaa00900114 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00900114 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00900114 message
     * @return
     *     a new instance of MxCaaa00900114
     */
    public static final MxCaaa00900114 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa00900114 .class);
    }
