    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00900114 parse(String xml) {
        return ((MxCaaa00900114) MxReadImpl.parse(MxCaaa00900114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00900114 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900114) MxReadImpl.parse(MxCaaa00900114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00900114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00900114 .class);
    }
