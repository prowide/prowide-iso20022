    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00400104 parse(String xml) {
        return ((MxCaaa00400104) MxReadImpl.parse(MxCaaa00400104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00400104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400104) MxReadImpl.parse(MxCaaa00400104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00400104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00400104 .class);
    }
