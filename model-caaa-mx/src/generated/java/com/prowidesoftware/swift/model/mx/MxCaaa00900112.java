    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00900112 parse(String xml) {
        return ((MxCaaa00900112) MxReadImpl.parse(MxCaaa00900112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00900112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900112) MxReadImpl.parse(MxCaaa00900112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00900112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00900112 .class);
    }
