    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.010.001.06";
    ...
    public static MxCaaa01000106 parse(String xml) {
        return ((MxCaaa01000106) MxReadImpl.parse(MxCaaa01000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000106) MxReadImpl.parse(MxCaaa01000106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01000106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01000106 .class);
    }
