    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01500105 parse(String xml) {
        return ((MxCaaa01500105) MxReadImpl.parse(MxCaaa01500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01500105) MxReadImpl.parse(MxCaaa01500105 .class, xml, _classes, new MxReadParams(conf)));
    }
