    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.017.001.05";
    ...
    public static MxCaaa01700105 parse(String xml) {
        return ((MxCaaa01700105) MxReadImpl.parse(MxCaaa01700105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01700105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01700105) MxReadImpl.parse(MxCaaa01700105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01700105 fromJson(String json) {
