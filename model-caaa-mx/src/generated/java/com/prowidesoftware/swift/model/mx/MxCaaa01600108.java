    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01600108 parse(String xml) {
        return ((MxCaaa01600108) MxReadImpl.parse(MxCaaa01600108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01600108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01600108) MxReadImpl.parse(MxCaaa01600108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01600108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01600108 .class);
    }
