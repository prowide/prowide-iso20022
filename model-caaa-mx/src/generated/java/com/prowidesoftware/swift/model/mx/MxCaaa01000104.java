    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.010.001.04";
    ...
    public static MxCaaa01000104 parse(String xml) {
        return ((MxCaaa01000104) MxReadImpl.parse(MxCaaa01000104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01000104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000104) MxReadImpl.parse(MxCaaa01000104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01000104 fromJson(String json) {
