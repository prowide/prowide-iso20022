    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02000105 parse(String xml) {
        return ((MxCaaa02000105) MxReadImpl.parse(MxCaaa02000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02000105) MxReadImpl.parse(MxCaaa02000105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02000105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02000105 .class);
    }
