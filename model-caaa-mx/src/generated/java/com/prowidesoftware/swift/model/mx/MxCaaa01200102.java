    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01200102 parse(String xml) {
        return ((MxCaaa01200102) MxReadImpl.parse(MxCaaa01200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01200102) MxReadImpl.parse(MxCaaa01200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01200102 .class);
    }
