    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01500102 parse(String xml) {
        return ((MxCaaa01500102) MxReadImpl.parse(MxCaaa01500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01500102) MxReadImpl.parse(MxCaaa01500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01500102 .class);
    }
