    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02300104 parse(String xml) {
        return ((MxCaaa02300104) MxReadImpl.parse(MxCaaa02300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02300104) MxReadImpl.parse(MxCaaa02300104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02300104 .class);
    }
