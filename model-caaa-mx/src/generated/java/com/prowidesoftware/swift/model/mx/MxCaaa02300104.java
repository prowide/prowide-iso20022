...
/**
 * Class for caaa.023.001.04 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02300104(final String xml) {
        this();
        MxCaaa02300104 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02300104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorNonFinancialResponseV04 }
     *     
     */
    public AcceptorNonFinancialResponseV04 getAccptrNonFinRspn() {
     ...
     *     
     */
    public MxCaaa02300104 setAccptrNonFinRspn(AcceptorNonFinancialResponseV04 value) {
     ...
     * 
     */
    public static MxCaaa02300104 parse(String xml) {
        return ((MxCaaa02300104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02300104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02300104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02300104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02300104 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02300104) parserImpl.read(MxCaaa02300104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02300104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02300104 message
     * @return
     *     a new instance of MxCaaa02300104
     */
    public static final MxCaaa02300104 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02300104 .class);
    }
