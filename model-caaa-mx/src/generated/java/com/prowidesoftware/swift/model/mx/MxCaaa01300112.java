...
/**
 * Class for caaa.013.001.12 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01300112(final String xml) {
        this();
        MxCaaa01300112 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01300112(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorDiagnosticRequestV12 }
     *     
     */
    public AcceptorDiagnosticRequestV12 getAccptrDgnstcReq() {
     ...
     *     
     */
    public MxCaaa01300112 setAccptrDgnstcReq(AcceptorDiagnosticRequestV12 value) {
     ...
     * 
     */
    public static MxCaaa01300112 parse(String xml) {
        return ((MxCaaa01300112) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01300112 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01300112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01300112) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01300112 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01300112 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01300112) parserImpl.read(MxCaaa01300112 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01300112 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01300112 message
     * @return
     *     a new instance of MxCaaa01300112
     */
    public static final MxCaaa01300112 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01300112 .class);
    }
