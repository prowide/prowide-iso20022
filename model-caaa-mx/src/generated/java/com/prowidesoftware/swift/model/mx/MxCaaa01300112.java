    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01300112 parse(String xml) {
        return ((MxCaaa01300112) MxReadImpl.parse(MxCaaa01300112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01300112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01300112) MxReadImpl.parse(MxCaaa01300112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01300112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01300112 .class);
    }
