...
/**
 * Class for caaa.014.001.13 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01400113(final String xml) {
        this();
        MxCaaa01400113 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01400113(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorDiagnosticResponseV13 }
     *     
     */
    public AcceptorDiagnosticResponseV13 getAccptrDgnstcRspn() {
     ...
     *     
     */
    public MxCaaa01400113 setAccptrDgnstcRspn(AcceptorDiagnosticResponseV13 value) {
     ...
     * 
     */
    public static MxCaaa01400113 parse(String xml) {
        return ((MxCaaa01400113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01400113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01400113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01400113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01400113 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01400113) parserImpl.read(MxCaaa01400113 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01400113 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01400113 message
     * @return
     *     a new instance of MxCaaa01400113
     */
    public static final MxCaaa01400113 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01400113 .class);
    }
