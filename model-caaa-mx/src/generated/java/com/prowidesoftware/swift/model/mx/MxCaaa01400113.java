    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01400113 parse(String xml) {
        return ((MxCaaa01400113) MxReadImpl.parse(MxCaaa01400113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01400113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400113) MxReadImpl.parse(MxCaaa01400113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01400113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01400113 .class);
    }
