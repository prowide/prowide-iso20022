    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02700102 parse(String xml) {
        return ((MxCaaa02700102) MxReadImpl.parse(MxCaaa02700102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02700102) MxReadImpl.parse(MxCaaa02700102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02700102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02700102 .class);
    }
