...
/**
 * Class for caaa.027.001.02 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02700102(final String xml) {
        this();
        MxCaaa02700102 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02700102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcquirerToAcceptorBatchFileExchangeV02 }
     *     
     */
    public AcquirerToAcceptorBatchFileExchangeV02 getAcqrrToAccptrBtchFileXchg() {
     ...
     *     
     */
    public MxCaaa02700102 setAcqrrToAccptrBtchFileXchg(AcquirerToAcceptorBatchFileExchangeV02 value) {
     ...
     * 
     */
    public static MxCaaa02700102 parse(String xml) {
        return ((MxCaaa02700102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02700102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02700102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02700102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02700102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02700102 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02700102) parserImpl.read(MxCaaa02700102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02700102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02700102 message
     * @return
     *     a new instance of MxCaaa02700102
     */
    public static final MxCaaa02700102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02700102 .class);
    }
