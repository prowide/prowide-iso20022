    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00200101 parse(String xml) {
        return ((MxCaaa00200101) MxReadImpl.parse(MxCaaa00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00200101) MxReadImpl.parse(MxCaaa00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00200101 .class);
    }
