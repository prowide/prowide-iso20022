...
/**
 * Class for caaa.008.001.02 ISO 20022 message.
 * 
 */
    ...
    extends AbstractMX
{
     ...
     * 
     */
    public MxCaaa00800102(final String xml) {
        this();
        MxCaaa00800102 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00800102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCancellationAdviceResponseV02 }
     *     
     */
    public AcceptorCancellationAdviceResponseV02 getAccptrCxlAdvcRspn() {
     ...
     *     
     */
    public MxCaaa00800102 setAccptrCxlAdvcRspn(AcceptorCancellationAdviceResponseV02 value) {
    ...
    public static MxCaaa00800102 parse(String xml) {
        return ((MxCaaa00800102) MxReadImpl.parse(MxCaaa00800102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00800102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00800102) MxReadImpl.parse(MxCaaa00800102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00800102 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00800102) parserImpl.read(MxCaaa00800102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00800102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00800102 message
     * @return
     *     a new instance of MxCaaa00800102
     */
    public static final MxCaaa00800102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00800102 .class);
    }
