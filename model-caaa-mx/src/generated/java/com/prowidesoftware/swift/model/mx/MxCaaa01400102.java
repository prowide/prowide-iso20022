    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.014.001.02";
    ...
    public static MxCaaa01400102 parse(String xml) {
        return ((MxCaaa01400102) MxReadImpl.parse(MxCaaa01400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400102) MxReadImpl.parse(MxCaaa01400102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01400102 .class);
    }
