    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.014.001.06";
    ...
    public static MxCaaa01400106 parse(String xml) {
        return ((MxCaaa01400106) MxReadImpl.parse(MxCaaa01400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400106) MxReadImpl.parse(MxCaaa01400106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01400106 fromJson(String json) {
