    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00200107 parse(String xml) {
        return ((MxCaaa00200107) MxReadImpl.parse(MxCaaa00200107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00200107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00200107) MxReadImpl.parse(MxCaaa00200107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00200107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00200107 .class);
    }
