...
/**
 * Class for caaa.017.001.07 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01700107(final String xml) {
        this();
        MxCaaa01700107 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01700107(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCurrencyConversionResponseV07 }
     *     
     */
    public AcceptorCurrencyConversionResponseV07 getAccptrCcyConvsRspn() {
     ...
     *     
     */
    public MxCaaa01700107 setAccptrCcyConvsRspn(AcceptorCurrencyConversionResponseV07 value) {
     ...
     * 
     */
    public static MxCaaa01700107 parse(String xml) {
        return ((MxCaaa01700107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01700107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01700107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01700107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01700107 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01700107) parserImpl.read(MxCaaa01700107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01700107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01700107 message
     * @return
     *     a new instance of MxCaaa01700107
     */
    public static final MxCaaa01700107 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01700107 .class);
    }
