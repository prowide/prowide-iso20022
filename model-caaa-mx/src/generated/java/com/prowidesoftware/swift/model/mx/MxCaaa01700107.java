    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01700107 parse(String xml) {
        return ((MxCaaa01700107) MxReadImpl.parse(MxCaaa01700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01700107) MxReadImpl.parse(MxCaaa01700107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01700107 .class);
    }
