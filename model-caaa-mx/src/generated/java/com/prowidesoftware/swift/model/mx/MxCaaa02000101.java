    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.020.001.01";
    ...
    public static MxCaaa02000101 parse(String xml) {
        return ((MxCaaa02000101) MxReadImpl.parse(MxCaaa02000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02000101) MxReadImpl.parse(MxCaaa02000101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa02000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02000101 .class);
    }
