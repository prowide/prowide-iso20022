    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.002.001.12";
    ...
    public static MxCaaa00200112 parse(String xml) {
        return ((MxCaaa00200112) MxReadImpl.parse(MxCaaa00200112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00200112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00200112) MxReadImpl.parse(MxCaaa00200112 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00200112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00200112 .class);
    }
