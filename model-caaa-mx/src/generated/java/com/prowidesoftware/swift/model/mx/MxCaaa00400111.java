    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00400111 parse(String xml) {
        return ((MxCaaa00400111) MxReadImpl.parse(MxCaaa00400111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00400111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400111) MxReadImpl.parse(MxCaaa00400111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00400111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00400111 .class);
    }
