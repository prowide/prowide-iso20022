...
/**
 * Class for caaa.004.001.11 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa00400111(final String xml) {
        this();
        MxCaaa00400111 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00400111(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCompletionAdviceResponseV11 }
     *     
     */
    public AcceptorCompletionAdviceResponseV11 getAccptrCmpltnAdvcRspn() {
     ...
     *     
     */
    public MxCaaa00400111 setAccptrCmpltnAdvcRspn(AcceptorCompletionAdviceResponseV11 value) {
     ...
     * 
     */
    public static MxCaaa00400111 parse(String xml) {
        return ((MxCaaa00400111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00400111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa00400111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00400111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00400111 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00400111) parserImpl.read(MxCaaa00400111 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00400111 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00400111 message
     * @return
     *     a new instance of MxCaaa00400111
     */
    public final static MxCaaa00400111 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa00400111 .class);
    }
