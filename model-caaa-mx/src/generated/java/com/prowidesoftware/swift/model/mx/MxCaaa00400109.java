    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00400109 parse(String xml) {
        return ((MxCaaa00400109) MxReadImpl.parse(MxCaaa00400109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00400109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400109) MxReadImpl.parse(MxCaaa00400109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00400109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00400109 .class);
    }
