...
/**
 * Class for caaa.001.001.09 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa00100109(final String xml) {
        this();
        MxCaaa00100109 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00100109(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorAuthorisationRequestV09 }
     *     
     */
    public AcceptorAuthorisationRequestV09 getAccptrAuthstnReq() {
     ...
     *     
     */
    public MxCaaa00100109 setAccptrAuthstnReq(AcceptorAuthorisationRequestV09 value) {
     ...
     * 
     */
    public static MxCaaa00100109 parse(String xml) {
        return ((MxCaaa00100109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00100109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa00100109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00100109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00100109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00100109 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00100109) parserImpl.read(MxCaaa00100109 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00100109 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00100109 message
     * @return
     *     a new instance of MxCaaa00100109
     */
    public final static MxCaaa00100109 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa00100109 .class);
    }
