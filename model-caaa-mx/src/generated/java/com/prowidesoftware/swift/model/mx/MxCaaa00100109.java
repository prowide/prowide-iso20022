    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00100109 parse(String xml) {
        return ((MxCaaa00100109) MxReadImpl.parse(MxCaaa00100109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00100109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00100109) MxReadImpl.parse(MxCaaa00100109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00100109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00100109 .class);
    }
