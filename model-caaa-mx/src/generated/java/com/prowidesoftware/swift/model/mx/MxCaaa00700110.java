    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00700110 parse(String xml) {
        return ((MxCaaa00700110) MxReadImpl.parse(MxCaaa00700110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00700110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00700110) MxReadImpl.parse(MxCaaa00700110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00700110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00700110 .class);
    }
