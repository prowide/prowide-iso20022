...
/**
 * Class for caaa.020.001.06 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02000106(final String xml) {
        this();
        MxCaaa02000106 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02000106(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link TransactionAdviceV06 }
     *     
     */
    public TransactionAdviceV06 getTxAdvc() {
        return txAdvc;
    }
     ...
     *     
     */
    public MxCaaa02000106 setTxAdvc(TransactionAdviceV06 value) {
        this.txAdvc = value;
        return this;
    }
     ...
     * 
     */
    public static MxCaaa02000106 parse(String xml) {
        return ((MxCaaa02000106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02000106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02000106) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02000106 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02000106 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02000106) parserImpl.read(MxCaaa02000106 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02000106 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02000106 message
     * @return
     *     a new instance of MxCaaa02000106
     */
    public static final MxCaaa02000106 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02000106 .class);
    }
