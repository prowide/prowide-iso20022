    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02000106 parse(String xml) {
        return ((MxCaaa02000106) MxReadImpl.parse(MxCaaa02000106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02000106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02000106) MxReadImpl.parse(MxCaaa02000106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02000106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02000106 .class);
    }
