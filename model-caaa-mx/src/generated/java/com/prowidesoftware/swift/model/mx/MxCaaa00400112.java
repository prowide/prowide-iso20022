    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00400112 parse(String xml) {
        return ((MxCaaa00400112) MxReadImpl.parse(MxCaaa00400112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00400112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400112) MxReadImpl.parse(MxCaaa00400112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00400112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00400112 .class);
    }
