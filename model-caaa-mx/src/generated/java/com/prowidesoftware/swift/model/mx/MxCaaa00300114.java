    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00300114 parse(String xml) {
        return ((MxCaaa00300114) MxReadImpl.parse(MxCaaa00300114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00300114 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300114) MxReadImpl.parse(MxCaaa00300114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00300114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00300114 .class);
    }
