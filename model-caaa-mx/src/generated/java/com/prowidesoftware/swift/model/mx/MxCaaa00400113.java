    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00400113 parse(String xml) {
        return ((MxCaaa00400113) MxReadImpl.parse(MxCaaa00400113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00400113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400113) MxReadImpl.parse(MxCaaa00400113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00400113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00400113 .class);
    }
