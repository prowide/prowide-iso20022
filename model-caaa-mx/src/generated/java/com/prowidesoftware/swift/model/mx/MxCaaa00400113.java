...
/**
 * Class for caaa.004.001.13 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa00400113(final String xml) {
        this();
        MxCaaa00400113 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00400113(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCompletionAdviceResponseV13 }
     *     
     */
    public AcceptorCompletionAdviceResponseV13 getAccptrCmpltnAdvcRspn() {
     ...
     *     
     */
    public MxCaaa00400113 setAccptrCmpltnAdvcRspn(AcceptorCompletionAdviceResponseV13 value) {
     ...
     * 
     */
    public static MxCaaa00400113 parse(String xml) {
        return ((MxCaaa00400113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00400113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa00400113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00400113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00400113 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00400113) parserImpl.read(MxCaaa00400113 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00400113 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00400113 message
     * @return
     *     a new instance of MxCaaa00400113
     */
    public final static MxCaaa00400113 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa00400113 .class);
    }
