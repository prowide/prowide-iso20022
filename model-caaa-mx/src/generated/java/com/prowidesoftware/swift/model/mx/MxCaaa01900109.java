    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01900109 parse(String xml) {
        return ((MxCaaa01900109) MxReadImpl.parse(MxCaaa01900109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01900109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01900109) MxReadImpl.parse(MxCaaa01900109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01900109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01900109 .class);
    }
