...
/**
 * Class for caaa.019.001.09 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01900109(final String xml) {
        this();
        MxCaaa01900109 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01900109(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCurrencyConversionAdviceResponseV09 }
     *     
     */
    public AcceptorCurrencyConversionAdviceResponseV09 getAccptrCcyConvsAdvcRspn() {
     ...
     *     
     */
    public MxCaaa01900109 setAccptrCcyConvsAdvcRspn(AcceptorCurrencyConversionAdviceResponseV09 value) {
     ...
     * 
     */
    public static MxCaaa01900109 parse(String xml) {
        return ((MxCaaa01900109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01900109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01900109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01900109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01900109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01900109 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01900109) parserImpl.read(MxCaaa01900109 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01900109 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01900109 message
     * @return
     *     a new instance of MxCaaa01900109
     */
    public static final MxCaaa01900109 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01900109 .class);
    }
