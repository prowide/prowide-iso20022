    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00700108 parse(String xml) {
        return ((MxCaaa00700108) MxReadImpl.parse(MxCaaa00700108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00700108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00700108) MxReadImpl.parse(MxCaaa00700108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00700108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00700108 .class);
    }
