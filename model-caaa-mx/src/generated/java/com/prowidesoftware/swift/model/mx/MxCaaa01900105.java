    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01900105 parse(String xml) {
        return ((MxCaaa01900105) MxReadImpl.parse(MxCaaa01900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01900105) MxReadImpl.parse(MxCaaa01900105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01900105 .class);
    }
