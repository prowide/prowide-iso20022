    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02600102 parse(String xml) {
        return ((MxCaaa02600102) MxReadImpl.parse(MxCaaa02600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02600102) MxReadImpl.parse(MxCaaa02600102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02600102 .class);
    }
