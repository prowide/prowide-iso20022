    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02500104 parse(String xml) {
        return ((MxCaaa02500104) MxReadImpl.parse(MxCaaa02500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02500104) MxReadImpl.parse(MxCaaa02500104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02500104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02500104 .class);
    }
