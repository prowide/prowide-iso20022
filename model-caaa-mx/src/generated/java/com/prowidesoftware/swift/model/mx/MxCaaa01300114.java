    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01300114 parse(String xml) {
        return ((MxCaaa01300114) MxReadImpl.parse(MxCaaa01300114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01300114 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01300114) MxReadImpl.parse(MxCaaa01300114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01300114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01300114 .class);
    }
