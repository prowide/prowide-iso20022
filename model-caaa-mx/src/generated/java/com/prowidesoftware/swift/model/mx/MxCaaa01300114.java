...
/**
 * Class for caaa.013.001.14 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01300114(final String xml) {
        this();
        MxCaaa01300114 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01300114(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorDiagnosticRequestV14 }
     *     
     */
    public AcceptorDiagnosticRequestV14 getAccptrDgnstcReq() {
     ...
     *     
     */
    public MxCaaa01300114 setAccptrDgnstcReq(AcceptorDiagnosticRequestV14 value) {
     ...
     * 
     */
    public static MxCaaa01300114 parse(String xml) {
        return ((MxCaaa01300114) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01300114 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01300114 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01300114) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01300114 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01300114 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01300114) parserImpl.read(MxCaaa01300114 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01300114 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01300114 message
     * @return
     *     a new instance of MxCaaa01300114
     */
    public static final MxCaaa01300114 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01300114 .class);
    }
