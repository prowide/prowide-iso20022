    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00900101 parse(String xml) {
        return ((MxCaaa00900101) MxReadImpl.parse(MxCaaa00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900101) MxReadImpl.parse(MxCaaa00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00900101 .class);
    }
