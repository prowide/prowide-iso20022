    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01700111 parse(String xml) {
        return ((MxCaaa01700111) MxReadImpl.parse(MxCaaa01700111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01700111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01700111) MxReadImpl.parse(MxCaaa01700111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01700111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01700111 .class);
    }
