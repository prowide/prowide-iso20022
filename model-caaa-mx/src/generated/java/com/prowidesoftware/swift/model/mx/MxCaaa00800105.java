    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00800105 parse(String xml) {
        return ((MxCaaa00800105) MxReadImpl.parse(MxCaaa00800105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00800105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00800105) MxReadImpl.parse(MxCaaa00800105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00800105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00800105 .class);
    }
