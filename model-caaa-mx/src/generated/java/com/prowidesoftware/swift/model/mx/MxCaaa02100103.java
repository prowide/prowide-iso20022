...
/**
 * Class for caaa.021.001.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02100103(final String xml) {
        this();
        MxCaaa02100103 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02100103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link TransactionAdviceResponseV03 }
     *     
     */
    public TransactionAdviceResponseV03 getTxAdvcRspn() {
        return txAdvcRspn;
    }
     ...
     *     
     */
    public MxCaaa02100103 setTxAdvcRspn(TransactionAdviceResponseV03 value) {
     ...
     * 
     */
    public static MxCaaa02100103 parse(String xml) {
        return ((MxCaaa02100103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02100103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02100103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02100103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02100103 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02100103) parserImpl.read(MxCaaa02100103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02100103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02100103 message
     * @return
     *     a new instance of MxCaaa02100103
     */
    public final static MxCaaa02100103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02100103 .class);
    }
