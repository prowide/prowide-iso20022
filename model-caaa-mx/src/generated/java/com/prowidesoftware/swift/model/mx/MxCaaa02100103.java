    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02100103 parse(String xml) {
        return ((MxCaaa02100103) MxReadImpl.parse(MxCaaa02100103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02100103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02100103) MxReadImpl.parse(MxCaaa02100103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02100103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02100103 .class);
    }
