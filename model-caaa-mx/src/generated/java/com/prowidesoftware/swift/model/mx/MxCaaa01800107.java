...
/**
 * Class for caaa.018.001.07 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:caaa.018.001.07")
public class MxCaaa01800107
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01800107(final String xml) {
        this();
        MxCaaa01800107 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01800107(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCaaa01800107 setAccptrCcyConvsAdvc(AcceptorCurrencyConversionAdviceV07 value) {
     ...
     * 
     */
    public static MxCaaa01800107 parse(String xml) {
        return ((MxCaaa01800107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01800107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01800107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01800107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01800107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01800107 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01800107) parserImpl.read(MxCaaa01800107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01800107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01800107 message
     * @return
     *     a new instance of MxCaaa01800107
     */
    public final static MxCaaa01800107 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01800107 .class);
    }
