    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01800107 parse(String xml) {
        return ((MxCaaa01800107) MxReadImpl.parse(MxCaaa01800107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01800107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01800107) MxReadImpl.parse(MxCaaa01800107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01800107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01800107 .class);
    }
