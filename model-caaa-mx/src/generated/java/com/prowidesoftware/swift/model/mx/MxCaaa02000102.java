...
/**
 * Class for caaa.020.001.02 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02000102(final String xml) {
        this();
        MxCaaa02000102 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02000102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link TransactionAdviceV02 }
     *     
     */
    public TransactionAdviceV02 getTxAdvc() {
        return txAdvc;
    }
     ...
     *     
     */
    public MxCaaa02000102 setTxAdvc(TransactionAdviceV02 value) {
        this.txAdvc = value;
        return this;
    }
     ...
     * 
     */
    public static MxCaaa02000102 parse(String xml) {
        return ((MxCaaa02000102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02000102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02000102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02000102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02000102 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02000102) parserImpl.read(MxCaaa02000102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02000102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02000102 message
     * @return
     *     a new instance of MxCaaa02000102
     */
    public static final MxCaaa02000102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02000102 .class);
    }
