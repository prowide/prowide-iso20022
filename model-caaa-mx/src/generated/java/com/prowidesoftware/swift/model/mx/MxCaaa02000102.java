    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02000102 parse(String xml) {
        return ((MxCaaa02000102) MxReadImpl.parse(MxCaaa02000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02000102) MxReadImpl.parse(MxCaaa02000102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02000102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02000102 .class);
    }
