    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.023.001.03";
    ...
    public static MxCaaa02300103 parse(String xml) {
        return ((MxCaaa02300103) MxReadImpl.parse(MxCaaa02300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02300103) MxReadImpl.parse(MxCaaa02300103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa02300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02300103 .class);
    }
