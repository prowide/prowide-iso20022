    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.017.001.06";
    ...
    public static MxCaaa01700106 parse(String xml) {
        return ((MxCaaa01700106) MxReadImpl.parse(MxCaaa01700106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01700106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01700106) MxReadImpl.parse(MxCaaa01700106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01700106 fromJson(String json) {
