    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.023.001.02";
    ...
    public static MxCaaa02300102 parse(String xml) {
        return ((MxCaaa02300102) MxReadImpl.parse(MxCaaa02300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02300102) MxReadImpl.parse(MxCaaa02300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa02300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02300102 .class);
    }
