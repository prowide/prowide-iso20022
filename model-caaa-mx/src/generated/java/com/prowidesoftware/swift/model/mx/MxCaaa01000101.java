    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01000101 parse(String xml) {
        return ((MxCaaa01000101) MxReadImpl.parse(MxCaaa01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000101) MxReadImpl.parse(MxCaaa01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01000101 .class);
    }
