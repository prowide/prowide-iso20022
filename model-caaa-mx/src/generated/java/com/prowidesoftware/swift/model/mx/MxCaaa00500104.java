    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.005.001.04";
    ...
    public static MxCaaa00500104 parse(String xml) {
        return ((MxCaaa00500104) MxReadImpl.parse(MxCaaa00500104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00500104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00500104) MxReadImpl.parse(MxCaaa00500104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00500104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00500104 .class);
    }
