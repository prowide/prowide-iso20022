    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01000110 parse(String xml) {
        return ((MxCaaa01000110) MxReadImpl.parse(MxCaaa01000110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01000110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000110) MxReadImpl.parse(MxCaaa01000110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01000110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01000110 .class);
    }
