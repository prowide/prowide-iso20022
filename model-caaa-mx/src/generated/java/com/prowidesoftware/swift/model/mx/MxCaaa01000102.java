    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.010.001.02";
    ...
    public static MxCaaa01000102 parse(String xml) {
        return ((MxCaaa01000102) MxReadImpl.parse(MxCaaa01000102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01000102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000102) MxReadImpl.parse(MxCaaa01000102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01000102 fromJson(String json) {
