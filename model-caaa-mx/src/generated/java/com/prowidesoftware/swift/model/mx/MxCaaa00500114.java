    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00500114 parse(String xml) {
        return ((MxCaaa00500114) MxReadImpl.parse(MxCaaa00500114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00500114 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00500114) MxReadImpl.parse(MxCaaa00500114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00500114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00500114 .class);
    }
