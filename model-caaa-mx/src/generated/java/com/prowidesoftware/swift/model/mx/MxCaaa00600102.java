    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.006.001.02";
    ...
    public static MxCaaa00600102 parse(String xml) {
        return ((MxCaaa00600102) MxReadImpl.parse(MxCaaa00600102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00600102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00600102) MxReadImpl.parse(MxCaaa00600102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00600102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00600102 .class);
    }
