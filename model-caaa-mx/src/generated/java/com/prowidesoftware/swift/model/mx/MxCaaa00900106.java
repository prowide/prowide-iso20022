    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00900106 parse(String xml) {
        return ((MxCaaa00900106) MxReadImpl.parse(MxCaaa00900106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00900106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900106) MxReadImpl.parse(MxCaaa00900106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00900106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00900106 .class);
    }
