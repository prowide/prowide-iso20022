    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01100105 parse(String xml) {
        return ((MxCaaa01100105) MxReadImpl.parse(MxCaaa01100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01100105) MxReadImpl.parse(MxCaaa01100105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01100105 .class);
    }
