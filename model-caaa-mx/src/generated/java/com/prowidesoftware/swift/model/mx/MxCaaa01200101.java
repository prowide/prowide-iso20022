    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.012.001.01";
    ...
    public static MxCaaa01200101 parse(String xml) {
        return ((MxCaaa01200101) MxReadImpl.parse(MxCaaa01200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01200101) MxReadImpl.parse(MxCaaa01200101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01200101 .class);
    }
