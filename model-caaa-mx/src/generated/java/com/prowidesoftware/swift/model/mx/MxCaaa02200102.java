    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02200102 parse(String xml) {
        return ((MxCaaa02200102) MxReadImpl.parse(MxCaaa02200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02200102) MxReadImpl.parse(MxCaaa02200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02200102 .class);
    }
