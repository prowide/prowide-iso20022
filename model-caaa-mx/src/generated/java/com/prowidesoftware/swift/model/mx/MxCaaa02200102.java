...
/**
 * Class for caaa.022.001.02 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02200102(final String xml) {
        this();
        MxCaaa02200102 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02200102(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorNonFinancialRequestV02 }
     *     
     */
    public AcceptorNonFinancialRequestV02 getAccptrNonFinReq() {
     ...
     *     
     */
    public MxCaaa02200102 setAccptrNonFinReq(AcceptorNonFinancialRequestV02 value) {
     ...
     * 
     */
    public static MxCaaa02200102 parse(String xml) {
        return ((MxCaaa02200102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02200102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02200102) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02200102 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02200102 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02200102) parserImpl.read(MxCaaa02200102 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02200102 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02200102 message
     * @return
     *     a new instance of MxCaaa02200102
     */
    public static final MxCaaa02200102 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02200102 .class);
    }
