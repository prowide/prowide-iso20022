    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00700114 parse(String xml) {
        return ((MxCaaa00700114) MxReadImpl.parse(MxCaaa00700114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00700114 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00700114) MxReadImpl.parse(MxCaaa00700114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00700114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00700114 .class);
    }
