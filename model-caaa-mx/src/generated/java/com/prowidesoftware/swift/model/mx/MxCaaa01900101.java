    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.019.001.01";
    ...
    public static MxCaaa01900101 parse(String xml) {
        return ((MxCaaa01900101) MxReadImpl.parse(MxCaaa01900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01900101) MxReadImpl.parse(MxCaaa01900101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01900101 .class);
    }
