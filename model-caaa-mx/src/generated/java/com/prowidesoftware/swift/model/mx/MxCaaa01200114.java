    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01200114 parse(String xml) {
        return ((MxCaaa01200114) MxReadImpl.parse(MxCaaa01200114 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01200114 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01200114) MxReadImpl.parse(MxCaaa01200114 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01200114 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01200114 .class);
    }
