    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01300113 parse(String xml) {
        return ((MxCaaa01300113) MxReadImpl.parse(MxCaaa01300113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01300113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01300113) MxReadImpl.parse(MxCaaa01300113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01300113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01300113 .class);
    }
