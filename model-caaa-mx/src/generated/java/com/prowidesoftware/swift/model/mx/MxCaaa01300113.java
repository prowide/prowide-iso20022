...
/**
 * Class for caaa.013.001.13 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01300113(final String xml) {
        this();
        MxCaaa01300113 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01300113(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorDiagnosticRequestV13 }
     *     
     */
    public AcceptorDiagnosticRequestV13 getAccptrDgnstcReq() {
     ...
     *     
     */
    public MxCaaa01300113 setAccptrDgnstcReq(AcceptorDiagnosticRequestV13 value) {
     ...
     * 
     */
    public static MxCaaa01300113 parse(String xml) {
        return ((MxCaaa01300113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01300113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01300113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01300113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01300113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01300113 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01300113) parserImpl.read(MxCaaa01300113 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01300113 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01300113 message
     * @return
     *     a new instance of MxCaaa01300113
     */
    public final static MxCaaa01300113 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01300113 .class);
    }
