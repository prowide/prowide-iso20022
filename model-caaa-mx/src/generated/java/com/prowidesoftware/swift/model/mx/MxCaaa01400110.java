...
/**
 * Class for caaa.014.001.10 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01400110(final String xml) {
        this();
        MxCaaa01400110 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01400110(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorDiagnosticResponseV10 }
     *     
     */
    public AcceptorDiagnosticResponseV10 getAccptrDgnstcRspn() {
     ...
     *     
     */
    public MxCaaa01400110 setAccptrDgnstcRspn(AcceptorDiagnosticResponseV10 value) {
     ...
     * 
     */
    public static MxCaaa01400110 parse(String xml) {
        return ((MxCaaa01400110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01400110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01400110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01400110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01400110 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01400110) parserImpl.read(MxCaaa01400110 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01400110 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01400110 message
     * @return
     *     a new instance of MxCaaa01400110
     */
    public static final MxCaaa01400110 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01400110 .class);
    }
