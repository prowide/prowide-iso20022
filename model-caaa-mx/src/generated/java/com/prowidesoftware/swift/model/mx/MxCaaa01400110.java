    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01400110 parse(String xml) {
        return ((MxCaaa01400110) MxReadImpl.parse(MxCaaa01400110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01400110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400110) MxReadImpl.parse(MxCaaa01400110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01400110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01400110 .class);
    }
