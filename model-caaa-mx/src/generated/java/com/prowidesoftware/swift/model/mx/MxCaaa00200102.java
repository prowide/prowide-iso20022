    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00200102 parse(String xml) {
        return ((MxCaaa00200102) MxReadImpl.parse(MxCaaa00200102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00200102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00200102) MxReadImpl.parse(MxCaaa00200102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00200102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00200102 .class);
    }
