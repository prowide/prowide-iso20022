    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01000113 parse(String xml) {
        return ((MxCaaa01000113) MxReadImpl.parse(MxCaaa01000113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01000113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000113) MxReadImpl.parse(MxCaaa01000113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01000113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01000113 .class);
    }
