...
/**
 * Class for caaa.010.001.13 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01000113(final String xml) {
        this();
        MxCaaa01000113 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01000113(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorReconciliationResponseV13 }
     *     
     */
    public AcceptorReconciliationResponseV13 getAccptrRcncltnRspn() {
     ...
     *     
     */
    public MxCaaa01000113 setAccptrRcncltnRspn(AcceptorReconciliationResponseV13 value) {
     ...
     * 
     */
    public static MxCaaa01000113 parse(String xml) {
        return ((MxCaaa01000113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01000113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01000113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01000113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01000113 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01000113) parserImpl.read(MxCaaa01000113 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01000113 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01000113 message
     * @return
     *     a new instance of MxCaaa01000113
     */
    public static final MxCaaa01000113 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01000113 .class);
    }
