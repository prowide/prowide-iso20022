    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.018.001.04";
    ...
    public static MxCaaa01800104 parse(String xml) {
        return ((MxCaaa01800104) MxReadImpl.parse(MxCaaa01800104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01800104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01800104) MxReadImpl.parse(MxCaaa01800104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01800104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01800104 .class);
    }
