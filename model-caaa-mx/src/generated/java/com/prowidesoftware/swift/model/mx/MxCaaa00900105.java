...
/**
 * Class for caaa.009.001.05 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:caaa.009.001.05")
public class MxCaaa00900105
    extends AbstractMX
{

    @XmlElement(name = "AccptrRcncltnReq", required = true)
    protected AcceptorReconciliationRequestV05 accptrRcncltnReq;
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.009.001.05";

    public MxCaaa00900105() {
        super();
    }
     ...
     * 
     */
    public MxCaaa00900105(final String xml) {
        this();
        MxCaaa00900105 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00900105(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorReconciliationRequestV05 }
     *     
     */
     ...
     *     
     */
    public MxCaaa00900105 setAccptrRcncltnReq(AcceptorReconciliationRequestV05 value) {
    ...
    public static MxCaaa00900105 parse(String xml) {
        return ((MxCaaa00900105) MxReadImpl.parse(MxCaaa00900105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00900105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900105) MxReadImpl.parse(MxCaaa00900105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00900105 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00900105) parserImpl.read(MxCaaa00900105 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00900105 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00900105 message
     * @return
     *     a new instance of MxCaaa00900105
     */
    public static final MxCaaa00900105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00900105 .class);
    }
