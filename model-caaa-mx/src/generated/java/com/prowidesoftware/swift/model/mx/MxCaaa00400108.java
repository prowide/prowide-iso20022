...
/**
 * Class for caaa.004.001.08 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa00400108(final String xml) {
        this();
        MxCaaa00400108 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00400108(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCompletionAdviceResponseV08 }
     *     
     */
    public AcceptorCompletionAdviceResponseV08 getAccptrCmpltnAdvcRspn() {
     ...
     *     
     */
    public MxCaaa00400108 setAccptrCmpltnAdvcRspn(AcceptorCompletionAdviceResponseV08 value) {
     ...
     * 
     */
    public static MxCaaa00400108 parse(String xml) {
        return ((MxCaaa00400108) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00400108 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa00400108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400108) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00400108 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00400108 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00400108) parserImpl.read(MxCaaa00400108 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00400108 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00400108 message
     * @return
     *     a new instance of MxCaaa00400108
     */
    public final static MxCaaa00400108 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa00400108 .class);
    }
