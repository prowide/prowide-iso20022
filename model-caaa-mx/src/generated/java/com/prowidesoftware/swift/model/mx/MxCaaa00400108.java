    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00400108 parse(String xml) {
        return ((MxCaaa00400108) MxReadImpl.parse(MxCaaa00400108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00400108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400108) MxReadImpl.parse(MxCaaa00400108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00400108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00400108 .class);
    }
