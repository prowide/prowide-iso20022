    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01000105 parse(String xml) {
        return ((MxCaaa01000105) MxReadImpl.parse(MxCaaa01000105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01000105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000105) MxReadImpl.parse(MxCaaa01000105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01000105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01000105 .class);
    }
