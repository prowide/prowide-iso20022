    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01600111 parse(String xml) {
        return ((MxCaaa01600111) MxReadImpl.parse(MxCaaa01600111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01600111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01600111) MxReadImpl.parse(MxCaaa01600111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01600111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01600111 .class);
    }
