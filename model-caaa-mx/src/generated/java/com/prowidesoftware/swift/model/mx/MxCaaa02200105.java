    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02200105 parse(String xml) {
        return ((MxCaaa02200105) MxReadImpl.parse(MxCaaa02200105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02200105) MxReadImpl.parse(MxCaaa02200105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02200105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02200105 .class);
    }
