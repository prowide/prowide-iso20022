...
/**
 * Class for caaa.022.001.05 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02200105(final String xml) {
        this();
        MxCaaa02200105 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02200105(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorNonFinancialRequestV05 }
     *     
     */
    public AcceptorNonFinancialRequestV05 getAccptrNonFinReq() {
     ...
     *     
     */
    public MxCaaa02200105 setAccptrNonFinReq(AcceptorNonFinancialRequestV05 value) {
     ...
     * 
     */
    public static MxCaaa02200105 parse(String xml) {
        return ((MxCaaa02200105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02200105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02200105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02200105) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02200105 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02200105 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02200105) parserImpl.read(MxCaaa02200105 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02200105 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02200105 message
     * @return
     *     a new instance of MxCaaa02200105
     */
    public static final MxCaaa02200105 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02200105 .class);
    }
