    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01100113 parse(String xml) {
        return ((MxCaaa01100113) MxReadImpl.parse(MxCaaa01100113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01100113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01100113) MxReadImpl.parse(MxCaaa01100113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01100113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01100113 .class);
    }
