...
/**
 * Class for caaa.011.001.13 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:caaa.011.001.13")
public class MxCaaa01100113
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01100113(final String xml) {
        this();
        MxCaaa01100113 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01100113(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCaaa01100113 setAccptrBtchTrf(AcceptorBatchTransferV13 value) {
     ...
     * 
     */
    public static MxCaaa01100113 parse(String xml) {
        return ((MxCaaa01100113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01100113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01100113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01100113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01100113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01100113 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01100113) parserImpl.read(MxCaaa01100113 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01100113 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01100113 message
     * @return
     *     a new instance of MxCaaa01100113
     */
    public final static MxCaaa01100113 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01100113 .class);
    }
