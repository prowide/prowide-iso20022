    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00400102 parse(String xml) {
        return ((MxCaaa00400102) MxReadImpl.parse(MxCaaa00400102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00400102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400102) MxReadImpl.parse(MxCaaa00400102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00400102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00400102 .class);
    }
