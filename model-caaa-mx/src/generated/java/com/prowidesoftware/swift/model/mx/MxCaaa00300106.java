    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00300106 parse(String xml) {
        return ((MxCaaa00300106) MxReadImpl.parse(MxCaaa00300106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00300106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300106) MxReadImpl.parse(MxCaaa00300106 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00300106 fromJson(String json) {
