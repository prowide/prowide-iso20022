    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00800112 parse(String xml) {
        return ((MxCaaa00800112) MxReadImpl.parse(MxCaaa00800112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00800112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00800112) MxReadImpl.parse(MxCaaa00800112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00800112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00800112 .class);
    }
