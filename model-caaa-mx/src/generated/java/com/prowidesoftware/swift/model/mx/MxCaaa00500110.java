    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00500110 parse(String xml) {
        return ((MxCaaa00500110) MxReadImpl.parse(MxCaaa00500110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00500110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00500110) MxReadImpl.parse(MxCaaa00500110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00500110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00500110 .class);
    }
