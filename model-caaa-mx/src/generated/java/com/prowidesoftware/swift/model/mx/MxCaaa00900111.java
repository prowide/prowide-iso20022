    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00900111 parse(String xml) {
        return ((MxCaaa00900111) MxReadImpl.parse(MxCaaa00900111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00900111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900111) MxReadImpl.parse(MxCaaa00900111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00900111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00900111 .class);
    }
