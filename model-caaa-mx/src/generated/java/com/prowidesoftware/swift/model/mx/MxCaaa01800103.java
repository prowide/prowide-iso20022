    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01800103 parse(String xml) {
        return ((MxCaaa01800103) MxReadImpl.parse(MxCaaa01800103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01800103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01800103) MxReadImpl.parse(MxCaaa01800103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01800103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01800103 .class);
    }
