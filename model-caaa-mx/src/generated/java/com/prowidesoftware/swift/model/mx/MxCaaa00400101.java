    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00400101 parse(String xml) {
        return ((MxCaaa00400101) MxReadImpl.parse(MxCaaa00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400101) MxReadImpl.parse(MxCaaa00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
