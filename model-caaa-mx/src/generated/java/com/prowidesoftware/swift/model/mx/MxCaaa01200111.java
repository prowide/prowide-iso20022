    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01200111 parse(String xml) {
        return ((MxCaaa01200111) MxReadImpl.parse(MxCaaa01200111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01200111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01200111) MxReadImpl.parse(MxCaaa01200111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01200111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01200111 .class);
    }
