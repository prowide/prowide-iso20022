...
/**
 * Class for caaa.012.001.10 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01200110(final String xml) {
        this();
        MxCaaa01200110 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01200110(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorBatchTransferResponseV10 }
     *     
     */
    public AcceptorBatchTransferResponseV10 getAccptrBtchTrfRspn() {
     ...
     *     
     */
    public MxCaaa01200110 setAccptrBtchTrfRspn(AcceptorBatchTransferResponseV10 value) {
     ...
     * 
     */
    public static MxCaaa01200110 parse(String xml) {
        return ((MxCaaa01200110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01200110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01200110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01200110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01200110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01200110 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01200110) parserImpl.read(MxCaaa01200110 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01200110 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01200110 message
     * @return
     *     a new instance of MxCaaa01200110
     */
    public final static MxCaaa01200110 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01200110 .class);
    }
