    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01200110 parse(String xml) {
        return ((MxCaaa01200110) MxReadImpl.parse(MxCaaa01200110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01200110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01200110) MxReadImpl.parse(MxCaaa01200110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01200110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01200110 .class);
    }
