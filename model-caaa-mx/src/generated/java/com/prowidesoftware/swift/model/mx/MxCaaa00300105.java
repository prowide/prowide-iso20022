    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.003.001.05";
    ...
    public static MxCaaa00300105 parse(String xml) {
        return ((MxCaaa00300105) MxReadImpl.parse(MxCaaa00300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300105) MxReadImpl.parse(MxCaaa00300105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00300105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00300105 .class);
    }
