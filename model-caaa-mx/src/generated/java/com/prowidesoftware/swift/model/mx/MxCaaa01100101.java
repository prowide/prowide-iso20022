    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.011.001.01";
    ...
    public static MxCaaa01100101 parse(String xml) {
        return ((MxCaaa01100101) MxReadImpl.parse(MxCaaa01100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01100101) MxReadImpl.parse(MxCaaa01100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01100101 .class);
    }
