    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01900104 parse(String xml) {
        return ((MxCaaa01900104) MxReadImpl.parse(MxCaaa01900104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01900104) MxReadImpl.parse(MxCaaa01900104 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01900104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01900104 .class);
    }
