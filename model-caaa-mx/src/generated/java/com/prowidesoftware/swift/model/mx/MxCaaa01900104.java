...
/**
 * Class for caaa.019.001.04 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01900104(final String xml) {
        this();
        MxCaaa01900104 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01900104(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCurrencyConversionAdviceResponseV04 }
     *     
     */
    public AcceptorCurrencyConversionAdviceResponseV04 getAccptrCcyConvsAdvcRspn() {
     ...
     *     
     */
    public MxCaaa01900104 setAccptrCcyConvsAdvcRspn(AcceptorCurrencyConversionAdviceResponseV04 value) {
     ...
     * 
     */
    public static MxCaaa01900104 parse(String xml) {
        return ((MxCaaa01900104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01900104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01900104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01900104) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01900104 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01900104 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01900104) parserImpl.read(MxCaaa01900104 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01900104 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01900104 message
     * @return
     *     a new instance of MxCaaa01900104
     */
    public static final MxCaaa01900104 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01900104 .class);
    }
