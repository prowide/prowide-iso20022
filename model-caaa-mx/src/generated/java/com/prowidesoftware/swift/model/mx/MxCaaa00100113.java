    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00100113 parse(String xml) {
        return ((MxCaaa00100113) MxReadImpl.parse(MxCaaa00100113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00100113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00100113) MxReadImpl.parse(MxCaaa00100113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00100113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00100113 .class);
    }
