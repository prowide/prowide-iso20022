    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01300108 parse(String xml) {
        return ((MxCaaa01300108) MxReadImpl.parse(MxCaaa01300108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01300108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01300108) MxReadImpl.parse(MxCaaa01300108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01300108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01300108 .class);
    }
