    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.009.001.07";
    ...
    public static MxCaaa00900107 parse(String xml) {
        return ((MxCaaa00900107) MxReadImpl.parse(MxCaaa00900107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00900107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900107) MxReadImpl.parse(MxCaaa00900107 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00900107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00900107 .class);
    }
