    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00200103 parse(String xml) {
        return ((MxCaaa00200103) MxReadImpl.parse(MxCaaa00200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00200103) MxReadImpl.parse(MxCaaa00200103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00200103 .class);
    }
