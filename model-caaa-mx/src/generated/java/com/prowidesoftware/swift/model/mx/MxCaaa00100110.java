...
/**
 * Class for caaa.001.001.10 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa00100110(final String xml) {
        this();
        MxCaaa00100110 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00100110(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorAuthorisationRequestV10 }
     *     
     */
    public AcceptorAuthorisationRequestV10 getAccptrAuthstnReq() {
     ...
     *     
     */
    public MxCaaa00100110 setAccptrAuthstnReq(AcceptorAuthorisationRequestV10 value) {
     ...
     * 
     */
    public static MxCaaa00100110 parse(String xml) {
        return ((MxCaaa00100110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00100110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa00100110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00100110) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00100110 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00100110 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00100110) parserImpl.read(MxCaaa00100110 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00100110 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00100110 message
     * @return
     *     a new instance of MxCaaa00100110
     */
    public final static MxCaaa00100110 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa00100110 .class);
    }
