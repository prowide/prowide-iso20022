...
/**
 * Class for caaa.010.001.12 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01000112(final String xml) {
        this();
        MxCaaa01000112 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01000112(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorReconciliationResponseV12 }
     *     
     */
    public AcceptorReconciliationResponseV12 getAccptrRcncltnRspn() {
     ...
     *     
     */
    public MxCaaa01000112 setAccptrRcncltnRspn(AcceptorReconciliationResponseV12 value) {
     ...
     * 
     */
    public static MxCaaa01000112 parse(String xml) {
        return ((MxCaaa01000112) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01000112 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01000112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000112) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01000112 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01000112 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01000112) parserImpl.read(MxCaaa01000112 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01000112 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01000112 message
     * @return
     *     a new instance of MxCaaa01000112
     */
    public final static MxCaaa01000112 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01000112 .class);
    }
