    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01000112 parse(String xml) {
        return ((MxCaaa01000112) MxReadImpl.parse(MxCaaa01000112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01000112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000112) MxReadImpl.parse(MxCaaa01000112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01000112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01000112 .class);
    }
