    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01700108 parse(String xml) {
        return ((MxCaaa01700108) MxReadImpl.parse(MxCaaa01700108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01700108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01700108) MxReadImpl.parse(MxCaaa01700108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01700108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01700108 .class);
    }
