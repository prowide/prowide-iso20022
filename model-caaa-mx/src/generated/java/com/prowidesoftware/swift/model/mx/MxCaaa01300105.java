    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.013.001.05";
    ...
    public static MxCaaa01300105 parse(String xml) {
        return ((MxCaaa01300105) MxReadImpl.parse(MxCaaa01300105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01300105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01300105) MxReadImpl.parse(MxCaaa01300105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa01300105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01300105 .class);
    }
