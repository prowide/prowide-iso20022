    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02600101 parse(String xml) {
        return ((MxCaaa02600101) MxReadImpl.parse(MxCaaa02600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02600101) MxReadImpl.parse(MxCaaa02600101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02600101 .class);
    }
