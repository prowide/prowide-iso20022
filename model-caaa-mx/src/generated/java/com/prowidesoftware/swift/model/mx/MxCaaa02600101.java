...
/**
 * Class for caaa.026.001.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02600101(final String xml) {
        this();
        MxCaaa02600101 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02600101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorToAcquirerBatchFileExchangeV01 }
     *     
     */
    public AcceptorToAcquirerBatchFileExchangeV01 getAccptrToAcqrrBtchFileXchg() {
     ...
     *     
     */
    public MxCaaa02600101 setAccptrToAcqrrBtchFileXchg(AcceptorToAcquirerBatchFileExchangeV01 value) {
     ...
     * 
     */
    public static MxCaaa02600101 parse(String xml) {
        return ((MxCaaa02600101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02600101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02600101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02600101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02600101 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02600101) parserImpl.read(MxCaaa02600101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02600101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02600101 message
     * @return
     *     a new instance of MxCaaa02600101
     */
    public final static MxCaaa02600101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02600101 .class);
    }
