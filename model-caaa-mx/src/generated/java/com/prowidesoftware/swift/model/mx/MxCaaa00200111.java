    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00200111 parse(String xml) {
        return ((MxCaaa00200111) MxReadImpl.parse(MxCaaa00200111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00200111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00200111) MxReadImpl.parse(MxCaaa00200111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00200111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00200111 .class);
    }
