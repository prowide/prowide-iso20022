...
/**
 * Class for caaa.002.001.11 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:caaa.002.001.11")
public class MxCaaa00200111
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa00200111(final String xml) {
        this();
        MxCaaa00200111 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00200111(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorAuthorisationResponseV11 }
     *     
     */
     ...
     *     
     */
    public MxCaaa00200111 setAccptrAuthstnRspn(AcceptorAuthorisationResponseV11 value) {
     ...
     * 
     */
    public static MxCaaa00200111 parse(String xml) {
        return ((MxCaaa00200111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00200111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa00200111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00200111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00200111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00200111 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00200111) parserImpl.read(MxCaaa00200111 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00200111 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00200111 message
     * @return
     *     a new instance of MxCaaa00200111
     */
    public final static MxCaaa00200111 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa00200111 .class);
    }
