    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.001.001.01";
    ...
    public static MxCaaa00100101 parse(String xml) {
        return ((MxCaaa00100101) MxReadImpl.parse(MxCaaa00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00100101) MxReadImpl.parse(MxCaaa00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00100101 .class);
    }
