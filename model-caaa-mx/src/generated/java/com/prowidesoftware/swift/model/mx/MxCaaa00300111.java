...
/**
 * Class for caaa.003.001.11 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa00300111(final String xml) {
        this();
        MxCaaa00300111 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00300111(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCompletionAdviceV11 }
     *     
     */
    public AcceptorCompletionAdviceV11 getAccptrCmpltnAdvc() {
     ...
     *     
     */
    public MxCaaa00300111 setAccptrCmpltnAdvc(AcceptorCompletionAdviceV11 value) {
     ...
     * 
     */
    public static MxCaaa00300111 parse(String xml) {
        return ((MxCaaa00300111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00300111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa00300111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00300111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00300111 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00300111) parserImpl.read(MxCaaa00300111 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00300111 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00300111 message
     * @return
     *     a new instance of MxCaaa00300111
     */
    public static final MxCaaa00300111 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa00300111 .class);
    }
