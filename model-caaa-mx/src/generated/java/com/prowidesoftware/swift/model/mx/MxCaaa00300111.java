    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00300111 parse(String xml) {
        return ((MxCaaa00300111) MxReadImpl.parse(MxCaaa00300111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00300111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300111) MxReadImpl.parse(MxCaaa00300111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00300111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00300111 .class);
    }
