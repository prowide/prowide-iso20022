    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00500102 parse(String xml) {
        return ((MxCaaa00500102) MxReadImpl.parse(MxCaaa00500102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00500102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00500102) MxReadImpl.parse(MxCaaa00500102 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00500102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00500102 .class);
    }
