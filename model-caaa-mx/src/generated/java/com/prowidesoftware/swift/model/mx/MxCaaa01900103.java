    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01900103 parse(String xml) {
        return ((MxCaaa01900103) MxReadImpl.parse(MxCaaa01900103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01900103) MxReadImpl.parse(MxCaaa01900103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01900103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01900103 .class);
    }
