...
/**
 * Class for caaa.019.001.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01900103(final String xml) {
        this();
        MxCaaa01900103 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01900103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCurrencyConversionAdviceResponseV03 }
     *     
     */
    public AcceptorCurrencyConversionAdviceResponseV03 getAccptrCcyConvsAdvcRspn() {
     ...
     *     
     */
    public MxCaaa01900103 setAccptrCcyConvsAdvcRspn(AcceptorCurrencyConversionAdviceResponseV03 value) {
     ...
     * 
     */
    public static MxCaaa01900103 parse(String xml) {
        return ((MxCaaa01900103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01900103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01900103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01900103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01900103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01900103 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01900103) parserImpl.read(MxCaaa01900103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01900103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01900103 message
     * @return
     *     a new instance of MxCaaa01900103
     */
    public static final MxCaaa01900103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01900103 .class);
    }
