    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01200103 parse(String xml) {
        return ((MxCaaa01200103) MxReadImpl.parse(MxCaaa01200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01200103) MxReadImpl.parse(MxCaaa01200103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01200103 .class);
    }
