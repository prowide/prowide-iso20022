    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01600110 parse(String xml) {
        return ((MxCaaa01600110) MxReadImpl.parse(MxCaaa01600110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01600110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01600110) MxReadImpl.parse(MxCaaa01600110 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01600110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01600110 .class);
    }
