    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02000103 parse(String xml) {
        return ((MxCaaa02000103) MxReadImpl.parse(MxCaaa02000103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02000103) MxReadImpl.parse(MxCaaa02000103 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02000103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02000103 .class);
    }
