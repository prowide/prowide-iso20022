...
/**
 * Class for caaa.020.001.03 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02000103(final String xml) {
        this();
        MxCaaa02000103 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02000103(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link TransactionAdviceV03 }
     *     
     */
    public TransactionAdviceV03 getTxAdvc() {
        return txAdvc;
    }
     ...
     *     
     */
    public MxCaaa02000103 setTxAdvc(TransactionAdviceV03 value) {
        this.txAdvc = value;
        return this;
    }
     ...
     * 
     */
    public static MxCaaa02000103 parse(String xml) {
        return ((MxCaaa02000103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02000103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02000103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02000103) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02000103 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02000103 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02000103) parserImpl.read(MxCaaa02000103 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02000103 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02000103 message
     * @return
     *     a new instance of MxCaaa02000103
     */
    public final static MxCaaa02000103 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02000103 .class);
    }
