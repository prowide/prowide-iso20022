    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00700107 parse(String xml) {
        return ((MxCaaa00700107) MxReadImpl.parse(MxCaaa00700107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00700107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00700107) MxReadImpl.parse(MxCaaa00700107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00700107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00700107 .class);
    }
