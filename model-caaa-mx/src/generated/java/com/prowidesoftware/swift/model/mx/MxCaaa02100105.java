    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02100105 parse(String xml) {
        return ((MxCaaa02100105) MxReadImpl.parse(MxCaaa02100105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02100105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02100105) MxReadImpl.parse(MxCaaa02100105 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02100105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02100105 .class);
    }
