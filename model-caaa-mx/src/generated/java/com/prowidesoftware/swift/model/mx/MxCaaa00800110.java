    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.008.001.10";
    ...
    public static MxCaaa00800110 parse(String xml) {
        return ((MxCaaa00800110) MxReadImpl.parse(MxCaaa00800110 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00800110 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00800110) MxReadImpl.parse(MxCaaa00800110 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00800110 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00800110 .class);
    }
