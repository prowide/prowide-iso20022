    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.003.001.04";
    ...
    public static MxCaaa00300104 parse(String xml) {
        return ((MxCaaa00300104) MxReadImpl.parse(MxCaaa00300104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00300104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300104) MxReadImpl.parse(MxCaaa00300104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00300104 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00300104 .class);
    }
