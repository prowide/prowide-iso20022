    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01300109 parse(String xml) {
        return ((MxCaaa01300109) MxReadImpl.parse(MxCaaa01300109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01300109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01300109) MxReadImpl.parse(MxCaaa01300109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01300109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01300109 .class);
    }
