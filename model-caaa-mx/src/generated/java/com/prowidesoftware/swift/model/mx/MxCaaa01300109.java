...
/**
 * Class for caaa.013.001.09 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01300109(final String xml) {
        this();
        MxCaaa01300109 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01300109(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorDiagnosticRequestV09 }
     *     
     */
    public AcceptorDiagnosticRequestV09 getAccptrDgnstcReq() {
     ...
     *     
     */
    public MxCaaa01300109 setAccptrDgnstcReq(AcceptorDiagnosticRequestV09 value) {
     ...
     * 
     */
    public static MxCaaa01300109 parse(String xml) {
        return ((MxCaaa01300109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01300109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01300109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01300109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01300109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01300109 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01300109) parserImpl.read(MxCaaa01300109 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01300109 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01300109 message
     * @return
     *     a new instance of MxCaaa01300109
     */
    public final static MxCaaa01300109 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01300109 .class);
    }
