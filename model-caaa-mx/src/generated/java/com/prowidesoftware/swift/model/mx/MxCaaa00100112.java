...
/**
 * Class for caaa.001.001.12 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa00100112(final String xml) {
        this();
        MxCaaa00100112 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00100112(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorAuthorisationRequestV12 }
     *     
     */
    public AcceptorAuthorisationRequestV12 getAccptrAuthstnReq() {
     ...
     *     
     */
    public MxCaaa00100112 setAccptrAuthstnReq(AcceptorAuthorisationRequestV12 value) {
     ...
     * 
     */
    public static MxCaaa00100112 parse(String xml) {
        return ((MxCaaa00100112) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00100112 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa00100112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00100112) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00100112 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00100112 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00100112) parserImpl.read(MxCaaa00100112 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00100112 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00100112 message
     * @return
     *     a new instance of MxCaaa00100112
     */
    public static final MxCaaa00100112 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa00100112 .class);
    }
