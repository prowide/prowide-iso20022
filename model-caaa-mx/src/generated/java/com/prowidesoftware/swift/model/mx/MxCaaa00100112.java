    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00100112 parse(String xml) {
        return ((MxCaaa00100112) MxReadImpl.parse(MxCaaa00100112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00100112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00100112) MxReadImpl.parse(MxCaaa00100112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00100112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00100112 .class);
    }
