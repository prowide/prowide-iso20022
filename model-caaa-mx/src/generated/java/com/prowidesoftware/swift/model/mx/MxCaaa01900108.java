    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01900108 parse(String xml) {
        return ((MxCaaa01900108) MxReadImpl.parse(MxCaaa01900108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01900108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01900108) MxReadImpl.parse(MxCaaa01900108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01900108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01900108 .class);
    }
