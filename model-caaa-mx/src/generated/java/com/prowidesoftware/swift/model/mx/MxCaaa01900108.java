...
/**
 * Class for caaa.019.001.08 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01900108(final String xml) {
        this();
        MxCaaa01900108 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01900108(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorCurrencyConversionAdviceResponseV08 }
     *     
     */
    public AcceptorCurrencyConversionAdviceResponseV08 getAccptrCcyConvsAdvcRspn() {
     ...
     *     
     */
    public MxCaaa01900108 setAccptrCcyConvsAdvcRspn(AcceptorCurrencyConversionAdviceResponseV08 value) {
     ...
     * 
     */
    public static MxCaaa01900108 parse(String xml) {
        return ((MxCaaa01900108) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01900108 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01900108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01900108) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01900108 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01900108 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01900108) parserImpl.read(MxCaaa01900108 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01900108 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01900108 message
     * @return
     *     a new instance of MxCaaa01900108
     */
    public static final MxCaaa01900108 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01900108 .class);
    }
