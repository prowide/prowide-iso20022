    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00400106 parse(String xml) {
        return ((MxCaaa00400106) MxReadImpl.parse(MxCaaa00400106 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00400106 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00400106) MxReadImpl.parse(MxCaaa00400106 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00400106 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00400106 .class);
    }
