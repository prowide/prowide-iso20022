    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00300103 parse(String xml) {
        return ((MxCaaa00300103) MxReadImpl.parse(MxCaaa00300103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00300103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300103) MxReadImpl.parse(MxCaaa00300103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00300103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00300103 .class);
    }
