...
/**
 * Class for caaa.009.001.13 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa00900113(final String xml) {
        this();
        MxCaaa00900113 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00900113(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorReconciliationRequestV13 }
     *     
     */
    public AcceptorReconciliationRequestV13 getAccptrRcncltnReq() {
     ...
     *     
     */
    public MxCaaa00900113 setAccptrRcncltnReq(AcceptorReconciliationRequestV13 value) {
     ...
     * 
     */
    public static MxCaaa00900113 parse(String xml) {
        return ((MxCaaa00900113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00900113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa00900113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00900113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00900113 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00900113) parserImpl.read(MxCaaa00900113 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00900113 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00900113 message
     * @return
     *     a new instance of MxCaaa00900113
     */
    public static final MxCaaa00900113 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa00900113 .class);
    }
