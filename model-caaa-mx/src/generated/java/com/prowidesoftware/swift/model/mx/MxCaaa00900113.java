    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00900113 parse(String xml) {
        return ((MxCaaa00900113) MxReadImpl.parse(MxCaaa00900113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00900113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900113) MxReadImpl.parse(MxCaaa00900113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00900113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00900113 .class);
    }
