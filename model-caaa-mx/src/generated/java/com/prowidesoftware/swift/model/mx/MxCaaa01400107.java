    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01400107 parse(String xml) {
        return ((MxCaaa01400107) MxReadImpl.parse(MxCaaa01400107 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01400107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400107) MxReadImpl.parse(MxCaaa01400107 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01400107 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01400107 .class);
    }
