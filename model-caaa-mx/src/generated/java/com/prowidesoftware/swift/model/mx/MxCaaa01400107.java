...
/**
 * Class for caaa.014.001.07 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01400107(final String xml) {
        this();
        MxCaaa01400107 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01400107(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorDiagnosticResponseV07 }
     *     
     */
    public AcceptorDiagnosticResponseV07 getAccptrDgnstcRspn() {
     ...
     *     
     */
    public MxCaaa01400107 setAccptrDgnstcRspn(AcceptorDiagnosticResponseV07 value) {
     ...
     * 
     */
    public static MxCaaa01400107 parse(String xml) {
        return ((MxCaaa01400107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01400107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01400107 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400107) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01400107 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01400107 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01400107) parserImpl.read(MxCaaa01400107 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01400107 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01400107 message
     * @return
     *     a new instance of MxCaaa01400107
     */
    public final static MxCaaa01400107 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01400107 .class);
    }
