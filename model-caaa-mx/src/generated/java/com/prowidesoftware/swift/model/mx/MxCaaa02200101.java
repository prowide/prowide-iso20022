...
/**
 * Class for caaa.022.001.01 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa02200101(final String xml) {
        this();
        MxCaaa02200101 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa02200101(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorNonFinancialRequestV01 }
     *     
     */
    public AcceptorNonFinancialRequestV01 getAccptrNonFinReq() {
     ...
     *     
     */
    public MxCaaa02200101 setAccptrNonFinReq(AcceptorNonFinancialRequestV01 value) {
     ...
     * 
     */
    public static MxCaaa02200101 parse(String xml) {
        return ((MxCaaa02200101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02200101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa02200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02200101) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa02200101 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa02200101 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa02200101) parserImpl.read(MxCaaa02200101 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa02200101 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa02200101 message
     * @return
     *     a new instance of MxCaaa02200101
     */
    public final static MxCaaa02200101 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa02200101 .class);
    }
