    ...
    extends AbstractMX
{
    ...
    public static MxCaaa02200101 parse(String xml) {
        return ((MxCaaa02200101) MxReadImpl.parse(MxCaaa02200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02200101) MxReadImpl.parse(MxCaaa02200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa02200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02200101 .class);
    }
