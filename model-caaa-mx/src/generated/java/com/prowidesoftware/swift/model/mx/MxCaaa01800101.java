    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01800101 parse(String xml) {
        return ((MxCaaa01800101) MxReadImpl.parse(MxCaaa01800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01800101) MxReadImpl.parse(MxCaaa01800101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01800101 .class);
    }
