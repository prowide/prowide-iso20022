    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01700112 parse(String xml) {
        return ((MxCaaa01700112) MxReadImpl.parse(MxCaaa01700112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01700112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01700112) MxReadImpl.parse(MxCaaa01700112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01700112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01700112 .class);
    }
