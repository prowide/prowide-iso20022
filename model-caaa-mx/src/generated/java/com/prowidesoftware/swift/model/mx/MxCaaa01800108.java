    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01800108 parse(String xml) {
        return ((MxCaaa01800108) MxReadImpl.parse(MxCaaa01800108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01800108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01800108) MxReadImpl.parse(MxCaaa01800108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01800108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01800108 .class);
    }
