...
/**
 * Class for caaa.013.001.11 ISO 20022 message.
 * 
 */
...
@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:caaa.013.001.11")
public class MxCaaa01300111
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01300111(final String xml) {
        this();
        MxCaaa01300111 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01300111(final MxSwiftMessage mxSwiftMessage) {
     ...
     *     
     */
    public MxCaaa01300111 setAccptrDgnstcReq(AcceptorDiagnosticRequestV11 value) {
     ...
     * 
     */
    public static MxCaaa01300111 parse(String xml) {
        return ((MxCaaa01300111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01300111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01300111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01300111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01300111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01300111 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01300111) parserImpl.read(MxCaaa01300111 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01300111 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01300111 message
     * @return
     *     a new instance of MxCaaa01300111
     */
    public static final MxCaaa01300111 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01300111 .class);
    }
