    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01300111 parse(String xml) {
        return ((MxCaaa01300111) MxReadImpl.parse(MxCaaa01300111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01300111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01300111) MxReadImpl.parse(MxCaaa01300111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01300111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01300111 .class);
    }
