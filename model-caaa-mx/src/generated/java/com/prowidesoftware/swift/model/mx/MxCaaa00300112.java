    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00300112 parse(String xml) {
        return ((MxCaaa00300112) MxReadImpl.parse(MxCaaa00300112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00300112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300112) MxReadImpl.parse(MxCaaa00300112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00300112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00300112 .class);
    }
