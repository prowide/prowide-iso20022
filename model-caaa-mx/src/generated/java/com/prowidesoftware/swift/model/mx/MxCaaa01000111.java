...
/**
 * Class for caaa.010.001.11 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01000111(final String xml) {
        this();
        MxCaaa01000111 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01000111(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorReconciliationResponseV11 }
     *     
     */
    public AcceptorReconciliationResponseV11 getAccptrRcncltnRspn() {
     ...
     *     
     */
    public MxCaaa01000111 setAccptrRcncltnRspn(AcceptorReconciliationResponseV11 value) {
     ...
     * 
     */
    public static MxCaaa01000111 parse(String xml) {
        return ((MxCaaa01000111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01000111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01000111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000111) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01000111 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01000111 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01000111) parserImpl.read(MxCaaa01000111 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01000111 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01000111 message
     * @return
     *     a new instance of MxCaaa01000111
     */
    public static final MxCaaa01000111 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01000111 .class);
    }
