    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01000111 parse(String xml) {
        return ((MxCaaa01000111) MxReadImpl.parse(MxCaaa01000111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01000111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01000111) MxReadImpl.parse(MxCaaa01000111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01000111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01000111 .class);
    }
