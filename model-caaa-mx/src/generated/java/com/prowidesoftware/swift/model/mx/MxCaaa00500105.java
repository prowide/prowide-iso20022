    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00500105 parse(String xml) {
        return ((MxCaaa00500105) MxReadImpl.parse(MxCaaa00500105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00500105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00500105) MxReadImpl.parse(MxCaaa00500105 .class, xml, _classes, new MxReadParams(conf)));
    }
