    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01200113 parse(String xml) {
        return ((MxCaaa01200113) MxReadImpl.parse(MxCaaa01200113 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01200113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01200113) MxReadImpl.parse(MxCaaa01200113 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01200113 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01200113 .class);
    }
