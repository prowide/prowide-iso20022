...
/**
 * Class for caaa.012.001.13 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01200113(final String xml) {
        this();
        MxCaaa01200113 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01200113(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorBatchTransferResponseV13 }
     *     
     */
    public AcceptorBatchTransferResponseV13 getAccptrBtchTrfRspn() {
     ...
     *     
     */
    public MxCaaa01200113 setAccptrBtchTrfRspn(AcceptorBatchTransferResponseV13 value) {
     ...
     * 
     */
    public static MxCaaa01200113 parse(String xml) {
        return ((MxCaaa01200113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01200113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01200113 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01200113) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01200113 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01200113 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01200113) parserImpl.read(MxCaaa01200113 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01200113 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01200113 message
     * @return
     *     a new instance of MxCaaa01200113
     */
    public static final MxCaaa01200113 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01200113 .class);
    }
