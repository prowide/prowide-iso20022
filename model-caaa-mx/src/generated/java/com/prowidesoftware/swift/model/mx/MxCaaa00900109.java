...
/**
 * Class for caaa.009.001.09 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa00900109(final String xml) {
        this();
        MxCaaa00900109 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa00900109(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorReconciliationRequestV09 }
     *     
     */
    public AcceptorReconciliationRequestV09 getAccptrRcncltnReq() {
     ...
     *     
     */
    public MxCaaa00900109 setAccptrRcncltnReq(AcceptorReconciliationRequestV09 value) {
     ...
     * 
     */
    public static MxCaaa00900109 parse(String xml) {
        return ((MxCaaa00900109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00900109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa00900109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900109) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa00900109 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa00900109 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa00900109) parserImpl.read(MxCaaa00900109 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa00900109 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa00900109 message
     * @return
     *     a new instance of MxCaaa00900109
     */
    public static final MxCaaa00900109 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa00900109 .class);
    }
