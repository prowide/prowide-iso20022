    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00900109 parse(String xml) {
        return ((MxCaaa00900109) MxReadImpl.parse(MxCaaa00900109 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00900109 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00900109) MxReadImpl.parse(MxCaaa00900109 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00900109 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00900109 .class);
    }
