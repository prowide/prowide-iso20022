    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00500111 parse(String xml) {
        return ((MxCaaa00500111) MxReadImpl.parse(MxCaaa00500111 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00500111 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00500111) MxReadImpl.parse(MxCaaa00500111 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00500111 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00500111 .class);
    }
