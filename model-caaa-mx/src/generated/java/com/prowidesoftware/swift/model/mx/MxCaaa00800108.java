    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00800108 parse(String xml) {
        return ((MxCaaa00800108) MxReadImpl.parse(MxCaaa00800108 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00800108 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00800108) MxReadImpl.parse(MxCaaa00800108 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa00800108 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00800108 .class);
    }
