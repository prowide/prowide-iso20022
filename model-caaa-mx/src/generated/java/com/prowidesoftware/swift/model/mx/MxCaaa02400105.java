    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.024.001.05";
    ...
    public static MxCaaa02400105 parse(String xml) {
        return ((MxCaaa02400105) MxReadImpl.parse(MxCaaa02400105 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02400105 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02400105) MxReadImpl.parse(MxCaaa02400105 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa02400105 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02400105 .class);
    }
