    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.022.001.03";
    ...
    public static MxCaaa02200103 parse(String xml) {
        return ((MxCaaa02200103) MxReadImpl.parse(MxCaaa02200103 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa02200103 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa02200103) MxReadImpl.parse(MxCaaa02200103 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa02200103 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa02200103 .class);
    }
