    ...
    extends AbstractMX
{
    ...
    public static MxCaaa00700104 parse(String xml) {
        return ((MxCaaa00700104) MxReadImpl.parse(MxCaaa00700104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00700104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00700104) MxReadImpl.parse(MxCaaa00700104 .class, xml, _classes, new MxReadParams(conf)));
    }
