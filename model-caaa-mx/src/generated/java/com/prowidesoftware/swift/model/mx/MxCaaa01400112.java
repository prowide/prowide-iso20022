    ...
    extends AbstractMX
{
    ...
    public static MxCaaa01400112 parse(String xml) {
        return ((MxCaaa01400112) MxReadImpl.parse(MxCaaa01400112 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa01400112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400112) MxReadImpl.parse(MxCaaa01400112 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCaaa01400112 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa01400112 .class);
    }
