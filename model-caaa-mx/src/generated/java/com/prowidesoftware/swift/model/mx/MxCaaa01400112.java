...
/**
 * Class for caaa.014.001.12 ISO 20022 message.
 * 
 */
    ...
    extends com.prowidesoftware.swift.model.mx.AbstractMX
{
     ...
     * 
     */
    public MxCaaa01400112(final String xml) {
        this();
        MxCaaa01400112 tmp = parse(xml);
     ...
     * 
     */
    public MxCaaa01400112(final MxSwiftMessage mxSwiftMessage) {
     ...
     * @return
     *     possible object is
     *     {@link AcceptorDiagnosticResponseV12 }
     *     
     */
    public AcceptorDiagnosticResponseV12 getAccptrDgnstcRspn() {
     ...
     *     
     */
    public MxCaaa01400112 setAccptrDgnstcRspn(AcceptorDiagnosticResponseV12 value) {
     ...
     * 
     */
    public static MxCaaa01400112 parse(String xml) {
        return ((MxCaaa01400112) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01400112 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams()));
    }
     ...
     * 
     */
    public static MxCaaa01400112 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa01400112) com.prowidesoftware.swift.model.mx.MxReadImpl.parse(MxCaaa01400112 .class, xml, _classes, new com.prowidesoftware.swift.model.mx.MxReadParams(conf)));
    }
     ...
     */
    public static MxCaaa01400112 parse(String xml, MxRead parserImpl) {
        return ((MxCaaa01400112) parserImpl.read(MxCaaa01400112 .class, xml, _classes));
    }
    ...
    /**
     * Creates an MxCaaa01400112 messages from its JSON representation.
     * <p>
     ...
     * @since 7.10.2
     * 
     * @param json a JSON representation of an MxCaaa01400112 message
     * @return
     *     a new instance of MxCaaa01400112
     */
    public final static MxCaaa01400112 fromJson(String json) {
        return com.prowidesoftware.swift.model.mx.AbstractMX.fromJson(json, MxCaaa01400112 .class);
    }
