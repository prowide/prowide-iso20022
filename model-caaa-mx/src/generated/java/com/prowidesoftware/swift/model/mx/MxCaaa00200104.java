    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.002.001.04";
    ...
    public static MxCaaa00200104 parse(String xml) {
        return ((MxCaaa00200104) MxReadImpl.parse(MxCaaa00200104 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00200104 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00200104) MxReadImpl.parse(MxCaaa00200104 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00200104 fromJson(String json) {
