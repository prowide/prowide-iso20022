    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:iso:std:iso:20022:tech:xsd:caaa.003.001.02";
    ...
    public static MxCaaa00300102 parse(String xml) {
        return ((MxCaaa00300102) MxReadImpl.parse(MxCaaa00300102 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCaaa00300102 parse(String xml, MxReadConfiguration conf) {
        return ((MxCaaa00300102) MxReadImpl.parse(MxCaaa00300102 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCaaa00300102 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCaaa00300102 .class);
    }
