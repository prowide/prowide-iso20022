    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:cbrf:xsd:cbrf.001.001.01";
    ...
    public static MxCbrf00100101 parse(String xml) {
        return ((MxCbrf00100101) MxReadImpl.parse(MxCbrf00100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCbrf00100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCbrf00100101) MxReadImpl.parse(MxCbrf00100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCbrf00100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCbrf00100101 .class);
    }
