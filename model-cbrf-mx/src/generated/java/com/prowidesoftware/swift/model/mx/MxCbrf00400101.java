    ...
    extends AbstractMX
{
    ...
    public static MxCbrf00400101 parse(String xml) {
        return ((MxCbrf00400101) MxReadImpl.parse(MxCbrf00400101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCbrf00400101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCbrf00400101) MxReadImpl.parse(MxCbrf00400101 .class, xml, _classes, new MxReadParams(conf)));
    }
