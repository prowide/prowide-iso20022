    ...
    extends AbstractMX
{
    ...
    public static MxCbrf00900101 parse(String xml) {
        return ((MxCbrf00900101) MxReadImpl.parse(MxCbrf00900101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCbrf00900101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCbrf00900101) MxReadImpl.parse(MxCbrf00900101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCbrf00900101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCbrf00900101 .class);
    }
