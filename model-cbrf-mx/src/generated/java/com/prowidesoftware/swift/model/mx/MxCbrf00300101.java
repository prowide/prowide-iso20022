    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {CommunicationChannel1Choice.class, CommunicationCharacteristicsModificationRequestV01 .class, MessageHeader1 .class, MxCbrf00300101 .class, SupplementaryData1 .class, SupplementaryDataEnvelope1 .class };
    public static final transient String NAMESPACE = "urn:cbrf:xsd:cbrf.003.001.01";
    ...
    public static MxCbrf00300101 parse(String xml) {
        return ((MxCbrf00300101) MxReadImpl.parse(MxCbrf00300101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCbrf00300101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCbrf00300101) MxReadImpl.parse(MxCbrf00300101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCbrf00300101 fromJson(String json) {
