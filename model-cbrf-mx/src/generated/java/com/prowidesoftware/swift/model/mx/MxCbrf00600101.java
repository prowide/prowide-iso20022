    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:cbrf:xsd:cbrf.006.001.01";
    ...
    public static MxCbrf00600101 parse(String xml) {
        return ((MxCbrf00600101) MxReadImpl.parse(MxCbrf00600101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCbrf00600101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCbrf00600101) MxReadImpl.parse(MxCbrf00600101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCbrf00600101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCbrf00600101 .class);
    }
