    ...
    extends AbstractMX
{
    ...
    public static MxCbrf01000101 parse(String xml) {
        return ((MxCbrf01000101) MxReadImpl.parse(MxCbrf01000101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCbrf01000101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCbrf01000101) MxReadImpl.parse(MxCbrf01000101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCbrf01000101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCbrf01000101 .class);
    }
