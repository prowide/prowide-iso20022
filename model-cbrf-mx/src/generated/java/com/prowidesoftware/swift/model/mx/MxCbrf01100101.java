    ...
    extends AbstractMX
{
    ...
    public static final transient Class[] _classes = new Class[] {MessageHeader1 .class, MxCbrf01100101 .class, ParticipantNotificationV01 .class };
    public static final transient String NAMESPACE = "urn:cbrf:xsd:cbrf.011.001.01";
    ...
    public static MxCbrf01100101 parse(String xml) {
        return ((MxCbrf01100101) MxReadImpl.parse(MxCbrf01100101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCbrf01100101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCbrf01100101) MxReadImpl.parse(MxCbrf01100101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCbrf01100101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCbrf01100101 .class);
    }
