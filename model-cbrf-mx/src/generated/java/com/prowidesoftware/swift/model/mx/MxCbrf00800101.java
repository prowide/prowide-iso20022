    ...
    extends AbstractMX
{
    ...
    public static final transient String NAMESPACE = "urn:cbrf:xsd:cbrf.008.001.01";
    ...
    public static MxCbrf00800101 parse(String xml) {
        return ((MxCbrf00800101) MxReadImpl.parse(MxCbrf00800101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCbrf00800101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCbrf00800101) MxReadImpl.parse(MxCbrf00800101 .class, xml, _classes, new MxReadParams(conf)));
    }
     ...
     */
    public static final MxCbrf00800101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCbrf00800101 .class);
    }
