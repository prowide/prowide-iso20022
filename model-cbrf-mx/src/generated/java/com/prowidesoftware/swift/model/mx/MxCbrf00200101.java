    ...
    extends AbstractMX
{
    ...
    public static MxCbrf00200101 parse(String xml) {
        return ((MxCbrf00200101) MxReadImpl.parse(MxCbrf00200101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCbrf00200101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCbrf00200101) MxReadImpl.parse(MxCbrf00200101 .class, xml, _classes, new MxReadParams(conf)));
    }
    ...
    public static final MxCbrf00200101 fromJson(String json) {
        return AbstractMX.fromJson(json, MxCbrf00200101 .class);
    }
