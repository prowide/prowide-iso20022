    ...
    extends AbstractMX
{
    ...
    public static MxCbrf00500101 parse(String xml) {
        return ((MxCbrf00500101) MxReadImpl.parse(MxCbrf00500101 .class, xml, _classes, new MxReadParams()));
    }
    ...
    public static MxCbrf00500101 parse(String xml, MxReadConfiguration conf) {
        return ((MxCbrf00500101) MxReadImpl.parse(MxCbrf00500101 .class, xml, _classes, new MxReadParams(conf)));
    }
